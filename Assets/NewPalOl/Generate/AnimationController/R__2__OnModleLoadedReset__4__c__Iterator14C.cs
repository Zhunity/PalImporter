...
{public partial class RAnimationController
{
	...
	/// <summary>
	/// AnimationController+<OnModleLoadedReset>c__Iterator14C
	/// </summary>
    public partial class R__2__OnModleLoadedReset__4__c__Iterator14C : RMember //
    {
        ...
        public R__2__OnModleLoadedReset__4__c__Iterator14C() : base("AnimationController+<OnModleLoadedReset>c__Iterator14C")
        {
        }

        public R__2__OnModleLoadedReset__4__c__Iterator14C(System.Object instance) : base("AnimationController+<OnModleLoadedReset>c__Iterator14C")
		{
            SetInstance(instance);
		}

        public R__2__OnModleLoadedReset__4__c__Iterator14C(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__OnModleLoadedReset__4__c__Iterator14C(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

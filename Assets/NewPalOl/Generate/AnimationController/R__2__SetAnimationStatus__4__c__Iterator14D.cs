...
{public partial class RAnimationController
{
	
	/// <summary>
	/// AnimationController+<SetAnimationStatus>c__Iterator14D
	/// </summary>
    public partial class R__2__SetAnimationStatus__4__c__Iterator14D : RMember //
    {

		/// <summary>
		/// UnityEngine.AnimationClip <tmpAC>__0
		/// </summary>
		protected RUnityEngine.RAnimationClip r___2__tmpAC__4____0;
		public virtual RUnityEngine.RAnimationClip R__2__tmpAC__4____0
		{
			get
			{
				if(r___2__tmpAC__4____0 == null)
				{
					r___2__tmpAC__4____0 = new(this, "<tmpAC>__0");
					r___2__tmpAC__4____0.SetBelong(this.instance);
				}
				return r___2__tmpAC__4____0;
			}
		}
		...
		/// <summary>
		/// AnimationController <>f__this
		/// </summary>
		protected RAnimationController r___2____4__f__this;
		public virtual RAnimationController R__2____4__f__this
		{
			get
			{
        ...
        public R__2__SetAnimationStatus__4__c__Iterator14D() : base("AnimationController+<SetAnimationStatus>c__Iterator14D")
        {
        }

        public R__2__SetAnimationStatus__4__c__Iterator14D(System.Object instance) : base("AnimationController+<SetAnimationStatus>c__Iterator14D")
		{
            SetInstance(instance);
		}

        public R__2__SetAnimationStatus__4__c__Iterator14D(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__SetAnimationStatus__4__c__Iterator14D(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

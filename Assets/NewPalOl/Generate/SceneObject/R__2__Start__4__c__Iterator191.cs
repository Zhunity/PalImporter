...
{public partial class RSceneObject
{
	
	/// <summary>
	/// SceneObject+<Start>c__Iterator191
	/// </summary>
    public partial class R__2__Start__4__c__Iterator191 : RMember //
    {

		/// <summary>
		/// UnityEngine.Animation <tmpAni>__0
		/// </summary>
		protected RUnityEngine.RAnimation r___2__tmpAni__4____0;
		public virtual RUnityEngine.RAnimation R__2__tmpAni__4____0
		{
			get
			{
				if(r___2__tmpAni__4____0 == null)
				{
					r___2__tmpAni__4____0 = new(this, "<tmpAni>__0");
					r___2__tmpAni__4____0.SetBelong(this.instance);
				}
				return r___2__tmpAni__4____0;
			}
		}
		...
		/// SceneObject <>f__this
		/// </summary>
		protected RSceneObject r___2____4__f__this;
		public virtual RSceneObject R__2____4__f__this
		{
			get
			{
        ...
        public R__2__Start__4__c__Iterator191() : base("SceneObject+<Start>c__Iterator191")
        {
        }

        public R__2__Start__4__c__Iterator191(System.Object instance) : base("SceneObject+<Start>c__Iterator191")
		{
            SetInstance(instance);
		}

        public R__2__Start__4__c__Iterator191(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__Start__4__c__Iterator191(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

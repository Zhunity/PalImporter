...
namespace SMFrame.Editor.Refleaction
{
	...
	/// WaterBase
	/// </summary>
    public partial class RWaterBase : RMember //
    {
		...
		/// </summary>
		protected RField r_waterQuality;
		public virtual RField RwaterQuality
		{
			get
			{
				if(r_waterQuality == null)
				{
					r_waterQuality = new(this, "waterQuality");
					r_waterQuality.SetBelong(this.instance);
				}
				return r_waterQuality;
			}
		}

		/// <summary>
		/// System.Boolean edgeBlend
		/// </summary>
		protected RField r_edgeBlend;
		public virtual RField RedgeBlend
		{
			get
			{
				if(r_edgeBlend == null)
				{
					r_edgeBlend = new(this, "edgeBlend");
					r_edgeBlend.SetBelong(this.instance);
				}
				return r_edgeBlend;
			}
		}
		...
		/// Void UpdateShader()
		/// </summary>
		protected RMethod r_RUpdateShader;
		public virtual RMethod RUpdateShader
		{
			get
			{
				if(r_RUpdateShader == null)
				{
					r_RUpdateShader = new(this, "UpdateShader", 0);
					r_RUpdateShader.SetBelong(this.instance);
				}
				return r_RUpdateShader;
			}
		}
        ...
        public RWaterBase() : base("WaterBase")
        {
        }

        public RWaterBase(System.Object instance) : base("WaterBase")
		{
            SetInstance(instance);
		}

        public RWaterBase(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RWaterBase(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void UpdateShader()
        {
            ...
            var ___result = RUpdateShader.Invoke(___genericsType, ___parameters);

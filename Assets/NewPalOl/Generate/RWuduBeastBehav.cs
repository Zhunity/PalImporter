...
namespace SMFrame.Editor.Refleaction
{
	...
	/// WuduBeastBehav
	/// </summary>
    public partial class RWuduBeastBehav : RMember //
    {

		/// <summary>
		/// UnityEngine.Quaternion m_WorldRotation
		/// </summary>
		protected RUnityEngine.RQuaternion r_m_WorldRotation;
		public virtual RUnityEngine.RQuaternion Rm_WorldRotation
		{
			get
			{
				if(r_m_WorldRotation == null)
				{
					r_m_WorldRotation = new(this, "m_WorldRotation");
					r_m_WorldRotation.SetBelong(this.instance);
				}
				return r_m_WorldRotation;
			}
		}
		...
		/// System.Int32 m_nIdx
		/// </summary>
		protected RField r_m_nIdx;
		public virtual RField Rm_nIdx
		{
			get
			{
				if(r_m_nIdx == null)
				{
					r_m_nIdx = new(this, "m_nIdx");
					r_m_nIdx.SetBelong(this.instance);
				}
				return r_m_nIdx;
			}
		}
        ...
        public RWuduBeastBehav() : base("WuduBeastBehav")
        {
        }

        public RWuduBeastBehav(System.Object instance) : base("WuduBeastBehav")
		{
            SetInstance(instance);
		}

        public RWuduBeastBehav(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RWuduBeastBehav(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

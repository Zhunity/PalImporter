...
{
	/// <summary>
	/// CareerPropConfigHold
	/// </summary>
    public partial class RCareerPropConfigHold : RMember //
    {
		...
		public static RField ROOT_NAME
		{
			get
			{
				if(r_ROOT_NAME == null)
				{
					r_ROOT_NAME = new(typeof(CareerPropConfigHold), "ROOT_NAME");
		...
		public static RField RID_NAME
		{
			get
			{
				if(r_ID_NAME == null)
				{
					r_ID_NAME = new(typeof(CareerPropConfigHold), "ID_NAME");
		...
		public static RField RTYPE_NAME
		{
			get
			{
				if(r_TYPE_NAME == null)
				{
					r_TYPE_NAME = new(typeof(CareerPropConfigHold), "TYPE_NAME");
		...
		/// <summary>
		/// System.Collections.Generic.List`1[System.String] skipchilds
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RList<RField> r_skipchilds;
		public static RSystem.RCollections.RGeneric.RList<RField> Rskipchilds
		{
			get
			{
				if(r_skipchilds == null)
				{
					r_skipchilds = new(typeof(CareerPropConfigHold), "skipchilds");
					r_skipchilds.SetBelong(null);
				}
				return r_skipchilds;
			}
		}
		...
		public static RMethod RLoadXml_Object
		{
			get
			{
				...
				{
					r_RLoadXml_Object = new(typeof(CareerPropConfigHold), "LoadXml", 0, typeof(System.Object));
		...
		public static RMethod RParseKeyValue_XmlNode
		{
			get
			{
				...
				{
					r_RParseKeyValue_XmlNode = new(typeof(CareerPropConfigHold), "ParseKeyValue", 0, typeof(System.Xml.XmlNode));
        ...
        public RCareerPropConfigHold() : base("CareerPropConfigHold")
        {
        }

        public RCareerPropConfigHold(System.Object instance) : base("CareerPropConfigHold")
		{
            SetInstance(instance);
		}

        public RCareerPropConfigHold(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCareerPropConfigHold(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

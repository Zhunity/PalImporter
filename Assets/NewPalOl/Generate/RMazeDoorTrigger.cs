...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MazeDoorTrigger
	/// </summary>
    public partial class RMazeDoorTrigger : RMember //
    {
		...
		/// <summary>
		/// System.String TargetObjName
		/// </summary>
		protected RField r_TargetObjName;
		public virtual RField RTargetObjName
		{
			get
			{
				if(r_TargetObjName == null)
				{
					r_TargetObjName = new(this, "TargetObjName");
					r_TargetObjName.SetBelong(this.instance);
				}
				return r_TargetObjName;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator WaitForCameraFade(Single)
		/// </summary>
		protected RMethod r_RWaitForCameraFade_Single;
		public virtual RMethod RWaitForCameraFade_Single
		{
			get
			{
				if(r_RWaitForCameraFade_Single == null)
				{
					r_RWaitForCameraFade_Single = new(this, "WaitForCameraFade", 0, typeof(System.Single));
					r_RWaitForCameraFade_Single.SetBelong(this.instance);
				}
				return r_RWaitForCameraFade_Single;
			}
		}
        ...
        public RMazeDoorTrigger() : base("MazeDoorTrigger")
        {
        }

        public RMazeDoorTrigger(System.Object instance) : base("MazeDoorTrigger")
		{
            SetInstance(instance);
		}

        public RMazeDoorTrigger(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMazeDoorTrigger(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Collections.IEnumerator WaitForCameraFade(System.Single  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time};
            var ___result = RWaitForCameraFade_Single.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// FPSCounter
	/// </summary>
    public partial class RFPSCounter : RMember //
    {

		/// <summary>
		/// System.Single updateInterval
		/// </summary>
		protected RField r_updateInterval;
		public virtual RField RupdateInterval
		{
			get
			{
				if(r_updateInterval == null)
				{
					r_updateInterval = new(this, "updateInterval");
					r_updateInterval.SetBelong(this.instance);
				}
				return r_updateInterval;
			}
		}
		...
		/// System.Single accum
		/// </summary>
		protected RField r_accum;
		public virtual RField Raccum
		{
			get
			{
				if(r_accum == null)
				{
					r_accum = new(this, "accum");
					r_accum.SetBelong(this.instance);
				}
				return r_accum;
			}
		}
		...
		/// </summary>
		protected RField r_timeleft;
		public virtual RField Rtimeleft
		{
			get
			{
				if(r_timeleft == null)
				{
					r_timeleft = new(this, "timeleft");
					r_timeleft.SetBelong(this.instance);
				}
				return r_timeleft;
			}
		}
		...
		/// System.Single fps
		/// </summary>
		protected RField r_fps;
		public virtual RField Rfps
		{
			get
			{
				if(r_fps == null)
		...
		/// <summary>
		/// System.Single lastSample
		/// </summary>
		protected RField r_lastSample;
		public virtual RField RlastSample
		{
			get
			{
				if(r_lastSample == null)
				{
					r_lastSample = new(this, "lastSample");
					r_lastSample.SetBelong(this.instance);
				}
				return r_lastSample;
			}
		}
		...
		/// <summary>
		/// System.Single gotIntervals
		/// </summary>
		protected RField r_gotIntervals;
		public virtual RField RgotIntervals
		{
			get
			{
				if(r_gotIntervals == null)
				{
					r_gotIntervals = new(this, "gotIntervals");
					r_gotIntervals.SetBelong(this.instance);
				}
				return r_gotIntervals;
			}
		}

		/// <summary>
		/// System.Boolean showFPS
		/// </summary>
		protected RField r_showFPS;
		public virtual RField RshowFPS
		{
			get
			{
				if(r_showFPS == null)
				{
					r_showFPS = new(this, "showFPS");
					r_showFPS.SetBelong(this.instance);
				}
				return r_showFPS;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Transform mplayer
		/// </summary>
		protected RUnityEngine.RTransform r_mplayer;
		public virtual RUnityEngine.RTransform Rmplayer
		{
			get
			{
				if(r_mplayer == null)
				{
					r_mplayer = new(this, "mplayer");
					r_mplayer.SetBelong(this.instance);
				}
				return r_mplayer;
			}
		}
		...
		/// <summary>
		/// System.Boolean debugLock
		/// </summary>
		protected RField r_debugLock;
		public virtual RField RdebugLock
		{
			get
			{
				if(r_debugLock == null)
				{
					r_debugLock = new(this, "debugLock");
					r_debugLock.SetBelong(this.instance);
				}
				return r_debugLock;
			}
		}
		...
		/// Single GetFPS()
		/// </summary>
		protected RMethod r_RGetFPS;
		public virtual RMethod RGetFPS
		{
			get
			{
				if(r_RGetFPS == null)
				{
					r_RGetFPS = new(this, "GetFPS", 0);
					r_RGetFPS.SetBelong(this.instance);
				}
				return r_RGetFPS;
			}
		}
		...
		/// Boolean HasFPS()
		/// </summary>
		protected RMethod r_RHasFPS;
		public virtual RMethod RHasFPS
		{
			get
			{
				if(r_RHasFPS == null)
				{
					r_RHasFPS = new(this, "HasFPS", 0);
					r_RHasFPS.SetBelong(this.instance);
				}
				return r_RHasFPS;
			}
		}
		...
		/// Void FakeFps(Single)
		/// </summary>
		protected RMethod r_RFakeFps_Single;
		public virtual RMethod RFakeFps_Single
		{
			get
			{
				if(r_RFakeFps_Single == null)
				{
					r_RFakeFps_Single = new(this, "FakeFps", 0, typeof(System.Single));
					r_RFakeFps_Single.SetBelong(this.instance);
				}
				return r_RFakeFps_Single;
			}
		}
        ...
        public RFPSCounter() : base("FPSCounter")
        {
        }

        public RFPSCounter(System.Object instance) : base("FPSCounter")
		{
            SetInstance(instance);
		}

        public RFPSCounter(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RFPSCounter(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Single GetFPS()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RGetFPS.Invoke(___genericsType, ___parameters);

            return (System.Single)___result;
        }


        public virtual System.Boolean HasFPS()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RHasFPS.Invoke(___genericsType, ___parameters);
        ...
        public virtual void FakeFps(System.Single  @fake)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@fake};
            var ___result = RFakeFps_Single.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// Audio
	/// </summary>
    public partial class RAudio : RMember //
    {

		/// <summary>
		/// System.Single minDistance
		/// </summary>
		protected static RField r_minDistance;
		public static RField RminDistance
		{
			get
			{
				if(r_minDistance == null)
				{
					r_minDistance = new( ReleactionUtils.GetType("Audio"), "minDistance");
					r_minDistance.SetBelong(null);
				}
		...
		/// </summary>
		protected static RField r_maxDistance;
		public static RField RmaxDistance
		{
			get
			{
				if(r_maxDistance == null)
				{
					r_maxDistance = new( ReleactionUtils.GetType("Audio"), "maxDistance");
					r_maxDistance.SetBelong(null);
				}
		...
		/// </summary>
		protected RUnityEngine.RTransform r_audioListener;
		public virtual RUnityEngine.RTransform RaudioListener
		{
			get
			{
				if(r_audioListener == null)
				{
					r_audioListener = new(this, "audioListener");
					r_audioListener.SetBelong(this.instance);
				}
				return r_audioListener;
			}
		}
		...
		/// </summary>
		protected RField r_minVolume;
		public virtual RField RminVolume
		{
			get
			{
				if(r_minVolume == null)
				{
					r_minVolume = new(this, "minVolume");
		...
		/// </summary>
		protected RField r_maxVolume;
		public virtual RField RmaxVolume
		{
			get
			{
				if(r_maxVolume == null)
				{
					r_maxVolume = new(this, "maxVolume");
		...
		/// <summary>
		/// System.Single rolloffThreshold
		/// </summary>
		protected RField r_rolloffThreshold;
		public virtual RField RrolloffThreshold
		{
			get
			{
				if(r_rolloffThreshold == null)
				{
					r_rolloffThreshold = new(this, "rolloffThreshold");
					r_rolloffThreshold.SetBelong(this.instance);
				}
				return r_rolloffThreshold;
			}
		}

		/// <summary>
		/// System.Boolean ignoreDistance
		/// </summary>
		protected RField r_ignoreDistance;
		public virtual RField RignoreDistance
		{
			get
			{
				if(r_ignoreDistance == null)
				{
					r_ignoreDistance = new(this, "ignoreDistance");
					r_ignoreDistance.SetBelong(this.instance);
				}
				return r_ignoreDistance;
			}
		}
		...
		/// </summary>
		protected RField r_loudness;
		public virtual RField Rloudness
		{
			get
			{
				if(r_loudness == null)
				{
					r_loudness = new(this, "loudness");
					r_loudness.SetBelong(this.instance);
				}
				return r_loudness;
			}
		}
		...
		/// <summary>
		/// System.Single minLoudness
		/// </summary>
		protected RField r_minLoudness;
		public virtual RField RminLoudness
		{
			get
			{
				if(r_minLoudness == null)
				{
					r_minLoudness = new(this, "minLoudness");
					r_minLoudness.SetBelong(this.instance);
				}
				return r_minLoudness;
			}
		}

		/// <summary>
		/// System.Single maxLoudness
		/// </summary>
		protected RField r_maxLoudness;
		public virtual RField RmaxLoudness
		{
			get
			{
				if(r_maxLoudness == null)
				{
					r_maxLoudness = new(this, "maxLoudness");
					r_maxLoudness.SetBelong(this.instance);
				}
				return r_maxLoudness;
			}
		}

		/// <summary>
		/// System.Single loudnessExponent
		/// </summary>
		protected RField r_loudnessExponent;
		public virtual RField RloudnessExponent
		{
			get
			{
				if(r_loudnessExponent == null)
				{
					r_loudnessExponent = new(this, "loudnessExponent");
					r_loudnessExponent.SetBelong(this.instance);
				}
				return r_loudnessExponent;
			}
		}

		/// <summary>
		/// System.Single rolloffExponent
		/// </summary>
		protected RField r_rolloffExponent;
		public virtual RField RrolloffExponent
		{
			get
			{
				if(r_rolloffExponent == null)
				{
					r_rolloffExponent = new(this, "rolloffExponent");
					r_rolloffExponent.SetBelong(this.instance);
				}
				return r_rolloffExponent;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RTransform r_thisTransform;
		public virtual RUnityEngine.RTransform RthisTransform
		{
			get
			{
				if(r_thisTransform == null)
				{
					r_thisTransform = new(this, "thisTransform");
					r_thisTransform.SetBelong(this.instance);
				}
				return r_thisTransform;
			}
		}
		...
		public virtual RProperty RolloffFactor
		{
			get
			{
				if(r_RolloffFactor == null)
		...
		/// <summary>
		/// Single RolloffThreshold
		/// </summary>
		protected RProperty r_RolloffThreshold_Single;
		public virtual RProperty RolloffThreshold_Single
		{
			get
			{
				if(r_RolloffThreshold_Single == null)
				{
					r_RolloffThreshold_Single = new(this, "RolloffThreshold", -1, typeof(System.Single));
					r_RolloffThreshold_Single.SetBelong(this.instance);
				}
				return r_RolloffThreshold_Single;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator RefreshProperties()
		/// </summary>
		protected RMethod r_RRefreshProperties;
		public virtual RMethod RRefreshProperties
		{
			get
			{
				if(r_RRefreshProperties == null)
				{
					r_RRefreshProperties = new(this, "RefreshProperties", 0);
					r_RRefreshProperties.SetBelong(this.instance);
				}
				return r_RRefreshProperties;
			}
		}
		...
		/// Single CalVolume()
		/// </summary>
		protected RMethod r_RCalVolume;
		public virtual RMethod RCalVolume
		{
			get
			{
				if(r_RCalVolume == null)
				{
					r_RCalVolume = new(this, "CalVolume", 0);
					r_RCalVolume.SetBelong(this.instance);
				}
				return r_RCalVolume;
			}
		}
        ...
        public RAudio() : base("Audio")
        {
        }

        public RAudio(System.Object instance) : base("Audio")
		{
            SetInstance(instance);
		}

        public RAudio(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAudio(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Collections.IEnumerator RefreshProperties()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RRefreshProperties.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual System.Single CalVolume()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RCalVolume.Invoke(___genericsType, ___parameters);

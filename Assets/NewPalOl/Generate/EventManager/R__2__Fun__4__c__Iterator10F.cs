...
{public partial class REventManager
{
	
	/// <summary>
	/// EventManager+<Fun>c__Iterator10F
	/// </summary>
    public partial class R__2__Fun__4__c__Iterator10F : RMember //
    {
		...
		/// EventHandler obj
		/// </summary>
		protected REventHandler r_obj;
		public virtual REventHandler Robj
		{
			get
			{
				if(r_obj == null)
		...
		/// System.EventArgs e
		/// </summary>
		protected RSystem.REventArgs r_e;
		public virtual RSystem.REventArgs Re
		{
			get
			{
				if(r_e == null)
		...
		/// EventHandler <$>obj
		/// </summary>
		protected REventHandler r___2____9____4__obj;
		public virtual REventHandler R__2____9____4__obj
		{
			get
			{
				if(r___2____9____4__obj == null)
				{
					r___2____9____4__obj = new(this, "<$>obj");
					r___2____9____4__obj.SetBelong(this.instance);
				}
				return r___2____9____4__obj;
			}
		}
		...
		/// System.Object <$>sender
		/// </summary>
		protected RSystem.RObject r___2____9____4__sender;
		public virtual RSystem.RObject R__2____9____4__sender
		{
			get
			{
				if(r___2____9____4__sender == null)
				{
					r___2____9____4__sender = new(this, "<$>sender");
					r___2____9____4__sender.SetBelong(this.instance);
				}
				return r___2____9____4__sender;
			}
		}
		...
		/// System.EventArgs <$>e
		/// </summary>
		protected RSystem.REventArgs r___2____9____4__e;
		public virtual RSystem.REventArgs R__2____9____4__e
		{
			get
			{
				if(r___2____9____4__e == null)
				{
					r___2____9____4__e = new(this, "<$>e");
					r___2____9____4__e.SetBelong(this.instance);
				}
				return r___2____9____4__e;
			}
		}
        ...
        public R__2__Fun__4__c__Iterator10F() : base("EventManager+<Fun>c__Iterator10F")
        {
        }

        public R__2__Fun__4__c__Iterator10F(System.Object instance) : base("EventManager+<Fun>c__Iterator10F")
		{
            SetInstance(instance);
		}

        public R__2__Fun__4__c__Iterator10F(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__Fun__4__c__Iterator10F(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

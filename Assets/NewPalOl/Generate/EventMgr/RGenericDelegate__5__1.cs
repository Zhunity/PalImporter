...
{public partial class REventMgr
{
	...
	/// <summary>
	/// EventMgr+GenericDelegate`1
	/// </summary>
    public partial class RGenericDelegate<T> : RMember // where T : EventMessage
    {
        ...
        public RGenericDelegate() : base("EventMgr+GenericDelegate`1")
        {
        }

        public RGenericDelegate(System.Object instance) : base("EventMgr+GenericDelegate`1")
		{
            SetInstance(instance);
		}

        public RGenericDelegate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RGenericDelegate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

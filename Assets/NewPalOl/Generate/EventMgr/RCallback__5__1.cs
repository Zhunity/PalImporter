...
{public partial class REventMgr
{
	...
	/// EventMgr+Callback`1
	/// </summary>
    public partial class RCallback<T> : RMember // where T : EventMessage
    {

		/// <summary>
		/// EventMgr+GenericDelegate`1[T] func
		/// </summary>
		protected REventMgr.RGenericDelegate<RField> r_func;
		public virtual REventMgr.RGenericDelegate<RField> Rfunc
		{
			get
			{
				if(r_func == null)
        ...
        public RCallback() : base("EventMgr+Callback`1")
        {
        }

        public RCallback(System.Object instance) : base("EventMgr+Callback`1")
		{
            SetInstance(instance);
		}

        public RCallback(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCallback(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

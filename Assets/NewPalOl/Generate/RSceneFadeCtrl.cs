...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SceneFadeCtrl
	/// </summary>
    public partial class RSceneFadeCtrl : RMember //
    {
		...
		/// <summary>
		/// System.Single TIME_FADE_PLAY
		/// </summary>
		protected RField r_TIME_FADE_PLAY;
		public virtual RField RTIME_FADE_PLAY
		{
			get
			{
				if(r_TIME_FADE_PLAY == null)
				{
					r_TIME_FADE_PLAY = new(this, "TIME_FADE_PLAY");
					r_TIME_FADE_PLAY.SetBelong(this.instance);
				}
				return r_TIME_FADE_PLAY;
			}
		}
		...
		/// Void UpdateFade()
		/// </summary>
		protected RMethod r_RUpdateFade;
		public virtual RMethod RUpdateFade
		{
			get
			{
				if(r_RUpdateFade == null)
				{
					r_RUpdateFade = new(this, "UpdateFade", 0);
					r_RUpdateFade.SetBelong(this.instance);
				}
				return r_RUpdateFade;
			}
		}
		...
		/// Void FadeOut(Single)
		/// </summary>
		protected RMethod r_RFadeOut_Single;
		public virtual RMethod RFadeOut_Single
		{
			get
			{
				if(r_RFadeOut_Single == null)
				{
					r_RFadeOut_Single = new(this, "FadeOut", 0, typeof(System.Single));
					r_RFadeOut_Single.SetBelong(this.instance);
				}
				return r_RFadeOut_Single;
			}
		}
        ...
        public RSceneFadeCtrl() : base("SceneFadeCtrl")
        {
        }

        public RSceneFadeCtrl(System.Object instance) : base("SceneFadeCtrl")
		{
            SetInstance(instance);
		}

        public RSceneFadeCtrl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSceneFadeCtrl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void UpdateFade()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RUpdateFade.Invoke(___genericsType, ___parameters);
        ...
        public virtual void FadeOut(System.Single  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time};
            var ___result = RFadeOut_Single.Invoke(___genericsType, ___parameters);

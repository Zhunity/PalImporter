...
namespace SMFrame.Editor.Refleaction
{
	...
	/// RainManager
	/// </summary>
    public partial class RRainManager : RMember //
    {

		/// <summary>
		/// System.Single minYPosition
		/// </summary>
		protected RField r_minYPosition;
		public virtual RField RminYPosition
		{
			get
			{
				if(r_minYPosition == null)
				{
					r_minYPosition = new(this, "minYPosition");
					r_minYPosition.SetBelong(this.instance);
				}
				return r_minYPosition;
			}
		}

		/// <summary>
		/// System.Int32 numberOfParticles
		/// </summary>
		protected RField r_numberOfParticles;
		public virtual RField RnumberOfParticles
		{
			get
			{
				if(r_numberOfParticles == null)
				{
					r_numberOfParticles = new(this, "numberOfParticles");
					r_numberOfParticles.SetBelong(this.instance);
				}
				return r_numberOfParticles;
			}
		}

		/// <summary>
		/// System.Single areaSize
		/// </summary>
		protected RField r_areaSize;
		public virtual RField RareaSize
		{
			get
			{
				if(r_areaSize == null)
				{
					r_areaSize = new(this, "areaSize");
		...
		/// <summary>
		/// System.Single areaHeight
		/// </summary>
		protected RField r_areaHeight;
		public virtual RField RareaHeight
		{
			get
			{
				if(r_areaHeight == null)
				{
					r_areaHeight = new(this, "areaHeight");
					r_areaHeight.SetBelong(this.instance);
				}
				return r_areaHeight;
			}
		}
		...
		/// <summary>
		/// System.Single fallingSpeed
		/// </summary>
		protected RField r_fallingSpeed;
		public virtual RField RfallingSpeed
		{
			get
			{
				if(r_fallingSpeed == null)
				{
					r_fallingSpeed = new(this, "fallingSpeed");
					r_fallingSpeed.SetBelong(this.instance);
				}
				return r_fallingSpeed;
			}
		}

		/// <summary>
		/// System.Single particleSize
		/// </summary>
		protected RField r_particleSize;
		public virtual RField RparticleSize
		{
			get
			{
				if(r_particleSize == null)
				{
					r_particleSize = new(this, "particleSize");
					r_particleSize.SetBelong(this.instance);
				}
				return r_particleSize;
			}
		}

		/// <summary>
		/// System.Single flakeRandom
		/// </summary>
		protected RField r_flakeRandom;
		public virtual RField RflakeRandom
		{
			get
			{
				if(r_flakeRandom == null)
				{
					r_flakeRandom = new(this, "flakeRandom");
					r_flakeRandom.SetBelong(this.instance);
				}
				return r_flakeRandom;
			}
		}

		/// <summary>
		/// UnityEngine.Mesh[] preGennedMeshes
		/// </summary>
		protected RFieldArray<RUnityEngine.RMesh> r_preGennedMeshes;
		public virtual RFieldArray<RUnityEngine.RMesh> RpreGennedMeshes
		{
			get
			{
				if(r_preGennedMeshes == null)
				{
					r_preGennedMeshes = new(this, "preGennedMeshes");
					r_preGennedMeshes.SetBelong(this.instance);
				}
				return r_preGennedMeshes;
			}
		}

		/// <summary>
		/// System.Int32 preGennedIndex
		/// </summary>
		protected RField r_preGennedIndex;
		public virtual RField RpreGennedIndex
		{
			get
			{
				if(r_preGennedIndex == null)
				{
					r_preGennedIndex = new(this, "preGennedIndex");
					r_preGennedIndex.SetBelong(this.instance);
				}
				return r_preGennedIndex;
			}
		}

		/// <summary>
		/// System.Boolean generateNewAssetsOnStart
		/// </summary>
		protected RField r_generateNewAssetsOnStart;
		public virtual RField RgenerateNewAssetsOnStart
		{
			get
			{
				if(r_generateNewAssetsOnStart == null)
				{
					r_generateNewAssetsOnStart = new(this, "generateNewAssetsOnStart");
					r_generateNewAssetsOnStart.SetBelong(this.instance);
				}
				return r_generateNewAssetsOnStart;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Mesh GetPreGennedMesh()
		/// </summary>
		protected RMethod r_RGetPreGennedMesh;
		public virtual RMethod RGetPreGennedMesh
		{
			get
			{
				if(r_RGetPreGennedMesh == null)
				{
					r_RGetPreGennedMesh = new(this, "GetPreGennedMesh", 0);
					r_RGetPreGennedMesh.SetBelong(this.instance);
				}
				return r_RGetPreGennedMesh;
			}
		}
		...
		/// </summary>
		protected RMethod r_RCreateMesh;
		public virtual RMethod RCreateMesh
		{
			get
			{
				if(r_RCreateMesh == null)
				{
					r_RCreateMesh = new(this, "CreateMesh", 0);
					r_RCreateMesh.SetBelong(this.instance);
				}
				return r_RCreateMesh;
			}
		}
        ...
        public RRainManager() : base("RainManager")
        {
        }

        public RRainManager(System.Object instance) : base("RainManager")
		{
            SetInstance(instance);
		}

        public RRainManager(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RRainManager(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual UnityEngine.Mesh GetPreGennedMesh()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RGetPreGennedMesh.Invoke(___genericsType, ___parameters);

            return (UnityEngine.Mesh)___result;
        }


        public virtual UnityEngine.Mesh CreateMesh()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RCreateMesh.Invoke(___genericsType, ___parameters);

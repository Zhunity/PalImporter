...
{public partial class RSocket
{
	...
	/// </summary>
    public partial class RTaskSocketAsyncEventArgs<TResult> : RMember //
    {
		...
		/// <summary>
		/// System.Runtime.CompilerServices.AsyncTaskMethodBuilder`1[TResult] GetCompletionResponsibility(Boolean ByRef)
		/// </summary>
        ...
        public RTaskSocketAsyncEventArgs() : base("System.Net.Sockets.Socket+TaskSocketAsyncEventArgs`1")
        {
        }

        public RTaskSocketAsyncEventArgs(System.Object instance) : base("System.Net.Sockets.Socket+TaskSocketAsyncEventArgs`1")
		{
            SetInstance(instance);
		}

        public RTaskSocketAsyncEventArgs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RTaskSocketAsyncEventArgs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Runtime.CompilerServices.AsyncTaskMethodBuilder<TResult> GetCompletionResponsibility(out System.Boolean  @responsibleForReturningToPool)
        {

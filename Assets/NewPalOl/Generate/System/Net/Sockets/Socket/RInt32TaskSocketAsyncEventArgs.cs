...
{public partial class RSocket
{
	...
	/// </summary>
    public partial class RInt32TaskSocketAsyncEventArgs : RMember //
    {

		/// <summary>
		/// System.Boolean _wrapExceptionsInIOExceptions
		/// </summary>
		protected RField r__wrapExceptionsInIOExceptions;
		public virtual RField R_wrapExceptionsInIOExceptions
		{
			get
			{
				if(r__wrapExceptionsInIOExceptions == null)
				{
					r__wrapExceptionsInIOExceptions = new(this, "_wrapExceptionsInIOExceptions");
					r__wrapExceptionsInIOExceptions.SetBelong(this.instance);
				}
				return r__wrapExceptionsInIOExceptions;
			}
		}

		/// <summary>
		/// System.Runtime.CompilerServices.AsyncTaskMethodBuilder`1[System.Int32] _builder
		/// </summary>
		protected RSystem.RRuntime.RCompilerServices.RAsyncTaskMethodBuilder<RField> r__builder;
		public virtual RSystem.RRuntime.RCompilerServices.RAsyncTaskMethodBuilder<RField> R_builder
		{
			get
			{
				if(r__builder == null)
				{
					r__builder = new(this, "_builder");
					r__builder.SetBelong(this.instance);
				}
				return r__builder;
			}
		}
		...
		/// </summary>
		protected RField r__accessed;
		public virtual RField R_accessed
		{
			get
			{
				if(r__accessed == null)
				{
					r__accessed = new(this, "_accessed");
					r__accessed.SetBelong(this.instance);
				}
				return r__accessed;
			}
		}
		...
		/// <summary>
		/// System.Runtime.CompilerServices.AsyncTaskMethodBuilder`1[System.Int32] GetCompletionResponsibility(Boolean ByRef)
		/// </summary>
		protected RMethod r_RGetCompletionResponsibility_Out_Boolean;
		public virtual RMethod RGetCompletionResponsibility_Out_Boolean
		{
			get
			{
				if(r_RGetCompletionResponsibility_Out_Boolean == null)
				{
					r_RGetCompletionResponsibility_Out_Boolean = new(this, "GetCompletionResponsibility", 0, typeof(System.Boolean).MakeByRefType());
					r_RGetCompletionResponsibility_Out_Boolean.SetBelong(this.instance);
				}
				return r_RGetCompletionResponsibility_Out_Boolean;
			}
		}
        ...
        public RInt32TaskSocketAsyncEventArgs() : base("System.Net.Sockets.Socket+Int32TaskSocketAsyncEventArgs")
        {
        }

        public RInt32TaskSocketAsyncEventArgs(System.Object instance) : base("System.Net.Sockets.Socket+Int32TaskSocketAsyncEventArgs")
		{
            SetInstance(instance);
		}

        public RInt32TaskSocketAsyncEventArgs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RInt32TaskSocketAsyncEventArgs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Runtime.CompilerServices.AsyncTaskMethodBuilder<System.Int32> GetCompletionResponsibility(out System.Boolean  @responsibleForReturningToPool)
        {
			responsibleForReturningToPool = default;

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@responsibleForReturningToPool};
            var ___result = RGetCompletionResponsibility_Out_Boolean.Invoke(___genericsType, ___parameters);
			responsibleForReturningToPool = (System.Boolean)___parameters[0];

            return (System.Runtime.CompilerServices.AsyncTaskMethodBuilder<System.Int32>)___result;
        }

...
namespace SMFrame.Editor.Refleaction.RSystem.RNet.RSockets
{
	...
	/// </summary>
    public partial class RSocketReceiveFromResult : RMember //
    {
        ...
        public RSocketReceiveFromResult() : base("System.Net.Sockets.SocketReceiveFromResult")
        {
        }

        public RSocketReceiveFromResult(System.Object instance) : base("System.Net.Sockets.SocketReceiveFromResult")
		{
            SetInstance(instance);
		}

        public RSocketReceiveFromResult(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSocketReceiveFromResult(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

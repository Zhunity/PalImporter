...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection
{
    ...
    public partial class RCustomAttributeTypedArgument : RMember //
    {
		...
		/// </summary>
		protected RSystem.RType r___2__ArgumentType__4__k__BackingField;
		public virtual RSystem.RType R__2__ArgumentType__4__k__BackingField
		{
			get
			{
				if(r___2__ArgumentType__4__k__BackingField == null)
				{
					r___2__ArgumentType__4__k__BackingField = new(this, "<ArgumentType>k__BackingField");
					r___2__ArgumentType__4__k__BackingField.SetBelong(this.instance);
				}
				return r___2__ArgumentType__4__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RSystem.RObject r___2__Value__4__k__BackingField;
		public virtual RSystem.RObject R__2__Value__4__k__BackingField
		{
			get
			{
				if(r___2__Value__4__k__BackingField == null)
				{
					r___2__Value__4__k__BackingField = new(this, "<Value>k__BackingField");
					r___2__Value__4__k__BackingField.SetBelong(this.instance);
				}
				return r___2__Value__4__k__BackingField;
			}
		}

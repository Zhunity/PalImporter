...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection
{
    ...
    public partial class RManifestResourceInfo : RMember //
    {
		...
		/// </summary>
		protected RSystem.RReflection.RAssembly r___2__ReferencedAssembly__4__k__BackingField;
		public virtual RSystem.RReflection.RAssembly R__2__ReferencedAssembly__4__k__BackingField
		{
			get
			{
				if(r___2__ReferencedAssembly__4__k__BackingField == null)
				{
					r___2__ReferencedAssembly__4__k__BackingField = new(this, "<ReferencedAssembly>k__BackingField");
					r___2__ReferencedAssembly__4__k__BackingField.SetBelong(this.instance);
				}
				return r___2__ReferencedAssembly__4__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RField r___2__FileName__4__k__BackingField;
		public virtual RField R__2__FileName__4__k__BackingField
		{
			get
			{
				if(r___2__FileName__4__k__BackingField == null)
				{
					r___2__FileName__4__k__BackingField = new(this, "<FileName>k__BackingField");
					r___2__FileName__4__k__BackingField.SetBelong(this.instance);
				}
				return r___2__FileName__4__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RField r___2__ResourceLocation__4__k__BackingField;
		public virtual RField R__2__ResourceLocation__4__k__BackingField
		{
			get
			{
				if(r___2__ResourceLocation__4__k__BackingField == null)
				{
					r___2__ResourceLocation__4__k__BackingField = new(this, "<ResourceLocation>k__BackingField");
					r___2__ResourceLocation__4__k__BackingField.SetBelong(this.instance);
				}
				return r___2__ResourceLocation__4__k__BackingField;
			}
		}

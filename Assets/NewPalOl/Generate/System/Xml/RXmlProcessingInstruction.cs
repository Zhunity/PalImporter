...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class RXmlProcessingInstruction : RMember //
    {
        ...
        public RXmlProcessingInstruction() : base("System.Xml.XmlProcessingInstruction")
        {
        }

        public RXmlProcessingInstruction(System.Object instance) : base("System.Xml.XmlProcessingInstruction")
		{
            SetInstance(instance);
		}

        public RXmlProcessingInstruction(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlProcessingInstruction(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class RBinHexDecoder : RMember //
    {
		...
		/// <summary>
		/// System.Boolean hasHalfByteCached
		/// </summary>
		protected RField r_hasHalfByteCached;
		public virtual RField RhasHalfByteCached
		{
			get
			{
				if(r_hasHalfByteCached == null)
				{
					r_hasHalfByteCached = new(this, "hasHalfByteCached");
					r_hasHalfByteCached.SetBelong(this.instance);
				}
				return r_hasHalfByteCached;
			}
		}

		/// <summary>
		/// System.Byte cachedHalfByte
		/// </summary>
		protected RField r_cachedHalfByte;
		public virtual RField RcachedHalfByte
		{
			get
			{
				if(r_cachedHalfByte == null)
				{
					r_cachedHalfByte = new(this, "cachedHalfByte");
					r_cachedHalfByte.SetBelong(this.instance);
				}
				return r_cachedHalfByte;
			}
		}
		...
		/// <summary>
		/// Byte[] Decode(Char[], Boolean)
		/// </summary>
		protected static RMethod r_RDecode_CharArray_Boolean;
		public static RMethod RDecode_CharArray_Boolean
		{
			get
			{
				if(r_RDecode_CharArray_Boolean == null)
				{
					r_RDecode_CharArray_Boolean = new( ReleactionUtils.GetType("System.Xml.BinHexDecoder"), "Decode", 0, typeof(System.Char).MakeArrayType(), typeof(System.Boolean));
					r_RDecode_CharArray_Boolean.SetBelong(null);
				}
				return r_RDecode_CharArray_Boolean;
			}
		}

		/// <summary>
		/// Void Decode(Char*, Char*, Byte*, Byte*, Boolean ByRef, Byte ByRef, Int32 ByRef, Int32 ByRef)
		/// </summary>
		protected static RMethod r_RDecode_CharPointer_CharPointer_BytePointer_BytePointer_Ref_Boolean_Ref_Byte_Out_Int32_Out_Int32;
		public static RMethod RDecode_CharPointer_CharPointer_BytePointer_BytePointer_Ref_Boolean_Ref_Byte_Out_Int32_Out_Int32
		{
			get
			{
				if(r_RDecode_CharPointer_CharPointer_BytePointer_BytePointer_Ref_Boolean_Ref_Byte_Out_Int32_Out_Int32 == null)
				{
					r_RDecode_CharPointer_CharPointer_BytePointer_BytePointer_Ref_Boolean_Ref_Byte_Out_Int32_Out_Int32 = new( ReleactionUtils.GetType("System.Xml.BinHexDecoder"), "Decode", 0, typeof(System.Char).MakePointerType(), typeof(System.Char).MakePointerType(), typeof(System.Byte).MakePointerType(), typeof(System.Byte).MakePointerType(), typeof(System.Boolean).MakeByRefType(), typeof(System.Byte).MakeByRefType(), typeof(System.Int32).MakeByRefType(), typeof(System.Int32).MakeByRefType());
					r_RDecode_CharPointer_CharPointer_BytePointer_BytePointer_Ref_Boolean_Ref_Byte_Out_Int32_Out_Int32.SetBelong(null);
				}
				return r_RDecode_CharPointer_CharPointer_BytePointer_BytePointer_Ref_Boolean_Ref_Byte_Out_Int32_Out_Int32;
			}
		}
        ...
        public RBinHexDecoder() : base("System.Xml.BinHexDecoder")
        {
        }

        public RBinHexDecoder(System.Object instance) : base("System.Xml.BinHexDecoder")
		{
            SetInstance(instance);
		}

        public RBinHexDecoder(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBinHexDecoder(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public static System.Byte[] Decode(System.Char[]  @chars, System.Boolean  @allowOddChars)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@chars, @allowOddChars};
            var ___result = RDecode_CharArray_Boolean.Invoke(___genericsType, ___parameters);

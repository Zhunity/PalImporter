...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class RXmlLinkedNode : RMember //
    {
        ...
        public RXmlLinkedNode() : base("System.Xml.XmlLinkedNode")
        {
        }

        public RXmlLinkedNode(System.Object instance) : base("System.Xml.XmlLinkedNode")
		{
            SetInstance(instance);
		}

        public RXmlLinkedNode(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlLinkedNode(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

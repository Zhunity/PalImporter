...
{public partial class RXmlTextReaderImpl
{
	...
	/// </summary>
    public partial class ROnDefaultAttributeUseDelegate : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Xml.IDtdDefaultAttributeInfo, System.Xml.XmlTextReaderImpl)
		/// </summary>
		protected RMethod r_RInvoke_IDtdDefaultAttributeInfo_XmlTextReaderImpl;
		public virtual RMethod RInvoke_IDtdDefaultAttributeInfo_XmlTextReaderImpl
		{
			get
			{
				if(r_RInvoke_IDtdDefaultAttributeInfo_XmlTextReaderImpl == null)
				{
					r_RInvoke_IDtdDefaultAttributeInfo_XmlTextReaderImpl = new(this, "Invoke", 0,  ReleactionUtils.GetType("System.Xml.IDtdDefaultAttributeInfo"),  ReleactionUtils.GetType("System.Xml.XmlTextReaderImpl"));
					r_RInvoke_IDtdDefaultAttributeInfo_XmlTextReaderImpl.SetBelong(this.instance);
				}
				return r_RInvoke_IDtdDefaultAttributeInfo_XmlTextReaderImpl;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Xml.IDtdDefaultAttributeInfo, System.Xml.XmlTextReaderImpl, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_IDtdDefaultAttributeInfo_XmlTextReaderImpl_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_IDtdDefaultAttributeInfo_XmlTextReaderImpl_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_IDtdDefaultAttributeInfo_XmlTextReaderImpl_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_IDtdDefaultAttributeInfo_XmlTextReaderImpl_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("System.Xml.IDtdDefaultAttributeInfo"),  ReleactionUtils.GetType("System.Xml.XmlTextReaderImpl"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_IDtdDefaultAttributeInfo_XmlTextReaderImpl_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_IDtdDefaultAttributeInfo_XmlTextReaderImpl_AsyncCallback_Object;
			}
		}
        ...
        public ROnDefaultAttributeUseDelegate() : base("System.Xml.XmlTextReaderImpl+OnDefaultAttributeUseDelegate")
        {
        }

        public ROnDefaultAttributeUseDelegate(System.Object instance) : base("System.Xml.XmlTextReaderImpl+OnDefaultAttributeUseDelegate")
		{
            SetInstance(instance);
		}

        public ROnDefaultAttributeUseDelegate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public ROnDefaultAttributeUseDelegate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.RSystem.RXml.RSchema
{
	...
	/// </summary>
    public partial class RXmlSchemaObjectEnumerator : RMember //
    {

		/// <summary>
		/// System.Collections.IEnumerator enumerator
		/// </summary>
		protected RSystem.RCollections.RIEnumerator r_enumerator;
		public virtual RSystem.RCollections.RIEnumerator Renumerator
		{
			get
			{
		...
		/// <summary>
		/// System.Xml.Schema.XmlSchemaObject Current
		/// </summary>
		protected RSystem.RXml.RSchema.RXmlSchemaObject r_Current;
		public virtual RSystem.RXml.RSchema.RXmlSchemaObject RCurrent
		{
			get
			{
				if(r_Current == null)
        ...
        public RXmlSchemaObjectEnumerator() : base("System.Xml.Schema.XmlSchemaObjectEnumerator")
        {
        }

        public RXmlSchemaObjectEnumerator(System.Object instance) : base("System.Xml.Schema.XmlSchemaObjectEnumerator")
		{
            SetInstance(instance);
		}

        public RXmlSchemaObjectEnumerator(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlSchemaObjectEnumerator(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

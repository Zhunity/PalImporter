...
namespace SMFrame.Editor.Refleaction.RSystem.RXml.RSchema
{
	...
	/// </summary>
    public partial class RXmlSchemaObject : RMember //
    {
		...
		/// </summary>
		protected RField r_isProcessing;
		public virtual RField RisProcessing
		{
			get
			{
				if(r_isProcessing == null)
				{
					r_isProcessing = new(this, "isProcessing");
        ...
        public RXmlSchemaObject() : base("System.Xml.Schema.XmlSchemaObject")
        {
        }

        public RXmlSchemaObject(System.Object instance) : base("System.Xml.Schema.XmlSchemaObject")
		{
            SetInstance(instance);
		}

        public RXmlSchemaObject(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlSchemaObject(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.RSystem.RXml.RSchema
{
	...
	/// </summary>
    public partial class RXmlSchemaContentModel : RMember //
    {

		/// <summary>
		/// System.Xml.Schema.XmlSchemaContent Content
		/// </summary>
		protected RSystem.RXml.RSchema.RXmlSchemaContent r_Content;
		public virtual RSystem.RXml.RSchema.RXmlSchemaContent RContent
		{
			get
			{
				if(r_Content == null)
        ...
        public RXmlSchemaContentModel() : base("System.Xml.Schema.XmlSchemaContentModel")
        {
        }

        public RXmlSchemaContentModel(System.Object instance) : base("System.Xml.Schema.XmlSchemaContentModel")
		{
            SetInstance(instance);
		}

        public RXmlSchemaContentModel(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlSchemaContentModel(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

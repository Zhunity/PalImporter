...
namespace SMFrame.Editor.Refleaction.RSystem.RXml.RSchema
{
	...
	/// </summary>
    public partial class RXmlSchemaContent : RMember //
    {
        ...
        public RXmlSchemaContent() : base("System.Xml.Schema.XmlSchemaContent")
        {
        }

        public RXmlSchemaContent(System.Object instance) : base("System.Xml.Schema.XmlSchemaContent")
		{
            SetInstance(instance);
		}

        public RXmlSchemaContent(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlSchemaContent(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

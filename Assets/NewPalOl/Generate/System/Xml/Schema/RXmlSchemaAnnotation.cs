...
namespace SMFrame.Editor.Refleaction.RSystem.RXml.RSchema
{
	...
	/// </summary>
    public partial class RXmlSchemaAnnotation : RMember //
    {
        ...
        public RXmlSchemaAnnotation() : base("System.Xml.Schema.XmlSchemaAnnotation")
        {
        }

        public RXmlSchemaAnnotation(System.Object instance) : base("System.Xml.Schema.XmlSchemaAnnotation")
		{
            SetInstance(instance);
		}

        public RXmlSchemaAnnotation(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlSchemaAnnotation(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.RSystem.RXml.RSchema
{
	...
	/// </summary>
    public partial class RXmlSchemaSimpleType : RMember //
    {

		/// <summary>
		/// System.Xml.Schema.XmlSchemaSimpleTypeContent content
		/// </summary>
		protected RSystem.RXml.RSchema.RXmlSchemaSimpleTypeContent r_content;
		public virtual RSystem.RXml.RSchema.RXmlSchemaSimpleTypeContent Rcontent
		{
			get
			{
				if(r_content == null)
        ...
        public RXmlSchemaSimpleType() : base("System.Xml.Schema.XmlSchemaSimpleType")
        {
        }

        public RXmlSchemaSimpleType(System.Object instance) : base("System.Xml.Schema.XmlSchemaSimpleType")
		{
            SetInstance(instance);
		}

        public RXmlSchemaSimpleType(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlSchemaSimpleType(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

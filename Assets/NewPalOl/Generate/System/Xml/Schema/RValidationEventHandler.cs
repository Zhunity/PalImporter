...
namespace SMFrame.Editor.Refleaction.RSystem.RXml.RSchema
{
	...
	/// </summary>
    public partial class RValidationEventHandler : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_Object_ValidationEventArgs;
		public virtual RMethod RInvoke_Object_ValidationEventArgs
		{
			get
			{
				if(r_RInvoke_Object_ValidationEventArgs == null)
				{
					r_RInvoke_Object_ValidationEventArgs = new(this, "Invoke", 0, typeof(System.Object), typeof(System.Xml.Schema.ValidationEventArgs));
					r_RInvoke_Object_ValidationEventArgs.SetBelong(this.instance);
				}
				return r_RInvoke_Object_ValidationEventArgs;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_Object_ValidationEventArgs_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object_ValidationEventArgs_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object_ValidationEventArgs_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object_ValidationEventArgs_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object), typeof(System.Xml.Schema.ValidationEventArgs), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object_ValidationEventArgs_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object_ValidationEventArgs_AsyncCallback_Object;
			}
		}
        ...
        public RValidationEventHandler() : base("System.Xml.Schema.ValidationEventHandler")
        {
        }

        public RValidationEventHandler(System.Object instance) : base("System.Xml.Schema.ValidationEventHandler")
		{
            SetInstance(instance);
		}

        public RValidationEventHandler(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RValidationEventHandler(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Object  @sender, System.Xml.Schema.ValidationEventArgs  @e)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @e};
            var ___result = RInvoke_Object_ValidationEventArgs.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.Object  @sender, System.Xml.Schema.ValidationEventArgs  @e, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @e, @callback, @object};
            var ___result = RBeginInvoke_Object_ValidationEventArgs_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

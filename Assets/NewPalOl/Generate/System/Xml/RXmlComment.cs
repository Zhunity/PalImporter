...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class RXmlComment : RMember //
    {
        ...
        public RXmlComment() : base("System.Xml.XmlComment")
        {
        }

        public RXmlComment(System.Object instance) : base("System.Xml.XmlComment")
		{
            SetInstance(instance);
		}

        public RXmlComment(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlComment(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class RXmlNodeChangedEventHandler : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_Object_XmlNodeChangedEventArgs;
		public virtual RMethod RInvoke_Object_XmlNodeChangedEventArgs
		{
			get
			{
				if(r_RInvoke_Object_XmlNodeChangedEventArgs == null)
				{
					r_RInvoke_Object_XmlNodeChangedEventArgs = new(this, "Invoke", 0, typeof(System.Object), typeof(System.Xml.XmlNodeChangedEventArgs));
					r_RInvoke_Object_XmlNodeChangedEventArgs.SetBelong(this.instance);
				}
				return r_RInvoke_Object_XmlNodeChangedEventArgs;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_Object_XmlNodeChangedEventArgs_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object_XmlNodeChangedEventArgs_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object_XmlNodeChangedEventArgs_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object_XmlNodeChangedEventArgs_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object), typeof(System.Xml.XmlNodeChangedEventArgs), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object_XmlNodeChangedEventArgs_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object_XmlNodeChangedEventArgs_AsyncCallback_Object;
			}
		}
        ...
        public RXmlNodeChangedEventHandler() : base("System.Xml.XmlNodeChangedEventHandler")
        {
        }

        public RXmlNodeChangedEventHandler(System.Object instance) : base("System.Xml.XmlNodeChangedEventHandler")
		{
            SetInstance(instance);
		}

        public RXmlNodeChangedEventHandler(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlNodeChangedEventHandler(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Object  @sender, System.Xml.XmlNodeChangedEventArgs  @e)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @e};
            var ___result = RInvoke_Object_XmlNodeChangedEventArgs.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.Object  @sender, System.Xml.XmlNodeChangedEventArgs  @e, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @e, @callback, @object};
            var ___result = RBeginInvoke_Object_XmlNodeChangedEventArgs_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

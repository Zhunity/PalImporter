...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class RXmlSignificantWhitespace : RMember //
    {
        ...
        public RXmlSignificantWhitespace() : base("System.Xml.XmlSignificantWhitespace")
        {
        }

        public RXmlSignificantWhitespace(System.Object instance) : base("System.Xml.XmlSignificantWhitespace")
		{
            SetInstance(instance);
		}

        public RXmlSignificantWhitespace(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlSignificantWhitespace(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

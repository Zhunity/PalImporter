...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class RXmlDocumentType : RMember //
    {
		...
		/// </summary>
		protected RField r_internalSubset;
		public virtual RField RinternalSubset
		{
			get
			{
				if(r_internalSubset == null)
				{
					r_internalSubset = new(this, "internalSubset");
		...
		/// </summary>
		protected RSystem.RXml.RXmlNamedNodeMap r_notations;
		public virtual RSystem.RXml.RXmlNamedNodeMap Rnotations
		{
			get
			{
				if(r_notations == null)
		...
		/// <summary>
		/// Boolean ParseWithNamespaces
		/// </summary>
		protected RProperty r_ParseWithNamespaces;
		public virtual RProperty RParseWithNamespaces
		{
			get
			{
				if(r_ParseWithNamespaces == null)
				{
					r_ParseWithNamespaces = new(this, "ParseWithNamespaces", -1);
					r_ParseWithNamespaces.SetBelong(this.instance);
				}
				return r_ParseWithNamespaces;
			}
		}
        ...
        public RXmlDocumentType() : base("System.Xml.XmlDocumentType")
        {
        }

        public RXmlDocumentType(System.Object instance) : base("System.Xml.XmlDocumentType")
		{
            SetInstance(instance);
		}

        public RXmlDocumentType(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlDocumentType(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.RSystem.RXml.RXsl.RRuntime
{
	/// <summary>
	/// System.Xml.Xsl.Runtime.XmlQueryDataWriter
	/// </summary>
    public partial class RXmlQueryDataWriter : RMember //
    {
		...
		/// <summary>
		/// Void WriteInt32Encoded(Int32)
		/// </summary>
		protected RMethod r_RWriteInt32Encoded_Int32;
		public virtual RMethod RWriteInt32Encoded_Int32
		{
			get
			{
				if(r_RWriteInt32Encoded_Int32 == null)
				{
					r_RWriteInt32Encoded_Int32 = new(this, "WriteInt32Encoded", 0, typeof(System.Int32));
					r_RWriteInt32Encoded_Int32.SetBelong(this.instance);
				}
				return r_RWriteInt32Encoded_Int32;
			}
		}

		/// <summary>
		/// Void WriteStringQ(System.String)
		/// </summary>
		protected RMethod r_RWriteStringQ_String;
		public virtual RMethod RWriteStringQ_String
		{
			get
			{
				if(r_RWriteStringQ_String == null)
				{
					r_RWriteStringQ_String = new(this, "WriteStringQ", 0, typeof(System.String));
					r_RWriteStringQ_String.SetBelong(this.instance);
				}
				return r_RWriteStringQ_String;
			}
		}
        ...
        public RXmlQueryDataWriter() : base("System.Xml.Xsl.Runtime.XmlQueryDataWriter")
        {
        }

        public RXmlQueryDataWriter(System.Object instance) : base("System.Xml.Xsl.Runtime.XmlQueryDataWriter")
		{
            SetInstance(instance);
		}

        public RXmlQueryDataWriter(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlQueryDataWriter(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void WriteInt32Encoded(System.Int32  @value)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@value};
            var ___result = RWriteInt32Encoded_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void WriteStringQ(System.String  @value)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@value};
            var ___result = RWriteStringQ_String.Invoke(___genericsType, ___parameters);

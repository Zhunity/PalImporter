...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class RXmlEntityReference : RMember //
    {
		...
		/// <summary>
		/// System.String ChildBaseURI
		/// </summary>
		protected RProperty r_ChildBaseURI;
		public virtual RProperty RChildBaseURI
		{
			get
			{
				if(r_ChildBaseURI == null)
				{
					r_ChildBaseURI = new(this, "ChildBaseURI", -1);
					r_ChildBaseURI.SetBelong(this.instance);
				}
				return r_ChildBaseURI;
			}
		}
		...
		/// <summary>
		/// System.String ConstructBaseURI(System.String, System.String)
		/// </summary>
		protected RMethod r_RConstructBaseURI_String_String;
		public virtual RMethod RConstructBaseURI_String_String
		{
			get
			{
				if(r_RConstructBaseURI_String_String == null)
				{
					r_RConstructBaseURI_String_String = new(this, "ConstructBaseURI", 0, typeof(System.String), typeof(System.String));
					r_RConstructBaseURI_String_String.SetBelong(this.instance);
				}
				return r_RConstructBaseURI_String_String;
			}
		}
        ...
        public RXmlEntityReference() : base("System.Xml.XmlEntityReference")
        {
        }

        public RXmlEntityReference(System.Object instance) : base("System.Xml.XmlEntityReference")
		{
            SetInstance(instance);
		}

        public RXmlEntityReference(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlEntityReference(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.String ConstructBaseURI(System.String  @baseURI, System.String  @systemId)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@baseURI, @systemId};
            var ___result = RConstructBaseURI_String_String.Invoke(___genericsType, ___parameters);

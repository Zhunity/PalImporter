...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class RXmlAttribute : RMember //
    {
		...
		/// Int32 LocalNameHash
		/// </summary>
		protected RProperty r_LocalNameHash;
		public virtual RProperty RLocalNameHash
		{
			get
			{
				if(r_LocalNameHash == null)
				{
					r_LocalNameHash = new(this, "LocalNameHash", -1);
					r_LocalNameHash.SetBelong(this.instance);
				}
				return r_LocalNameHash;
			}
		}
		...
		/// Boolean Specified
		/// </summary>
		protected RProperty r_Specified;
		public virtual RProperty RSpecified
		{
			get
			{
				if(r_Specified == null)
				{
					r_Specified = new(this, "Specified", -1);
					r_Specified.SetBelong(this.instance);
				}
				return r_Specified;
			}
		}
		...
		/// <summary>
		/// System.Xml.XmlElement OwnerElement
		/// </summary>
		protected RSystem.RXml.RXmlElement r_OwnerElement;
		public virtual RSystem.RXml.RXmlElement ROwnerElement
		{
			get
			{
				if(r_OwnerElement == null)
				{
					r_OwnerElement = new(this, "OwnerElement", -1);
					r_OwnerElement.SetBelong(this.instance);
				}
				return r_OwnerElement;
			}
		}
		...
		/// </summary>
		protected RProperty r_InnerXml_String;
		public virtual RProperty RInnerXml_String
		{
			get
			{
				if(r_InnerXml_String == null)
				{
					r_InnerXml_String = new(this, "InnerXml", -1, typeof(System.String));
					r_InnerXml_String.SetBelong(this.instance);
				}
				return r_InnerXml_String;
			}
		}
		...
		/// Boolean IsNamespace
		/// </summary>
		protected RProperty r_IsNamespace;
		public virtual RProperty RIsNamespace
		{
			get
			{
				if(r_IsNamespace == null)
				{
					r_IsNamespace = new(this, "IsNamespace", -1);
					r_IsNamespace.SetBelong(this.instance);
				}
				return r_IsNamespace;
			}
		}
		...
		/// <summary>
		/// Boolean PrepareOwnerElementInElementIdAttrMap()
		/// </summary>
		protected RMethod r_RPrepareOwnerElementInElementIdAttrMap;
		public virtual RMethod RPrepareOwnerElementInElementIdAttrMap
		{
			get
			{
				if(r_RPrepareOwnerElementInElementIdAttrMap == null)
				{
					r_RPrepareOwnerElementInElementIdAttrMap = new(this, "PrepareOwnerElementInElementIdAttrMap", 0);
					r_RPrepareOwnerElementInElementIdAttrMap.SetBelong(this.instance);
				}
				return r_RPrepareOwnerElementInElementIdAttrMap;
			}
		}

		/// <summary>
		/// Void ResetOwnerElementInElementIdAttrMap(System.String)
		/// </summary>
		protected RMethod r_RResetOwnerElementInElementIdAttrMap_String;
		public virtual RMethod RResetOwnerElementInElementIdAttrMap_String
		{
			get
			{
				if(r_RResetOwnerElementInElementIdAttrMap_String == null)
				{
					r_RResetOwnerElementInElementIdAttrMap_String = new(this, "ResetOwnerElementInElementIdAttrMap", 0, typeof(System.String));
					r_RResetOwnerElementInElementIdAttrMap_String.SetBelong(this.instance);
				}
				return r_RResetOwnerElementInElementIdAttrMap_String;
			}
		}
		...
		/// <summary>
		/// System.String get_InnerXml()
		/// </summary>
		protected RMethod r_Rget_InnerXml;
		public virtual RMethod Rget_InnerXml
		{
			get
			{
				if(r_Rget_InnerXml == null)
				{
					r_Rget_InnerXml = new(this, "get_InnerXml", 0);
					r_Rget_InnerXml.SetBelong(this.instance);
				}
				return r_Rget_InnerXml;
			}
		}
        ...
        public RXmlAttribute() : base("System.Xml.XmlAttribute")
        {
        }

        public RXmlAttribute(System.Object instance) : base("System.Xml.XmlAttribute")
		{
            SetInstance(instance);
		}

        public RXmlAttribute(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlAttribute(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Boolean PrepareOwnerElementInElementIdAttrMap()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RPrepareOwnerElementInElementIdAttrMap.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual void ResetOwnerElementInElementIdAttrMap(System.String  @oldInnerText)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@oldInnerText};
            var ___result = RResetOwnerElementInElementIdAttrMap_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.String get_InnerXml()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = Rget_InnerXml.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class REmptyEnumerator : RMember //
    {
        ...
        public REmptyEnumerator() : base("System.Xml.EmptyEnumerator")
        {
        }

        public REmptyEnumerator(System.Object instance) : base("System.Xml.EmptyEnumerator")
		{
            SetInstance(instance);
		}

        public REmptyEnumerator(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REmptyEnumerator(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

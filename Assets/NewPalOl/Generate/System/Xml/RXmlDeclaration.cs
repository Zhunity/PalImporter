...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class RXmlDeclaration : RMember //
    {

		/// <summary>
		/// System.String YES
		/// </summary>
		protected static RField r_YES;
		public static RField RYES
		{
			get
			{
				if(r_YES == null)
				{
					r_YES = new(typeof(System.Xml.XmlDeclaration), "YES");
					r_YES.SetBelong(null);
				}
				return r_YES;
			}
		}
		...
		/// System.String NO
		/// </summary>
		protected static RField r_NO;
		public static RField RNO
		{
			get
			{
				if(r_NO == null)
				{
					r_NO = new(typeof(System.Xml.XmlDeclaration), "NO");
					r_NO.SetBelong(null);
				}
				return r_NO;
			}
		...
		/// </summary>
		protected RField r_encoding;
		public virtual RField Rencoding
		{
			get
			{
				if(r_encoding == null)
		...
		/// <summary>
		/// Boolean IsValidXmlVersion(System.String)
		/// </summary>
		protected RMethod r_RIsValidXmlVersion_String;
		public virtual RMethod RIsValidXmlVersion_String
		{
			get
			{
				if(r_RIsValidXmlVersion_String == null)
				{
					r_RIsValidXmlVersion_String = new(this, "IsValidXmlVersion", 0, typeof(System.String));
					r_RIsValidXmlVersion_String.SetBelong(this.instance);
				}
				return r_RIsValidXmlVersion_String;
			}
		}
        ...
        public RXmlDeclaration() : base("System.Xml.XmlDeclaration")
        {
        }

        public RXmlDeclaration(System.Object instance) : base("System.Xml.XmlDeclaration")
		{
            SetInstance(instance);
		}

        public RXmlDeclaration(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlDeclaration(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Boolean IsValidXmlVersion(System.String  @ver)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@ver};
            var ___result = RIsValidXmlVersion_String.Invoke(___genericsType, ___parameters);

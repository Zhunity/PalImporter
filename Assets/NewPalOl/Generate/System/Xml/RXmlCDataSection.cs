...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class RXmlCDataSection : RMember //
    {
        ...
        public RXmlCDataSection() : base("System.Xml.XmlCDataSection")
        {
        }

        public RXmlCDataSection(System.Object instance) : base("System.Xml.XmlCDataSection")
		{
            SetInstance(instance);
		}

        public RXmlCDataSection(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlCDataSection(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class RXmlDocumentFragment : RMember //
    {
        ...
        public RXmlDocumentFragment() : base("System.Xml.XmlDocumentFragment")
        {
        }

        public RXmlDocumentFragment(System.Object instance) : base("System.Xml.XmlDocumentFragment")
		{
            SetInstance(instance);
		}

        public RXmlDocumentFragment(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlDocumentFragment(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

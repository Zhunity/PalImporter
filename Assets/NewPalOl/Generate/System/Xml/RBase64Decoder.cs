...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class RBase64Decoder : RMember //
    {
		...
		/// System.Int32 bits
		/// </summary>
		protected RField r_bits;
		public virtual RField Rbits
		{
			get
			{
				if(r_bits == null)
		...
		/// <summary>
		/// System.Int32 bitsFilled
		/// </summary>
		protected RField r_bitsFilled;
		public virtual RField RbitsFilled
		{
			get
			{
				if(r_bitsFilled == null)
				{
					r_bitsFilled = new(this, "bitsFilled");
					r_bitsFilled.SetBelong(this.instance);
				}
				return r_bitsFilled;
			}
		}
		...
		/// <summary>
		/// System.String CharsBase64
		/// </summary>
		protected static RField r_CharsBase64;
		public static RField RCharsBase64
		{
			get
			{
				if(r_CharsBase64 == null)
				{
					r_CharsBase64 = new( ReleactionUtils.GetType("System.Xml.Base64Decoder"), "CharsBase64");
					r_CharsBase64.SetBelong(null);
				}
				return r_CharsBase64;
			}
		}

		/// <summary>
		/// System.Byte[] MapBase64
		/// </summary>
		protected static RFieldArray<RField> r_MapBase64;
		public static RFieldArray<RField> RMapBase64
		{
			get
			{
				if(r_MapBase64 == null)
				{
					r_MapBase64 = new( ReleactionUtils.GetType("System.Xml.Base64Decoder"), "MapBase64");
					r_MapBase64.SetBelong(null);
				}
				return r_MapBase64;
			}
		}
		...
		/// <summary>
		/// System.Int32 MaxValidChar
		/// </summary>
		protected static RField r_MaxValidChar;
		public static RField RMaxValidChar
		{
			get
			{
				if(r_MaxValidChar == null)
				{
					r_MaxValidChar = new( ReleactionUtils.GetType("System.Xml.Base64Decoder"), "MaxValidChar");
					r_MaxValidChar.SetBelong(null);
				}
				return r_MaxValidChar;
			}
		}
		...
		/// System.Byte Invalid
		/// </summary>
		protected static RField r_Invalid;
		public static RField RInvalid
		{
			get
			{
				if(r_Invalid == null)
				{
					r_Invalid = new( ReleactionUtils.GetType("System.Xml.Base64Decoder"), "Invalid");
		...
		/// <summary>
		/// Byte[] ConstructMapBase64()
		/// </summary>
		protected static RMethod r_RConstructMapBase64;
		public static RMethod RConstructMapBase64
		{
			get
			{
				if(r_RConstructMapBase64 == null)
				{
					r_RConstructMapBase64 = new( ReleactionUtils.GetType("System.Xml.Base64Decoder"), "ConstructMapBase64", 0);
					r_RConstructMapBase64.SetBelong(null);
				}
				return r_RConstructMapBase64;
			}
		}

		/// <summary>
		/// Void Decode(Char*, Char*, Byte*, Byte*, Int32 ByRef, Int32 ByRef)
		/// </summary>
		protected RMethod r_RDecode_CharPointer_CharPointer_BytePointer_BytePointer_Out_Int32_Out_Int32;
		public virtual RMethod RDecode_CharPointer_CharPointer_BytePointer_BytePointer_Out_Int32_Out_Int32
		{
			get
			{
				if(r_RDecode_CharPointer_CharPointer_BytePointer_BytePointer_Out_Int32_Out_Int32 == null)
				{
					r_RDecode_CharPointer_CharPointer_BytePointer_BytePointer_Out_Int32_Out_Int32 = new(this, "Decode", 0, typeof(System.Char).MakePointerType(), typeof(System.Char).MakePointerType(), typeof(System.Byte).MakePointerType(), typeof(System.Byte).MakePointerType(), typeof(System.Int32).MakeByRefType(), typeof(System.Int32).MakeByRefType());
					r_RDecode_CharPointer_CharPointer_BytePointer_BytePointer_Out_Int32_Out_Int32.SetBelong(this.instance);
				}
				return r_RDecode_CharPointer_CharPointer_BytePointer_BytePointer_Out_Int32_Out_Int32;
			}
		}
        ...
        public RBase64Decoder() : base("System.Xml.Base64Decoder")
        {
        }

        public RBase64Decoder(System.Object instance) : base("System.Xml.Base64Decoder")
		{
            SetInstance(instance);
		}

        public RBase64Decoder(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBase64Decoder(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public static System.Byte[] ConstructMapBase64()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RConstructMapBase64.Invoke(___genericsType, ___parameters);

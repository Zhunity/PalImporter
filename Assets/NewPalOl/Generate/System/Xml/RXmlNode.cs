...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// System.Xml.XmlNode
	/// </summary>
    public partial class RXmlNode : RMember //
    {
		...
		/// <summary>
		/// System.Xml.XmlNode NormalizeWinner(System.Xml.XmlNode, System.Xml.XmlNode)
		/// </summary>
		protected RMethod r_RNormalizeWinner_XmlNode_XmlNode;
		public virtual RMethod RNormalizeWinner_XmlNode_XmlNode
		{
			get
			{
				if(r_RNormalizeWinner_XmlNode_XmlNode == null)
				{
					r_RNormalizeWinner_XmlNode_XmlNode = new(this, "NormalizeWinner", 0, typeof(System.Xml.XmlNode), typeof(System.Xml.XmlNode));
					r_RNormalizeWinner_XmlNode_XmlNode.SetBelong(this.instance);
				}
				return r_RNormalizeWinner_XmlNode_XmlNode;
			}
		}
		...
		/// <summary>
		/// Boolean HasReadOnlyParent(System.Xml.XmlNode)
		/// </summary>
		protected static RMethod r_RHasReadOnlyParent_XmlNode;
		public static RMethod RHasReadOnlyParent_XmlNode
		{
			get
			{
				if(r_RHasReadOnlyParent_XmlNode == null)
				{
					r_RHasReadOnlyParent_XmlNode = new(typeof(System.Xml.XmlNode), "HasReadOnlyParent", 0, typeof(System.Xml.XmlNode));
					r_RHasReadOnlyParent_XmlNode.SetBelong(null);
				}
				return r_RHasReadOnlyParent_XmlNode;
			}
		}
		...
		/// <summary>
		/// Void AppendChildText(System.Text.StringBuilder)
		/// </summary>
		protected RMethod r_RAppendChildText_StringBuilder;
		public virtual RMethod RAppendChildText_StringBuilder
		{
			get
			{
				if(r_RAppendChildText_StringBuilder == null)
				{
					r_RAppendChildText_StringBuilder = new(this, "AppendChildText", 0, typeof(System.Text.StringBuilder));
					r_RAppendChildText_StringBuilder.SetBelong(this.instance);
				}
				return r_RAppendChildText_StringBuilder;
			}
		}
		...
		public static RMethod RSplitName_String_Out_String_Out_String
		{
			get
			{
				...
				{
					r_RSplitName_String_Out_String_Out_String = new(typeof(System.Xml.XmlNode), "SplitName", 0, typeof(System.String), typeof(System.String).MakeByRefType(), typeof(System.String).MakeByRefType());
		...
		/// <summary>
		/// Void NestTextNodes(System.Xml.XmlNode, System.Xml.XmlNode)
		/// </summary>
		protected static RMethod r_RNestTextNodes_XmlNode_XmlNode;
		public static RMethod RNestTextNodes_XmlNode_XmlNode
		{
			get
			{
				if(r_RNestTextNodes_XmlNode_XmlNode == null)
				{
					r_RNestTextNodes_XmlNode_XmlNode = new(typeof(System.Xml.XmlNode), "NestTextNodes", 0, typeof(System.Xml.XmlNode), typeof(System.Xml.XmlNode));
					r_RNestTextNodes_XmlNode_XmlNode.SetBelong(null);
				}
				return r_RNestTextNodes_XmlNode_XmlNode;
			}
		}

		/// <summary>
		/// Void UnnestTextNodes(System.Xml.XmlNode, System.Xml.XmlNode)
		/// </summary>
		protected static RMethod r_RUnnestTextNodes_XmlNode_XmlNode;
		public static RMethod RUnnestTextNodes_XmlNode_XmlNode
		{
			get
			{
				if(r_RUnnestTextNodes_XmlNode_XmlNode == null)
				{
					r_RUnnestTextNodes_XmlNode_XmlNode = new(typeof(System.Xml.XmlNode), "UnnestTextNodes", 0, typeof(System.Xml.XmlNode), typeof(System.Xml.XmlNode));
					r_RUnnestTextNodes_XmlNode_XmlNode.SetBelong(null);
				}
				return r_RUnnestTextNodes_XmlNode_XmlNode;
			}
		}
        ...
        public RXmlNode() : base("System.Xml.XmlNode")
        {
        }

        public RXmlNode(System.Object instance) : base("System.Xml.XmlNode")
		{
            SetInstance(instance);
		}

        public RXmlNode(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlNode(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Xml.XmlNode NormalizeWinner(System.Xml.XmlNode  @firstNode, System.Xml.XmlNode  @secondNode)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@firstNode, @secondNode};
            var ___result = RNormalizeWinner_XmlNode_XmlNode.Invoke(___genericsType, ___parameters);
        ...
        public static System.Boolean HasReadOnlyParent(System.Xml.XmlNode  @n)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@n};
            var ___result = RHasReadOnlyParent_XmlNode.Invoke(___genericsType, ___parameters);
        ...
        public virtual void AppendChildText(System.Text.StringBuilder  @builder)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@builder};
            var ___result = RAppendChildText_StringBuilder.Invoke(___genericsType, ___parameters);
        ...
        public static void SplitName(System.String  @name, out System.String  @prefix, out System.String  @localName)
        {
			prefix = default;
			localName = default;

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@name, @prefix, @localName};
			...
			localName = (System.String)___parameters[2];
        ...
        public static void NestTextNodes(System.Xml.XmlNode  @prevNode, System.Xml.XmlNode  @nextNode)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@prevNode, @nextNode};
            var ___result = RNestTextNodes_XmlNode_XmlNode.Invoke(___genericsType, ___parameters);

            
        }


        public static void UnnestTextNodes(System.Xml.XmlNode  @prevNode, System.Xml.XmlNode  @nextNode)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@prevNode, @nextNode};
            var ___result = RUnnestTextNodes_XmlNode_XmlNode.Invoke(___genericsType, ___parameters);

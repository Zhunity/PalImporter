...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class RXmlWhitespace : RMember //
    {
        ...
        public RXmlWhitespace() : base("System.Xml.XmlWhitespace")
        {
        }

        public RXmlWhitespace(System.Object instance) : base("System.Xml.XmlWhitespace")
		{
            SetInstance(instance);
		}

        public RXmlWhitespace(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXmlWhitespace(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

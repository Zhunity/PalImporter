...
namespace SMFrame.Editor.Refleaction.RSystem.RXml
{
	...
	/// </summary>
    public partial class RIncrementalReadDecoder : RMember //
    {
        ...
        public RIncrementalReadDecoder() : base("System.Xml.IncrementalReadDecoder")
        {
        }

        public RIncrementalReadDecoder(System.Object instance) : base("System.Xml.IncrementalReadDecoder")
		{
            SetInstance(instance);
		}

        public RIncrementalReadDecoder(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RIncrementalReadDecoder(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void SetNextOutputBuffer(System.Array  @array, System.Int32  @offset, System.Int32  @len)
        {

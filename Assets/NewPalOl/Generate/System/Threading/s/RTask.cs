...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading.RTasks
{
    ...
    public partial class RTask : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RThreading.RTasks.RTaskFactory r___2__Factory__4__k__BackingField;
		public static RSystem.RThreading.RTasks.RTaskFactory R__2__Factory__4__k__BackingField
		{
			get
			{
				if(r___2__Factory__4__k__BackingField == null)
				{
					r___2__Factory__4__k__BackingField = new(typeof(System.Threading.Tasks.Task), "<Factory>k__BackingField");
					r___2__Factory__4__k__BackingField.SetBelong(null);
				}
				return r___2__Factory__4__k__BackingField;
			}
		}
		...
		/// </summary>
		protected static RSystem.RThreading.RTasks.RTask r___2__CompletedTask__4__k__BackingField;
		public static RSystem.RThreading.RTasks.RTask R__2__CompletedTask__4__k__BackingField
		{
			get
			{
				if(r___2__CompletedTask__4__k__BackingField == null)
				{
					r___2__CompletedTask__4__k__BackingField = new(typeof(System.Threading.Tasks.Task), "<CompletedTask>k__BackingField");
					r___2__CompletedTask__4__k__BackingField.SetBelong(null);
				}
				return r___2__CompletedTask__4__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RSystem.RThreading.RWaitHandle r_RSystem__1__IAsyncResult__1__get_AsyncWaitHandle;
		public virtual RSystem.RThreading.RWaitHandle RSystem__1__IAsyncResult__1__get_AsyncWaitHandle
		{
			get
			{
				if(r_RSystem__1__IAsyncResult__1__get_AsyncWaitHandle == null)
				{
					r_RSystem__1__IAsyncResult__1__get_AsyncWaitHandle = new(this, "System.IAsyncResult.AsyncWaitHandle", -1);
					r_RSystem__1__IAsyncResult__1__get_AsyncWaitHandle.SetBelong(this.instance);
				}
				return r_RSystem__1__IAsyncResult__1__get_AsyncWaitHandle;
			}
		}
		...
		/// </summary>
		protected RProperty r_RSystem__1__IAsyncResult__1__get_CompletedSynchronously;
		public virtual RProperty RSystem__1__IAsyncResult__1__get_CompletedSynchronously
		{
			get
			{
				if(r_RSystem__1__IAsyncResult__1__get_CompletedSynchronously == null)
				{
					r_RSystem__1__IAsyncResult__1__get_CompletedSynchronously = new(this, "System.IAsyncResult.CompletedSynchronously", -1);
					r_RSystem__1__IAsyncResult__1__get_CompletedSynchronously.SetBelong(this.instance);
				}
				return r_RSystem__1__IAsyncResult__1__get_CompletedSynchronously;
			}
		}

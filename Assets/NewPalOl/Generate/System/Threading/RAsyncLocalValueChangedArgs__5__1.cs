...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading
{
    ...
    public partial class RAsyncLocalValueChangedArgs<T> : RMember //
    {
		...
		/// </summary>
		protected RField r___2__PreviousValue__4__k__BackingField;
		public virtual RField R__2__PreviousValue__4__k__BackingField
		{
			get
			{
				if(r___2__PreviousValue__4__k__BackingField == null)
				{
					r___2__PreviousValue__4__k__BackingField = new(this, "<PreviousValue>k__BackingField");
					r___2__PreviousValue__4__k__BackingField.SetBelong(this.instance);
				}
				return r___2__PreviousValue__4__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RField r___2__CurrentValue__4__k__BackingField;
		public virtual RField R__2__CurrentValue__4__k__BackingField
		{
			get
			{
				if(r___2__CurrentValue__4__k__BackingField == null)
				{
					r___2__CurrentValue__4__k__BackingField = new(this, "<CurrentValue>k__BackingField");
					r___2__CurrentValue__4__k__BackingField.SetBelong(this.instance);
				}
				return r___2__CurrentValue__4__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RField r___2__ThreadContextChanged__4__k__BackingField;
		public virtual RField R__2__ThreadContextChanged__4__k__BackingField
		{
			get
			{
				if(r___2__ThreadContextChanged__4__k__BackingField == null)
				{
					r___2__ThreadContextChanged__4__k__BackingField = new(this, "<ThreadContextChanged>k__BackingField");
					r___2__ThreadContextChanged__4__k__BackingField.SetBelong(this.instance);
				}
				return r___2__ThreadContextChanged__4__k__BackingField;
			}
		}

...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RExceptionServices
{
    ...
    public partial class RFirstChanceExceptionEventArgs : RMember //
    {
		...
		/// </summary>
		protected RSystem.RException r___2__Exception__4__k__BackingField;
		public virtual RSystem.RException R__2__Exception__4__k__BackingField
		{
			get
			{
				if(r___2__Exception__4__k__BackingField == null)
				{
					r___2__Exception__4__k__BackingField = new(this, "<Exception>k__BackingField");
					r___2__Exception__4__k__BackingField.SetBelong(this.instance);
				}
				return r___2__Exception__4__k__BackingField;
			}
		}

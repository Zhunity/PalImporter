...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RAppDomainSetup : RMember //
    {
		...
		/// </summary>
		protected RField r___2__TargetFrameworkName__4__k__BackingField;
		public virtual RField R__2__TargetFrameworkName__4__k__BackingField
		{
			get
			{
				if(r___2__TargetFrameworkName__4__k__BackingField == null)
				{
					r___2__TargetFrameworkName__4__k__BackingField = new(this, "<TargetFrameworkName>k__BackingField");
					r___2__TargetFrameworkName__4__k__BackingField.SetBelong(this.instance);
				}
				return r___2__TargetFrameworkName__4__k__BackingField;
			}
		}

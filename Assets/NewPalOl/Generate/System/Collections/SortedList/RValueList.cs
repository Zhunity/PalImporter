...
{public partial class RSortedList
{
	...
	/// </summary>
    public partial class RValueList : RMember //
    {
        ...
        public RValueList() : base("System.Collections.SortedList+ValueList")
        {
        }

        public RValueList(System.Object instance) : base("System.Collections.SortedList+ValueList")
		{
            SetInstance(instance);
		}

        public RValueList(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RValueList(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

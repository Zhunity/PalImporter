...
namespace SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric
{
	...
	/// </summary>
    public partial class RTreeWalkPredicate<T> : RMember //
    {
		...
		/// Boolean Invoke(Node)
		/// </summary>
		protected RMethod r_RInvoke_Node;
		public virtual RMethod RInvoke_Node
		{
			get
			{
				if(r_RInvoke_Node == null)
				{
					r_RInvoke_Node = new(this, "Invoke", 0,  ReleactionUtils.GetType("System.Collections.Generic.SortedSet`1+Node").MakeGenericType(Type.MakeGenericMethodParameter(0)));
					r_RInvoke_Node.SetBelong(this.instance);
				}
				return r_RInvoke_Node;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(Node, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Node_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Node_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Node_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Node_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("System.Collections.Generic.SortedSet`1+Node").MakeGenericType(Type.MakeGenericMethodParameter(0)), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Node_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Node_AsyncCallback_Object;
			}
		}
        ...
        public RTreeWalkPredicate() : base("System.Collections.Generic.TreeWalkPredicate`1")
        {
        }

        public RTreeWalkPredicate(System.Object instance) : base("System.Collections.Generic.TreeWalkPredicate`1")
		{
            SetInstance(instance);
		}

        public RTreeWalkPredicate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RTreeWalkPredicate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.RSystem
{
	...
	/// </summary>
    public partial class RIOAsyncCallback : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.IOAsyncResult)
		/// </summary>
		protected RMethod r_RInvoke_IOAsyncResult;
		public virtual RMethod RInvoke_IOAsyncResult
		{
			get
			{
				if(r_RInvoke_IOAsyncResult == null)
				{
					r_RInvoke_IOAsyncResult = new(this, "Invoke", 0,  ReleactionUtils.GetType("System.IOAsyncResult"));
					r_RInvoke_IOAsyncResult.SetBelong(this.instance);
				}
				return r_RInvoke_IOAsyncResult;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.IOAsyncResult, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_IOAsyncResult_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_IOAsyncResult_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_IOAsyncResult_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_IOAsyncResult_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("System.IOAsyncResult"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_IOAsyncResult_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_IOAsyncResult_AsyncCallback_Object;
			}
		}
        ...
        public RIOAsyncCallback() : base("System.IOAsyncCallback")
        {
        }

        public RIOAsyncCallback(System.Object instance) : base("System.IOAsyncCallback")
		{
            SetInstance(instance);
		}

        public RIOAsyncCallback(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RIOAsyncCallback(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

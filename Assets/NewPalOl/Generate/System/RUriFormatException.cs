...
namespace SMFrame.Editor.Refleaction.RSystem
{
	...
	/// </summary>
    public partial class RUriFormatException : RMember //
    {
        ...
        public RUriFormatException() : base("System.UriFormatException")
        {
        }

        public RUriFormatException(System.Object instance) : base("System.UriFormatException")
		{
            SetInstance(instance);
		}

        public RUriFormatException(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RUriFormatException(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

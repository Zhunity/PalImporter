...
namespace SMFrame.Editor.Refleaction.RSystem.RIO
{
	...
	/// </summary>
    public partial class RTextReader : RMember //
    {

		/// <summary>
		/// System.IO.TextReader Null
		/// </summary>
		protected static RSystem.RIO.RTextReader r_Null;
		public static RSystem.RIO.RTextReader RNull
		{
			get
			{
				if(r_Null == null)
				{
					r_Null = new(typeof(System.IO.TextReader), "Null");
		...
		/// </summary>
		protected static RMethod r_RSynchronized_TextReader;
		public static RMethod RSynchronized_TextReader
		{
			get
			{
				if(r_RSynchronized_TextReader == null)
				{
					r_RSynchronized_TextReader = new(typeof(System.IO.TextReader), "Synchronized", 0, typeof(System.IO.TextReader));
					r_RSynchronized_TextReader.SetBelong(null);
				}
				return r_RSynchronized_TextReader;
			}
		}
        ...
        public RTextReader() : base("System.IO.TextReader")
        {
        }

        public RTextReader(System.Object instance) : base("System.IO.TextReader")
		{
            SetInstance(instance);
		}

        public RTextReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RTextReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public static System.IO.TextReader Synchronized(System.IO.TextReader  @reader)
        {
            ...
            var ___result = RSynchronized_TextReader.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction.RSystem.RIO
{
	...
	/// </summary>
    public partial class RStringWriter : RMember //
    {

		/// <summary>
		/// System.Text.UnicodeEncoding m_encoding
		/// </summary>
		protected static RSystem.RText.RUnicodeEncoding r_m_encoding;
		public static RSystem.RText.RUnicodeEncoding Rm_encoding
		{
			get
			{
				if(r_m_encoding == null)
				{
					r_m_encoding = new(typeof(System.IO.StringWriter), "m_encoding");
					r_m_encoding.SetBelong(null);
				}
				return r_m_encoding;
			}
		}
		...
		/// </summary>
		protected RSystem.RText.RStringBuilder r__sb;
		public virtual RSystem.RText.RStringBuilder R_sb
		{
			get
			{
				if(r__sb == null)
		...
		/// </summary>
		protected RField r__isOpen;
		public virtual RField R_isOpen
		{
			get
			{
				if(r__isOpen == null)
				{
					r__isOpen = new(this, "_isOpen");
					r__isOpen.SetBelong(this.instance);
				}
				return r__isOpen;
			}
		}
		...
		/// </summary>
		protected RMethod r_RGetStringBuilder;
		public virtual RMethod RGetStringBuilder
		{
			get
			{
				if(r_RGetStringBuilder == null)
				{
					r_RGetStringBuilder = new(this, "GetStringBuilder", 0);
					r_RGetStringBuilder.SetBelong(this.instance);
				}
				return r_RGetStringBuilder;
			}
		}
        ...
        public RStringWriter() : base("System.IO.StringWriter")
        {
        }

        public RStringWriter(System.Object instance) : base("System.IO.StringWriter")
		{
            SetInstance(instance);
		}

        public RStringWriter(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RStringWriter(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Text.StringBuilder GetStringBuilder()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RGetStringBuilder.Invoke(___genericsType, ___parameters);

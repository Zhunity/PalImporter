...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CombatMenu
	/// </summary>
    public partial class RCombatMenu : RMember //
    {

		/// <summary>
		/// UnityEngine.GUISkin mGuiskin
		/// </summary>
		protected static RUnityEngine.RGUISkin r_mGuiskin;
		public static RUnityEngine.RGUISkin RmGuiskin
		{
			get
			{
				if(r_mGuiskin == null)
				{
					r_mGuiskin = new( ReleactionUtils.GetType("CombatMenu"), "mGuiskin");
					r_mGuiskin.SetBelong(null);
				}
				return r_mGuiskin;
			}
		}
        ...
        public RCombatMenu() : base("CombatMenu")
        {
        }

        public RCombatMenu(System.Object instance) : base("CombatMenu")
		{
            SetInstance(instance);
		}

        public RCombatMenu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCombatMenu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

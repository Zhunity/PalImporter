...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SplineController
	/// </summary>
    public partial class RSplineController : RMember //
    {

		/// <summary>
		/// UnityEngine.GameObject SplineRoot
		/// </summary>
		protected RUnityEngine.RGameObject r_SplineRoot;
		public virtual RUnityEngine.RGameObject RSplineRoot
		{
			get
			{
				if(r_SplineRoot == null)
				{
					r_SplineRoot = new(this, "SplineRoot");
					r_SplineRoot.SetBelong(this.instance);
				}
				return r_SplineRoot;
			}
		}
		...
		/// </summary>
		protected RSplineInterpolator r_mSplineInterp;
		public virtual RSplineInterpolator RmSplineInterp
		{
			get
			{
				if(r_mSplineInterp == null)
				{
					r_mSplineInterp = new(this, "mSplineInterp");
					r_mSplineInterp.SetBelong(this.instance);
				}
				return r_mSplineInterp;
			}
		}

		/// <summary>
		/// UnityEngine.Transform[] mTransforms
		/// </summary>
		protected RFieldArray<RUnityEngine.RTransform> r_mTransforms;
		public virtual RFieldArray<RUnityEngine.RTransform> RmTransforms
		{
			get
			{
				if(r_mTransforms == null)
				{
					r_mTransforms = new(this, "mTransforms");
					r_mTransforms.SetBelong(this.instance);
				}
				return r_mTransforms;
			}
		}

		/// <summary>
		/// SplinePathParams mCurrentPathParams
		/// </summary>
		protected RSplinePathParams r_mCurrentPathParams;
		public virtual RSplinePathParams RmCurrentPathParams
		{
			get
			{
				if(r_mCurrentPathParams == null)
				{
					r_mCurrentPathParams = new(this, "mCurrentPathParams");
					r_mCurrentPathParams.SetBelong(this.instance);
				}
				return r_mCurrentPathParams;
			}
		}

		/// <summary>
		/// System.Boolean Controling
		/// </summary>
		protected RField r_Controling;
		public virtual RField RControling
		{
			get
			{
				if(r_Controling == null)
				{
					r_Controling = new(this, "Controling");
					r_Controling.SetBelong(this.instance);
				}
				return r_Controling;
			}
		}
		...
		/// <summary>
		/// System.Comparison`1[UnityEngine.Transform] <>f__am$cache5
		/// </summary>
		protected static RSystem.RComparison<RUnityEngine.RTransform> r___2____4__f__am__9__cache5;
		public static RSystem.RComparison<RUnityEngine.RTransform> R__2____4__f__am__9__cache5
		{
			get
			{
				if(r___2____4__f__am__9__cache5 == null)
				{
					r___2____4__f__am__9__cache5 = new(typeof(SplineController), "<>f__am$cache5");
					r___2____4__f__am__9__cache5.SetBelong(null);
				}
				return r___2____4__f__am__9__cache5;
			}
		}
		...
		/// <summary>
		/// Void SetupSplineInterpolator(SplineInterpolator, UnityEngine.Transform[])
		/// </summary>
		protected RMethod r_RSetupSplineInterpolator_SplineInterpolator_TransformArray;
		public virtual RMethod RSetupSplineInterpolator_SplineInterpolator_TransformArray
		{
			get
			{
				if(r_RSetupSplineInterpolator_SplineInterpolator_TransformArray == null)
				{
					r_RSetupSplineInterpolator_SplineInterpolator_TransformArray = new(this, "SetupSplineInterpolator", 0, typeof(SplineInterpolator), typeof(UnityEngine.Transform).MakeArrayType());
					r_RSetupSplineInterpolator_SplineInterpolator_TransformArray.SetBelong(this.instance);
				}
				return r_RSetupSplineInterpolator_SplineInterpolator_TransformArray;
			}
		}
		...
		/// </summary>
		protected RMethod r_RGetTransforms;
		public virtual RMethod RGetTransforms
		{
			get
			{
				if(r_RGetTransforms == null)
				{
					r_RGetTransforms = new(this, "GetTransforms", 0);
					r_RGetTransforms.SetBelong(this.instance);
				}
				return r_RGetTransforms;
			}
		}
		...
		/// </summary>
		protected RMethod r_RDisableTransforms;
		public virtual RMethod RDisableTransforms
		{
			get
			{
				if(r_RDisableTransforms == null)
				{
					r_RDisableTransforms = new(this, "DisableTransforms", 0);
					r_RDisableTransforms.SetBelong(this.instance);
				}
				return r_RDisableTransforms;
			}
		}
		...
		/// Void FollowSpline()
		/// </summary>
		protected RMethod r_RFollowSpline;
		public virtual RMethod RFollowSpline
		{
			get
			{
				if(r_RFollowSpline == null)
				{
					r_RFollowSpline = new(this, "FollowSpline", 0);
					r_RFollowSpline.SetBelong(this.instance);
				}
				return r_RFollowSpline;
			}
		}
		...
		/// Void OnEndControl()
		/// </summary>
		protected RMethod r_ROnEndControl;
		public virtual RMethod ROnEndControl
		{
			get
			{
				if(r_ROnEndControl == null)
				{
					r_ROnEndControl = new(this, "OnEndControl", 0);
					r_ROnEndControl.SetBelong(this.instance);
				}
				return r_ROnEndControl;
			}
		}

		/// <summary>
		/// Boolean IsControling()
		/// </summary>
		protected RMethod r_RIsControling;
		public virtual RMethod RIsControling
		{
			get
			{
				if(r_RIsControling == null)
				{
					r_RIsControling = new(this, "IsControling", 0);
					r_RIsControling.SetBelong(this.instance);
				}
				return r_RIsControling;
			}
		}

		/// <summary>
		/// Single GetDelateTime(UnityEngine.Component)
		/// </summary>
		protected RMethod r_RGetDelateTime_Component;
		public virtual RMethod RGetDelateTime_Component
		{
			get
			{
				if(r_RGetDelateTime_Component == null)
				{
					r_RGetDelateTime_Component = new(this, "GetDelateTime", 0, typeof(UnityEngine.Component));
					r_RGetDelateTime_Component.SetBelong(this.instance);
				}
				return r_RGetDelateTime_Component;
			}
		}
		...
		/// Void InitSplinePath()
		/// </summary>
		protected RMethod r_RInitSplinePath;
		public virtual RMethod RInitSplinePath
		{
			get
			{
				if(r_RInitSplinePath == null)
				{
					r_RInitSplinePath = new(this, "InitSplinePath", 0);
					r_RInitSplinePath.SetBelong(this.instance);
				}
				return r_RInitSplinePath;
			}
		}

		/// <summary>
		/// Void FollowSplinePath(UnityEngine.GameObject)
		/// </summary>
		protected RMethod r_RFollowSplinePath_GameObject;
		public virtual RMethod RFollowSplinePath_GameObject
		{
			get
			{
				if(r_RFollowSplinePath_GameObject == null)
				{
					r_RFollowSplinePath_GameObject = new(this, "FollowSplinePath", 0, typeof(UnityEngine.GameObject));
					r_RFollowSplinePath_GameObject.SetBelong(this.instance);
				}
				return r_RFollowSplinePath_GameObject;
			}
		}

		/// <summary>
		/// Int32 <GetTransforms>m__1F0(UnityEngine.Transform, UnityEngine.Transform)
		/// </summary>
		protected static RMethod r_R__2__GetTransforms__4__m__1F0_Transform_Transform;
		public static RMethod R__2__GetTransforms__4__m__1F0_Transform_Transform
		{
			get
			{
				if(r_R__2__GetTransforms__4__m__1F0_Transform_Transform == null)
				{
					r_R__2__GetTransforms__4__m__1F0_Transform_Transform = new(typeof(SplineController), "<GetTransforms>m__1F0", 0, typeof(UnityEngine.Transform), typeof(UnityEngine.Transform));
					r_R__2__GetTransforms__4__m__1F0_Transform_Transform.SetBelong(null);
				}
				return r_R__2__GetTransforms__4__m__1F0_Transform_Transform;
			}
		}
        ...
        public RSplineController() : base("SplineController")
        {
        }

        public RSplineController(System.Object instance) : base("SplineController")
		{
            SetInstance(instance);
		}

        public RSplineController(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSplineController(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void SetupSplineInterpolator(SplineInterpolator  @interp, UnityEngine.Transform[]  @trans)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@interp, @trans};
            var ___result = RSetupSplineInterpolator_SplineInterpolator_TransformArray.Invoke(___genericsType, ___parameters);

            
        }


        public virtual UnityEngine.Transform[] GetTransforms()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RGetTransforms.Invoke(___genericsType, ___parameters);

            return (UnityEngine.Transform[])___result;
        }


        public virtual void DisableTransforms()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RDisableTransforms.Invoke(___genericsType, ___parameters);
        ...
        public virtual void FollowSpline()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RFollowSpline.Invoke(___genericsType, ___parameters);
        ...
        public virtual void OnEndControl()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = ROnEndControl.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Boolean IsControling()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RIsControling.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual System.Single GetDelateTime(UnityEngine.Component  @pointNode)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pointNode};
            var ___result = RGetDelateTime_Component.Invoke(___genericsType, ___parameters);

            return (System.Single)___result;
        }


        public virtual void InitSplinePath()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RInitSplinePath.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void FollowSplinePath(UnityEngine.GameObject  @pathObj)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pathObj};
            var ___result = RFollowSplinePath_GameObject.Invoke(___genericsType, ___parameters);

            
        }


        public static System.Int32 __2__GetTransforms__4__m__1F0(UnityEngine.Transform  @a, UnityEngine.Transform  @b)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@a, @b};
            var ___result = R__2__GetTransforms__4__m__1F0_Transform_Transform.Invoke(___genericsType, ___parameters);

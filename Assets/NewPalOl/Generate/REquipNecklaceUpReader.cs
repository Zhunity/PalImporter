...
{
	/// <summary>
	/// EquipNecklaceUpReader
	/// </summary>
    public partial class REquipNecklaceUpReader : RMember //
    {
        ...
        public REquipNecklaceUpReader() : base("EquipNecklaceUpReader")
        {
        }

        public REquipNecklaceUpReader(System.Object instance) : base("EquipNecklaceUpReader")
		{
            SetInstance(instance);
		}

        public REquipNecklaceUpReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REquipNecklaceUpReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

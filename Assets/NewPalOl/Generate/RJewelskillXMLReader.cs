...
namespace SMFrame.Editor.Refleaction
{
	...
	/// JewelskillXMLReader
	/// </summary>
    public partial class RJewelskillXMLReader : RMember //
    {
        ...
        public RJewelskillXMLReader() : base("JewelskillXMLReader")
        {
        }

        public RJewelskillXMLReader(System.Object instance) : base("JewelskillXMLReader")
		{
            SetInstance(instance);
		}

        public RJewelskillXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RJewelskillXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// HideBloodUIEffect
	/// </summary>
    public partial class RHideBloodUIEffect : RMember //
    {
        ...
        public RHideBloodUIEffect() : base("HideBloodUIEffect")
        {
        }

        public RHideBloodUIEffect(System.Object instance) : base("HideBloodUIEffect")
		{
            SetInstance(instance);
		}

        public RHideBloodUIEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RHideBloodUIEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

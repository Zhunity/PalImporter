...
{public partial class RDialogScript
{
	
	/// <summary>
	/// DialogScript+<ShowOneText>c__Iterator173
	/// </summary>
    public partial class R__2__ShowOneText__4__c__Iterator173 : RMember //
    {

		/// <summary>
		/// System.String <showText>__0
		/// </summary>
		protected RField r___2__showText__4____0;
		public virtual RField R__2__showText__4____0
		{
			get
			{
				if(r___2__showText__4____0 == null)
				{
					r___2__showText__4____0 = new(this, "<showText>__0");
					r___2__showText__4____0.SetBelong(this.instance);
				}
				return r___2__showText__4____0;
			}
		}
		...
		/// System.Int32 <i>__1
		/// </summary>
		protected RField r___2__i__4____1;
		public virtual RField R__2__i__4____1
		{
			get
			{
				if(r___2__i__4____1 == null)
				{
					r___2__i__4____1 = new(this, "<i>__1");
					r___2__i__4____1.SetBelong(this.instance);
				}
				return r___2__i__4____1;
			}
		}

		/// <summary>
		/// System.Int32 <counter>__2
		/// </summary>
		protected RField r___2__counter__4____2;
		public virtual RField R__2__counter__4____2
		{
			get
			{
				if(r___2__counter__4____2 == null)
				{
					r___2__counter__4____2 = new(this, "<counter>__2");
					r___2__counter__4____2.SetBelong(this.instance);
				}
				return r___2__counter__4____2;
			}
		}
		...
		/// <summary>
		/// DialogScript <>f__this
		/// </summary>
		protected RDialogScript r___2____4__f__this;
		public virtual RDialogScript R__2____4__f__this
		{
			get
			{
        ...
        public R__2__ShowOneText__4__c__Iterator173() : base("DialogScript+<ShowOneText>c__Iterator173")
        {
        }

        public R__2__ShowOneText__4__c__Iterator173(System.Object instance) : base("DialogScript+<ShowOneText>c__Iterator173")
		{
            SetInstance(instance);
		}

        public R__2__ShowOneText__4__c__Iterator173(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ShowOneText__4__c__Iterator173(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RDialogScript
{
	...
	/// <summary>
	/// DialogScript+<ProcessFinish>c__Iterator174
	/// </summary>
    public partial class R__2__ProcessFinish__4__c__Iterator174 : RMember //
    {
        ...
        public R__2__ProcessFinish__4__c__Iterator174() : base("DialogScript+<ProcessFinish>c__Iterator174")
        {
        }

        public R__2__ProcessFinish__4__c__Iterator174(System.Object instance) : base("DialogScript+<ProcessFinish>c__Iterator174")
		{
            SetInstance(instance);
		}

        public R__2__ProcessFinish__4__c__Iterator174(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ProcessFinish__4__c__Iterator174(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

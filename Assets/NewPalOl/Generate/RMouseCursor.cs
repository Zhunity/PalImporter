...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MouseCursor
	/// </summary>
    public partial class RMouseCursor : RMember //
    {

		/// <summary>
		/// MouseState _state
		/// </summary>
		protected static RField r__state;
		public static RField R_state
		{
			get
			{
				if(r__state == null)
				{
					r__state = new( ReleactionUtils.GetType("MouseCursor"), "_state");
					r__state.SetBelong(null);
				}
				return r__state;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Texture mouse
		/// </summary>
		protected RUnityEngine.RTexture r_mouse;
		public virtual RUnityEngine.RTexture Rmouse
		{
			get
			{
				if(r_mouse == null)
				{
					r_mouse = new(this, "mouse");
					r_mouse.SetBelong(this.instance);
				}
				return r_mouse;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Texture normalCursor
		/// </summary>
		protected RUnityEngine.RTexture r_normalCursor;
		public virtual RUnityEngine.RTexture RnormalCursor
		{
			get
			{
				if(r_normalCursor == null)
				{
					r_normalCursor = new(this, "normalCursor");
					r_normalCursor.SetBelong(this.instance);
				}
				return r_normalCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture walkCursor
		/// </summary>
		protected RUnityEngine.RTexture r_walkCursor;
		public virtual RUnityEngine.RTexture RwalkCursor
		{
			get
			{
				if(r_walkCursor == null)
				{
					r_walkCursor = new(this, "walkCursor");
					r_walkCursor.SetBelong(this.instance);
				}
				return r_walkCursor;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Texture attackCursor
		/// </summary>
		protected RUnityEngine.RTexture r_attackCursor;
		public virtual RUnityEngine.RTexture RattackCursor
		{
			get
			{
				if(r_attackCursor == null)
				{
					r_attackCursor = new(this, "attackCursor");
					r_attackCursor.SetBelong(this.instance);
				}
				return r_attackCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture skillCursor
		/// </summary>
		protected RUnityEngine.RTexture r_skillCursor;
		public virtual RUnityEngine.RTexture RskillCursor
		{
			get
			{
				if(r_skillCursor == null)
				{
					r_skillCursor = new(this, "skillCursor");
					r_skillCursor.SetBelong(this.instance);
				}
				return r_skillCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture protectCursor
		/// </summary>
		protected RUnityEngine.RTexture r_protectCursor;
		public virtual RUnityEngine.RTexture RprotectCursor
		{
			get
			{
				if(r_protectCursor == null)
				{
					r_protectCursor = new(this, "protectCursor");
					r_protectCursor.SetBelong(this.instance);
				}
				return r_protectCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture catchCursor
		/// </summary>
		protected RUnityEngine.RTexture r_catchCursor;
		public virtual RUnityEngine.RTexture RcatchCursor
		{
			get
			{
				if(r_catchCursor == null)
				{
					r_catchCursor = new(this, "catchCursor");
					r_catchCursor.SetBelong(this.instance);
				}
				return r_catchCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture jointeamCursor
		/// </summary>
		protected RUnityEngine.RTexture r_jointeamCursor;
		public virtual RUnityEngine.RTexture RjointeamCursor
		{
			get
			{
				if(r_jointeamCursor == null)
				{
					r_jointeamCursor = new(this, "jointeamCursor");
					r_jointeamCursor.SetBelong(this.instance);
				}
				return r_jointeamCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture checknpcItemCursor
		/// </summary>
		protected RUnityEngine.RTexture r_checknpcItemCursor;
		public virtual RUnityEngine.RTexture RchecknpcItemCursor
		{
			get
			{
				if(r_checknpcItemCursor == null)
				{
					r_checknpcItemCursor = new(this, "checknpcItemCursor");
					r_checknpcItemCursor.SetBelong(this.instance);
				}
				return r_checknpcItemCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture repairitemCursor
		/// </summary>
		protected RUnityEngine.RTexture r_repairitemCursor;
		public virtual RUnityEngine.RTexture RrepairitemCursor
		{
			get
			{
				if(r_repairitemCursor == null)
				{
					r_repairitemCursor = new(this, "repairitemCursor");
					r_repairitemCursor.SetBelong(this.instance);
				}
				return r_repairitemCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture tradeCursor
		/// </summary>
		protected RUnityEngine.RTexture r_tradeCursor;
		public virtual RUnityEngine.RTexture RtradeCursor
		{
			get
			{
				if(r_tradeCursor == null)
				{
					r_tradeCursor = new(this, "tradeCursor");
					r_tradeCursor.SetBelong(this.instance);
				}
				return r_tradeCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture buyItemCursor
		/// </summary>
		protected RUnityEngine.RTexture r_buyItemCursor;
		public virtual RUnityEngine.RTexture RbuyItemCursor
		{
			get
			{
				if(r_buyItemCursor == null)
				{
					r_buyItemCursor = new(this, "buyItemCursor");
					r_buyItemCursor.SetBelong(this.instance);
				}
				return r_buyItemCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture sellItemCursor
		/// </summary>
		protected RUnityEngine.RTexture r_sellItemCursor;
		public virtual RUnityEngine.RTexture RsellItemCursor
		{
			get
			{
				if(r_sellItemCursor == null)
				{
					r_sellItemCursor = new(this, "sellItemCursor");
					r_sellItemCursor.SetBelong(this.instance);
				}
				return r_sellItemCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture useItemCursor
		/// </summary>
		protected RUnityEngine.RTexture r_useItemCursor;
		public virtual RUnityEngine.RTexture RuseItemCursor
		{
			get
			{
				if(r_useItemCursor == null)
				{
					r_useItemCursor = new(this, "useItemCursor");
					r_useItemCursor.SetBelong(this.instance);
				}
				return r_useItemCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture[] checkObjNpcCursor
		/// </summary>
		protected RFieldArray<RUnityEngine.RTexture> r_checkObjNpcCursor;
		public virtual RFieldArray<RUnityEngine.RTexture> RcheckObjNpcCursor
		{
			get
			{
				if(r_checkObjNpcCursor == null)
				{
					r_checkObjNpcCursor = new(this, "checkObjNpcCursor");
					r_checkObjNpcCursor.SetBelong(this.instance);
				}
				return r_checkObjNpcCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture[] checkTalkNpcCursor
		/// </summary>
		protected RFieldArray<RUnityEngine.RTexture> r_checkTalkNpcCursor;
		public virtual RFieldArray<RUnityEngine.RTexture> RcheckTalkNpcCursor
		{
			get
			{
				if(r_checkTalkNpcCursor == null)
				{
					r_checkTalkNpcCursor = new(this, "checkTalkNpcCursor");
					r_checkTalkNpcCursor.SetBelong(this.instance);
				}
				return r_checkTalkNpcCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture unselectableCursor
		/// </summary>
		protected RUnityEngine.RTexture r_unselectableCursor;
		public virtual RUnityEngine.RTexture RunselectableCursor
		{
			get
			{
				if(r_unselectableCursor == null)
				{
					r_unselectableCursor = new(this, "unselectableCursor");
					r_unselectableCursor.SetBelong(this.instance);
				}
				return r_unselectableCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture baoguofenjie
		/// </summary>
		protected RUnityEngine.RTexture r_baoguofenjie;
		public virtual RUnityEngine.RTexture Rbaoguofenjie
		{
			get
			{
				if(r_baoguofenjie == null)
				{
					r_baoguofenjie = new(this, "baoguofenjie");
					r_baoguofenjie.SetBelong(this.instance);
				}
				return r_baoguofenjie;
			}
		}

		/// <summary>
		/// UnityEngine.Texture reduceequip
		/// </summary>
		protected RUnityEngine.RTexture r_reduceequip;
		public virtual RUnityEngine.RTexture Rreduceequip
		{
			get
			{
				if(r_reduceequip == null)
				{
					r_reduceequip = new(this, "reduceequip");
					r_reduceequip.SetBelong(this.instance);
				}
				return r_reduceequip;
			}
		}

		/// <summary>
		/// UnityEngine.Texture StretchChatCursor
		/// </summary>
		protected RUnityEngine.RTexture r_StretchChatCursor;
		public virtual RUnityEngine.RTexture RStretchChatCursor
		{
			get
			{
				if(r_StretchChatCursor == null)
				{
					r_StretchChatCursor = new(this, "StretchChatCursor");
					r_StretchChatCursor.SetBelong(this.instance);
				}
				return r_StretchChatCursor;
			}
		}

		/// <summary>
		/// UnityEngine.Texture watering
		/// </summary>
		protected RUnityEngine.RTexture r_watering;
		public virtual RUnityEngine.RTexture Rwatering
		{
			get
			{
				if(r_watering == null)
				{
					r_watering = new(this, "watering");
					r_watering.SetBelong(this.instance);
				}
				return r_watering;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Texture fertilize
		/// </summary>
		protected RUnityEngine.RTexture r_fertilize;
		public virtual RUnityEngine.RTexture Rfertilize
		{
			get
			{
				if(r_fertilize == null)
				{
					r_fertilize = new(this, "fertilize");
					r_fertilize.SetBelong(this.instance);
				}
				return r_fertilize;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Texture insecticide
		/// </summary>
		protected RUnityEngine.RTexture r_insecticide;
		public virtual RUnityEngine.RTexture Rinsecticide
		{
			get
			{
				if(r_insecticide == null)
				{
					r_insecticide = new(this, "insecticide");
					r_insecticide.SetBelong(this.instance);
				}
				return r_insecticide;
			}
		}

		/// <summary>
		/// System.Single lastChangeTime
		/// </summary>
		protected static RField r_lastChangeTime;
		public static RField RlastChangeTime
		{
			get
			{
				if(r_lastChangeTime == null)
				{
					r_lastChangeTime = new( ReleactionUtils.GetType("MouseCursor"), "lastChangeTime");
					r_lastChangeTime.SetBelong(null);
				}
				return r_lastChangeTime;
			}
		}

		/// <summary>
		/// System.Int32 changeIndex
		/// </summary>
		protected static RField r_changeIndex;
		public static RField RchangeIndex
		{
			get
			{
				if(r_changeIndex == null)
				{
					r_changeIndex = new( ReleactionUtils.GetType("MouseCursor"), "changeIndex");
					r_changeIndex.SetBelong(null);
				}
				return r_changeIndex;
			}
		}

		/// <summary>
		/// System.Single changeTimeLength
		/// </summary>
		protected RField r_changeTimeLength;
		public virtual RField RchangeTimeLength
		{
			get
			{
				if(r_changeTimeLength == null)
				{
					r_changeTimeLength = new(this, "changeTimeLength");
					r_changeTimeLength.SetBelong(this.instance);
				}
				return r_changeTimeLength;
			}
		}

		/// <summary>
		/// UnityEngine.GameObject _controller
		/// </summary>
		protected RUnityEngine.RGameObject r__controller;
		public virtual RUnityEngine.RGameObject R_controller
		{
			get
			{
				if(r__controller == null)
				{
					r__controller = new(this, "_controller");
					r__controller.SetBelong(this.instance);
				}
				return r__controller;
			}
		}
		...
		/// MouseState state
		/// </summary>
		protected static RProperty r_state;
		public static RProperty Rstate
		{
			get
			{
				if(r_state == null)
				{
					r_state = new( ReleactionUtils.GetType("MouseCursor"), "state", -1);
					r_state.SetBelong(null);
				}
				return r_state;
			}
		}
        ...
        public RMouseCursor() : base("MouseCursor")
        {
        }

        public RMouseCursor(System.Object instance) : base("MouseCursor")
		{
            SetInstance(instance);
		}

        public RMouseCursor(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMouseCursor(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

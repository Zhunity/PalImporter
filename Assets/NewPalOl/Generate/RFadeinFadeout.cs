...
namespace SMFrame.Editor.Refleaction
{
	...
	/// FadeinFadeout
	/// </summary>
    public partial class RFadeinFadeout : RMember //
    {

		/// <summary>
		/// System.Boolean DrawInThisClass
		/// </summary>
		protected RField r_DrawInThisClass;
		public virtual RField RDrawInThisClass
		{
			get
			{
				if(r_DrawInThisClass == null)
				{
					r_DrawInThisClass = new(this, "DrawInThisClass");
					r_DrawInThisClass.SetBelong(this.instance);
				}
				return r_DrawInThisClass;
			}
		}
		...
		/// </summary>
		protected RField r_bFadein;
		public virtual RField RbFadein
		{
			get
			{
				if(r_bFadein == null)
				{
					r_bFadein = new(this, "bFadein");
					r_bFadein.SetBelong(this.instance);
				}
				return r_bFadein;
			}
		}
		...
		/// <summary>
		/// System.Boolean bFadeout
		/// </summary>
		protected RField r_bFadeout;
		public virtual RField RbFadeout
		{
			get
			{
				if(r_bFadeout == null)
				{
					r_bFadeout = new(this, "bFadeout");
					r_bFadeout.SetBelong(this.instance);
				}
				return r_bFadeout;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Color mColor
		/// </summary>
		protected RUnityEngine.RColor r_mColor;
		public virtual RUnityEngine.RColor RmColor
		{
			get
			{
				if(r_mColor == null)
				{
					r_mColor = new(this, "mColor");
					r_mColor.SetBelong(this.instance);
				}
				return r_mColor;
			}
		}
		...
		/// <summary>
		/// System.Single mFadeLength
		/// </summary>
		protected RField r_mFadeLength;
		public virtual RField RmFadeLength
		{
			get
			{
				if(r_mFadeLength == null)
				{
					r_mFadeLength = new(this, "mFadeLength");
					r_mFadeLength.SetBelong(this.instance);
				}
				return r_mFadeLength;
			}
		}
		...
		/// System.Single fTime
		/// </summary>
		protected RField r_fTime;
		public virtual RField RfTime
		{
			get
			{
				if(r_fTime == null)
				{
					r_fTime = new(this, "fTime");
		...
		/// <summary>
		/// UnityEngine.Texture2D fadeTexture
		/// </summary>
		protected RUnityEngine.RTexture2D r_fadeTexture;
		public virtual RUnityEngine.RTexture2D RfadeTexture
		{
			get
			{
				if(r_fadeTexture == null)
				{
					r_fadeTexture = new(this, "fadeTexture");
					r_fadeTexture.SetBelong(this.instance);
				}
				return r_fadeTexture;
			}
		}

		/// <summary>
		/// TwirlEffect mTEffect
		/// </summary>
		protected RTwirlEffect r_mTEffect;
		public virtual RTwirlEffect RmTEffect
		{
			get
			{
				if(r_mTEffect == null)
				{
					r_mTEffect = new(this, "mTEffect");
					r_mTEffect.SetBelong(this.instance);
				}
				return r_mTEffect;
			}
		}
		...
		/// <summary>
		/// FadeinFadeout mSingleton
		/// </summary>
		protected static RFadeinFadeout r_mSingleton;
		public static RFadeinFadeout RmSingleton
		{
			get
			{
				if(r_mSingleton == null)
				{
					r_mSingleton = new( ReleactionUtils.GetType("FadeinFadeout"), "mSingleton");
		...
		/// <summary>
		/// EventHandler OnFadeInFinish
		/// </summary>
		protected REventHandler r_OnFadeInFinish;
		public virtual REventHandler ROnFadeInFinish
		{
			get
			{
				if(r_OnFadeInFinish == null)
				{
					r_OnFadeInFinish = new(this, "OnFadeInFinish");
					r_OnFadeInFinish.SetBelong(this.instance);
				}
				return r_OnFadeInFinish;
			}
		}

		/// <summary>
		/// EventHandler OnFadeOutFinish
		/// </summary>
		protected REventHandler r_OnFadeOutFinish;
		public virtual REventHandler ROnFadeOutFinish
		{
			get
			{
				if(r_OnFadeOutFinish == null)
				{
					r_OnFadeOutFinish = new(this, "OnFadeOutFinish");
					r_OnFadeOutFinish.SetBelong(this.instance);
				}
				return r_OnFadeOutFinish;
			}
		}

		/// <summary>
		/// EventHandler OnFadeInFadeOut
		/// </summary>
		protected REventHandler r_OnFadeInFadeOut;
		public virtual REventHandler ROnFadeInFadeOut
		{
			get
			{
				if(r_OnFadeInFadeOut == null)
				{
					r_OnFadeInFadeOut = new(this, "OnFadeInFadeOut");
					r_OnFadeInFadeOut.SetBelong(this.instance);
				}
				return r_OnFadeInFadeOut;
			}
		}
		...
		public static RMethod RGet
		{
			get
			{
				if(r_RGet == null)
				{
					r_RGet = new( ReleactionUtils.GetType("FadeinFadeout"), "Get", 0);
		...
		/// <summary>
		/// Void Fadein(Single, UnityEngine.Color, EventHandler)
		/// </summary>
		protected RMethod r_RFadein_Single_Color_EventHandler;
		public virtual RMethod RFadein_Single_Color_EventHandler
		{
			get
			{
				if(r_RFadein_Single_Color_EventHandler == null)
				{
					r_RFadein_Single_Color_EventHandler = new(this, "Fadein", 0, typeof(System.Single), typeof(UnityEngine.Color), typeof(EventHandler));
					r_RFadein_Single_Color_EventHandler.SetBelong(this.instance);
				}
				return r_RFadein_Single_Color_EventHandler;
			}
		}

		/// <summary>
		/// Void Fadein(Single, UnityEngine.Color)
		/// </summary>
		protected RMethod r_RFadein_Single_Color;
		public virtual RMethod RFadein_Single_Color
		{
			get
			{
				if(r_RFadein_Single_Color == null)
				{
					r_RFadein_Single_Color = new(this, "Fadein", 0, typeof(System.Single), typeof(UnityEngine.Color));
					r_RFadein_Single_Color.SetBelong(this.instance);
				}
				return r_RFadein_Single_Color;
			}
		}

		/// <summary>
		/// Void Fadeout(Single, UnityEngine.Color, EventHandler)
		/// </summary>
		protected RMethod r_RFadeout_Single_Color_EventHandler;
		public virtual RMethod RFadeout_Single_Color_EventHandler
		{
			get
			{
				if(r_RFadeout_Single_Color_EventHandler == null)
				{
					r_RFadeout_Single_Color_EventHandler = new(this, "Fadeout", 0, typeof(System.Single), typeof(UnityEngine.Color), typeof(EventHandler));
					r_RFadeout_Single_Color_EventHandler.SetBelong(this.instance);
				}
				return r_RFadeout_Single_Color_EventHandler;
			}
		}

		/// <summary>
		/// Void Fadeout(Single, UnityEngine.Color)
		/// </summary>
		protected RMethod r_RFadeout_Single_Color;
		public virtual RMethod RFadeout_Single_Color
		{
			get
			{
				if(r_RFadeout_Single_Color == null)
				{
					r_RFadeout_Single_Color = new(this, "Fadeout", 0, typeof(System.Single), typeof(UnityEngine.Color));
					r_RFadeout_Single_Color.SetBelong(this.instance);
				}
				return r_RFadeout_Single_Color;
			}
		}
		...
		/// Void fadeinfadeout()
		/// </summary>
		protected RMethod r_Rfadeinfadeout;
		public virtual RMethod Rfadeinfadeout
		{
			get
			{
				if(r_Rfadeinfadeout == null)
				{
					r_Rfadeinfadeout = new(this, "fadeinfadeout", 0);
					r_Rfadeinfadeout.SetBelong(this.instance);
				}
				return r_Rfadeinfadeout;
			}
		}

		/// <summary>
		/// Void fadeoutfadein(Single, UnityEngine.Color, EventHandler)
		/// </summary>
		protected RMethod r_Rfadeoutfadein_Single_Color_EventHandler;
		public virtual RMethod Rfadeoutfadein_Single_Color_EventHandler
		{
			get
			{
				if(r_Rfadeoutfadein_Single_Color_EventHandler == null)
				{
					r_Rfadeoutfadein_Single_Color_EventHandler = new(this, "fadeoutfadein", 0, typeof(System.Single), typeof(UnityEngine.Color), typeof(EventHandler));
					r_Rfadeoutfadein_Single_Color_EventHandler.SetBelong(this.instance);
				}
				return r_Rfadeoutfadein_Single_Color_EventHandler;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator fadeoutfadeinCoroutine(Single, UnityEngine.Color)
		/// </summary>
		protected RMethod r_RfadeoutfadeinCoroutine_Single_Color;
		public virtual RMethod RfadeoutfadeinCoroutine_Single_Color
		{
			get
			{
				if(r_RfadeoutfadeinCoroutine_Single_Color == null)
				{
					r_RfadeoutfadeinCoroutine_Single_Color = new(this, "fadeoutfadeinCoroutine", 0, typeof(System.Single), typeof(UnityEngine.Color));
					r_RfadeoutfadeinCoroutine_Single_Color.SetBelong(this.instance);
				}
				return r_RfadeoutfadeinCoroutine_Single_Color;
			}
		}
        ...
        public RFadeinFadeout() : base("FadeinFadeout")
        {
        }

        public RFadeinFadeout(System.Object instance) : base("FadeinFadeout")
		{
            SetInstance(instance);
		}

        public RFadeinFadeout(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RFadeinFadeout(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void Fadein(System.Single  @fFadeLength, UnityEngine.Color  @fadeColor, EventHandler  @mHandler)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@fFadeLength, @fadeColor, @mHandler};
            var ___result = RFadein_Single_Color_EventHandler.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void Fadein(System.Single  @fFadeLength, UnityEngine.Color  @fadeColor)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@fFadeLength, @fadeColor};
            var ___result = RFadein_Single_Color.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void Fadeout(System.Single  @fFadeLength, UnityEngine.Color  @fadeColor, EventHandler  @mHandler)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@fFadeLength, @fadeColor, @mHandler};
            var ___result = RFadeout_Single_Color_EventHandler.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void Fadeout(System.Single  @fFadeLength, UnityEngine.Color  @fadeColor)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@fFadeLength, @fadeColor};
            var ___result = RFadeout_Single_Color.Invoke(___genericsType, ___parameters);
        ...
        public virtual void fadeinfadeout()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = Rfadeinfadeout.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void fadeoutfadein(System.Single  @fadeTime, UnityEngine.Color  @mColor, EventHandler  @mHandler)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@fadeTime, @mColor, @mHandler};
            var ___result = Rfadeoutfadein_Single_Color_EventHandler.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator fadeoutfadeinCoroutine(System.Single  @fadeTime, UnityEngine.Color  @mColor)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@fadeTime, @mColor};
            var ___result = RfadeoutfadeinCoroutine_Single_Color.Invoke(___genericsType, ___parameters);

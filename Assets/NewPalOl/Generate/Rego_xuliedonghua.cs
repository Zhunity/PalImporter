...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ego_xuliedonghua
	/// </summary>
    public partial class Rego_xuliedonghua : RMember //
    {

		/// <summary>
		/// UnityEngine.Texture[] frames
		/// </summary>
		protected RFieldArray<RUnityEngine.RTexture> r_frames;
		public virtual RFieldArray<RUnityEngine.RTexture> Rframes
		{
			get
			{
				if(r_frames == null)
		...
		/// </summary>
		protected RField r_framesPerSecond;
		public virtual RField RframesPerSecond
		{
			get
			{
				if(r_framesPerSecond == null)
				{
					r_framesPerSecond = new(this, "framesPerSecond");
					r_framesPerSecond.SetBelong(this.instance);
				}
				return r_framesPerSecond;
			}
		}
        ...
        public Rego_xuliedonghua() : base("ego_xuliedonghua")
        {
        }

        public Rego_xuliedonghua(System.Object instance) : base("ego_xuliedonghua")
		{
            SetInstance(instance);
		}

        public Rego_xuliedonghua(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public Rego_xuliedonghua(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

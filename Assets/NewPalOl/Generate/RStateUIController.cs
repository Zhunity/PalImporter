...
namespace SMFrame.Editor.Refleaction
{
	...
	/// StateUIController
	/// </summary>
    public partial class RStateUIController : RMember //
    {
		...
		/// <summary>
		/// CreatureBehav _creature
		/// </summary>
		protected RCreatureBehav r__creature;
		public virtual RCreatureBehav R_creature
		{
			get
			{
				if(r__creature == null)
				{
					r__creature = new(this, "_creature");
					r__creature.SetBelong(this.instance);
				}
				return r__creature;
			}
		}
		...
		/// <summary>
		/// System.Single OFFSET_HEIGHT
		/// </summary>
		protected RField r_OFFSET_HEIGHT;
		public virtual RField ROFFSET_HEIGHT
		{
			get
			{
				if(r_OFFSET_HEIGHT == null)
				{
					r_OFFSET_HEIGHT = new(this, "OFFSET_HEIGHT");
					r_OFFSET_HEIGHT.SetBelong(this.instance);
				}
				return r_OFFSET_HEIGHT;
			}
		}

		/// <summary>
		/// StateUIController+STATE_ICON mCurrentStat
		/// </summary>
		protected RField r_mCurrentStat;
		public virtual RField RmCurrentStat
		{
			get
			{
				if(r_mCurrentStat == null)
				{
					r_mCurrentStat = new(this, "mCurrentStat");
					r_mCurrentStat.SetBelong(this.instance);
				}
				return r_mCurrentStat;
			}
		}

		/// <summary>
		/// UnityEngine.GameObject TeamLeaderIconObj
		/// </summary>
		protected RUnityEngine.RGameObject r_TeamLeaderIconObj;
		public virtual RUnityEngine.RGameObject RTeamLeaderIconObj
		{
			get
			{
				if(r_TeamLeaderIconObj == null)
				{
					r_TeamLeaderIconObj = new(this, "TeamLeaderIconObj");
					r_TeamLeaderIconObj.SetBelong(this.instance);
				}
				return r_TeamLeaderIconObj;
			}
		}

		/// <summary>
		/// UnityEngine.Material TeamLeaderIconMat
		/// </summary>
		protected RUnityEngine.RMaterial r_TeamLeaderIconMat;
		public virtual RUnityEngine.RMaterial RTeamLeaderIconMat
		{
			get
			{
				if(r_TeamLeaderIconMat == null)
				{
					r_TeamLeaderIconMat = new(this, "TeamLeaderIconMat");
					r_TeamLeaderIconMat.SetBelong(this.instance);
				}
				return r_TeamLeaderIconMat;
			}
		}

		/// <summary>
		/// System.Int32 stateFlag
		/// </summary>
		protected RField r_stateFlag;
		public virtual RField RstateFlag
		{
			get
			{
				if(r_stateFlag == null)
				{
					r_stateFlag = new(this, "stateFlag");
					r_stateFlag.SetBelong(this.instance);
				}
				return r_stateFlag;
			}
		}
		...
		/// <summary>
		/// System.Single beSelectedTime
		/// </summary>
		protected RField r_beSelectedTime;
		public virtual RField RbeSelectedTime
		{
			get
			{
				if(r_beSelectedTime == null)
				{
					r_beSelectedTime = new(this, "beSelectedTime");
					r_beSelectedTime.SetBelong(this.instance);
				}
				return r_beSelectedTime;
			}
		}

		/// <summary>
		/// UnityEngine.Color mOrgienColor
		/// </summary>
		protected RUnityEngine.RColor r_mOrgienColor;
		public virtual RUnityEngine.RColor RmOrgienColor
		{
			get
			{
				if(r_mOrgienColor == null)
				{
					r_mOrgienColor = new(this, "mOrgienColor");
					r_mOrgienColor.SetBelong(this.instance);
				}
				return r_mOrgienColor;
			}
		}
		...
		/// <summary>
		/// System.Boolean m_bHighlightAlways
		/// </summary>
		protected RField r_m_bHighlightAlways;
		public virtual RField Rm_bHighlightAlways
		{
			get
			{
				if(r_m_bHighlightAlways == null)
				{
					r_m_bHighlightAlways = new(this, "m_bHighlightAlways");
					r_m_bHighlightAlways.SetBelong(this.instance);
				}
				return r_m_bHighlightAlways;
			}
		}

		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.String,UnityEngine.Color] m_ColorDict
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, RUnityEngine.RColor> r_m_ColorDict;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, RUnityEngine.RColor> Rm_ColorDict
		{
			get
			{
				if(r_m_ColorDict == null)
				{
					r_m_ColorDict = new(this, "m_ColorDict");
					r_m_ColorDict.SetBelong(this.instance);
				}
				return r_m_ColorDict;
			}
		}

		/// <summary>
		/// UnityEngine.Shader _outLineShader
		/// </summary>
		protected static RUnityEngine.RShader r__outLineShader;
		public static RUnityEngine.RShader R_outLineShader
		{
			get
			{
				if(r__outLineShader == null)
				{
					r__outLineShader = new( ReleactionUtils.GetType("StateUIController"), "_outLineShader");
					r__outLineShader.SetBelong(null);
				}
				return r__outLineShader;
			}
		}
		...
		/// <summary>
		/// CreatureBehav Creature
		/// </summary>
		protected RCreatureBehav r_Creature;
		public virtual RCreatureBehav RCreature
		{
			get
			{
				if(r_Creature == null)
				{
					r_Creature = new(this, "Creature", -1);
		...
		/// <summary>
		/// UnityEngine.Shader m_OutLineShader
		/// </summary>
		protected static RUnityEngine.RShader r_m_OutLineShader;
		public static RUnityEngine.RShader Rm_OutLineShader
		{
			get
			{
				if(r_m_OutLineShader == null)
				{
					r_m_OutLineShader = new( ReleactionUtils.GetType("StateUIController"), "m_OutLineShader", -1);
					r_m_OutLineShader.SetBelong(null);
				}
				return r_m_OutLineShader;
			}
		}
		...
		/// <summary>
		/// UnityEngine.GameObject ShowStateIcon(STATE_ICON)
		/// </summary>
		protected RMethod r_RShowStateIcon_STATE_ICON;
		public virtual RMethod RShowStateIcon_STATE_ICON
		{
			get
			{
				if(r_RShowStateIcon_STATE_ICON == null)
				{
					r_RShowStateIcon_STATE_ICON = new(this, "ShowStateIcon", 0,  ReleactionUtils.GetType("StateUIController+STATE_ICON"));
					r_RShowStateIcon_STATE_ICON.SetBelong(this.instance);
				}
				return r_RShowStateIcon_STATE_ICON;
			}
		}

		/// <summary>
		/// Void ShowBattleIcon(Boolean)
		/// </summary>
		protected RMethod r_RShowBattleIcon_Boolean;
		public virtual RMethod RShowBattleIcon_Boolean
		{
			get
			{
				if(r_RShowBattleIcon_Boolean == null)
				{
					r_RShowBattleIcon_Boolean = new(this, "ShowBattleIcon", 0, typeof(System.Boolean));
					r_RShowBattleIcon_Boolean.SetBelong(this.instance);
				}
				return r_RShowBattleIcon_Boolean;
			}
		}

		/// <summary>
		/// Void ShowTeamLeaderIcon(Boolean)
		/// </summary>
		protected RMethod r_RShowTeamLeaderIcon_Boolean;
		public virtual RMethod RShowTeamLeaderIcon_Boolean
		{
			get
			{
				if(r_RShowTeamLeaderIcon_Boolean == null)
				{
					r_RShowTeamLeaderIcon_Boolean = new(this, "ShowTeamLeaderIcon", 0, typeof(System.Boolean));
					r_RShowTeamLeaderIcon_Boolean.SetBelong(this.instance);
				}
				return r_RShowTeamLeaderIcon_Boolean;
			}
		}

		/// <summary>
		/// Void HideTeamLeaderIcon(Boolean)
		/// </summary>
		protected RMethod r_RHideTeamLeaderIcon_Boolean;
		public virtual RMethod RHideTeamLeaderIcon_Boolean
		{
			get
			{
				if(r_RHideTeamLeaderIcon_Boolean == null)
				{
					r_RHideTeamLeaderIcon_Boolean = new(this, "HideTeamLeaderIcon", 0, typeof(System.Boolean));
					r_RHideTeamLeaderIcon_Boolean.SetBelong(this.instance);
				}
				return r_RHideTeamLeaderIcon_Boolean;
			}
		}
		...
		/// Void SetIconHeight()
		/// </summary>
		protected RMethod r_RSetIconHeight;
		public virtual RMethod RSetIconHeight
		{
			get
			{
				if(r_RSetIconHeight == null)
				{
					r_RSetIconHeight = new(this, "SetIconHeight", 0);
					r_RSetIconHeight.SetBelong(this.instance);
				}
				return r_RSetIconHeight;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator RideUpHorse()
		/// </summary>
		...
		/// <summary>
		/// System.Collections.IEnumerator RideDownHorse()
		/// </summary>
		...
		/// <summary>
		/// Void DestroyLeaderIcon()
		/// </summary>
		protected RMethod r_RDestroyLeaderIcon;
		public virtual RMethod RDestroyLeaderIcon
		{
			get
			{
				if(r_RDestroyLeaderIcon == null)
				{
					r_RDestroyLeaderIcon = new(this, "DestroyLeaderIcon", 0);
					r_RDestroyLeaderIcon.SetBelong(this.instance);
				}
				return r_RDestroyLeaderIcon;
			}
		}
		...
		/// <summary>
		/// Void SetHLColor(Single)
		/// </summary>
		protected RMethod r_RSetHLColor_Single;
		public virtual RMethod RSetHLColor_Single
		{
			get
			{
				if(r_RSetHLColor_Single == null)
				{
					r_RSetHLColor_Single = new(this, "SetHLColor", 0, typeof(System.Single));
					r_RSetHLColor_Single.SetBelong(this.instance);
				}
				return r_RSetHLColor_Single;
			}
		}

		/// <summary>
		/// Void SetHLAlways(Boolean, Single)
		/// </summary>
		protected RMethod r_RSetHLAlways_Boolean_Single;
		public virtual RMethod RSetHLAlways_Boolean_Single
		{
			get
			{
				if(r_RSetHLAlways_Boolean_Single == null)
				{
					r_RSetHLAlways_Boolean_Single = new(this, "SetHLAlways", 0, typeof(System.Boolean), typeof(System.Single));
					r_RSetHLAlways_Boolean_Single.SetBelong(this.instance);
				}
				return r_RSetHLAlways_Boolean_Single;
			}
		}
		...
		/// <summary>
		/// Void SetStroke(Boolean)
		/// </summary>
		protected RMethod r_RSetStroke_Boolean;
		public virtual RMethod RSetStroke_Boolean
		{
			get
			{
				if(r_RSetStroke_Boolean == null)
				{
					r_RSetStroke_Boolean = new(this, "SetStroke", 0, typeof(System.Boolean));
					r_RSetStroke_Boolean.SetBelong(this.instance);
				}
				return r_RSetStroke_Boolean;
			}
		}
		...
		/// </summary>
		protected RMethod r_ROnAvatarChanged;
		public virtual RMethod ROnAvatarChanged
		{
			get
			{
				if(r_ROnAvatarChanged == null)
				{
					r_ROnAvatarChanged = new(this, "OnAvatarChanged", 0);
					r_ROnAvatarChanged.SetBelong(this.instance);
				}
				return r_ROnAvatarChanged;
			}
		}
        ...
        public RStateUIController() : base("StateUIController")
        {
        }

        public RStateUIController(System.Object instance) : base("StateUIController")
		{
            SetInstance(instance);
		}

        public RStateUIController(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RStateUIController(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }


        public virtual void ShowBattleIcon(System.Boolean  @bl)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bl};
            var ___result = RShowBattleIcon_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void ShowTeamLeaderIcon(System.Boolean  @show)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@show};
            var ___result = RShowTeamLeaderIcon_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void HideTeamLeaderIcon(System.Boolean  @bl)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bl};
            var ___result = RHideTeamLeaderIcon_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void SetIconHeight()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RSetIconHeight.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator RideUpHorse()
        {
        ...
        public virtual System.Collections.IEnumerator RideDownHorse()
        {
        ...
        public virtual void DestroyLeaderIcon()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RDestroyLeaderIcon.Invoke(___genericsType, ___parameters);
        ...
        public virtual void SetHLColor(System.Single  @fColor)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@fColor};
            var ___result = RSetHLColor_Single.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void SetHLAlways(System.Boolean  @bHL, System.Single  @fColor)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bHL, @fColor};
            var ___result = RSetHLAlways_Boolean_Single.Invoke(___genericsType, ___parameters);
        ...
        public virtual void SetStroke(System.Boolean  @bl)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bl};
            var ___result = RSetStroke_Boolean.Invoke(___genericsType, ___parameters);
        ...
        public virtual void OnAvatarChanged()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = ROnAvatarChanged.Invoke(___genericsType, ___parameters);

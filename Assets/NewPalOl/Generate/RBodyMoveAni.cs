...
namespace SMFrame.Editor.Refleaction
{
	...
	/// BodyMoveAni
	/// </summary>
    public partial class RBodyMoveAni : RMember //
    {
        ...
        public RBodyMoveAni() : base("BodyMoveAni")
        {
        }

        public RBodyMoveAni(System.Object instance) : base("BodyMoveAni")
		{
            SetInstance(instance);
		}

        public RBodyMoveAni(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBodyMoveAni(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

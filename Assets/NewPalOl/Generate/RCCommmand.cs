...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CCommmand
	/// </summary>
    public partial class RCCommmand : RMember //
    {
        ...
        public RCCommmand() : base("CCommmand")
        {
        }

        public RCCommmand(System.Object instance) : base("CCommmand")
		{
            SetInstance(instance);
		}

        public RCCommmand(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCCommmand(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

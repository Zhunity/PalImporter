...
{public partial class RScreenWipes
{
	...
	/// <summary>
	/// ScreenWipes+<AlphaTimer>c__Iterator179
	/// </summary>
    public partial class R__2__AlphaTimer__4__c__Iterator179 : RMember //
    {
		...
		/// <summary>
		/// System.Single <rate>__0
		/// </summary>
		protected RField r___2__rate__4____0;
		public virtual RField R__2__rate__4____0
		{
			get
			{
				if(r___2__rate__4____0 == null)
				{
					r___2__rate__4____0 = new(this, "<rate>__0");
					r___2__rate__4____0.SetBelong(this.instance);
				}
				return r___2__rate__4____0;
			}
		}
        ...
        public R__2__AlphaTimer__4__c__Iterator179() : base("ScreenWipes+<AlphaTimer>c__Iterator179")
        {
        }

        public R__2__AlphaTimer__4__c__Iterator179(System.Object instance) : base("ScreenWipes+<AlphaTimer>c__Iterator179")
		{
            SetInstance(instance);
		}

        public R__2__AlphaTimer__4__c__Iterator179(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__AlphaTimer__4__c__Iterator179(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

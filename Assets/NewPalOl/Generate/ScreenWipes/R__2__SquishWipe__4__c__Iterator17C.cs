...
{public partial class RScreenWipes
{
	...
	/// <summary>
	/// ScreenWipes+<SquishWipe>c__Iterator17C
	/// </summary>
    public partial class R__2__SquishWipe__4__c__Iterator17C : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.Rect <oriCam1Rect>__0
		/// </summary>
		protected RUnityEngine.RRect r___2__oriCam1Rect__4____0;
		public virtual RUnityEngine.RRect R__2__oriCam1Rect__4____0
		{
			get
			{
				if(r___2__oriCam1Rect__4____0 == null)
				{
					r___2__oriCam1Rect__4____0 = new(this, "<oriCam1Rect>__0");
					r___2__oriCam1Rect__4____0.SetBelong(this.instance);
				}
				return r___2__oriCam1Rect__4____0;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Rect <oriCam2Rect>__1
		/// </summary>
		protected RUnityEngine.RRect r___2__oriCam2Rect__4____1;
		public virtual RUnityEngine.RRect R__2__oriCam2Rect__4____1
		{
			get
			{
				if(r___2__oriCam2Rect__4____1 == null)
				{
					r___2__oriCam2Rect__4____1 = new(this, "<oriCam2Rect>__1");
					r___2__oriCam2Rect__4____1.SetBelong(this.instance);
				}
				return r___2__oriCam2Rect__4____1;
			}
		}

		/// <summary>
		/// UnityEngine.Matrix4x4 <cam1Matrix>__2
		/// </summary>
		protected RUnityEngine.RMatrix4x4 r___2__cam1Matrix__4____2;
		public virtual RUnityEngine.RMatrix4x4 R__2__cam1Matrix__4____2
		{
			get
			{
				if(r___2__cam1Matrix__4____2 == null)
				{
					r___2__cam1Matrix__4____2 = new(this, "<cam1Matrix>__2");
					r___2__cam1Matrix__4____2.SetBelong(this.instance);
				}
				return r___2__cam1Matrix__4____2;
			}
		}

		/// <summary>
		/// UnityEngine.Matrix4x4 <cam2Matrix>__3
		/// </summary>
		protected RUnityEngine.RMatrix4x4 r___2__cam2Matrix__4____3;
		public virtual RUnityEngine.RMatrix4x4 R__2__cam2Matrix__4____3
		{
			get
			{
				if(r___2__cam2Matrix__4____3 == null)
				{
					r___2__cam2Matrix__4____3 = new(this, "<cam2Matrix>__3");
					r___2__cam2Matrix__4____3.SetBelong(this.instance);
				}
				return r___2__cam2Matrix__4____3;
			}
		}
        ...
        public R__2__SquishWipe__4__c__Iterator17C() : base("ScreenWipes+<SquishWipe>c__Iterator17C")
        {
        }

        public R__2__SquishWipe__4__c__Iterator17C(System.Object instance) : base("ScreenWipes+<SquishWipe>c__Iterator17C")
		{
            SetInstance(instance);
		}

        public R__2__SquishWipe__4__c__Iterator17C(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__SquishWipe__4__c__Iterator17C(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SceneObject
	/// </summary>
    public partial class RSceneObject : RMember //
    {
        ...
        public RSceneObject() : base("SceneObject")
        {
        }

        public RSceneObject(System.Object instance) : base("SceneObject")
		{
            SetInstance(instance);
		}

        public RSceneObject(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSceneObject(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

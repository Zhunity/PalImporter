...
{public partial class RMyGUIFinalEquipWnd
{
	...
	/// <summary>
	/// MyGUIFinalEquipWnd+#0Qw
	/// </summary>
    public partial class R__0__0Qw : RMember //
    {
        ...
        public R__0__0Qw() : base("MyGUIFinalEquipWnd+#0Qw")
        {
        }

        public R__0__0Qw(System.Object instance) : base("MyGUIFinalEquipWnd+#0Qw")
		{
            SetInstance(instance);
		}

        public R__0__0Qw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0Qw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RMyGUIFinalEquipWnd
{
	...
	/// <summary>
	/// MyGUIFinalEquipWnd+#s5u
	/// </summary>
    public partial class R__0__s5u : RMember //
    {
		...
		/// <summary>
		/// MyGUIFinalEquipWnd #e
		/// </summary>
		protected RMyGUIFinalEquipWnd r___0__e;
		public virtual RMyGUIFinalEquipWnd R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__s5u() : base("MyGUIFinalEquipWnd+#s5u")
        {
        }

        public R__0__s5u(System.Object instance) : base("MyGUIFinalEquipWnd+#s5u")
		{
            SetInstance(instance);
		}

        public R__0__s5u(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__s5u(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

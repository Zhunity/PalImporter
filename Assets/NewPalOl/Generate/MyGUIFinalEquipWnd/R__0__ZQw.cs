...
{public partial class RMyGUIFinalEquipWnd
{
	...
	/// <summary>
	/// MyGUIFinalEquipWnd+#ZQw
	/// </summary>
    public partial class R__0__ZQw : RMember //
    {
		...
		/// <summary>
		/// MyGUIFinalEquipWnd #k
		/// </summary>
		protected RMyGUIFinalEquipWnd r___0__k;
		public virtual RMyGUIFinalEquipWnd R__0__k
		{
			get
			{
				if(r___0__k == null)
        ...
        public R__0__ZQw() : base("MyGUIFinalEquipWnd+#ZQw")
        {
        }

        public R__0__ZQw(System.Object instance) : base("MyGUIFinalEquipWnd+#ZQw")
		{
            SetInstance(instance);
		}

        public R__0__ZQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ZQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

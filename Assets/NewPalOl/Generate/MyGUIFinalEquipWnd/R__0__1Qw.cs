...
{public partial class RMyGUIFinalEquipWnd
{
	...
	/// <summary>
	/// MyGUIFinalEquipWnd+#1Qw
	/// </summary>
    public partial class R__0__1Qw : RMember //
    {
        ...
        public R__0__1Qw() : base("MyGUIFinalEquipWnd+#1Qw")
        {
        }

        public R__0__1Qw(System.Object instance) : base("MyGUIFinalEquipWnd+#1Qw")
		{
            SetInstance(instance);
		}

        public R__0__1Qw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1Qw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RCharacterDownloader
{
	...
	/// <summary>
	/// CharacterDownloader+CGLoadingHandler
	/// </summary>
    public partial class RCGLoadingHandler : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Object, CGLoadingArgs)
		/// </summary>
		protected RMethod r_RInvoke_Object_CGLoadingArgs;
		public virtual RMethod RInvoke_Object_CGLoadingArgs
		{
			get
			{
				if(r_RInvoke_Object_CGLoadingArgs == null)
				{
					r_RInvoke_Object_CGLoadingArgs = new(this, "Invoke", 0, typeof(System.Object),  ReleactionUtils.GetType("CharacterDownloader+CGLoadingArgs"));
					r_RInvoke_Object_CGLoadingArgs.SetBelong(this.instance);
				}
				return r_RInvoke_Object_CGLoadingArgs;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, CGLoadingArgs, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Object_CGLoadingArgs_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object_CGLoadingArgs_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object_CGLoadingArgs_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object_CGLoadingArgs_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object),  ReleactionUtils.GetType("CharacterDownloader+CGLoadingArgs"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object_CGLoadingArgs_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object_CGLoadingArgs_AsyncCallback_Object;
			}
		}
        ...
        public RCGLoadingHandler() : base("CharacterDownloader+CGLoadingHandler")
        {
        }

        public RCGLoadingHandler(System.Object instance) : base("CharacterDownloader+CGLoadingHandler")
		{
            SetInstance(instance);
		}

        public RCGLoadingHandler(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCGLoadingHandler(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

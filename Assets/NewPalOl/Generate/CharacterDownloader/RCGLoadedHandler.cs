...
{public partial class RCharacterDownloader
{
	...
	/// <summary>
	/// CharacterDownloader+CGLoadedHandler
	/// </summary>
    public partial class RCGLoadedHandler : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Object, CGLoadedArgs)
		/// </summary>
		protected RMethod r_RInvoke_Object_CGLoadedArgs;
		public virtual RMethod RInvoke_Object_CGLoadedArgs
		{
			get
			{
				if(r_RInvoke_Object_CGLoadedArgs == null)
				{
					r_RInvoke_Object_CGLoadedArgs = new(this, "Invoke", 0, typeof(System.Object),  ReleactionUtils.GetType("CharacterDownloader+CGLoadedArgs"));
					r_RInvoke_Object_CGLoadedArgs.SetBelong(this.instance);
				}
				return r_RInvoke_Object_CGLoadedArgs;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, CGLoadedArgs, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Object_CGLoadedArgs_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object_CGLoadedArgs_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object_CGLoadedArgs_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object_CGLoadedArgs_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object),  ReleactionUtils.GetType("CharacterDownloader+CGLoadedArgs"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object_CGLoadedArgs_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object_CGLoadedArgs_AsyncCallback_Object;
			}
		}
        ...
        public RCGLoadedHandler() : base("CharacterDownloader+CGLoadedHandler")
        {
        }

        public RCGLoadedHandler(System.Object instance) : base("CharacterDownloader+CGLoadedHandler")
		{
            SetInstance(instance);
		}

        public RCGLoadedHandler(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCGLoadedHandler(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class REffectTimeDelay
{
	
	/// <summary>
	/// EffectTimeDelay+<GameObjectOnLoop>c__Iterator10E
	/// </summary>
    public partial class R__2__GameObjectOnLoop__4__c__Iterator10E : RMember //
    {
		...
		/// <summary>
		/// EffectTimeDelay <>f__this
		/// </summary>
		protected REffectTimeDelay r___2____4__f__this;
		public virtual REffectTimeDelay R__2____4__f__this
		{
			get
			{
        ...
        public R__2__GameObjectOnLoop__4__c__Iterator10E() : base("EffectTimeDelay+<GameObjectOnLoop>c__Iterator10E")
        {
        }

        public R__2__GameObjectOnLoop__4__c__Iterator10E(System.Object instance) : base("EffectTimeDelay+<GameObjectOnLoop>c__Iterator10E")
		{
            SetInstance(instance);
		}

        public R__2__GameObjectOnLoop__4__c__Iterator10E(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__GameObjectOnLoop__4__c__Iterator10E(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

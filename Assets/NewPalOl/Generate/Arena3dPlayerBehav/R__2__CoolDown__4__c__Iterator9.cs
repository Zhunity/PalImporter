...
{public partial class RArena3dPlayerBehav
{
	...
	/// <summary>
	/// Arena3dPlayerBehav+<CoolDown>c__Iterator9
	/// </summary>
    public partial class R__2__CoolDown__4__c__Iterator9 : RMember //
    {
        ...
        public R__2__CoolDown__4__c__Iterator9() : base("Arena3dPlayerBehav+<CoolDown>c__Iterator9")
        {
        }

        public R__2__CoolDown__4__c__Iterator9(System.Object instance) : base("Arena3dPlayerBehav+<CoolDown>c__Iterator9")
		{
            SetInstance(instance);
		}

        public R__2__CoolDown__4__c__Iterator9(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__CoolDown__4__c__Iterator9(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RArena3dPlayerBehav
{
	
	/// <summary>
	/// Arena3dPlayerBehav+<CoolMouseDown>c__IteratorA
	/// </summary>
    public partial class R__2__CoolMouseDown__4__c__IteratorA : RMember //
    {
		...
		/// <summary>
		/// Arena3dPlayerBehav <>f__this
		/// </summary>
		protected RArena3dPlayerBehav r___2____4__f__this;
		public virtual RArena3dPlayerBehav R__2____4__f__this
		{
			get
			{
        ...
        public R__2__CoolMouseDown__4__c__IteratorA() : base("Arena3dPlayerBehav+<CoolMouseDown>c__IteratorA")
        {
        }

        public R__2__CoolMouseDown__4__c__IteratorA(System.Object instance) : base("Arena3dPlayerBehav+<CoolMouseDown>c__IteratorA")
		{
            SetInstance(instance);
		}

        public R__2__CoolMouseDown__4__c__IteratorA(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__CoolMouseDown__4__c__IteratorA(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

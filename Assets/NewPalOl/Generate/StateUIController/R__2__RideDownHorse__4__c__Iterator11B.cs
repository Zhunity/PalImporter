...
{public partial class RStateUIController
{
	
	/// <summary>
	/// StateUIController+<RideDownHorse>c__Iterator11B
	/// </summary>
    public partial class R__2__RideDownHorse__4__c__Iterator11B : RMember //
    {
		...
		/// <summary>
		/// StateUIController <>f__this
		/// </summary>
		protected RStateUIController r___2____4__f__this;
		public virtual RStateUIController R__2____4__f__this
		{
			get
			{
        ...
        public R__2__RideDownHorse__4__c__Iterator11B() : base("StateUIController+<RideDownHorse>c__Iterator11B")
        {
        }

        public R__2__RideDownHorse__4__c__Iterator11B(System.Object instance) : base("StateUIController+<RideDownHorse>c__Iterator11B")
		{
            SetInstance(instance);
		}

        public R__2__RideDownHorse__4__c__Iterator11B(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__RideDownHorse__4__c__Iterator11B(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RStateUIController
{
	...
	/// <summary>
	/// StateUIController+<RideUpHorse>c__Iterator11A
	/// </summary>
    public partial class R__2__RideUpHorse__4__c__Iterator11A : RMember //
    {
        ...
        public R__2__RideUpHorse__4__c__Iterator11A() : base("StateUIController+<RideUpHorse>c__Iterator11A")
        {
        }

        public R__2__RideUpHorse__4__c__Iterator11A(System.Object instance) : base("StateUIController+<RideUpHorse>c__Iterator11A")
		{
            SetInstance(instance);
		}

        public R__2__RideUpHorse__4__c__Iterator11A(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__RideUpHorse__4__c__Iterator11A(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

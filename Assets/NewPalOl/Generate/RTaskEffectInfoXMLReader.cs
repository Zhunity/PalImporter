...
{
	/// <summary>
	/// TaskEffectInfoXMLReader
	/// </summary>
    public partial class RTaskEffectInfoXMLReader : RMember //
    {
        ...
        public RTaskEffectInfoXMLReader() : base("TaskEffectInfoXMLReader")
        {
        }

        public RTaskEffectInfoXMLReader(System.Object instance) : base("TaskEffectInfoXMLReader")
		{
            SetInstance(instance);
		}

        public RTaskEffectInfoXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RTaskEffectInfoXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

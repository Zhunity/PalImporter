...
namespace SMFrame.Editor.Refleaction
{
	...
	/// VortexEffect
	/// </summary>
    public partial class RVortexEffect : RMember //
    {
        ...
        public RVortexEffect() : base("VortexEffect")
        {
        }

        public RVortexEffect(System.Object instance) : base("VortexEffect")
		{
            SetInstance(instance);
		}

        public RVortexEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RVortexEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// GUIPopText
	/// </summary>
    public partial class RGUIPopText : RMember //
    {

		/// <summary>
		/// System.Single _time
		/// </summary>
		protected RField r__time;
		public virtual RField R_time
		{
			get
			{
				if(r__time == null)
				{
					r__time = new(this, "_time");
					r__time.SetBelong(this.instance);
				}
				return r__time;
			}
		}
		...
		public virtual RUnityEngine.RGUIStyle RmPopTextGUIStyle
		{
			get
			{
				...
				{
					r_mPopTextGUIStyle = new(this, "mPopTextGUIStyle");
		...
		/// </summary>
		protected RUnityEngine.RGUIStyle r_mPopTextShadowGUIStyle;
		public virtual RUnityEngine.RGUIStyle RmPopTextShadowGUIStyle
		{
			get
			{
				if(r_mPopTextShadowGUIStyle == null)
				{
					r_mPopTextShadowGUIStyle = new(this, "mPopTextShadowGUIStyle");
					r_mPopTextShadowGUIStyle.SetBelong(this.instance);
				}
		...
		/// <summary>
		/// UnityEngine.GUIContent _content
		/// </summary>
		protected RUnityEngine.RGUIContent r__content;
		public virtual RUnityEngine.RGUIContent R_content
		{
			get
			{
				if(r__content == null)
		...
		/// </summary>
		protected RField r_offsetY;
		public virtual RField RoffsetY
		{
			get
			{
				if(r_offsetY == null)
				{
					r_offsetY = new(this, "offsetY");
					r_offsetY.SetBelong(this.instance);
				}
				return r_offsetY;
			}
		}
		...
		/// <summary>
		/// System.Single _delayTime
		/// </summary>
		protected RField r__delayTime;
		public virtual RField R_delayTime
		{
			get
			{
				if(r__delayTime == null)
				{
					r__delayTime = new(this, "_delayTime");
					r__delayTime.SetBelong(this.instance);
				}
				return r__delayTime;
			}
		}
		...
		/// <summary>
		/// GameDefineType.ID mNpcId
		/// </summary>
		protected RGameDefineType.RID r_mNpcId;
		public virtual RGameDefineType.RID RmNpcId
		{
			get
			{
				if(r_mNpcId == null)
		...
		/// <summary>
		/// Void SetGUIPopText(UnityEngine.GUIContent, UnityEngine.GUIStyle, UnityEngine.GUIStyle, Single, UnityEngine.Vector2, GameDefineType.ID, Single)
		/// </summary>
		protected RMethod r_RSetGUIPopText_GUIContent_GUIStyle_GUIStyle_Single_Vector2_ID_Single;
		public virtual RMethod RSetGUIPopText_GUIContent_GUIStyle_GUIStyle_Single_Vector2_ID_Single
		{
			get
			{
				if(r_RSetGUIPopText_GUIContent_GUIStyle_GUIStyle_Single_Vector2_ID_Single == null)
				{
					r_RSetGUIPopText_GUIContent_GUIStyle_GUIStyle_Single_Vector2_ID_Single = new(this, "SetGUIPopText", 0, typeof(UnityEngine.GUIContent), typeof(UnityEngine.GUIStyle), typeof(UnityEngine.GUIStyle), typeof(System.Single), typeof(UnityEngine.Vector2), typeof(GameDefineType.ID), typeof(System.Single));
					r_RSetGUIPopText_GUIContent_GUIStyle_GUIStyle_Single_Vector2_ID_Single.SetBelong(this.instance);
				}
				return r_RSetGUIPopText_GUIContent_GUIStyle_GUIStyle_Single_Vector2_ID_Single;
			}
		}
		...
		/// Void DestroyMyself()
		/// </summary>
		protected RMethod r_RDestroyMyself;
		public virtual RMethod RDestroyMyself
		{
			get
			{
				if(r_RDestroyMyself == null)
				{
					r_RDestroyMyself = new(this, "DestroyMyself", 0);
					r_RDestroyMyself.SetBelong(this.instance);
				}
				return r_RDestroyMyself;
			}
		}
		...
		/// </summary>
		protected RMethod r_RGetContentText;
		public virtual RMethod RGetContentText
		{
			get
			{
				if(r_RGetContentText == null)
				{
					r_RGetContentText = new(this, "GetContentText", 0);
					r_RGetContentText.SetBelong(this.instance);
				}
				return r_RGetContentText;
			}
		}
        ...
        public RGUIPopText() : base("GUIPopText")
        {
        }

        public RGUIPopText(System.Object instance) : base("GUIPopText")
		{
            SetInstance(instance);
		}

        public RGUIPopText(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RGUIPopText(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void SetGUIPopText(UnityEngine.GUIContent  @mContent, UnityEngine.GUIStyle  @popTexGUIStyle, UnityEngine.GUIStyle  @popTextShadowGUIStyle, System.Single  @time, UnityEngine.Vector2  @position, GameDefineType.ID  @npcid, System.Single  @count)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@mContent, @popTexGUIStyle, @popTextShadowGUIStyle, @time, @position, @npcid, @count};
            var ___result = RSetGUIPopText_GUIContent_GUIStyle_GUIStyle_Single_Vector2_ID_Single.Invoke(___genericsType, ___parameters);
        ...
        public virtual void DestroyMyself()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RDestroyMyself.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.String GetContentText()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RGetContentText.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// DialogScript
	/// </summary>
    public partial class RDialogScript : RMember //
    {

		/// <summary>
		/// System.Single FONT_SIZE
		/// </summary>
		protected static RField r_FONT_SIZE;
		public static RField RFONT_SIZE
		{
			get
			{
				if(r_FONT_SIZE == null)
				{
					r_FONT_SIZE = new( ReleactionUtils.GetType("DialogScript"), "FONT_SIZE");
					r_FONT_SIZE.SetBelong(null);
				}
				return r_FONT_SIZE;
			}
		}
		...
		/// <summary>
		/// System.Single MAX_FADE_TIME
		/// </summary>
		protected static RField r_MAX_FADE_TIME;
		public static RField RMAX_FADE_TIME
		{
			get
			{
				if(r_MAX_FADE_TIME == null)
				{
					r_MAX_FADE_TIME = new( ReleactionUtils.GetType("DialogScript"), "MAX_FADE_TIME");
					r_MAX_FADE_TIME.SetBelong(null);
				}
				return r_MAX_FADE_TIME;
			}
		}

		/// <summary>
		/// System.String m_DialogType
		/// </summary>
		protected RField r_m_DialogType;
		public virtual RField Rm_DialogType
		{
			get
			{
				if(r_m_DialogType == null)
				{
					r_m_DialogType = new(this, "m_DialogType");
					r_m_DialogType.SetBelong(this.instance);
				}
				return r_m_DialogType;
			}
		}

		/// <summary>
		/// UnityEngine.Texture2D m_TexHead
		/// </summary>
		protected RUnityEngine.RTexture2D r_m_TexHead;
		public virtual RUnityEngine.RTexture2D Rm_TexHead
		{
			get
			{
				if(r_m_TexHead == null)
				{
					r_m_TexHead = new(this, "m_TexHead");
					r_m_TexHead.SetBelong(this.instance);
				}
				return r_m_TexHead;
			}
		}
		...
		/// <summary>
		/// MyGUI.CustomLabel m_Dialog
		/// </summary>
		protected RMyGUI.RCustomLabel r_m_Dialog;
		public virtual RMyGUI.RCustomLabel Rm_Dialog
		{
			get
			{
				if(r_m_Dialog == null)
				{
					r_m_Dialog = new(this, "m_Dialog");
					r_m_Dialog.SetBelong(this.instance);
				}
				return r_m_Dialog;
			}
		}
		...
		/// <summary>
		/// TextMoveType m_TextMoveType
		/// </summary>
		protected RField r_m_TextMoveType;
		public virtual RField Rm_TextMoveType
		{
			get
			{
				if(r_m_TextMoveType == null)
				{
					r_m_TextMoveType = new(this, "m_TextMoveType");
					r_m_TextMoveType.SetBelong(this.instance);
				}
				return r_m_TextMoveType;
			}
		}
		...
		/// <summary>
		/// System.Single m_fTextSpeed
		/// </summary>
		protected RField r_m_fTextSpeed;
		public virtual RField Rm_fTextSpeed
		{
			get
			{
				if(r_m_fTextSpeed == null)
				{
					r_m_fTextSpeed = new(this, "m_fTextSpeed");
					r_m_fTextSpeed.SetBelong(this.instance);
				}
				return r_m_fTextSpeed;
			}
		}

		/// <summary>
		/// System.Single m_fMaxShowTime
		/// </summary>
		protected RField r_m_fMaxShowTime;
		public virtual RField Rm_fMaxShowTime
		{
			get
			{
				if(r_m_fMaxShowTime == null)
				{
					r_m_fMaxShowTime = new(this, "m_fMaxShowTime");
					r_m_fMaxShowTime.SetBelong(this.instance);
				}
				return r_m_fMaxShowTime;
			}
		}

		/// <summary>
		/// System.Single m_fDelayTime
		/// </summary>
		protected RField r_m_fDelayTime;
		public virtual RField Rm_fDelayTime
		{
			get
			{
				if(r_m_fDelayTime == null)
				{
					r_m_fDelayTime = new(this, "m_fDelayTime");
					r_m_fDelayTime.SetBelong(this.instance);
				}
				return r_m_fDelayTime;
			}
		}

		/// <summary>
		/// System.Single m_fFadeinTime
		/// </summary>
		protected RField r_m_fFadeinTime;
		public virtual RField Rm_fFadeinTime
		{
			get
			{
				if(r_m_fFadeinTime == null)
				{
					r_m_fFadeinTime = new(this, "m_fFadeinTime");
					r_m_fFadeinTime.SetBelong(this.instance);
				}
				return r_m_fFadeinTime;
			}
		}

		/// <summary>
		/// System.Single m_fFadeoutTime
		/// </summary>
		protected RField r_m_fFadeoutTime;
		public virtual RField Rm_fFadeoutTime
		{
			get
			{
				if(r_m_fFadeoutTime == null)
				{
					r_m_fFadeoutTime = new(this, "m_fFadeoutTime");
					r_m_fFadeoutTime.SetBelong(this.instance);
				}
				return r_m_fFadeoutTime;
			}
		}
		...
		/// <summary>
		/// System.Single m_fAlphaTime
		/// </summary>
		protected RField r_m_fAlphaTime;
		public virtual RField Rm_fAlphaTime
		{
			get
			{
				if(r_m_fAlphaTime == null)
				{
					r_m_fAlphaTime = new(this, "m_fAlphaTime");
					r_m_fAlphaTime.SetBelong(this.instance);
				}
				return r_m_fAlphaTime;
			}
		}
		...
		/// <summary>
		/// System.Boolean m_bShowing
		/// </summary>
		protected RField r_m_bShowing;
		public virtual RField Rm_bShowing
		{
			get
			{
				if(r_m_bShowing == null)
				{
					r_m_bShowing = new(this, "m_bShowing");
					r_m_bShowing.SetBelong(this.instance);
				}
				return r_m_bShowing;
			}
		}
		...
		/// <summary>
		/// System.Boolean m_bWaitingClose
		/// </summary>
		protected RField r_m_bWaitingClose;
		public virtual RField Rm_bWaitingClose
		{
			get
			{
				if(r_m_bWaitingClose == null)
				{
					r_m_bWaitingClose = new(this, "m_bWaitingClose");
					r_m_bWaitingClose.SetBelong(this.instance);
				}
				return r_m_bWaitingClose;
			}
		}

		/// <summary>
		/// System.Boolean m_bClick
		/// </summary>
		protected RField r_m_bClick;
		public virtual RField Rm_bClick
		{
			get
			{
				if(r_m_bClick == null)
				{
					r_m_bClick = new(this, "m_bClick");
					r_m_bClick.SetBelong(this.instance);
				}
				return r_m_bClick;
			}
		}
		...
		/// <summary>
		/// System.Boolean m_bShowRight
		/// </summary>
		protected RField r_m_bShowRight;
		public virtual RField Rm_bShowRight
		{
			get
			{
				if(r_m_bShowRight == null)
				{
					r_m_bShowRight = new(this, "m_bShowRight");
					r_m_bShowRight.SetBelong(this.instance);
				}
				return r_m_bShowRight;
			}
		}

		/// <summary>
		/// UnityEngine.Transform m_RefTransform
		/// </summary>
		protected RUnityEngine.RTransform r_m_RefTransform;
		public virtual RUnityEngine.RTransform Rm_RefTransform
		{
			get
			{
				if(r_m_RefTransform == null)
				{
					r_m_RefTransform = new(this, "m_RefTransform");
					r_m_RefTransform.SetBelong(this.instance);
				}
				return r_m_RefTransform;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RRect r_m_Rect;
		public virtual RUnityEngine.RRect Rm_Rect
		{
			get
			{
				if(r_m_Rect == null)
				{
					r_m_Rect = new(this, "m_Rect");
					r_m_Rect.SetBelong(this.instance);
				}
				return r_m_Rect;
			}
		}
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.String,System.Int32] <>f__switch$map31
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RDictionary<RField, RField> r___2____4__f__switch__9__map31;
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__2____4__f__switch__9__map31
		{
			get
			{
				if(r___2____4__f__switch__9__map31 == null)
				{
					r___2____4__f__switch__9__map31 = new( ReleactionUtils.GetType("DialogScript"), "<>f__switch$map31");
					r___2____4__f__switch__9__map31.SetBelong(null);
				}
				return r___2____4__f__switch__9__map31;
			}
		}
		...
		/// <summary>
		/// Void Initial(SceneMovieDialogCmd, System.String, System.String, UnityEngine.Texture2D, UnityEngine.Texture2D, Boolean, Boolean)
		/// </summary>
		protected RMethod r_RInitial_SceneMovieDialogCmd_String_String_Texture2D_Texture2D_Boolean_Boolean;
		public virtual RMethod RInitial_SceneMovieDialogCmd_String_String_Texture2D_Texture2D_Boolean_Boolean
		{
			get
			{
				if(r_RInitial_SceneMovieDialogCmd_String_String_Texture2D_Texture2D_Boolean_Boolean == null)
				{
					r_RInitial_SceneMovieDialogCmd_String_String_Texture2D_Texture2D_Boolean_Boolean = new(this, "Initial", 0, typeof(SceneMovieDialogCmd), typeof(System.String), typeof(System.String), typeof(UnityEngine.Texture2D), typeof(UnityEngine.Texture2D), typeof(System.Boolean), typeof(System.Boolean));
					r_RInitial_SceneMovieDialogCmd_String_String_Texture2D_Texture2D_Boolean_Boolean.SetBelong(this.instance);
				}
				return r_RInitial_SceneMovieDialogCmd_String_String_Texture2D_Texture2D_Boolean_Boolean;
			}
		}

		/// <summary>
		/// Void InitScreenDialog(System.String, Single, Single)
		/// </summary>
		protected RMethod r_RInitScreenDialog_String_Single_Single;
		public virtual RMethod RInitScreenDialog_String_Single_Single
		{
			get
			{
				if(r_RInitScreenDialog_String_Single_Single == null)
				{
					r_RInitScreenDialog_String_Single_Single = new(this, "InitScreenDialog", 0, typeof(System.String), typeof(System.Single), typeof(System.Single));
					r_RInitScreenDialog_String_Single_Single.SetBelong(this.instance);
				}
				return r_RInitScreenDialog_String_Single_Single;
			}
		}

		/// <summary>
		/// Void InitFixedDialog(System.String, System.String, UnityEngine.Texture2D, UnityEngine.Texture2D)
		/// </summary>
		protected RMethod r_RInitFixedDialog_String_String_Texture2D_Texture2D;
		public virtual RMethod RInitFixedDialog_String_String_Texture2D_Texture2D
		{
			get
			{
				if(r_RInitFixedDialog_String_String_Texture2D_Texture2D == null)
				{
					r_RInitFixedDialog_String_String_Texture2D_Texture2D = new(this, "InitFixedDialog", 0, typeof(System.String), typeof(System.String), typeof(UnityEngine.Texture2D), typeof(UnityEngine.Texture2D));
					r_RInitFixedDialog_String_String_Texture2D_Texture2D.SetBelong(this.instance);
				}
				return r_RInitFixedDialog_String_String_Texture2D_Texture2D;
			}
		}

		/// <summary>
		/// Void InitPopDialog(System.String, System.String, Boolean, Boolean)
		/// </summary>
		protected RMethod r_RInitPopDialog_String_String_Boolean_Boolean;
		public virtual RMethod RInitPopDialog_String_String_Boolean_Boolean
		{
			get
			{
				if(r_RInitPopDialog_String_String_Boolean_Boolean == null)
				{
					r_RInitPopDialog_String_String_Boolean_Boolean = new(this, "InitPopDialog", 0, typeof(System.String), typeof(System.String), typeof(System.Boolean), typeof(System.Boolean));
					r_RInitPopDialog_String_String_Boolean_Boolean.SetBelong(this.instance);
				}
				return r_RInitPopDialog_String_String_Boolean_Boolean;
			}
		}

		/// <summary>
		/// UnityEngine.Vector2 CalcPopDialogPos(Boolean, Boolean, Single, Single, System.String)
		/// </summary>
		protected RMethod r_RCalcPopDialogPos_Boolean_Boolean_Single_Single_String;
		public virtual RMethod RCalcPopDialogPos_Boolean_Boolean_Single_Single_String
		{
			get
			{
				if(r_RCalcPopDialogPos_Boolean_Boolean_Single_Single_String == null)
				{
					r_RCalcPopDialogPos_Boolean_Boolean_Single_Single_String = new(this, "CalcPopDialogPos", 0, typeof(System.Boolean), typeof(System.Boolean), typeof(System.Single), typeof(System.Single), typeof(System.String));
					r_RCalcPopDialogPos_Boolean_Boolean_Single_Single_String.SetBelong(this.instance);
				}
				return r_RCalcPopDialogPos_Boolean_Boolean_Single_Single_String;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator ShowOneText()
		/// </summary>
		protected RMethod r_RShowOneText;
		public virtual RMethod RShowOneText
		{
			get
			{
				if(r_RShowOneText == null)
				{
					r_RShowOneText = new(this, "ShowOneText", 0);
					r_RShowOneText.SetBelong(this.instance);
				}
				return r_RShowOneText;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator ProcessFinish()
		/// </summary>
		protected RMethod r_RProcessFinish;
		public virtual RMethod RProcessFinish
		{
			get
			{
				if(r_RProcessFinish == null)
				{
					r_RProcessFinish = new(this, "ProcessFinish", 0);
					r_RProcessFinish.SetBelong(this.instance);
				}
				return r_RProcessFinish;
			}
		}
		...
		/// Void OnMouseClick()
		/// </summary>
		protected RMethod r_ROnMouseClick;
		public virtual RMethod ROnMouseClick
		{
			get
			{
				if(r_ROnMouseClick == null)
				{
					r_ROnMouseClick = new(this, "OnMouseClick", 0);
					r_ROnMouseClick.SetBelong(this.instance);
				}
				return r_ROnMouseClick;
			}
		}
		...
		/// Void CloseUIWnd()
		/// </summary>
		protected RMethod r_RCloseUIWnd;
		public virtual RMethod RCloseUIWnd
		{
			get
			{
				if(r_RCloseUIWnd == null)
				{
					r_RCloseUIWnd = new(this, "CloseUIWnd", 0);
					r_RCloseUIWnd.SetBelong(this.instance);
				}
				return r_RCloseUIWnd;
			}
		}
        ...
        public RDialogScript() : base("DialogScript")
        {
        }

        public RDialogScript(System.Object instance) : base("DialogScript")
		{
            SetInstance(instance);
		}

        public RDialogScript(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RDialogScript(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void Initial(SceneMovieDialogCmd  @cmd, System.String  @type, System.String  @text, UnityEngine.Texture2D  @headtexture, UnityEngine.Texture2D  @righthead, System.Boolean  @bWait, System.Boolean  @bDown)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cmd, @type, @text, @headtexture, @righthead, @bWait, @bDown};
            var ___result = RInitial_SceneMovieDialogCmd_String_String_Texture2D_Texture2D_Boolean_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void InitScreenDialog(System.String  @text, System.Single  @fadeinTime, System.Single  @fadeoutTime)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text, @fadeinTime, @fadeoutTime};
            var ___result = RInitScreenDialog_String_Single_Single.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void InitFixedDialog(System.String  @charName, System.String  @text, UnityEngine.Texture2D  @headtexture, UnityEngine.Texture2D  @righthead)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@charName, @text, @headtexture, @righthead};
            var ___result = RInitFixedDialog_String_String_Texture2D_Texture2D.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void InitPopDialog(System.String  @text, System.String  @refName, System.Boolean  @bDown, System.Boolean  @bRight)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text, @refName, @bDown, @bRight};
            var ___result = RInitPopDialog_String_String_Boolean_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual UnityEngine.Vector2 CalcPopDialogPos(System.Boolean  @bDown, System.Boolean  @bRight, System.Single  @rectWidth, System.Single  @rectHeight, System.String  @refName)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bDown, @bRight, @rectWidth, @rectHeight, @refName};
            var ___result = RCalcPopDialogPos_Boolean_Boolean_Single_Single_String.Invoke(___genericsType, ___parameters);

            return (UnityEngine.Vector2)___result;
        }


        public virtual System.Collections.IEnumerator ShowOneText()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RShowOneText.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual System.Collections.IEnumerator ProcessFinish()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RProcessFinish.Invoke(___genericsType, ___parameters);
        ...
        public virtual void OnMouseClick()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = ROnMouseClick.Invoke(___genericsType, ___parameters);
        ...
        public virtual void CloseUIWnd()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RCloseUIWnd.Invoke(___genericsType, ___parameters);

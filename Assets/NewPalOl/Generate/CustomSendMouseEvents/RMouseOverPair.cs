...
{public partial class RCustomSendMouseEvents
{
	
	/// <summary>
	/// CustomSendMouseEvents+MouseOverPair
	/// </summary>
    public partial class RMouseOverPair : RMember //
    {
		...
		public static RMethod RComparePair_MouseOverPair_MouseOverPair
		{
			get
			{
				...
				{
					r_RComparePair_MouseOverPair_MouseOverPair = new( ReleactionUtils.GetType("CustomSendMouseEvents+MouseOverPair"), "ComparePair", 0,  ReleactionUtils.GetType("CustomSendMouseEvents+MouseOverPair"),  ReleactionUtils.GetType("CustomSendMouseEvents+MouseOverPair"));
		...
		public static RMethod Rop_Implicit_MouseOverPair
		{
			get
			{
				...
				{
					r_Rop_Implicit_MouseOverPair = new( ReleactionUtils.GetType("CustomSendMouseEvents+MouseOverPair"), "op_Implicit", 0,  ReleactionUtils.GetType("CustomSendMouseEvents+MouseOverPair"));
        ...
        public RMouseOverPair() : base("CustomSendMouseEvents+MouseOverPair")
        {
        }

        public RMouseOverPair(System.Object instance) : base("CustomSendMouseEvents+MouseOverPair")
		{

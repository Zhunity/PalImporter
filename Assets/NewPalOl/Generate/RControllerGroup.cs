...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ControllerGroup
	/// </summary>
    public partial class RControllerGroup : RMember //
    {

		/// <summary>
		/// UnityEngine.GameObject m_weapon
		/// </summary>
		protected RUnityEngine.RGameObject r_m_weapon;
		public virtual RUnityEngine.RGameObject Rm_weapon
		{
			get
			{
				if(r_m_weapon == null)
				{
					r_m_weapon = new(this, "m_weapon");
					r_m_weapon.SetBelong(this.instance);
				}
				return r_m_weapon;
			}
		}
		...
		/// <summary>
		/// UnityEngine.GameObject m_enterPoint
		/// </summary>
		protected RUnityEngine.RGameObject r_m_enterPoint;
		public virtual RUnityEngine.RGameObject Rm_enterPoint
		{
			get
			{
				if(r_m_enterPoint == null)
				{
					r_m_enterPoint = new(this, "m_enterPoint");
					r_m_enterPoint.SetBelong(this.instance);
				}
				return r_m_enterPoint;
			}
		}

		/// <summary>
		/// UnityEngine.GameObject m_NPC
		/// </summary>
		protected RUnityEngine.RGameObject r_m_NPC;
		public virtual RUnityEngine.RGameObject Rm_NPC
		{
			get
			{
				if(r_m_NPC == null)
				{
					r_m_NPC = new(this, "m_NPC");
					r_m_NPC.SetBelong(this.instance);
				}
				return r_m_NPC;
			}
		}
		...
		/// <summary>
		/// UnityEngine.GameObject m_mob
		/// </summary>
		protected RUnityEngine.RGameObject r_m_mob;
		public virtual RUnityEngine.RGameObject Rm_mob
		{
			get
			{
				if(r_m_mob == null)
				{
					r_m_mob = new(this, "m_mob");
					r_m_mob.SetBelong(this.instance);
				}
				return r_m_mob;
			}
		}
		...
		/// <summary>
		/// UnityEngine.GameObject m_boss
		/// </summary>
		protected RUnityEngine.RGameObject r_m_boss;
		public virtual RUnityEngine.RGameObject Rm_boss
		{
			get
			{
				if(r_m_boss == null)
				{
					r_m_boss = new(this, "m_boss");
					r_m_boss.SetBelong(this.instance);
				}
				return r_m_boss;
			}
		}
		...
		/// <summary>
		/// UnityEngine.GameObject m_targetEffect
		/// </summary>
		protected RUnityEngine.RGameObject r_m_targetEffect;
		public virtual RUnityEngine.RGameObject Rm_targetEffect
		{
			get
			{
				if(r_m_targetEffect == null)
				{
					r_m_targetEffect = new(this, "m_targetEffect");
					r_m_targetEffect.SetBelong(this.instance);
				}
				return r_m_targetEffect;
			}
		}

		/// <summary>
		/// UnityEngine.GUISkin m_NameSkin
		/// </summary>
		protected RUnityEngine.RGUISkin r_m_NameSkin;
		public virtual RUnityEngine.RGUISkin Rm_NameSkin
		{
			get
			{
				if(r_m_NameSkin == null)
				{
					r_m_NameSkin = new(this, "m_NameSkin");
					r_m_NameSkin.SetBelong(this.instance);
				}
				return r_m_NameSkin;
			}
		}
        ...
        public RControllerGroup() : base("ControllerGroup")
        {
        }

        public RControllerGroup(System.Object instance) : base("ControllerGroup")
		{
            SetInstance(instance);
		}

        public RControllerGroup(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RControllerGroup(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

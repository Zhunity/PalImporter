...
namespace SMFrame.Editor.Refleaction
{
	...
	/// LevelTrigger
	/// </summary>
    public partial class RLevelTrigger : RMember //
    {

		/// <summary>
		/// System.Boolean TouchOn
		/// </summary>
		protected RField r_TouchOn;
		public virtual RField RTouchOn
		{
			get
			{
				if(r_TouchOn == null)
				{
					r_TouchOn = new(this, "TouchOn");
					r_TouchOn.SetBelong(this.instance);
				}
				return r_TouchOn;
			}
		}
		...
		/// <summary>
		/// System.Single TouchOnTime
		/// </summary>
		protected RField r_TouchOnTime;
		public virtual RField RTouchOnTime
		{
			get
			{
				if(r_TouchOnTime == null)
				{
					r_TouchOnTime = new(this, "TouchOnTime");
					r_TouchOnTime.SetBelong(this.instance);
				}
				return r_TouchOnTime;
			}
		}

		/// <summary>
		/// System.Single TrackRount
		/// </summary>
		protected RField r_TrackRount;
		public virtual RField RTrackRount
		{
			get
			{
				if(r_TrackRount == null)
				{
					r_TrackRount = new(this, "TrackRount");
					r_TrackRount.SetBelong(this.instance);
				}
				return r_TrackRount;
			}
		}
        ...
        public RLevelTrigger() : base("LevelTrigger")
        {
        }

        public RLevelTrigger(System.Object instance) : base("LevelTrigger")
		{
            SetInstance(instance);
		}

        public RLevelTrigger(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RLevelTrigger(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

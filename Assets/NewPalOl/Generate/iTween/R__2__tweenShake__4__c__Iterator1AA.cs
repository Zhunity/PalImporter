...
{public partial class RiTween
{
	...
	/// <summary>
	/// iTween+<tweenShake>c__Iterator1AA
	/// </summary>
    public partial class R__2__tweenShake__4__c__Iterator1AA : RMember //
    {

		/// <summary>
		/// UnityEngine.Vector3 <shakeMagnitude>__0
		/// </summary>
		protected RUnityEngine.RVector3 r___2__shakeMagnitude__4____0;
		public virtual RUnityEngine.RVector3 R__2__shakeMagnitude__4____0
		{
			get
			{
				if(r___2__shakeMagnitude__4____0 == null)
				{
					r___2__shakeMagnitude__4____0 = new(this, "<shakeMagnitude>__0");
					r___2__shakeMagnitude__4____0.SetBelong(this.instance);
				}
				return r___2__shakeMagnitude__4____0;
			}
		}

		/// <summary>
		/// UnityEngine.Vector3 <startingPosition>__1
		/// </summary>
		protected RUnityEngine.RVector3 r___2__startingPosition__4____1;
		public virtual RUnityEngine.RVector3 R__2__startingPosition__4____1
		{
			get
			{
				if(r___2__startingPosition__4____1 == null)
				{
					r___2__startingPosition__4____1 = new(this, "<startingPosition>__1");
					r___2__startingPosition__4____1.SetBelong(this.instance);
				}
				return r___2__startingPosition__4____1;
			}
		}

		/// <summary>
		/// System.Single <curTime>__2
		/// </summary>
		protected RField r___2__curTime__4____2;
		public virtual RField R__2__curTime__4____2
		{
			get
			{
				if(r___2__curTime__4____2 == null)
				{
					r___2__curTime__4____2 = new(this, "<curTime>__2");
					r___2__curTime__4____2.SetBelong(this.instance);
				}
				return r___2__curTime__4____2;
			}
		}

		/// <summary>
		/// UnityEngine.Vector3 <newVector>__3
		/// </summary>
		protected RUnityEngine.RVector3 r___2__newVector__4____3;
		public virtual RUnityEngine.RVector3 R__2__newVector__4____3
		{
			get
			{
				if(r___2__newVector__4____3 == null)
				{
					r___2__newVector__4____3 = new(this, "<newVector>__3");
					r___2__newVector__4____3.SetBelong(this.instance);
				}
				return r___2__newVector__4____3;
			}
		}
        ...
        public R__2__tweenShake__4__c__Iterator1AA() : base("iTween+<tweenShake>c__Iterator1AA")
        {
        }

        public R__2__tweenShake__4__c__Iterator1AA(System.Object instance) : base("iTween+<tweenShake>c__Iterator1AA")
		{
            SetInstance(instance);
		}

        public R__2__tweenShake__4__c__Iterator1AA(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__tweenShake__4__c__Iterator1AA(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

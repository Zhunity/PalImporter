...
{public partial class RiTween
{
	...
	/// <summary>
	/// iTween+<tweenMove>c__Iterator1A1
	/// </summary>
    public partial class R__2__tweenMove__4__c__Iterator1A1 : RMember //
    {

		/// <summary>
		/// UnityEngine.Vector3 <end>__0
		/// </summary>
		protected RUnityEngine.RVector3 r___2__end__4____0;
		public virtual RUnityEngine.RVector3 R__2__end__4____0
		{
			get
			{
				if(r___2__end__4____0 == null)
				{
					r___2__end__4____0 = new(this, "<end>__0");
					r___2__end__4____0.SetBelong(this.instance);
				}
				return r___2__end__4____0;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Vector3 <lastValues>__4
		/// </summary>
		protected RUnityEngine.RVector3 r___2__lastValues__4____4;
		public virtual RUnityEngine.RVector3 R__2__lastValues__4____4
		{
			get
			{
				if(r___2__lastValues__4____4 == null)
				{
					r___2__lastValues__4____4 = new(this, "<lastValues>__4");
					r___2__lastValues__4____4.SetBelong(this.instance);
				}
				return r___2__lastValues__4____4;
			}
		}

		/// <summary>
		/// UnityEngine.Vector3 <newVector>__5
		/// </summary>
		protected RUnityEngine.RVector3 r___2__newVector__4____5;
		public virtual RUnityEngine.RVector3 R__2__newVector__4____5
		{
			get
			{
				if(r___2__newVector__4____5 == null)
				{
					r___2__newVector__4____5 = new(this, "<newVector>__5");
					r___2__newVector__4____5.SetBelong(this.instance);
				}
				return r___2__newVector__4____5;
			}
		}
        ...
        public R__2__tweenMove__4__c__Iterator1A1() : base("iTween+<tweenMove>c__Iterator1A1")
        {
        }

        public R__2__tweenMove__4__c__Iterator1A1(System.Object instance) : base("iTween+<tweenMove>c__Iterator1A1")
		{
            SetInstance(instance);
		}

        public R__2__tweenMove__4__c__Iterator1A1(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__tweenMove__4__c__Iterator1A1(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

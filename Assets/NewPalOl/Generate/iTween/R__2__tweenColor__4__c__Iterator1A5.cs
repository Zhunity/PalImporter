...
{public partial class RiTween
{
	...
	/// <summary>
	/// iTween+<tweenColor>c__Iterator1A5
	/// </summary>
    public partial class R__2__tweenColor__4__c__Iterator1A5 : RMember //
    {

		/// <summary>
		/// UnityEngine.Color <end>__0
		/// </summary>
		protected RUnityEngine.RColor r___2__end__4____0;
		public virtual RUnityEngine.RColor R__2__end__4____0
		{
			get
			{
		...
		/// <summary>
		/// UnityEngine.Color <start>__1
		/// </summary>
		protected RUnityEngine.RColor r___2__start__4____1;
		public virtual RUnityEngine.RColor R__2__start__4____1
		{
			get
			{
				if(r___2__start__4____1 == null)
				{
					r___2__start__4____1 = new(this, "<start>__1");
					r___2__start__4____1.SetBelong(this.instance);
				}
				return r___2__start__4____1;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Color <newColor>__4
		/// </summary>
		protected RUnityEngine.RColor r___2__newColor__4____4;
		public virtual RUnityEngine.RColor R__2__newColor__4____4
		{
			get
			{
				if(r___2__newColor__4____4 == null)
				{
					r___2__newColor__4____4 = new(this, "<newColor>__4");
					r___2__newColor__4____4.SetBelong(this.instance);
				}
				return r___2__newColor__4____4;
			}
		}
        ...
        public R__2__tweenColor__4__c__Iterator1A5() : base("iTween+<tweenColor>c__Iterator1A5")
        {
        }

        public R__2__tweenColor__4__c__Iterator1A5(System.Object instance) : base("iTween+<tweenColor>c__Iterator1A5")
		{
            SetInstance(instance);
		}

        public R__2__tweenColor__4__c__Iterator1A5(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__tweenColor__4__c__Iterator1A5(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

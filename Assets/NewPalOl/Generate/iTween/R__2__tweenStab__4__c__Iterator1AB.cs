...
{public partial class RiTween
{
	...
	/// <summary>
	/// iTween+<tweenStab>c__Iterator1AB
	/// </summary>
    public partial class R__2__tweenStab__4__c__Iterator1AB : RMember //
    {

		/// <summary>
		/// UnityEngine.AudioSource <obj>__0
		/// </summary>
		protected RUnityEngine.RAudioSource r___2__obj__4____0;
		public virtual RUnityEngine.RAudioSource R__2__obj__4____0
		{
			get
			{
				if(r___2__obj__4____0 == null)
				{
					r___2__obj__4____0 = new(this, "<obj>__0");
					r___2__obj__4____0.SetBelong(this.instance);
				}
				return r___2__obj__4____0;
			}
		}
        ...
        public R__2__tweenStab__4__c__Iterator1AB() : base("iTween+<tweenStab>c__Iterator1AB")
        {
        }

        public R__2__tweenStab__4__c__Iterator1AB(System.Object instance) : base("iTween+<tweenStab>c__Iterator1AB")
		{
            SetInstance(instance);
		}

        public R__2__tweenStab__4__c__Iterator1AB(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__tweenStab__4__c__Iterator1AB(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RiTween
{
	...
	/// <summary>
	/// iTween+<Start>c__Iterator19F
	/// </summary>
    public partial class R__2__Start__4__c__Iterator19F : RMember //
    {

		/// <summary>
		/// System.Collections.IEnumerator <$s_2876>__0
		/// </summary>
		protected RSystem.RCollections.RIEnumerator r___2____9__s_2876__4____0;
		public virtual RSystem.RCollections.RIEnumerator R__2____9__s_2876__4____0
		{
			get
			{
				if(r___2____9__s_2876__4____0 == null)
				{
					r___2____9__s_2876__4____0 = new(this, "<$s_2876>__0");
					r___2____9__s_2876__4____0.SetBelong(this.instance);
				}
				return r___2____9__s_2876__4____0;
			}
		}

		/// <summary>
		/// UnityEngine.Transform <child>__1
		/// </summary>
		protected RUnityEngine.RTransform r___2__child__4____1;
		public virtual RUnityEngine.RTransform R__2__child__4____1
		{
			get
			{
				if(r___2__child__4____1 == null)
				{
					r___2__child__4____1 = new(this, "<child>__1");
					r___2__child__4____1.SetBelong(this.instance);
				}
				return r___2__child__4____1;
			}
		}

		/// <summary>
		/// iTween+Arguments <newArgs>__2
		/// </summary>
		protected RiTween.RArguments r___2__newArgs__4____2;
		public virtual RiTween.RArguments R__2__newArgs__4____2
		{
			get
			{
				if(r___2__newArgs__4____2 == null)
				{
					r___2__newArgs__4____2 = new(this, "<newArgs>__2");
					r___2__newArgs__4____2.SetBelong(this.instance);
				}
				return r___2__newArgs__4____2;
			}
		}
        ...
        public R__2__Start__4__c__Iterator19F() : base("iTween+<Start>c__Iterator19F")
        {
        }

        public R__2__Start__4__c__Iterator19F(System.Object instance) : base("iTween+<Start>c__Iterator19F")
		{
            SetInstance(instance);
		}

        public R__2__Start__4__c__Iterator19F(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__Start__4__c__Iterator19F(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

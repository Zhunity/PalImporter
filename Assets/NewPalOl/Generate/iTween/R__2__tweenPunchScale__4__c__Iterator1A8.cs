...
{public partial class RiTween
{
	...
	/// <summary>
	/// iTween+<tweenPunchScale>c__Iterator1A8
	/// </summary>
    public partial class R__2__tweenPunchScale__4__c__Iterator1A8 : RMember //
    {

		/// <summary>
		/// UnityEngine.Vector3 <startScale>__0
		/// </summary>
		protected RUnityEngine.RVector3 r___2__startScale__4____0;
		public virtual RUnityEngine.RVector3 R__2__startScale__4____0
		{
			get
			{
				if(r___2__startScale__4____0 == null)
				{
					r___2__startScale__4____0 = new(this, "<startScale>__0");
					r___2__startScale__4____0.SetBelong(this.instance);
				}
				return r___2__startScale__4____0;
			}
		}
        ...
        public R__2__tweenPunchScale__4__c__Iterator1A8() : base("iTween+<tweenPunchScale>c__Iterator1A8")
        {
        }

        public R__2__tweenPunchScale__4__c__Iterator1A8(System.Object instance) : base("iTween+<tweenPunchScale>c__Iterator1A8")
		{
            SetInstance(instance);
		}

        public R__2__tweenPunchScale__4__c__Iterator1A8(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__tweenPunchScale__4__c__Iterator1A8(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

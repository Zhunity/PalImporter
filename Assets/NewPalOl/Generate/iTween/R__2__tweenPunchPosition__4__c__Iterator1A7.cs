...
{public partial class RiTween
{
	...
	/// <summary>
	/// iTween+<tweenPunchPosition>c__Iterator1A7
	/// </summary>
    public partial class R__2__tweenPunchPosition__4__c__Iterator1A7 : RMember //
    {

		/// <summary>
		/// UnityEngine.Vector3 <startPosition>__0
		/// </summary>
		protected RUnityEngine.RVector3 r___2__startPosition__4____0;
		public virtual RUnityEngine.RVector3 R__2__startPosition__4____0
		{
			get
			{
				if(r___2__startPosition__4____0 == null)
				{
					r___2__startPosition__4____0 = new(this, "<startPosition>__0");
					r___2__startPosition__4____0.SetBelong(this.instance);
				}
				return r___2__startPosition__4____0;
			}
		}

		/// <summary>
		/// System.Single <curTime>__1
		/// </summary>
		protected RField r___2__curTime__4____1;
		public virtual RField R__2__curTime__4____1
		{
			get
			{
				if(r___2__curTime__4____1 == null)
				{
					r___2__curTime__4____1 = new(this, "<curTime>__1");
					r___2__curTime__4____1.SetBelong(this.instance);
				}
				return r___2__curTime__4____1;
			}
		}

		/// <summary>
		/// UnityEngine.Vector3 <newVector>__2
		/// </summary>
		protected RUnityEngine.RVector3 r___2__newVector__4____2;
		public virtual RUnityEngine.RVector3 R__2__newVector__4____2
		{
			get
			{
				if(r___2__newVector__4____2 == null)
				{
					r___2__newVector__4____2 = new(this, "<newVector>__2");
					r___2__newVector__4____2.SetBelong(this.instance);
				}
				return r___2__newVector__4____2;
			}
		}
        ...
        public R__2__tweenPunchPosition__4__c__Iterator1A7() : base("iTween+<tweenPunchPosition>c__Iterator1A7")
        {
        }

        public R__2__tweenPunchPosition__4__c__Iterator1A7(System.Object instance) : base("iTween+<tweenPunchPosition>c__Iterator1A7")
		{
            SetInstance(instance);
		}

        public R__2__tweenPunchPosition__4__c__Iterator1A7(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__tweenPunchPosition__4__c__Iterator1A7(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

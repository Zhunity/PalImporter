...
namespace SMFrame.Editor.Refleaction
{
	...
	/// FarmModelConfig
	/// </summary>
    public partial class RFarmModelConfig : RMember //
    {
        ...
        public RFarmModelConfig() : base("FarmModelConfig")
        {
        }

        public RFarmModelConfig(System.Object instance) : base("FarmModelConfig")
		{
            SetInstance(instance);
		}

        public RFarmModelConfig(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RFarmModelConfig(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

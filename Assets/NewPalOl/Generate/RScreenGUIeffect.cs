...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ScreenGUIeffect
	/// </summary>
    public partial class RScreenGUIeffect : RMember //
    {
        ...
        public RScreenGUIeffect() : base("ScreenGUIeffect")
        {
        }

        public RScreenGUIeffect(System.Object instance) : base("ScreenGUIeffect")
		{
            SetInstance(instance);
		}

        public RScreenGUIeffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RScreenGUIeffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

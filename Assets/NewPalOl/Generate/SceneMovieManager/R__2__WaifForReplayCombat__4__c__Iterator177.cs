...
{public partial class RSceneMovieManager
{
	...
	/// <summary>
	/// SceneMovieManager+<WaifForReplayCombat>c__Iterator177
	/// </summary>
    public partial class R__2__WaifForReplayCombat__4__c__Iterator177 : RMember //
    {
        ...
        public R__2__WaifForReplayCombat__4__c__Iterator177() : base("SceneMovieManager+<WaifForReplayCombat>c__Iterator177")
        {
        }

        public R__2__WaifForReplayCombat__4__c__Iterator177(System.Object instance) : base("SceneMovieManager+<WaifForReplayCombat>c__Iterator177")
		{
            SetInstance(instance);
		}

        public R__2__WaifForReplayCombat__4__c__Iterator177(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__WaifForReplayCombat__4__c__Iterator177(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

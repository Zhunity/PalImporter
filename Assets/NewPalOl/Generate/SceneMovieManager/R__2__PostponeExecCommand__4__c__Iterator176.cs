...
{public partial class RSceneMovieManager
{
	
	/// <summary>
	/// SceneMovieManager+<PostponeExecCommand>c__Iterator176
	/// </summary>
    public partial class R__2__PostponeExecCommand__4__c__Iterator176 : RMember //
    {

		/// <summary>
		/// System.Single fPostpone
		/// </summary>
		protected RField r_fPostpone;
		public virtual RField RfPostpone
		{
			get
			{
				if(r_fPostpone == null)
				{
					r_fPostpone = new(this, "fPostpone");
					r_fPostpone.SetBelong(this.instance);
				}
				return r_fPostpone;
			}
		}
		...
		/// System.Int32 cmdIdx
		/// </summary>
		protected RField r_cmdIdx;
		public virtual RField RcmdIdx
		{
			get
			{
				if(r_cmdIdx == null)
				{
					r_cmdIdx = new(this, "cmdIdx");
					r_cmdIdx.SetBelong(this.instance);
				}
				return r_cmdIdx;
			}
		}
		...
		/// <summary>
		/// SceneMovieCommand <cmd>__0
		/// </summary>
		protected RSceneMovieCommand r___2__cmd__4____0;
		public virtual RSceneMovieCommand R__2__cmd__4____0
		{
			get
			{
				if(r___2__cmd__4____0 == null)
				{
					r___2__cmd__4____0 = new(this, "<cmd>__0");
					r___2__cmd__4____0.SetBelong(this.instance);
				}
				return r___2__cmd__4____0;
			}
		}
		...
		/// System.Single <$>fPostpone
		/// </summary>
		protected RField r___2____9____4__fPostpone;
		public virtual RField R__2____9____4__fPostpone
		{
			get
			{
				if(r___2____9____4__fPostpone == null)
				{
					r___2____9____4__fPostpone = new(this, "<$>fPostpone");
					r___2____9____4__fPostpone.SetBelong(this.instance);
				}
				return r___2____9____4__fPostpone;
			}
		}
		...
		/// System.Int32 <$>cmdIdx
		/// </summary>
		protected RField r___2____9____4__cmdIdx;
		public virtual RField R__2____9____4__cmdIdx
		{
			get
			{
				if(r___2____9____4__cmdIdx == null)
				{
					r___2____9____4__cmdIdx = new(this, "<$>cmdIdx");
					r___2____9____4__cmdIdx.SetBelong(this.instance);
				}
				return r___2____9____4__cmdIdx;
			}
		}

		/// <summary>
		/// SceneMovieManager <>f__this
		/// </summary>
		protected RSceneMovieManager r___2____4__f__this;
		public virtual RSceneMovieManager R__2____4__f__this
		{
			get
			{
        ...
        public R__2__PostponeExecCommand__4__c__Iterator176() : base("SceneMovieManager+<PostponeExecCommand>c__Iterator176")
        {
        }

        public R__2__PostponeExecCommand__4__c__Iterator176(System.Object instance) : base("SceneMovieManager+<PostponeExecCommand>c__Iterator176")
		{
            SetInstance(instance);
		}

        public R__2__PostponeExecCommand__4__c__Iterator176(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__PostponeExecCommand__4__c__Iterator176(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

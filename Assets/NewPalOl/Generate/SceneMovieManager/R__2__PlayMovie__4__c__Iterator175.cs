...
{public partial class RSceneMovieManager
{
	...
	/// <summary>
	/// SceneMovieManager+<PlayMovie>c__Iterator175
	/// </summary>
    public partial class R__2__PlayMovie__4__c__Iterator175 : RMember //
    {

		/// <summary>
		/// GameDefineType.ID <sceneID>__0
		/// </summary>
		protected RGameDefineType.RID r___2__sceneID__4____0;
		public virtual RGameDefineType.RID R__2__sceneID__4____0
		{
			get
			{
				if(r___2__sceneID__4____0 == null)
				{
					r___2__sceneID__4____0 = new(this, "<sceneID>__0");
					r___2__sceneID__4____0.SetBelong(this.instance);
				}
				return r___2__sceneID__4____0;
			}
		}

		/// <summary>
		/// SceneMovieNetConfig <config>__1
		/// </summary>
		protected RSceneMovieNetConfig r___2__config__4____1;
		public virtual RSceneMovieNetConfig R__2__config__4____1
		{
			get
			{
				if(r___2__config__4____1 == null)
				{
					r___2__config__4____1 = new(this, "<config>__1");
					r___2__config__4____1.SetBelong(this.instance);
				}
				return r___2__config__4____1;
			}
		}

		/// <summary>
		/// Message.SCNetMsgPlayMovieNty msg
		/// </summary>
		protected RMessage.RSCNetMsgPlayMovieNty r_msg;
		public virtual RMessage.RSCNetMsgPlayMovieNty Rmsg
		{
			get
			{
				if(r_msg == null)
		...
		/// Message.SCNetMsgPlayMovieNty <$>msg
		/// </summary>
		protected RMessage.RSCNetMsgPlayMovieNty r___2____9____4__msg;
		public virtual RMessage.RSCNetMsgPlayMovieNty R__2____9____4__msg
		{
			get
			{
				if(r___2____9____4__msg == null)
				{
					r___2____9____4__msg = new(this, "<$>msg");
					r___2____9____4__msg.SetBelong(this.instance);
				}
				return r___2____9____4__msg;
			}
		}
        ...
        public R__2__PlayMovie__4__c__Iterator175() : base("SceneMovieManager+<PlayMovie>c__Iterator175")
        {
        }

        public R__2__PlayMovie__4__c__Iterator175(System.Object instance) : base("SceneMovieManager+<PlayMovie>c__Iterator175")
		{
            SetInstance(instance);
		}

        public R__2__PlayMovie__4__c__Iterator175(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__PlayMovie__4__c__Iterator175(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

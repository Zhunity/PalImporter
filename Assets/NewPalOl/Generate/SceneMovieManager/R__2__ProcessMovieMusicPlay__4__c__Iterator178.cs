...
{public partial class RSceneMovieManager
{
	...
	/// <summary>
	/// SceneMovieManager+<ProcessMovieMusicPlay>c__Iterator178
	/// </summary>
    public partial class R__2__ProcessMovieMusicPlay__4__c__Iterator178 : RMember //
    {
        ...
        public R__2__ProcessMovieMusicPlay__4__c__Iterator178() : base("SceneMovieManager+<ProcessMovieMusicPlay>c__Iterator178")
        {
        }

        public R__2__ProcessMovieMusicPlay__4__c__Iterator178(System.Object instance) : base("SceneMovieManager+<ProcessMovieMusicPlay>c__Iterator178")
		{
            SetInstance(instance);
		}

        public R__2__ProcessMovieMusicPlay__4__c__Iterator178(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ProcessMovieMusicPlay__4__c__Iterator178(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

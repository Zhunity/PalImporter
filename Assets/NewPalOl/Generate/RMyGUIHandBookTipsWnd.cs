...
{
	/// <summary>
	/// MyGUIHandBookTipsWnd
	/// </summary>
    public partial class RMyGUIHandBookTipsWnd : RMember //
    {
		...
		/// #oU.#dZ #f
		/// </summary>
		protected R__0__oU.R__0__dZ r___0__f;
		public virtual R__0__oU.R__0__dZ R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__g
		{
			get
			{
				if(r___0__g == null)
				{
					r___0__g = new( ReleactionUtils.GetType("MyGUIHandBookTipsWnd"), "#g");
		...
		/// <summary>
		/// Void #iT(GameDefineType.ID, Int32)
		/// </summary>
		protected RMethod r_R__0__iT_ID_Int32;
		public virtual RMethod R__0__iT_ID_Int32
		{
			get
			{
				if(r_R__0__iT_ID_Int32 == null)
				{
					r_R__0__iT_ID_Int32 = new(this, "#iT", 0, typeof(GameDefineType.ID), typeof(System.Int32));
					r_R__0__iT_ID_Int32.SetBelong(this.instance);
				}
				return r_R__0__iT_ID_Int32;
			}
		}
		...
		/// <summary>
		/// System.String #lT(Int32)
		/// </summary>
		protected RMethod r_R__0__lT_Int32;
		public virtual RMethod R__0__lT_Int32
		{
			get
			{
				if(r_R__0__lT_Int32 == null)
				{
					r_R__0__lT_Int32 = new(this, "#lT", 0, typeof(System.Int32));
					r_R__0__lT_Int32.SetBelong(this.instance);
				}
				return r_R__0__lT_Int32;
			}
		}

		/// <summary>
		/// UnityEngine.Color #mT(Int32)
		/// </summary>
		protected RMethod r_R__0__mT_Int32;
		public virtual RMethod R__0__mT_Int32
		{
			get
			{
				if(r_R__0__mT_Int32 == null)
				{
					r_R__0__mT_Int32 = new(this, "#mT", 0, typeof(System.Int32));
					r_R__0__mT_Int32.SetBelong(this.instance);
				}
				return r_R__0__mT_Int32;
			}
		}
		...
		/// <summary>
		/// Void #5Pd(ILLUSTRATION_INFO)
		/// </summary>
		protected RMethod r_R__0__5Pd_ILLUSTRATION_INFO;
		public virtual RMethod R__0__5Pd_ILLUSTRATION_INFO
		{
			get
			{
				if(r_R__0__5Pd_ILLUSTRATION_INFO == null)
				{
					r_R__0__5Pd_ILLUSTRATION_INFO = new(this, "#5Pd", 0, typeof(ILLUSTRATION_INFO));
					r_R__0__5Pd_ILLUSTRATION_INFO.SetBelong(this.instance);
				}
				return r_R__0__5Pd_ILLUSTRATION_INFO;
			}
		}
		...
		/// Void #6Pd(Pet)
		/// </summary>
		protected RMethod r_R__0__6Pd_Pet;
		public virtual RMethod R__0__6Pd_Pet
		{
			get
			{
				if(r_R__0__6Pd_Pet == null)
				{
					r_R__0__6Pd_Pet = new(this, "#6Pd", 0,  ReleactionUtils.GetType("Pet"));
					r_R__0__6Pd_Pet.SetBelong(this.instance);
				}
				return r_R__0__6Pd_Pet;
			}
		}
        ...
        public RMyGUIHandBookTipsWnd() : base("MyGUIHandBookTipsWnd")
        {
        }

        public RMyGUIHandBookTipsWnd(System.Object instance) : base("MyGUIHandBookTipsWnd")
		{
            SetInstance(instance);
		}

        public RMyGUIHandBookTipsWnd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMyGUIHandBookTipsWnd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__iT(GameDefineType.ID  @id, System.Int32  @type)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id, @type};
            var ___result = R__0__iT_ID_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.String __0__lT(System.Int32  @lvl)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@lvl};
            var ___result = R__0__lT_Int32.Invoke(___genericsType, ___parameters);

            return (System.String)___result;
        }


        public virtual UnityEngine.Color __0__mT(System.Int32  @lvl)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@lvl};
            var ___result = R__0__mT_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__5Pd(ILLUSTRATION_INFO  @illu)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@illu};
            var ___result = R__0__5Pd_ILLUSTRATION_INFO.Invoke(___genericsType, ___parameters);

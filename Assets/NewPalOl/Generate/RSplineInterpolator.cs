...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SplineInterpolator
	/// </summary>
    public partial class RSplineInterpolator : RMember //
    {

		/// <summary>
		/// eEndPointsMode mEndPointsMode
		/// </summary>
		protected RField r_mEndPointsMode;
		public virtual RField RmEndPointsMode
		{
			get
			{
				if(r_mEndPointsMode == null)
				{
					r_mEndPointsMode = new(this, "mEndPointsMode");
					r_mEndPointsMode.SetBelong(this.instance);
				}
				return r_mEndPointsMode;
			}
		}

		/// <summary>
		/// System.Collections.Generic.List`1[SplineInterpolator+SplineNode] mNodes
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RSplineInterpolator.RSplineNode> r_mNodes;
		public virtual RSystem.RCollections.RGeneric.RList<RSplineInterpolator.RSplineNode> RmNodes
		{
			get
			{
				if(r_mNodes == null)
				{
					r_mNodes = new(this, "mNodes");
					r_mNodes.SetBelong(this.instance);
				}
				return r_mNodes;
			}
		}
		...
		/// <summary>
		/// System.Boolean mRotations
		/// </summary>
		protected RField r_mRotations;
		public virtual RField RmRotations
		{
			get
			{
				if(r_mRotations == null)
				{
					r_mRotations = new(this, "mRotations");
					r_mRotations.SetBelong(this.instance);
				}
				return r_mRotations;
			}
		}
		...
		/// </summary>
		protected ROnEndCallback r_mOnEndCallback;
		public virtual ROnEndCallback RmOnEndCallback
		{
			get
			{
				if(r_mOnEndCallback == null)
				{
					r_mOnEndCallback = new(this, "mOnEndCallback");
					r_mOnEndCallback.SetBelong(this.instance);
				}
				return r_mOnEndCallback;
			}
		}

		/// <summary>
		/// System.Single mCurrentTime
		/// </summary>
		protected RField r_mCurrentTime;
		public virtual RField RmCurrentTime
		{
			get
			{
				if(r_mCurrentTime == null)
				{
					r_mCurrentTime = new(this, "mCurrentTime");
					r_mCurrentTime.SetBelong(this.instance);
				}
				return r_mCurrentTime;
			}
		}

		/// <summary>
		/// System.Single mDelateTime
		/// </summary>
		protected RField r_mDelateTime;
		public virtual RField RmDelateTime
		{
			get
			{
				if(r_mDelateTime == null)
				{
					r_mDelateTime = new(this, "mDelateTime");
					r_mDelateTime.SetBelong(this.instance);
				}
				return r_mDelateTime;
			}
		}

		/// <summary>
		/// System.Int32 mCurrentIdx
		/// </summary>
		protected RField r_mCurrentIdx;
		public virtual RField RmCurrentIdx
		{
			get
			{
				if(r_mCurrentIdx == null)
				{
					r_mCurrentIdx = new(this, "mCurrentIdx");
					r_mCurrentIdx.SetBelong(this.instance);
				}
				return r_mCurrentIdx;
			}
		}
		...
		/// <summary>
		/// Void StartInterpolation(OnEndCallback, Boolean, eWrapMode)
		/// </summary>
		protected RMethod r_RStartInterpolation_OnEndCallback_Boolean_eWrapMode;
		public virtual RMethod RStartInterpolation_OnEndCallback_Boolean_eWrapMode
		{
			get
			{
				if(r_RStartInterpolation_OnEndCallback_Boolean_eWrapMode == null)
				{
					r_RStartInterpolation_OnEndCallback_Boolean_eWrapMode = new(this, "StartInterpolation", 0,  ReleactionUtils.GetType("OnEndCallback"), typeof(System.Boolean),  ReleactionUtils.GetType("eWrapMode"));
					r_RStartInterpolation_OnEndCallback_Boolean_eWrapMode.SetBelong(this.instance);
				}
				return r_RStartInterpolation_OnEndCallback_Boolean_eWrapMode;
			}
		}
		...
		/// <summary>
		/// Void AddPoint(UnityEngine.Vector3, UnityEngine.Quaternion, Single, Single, UnityEngine.Vector2)
		/// </summary>
		protected RMethod r_RAddPoint_Vector3_Quaternion_Single_Single_Vector2;
		public virtual RMethod RAddPoint_Vector3_Quaternion_Single_Single_Vector2
		{
			get
			{
				if(r_RAddPoint_Vector3_Quaternion_Single_Single_Vector2 == null)
				{
					r_RAddPoint_Vector3_Quaternion_Single_Single_Vector2 = new(this, "AddPoint", 0, typeof(UnityEngine.Vector3), typeof(UnityEngine.Quaternion), typeof(System.Single), typeof(System.Single), typeof(UnityEngine.Vector2));
					r_RAddPoint_Vector3_Quaternion_Single_Single_Vector2.SetBelong(this.instance);
				}
				return r_RAddPoint_Vector3_Quaternion_Single_Single_Vector2;
			}
		}
		...
		/// Void SetInput()
		/// </summary>
		protected RMethod r_RSetInput;
		public virtual RMethod RSetInput
		{
			get
			{
				if(r_RSetInput == null)
				{
					r_RSetInput = new(this, "SetInput", 0);
					r_RSetInput.SetBelong(this.instance);
				}
				return r_RSetInput;
			}
		}
		...
		/// </summary>
		protected RMethod r_RSetExplicitMode;
		public virtual RMethod RSetExplicitMode
		{
			get
			{
				if(r_RSetExplicitMode == null)
				{
					r_RSetExplicitMode = new(this, "SetExplicitMode", 0);
					r_RSetExplicitMode.SetBelong(this.instance);
				}
				return r_RSetExplicitMode;
			}
		}

		/// <summary>
		/// Void SetAutoCloseMode(Single)
		/// </summary>
		protected RMethod r_RSetAutoCloseMode_Single;
		public virtual RMethod RSetAutoCloseMode_Single
		{
			get
			{
				if(r_RSetAutoCloseMode_Single == null)
				{
					r_RSetAutoCloseMode_Single = new(this, "SetAutoCloseMode", 0, typeof(System.Single));
					r_RSetAutoCloseMode_Single.SetBelong(this.instance);
				}
				return r_RSetAutoCloseMode_Single;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Quaternion GetSquad(Int32, Single)
		/// </summary>
		protected RMethod r_RGetSquad_Int32_Single;
		public virtual RMethod RGetSquad_Int32_Single
		{
			get
			{
				if(r_RGetSquad_Int32_Single == null)
				{
					r_RGetSquad_Int32_Single = new(this, "GetSquad", 0, typeof(System.Int32), typeof(System.Single));
					r_RGetSquad_Int32_Single.SetBelong(this.instance);
				}
				return r_RGetSquad_Int32_Single;
			}
		}

		/// <summary>
		/// UnityEngine.Vector3 GetHermiteInternal(Int32, Single)
		/// </summary>
		protected RMethod r_RGetHermiteInternal_Int32_Single;
		public virtual RMethod RGetHermiteInternal_Int32_Single
		{
			get
			{
				if(r_RGetHermiteInternal_Int32_Single == null)
				{
					r_RGetHermiteInternal_Int32_Single = new(this, "GetHermiteInternal", 0, typeof(System.Int32), typeof(System.Single));
					r_RGetHermiteInternal_Int32_Single.SetBelong(this.instance);
				}
				return r_RGetHermiteInternal_Int32_Single;
			}
		}

		/// <summary>
		/// UnityEngine.Vector3 GetHermiteAtTime(Single)
		/// </summary>
		protected RMethod r_RGetHermiteAtTime_Single;
		public virtual RMethod RGetHermiteAtTime_Single
		{
			get
			{
				if(r_RGetHermiteAtTime_Single == null)
				{
					r_RGetHermiteAtTime_Single = new(this, "GetHermiteAtTime", 0, typeof(System.Single));
					r_RGetHermiteAtTime_Single.SetBelong(this.instance);
				}
				return r_RGetHermiteAtTime_Single;
			}
		}
        ...
        public RSplineInterpolator() : base("SplineInterpolator")
        {
        }

        public RSplineInterpolator(System.Object instance) : base("SplineInterpolator")
		{
            SetInstance(instance);
		}

        public RSplineInterpolator(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSplineInterpolator(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void AddPoint(UnityEngine.Vector3  @pos, UnityEngine.Quaternion  @quat, System.Single  @timeInSeconds, System.Single  @delateInSeconds, UnityEngine.Vector2  @easeInOut)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pos, @quat, @timeInSeconds, @delateInSeconds, @easeInOut};
            var ___result = RAddPoint_Vector3_Quaternion_Single_Single_Vector2.Invoke(___genericsType, ___parameters);
        ...
        public virtual void SetInput()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RSetInput.Invoke(___genericsType, ___parameters);
        ...
        public virtual void SetExplicitMode()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RSetExplicitMode.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void SetAutoCloseMode(System.Single  @joiningPointTime)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@joiningPointTime};
            var ___result = RSetAutoCloseMode_Single.Invoke(___genericsType, ___parameters);
        ...
        public virtual UnityEngine.Quaternion GetSquad(System.Int32  @idxFirstPoint, System.Single  @t)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@idxFirstPoint, @t};
            var ___result = RGetSquad_Int32_Single.Invoke(___genericsType, ___parameters);

            return (UnityEngine.Quaternion)___result;
        }


        public virtual UnityEngine.Vector3 GetHermiteInternal(System.Int32  @idxFirstPoint, System.Single  @t)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@idxFirstPoint, @t};
            var ___result = RGetHermiteInternal_Int32_Single.Invoke(___genericsType, ___parameters);

            return (UnityEngine.Vector3)___result;
        }


        public virtual UnityEngine.Vector3 GetHermiteAtTime(System.Single  @timeParam)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@timeParam};
            var ___result = RGetHermiteAtTime_Single.Invoke(___genericsType, ___parameters);

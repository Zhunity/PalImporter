...
namespace SMFrame.Editor.Refleaction
{
	...
	/// FadeoutOccluder
	/// </summary>
    public partial class RFadeoutOccluder : RMember //
    {

		/// <summary>
		/// UnityEngine.LayerMask layerMask
		/// </summary>
		protected RUnityEngine.RLayerMask r_layerMask;
		public virtual RUnityEngine.RLayerMask RlayerMask
		{
			get
			{
				if(r_layerMask == null)
		...
		/// <summary>
		/// UnityEngine.Transform mCameraTransform
		/// </summary>
		protected RUnityEngine.RTransform r_mCameraTransform;
		public virtual RUnityEngine.RTransform RmCameraTransform
		{
			get
			{
				if(r_mCameraTransform == null)
				{
					r_mCameraTransform = new(this, "mCameraTransform");
					r_mCameraTransform.SetBelong(this.instance);
				}
				return r_mCameraTransform;
			}
		}
		...
		/// </summary>
		protected RField r_occlusionRadius;
		public virtual RField RocclusionRadius
		{
			get
			{
				if(r_occlusionRadius == null)
				{
					r_occlusionRadius = new(this, "occlusionRadius");
					r_occlusionRadius.SetBelong(this.instance);
				}
				return r_occlusionRadius;
			}
		}

		/// <summary>
		/// System.Single fadeOutAlpha
		/// </summary>
		protected RField r_fadeOutAlpha;
		public virtual RField RfadeOutAlpha
		{
			get
			{
				if(r_fadeOutAlpha == null)
				{
					r_fadeOutAlpha = new(this, "fadeOutAlpha");
					r_fadeOutAlpha.SetBelong(this.instance);
				}
				return r_fadeOutAlpha;
			}
		}

		/// <summary>
		/// UnityEngine.Shader mTransparentShader
		/// </summary>
		protected RUnityEngine.RShader r_mTransparentShader;
		public virtual RUnityEngine.RShader RmTransparentShader
		{
			get
			{
				if(r_mTransparentShader == null)
				{
					r_mTransparentShader = new(this, "mTransparentShader");
					r_mTransparentShader.SetBelong(this.instance);
				}
				return r_mTransparentShader;
			}
		}

		/// <summary>
		/// UnityEngine.Shader mTransparentTreeShader
		/// </summary>
		protected RUnityEngine.RShader r_mTransparentTreeShader;
		public virtual RUnityEngine.RShader RmTransparentTreeShader
		{
			get
			{
				if(r_mTransparentTreeShader == null)
				{
					r_mTransparentTreeShader = new(this, "mTransparentTreeShader");
					r_mTransparentTreeShader.SetBelong(this.instance);
				}
				return r_mTransparentTreeShader;
			}
		}

		/// <summary>
		/// System.Collections.ArrayList fadedOutObjects
		/// </summary>
		protected RSystem.RCollections.RArrayList r_fadedOutObjects;
		public virtual RSystem.RCollections.RArrayList RfadedOutObjects
		{
			get
			{
				if(r_fadedOutObjects == null)
				{
					r_fadedOutObjects = new(this, "fadedOutObjects");
					r_fadedOutObjects.SetBelong(this.instance);
				}
				return r_fadedOutObjects;
			}
		}

		/// <summary>
		/// System.Boolean m_enable
		/// </summary>
		protected RField r_m_enable;
		public virtual RField Rm_enable
		{
			get
			{
				if(r_m_enable == null)
				{
					r_m_enable = new(this, "m_enable");
					r_m_enable.SetBelong(this.instance);
				}
				return r_m_enable;
			}
		}
		...
		/// <summary>
		/// System.Single m_deltaTime
		/// </summary>
		protected RField r_m_deltaTime;
		public virtual RField Rm_deltaTime
		{
			get
			{
				if(r_m_deltaTime == null)
				{
					r_m_deltaTime = new(this, "m_deltaTime");
					r_m_deltaTime.SetBelong(this.instance);
				}
				return r_m_deltaTime;
			}
		}
		...
		/// <summary>
		/// Void EnableFadeoutOccluder(Boolean)
		/// </summary>
		protected RMethod r_REnableFadeoutOccluder_Boolean;
		public virtual RMethod REnableFadeoutOccluder_Boolean
		{
			get
			{
				if(r_REnableFadeoutOccluder_Boolean == null)
				{
					r_REnableFadeoutOccluder_Boolean = new(this, "EnableFadeoutOccluder", 0, typeof(System.Boolean));
					r_REnableFadeoutOccluder_Boolean.SetBelong(this.instance);
				}
				return r_REnableFadeoutOccluder_Boolean;
			}
		}

		/// <summary>
		/// FadeoutLOSInfo FindLosInfo(UnityEngine.Renderer)
		/// </summary>
		protected RMethod r_RFindLosInfo_Renderer;
		public virtual RMethod RFindLosInfo_Renderer
		{
			get
			{
				if(r_RFindLosInfo_Renderer == null)
				{
					r_RFindLosInfo_Renderer = new(this, "FindLosInfo", 0, typeof(UnityEngine.Renderer));
					r_RFindLosInfo_Renderer.SetBelong(this.instance);
				}
				return r_RFindLosInfo_Renderer;
			}
		}
        ...
        public RFadeoutOccluder() : base("FadeoutOccluder")
        {
        }

        public RFadeoutOccluder(System.Object instance) : base("FadeoutOccluder")
		{
            SetInstance(instance);
		}

        public RFadeoutOccluder(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RFadeoutOccluder(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void EnableFadeoutOccluder(System.Boolean  @bl)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bl};
            var ___result = REnableFadeoutOccluder_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Object FindLosInfo(UnityEngine.Renderer  @r)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@r};
            var ___result = RFindLosInfo_Renderer.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SwitchCombatMusic
	/// </summary>
    public partial class RSwitchCombatMusic : RMember //
    {
		...
		/// <summary>
		/// System.Single volumn
		/// </summary>
		protected RField r_volumn;
		public virtual RField Rvolumn
		{
			get
			{
				if(r_volumn == null)
				{
					r_volumn = new(this, "volumn");
					r_volumn.SetBelong(this.instance);
				}
				return r_volumn;
			}
		}
        ...
        public RSwitchCombatMusic() : base("SwitchCombatMusic")
        {
        }

        public RSwitchCombatMusic(System.Object instance) : base("SwitchCombatMusic")
		{
            SetInstance(instance);
		}

        public RSwitchCombatMusic(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSwitchCombatMusic(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

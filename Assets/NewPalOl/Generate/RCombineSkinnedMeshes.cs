...
namespace SMFrame.Editor.Refleaction
{
	...
	/// </summary>
    public partial class RCombineSkinnedMeshes : RMember //
    {

		/// <summary>
		/// System.Boolean castShadows
		/// </summary>
		protected RField r_castShadows;
		public virtual RField RcastShadows
		{
			get
			{
				if(r_castShadows == null)
				{
					r_castShadows = new(this, "castShadows");
		...
		/// </summary>
		protected RField r_receiveShadows;
		public virtual RField RreceiveShadows
		{
			get
			{
				if(r_receiveShadows == null)
				{
					r_receiveShadows = new(this, "receiveShadows");
		...
		/// <summary>
		/// System.Int32 VERTEX_NUMBER
		/// </summary>
		protected static RField r_VERTEX_NUMBER;
		public static RField RVERTEX_NUMBER
		{
			get
			{
				if(r_VERTEX_NUMBER == null)
				{
					r_VERTEX_NUMBER = new(typeof(CombineSkinnedMeshes), "VERTEX_NUMBER");
					r_VERTEX_NUMBER.SetBelong(null);
				}
		...
		/// <summary>
		/// System.Int32 BONE_NUMBER
		/// </summary>
		protected static RField r_BONE_NUMBER;
		public static RField RBONE_NUMBER
		{
			get
			{
				if(r_BONE_NUMBER == null)
				{
					r_BONE_NUMBER = new(typeof(CombineSkinnedMeshes), "BONE_NUMBER");
					r_BONE_NUMBER.SetBelong(null);
				}
				return r_BONE_NUMBER;
			}
		}

		/// <summary>
		/// System.Collections.ArrayList myMaterials
		/// </summary>
		protected RSystem.RCollections.RArrayList r_myMaterials;
		public virtual RSystem.RCollections.RArrayList RmyMaterials
		{
			get
			{
				if(r_myMaterials == null)
				{
					r_myMaterials = new(this, "myMaterials");
					r_myMaterials.SetBelong(this.instance);
				}
				return r_myMaterials;
			}
		}

		/// <summary>
		/// UnityEngine.Transform[] totalBones
		/// </summary>
		protected RFieldArray<RUnityEngine.RTransform> r_totalBones;
		public virtual RFieldArray<RUnityEngine.RTransform> RtotalBones
		{
			get
			{
				if(r_totalBones == null)
				{
					r_totalBones = new(this, "totalBones");
					r_totalBones.SetBelong(this.instance);
				}
				return r_totalBones;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Matrix4x4[] totalBindPoses
		/// </summary>
		protected RFieldArray<RUnityEngine.RMatrix4x4> r_totalBindPoses;
		public virtual RFieldArray<RUnityEngine.RMatrix4x4> RtotalBindPoses
		{
			get
			{
				if(r_totalBindPoses == null)
				{
					r_totalBindPoses = new(this, "totalBindPoses");
					r_totalBindPoses.SetBelong(this.instance);
				}
				return r_totalBindPoses;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Component[] revertComponent(UnityEngine.Component[])
		/// </summary>
		protected static RMethod r_RrevertComponent_ComponentArray;
		public static RMethod RrevertComponent_ComponentArray
		{
			get
			{
				if(r_RrevertComponent_ComponentArray == null)
				{
					r_RrevertComponent_ComponentArray = new(typeof(CombineSkinnedMeshes), "revertComponent", 0, typeof(UnityEngine.Component).MakeArrayType());
					r_RrevertComponent_ComponentArray.SetBelong(null);
				}
				return r_RrevertComponent_ComponentArray;
			}
		}

		/// <summary>
		/// UnityEngine.BoneWeight recalculateIndexes(UnityEngine.BoneWeight, System.Collections.Hashtable, UnityEngine.Transform[])
		/// </summary>
		protected static RMethod r_RrecalculateIndexes_BoneWeight_Hashtable_TransformArray;
		public static RMethod RrecalculateIndexes_BoneWeight_Hashtable_TransformArray
		{
			get
			{
				if(r_RrecalculateIndexes_BoneWeight_Hashtable_TransformArray == null)
				{
					r_RrecalculateIndexes_BoneWeight_Hashtable_TransformArray = new(typeof(CombineSkinnedMeshes), "recalculateIndexes", 0, typeof(UnityEngine.BoneWeight), typeof(System.Collections.Hashtable), typeof(UnityEngine.Transform).MakeArrayType());
					r_RrecalculateIndexes_BoneWeight_Hashtable_TransformArray.SetBelong(null);
				}
				return r_RrecalculateIndexes_BoneWeight_Hashtable_TransformArray;
			}
		}
        ...
        public RCombineSkinnedMeshes() : base("CombineSkinnedMeshes")
        {
        }

        public RCombineSkinnedMeshes(System.Object instance) : base("CombineSkinnedMeshes")
		{
            SetInstance(instance);
		}

        public RCombineSkinnedMeshes(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCombineSkinnedMeshes(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public static UnityEngine.Component[] revertComponent(UnityEngine.Component[]  @comp)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@comp};
            var ___result = RrevertComponent_ComponentArray.Invoke(___genericsType, ___parameters);

            return (UnityEngine.Component[])___result;
        }


        public static UnityEngine.BoneWeight recalculateIndexes(UnityEngine.BoneWeight  @bw, System.Collections.Hashtable  @boneHash, UnityEngine.Transform[]  @meshBones)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bw, @boneHash, @meshBones};
            var ___result = RrecalculateIndexes_BoneWeight_Hashtable_TransformArray.Invoke(___genericsType, ___parameters);

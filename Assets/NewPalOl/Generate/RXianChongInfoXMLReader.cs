...
{
	/// <summary>
	/// XianChongInfoXMLReader
	/// </summary>
    public partial class RXianChongInfoXMLReader : RMember //
    {
        ...
        public RXianChongInfoXMLReader() : base("XianChongInfoXMLReader")
        {
        }

        public RXianChongInfoXMLReader(System.Object instance) : base("XianChongInfoXMLReader")
		{
            SetInstance(instance);
		}

        public RXianChongInfoXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXianChongInfoXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

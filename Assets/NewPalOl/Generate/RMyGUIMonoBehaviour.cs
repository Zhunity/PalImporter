...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MyGUIMonoBehaviour
	/// </summary>
    public partial class RMyGUIMonoBehaviour : RMember //
    {

		/// <summary>
		/// MyGUIWindow _targetWndow
		/// </summary>
		protected RMyGUIWindow r__targetWndow;
		public virtual RMyGUIWindow R_targetWndow
		{
			get
			{
				if(r__targetWndow == null)
				{
					r__targetWndow = new(this, "_targetWndow");
					r__targetWndow.SetBelong(this.instance);
				}
				return r__targetWndow;
			}
		}

		/// <summary>
		/// UnityEngine.GUISkin WindowSkin
		/// </summary>
		protected RUnityEngine.RGUISkin r_WindowSkin;
		public virtual RUnityEngine.RGUISkin RWindowSkin
		{
			get
			{
				if(r_WindowSkin == null)
				{
					r_WindowSkin = new(this, "WindowSkin");
					r_WindowSkin.SetBelong(this.instance);
				}
				return r_WindowSkin;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RGUISkin r_TemplateSkin;
		public virtual RUnityEngine.RGUISkin RTemplateSkin
		{
			get
			{
				if(r_TemplateSkin == null)
				{
					r_TemplateSkin = new(this, "TemplateSkin");
					r_TemplateSkin.SetBelong(this.instance);
				}
				return r_TemplateSkin;
			}
		}

		/// <summary>
		/// UnityEngine.GUIStyle WindowStyle
		/// </summary>
		protected RUnityEngine.RGUIStyle r_WindowStyle;
		public virtual RUnityEngine.RGUIStyle RWindowStyle
		{
			get
			{
				if(r_WindowStyle == null)
				{
					r_WindowStyle = new(this, "WindowStyle");
					r_WindowStyle.SetBelong(this.instance);
				}
				return r_WindowStyle;
			}
		}
		...
		public static RMethod RDestroy_Object
		{
			get
			{
				...
				{
					r_RDestroy_Object = new( ReleactionUtils.GetType("MyGUIMonoBehaviour"), "Destroy", 0, typeof(UnityEngine.Object));
        ...
        public RMyGUIMonoBehaviour() : base("MyGUIMonoBehaviour")
        {
        }

        public RMyGUIMonoBehaviour(System.Object instance) : base("MyGUIMonoBehaviour")
		{
            SetInstance(instance);
		}

        public RMyGUIMonoBehaviour(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMyGUIMonoBehaviour(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

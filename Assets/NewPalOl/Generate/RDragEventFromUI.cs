...
namespace SMFrame.Editor.Refleaction
{
	...
	/// DragEventFromUI
	/// </summary>
    public partial class RDragEventFromUI : RMember //
    {

		/// <summary>
		/// MyGUI.ElementBase _UIelement
		/// </summary>
		protected RMyGUI.RElementBase r__UIelement;
		public virtual RMyGUI.RElementBase R_UIelement
		{
			get
			{
				if(r__UIelement == null)
				{
					r__UIelement = new(this, "_UIelement");
					r__UIelement.SetBelong(this.instance);
				}
				return r__UIelement;
			}
		}
		...
		public virtual RUnityEngine.RRenderTexture Rrt
		{
			get
			{
				if(r_rt == null)
		...
		/// <summary>
		/// DragEventFromUI+MouseOverPair[] m_OldMouseDrag
		/// </summary>
		protected RFieldArray<RDragEventFromUI.RMouseOverPair> r_m_OldMouseDrag;
		public virtual RFieldArray<RDragEventFromUI.RMouseOverPair> Rm_OldMouseDrag
		{
			get
			{
				if(r_m_OldMouseDrag == null)
				{
					r_m_OldMouseDrag = new(this, "m_OldMouseDrag");
					r_m_OldMouseDrag.SetBelong(this.instance);
				}
				return r_m_OldMouseDrag;
			}
		}

		/// <summary>
		/// DragEventFromUI+MouseOverPair[] m_OldMouseOver
		/// </summary>
		protected RFieldArray<RDragEventFromUI.RMouseOverPair> r_m_OldMouseOver;
		public virtual RFieldArray<RDragEventFromUI.RMouseOverPair> Rm_OldMouseOver
		{
			get
			{
				if(r_m_OldMouseOver == null)
				{
					r_m_OldMouseOver = new(this, "m_OldMouseOver");
					r_m_OldMouseOver.SetBelong(this.instance);
				}
				return r_m_OldMouseOver;
			}
		}
		...
		/// <summary>
		/// Void Init(MyGUI.ElementBase, UnityEngine.RenderTexture)
		/// </summary>
		protected RMethod r_RInit_ElementBase_RenderTexture;
		public virtual RMethod RInit_ElementBase_RenderTexture
		{
			get
			{
				if(r_RInit_ElementBase_RenderTexture == null)
				{
					r_RInit_ElementBase_RenderTexture = new(this, "Init", 0, typeof(MyGUI.ElementBase), typeof(UnityEngine.RenderTexture));
					r_RInit_ElementBase_RenderTexture.SetBelong(this.instance);
				}
				return r_RInit_ElementBase_RenderTexture;
			}
		}

		/// <summary>
		/// Void DoSendMouseEvents(UnityEngine.Vector2, UnityEngine.Camera)
		/// </summary>
		protected RMethod r_RDoSendMouseEvents_Vector2_Camera;
		public virtual RMethod RDoSendMouseEvents_Vector2_Camera
		{
			get
			{
				if(r_RDoSendMouseEvents_Vector2_Camera == null)
				{
					r_RDoSendMouseEvents_Vector2_Camera = new(this, "DoSendMouseEvents", 0, typeof(UnityEngine.Vector2), typeof(UnityEngine.Camera));
					r_RDoSendMouseEvents_Vector2_Camera.SetBelong(this.instance);
				}
				return r_RDoSendMouseEvents_Vector2_Camera;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Vector2 ScreenToGUIPoint(UnityEngine.Vector2)
		/// </summary>
		protected RMethod r_RScreenToGUIPoint_Vector2;
		public virtual RMethod RScreenToGUIPoint_Vector2
		{
			get
			{
				if(r_RScreenToGUIPoint_Vector2 == null)
				{
					r_RScreenToGUIPoint_Vector2 = new(this, "ScreenToGUIPoint", 0, typeof(UnityEngine.Vector2));
					r_RScreenToGUIPoint_Vector2.SetBelong(this.instance);
				}
				return r_RScreenToGUIPoint_Vector2;
			}
		}
        ...
        public RDragEventFromUI() : base("DragEventFromUI")
        {
        }

        public RDragEventFromUI(System.Object instance) : base("DragEventFromUI")
		{
            SetInstance(instance);
		}

        public RDragEventFromUI(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RDragEventFromUI(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Init(MyGUI.ElementBase  @_UIelement, UnityEngine.RenderTexture  @rt)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@_UIelement, @rt};
            var ___result = RInit_ElementBase_RenderTexture.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void DoSendMouseEvents(UnityEngine.Vector2  @cameraScreenPos, UnityEngine.Camera  @cam)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cameraScreenPos, @cam};
            var ___result = RDoSendMouseEvents_Vector2_Camera.Invoke(___genericsType, ___parameters);
        ...
        public virtual UnityEngine.Vector2 ScreenToGUIPoint(UnityEngine.Vector2  @pos)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pos};
            var ___result = RScreenToGUIPoint_Vector2.Invoke(___genericsType, ___parameters);

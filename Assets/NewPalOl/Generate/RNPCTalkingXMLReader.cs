...
namespace SMFrame.Editor.Refleaction
{
	...
	/// NPCTalkingXMLReader
	/// </summary>
    public partial class RNPCTalkingXMLReader : RMember //
    {
        ...
        public RNPCTalkingXMLReader() : base("NPCTalkingXMLReader")
        {
        }

        public RNPCTalkingXMLReader(System.Object instance) : base("NPCTalkingXMLReader")
		{
            SetInstance(instance);
		}

        public RNPCTalkingXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RNPCTalkingXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

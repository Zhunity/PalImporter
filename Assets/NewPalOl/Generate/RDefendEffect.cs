...
namespace SMFrame.Editor.Refleaction
{
	...
	/// DefendEffect
	/// </summary>
    public partial class RDefendEffect : RMember //
    {
        ...
        public RDefendEffect() : base("DefendEffect")
        {
        }

        public RDefendEffect(System.Object instance) : base("DefendEffect")
		{
            SetInstance(instance);
		}

        public RDefendEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RDefendEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

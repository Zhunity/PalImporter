...
namespace SMFrame.Editor.Refleaction
{
	...
	/// EventHandlering
	/// </summary>
    public partial class REventHandlering : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Object, System.EventArgs, Single)
		/// </summary>
		protected RMethod r_RInvoke_Object_EventArgs_Single;
		public virtual RMethod RInvoke_Object_EventArgs_Single
		{
			get
			{
				if(r_RInvoke_Object_EventArgs_Single == null)
				{
					r_RInvoke_Object_EventArgs_Single = new(this, "Invoke", 0, typeof(System.Object), typeof(System.EventArgs), typeof(System.Single));
					r_RInvoke_Object_EventArgs_Single.SetBelong(this.instance);
				}
				return r_RInvoke_Object_EventArgs_Single;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, System.EventArgs, Single, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Object_EventArgs_Single_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object_EventArgs_Single_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object_EventArgs_Single_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object_EventArgs_Single_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object), typeof(System.EventArgs), typeof(System.Single), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object_EventArgs_Single_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object_EventArgs_Single_AsyncCallback_Object;
			}
		}
        ...
        public REventHandlering() : base("EventHandlering")
        {
        }

        public REventHandlering(System.Object instance) : base("EventHandlering")
		{
            SetInstance(instance);
		}

        public REventHandlering(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REventHandlering(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Object  @sender, System.EventArgs  @e, System.Single  @perCent)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @e, @perCent};
            var ___result = RInvoke_Object_EventArgs_Single.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.Object  @sender, System.EventArgs  @e, System.Single  @perCent, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @e, @perCent, @callback, @object};
            var ___result = RBeginInvoke_Object_EventArgs_Single_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

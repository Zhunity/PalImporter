...
{
	/// <summary>
	/// ObjcectBasedMotionBlur
	/// </summary>
    public partial class RObjcectBasedMotionBlur : RMember //
    {

		/// <summary>
		/// System.Single blurAmount
		/// </summary>
		protected RField r_blurAmount;
		public virtual RField RblurAmount
		{
			get
			{
				if(r_blurAmount == null)
				{
					r_blurAmount = new(this, "blurAmount");
					r_blurAmount.SetBelong(this.instance);
				}
				return r_blurAmount;
			}
		}
		...
		/// <summary>
		/// System.Boolean extraBlur
		/// </summary>
		protected RField r_extraBlur;
		public virtual RField RextraBlur
		{
			get
			{
				if(r_extraBlur == null)
				{
					r_extraBlur = new(this, "extraBlur");
					r_extraBlur.SetBelong(this.instance);
				}
				return r_extraBlur;
			}
		}
		...
		/// <summary>
		/// UnityEngine.RenderTexture accumTexture
		/// </summary>
		protected RUnityEngine.RRenderTexture r_accumTexture;
		public virtual RUnityEngine.RRenderTexture RaccumTexture
		{
			get
			{
				if(r_accumTexture == null)
				{
					r_accumTexture = new(this, "accumTexture");
					r_accumTexture.SetBelong(this.instance);
				}
				return r_accumTexture;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Shader copyShader
		/// </summary>
		protected RUnityEngine.RShader r_copyShader;
		public virtual RUnityEngine.RShader RcopyShader
		{
			get
			{
				if(r_copyShader == null)
				{
					r_copyShader = new(this, "copyShader");
					r_copyShader.SetBelong(this.instance);
				}
				return r_copyShader;
			}
		}
		...
		/// <summary>
		/// UnityEngine.GameObject shaderCamera
		/// </summary>
		protected RUnityEngine.RGameObject r_shaderCamera;
		public virtual RUnityEngine.RGameObject RshaderCamera
		{
			get
			{
		...
		/// <summary>
		/// Void ObjectBaseMotionBlurGenerate()
		/// </summary>
		protected RMethod r_RObjectBaseMotionBlurGenerate;
		public virtual RMethod RObjectBaseMotionBlurGenerate
		{
			get
			{
				if(r_RObjectBaseMotionBlurGenerate == null)
				{
					r_RObjectBaseMotionBlurGenerate = new(this, "ObjectBaseMotionBlurGenerate", 0);
					r_RObjectBaseMotionBlurGenerate.SetBelong(this.instance);
				}
				return r_RObjectBaseMotionBlurGenerate;
			}
		}
        ...
        public RObjcectBasedMotionBlur() : base("ObjcectBasedMotionBlur")
        {
        }

        public RObjcectBasedMotionBlur(System.Object instance) : base("ObjcectBasedMotionBlur")
		{
            SetInstance(instance);
		}

        public RObjcectBasedMotionBlur(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RObjcectBasedMotionBlur(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void ObjectBaseMotionBlurGenerate()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RObjectBaseMotionBlurGenerate.Invoke(___genericsType, ___parameters);

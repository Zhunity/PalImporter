...
namespace SMFrame.Editor.Refleaction
{
	...
	/// LocalPlayCombatCtr
	/// </summary>
    public partial class RLocalPlayCombatCtr : RMember //
    {
		...
		/// Void _OnBattlePK()
		/// </summary>
		protected RMethod r_R_OnBattlePK;
		public virtual RMethod R_OnBattlePK
		{
			get
			{
				if(r_R_OnBattlePK == null)
				{
					r_R_OnBattlePK = new(this, "_OnBattlePK", 0);
					r_R_OnBattlePK.SetBelong(this.instance);
				}
				return r_R_OnBattlePK;
			}
		}
		...
		/// Void _OnBattleOver()
		/// </summary>
		protected RMethod r_R_OnBattleOver;
		public virtual RMethod R_OnBattleOver
		{
			get
			{
				if(r_R_OnBattleOver == null)
				{
					r_R_OnBattleOver = new(this, "_OnBattleOver", 0);
					r_R_OnBattleOver.SetBelong(this.instance);
				}
				return r_R_OnBattleOver;
			}
		}
		...
		/// <summary>
		/// Void SetOrigPosition(UnityEngine.Vector3)
		/// </summary>
		protected RMethod r_RSetOrigPosition_Vector3;
		public virtual RMethod RSetOrigPosition_Vector3
		{
			get
			{
				if(r_RSetOrigPosition_Vector3 == null)
				{
					r_RSetOrigPosition_Vector3 = new(this, "SetOrigPosition", 0, typeof(UnityEngine.Vector3));
					r_RSetOrigPosition_Vector3.SetBelong(this.instance);
				}
				return r_RSetOrigPosition_Vector3;
			}
		}
        ...
        public RLocalPlayCombatCtr() : base("LocalPlayCombatCtr")
        {
        }

        public RLocalPlayCombatCtr(System.Object instance) : base("LocalPlayCombatCtr")
		{
            SetInstance(instance);
		}

        public RLocalPlayCombatCtr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RLocalPlayCombatCtr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void _OnBattlePK()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R_OnBattlePK.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void _OnBattleOver()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R_OnBattleOver.Invoke(___genericsType, ___parameters);
        ...
        public virtual void SetOrigPosition(UnityEngine.Vector3  @pos)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pos};
            var ___result = RSetOrigPosition_Vector3.Invoke(___genericsType, ___parameters);

...
{public partial class RAssetBundleDownloader
{
	...
	/// <summary>
	/// AssetBundleDownloader+ABLoadedHandler
	/// </summary>
    public partial class RABLoadedHandler : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Object, ABLoadedArgs)
		/// </summary>
		protected RMethod r_RInvoke_Object_ABLoadedArgs;
		public virtual RMethod RInvoke_Object_ABLoadedArgs
		{
			get
			{
				if(r_RInvoke_Object_ABLoadedArgs == null)
				{
					r_RInvoke_Object_ABLoadedArgs = new(this, "Invoke", 0, typeof(System.Object),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadedArgs"));
					r_RInvoke_Object_ABLoadedArgs.SetBelong(this.instance);
				}
				return r_RInvoke_Object_ABLoadedArgs;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, ABLoadedArgs, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Object_ABLoadedArgs_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object_ABLoadedArgs_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object_ABLoadedArgs_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object_ABLoadedArgs_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadedArgs"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object_ABLoadedArgs_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object_ABLoadedArgs_AsyncCallback_Object;
			}
		}
        ...
        public RABLoadedHandler() : base("AssetBundleDownloader+ABLoadedHandler")
        {
        }

        public RABLoadedHandler(System.Object instance) : base("AssetBundleDownloader+ABLoadedHandler")
		{
            SetInstance(instance);
		}

        public RABLoadedHandler(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RABLoadedHandler(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

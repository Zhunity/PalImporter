...
{public partial class RAssetBundleDownloader
{
	...
	/// <summary>
	/// AssetBundleDownloader+ABLoadingHandler
	/// </summary>
    public partial class RABLoadingHandler : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Object, ABLoadingArgs)
		/// </summary>
		protected RMethod r_RInvoke_Object_ABLoadingArgs;
		public virtual RMethod RInvoke_Object_ABLoadingArgs
		{
			get
			{
				if(r_RInvoke_Object_ABLoadingArgs == null)
				{
					r_RInvoke_Object_ABLoadingArgs = new(this, "Invoke", 0, typeof(System.Object),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadingArgs"));
					r_RInvoke_Object_ABLoadingArgs.SetBelong(this.instance);
				}
				return r_RInvoke_Object_ABLoadingArgs;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, ABLoadingArgs, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Object_ABLoadingArgs_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object_ABLoadingArgs_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object_ABLoadingArgs_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object_ABLoadingArgs_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadingArgs"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object_ABLoadingArgs_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object_ABLoadingArgs_AsyncCallback_Object;
			}
		}
        ...
        public RABLoadingHandler() : base("AssetBundleDownloader+ABLoadingHandler")
        {
        }

        public RABLoadingHandler(System.Object instance) : base("AssetBundleDownloader+ABLoadingHandler")
		{
            SetInstance(instance);
		}

        public RABLoadingHandler(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RABLoadingHandler(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

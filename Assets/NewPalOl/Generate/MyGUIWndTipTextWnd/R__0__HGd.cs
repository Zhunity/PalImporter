...
{public partial class RMyGUIWndTipTextWnd
{
	
	/// <summary>
	/// MyGUIWndTipTextWnd+#HGd
	/// </summary>
    public partial class R__0__HGd : RMember //
    {
		...
		/// <summary>
		/// System.String Invoke(MyGUIWindow, MyGUI.ElementBase)
		/// </summary>
		protected RMethod r_RInvoke_MyGUIWindow_ElementBase;
		public virtual RMethod RInvoke_MyGUIWindow_ElementBase
		{
			get
			{
				if(r_RInvoke_MyGUIWindow_ElementBase == null)
				{
					r_RInvoke_MyGUIWindow_ElementBase = new(this, "Invoke", 0,  ReleactionUtils.GetType("MyGUIWindow"), typeof(MyGUI.ElementBase));
					r_RInvoke_MyGUIWindow_ElementBase.SetBelong(this.instance);
				}
				return r_RInvoke_MyGUIWindow_ElementBase;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(MyGUIWindow, MyGUI.ElementBase, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_MyGUIWindow_ElementBase_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_MyGUIWindow_ElementBase_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_MyGUIWindow_ElementBase_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_MyGUIWindow_ElementBase_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("MyGUIWindow"), typeof(MyGUI.ElementBase), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_MyGUIWindow_ElementBase_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_MyGUIWindow_ElementBase_AsyncCallback_Object;
			}
		}
        ...
        public R__0__HGd() : base("MyGUIWndTipTextWnd+#HGd")
        {
        }

        public R__0__HGd(System.Object instance) : base("MyGUIWndTipTextWnd+#HGd")
		{

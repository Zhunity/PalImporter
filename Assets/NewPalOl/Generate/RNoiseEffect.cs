...
namespace SMFrame.Editor.Refleaction
{
	...
	/// NoiseEffect
	/// </summary>
    public partial class RNoiseEffect : RMember //
    {

		/// <summary>
		/// System.Boolean monochrome
		/// </summary>
		protected RField r_monochrome;
		public virtual RField Rmonochrome
		{
			get
			{
				if(r_monochrome == null)
				{
					r_monochrome = new(this, "monochrome");
					r_monochrome.SetBelong(this.instance);
				}
				return r_monochrome;
			}
		}
		...
		/// <summary>
		/// System.Boolean rgbFallback
		/// </summary>
		protected RField r_rgbFallback;
		public virtual RField RrgbFallback
		{
			get
			{
				if(r_rgbFallback == null)
				{
					r_rgbFallback = new(this, "rgbFallback");
					r_rgbFallback.SetBelong(this.instance);
				}
				return r_rgbFallback;
			}
		}

		/// <summary>
		/// System.Single grainIntensityMin
		/// </summary>
		protected RField r_grainIntensityMin;
		public virtual RField RgrainIntensityMin
		{
			get
			{
				if(r_grainIntensityMin == null)
				{
					r_grainIntensityMin = new(this, "grainIntensityMin");
					r_grainIntensityMin.SetBelong(this.instance);
				}
				return r_grainIntensityMin;
			}
		}

		/// <summary>
		/// System.Single grainIntensityMax
		/// </summary>
		protected RField r_grainIntensityMax;
		public virtual RField RgrainIntensityMax
		{
			get
			{
				if(r_grainIntensityMax == null)
				{
					r_grainIntensityMax = new(this, "grainIntensityMax");
					r_grainIntensityMax.SetBelong(this.instance);
				}
				return r_grainIntensityMax;
			}
		}

		/// <summary>
		/// System.Single grainSize
		/// </summary>
		protected RField r_grainSize;
		public virtual RField RgrainSize
		{
			get
			{
				if(r_grainSize == null)
				{
					r_grainSize = new(this, "grainSize");
					r_grainSize.SetBelong(this.instance);
				}
				return r_grainSize;
			}
		}
		...
		/// <summary>
		/// System.Single scratchIntensityMin
		/// </summary>
		protected RField r_scratchIntensityMin;
		public virtual RField RscratchIntensityMin
		{
			get
			{
				if(r_scratchIntensityMin == null)
				{
					r_scratchIntensityMin = new(this, "scratchIntensityMin");
					r_scratchIntensityMin.SetBelong(this.instance);
				}
				return r_scratchIntensityMin;
			}
		}

		/// <summary>
		/// System.Single scratchIntensityMax
		/// </summary>
		protected RField r_scratchIntensityMax;
		public virtual RField RscratchIntensityMax
		{
			get
			{
				if(r_scratchIntensityMax == null)
				{
					r_scratchIntensityMax = new(this, "scratchIntensityMax");
					r_scratchIntensityMax.SetBelong(this.instance);
				}
				return r_scratchIntensityMax;
			}
		}

		/// <summary>
		/// System.Single scratchFPS
		/// </summary>
		protected RField r_scratchFPS;
		public virtual RField RscratchFPS
		{
			get
			{
				if(r_scratchFPS == null)
				{
					r_scratchFPS = new(this, "scratchFPS");
					r_scratchFPS.SetBelong(this.instance);
				}
				return r_scratchFPS;
			}
		}
		...
		/// <summary>
		/// System.Single scratchJitter
		/// </summary>
		protected RField r_scratchJitter;
		public virtual RField RscratchJitter
		{
			get
			{
				if(r_scratchJitter == null)
				{
					r_scratchJitter = new(this, "scratchJitter");
					r_scratchJitter.SetBelong(this.instance);
				}
				return r_scratchJitter;
			}
		}

		/// <summary>
		/// UnityEngine.Texture grainTexture
		/// </summary>
		protected RUnityEngine.RTexture r_grainTexture;
		public virtual RUnityEngine.RTexture RgrainTexture
		{
			get
			{
				if(r_grainTexture == null)
				{
					r_grainTexture = new(this, "grainTexture");
					r_grainTexture.SetBelong(this.instance);
				}
				return r_grainTexture;
			}
		}

		/// <summary>
		/// UnityEngine.Texture scratchTexture
		/// </summary>
		protected RUnityEngine.RTexture r_scratchTexture;
		public virtual RUnityEngine.RTexture RscratchTexture
		{
			get
			{
				if(r_scratchTexture == null)
				{
					r_scratchTexture = new(this, "scratchTexture");
					r_scratchTexture.SetBelong(this.instance);
				}
				return r_scratchTexture;
			}
		}

		/// <summary>
		/// UnityEngine.Shader shaderRGB
		/// </summary>
		protected RUnityEngine.RShader r_shaderRGB;
		public virtual RUnityEngine.RShader RshaderRGB
		{
			get
			{
				if(r_shaderRGB == null)
				{
					r_shaderRGB = new(this, "shaderRGB");
					r_shaderRGB.SetBelong(this.instance);
				}
				return r_shaderRGB;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Shader shaderYUV
		/// </summary>
		protected RUnityEngine.RShader r_shaderYUV;
		public virtual RUnityEngine.RShader RshaderYUV
		{
			get
			{
				if(r_shaderYUV == null)
				{
					r_shaderYUV = new(this, "shaderYUV");
					r_shaderYUV.SetBelong(this.instance);
				}
				return r_shaderYUV;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Material m_MaterialRGB
		/// </summary>
		protected RUnityEngine.RMaterial r_m_MaterialRGB;
		public virtual RUnityEngine.RMaterial Rm_MaterialRGB
		{
			get
			{
				if(r_m_MaterialRGB == null)
				{
					r_m_MaterialRGB = new(this, "m_MaterialRGB");
					r_m_MaterialRGB.SetBelong(this.instance);
				}
				return r_m_MaterialRGB;
			}
		}

		/// <summary>
		/// UnityEngine.Material m_MaterialYUV
		/// </summary>
		protected RUnityEngine.RMaterial r_m_MaterialYUV;
		public virtual RUnityEngine.RMaterial Rm_MaterialYUV
		{
			get
			{
				if(r_m_MaterialYUV == null)
				{
					r_m_MaterialYUV = new(this, "m_MaterialYUV");
					r_m_MaterialYUV.SetBelong(this.instance);
				}
				return r_m_MaterialYUV;
			}
		}

		/// <summary>
		/// System.Single scratchTimeLeft
		/// </summary>
		protected RField r_scratchTimeLeft;
		public virtual RField RscratchTimeLeft
		{
			get
			{
				if(r_scratchTimeLeft == null)
				{
					r_scratchTimeLeft = new(this, "scratchTimeLeft");
					r_scratchTimeLeft.SetBelong(this.instance);
				}
				return r_scratchTimeLeft;
			}
		}

		/// <summary>
		/// System.Single scratchX
		/// </summary>
		protected RField r_scratchX;
		public virtual RField RscratchX
		{
			get
			{
				if(r_scratchX == null)
				{
					r_scratchX = new(this, "scratchX");
					r_scratchX.SetBelong(this.instance);
				}
				return r_scratchX;
			}
		}
		...
		/// <summary>
		/// System.Single scratchY
		/// </summary>
		protected RField r_scratchY;
		public virtual RField RscratchY
		{
			get
			{
				if(r_scratchY == null)
				{
					r_scratchY = new(this, "scratchY");
					r_scratchY.SetBelong(this.instance);
				}
				return r_scratchY;
			}
		}
		...
		/// </summary>
		protected RMethod r_RSanitizeParameters;
		public virtual RMethod RSanitizeParameters
		{
			get
			{
				if(r_RSanitizeParameters == null)
				{
					r_RSanitizeParameters = new(this, "SanitizeParameters", 0);
					r_RSanitizeParameters.SetBelong(this.instance);
				}
				return r_RSanitizeParameters;
			}
		}
        ...
        public RNoiseEffect() : base("NoiseEffect")
        {
        }

        public RNoiseEffect(System.Object instance) : base("NoiseEffect")
		{
            SetInstance(instance);
		}

        public RNoiseEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RNoiseEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void SanitizeParameters()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RSanitizeParameters.Invoke(___genericsType, ___parameters);

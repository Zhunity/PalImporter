...
namespace SMFrame.Editor.Refleaction
{
	...
	/// RainBox
	/// </summary>
    public partial class RRainBox : RMember //
    {

		/// <summary>
		/// UnityEngine.MeshFilter mf
		/// </summary>
		protected RUnityEngine.RMeshFilter r_mf;
		public virtual RUnityEngine.RMeshFilter Rmf
		{
			get
			{
				if(r_mf == null)
		...
		/// </summary>
		protected RUnityEngine.RVector3 r_defaultPosition;
		public virtual RUnityEngine.RVector3 RdefaultPosition
		{
			get
			{
				if(r_defaultPosition == null)
				{
					r_defaultPosition = new(this, "defaultPosition");
					r_defaultPosition.SetBelong(this.instance);
				}
				return r_defaultPosition;
			}
		}
		...
		/// RainManager manager
		/// </summary>
		protected RRainManager r_manager;
		public virtual RRainManager Rmanager
		{
			get
			{
				if(r_manager == null)
				{
					r_manager = new(this, "manager");
		...
		/// </summary>
		protected RUnityEngine.RTransform r_cachedTransform;
		public virtual RUnityEngine.RTransform RcachedTransform
		{
			get
			{
				if(r_cachedTransform == null)
				{
					r_cachedTransform = new(this, "cachedTransform");
					r_cachedTransform.SetBelong(this.instance);
				}
				return r_cachedTransform;
			}
		}

		/// <summary>
		/// System.Single cachedMinY
		/// </summary>
		protected RField r_cachedMinY;
		public virtual RField RcachedMinY
		{
			get
			{
				if(r_cachedMinY == null)
				{
					r_cachedMinY = new(this, "cachedMinY");
					r_cachedMinY.SetBelong(this.instance);
				}
				return r_cachedMinY;
			}
		}
		...
		/// <summary>
		/// System.Single cachedAreaHeight
		/// </summary>
		protected RField r_cachedAreaHeight;
		public virtual RField RcachedAreaHeight
		{
			get
			{
				if(r_cachedAreaHeight == null)
				{
					r_cachedAreaHeight = new(this, "cachedAreaHeight");
					r_cachedAreaHeight.SetBelong(this.instance);
				}
				return r_cachedAreaHeight;
			}
		}

		/// <summary>
		/// System.Single cachedFallingSpeed
		/// </summary>
		protected RField r_cachedFallingSpeed;
		public virtual RField RcachedFallingSpeed
		{
			get
			{
				if(r_cachedFallingSpeed == null)
				{
					r_cachedFallingSpeed = new(this, "cachedFallingSpeed");
					r_cachedFallingSpeed.SetBelong(this.instance);
				}
				return r_cachedFallingSpeed;
			}
		}

		/// <summary>
		/// System.Single cachePosY
		/// </summary>
		protected RField r_cachePosY;
		public virtual RField RcachePosY
		{
			get
			{
				if(r_cachePosY == null)
				{
					r_cachePosY = new(this, "cachePosY");
					r_cachePosY.SetBelong(this.instance);
				}
				return r_cachePosY;
			}
		}
        ...
        public RRainBox() : base("RainBox")
        {
        }

        public RRainBox(System.Object instance) : base("RainBox")
		{
            SetInstance(instance);
		}

        public RRainBox(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RRainBox(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

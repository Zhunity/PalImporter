...
{public partial class RTribeManager
{
	...
	/// <summary>
	/// TribeManager+TribemoraleXMLReader
	/// </summary>
    public partial class RTribemoraleXMLReader : RMember //
    {
        ...
        public RTribemoraleXMLReader() : base("TribeManager+TribemoraleXMLReader")
        {
        }

        public RTribemoraleXMLReader(System.Object instance) : base("TribeManager+TribemoraleXMLReader")
		{
            SetInstance(instance);
		}

        public RTribemoraleXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RTribemoraleXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

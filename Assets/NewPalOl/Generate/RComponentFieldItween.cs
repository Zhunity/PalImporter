...
{
	/// <summary>
	/// ComponentFieldItween
	/// </summary>
    public partial class RComponentFieldItween : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.List`1[ItweenItem] ItweenItemList
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RItweenItem> r_ItweenItemList;
		public virtual RSystem.RCollections.RGeneric.RList<RItweenItem> RItweenItemList
		{
			get
			{
				if(r_ItweenItemList == null)
				{
					r_ItweenItemList = new(this, "ItweenItemList");
					r_ItweenItemList.SetBelong(this.instance);
				}
				return r_ItweenItemList;
			}
		}
		...
		/// <summary>
		/// Void ComponentFieldItweenSet(Int32)
		/// </summary>
		protected RMethod r_RComponentFieldItweenSet_Int32;
		public virtual RMethod RComponentFieldItweenSet_Int32
		{
			get
			{
				if(r_RComponentFieldItweenSet_Int32 == null)
				{
					r_RComponentFieldItweenSet_Int32 = new(this, "ComponentFieldItweenSet", 0, typeof(System.Int32));
					r_RComponentFieldItweenSet_Int32.SetBelong(this.instance);
				}
				return r_RComponentFieldItweenSet_Int32;
			}
		}

		/// <summary>
		/// Void ComponentFieldItweenSet(Int32, ItweenItem)
		/// </summary>
		protected RMethod r_RComponentFieldItweenSet_Int32_ItweenItem;
		public virtual RMethod RComponentFieldItweenSet_Int32_ItweenItem
		{
			get
			{
				if(r_RComponentFieldItweenSet_Int32_ItweenItem == null)
				{
					r_RComponentFieldItweenSet_Int32_ItweenItem = new(this, "ComponentFieldItweenSet", 0, typeof(System.Int32), typeof(ItweenItem));
					r_RComponentFieldItweenSet_Int32_ItweenItem.SetBelong(this.instance);
				}
				return r_RComponentFieldItweenSet_Int32_ItweenItem;
			}
		}
        ...
        public RComponentFieldItween() : base("ComponentFieldItween")
        {
        }

        public RComponentFieldItween(System.Object instance) : base("ComponentFieldItween")
		{
            SetInstance(instance);
		}

        public RComponentFieldItween(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RComponentFieldItween(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void ComponentFieldItweenSet(System.Int32  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time};
            var ___result = RComponentFieldItweenSet_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void ComponentFieldItweenSet(System.Int32  @time, ItweenItem  @item)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time, @item};
            var ___result = RComponentFieldItweenSet_Int32_ItweenItem.Invoke(___genericsType, ___parameters);

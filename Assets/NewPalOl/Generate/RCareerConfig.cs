...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CareerConfig
	/// </summary>
    public partial class RCareerConfig : RMember //
    {
        ...
        public RCareerConfig() : base("CareerConfig")
        {
        }

        public RCareerConfig(System.Object instance) : base("CareerConfig")
		{
            SetInstance(instance);
		}

        public RCareerConfig(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCareerConfig(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{
	/// <summary>
	/// Water3UnderwaterEffect
	/// </summary>
    public partial class RWater3UnderwaterEffect : RMember //
    {

		/// <summary>
		/// System.Single m_UnderwaterColorFade
		/// </summary>
		protected RField r_m_UnderwaterColorFade;
		public virtual RField Rm_UnderwaterColorFade
		{
			get
			{
				if(r_m_UnderwaterColorFade == null)
				{
					r_m_UnderwaterColorFade = new(this, "m_UnderwaterColorFade");
					r_m_UnderwaterColorFade.SetBelong(this.instance);
				}
				return r_m_UnderwaterColorFade;
			}
		}

		/// <summary>
		/// UnityEngine.Shader m_UnderwaterShader
		/// </summary>
		protected RUnityEngine.RShader r_m_UnderwaterShader;
		public virtual RUnityEngine.RShader Rm_UnderwaterShader
		{
			get
			{
				if(r_m_UnderwaterShader == null)
				{
					r_m_UnderwaterShader = new(this, "m_UnderwaterShader");
					r_m_UnderwaterShader.SetBelong(this.instance);
				}
				return r_m_UnderwaterShader;
			}
		}
		...
		/// Water3 m_Water
		/// </summary>
		protected RWater3 r_m_Water;
		public virtual RWater3 Rm_Water
		{
			get
			{
				if(r_m_Water == null)
				{
					r_m_Water = new(this, "m_Water");
					r_m_Water.SetBelong(this.instance);
				}
				return r_m_Water;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Color m_BlendColor
		/// </summary>
		protected RUnityEngine.RColor r_m_BlendColor;
		public virtual RUnityEngine.RColor Rm_BlendColor
		{
			get
			{
				if(r_m_BlendColor == null)
				{
					r_m_BlendColor = new(this, "m_BlendColor");
					r_m_BlendColor.SetBelong(this.instance);
				}
				return r_m_BlendColor;
			}
		}

		/// <summary>
		/// UnityEngine.Material m_UnderwaterMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r_m_UnderwaterMaterial;
		public virtual RUnityEngine.RMaterial Rm_UnderwaterMaterial
		{
			get
			{
				if(r_m_UnderwaterMaterial == null)
				{
					r_m_UnderwaterMaterial = new(this, "m_UnderwaterMaterial");
					r_m_UnderwaterMaterial.SetBelong(this.instance);
				}
				return r_m_UnderwaterMaterial;
			}
		}
        ...
        public RWater3UnderwaterEffect() : base("Water3UnderwaterEffect")
        {
        }

        public RWater3UnderwaterEffect(System.Object instance) : base("Water3UnderwaterEffect")
		{
            SetInstance(instance);
		}

        public RWater3UnderwaterEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RWater3UnderwaterEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MyGUIWndTipTextWnd
	/// </summary>
    public partial class RMyGUIWndTipTextWnd : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[MyGUI.ElementBase,MyGUIWndTipTextWnd+#HGd] #f
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RMyGUI.RElementBase, RMyGUIWndTipTextWnd.R__0__HGd> r___0__f;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RMyGUI.RElementBase, RMyGUIWndTipTextWnd.R__0__HGd> R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// MyGUIWindow #g
		/// </summary>
		protected RMyGUIWindow r___0__g;
		public virtual RMyGUIWindow R__0__g
		{
			get
			{
				if(r___0__g == null)
		...
		/// <summary>
		/// Boolean IsUpdateTipsAlways
		/// </summary>
		protected RProperty r_R__0__OZd;
		public virtual RProperty R__0__OZd
		{
			get
			{
				if(r_R__0__OZd == null)
				{
					r_R__0__OZd = new(this, "IsUpdateTipsAlways", -1);
		...
		public virtual RProperty R__0__kw
		{
			get
			{
				if(r_R__0__kw == null)
				{
					r_R__0__kw = new(this, "CycleTime", -1);
		...
		/// <summary>
		/// Void #sb(MyGUIWindow, MyGUI.ElementBase, Boolean)
		/// </summary>
		protected RMethod r_R__0__sb_MyGUIWindow_ElementBase_Boolean;
		public virtual RMethod R__0__sb_MyGUIWindow_ElementBase_Boolean
		{
			get
			{
				if(r_R__0__sb_MyGUIWindow_ElementBase_Boolean == null)
				{
					r_R__0__sb_MyGUIWindow_ElementBase_Boolean = new(this, "#sb", 0,  ReleactionUtils.GetType("MyGUIWindow"), typeof(MyGUI.ElementBase), typeof(System.Boolean));
					r_R__0__sb_MyGUIWindow_ElementBase_Boolean.SetBelong(this.instance);
				}
				return r_R__0__sb_MyGUIWindow_ElementBase_Boolean;
			}
		}

		/// <summary>
		/// Void #sb(MyGUIWindow, MyGUI.ElementBase)
		/// </summary>
		protected RMethod r_R__0__sb_MyGUIWindow_ElementBase;
		public virtual RMethod R__0__sb_MyGUIWindow_ElementBase
		{
			get
			{
				if(r_R__0__sb_MyGUIWindow_ElementBase == null)
				{
					r_R__0__sb_MyGUIWindow_ElementBase = new(this, "#sb", 0,  ReleactionUtils.GetType("MyGUIWindow"), typeof(MyGUI.ElementBase));
					r_R__0__sb_MyGUIWindow_ElementBase.SetBelong(this.instance);
				}
				return r_R__0__sb_MyGUIWindow_ElementBase;
			}
		}
		...
		/// <summary>
		/// Void #dw(MyGUIWindow, MyGUI.ElementBase)
		/// </summary>
		protected RMethod r_R__0__dw_MyGUIWindow_ElementBase;
		public virtual RMethod R__0__dw_MyGUIWindow_ElementBase
		{
			get
			{
				if(r_R__0__dw_MyGUIWindow_ElementBase == null)
				{
					r_R__0__dw_MyGUIWindow_ElementBase = new(this, "#dw", 0,  ReleactionUtils.GetType("MyGUIWindow"), typeof(MyGUI.ElementBase));
					r_R__0__dw_MyGUIWindow_ElementBase.SetBelong(this.instance);
				}
				return r_R__0__dw_MyGUIWindow_ElementBase;
			}
		}
		...
		/// Void #lw(Single)
		/// </summary>
		protected RMethod r_R__0__lw_Single;
		public virtual RMethod R__0__lw_Single
		{
			get
			{
				if(r_R__0__lw_Single == null)
				{
					r_R__0__lw_Single = new(this, "#lw", 0, typeof(System.Single));
					r_R__0__lw_Single.SetBelong(this.instance);
				}
				return r_R__0__lw_Single;
			}
		}

		/// <summary>
		/// Void #mw(System.String)
		/// </summary>
		protected RMethod r_R__0__mw_String;
		public virtual RMethod R__0__mw_String
		{
			get
			{
				if(r_R__0__mw_String == null)
				{
					r_R__0__mw_String = new(this, "#mw", 0, typeof(System.String));
					r_R__0__mw_String.SetBelong(this.instance);
				}
				return r_R__0__mw_String;
			}
		}

		/// <summary>
		/// Void #HBd(MyGUI.ElementBase, #HGd)
		/// </summary>
		protected RMethod r_R__0__HBd_ElementBase___0__HGd;
		public virtual RMethod R__0__HBd_ElementBase___0__HGd
		{
			get
			{
				if(r_R__0__HBd_ElementBase___0__HGd == null)
				{
					r_R__0__HBd_ElementBase___0__HGd = new(this, "#HBd", 0, typeof(MyGUI.ElementBase),  ReleactionUtils.GetType("MyGUIWndTipTextWnd+#HGd"));
					r_R__0__HBd_ElementBase___0__HGd.SetBelong(this.instance);
				}
				return r_R__0__HBd_ElementBase___0__HGd;
			}
		}

		/// <summary>
		/// Void #sb(MyGUIWindow, MyGUI.ElementBase, System.String)
		/// </summary>
		protected RMethod r_R__0__sb_MyGUIWindow_ElementBase_String;
		public virtual RMethod R__0__sb_MyGUIWindow_ElementBase_String
		{
			get
			{
				if(r_R__0__sb_MyGUIWindow_ElementBase_String == null)
				{
					r_R__0__sb_MyGUIWindow_ElementBase_String = new(this, "#sb", 0,  ReleactionUtils.GetType("MyGUIWindow"), typeof(MyGUI.ElementBase), typeof(System.String));
					r_R__0__sb_MyGUIWindow_ElementBase_String.SetBelong(this.instance);
				}
				return r_R__0__sb_MyGUIWindow_ElementBase_String;
			}
		}
        ...
        public RMyGUIWndTipTextWnd() : base("MyGUIWndTipTextWnd")
        {
        }

        public RMyGUIWndTipTextWnd(System.Object instance) : base("MyGUIWndTipTextWnd")
		{
            SetInstance(instance);
		}

        public RMyGUIWndTipTextWnd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMyGUIWndTipTextWnd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__iT(System.Object  @obj)
        {
        ...
        public virtual void __0__lw(System.Single  @_width)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@_width};
            var ___result = R__0__lw_Single.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__mw(System.String  @tipText)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@tipText};
            var ___result = R__0__mw_String.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ImageEffectsOrder
	/// </summary>
    public partial class RImageEffectsOrder : RMember //
    {

		/// <summary>
		/// UnityEngine.RenderTexture[] _tex
		/// </summary>
		protected RFieldArray<RUnityEngine.RRenderTexture> r__tex;
		public virtual RFieldArray<RUnityEngine.RRenderTexture> R_tex
		{
			get
			{
				if(r__tex == null)
				{
					r__tex = new(this, "_tex");
					r__tex.SetBelong(this.instance);
				}
				return r__tex;
			}
		}
        ...
        public RImageEffectsOrder() : base("ImageEffectsOrder")
        {
        }

        public RImageEffectsOrder(System.Object instance) : base("ImageEffectsOrder")
		{
            SetInstance(instance);
		}

        public RImageEffectsOrder(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RImageEffectsOrder(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

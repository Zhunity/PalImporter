...
{
	/// <summary>
	/// EffectGarbageCollection
	/// </summary>
    public partial class REffectGarbageCollection : RMember //
    {
        ...
        public REffectGarbageCollection() : base("EffectGarbageCollection")
        {
        }

        public REffectGarbageCollection(System.Object instance) : base("EffectGarbageCollection")
		{
            SetInstance(instance);
		}

        public REffectGarbageCollection(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REffectGarbageCollection(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

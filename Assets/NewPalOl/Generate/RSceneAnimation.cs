...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SceneAnimation
	/// </summary>
    public partial class RSceneAnimation : RMember //
    {
        ...
        public RSceneAnimation() : base("SceneAnimation")
        {
        }

        public RSceneAnimation(System.Object instance) : base("SceneAnimation")
		{
            SetInstance(instance);
		}

        public RSceneAnimation(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSceneAnimation(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

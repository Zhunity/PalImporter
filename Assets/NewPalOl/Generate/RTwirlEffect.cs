...
namespace SMFrame.Editor.Refleaction
{
	...
	/// TwirlEffect
	/// </summary>
    public partial class RTwirlEffect : RMember //
    {
        ...
        public RTwirlEffect() : base("TwirlEffect")
        {
        }

        public RTwirlEffect(System.Object instance) : base("TwirlEffect")
		{
            SetInstance(instance);
		}

        public RTwirlEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RTwirlEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// LookAtCamera
	/// </summary>
    public partial class RLookAtCamera : RMember //
    {
        ...
        public RLookAtCamera() : base("LookAtCamera")
        {
        }

        public RLookAtCamera(System.Object instance) : base("LookAtCamera")
		{
            SetInstance(instance);
		}

        public RLookAtCamera(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RLookAtCamera(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

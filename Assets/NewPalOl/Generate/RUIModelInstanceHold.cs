...
namespace SMFrame.Editor.Refleaction
{
	...
	/// UIModelInstanceHold
	/// </summary>
    public partial class RUIModelInstanceHold : RMember //
    {

		/// <summary>
		/// MyGUI.ElementBase m_ModelElem
		/// </summary>
		protected RMyGUI.RElementBase r_m_ModelElem;
		public virtual RMyGUI.RElementBase Rm_ModelElem
		{
			get
			{
				if(r_m_ModelElem == null)
				{
					r_m_ModelElem = new(this, "m_ModelElem");
					r_m_ModelElem.SetBelong(this.instance);
				}
				return r_m_ModelElem;
			}
		}

		/// <summary>
		/// System.Int32 m_nShowCareer
		/// </summary>
		protected RField r_m_nShowCareer;
		public virtual RField Rm_nShowCareer
		{
			get
			{
				if(r_m_nShowCareer == null)
				{
					r_m_nShowCareer = new(this, "m_nShowCareer");
					r_m_nShowCareer.SetBelong(this.instance);
				}
				return r_m_nShowCareer;
			}
		}

		/// <summary>
		/// TexRenderType m_TexRenderType
		/// </summary>
		protected RField r_m_TexRenderType;
		public virtual RField Rm_TexRenderType
		{
			get
			{
				if(r_m_TexRenderType == null)
				{
					r_m_TexRenderType = new(this, "m_TexRenderType");
					r_m_TexRenderType.SetBelong(this.instance);
				}
				return r_m_TexRenderType;
			}
		}

		/// <summary>
		/// UnityEngine.GameObject m_PetModel
		/// </summary>
		protected RUnityEngine.RGameObject r_m_PetModel;
		public virtual RUnityEngine.RGameObject Rm_PetModel
		{
			get
			{
				if(r_m_PetModel == null)
				{
					r_m_PetModel = new(this, "m_PetModel");
					r_m_PetModel.SetBelong(this.instance);
				}
				return r_m_PetModel;
			}
		}
		...
		/// <summary>
		/// System.Int32 m_ResID
		/// </summary>
		protected RField r_m_ResID;
		public virtual RField Rm_ResID
		{
			get
			{
				if(r_m_ResID == null)
				{
					r_m_ResID = new(this, "m_ResID");
					r_m_ResID.SetBelong(this.instance);
				}
				return r_m_ResID;
			}
		}
		...
		/// <summary>
		/// MyGUIWindow m_BelongGUIWnd
		/// </summary>
		protected RMyGUIWindow r_m_BelongGUIWnd;
		public virtual RMyGUIWindow Rm_BelongGUIWnd
		{
			get
			{
				if(r_m_BelongGUIWnd == null)
				{
					r_m_BelongGUIWnd = new(this, "m_BelongGUIWnd");
					r_m_BelongGUIWnd.SetBelong(this.instance);
				}
				return r_m_BelongGUIWnd;
			}
		}
		...
		/// </summary>
		protected RMethod r_RRefreshPlayerModel;
		public virtual RMethod RRefreshPlayerModel
		{
			get
			{
				if(r_RRefreshPlayerModel == null)
				{
					r_RRefreshPlayerModel = new(this, "RefreshPlayerModel", 0);
					r_RRefreshPlayerModel.SetBelong(this.instance);
				}
				return r_RRefreshPlayerModel;
			}
		}
		...
		/// <summary>
		/// Void RefreshModelByResId()
		/// </summary>
		protected RMethod r_RRefreshModelByResId;
		public virtual RMethod RRefreshModelByResId
		{
			get
			{
				if(r_RRefreshModelByResId == null)
				{
					r_RRefreshModelByResId = new(this, "RefreshModelByResId", 0);
					r_RRefreshModelByResId.SetBelong(this.instance);
				}
				return r_RRefreshModelByResId;
			}
		}

		/// <summary>
		/// Void OnLoadedModel(System.Object, #u.#egb)
		/// </summary>
		protected RMethod r_ROnLoadedModel_Object___0__egb;
		public virtual RMethod ROnLoadedModel_Object___0__egb
		{
			get
			{
				if(r_ROnLoadedModel_Object___0__egb == null)
				{
					r_ROnLoadedModel_Object___0__egb = new(this, "OnLoadedModel", 0, typeof(System.Object),  ReleactionUtils.GetType("#u.#egb"));
					r_ROnLoadedModel_Object___0__egb.SetBelong(this.instance);
				}
				return r_ROnLoadedModel_Object___0__egb;
			}
		}
		...
		/// Void ShowModel()
		/// </summary>
		protected RMethod r_RShowModel;
		public virtual RMethod RShowModel
		{
			get
			{
				if(r_RShowModel == null)
				{
					r_RShowModel = new(this, "ShowModel", 0);
					r_RShowModel.SetBelong(this.instance);
				}
				return r_RShowModel;
			}
		}
		...
		/// <summary>
		/// Void StartPlayModelAni(UnityEngine.GameObject)
		/// </summary>
		protected RMethod r_RStartPlayModelAni_GameObject;
		public virtual RMethod RStartPlayModelAni_GameObject
		{
			get
			{
				if(r_RStartPlayModelAni_GameObject == null)
				{
					r_RStartPlayModelAni_GameObject = new(this, "StartPlayModelAni", 0, typeof(UnityEngine.GameObject));
					r_RStartPlayModelAni_GameObject.SetBelong(this.instance);
				}
				return r_RStartPlayModelAni_GameObject;
			}
		}
		...
		/// Void CloseCamera()
		/// </summary>
		protected RMethod r_RCloseCamera;
		public virtual RMethod RCloseCamera
		{
			get
			{
				if(r_RCloseCamera == null)
				{
					r_RCloseCamera = new(this, "CloseCamera", 0);
					r_RCloseCamera.SetBelong(this.instance);
				}
				return r_RCloseCamera;
			}
		}
        ...
        public RUIModelInstanceHold() : base("UIModelInstanceHold")
        {
        }

        public RUIModelInstanceHold(System.Object instance) : base("UIModelInstanceHold")
		{
            SetInstance(instance);
		}

        public RUIModelInstanceHold(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RUIModelInstanceHold(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void RefreshPlayerModel()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RRefreshPlayerModel.Invoke(___genericsType, ___parameters);
        ...
        public virtual void RefreshModelByResId()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RRefreshModelByResId.Invoke(___genericsType, ___parameters);
        ...
        public virtual void ShowModel()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RShowModel.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void StartPlayModelAni(UnityEngine.GameObject  @modRoot)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@modRoot};
            var ___result = RStartPlayModelAni_GameObject.Invoke(___genericsType, ___parameters);
        ...
        public virtual void CloseCamera()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RCloseCamera.Invoke(___genericsType, ___parameters);

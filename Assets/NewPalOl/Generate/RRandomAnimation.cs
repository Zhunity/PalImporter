...
namespace SMFrame.Editor.Refleaction
{
	...
	/// RandomAnimation
	/// </summary>
    public partial class RRandomAnimation : RMember //
    {

		/// <summary>
		/// UnityEngine.AnimationClip[] RandomAnimationClips
		/// </summary>
		protected RFieldArray<RUnityEngine.RAnimationClip> r_RandomAnimationClips;
		public virtual RFieldArray<RUnityEngine.RAnimationClip> RandomAnimationClips
		{
			get
			{
				if(r_RandomAnimationClips == null)
				{
					r_RandomAnimationClips = new(this, "RandomAnimationClips");
					r_RandomAnimationClips.SetBelong(this.instance);
				}
				return r_RandomAnimationClips;
			}
		}

		/// <summary>
		/// UnityEngine.Animation aniCom
		/// </summary>
		protected RUnityEngine.RAnimation r_aniCom;
		public virtual RUnityEngine.RAnimation RaniCom
		{
			get
			{
				if(r_aniCom == null)
				{
					r_aniCom = new(this, "aniCom");
					r_aniCom.SetBelong(this.instance);
				}
				return r_aniCom;
			}
		}
		...
		/// <summary>
		/// Void PlayRandomClip(System.Object, System.EventArgs)
		/// </summary>
		protected RMethod r_RPlayRandomClip_Object_EventArgs;
		public virtual RMethod RPlayRandomClip_Object_EventArgs
		{
			get
			{
				if(r_RPlayRandomClip_Object_EventArgs == null)
				{
					r_RPlayRandomClip_Object_EventArgs = new(this, "PlayRandomClip", 0, typeof(System.Object), typeof(System.EventArgs));
					r_RPlayRandomClip_Object_EventArgs.SetBelong(this.instance);
				}
				return r_RPlayRandomClip_Object_EventArgs;
			}
		}
        ...
        public RRandomAnimation() : base("RandomAnimation")
        {
        }

        public RRandomAnimation(System.Object instance) : base("RandomAnimation")
		{
            SetInstance(instance);
		}

        public RRandomAnimation(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RRandomAnimation(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void PlayRandomClip(System.Object  @sender, System.EventArgs  @e)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @e};
            var ___result = RPlayRandomClip_Object_EventArgs.Invoke(___genericsType, ___parameters);

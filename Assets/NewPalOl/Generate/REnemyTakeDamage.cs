...
namespace SMFrame.Editor.Refleaction
{
	...
	/// EnemyTakeDamage
	/// </summary>
    public partial class REnemyTakeDamage : RMember //
    {
        ...
        public REnemyTakeDamage() : base("EnemyTakeDamage")
        {
        }

        public REnemyTakeDamage(System.Object instance) : base("EnemyTakeDamage")
		{
            SetInstance(instance);
		}

        public REnemyTakeDamage(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REnemyTakeDamage(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

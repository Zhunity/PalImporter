...
namespace SMFrame.Editor.Refleaction
{
	...
	/// NPCInfoXMLReader
	/// </summary>
    public partial class RNPCInfoXMLReader : RMember //
    {

		/// <summary>
		/// KeyValueContent LoadContentFromNPCConfigHold(NpcInfoConfigHold)
		/// </summary>
		protected RMethod r_RLoadContentFromNPCConfigHold_NpcInfoConfigHold;
		public virtual RMethod RLoadContentFromNPCConfigHold_NpcInfoConfigHold
		{
			get
			{
				if(r_RLoadContentFromNPCConfigHold_NpcInfoConfigHold == null)
				{
					r_RLoadContentFromNPCConfigHold_NpcInfoConfigHold = new(this, "LoadContentFromNPCConfigHold", 0, typeof(NpcInfoConfigHold));
					r_RLoadContentFromNPCConfigHold_NpcInfoConfigHold.SetBelong(this.instance);
				}
				return r_RLoadContentFromNPCConfigHold_NpcInfoConfigHold;
			}
		}
        ...
        public RNPCInfoXMLReader() : base("NPCInfoXMLReader")
        {
        }

        public RNPCInfoXMLReader(System.Object instance) : base("NPCInfoXMLReader")
		{
            SetInstance(instance);
		}

        public RNPCInfoXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RNPCInfoXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Object LoadContentFromNPCConfigHold(NpcInfoConfigHold  @config)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@config};
            var ___result = RLoadContentFromNPCConfigHold_NpcInfoConfigHold.Invoke(___genericsType, ___parameters);

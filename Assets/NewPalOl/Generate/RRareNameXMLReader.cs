...
namespace SMFrame.Editor.Refleaction
{
	...
	/// RareNameXMLReader
	/// </summary>
    public partial class RRareNameXMLReader : RMember //
    {
        ...
        public RRareNameXMLReader() : base("RareNameXMLReader")
        {
        }

        public RRareNameXMLReader(System.Object instance) : base("RareNameXMLReader")
		{
            SetInstance(instance);
		}

        public RRareNameXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RRareNameXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

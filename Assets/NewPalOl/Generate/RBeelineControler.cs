...
namespace SMFrame.Editor.Refleaction
{
	...
	/// BeelineControler
	/// </summary>
    public partial class RBeelineControler : RMember //
    {

		/// <summary>
		/// UnityEngine.GameObject mBeelinePoint
		/// </summary>
		protected RUnityEngine.RGameObject r_mBeelinePoint;
		public virtual RUnityEngine.RGameObject RmBeelinePoint
		{
			get
			{
				if(r_mBeelinePoint == null)
				{
					r_mBeelinePoint = new(this, "mBeelinePoint");
					r_mBeelinePoint.SetBelong(this.instance);
				}
				return r_mBeelinePoint;
			}
		}
		...
		/// <summary>
		/// System.Single mDuration
		/// </summary>
		protected RField r_mDuration;
		public virtual RField RmDuration
		{
			get
			{
				if(r_mDuration == null)
				{
					r_mDuration = new(this, "mDuration");
		...
		/// <summary>
		/// UnityEngine.Vector3 mCameraPos
		/// </summary>
		protected RUnityEngine.RVector3 r_mCameraPos;
		public virtual RUnityEngine.RVector3 RmCameraPos
		{
			get
			{
				if(r_mCameraPos == null)
				{
					r_mCameraPos = new(this, "mCameraPos");
					r_mCameraPos.SetBelong(this.instance);
				}
				return r_mCameraPos;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Quaternion mCameraRot
		/// </summary>
		protected RUnityEngine.RQuaternion r_mCameraRot;
		public virtual RUnityEngine.RQuaternion RmCameraRot
		{
			get
			{
				if(r_mCameraRot == null)
				{
					r_mCameraRot = new(this, "mCameraRot");
					r_mCameraRot.SetBelong(this.instance);
				}
				return r_mCameraRot;
			}
		}
		...
		/// <summary>
		/// Void FollowBeelinePath(UnityEngine.GameObject)
		/// </summary>
		protected RMethod r_RFollowBeelinePath_GameObject;
		public virtual RMethod RFollowBeelinePath_GameObject
		{
			get
			{
				if(r_RFollowBeelinePath_GameObject == null)
				{
					r_RFollowBeelinePath_GameObject = new(this, "FollowBeelinePath", 0, typeof(UnityEngine.GameObject));
					r_RFollowBeelinePath_GameObject.SetBelong(this.instance);
				}
				return r_RFollowBeelinePath_GameObject;
			}
		}
		...
		/// Void FollowBeeline()
		/// </summary>
		protected RMethod r_RFollowBeeline;
		public virtual RMethod RFollowBeeline
		{
			get
			{
				if(r_RFollowBeeline == null)
				{
					r_RFollowBeeline = new(this, "FollowBeeline", 0);
					r_RFollowBeeline.SetBelong(this.instance);
				}
				return r_RFollowBeeline;
			}
		}
        ...
        public RBeelineControler() : base("BeelineControler")
        {
        }

        public RBeelineControler(System.Object instance) : base("BeelineControler")
		{
            SetInstance(instance);
		}

        public RBeelineControler(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBeelineControler(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void FollowBeelinePath(UnityEngine.GameObject  @pointObj)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pointObj};
            var ___result = RFollowBeelinePath_GameObject.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void FollowBeeline()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RFollowBeeline.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MyGUITeamAtiWnd
	/// </summary>
    public partial class RMyGUITeamAtiWnd : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.Queue`1[#oU.#5bb] #c
		/// </summary>
		protected RSystem.RCollections.RGeneric.RQueue<R__0__oU.R__0__5bb> r___0__c;
		public virtual RSystem.RCollections.RGeneric.RQueue<R__0__oU.R__0__5bb> R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		public static RField R__0__d
		{
			get
			{
				if(r___0__d == null)
				{
					r___0__d = new( ReleactionUtils.GetType("MyGUITeamAtiWnd"), "#d");
		...
		public static RField R__0__e
		{
			get
			{
				if(r___0__e == null)
				{
					r___0__e = new( ReleactionUtils.GetType("MyGUITeamAtiWnd"), "#e");
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[GameDefineType.ID,System.Collections.Generic.Dictionary`2[MyGUITeamAtiWnd+AttributeType,System.Int32]] #f
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RGameDefineType.RID, RSystem.RCollections.RGeneric.RDictionary<RField, RField>> r___0__f;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RGameDefineType.RID, RSystem.RCollections.RGeneric.RDictionary<RField, RField>> R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.String,UIeffect] #m
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, RUIeffect> r___0__m;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, RUIeffect> R__0__m
		{
			get
			{
				if(r___0__m == null)
		...
		/// Boolean ShowTeamAti
		/// </summary>
		protected RProperty r_R__0__nHe;
		public virtual RProperty R__0__nHe
		{
			get
			{
				if(r_R__0__nHe == null)
				{
					r_R__0__nHe = new(this, "ShowTeamAti", -1);
					r_R__0__nHe.SetBelong(this.instance);
				}
				return r_R__0__nHe;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator #jyj(Int32)
		/// </summary>
		protected RMethod r_R__0__jyj_Int32;
		public virtual RMethod R__0__jyj_Int32
		{
			get
			{
				if(r_R__0__jyj_Int32 == null)
				{
					r_R__0__jyj_Int32 = new(this, "#jyj", 0, typeof(System.Int32));
					r_R__0__jyj_Int32.SetBelong(this.instance);
				}
				return r_R__0__jyj_Int32;
			}
		}

		/// <summary>
		/// #oU.#5bb #kyj(Boolean, AttributeType, Int32)
		/// </summary>
		protected RMethod r_R__0__kyj_Boolean_AttributeType_Int32;
		public virtual RMethod R__0__kyj_Boolean_AttributeType_Int32
		{
			get
			{
				if(r_R__0__kyj_Boolean_AttributeType_Int32 == null)
				{
					r_R__0__kyj_Boolean_AttributeType_Int32 = new(this, "#kyj", 0, typeof(System.Boolean),  ReleactionUtils.GetType("MyGUITeamAtiWnd+AttributeType"), typeof(System.Int32));
					r_R__0__kyj_Boolean_AttributeType_Int32.SetBelong(this.instance);
				}
				return r_R__0__kyj_Boolean_AttributeType_Int32;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator #lyj(#oU.#5bb)
		/// </summary>
		protected RMethod r_R__0__lyj___0__5bb;
		public virtual RMethod R__0__lyj___0__5bb
		{
			get
			{
				if(r_R__0__lyj___0__5bb == null)
				{
					r_R__0__lyj___0__5bb = new(this, "#lyj", 0,  ReleactionUtils.GetType("#oU.#5bb"));
					r_R__0__lyj___0__5bb.SetBelong(this.instance);
				}
				return r_R__0__lyj___0__5bb;
			}
		}

		/// <summary>
		/// System.String #GF(System.String, System.String)
		/// </summary>
		protected RMethod r_R__0__GF_String_String;
		public virtual RMethod R__0__GF_String_String
		{
			get
			{
				if(r_R__0__GF_String_String == null)
				{
					r_R__0__GF_String_String = new(this, "#GF", 0, typeof(System.String), typeof(System.String));
					r_R__0__GF_String_String.SetBelong(this.instance);
				}
				return r_R__0__GF_String_String;
			}
		}
		...
		/// Void #LDj(Pet)
		/// </summary>
		protected RMethod r_R__0__LDj_Pet;
		public virtual RMethod R__0__LDj_Pet
		{
			get
			{
				if(r_R__0__LDj_Pet == null)
				{
					r_R__0__LDj_Pet = new(this, "#LDj", 0,  ReleactionUtils.GetType("Pet"));
					r_R__0__LDj_Pet.SetBelong(this.instance);
				}
				return r_R__0__LDj_Pet;
			}
		}
		...
		/// Void #MDj(Pet)
		/// </summary>
		protected RMethod r_R__0__MDj_Pet;
		public virtual RMethod R__0__MDj_Pet
		{
			get
			{
				if(r_R__0__MDj_Pet == null)
				{
					r_R__0__MDj_Pet = new(this, "#MDj", 0,  ReleactionUtils.GetType("Pet"));
					r_R__0__MDj_Pet.SetBelong(this.instance);
				}
				return r_R__0__MDj_Pet;
			}
		}

		/// <summary>
		/// Void #NDj(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__NDj_ID;
		public virtual RMethod R__0__NDj_ID
		{
			get
			{
				if(r_R__0__NDj_ID == null)
				{
					r_R__0__NDj_ID = new(this, "#NDj", 0, typeof(GameDefineType.ID));
					r_R__0__NDj_ID.SetBelong(this.instance);
				}
				return r_R__0__NDj_ID;
			}
		}
		...
		/// Void #myj()
		/// </summary>
		protected RMethod r_R__0__myj;
		public virtual RMethod R__0__myj
		{
			get
			{
				if(r_R__0__myj == null)
				{
					r_R__0__myj = new(this, "#myj", 0);
					r_R__0__myj.SetBelong(this.instance);
				}
				return r_R__0__myj;
			}
		}
		...
		/// Void #pod()
		/// </summary>
		protected RMethod r_R__0__pod;
		public virtual RMethod R__0__pod
		{
			get
			{
				if(r_R__0__pod == null)
				{
					r_R__0__pod = new(this, "#pod", 0);
					r_R__0__pod.SetBelong(this.instance);
				}
				return r_R__0__pod;
			}
		}
		...
		/// Int32 #hkf()
		/// </summary>
		protected RMethod r_R__0__hkf;
		public virtual RMethod R__0__hkf
		{
			get
			{
				if(r_R__0__hkf == null)
				{
					r_R__0__hkf = new(this, "#hkf", 0);
					r_R__0__hkf.SetBelong(this.instance);
				}
				return r_R__0__hkf;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator #ODj()
		/// </summary>
		protected RMethod r_R__0__ODj;
		public virtual RMethod R__0__ODj
		{
			get
			{
				if(r_R__0__ODj == null)
				{
					r_R__0__ODj = new(this, "#ODj", 0);
					r_R__0__ODj.SetBelong(this.instance);
				}
				return r_R__0__ODj;
			}
		}
		...
		/// <summary>
		/// Void OnLoadEffect(System.String, MyGUI.ElementBase)
		/// </summary>
		protected RMethod r_ROnLoadEffect_String_ElementBase;
		public virtual RMethod ROnLoadEffect_String_ElementBase
		{
			get
			{
				if(r_ROnLoadEffect_String_ElementBase == null)
				{
					r_ROnLoadEffect_String_ElementBase = new(this, "OnLoadEffect", 0, typeof(System.String), typeof(MyGUI.ElementBase));
					r_ROnLoadEffect_String_ElementBase.SetBelong(this.instance);
				}
				return r_ROnLoadEffect_String_ElementBase;
			}
		}
        ...
        public RMyGUITeamAtiWnd() : base("MyGUITeamAtiWnd")
        {
        }

        public RMyGUITeamAtiWnd(System.Object instance) : base("MyGUITeamAtiWnd")
		{
            SetInstance(instance);
		}

        public RMyGUITeamAtiWnd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMyGUITeamAtiWnd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Collections.IEnumerator __0__jyj(System.Int32  @addval)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@addval};
            var ___result = R__0__jyj_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.String __0__GF(System.String  @val, System.String  @col)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@val, @col};
            var ___result = R__0__GF_String_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__NDj(GameDefineType.ID  @dirtyid)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@dirtyid};
            var ___result = R__0__NDj_ID.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__myj()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__myj.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__pod()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__pod.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Int32 __0__hkf()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__hkf.Invoke(___genericsType, ___parameters);

            return (System.Int32)___result;
        }


        public virtual System.Collections.IEnumerator __0__ODj()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__ODj.Invoke(___genericsType, ___parameters);
        ...
        public virtual void OnLoadEffect(System.String  @url, MyGUI.ElementBase  @eb)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@url, @eb};
            var ___result = ROnLoadEffect_String_ElementBase.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// HideBodyEffect
	/// </summary>
    public partial class RHideBodyEffect : RMember //
    {
        ...
        public RHideBodyEffect() : base("HideBodyEffect")
        {
        }

        public RHideBodyEffect(System.Object instance) : base("HideBodyEffect")
		{
            SetInstance(instance);
		}

        public RHideBodyEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RHideBodyEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

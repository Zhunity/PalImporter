...
namespace SMFrame.Editor.Refleaction
{
	...
	/// PlanarReflection
	/// </summary>
    public partial class RPlanarReflection : RMember //
    {

		/// <summary>
		/// UnityEngine.LayerMask reflectionMask
		/// </summary>
		protected RUnityEngine.RLayerMask r_reflectionMask;
		public virtual RUnityEngine.RLayerMask RreflectionMask
		{
			get
			{
				if(r_reflectionMask == null)
				{
					r_reflectionMask = new(this, "reflectionMask");
					r_reflectionMask.SetBelong(this.instance);
				}
				return r_reflectionMask;
			}
		}

		/// <summary>
		/// System.Boolean reflectSkybox
		/// </summary>
		protected RField r_reflectSkybox;
		public virtual RField RreflectSkybox
		{
			get
			{
				if(r_reflectSkybox == null)
				{
					r_reflectSkybox = new(this, "reflectSkybox");
					r_reflectSkybox.SetBelong(this.instance);
				}
				return r_reflectSkybox;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RColor r_clearColor;
		public virtual RUnityEngine.RColor RclearColor
		{
			get
			{
		...
		/// <summary>
		/// System.String reflectionSampler
		/// </summary>
		protected RField r_reflectionSampler;
		public virtual RField RreflectionSampler
		{
			get
			{
				if(r_reflectionSampler == null)
				{
					r_reflectionSampler = new(this, "reflectionSampler");
					r_reflectionSampler.SetBelong(this.instance);
				}
				return r_reflectionSampler;
			}
		}
		...
		/// </summary>
		protected RField r_clipPlaneOffset;
		public virtual RField RclipPlaneOffset
		{
			get
			{
				if(r_clipPlaneOffset == null)
				{
					r_clipPlaneOffset = new(this, "clipPlaneOffset");
					r_clipPlaneOffset.SetBelong(this.instance);
				}
				return r_clipPlaneOffset;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RVector3 r_oldpos;
		public virtual RUnityEngine.RVector3 Roldpos
		{
			get
			{
				if(r_oldpos == null)
				{
					r_oldpos = new(this, "oldpos");
					r_oldpos.SetBelong(this.instance);
				}
				return r_oldpos;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RCamera r_reflectionCamera;
		public virtual RUnityEngine.RCamera RreflectionCamera
		{
			get
			{
				if(r_reflectionCamera == null)
				{
					r_reflectionCamera = new(this, "reflectionCamera");
					r_reflectionCamera.SetBelong(this.instance);
				}
				return r_reflectionCamera;
			}
		}
		...
		public virtual RUnityEngine.RMaterial RsharedMaterial
		{
			get
			{
				...
				{
					r_sharedMaterial = new(this, "sharedMaterial");
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[UnityEngine.Camera,System.Boolean] helperCameras
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RUnityEngine.RCamera, RField> r_helperCameras;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RUnityEngine.RCamera, RField> RhelperCameras
		{
			get
			{
				if(r_helperCameras == null)
				{
					r_helperCameras = new(this, "helperCameras");
					r_helperCameras.SetBelong(this.instance);
				}
				return r_helperCameras;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Camera CreateReflectionCameraFor(UnityEngine.Camera)
		/// </summary>
		protected RMethod r_RCreateReflectionCameraFor_Camera;
		public virtual RMethod RCreateReflectionCameraFor_Camera
		{
			get
			{
				if(r_RCreateReflectionCameraFor_Camera == null)
				{
					r_RCreateReflectionCameraFor_Camera = new(this, "CreateReflectionCameraFor", 0, typeof(UnityEngine.Camera));
					r_RCreateReflectionCameraFor_Camera.SetBelong(this.instance);
				}
				return r_RCreateReflectionCameraFor_Camera;
			}
		}

		/// <summary>
		/// Void SetStandardCameraParameter(UnityEngine.Camera, UnityEngine.LayerMask)
		/// </summary>
		protected RMethod r_RSetStandardCameraParameter_Camera_LayerMask;
		public virtual RMethod RSetStandardCameraParameter_Camera_LayerMask
		{
			get
			{
				if(r_RSetStandardCameraParameter_Camera_LayerMask == null)
				{
					r_RSetStandardCameraParameter_Camera_LayerMask = new(this, "SetStandardCameraParameter", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.LayerMask));
					r_RSetStandardCameraParameter_Camera_LayerMask.SetBelong(this.instance);
				}
				return r_RSetStandardCameraParameter_Camera_LayerMask;
			}
		}

		/// <summary>
		/// UnityEngine.RenderTexture CreateTextureFor(UnityEngine.Camera)
		/// </summary>
		protected RMethod r_RCreateTextureFor_Camera;
		public virtual RMethod RCreateTextureFor_Camera
		{
			get
			{
				if(r_RCreateTextureFor_Camera == null)
				{
					r_RCreateTextureFor_Camera = new(this, "CreateTextureFor", 0, typeof(UnityEngine.Camera));
					r_RCreateTextureFor_Camera.SetBelong(this.instance);
				}
				return r_RCreateTextureFor_Camera;
			}
		}

		/// <summary>
		/// Void RenderHelpCameras(UnityEngine.Camera)
		/// </summary>
		protected RMethod r_RRenderHelpCameras_Camera;
		public virtual RMethod RRenderHelpCameras_Camera
		{
			get
			{
				if(r_RRenderHelpCameras_Camera == null)
				{
					r_RRenderHelpCameras_Camera = new(this, "RenderHelpCameras", 0, typeof(UnityEngine.Camera));
					r_RRenderHelpCameras_Camera.SetBelong(this.instance);
				}
				return r_RRenderHelpCameras_Camera;
			}
		}
		...
		/// <summary>
		/// Void WaterTileBeingRendered(UnityEngine.Transform, UnityEngine.Camera)
		/// </summary>
		protected RMethod r_RWaterTileBeingRendered_Transform_Camera;
		public virtual RMethod RWaterTileBeingRendered_Transform_Camera
		{
			get
			{
				if(r_RWaterTileBeingRendered_Transform_Camera == null)
				{
					r_RWaterTileBeingRendered_Transform_Camera = new(this, "WaterTileBeingRendered", 0, typeof(UnityEngine.Transform), typeof(UnityEngine.Camera));
					r_RWaterTileBeingRendered_Transform_Camera.SetBelong(this.instance);
				}
				return r_RWaterTileBeingRendered_Transform_Camera;
			}
		}
		...
		/// <summary>
		/// Void RenderReflectionFor(UnityEngine.Camera, UnityEngine.Camera)
		/// </summary>
		protected RMethod r_RRenderReflectionFor_Camera_Camera;
		public virtual RMethod RRenderReflectionFor_Camera_Camera
		{
			get
			{
				if(r_RRenderReflectionFor_Camera_Camera == null)
				{
					r_RRenderReflectionFor_Camera_Camera = new(this, "RenderReflectionFor", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.Camera));
					r_RRenderReflectionFor_Camera_Camera.SetBelong(this.instance);
				}
				return r_RRenderReflectionFor_Camera_Camera;
			}
		}

		/// <summary>
		/// Void SaneCameraSettings(UnityEngine.Camera)
		/// </summary>
		protected RMethod r_RSaneCameraSettings_Camera;
		public virtual RMethod RSaneCameraSettings_Camera
		{
			get
			{
				if(r_RSaneCameraSettings_Camera == null)
				{
					r_RSaneCameraSettings_Camera = new(this, "SaneCameraSettings", 0, typeof(UnityEngine.Camera));
					r_RSaneCameraSettings_Camera.SetBelong(this.instance);
				}
				return r_RSaneCameraSettings_Camera;
			}
		}

		/// <summary>
		/// UnityEngine.Matrix4x4 CalculateObliqueMatrix(UnityEngine.Matrix4x4, UnityEngine.Vector4)
		/// </summary>
		protected static RMethod r_RCalculateObliqueMatrix_Matrix4x4_Vector4;
		public static RMethod RCalculateObliqueMatrix_Matrix4x4_Vector4
		{
			get
			{
				if(r_RCalculateObliqueMatrix_Matrix4x4_Vector4 == null)
				{
					r_RCalculateObliqueMatrix_Matrix4x4_Vector4 = new(typeof(PlanarReflection), "CalculateObliqueMatrix", 0, typeof(UnityEngine.Matrix4x4), typeof(UnityEngine.Vector4));
					r_RCalculateObliqueMatrix_Matrix4x4_Vector4.SetBelong(null);
				}
				return r_RCalculateObliqueMatrix_Matrix4x4_Vector4;
			}
		}

		/// <summary>
		/// UnityEngine.Matrix4x4 CalculateReflectionMatrix(UnityEngine.Matrix4x4, UnityEngine.Vector4)
		/// </summary>
		protected static RMethod r_RCalculateReflectionMatrix_Matrix4x4_Vector4;
		public static RMethod RCalculateReflectionMatrix_Matrix4x4_Vector4
		{
			get
			{
				if(r_RCalculateReflectionMatrix_Matrix4x4_Vector4 == null)
				{
					r_RCalculateReflectionMatrix_Matrix4x4_Vector4 = new(typeof(PlanarReflection), "CalculateReflectionMatrix", 0, typeof(UnityEngine.Matrix4x4), typeof(UnityEngine.Vector4));
					r_RCalculateReflectionMatrix_Matrix4x4_Vector4.SetBelong(null);
				}
				return r_RCalculateReflectionMatrix_Matrix4x4_Vector4;
			}
		}
		...
		public static RMethod Rsgn_Single
		{
			get
			{
				...
				{
					r_Rsgn_Single = new(typeof(PlanarReflection), "sgn", 0, typeof(System.Single));
        ...
        public RPlanarReflection() : base("PlanarReflection")
        {
        }

        public RPlanarReflection(System.Object instance) : base("PlanarReflection")
		{
            SetInstance(instance);
		}

        public RPlanarReflection(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPlanarReflection(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual UnityEngine.Camera CreateReflectionCameraFor(UnityEngine.Camera  @cam)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cam};
            var ___result = RCreateReflectionCameraFor_Camera.Invoke(___genericsType, ___parameters);

            return (UnityEngine.Camera)___result;
        }


        public virtual void SetStandardCameraParameter(UnityEngine.Camera  @cam, UnityEngine.LayerMask  @mask)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cam, @mask};
            var ___result = RSetStandardCameraParameter_Camera_LayerMask.Invoke(___genericsType, ___parameters);

            
        }


        public virtual UnityEngine.RenderTexture CreateTextureFor(UnityEngine.Camera  @cam)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cam};
            var ___result = RCreateTextureFor_Camera.Invoke(___genericsType, ___parameters);

            return (UnityEngine.RenderTexture)___result;
        }


        public virtual void RenderHelpCameras(UnityEngine.Camera  @currentCam)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@currentCam};
            var ___result = RRenderHelpCameras_Camera.Invoke(___genericsType, ___parameters);
        ...
        public virtual void WaterTileBeingRendered(UnityEngine.Transform  @tr, UnityEngine.Camera  @currentCam)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@tr, @currentCam};
            var ___result = RWaterTileBeingRendered_Transform_Camera.Invoke(___genericsType, ___parameters);
        ...
        public virtual void RenderReflectionFor(UnityEngine.Camera  @cam, UnityEngine.Camera  @reflectCamera)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cam, @reflectCamera};
            var ___result = RRenderReflectionFor_Camera_Camera.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void SaneCameraSettings(UnityEngine.Camera  @helperCam)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@helperCam};
            var ___result = RSaneCameraSettings_Camera.Invoke(___genericsType, ___parameters);

            
        }


        public static UnityEngine.Matrix4x4 CalculateObliqueMatrix(UnityEngine.Matrix4x4  @projection, UnityEngine.Vector4  @clipPlane)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@projection, @clipPlane};
            var ___result = RCalculateObliqueMatrix_Matrix4x4_Vector4.Invoke(___genericsType, ___parameters);

            return (UnityEngine.Matrix4x4)___result;
        }


        public static UnityEngine.Matrix4x4 CalculateReflectionMatrix(UnityEngine.Matrix4x4  @reflectionMat, UnityEngine.Vector4  @plane)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@reflectionMat, @plane};
            var ___result = RCalculateReflectionMatrix_Matrix4x4_Vector4.Invoke(___genericsType, ___parameters);

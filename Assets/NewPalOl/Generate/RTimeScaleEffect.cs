...
namespace SMFrame.Editor.Refleaction
{
	...
	/// TimeScaleEffect
	/// </summary>
    public partial class RTimeScaleEffect : RMember //
    {

		/// <summary>
		/// System.Single factor
		/// </summary>
		protected RField r_factor;
		public virtual RField Rfactor
		{
			get
			{
				if(r_factor == null)
				{
					r_factor = new(this, "factor");
					r_factor.SetBelong(this.instance);
				}
				return r_factor;
			}
		}
        ...
        public RTimeScaleEffect() : base("TimeScaleEffect")
        {
        }

        public RTimeScaleEffect(System.Object instance) : base("TimeScaleEffect")
		{
            SetInstance(instance);
		}

        public RTimeScaleEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RTimeScaleEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

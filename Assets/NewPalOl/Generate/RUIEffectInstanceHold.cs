...
{
	/// <summary>
	/// UIEffectInstanceHold
	/// </summary>
    public partial class RUIEffectInstanceHold : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.GameObject m_EffectObj
		/// </summary>
		protected RUnityEngine.RGameObject r_m_EffectObj;
		public virtual RUnityEngine.RGameObject Rm_EffectObj
		{
			get
			{
				if(r_m_EffectObj == null)
				{
					r_m_EffectObj = new(this, "m_EffectObj");
					r_m_EffectObj.SetBelong(this.instance);
				}
				return r_m_EffectObj;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RVector2 r_m_Offset;
		public virtual RUnityEngine.RVector2 Rm_Offset
		{
			get
			{
				if(r_m_Offset == null)
		...
		/// <summary>
		/// System.String m_UIObjUrl
		/// </summary>
		protected RField r_m_UIObjUrl;
		public virtual RField Rm_UIObjUrl
		{
			get
			{
				if(r_m_UIObjUrl == null)
				{
					r_m_UIObjUrl = new(this, "m_UIObjUrl");
					r_m_UIObjUrl.SetBelong(this.instance);
				}
				return r_m_UIObjUrl;
			}
		}
		...
		/// <summary>
		/// Void SetUrl(System.String, System.String, MyGUI.ElementBase)
		/// </summary>
		protected RMethod r_RSetUrl_String_String_ElementBase;
		public virtual RMethod RSetUrl_String_String_ElementBase
		{
			get
			{
				if(r_RSetUrl_String_String_ElementBase == null)
				{
					r_RSetUrl_String_String_ElementBase = new(this, "SetUrl", 0, typeof(System.String), typeof(System.String), typeof(MyGUI.ElementBase));
					r_RSetUrl_String_String_ElementBase.SetBelong(this.instance);
				}
				return r_RSetUrl_String_String_ElementBase;
			}
		}
		...
		/// Void DestroySelf()
		/// </summary>
		protected RMethod r_RDestroySelf;
		public virtual RMethod RDestroySelf
		{
			get
			{
				if(r_RDestroySelf == null)
				{
					r_RDestroySelf = new(this, "DestroySelf", 0);
					r_RDestroySelf.SetBelong(this.instance);
				}
				return r_RDestroySelf;
			}
		}

		/// <summary>
		/// UIeffect GetUIEffect()
		/// </summary>
		protected RMethod r_RGetUIEffect;
		public virtual RMethod RGetUIEffect
		{
			get
			{
				if(r_RGetUIEffect == null)
				{
					r_RGetUIEffect = new(this, "GetUIEffect", 0);
					r_RGetUIEffect.SetBelong(this.instance);
				}
				return r_RGetUIEffect;
			}
		}
        ...
        public RUIEffectInstanceHold() : base("UIEffectInstanceHold")
        {
        }

        public RUIEffectInstanceHold(System.Object instance) : base("UIEffectInstanceHold")
		{
            SetInstance(instance);
		}

        public RUIEffectInstanceHold(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RUIEffectInstanceHold(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void SetUrl(System.String  @url, System.String  @name, MyGUI.ElementBase  @elem)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@url, @name, @elem};
            var ___result = RSetUrl_String_String_ElementBase.Invoke(___genericsType, ___parameters);
        ...
        public virtual void DestroySelf()
        {
            ...
            var ___result = RDestroySelf.Invoke(___genericsType, ___parameters);

            
        }


        public virtual UIeffect GetUIEffect()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RGetUIEffect.Invoke(___genericsType, ___parameters);

...
{
	/// <summary>
	/// EffectRotationForeverZero
	/// </summary>
    public partial class REffectRotationForeverZero : RMember //
    {
        ...
        public REffectRotationForeverZero() : base("EffectRotationForeverZero")
        {
        }

        public REffectRotationForeverZero(System.Object instance) : base("EffectRotationForeverZero")
		{
            SetInstance(instance);
		}

        public REffectRotationForeverZero(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REffectRotationForeverZero(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

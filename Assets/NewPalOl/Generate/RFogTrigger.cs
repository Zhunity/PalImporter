...
namespace SMFrame.Editor.Refleaction
{
	...
	/// FogTrigger
	/// </summary>
    public partial class RFogTrigger : RMember //
    {
		...
		/// <summary>
		/// System.Boolean EnableFog
		/// </summary>
		protected RField r_EnableFog;
		public virtual RField REnableFog
		{
			get
			{
				if(r_EnableFog == null)
				{
					r_EnableFog = new(this, "EnableFog");
					r_EnableFog.SetBelong(this.instance);
				}
				return r_EnableFog;
			}
		}
		...
		/// <summary>
		/// System.Boolean EditFog
		/// </summary>
		protected RField r_EditFog;
		public virtual RField REditFog
		{
			get
			{
				if(r_EditFog == null)
				{
					r_EditFog = new(this, "EditFog");
					r_EditFog.SetBelong(this.instance);
				}
				return r_EditFog;
			}
		}
		...
		/// <summary>
		/// System.Single GradualChangeTime
		/// </summary>
		protected RField r_GradualChangeTime;
		public virtual RField RGradualChangeTime
		{
			get
			{
				if(r_GradualChangeTime == null)
				{
					r_GradualChangeTime = new(this, "GradualChangeTime");
					r_GradualChangeTime.SetBelong(this.instance);
				}
				return r_GradualChangeTime;
			}
		}

		/// <summary>
		/// FogTriggerHandler playerFogControl
		/// </summary>
		protected RFogTriggerHandler r_playerFogControl;
		public virtual RFogTriggerHandler RplayerFogControl
		{
			get
			{
				if(r_playerFogControl == null)
				{
					r_playerFogControl = new(this, "playerFogControl");
					r_playerFogControl.SetBelong(this.instance);
				}
				return r_playerFogControl;
			}
		}
        ...
        public RFogTrigger() : base("FogTrigger")
        {
        }

        public RFogTrigger(System.Object instance) : base("FogTrigger")
		{
            SetInstance(instance);
		}

        public RFogTrigger(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RFogTrigger(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

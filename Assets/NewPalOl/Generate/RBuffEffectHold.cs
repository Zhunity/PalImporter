...
namespace SMFrame.Editor.Refleaction
{
	...
	/// BuffEffectHold
	/// </summary>
    public partial class RBuffEffectHold : RMember //
    {
		...
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__k
		{
			get
			{
				if(r___0__k == null)
				{
					r___0__k = new( ReleactionUtils.GetType("BuffEffectHold"), "#k");
		...
		/// <summary>
		/// System.String GetEffect(System.String)
		/// </summary>
        ...
        public RBuffEffectHold() : base("BuffEffectHold")
        {
        }

        public RBuffEffectHold(System.Object instance) : base("BuffEffectHold")
		{
            SetInstance(instance);
		}

        public RBuffEffectHold(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBuffEffectHold(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.String GetEffect(System.String  @typ)
        {

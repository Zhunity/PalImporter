...
namespace SMFrame.Editor.Refleaction
{
	...
	/// BumpMapGenerate
	/// </summary>
    public partial class RBumpMapGenerate : RMember //
    {
        ...
        public RBumpMapGenerate() : base("BumpMapGenerate")
        {
        }

        public RBumpMapGenerate(System.Object instance) : base("BumpMapGenerate")
		{
            SetInstance(instance);
		}

        public RBumpMapGenerate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBumpMapGenerate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{
	/// <summary>
	/// LookAtCameraBillboardEx
	/// </summary>
    public partial class RLookAtCameraBillboardEx : RMember //
    {
		...
		/// <summary>
		/// LookAtCameraBillboardEx+BillboardMode _billboardMode
		/// </summary>
		protected RField r__billboardMode;
		public virtual RField R_billboardMode
		{
			get
			{
				if(r__billboardMode == null)
				{
					r__billboardMode = new(this, "_billboardMode");
					r__billboardMode.SetBelong(this.instance);
				}
				return r__billboardMode;
			}
		}
		...
		/// <summary>
		/// Void SetBillboardMode(BillboardMode)
		/// </summary>
		protected RMethod r_RSetBillboardMode_BillboardMode;
		public virtual RMethod RSetBillboardMode_BillboardMode
		{
			get
			{
				if(r_RSetBillboardMode_BillboardMode == null)
				{
					r_RSetBillboardMode_BillboardMode = new(this, "SetBillboardMode", 0,  ReleactionUtils.GetType("LookAtCameraBillboardEx+BillboardMode"));
					r_RSetBillboardMode_BillboardMode.SetBelong(this.instance);
				}
				return r_RSetBillboardMode_BillboardMode;
			}
		}
        ...
        public RLookAtCameraBillboardEx() : base("LookAtCameraBillboardEx")
        {
        }

        public RLookAtCameraBillboardEx(System.Object instance) : base("LookAtCameraBillboardEx")
		{
            SetInstance(instance);
		}

        public RLookAtCameraBillboardEx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RLookAtCameraBillboardEx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

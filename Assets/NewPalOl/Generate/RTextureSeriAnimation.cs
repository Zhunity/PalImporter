...
{
	/// <summary>
	/// TextureSeriAnimation
	/// </summary>
    public partial class RTextureSeriAnimation : RMember //
    {

		/// <summary>
		/// UnityEngine.Texture[] mTextures
		/// </summary>
		protected RFieldArray<RUnityEngine.RTexture> r_mTextures;
		public virtual RFieldArray<RUnityEngine.RTexture> RmTextures
		{
			get
			{
				if(r_mTextures == null)
				{
					r_mTextures = new(this, "mTextures");
					r_mTextures.SetBelong(this.instance);
				}
				return r_mTextures;
			}
		}
		...
		/// <summary>
		/// UnityEngine.MeshRenderer _mr
		/// </summary>
		protected RUnityEngine.RMeshRenderer r__mr;
		public virtual RUnityEngine.RMeshRenderer R_mr
		{
			get
			{
				if(r__mr == null)
		...
		/// <summary>
		/// System.Single _deltaTime
		/// </summary>
		protected RField r__deltaTime;
		public virtual RField R_deltaTime
		{
			get
			{
				if(r__deltaTime == null)
				{
					r__deltaTime = new(this, "_deltaTime");
					r__deltaTime.SetBelong(this.instance);
				}
				return r__deltaTime;
			}
		}
        ...
        public RTextureSeriAnimation() : base("TextureSeriAnimation")
        {
        }

        public RTextureSeriAnimation(System.Object instance) : base("TextureSeriAnimation")
		{
            SetInstance(instance);
		}

        public RTextureSeriAnimation(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RTextureSeriAnimation(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// StatueTrigger
	/// </summary>
    public partial class RStatueTrigger : RMember //
    {

		/// <summary>
		/// System.Single VaildRange
		/// </summary>
		protected RField r_VaildRange;
		public virtual RField RVaildRange
		{
			get
			{
				if(r_VaildRange == null)
				{
					r_VaildRange = new(this, "VaildRange");
					r_VaildRange.SetBelong(this.instance);
				}
				return r_VaildRange;
			}
		}
		...
		/// <summary>
		/// System.Single RotateSpeed
		/// </summary>
		protected RField r_RotateSpeed;
		public virtual RField RotateSpeed
		{
			get
			{
				if(r_RotateSpeed == null)
				{
					r_RotateSpeed = new(this, "RotateSpeed");
					r_RotateSpeed.SetBelong(this.instance);
				}
				return r_RotateSpeed;
			}
		}

		/// <summary>
		/// System.Int32 RotateDir
		/// </summary>
		protected RField r_RotateDir;
		public virtual RField RotateDir
		{
			get
			{
				if(r_RotateDir == null)
				{
					r_RotateDir = new(this, "RotateDir");
					r_RotateDir.SetBelong(this.instance);
				}
				return r_RotateDir;
			}
		}
		...
		/// <summary>
		/// System.Single VaildRFanAngleRange
		/// </summary>
		protected RField r_VaildRFanAngleRange;
		public virtual RField RVaildRFanAngleRange
		{
			get
			{
				if(r_VaildRFanAngleRange == null)
				{
					r_VaildRFanAngleRange = new(this, "VaildRFanAngleRange");
					r_VaildRFanAngleRange.SetBelong(this.instance);
				}
				return r_VaildRFanAngleRange;
			}
		}

		/// <summary>
		/// GameDefineType.ID npcID
		/// </summary>
		protected RGameDefineType.RID r_npcID;
		public virtual RGameDefineType.RID RnpcID
		{
			get
			{
				if(r_npcID == null)
		...
		/// <summary>
		/// System.Single piPerDegree
		/// </summary>
		protected static RField r_piPerDegree;
		public static RField RpiPerDegree
		{
			get
			{
				if(r_piPerDegree == null)
				{
					r_piPerDegree = new(typeof(StatueTrigger), "piPerDegree");
					r_piPerDegree.SetBelong(null);
				}
				return r_piPerDegree;
			}
		}
		...
		/// <summary>
		/// Void InitTriggerParam3(Single, Single, Int32)
		/// </summary>
		protected RMethod r_RInitTriggerParam3_Single_Single_Int32;
		public virtual RMethod RInitTriggerParam3_Single_Single_Int32
		{
			get
			{
				if(r_RInitTriggerParam3_Single_Single_Int32 == null)
				{
					r_RInitTriggerParam3_Single_Single_Int32 = new(this, "InitTriggerParam3", 0, typeof(System.Single), typeof(System.Single), typeof(System.Int32));
					r_RInitTriggerParam3_Single_Single_Int32.SetBelong(this.instance);
				}
				return r_RInitTriggerParam3_Single_Single_Int32;
			}
		}

		/// <summary>
		/// Void InitTriggerParam4(Single, Single, Int32, Int32)
		/// </summary>
		protected RMethod r_RInitTriggerParam4_Single_Single_Int32_Int32;
		public virtual RMethod RInitTriggerParam4_Single_Single_Int32_Int32
		{
			get
			{
				if(r_RInitTriggerParam4_Single_Single_Int32_Int32 == null)
				{
					r_RInitTriggerParam4_Single_Single_Int32_Int32 = new(this, "InitTriggerParam4", 0, typeof(System.Single), typeof(System.Single), typeof(System.Int32), typeof(System.Int32));
					r_RInitTriggerParam4_Single_Single_Int32_Int32.SetBelong(this.instance);
				}
				return r_RInitTriggerParam4_Single_Single_Int32_Int32;
			}
		}
		...
		/// <summary>
		/// Boolean IsFacePlayerInRange(Single, Single)
		/// </summary>
		protected RMethod r_RIsFacePlayerInRange_Single_Single;
		public virtual RMethod RIsFacePlayerInRange_Single_Single
		{
			get
			{
				if(r_RIsFacePlayerInRange_Single_Single == null)
				{
					r_RIsFacePlayerInRange_Single_Single = new(this, "IsFacePlayerInRange", 0, typeof(System.Single), typeof(System.Single));
					r_RIsFacePlayerInRange_Single_Single.SetBelong(this.instance);
				}
				return r_RIsFacePlayerInRange_Single_Single;
			}
		}

		/// <summary>
		/// GameDefineType.ID GetNpcID()
		/// </summary>
		protected RMethod r_RGetNpcID;
		public virtual RMethod RGetNpcID
		{
			get
			{
				if(r_RGetNpcID == null)
				{
					r_RGetNpcID = new(this, "GetNpcID", 0);
					r_RGetNpcID.SetBelong(this.instance);
				}
				return r_RGetNpcID;
			}
		}
		...
		/// <summary>
		/// Boolean TraceTrigger()
		/// </summary>
		protected RMethod r_RTraceTrigger;
		public virtual RMethod RTraceTrigger
		{
			get
			{
				if(r_RTraceTrigger == null)
				{
					r_RTraceTrigger = new(this, "TraceTrigger", 0);
					r_RTraceTrigger.SetBelong(this.instance);
				}
				return r_RTraceTrigger;
			}
		}
        ...
        public RStatueTrigger() : base("StatueTrigger")
        {
        }

        public RStatueTrigger(System.Object instance) : base("StatueTrigger")
		{
            SetInstance(instance);
		}

        public RStatueTrigger(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RStatueTrigger(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void InitTriggerParam3(System.Single  @vaildRange, System.Single  @rotateSpeed, System.Int32  @rotateDir)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@vaildRange, @rotateSpeed, @rotateDir};
            var ___result = RInitTriggerParam3_Single_Single_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void InitTriggerParam4(System.Single  @vaildRange, System.Single  @rotateSpeed, System.Int32  @rotateDir, System.Int32  @vaildRFanAngleRange)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@vaildRange, @rotateSpeed, @rotateDir, @vaildRFanAngleRange};
            var ___result = RInitTriggerParam4_Single_Single_Int32_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Boolean IsFacePlayerInRange(System.Single  @distRange, System.Single  @fanAangle)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@distRange, @fanAangle};
            var ___result = RIsFacePlayerInRange_Single_Single.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual GameDefineType.ID GetNpcID()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RGetNpcID.Invoke(___genericsType, ___parameters);

            return (GameDefineType.ID)___result;
        }


        public virtual System.Boolean TraceTrigger()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RTraceTrigger.Invoke(___genericsType, ___parameters);

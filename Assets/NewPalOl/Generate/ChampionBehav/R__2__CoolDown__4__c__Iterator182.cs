...
{public partial class RChampionBehav
{
	
	/// <summary>
	/// ChampionBehav+<CoolDown>c__Iterator182
	/// </summary>
    public partial class R__2__CoolDown__4__c__Iterator182 : RMember //
    {
		...
		/// <summary>
		/// ChampionBehav <>f__this
		/// </summary>
		protected RChampionBehav r___2____4__f__this;
		public virtual RChampionBehav R__2____4__f__this
		{
			get
			{
        ...
        public R__2__CoolDown__4__c__Iterator182() : base("ChampionBehav+<CoolDown>c__Iterator182")
        {
        }

        public R__2__CoolDown__4__c__Iterator182(System.Object instance) : base("ChampionBehav+<CoolDown>c__Iterator182")
		{
            SetInstance(instance);
		}

        public R__2__CoolDown__4__c__Iterator182(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__CoolDown__4__c__Iterator182(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{
	/// <summary>
	/// EquipmentExPropXMLReader
	/// </summary>
    public partial class REquipmentExPropXMLReader : RMember //
    {

		/// <summary>
		/// KeyValueContent LoadXml(UnityEngine.TextAsset, System.String ByRef)
		/// </summary>
		protected RMethod r_RLoadXml_TextAsset_Ref_String;
		public virtual RMethod RLoadXml_TextAsset_Ref_String
		{
			get
			{
				if(r_RLoadXml_TextAsset_Ref_String == null)
				{
					r_RLoadXml_TextAsset_Ref_String = new(this, "LoadXml", 0, typeof(UnityEngine.TextAsset), typeof(System.String).MakeByRefType());
					r_RLoadXml_TextAsset_Ref_String.SetBelong(this.instance);
				}
				return r_RLoadXml_TextAsset_Ref_String;
			}
		}
        ...
        public REquipmentExPropXMLReader() : base("EquipmentExPropXMLReader")
        {
        }

        public REquipmentExPropXMLReader(System.Object instance) : base("EquipmentExPropXMLReader")
		{
            SetInstance(instance);
		}

        public REquipmentExPropXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REquipmentExPropXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Object LoadXml(UnityEngine.TextAsset  @text, ref System.String  @prefix)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text, @prefix};
            var ___result = RLoadXml_TextAsset_Ref_String.Invoke(___genericsType, ___parameters);

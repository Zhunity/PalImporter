...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ColorRevert
	/// </summary>
    public partial class RColorRevert : RMember //
    {
        ...
        public RColorRevert() : base("ColorRevert")
        {
        }

        public RColorRevert(System.Object instance) : base("ColorRevert")
		{
            SetInstance(instance);
		}

        public RColorRevert(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RColorRevert(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

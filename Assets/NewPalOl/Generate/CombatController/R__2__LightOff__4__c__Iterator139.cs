...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<LightOff>c__Iterator139
	/// </summary>
    public partial class R__2__LightOff__4__c__Iterator139 : RMember //
    {
		...
		/// <summary>
		/// LightOffEffect <args>__0
		/// </summary>
		protected RLightOffEffect r___2__args__4____0;
		public virtual RLightOffEffect R__2__args__4____0
		{
			get
			{
        ...
        public R__2__LightOff__4__c__Iterator139() : base("CombatController+<LightOff>c__Iterator139")
        {
        }

        public R__2__LightOff__4__c__Iterator139(System.Object instance) : base("CombatController+<LightOff>c__Iterator139")
		{
            SetInstance(instance);
		}

        public R__2__LightOff__4__c__Iterator139(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__LightOff__4__c__Iterator139(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

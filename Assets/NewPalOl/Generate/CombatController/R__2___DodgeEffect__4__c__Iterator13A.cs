...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<_DodgeEffect>c__Iterator13A
	/// </summary>
    public partial class R__2___DodgeEffect__4__c__Iterator13A : RMember //
    {
        ...
        public R__2___DodgeEffect__4__c__Iterator13A() : base("CombatController+<_DodgeEffect>c__Iterator13A")
        {
        }

        public R__2___DodgeEffect__4__c__Iterator13A(System.Object instance) : base("CombatController+<_DodgeEffect>c__Iterator13A")
		{
            SetInstance(instance);
		}

        public R__2___DodgeEffect__4__c__Iterator13A(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2___DodgeEffect__4__c__Iterator13A(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<CameraMove>c__Iterator13E
	/// </summary>
    public partial class R__2__CameraMove__4__c__Iterator13E : RMember //
    {
		...
		/// CameraMove <args>__0
		/// </summary>
		protected RCameraMove r___2__args__4____0;
		public virtual RCameraMove R__2__args__4____0
		{
			get
			{
        ...
        public R__2__CameraMove__4__c__Iterator13E() : base("CombatController+<CameraMove>c__Iterator13E")
        {
        }

        public R__2__CameraMove__4__c__Iterator13E(System.Object instance) : base("CombatController+<CameraMove>c__Iterator13E")
		{
            SetInstance(instance);
		}

        public R__2__CameraMove__4__c__Iterator13E(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__CameraMove__4__c__Iterator13E(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

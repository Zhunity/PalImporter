...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<EscapingFinish>c__Iterator128
	/// </summary>
    public partial class R__2__EscapingFinish__4__c__Iterator128 : RMember //
    {

		/// <summary>
		/// CCommmandEscape cc
		/// </summary>
		protected RCCommmandEscape r_cc;
		public virtual RCCommmandEscape Rcc
		{
			get
			{
				if(r_cc == null)
		...
		/// CCommmandEscape <$>cc
		/// </summary>
		protected RCCommmandEscape r___2____9____4__cc;
		public virtual RCCommmandEscape R__2____9____4__cc
		{
			get
			{
				if(r___2____9____4__cc == null)
				{
					r___2____9____4__cc = new(this, "<$>cc");
					r___2____9____4__cc.SetBelong(this.instance);
				}
				return r___2____9____4__cc;
			}
		}
        ...
        public R__2__EscapingFinish__4__c__Iterator128() : base("CombatController+<EscapingFinish>c__Iterator128")
        {
        }

        public R__2__EscapingFinish__4__c__Iterator128(System.Object instance) : base("CombatController+<EscapingFinish>c__Iterator128")
		{
            SetInstance(instance);
		}

        public R__2__EscapingFinish__4__c__Iterator128(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__EscapingFinish__4__c__Iterator128(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<EscapeFail>c__Iterator127
	/// </summary>
    public partial class R__2__EscapeFail__4__c__Iterator127 : RMember //
    {
        ...
        public R__2__EscapeFail__4__c__Iterator127() : base("CombatController+<EscapeFail>c__Iterator127")
        {
        }

        public R__2__EscapeFail__4__c__Iterator127(System.Object instance) : base("CombatController+<EscapeFail>c__Iterator127")
		{
            SetInstance(instance);
		}

        public R__2__EscapeFail__4__c__Iterator127(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__EscapeFail__4__c__Iterator127(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<SwitchCombatMusic>c__Iterator141
	/// </summary>
    public partial class R__2__SwitchCombatMusic__4__c__Iterator141 : RMember //
    {
		...
		/// <summary>
		/// SwitchCombatMusic <args>__0
		/// </summary>
		protected RSwitchCombatMusic r___2__args__4____0;
		public virtual RSwitchCombatMusic R__2__args__4____0
		{
			get
			{
        ...
        public R__2__SwitchCombatMusic__4__c__Iterator141() : base("CombatController+<SwitchCombatMusic>c__Iterator141")
        {
        }

        public R__2__SwitchCombatMusic__4__c__Iterator141(System.Object instance) : base("CombatController+<SwitchCombatMusic>c__Iterator141")
		{
            SetInstance(instance);
		}

        public R__2__SwitchCombatMusic__4__c__Iterator141(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__SwitchCombatMusic__4__c__Iterator141(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

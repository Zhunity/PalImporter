...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<BodyShake>c__Iterator130
	/// </summary>
    public partial class R__2__BodyShake__4__c__Iterator130 : RMember //
    {
		...
		/// <summary>
		/// BodyShakeEffect <tmpArgs>__0
		/// </summary>
		protected RBodyShakeEffect r___2__tmpArgs__4____0;
		public virtual RBodyShakeEffect R__2__tmpArgs__4____0
		{
			get
			{
        ...
        public R__2__BodyShake__4__c__Iterator130() : base("CombatController+<BodyShake>c__Iterator130")
        {
        }

        public R__2__BodyShake__4__c__Iterator130(System.Object instance) : base("CombatController+<BodyShake>c__Iterator130")
		{
            SetInstance(instance);
		}

        public R__2__BodyShake__4__c__Iterator130(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__BodyShake__4__c__Iterator130(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

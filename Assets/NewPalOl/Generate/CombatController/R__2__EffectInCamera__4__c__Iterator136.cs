...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<EffectInCamera>c__Iterator136
	/// </summary>
    public partial class R__2__EffectInCamera__4__c__Iterator136 : RMember //
    {
		...
		/// <summary>
		/// NormalEffectInCamera <args>__0
		/// </summary>
		protected RNormalEffectInCamera r___2__args__4____0;
		public virtual RNormalEffectInCamera R__2__args__4____0
		{
			get
			{
        ...
        public R__2__EffectInCamera__4__c__Iterator136() : base("CombatController+<EffectInCamera>c__Iterator136")
        {
        }

        public R__2__EffectInCamera__4__c__Iterator136(System.Object instance) : base("CombatController+<EffectInCamera>c__Iterator136")
		{
            SetInstance(instance);
		}

        public R__2__EffectInCamera__4__c__Iterator136(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__EffectInCamera__4__c__Iterator136(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

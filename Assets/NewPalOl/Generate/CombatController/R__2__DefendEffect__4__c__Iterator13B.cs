...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<DefendEffect>c__Iterator13B
	/// </summary>
    public partial class R__2__DefendEffect__4__c__Iterator13B : RMember //
    {

		/// <summary>
		/// UnityEngine.Vector3 <dodgeTmpPos>__0
		/// </summary>
		protected RUnityEngine.RVector3 r___2__dodgeTmpPos__4____0;
		public virtual RUnityEngine.RVector3 R__2__dodgeTmpPos__4____0
		{
			get
			{
				if(r___2__dodgeTmpPos__4____0 == null)
				{
					r___2__dodgeTmpPos__4____0 = new(this, "<dodgeTmpPos>__0");
					r___2__dodgeTmpPos__4____0.SetBelong(this.instance);
				}
				return r___2__dodgeTmpPos__4____0;
			}
		}
        ...
        public R__2__DefendEffect__4__c__Iterator13B() : base("CombatController+<DefendEffect>c__Iterator13B")
        {
        }

        public R__2__DefendEffect__4__c__Iterator13B(System.Object instance) : base("CombatController+<DefendEffect>c__Iterator13B")
		{
            SetInstance(instance);
		}

        public R__2__DefendEffect__4__c__Iterator13B(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__DefendEffect__4__c__Iterator13B(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<ColorRevert>c__Iterator142
	/// </summary>
    public partial class R__2__ColorRevert__4__c__Iterator142 : RMember //
    {
		...
		/// <summary>
		/// ColorRevert <args>__0
		/// </summary>
		protected RColorRevert r___2__args__4____0;
		public virtual RColorRevert R__2__args__4____0
		{
			get
			{
        ...
        public R__2__ColorRevert__4__c__Iterator142() : base("CombatController+<ColorRevert>c__Iterator142")
        {
        }

        public R__2__ColorRevert__4__c__Iterator142(System.Object instance) : base("CombatController+<ColorRevert>c__Iterator142")
		{
            SetInstance(instance);
		}

        public R__2__ColorRevert__4__c__Iterator142(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ColorRevert__4__c__Iterator142(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<CameraShake>c__Iterator12D
	/// </summary>
    public partial class R__2__CameraShake__4__c__Iterator12D : RMember //
    {
		...
		/// <summary>
		/// CameraShakeEffect <tmpArgs>__0
		/// </summary>
		protected RCameraShakeEffect r___2__tmpArgs__4____0;
		public virtual RCameraShakeEffect R__2__tmpArgs__4____0
		{
			get
			{
		...
		/// <summary>
		/// CameraInCombat <tmpCIC>__1
		/// </summary>
		protected RCameraInCombat r___2__tmpCIC__4____1;
		public virtual RCameraInCombat R__2__tmpCIC__4____1
		{
			get
			{
				if(r___2__tmpCIC__4____1 == null)
				{
					r___2__tmpCIC__4____1 = new(this, "<tmpCIC>__1");
					r___2__tmpCIC__4____1.SetBelong(this.instance);
				}
				return r___2__tmpCIC__4____1;
			}
		}
        ...
        public R__2__CameraShake__4__c__Iterator12D() : base("CombatController+<CameraShake>c__Iterator12D")
        {
        }

        public R__2__CameraShake__4__c__Iterator12D(System.Object instance) : base("CombatController+<CameraShake>c__Iterator12D")
		{
            SetInstance(instance);
		}

        public R__2__CameraShake__4__c__Iterator12D(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__CameraShake__4__c__Iterator12D(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

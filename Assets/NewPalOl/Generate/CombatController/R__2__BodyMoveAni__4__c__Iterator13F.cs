...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<BodyMoveAni>c__Iterator13F
	/// </summary>
    public partial class R__2__BodyMoveAni__4__c__Iterator13F : RMember //
    {
		...
		/// <summary>
		/// BodyMoveAni <args>__0
		/// </summary>
		protected RBodyMoveAni r___2__args__4____0;
		public virtual RBodyMoveAni R__2__args__4____0
		{
			get
			{
		...
		/// <summary>
		/// TimedObjectDestructor <tmpCom>__2
		/// </summary>
		protected RTimedObjectDestructor r___2__tmpCom__4____2;
		public virtual RTimedObjectDestructor R__2__tmpCom__4____2
		{
			get
			{
				if(r___2__tmpCom__4____2 == null)
				{
					r___2__tmpCom__4____2 = new(this, "<tmpCom>__2");
					r___2__tmpCom__4____2.SetBelong(this.instance);
				}
				return r___2__tmpCom__4____2;
			}
		}

		/// <summary>
		/// UnityEngine.Animation <moveAnimation>__3
		/// </summary>
		protected RUnityEngine.RAnimation r___2__moveAnimation__4____3;
		public virtual RUnityEngine.RAnimation R__2__moveAnimation__4____3
		{
			get
			{
				if(r___2__moveAnimation__4____3 == null)
				{
					r___2__moveAnimation__4____3 = new(this, "<moveAnimation>__3");
					r___2__moveAnimation__4____3.SetBelong(this.instance);
				}
				return r___2__moveAnimation__4____3;
			}
		}
        ...
        public R__2__BodyMoveAni__4__c__Iterator13F() : base("CombatController+<BodyMoveAni>c__Iterator13F")
        {
        }

        public R__2__BodyMoveAni__4__c__Iterator13F(System.Object instance) : base("CombatController+<BodyMoveAni>c__Iterator13F")
		{
            SetInstance(instance);
		}

        public R__2__BodyMoveAni__4__c__Iterator13F(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__BodyMoveAni__4__c__Iterator13F(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

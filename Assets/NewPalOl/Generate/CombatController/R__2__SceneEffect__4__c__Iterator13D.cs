...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<SceneEffect>c__Iterator13D
	/// </summary>
    public partial class R__2__SceneEffect__4__c__Iterator13D : RMember //
    {
		...
		/// <summary>
		/// SceneObjEffect <args>__0
		/// </summary>
		protected RSceneObjEffect r___2__args__4____0;
		public virtual RSceneObjEffect R__2__args__4____0
		{
			get
			{
        ...
        public R__2__SceneEffect__4__c__Iterator13D() : base("CombatController+<SceneEffect>c__Iterator13D")
        {
        }

        public R__2__SceneEffect__4__c__Iterator13D(System.Object instance) : base("CombatController+<SceneEffect>c__Iterator13D")
		{
            SetInstance(instance);
		}

        public R__2__SceneEffect__4__c__Iterator13D(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__SceneEffect__4__c__Iterator13D(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<SceneAnimation>c__Iterator13C
	/// </summary>
    public partial class R__2__SceneAnimation__4__c__Iterator13C : RMember //
    {
		...
		/// <summary>
		/// SceneAnimation <args>__0
		/// </summary>
		protected RSceneAnimation r___2__args__4____0;
		public virtual RSceneAnimation R__2__args__4____0
		{
			get
			{
        ...
        public R__2__SceneAnimation__4__c__Iterator13C() : base("CombatController+<SceneAnimation>c__Iterator13C")
        {
        }

        public R__2__SceneAnimation__4__c__Iterator13C(System.Object instance) : base("CombatController+<SceneAnimation>c__Iterator13C")
		{
            SetInstance(instance);
		}

        public R__2__SceneAnimation__4__c__Iterator13C(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__SceneAnimation__4__c__Iterator13C(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

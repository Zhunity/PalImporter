...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<AniPause>c__Iterator12F
	/// </summary>
    public partial class R__2__AniPause__4__c__Iterator12F : RMember //
    {
		...
		/// <summary>
		/// AniPauseEffect <tmpArgs>__0
		/// </summary>
		protected RAniPauseEffect r___2__tmpArgs__4____0;
		public virtual RAniPauseEffect R__2__tmpArgs__4____0
		{
			get
			{
        ...
        public R__2__AniPause__4__c__Iterator12F() : base("CombatController+<AniPause>c__Iterator12F")
        {
        }

        public R__2__AniPause__4__c__Iterator12F(System.Object instance) : base("CombatController+<AniPause>c__Iterator12F")
		{
            SetInstance(instance);
		}

        public R__2__AniPause__4__c__Iterator12F(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__AniPause__4__c__Iterator12F(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

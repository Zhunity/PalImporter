...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<OnModleLoadedReset>c__Iterator124
	/// </summary>
    public partial class R__2__OnModleLoadedReset__4__c__Iterator124 : RMember //
    {
        ...
        public R__2__OnModleLoadedReset__4__c__Iterator124() : base("CombatController+<OnModleLoadedReset>c__Iterator124")
        {
        }

        public R__2__OnModleLoadedReset__4__c__Iterator124(System.Object instance) : base("CombatController+<OnModleLoadedReset>c__Iterator124")
		{
            SetInstance(instance);
		}

        public R__2__OnModleLoadedReset__4__c__Iterator124(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__OnModleLoadedReset__4__c__Iterator124(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

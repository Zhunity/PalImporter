...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<CleaInjureActionList>c__Iterator123
	/// </summary>
    public partial class R__2__CleaInjureActionList__4__c__Iterator123 : RMember //
    {
		...
		/// System.Single <$>mTime
		/// </summary>
		protected RField r___2____9____4__mTime;
		public virtual RField R__2____9____4__mTime
		{
			get
			{
				if(r___2____9____4__mTime == null)
				{
					r___2____9____4__mTime = new(this, "<$>mTime");
					r___2____9____4__mTime.SetBelong(this.instance);
				}
				return r___2____9____4__mTime;
			}
		}
        ...
        public R__2__CleaInjureActionList__4__c__Iterator123() : base("CombatController+<CleaInjureActionList>c__Iterator123")
        {
        }

        public R__2__CleaInjureActionList__4__c__Iterator123(System.Object instance) : base("CombatController+<CleaInjureActionList>c__Iterator123")
		{
            SetInstance(instance);
		}

        public R__2__CleaInjureActionList__4__c__Iterator123(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__CleaInjureActionList__4__c__Iterator123(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

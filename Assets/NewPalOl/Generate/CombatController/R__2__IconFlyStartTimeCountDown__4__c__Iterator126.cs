...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<IconFlyStartTimeCountDown>c__Iterator126
	/// </summary>
    public partial class R__2__IconFlyStartTimeCountDown__4__c__Iterator126 : RMember //
    {

		/// <summary>
		/// System.Single <timeCur>__0
		/// </summary>
		protected RField r___2__timeCur__4____0;
		public virtual RField R__2__timeCur__4____0
		{
			get
			{
				if(r___2__timeCur__4____0 == null)
				{
					r___2__timeCur__4____0 = new(this, "<timeCur>__0");
					r___2__timeCur__4____0.SetBelong(this.instance);
				}
				return r___2__timeCur__4____0;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RGameObject r_obj;
		public virtual RUnityEngine.RGameObject Robj
		{
			get
			{
				if(r_obj == null)
		...
		/// UnityEngine.GameObject <$>obj
		/// </summary>
		protected RUnityEngine.RGameObject r___2____9____4__obj;
		public virtual RUnityEngine.RGameObject R__2____9____4__obj
		{
			get
			{
        ...
        public R__2__IconFlyStartTimeCountDown__4__c__Iterator126() : base("CombatController+<IconFlyStartTimeCountDown>c__Iterator126")
        {
        }

        public R__2__IconFlyStartTimeCountDown__4__c__Iterator126(System.Object instance) : base("CombatController+<IconFlyStartTimeCountDown>c__Iterator126")
		{
            SetInstance(instance);
		}

        public R__2__IconFlyStartTimeCountDown__4__c__Iterator126(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__IconFlyStartTimeCountDown__4__c__Iterator126(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

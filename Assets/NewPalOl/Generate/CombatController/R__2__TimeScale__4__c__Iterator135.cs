...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<TimeScale>c__Iterator135
	/// </summary>
    public partial class R__2__TimeScale__4__c__Iterator135 : RMember //
    {
		...
		/// <summary>
		/// TimeScaleEffect <args>__0
		/// </summary>
		protected RTimeScaleEffect r___2__args__4____0;
		public virtual RTimeScaleEffect R__2__args__4____0
		{
			get
			{
        ...
        public R__2__TimeScale__4__c__Iterator135() : base("CombatController+<TimeScale>c__Iterator135")
        {
        }

        public R__2__TimeScale__4__c__Iterator135(System.Object instance) : base("CombatController+<TimeScale>c__Iterator135")
		{
            SetInstance(instance);
		}

        public R__2__TimeScale__4__c__Iterator135(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__TimeScale__4__c__Iterator135(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

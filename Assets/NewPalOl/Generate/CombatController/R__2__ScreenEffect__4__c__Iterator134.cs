...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<ScreenEffect>c__Iterator134
	/// </summary>
    public partial class R__2__ScreenEffect__4__c__Iterator134 : RMember //
    {
        ...
        public R__2__ScreenEffect__4__c__Iterator134() : base("CombatController+<ScreenEffect>c__Iterator134")
        {
        }

        public R__2__ScreenEffect__4__c__Iterator134(System.Object instance) : base("CombatController+<ScreenEffect>c__Iterator134")
		{
            SetInstance(instance);
		}

        public R__2__ScreenEffect__4__c__Iterator134(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ScreenEffect__4__c__Iterator134(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

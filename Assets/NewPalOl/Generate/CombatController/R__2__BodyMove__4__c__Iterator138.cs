...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<BodyMove>c__Iterator138
	/// </summary>
    public partial class R__2__BodyMove__4__c__Iterator138 : RMember //
    {
		...
		/// <summary>
		/// BodyMoveEffect <args>__0
		/// </summary>
		protected RBodyMoveEffect r___2__args__4____0;
		public virtual RBodyMoveEffect R__2__args__4____0
		{
			get
			{
		...
		/// <summary>
		/// UnityEngine.Vector3 <mToPos>__1
		/// </summary>
		protected RUnityEngine.RVector3 r___2__mToPos__4____1;
		public virtual RUnityEngine.RVector3 R__2__mToPos__4____1
		{
			get
			{
				if(r___2__mToPos__4____1 == null)
				{
					r___2__mToPos__4____1 = new(this, "<mToPos>__1");
					r___2__mToPos__4____1.SetBelong(this.instance);
				}
				return r___2__mToPos__4____1;
			}
		}

		/// <summary>
		/// UnityEngine.GameObject <tmpObj>__2
		/// </summary>
		protected RUnityEngine.RGameObject r___2__tmpObj__4____2;
		public virtual RUnityEngine.RGameObject R__2__tmpObj__4____2
		{
			get
			{
				if(r___2__tmpObj__4____2 == null)
				{
					r___2__tmpObj__4____2 = new(this, "<tmpObj>__2");
					r___2__tmpObj__4____2.SetBelong(this.instance);
				}
				return r___2__tmpObj__4____2;
			}
		}

		/// <summary>
		/// CombatController <tmpCCtarget>__3
		/// </summary>
		protected RCombatController r___2__tmpCCtarget__4____3;
		public virtual RCombatController R__2__tmpCCtarget__4____3
		{
			get
			{
				if(r___2__tmpCCtarget__4____3 == null)
				{
					r___2__tmpCCtarget__4____3 = new(this, "<tmpCCtarget>__3");
					r___2__tmpCCtarget__4____3.SetBelong(this.instance);
				}
				return r___2__tmpCCtarget__4____3;
			}
		}
        ...
        public R__2__BodyMove__4__c__Iterator138() : base("CombatController+<BodyMove>c__Iterator138")
        {
        }

        public R__2__BodyMove__4__c__Iterator138(System.Object instance) : base("CombatController+<BodyMove>c__Iterator138")
		{
            SetInstance(instance);
		}

        public R__2__BodyMove__4__c__Iterator138(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__BodyMove__4__c__Iterator138(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

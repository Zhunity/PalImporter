...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<SoundEffect>c__Iterator12B
	/// </summary>
    public partial class R__2__SoundEffect__4__c__Iterator12B : RMember //
    {
		...
		/// <summary>
		/// SoundEffect <tmpArgs>__0
		/// </summary>
		protected RSoundEffect r___2__tmpArgs__4____0;
		public virtual RSoundEffect R__2__tmpArgs__4____0
		{
			get
			{
		...
		/// <summary>
		/// UnityEngine.AudioClip <tmpAC>__1
		/// </summary>
		protected RUnityEngine.RAudioClip r___2__tmpAC__4____1;
		public virtual RUnityEngine.RAudioClip R__2__tmpAC__4____1
		{
			get
			{
        ...
        public R__2__SoundEffect__4__c__Iterator12B() : base("CombatController+<SoundEffect>c__Iterator12B")
        {
        }

        public R__2__SoundEffect__4__c__Iterator12B(System.Object instance) : base("CombatController+<SoundEffect>c__Iterator12B")
		{
            SetInstance(instance);
		}

        public R__2__SoundEffect__4__c__Iterator12B(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__SoundEffect__4__c__Iterator12B(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

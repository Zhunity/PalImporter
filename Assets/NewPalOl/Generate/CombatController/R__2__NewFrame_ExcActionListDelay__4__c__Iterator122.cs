...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<NewFrame_ExcActionListDelay>c__Iterator122
	/// </summary>
    public partial class R__2__NewFrame_ExcActionListDelay__4__c__Iterator122 : RMember //
    {
        ...
        public R__2__NewFrame_ExcActionListDelay__4__c__Iterator122() : base("CombatController+<NewFrame_ExcActionListDelay>c__Iterator122")
        {
        }

        public R__2__NewFrame_ExcActionListDelay__4__c__Iterator122(System.Object instance) : base("CombatController+<NewFrame_ExcActionListDelay>c__Iterator122")
		{
            SetInstance(instance);
		}

        public R__2__NewFrame_ExcActionListDelay__4__c__Iterator122(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__NewFrame_ExcActionListDelay__4__c__Iterator122(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<PlayApperar>c__Iterator120
	/// </summary>
    public partial class R__2__PlayApperar__4__c__Iterator120 : RMember //
    {
        ...
        public R__2__PlayApperar__4__c__Iterator120() : base("CombatController+<PlayApperar>c__Iterator120")
        {
        }

        public R__2__PlayApperar__4__c__Iterator120(System.Object instance) : base("CombatController+<PlayApperar>c__Iterator120")
		{
            SetInstance(instance);
		}

        public R__2__PlayApperar__4__c__Iterator120(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__PlayApperar__4__c__Iterator120(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

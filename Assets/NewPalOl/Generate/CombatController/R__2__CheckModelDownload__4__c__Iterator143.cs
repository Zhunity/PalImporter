...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<CheckModelDownload>c__Iterator143
	/// </summary>
    public partial class R__2__CheckModelDownload__4__c__Iterator143 : RMember //
    {
        ...
        public R__2__CheckModelDownload__4__c__Iterator143() : base("CombatController+<CheckModelDownload>c__Iterator143")
        {
        }

        public R__2__CheckModelDownload__4__c__Iterator143(System.Object instance) : base("CombatController+<CheckModelDownload>c__Iterator143")
		{
            SetInstance(instance);
		}

        public R__2__CheckModelDownload__4__c__Iterator143(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__CheckModelDownload__4__c__Iterator143(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

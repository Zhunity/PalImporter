...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<DieBodyClear>c__Iterator125
	/// </summary>
    public partial class R__2__DieBodyClear__4__c__Iterator125 : RMember //
    {

		/// <summary>
		/// GameDefineType.ID idFighter
		/// </summary>
		protected RGameDefineType.RID r_idFighter;
		public virtual RGameDefineType.RID RidFighter
		{
			get
			{
				if(r_idFighter == null)
				{
					r_idFighter = new(this, "idFighter");
					r_idFighter.SetBelong(this.instance);
				}
				return r_idFighter;
			}
		}
		...
		/// GameDefineType.ID <$>idFighter
		/// </summary>
		protected RGameDefineType.RID r___2____9____4__idFighter;
		public virtual RGameDefineType.RID R__2____9____4__idFighter
		{
			get
			{
				if(r___2____9____4__idFighter == null)
				{
					r___2____9____4__idFighter = new(this, "<$>idFighter");
					r___2____9____4__idFighter.SetBelong(this.instance);
				}
				return r___2____9____4__idFighter;
			}
		}
        ...
        public R__2__DieBodyClear__4__c__Iterator125() : base("CombatController+<DieBodyClear>c__Iterator125")
        {
        }

        public R__2__DieBodyClear__4__c__Iterator125(System.Object instance) : base("CombatController+<DieBodyClear>c__Iterator125")
		{
            SetInstance(instance);
		}

        public R__2__DieBodyClear__4__c__Iterator125(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__DieBodyClear__4__c__Iterator125(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

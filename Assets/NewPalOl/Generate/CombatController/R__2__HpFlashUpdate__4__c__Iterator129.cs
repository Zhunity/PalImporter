...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<HpFlashUpdate>c__Iterator129
	/// </summary>
    public partial class R__2__HpFlashUpdate__4__c__Iterator129 : RMember //
    {
        ...
        public R__2__HpFlashUpdate__4__c__Iterator129() : base("CombatController+<HpFlashUpdate>c__Iterator129")
        {
        }

        public R__2__HpFlashUpdate__4__c__Iterator129(System.Object instance) : base("CombatController+<HpFlashUpdate>c__Iterator129")
		{
            SetInstance(instance);
		}

        public R__2__HpFlashUpdate__4__c__Iterator129(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__HpFlashUpdate__4__c__Iterator129(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

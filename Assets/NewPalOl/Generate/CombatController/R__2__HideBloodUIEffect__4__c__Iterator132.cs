...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<HideBloodUIEffect>c__Iterator132
	/// </summary>
    public partial class R__2__HideBloodUIEffect__4__c__Iterator132 : RMember //
    {
		...
		/// <summary>
		/// HideBloodUIEffect <tmpArgs>__0
		/// </summary>
		protected RHideBloodUIEffect r___2__tmpArgs__4____0;
		public virtual RHideBloodUIEffect R__2__tmpArgs__4____0
		{
			get
			{
        ...
        public R__2__HideBloodUIEffect__4__c__Iterator132() : base("CombatController+<HideBloodUIEffect>c__Iterator132")
        {
        }

        public R__2__HideBloodUIEffect__4__c__Iterator132(System.Object instance) : base("CombatController+<HideBloodUIEffect>c__Iterator132")
		{
            SetInstance(instance);
		}

        public R__2__HideBloodUIEffect__4__c__Iterator132(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__HideBloodUIEffect__4__c__Iterator132(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<ShowInjured>c__Iterator133
	/// </summary>
    public partial class R__2__ShowInjured__4__c__Iterator133 : RMember //
    {
		...
		/// <summary>
		/// ShowInjuredEffect <tmpArgs>__0
		/// </summary>
		protected RShowInjuredEffect r___2__tmpArgs__4____0;
		public virtual RShowInjuredEffect R__2__tmpArgs__4____0
		{
			get
			{
        ...
        public R__2__ShowInjured__4__c__Iterator133() : base("CombatController+<ShowInjured>c__Iterator133")
        {
        }

        public R__2__ShowInjured__4__c__Iterator133(System.Object instance) : base("CombatController+<ShowInjured>c__Iterator133")
		{
            SetInstance(instance);
		}

        public R__2__ShowInjured__4__c__Iterator133(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ShowInjured__4__c__Iterator133(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

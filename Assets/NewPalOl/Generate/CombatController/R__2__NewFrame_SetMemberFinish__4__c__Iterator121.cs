...
{public partial class RCombatController
{
	...
	/// <summary>
	/// CombatController+<NewFrame_SetMemberFinish>c__Iterator121
	/// </summary>
    public partial class R__2__NewFrame_SetMemberFinish__4__c__Iterator121 : RMember //
    {

		/// <summary>
		/// CCommmand <tmpCCmd>__0
		/// </summary>
		protected RCCommmand r___2__tmpCCmd__4____0;
		public virtual RCCommmand R__2__tmpCCmd__4____0
		{
			get
			{
				if(r___2__tmpCCmd__4____0 == null)
				{
					r___2__tmpCCmd__4____0 = new(this, "<tmpCCmd>__0");
					r___2__tmpCCmd__4____0.SetBelong(this.instance);
				}
				return r___2__tmpCCmd__4____0;
			}
		}
        ...
        public R__2__NewFrame_SetMemberFinish__4__c__Iterator121() : base("CombatController+<NewFrame_SetMemberFinish>c__Iterator121")
        {
        }

        public R__2__NewFrame_SetMemberFinish__4__c__Iterator121(System.Object instance) : base("CombatController+<NewFrame_SetMemberFinish>c__Iterator121")
		{
            SetInstance(instance);
		}

        public R__2__NewFrame_SetMemberFinish__4__c__Iterator121(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__NewFrame_SetMemberFinish__4__c__Iterator121(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

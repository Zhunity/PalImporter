...
{
	/// <summary>
	/// AfterMainCallStartCB
	/// </summary>
    public partial class RAfterMainCallStartCB : RMember //
    {
        ...
        public RAfterMainCallStartCB() : base("AfterMainCallStartCB")
        {
        }

        public RAfterMainCallStartCB(System.Object instance) : base("AfterMainCallStartCB")
		{
            SetInstance(instance);
		}

        public RAfterMainCallStartCB(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAfterMainCallStartCB(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

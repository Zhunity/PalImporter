...
{public partial class RUIManager
{
	...
	/// <summary>
	/// UIManager+<InitWaitAsset>c__Iterator192
	/// </summary>
    public partial class R__2__InitWaitAsset__4__c__Iterator192 : RMember //
    {
		...
		/// <summary>
		/// System.String <name>__1
		/// </summary>
		protected RField r___2__name__4____1;
		public virtual RField R__2__name__4____1
		{
			get
			{
				if(r___2__name__4____1 == null)
				{
					r___2__name__4____1 = new(this, "<name>__1");
					r___2__name__4____1.SetBelong(this.instance);
				}
				return r___2__name__4____1;
			}
		}
		...
		/// UIManager <>f__this
		/// </summary>
		protected RUIManager r___2____4__f__this;
		public virtual RUIManager R__2____4__f__this
		{
			get
			{
        ...
        public R__2__InitWaitAsset__4__c__Iterator192() : base("UIManager+<InitWaitAsset>c__Iterator192")
        {
        }

        public R__2__InitWaitAsset__4__c__Iterator192(System.Object instance) : base("UIManager+<InitWaitAsset>c__Iterator192")
		{
            SetInstance(instance);
		}

        public R__2__InitWaitAsset__4__c__Iterator192(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__InitWaitAsset__4__c__Iterator192(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

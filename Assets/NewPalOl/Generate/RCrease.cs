...
namespace SMFrame.Editor.Refleaction
{
	...
	/// Crease
	/// </summary>
    public partial class RCrease : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.Material _creaseApplyMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r__creaseApplyMaterial;
		public virtual RUnityEngine.RMaterial R_creaseApplyMaterial
		{
			get
			{
				if(r__creaseApplyMaterial == null)
				{
					r__creaseApplyMaterial = new(this, "_creaseApplyMaterial");
					r__creaseApplyMaterial.SetBelong(this.instance);
				}
				return r__creaseApplyMaterial;
			}
		}

		/// <summary>
		/// UnityEngine.Material _depthFetchMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r__depthFetchMaterial;
		public virtual RUnityEngine.RMaterial R_depthFetchMaterial
		{
			get
			{
				if(r__depthFetchMaterial == null)
				{
					r__depthFetchMaterial = new(this, "_depthFetchMaterial");
					r__depthFetchMaterial.SetBelong(this.instance);
				}
				return r__depthFetchMaterial;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Shader creaseApplyShader
		/// </summary>
		protected RUnityEngine.RShader r_creaseApplyShader;
		public virtual RUnityEngine.RShader RcreaseApplyShader
		{
			get
			{
				if(r_creaseApplyShader == null)
				{
					r_creaseApplyShader = new(this, "creaseApplyShader");
					r_creaseApplyShader.SetBelong(this.instance);
				}
				return r_creaseApplyShader;
			}
		}

		/// <summary>
		/// UnityEngine.Shader depthFetchShader
		/// </summary>
		protected RUnityEngine.RShader r_depthFetchShader;
		public virtual RUnityEngine.RShader RdepthFetchShader
		{
			get
			{
				if(r_depthFetchShader == null)
				{
					r_depthFetchShader = new(this, "depthFetchShader");
					r_depthFetchShader.SetBelong(this.instance);
				}
				return r_depthFetchShader;
			}
		}
		...
		/// <summary>
		/// System.Int32 softness
		/// </summary>
		protected RField r_softness;
		public virtual RField Rsoftness
		{
			get
			{
				if(r_softness == null)
				{
					r_softness = new(this, "softness");
					r_softness.SetBelong(this.instance);
				}
				return r_softness;
			}
		}
        ...
        public RCrease() : base("Crease")
        {
        }

        public RCrease(System.Object instance) : base("Crease")
		{
            SetInstance(instance);
		}

        public RCrease(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCrease(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

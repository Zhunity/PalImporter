...
{public partial class RTransactionMonitor
{
	...
	/// <summary>
	/// TransactionMonitor+OnStepDelegate
	/// </summary>
    public partial class ROnStepDelegate : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.String, Boolean, TransactionMonitor)
		/// </summary>
		protected RMethod r_RInvoke_String_Boolean_TransactionMonitor;
		public virtual RMethod RInvoke_String_Boolean_TransactionMonitor
		{
			get
			{
				if(r_RInvoke_String_Boolean_TransactionMonitor == null)
				{
					r_RInvoke_String_Boolean_TransactionMonitor = new(this, "Invoke", 0, typeof(System.String), typeof(System.Boolean), typeof(TransactionMonitor));
					r_RInvoke_String_Boolean_TransactionMonitor.SetBelong(this.instance);
				}
				return r_RInvoke_String_Boolean_TransactionMonitor;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.String, Boolean, TransactionMonitor, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_String_Boolean_TransactionMonitor_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_String_Boolean_TransactionMonitor_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_String_Boolean_TransactionMonitor_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_String_Boolean_TransactionMonitor_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.String), typeof(System.Boolean), typeof(TransactionMonitor), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_String_Boolean_TransactionMonitor_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_String_Boolean_TransactionMonitor_AsyncCallback_Object;
			}
		}
        ...
        public ROnStepDelegate() : base("TransactionMonitor+OnStepDelegate")
        {
        }

        public ROnStepDelegate(System.Object instance) : base("TransactionMonitor+OnStepDelegate")
		{
            SetInstance(instance);
		}

        public ROnStepDelegate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public ROnStepDelegate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.String  @step, System.Boolean  @success, TransactionMonitor  @transaction)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@step, @success, @transaction};
            var ___result = RInvoke_String_Boolean_TransactionMonitor.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.String  @step, System.Boolean  @success, TransactionMonitor  @transaction, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@step, @success, @transaction, @callback, @object};
            var ___result = RBeginInvoke_String_Boolean_TransactionMonitor_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

...
{public partial class RTransactionMonitor
{
	...
	/// <summary>
	/// TransactionMonitor+OnCompleteDelegate
	/// </summary>
    public partial class ROnCompleteDelegate : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(ExitCondition, System.String, System.Object)
		/// </summary>
		protected RMethod r_RInvoke_ExitCondition_String_Object;
		public virtual RMethod RInvoke_ExitCondition_String_Object
		{
			get
			{
				if(r_RInvoke_ExitCondition_String_Object == null)
				{
					r_RInvoke_ExitCondition_String_Object = new(this, "Invoke", 0,  ReleactionUtils.GetType("TransactionMonitor+ExitCondition"), typeof(System.String), typeof(System.Object));
					r_RInvoke_ExitCondition_String_Object.SetBelong(this.instance);
				}
				return r_RInvoke_ExitCondition_String_Object;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(ExitCondition, System.String, System.Object, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_ExitCondition_String_Object_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_ExitCondition_String_Object_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_ExitCondition_String_Object_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_ExitCondition_String_Object_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("TransactionMonitor+ExitCondition"), typeof(System.String), typeof(System.Object), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_ExitCondition_String_Object_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_ExitCondition_String_Object_AsyncCallback_Object;
			}
		}
        ...
        public ROnCompleteDelegate() : base("TransactionMonitor+OnCompleteDelegate")
        {
        }

        public ROnCompleteDelegate(System.Object instance) : base("TransactionMonitor+OnCompleteDelegate")
		{
            SetInstance(instance);
		}

        public ROnCompleteDelegate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public ROnCompleteDelegate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

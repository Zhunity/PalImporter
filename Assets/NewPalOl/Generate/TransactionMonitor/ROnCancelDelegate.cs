...
{public partial class RTransactionMonitor
{
	...
	/// <summary>
	/// TransactionMonitor+OnCancelDelegate
	/// </summary>
    public partial class ROnCancelDelegate : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(ExitCondition, System.Object)
		/// </summary>
		protected RMethod r_RInvoke_ExitCondition_Object;
		public virtual RMethod RInvoke_ExitCondition_Object
		{
			get
			{
				if(r_RInvoke_ExitCondition_Object == null)
				{
					r_RInvoke_ExitCondition_Object = new(this, "Invoke", 0,  ReleactionUtils.GetType("TransactionMonitor+ExitCondition"), typeof(System.Object));
					r_RInvoke_ExitCondition_Object.SetBelong(this.instance);
				}
				return r_RInvoke_ExitCondition_Object;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(ExitCondition, System.Object, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_ExitCondition_Object_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_ExitCondition_Object_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_ExitCondition_Object_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_ExitCondition_Object_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("TransactionMonitor+ExitCondition"), typeof(System.Object), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_ExitCondition_Object_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_ExitCondition_Object_AsyncCallback_Object;
			}
		}
        ...
        public ROnCancelDelegate() : base("TransactionMonitor+OnCancelDelegate")
        {
        }

        public ROnCancelDelegate(System.Object instance) : base("TransactionMonitor+OnCancelDelegate")
		{
            SetInstance(instance);
		}

        public ROnCancelDelegate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public ROnCancelDelegate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{
	/// <summary>
	/// TextureObjectSetting
	/// </summary>
    public partial class RTextureObjectSetting : RMember //
    {
		...
		/// <summary>
		/// System.Single flareStrength
		/// </summary>
		protected RField r_flareStrength;
		public virtual RField RflareStrength
		{
			get
			{
				if(r_flareStrength == null)
				{
					r_flareStrength = new(this, "flareStrength");
					r_flareStrength.SetBelong(this.instance);
				}
				return r_flareStrength;
			}
		}
		...
		/// <summary>
		/// System.Single haloStrength
		/// </summary>
		protected RField r_haloStrength;
		public virtual RField RhaloStrength
		{
			get
			{
				if(r_haloStrength == null)
				{
					r_haloStrength = new(this, "haloStrength");
					r_haloStrength.SetBelong(this.instance);
				}
				return r_haloStrength;
			}
		}

		/// <summary>
		/// UnityEngine.Color tmpAmbientLight
		/// </summary>
		protected RUnityEngine.RColor r_tmpAmbientLight;
		public virtual RUnityEngine.RColor RtmpAmbientLight
		{
			get
			{
				if(r_tmpAmbientLight == null)
				{
					r_tmpAmbientLight = new(this, "tmpAmbientLight");
					r_tmpAmbientLight.SetBelong(this.instance);
				}
				return r_tmpAmbientLight;
			}
		}

		/// <summary>
		/// System.Single tmpFlareStrength
		/// </summary>
		protected RField r_tmpFlareStrength;
		public virtual RField RtmpFlareStrength
		{
			get
			{
				if(r_tmpFlareStrength == null)
				{
					r_tmpFlareStrength = new(this, "tmpFlareStrength");
					r_tmpFlareStrength.SetBelong(this.instance);
				}
				return r_tmpFlareStrength;
			}
		}

		/// <summary>
		/// System.Boolean tmpFog
		/// </summary>
		protected RField r_tmpFog;
		public virtual RField RtmpFog
		{
			get
			{
				if(r_tmpFog == null)
				{
					r_tmpFog = new(this, "tmpFog");
					r_tmpFog.SetBelong(this.instance);
				}
				return r_tmpFog;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Color tmpFogColor
		/// </summary>
		protected RUnityEngine.RColor r_tmpFogColor;
		public virtual RUnityEngine.RColor RtmpFogColor
		{
			get
			{
				if(r_tmpFogColor == null)
				{
					r_tmpFogColor = new(this, "tmpFogColor");
					r_tmpFogColor.SetBelong(this.instance);
				}
				return r_tmpFogColor;
			}
		}

		/// <summary>
		/// System.Single tmpFogDensity
		/// </summary>
		protected RField r_tmpFogDensity;
		public virtual RField RtmpFogDensity
		{
			get
			{
				if(r_tmpFogDensity == null)
				{
					r_tmpFogDensity = new(this, "tmpFogDensity");
					r_tmpFogDensity.SetBelong(this.instance);
				}
				return r_tmpFogDensity;
			}
		}

		/// <summary>
		/// System.Single tmpHaloStrength
		/// </summary>
		protected RField r_tmpHaloStrength;
		public virtual RField RtmpHaloStrength
		{
			get
			{
				if(r_tmpHaloStrength == null)
				{
					r_tmpHaloStrength = new(this, "tmpHaloStrength");
					r_tmpHaloStrength.SetBelong(this.instance);
				}
				return r_tmpHaloStrength;
			}
		}

		/// <summary>
		/// UnityEngine.RenderTexture targetRenderTextrue
		/// </summary>
		protected RUnityEngine.RRenderTexture r_targetRenderTextrue;
		public virtual RUnityEngine.RRenderTexture RtargetRenderTextrue
		{
			get
			{
				if(r_targetRenderTextrue == null)
				{
					r_targetRenderTextrue = new(this, "targetRenderTextrue");
					r_targetRenderTextrue.SetBelong(this.instance);
				}
				return r_targetRenderTextrue;
			}
		}
		...
		/// Void OnPostRender()
		/// </summary>
		protected RMethod r_ROnPostRender;
		public virtual RMethod ROnPostRender
		{
			get
			{
				if(r_ROnPostRender == null)
				{
					r_ROnPostRender = new(this, "OnPostRender", 0);
					r_ROnPostRender.SetBelong(this.instance);
				}
				return r_ROnPostRender;
			}
		}
        ...
        public RTextureObjectSetting() : base("TextureObjectSetting")
        {
        }

        public RTextureObjectSetting(System.Object instance) : base("TextureObjectSetting")
		{
            SetInstance(instance);
		}

        public RTextureObjectSetting(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RTextureObjectSetting(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void OnPostRender()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = ROnPostRender.Invoke(___genericsType, ___parameters);

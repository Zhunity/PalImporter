...
{
	/// <summary>
	/// PrestigeItemNameXMLReader
	/// </summary>
    public partial class RPrestigeItemNameXMLReader : RMember //
    {
        ...
        public RPrestigeItemNameXMLReader() : base("PrestigeItemNameXMLReader")
        {
        }

        public RPrestigeItemNameXMLReader(System.Object instance) : base("PrestigeItemNameXMLReader")
		{
            SetInstance(instance);
		}

        public RPrestigeItemNameXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPrestigeItemNameXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

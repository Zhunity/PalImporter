...
{
	/// <summary>
	/// SceneMovieEffectManager
	/// </summary>
    public partial class RSceneMovieEffectManager : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.String,UnityEngine.GameObject] m_listEffect
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, RUnityEngine.RGameObject> r_m_listEffect;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, RUnityEngine.RGameObject> Rm_listEffect
		{
			get
			{
				if(r_m_listEffect == null)
				{
					r_m_listEffect = new(this, "m_listEffect");
					r_m_listEffect.SetBelong(this.instance);
				}
				return r_m_listEffect;
			}
		}

		/// <summary>
		/// System.Collections.Generic.List`1[UnityEngine.GameObject] m_AllEffects
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RGameObject> r_m_AllEffects;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RGameObject> Rm_AllEffects
		{
			get
			{
				if(r_m_AllEffects == null)
				{
					r_m_AllEffects = new(this, "m_AllEffects");
					r_m_AllEffects.SetBelong(this.instance);
				}
				return r_m_AllEffects;
			}
		}
		...
		/// Void ResetEffectLib()
		/// </summary>
		protected RMethod r_RResetEffectLib;
		public virtual RMethod RResetEffectLib
		{
			get
			{
				if(r_RResetEffectLib == null)
				{
					r_RResetEffectLib = new(this, "ResetEffectLib", 0);
					r_RResetEffectLib.SetBelong(this.instance);
				}
				return r_RResetEffectLib;
			}
		}

		/// <summary>
		/// Void ScenePlayAnim(System.String, System.String)
		/// </summary>
		protected RMethod r_RScenePlayAnim_String_String;
		public virtual RMethod RScenePlayAnim_String_String
		{
			get
			{
				if(r_RScenePlayAnim_String_String == null)
				{
					r_RScenePlayAnim_String_String = new(this, "ScenePlayAnim", 0, typeof(System.String), typeof(System.String));
					r_RScenePlayAnim_String_String.SetBelong(this.instance);
				}
				return r_RScenePlayAnim_String_String;
			}
		}

		/// <summary>
		/// Void EffectBind(System.String, System.String, System.String, System.String, Single, Single, Single)
		/// </summary>
		protected RMethod r_REffectBind_String_String_String_String_Single_Single_Single;
		public virtual RMethod REffectBind_String_String_String_String_Single_Single_Single
		{
			get
			{
				if(r_REffectBind_String_String_String_String_Single_Single_Single == null)
				{
					r_REffectBind_String_String_String_String_Single_Single_Single = new(this, "EffectBind", 0, typeof(System.String), typeof(System.String), typeof(System.String), typeof(System.String), typeof(System.Single), typeof(System.Single), typeof(System.Single));
					r_REffectBind_String_String_String_String_Single_Single_Single.SetBelong(this.instance);
				}
				return r_REffectBind_String_String_String_String_Single_Single_Single;
			}
		}

		/// <summary>
		/// Void EffectPlay(System.String, System.String, System.String, UnityEngine.Vector3, UnityEngine.Vector3, Single, Single, Single)
		/// </summary>
		protected RMethod r_REffectPlay_String_String_String_Vector3_Vector3_Single_Single_Single;
		public virtual RMethod REffectPlay_String_String_String_Vector3_Vector3_Single_Single_Single
		{
			get
			{
				if(r_REffectPlay_String_String_String_Vector3_Vector3_Single_Single_Single == null)
				{
					r_REffectPlay_String_String_String_Vector3_Vector3_Single_Single_Single = new(this, "EffectPlay", 0, typeof(System.String), typeof(System.String), typeof(System.String), typeof(UnityEngine.Vector3), typeof(UnityEngine.Vector3), typeof(System.Single), typeof(System.Single), typeof(System.Single));
					r_REffectPlay_String_String_String_Vector3_Vector3_Single_Single_Single.SetBelong(this.instance);
				}
				return r_REffectPlay_String_String_String_Vector3_Vector3_Single_Single_Single;
			}
		}

		/// <summary>
		/// Void EffectStop(System.String)
		/// </summary>
		protected RMethod r_REffectStop_String;
		public virtual RMethod REffectStop_String
		{
			get
			{
				if(r_REffectStop_String == null)
				{
					r_REffectStop_String = new(this, "EffectStop", 0, typeof(System.String));
					r_REffectStop_String.SetBelong(this.instance);
				}
				return r_REffectStop_String;
			}
		}

		/// <summary>
		/// Boolean IsParentContainsDelay(UnityEngine.Transform, UnityEngine.Transform)
		/// </summary>
		protected RMethod r_RIsParentContainsDelay_Transform_Transform;
		public virtual RMethod RIsParentContainsDelay_Transform_Transform
		{
			get
			{
				if(r_RIsParentContainsDelay_Transform_Transform == null)
				{
					r_RIsParentContainsDelay_Transform_Transform = new(this, "IsParentContainsDelay", 0, typeof(UnityEngine.Transform), typeof(UnityEngine.Transform));
					r_RIsParentContainsDelay_Transform_Transform.SetBelong(this.instance);
				}
				return r_RIsParentContainsDelay_Transform_Transform;
			}
		}

		/// <summary>
		/// Void CalcStartTime(Single, UnityEngine.GameObject)
		/// </summary>
		protected RMethod r_RCalcStartTime_Single_GameObject;
		public virtual RMethod RCalcStartTime_Single_GameObject
		{
			get
			{
				if(r_RCalcStartTime_Single_GameObject == null)
				{
					r_RCalcStartTime_Single_GameObject = new(this, "CalcStartTime", 0, typeof(System.Single), typeof(UnityEngine.GameObject));
					r_RCalcStartTime_Single_GameObject.SetBelong(this.instance);
				}
				return r_RCalcStartTime_Single_GameObject;
			}
		}
        ...
        public RSceneMovieEffectManager() : base("SceneMovieEffectManager")
        {
        }

        public RSceneMovieEffectManager(System.Object instance) : base("SceneMovieEffectManager")
		{
            SetInstance(instance);
		}

        public RSceneMovieEffectManager(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSceneMovieEffectManager(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void ResetEffectLib()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RResetEffectLib.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void ScenePlayAnim(System.String  @objpath, System.String  @animName)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@objpath, @animName};
            var ___result = RScenePlayAnim_String_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void EffectBind(System.String  @id, System.String  @asset, System.String  @nodeName, System.String  @boneName, System.Single  @timeout, System.Single  @starttime, System.Single  @speed)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id, @asset, @nodeName, @boneName, @timeout, @starttime, @speed};
            var ___result = REffectBind_String_String_String_String_Single_Single_Single.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void EffectPlay(System.String  @id, System.String  @asset, System.String  @nodeName, UnityEngine.Vector3  @position, UnityEngine.Vector3  @rotation, System.Single  @timeout, System.Single  @starttime, System.Single  @speed)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id, @asset, @nodeName, @position, @rotation, @timeout, @starttime, @speed};
            var ___result = REffectPlay_String_String_String_Vector3_Vector3_Single_Single_Single.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void EffectStop(System.String  @id)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id};
            var ___result = REffectStop_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Boolean IsParentContainsDelay(UnityEngine.Transform  @trans, UnityEngine.Transform  @root)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@trans, @root};
            var ___result = RIsParentContainsDelay_Transform_Transform.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual void CalcStartTime(System.Single  @starttime, UnityEngine.GameObject  @effect)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@starttime, @effect};
            var ___result = RCalcStartTime_Single_GameObject.Invoke(___genericsType, ___parameters);

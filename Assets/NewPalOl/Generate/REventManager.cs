...
namespace SMFrame.Editor.Refleaction
{
	...
	/// EventManager
	/// </summary>
    public partial class REventManager : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.String,EventBase] mEventMap
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, REventBase> r_mEventMap;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, REventBase> RmEventMap
		{
			get
			{
				if(r_mEventMap == null)
				{
					r_mEventMap = new(this, "mEventMap");
					r_mEventMap.SetBelong(this.instance);
				}
				return r_mEventMap;
			}
		}
		...
		/// <summary>
		/// EventManager mSingleton
		/// </summary>
		protected static REventManager r_mSingleton;
		public static REventManager RmSingleton
		{
			get
			{
				if(r_mSingleton == null)
				{
					r_mSingleton = new( ReleactionUtils.GetType("EventManager"), "mSingleton");
					r_mSingleton.SetBelong(null);
				}
				return r_mSingleton;
			}
		}
		...
		/// <summary>
		/// System.EventArgs mEventArgs
		/// </summary>
		protected RSystem.REventArgs r_mEventArgs;
		public virtual RSystem.REventArgs RmEventArgs
		{
			get
			{
				if(r_mEventArgs == null)
				{
					r_mEventArgs = new(this, "mEventArgs");
					r_mEventArgs.SetBelong(this.instance);
				}
				return r_mEventArgs;
			}
		}
		...
		/// <summary>
		/// System.Int32 mFrameCount
		/// </summary>
		protected RField r_mFrameCount;
		public virtual RField RmFrameCount
		{
			get
			{
				if(r_mFrameCount == null)
				{
					r_mFrameCount = new(this, "mFrameCount");
					r_mFrameCount.SetBelong(this.instance);
				}
				return r_mFrameCount;
			}
		}

		/// <summary>
		/// EventHandler mWait4FrameHandle
		/// </summary>
		protected REventHandler r_mWait4FrameHandle;
		public virtual REventHandler RmWait4FrameHandle
		{
			get
			{
				if(r_mWait4FrameHandle == null)
				{
					r_mWait4FrameHandle = new(this, "mWait4FrameHandle");
					r_mWait4FrameHandle.SetBelong(this.instance);
				}
				return r_mWait4FrameHandle;
			}
		}
		...
		/// </summary>
		protected static REventManager r_Instance;
		public static REventManager RInstance
		{
			get
			{
				if(r_Instance == null)
				{
					r_Instance = new( ReleactionUtils.GetType("EventManager"), "Instance", -1);
		...
		/// <summary>
		/// Boolean RegisterEvent(System.String, EventBase)
		/// </summary>
		protected RMethod r_RRegisterEvent_String_EventBase;
		public virtual RMethod RRegisterEvent_String_EventBase
		{
			get
			{
				if(r_RRegisterEvent_String_EventBase == null)
				{
					r_RRegisterEvent_String_EventBase = new(this, "RegisterEvent", 0, typeof(System.String),  ReleactionUtils.GetType("EventBase"));
					r_RRegisterEvent_String_EventBase.SetBelong(this.instance);
				}
				return r_RRegisterEvent_String_EventBase;
			}
		}
		...
		/// <summary>
		/// Boolean DeleteEvent(System.String)
		/// </summary>
		protected RMethod r_RDeleteEvent_String;
		public virtual RMethod RDeleteEvent_String
		{
			get
			{
				if(r_RDeleteEvent_String == null)
				{
					r_RDeleteEvent_String = new(this, "DeleteEvent", 0, typeof(System.String));
					r_RDeleteEvent_String.SetBelong(this.instance);
				}
				return r_RDeleteEvent_String;
			}
		}
		...
		/// Void ClearEventMap()
		/// </summary>
		protected RMethod r_RClearEventMap;
		public virtual RMethod RClearEventMap
		{
			get
			{
				if(r_RClearEventMap == null)
				{
					r_RClearEventMap = new(this, "ClearEventMap", 0);
					r_RClearEventMap.SetBelong(this.instance);
				}
				return r_RClearEventMap;
			}
		}

		/// <summary>
		/// EventBase GetEvent(System.String)
		/// </summary>
		...
		/// <summary>
		/// Boolean SleepEvent(System.String)
		/// </summary>
		protected RMethod r_RSleepEvent_String;
		public virtual RMethod RSleepEvent_String
		{
			get
			{
				if(r_RSleepEvent_String == null)
				{
					r_RSleepEvent_String = new(this, "SleepEvent", 0, typeof(System.String));
					r_RSleepEvent_String.SetBelong(this.instance);
				}
				return r_RSleepEvent_String;
			}
		}

		/// <summary>
		/// Boolean ActiveEvent(System.String)
		/// </summary>
		protected RMethod r_RActiveEvent_String;
		public virtual RMethod RActiveEvent_String
		{
			get
			{
				if(r_RActiveEvent_String == null)
				{
					r_RActiveEvent_String = new(this, "ActiveEvent", 0, typeof(System.String));
					r_RActiveEvent_String.SetBelong(this.instance);
				}
				return r_RActiveEvent_String;
			}
		}

		/// <summary>
		/// Boolean WakeEvent(System.String)
		/// </summary>
		protected RMethod r_RWakeEvent_String;
		public virtual RMethod RWakeEvent_String
		{
			get
			{
				if(r_RWakeEvent_String == null)
				{
					r_RWakeEvent_String = new(this, "WakeEvent", 0, typeof(System.String));
					r_RWakeEvent_String.SetBelong(this.instance);
				}
				return r_RWakeEvent_String;
			}
		}

		/// <summary>
		/// Void InvokeFun(Single, EventHandler, System.Object, System.EventArgs)
		/// </summary>
		protected RMethod r_RInvokeFun_Single_EventHandler_Object_EventArgs;
		public virtual RMethod RInvokeFun_Single_EventHandler_Object_EventArgs
		{
			get
			{
				if(r_RInvokeFun_Single_EventHandler_Object_EventArgs == null)
				{
					r_RInvokeFun_Single_EventHandler_Object_EventArgs = new(this, "InvokeFun", 0, typeof(System.Single), typeof(EventHandler), typeof(System.Object), typeof(System.EventArgs));
					r_RInvokeFun_Single_EventHandler_Object_EventArgs.SetBelong(this.instance);
				}
				return r_RInvokeFun_Single_EventHandler_Object_EventArgs;
			}
		}
		...
		/// Void StopAll()
		/// </summary>
		protected RMethod r_RStopAll;
		public virtual RMethod RStopAll
		{
			get
			{
				if(r_RStopAll == null)
				{
					r_RStopAll = new(this, "StopAll", 0);
					r_RStopAll.SetBelong(this.instance);
				}
				return r_RStopAll;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator Fun(Single, EventHandler, System.Object, System.EventArgs)
		/// </summary>
		protected RMethod r_RFun_Single_EventHandler_Object_EventArgs;
		public virtual RMethod RFun_Single_EventHandler_Object_EventArgs
		{
			get
			{
				if(r_RFun_Single_EventHandler_Object_EventArgs == null)
				{
					r_RFun_Single_EventHandler_Object_EventArgs = new(this, "Fun", 0, typeof(System.Single), typeof(EventHandler), typeof(System.Object), typeof(System.EventArgs));
					r_RFun_Single_EventHandler_Object_EventArgs.SetBelong(this.instance);
				}
				return r_RFun_Single_EventHandler_Object_EventArgs;
			}
		}

		/// <summary>
		/// Void WaitForFrames(Int32, EventHandler, System.Object, System.EventArgs)
		/// </summary>
		protected RMethod r_RWaitForFrames_Int32_EventHandler_Object_EventArgs;
		public virtual RMethod RWaitForFrames_Int32_EventHandler_Object_EventArgs
		{
			get
			{
				if(r_RWaitForFrames_Int32_EventHandler_Object_EventArgs == null)
				{
					r_RWaitForFrames_Int32_EventHandler_Object_EventArgs = new(this, "WaitForFrames", 0, typeof(System.Int32), typeof(EventHandler), typeof(System.Object), typeof(System.EventArgs));
					r_RWaitForFrames_Int32_EventHandler_Object_EventArgs.SetBelong(this.instance);
				}
				return r_RWaitForFrames_Int32_EventHandler_Object_EventArgs;
			}
		}
        ...
        public REventManager() : base("EventManager")
        {
        }

        public REventManager(System.Object instance) : base("EventManager")
		{
            SetInstance(instance);
		}

        public REventManager(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REventManager(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Boolean DeleteEvent(System.String  @evtName)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@evtName};
            var ___result = RDeleteEvent_String.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual void ClearEventMap()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RClearEventMap.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Object GetEvent(System.String  @evtName)
        {
        ...
        public virtual System.Boolean SleepEvent(System.String  @evtName)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@evtName};
            var ___result = RSleepEvent_String.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual System.Boolean ActiveEvent(System.String  @evtName)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@evtName};
            var ___result = RActiveEvent_String.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual System.Boolean WakeEvent(System.String  @evtName)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@evtName};
            var ___result = RWakeEvent_String.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual void InvokeFun(System.Single  @time, EventHandler  @mHandler, System.Object  @sender, System.EventArgs  @e)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time, @mHandler, @sender, @e};
            var ___result = RInvokeFun_Single_EventHandler_Object_EventArgs.Invoke(___genericsType, ___parameters);
        ...
        public virtual void StopAll()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RStopAll.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator Fun(System.Single  @time, EventHandler  @obj, System.Object  @sender, System.EventArgs  @e)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time, @obj, @sender, @e};
            var ___result = RFun_Single_EventHandler_Object_EventArgs.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual void WaitForFrames(System.Int32  @Frames, EventHandler  @mHandler, System.Object  @sender, System.EventArgs  @e)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@Frames, @mHandler, @sender, @e};
            var ___result = RWaitForFrames_Int32_EventHandler_Object_EventArgs.Invoke(___genericsType, ___parameters);

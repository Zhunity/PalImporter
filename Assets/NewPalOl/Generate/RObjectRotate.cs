...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ObjectRotate
	/// </summary>
    public partial class RObjectRotate : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.Space coordinateSpace
		/// </summary>
		protected RField r_coordinateSpace;
		public virtual RField RcoordinateSpace
		{
			get
			{
				if(r_coordinateSpace == null)
				{
					r_coordinateSpace = new(this, "coordinateSpace");
					r_coordinateSpace.SetBelong(this.instance);
				}
				return r_coordinateSpace;
			}
		}
        ...
        public RObjectRotate() : base("ObjectRotate")
        {
        }

        public RObjectRotate(System.Object instance) : base("ObjectRotate")
		{
            SetInstance(instance);
		}

        public RObjectRotate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RObjectRotate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

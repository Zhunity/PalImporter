...
namespace SMFrame.Editor.Refleaction
{
	...
	/// StatueAction
	/// </summary>
    public partial class RStatueAction : RMember //
    {
        ...
        public RStatueAction() : base("StatueAction")
        {
        }

        public RStatueAction(System.Object instance) : base("StatueAction")
		{
            SetInstance(instance);
		}

        public RStatueAction(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RStatueAction(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

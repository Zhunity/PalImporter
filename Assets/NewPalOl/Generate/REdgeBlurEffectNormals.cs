...
{
	/// <summary>
	/// EdgeBlurEffectNormals
	/// </summary>
    public partial class REdgeBlurEffectNormals : RMember //
    {

		/// <summary>
		/// UnityEngine.Material _edgeBlurApplyMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r__edgeBlurApplyMaterial;
		public virtual RUnityEngine.RMaterial R_edgeBlurApplyMaterial
		{
			get
			{
				if(r__edgeBlurApplyMaterial == null)
				{
					r__edgeBlurApplyMaterial = new(this, "_edgeBlurApplyMaterial");
					r__edgeBlurApplyMaterial.SetBelong(this.instance);
				}
				return r__edgeBlurApplyMaterial;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Material _showAlphaChannelMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r__showAlphaChannelMaterial;
		public virtual RUnityEngine.RMaterial R_showAlphaChannelMaterial
		{
			get
			{
				if(r__showAlphaChannelMaterial == null)
				{
					r__showAlphaChannelMaterial = new(this, "_showAlphaChannelMaterial");
					r__showAlphaChannelMaterial.SetBelong(this.instance);
				}
				return r__showAlphaChannelMaterial;
			}
		}

		/// <summary>
		/// UnityEngine.Shader edgeBlurApplyShader
		/// </summary>
		protected RUnityEngine.RShader r_edgeBlurApplyShader;
		public virtual RUnityEngine.RShader RedgeBlurApplyShader
		{
			get
			{
				if(r_edgeBlurApplyShader == null)
				{
					r_edgeBlurApplyShader = new(this, "edgeBlurApplyShader");
					r_edgeBlurApplyShader.SetBelong(this.instance);
				}
				return r_edgeBlurApplyShader;
			}
		}
		...
		/// <summary>
		/// System.Single edgeDetectSpread
		/// </summary>
		protected RField r_edgeDetectSpread;
		public virtual RField RedgeDetectSpread
		{
			get
			{
				if(r_edgeDetectSpread == null)
				{
					r_edgeDetectSpread = new(this, "edgeDetectSpread");
					r_edgeDetectSpread.SetBelong(this.instance);
				}
				return r_edgeDetectSpread;
			}
		}

		/// <summary>
		/// System.Single filterRadius
		/// </summary>
		protected RField r_filterRadius;
		public virtual RField RfilterRadius
		{
			get
			{
				if(r_filterRadius == null)
				{
					r_filterRadius = new(this, "filterRadius");
					r_filterRadius.SetBelong(this.instance);
				}
				return r_filterRadius;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Shader showAlphaChannelShader
		/// </summary>
		protected RUnityEngine.RShader r_showAlphaChannelShader;
		public virtual RUnityEngine.RShader RshowAlphaChannelShader
		{
			get
			{
				if(r_showAlphaChannelShader == null)
				{
					r_showAlphaChannelShader = new(this, "showAlphaChannelShader");
					r_showAlphaChannelShader.SetBelong(this.instance);
				}
				return r_showAlphaChannelShader;
			}
		}

		/// <summary>
		/// System.Boolean showEdges
		/// </summary>
		protected RField r_showEdges;
		public virtual RField RshowEdges
		{
			get
			{
				if(r_showEdges == null)
				{
					r_showEdges = new(this, "showEdges");
					r_showEdges.SetBelong(this.instance);
				}
				return r_showEdges;
			}
		}
        ...
        public REdgeBlurEffectNormals() : base("EdgeBlurEffectNormals")
        {
        }

        public REdgeBlurEffectNormals(System.Object instance) : base("EdgeBlurEffectNormals")
		{
            SetInstance(instance);
		}

        public REdgeBlurEffectNormals(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REdgeBlurEffectNormals(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CameraMask
	/// </summary>
    public partial class RCameraMask : RMember //
    {

		/// <summary>
		/// UnityEngine.Material _mat
		/// </summary>
		protected static RUnityEngine.RMaterial r__mat;
		public static RUnityEngine.RMaterial R_mat
		{
			get
			{
				if(r__mat == null)
				{
					r__mat = new(typeof(CameraMask), "_mat");
					r__mat.SetBelong(null);
				}
				return r__mat;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Texture m_mask
		/// </summary>
		protected RUnityEngine.RTexture r_m_mask;
		public virtual RUnityEngine.RTexture Rm_mask
		{
			get
			{
				if(r_m_mask == null)
		...
		/// <summary>
		/// MyGUI.ElementBase m_EB
		/// </summary>
		protected RMyGUI.RElementBase r_m_EB;
		public virtual RMyGUI.RElementBase Rm_EB
		{
			get
			{
				if(r_m_EB == null)
				{
					r_m_EB = new(this, "m_EB");
					r_m_EB.SetBelong(this.instance);
				}
				return r_m_EB;
			}
		}
		...
		/// </summary>
		protected static RUnityEngine.RMaterial r_mat;
		public static RUnityEngine.RMaterial Rmat
		{
			get
			{
				if(r_mat == null)
				{
					r_mat = new(typeof(CameraMask), "mat", -1);
					r_mat.SetBelong(null);
				}
				return r_mat;
			}
		}
		...
		/// <summary>
		/// Void Init(MyGUI.ElementBase)
		/// </summary>
		protected RMethod r_RInit_ElementBase;
		public virtual RMethod RInit_ElementBase
		{
			get
			{
				if(r_RInit_ElementBase == null)
				{
					r_RInit_ElementBase = new(this, "Init", 0, typeof(MyGUI.ElementBase));
					r_RInit_ElementBase.SetBelong(this.instance);
				}
				return r_RInit_ElementBase;
			}
		}
        ...
        public RCameraMask() : base("CameraMask")
        {
        }

        public RCameraMask(System.Object instance) : base("CameraMask")
		{
            SetInstance(instance);
		}

        public RCameraMask(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCameraMask(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Init(MyGUI.ElementBase  @uiElement)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@uiElement};
            var ___result = RInit_ElementBase.Invoke(___genericsType, ___parameters);

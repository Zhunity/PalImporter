...
namespace SMFrame.Editor.Refleaction
{
	...
	/// </summary>
    public partial class RTimedObjectDestructor : RMember //
    {

		/// <summary>
		/// System.Boolean detachChildren
		/// </summary>
		protected RField r_detachChildren;
		public virtual RField RdetachChildren
		{
			get
			{
				if(r_detachChildren == null)
				{
					r_detachChildren = new(this, "detachChildren");
        ...
        public RTimedObjectDestructor() : base("TimedObjectDestructor")
        {
        }

        public RTimedObjectDestructor(System.Object instance) : base("TimedObjectDestructor")
		{
            SetInstance(instance);
		}

        public RTimedObjectDestructor(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RTimedObjectDestructor(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

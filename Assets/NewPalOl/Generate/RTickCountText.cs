...
namespace SMFrame.Editor.Refleaction
{
	...
	/// TickCountText
	/// </summary>
    public partial class RTickCountText : RMember //
    {
		...
		/// Void UpdateSecond()
		/// </summary>
		protected RMethod r_RUpdateSecond;
		public virtual RMethod RUpdateSecond
		{
			get
			{
				if(r_RUpdateSecond == null)
				{
					r_RUpdateSecond = new(this, "UpdateSecond", 0);
					r_RUpdateSecond.SetBelong(this.instance);
				}
				return r_RUpdateSecond;
			}
		}
        ...
        public RTickCountText() : base("TickCountText")
        {
        }

        public RTickCountText(System.Object instance) : base("TickCountText")
		{
            SetInstance(instance);
		}

        public RTickCountText(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RTickCountText(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void UpdateSecond()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RUpdateSecond.Invoke(___genericsType, ___parameters);

...
{public partial class RCountdownManager
{
	...
	/// </summary>
    public partial class RHandler : RMember //
    {
        ...
        public RHandler() : base("CountdownManager+Handler")
        {
        }

        public RHandler(System.Object instance) : base("CountdownManager+Handler")
		{
            SetInstance(instance);
		}

        public RHandler(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RHandler(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

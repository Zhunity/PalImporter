...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MyGUIEmptyWnd
	/// </summary>
    public partial class RMyGUIEmptyWnd : RMember //
    {
        ...
        public RMyGUIEmptyWnd() : base("MyGUIEmptyWnd")
        {
        }

        public RMyGUIEmptyWnd(System.Object instance) : base("MyGUIEmptyWnd")
		{
            SetInstance(instance);
		}

        public RMyGUIEmptyWnd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMyGUIEmptyWnd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__2k(MyGUI.ElementBase  @elem)
        {
        ...
        public virtual void __0__3k(MyGUI.ElementBase  @elem)
        {

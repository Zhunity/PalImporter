...
{public partial class RHighlightableObject
{
	...
	/// <summary>
	/// HighlightableObject+<EndOfFrame>c__Iterator110
	/// </summary>
    public partial class R__2__EndOfFrame__4__c__Iterator110 : RMember //
    {
		...
		/// <summary>
		/// HighlightableObject <>f__this
		/// </summary>
		protected RHighlightableObject r___2____4__f__this;
		public virtual RHighlightableObject R__2____4__f__this
		{
			get
			{
        ...
        public R__2__EndOfFrame__4__c__Iterator110() : base("HighlightableObject+<EndOfFrame>c__Iterator110")
        {
        }

        public R__2__EndOfFrame__4__c__Iterator110(System.Object instance) : base("HighlightableObject+<EndOfFrame>c__Iterator110")
		{
            SetInstance(instance);
		}

        public R__2__EndOfFrame__4__c__Iterator110(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__EndOfFrame__4__c__Iterator110(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

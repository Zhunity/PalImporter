...
{public partial class RMyGUIXJCardWnd
{
	...
	/// MyGUIXJCardWnd+#fee
	/// </summary>
    public partial class R__0__fee : RMember //
    {
		...
		/// Void Invoke(XJCard)
		/// </summary>
		protected RMethod r_RInvoke_XJCard;
		public virtual RMethod RInvoke_XJCard
		{
			get
			{
				if(r_RInvoke_XJCard == null)
				{
					r_RInvoke_XJCard = new(this, "Invoke", 0,  ReleactionUtils.GetType("XJCard"));
					r_RInvoke_XJCard.SetBelong(this.instance);
				}
				return r_RInvoke_XJCard;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(XJCard, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_XJCard_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_XJCard_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_XJCard_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_XJCard_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("XJCard"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_XJCard_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_XJCard_AsyncCallback_Object;
			}
		}
        ...
        public R__0__fee() : base("MyGUIXJCardWnd+#fee")
        {
        }

        public R__0__fee(System.Object instance) : base("MyGUIXJCardWnd+#fee")
		{
            SetInstance(instance);
		}

        public R__0__fee(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fee(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

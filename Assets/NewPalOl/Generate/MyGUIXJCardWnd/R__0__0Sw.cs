...
{public partial class RMyGUIXJCardWnd
{
	...
	/// MyGUIXJCardWnd+#0Sw
	/// </summary>
    public partial class R__0__0Sw : RMember //
    {
		...
		/// XJCard #d
		/// </summary>
		protected RXJCard r___0__d;
		public virtual RXJCard R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// MyGUIXJCardWnd #e
		/// </summary>
		protected RMyGUIXJCardWnd r___0__e;
		public virtual RMyGUIXJCardWnd R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__0Sw() : base("MyGUIXJCardWnd+#0Sw")
        {
        }

        public R__0__0Sw(System.Object instance) : base("MyGUIXJCardWnd+#0Sw")
		{
            SetInstance(instance);
		}

        public R__0__0Sw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0Sw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

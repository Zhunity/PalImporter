...
{public partial class RMyGUIXJCardWnd
{
	...
	/// MyGUIXJCardWnd+#5Sw
	/// </summary>
    public partial class R__0__5Sw : RMember //
    {

		/// <summary>
		/// XJCard #a
		/// </summary>
		protected RXJCard r___0__a;
		public virtual RXJCard R__0__a
		{
			get
			{
				if(r___0__a == null)
        ...
        public R__0__5Sw() : base("MyGUIXJCardWnd+#5Sw")
        {
        }

        public R__0__5Sw(System.Object instance) : base("MyGUIXJCardWnd+#5Sw")
		{
            SetInstance(instance);
		}

        public R__0__5Sw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5Sw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

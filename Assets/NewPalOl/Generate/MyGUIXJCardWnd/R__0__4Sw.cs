...
{public partial class RMyGUIXJCardWnd
{
	...
	/// MyGUIXJCardWnd+#4Sw
	/// </summary>
    public partial class R__0__4Sw : RMember //
    {
		...
		/// <summary>
		/// MyGUIXJCardWnd+#fee #e
		/// </summary>
		protected RMyGUIXJCardWnd.R__0__fee r___0__e;
		public virtual RMyGUIXJCardWnd.R__0__fee R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// <summary>
		/// MyGUIXJCardWnd+#fee #j
		/// </summary>
		protected RMyGUIXJCardWnd.R__0__fee r___0__j;
		public virtual RMyGUIXJCardWnd.R__0__fee R__0__j
		{
			get
			{
				if(r___0__j == null)
		...
		/// MyGUIXJCardWnd #k
		/// </summary>
		protected RMyGUIXJCardWnd r___0__k;
		public virtual RMyGUIXJCardWnd R__0__k
		{
			get
			{
				if(r___0__k == null)
        ...
        public R__0__4Sw() : base("MyGUIXJCardWnd+#4Sw")
        {
        }

        public R__0__4Sw(System.Object instance) : base("MyGUIXJCardWnd+#4Sw")
		{
            SetInstance(instance);
		}

        public R__0__4Sw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4Sw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

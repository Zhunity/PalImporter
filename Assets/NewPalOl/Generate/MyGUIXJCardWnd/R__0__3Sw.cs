...
{public partial class RMyGUIXJCardWnd
{
	...
	/// MyGUIXJCardWnd+#3Sw
	/// </summary>
    public partial class R__0__3Sw : RMember //
    {
        ...
        public R__0__3Sw() : base("MyGUIXJCardWnd+#3Sw")
        {
        }

        public R__0__3Sw(System.Object instance) : base("MyGUIXJCardWnd+#3Sw")
		{
            SetInstance(instance);
		}

        public R__0__3Sw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3Sw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

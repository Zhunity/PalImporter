...
{public partial class RMyGUIXJCardWnd
{
	...
	/// MyGUIXJCardWnd+#6Sw
	/// </summary>
    public partial class R__0__6Sw : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.List`1[#u.#Ckb] #c
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__u.R__0__Ckb> r___0__c;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__u.R__0__Ckb> R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1+Enumerator[GameDefineType.ID] #j
		/// </summary>
		...
		/// MyGUIXJCardWnd #t
		/// </summary>
		protected RMyGUIXJCardWnd r___0__t;
		public virtual RMyGUIXJCardWnd R__0__t
		{
			get
			{
				if(r___0__t == null)
        ...
        public R__0__6Sw() : base("MyGUIXJCardWnd+#6Sw")
        {
        }

        public R__0__6Sw(System.Object instance) : base("MyGUIXJCardWnd+#6Sw")
		{
            SetInstance(instance);
		}

        public R__0__6Sw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6Sw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

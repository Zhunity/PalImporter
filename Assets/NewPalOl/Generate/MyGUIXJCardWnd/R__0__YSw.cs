...
{public partial class RMyGUIXJCardWnd
{
	...
	/// MyGUIXJCardWnd+#YSw
	/// </summary>
    public partial class R__0__YSw : RMember //
    {
		...
		/// MyGUIXJCardWnd #g
		/// </summary>
		protected RMyGUIXJCardWnd r___0__g;
		public virtual RMyGUIXJCardWnd R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__YSw() : base("MyGUIXJCardWnd+#YSw")
        {
        }

        public R__0__YSw(System.Object instance) : base("MyGUIXJCardWnd+#YSw")
		{
            SetInstance(instance);
		}

        public R__0__YSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RMyGUIXJCardWnd
{
	...
	/// MyGUIXJCardWnd+#1Sw
	/// </summary>
    public partial class R__0__1Sw : RMember //
    {
        ...
        public R__0__1Sw() : base("MyGUIXJCardWnd+#1Sw")
        {
        }

        public R__0__1Sw(System.Object instance) : base("MyGUIXJCardWnd+#1Sw")
		{
            SetInstance(instance);
		}

        public R__0__1Sw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1Sw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

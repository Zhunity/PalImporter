...
{public partial class RMyGUIXJCardWnd
{
	
	/// <summary>
	/// MyGUIXJCardWnd+#eee
	/// </summary>
    public partial class R__0__eee : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(UnityEngine.GameObject)
		/// </summary>
		protected RMethod r_RInvoke_GameObject;
		public virtual RMethod RInvoke_GameObject
		{
			get
			{
				if(r_RInvoke_GameObject == null)
				{
					r_RInvoke_GameObject = new(this, "Invoke", 0, typeof(UnityEngine.GameObject));
					r_RInvoke_GameObject.SetBelong(this.instance);
				}
				return r_RInvoke_GameObject;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(UnityEngine.GameObject, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_GameObject_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_GameObject_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_GameObject_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_GameObject_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEngine.GameObject), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_GameObject_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_GameObject_AsyncCallback_Object;
			}
		}
        ...
        public R__0__eee() : base("MyGUIXJCardWnd+#eee")
        {
        }

        public R__0__eee(System.Object instance) : base("MyGUIXJCardWnd+#eee")
		{
            SetInstance(instance);
		}

        public R__0__eee(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__eee(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(UnityEngine.GameObject  @ojt)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@ojt};
            var ___result = RInvoke_GameObject.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(UnityEngine.GameObject  @ojt, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@ojt, @callback, @object};
            var ___result = RBeginInvoke_GameObject_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

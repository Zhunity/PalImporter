...
{public partial class Rsingleton
{
	...
	/// <summary>
	/// singleton+<Start>c__Iterator115
	/// </summary>
    public partial class R__2__Start__4__c__Iterator115 : RMember //
    {
        ...
        public R__2__Start__4__c__Iterator115() : base("singleton+<Start>c__Iterator115")
        {
        }

        public R__2__Start__4__c__Iterator115(System.Object instance) : base("singleton+<Start>c__Iterator115")
		{
            SetInstance(instance);
		}

        public R__2__Start__4__c__Iterator115(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__Start__4__c__Iterator115(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

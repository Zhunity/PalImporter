...
{public partial class Rsingleton
{
	
	/// <summary>
	/// singleton+<DownLoadObject>c__Iterator116
	/// </summary>
    public partial class R__2__DownLoadObject__4__c__Iterator116 : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.List`1+Enumerator[SingletonAsset] <$s_1477>__0
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RField>.REnumerator r___2____9__s_1477__4____0;
		public virtual RSystem.RCollections.RGeneric.RList<RField>.REnumerator R__2____9__s_1477__4____0
		{
			get
			{
				if(r___2____9__s_1477__4____0 == null)
				{
					r___2____9__s_1477__4____0 = new(this, "<$s_1477>__0");
					r___2____9__s_1477__4____0.SetBelong(this.instance);
				}
				return r___2____9__s_1477__4____0;
			}
		}

		/// <summary>
		/// SingletonAsset <asset>__1
		/// </summary>
		protected RSingletonAsset r___2__asset__4____1;
		public virtual RSingletonAsset R__2__asset__4____1
		{
			get
			{
				if(r___2__asset__4____1 == null)
				{
					r___2__asset__4____1 = new(this, "<asset>__1");
					r___2__asset__4____1.SetBelong(this.instance);
				}
				return r___2__asset__4____1;
			}
		}

		/// <summary>
		/// AssetBundleDownloader+AB_DOWNLOADER_ARGS <args>__2
		/// </summary>
		protected RAssetBundleDownloader.RAB_DOWNLOADER_ARGS r___2__args__4____2;
		public virtual RAssetBundleDownloader.RAB_DOWNLOADER_ARGS R__2__args__4____2
		{
			get
			{
				if(r___2__args__4____2 == null)
				{
					r___2__args__4____2 = new(this, "<args>__2");
					r___2__args__4____2.SetBelong(this.instance);
				}
				return r___2__args__4____2;
			}
		}
		...
		/// singleton <>f__this
		/// </summary>
		protected Rsingleton r___2____4__f__this;
		public virtual Rsingleton R__2____4__f__this
		{
			get
			{
        ...
        public R__2__DownLoadObject__4__c__Iterator116() : base("singleton+<DownLoadObject>c__Iterator116")
        {
        }

        public R__2__DownLoadObject__4__c__Iterator116(System.Object instance) : base("singleton+<DownLoadObject>c__Iterator116")
		{
            SetInstance(instance);
		}

        public R__2__DownLoadObject__4__c__Iterator116(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__DownLoadObject__4__c__Iterator116(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

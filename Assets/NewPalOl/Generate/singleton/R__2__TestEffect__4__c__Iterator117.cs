...
{public partial class Rsingleton
{
	...
	/// <summary>
	/// singleton+<TestEffect>c__Iterator117
	/// </summary>
    public partial class R__2__TestEffect__4__c__Iterator117 : RMember //
    {

		/// <summary>
		/// UnityEngine.WWW <mWWW>__0
		/// </summary>
		protected RUnityEngine.RWWW r___2__mWWW__4____0;
		public virtual RUnityEngine.RWWW R__2__mWWW__4____0
		{
			get
			{
				if(r___2__mWWW__4____0 == null)
				{
					r___2__mWWW__4____0 = new(this, "<mWWW>__0");
					r___2__mWWW__4____0.SetBelong(this.instance);
				}
				return r___2__mWWW__4____0;
			}
		}

		/// <summary>
		/// UnityEngine.AssetBundleCreateRequest <tmpABR>__1
		/// </summary>
		protected RUnityEngine.RAssetBundleCreateRequest r___2__tmpABR__4____1;
		public virtual RUnityEngine.RAssetBundleCreateRequest R__2__tmpABR__4____1
		{
			get
			{
				if(r___2__tmpABR__4____1 == null)
				{
					r___2__tmpABR__4____1 = new(this, "<tmpABR>__1");
					r___2__tmpABR__4____1.SetBelong(this.instance);
				}
				return r___2__tmpABR__4____1;
			}
		}

		/// <summary>
		/// UnityEngine.AssetBundle <m_asset>__2
		/// </summary>
		protected RUnityEngine.RAssetBundle r___2__m_asset__4____2;
		public virtual RUnityEngine.RAssetBundle R__2__m_asset__4____2
		{
			get
			{
				if(r___2__m_asset__4____2 == null)
				{
					r___2__m_asset__4____2 = new(this, "<m_asset>__2");
					r___2__m_asset__4____2.SetBelong(this.instance);
				}
				return r___2__m_asset__4____2;
			}
		}
        ...
        public R__2__TestEffect__4__c__Iterator117() : base("singleton+<TestEffect>c__Iterator117")
        {
        }

        public R__2__TestEffect__4__c__Iterator117(System.Object instance) : base("singleton+<TestEffect>c__Iterator117")
		{
            SetInstance(instance);
		}

        public R__2__TestEffect__4__c__Iterator117(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__TestEffect__4__c__Iterator117(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

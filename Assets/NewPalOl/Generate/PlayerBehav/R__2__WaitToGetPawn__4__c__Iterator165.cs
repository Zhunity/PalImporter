...
{public partial class RPlayerBehav
{
	...
	/// <summary>
	/// PlayerBehav+<WaitToGetPawn>c__Iterator165
	/// </summary>
    public partial class R__2__WaitToGetPawn__4__c__Iterator165 : RMember //
    {
        ...
        public R__2__WaitToGetPawn__4__c__Iterator165() : base("PlayerBehav+<WaitToGetPawn>c__Iterator165")
        {
        }

        public R__2__WaitToGetPawn__4__c__Iterator165(System.Object instance) : base("PlayerBehav+<WaitToGetPawn>c__Iterator165")
		{
            SetInstance(instance);
		}

        public R__2__WaitToGetPawn__4__c__Iterator165(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__WaitToGetPawn__4__c__Iterator165(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RPlayerBehav
{
	...
	/// <summary>
	/// PlayerBehav+<WaitForFadeIn>c__Iterator16A
	/// </summary>
    public partial class R__2__WaitForFadeIn__4__c__Iterator16A : RMember //
    {
        ...
        public R__2__WaitForFadeIn__4__c__Iterator16A() : base("PlayerBehav+<WaitForFadeIn>c__Iterator16A")
        {
        }

        public R__2__WaitForFadeIn__4__c__Iterator16A(System.Object instance) : base("PlayerBehav+<WaitForFadeIn>c__Iterator16A")
		{
            SetInstance(instance);
		}

        public R__2__WaitForFadeIn__4__c__Iterator16A(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__WaitForFadeIn__4__c__Iterator16A(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

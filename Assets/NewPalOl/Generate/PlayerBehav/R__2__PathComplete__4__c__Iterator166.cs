...
{public partial class RPlayerBehav
{
	...
	/// <summary>
	/// PlayerBehav+<PathComplete>c__Iterator166
	/// </summary>
    public partial class R__2__PathComplete__4__c__Iterator166 : RMember //
    {
        ...
        public R__2__PathComplete__4__c__Iterator166() : base("PlayerBehav+<PathComplete>c__Iterator166")
        {
        }

        public R__2__PathComplete__4__c__Iterator166(System.Object instance) : base("PlayerBehav+<PathComplete>c__Iterator166")
		{
            SetInstance(instance);
		}

        public R__2__PathComplete__4__c__Iterator166(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__PathComplete__4__c__Iterator166(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

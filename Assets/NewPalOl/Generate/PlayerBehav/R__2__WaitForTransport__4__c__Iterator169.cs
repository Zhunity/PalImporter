...
{public partial class RPlayerBehav
{
	...
	/// <summary>
	/// PlayerBehav+<WaitForTransport>c__Iterator169
	/// </summary>
    public partial class R__2__WaitForTransport__4__c__Iterator169 : RMember //
    {

		/// <summary>
		/// GameDefineType.ID targetMapID
		/// </summary>
		protected RGameDefineType.RID r_targetMapID;
		public virtual RGameDefineType.RID RtargetMapID
		{
			get
			{
		...
		/// <summary>
		/// LoadingScene <state>__0
		/// </summary>
		protected RLoadingScene r___2__state__4____0;
		public virtual RLoadingScene R__2__state__4____0
		{
			get
			{
				if(r___2__state__4____0 == null)
				{
					r___2__state__4____0 = new(this, "<state>__0");
					r___2__state__4____0.SetBelong(this.instance);
				}
				return r___2__state__4____0;
			}
		}
		...
		/// GameDefineType.ID <$>targetMapID
		/// </summary>
		protected RGameDefineType.RID r___2____9____4__targetMapID;
		public virtual RGameDefineType.RID R__2____9____4__targetMapID
		{
			get
			{
				if(r___2____9____4__targetMapID == null)
				{
					r___2____9____4__targetMapID = new(this, "<$>targetMapID");
					r___2____9____4__targetMapID.SetBelong(this.instance);
				}
				return r___2____9____4__targetMapID;
			}
		}
        ...
        public R__2__WaitForTransport__4__c__Iterator169() : base("PlayerBehav+<WaitForTransport>c__Iterator169")
        {
        }

        public R__2__WaitForTransport__4__c__Iterator169(System.Object instance) : base("PlayerBehav+<WaitForTransport>c__Iterator169")
		{
            SetInstance(instance);
		}

        public R__2__WaitForTransport__4__c__Iterator169(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__WaitForTransport__4__c__Iterator169(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

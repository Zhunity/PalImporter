...
{public partial class RPlayerBehav
{
	...
	/// <summary>
	/// PlayerBehav+<StartFollowOtherPlayer>c__Iterator16B
	/// </summary>
    public partial class R__2__StartFollowOtherPlayer__4__c__Iterator16B : RMember //
    {

		/// <summary>
		/// PATH_FIND_STRUCT <pfs>__0
		/// </summary>
		protected RPATH_FIND_STRUCT r___2__pfs__4____0;
		public virtual RPATH_FIND_STRUCT R__2__pfs__4____0
		{
			get
			{
				if(r___2__pfs__4____0 == null)
				{
					r___2__pfs__4____0 = new(this, "<pfs>__0");
					r___2__pfs__4____0.SetBelong(this.instance);
				}
				return r___2__pfs__4____0;
			}
		}
		...
		/// NPC <npc>__1
		/// </summary>
		protected RNPC r___2__npc__4____1;
		public virtual RNPC R__2__npc__4____1
		{
			get
			{
				if(r___2__npc__4____1 == null)
				{
					r___2__npc__4____1 = new(this, "<npc>__1");
					r___2__npc__4____1.SetBelong(this.instance);
				}
				return r___2__npc__4____1;
			}
		}
        ...
        public R__2__StartFollowOtherPlayer__4__c__Iterator16B() : base("PlayerBehav+<StartFollowOtherPlayer>c__Iterator16B")
        {
        }

        public R__2__StartFollowOtherPlayer__4__c__Iterator16B(System.Object instance) : base("PlayerBehav+<StartFollowOtherPlayer>c__Iterator16B")
		{
            SetInstance(instance);
		}

        public R__2__StartFollowOtherPlayer__4__c__Iterator16B(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__StartFollowOtherPlayer__4__c__Iterator16B(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

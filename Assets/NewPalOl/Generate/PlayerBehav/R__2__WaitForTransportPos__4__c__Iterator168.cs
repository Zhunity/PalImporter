...
{public partial class RPlayerBehav
{
	...
	/// <summary>
	/// PlayerBehav+<WaitForTransportPos>c__Iterator168
	/// </summary>
    public partial class R__2__WaitForTransportPos__4__c__Iterator168 : RMember //
    {

		/// <summary>
		/// UnityEngine.Vector3 newPos
		/// </summary>
		protected RUnityEngine.RVector3 r_newPos;
		public virtual RUnityEngine.RVector3 RnewPos
		{
			get
			{
				if(r_newPos == null)
				{
					r_newPos = new(this, "newPos");
					r_newPos.SetBelong(this.instance);
				}
				return r_newPos;
			}
		}
		...
		/// UnityEngine.Vector3 <$>newPos
		/// </summary>
		protected RUnityEngine.RVector3 r___2____9____4__newPos;
		public virtual RUnityEngine.RVector3 R__2____9____4__newPos
		{
			get
			{
				if(r___2____9____4__newPos == null)
				{
					r___2____9____4__newPos = new(this, "<$>newPos");
					r___2____9____4__newPos.SetBelong(this.instance);
				}
				return r___2____9____4__newPos;
			}
		}
        ...
        public R__2__WaitForTransportPos__4__c__Iterator168() : base("PlayerBehav+<WaitForTransportPos>c__Iterator168")
        {
        }

        public R__2__WaitForTransportPos__4__c__Iterator168(System.Object instance) : base("PlayerBehav+<WaitForTransportPos>c__Iterator168")
		{
            SetInstance(instance);
		}

        public R__2__WaitForTransportPos__4__c__Iterator168(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__WaitForTransportPos__4__c__Iterator168(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

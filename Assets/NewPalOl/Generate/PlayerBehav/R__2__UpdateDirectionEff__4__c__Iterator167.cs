...
{public partial class RPlayerBehav
{
	...
	/// <summary>
	/// PlayerBehav+<UpdateDirectionEff>c__Iterator167
	/// </summary>
    public partial class R__2__UpdateDirectionEff__4__c__Iterator167 : RMember //
    {
        ...
        public R__2__UpdateDirectionEff__4__c__Iterator167() : base("PlayerBehav+<UpdateDirectionEff>c__Iterator167")
        {
        }

        public R__2__UpdateDirectionEff__4__c__Iterator167(System.Object instance) : base("PlayerBehav+<UpdateDirectionEff>c__Iterator167")
		{
            SetInstance(instance);
		}

        public R__2__UpdateDirectionEff__4__c__Iterator167(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__UpdateDirectionEff__4__c__Iterator167(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

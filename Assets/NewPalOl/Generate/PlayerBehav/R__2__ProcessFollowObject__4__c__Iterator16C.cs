...
{public partial class RPlayerBehav
{
	
	/// <summary>
	/// PlayerBehav+<ProcessFollowObject>c__Iterator16C
	/// </summary>
    public partial class R__2__ProcessFollowObject__4__c__Iterator16C : RMember //
    {

		/// <summary>
		/// UnityEngine.Vector3 <objPos>__0
		/// </summary>
		protected RUnityEngine.RVector3 r___2__objPos__4____0;
		public virtual RUnityEngine.RVector3 R__2__objPos__4____0
		{
			get
			{
				if(r___2__objPos__4____0 == null)
				{
					r___2__objPos__4____0 = new(this, "<objPos>__0");
					r___2__objPos__4____0.SetBelong(this.instance);
				}
				return r___2__objPos__4____0;
			}
		}
		...
		/// System.Single <x>__1
		/// </summary>
		protected RField r___2__x__4____1;
		public virtual RField R__2__x__4____1
		{
			get
			{
				if(r___2__x__4____1 == null)
				{
					r___2__x__4____1 = new(this, "<x>__1");
					r___2__x__4____1.SetBelong(this.instance);
				}
				return r___2__x__4____1;
			}
		}
		...
		/// PlayerBehav <>f__this
		/// </summary>
		protected RPlayerBehav r___2____4__f__this;
		public virtual RPlayerBehav R__2____4__f__this
		{
			get
			{
        ...
        public R__2__ProcessFollowObject__4__c__Iterator16C() : base("PlayerBehav+<ProcessFollowObject>c__Iterator16C")
        {
        }

        public R__2__ProcessFollowObject__4__c__Iterator16C(System.Object instance) : base("PlayerBehav+<ProcessFollowObject>c__Iterator16C")
		{
            SetInstance(instance);
		}

        public R__2__ProcessFollowObject__4__c__Iterator16C(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ProcessFollowObject__4__c__Iterator16C(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

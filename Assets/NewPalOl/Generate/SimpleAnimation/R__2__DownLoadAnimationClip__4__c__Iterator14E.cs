...
{public partial class RSimpleAnimation
{
	
	/// <summary>
	/// SimpleAnimation+<DownLoadAnimationClip>c__Iterator14E
	/// </summary>
    public partial class R__2__DownLoadAnimationClip__4__c__Iterator14E : RMember //
    {
		...
		/// <summary>
		/// SimpleAnimation <>f__this
		/// </summary>
		protected RSimpleAnimation r___2____4__f__this;
		public virtual RSimpleAnimation R__2____4__f__this
		{
			get
			{
        ...
        public R__2__DownLoadAnimationClip__4__c__Iterator14E() : base("SimpleAnimation+<DownLoadAnimationClip>c__Iterator14E")
        {
        }

        public R__2__DownLoadAnimationClip__4__c__Iterator14E(System.Object instance) : base("SimpleAnimation+<DownLoadAnimationClip>c__Iterator14E")
		{
            SetInstance(instance);
		}

        public R__2__DownLoadAnimationClip__4__c__Iterator14E(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__DownLoadAnimationClip__4__c__Iterator14E(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

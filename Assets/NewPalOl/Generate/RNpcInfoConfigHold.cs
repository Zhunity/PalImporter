...
namespace SMFrame.Editor.Refleaction
{
	...
	/// NpcInfoConfigHold
	/// </summary>
    public partial class RNpcInfoConfigHold : RMember //
    {
		...
		public static RField ROOT_NAME
		{
			get
			{
				if(r_ROOT_NAME == null)
				{
					r_ROOT_NAME = new(typeof(NpcInfoConfigHold), "ROOT_NAME");
		...
		public static RField RID_NAME
		{
			get
			{
				if(r_ID_NAME == null)
				{
					r_ID_NAME = new(typeof(NpcInfoConfigHold), "ID_NAME");
		...
		public static RField RTYPE_NAME
		{
			get
			{
				if(r_TYPE_NAME == null)
				{
					r_TYPE_NAME = new(typeof(NpcInfoConfigHold), "TYPE_NAME");
		...
		public static RSystem.RCollections.RGeneric.RList<RField> Rskipchilds
		{
			get
			{
				...
				{
					r_skipchilds = new(typeof(NpcInfoConfigHold), "skipchilds");
		...
		public static RMethod RLoadXml_Object
		{
			get
			{
				...
				{
					r_RLoadXml_Object = new(typeof(NpcInfoConfigHold), "LoadXml", 0, typeof(System.Object));
		...
		public static RMethod RParseKeyValue_XmlNode
		{
			get
			{
				...
				{
					r_RParseKeyValue_XmlNode = new(typeof(NpcInfoConfigHold), "ParseKeyValue", 0, typeof(System.Xml.XmlNode));
        ...
        public RNpcInfoConfigHold() : base("NpcInfoConfigHold")
        {
        }

        public RNpcInfoConfigHold(System.Object instance) : base("NpcInfoConfigHold")
		{
            SetInstance(instance);
		}

        public RNpcInfoConfigHold(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RNpcInfoConfigHold(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

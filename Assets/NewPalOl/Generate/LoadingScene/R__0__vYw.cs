...
{public partial class RLoadingScene
{
	
	/// <summary>
	/// LoadingScene+#vYw
	/// </summary>
    public partial class R__0__vYw : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.Camera #d
		/// </summary>
		protected RUnityEngine.RCamera r___0__d;
		public virtual RUnityEngine.RCamera R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// LoadingScene #k
		/// </summary>
		protected RLoadingScene r___0__k;
		public virtual RLoadingScene R__0__k
		{
			get
			{
				if(r___0__k == null)
        ...
        public R__0__vYw() : base("LoadingScene+#vYw")
        {
        }

        public R__0__vYw(System.Object instance) : base("LoadingScene+#vYw")
		{
            SetInstance(instance);
		}

        public R__0__vYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__vYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

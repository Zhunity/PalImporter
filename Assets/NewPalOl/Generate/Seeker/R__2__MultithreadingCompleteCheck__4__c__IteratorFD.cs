...
{public partial class RSeeker
{
	
	/// <summary>
	/// Seeker+<MultithreadingCompleteCheck>c__IteratorFD
	/// </summary>
    public partial class R__2__MultithreadingCompleteCheck__4__c__IteratorFD : RMember //
    {
		...
		/// Seeker <>f__this
		/// </summary>
		protected RSeeker r___2____4__f__this;
		public virtual RSeeker R__2____4__f__this
		{
			get
			{
        ...
        public R__2__MultithreadingCompleteCheck__4__c__IteratorFD() : base("Seeker+<MultithreadingCompleteCheck>c__IteratorFD")
        {
        }

        public R__2__MultithreadingCompleteCheck__4__c__IteratorFD(System.Object instance) : base("Seeker+<MultithreadingCompleteCheck>c__IteratorFD")
		{
            SetInstance(instance);
		}

        public R__2__MultithreadingCompleteCheck__4__c__IteratorFD(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__MultithreadingCompleteCheck__4__c__IteratorFD(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

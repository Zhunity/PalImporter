...
{
	/// <summary>
	/// ServerParserAttribute
	/// </summary>
    public partial class RServerParserAttribute : RMember //
    {
        ...
        public RServerParserAttribute() : base("ServerParserAttribute")
        {
        }

        public RServerParserAttribute(System.Object instance) : base("ServerParserAttribute")
		{
            SetInstance(instance);
		}

        public RServerParserAttribute(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RServerParserAttribute(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

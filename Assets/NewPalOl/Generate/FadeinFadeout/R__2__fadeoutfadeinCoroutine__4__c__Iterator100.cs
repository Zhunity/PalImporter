...
{public partial class RFadeinFadeout
{
	
	/// <summary>
	/// FadeinFadeout+<fadeoutfadeinCoroutine>c__Iterator100
	/// </summary>
    public partial class R__2__fadeoutfadeinCoroutine__4__c__Iterator100 : RMember //
    {

		/// <summary>
		/// System.Single fadeTime
		/// </summary>
		protected RField r_fadeTime;
		public virtual RField RfadeTime
		{
			get
			{
				if(r_fadeTime == null)
				{
					r_fadeTime = new(this, "fadeTime");
					r_fadeTime.SetBelong(this.instance);
				}
				return r_fadeTime;
			}
		}
		...
		/// System.Single <$>fadeTime
		/// </summary>
		protected RField r___2____9____4__fadeTime;
		public virtual RField R__2____9____4__fadeTime
		{
			get
			{
				if(r___2____9____4__fadeTime == null)
				{
					r___2____9____4__fadeTime = new(this, "<$>fadeTime");
					r___2____9____4__fadeTime.SetBelong(this.instance);
				}
				return r___2____9____4__fadeTime;
			}
		}
		...
		/// UnityEngine.Color <$>mColor
		/// </summary>
		protected RUnityEngine.RColor r___2____9____4__mColor;
		public virtual RUnityEngine.RColor R__2____9____4__mColor
		{
			get
			{
				if(r___2____9____4__mColor == null)
				{
					r___2____9____4__mColor = new(this, "<$>mColor");
					r___2____9____4__mColor.SetBelong(this.instance);
				}
				return r___2____9____4__mColor;
			}
		}

		/// <summary>
		/// FadeinFadeout <>f__this
		/// </summary>
		protected RFadeinFadeout r___2____4__f__this;
		public virtual RFadeinFadeout R__2____4__f__this
		{
			get
			{
        ...
        public R__2__fadeoutfadeinCoroutine__4__c__Iterator100() : base("FadeinFadeout+<fadeoutfadeinCoroutine>c__Iterator100")
        {
        }

        public R__2__fadeoutfadeinCoroutine__4__c__Iterator100(System.Object instance) : base("FadeinFadeout+<fadeoutfadeinCoroutine>c__Iterator100")
		{
            SetInstance(instance);
		}

        public R__2__fadeoutfadeinCoroutine__4__c__Iterator100(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__fadeoutfadeinCoroutine__4__c__Iterator100(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// WorldmapConfigHold
	/// </summary>
    public partial class RWorldmapConfigHold : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.List`1[WORLD_MAP_CFG] m_WorldMapCfgList
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RWORLD_MAP_CFG> r_m_WorldMapCfgList;
		public virtual RSystem.RCollections.RGeneric.RList<RWORLD_MAP_CFG> Rm_WorldMapCfgList
		{
			get
			{
		...
		public static RMethod RLoadXml_Object
		{
			get
			{
				...
				{
					r_RLoadXml_Object = new(typeof(WorldmapConfigHold), "LoadXml", 0, typeof(System.Object));
        ...
        public RWorldmapConfigHold() : base("WorldmapConfigHold")
        {
        }

        public RWorldmapConfigHold(System.Object instance) : base("WorldmapConfigHold")
		{
            SetInstance(instance);
		}

        public RWorldmapConfigHold(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RWorldmapConfigHold(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

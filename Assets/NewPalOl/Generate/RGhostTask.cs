...
namespace SMFrame.Editor.Refleaction
{
	...
	/// GhostTask
	/// </summary>
    public partial class RGhostTask : RMember //
    {
        ...
        public RGhostTask() : base("GhostTask")
        {
        }

        public RGhostTask(System.Object instance) : base("GhostTask")
		{
            SetInstance(instance);
		}

        public RGhostTask(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RGhostTask(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

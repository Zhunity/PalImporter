...
namespace SMFrame.Editor.Refleaction
{
	...
	/// EdgeDetectEffect
	/// </summary>
    public partial class REdgeDetectEffect : RMember //
    {
        ...
        public REdgeDetectEffect() : base("EdgeDetectEffect")
        {
        }

        public REdgeDetectEffect(System.Object instance) : base("EdgeDetectEffect")
		{
            SetInstance(instance);
		}

        public REdgeDetectEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REdgeDetectEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// Platform
	/// </summary>
    public partial class RPlatform : RMember //
    {

		/// <summary>
		/// System.Single C_PointTime
		/// </summary>
		protected static RField r_C_PointTime;
		public static RField RC_PointTime
		{
			get
			{
				if(r_C_PointTime == null)
				{
					r_C_PointTime = new( ReleactionUtils.GetType("Platform"), "C_PointTime");
					r_C_PointTime.SetBelong(null);
				}
				return r_C_PointTime;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Transform[] WayPoint
		/// </summary>
		protected RFieldArray<RUnityEngine.RTransform> r_WayPoint;
		public virtual RFieldArray<RUnityEngine.RTransform> RWayPoint
		{
			get
			{
				if(r_WayPoint == null)
				{
					r_WayPoint = new(this, "WayPoint");
					r_WayPoint.SetBelong(this.instance);
				}
				return r_WayPoint;
			}
		}
		...
		/// <summary>
		/// System.Boolean mb_MovingStart
		/// </summary>
		protected RField r_mb_MovingStart;
		public virtual RField Rmb_MovingStart
		{
			get
			{
				if(r_mb_MovingStart == null)
				{
					r_mb_MovingStart = new(this, "mb_MovingStart");
					r_mb_MovingStart.SetBelong(this.instance);
				}
				return r_mb_MovingStart;
			}
		}

		/// <summary>
		/// System.Int32 mi_ArrivePointIndex
		/// </summary>
		protected RField r_mi_ArrivePointIndex;
		public virtual RField Rmi_ArrivePointIndex
		{
			get
			{
				if(r_mi_ArrivePointIndex == null)
				{
					r_mi_ArrivePointIndex = new(this, "mi_ArrivePointIndex");
					r_mi_ArrivePointIndex.SetBelong(this.instance);
				}
				return r_mi_ArrivePointIndex;
			}
		}

		/// <summary>
		/// System.Boolean mb_Inverse
		/// </summary>
		protected RField r_mb_Inverse;
		public virtual RField Rmb_Inverse
		{
			get
			{
				if(r_mb_Inverse == null)
				{
					r_mb_Inverse = new(this, "mb_Inverse");
					r_mb_Inverse.SetBelong(this.instance);
				}
				return r_mb_Inverse;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RGameObject r_Player;
		public virtual RUnityEngine.RGameObject RPlayer
		{
			get
			{
				if(r_Player == null)
				{
					r_Player = new(this, "Player");
		...
		/// <summary>
		/// System.Boolean mb_PlayerEnter
		/// </summary>
		protected RField r_mb_PlayerEnter;
		public virtual RField Rmb_PlayerEnter
		{
			get
			{
				if(r_mb_PlayerEnter == null)
				{
					r_mb_PlayerEnter = new(this, "mb_PlayerEnter");
					r_mb_PlayerEnter.SetBelong(this.instance);
				}
				return r_mb_PlayerEnter;
			}
		}

		/// <summary>
		/// UnityEngine.MeshCollider[] mbarrier
		/// </summary>
		protected RFieldArray<RUnityEngine.RMeshCollider> r_mbarrier;
		public virtual RFieldArray<RUnityEngine.RMeshCollider> Rmbarrier
		{
			get
			{
				if(r_mbarrier == null)
				{
					r_mbarrier = new(this, "mbarrier");
					r_mbarrier.SetBelong(this.instance);
				}
				return r_mbarrier;
			}
		}
		...
		/// Void OnPlayerEnter()
		/// </summary>
		protected RMethod r_ROnPlayerEnter;
		public virtual RMethod ROnPlayerEnter
		{
			get
			{
				if(r_ROnPlayerEnter == null)
				{
					r_ROnPlayerEnter = new(this, "OnPlayerEnter", 0);
					r_ROnPlayerEnter.SetBelong(this.instance);
				}
				return r_ROnPlayerEnter;
			}
		}
		...
		/// Void OnPlayerExit()
		/// </summary>
		protected RMethod r_ROnPlayerExit;
		public virtual RMethod ROnPlayerExit
		{
			get
			{
				if(r_ROnPlayerExit == null)
				{
					r_ROnPlayerExit = new(this, "OnPlayerExit", 0);
					r_ROnPlayerExit.SetBelong(this.instance);
				}
				return r_ROnPlayerExit;
			}
		}
        ...
        public RPlatform() : base("Platform")
        {
        }

        public RPlatform(System.Object instance) : base("Platform")
		{
            SetInstance(instance);
		}

        public RPlatform(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPlatform(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void OnPlayerEnter()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = ROnPlayerEnter.Invoke(___genericsType, ___parameters);
        ...
        public virtual void OnPlayerExit()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = ROnPlayerExit.Invoke(___genericsType, ___parameters);

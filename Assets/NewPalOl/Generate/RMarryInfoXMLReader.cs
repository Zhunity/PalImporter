...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MarryInfoXMLReader
	/// </summary>
    public partial class RMarryInfoXMLReader : RMember //
    {
        ...
        public RMarryInfoXMLReader() : base("MarryInfoXMLReader")
        {
        }

        public RMarryInfoXMLReader(System.Object instance) : base("MarryInfoXMLReader")
		{
            SetInstance(instance);
		}

        public RMarryInfoXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMarryInfoXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RMyGUIfightshotcutWnd
{
	
	/// <summary>
	/// MyGUIfightshotcutWnd+#cTw
	/// </summary>
    public partial class R__0__cTw : RMember //
    {
		...
		/// </summary>
		protected RSystem.RCollections.RIEnumerator r___0__d;
		public virtual RSystem.RCollections.RIEnumerator R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// <summary>
		/// UnityEngine.Transform #e
		/// </summary>
		protected RUnityEngine.RTransform r___0__e;
		public virtual RUnityEngine.RTransform R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// <summary>
		/// MyGUIfightshotcutWnd+ITEM_EFFECT #f
		/// </summary>
		...
		/// <summary>
		/// System.Collections.IEnumerator #h
		/// </summary>
		protected RSystem.RCollections.RIEnumerator r___0__h;
		public virtual RSystem.RCollections.RIEnumerator R__0__h
		{
			get
			{
				if(r___0__h == null)
		...
		/// <summary>
		/// UnityEngine.Transform #i
		/// </summary>
		protected RUnityEngine.RTransform r___0__i;
		public virtual RUnityEngine.RTransform R__0__i
		{
			get
			{
				if(r___0__i == null)
		...
		/// <summary>
		/// System.Collections.IEnumerator #k
		/// </summary>
		protected RSystem.RCollections.RIEnumerator r___0__k;
		public virtual RSystem.RCollections.RIEnumerator R__0__k
		{
			get
			{
				if(r___0__k == null)
		...
		/// <summary>
		/// UnityEngine.Transform #l
		/// </summary>
		protected RUnityEngine.RTransform r___0__l;
		public virtual RUnityEngine.RTransform R__0__l
		{
			get
			{
				if(r___0__l == null)
		...
		/// System.Object #n
		/// </summary>
		protected RSystem.RObject r___0__n;
		public virtual RSystem.RObject R__0__n
		{
			get
			{
				if(r___0__n == null)
		...
		/// <summary>
		/// MyGUIfightshotcutWnd+ITEM_EFFECT #q
		/// </summary>
		...
		/// <summary>
		/// MyGUIfightshotcutWnd #s
		/// </summary>
		protected RMyGUIfightshotcutWnd r___0__s;
		public virtual RMyGUIfightshotcutWnd R__0__s
		{
			get
			{
				if(r___0__s == null)
        ...
        public R__0__cTw() : base("MyGUIfightshotcutWnd+#cTw")
        {
        }

        public R__0__cTw(System.Object instance) : base("MyGUIfightshotcutWnd+#cTw")
		{
            SetInstance(instance);
		}

        public R__0__cTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RMyGUIfightshotcutWnd
{
	...
	/// <summary>
	/// MyGUIfightshotcutWnd+#fTw
	/// </summary>
    public partial class R__0__fTw : RMember //
    {

		/// <summary>
		/// #u.#Ieb #a
		/// </summary>
		protected R__0__u.R__0__Ieb r___0__a;
		public virtual R__0__u.R__0__Ieb R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #u.#Ieb #f
		/// </summary>
		protected R__0__u.R__0__Ieb r___0__f;
		public virtual R__0__u.R__0__Ieb R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// <summary>
		/// MyGUIfightshotcutWnd #r
		/// </summary>
		protected RMyGUIfightshotcutWnd r___0__r;
		public virtual RMyGUIfightshotcutWnd R__0__r
		{
			get
			{
				if(r___0__r == null)
        ...
        public R__0__fTw() : base("MyGUIfightshotcutWnd+#fTw")
        {
        }

        public R__0__fTw(System.Object instance) : base("MyGUIfightshotcutWnd+#fTw")
		{
            SetInstance(instance);
		}

        public R__0__fTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RMyGUIfightshotcutWnd
{
	...
	/// <summary>
	/// MyGUIfightshotcutWnd+#gTw
	/// </summary>
    public partial class R__0__gTw : RMember //
    {
		...
		/// <summary>
		/// MyGUIfightshotcutWnd #j
		/// </summary>
		protected RMyGUIfightshotcutWnd r___0__j;
		public virtual RMyGUIfightshotcutWnd R__0__j
		{
			get
			{
				if(r___0__j == null)
        ...
        public R__0__gTw() : base("MyGUIfightshotcutWnd+#gTw")
        {
        }

        public R__0__gTw(System.Object instance) : base("MyGUIfightshotcutWnd+#gTw")
		{
            SetInstance(instance);
		}

        public R__0__gTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

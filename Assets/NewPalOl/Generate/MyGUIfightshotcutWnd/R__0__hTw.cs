...
{public partial class RMyGUIfightshotcutWnd
{
	...
	/// <summary>
	/// MyGUIfightshotcutWnd+#hTw
	/// </summary>
    public partial class R__0__hTw : RMember //
    {
        ...
        public R__0__hTw() : base("MyGUIfightshotcutWnd+#hTw")
        {
        }

        public R__0__hTw(System.Object instance) : base("MyGUIfightshotcutWnd+#hTw")
		{
            SetInstance(instance);
		}

        public R__0__hTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

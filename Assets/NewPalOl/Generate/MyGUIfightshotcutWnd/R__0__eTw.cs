...
{public partial class RMyGUIfightshotcutWnd
{
	...
	/// <summary>
	/// MyGUIfightshotcutWnd+#eTw
	/// </summary>
    public partial class R__0__eTw : RMember //
    {
		...
		/// <summary>
		/// MyGUIfightshotcutWnd+ITEM_EFFECT #g
		/// </summary>
		...
		/// <summary>
		/// UnityEngine.Vector3 #i
		/// </summary>
		protected RUnityEngine.RVector3 r___0__i;
		public virtual RUnityEngine.RVector3 R__0__i
		{
			get
			{
				if(r___0__i == null)
		...
		/// <summary>
		/// UnityEngine.MonoBehaviour #k
		/// </summary>
		protected RUnityEngine.RMonoBehaviour r___0__k;
		public virtual RUnityEngine.RMonoBehaviour R__0__k
		{
			get
			{
				if(r___0__k == null)
		...
		/// <summary>
		/// MyGUIfightshotcutWnd+ITEM_EFFECT #s
		/// </summary>
		...
		/// <summary>
		/// MyGUIfightshotcutWnd #u
		/// </summary>
		protected RMyGUIfightshotcutWnd r___0__u;
		public virtual RMyGUIfightshotcutWnd R__0__u
		{
			get
			{
				if(r___0__u == null)
        ...
        public R__0__eTw() : base("MyGUIfightshotcutWnd+#eTw")
        {
        }

        public R__0__eTw(System.Object instance) : base("MyGUIfightshotcutWnd+#eTw")
		{
            SetInstance(instance);
		}

        public R__0__eTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__eTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

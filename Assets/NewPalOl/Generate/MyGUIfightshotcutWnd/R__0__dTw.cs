...
{public partial class RMyGUIfightshotcutWnd
{
	...
	/// <summary>
	/// MyGUIfightshotcutWnd+#dTw
	/// </summary>
    public partial class R__0__dTw : RMember //
    {
        ...
        public R__0__dTw() : base("MyGUIfightshotcutWnd+#dTw")
        {
        }

        public R__0__dTw(System.Object instance) : base("MyGUIfightshotcutWnd+#dTw")
		{
            SetInstance(instance);
		}

        public R__0__dTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

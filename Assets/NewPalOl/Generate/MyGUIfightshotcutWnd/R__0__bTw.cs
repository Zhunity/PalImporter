...
{public partial class RMyGUIfightshotcutWnd
{
	...
	/// <summary>
	/// MyGUIfightshotcutWnd+#bTw
	/// </summary>
    public partial class R__0__bTw : RMember //
    {
		...
		/// <summary>
		/// MyGUIWndTipTextWnd #b
		/// </summary>
		protected RMyGUIWndTipTextWnd r___0__b;
		public virtual RMyGUIWndTipTextWnd R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// <summary>
		/// MyGUIWndTipTextWnd+WindowAndElementTip #d
		/// </summary>
		protected RMyGUIWndTipTextWnd.RWindowAndElementTip r___0__d;
		public virtual RMyGUIWndTipTextWnd.RWindowAndElementTip R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// System.Object #f
		/// </summary>
		protected RSystem.RObject r___0__f;
		public virtual RSystem.RObject R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// <summary>
		/// MyGUIfightshotcutWnd #i
		/// </summary>
		protected RMyGUIfightshotcutWnd r___0__i;
		public virtual RMyGUIfightshotcutWnd R__0__i
		{
			get
			{
				if(r___0__i == null)
		...
		/// <summary>
		/// Void #B5h(#u.#BGd, System.Object, MyGUI.ElementBase, System.Object)
		/// </summary>
		protected RMethod r_R__0__B5h___0__BGd_Object_ElementBase_Object;
		public virtual RMethod R__0__B5h___0__BGd_Object_ElementBase_Object
		{
			get
			{
				if(r_R__0__B5h___0__BGd_Object_ElementBase_Object == null)
				{
					r_R__0__B5h___0__BGd_Object_ElementBase_Object = new(this, "#B5h", 0,  ReleactionUtils.GetType("#u.#BGd"), typeof(System.Object), typeof(MyGUI.ElementBase), typeof(System.Object));
					r_R__0__B5h___0__BGd_Object_ElementBase_Object.SetBelong(this.instance);
				}
				return r_R__0__B5h___0__BGd_Object_ElementBase_Object;
			}
		}
        ...
        public R__0__bTw() : base("MyGUIfightshotcutWnd+#bTw")
        {
        }

        public R__0__bTw(System.Object instance) : base("MyGUIfightshotcutWnd+#bTw")
		{
            SetInstance(instance);
		}

        public R__0__bTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__bTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{
	/// <summary>
	/// EquipActivityGiftConfig
	/// </summary>
    public partial class REquipActivityGiftConfig : RMember //
    {
        ...
        public REquipActivityGiftConfig() : base("EquipActivityGiftConfig")
        {
        }

        public REquipActivityGiftConfig(System.Object instance) : base("EquipActivityGiftConfig")
		{
            SetInstance(instance);
		}

        public REquipActivityGiftConfig(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REquipActivityGiftConfig(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

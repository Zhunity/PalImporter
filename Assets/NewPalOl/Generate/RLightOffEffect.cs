...
namespace SMFrame.Editor.Refleaction
{
	...
	/// LightOffEffect
	/// </summary>
    public partial class RLightOffEffect : RMember //
    {
        ...
        public RLightOffEffect() : base("LightOffEffect")
        {
        }

        public RLightOffEffect(System.Object instance) : base("LightOffEffect")
		{
            SetInstance(instance);
		}

        public RLightOffEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RLightOffEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

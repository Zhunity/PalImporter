...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CameraNavigate
	/// </summary>
    public partial class RCameraNavigate : RMember //
    {

		/// <summary>
		/// SplineController mSplineCtrl
		/// </summary>
		protected RSplineController r_mSplineCtrl;
		public virtual RSplineController RmSplineCtrl
		{
			get
			{
				if(r_mSplineCtrl == null)
				{
					r_mSplineCtrl = new(this, "mSplineCtrl");
					r_mSplineCtrl.SetBelong(this.instance);
				}
				return r_mSplineCtrl;
			}
		}

		/// <summary>
		/// BeelineControler mBeelineCtrl
		/// </summary>
		protected RBeelineControler r_mBeelineCtrl;
		public virtual RBeelineControler RmBeelineCtrl
		{
			get
			{
				if(r_mBeelineCtrl == null)
				{
					r_mBeelineCtrl = new(this, "mBeelineCtrl");
					r_mBeelineCtrl.SetBelong(this.instance);
				}
				return r_mBeelineCtrl;
			}
		}

		/// <summary>
		/// UnityEngine.GameObject mTestSplinePathObj
		/// </summary>
		protected RUnityEngine.RGameObject r_mTestSplinePathObj;
		public virtual RUnityEngine.RGameObject RmTestSplinePathObj
		{
			get
			{
				if(r_mTestSplinePathObj == null)
				{
					r_mTestSplinePathObj = new(this, "mTestSplinePathObj");
					r_mTestSplinePathObj.SetBelong(this.instance);
				}
				return r_mTestSplinePathObj;
			}
		}

		/// <summary>
		/// System.Boolean bSplineTest
		/// </summary>
		protected RField r_bSplineTest;
		public virtual RField RbSplineTest
		{
			get
			{
				if(r_bSplineTest == null)
				{
					r_bSplineTest = new(this, "bSplineTest");
					r_bSplineTest.SetBelong(this.instance);
				}
				return r_bSplineTest;
			}
		}

		/// <summary>
		/// UnityEngine.GameObject mTestBeelinePathObj
		/// </summary>
		protected RUnityEngine.RGameObject r_mTestBeelinePathObj;
		public virtual RUnityEngine.RGameObject RmTestBeelinePathObj
		{
			get
			{
				if(r_mTestBeelinePathObj == null)
				{
					r_mTestBeelinePathObj = new(this, "mTestBeelinePathObj");
					r_mTestBeelinePathObj.SetBelong(this.instance);
				}
				return r_mTestBeelinePathObj;
			}
		}

		/// <summary>
		/// System.Boolean bBeelineTest
		/// </summary>
		protected RField r_bBeelineTest;
		public virtual RField RbBeelineTest
		{
			get
			{
				if(r_bBeelineTest == null)
				{
					r_bBeelineTest = new(this, "bBeelineTest");
					r_bBeelineTest.SetBelong(this.instance);
				}
				return r_bBeelineTest;
			}
		}
		...
		/// <summary>
		/// Void TestSplineNavigate()
		/// </summary>
		protected RMethod r_RTestSplineNavigate;
		public virtual RMethod RTestSplineNavigate
		{
			get
			{
				if(r_RTestSplineNavigate == null)
				{
					r_RTestSplineNavigate = new(this, "TestSplineNavigate", 0);
					r_RTestSplineNavigate.SetBelong(this.instance);
				}
				return r_RTestSplineNavigate;
			}
		}

		/// <summary>
		/// Void TestBeelineNavigate()
		/// </summary>
		protected RMethod r_RTestBeelineNavigate;
		public virtual RMethod RTestBeelineNavigate
		{
			get
			{
				if(r_RTestBeelineNavigate == null)
				{
					r_RTestBeelineNavigate = new(this, "TestBeelineNavigate", 0);
					r_RTestBeelineNavigate.SetBelong(this.instance);
				}
				return r_RTestBeelineNavigate;
			}
		}

		/// <summary>
		/// Void SplineNavigate(System.String)
		/// </summary>
		protected RMethod r_RSplineNavigate_String;
		public virtual RMethod RSplineNavigate_String
		{
			get
			{
				if(r_RSplineNavigate_String == null)
				{
					r_RSplineNavigate_String = new(this, "SplineNavigate", 0, typeof(System.String));
					r_RSplineNavigate_String.SetBelong(this.instance);
				}
				return r_RSplineNavigate_String;
			}
		}

		/// <summary>
		/// Void BeelineNavigate(System.String)
		/// </summary>
		protected RMethod r_RBeelineNavigate_String;
		public virtual RMethod RBeelineNavigate_String
		{
			get
			{
				if(r_RBeelineNavigate_String == null)
				{
					r_RBeelineNavigate_String = new(this, "BeelineNavigate", 0, typeof(System.String));
					r_RBeelineNavigate_String.SetBelong(this.instance);
				}
				return r_RBeelineNavigate_String;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator doBeelineNavigate(System.String, Single, UnityEngine.Transform)
		/// </summary>
		protected RMethod r_RdoBeelineNavigate_String_Single_Transform;
		public virtual RMethod RdoBeelineNavigate_String_Single_Transform
		{
			get
			{
				if(r_RdoBeelineNavigate_String_Single_Transform == null)
				{
					r_RdoBeelineNavigate_String_Single_Transform = new(this, "doBeelineNavigate", 0, typeof(System.String), typeof(System.Single), typeof(UnityEngine.Transform));
					r_RdoBeelineNavigate_String_Single_Transform.SetBelong(this.instance);
				}
				return r_RdoBeelineNavigate_String_Single_Transform;
			}
		}

		/// <summary>
		/// Void BeelineNavigate(System.String, Single, UnityEngine.Transform)
		/// </summary>
		protected RMethod r_RBeelineNavigate_String_Single_Transform;
		public virtual RMethod RBeelineNavigate_String_Single_Transform
		{
			get
			{
				if(r_RBeelineNavigate_String_Single_Transform == null)
				{
					r_RBeelineNavigate_String_Single_Transform = new(this, "BeelineNavigate", 0, typeof(System.String), typeof(System.Single), typeof(UnityEngine.Transform));
					r_RBeelineNavigate_String_Single_Transform.SetBelong(this.instance);
				}
				return r_RBeelineNavigate_String_Single_Transform;
			}
		}
		...
		/// </summary>
		protected RMethod r_RIsNavigating;
		public virtual RMethod RIsNavigating
		{
			get
			{
				if(r_RIsNavigating == null)
				{
					r_RIsNavigating = new(this, "IsNavigating", 0);
					r_RIsNavigating.SetBelong(this.instance);
				}
				return r_RIsNavigating;
			}
		}
        ...
        public RCameraNavigate() : base("CameraNavigate")
        {
        }

        public RCameraNavigate(System.Object instance) : base("CameraNavigate")
		{
            SetInstance(instance);
		}

        public RCameraNavigate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCameraNavigate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void TestSplineNavigate()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RTestSplineNavigate.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void TestBeelineNavigate()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RTestBeelineNavigate.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void SplineNavigate(System.String  @pathName)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pathName};
            var ___result = RSplineNavigate_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void BeelineNavigate(System.String  @pathName)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pathName};
            var ___result = RBeelineNavigate_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator doBeelineNavigate(System.String  @pathName, System.Single  @time, UnityEngine.Transform  @obj)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pathName, @time, @obj};
            var ___result = RdoBeelineNavigate_String_Single_Transform.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual void BeelineNavigate(System.String  @pathName, System.Single  @time, UnityEngine.Transform  @obj)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pathName, @time, @obj};
            var ___result = RBeelineNavigate_String_Single_Transform.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Boolean IsNavigating()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RIsNavigating.Invoke(___genericsType, ___parameters);

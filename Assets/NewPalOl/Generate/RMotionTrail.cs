...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MotionTrail
	/// </summary>
    public partial class RMotionTrail : RMember //
    {

		/// <summary>
		/// UnityEngine.Transform target1
		/// </summary>
		protected RUnityEngine.RTransform r_target1;
		public virtual RUnityEngine.RTransform Rtarget1
		{
			get
			{
				if(r_target1 == null)
				{
					r_target1 = new(this, "target1");
					r_target1.SetBelong(this.instance);
				}
				return r_target1;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Transform target2
		/// </summary>
		protected RUnityEngine.RTransform r_target2;
		public virtual RUnityEngine.RTransform Rtarget2
		{
			get
			{
				if(r_target2 == null)
				{
					r_target2 = new(this, "target2");
					r_target2.SetBelong(this.instance);
				}
				return r_target2;
			}
		}
		...
		/// <summary>
		/// System.Single slerpSegmentMaxDistan
		/// </summary>
		protected RField r_slerpSegmentMaxDistan;
		public virtual RField RslerpSegmentMaxDistan
		{
			get
			{
				if(r_slerpSegmentMaxDistan == null)
				{
					r_slerpSegmentMaxDistan = new(this, "slerpSegmentMaxDistan");
					r_slerpSegmentMaxDistan.SetBelong(this.instance);
				}
				return r_slerpSegmentMaxDistan;
			}
		}

		/// <summary>
		/// System.Collections.Generic.List`1[Vertex] mVertex
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RVertex> r_mVertex;
		public virtual RSystem.RCollections.RGeneric.RList<RVertex> RmVertex
		{
			get
			{
				if(r_mVertex == null)
				{
					r_mVertex = new(this, "mVertex");
					r_mVertex.SetBelong(this.instance);
				}
				return r_mVertex;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RMaterial r__material;
		public virtual RUnityEngine.RMaterial R_material
		{
			get
			{
				if(r__material == null)
				{
					r__material = new(this, "_material");
					r__material.SetBelong(this.instance);
				}
				return r__material;
			}
		}
		...
		/// <summary>
		/// System.Int32 MaxSegment
		/// </summary>
		protected RField r_MaxSegment;
		public virtual RField RMaxSegment
		{
			get
			{
				if(r_MaxSegment == null)
				{
					r_MaxSegment = new(this, "MaxSegment");
					r_MaxSegment.SetBelong(this.instance);
				}
				return r_MaxSegment;
			}
		}
		...
		/// <summary>
		/// System.Int32 DisappearFactor
		/// </summary>
		protected RField r_DisappearFactor;
		public virtual RField RDisappearFactor
		{
			get
			{
				if(r_DisappearFactor == null)
				{
					r_DisappearFactor = new(this, "DisappearFactor");
					r_DisappearFactor.SetBelong(this.instance);
				}
				return r_DisappearFactor;
			}
		}
		...
		/// Void RenderTrail()
		/// </summary>
		protected RMethod r_RRenderTrail;
		public virtual RMethod RRenderTrail
		{
			get
			{
				if(r_RRenderTrail == null)
				{
					r_RRenderTrail = new(this, "RenderTrail", 0);
					r_RRenderTrail.SetBelong(this.instance);
				}
				return r_RRenderTrail;
			}
		}
		...
		/// Void DebugMesh()
		/// </summary>
		protected RMethod r_RDebugMesh;
		public virtual RMethod RDebugMesh
		{
			get
			{
				if(r_RDebugMesh == null)
				{
					r_RDebugMesh = new(this, "DebugMesh", 0);
					r_RDebugMesh.SetBelong(this.instance);
				}
				return r_RDebugMesh;
			}
		}
		...
		/// Void UpdateMesh()
		/// </summary>
		protected RMethod r_RUpdateMesh;
		public virtual RMethod RUpdateMesh
		{
			get
			{
				if(r_RUpdateMesh == null)
				{
					r_RUpdateMesh = new(this, "UpdateMesh", 0);
					r_RUpdateMesh.SetBelong(this.instance);
				}
				return r_RUpdateMesh;
			}
		}

		/// <summary>
		/// Void SampleVertex(UnityEngine.Transform, UnityEngine.Transform)
		/// </summary>
		protected RMethod r_RSampleVertex_Transform_Transform;
		public virtual RMethod RSampleVertex_Transform_Transform
		{
			get
			{
				if(r_RSampleVertex_Transform_Transform == null)
				{
					r_RSampleVertex_Transform_Transform = new(this, "SampleVertex", 0, typeof(UnityEngine.Transform), typeof(UnityEngine.Transform));
					r_RSampleVertex_Transform_Transform.SetBelong(this.instance);
				}
				return r_RSampleVertex_Transform_Transform;
			}
		}

		/// <summary>
		/// Boolean SlerpVector(UnityEngine.Vector3, UnityEngine.Vector3, UnityEngine.Vector3, UnityEngine.Vector3)
		/// </summary>
		protected RMethod r_RSlerpVector_Vector3_Vector3_Vector3_Vector3;
		public virtual RMethod RSlerpVector_Vector3_Vector3_Vector3_Vector3
		{
			get
			{
				if(r_RSlerpVector_Vector3_Vector3_Vector3_Vector3 == null)
				{
					r_RSlerpVector_Vector3_Vector3_Vector3_Vector3 = new(this, "SlerpVector", 0, typeof(UnityEngine.Vector3), typeof(UnityEngine.Vector3), typeof(UnityEngine.Vector3), typeof(UnityEngine.Vector3));
					r_RSlerpVector_Vector3_Vector3_Vector3_Vector3.SetBelong(this.instance);
				}
				return r_RSlerpVector_Vector3_Vector3_Vector3_Vector3;
			}
		}
        ...
        public RMotionTrail() : base("MotionTrail")
        {
        }

        public RMotionTrail(System.Object instance) : base("MotionTrail")
		{
            SetInstance(instance);
		}

        public RMotionTrail(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMotionTrail(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void RenderTrail()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RRenderTrail.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void DebugMesh()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RDebugMesh.Invoke(___genericsType, ___parameters);
        ...
        public virtual void UpdateMesh()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RUpdateMesh.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void SampleVertex(UnityEngine.Transform  @trans1, UnityEngine.Transform  @trans2)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@trans1, @trans2};
            var ___result = RSampleVertex_Transform_Transform.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Boolean SlerpVector(UnityEngine.Vector3  @fromPos1, UnityEngine.Vector3  @fromPos2, UnityEngine.Vector3  @toPos1, UnityEngine.Vector3  @toPos2)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@fromPos1, @fromPos2, @toPos1, @toPos2};
            var ___result = RSlerpVector_Vector3_Vector3_Vector3_Vector3.Invoke(___genericsType, ___parameters);

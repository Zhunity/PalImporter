...
{public partial class RMazeDoorTrigger
{
	
	/// <summary>
	/// MazeDoorTrigger+<WaitForCameraFade>c__Iterator16D
	/// </summary>
    public partial class R__2__WaitForCameraFade__4__c__Iterator16D : RMember //
    {
        ...
        public R__2__WaitForCameraFade__4__c__Iterator16D() : base("MazeDoorTrigger+<WaitForCameraFade>c__Iterator16D")
        {
        }

        public R__2__WaitForCameraFade__4__c__Iterator16D(System.Object instance) : base("MazeDoorTrigger+<WaitForCameraFade>c__Iterator16D")
		{
            SetInstance(instance);
		}

        public R__2__WaitForCameraFade__4__c__Iterator16D(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__WaitForCameraFade__4__c__Iterator16D(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// BaseResource
	/// </summary>
    public partial class RBaseResource : RMember //
    {
        ...
        public RBaseResource() : base("BaseResource")
        {
        }

        public RBaseResource(System.Object instance) : base("BaseResource")
		{
            SetInstance(instance);
		}

        public RBaseResource(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBaseResource(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// Seeker
	/// </summary>
    public partial class RSeeker : RMember //
    {

		/// <summary>
		/// AstarPath+Path path
		/// </summary>
		protected RAstarPath.RPath r_path;
		public virtual RAstarPath.RPath Rpath
		{
			get
			{
				if(r_path == null)
		...
		/// <summary>
		/// System.Boolean debugPath
		/// </summary>
		protected RField r_debugPath;
		public virtual RField RdebugPath
		{
			get
			{
				if(r_debugPath == null)
				{
					r_debugPath = new(this, "debugPath");
					r_debugPath.SetBelong(this.instance);
				}
				return r_debugPath;
			}
		}
		...
		/// <summary>
		/// System.Boolean onlyDebugSmoothedPath
		/// </summary>
		protected RField r_onlyDebugSmoothedPath;
		public virtual RField RonlyDebugSmoothedPath
		{
			get
			{
				if(r_onlyDebugSmoothedPath == null)
				{
					r_onlyDebugSmoothedPath = new(this, "onlyDebugSmoothedPath");
					r_onlyDebugSmoothedPath.SetBelong(this.instance);
				}
				return r_onlyDebugSmoothedPath;
			}
		}
		...
		/// <summary>
		/// System.Boolean removeFirst
		/// </summary>
		protected RField r_removeFirst;
		public virtual RField RremoveFirst
		{
			get
			{
				if(r_removeFirst == null)
				{
					r_removeFirst = new(this, "removeFirst");
		...
		/// <summary>
		/// Seeker+RealStart startPoint
		/// </summary>
		protected RField r_startPoint;
		public virtual RField RstartPoint
		{
			get
			{
				if(r_startPoint == null)
				{
					r_startPoint = new(this, "startPoint");
					r_startPoint.SetBelong(this.instance);
				}
				return r_startPoint;
			}
		}
		...
		/// <summary>
		/// Seeker+RealEnd endPoint
		/// </summary>
		protected RField r_endPoint;
		public virtual RField RendPoint
		{
			get
			{
				if(r_endPoint == null)
		...
		/// <summary>
		/// Seeker+OnError onError
		/// </summary>
		protected RField r_onError;
		public virtual RField RonError
		{
			get
			{
				if(r_onError == null)
				{
					r_onError = new(this, "onError");
					r_onError.SetBelong(this.instance);
				}
				return r_onError;
			}
		}
		...
		/// <summary>
		/// Seeker+GridSelection gridSelection
		/// </summary>
		protected RField r_gridSelection;
		public virtual RField RgridSelection
		{
			get
			{
				if(r_gridSelection == null)
				{
					r_gridSelection = new(this, "gridSelection");
					r_gridSelection.SetBelong(this.instance);
				}
				return r_gridSelection;
			}
		}
		...
		/// System.Int32 grid
		/// </summary>
		protected RField r_grid;
		public virtual RField Rgrid
		{
			get
			{
				if(r_grid == null)
		...
		/// <summary>
		/// System.Boolean postProcessEdges
		/// </summary>
		protected RField r_postProcessEdges;
		public virtual RField RpostProcessEdges
		{
			get
			{
				if(r_postProcessEdges == null)
				{
					r_postProcessEdges = new(this, "postProcessEdges");
					r_postProcessEdges.SetBelong(this.instance);
				}
				return r_postProcessEdges;
			}
		}

		/// <summary>
		/// Seeker+PostProcessor postProcessor
		/// </summary>
		protected RField r_postProcessor;
		public virtual RField RpostProcessor
		{
			get
			{
				if(r_postProcessor == null)
				{
					r_postProcessor = new(this, "postProcessor");
					r_postProcessor.SetBelong(this.instance);
				}
				return r_postProcessor;
			}
		}
		...
		/// </summary>
		protected RField r_subdivisions;
		public virtual RField Rsubdivisions
		{
			get
			{
				if(r_subdivisions == null)
				{
					r_subdivisions = new(this, "subdivisions");
					r_subdivisions.SetBelong(this.instance);
				}
				return r_subdivisions;
			}
		}

		/// <summary>
		/// System.Boolean bezierNormalizeTangents
		/// </summary>
		protected RField r_bezierNormalizeTangents;
		public virtual RField RbezierNormalizeTangents
		{
			get
			{
				if(r_bezierNormalizeTangents == null)
				{
					r_bezierNormalizeTangents = new(this, "bezierNormalizeTangents");
					r_bezierNormalizeTangents.SetBelong(this.instance);
				}
				return r_bezierNormalizeTangents;
			}
		}

		/// <summary>
		/// System.Single bezierTangentLength
		/// </summary>
		protected RField r_bezierTangentLength;
		public virtual RField RbezierTangentLength
		{
			get
			{
				if(r_bezierTangentLength == null)
				{
					r_bezierTangentLength = new(this, "bezierTangentLength");
					r_bezierTangentLength.SetBelong(this.instance);
				}
				return r_bezierTangentLength;
			}
		}

		/// <summary>
		/// System.Int32 simpleSmoothIterations
		/// </summary>
		protected RField r_simpleSmoothIterations;
		public virtual RField RsimpleSmoothIterations
		{
			get
			{
				if(r_simpleSmoothIterations == null)
				{
					r_simpleSmoothIterations = new(this, "simpleSmoothIterations");
					r_simpleSmoothIterations.SetBelong(this.instance);
				}
				return r_simpleSmoothIterations;
			}
		}

		/// <summary>
		/// System.Single simpleSmoothStrength
		/// </summary>
		protected RField r_simpleSmoothStrength;
		public virtual RField RsimpleSmoothStrength
		{
			get
			{
				if(r_simpleSmoothStrength == null)
				{
					r_simpleSmoothStrength = new(this, "simpleSmoothStrength");
					r_simpleSmoothStrength.SetBelong(this.instance);
				}
				return r_simpleSmoothStrength;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Vector3[] pathPoints
		/// </summary>
		protected RFieldArray<RUnityEngine.RVector3> r_pathPoints;
		public virtual RFieldArray<RUnityEngine.RVector3> RpathPoints
		{
			get
			{
				if(r_pathPoints == null)
				{
					r_pathPoints = new(this, "pathPoints");
					r_pathPoints.SetBelong(this.instance);
				}
				return r_pathPoints;
			}
		}
		...
		/// </summary>
		protected RField r_isComplete;
		public virtual RField RisComplete
		{
			get
			{
				if(r_isComplete == null)
				{
					r_isComplete = new(this, "isComplete");
					r_isComplete.SetBelong(this.instance);
				}
				return r_isComplete;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Vector3 _DebugNearestNodePos
		/// </summary>
		protected RUnityEngine.RVector3 r__DebugNearestNodePos;
		public virtual RUnityEngine.RVector3 R_DebugNearestNodePos
		{
			get
			{
				if(r__DebugNearestNodePos == null)
				{
					r__DebugNearestNodePos = new(this, "_DebugNearestNodePos");
					r__DebugNearestNodePos.SetBelong(this.instance);
				}
				return r__DebugNearestNodePos;
			}
		}
		...
		/// AIFollow _aiFollow
		/// </summary>
		protected RAIFollow r__aiFollow;
		public virtual RAIFollow R_aiFollow
		{
			get
			{
				if(r__aiFollow == null)
				{
					r__aiFollow = new(this, "_aiFollow");
					r__aiFollow.SetBelong(this.instance);
				}
				return r__aiFollow;
			}
		}
		...
		/// AIFollow AiFllowCtr
		/// </summary>
		protected RAIFollow r_AiFllowCtr;
		public virtual RAIFollow RAiFllowCtr
		{
			get
			{
				if(r_AiFllowCtr == null)
				{
					r_AiFllowCtr = new(this, "AiFllowCtr", -1);
					r_AiFllowCtr.SetBelong(this.instance);
				}
				return r_AiFllowCtr;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator MultithreadingCompleteCheck()
		/// </summary>
		protected RMethod r_RMultithreadingCompleteCheck;
		public virtual RMethod RMultithreadingCompleteCheck
		{
			get
			{
				if(r_RMultithreadingCompleteCheck == null)
				{
					r_RMultithreadingCompleteCheck = new(this, "MultithreadingCompleteCheck", 0);
					r_RMultithreadingCompleteCheck.SetBelong(this.instance);
				}
				return r_RMultithreadingCompleteCheck;
			}
		}

		/// <summary>
		/// Void OnCompleteLater(Path)
		/// </summary>
		protected RMethod r_ROnCompleteLater_Path;
		public virtual RMethod ROnCompleteLater_Path
		{
			get
			{
				if(r_ROnCompleteLater_Path == null)
				{
					r_ROnCompleteLater_Path = new(this, "OnCompleteLater", 0,  ReleactionUtils.GetType("AstarPath+Path"));
					r_ROnCompleteLater_Path.SetBelong(this.instance);
				}
				return r_ROnCompleteLater_Path;
			}
		}

		/// <summary>
		/// Void OnComplete(Path)
		/// </summary>
		protected RMethod r_ROnComplete_Path;
		public virtual RMethod ROnComplete_Path
		{
			get
			{
				if(r_ROnComplete_Path == null)
				{
					r_ROnComplete_Path = new(this, "OnComplete", 0,  ReleactionUtils.GetType("AstarPath+Path"));
					r_ROnComplete_Path.SetBelong(this.instance);
				}
				return r_ROnComplete_Path;
			}
		}

		/// <summary>
		/// UnityEngine.Vector3[] PostProcess(UnityEngine.Vector3[])
		/// </summary>
		protected RMethod r_RPostProcess_Vector3Array;
		public virtual RMethod RPostProcess_Vector3Array
		{
			get
			{
				if(r_RPostProcess_Vector3Array == null)
				{
					r_RPostProcess_Vector3Array = new(this, "PostProcess", 0, typeof(UnityEngine.Vector3).MakeArrayType());
					r_RPostProcess_Vector3Array.SetBelong(this.instance);
				}
				return r_RPostProcess_Vector3Array;
			}
		}

		/// <summary>
		/// UnityEngine.Vector3 GetNode(Int32, UnityEngine.Vector3[])
		/// </summary>
		protected static RMethod r_RGetNode_Int32_Vector3Array;
		public static RMethod RGetNode_Int32_Vector3Array
		{
			get
			{
				if(r_RGetNode_Int32_Vector3Array == null)
				{
					r_RGetNode_Int32_Vector3Array = new(typeof(Seeker), "GetNode", 0, typeof(System.Int32), typeof(UnityEngine.Vector3).MakeArrayType());
					r_RGetNode_Int32_Vector3Array.SetBelong(null);
				}
				return r_RGetNode_Int32_Vector3Array;
			}
		}
		...
		/// <summary>
		/// Path StartPath(UnityEngine.Vector3, UnityEngine.Vector3)
		/// </summary>
		protected RMethod r_RStartPath_Vector3_Vector3;
		public virtual RMethod RStartPath_Vector3_Vector3
		{
			get
			{
				if(r_RStartPath_Vector3_Vector3 == null)
				{
					r_RStartPath_Vector3_Vector3 = new(this, "StartPath", 0, typeof(UnityEngine.Vector3), typeof(UnityEngine.Vector3));
					r_RStartPath_Vector3_Vector3.SetBelong(this.instance);
				}
				return r_RStartPath_Vector3_Vector3;
			}
		}

		/// <summary>
		/// Path StartPath(UnityEngine.Vector3, UnityEngine.Vector3, UnityEngine.LayerMask)
		/// </summary>
		protected RMethod r_RStartPath_Vector3_Vector3_LayerMask;
		public virtual RMethod RStartPath_Vector3_Vector3_LayerMask
		{
			get
			{
				if(r_RStartPath_Vector3_Vector3_LayerMask == null)
				{
					r_RStartPath_Vector3_Vector3_LayerMask = new(this, "StartPath", 0, typeof(UnityEngine.Vector3), typeof(UnityEngine.Vector3), typeof(UnityEngine.LayerMask));
					r_RStartPath_Vector3_Vector3_LayerMask.SetBelong(this.instance);
				}
				return r_RStartPath_Vector3_Vector3_LayerMask;
			}
		}

		/// <summary>
		/// Void GoTo(UnityEngine.Vector3)
		/// </summary>
		protected RMethod r_RGoTo_Vector3;
		public virtual RMethod RGoTo_Vector3
		{
			get
			{
				if(r_RGoTo_Vector3 == null)
				{
					r_RGoTo_Vector3 = new(this, "GoTo", 0, typeof(UnityEngine.Vector3));
					r_RGoTo_Vector3.SetBelong(this.instance);
				}
				return r_RGoTo_Vector3;
			}
		}
		...
		/// <summary>
		/// Void _EnablePathFinder(Boolean)
		/// </summary>
		protected RMethod r_R_EnablePathFinder_Boolean;
		public virtual RMethod R_EnablePathFinder_Boolean
		{
			get
			{
				if(r_R_EnablePathFinder_Boolean == null)
				{
					r_R_EnablePathFinder_Boolean = new(this, "_EnablePathFinder", 0, typeof(System.Boolean));
					r_R_EnablePathFinder_Boolean.SetBelong(this.instance);
				}
				return r_R_EnablePathFinder_Boolean;
			}
		}
        ...
        public RSeeker() : base("Seeker")
        {
        }

        public RSeeker(System.Object instance) : base("Seeker")
		{
            SetInstance(instance);
		}

        public RSeeker(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSeeker(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Collections.IEnumerator MultithreadingCompleteCheck()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMultithreadingCompleteCheck.Invoke(___genericsType, ___parameters);
        ...
        public virtual UnityEngine.Vector3[] PostProcess(UnityEngine.Vector3[]  @nodes)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@nodes};
            var ___result = RPostProcess_Vector3Array.Invoke(___genericsType, ___parameters);

            return (UnityEngine.Vector3[])___result;
        }


        public static UnityEngine.Vector3 GetNode(System.Int32  @i, UnityEngine.Vector3[]  @nodes)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@i, @nodes};
            var ___result = RGetNode_Int32_Vector3Array.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Object StartPath(UnityEngine.Vector3  @start, UnityEngine.Vector3  @end)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@start, @end};
            var ___result = RStartPath_Vector3_Vector3.Invoke(___genericsType, ___parameters);

            return (System.Object)___result;
        }


        public virtual System.Object StartPath(UnityEngine.Vector3  @start, UnityEngine.Vector3  @end, UnityEngine.LayerMask  @collision)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@start, @end, @collision};
            var ___result = RStartPath_Vector3_Vector3_LayerMask.Invoke(___genericsType, ___parameters);

            return (System.Object)___result;
        }


        public virtual void GoTo(UnityEngine.Vector3  @pos)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pos};
            var ___result = RGoTo_Vector3.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void GoTo(UnityEngine.Vector3  @pos, System.Boolean  @isWalkStraight)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pos, @isWalkStraight};
        ...
        public virtual void _EnablePathFinder(System.Boolean  @bl)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bl};
            var ___result = R_EnablePathFinder_Boolean.Invoke(___genericsType, ___parameters);

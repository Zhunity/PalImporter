...
{public partial class RMyGUISpellWnd
{
	...
	/// MyGUISpellWnd+#3Qw
	/// </summary>
    public partial class R__0__3Qw : RMember //
    {
		...
		/// MyGUISpellWnd #e
		/// </summary>
		protected RMyGUISpellWnd r___0__e;
		public virtual RMyGUISpellWnd R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__3Qw() : base("MyGUISpellWnd+#3Qw")
        {
        }

        public R__0__3Qw(System.Object instance) : base("MyGUISpellWnd+#3Qw")
		{
            SetInstance(instance);
		}

        public R__0__3Qw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3Qw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RPetBehav
{
	...
	/// <summary>
	/// PetBehav+<LandGroundReset>c__Iterator164
	/// </summary>
    public partial class R__2__LandGroundReset__4__c__Iterator164 : RMember //
    {
        ...
        public R__2__LandGroundReset__4__c__Iterator164() : base("PetBehav+<LandGroundReset>c__Iterator164")
        {
        }

        public R__2__LandGroundReset__4__c__Iterator164(System.Object instance) : base("PetBehav+<LandGroundReset>c__Iterator164")
		{
            SetInstance(instance);
		}

        public R__2__LandGroundReset__4__c__Iterator164(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__LandGroundReset__4__c__Iterator164(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

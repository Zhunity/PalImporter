...
namespace SMFrame.Editor.Refleaction
{
	...
	/// EffectTimeDelay
	/// </summary>
    public partial class REffectTimeDelay : RMember //
    {

		/// <summary>
		/// EffectTimeDelay+EffectTimeDelayMode ModeSet
		/// </summary>
		protected RField r_ModeSet;
		public virtual RField RModeSet
		{
			get
			{
				if(r_ModeSet == null)
				{
					r_ModeSet = new(this, "ModeSet");
					r_ModeSet.SetBelong(this.instance);
				}
				return r_ModeSet;
			}
		}
		...
		/// <summary>
		/// System.Single timeDelay
		/// </summary>
		protected RField r_timeDelay;
		public virtual RField RtimeDelay
		{
			get
			{
				if(r_timeDelay == null)
				{
					r_timeDelay = new(this, "timeDelay");
					r_timeDelay.SetBelong(this.instance);
				}
				return r_timeDelay;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RTransform r_trans;
		public virtual RUnityEngine.RTransform Rtrans
		{
			get
			{
				if(r_trans == null)
				{
					r_trans = new(this, "trans");
					r_trans.SetBelong(this.instance);
				}
				return r_trans;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator GameObjectOnLoop()
		/// </summary>
		protected RMethod r_RGameObjectOnLoop;
		public virtual RMethod RGameObjectOnLoop
		{
			get
			{
				if(r_RGameObjectOnLoop == null)
				{
					r_RGameObjectOnLoop = new(this, "GameObjectOnLoop", 0);
					r_RGameObjectOnLoop.SetBelong(this.instance);
				}
				return r_RGameObjectOnLoop;
			}
		}
		...
		/// Void ReInvoke()
		/// </summary>
		protected RMethod r_RReInvoke;
		public virtual RMethod RReInvoke
		{
			get
			{
				if(r_RReInvoke == null)
				{
					r_RReInvoke = new(this, "ReInvoke", 0);
					r_RReInvoke.SetBelong(this.instance);
				}
				return r_RReInvoke;
			}
		}
		...
		/// Void InvkoeImm()
		/// </summary>
		protected RMethod r_RInvkoeImm;
		public virtual RMethod RInvkoeImm
		{
			get
			{
				if(r_RInvkoeImm == null)
				{
					r_RInvkoeImm = new(this, "InvkoeImm", 0);
					r_RInvkoeImm.SetBelong(this.instance);
				}
				return r_RInvkoeImm;
			}
		}
		...
		/// </summary>
		protected RMethod r_ROnEffectEventFire;
		public virtual RMethod ROnEffectEventFire
		{
			get
			{
				if(r_ROnEffectEventFire == null)
				{
					r_ROnEffectEventFire = new(this, "OnEffectEventFire", 0);
					r_ROnEffectEventFire.SetBelong(this.instance);
				}
				return r_ROnEffectEventFire;
			}
		}
        ...
        public REffectTimeDelay() : base("EffectTimeDelay")
        {
        }

        public REffectTimeDelay(System.Object instance) : base("EffectTimeDelay")
		{
            SetInstance(instance);
		}

        public REffectTimeDelay(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REffectTimeDelay(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Collections.IEnumerator GameObjectOnLoop()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RGameObjectOnLoop.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual void ReInvoke()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RReInvoke.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void InvkoeImm()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RInvkoeImm.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void OnEffectEventFire()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = ROnEffectEventFire.Invoke(___genericsType, ___parameters);

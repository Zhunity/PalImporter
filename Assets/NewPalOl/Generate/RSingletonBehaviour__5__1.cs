...
{
	/// <summary>
	/// SingletonBehaviour`1
	/// </summary>
    public partial class RSingletonBehaviour<S> : RMember // where S : UnityEngine.MonoBehaviour
    {

		/// <summary>
		/// S mSingleton
		/// </summary>
		protected static RField r_mSingleton;
		public static RField RmSingleton
		{
			get
			{
				if(r_mSingleton == null)
				{
					r_mSingleton = new(typeof(SingletonBehaviour<>), "mSingleton");
		...
		/// S Instance
		/// </summary>
		protected static RProperty r_Instance;
		public static RProperty RInstance
		{
			get
			{
				if(r_Instance == null)
				{
					r_Instance = new(typeof(SingletonBehaviour<>), "Instance", -1);
		...
		/// S GetSingleton()
		/// </summary>
		protected static RMethod r_RGetSingleton;
		public static RMethod RGetSingleton
		{
			get
			{
				if(r_RGetSingleton == null)
				{
					r_RGetSingleton = new(typeof(SingletonBehaviour<>), "GetSingleton", 0);
					r_RGetSingleton.SetBelong(null);
				}
				return r_RGetSingleton;
			}
		}
		...
		public static RMethod RGetInst
		{
			get
			{
				if(r_RGetInst == null)
				{
					r_RGetInst = new(typeof(SingletonBehaviour<>), "GetInst", 0);
		...
		public static RMethod RGetInstance
		{
			get
			{
				...
				{
					r_RGetInstance = new(typeof(SingletonBehaviour<>), "GetInstance", 0);
        ...
        public RSingletonBehaviour() : base("SingletonBehaviour`1")
        {
        }

        public RSingletonBehaviour(System.Object instance) : base("SingletonBehaviour`1")
		{
            SetInstance(instance);
		}

        public RSingletonBehaviour(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSingletonBehaviour(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public static S GetSingleton()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RGetSingleton.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// BattleBuff
	/// </summary>
    public partial class RBattleBuff : RMember //
    {
        ...
        public RBattleBuff() : base("BattleBuff")
        {
        }

        public RBattleBuff(System.Object instance) : base("BattleBuff")
		{
            SetInstance(instance);
		}

        public RBattleBuff(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBattleBuff(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

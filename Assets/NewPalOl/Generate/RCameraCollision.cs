...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CameraCollision
	/// </summary>
    public partial class RCameraCollision : RMember //
    {
		...
		/// <summary>
		/// System.Single wantedDistance
		/// </summary>
		protected RField r_wantedDistance;
		public virtual RField RwantedDistance
		{
			get
			{
				if(r_wantedDistance == null)
				{
					r_wantedDistance = new(this, "wantedDistance");
					r_wantedDistance.SetBelong(this.instance);
				}
				return r_wantedDistance;
			}
		}
		...
		/// <summary>
		/// System.Single scrollMinLimit
		/// </summary>
		protected RField r_scrollMinLimit;
		public virtual RField RscrollMinLimit
		{
			get
			{
				if(r_scrollMinLimit == null)
				{
					r_scrollMinLimit = new(this, "scrollMinLimit");
					r_scrollMinLimit.SetBelong(this.instance);
				}
				return r_scrollMinLimit;
			}
		}

		/// <summary>
		/// System.Boolean clearBehind
		/// </summary>
		protected RField r_clearBehind;
		public virtual RField RclearBehind
		{
			get
			{
				if(r_clearBehind == null)
				{
					r_clearBehind = new(this, "clearBehind");
					r_clearBehind.SetBelong(this.instance);
				}
				return r_clearBehind;
			}
		}

		/// <summary>
		/// System.Single downClearance
		/// </summary>
		protected RField r_downClearance;
		public virtual RField RdownClearance
		{
			get
			{
				if(r_downClearance == null)
				{
					r_downClearance = new(this, "downClearance");
					r_downClearance.SetBelong(this.instance);
				}
				return r_downClearance;
			}
		}

		/// <summary>
		/// System.Single rearClearance
		/// </summary>
		protected RField r_rearClearance;
		public virtual RField RrearClearance
		{
			get
			{
				if(r_rearClearance == null)
				{
					r_rearClearance = new(this, "rearClearance");
					r_rearClearance.SetBelong(this.instance);
				}
				return r_rearClearance;
			}
		}

		/// <summary>
		/// System.Boolean clearDown
		/// </summary>
		protected RField r_clearDown;
		public virtual RField RclearDown
		{
			get
			{
				if(r_clearDown == null)
				{
					r_clearDown = new(this, "clearDown");
					r_clearDown.SetBelong(this.instance);
				}
				return r_clearDown;
			}
		}
		...
		/// <summary>
		/// System.Boolean allClear
		/// </summary>
		protected RField r_allClear;
		public virtual RField RallClear
		{
			get
			{
				if(r_allClear == null)
				{
					r_allClear = new(this, "allClear");
					r_allClear.SetBelong(this.instance);
				}
				return r_allClear;
			}
		}
		...
		/// <summary>
		/// System.Single clearRange
		/// </summary>
		protected RField r_clearRange;
		public virtual RField RclearRange
		{
			get
			{
				if(r_clearRange == null)
				{
					r_clearRange = new(this, "clearRange");
					r_clearRange.SetBelong(this.instance);
				}
				return r_clearRange;
			}
		}
		...
		/// <summary>
		/// System.Int32 layermark
		/// </summary>
		protected RField r_layermark;
		public virtual RField Rlayermark
		{
			get
			{
				if(r_layermark == null)
				{
					r_layermark = new(this, "layermark");
					r_layermark.SetBelong(this.instance);
				}
				return r_layermark;
			}
		}
		...
		/// </summary>
		protected RMethod r_RDetectCollision;
		public virtual RMethod RDetectCollision
		{
			get
			{
				if(r_RDetectCollision == null)
				{
					r_RDetectCollision = new(this, "DetectCollision", 0);
					r_RDetectCollision.SetBelong(this.instance);
				}
				return r_RDetectCollision;
			}
		}
        ...
        public RCameraCollision() : base("CameraCollision")
        {
        }

        public RCameraCollision(System.Object instance) : base("CameraCollision")
		{
            SetInstance(instance);
		}

        public RCameraCollision(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCameraCollision(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Boolean DetectCollision()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RDetectCollision.Invoke(___genericsType, ___parameters);

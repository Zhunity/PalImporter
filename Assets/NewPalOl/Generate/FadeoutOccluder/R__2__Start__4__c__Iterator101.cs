...
{public partial class RFadeoutOccluder
{
	...
	/// <summary>
	/// FadeoutOccluder+<Start>c__Iterator101
	/// </summary>
    public partial class R__2__Start__4__c__Iterator101 : RMember //
    {
		...
		/// <summary>
		/// FadeoutOccluder <>f__this
		/// </summary>
		protected RFadeoutOccluder r___2____4__f__this;
		public virtual RFadeoutOccluder R__2____4__f__this
		{
			get
			{
        ...
        public R__2__Start__4__c__Iterator101() : base("FadeoutOccluder+<Start>c__Iterator101")
        {
        }

        public R__2__Start__4__c__Iterator101(System.Object instance) : base("FadeoutOccluder+<Start>c__Iterator101")
		{
            SetInstance(instance);
		}

        public R__2__Start__4__c__Iterator101(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__Start__4__c__Iterator101(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

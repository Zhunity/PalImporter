...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SimpleAnimation
	/// </summary>
    public partial class RSimpleAnimation : RMember //
    {

		/// <summary>
		/// CreatureBehav mCreature
		/// </summary>
		protected RCreatureBehav r_mCreature;
		public virtual RCreatureBehav RmCreature
		{
			get
			{
				if(r_mCreature == null)
				{
					r_mCreature = new(this, "mCreature");
					r_mCreature.SetBelong(this.instance);
				}
				return r_mCreature;
			}
		}
		...
		public virtual RUnityEngine.RAnimation RmAnimation
		{
			get
			{
				...
				{
					r_mAnimation = new(this, "mAnimation", -1);
		...
		/// <summary>
		/// System.Collections.IEnumerator DownLoadAnimationClip()
		/// </summary>
		protected RMethod r_RDownLoadAnimationClip;
		public virtual RMethod RDownLoadAnimationClip
		{
			get
			{
				if(r_RDownLoadAnimationClip == null)
				{
					r_RDownLoadAnimationClip = new(this, "DownLoadAnimationClip", 0);
					r_RDownLoadAnimationClip.SetBelong(this.instance);
				}
				return r_RDownLoadAnimationClip;
			}
		}
        ...
        public RSimpleAnimation() : base("SimpleAnimation")
        {
        }

        public RSimpleAnimation(System.Object instance) : base("SimpleAnimation")
		{
            SetInstance(instance);
		}

        public RSimpleAnimation(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSimpleAnimation(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Collections.IEnumerator DownLoadAnimationClip()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RDownLoadAnimationClip.Invoke(___genericsType, ___parameters);

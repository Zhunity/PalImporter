...
{
	/// <summary>
	/// ClientParamXMLReader
	/// </summary>
    public partial class RClientParamXMLReader : RMember //
    {
        ...
        public RClientParamXMLReader() : base("ClientParamXMLReader")
        {
        }

        public RClientParamXMLReader(System.Object instance) : base("ClientParamXMLReader")
		{
            SetInstance(instance);
		}

        public RClientParamXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RClientParamXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

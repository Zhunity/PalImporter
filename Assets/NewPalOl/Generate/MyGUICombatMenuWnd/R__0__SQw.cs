...
{public partial class RMyGUICombatMenuWnd
{
	...
	/// <summary>
	/// MyGUICombatMenuWnd+#SQw
	/// </summary>
    public partial class R__0__SQw : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RVector3 r___0__e;
		public virtual RUnityEngine.RVector3 R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// <summary>
		/// MyGUICombatMenuWnd #k
		/// </summary>
		protected RMyGUICombatMenuWnd r___0__k;
		public virtual RMyGUICombatMenuWnd R__0__k
		{
			get
			{
				if(r___0__k == null)
        ...
        public R__0__SQw() : base("MyGUICombatMenuWnd+#SQw")
        {
        }

        public R__0__SQw(System.Object instance) : base("MyGUICombatMenuWnd+#SQw")
		{
            SetInstance(instance);
		}

        public R__0__SQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__SQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

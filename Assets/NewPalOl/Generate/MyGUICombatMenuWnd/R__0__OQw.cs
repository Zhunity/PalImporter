...
{public partial class RMyGUICombatMenuWnd
{
	...
	/// <summary>
	/// MyGUICombatMenuWnd+#OQw
	/// </summary>
    public partial class R__0__OQw : RMember //
    {
        ...
        public R__0__OQw() : base("MyGUICombatMenuWnd+#OQw")
        {
        }

        public R__0__OQw(System.Object instance) : base("MyGUICombatMenuWnd+#OQw")
		{
            SetInstance(instance);
		}

        public R__0__OQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__OQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RMyGUICombatMenuWnd
{
	...
	/// <summary>
	/// MyGUICombatMenuWnd+#6xc
	/// </summary>
    public partial class R__0__6xc : RMember //
    {
		...
		/// <summary>
		/// MyGUICombatMenuWnd #e
		/// </summary>
		protected RMyGUICombatMenuWnd r___0__e;
		public virtual RMyGUICombatMenuWnd R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__6xc() : base("MyGUICombatMenuWnd+#6xc")
        {
        }

        public R__0__6xc(System.Object instance) : base("MyGUICombatMenuWnd+#6xc")
		{
            SetInstance(instance);
		}

        public R__0__6xc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6xc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

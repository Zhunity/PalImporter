...
{public partial class RMyGUICombatMenuWnd
{
	...
	/// <summary>
	/// MyGUICombatMenuWnd+#jZi
	/// </summary>
    public partial class R__0__jZi : RMember //
    {
        ...
        public R__0__jZi() : base("MyGUICombatMenuWnd+#jZi")
        {
        }

        public R__0__jZi(System.Object instance) : base("MyGUICombatMenuWnd+#jZi")
		{
            SetInstance(instance);
		}

        public R__0__jZi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jZi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

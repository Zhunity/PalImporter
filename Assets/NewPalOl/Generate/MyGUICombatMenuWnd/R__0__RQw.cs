...
{public partial class RMyGUICombatMenuWnd
{
	...
	/// <summary>
	/// MyGUICombatMenuWnd+#RQw
	/// </summary>
    public partial class R__0__RQw : RMember //
    {
        ...
        public R__0__RQw() : base("MyGUICombatMenuWnd+#RQw")
        {
        }

        public R__0__RQw(System.Object instance) : base("MyGUICombatMenuWnd+#RQw")
		{
            SetInstance(instance);
		}

        public R__0__RQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__RQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

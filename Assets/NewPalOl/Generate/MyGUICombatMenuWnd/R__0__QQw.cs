...
{public partial class RMyGUICombatMenuWnd
{
	...
	/// <summary>
	/// MyGUICombatMenuWnd+#QQw
	/// </summary>
    public partial class R__0__QQw : RMember //
    {
        ...
        public R__0__QQw() : base("MyGUICombatMenuWnd+#QQw")
        {
        }

        public R__0__QQw(System.Object instance) : base("MyGUICombatMenuWnd+#QQw")
		{
            SetInstance(instance);
		}

        public R__0__QQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__QQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RMyGUICombatMenuWnd
{
	...
	/// <summary>
	/// MyGUICombatMenuWnd+#PQw
	/// </summary>
    public partial class R__0__PQw : RMember //
    {
		...
		/// <summary>
		/// MyGUICombatMenuWnd #g
		/// </summary>
		protected RMyGUICombatMenuWnd r___0__g;
		public virtual RMyGUICombatMenuWnd R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__PQw() : base("MyGUICombatMenuWnd+#PQw")
        {
        }

        public R__0__PQw(System.Object instance) : base("MyGUICombatMenuWnd+#PQw")
		{
            SetInstance(instance);
		}

        public R__0__PQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__PQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

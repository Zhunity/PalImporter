...
{public partial class RMyGUICombatMenuWnd
{
	...
	/// <summary>
	/// MyGUICombatMenuWnd+#KGd
	/// </summary>
    public partial class R__0__KGd : RMember //
    {

		/// <summary>
		/// System.Object #a
		/// </summary>
		protected RSystem.RObject r___0__a;
		public virtual RSystem.RObject R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// MyGUICombatMenuWnd #h
		/// </summary>
		protected RMyGUICombatMenuWnd r___0__h;
		public virtual RMyGUICombatMenuWnd R__0__h
		{
			get
			{
				if(r___0__h == null)
        ...
        public R__0__KGd() : base("MyGUICombatMenuWnd+#KGd")
        {
        }

        public R__0__KGd(System.Object instance) : base("MyGUICombatMenuWnd+#KGd")
		{
            SetInstance(instance);
		}

        public R__0__KGd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__KGd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

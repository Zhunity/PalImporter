...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SetRenderQueue
	/// </summary>
    public partial class RSetRenderQueue : RMember //
    {

		/// <summary>
		/// System.Int32 mRendererQueue
		/// </summary>
		protected RField r_mRendererQueue;
		public virtual RField RmRendererQueue
		{
			get
			{
				if(r_mRendererQueue == null)
				{
					r_mRendererQueue = new(this, "mRendererQueue");
					r_mRendererQueue.SetBelong(this.instance);
				}
				return r_mRendererQueue;
			}
		}

		/// <summary>
		/// UnityEngine.Renderer[] mRd
		/// </summary>
		protected RFieldArray<RUnityEngine.RRenderer> r_mRd;
		public virtual RFieldArray<RUnityEngine.RRenderer> RmRd
		{
			get
			{
				if(r_mRd == null)
        ...
        public RSetRenderQueue() : base("SetRenderQueue")
        {
        }

        public RSetRenderQueue(System.Object instance) : base("SetRenderQueue")
		{
            SetInstance(instance);
		}

        public RSetRenderQueue(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSetRenderQueue(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

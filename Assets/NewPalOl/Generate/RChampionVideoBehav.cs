...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ChampionVideoBehav
	/// </summary>
    public partial class RChampionVideoBehav : RMember //
    {
		...
		/// <summary>
		/// System.Int32 ScoreNo
		/// </summary>
		protected RField r_ScoreNo;
		public virtual RField RScoreNo
		{
			get
			{
				if(r_ScoreNo == null)
				{
					r_ScoreNo = new(this, "ScoreNo");
					r_ScoreNo.SetBelong(this.instance);
				}
				return r_ScoreNo;
			}
		}
		...
		/// <summary>
		/// System.Int32 m_iRound
		/// </summary>
		protected RField r_m_iRound;
		public virtual RField Rm_iRound
		{
			get
			{
				if(r_m_iRound == null)
				{
					r_m_iRound = new(this, "m_iRound");
					r_m_iRound.SetBelong(this.instance);
				}
				return r_m_iRound;
			}
		}
		...
		/// Int32 RoundNo
		/// </summary>
		protected RProperty r_RoundNo;
		public virtual RProperty RoundNo
		{
			get
			{
				if(r_RoundNo == null)
				{
					r_RoundNo = new(this, "RoundNo", -1);
					r_RoundNo.SetBelong(this.instance);
				}
				return r_RoundNo;
			}
		}
        ...
        public RChampionVideoBehav() : base("ChampionVideoBehav")
        {
        }

        public RChampionVideoBehav(System.Object instance) : base("ChampionVideoBehav")
		{
            SetInstance(instance);
		}

        public RChampionVideoBehav(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RChampionVideoBehav(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

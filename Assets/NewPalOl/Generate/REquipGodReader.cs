...
namespace SMFrame.Editor.Refleaction
{
	...
	/// EquipGodReader
	/// </summary>
    public partial class REquipGodReader : RMember //
    {
        ...
        public REquipGodReader() : base("EquipGodReader")
        {
        }

        public REquipGodReader(System.Object instance) : base("EquipGodReader")
		{
            SetInstance(instance);
		}

        public REquipGodReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REquipGodReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{
	/// <summary>
	/// NormalEffectInCamera
	/// </summary>
    public partial class RNormalEffectInCamera : RMember //
    {
        ...
        public RNormalEffectInCamera() : base("NormalEffectInCamera")
        {
        }

        public RNormalEffectInCamera(System.Object instance) : base("NormalEffectInCamera")
		{
            SetInstance(instance);
		}

        public RNormalEffectInCamera(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RNormalEffectInCamera(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

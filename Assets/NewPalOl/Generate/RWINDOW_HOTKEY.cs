...
namespace SMFrame.Editor.Refleaction
{
	...
	/// WINDOW_HOTKEY
	/// </summary>
    public partial class RWINDOW_HOTKEY : RMember //
    {
        ...
        public RWINDOW_HOTKEY() : base("WINDOW_HOTKEY")
        {
        }

        public RWINDOW_HOTKEY(System.Object instance) : base("WINDOW_HOTKEY")
		{
            SetInstance(instance);
		}

        public RWINDOW_HOTKEY(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RWINDOW_HOTKEY(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

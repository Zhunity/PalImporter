...
{public partial class RMyGUITeamAtiWnd
{
	
	/// <summary>
	/// MyGUITeamAtiWnd+#LTv
	/// </summary>
    public partial class R__0__LTv : RMember //
    {
		...
		/// MyGUITeamAtiWnd #p
		/// </summary>
		protected RMyGUITeamAtiWnd r___0__p;
		public virtual RMyGUITeamAtiWnd R__0__p
		{
			get
			{
				if(r___0__p == null)
        ...
        public R__0__LTv() : base("MyGUITeamAtiWnd+#LTv")
        {
        }

        public R__0__LTv(System.Object instance) : base("MyGUITeamAtiWnd+#LTv")
		{
            SetInstance(instance);
		}

        public R__0__LTv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__LTv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

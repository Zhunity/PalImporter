...
{public partial class RMyGUITeamAtiWnd
{
	...
	/// MyGUITeamAtiWnd+#KTv
	/// </summary>
    public partial class R__0__KTv : RMember //
    {
		...
		/// MyGUITeamAtiWnd #k
		/// </summary>
		protected RMyGUITeamAtiWnd r___0__k;
		public virtual RMyGUITeamAtiWnd R__0__k
		{
			get
			{
				if(r___0__k == null)
        ...
        public R__0__KTv() : base("MyGUITeamAtiWnd+#KTv")
        {
        }

        public R__0__KTv(System.Object instance) : base("MyGUITeamAtiWnd+#KTv")
		{
            SetInstance(instance);
		}

        public R__0__KTv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__KTv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RMyGUITeamAtiWnd
{
	...
	/// MyGUITeamAtiWnd+#MTv
	/// </summary>
    public partial class R__0__MTv : RMember //
    {
		...
		/// MyGUITeamAtiWnd #c
		/// </summary>
		protected RMyGUITeamAtiWnd r___0__c;
		public virtual RMyGUITeamAtiWnd R__0__c
		{
			get
			{
				if(r___0__c == null)
        ...
        public R__0__MTv() : base("MyGUITeamAtiWnd+#MTv")
        {
        }

        public R__0__MTv(System.Object instance) : base("MyGUITeamAtiWnd+#MTv")
		{
            SetInstance(instance);
		}

        public R__0__MTv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__MTv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{
	/// <summary>
	/// Message.SCNetMsgTribe
	/// </summary>
    public partial class RSCNetMsgTribe : RMember //
    {
        ...
        public RSCNetMsgTribe() : base("Message.SCNetMsgTribe")
        {
        }

        public RSCNetMsgTribe(System.Object instance) : base("Message.SCNetMsgTribe")
		{
            SetInstance(instance);
		}

        public RSCNetMsgTribe(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSCNetMsgTribe(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

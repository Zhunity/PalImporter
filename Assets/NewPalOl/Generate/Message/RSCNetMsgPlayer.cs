...
namespace SMFrame.Editor.Refleaction.RMessage
{
	/// <summary>
	/// Message.SCNetMsgPlayer
	/// </summary>
    public partial class RSCNetMsgPlayer : RMember //
    {
		...
		/// GameDefineType.ID #N
		/// </summary>
		protected RGameDefineType.RID r___0__N;
		public virtual RGameDefineType.RID R__0__N
		{
			get
			{
				if(r___0__N == null)
        ...
        public RSCNetMsgPlayer() : base("Message.SCNetMsgPlayer")
        {
        }

        public RSCNetMsgPlayer(System.Object instance) : base("Message.SCNetMsgPlayer")
		{
            SetInstance(instance);
		}

        public RSCNetMsgPlayer(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSCNetMsgPlayer(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

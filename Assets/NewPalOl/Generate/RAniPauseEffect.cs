...
namespace SMFrame.Editor.Refleaction
{
	...
	/// AniPauseEffect
	/// </summary>
    public partial class RAniPauseEffect : RMember //
    {
        ...
        public RAniPauseEffect() : base("AniPauseEffect")
        {
        }

        public RAniPauseEffect(System.Object instance) : base("AniPauseEffect")
		{
            SetInstance(instance);
		}

        public RAniPauseEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAniPauseEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

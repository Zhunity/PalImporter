...
namespace SMFrame.Editor.Refleaction
{
	...
	/// WeaponOn
	/// </summary>
    public partial class RWeaponOn : RMember //
    {
        ...
        public RWeaponOn() : base("WeaponOn")
        {
        }

        public RWeaponOn(System.Object instance) : base("WeaponOn")
		{
            SetInstance(instance);
		}

        public RWeaponOn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RWeaponOn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

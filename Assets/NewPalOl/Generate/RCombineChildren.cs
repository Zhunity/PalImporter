...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CombineChildren
	/// </summary>
    public partial class RCombineChildren : RMember //
    {

		/// <summary>
		/// System.Boolean generateTriangleStrips
		/// </summary>
		protected RField r_generateTriangleStrips;
		public virtual RField RgenerateTriangleStrips
		{
			get
			{
				if(r_generateTriangleStrips == null)
				{
					r_generateTriangleStrips = new(this, "generateTriangleStrips");
					r_generateTriangleStrips.SetBelong(this.instance);
				}
				return r_generateTriangleStrips;
			}
		}

		/// <summary>
		/// System.Collections.Generic.List`1[UnityEngine.GameObject] currentMeshes
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RGameObject> r_currentMeshes;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RGameObject> RcurrentMeshes
		{
			get
			{
				if(r_currentMeshes == null)
				{
					r_currentMeshes = new(this, "currentMeshes");
					r_currentMeshes.SetBelong(this.instance);
				}
				return r_currentMeshes;
			}
		}

		/// <summary>
		/// System.Collections.Generic.List`1[UnityEngine.Renderer] allRenderers
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RRenderer> r_allRenderers;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RRenderer> RallRenderers
		{
			get
			{
				if(r_allRenderers == null)
				{
					r_allRenderers = new(this, "allRenderers");
					r_allRenderers.SetBelong(this.instance);
				}
				return r_allRenderers;
			}
		}

		/// <summary>
		/// System.Boolean combineAtStart
		/// </summary>
		protected RField r_combineAtStart;
		public virtual RField RcombineAtStart
		{
			get
			{
				if(r_combineAtStart == null)
				{
					r_combineAtStart = new(this, "combineAtStart");
					r_combineAtStart.SetBelong(this.instance);
				}
				return r_combineAtStart;
			}
		}

		/// <summary>
		/// System.Boolean destroyOnDisable
		/// </summary>
		protected RField r_destroyOnDisable;
		public virtual RField RdestroyOnDisable
		{
			get
			{
				if(r_destroyOnDisable == null)
				{
					r_destroyOnDisable = new(this, "destroyOnDisable");
					r_destroyOnDisable.SetBelong(this.instance);
				}
				return r_destroyOnDisable;
			}
		}

		/// <summary>
		/// System.Boolean areaCombine
		/// </summary>
		protected RField r_areaCombine;
		public virtual RField RareaCombine
		{
			get
			{
				if(r_areaCombine == null)
				{
					r_areaCombine = new(this, "areaCombine");
					r_areaCombine.SetBelong(this.instance);
				}
				return r_areaCombine;
			}
		}

		/// <summary>
		/// System.Boolean removeColliders
		/// </summary>
		protected RField r_removeColliders;
		public virtual RField RremoveColliders
		{
			get
			{
				if(r_removeColliders == null)
				{
					r_removeColliders = new(this, "removeColliders");
					r_removeColliders.SetBelong(this.instance);
				}
				return r_removeColliders;
			}
		}
		...
		/// Void DisableCombine()
		/// </summary>
		protected RMethod r_RDisableCombine;
		public virtual RMethod RDisableCombine
		{
			get
			{
				if(r_RDisableCombine == null)
				{
					r_RDisableCombine = new(this, "DisableCombine", 0);
					r_RDisableCombine.SetBelong(this.instance);
				}
				return r_RDisableCombine;
			}
		}
		...
		/// Void Combine()
		/// </summary>
		protected RMethod r_RCombine;
		public virtual RMethod RCombine
		{
			get
			{
				if(r_RCombine == null)
				{
					r_RCombine = new(this, "Combine", 0);
					r_RCombine.SetBelong(this.instance);
				}
				return r_RCombine;
			}
		}
        ...
        public RCombineChildren() : base("CombineChildren")
        {
        }

        public RCombineChildren(System.Object instance) : base("CombineChildren")
		{
            SetInstance(instance);
		}

        public RCombineChildren(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCombineChildren(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void DisableCombine()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RDisableCombine.Invoke(___genericsType, ___parameters);
        ...
        public virtual void Combine()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RCombine.Invoke(___genericsType, ___parameters);

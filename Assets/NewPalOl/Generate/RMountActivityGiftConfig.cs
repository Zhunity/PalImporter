...
{
	/// <summary>
	/// MountActivityGiftConfig
	/// </summary>
    public partial class RMountActivityGiftConfig : RMember //
    {
		...
		/// <summary>
		/// System.String horse_lv_up_item
		/// </summary>
		protected RField r_horse_lv_up_item;
		public virtual RField Rhorse_lv_up_item
		{
			get
			{
				if(r_horse_lv_up_item == null)
				{
					r_horse_lv_up_item = new(this, "horse_lv_up_item");
					r_horse_lv_up_item.SetBelong(this.instance);
				}
				return r_horse_lv_up_item;
			}
		}
		...
		/// System.Int32 open
		/// </summary>
		protected RField r_open;
		public virtual RField Ropen
		{
			get
			{
				if(r_open == null)
        ...
        public RMountActivityGiftConfig() : base("MountActivityGiftConfig")
        {
        }

        public RMountActivityGiftConfig(System.Object instance) : base("MountActivityGiftConfig")
		{
            SetInstance(instance);
		}

        public RMountActivityGiftConfig(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMountActivityGiftConfig(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

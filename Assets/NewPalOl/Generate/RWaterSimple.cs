...
namespace SMFrame.Editor.Refleaction
{
	...
	/// WaterSimple
	/// </summary>
    public partial class RWaterSimple : RMember //
    {
        ...
        public RWaterSimple() : base("WaterSimple")
        {
        }

        public RWaterSimple(System.Object instance) : base("WaterSimple")
		{
            SetInstance(instance);
		}

        public RWaterSimple(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RWaterSimple(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

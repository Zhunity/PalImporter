...
namespace SMFrame.Editor.Refleaction
{
	...
	/// </summary>
    public partial class RColorCorrectionEffect : RMember //
    {
        ...
        public RColorCorrectionEffect() : base("ColorCorrectionEffect")
        {
        }

        public RColorCorrectionEffect(System.Object instance) : base("ColorCorrectionEffect")
		{
            SetInstance(instance);
		}

        public RColorCorrectionEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RColorCorrectionEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

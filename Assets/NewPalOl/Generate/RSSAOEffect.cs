...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SSAOEffect
	/// </summary>
    public partial class RSSAOEffect : RMember //
    {

		/// <summary>
		/// System.Single m_Radius
		/// </summary>
		protected RField r_m_Radius;
		public virtual RField Rm_Radius
		{
			get
			{
				if(r_m_Radius == null)
				{
					r_m_Radius = new(this, "m_Radius");
					r_m_Radius.SetBelong(this.instance);
				}
				return r_m_Radius;
			}
		}
		...
		/// <summary>
		/// SSAOEffect+SSAOSamples m_SampleCount
		/// </summary>
		protected RField r_m_SampleCount;
		public virtual RField Rm_SampleCount
		{
			get
			{
				if(r_m_SampleCount == null)
				{
					r_m_SampleCount = new(this, "m_SampleCount");
					r_m_SampleCount.SetBelong(this.instance);
				}
				return r_m_SampleCount;
			}
		}

		/// <summary>
		/// System.Single m_OcclusionIntensity
		/// </summary>
		protected RField r_m_OcclusionIntensity;
		public virtual RField Rm_OcclusionIntensity
		{
			get
			{
				if(r_m_OcclusionIntensity == null)
				{
					r_m_OcclusionIntensity = new(this, "m_OcclusionIntensity");
					r_m_OcclusionIntensity.SetBelong(this.instance);
				}
				return r_m_OcclusionIntensity;
			}
		}
		...
		/// System.Int32 m_Blur
		/// </summary>
		protected RField r_m_Blur;
		public virtual RField Rm_Blur
		{
			get
			{
				if(r_m_Blur == null)
				{
					r_m_Blur = new(this, "m_Blur");
					r_m_Blur.SetBelong(this.instance);
				}
				return r_m_Blur;
			}
		}
		...
		/// <summary>
		/// System.Int32 m_Downsampling
		/// </summary>
		protected RField r_m_Downsampling;
		public virtual RField Rm_Downsampling
		{
			get
			{
				if(r_m_Downsampling == null)
				{
					r_m_Downsampling = new(this, "m_Downsampling");
					r_m_Downsampling.SetBelong(this.instance);
				}
				return r_m_Downsampling;
			}
		}

		/// <summary>
		/// System.Single m_OcclusionAttenuation
		/// </summary>
		protected RField r_m_OcclusionAttenuation;
		public virtual RField Rm_OcclusionAttenuation
		{
			get
			{
				if(r_m_OcclusionAttenuation == null)
				{
					r_m_OcclusionAttenuation = new(this, "m_OcclusionAttenuation");
					r_m_OcclusionAttenuation.SetBelong(this.instance);
				}
				return r_m_OcclusionAttenuation;
			}
		}

		/// <summary>
		/// System.Single m_MinZ
		/// </summary>
		protected RField r_m_MinZ;
		public virtual RField Rm_MinZ
		{
			get
			{
				if(r_m_MinZ == null)
				{
					r_m_MinZ = new(this, "m_MinZ");
					r_m_MinZ.SetBelong(this.instance);
				}
				return r_m_MinZ;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Shader m_SSAOShader
		/// </summary>
		protected RUnityEngine.RShader r_m_SSAOShader;
		public virtual RUnityEngine.RShader Rm_SSAOShader
		{
			get
			{
				if(r_m_SSAOShader == null)
				{
					r_m_SSAOShader = new(this, "m_SSAOShader");
					r_m_SSAOShader.SetBelong(this.instance);
				}
				return r_m_SSAOShader;
			}
		}

		/// <summary>
		/// UnityEngine.Material m_SSAOMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r_m_SSAOMaterial;
		public virtual RUnityEngine.RMaterial Rm_SSAOMaterial
		{
			get
			{
				if(r_m_SSAOMaterial == null)
				{
					r_m_SSAOMaterial = new(this, "m_SSAOMaterial");
					r_m_SSAOMaterial.SetBelong(this.instance);
				}
				return r_m_SSAOMaterial;
			}
		}

		/// <summary>
		/// UnityEngine.Texture2D m_RandomTexture
		/// </summary>
		protected RUnityEngine.RTexture2D r_m_RandomTexture;
		public virtual RUnityEngine.RTexture2D Rm_RandomTexture
		{
			get
			{
				if(r_m_RandomTexture == null)
				{
					r_m_RandomTexture = new(this, "m_RandomTexture");
					r_m_RandomTexture.SetBelong(this.instance);
				}
				return r_m_RandomTexture;
			}
		}

		/// <summary>
		/// System.Boolean m_Supported
		/// </summary>
		protected RField r_m_Supported;
		public virtual RField Rm_Supported
		{
			get
			{
				if(r_m_Supported == null)
				{
					r_m_Supported = new(this, "m_Supported");
					r_m_Supported.SetBelong(this.instance);
				}
				return r_m_Supported;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Material CreateMaterial(UnityEngine.Shader)
		/// </summary>
		protected static RMethod r_RCreateMaterial_Shader;
		public static RMethod RCreateMaterial_Shader
		{
			get
			{
				if(r_RCreateMaterial_Shader == null)
				{
					r_RCreateMaterial_Shader = new(typeof(SSAOEffect), "CreateMaterial", 0, typeof(UnityEngine.Shader));
					r_RCreateMaterial_Shader.SetBelong(null);
				}
				return r_RCreateMaterial_Shader;
			}
		}

		/// <summary>
		/// Void DestroyMaterial(UnityEngine.Material)
		/// </summary>
		protected static RMethod r_RDestroyMaterial_Material;
		public static RMethod RDestroyMaterial_Material
		{
			get
			{
				if(r_RDestroyMaterial_Material == null)
				{
					r_RDestroyMaterial_Material = new(typeof(SSAOEffect), "DestroyMaterial", 0, typeof(UnityEngine.Material));
					r_RDestroyMaterial_Material.SetBelong(null);
				}
				return r_RDestroyMaterial_Material;
			}
		}
        ...
        public RSSAOEffect() : base("SSAOEffect")
        {
        }

        public RSSAOEffect(System.Object instance) : base("SSAOEffect")
		{
            SetInstance(instance);
		}

        public RSSAOEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSSAOEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public static UnityEngine.Material CreateMaterial(UnityEngine.Shader  @shader)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@shader};
            var ___result = RCreateMaterial_Shader.Invoke(___genericsType, ___parameters);

            return (UnityEngine.Material)___result;
        }


        public static void DestroyMaterial(UnityEngine.Material  @mat)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@mat};
            var ___result = RDestroyMaterial_Material.Invoke(___genericsType, ___parameters);

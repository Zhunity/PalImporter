...
namespace SMFrame.Editor.Refleaction
{
	...
	/// Arena3dPlayerBehav
	/// </summary>
    public partial class RArena3dPlayerBehav : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.Vector3 NameOffset3D
		/// </summary>
		protected RUnityEngine.RVector3 r_NameOffset3D;
		public virtual RUnityEngine.RVector3 RNameOffset3D
		{
			get
			{
				if(r_NameOffset3D == null)
				{
					r_NameOffset3D = new(this, "NameOffset3D");
					r_NameOffset3D.SetBelong(this.instance);
				}
				return r_NameOffset3D;
			}
		}

		/// <summary>
		/// GameDefineType.ID playerId
		/// </summary>
		protected RGameDefineType.RID r_playerId;
		public virtual RGameDefineType.RID RplayerId
		{
			get
			{
				if(r_playerId == null)
				{
					r_playerId = new(this, "playerId");
					r_playerId.SetBelong(this.instance);
				}
				return r_playerId;
			}
		}
		...
		/// </summary>
		protected RField r_nameLength;
		public virtual RField RnameLength
		{
			get
			{
				if(r_nameLength == null)
				{
					r_nameLength = new(this, "nameLength");
					r_nameLength.SetBelong(this.instance);
				}
				return r_nameLength;
			}
		}
		...
		/// System.Int32 rank
		/// </summary>
		protected RField r_rank;
		public virtual RField Rrank
		{
			get
			{
				if(r_rank == null)
				{
					r_rank = new(this, "rank");
		...
		/// <summary>
		/// System.String rankStr
		/// </summary>
		protected RField r_rankStr;
		public virtual RField RrankStr
		{
			get
			{
				if(r_rankStr == null)
				{
					r_rankStr = new(this, "rankStr");
					r_rankStr.SetBelong(this.instance);
				}
				return r_rankStr;
			}
		}
		...
		/// <summary>
		/// System.Int32 rankStrLength
		/// </summary>
		protected RField r_rankStrLength;
		public virtual RField RrankStrLength
		{
			get
			{
				if(r_rankStrLength == null)
				{
					r_rankStrLength = new(this, "rankStrLength");
					r_rankStrLength.SetBelong(this.instance);
				}
				return r_rankStrLength;
			}
		}
		...
		/// <summary>
		/// System.String powerStr
		/// </summary>
		protected RField r_powerStr;
		public virtual RField RpowerStr
		{
			get
			{
				if(r_powerStr == null)
				{
					r_powerStr = new(this, "powerStr");
					r_powerStr.SetBelong(this.instance);
				}
				return r_powerStr;
			}
		}
		...
		/// <summary>
		/// System.Int32 powerStrLength
		/// </summary>
		protected RField r_powerStrLength;
		public virtual RField RpowerStrLength
		{
			get
			{
				if(r_powerStrLength == null)
				{
					r_powerStrLength = new(this, "powerStrLength");
					r_powerStrLength.SetBelong(this.instance);
				}
				return r_powerStrLength;
			}
		}
		...
		/// <summary>
		/// System.Int32 tipsLength
		/// </summary>
		protected RField r_tipsLength;
		public virtual RField RtipsLength
		{
			get
			{
				if(r_tipsLength == null)
				{
					r_tipsLength = new(this, "tipsLength");
					r_tipsLength.SetBelong(this.instance);
				}
				return r_tipsLength;
			}
		}
		...
		/// <summary>
		/// UnityEngine.GUIStyle nameStyle
		/// </summary>
		protected RUnityEngine.RGUIStyle r_nameStyle;
		public virtual RUnityEngine.RGUIStyle RnameStyle
		{
			get
			{
				if(r_nameStyle == null)
				{
					r_nameStyle = new(this, "nameStyle");
					r_nameStyle.SetBelong(this.instance);
				}
				return r_nameStyle;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RCamera r_m_Camera;
		public virtual RUnityEngine.RCamera Rm_Camera
		{
			get
			{
				if(r_m_Camera == null)
				{
					r_m_Camera = new(this, "m_Camera");
					r_m_Camera.SetBelong(this.instance);
				}
				return r_m_Camera;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Vector2 status
		/// </summary>
		protected RUnityEngine.RVector2 r_status;
		public virtual RUnityEngine.RVector2 Rstatus
		{
			get
			{
				if(r_status == null)
		...
		/// <summary>
		/// UnityEngine.GUIStyle m_NameGUIStyle
		/// </summary>
		protected RUnityEngine.RGUIStyle r_m_NameGUIStyle;
		public virtual RUnityEngine.RGUIStyle Rm_NameGUIStyle
		{
			get
			{
				if(r_m_NameGUIStyle == null)
				{
					r_m_NameGUIStyle = new(this, "m_NameGUIStyle");
					r_m_NameGUIStyle.SetBelong(this.instance);
				}
				return r_m_NameGUIStyle;
			}
		}

		/// <summary>
		/// UnityEngine.GUIStyle m_NameGUIStyle2
		/// </summary>
		protected RUnityEngine.RGUIStyle r_m_NameGUIStyle2;
		public virtual RUnityEngine.RGUIStyle Rm_NameGUIStyle2
		{
			get
			{
				if(r_m_NameGUIStyle2 == null)
				{
					r_m_NameGUIStyle2 = new(this, "m_NameGUIStyle2");
					r_m_NameGUIStyle2.SetBelong(this.instance);
				}
				return r_m_NameGUIStyle2;
			}
		}

		/// <summary>
		/// System.Single btnCDtime
		/// </summary>
		protected RField r_btnCDtime;
		public virtual RField RbtnCDtime
		{
			get
			{
				if(r_btnCDtime == null)
				{
					r_btnCDtime = new(this, "btnCDtime");
					r_btnCDtime.SetBelong(this.instance);
				}
				return r_btnCDtime;
			}
		}
		...
		/// <summary>
		/// UnityEngine.LayerMask mouseEventLayer
		/// </summary>
		protected RUnityEngine.RLayerMask r_mouseEventLayer;
		public virtual RUnityEngine.RLayerMask RmouseEventLayer
		{
			get
			{
				if(r_mouseEventLayer == null)
				{
					r_mouseEventLayer = new(this, "mouseEventLayer");
					r_mouseEventLayer.SetBelong(this.instance);
				}
				return r_mouseEventLayer;
			}
		}

		/// <summary>
		/// UnityEngine.Collider mOldGameObjHit
		/// </summary>
		protected RUnityEngine.RCollider r_mOldGameObjHit;
		public virtual RUnityEngine.RCollider RmOldGameObjHit
		{
			get
			{
				if(r_mOldGameObjHit == null)
				{
					r_mOldGameObjHit = new(this, "mOldGameObjHit");
					r_mOldGameObjHit.SetBelong(this.instance);
				}
				return r_mOldGameObjHit;
			}
		}

		/// <summary>
		/// System.Boolean haveWindowHover
		/// </summary>
		protected RField r_haveWindowHover;
		public virtual RField RhaveWindowHover
		{
			get
			{
				if(r_haveWindowHover == null)
				{
					r_haveWindowHover = new(this, "haveWindowHover");
					r_haveWindowHover.SetBelong(this.instance);
				}
				return r_haveWindowHover;
			}
		}

		/// <summary>
		/// System.Boolean m_bMouseClick
		/// </summary>
		protected RField r_m_bMouseClick;
		public virtual RField Rm_bMouseClick
		{
			get
			{
				if(r_m_bMouseClick == null)
				{
					r_m_bMouseClick = new(this, "m_bMouseClick");
					r_m_bMouseClick.SetBelong(this.instance);
				}
				return r_m_bMouseClick;
			}
		}

		/// <summary>
		/// UnityEngine.GUIStyle NameGUIStyle
		/// </summary>
		protected RUnityEngine.RGUIStyle r_NameGUIStyle;
		public virtual RUnityEngine.RGUIStyle RNameGUIStyle
		{
			get
			{
				if(r_NameGUIStyle == null)
				{
					r_NameGUIStyle = new(this, "NameGUIStyle", -1);
					r_NameGUIStyle.SetBelong(this.instance);
				}
				return r_NameGUIStyle;
			}
		}

		/// <summary>
		/// UnityEngine.GUIStyle NameGUIStyle2
		/// </summary>
		protected RUnityEngine.RGUIStyle r_NameGUIStyle2;
		public virtual RUnityEngine.RGUIStyle RNameGUIStyle2
		{
			get
			{
				if(r_NameGUIStyle2 == null)
				{
					r_NameGUIStyle2 = new(this, "NameGUIStyle2", -1);
					r_NameGUIStyle2.SetBelong(this.instance);
				}
				return r_NameGUIStyle2;
			}
		}
		...
		/// Int32 Power
		/// </summary>
		protected RProperty r_Power;
		public virtual RProperty RPower
		{
			get
			{
				if(r_Power == null)
				{
					r_Power = new(this, "Power", -1);
					r_Power.SetBelong(this.instance);
				}
				return r_Power;
			}
		...
		public virtual RGameDefineType.RID RPlayerId
		{
			get
			{
				if(r_PlayerId == null)
				{
					r_PlayerId = new(this, "PlayerId", -1);
					r_PlayerId.SetBelong(this.instance);
				}
				return r_PlayerId;
			}
		...
		/// <summary>
		/// Int32 GetStringLength(System.String, System.String)
		/// </summary>
		protected RMethod r_RGetStringLength_String_String;
		public virtual RMethod RGetStringLength_String_String
		{
			get
			{
				if(r_RGetStringLength_String_String == null)
				{
					r_RGetStringLength_String_String = new(this, "GetStringLength", 0, typeof(System.String), typeof(System.String));
					r_RGetStringLength_String_String.SetBelong(this.instance);
				}
				return r_RGetStringLength_String_String;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator CoolDown(Single)
		/// </summary>
		protected RMethod r_RCoolDown_Single;
		public virtual RMethod RCoolDown_Single
		{
			get
			{
				if(r_RCoolDown_Single == null)
				{
					r_RCoolDown_Single = new(this, "CoolDown", 0, typeof(System.Single));
					r_RCoolDown_Single.SetBelong(this.instance);
				}
				return r_RCoolDown_Single;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator CoolMouseDown(Single)
		/// </summary>
		protected RMethod r_RCoolMouseDown_Single;
		public virtual RMethod RCoolMouseDown_Single
		{
			get
			{
				if(r_RCoolMouseDown_Single == null)
				{
					r_RCoolMouseDown_Single = new(this, "CoolMouseDown", 0, typeof(System.Single));
					r_RCoolMouseDown_Single.SetBelong(this.instance);
				}
				return r_RCoolMouseDown_Single;
			}
		}

		/// <summary>
		/// Void UpdateMouseEventSend()
		/// </summary>
		protected RMethod r_RUpdateMouseEventSend;
		public virtual RMethod RUpdateMouseEventSend
		{
			get
			{
				if(r_RUpdateMouseEventSend == null)
				{
					r_RUpdateMouseEventSend = new(this, "UpdateMouseEventSend", 0);
					r_RUpdateMouseEventSend.SetBelong(this.instance);
				}
				return r_RUpdateMouseEventSend;
			}
		}
        ...
        public RArena3dPlayerBehav() : base("Arena3dPlayerBehav")
        {
        }

        public RArena3dPlayerBehav(System.Object instance) : base("Arena3dPlayerBehav")
		{
            SetInstance(instance);
		}

        public RArena3dPlayerBehav(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RArena3dPlayerBehav(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Int32 GetStringLength(System.String  @styleName, System.String  @name)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@styleName, @name};
            var ___result = RGetStringLength_String_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Collections.IEnumerator CoolDown(System.Single  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time};
            var ___result = RCoolDown_Single.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Collections.IEnumerator CoolMouseDown(System.Single  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time};
            var ___result = RCoolMouseDown_Single.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual void UpdateMouseEventSend()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RUpdateMouseEventSend.Invoke(___genericsType, ___parameters);

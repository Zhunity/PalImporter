...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ContrastEnhance
	/// </summary>
    public partial class RContrastEnhance : RMember //
    {

		/// <summary>
		/// UnityEngine.Material _contrastCompositeMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r__contrastCompositeMaterial;
		public virtual RUnityEngine.RMaterial R_contrastCompositeMaterial
		{
			get
			{
				if(r__contrastCompositeMaterial == null)
				{
					r__contrastCompositeMaterial = new(this, "_contrastCompositeMaterial");
					r__contrastCompositeMaterial.SetBelong(this.instance);
				}
				return r__contrastCompositeMaterial;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Shader contrastCompositeShader
		/// </summary>
		protected RUnityEngine.RShader r_contrastCompositeShader;
		public virtual RUnityEngine.RShader RcontrastCompositeShader
		{
			get
			{
				if(r_contrastCompositeShader == null)
				{
					r_contrastCompositeShader = new(this, "contrastCompositeShader");
					r_contrastCompositeShader.SetBelong(this.instance);
				}
				return r_contrastCompositeShader;
			}
		}
		...
		/// <summary>
		/// System.Single threshhold
		/// </summary>
		protected RField r_threshhold;
		public virtual RField Rthreshhold
		{
			get
			{
				if(r_threshhold == null)
				{
					r_threshhold = new(this, "threshhold");
					r_threshhold.SetBelong(this.instance);
				}
				return r_threshhold;
			}
		}
        ...
        public RContrastEnhance() : base("ContrastEnhance")
        {
        }

        public RContrastEnhance(System.Object instance) : base("ContrastEnhance")
		{
            SetInstance(instance);
		}

        public RContrastEnhance(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RContrastEnhance(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{
	/// <summary>
	/// SceneManagerMonoBehaviour
	/// </summary>
    public partial class RSceneManagerMonoBehaviour : RMember //
    {
        ...
        public RSceneManagerMonoBehaviour() : base("SceneManagerMonoBehaviour")
        {
        }

        public RSceneManagerMonoBehaviour(System.Object instance) : base("SceneManagerMonoBehaviour")
		{
            SetInstance(instance);
		}

        public RSceneManagerMonoBehaviour(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSceneManagerMonoBehaviour(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

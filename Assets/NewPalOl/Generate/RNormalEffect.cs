...
namespace SMFrame.Editor.Refleaction
{
	...
	/// NormalEffect
	/// </summary>
    public partial class RNormalEffect : RMember //
    {
        ...
        public RNormalEffect() : base("NormalEffect")
        {
        }

        public RNormalEffect(System.Object instance) : base("NormalEffect")
		{
            SetInstance(instance);
		}

        public RNormalEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RNormalEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

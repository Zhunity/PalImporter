...
namespace SMFrame.Editor.Refleaction
{
	...
	/// AIFollow
	/// </summary>
    public partial class RAIFollow : RMember //
    {
		...
		/// <summary>
		/// System.Single SearchWaypointFrequency
		/// </summary>
		protected RField r_SearchWaypointFrequency;
		public virtual RField RSearchWaypointFrequency
		{
			get
			{
				if(r_SearchWaypointFrequency == null)
				{
					r_SearchWaypointFrequency = new(this, "SearchWaypointFrequency");
					r_SearchWaypointFrequency.SetBelong(this.instance);
				}
				return r_SearchWaypointFrequency;
			}
		}

		/// <summary>
		/// System.Single maxStop
		/// </summary>
		protected RField r_maxStop;
		public virtual RField RmaxStop
		{
			get
			{
				if(r_maxStop == null)
				{
					r_maxStop = new(this, "maxStop");
					r_maxStop.SetBelong(this.instance);
				}
				return r_maxStop;
			}
		}
		...
		/// <summary>
		/// System.Boolean continousTargetSearch
		/// </summary>
		protected RField r_continousTargetSearch;
		public virtual RField RcontinousTargetSearch
		{
			get
			{
				if(r_continousTargetSearch == null)
				{
					r_continousTargetSearch = new(this, "continousTargetSearch");
					r_continousTargetSearch.SetBelong(this.instance);
				}
				return r_continousTargetSearch;
			}
		}

		/// <summary>
		/// System.Single targetSearchFrequency
		/// </summary>
		protected RField r_targetSearchFrequency;
		public virtual RField RtargetSearchFrequency
		{
			get
			{
				if(r_targetSearchFrequency == null)
				{
					r_targetSearchFrequency = new(this, "targetSearchFrequency");
					r_targetSearchFrequency.SetBelong(this.instance);
				}
				return r_targetSearchFrequency;
			}
		}

		/// <summary>
		/// System.Boolean canSearchAgain
		/// </summary>
		protected RField r_canSearchAgain;
		public virtual RField RcanSearchAgain
		{
			get
			{
				if(r_canSearchAgain == null)
				{
					r_canSearchAgain = new(this, "canSearchAgain");
					r_canSearchAgain.SetBelong(this.instance);
				}
				return r_canSearchAgain;
			}
		}

		/// <summary>
		/// AIFollow+Command _command
		/// </summary>
		protected RField r__command;
		public virtual RField R_command
		{
			get
			{
				if(r__command == null)
				{
					r__command = new(this, "_command");
					r__command.SetBelong(this.instance);
				}
				return r__command;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Vector3 _realDestiny
		/// </summary>
		protected RUnityEngine.RVector3 r__realDestiny;
		public virtual RUnityEngine.RVector3 R_realDestiny
		{
			get
			{
				if(r__realDestiny == null)
				{
					r__realDestiny = new(this, "_realDestiny");
					r__realDestiny.SetBelong(this.instance);
				}
				return r__realDestiny;
			}
		}

		/// <summary>
		/// AIFollow+PathState mState
		/// </summary>
		protected RField r_mState;
		public virtual RField RmState
		{
			get
			{
				if(r_mState == null)
				{
					r_mState = new(this, "mState");
					r_mState.SetBelong(this.instance);
				}
				return r_mState;
			}
		}
		...
		/// <summary>
		/// UnityEngine.LayerMask collision
		/// </summary>
		protected static RUnityEngine.RLayerMask r_collision;
		public static RUnityEngine.RLayerMask Rcollision
		{
			get
			{
				if(r_collision == null)
				{
					r_collision = new( ReleactionUtils.GetType("AIFollow"), "collision");
					r_collision.SetBelong(null);
				}
				return r_collision;
			}
		}
		...
		/// <summary>
		/// System.Boolean isRuntimeCheck
		/// </summary>
		protected RField r_isRuntimeCheck;
		public virtual RField RisRuntimeCheck
		{
			get
			{
				if(r_isRuntimeCheck == null)
				{
					r_isRuntimeCheck = new(this, "isRuntimeCheck");
					r_isRuntimeCheck.SetBelong(this.instance);
				}
				return r_isRuntimeCheck;
			}
		}

		/// <summary>
		/// PlayerBehav _PlayerBehav
		/// </summary>
		protected RPlayerBehav r__PlayerBehav;
		public virtual RPlayerBehav R_PlayerBehav
		{
			get
			{
				if(r__PlayerBehav == null)
				{
					r__PlayerBehav = new(this, "_PlayerBehav");
					r__PlayerBehav.SetBelong(this.instance);
				}
				return r__PlayerBehav;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Vector3 waypointPosition
		/// </summary>
		protected RUnityEngine.RVector3 r_waypointPosition;
		public virtual RUnityEngine.RVector3 RwaypointPosition
		{
			get
			{
				if(r_waypointPosition == null)
				{
					r_waypointPosition = new(this, "waypointPosition");
					r_waypointPosition.SetBelong(this.instance);
				}
				return r_waypointPosition;
			}
		}

		/// <summary>
		/// UnityEngine.Vector3[] points
		/// </summary>
		protected RFieldArray<RUnityEngine.RVector3> r_points;
		public virtual RFieldArray<RUnityEngine.RVector3> Rpoints
		{
			get
			{
				if(r_points == null)
		...
		/// <summary>
		/// System.Int32 curpoint
		/// </summary>
		protected RField r_curpoint;
		public virtual RField Rcurpoint
		{
			get
			{
				if(r_curpoint == null)
				{
					r_curpoint = new(this, "curpoint");
					r_curpoint.SetBelong(this.instance);
				}
				return r_curpoint;
			}
		}
		...
		/// <summary>
		/// Single pickNextWaypointDistance
		/// </summary>
		protected RProperty r_pickNextWaypointDistance;
		public virtual RProperty RpickNextWaypointDistance
		{
			get
			{
				if(r_pickNextWaypointDistance == null)
				{
					r_pickNextWaypointDistance = new(this, "pickNextWaypointDistance", -1);
					r_pickNextWaypointDistance.SetBelong(this.instance);
				}
				return r_pickNextWaypointDistance;
			}
		}
		...
		/// Void StartFollow()
		/// </summary>
		protected RMethod r_RStartFollow;
		public virtual RMethod RStartFollow
		{
			get
			{
				if(r_RStartFollow == null)
				{
					r_RStartFollow = new(this, "StartFollow", 0);
					r_RStartFollow.SetBelong(this.instance);
				}
				return r_RStartFollow;
			}
		}
		...
		/// Void StopFollow()
		/// </summary>
		protected RMethod r_RStopFollow;
		public virtual RMethod RStopFollow
		{
			get
			{
				if(r_RStopFollow == null)
				{
					r_RStopFollow = new(this, "StopFollow", 0);
					r_RStopFollow.SetBelong(this.instance);
				}
				return r_RStopFollow;
			}
		}
		...
		/// Void ClearPath()
		/// </summary>
		protected RMethod r_RClearPath;
		public virtual RMethod RClearPath
		{
			get
			{
				if(r_RClearPath == null)
				{
					r_RClearPath = new(this, "ClearPath", 0);
					r_RClearPath.SetBelong(this.instance);
				}
				return r_RClearPath;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Vector3[] GetPathPointFind()
		/// </summary>
		protected RMethod r_RGetPathPointFind;
		public virtual RMethod RGetPathPointFind
		{
			get
			{
				if(r_RGetPathPointFind == null)
				{
					r_RGetPathPointFind = new(this, "GetPathPointFind", 0);
					r_RGetPathPointFind.SetBelong(this.instance);
				}
				return r_RGetPathPointFind;
			}
		}
		...
		/// <summary>
		/// Void PathComplete(UnityEngine.Vector3[])
		/// </summary>
		...
		/// </summary>
		protected RMethod r_RHasReachedTarget;
		public virtual RMethod RHasReachedTarget
		{
			get
			{
				if(r_RHasReachedTarget == null)
				{
					r_RHasReachedTarget = new(this, "HasReachedTarget", 0);
					r_RHasReachedTarget.SetBelong(this.instance);
				}
				return r_RHasReachedTarget;
			}
		}

		/// <summary>
		/// Void FindPoint(Int32)
		/// </summary>
		protected RMethod r_RFindPoint_Int32;
		public virtual RMethod RFindPoint_Int32
		{
			get
			{
				if(r_RFindPoint_Int32 == null)
				{
					r_RFindPoint_Int32 = new(this, "FindPoint", 0, typeof(System.Int32));
					r_RFindPoint_Int32.SetBelong(this.instance);
				}
				return r_RFindPoint_Int32;
			}
		}

		/// <summary>
		/// Void FindPointRuntimeCheck()
		/// </summary>
		protected RMethod r_RFindPointRuntimeCheck;
		public virtual RMethod RFindPointRuntimeCheck
		{
			get
			{
				if(r_RFindPointRuntimeCheck == null)
				{
					r_RFindPointRuntimeCheck = new(this, "FindPointRuntimeCheck", 0);
					r_RFindPointRuntimeCheck.SetBelong(this.instance);
				}
				return r_RFindPointRuntimeCheck;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator FindPointRuntimeCheck2()
		/// </summary>
		protected RMethod r_RFindPointRuntimeCheck2;
		public virtual RMethod RFindPointRuntimeCheck2
		{
			get
			{
				if(r_RFindPointRuntimeCheck2 == null)
				{
					r_RFindPointRuntimeCheck2 = new(this, "FindPointRuntimeCheck2", 0);
					r_RFindPointRuntimeCheck2.SetBelong(this.instance);
				}
				return r_RFindPointRuntimeCheck2;
			}
		}

		/// <summary>
		/// Boolean WalkStraigtCheck(UnityEngine.Vector3)
		/// </summary>
		protected RMethod r_RWalkStraigtCheck_Vector3;
		public virtual RMethod RWalkStraigtCheck_Vector3
		{
			get
			{
				if(r_RWalkStraigtCheck_Vector3 == null)
				{
					r_RWalkStraigtCheck_Vector3 = new(this, "WalkStraigtCheck", 0, typeof(UnityEngine.Vector3));
					r_RWalkStraigtCheck_Vector3.SetBelong(this.instance);
				}
				return r_RWalkStraigtCheck_Vector3;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator Patrol()
		/// </summary>
		protected RMethod r_RPatrol;
		public virtual RMethod RPatrol
		{
			get
			{
				if(r_RPatrol == null)
				{
					r_RPatrol = new(this, "Patrol", 0);
					r_RPatrol.SetBelong(this.instance);
				}
				return r_RPatrol;
			}
		}
		...
		/// <summary>
		/// Void WalkStraigt(UnityEngine.Vector3)
		/// </summary>
		protected RMethod r_RWalkStraigt_Vector3;
		public virtual RMethod RWalkStraigt_Vector3
		{
			get
			{
				if(r_RWalkStraigt_Vector3 == null)
				{
					r_RWalkStraigt_Vector3 = new(this, "WalkStraigt", 0, typeof(UnityEngine.Vector3));
					r_RWalkStraigt_Vector3.SetBelong(this.instance);
				}
				return r_RWalkStraigt_Vector3;
			}
		}

		/// <summary>
		/// Void MoveTowards(UnityEngine.Vector3)
		/// </summary>
		protected RMethod r_RMoveTowards_Vector3;
		public virtual RMethod RMoveTowards_Vector3
		{
			get
			{
				if(r_RMoveTowards_Vector3 == null)
				{
					r_RMoveTowards_Vector3 = new(this, "MoveTowards", 0, typeof(UnityEngine.Vector3));
					r_RMoveTowards_Vector3.SetBelong(this.instance);
				}
				return r_RMoveTowards_Vector3;
			}
		}

		/// <summary>
		/// UnityEngine.Vector2 Vector3ToVector2(UnityEngine.Vector3)
		/// </summary>
		protected RMethod r_RVector3ToVector2_Vector3;
		public virtual RMethod RVector3ToVector2_Vector3
		{
			get
			{
				if(r_RVector3ToVector2_Vector3 == null)
				{
					r_RVector3ToVector2_Vector3 = new(this, "Vector3ToVector2", 0, typeof(UnityEngine.Vector3));
					r_RVector3ToVector2_Vector3.SetBelong(this.instance);
				}
				return r_RVector3ToVector2_Vector3;
			}
		}
        ...
        public RAIFollow() : base("AIFollow")
        {
        }

        public RAIFollow(System.Object instance) : base("AIFollow")
		{
            SetInstance(instance);
		}

        public RAIFollow(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAIFollow(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void StartFollow()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RStartFollow.Invoke(___genericsType, ___parameters);
        ...
        public virtual void StopFollow()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RStopFollow.Invoke(___genericsType, ___parameters);
        ...
        public virtual void ClearPath()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RClearPath.Invoke(___genericsType, ___parameters);

            
        }


        public virtual UnityEngine.Vector3[] GetPathPointFind()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RGetPathPointFind.Invoke(___genericsType, ___parameters);
        ...
        public virtual void PathComplete(UnityEngine.Vector3[]  @newPoints)
        {
        ...
        public virtual System.Boolean HasReachedTarget()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RHasReachedTarget.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual void FindPoint(System.Int32  @cpoint)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cpoint};
            var ___result = RFindPoint_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void FindPointRuntimeCheck()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RFindPointRuntimeCheck.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator FindPointRuntimeCheck2()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RFindPointRuntimeCheck2.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual System.Boolean WalkStraigtCheck(UnityEngine.Vector3  @dest)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@dest};
            var ___result = RWalkStraigtCheck_Vector3.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Collections.IEnumerator Patrol()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RPatrol.Invoke(___genericsType, ___parameters);
        ...
        public virtual void WalkStraigt(UnityEngine.Vector3  @des)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@des};
            var ___result = RWalkStraigt_Vector3.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void MoveTowards(UnityEngine.Vector3  @position)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@position};
            var ___result = RMoveTowards_Vector3.Invoke(___genericsType, ___parameters);

            
        }


        public virtual UnityEngine.Vector2 Vector3ToVector2(UnityEngine.Vector3  @v)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@v};
            var ___result = RVector3ToVector2_Vector3.Invoke(___genericsType, ___parameters);

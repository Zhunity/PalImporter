...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CameraShakeEffect
	/// </summary>
    public partial class RCameraShakeEffect : RMember //
    {
		...
		/// </summary>
		protected RField r_amplitude;
		public virtual RField Ramplitude
		{
			get
			{
				if(r_amplitude == null)
				{
					r_amplitude = new(this, "amplitude");
					r_amplitude.SetBelong(this.instance);
				}
				return r_amplitude;
			}
		}
        ...
        public RCameraShakeEffect() : base("CameraShakeEffect")
        {
        }

        public RCameraShakeEffect(System.Object instance) : base("CameraShakeEffect")
		{
            SetInstance(instance);
		}

        public RCameraShakeEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCameraShakeEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

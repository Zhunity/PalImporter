...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SpecularLighting
	/// </summary>
    public partial class RSpecularLighting : RMember //
    {

		/// <summary>
		/// UnityEngine.Transform specularLight
		/// </summary>
		protected RUnityEngine.RTransform r_specularLight;
		public virtual RUnityEngine.RTransform RspecularLight
		{
			get
			{
				if(r_specularLight == null)
				{
					r_specularLight = new(this, "specularLight");
					r_specularLight.SetBelong(this.instance);
				}
				return r_specularLight;
			}
		}
        ...
        public RSpecularLighting() : base("SpecularLighting")
        {
        }

        public RSpecularLighting(System.Object instance) : base("SpecularLighting")
		{
            SetInstance(instance);
		}

        public RSpecularLighting(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSpecularLighting(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{
	/// <summary>
	/// RenderTextureAlphaClear
	/// </summary>
    public partial class RRenderTextureAlphaClear : RMember //
    {
        ...
        public RRenderTextureAlphaClear() : base("RenderTextureAlphaClear")
        {
        }

        public RRenderTextureAlphaClear(System.Object instance) : base("RenderTextureAlphaClear")
		{
            SetInstance(instance);
		}

        public RRenderTextureAlphaClear(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RRenderTextureAlphaClear(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{
	/// <summary>
	/// CombatMenuBGColliderClick
	/// </summary>
    public partial class RCombatMenuBGColliderClick : RMember //
    {
        ...
        public RCombatMenuBGColliderClick() : base("CombatMenuBGColliderClick")
        {
        }

        public RCombatMenuBGColliderClick(System.Object instance) : base("CombatMenuBGColliderClick")
		{
            SetInstance(instance);
		}

        public RCombatMenuBGColliderClick(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCombatMenuBGColliderClick(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

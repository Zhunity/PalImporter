...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ScreenWipes
	/// </summary>
    public partial class RScreenWipes : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.RenderTexture renderTex
		/// </summary>
		protected RUnityEngine.RRenderTexture r_renderTex;
		public virtual RUnityEngine.RRenderTexture RrenderTex
		{
			get
			{
				if(r_renderTex == null)
				{
					r_renderTex = new(this, "renderTex");
					r_renderTex.SetBelong(this.instance);
				}
				return r_renderTex;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RTexture2D r_tex2D;
		public virtual RUnityEngine.RTexture2D Rtex2D
		{
			get
			{
				if(r_tex2D == null)
				{
					r_tex2D = new(this, "tex2D");
					r_tex2D.SetBelong(this.instance);
				}
				return r_tex2D;
			}
		}
		...
		/// <summary>
		/// System.Boolean reEnableListener
		/// </summary>
		protected RField r_reEnableListener;
		public virtual RField RreEnableListener
		{
			get
			{
				if(r_reEnableListener == null)
				{
					r_reEnableListener = new(this, "reEnableListener");
					r_reEnableListener.SetBelong(this.instance);
				}
				return r_reEnableListener;
			}
		}

		/// <summary>
		/// UnityEngine.Material shapeMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r_shapeMaterial;
		public virtual RUnityEngine.RMaterial RshapeMaterial
		{
			get
			{
				if(r_shapeMaterial == null)
				{
					r_shapeMaterial = new(this, "shapeMaterial");
					r_shapeMaterial.SetBelong(this.instance);
				}
				return r_shapeMaterial;
			}
		}

		/// <summary>
		/// UnityEngine.Transform shape
		/// </summary>
		protected RUnityEngine.RTransform r_shape;
		public virtual RUnityEngine.RTransform Rshape
		{
			get
			{
				if(r_shape == null)
				{
					r_shape = new(this, "shape");
		...
		/// <summary>
		/// ScreenWipes Instance
		/// </summary>
		protected RScreenWipes r_Instance;
		public virtual RScreenWipes RInstance
		{
			get
			{
				if(r_Instance == null)
				{
					r_Instance = new(this, "Instance");
					r_Instance.SetBelong(this.instance);
				}
				return r_Instance;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Camera mcam1
		/// </summary>
		protected RUnityEngine.RCamera r_mcam1;
		public virtual RUnityEngine.RCamera Rmcam1
		{
			get
			{
				if(r_mcam1 == null)
				{
					r_mcam1 = new(this, "mcam1");
					r_mcam1.SetBelong(this.instance);
				}
				return r_mcam1;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Camera mcam2
		/// </summary>
		protected RUnityEngine.RCamera r_mcam2;
		public virtual RUnityEngine.RCamera Rmcam2
		{
			get
			{
				if(r_mcam2 == null)
				{
					r_mcam2 = new(this, "mcam2");
					r_mcam2.SetBelong(this.instance);
				}
				return r_mcam2;
			}
		}
		...
		/// <summary>
		/// System.Boolean bAlphaTimerCounting
		/// </summary>
		protected RField r_bAlphaTimerCounting;
		public virtual RField RbAlphaTimerCounting
		{
			get
			{
				if(r_bAlphaTimerCounting == null)
				{
					r_bAlphaTimerCounting = new(this, "bAlphaTimerCounting");
					r_bAlphaTimerCounting.SetBelong(this.instance);
				}
				return r_bAlphaTimerCounting;
			}
		}

		/// <summary>
		/// System.Int32 planeResolution
		/// </summary>
		protected RField r_planeResolution;
		public virtual RField RplaneResolution
		{
			get
			{
				if(r_planeResolution == null)
				{
					r_planeResolution = new(this, "planeResolution");
					r_planeResolution.SetBelong(this.instance);
				}
				return r_planeResolution;
			}
		}
		...
		/// </summary>
		protected RFieldArray<RUnityEngine.RVector3> r_newVertices;
		public virtual RFieldArray<RUnityEngine.RVector3> RnewVertices
		{
			get
			{
				if(r_newVertices == null)
				{
					r_newVertices = new(this, "newVertices");
					r_newVertices.SetBelong(this.instance);
				}
				return r_newVertices;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RMaterial r_planeMaterial;
		public virtual RUnityEngine.RMaterial RplaneMaterial
		{
			get
			{
				if(r_planeMaterial == null)
				{
					r_planeMaterial = new(this, "planeMaterial");
					r_planeMaterial.SetBelong(this.instance);
				}
				return r_planeMaterial;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RGameObject r_plane;
		public virtual RUnityEngine.RGameObject Rplane
		{
			get
			{
				if(r_plane == null)
				{
					r_plane = new(this, "plane");
					r_plane.SetBelong(this.instance);
				}
				return r_plane;
			}
		}
		...
		/// <summary>
		/// UnityEngine.RenderTexture renderTex2
		/// </summary>
		protected RUnityEngine.RRenderTexture r_renderTex2;
		public virtual RUnityEngine.RRenderTexture RrenderTex2
		{
			get
			{
				if(r_renderTex2 == null)
				{
					r_renderTex2 = new(this, "renderTex2");
					r_renderTex2.SetBelong(this.instance);
				}
				return r_renderTex2;
			}
		}
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.String,System.Int32] <>f__switch$map39
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RDictionary<RField, RField> r___2____4__f__switch__9__map39;
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__2____4__f__switch__9__map39
		{
			get
			{
				if(r___2____4__f__switch__9__map39 == null)
				{
					r___2____4__f__switch__9__map39 = new( ReleactionUtils.GetType("ScreenWipes"), "<>f__switch$map39");
					r___2____4__f__switch__9__map39.SetBelong(null);
				}
				return r___2____4__f__switch__9__map39;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator AlphaTimer(Single)
		/// </summary>
		protected RMethod r_RAlphaTimer_Single;
		public virtual RMethod RAlphaTimer_Single
		{
			get
			{
				if(r_RAlphaTimer_Single == null)
				{
					r_RAlphaTimer_Single = new(this, "AlphaTimer", 0, typeof(System.Single));
					r_RAlphaTimer_Single.SetBelong(this.instance);
				}
				return r_RAlphaTimer_Single;
			}
		}

		/// <summary>
		/// Void CameraSetup(UnityEngine.Camera, UnityEngine.Camera, Boolean, Boolean)
		/// </summary>
		protected RMethod r_RCameraSetup_Camera_Camera_Boolean_Boolean;
		public virtual RMethod RCameraSetup_Camera_Camera_Boolean_Boolean
		{
			get
			{
				if(r_RCameraSetup_Camera_Camera_Boolean_Boolean == null)
				{
					r_RCameraSetup_Camera_Camera_Boolean_Boolean = new(this, "CameraSetup", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.Camera), typeof(System.Boolean), typeof(System.Boolean));
					r_RCameraSetup_Camera_Camera_Boolean_Boolean.SetBelong(this.instance);
				}
				return r_RCameraSetup_Camera_Camera_Boolean_Boolean;
			}
		}

		/// <summary>
		/// Void CameraCleanup(UnityEngine.Camera, UnityEngine.Camera)
		/// </summary>
		protected RMethod r_RCameraCleanup_Camera_Camera;
		public virtual RMethod RCameraCleanup_Camera_Camera
		{
			get
			{
				if(r_RCameraCleanup_Camera_Camera == null)
				{
					r_RCameraCleanup_Camera_Camera = new(this, "CameraCleanup", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.Camera));
					r_RCameraCleanup_Camera_Camera.SetBelong(this.instance);
				}
				return r_RCameraCleanup_Camera_Camera;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator CrossFadePro(UnityEngine.Camera, UnityEngine.Camera, Single)
		/// </summary>
		protected RMethod r_RCrossFadePro_Camera_Camera_Single;
		public virtual RMethod RCrossFadePro_Camera_Camera_Single
		{
			get
			{
				if(r_RCrossFadePro_Camera_Camera_Single == null)
				{
					r_RCrossFadePro_Camera_Camera_Single = new(this, "CrossFadePro", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.Camera), typeof(System.Single));
					r_RCrossFadePro_Camera_Camera_Single.SetBelong(this.instance);
				}
				return r_RCrossFadePro_Camera_Camera_Single;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator RectWipe(UnityEngine.Camera, UnityEngine.Camera, Single, ZoomType)
		/// </summary>
		protected RMethod r_RRectWipe_Camera_Camera_Single_ZoomType;
		public virtual RMethod RRectWipe_Camera_Camera_Single_ZoomType
		{
			get
			{
				if(r_RRectWipe_Camera_Camera_Single_ZoomType == null)
				{
					r_RRectWipe_Camera_Camera_Single_ZoomType = new(this, "RectWipe", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.Camera), typeof(System.Single),  ReleactionUtils.GetType("ScreenWipes+ZoomType"));
					r_RRectWipe_Camera_Camera_Single_ZoomType.SetBelong(this.instance);
				}
				return r_RRectWipe_Camera_Camera_Single_ZoomType;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator SquishWipe(UnityEngine.Camera, UnityEngine.Camera, Single, System.String)
		/// </summary>
		protected RMethod r_RSquishWipe_Camera_Camera_Single_String;
		public virtual RMethod RSquishWipe_Camera_Camera_Single_String
		{
			get
			{
				if(r_RSquishWipe_Camera_Camera_Single_String == null)
				{
					r_RSquishWipe_Camera_Camera_Single_String = new(this, "SquishWipe", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.Camera), typeof(System.Single), typeof(System.String));
					r_RSquishWipe_Camera_Camera_Single_String.SetBelong(this.instance);
				}
				return r_RSquishWipe_Camera_Camera_Single_String;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator ShapeWipe(UnityEngine.Camera, UnityEngine.Camera, Single, ZoomType, UnityEngine.Mesh, Single)
		/// </summary>
		protected RMethod r_RShapeWipe_Camera_Camera_Single_ZoomType_Mesh_Single;
		public virtual RMethod RShapeWipe_Camera_Camera_Single_ZoomType_Mesh_Single
		{
			get
			{
				if(r_RShapeWipe_Camera_Camera_Single_ZoomType_Mesh_Single == null)
				{
					r_RShapeWipe_Camera_Camera_Single_ZoomType_Mesh_Single = new(this, "ShapeWipe", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.Camera), typeof(System.Single),  ReleactionUtils.GetType("ScreenWipes+ZoomType"), typeof(UnityEngine.Mesh), typeof(System.Single));
					r_RShapeWipe_Camera_Camera_Single_ZoomType_Mesh_Single.SetBelong(this.instance);
				}
				return r_RShapeWipe_Camera_Camera_Single_ZoomType_Mesh_Single;
			}
		}

		/// <summary>
		/// Void InitialDreamWipe()
		/// </summary>
		protected RMethod r_RInitialDreamWipe;
		public virtual RMethod RInitialDreamWipe
		{
			get
			{
				if(r_RInitialDreamWipe == null)
				{
					r_RInitialDreamWipe = new(this, "InitialDreamWipe", 0);
					r_RInitialDreamWipe.SetBelong(this.instance);
				}
				return r_RInitialDreamWipe;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator DreamWipe(UnityEngine.Camera, UnityEngine.Camera, Single, Single, Single)
		/// </summary>
		protected RMethod r_RDreamWipe_Camera_Camera_Single_Single_Single;
		public virtual RMethod RDreamWipe_Camera_Camera_Single_Single_Single
		{
			get
			{
				if(r_RDreamWipe_Camera_Camera_Single_Single_Single == null)
				{
					r_RDreamWipe_Camera_Camera_Single_Single_Single = new(this, "DreamWipe", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.Camera), typeof(System.Single), typeof(System.Single), typeof(System.Single));
					r_RDreamWipe_Camera_Camera_Single_Single_Single.SetBelong(this.instance);
				}
				return r_RDreamWipe_Camera_Camera_Single_Single_Single;
			}
		}

		/// <summary>
		/// Void StartCrossFade(UnityEngine.Camera, UnityEngine.Camera, Single)
		/// </summary>
		protected RMethod r_RStartCrossFade_Camera_Camera_Single;
		public virtual RMethod RStartCrossFade_Camera_Camera_Single
		{
			get
			{
				if(r_RStartCrossFade_Camera_Camera_Single == null)
				{
					r_RStartCrossFade_Camera_Camera_Single = new(this, "StartCrossFade", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.Camera), typeof(System.Single));
					r_RStartCrossFade_Camera_Camera_Single.SetBelong(this.instance);
				}
				return r_RStartCrossFade_Camera_Camera_Single;
			}
		}

		/// <summary>
		/// Void StartRectWipe(UnityEngine.Camera, UnityEngine.Camera, Single, ZoomType)
		/// </summary>
		protected RMethod r_RStartRectWipe_Camera_Camera_Single_ZoomType;
		public virtual RMethod RStartRectWipe_Camera_Camera_Single_ZoomType
		{
			get
			{
				if(r_RStartRectWipe_Camera_Camera_Single_ZoomType == null)
				{
					r_RStartRectWipe_Camera_Camera_Single_ZoomType = new(this, "StartRectWipe", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.Camera), typeof(System.Single),  ReleactionUtils.GetType("ScreenWipes+ZoomType"));
					r_RStartRectWipe_Camera_Camera_Single_ZoomType.SetBelong(this.instance);
				}
				return r_RStartRectWipe_Camera_Camera_Single_ZoomType;
			}
		}

		/// <summary>
		/// Void StartSquishWipe(UnityEngine.Camera, UnityEngine.Camera, Single, System.String)
		/// </summary>
		protected RMethod r_RStartSquishWipe_Camera_Camera_Single_String;
		public virtual RMethod RStartSquishWipe_Camera_Camera_Single_String
		{
			get
			{
				if(r_RStartSquishWipe_Camera_Camera_Single_String == null)
				{
					r_RStartSquishWipe_Camera_Camera_Single_String = new(this, "StartSquishWipe", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.Camera), typeof(System.Single), typeof(System.String));
					r_RStartSquishWipe_Camera_Camera_Single_String.SetBelong(this.instance);
				}
				return r_RStartSquishWipe_Camera_Camera_Single_String;
			}
		}

		/// <summary>
		/// Void StartDreamWipe(UnityEngine.Camera, UnityEngine.Camera, Single)
		/// </summary>
		protected RMethod r_RStartDreamWipe_Camera_Camera_Single;
		public virtual RMethod RStartDreamWipe_Camera_Camera_Single
		{
			get
			{
				if(r_RStartDreamWipe_Camera_Camera_Single == null)
				{
					r_RStartDreamWipe_Camera_Camera_Single = new(this, "StartDreamWipe", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.Camera), typeof(System.Single));
					r_RStartDreamWipe_Camera_Camera_Single.SetBelong(this.instance);
				}
				return r_RStartDreamWipe_Camera_Camera_Single;
			}
		}

		/// <summary>
		/// Void StartDreamWipeWithTex(UnityEngine.Camera, UnityEngine.Camera, Single, UnityEngine.Texture)
		/// </summary>
		protected RMethod r_RStartDreamWipeWithTex_Camera_Camera_Single_Texture;
		public virtual RMethod RStartDreamWipeWithTex_Camera_Camera_Single_Texture
		{
			get
			{
				if(r_RStartDreamWipeWithTex_Camera_Camera_Single_Texture == null)
				{
					r_RStartDreamWipeWithTex_Camera_Camera_Single_Texture = new(this, "StartDreamWipeWithTex", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.Camera), typeof(System.Single), typeof(UnityEngine.Texture));
					r_RStartDreamWipeWithTex_Camera_Camera_Single_Texture.SetBelong(this.instance);
				}
				return r_RStartDreamWipeWithTex_Camera_Camera_Single_Texture;
			}
		}

		/// <summary>
		/// Void StartShapeWipe(UnityEngine.Camera, UnityEngine.Camera, Single, ZoomType)
		/// </summary>
		protected RMethod r_RStartShapeWipe_Camera_Camera_Single_ZoomType;
		public virtual RMethod RStartShapeWipe_Camera_Camera_Single_ZoomType
		{
			get
			{
				if(r_RStartShapeWipe_Camera_Camera_Single_ZoomType == null)
				{
					r_RStartShapeWipe_Camera_Camera_Single_ZoomType = new(this, "StartShapeWipe", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.Camera), typeof(System.Single),  ReleactionUtils.GetType("ScreenWipes+ZoomType"));
					r_RStartShapeWipe_Camera_Camera_Single_ZoomType.SetBelong(this.instance);
				}
				return r_RStartShapeWipe_Camera_Camera_Single_ZoomType;
			}
		}
        ...
        public RScreenWipes() : base("ScreenWipes")
        {
        }

        public RScreenWipes(System.Object instance) : base("ScreenWipes")
		{
            SetInstance(instance);
		}

        public RScreenWipes(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RScreenWipes(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Collections.IEnumerator AlphaTimer(System.Single  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time};
            var ___result = RAlphaTimer_Single.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual void CameraSetup(UnityEngine.Camera  @cam1, UnityEngine.Camera  @cam2, System.Boolean  @cam1Active, System.Boolean  @enableThis)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cam1, @cam2, @cam1Active, @enableThis};
            var ___result = RCameraSetup_Camera_Camera_Boolean_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void CameraCleanup(UnityEngine.Camera  @cam1, UnityEngine.Camera  @cam2)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cam1, @cam2};
            var ___result = RCameraCleanup_Camera_Camera.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator CrossFadePro(UnityEngine.Camera  @cam1, UnityEngine.Camera  @cam2, System.Single  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cam1, @cam2, @time};
            var ___result = RCrossFadePro_Camera_Camera_Single.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Collections.IEnumerator SquishWipe(UnityEngine.Camera  @cam1, UnityEngine.Camera  @cam2, System.Single  @time, System.String  @type)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cam1, @cam2, @time, @type};
            var ___result = RSquishWipe_Camera_Camera_Single_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual void InitialDreamWipe()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RInitialDreamWipe.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator DreamWipe(UnityEngine.Camera  @cam1, UnityEngine.Camera  @cam2, System.Single  @time, System.Single  @waveScale, System.Single  @waveFrequency)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cam1, @cam2, @time, @waveScale, @waveFrequency};
            var ___result = RDreamWipe_Camera_Camera_Single_Single_Single.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual void StartCrossFade(UnityEngine.Camera  @cam1, UnityEngine.Camera  @cam2, System.Single  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cam1, @cam2, @time};
            var ___result = RStartCrossFade_Camera_Camera_Single.Invoke(___genericsType, ___parameters);
        ...
        public virtual void StartSquishWipe(UnityEngine.Camera  @cam1, UnityEngine.Camera  @cam2, System.Single  @time, System.String  @type)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cam1, @cam2, @time, @type};
            var ___result = RStartSquishWipe_Camera_Camera_Single_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void StartDreamWipe(UnityEngine.Camera  @cam1, UnityEngine.Camera  @cam2, System.Single  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cam1, @cam2, @time};
            var ___result = RStartDreamWipe_Camera_Camera_Single.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void StartDreamWipeWithTex(UnityEngine.Camera  @cam1, UnityEngine.Camera  @cam2, System.Single  @time, UnityEngine.Texture  @tex)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cam1, @cam2, @time, @tex};
            var ___result = RStartDreamWipeWithTex_Camera_Camera_Single_Texture.Invoke(___genericsType, ___parameters);

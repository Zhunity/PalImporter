...
namespace SMFrame.Editor.Refleaction
{
	...
	/// FrameCheck
	/// </summary>
    public partial class RFrameCheck : RMember //
    {
        ...
        public RFrameCheck() : base("FrameCheck")
        {
        }

        public RFrameCheck(System.Object instance) : base("FrameCheck")
		{
            SetInstance(instance);
		}

        public RFrameCheck(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RFrameCheck(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ShieldUvAnimation
	/// </summary>
    public partial class RShieldUvAnimation : RMember //
    {

		/// <summary>
		/// UnityEngine.GameObject iShield
		/// </summary>
		protected RUnityEngine.RGameObject r_iShield;
		public virtual RUnityEngine.RGameObject RiShield
		{
			get
			{
				if(r_iShield == null)
				{
					r_iShield = new(this, "iShield");
					r_iShield.SetBelong(this.instance);
				}
				return r_iShield;
			}
		}
		...
		/// <summary>
		/// System.Single iSpeed
		/// </summary>
		protected RField r_iSpeed;
		public virtual RField RiSpeed
		{
			get
			{
				if(r_iSpeed == null)
				{
					r_iSpeed = new(this, "iSpeed");
					r_iSpeed.SetBelong(this.instance);
				}
				return r_iSpeed;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Material mMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r_mMaterial;
		public virtual RUnityEngine.RMaterial RmMaterial
		{
			get
			{
				if(r_mMaterial == null)
				{
					r_mMaterial = new(this, "mMaterial");
					r_mMaterial.SetBelong(this.instance);
				}
				return r_mMaterial;
			}
		}
		...
		/// System.Single mTime
		/// </summary>
		protected RField r_mTime;
		public virtual RField RmTime
		{
			get
			{
				if(r_mTime == null)
				{
					r_mTime = new(this, "mTime");
					r_mTime.SetBelong(this.instance);
				}
				return r_mTime;
			}
		}
        ...
        public RShieldUvAnimation() : base("ShieldUvAnimation")
        {
        }

        public RShieldUvAnimation(System.Object instance) : base("ShieldUvAnimation")
		{
            SetInstance(instance);
		}

        public RShieldUvAnimation(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RShieldUvAnimation(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

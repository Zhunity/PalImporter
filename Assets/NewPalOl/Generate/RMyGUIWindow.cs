...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MyGUIWindow
	/// </summary>
    public partial class RMyGUIWindow : RMember //
    {

		/// <summary>
		/// UnityEngine.Vector3 #a
		/// </summary>
		protected RUnityEngine.RVector3 r___0__a;
		public virtual RUnityEngine.RVector3 R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		public static RField R__0__r
		{
			get
			{
				if(r___0__r == null)
				{
					r___0__r = new( ReleactionUtils.GetType("MyGUIWindow"), "#r");
		...
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RList<RField> r___0__G;
		public static RSystem.RCollections.RGeneric.RList<RField> R__0__G
		{
			get
			{
				if(r___0__G == null)
				{
					r___0__G = new( ReleactionUtils.GetType("MyGUIWindow"), "#G");
		...
		public static RField R__0__H
		{
			get
			{
				if(r___0__H == null)
				{
					r___0__H = new( ReleactionUtils.GetType("MyGUIWindow"), "#H");
		...
		/// <summary>
		/// MyGUIMonoBehaviour #M
		/// </summary>
		protected RMyGUIMonoBehaviour r___0__M;
		public virtual RMyGUIMonoBehaviour R__0__M
		{
			get
			{
				if(r___0__M == null)
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.String,UnityEngine.GameObject] #N
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, RUnityEngine.RGameObject> r___0__N;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, RUnityEngine.RGameObject> R__0__N
		{
			get
			{
				if(r___0__N == null)
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[#oU.#uU,MyGUIWindow+#jLb] #S
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<R__0__oU.R__0__uU, RMyGUIWindow.R__0__jLb> r___0__S;
		public virtual RSystem.RCollections.RGeneric.RDictionary<R__0__oU.R__0__uU, RMyGUIWindow.R__0__jLb> R__0__S
		{
			get
			{
				if(r___0__S == null)
		...
		/// Void #oKb()
		/// </summary>
		protected RMethod r_R__0__oKb;
		public virtual RMethod R__0__oKb
		{
			get
			{
				if(r_R__0__oKb == null)
				{
					r_R__0__oKb = new(this, "#oKb", 0);
					r_R__0__oKb.SetBelong(this.instance);
				}
				return r_R__0__oKb;
			}
		}
		...
		/// Void #pKb()
		/// </summary>
		protected RMethod r_R__0__pKb;
		public virtual RMethod R__0__pKb
		{
			get
			{
				if(r_R__0__pKb == null)
				{
					r_R__0__pKb = new(this, "#pKb", 0);
					r_R__0__pKb.SetBelong(this.instance);
				}
				return r_R__0__pKb;
			}
		}
		...
		/// Void #qKb(Boolean)
		/// </summary>
		protected RMethod r_R__0__qKb_Boolean;
		public virtual RMethod R__0__qKb_Boolean
		{
			get
			{
				if(r_R__0__qKb_Boolean == null)
				{
					r_R__0__qKb_Boolean = new(this, "#qKb", 0, typeof(System.Boolean));
					r_R__0__qKb_Boolean.SetBelong(this.instance);
				}
				return r_R__0__qKb_Boolean;
			}
		}
		...
		/// Void #sKb(Boolean)
		/// </summary>
		protected RMethod r_R__0__sKb_Boolean;
		public virtual RMethod R__0__sKb_Boolean
		{
			get
			{
				if(r_R__0__sKb_Boolean == null)
				{
					r_R__0__sKb_Boolean = new(this, "#sKb", 0, typeof(System.Boolean));
					r_R__0__sKb_Boolean.SetBelong(this.instance);
				}
				return r_R__0__sKb_Boolean;
			}
		}
		...
		/// <summary>
		/// Void #OOi(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__OOi_Object___0__7X;
		public virtual RMethod R__0__OOi_Object___0__7X
		{
			get
			{
				if(r_R__0__OOi_Object___0__7X == null)
				{
					r_R__0__OOi_Object___0__7X = new(this, "#OOi", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__OOi_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__OOi_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator #0Kb(Boolean, Boolean, Boolean)
		/// </summary>
		protected RMethod r_R__0__0Kb_Boolean_Boolean_Boolean;
		public virtual RMethod R__0__0Kb_Boolean_Boolean_Boolean
		{
			get
			{
				if(r_R__0__0Kb_Boolean_Boolean_Boolean == null)
				{
					r_R__0__0Kb_Boolean_Boolean_Boolean = new(this, "#0Kb", 0, typeof(System.Boolean), typeof(System.Boolean), typeof(System.Boolean));
					r_R__0__0Kb_Boolean_Boolean_Boolean.SetBelong(this.instance);
				}
				return r_R__0__0Kb_Boolean_Boolean_Boolean;
			}
		}
		...
		/// Void #4Kb(Int32)
		/// </summary>
		protected RMethod r_R__0__4Kb_Int32;
		public virtual RMethod R__0__4Kb_Int32
		{
			get
			{
				if(r_R__0__4Kb_Int32 == null)
				{
					r_R__0__4Kb_Int32 = new(this, "#4Kb", 0, typeof(System.Int32));
					r_R__0__4Kb_Int32.SetBelong(this.instance);
				}
				return r_R__0__4Kb_Int32;
			}
		}
		...
		/// Void #aLb()
		/// </summary>
		protected RMethod r_R__0__aLb;
		public virtual RMethod R__0__aLb
		{
			get
			{
				if(r_R__0__aLb == null)
				{
					r_R__0__aLb = new(this, "#aLb", 0);
					r_R__0__aLb.SetBelong(this.instance);
				}
				return r_R__0__aLb;
			}
		}
        ...
        public RMyGUIWindow() : base("MyGUIWindow")
        {
        }

        public RMyGUIWindow(System.Object instance) : base("MyGUIWindow")
		{
            SetInstance(instance);
		}

        public RMyGUIWindow(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMyGUIWindow(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__oKb()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__oKb.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__pKb()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__pKb.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__qKb(System.Boolean  @show)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@show};
            var ___result = R__0__qKb_Boolean.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__sKb(System.Boolean  @show)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@show};
            var ___result = R__0__sKb_Boolean.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Collections.IEnumerator __0__0Kb(System.Boolean  @bOpen, System.Boolean  @bRelation, System.Boolean  @bNoFade)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bOpen, @bRelation, @bNoFade};
            var ___result = R__0__0Kb_Boolean_Boolean_Boolean.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__4Kb(System.Int32  @wID)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@wID};
            var ___result = R__0__4Kb_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__aLb()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__aLb.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MOVIE_UNIT
	/// </summary>
    public partial class RMOVIE_UNIT : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.Vector3 #j
		/// </summary>
		protected RUnityEngine.RVector3 r___0__j;
		public virtual RUnityEngine.RVector3 R__0__j
		{
			get
			{
				if(r___0__j == null)
		...
		/// <summary>
		/// UnityEngine.Transform #n
		/// </summary>
		protected RUnityEngine.RTransform r___0__n;
		public virtual RUnityEngine.RTransform R__0__n
		{
			get
			{
				if(r___0__n == null)
        ...
        public RMOVIE_UNIT() : base("MOVIE_UNIT")
        {
        }

        public RMOVIE_UNIT(System.Object instance) : base("MOVIE_UNIT")
		{
            SetInstance(instance);
		}

        public RMOVIE_UNIT(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMOVIE_UNIT(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

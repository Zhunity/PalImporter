...
{
	/// <summary>
	/// ProjectorMaterialAnimation
	/// </summary>
    public partial class RProjectorMaterialAnimation : RMember //
    {

		/// <summary>
		/// UnityEngine.Renderer _renderer
		/// </summary>
		protected RUnityEngine.RRenderer r__renderer;
		public virtual RUnityEngine.RRenderer R_renderer
		{
			get
			{
				if(r__renderer == null)
				{
					r__renderer = new(this, "_renderer");
					r__renderer.SetBelong(this.instance);
				}
				return r__renderer;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Projector _projector
		/// </summary>
		protected RUnityEngine.RProjector r__projector;
		public virtual RUnityEngine.RProjector R_projector
		{
			get
			{
				if(r__projector == null)
				{
					r__projector = new(this, "_projector");
					r__projector.SetBelong(this.instance);
				}
				return r__projector;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RRenderer r_m_renderer;
		public virtual RUnityEngine.RRenderer Rm_renderer
		{
			get
			{
				if(r_m_renderer == null)
				{
					r_m_renderer = new(this, "m_renderer", -1);
					r_m_renderer.SetBelong(this.instance);
				}
				return r_m_renderer;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RProjector r_m_projector;
		public virtual RUnityEngine.RProjector Rm_projector
		{
			get
			{
				if(r_m_projector == null)
				{
					r_m_projector = new(this, "m_projector", -1);
					r_m_projector.SetBelong(this.instance);
				}
				return r_m_projector;
			}
		}
        ...
        public RProjectorMaterialAnimation() : base("ProjectorMaterialAnimation")
        {
        }

        public RProjectorMaterialAnimation(System.Object instance) : base("ProjectorMaterialAnimation")
		{
            SetInstance(instance);
		}

        public RProjectorMaterialAnimation(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RProjectorMaterialAnimation(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

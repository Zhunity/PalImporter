...
namespace SMFrame.Editor.Refleaction
{
	...
	/// </summary>
    public partial class RContrastStretchEffect : RMember //
    {

		/// <summary>
		/// System.Single adaptationSpeed
		/// </summary>
		protected RField r_adaptationSpeed;
		public virtual RField RadaptationSpeed
		{
			get
			{
				if(r_adaptationSpeed == null)
				{
					r_adaptationSpeed = new(this, "adaptationSpeed");
					r_adaptationSpeed.SetBelong(this.instance);
				}
				return r_adaptationSpeed;
			}
		}

		/// <summary>
		/// System.Single limitMinimum
		/// </summary>
		protected RField r_limitMinimum;
		public virtual RField RlimitMinimum
		{
			get
			{
				if(r_limitMinimum == null)
				{
					r_limitMinimum = new(this, "limitMinimum");
					r_limitMinimum.SetBelong(this.instance);
				}
				return r_limitMinimum;
			}
		}

		/// <summary>
		/// System.Single limitMaximum
		/// </summary>
		protected RField r_limitMaximum;
		public virtual RField RlimitMaximum
		{
			get
			{
				if(r_limitMaximum == null)
				{
					r_limitMaximum = new(this, "limitMaximum");
					r_limitMaximum.SetBelong(this.instance);
				}
				return r_limitMaximum;
			}
		}

		/// <summary>
		/// UnityEngine.RenderTexture[] adaptRenderTex
		/// </summary>
		protected RFieldArray<RUnityEngine.RRenderTexture> r_adaptRenderTex;
		public virtual RFieldArray<RUnityEngine.RRenderTexture> RadaptRenderTex
		{
			get
			{
				if(r_adaptRenderTex == null)
				{
					r_adaptRenderTex = new(this, "adaptRenderTex");
					r_adaptRenderTex.SetBelong(this.instance);
				}
				return r_adaptRenderTex;
			}
		}

		/// <summary>
		/// System.Int32 curAdaptIndex
		/// </summary>
		protected RField r_curAdaptIndex;
		public virtual RField RcurAdaptIndex
		{
			get
			{
				if(r_curAdaptIndex == null)
				{
					r_curAdaptIndex = new(this, "curAdaptIndex");
					r_curAdaptIndex.SetBelong(this.instance);
				}
				return r_curAdaptIndex;
			}
		}

		/// <summary>
		/// UnityEngine.Shader shaderLum
		/// </summary>
		protected RUnityEngine.RShader r_shaderLum;
		public virtual RUnityEngine.RShader RshaderLum
		{
			get
			{
				if(r_shaderLum == null)
				{
					r_shaderLum = new(this, "shaderLum");
					r_shaderLum.SetBelong(this.instance);
				}
				return r_shaderLum;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Material m_materialLum
		/// </summary>
		protected RUnityEngine.RMaterial r_m_materialLum;
		public virtual RUnityEngine.RMaterial Rm_materialLum
		{
			get
			{
				if(r_m_materialLum == null)
				{
					r_m_materialLum = new(this, "m_materialLum");
					r_m_materialLum.SetBelong(this.instance);
				}
				return r_m_materialLum;
			}
		}

		/// <summary>
		/// UnityEngine.Shader shaderReduce
		/// </summary>
		protected RUnityEngine.RShader r_shaderReduce;
		public virtual RUnityEngine.RShader RshaderReduce
		{
			get
			{
				if(r_shaderReduce == null)
				{
					r_shaderReduce = new(this, "shaderReduce");
					r_shaderReduce.SetBelong(this.instance);
				}
				return r_shaderReduce;
			}
		}

		/// <summary>
		/// UnityEngine.Material m_materialReduce
		/// </summary>
		protected RUnityEngine.RMaterial r_m_materialReduce;
		public virtual RUnityEngine.RMaterial Rm_materialReduce
		{
			get
			{
				if(r_m_materialReduce == null)
				{
					r_m_materialReduce = new(this, "m_materialReduce");
					r_m_materialReduce.SetBelong(this.instance);
				}
				return r_m_materialReduce;
			}
		}

		/// <summary>
		/// UnityEngine.Shader shaderAdapt
		/// </summary>
		protected RUnityEngine.RShader r_shaderAdapt;
		public virtual RUnityEngine.RShader RshaderAdapt
		{
			get
			{
				if(r_shaderAdapt == null)
				{
					r_shaderAdapt = new(this, "shaderAdapt");
					r_shaderAdapt.SetBelong(this.instance);
				}
				return r_shaderAdapt;
			}
		}

		/// <summary>
		/// UnityEngine.Material m_materialAdapt
		/// </summary>
		protected RUnityEngine.RMaterial r_m_materialAdapt;
		public virtual RUnityEngine.RMaterial Rm_materialAdapt
		{
			get
			{
				if(r_m_materialAdapt == null)
				{
					r_m_materialAdapt = new(this, "m_materialAdapt");
					r_m_materialAdapt.SetBelong(this.instance);
				}
				return r_m_materialAdapt;
			}
		}

		/// <summary>
		/// UnityEngine.Shader shaderApply
		/// </summary>
		protected RUnityEngine.RShader r_shaderApply;
		public virtual RUnityEngine.RShader RshaderApply
		{
			get
			{
				if(r_shaderApply == null)
				{
					r_shaderApply = new(this, "shaderApply");
					r_shaderApply.SetBelong(this.instance);
				}
				return r_shaderApply;
			}
		}

		/// <summary>
		/// UnityEngine.Material m_materialApply
		/// </summary>
		protected RUnityEngine.RMaterial r_m_materialApply;
		public virtual RUnityEngine.RMaterial Rm_materialApply
		{
			get
			{
				if(r_m_materialApply == null)
				{
					r_m_materialApply = new(this, "m_materialApply");
					r_m_materialApply.SetBelong(this.instance);
				}
				return r_m_materialApply;
			}
		}

		/// <summary>
		/// UnityEngine.Material materialLum
		/// </summary>
		protected RUnityEngine.RMaterial r_materialLum;
		public virtual RUnityEngine.RMaterial RmaterialLum
		{
			get
			{
				if(r_materialLum == null)
				{
					r_materialLum = new(this, "materialLum", -1);
					r_materialLum.SetBelong(this.instance);
				}
				return r_materialLum;
			}
		}

		/// <summary>
		/// UnityEngine.Material materialReduce
		/// </summary>
		protected RUnityEngine.RMaterial r_materialReduce;
		public virtual RUnityEngine.RMaterial RmaterialReduce
		{
			get
			{
				if(r_materialReduce == null)
				{
					r_materialReduce = new(this, "materialReduce", -1);
					r_materialReduce.SetBelong(this.instance);
				}
				return r_materialReduce;
			}
		}

		/// <summary>
		/// UnityEngine.Material materialAdapt
		/// </summary>
		protected RUnityEngine.RMaterial r_materialAdapt;
		public virtual RUnityEngine.RMaterial RmaterialAdapt
		{
			get
			{
				if(r_materialAdapt == null)
				{
					r_materialAdapt = new(this, "materialAdapt", -1);
					r_materialAdapt.SetBelong(this.instance);
				}
				return r_materialAdapt;
			}
		}

		/// <summary>
		/// UnityEngine.Material materialApply
		/// </summary>
		protected RUnityEngine.RMaterial r_materialApply;
		public virtual RUnityEngine.RMaterial RmaterialApply
		{
			get
			{
				if(r_materialApply == null)
				{
					r_materialApply = new(this, "materialApply", -1);
					r_materialApply.SetBelong(this.instance);
				}
				return r_materialApply;
			}
		}
		...
		/// <summary>
		/// Void CalculateAdaptation(UnityEngine.Texture)
		/// </summary>
		protected RMethod r_RCalculateAdaptation_Texture;
		public virtual RMethod RCalculateAdaptation_Texture
		{
			get
			{
				if(r_RCalculateAdaptation_Texture == null)
				{
					r_RCalculateAdaptation_Texture = new(this, "CalculateAdaptation", 0, typeof(UnityEngine.Texture));
					r_RCalculateAdaptation_Texture.SetBelong(this.instance);
				}
				return r_RCalculateAdaptation_Texture;
			}
		}
        ...
        public RContrastStretchEffect() : base("ContrastStretchEffect")
        {
        }

        public RContrastStretchEffect(System.Object instance) : base("ContrastStretchEffect")
		{
            SetInstance(instance);
		}

        public RContrastStretchEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RContrastStretchEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void CalculateAdaptation(UnityEngine.Texture  @curTexture)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@curTexture};
            var ___result = RCalculateAdaptation_Texture.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// EquipSuitXMLReader
	/// </summary>
    public partial class REquipSuitXMLReader : RMember //
    {
        ...
        public REquipSuitXMLReader() : base("EquipSuitXMLReader")
        {
        }

        public REquipSuitXMLReader(System.Object instance) : base("EquipSuitXMLReader")
		{
            SetInstance(instance);
		}

        public REquipSuitXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REquipSuitXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

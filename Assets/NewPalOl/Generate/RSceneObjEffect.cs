...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SceneObjEffect
	/// </summary>
    public partial class RSceneObjEffect : RMember //
    {
        ...
        public RSceneObjEffect() : base("SceneObjEffect")
        {
        }

        public RSceneObjEffect(System.Object instance) : base("SceneObjEffect")
		{
            SetInstance(instance);
		}

        public RSceneObjEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSceneObjEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.RAstarClasses
{
    ...
    public partial class RNode : RMember //
    {
		...
		/// <summary>
		/// AstarClasses.Int3 _parentx
		/// </summary>
		protected RAstarClasses.RInt3 r__parentx;
		public virtual RAstarClasses.RInt3 R_parentx
		{
			get
			{
				if(r__parentx == null)
				{
					r__parentx = new(this, "_parentx");
					r__parentx.SetBelong(this.instance);
				}
				return r__parentx;
			}
		}
		...
		/// <summary>
		/// AstarClasses.Int3 _parent
		/// </summary>
		protected RAstarClasses.RInt3 r__parent;
		public virtual RAstarClasses.RInt3 R_parent
		{
			get
			{
				if(r__parent == null)
		...
		/// </summary>
		protected RField r_stackCount;
		public virtual RField RstackCount
		{
			get
			{
				if(r_stackCount == null)
				{
					r_stackCount = new(this, "stackCount");
					r_stackCount.SetBelong(this.instance);
				}
				return r_stackCount;
			}
		}
		...
		/// <summary>
		/// Void UpdateAllG(Int32)
		/// </summary>
		protected RMethod r_RUpdateAllG_Int32;
		public virtual RMethod RUpdateAllG_Int32
		{
			get
			{
				if(r_RUpdateAllG_Int32 == null)
				{
					r_RUpdateAllG_Int32 = new(this, "UpdateAllG", 0, typeof(System.Int32));
					r_RUpdateAllG_Int32.SetBelong(this.instance);
				}
				return r_RUpdateAllG_Int32;
			}
		}
        ...
        public RNode() : base("AstarClasses.Node")
        {
        }

        public RNode(System.Object instance) : base("AstarClasses.Node")
		{
        ...
        public virtual void UpdateAllG(System.Int32  @parentG)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@parentG};
            var ___result = RUpdateAllG_Int32.Invoke(___genericsType, ___parameters);

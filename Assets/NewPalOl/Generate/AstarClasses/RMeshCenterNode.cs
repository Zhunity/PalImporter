...
{
	/// <summary>
	/// AstarClasses.MeshCenterNode
	/// </summary>
    public partial class RMeshCenterNode : RMember //
    {

		/// <summary>
		/// AstarProcess.Edge[] neighbourEdges
		/// </summary>
		protected RFieldArray<RAstarProcess.REdge> r_neighbourEdges;
		public virtual RFieldArray<RAstarProcess.REdge> RneighbourEdges
		{
			get
			{
				if(r_neighbourEdges == null)
				{
					r_neighbourEdges = new(this, "neighbourEdges");
					r_neighbourEdges.SetBelong(this.instance);
				}
				return r_neighbourEdges;
			}
		}
        ...
        public RMeshCenterNode() : base("AstarClasses.MeshCenterNode")
        {
        }

        public RMeshCenterNode(System.Object instance) : base("AstarClasses.MeshCenterNode")
		{
            SetInstance(instance);
		}

        public RMeshCenterNode(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMeshCenterNode(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{
	/// <summary>
	/// PetGiftGhostXMLReader
	/// </summary>
    public partial class RPetGiftGhostXMLReader : RMember //
    {
        ...
        public RPetGiftGhostXMLReader() : base("PetGiftGhostXMLReader")
        {
        }

        public RPetGiftGhostXMLReader(System.Object instance) : base("PetGiftGhostXMLReader")
		{
            SetInstance(instance);
		}

        public RPetGiftGhostXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPetGiftGhostXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

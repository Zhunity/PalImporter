...
namespace SMFrame.Editor.Refleaction
{
	...
	/// QulityManager
	/// </summary>
    public partial class RQulityManager : RMember //
    {
        ...
        public RQulityManager() : base("QulityManager")
        {
        }

        public RQulityManager(System.Object instance) : base("QulityManager")
		{
            SetInstance(instance);
		}

        public RQulityManager(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RQulityManager(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

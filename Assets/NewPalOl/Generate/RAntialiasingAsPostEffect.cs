...
namespace SMFrame.Editor.Refleaction
{
	...
	/// </summary>
    public partial class RAntialiasingAsPostEffect : RMember //
    {
		...
		/// <summary>
		/// System.Boolean showGeneratedNormals
		/// </summary>
		protected RField r_showGeneratedNormals;
		public virtual RField RshowGeneratedNormals
		{
			get
			{
				if(r_showGeneratedNormals == null)
				{
					r_showGeneratedNormals = new(this, "showGeneratedNormals");
					r_showGeneratedNormals.SetBelong(this.instance);
				}
				return r_showGeneratedNormals;
			}
		}

		/// <summary>
		/// System.Single offsetScale
		/// </summary>
		protected RField r_offsetScale;
		public virtual RField RoffsetScale
		{
			get
			{
				if(r_offsetScale == null)
				{
					r_offsetScale = new(this, "offsetScale");
					r_offsetScale.SetBelong(this.instance);
				}
				return r_offsetScale;
			}
		}
		...
		/// <summary>
		/// System.Boolean dlaaSharp
		/// </summary>
		protected RField r_dlaaSharp;
		public virtual RField RdlaaSharp
		{
			get
			{
				if(r_dlaaSharp == null)
				{
					r_dlaaSharp = new(this, "dlaaSharp");
					r_dlaaSharp.SetBelong(this.instance);
				}
				return r_dlaaSharp;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Shader ssaaShader
		/// </summary>
		protected RUnityEngine.RShader r_ssaaShader;
		public virtual RUnityEngine.RShader RssaaShader
		{
			get
			{
				if(r_ssaaShader == null)
				{
					r_ssaaShader = new(this, "ssaaShader");
					r_ssaaShader.SetBelong(this.instance);
				}
				return r_ssaaShader;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Material ssaa
		/// </summary>
		protected RUnityEngine.RMaterial r_ssaa;
		public virtual RUnityEngine.RMaterial Rssaa
		{
			get
			{
				if(r_ssaa == null)
				{
					r_ssaa = new(this, "ssaa");
					r_ssaa.SetBelong(this.instance);
				}
				return r_ssaa;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Shader dlaaShader
		/// </summary>
		protected RUnityEngine.RShader r_dlaaShader;
		public virtual RUnityEngine.RShader RdlaaShader
		{
			get
			{
				if(r_dlaaShader == null)
				{
					r_dlaaShader = new(this, "dlaaShader");
					r_dlaaShader.SetBelong(this.instance);
				}
				return r_dlaaShader;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Material dlaa
		/// </summary>
		protected RUnityEngine.RMaterial r_dlaa;
		public virtual RUnityEngine.RMaterial Rdlaa
		{
			get
			{
				if(r_dlaa == null)
				{
					r_dlaa = new(this, "dlaa");
					r_dlaa.SetBelong(this.instance);
				}
				return r_dlaa;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Shader nfaaShader
		/// </summary>
		protected RUnityEngine.RShader r_nfaaShader;
		public virtual RUnityEngine.RShader RnfaaShader
		{
			get
			{
				if(r_nfaaShader == null)
				{
					r_nfaaShader = new(this, "nfaaShader");
					r_nfaaShader.SetBelong(this.instance);
				}
				return r_nfaaShader;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Material nfaa
		/// </summary>
		protected RUnityEngine.RMaterial r_nfaa;
		public virtual RUnityEngine.RMaterial Rnfaa
		{
			get
			{
				if(r_nfaa == null)
				{
					r_nfaa = new(this, "nfaa");
					r_nfaa.SetBelong(this.instance);
				}
				return r_nfaa;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Shader shaderFXAAPreset2
		/// </summary>
		protected RUnityEngine.RShader r_shaderFXAAPreset2;
		public virtual RUnityEngine.RShader RshaderFXAAPreset2
		{
			get
			{
				if(r_shaderFXAAPreset2 == null)
				{
					r_shaderFXAAPreset2 = new(this, "shaderFXAAPreset2");
					r_shaderFXAAPreset2.SetBelong(this.instance);
				}
				return r_shaderFXAAPreset2;
			}
		}

		/// <summary>
		/// UnityEngine.Material materialFXAAPreset2
		/// </summary>
		protected RUnityEngine.RMaterial r_materialFXAAPreset2;
		public virtual RUnityEngine.RMaterial RmaterialFXAAPreset2
		{
			get
			{
				if(r_materialFXAAPreset2 == null)
				{
					r_materialFXAAPreset2 = new(this, "materialFXAAPreset2");
					r_materialFXAAPreset2.SetBelong(this.instance);
				}
				return r_materialFXAAPreset2;
			}
		}

		/// <summary>
		/// UnityEngine.Shader shaderFXAAPreset3
		/// </summary>
		protected RUnityEngine.RShader r_shaderFXAAPreset3;
		public virtual RUnityEngine.RShader RshaderFXAAPreset3
		{
			get
			{
				if(r_shaderFXAAPreset3 == null)
				{
					r_shaderFXAAPreset3 = new(this, "shaderFXAAPreset3");
					r_shaderFXAAPreset3.SetBelong(this.instance);
				}
				return r_shaderFXAAPreset3;
			}
		}

		/// <summary>
		/// UnityEngine.Material materialFXAAPreset3
		/// </summary>
		protected RUnityEngine.RMaterial r_materialFXAAPreset3;
		public virtual RUnityEngine.RMaterial RmaterialFXAAPreset3
		{
			get
			{
				if(r_materialFXAAPreset3 == null)
				{
					r_materialFXAAPreset3 = new(this, "materialFXAAPreset3");
					r_materialFXAAPreset3.SetBelong(this.instance);
				}
				return r_materialFXAAPreset3;
			}
		}

		/// <summary>
		/// UnityEngine.Shader shaderFXAAII
		/// </summary>
		protected RUnityEngine.RShader r_shaderFXAAII;
		public virtual RUnityEngine.RShader RshaderFXAAII
		{
			get
			{
				if(r_shaderFXAAII == null)
				{
					r_shaderFXAAII = new(this, "shaderFXAAII");
					r_shaderFXAAII.SetBelong(this.instance);
				}
				return r_shaderFXAAII;
			}
		}

		/// <summary>
		/// UnityEngine.Material materialFXAAII
		/// </summary>
		protected RUnityEngine.RMaterial r_materialFXAAII;
		public virtual RUnityEngine.RMaterial RmaterialFXAAII
		{
			get
			{
				if(r_materialFXAAII == null)
				{
					r_materialFXAAII = new(this, "materialFXAAII");
					r_materialFXAAII.SetBelong(this.instance);
				}
				return r_materialFXAAII;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Material CheckShaderAndCreateMaterial(UnityEngine.Shader, UnityEngine.Material)
		/// </summary>
		protected RMethod r_RCheckShaderAndCreateMaterial_Shader_Material;
		public virtual RMethod RCheckShaderAndCreateMaterial_Shader_Material
		{
			get
			{
				if(r_RCheckShaderAndCreateMaterial_Shader_Material == null)
				{
					r_RCheckShaderAndCreateMaterial_Shader_Material = new(this, "CheckShaderAndCreateMaterial", 0, typeof(UnityEngine.Shader), typeof(UnityEngine.Material));
					r_RCheckShaderAndCreateMaterial_Shader_Material.SetBelong(this.instance);
				}
				return r_RCheckShaderAndCreateMaterial_Shader_Material;
			}
		}
        ...
        public RAntialiasingAsPostEffect() : base("AntialiasingAsPostEffect")
        {
        }

        public RAntialiasingAsPostEffect(System.Object instance) : base("AntialiasingAsPostEffect")
		{
            SetInstance(instance);
		}

        public RAntialiasingAsPostEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAntialiasingAsPostEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual UnityEngine.Material CheckShaderAndCreateMaterial(UnityEngine.Shader  @s, UnityEngine.Material  @m2Create)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@s, @m2Create};
            var ___result = RCheckShaderAndCreateMaterial_Shader_Material.Invoke(___genericsType, ___parameters);

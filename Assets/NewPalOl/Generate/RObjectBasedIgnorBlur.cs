...
{
	/// <summary>
	/// ObjectBasedIgnorBlur
	/// </summary>
    public partial class RObjectBasedIgnorBlur : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RCamera r__targetCamera;
		public virtual RUnityEngine.RCamera R_targetCamera
		{
			get
			{
				if(r__targetCamera == null)
				{
					r__targetCamera = new(this, "_targetCamera");
					r__targetCamera.SetBelong(this.instance);
				}
				return r__targetCamera;
			}
		}
		...
		/// </summary>
		protected RBlurEffect r__blurEffect;
		public virtual RBlurEffect R_blurEffect
		{
			get
			{
				if(r__blurEffect == null)
				{
					r__blurEffect = new(this, "_blurEffect");
					r__blurEffect.SetBelong(this.instance);
				}
				return r__blurEffect;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RCamera r_targetCamera;
		public virtual RUnityEngine.RCamera RtargetCamera
		{
			get
			{
				if(r_targetCamera == null)
				{
					r_targetCamera = new(this, "targetCamera", -1);
					r_targetCamera.SetBelong(this.instance);
				}
				return r_targetCamera;
			}
		}
		...
		/// </summary>
		protected RBlurEffect r_blurEffect;
		public virtual RBlurEffect RblurEffect
		{
			get
			{
				if(r_blurEffect == null)
				{
					r_blurEffect = new(this, "blurEffect", -1);
					r_blurEffect.SetBelong(this.instance);
				}
				return r_blurEffect;
			}
		}
        ...
        public RObjectBasedIgnorBlur() : base("ObjectBasedIgnorBlur")
        {
        }

        public RObjectBasedIgnorBlur(System.Object instance) : base("ObjectBasedIgnorBlur")
		{
            SetInstance(instance);
		}

        public RObjectBasedIgnorBlur(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RObjectBasedIgnorBlur(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

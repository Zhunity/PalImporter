...
namespace SMFrame.Editor.Refleaction
{
	...
	/// UVScroller
	/// </summary>
    public partial class RUVScroller : RMember //
    {
        ...
        public RUVScroller() : base("UVScroller")
        {
        }

        public RUVScroller(System.Object instance) : base("UVScroller")
		{
            SetInstance(instance);
		}

        public RUVScroller(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RUVScroller(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

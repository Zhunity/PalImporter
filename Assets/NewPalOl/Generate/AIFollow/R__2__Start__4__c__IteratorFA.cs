...
{public partial class RAIFollow
{
	...
	/// <summary>
	/// AIFollow+<Start>c__IteratorFA
	/// </summary>
    public partial class R__2__Start__4__c__IteratorFA : RMember //
    {
        ...
        public R__2__Start__4__c__IteratorFA() : base("AIFollow+<Start>c__IteratorFA")
        {
        }

        public R__2__Start__4__c__IteratorFA(System.Object instance) : base("AIFollow+<Start>c__IteratorFA")
		{
            SetInstance(instance);
		}

        public R__2__Start__4__c__IteratorFA(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__Start__4__c__IteratorFA(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

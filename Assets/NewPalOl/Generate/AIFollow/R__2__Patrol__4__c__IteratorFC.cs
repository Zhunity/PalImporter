...
{public partial class RAIFollow
{
	
	/// <summary>
	/// AIFollow+<Patrol>c__IteratorFC
	/// </summary>
    public partial class R__2__Patrol__4__c__IteratorFC : RMember //
    {
		...
		/// AIFollow <>f__this
		/// </summary>
		protected RAIFollow r___2____4__f__this;
		public virtual RAIFollow R__2____4__f__this
		{
			get
			{
        ...
        public R__2__Patrol__4__c__IteratorFC() : base("AIFollow+<Patrol>c__IteratorFC")
        {
        }

        public R__2__Patrol__4__c__IteratorFC(System.Object instance) : base("AIFollow+<Patrol>c__IteratorFC")
		{
            SetInstance(instance);
		}

        public R__2__Patrol__4__c__IteratorFC(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__Patrol__4__c__IteratorFC(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{
	/// <summary>
	/// NPCCreateInfoXMLReader
	/// </summary>
    public partial class RNPCCreateInfoXMLReader : RMember //
    {
        ...
        public RNPCCreateInfoXMLReader() : base("NPCCreateInfoXMLReader")
        {
        }

        public RNPCCreateInfoXMLReader(System.Object instance) : base("NPCCreateInfoXMLReader")
		{
            SetInstance(instance);
		}

        public RNPCCreateInfoXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RNPCCreateInfoXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

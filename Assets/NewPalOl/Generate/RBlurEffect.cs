...
namespace SMFrame.Editor.Refleaction
{
	...
	/// BlurEffect
	/// </summary>
    public partial class RBlurEffect : RMember //
    {
		...
		public static RField RblurMatString
		{
			get
			{
				...
				{
					r_blurMatString = new( ReleactionUtils.GetType("BlurEffect"), "blurMatString");
		...
		/// </summary>
		protected static RUnityEngine.RMaterial r_m_Material;
		public static RUnityEngine.RMaterial Rm_Material
		{
			get
			{
				if(r_m_Material == null)
				{
					r_m_Material = new( ReleactionUtils.GetType("BlurEffect"), "m_Material");
					r_m_Material.SetBelong(null);
				}
				return r_m_Material;
			}
		}
		...
		/// </summary>
		protected static RUnityEngine.RMaterial r_material;
		public static RUnityEngine.RMaterial Rmaterial
		{
			get
			{
				if(r_material == null)
				{
					r_material = new( ReleactionUtils.GetType("BlurEffect"), "material", -1);
					r_material.SetBelong(null);
				}
				return r_material;
			}
		}
        ...
        public RBlurEffect() : base("BlurEffect")
        {
        }

        public RBlurEffect(System.Object instance) : base("BlurEffect")
		{
            SetInstance(instance);
		}

        public RBlurEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBlurEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

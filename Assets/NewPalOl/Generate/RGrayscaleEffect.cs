...
namespace SMFrame.Editor.Refleaction
{
	...
	/// GrayscaleEffect
	/// </summary>
    public partial class RGrayscaleEffect : RMember //
    {

		/// <summary>
		/// UnityEngine.Texture textureRamp
		/// </summary>
		protected RUnityEngine.RTexture r_textureRamp;
		public virtual RUnityEngine.RTexture RtextureRamp
		{
			get
			{
				if(r_textureRamp == null)
				{
					r_textureRamp = new(this, "textureRamp");
					r_textureRamp.SetBelong(this.instance);
				}
				return r_textureRamp;
			}
		}

		/// <summary>
		/// System.Single rampOffset
		/// </summary>
		protected RField r_rampOffset;
		public virtual RField RrampOffset
		{
			get
			{
				if(r_rampOffset == null)
				{
					r_rampOffset = new(this, "rampOffset");
					r_rampOffset.SetBelong(this.instance);
				}
				return r_rampOffset;
			}
		}
		...
		/// <summary>
		/// System.Single effectAmount
		/// </summary>
		protected RField r_effectAmount;
		public virtual RField ReffectAmount
		{
			get
			{
				if(r_effectAmount == null)
				{
					r_effectAmount = new(this, "effectAmount");
					r_effectAmount.SetBelong(this.instance);
				}
				return r_effectAmount;
			}
		}
        ...
        public RGrayscaleEffect() : base("GrayscaleEffect")
        {
        }

        public RGrayscaleEffect(System.Object instance) : base("GrayscaleEffect")
		{
            SetInstance(instance);
		}

        public RGrayscaleEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RGrayscaleEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

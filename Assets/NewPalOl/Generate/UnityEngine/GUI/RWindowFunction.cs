...
{public partial class RGUI
{
	...
	/// </summary>
    public partial class RWindowFunction : RMember //
    {
        ...
        public RWindowFunction() : base("UnityEngine.GUI+WindowFunction")
        {
        }

        public RWindowFunction(System.Object instance) : base("UnityEngine.GUI+WindowFunction")
		{
            SetInstance(instance);
		}

        public RWindowFunction(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RWindowFunction(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Int32  @id)
        {
        ...
        public virtual System.IAsyncResult BeginInvoke(System.Int32  @id, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id, @callback, @object};

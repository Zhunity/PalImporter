...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
	...
	/// </summary>
    public partial class RCollider : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RRigidbody r_attachedRigidbody;
		public virtual RUnityEngine.RRigidbody RattachedRigidbody
		{
			get
			{
				if(r_attachedRigidbody == null)
				{
					r_attachedRigidbody = new(this, "attachedRigidbody", -1);
					r_attachedRigidbody.SetBelong(this.instance);
				}
				return r_attachedRigidbody;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RArticulationBody r_attachedArticulationBody;
		public virtual RUnityEngine.RArticulationBody RattachedArticulationBody
		{
			get
			{
				if(r_attachedArticulationBody == null)
				{
					r_attachedArticulationBody = new(this, "attachedArticulationBody", -1);
					r_attachedArticulationBody.SetBelong(this.instance);
				}
				return r_attachedArticulationBody;
			}
		}
		...
		/// Boolean isTrigger
		/// </summary>
		protected RProperty r_isTrigger;
		public virtual RProperty RisTrigger
		{
			get
			{
				if(r_isTrigger == null)
				{
					r_isTrigger = new(this, "isTrigger", -1);
					r_isTrigger.SetBelong(this.instance);
				}
				return r_isTrigger;
			}
		}
		...
		/// </summary>
		protected RProperty r_contactOffset;
		public virtual RProperty RcontactOffset
		{
			get
			{
				if(r_contactOffset == null)
				{
					r_contactOffset = new(this, "contactOffset", -1);
					r_contactOffset.SetBelong(this.instance);
				}
				return r_contactOffset;
			}
		}
		...
		/// </summary>
		protected RProperty r_hasModifiableContacts;
		public virtual RProperty RhasModifiableContacts
		{
			get
			{
				if(r_hasModifiableContacts == null)
				{
					r_hasModifiableContacts = new(this, "hasModifiableContacts", -1);
					r_hasModifiableContacts.SetBelong(this.instance);
				}
				return r_hasModifiableContacts;
			}
		}
		...
		/// </summary>
		protected RProperty r_providesContacts;
		public virtual RProperty RprovidesContacts
		{
			get
			{
				if(r_providesContacts == null)
				{
					r_providesContacts = new(this, "providesContacts", -1);
					r_providesContacts.SetBelong(this.instance);
				}
				return r_providesContacts;
			}
		}
		...
		/// </summary>
		protected RProperty r_layerOverridePriority;
		public virtual RProperty RlayerOverridePriority
		{
			get
			{
				if(r_layerOverridePriority == null)
				{
					r_layerOverridePriority = new(this, "layerOverridePriority", -1);
					r_layerOverridePriority.SetBelong(this.instance);
				}
				return r_layerOverridePriority;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RPhysicMaterial r_sharedMaterial;
		public virtual RUnityEngine.RPhysicMaterial RsharedMaterial
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RPhysicMaterial r_material;
		public virtual RUnityEngine.RPhysicMaterial Rmaterial
		{
			get
			{
				if(r_material == null)
		...
		/// <summary>
		/// UnityEngine.RaycastHit Raycast(UnityEngine.Ray, Single, Boolean ByRef)
		/// </summary>
		protected RMethod r_RRaycast_Ray_Single_Ref_Boolean;
		public virtual RMethod RRaycast_Ray_Single_Ref_Boolean
		{
			get
			{
				if(r_RRaycast_Ray_Single_Ref_Boolean == null)
				{
					r_RRaycast_Ray_Single_Ref_Boolean = new(this, "Raycast", 0, typeof(UnityEngine.Ray), typeof(System.Single), typeof(System.Boolean).MakeByRefType());
					r_RRaycast_Ray_Single_Ref_Boolean.SetBelong(this.instance);
				}
				return r_RRaycast_Ray_Single_Ref_Boolean;
			}
		}
		...
		/// </summary>
		protected RMethod r_RRaycast_Ray_Out_RaycastHit_Single;
		public virtual RMethod RRaycast_Ray_Out_RaycastHit_Single
		{
			get
			{
				if(r_RRaycast_Ray_Out_RaycastHit_Single == null)
				{
					r_RRaycast_Ray_Out_RaycastHit_Single = new(this, "Raycast", 0, typeof(UnityEngine.Ray), typeof(UnityEngine.RaycastHit).MakeByRefType(), typeof(System.Single));
					r_RRaycast_Ray_Out_RaycastHit_Single.SetBelong(this.instance);
				}
				return r_RRaycast_Ray_Out_RaycastHit_Single;
			}
		}
		...
		/// <summary>
		/// Void ClosestPoint_Injected(UnityEngine.Vector3 ByRef, UnityEngine.Vector3 ByRef)
		/// </summary>
		protected RMethod r_RClosestPoint_Injected_Ref_Vector3_Out_Vector3;
		public virtual RMethod RClosestPoint_Injected_Ref_Vector3_Out_Vector3
		{
			get
			{
				if(r_RClosestPoint_Injected_Ref_Vector3_Out_Vector3 == null)
				{
					r_RClosestPoint_Injected_Ref_Vector3_Out_Vector3 = new(this, "ClosestPoint_Injected", 0, typeof(UnityEngine.Vector3).MakeByRefType(), typeof(UnityEngine.Vector3).MakeByRefType());
					r_RClosestPoint_Injected_Ref_Vector3_Out_Vector3.SetBelong(this.instance);
				}
				return r_RClosestPoint_Injected_Ref_Vector3_Out_Vector3;
			}
		}
		...
		/// <summary>
		/// Void Raycast_Injected(UnityEngine.Ray ByRef, Single, Boolean ByRef, UnityEngine.RaycastHit ByRef)
		/// </summary>
		protected RMethod r_RRaycast_Injected_Ref_Ray_Single_Ref_Boolean_Out_RaycastHit;
		public virtual RMethod RRaycast_Injected_Ref_Ray_Single_Ref_Boolean_Out_RaycastHit
		{
			get
			{
				if(r_RRaycast_Injected_Ref_Ray_Single_Ref_Boolean_Out_RaycastHit == null)
				{
					r_RRaycast_Injected_Ref_Ray_Single_Ref_Boolean_Out_RaycastHit = new(this, "Raycast_Injected", 0, typeof(UnityEngine.Ray).MakeByRefType(), typeof(System.Single), typeof(System.Boolean).MakeByRefType(), typeof(UnityEngine.RaycastHit).MakeByRefType());
					r_RRaycast_Injected_Ref_Ray_Single_Ref_Boolean_Out_RaycastHit.SetBelong(this.instance);
				}
				return r_RRaycast_Injected_Ref_Ray_Single_Ref_Boolean_Out_RaycastHit;
			}
		}
        ...
        public RCollider() : base("UnityEngine.Collider")
        {
        }

        public RCollider(System.Object instance) : base("UnityEngine.Collider")
		{
            SetInstance(instance);
		}

        public RCollider(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCollider(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual UnityEngine.Vector3 ClosestPoint(UnityEngine.Vector3  @position)
        {
        ...
        public virtual UnityEngine.RaycastHit Raycast(UnityEngine.Ray  @ray, System.Single  @maxDistance, ref System.Boolean  @hasHit)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@ray, @maxDistance, @hasHit};
            var ___result = RRaycast_Ray_Single_Ref_Boolean.Invoke(___genericsType, ___parameters);
			hasHit = (System.Boolean)___parameters[2];

            return (UnityEngine.RaycastHit)___result;
        }


        public virtual System.Boolean Raycast(UnityEngine.Ray  @ray, out UnityEngine.RaycastHit  @hitInfo, System.Single  @maxDistance)
        {
			hitInfo = default;

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@ray, @hitInfo, @maxDistance};
            var ___result = RRaycast_Ray_Out_RaycastHit_Single.Invoke(___genericsType, ___parameters);
        ...
        public virtual void ClosestPoint_Injected(ref UnityEngine.Vector3  @position, out UnityEngine.Vector3  @ret)
        {
			ret = default;

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@position, @ret};
            var ___result = RClosestPoint_Injected_Ref_Vector3_Out_Vector3.Invoke(___genericsType, ___parameters);
        ...
        public virtual void Raycast_Injected(ref UnityEngine.Ray  @ray, System.Single  @maxDistance, ref System.Boolean  @hasHit, out UnityEngine.RaycastHit  @ret)
        {
			ret = default;

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@ray, @maxDistance, @hasHit, @ret};
            var ___result = RRaycast_Injected_Ref_Ray_Single_Ref_Boolean_Out_RaycastHit.Invoke(___genericsType, ___parameters);
			ray = (UnityEngine.Ray)___parameters[0];
			hasHit = (System.Boolean)___parameters[2];
			ret = (UnityEngine.RaycastHit)___parameters[3];

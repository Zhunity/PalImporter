...
{public partial class RAudioClip
{
	...
	/// </summary>
    public partial class RPCMSetPositionCallback : RMember //
    {
        ...
        public RPCMSetPositionCallback() : base("UnityEngine.AudioClip+PCMSetPositionCallback")
        {
        }

        public RPCMSetPositionCallback(System.Object instance) : base("UnityEngine.AudioClip+PCMSetPositionCallback")
		{
            SetInstance(instance);
		}

        public RPCMSetPositionCallback(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPCMSetPositionCallback(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Int32  @position)
        {
        ...
        public virtual System.IAsyncResult BeginInvoke(System.Int32  @position, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@position, @callback, @object};

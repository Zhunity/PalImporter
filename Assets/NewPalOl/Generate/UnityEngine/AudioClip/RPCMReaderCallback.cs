...
{public partial class RAudioClip
{
	
	/// <summary>
	/// UnityEngine.AudioClip+PCMReaderCallback
	/// </summary>
    public partial class RPCMReaderCallback : RMember //
    {
		...
		/// Void Invoke(Single[])
		/// </summary>
		protected RMethod r_RInvoke_SingleArray;
		public virtual RMethod RInvoke_SingleArray
		{
			get
			{
				if(r_RInvoke_SingleArray == null)
				{
					r_RInvoke_SingleArray = new(this, "Invoke", 0, typeof(System.Single).MakeArrayType());
					r_RInvoke_SingleArray.SetBelong(this.instance);
				}
				return r_RInvoke_SingleArray;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(Single[], System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_SingleArray_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_SingleArray_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_SingleArray_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_SingleArray_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Single).MakeArrayType(), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_SingleArray_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_SingleArray_AsyncCallback_Object;
			}
		}
        ...
        public RPCMReaderCallback() : base("UnityEngine.AudioClip+PCMReaderCallback")
        {
        }

        public RPCMReaderCallback(System.Object instance) : base("UnityEngine.AudioClip+PCMReaderCallback")
		{
            SetInstance(instance);
		}

        public RPCMReaderCallback(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPCMReaderCallback(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Single[]  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@data};
            var ___result = RInvoke_SingleArray.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.Single[]  @data, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@data, @callback, @object};
            var ___result = RBeginInvoke_SingleArray_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

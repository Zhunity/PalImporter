...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
	...
	/// </summary>
    public partial class RBoxCollider : RMember //
    {
        ...
        public RBoxCollider() : base("UnityEngine.BoxCollider")
        {
        }

        public RBoxCollider(System.Object instance) : base("UnityEngine.BoxCollider")
		{
            SetInstance(instance);
		}

        public RBoxCollider(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBoxCollider(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
	...
	/// </summary>
    public partial class RMeshFilter : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RDontStripMeshFilter;
		public virtual RMethod RDontStripMeshFilter
		{
			get
			{
				if(r_RDontStripMeshFilter == null)
				{
					r_RDontStripMeshFilter = new(this, "DontStripMeshFilter", 0);
					r_RDontStripMeshFilter.SetBelong(this.instance);
				}
				return r_RDontStripMeshFilter;
			}
		}
        ...
        public RMeshFilter() : base("UnityEngine.MeshFilter")
        {
        }

        public RMeshFilter(System.Object instance) : base("UnityEngine.MeshFilter")
		{
            SetInstance(instance);
		}

        public RMeshFilter(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMeshFilter(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void DontStripMeshFilter()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RDontStripMeshFilter.Invoke(___genericsType, ___parameters);

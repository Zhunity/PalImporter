...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
	...
	/// </summary>
    public partial class RSphereCollider : RMember //
    {
		...
		/// Single radius
		/// </summary>
		protected RProperty r_radius;
		public virtual RProperty Rradius
		{
			get
			{
				if(r_radius == null)
        ...
        public RSphereCollider() : base("UnityEngine.SphereCollider")
        {
        }

        public RSphereCollider(System.Object instance) : base("UnityEngine.SphereCollider")
		{
            SetInstance(instance);
		}

        public RSphereCollider(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSphereCollider(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
	...
	/// </summary>
    public partial class RMeshCollider : RMember //
    {
		...
		/// Boolean convex
		/// </summary>
		protected RProperty r_convex;
		public virtual RProperty Rconvex
		{
			get
			{
				if(r_convex == null)
				{
					r_convex = new(this, "convex", -1);
					r_convex.SetBelong(this.instance);
				}
				return r_convex;
			}
		}
		...
		/// </summary>
		protected RProperty r_cookingOptions;
		public virtual RProperty RcookingOptions
		{
			get
			{
				if(r_cookingOptions == null)
				{
					r_cookingOptions = new(this, "cookingOptions", -1);
					r_cookingOptions.SetBelong(this.instance);
				}
				return r_cookingOptions;
			}
		}

		/// <summary>
		/// Boolean smoothSphereCollisions
		/// </summary>
		protected RProperty r_smoothSphereCollisions;
		public virtual RProperty RsmoothSphereCollisions
		{
			get
			{
				if(r_smoothSphereCollisions == null)
				{
					r_smoothSphereCollisions = new(this, "smoothSphereCollisions", -1);
					r_smoothSphereCollisions.SetBelong(this.instance);
				}
				return r_smoothSphereCollisions;
			}
		}
		...
		/// Single skinWidth
		/// </summary>
		protected RProperty r_skinWidth;
		public virtual RProperty RskinWidth
		{
			get
			{
				if(r_skinWidth == null)
				{
					r_skinWidth = new(this, "skinWidth", -1);
					r_skinWidth.SetBelong(this.instance);
				}
				return r_skinWidth;
			}
		}
		...
		/// Boolean inflateMesh
		/// </summary>
		protected RProperty r_inflateMesh;
		public virtual RProperty RinflateMesh
		{
			get
			{
				if(r_inflateMesh == null)
				{
					r_inflateMesh = new(this, "inflateMesh", -1);
					r_inflateMesh.SetBelong(this.instance);
				}
				return r_inflateMesh;
			}
		}
        ...
        public RMeshCollider() : base("UnityEngine.MeshCollider")
        {
        }

        public RMeshCollider(System.Object instance) : base("UnityEngine.MeshCollider")
		{
            SetInstance(instance);
		}

        public RMeshCollider(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMeshCollider(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

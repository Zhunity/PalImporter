...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
	...
	/// </summary>
    public partial class RMeshRenderer : RMember //
    {

		/// <summary>
		/// UnityEngine.Mesh additionalVertexStreams
		/// </summary>
		protected RUnityEngine.RMesh r_additionalVertexStreams;
		public virtual RUnityEngine.RMesh RadditionalVertexStreams
		{
			get
			{
				if(r_additionalVertexStreams == null)
				{
					r_additionalVertexStreams = new(this, "additionalVertexStreams", -1);
					r_additionalVertexStreams.SetBelong(this.instance);
				}
				return r_additionalVertexStreams;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RMesh r_enlightenVertexStream;
		public virtual RUnityEngine.RMesh RenlightenVertexStream
		{
			get
			{
				if(r_enlightenVertexStream == null)
				{
					r_enlightenVertexStream = new(this, "enlightenVertexStream", -1);
					r_enlightenVertexStream.SetBelong(this.instance);
				}
				return r_enlightenVertexStream;
			}
		}
		...
		/// </summary>
		protected RProperty r_subMeshStartIndex;
		public virtual RProperty RsubMeshStartIndex
		{
			get
			{
				if(r_subMeshStartIndex == null)
				{
					r_subMeshStartIndex = new(this, "subMeshStartIndex", -1);
					r_subMeshStartIndex.SetBelong(this.instance);
				}
				return r_subMeshStartIndex;
			}
		}

		/// <summary>
		/// Single scaleInLightmap
		/// </summary>
		protected RProperty r_scaleInLightmap;
		public virtual RProperty RscaleInLightmap
		{
			get
			{
				if(r_scaleInLightmap == null)
				{
					r_scaleInLightmap = new(this, "scaleInLightmap", -1);
					r_scaleInLightmap.SetBelong(this.instance);
				}
				return r_scaleInLightmap;
			}
		}
		...
		/// </summary>
		protected RProperty r_receiveGI;
		public virtual RProperty RreceiveGI
		{
			get
			{
				if(r_receiveGI == null)
				{
					r_receiveGI = new(this, "receiveGI", -1);
					r_receiveGI.SetBelong(this.instance);
				}
				return r_receiveGI;
			}
		}
		...
		/// <summary>
		/// Boolean stitchLightmapSeams
		/// </summary>
		protected RProperty r_stitchLightmapSeams;
		public virtual RProperty RstitchLightmapSeams
		{
			get
			{
				if(r_stitchLightmapSeams == null)
				{
					r_stitchLightmapSeams = new(this, "stitchLightmapSeams", -1);
					r_stitchLightmapSeams.SetBelong(this.instance);
				}
				return r_stitchLightmapSeams;
			}
		}
		...
		/// </summary>
		protected RMethod r_RDontStripMeshRenderer;
		public virtual RMethod RDontStripMeshRenderer
		{
			get
			{
				if(r_RDontStripMeshRenderer == null)
				{
					r_RDontStripMeshRenderer = new(this, "DontStripMeshRenderer", 0);
					r_RDontStripMeshRenderer.SetBelong(this.instance);
				}
				return r_RDontStripMeshRenderer;
			}
		}
        ...
        public RMeshRenderer() : base("UnityEngine.MeshRenderer")
        {
        }

        public RMeshRenderer(System.Object instance) : base("UnityEngine.MeshRenderer")
		{
            SetInstance(instance);
		}

        public RMeshRenderer(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMeshRenderer(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void DontStripMeshRenderer()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RDontStripMeshRenderer.Invoke(___genericsType, ___parameters);

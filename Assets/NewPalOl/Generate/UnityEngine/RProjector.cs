...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
	...
	/// </summary>
    public partial class RProjector : RMember //
    {
		...
		/// Int32 ignoreLayers
		/// </summary>
		protected RProperty r_ignoreLayers;
		public virtual RProperty RignoreLayers
		{
			get
			{
				if(r_ignoreLayers == null)
				{
					r_ignoreLayers = new(this, "ignoreLayers", -1);
					r_ignoreLayers.SetBelong(this.instance);
				}
				return r_ignoreLayers;
			}
		}
        ...
        public RProjector() : base("UnityEngine.Projector")
        {
        }

        public RProjector(System.Object instance) : base("UnityEngine.Projector")
		{
            SetInstance(instance);
		}

        public RProjector(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RProjector(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

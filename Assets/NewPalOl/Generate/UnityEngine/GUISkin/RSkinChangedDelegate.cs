...
{public partial class RGUISkin
{
	
	/// <summary>
	/// UnityEngine.GUISkin+SkinChangedDelegate
	/// </summary>
    public partial class RSkinChangedDelegate : RMember //
    {
        ...
        public RSkinChangedDelegate() : base("UnityEngine.GUISkin+SkinChangedDelegate")
        {
        }

        public RSkinChangedDelegate(System.Object instance) : base("UnityEngine.GUISkin+SkinChangedDelegate")
		{
            SetInstance(instance);
		}

        public RSkinChangedDelegate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSkinChangedDelegate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

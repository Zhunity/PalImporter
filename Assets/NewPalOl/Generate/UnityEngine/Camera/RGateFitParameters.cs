...
{public partial class RCamera
{
    ...
    public partial class RGateFitParameters : RMember //
    {
		...
		/// </summary>
		protected RField r___2__mode__4__k__BackingField;
		public virtual RField R__2__mode__4__k__BackingField
		{
			get
			{
				if(r___2__mode__4__k__BackingField == null)
				{
					r___2__mode__4__k__BackingField = new(this, "<mode>k__BackingField");
					r___2__mode__4__k__BackingField.SetBelong(this.instance);
				}
				return r___2__mode__4__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RField r___2__aspect__4__k__BackingField;
		public virtual RField R__2__aspect__4__k__BackingField
		{
			get
			{
				if(r___2__aspect__4__k__BackingField == null)
				{
					r___2__aspect__4__k__BackingField = new(this, "<aspect>k__BackingField");
					r___2__aspect__4__k__BackingField.SetBelong(this.instance);
				}
				return r___2__aspect__4__k__BackingField;
			}
		}

...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
	...
	/// </summary>
    public partial class RAudioListener : RMember //
    {

		/// <summary>
		/// Single volume
		/// </summary>
		protected static RProperty r_volume;
		public static RProperty Rvolume
		{
			get
			{
				if(r_volume == null)
				{
					r_volume = new(typeof(UnityEngine.AudioListener), "volume", -1);
					r_volume.SetBelong(null);
				}
				return r_volume;
			}
		}
		...
		/// Boolean pause
		/// </summary>
		protected static RProperty r_pause;
		public static RProperty Rpause
		{
			get
			{
				if(r_pause == null)
				{
					r_pause = new(typeof(UnityEngine.AudioListener), "pause", -1);
					r_pause.SetBelong(null);
				}
				return r_pause;
			}
		}
		...
		/// <summary>
		/// Void GetOutputDataHelper(Single[], Int32)
		/// </summary>
		protected static RMethod r_RGetOutputDataHelper_SingleArray_Int32;
		public static RMethod RGetOutputDataHelper_SingleArray_Int32
		{
			get
			{
				if(r_RGetOutputDataHelper_SingleArray_Int32 == null)
				{
					r_RGetOutputDataHelper_SingleArray_Int32 = new(typeof(UnityEngine.AudioListener), "GetOutputDataHelper", 0, typeof(System.Single).MakeArrayType(), typeof(System.Int32));
					r_RGetOutputDataHelper_SingleArray_Int32.SetBelong(null);
				}
				return r_RGetOutputDataHelper_SingleArray_Int32;
			}
		}

		/// <summary>
		/// Void GetSpectrumDataHelper(Single[], Int32, UnityEngine.FFTWindow)
		/// </summary>
		protected static RMethod r_RGetSpectrumDataHelper_SingleArray_Int32_FFTWindow;
		public static RMethod RGetSpectrumDataHelper_SingleArray_Int32_FFTWindow
		{
			get
			{
				if(r_RGetSpectrumDataHelper_SingleArray_Int32_FFTWindow == null)
				{
					r_RGetSpectrumDataHelper_SingleArray_Int32_FFTWindow = new(typeof(UnityEngine.AudioListener), "GetSpectrumDataHelper", 0, typeof(System.Single).MakeArrayType(), typeof(System.Int32), typeof(UnityEngine.FFTWindow));
					r_RGetSpectrumDataHelper_SingleArray_Int32_FFTWindow.SetBelong(null);
				}
				return r_RGetSpectrumDataHelper_SingleArray_Int32_FFTWindow;
			}
		}
		...
		/// </summary>
		protected static RMethod r_RGetOutputData_Int32_Int32;
		public static RMethod RGetOutputData_Int32_Int32
		{
			get
			{
				if(r_RGetOutputData_Int32_Int32 == null)
				{
					r_RGetOutputData_Int32_Int32 = new(typeof(UnityEngine.AudioListener), "GetOutputData", 0, typeof(System.Int32), typeof(System.Int32));
					r_RGetOutputData_Int32_Int32.SetBelong(null);
				}
		...
		/// </summary>
		protected static RMethod r_RGetOutputData_SingleArray_Int32;
		public static RMethod RGetOutputData_SingleArray_Int32
		{
			get
			{
				if(r_RGetOutputData_SingleArray_Int32 == null)
				{
					r_RGetOutputData_SingleArray_Int32 = new(typeof(UnityEngine.AudioListener), "GetOutputData", 0, typeof(System.Single).MakeArrayType(), typeof(System.Int32));
					r_RGetOutputData_SingleArray_Int32.SetBelong(null);
				}
		...
		/// </summary>
		protected static RMethod r_RGetSpectrumData_Int32_Int32_FFTWindow;
		public static RMethod RGetSpectrumData_Int32_Int32_FFTWindow
		{
			get
			{
				if(r_RGetSpectrumData_Int32_Int32_FFTWindow == null)
				{
					r_RGetSpectrumData_Int32_Int32_FFTWindow = new(typeof(UnityEngine.AudioListener), "GetSpectrumData", 0, typeof(System.Int32), typeof(System.Int32), typeof(UnityEngine.FFTWindow));
					r_RGetSpectrumData_Int32_Int32_FFTWindow.SetBelong(null);
				}
		...
		/// </summary>
		protected static RMethod r_RGetSpectrumData_SingleArray_Int32_FFTWindow;
		public static RMethod RGetSpectrumData_SingleArray_Int32_FFTWindow
		{
			get
			{
				if(r_RGetSpectrumData_SingleArray_Int32_FFTWindow == null)
				{
					r_RGetSpectrumData_SingleArray_Int32_FFTWindow = new(typeof(UnityEngine.AudioListener), "GetSpectrumData", 0, typeof(System.Single).MakeArrayType(), typeof(System.Int32), typeof(UnityEngine.FFTWindow));
					r_RGetSpectrumData_SingleArray_Int32_FFTWindow.SetBelong(null);
				}
        ...
        public RAudioListener() : base("UnityEngine.AudioListener")
        {
        }

        public RAudioListener(System.Object instance) : base("UnityEngine.AudioListener")
		{
            SetInstance(instance);
		}

        public RAudioListener(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAudioListener(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public static void GetOutputDataHelper(System.Single[]  @samples, System.Int32  @channel)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@samples, @channel};
            var ___result = RGetOutputDataHelper_SingleArray_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public static void GetSpectrumDataHelper(System.Single[]  @samples, System.Int32  @channel, UnityEngine.FFTWindow  @window)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@samples, @channel, @window};
            var ___result = RGetSpectrumDataHelper_SingleArray_Int32_FFTWindow.Invoke(___genericsType, ___parameters);

            
        }


        public static System.Single[] GetOutputData(System.Int32  @numSamples, System.Int32  @channel)
        {
        ...
        public static void GetOutputData(System.Single[]  @samples, System.Int32  @channel)
        {
        ...
        public static System.Single[] GetSpectrumData(System.Int32  @numSamples, System.Int32  @channel, UnityEngine.FFTWindow  @window)
        {
        ...
        public static void GetSpectrumData(System.Single[]  @samples, System.Int32  @channel, UnityEngine.FFTWindow  @window)
        {

...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RRendering
{
    ...
    public partial class RVertexAttributeDescriptor : RMember //
    {
		...
		/// </summary>
		protected RField r___2__attribute__4__k__BackingField;
		public virtual RField R__2__attribute__4__k__BackingField
		{
			get
			{
				if(r___2__attribute__4__k__BackingField == null)
				{
					r___2__attribute__4__k__BackingField = new(this, "<attribute>k__BackingField");
					r___2__attribute__4__k__BackingField.SetBelong(this.instance);
				}
				return r___2__attribute__4__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RField r___2__format__4__k__BackingField;
		public virtual RField R__2__format__4__k__BackingField
		{
			get
			{
				if(r___2__format__4__k__BackingField == null)
				{
					r___2__format__4__k__BackingField = new(this, "<format>k__BackingField");
					r___2__format__4__k__BackingField.SetBelong(this.instance);
				}
				return r___2__format__4__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RField r___2__stream__4__k__BackingField;
		public virtual RField R__2__stream__4__k__BackingField
		{
			get
			{
				if(r___2__stream__4__k__BackingField == null)
				{
					r___2__stream__4__k__BackingField = new(this, "<stream>k__BackingField");
					r___2__stream__4__k__BackingField.SetBelong(this.instance);
				}
				return r___2__stream__4__k__BackingField;
			}
		}

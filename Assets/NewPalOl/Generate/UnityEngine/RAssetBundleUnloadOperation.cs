...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
	...
	/// </summary>
    public partial class RAssetBundleUnloadOperation : RMember //
    {
        ...
        public RAssetBundleUnloadOperation() : base("UnityEngine.AssetBundleUnloadOperation")
        {
        }

        public RAssetBundleUnloadOperation(System.Object instance) : base("UnityEngine.AssetBundleUnloadOperation")
		{
            SetInstance(instance);
		}

        public RAssetBundleUnloadOperation(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAssetBundleUnloadOperation(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

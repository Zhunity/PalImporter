...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
	...
	/// </summary>
    public partial class RCharacterController : RMember //
    {
		...
		/// Boolean isGrounded
		/// </summary>
		protected RProperty r_isGrounded;
		public virtual RProperty RisGrounded
		{
			get
			{
				if(r_isGrounded == null)
				{
					r_isGrounded = new(this, "isGrounded", -1);
					r_isGrounded.SetBelong(this.instance);
				}
				return r_isGrounded;
			}
		}
		...
		/// </summary>
		protected RProperty r_collisionFlags;
		public virtual RProperty RcollisionFlags
		{
			get
			{
				if(r_collisionFlags == null)
				{
					r_collisionFlags = new(this, "collisionFlags", -1);
					r_collisionFlags.SetBelong(this.instance);
				}
				return r_collisionFlags;
			}
		}
		...
		/// Single slopeLimit
		/// </summary>
		protected RProperty r_slopeLimit;
		public virtual RProperty RslopeLimit
		{
			get
			{
				if(r_slopeLimit == null)
				{
					r_slopeLimit = new(this, "slopeLimit", -1);
					r_slopeLimit.SetBelong(this.instance);
				}
				return r_slopeLimit;
			}
		}
		...
		/// Single stepOffset
		/// </summary>
		protected RProperty r_stepOffset;
		public virtual RProperty RstepOffset
		{
			get
			{
				if(r_stepOffset == null)
				{
					r_stepOffset = new(this, "stepOffset", -1);
					r_stepOffset.SetBelong(this.instance);
				}
				return r_stepOffset;
			}
		}
		...
		/// <summary>
		/// Single minMoveDistance
		/// </summary>
		protected RProperty r_minMoveDistance;
		public virtual RProperty RminMoveDistance
		{
			get
			{
				if(r_minMoveDistance == null)
				{
					r_minMoveDistance = new(this, "minMoveDistance", -1);
					r_minMoveDistance.SetBelong(this.instance);
				}
				return r_minMoveDistance;
			}
		}
		...
		/// <summary>
		/// Boolean enableOverlapRecovery
		/// </summary>
		protected RProperty r_enableOverlapRecovery;
		public virtual RProperty RenableOverlapRecovery
		{
			get
			{
				if(r_enableOverlapRecovery == null)
				{
					r_enableOverlapRecovery = new(this, "enableOverlapRecovery", -1);
					r_enableOverlapRecovery.SetBelong(this.instance);
				}
				return r_enableOverlapRecovery;
			}
		}
		...
		/// </summary>
		protected RMethod r_RSimpleMove_Vector3;
		public virtual RMethod RSimpleMove_Vector3
		{
			get
			{
				if(r_RSimpleMove_Vector3 == null)
				{
					r_RSimpleMove_Vector3 = new(this, "SimpleMove", 0, typeof(UnityEngine.Vector3));
					r_RSimpleMove_Vector3.SetBelong(this.instance);
				}
				return r_RSimpleMove_Vector3;
			}
		}
		...
		/// </summary>
		protected RMethod r_RMove_Vector3;
		public virtual RMethod RMove_Vector3
		{
			get
			{
				if(r_RMove_Vector3 == null)
				{
					r_RMove_Vector3 = new(this, "Move", 0, typeof(UnityEngine.Vector3));
					r_RMove_Vector3.SetBelong(this.instance);
				}
				return r_RMove_Vector3;
			}
		}

		/// <summary>
		/// Boolean SimpleMove_Injected(UnityEngine.Vector3 ByRef)
		/// </summary>
		protected RMethod r_RSimpleMove_Injected_Ref_Vector3;
		public virtual RMethod RSimpleMove_Injected_Ref_Vector3
		{
			get
			{
				if(r_RSimpleMove_Injected_Ref_Vector3 == null)
				{
					r_RSimpleMove_Injected_Ref_Vector3 = new(this, "SimpleMove_Injected", 0, typeof(UnityEngine.Vector3).MakeByRefType());
					r_RSimpleMove_Injected_Ref_Vector3.SetBelong(this.instance);
				}
				return r_RSimpleMove_Injected_Ref_Vector3;
			}
		}

		/// <summary>
		/// UnityEngine.CollisionFlags Move_Injected(UnityEngine.Vector3 ByRef)
		/// </summary>
		protected RMethod r_RMove_Injected_Ref_Vector3;
		public virtual RMethod RMove_Injected_Ref_Vector3
		{
			get
			{
				if(r_RMove_Injected_Ref_Vector3 == null)
				{
					r_RMove_Injected_Ref_Vector3 = new(this, "Move_Injected", 0, typeof(UnityEngine.Vector3).MakeByRefType());
					r_RMove_Injected_Ref_Vector3.SetBelong(this.instance);
				}
				return r_RMove_Injected_Ref_Vector3;
			}
		}
        ...
        public RCharacterController() : base("UnityEngine.CharacterController")
        {
        }

        public RCharacterController(System.Object instance) : base("UnityEngine.CharacterController")
		{
            SetInstance(instance);
		}

        public RCharacterController(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCharacterController(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Boolean SimpleMove(UnityEngine.Vector3  @speed)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@speed};
            var ___result = RSimpleMove_Vector3.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual UnityEngine.CollisionFlags Move(UnityEngine.Vector3  @motion)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@motion};
            var ___result = RMove_Vector3.Invoke(___genericsType, ___parameters);

            return (UnityEngine.CollisionFlags)___result;
        }


        public virtual System.Boolean SimpleMove_Injected(ref UnityEngine.Vector3  @speed)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@speed};
            var ___result = RSimpleMove_Injected_Ref_Vector3.Invoke(___genericsType, ___parameters);
			speed = (UnityEngine.Vector3)___parameters[0];

            return (System.Boolean)___result;
        }


        public virtual UnityEngine.CollisionFlags Move_Injected(ref UnityEngine.Vector3  @motion)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@motion};
            var ___result = RMove_Injected_Ref_Vector3.Invoke(___genericsType, ___parameters);
			motion = (UnityEngine.Vector3)___parameters[0];

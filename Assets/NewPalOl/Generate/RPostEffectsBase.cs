...
namespace SMFrame.Editor.Refleaction
{
	...
	/// PostEffectsBase
	/// </summary>
    public partial class RPostEffectsBase : RMember //
    {
        ...
        public RPostEffectsBase() : base("PostEffectsBase")
        {
        }

        public RPostEffectsBase(System.Object instance) : base("PostEffectsBase")
		{
            SetInstance(instance);
		}

        public RPostEffectsBase(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPostEffectsBase(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

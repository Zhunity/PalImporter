...
{public partial class RCameraInCombat
{
	
	/// <summary>
	/// CameraInCombat+<UpdateCameraShake>c__IteratorFE
	/// </summary>
    public partial class R__2__UpdateCameraShake__4__c__IteratorFE : RMember //
    {

		/// <summary>
		/// System.Single <xLen>__0
		/// </summary>
		protected RField r___2__xLen__4____0;
		public virtual RField R__2__xLen__4____0
		{
			get
			{
				if(r___2__xLen__4____0 == null)
				{
					r___2__xLen__4____0 = new(this, "<xLen>__0");
					r___2__xLen__4____0.SetBelong(this.instance);
				}
				return r___2__xLen__4____0;
			}
		}

		/// <summary>
		/// System.Single <yLen>__1
		/// </summary>
		protected RField r___2__yLen__4____1;
		public virtual RField R__2__yLen__4____1
		{
			get
			{
				if(r___2__yLen__4____1 == null)
				{
					r___2__yLen__4____1 = new(this, "<yLen>__1");
					r___2__yLen__4____1.SetBelong(this.instance);
				}
				return r___2__yLen__4____1;
			}
		}

		/// <summary>
		/// System.Single <zLen>__2
		/// </summary>
		protected RField r___2__zLen__4____2;
		public virtual RField R__2__zLen__4____2
		{
			get
			{
				if(r___2__zLen__4____2 == null)
				{
					r___2__zLen__4____2 = new(this, "<zLen>__2");
					r___2__zLen__4____2.SetBelong(this.instance);
				}
				return r___2__zLen__4____2;
			}
		}
		...
		/// <summary>
		/// CameraInCombat <>f__this
		/// </summary>
		protected RCameraInCombat r___2____4__f__this;
		public virtual RCameraInCombat R__2____4__f__this
		{
			get
			{
        ...
        public R__2__UpdateCameraShake__4__c__IteratorFE() : base("CameraInCombat+<UpdateCameraShake>c__IteratorFE")
        {
        }

        public R__2__UpdateCameraShake__4__c__IteratorFE(System.Object instance) : base("CameraInCombat+<UpdateCameraShake>c__IteratorFE")
		{
            SetInstance(instance);
		}

        public R__2__UpdateCameraShake__4__c__IteratorFE(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__UpdateCameraShake__4__c__IteratorFE(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

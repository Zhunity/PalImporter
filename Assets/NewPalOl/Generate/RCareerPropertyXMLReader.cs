...
{
	/// <summary>
	/// CareerPropertyXMLReader
	/// </summary>
    public partial class RCareerPropertyXMLReader : RMember //
    {

		/// <summary>
		/// KeyValueContent LoadContentFromCareerConfigHold(CareerPropConfigHold)
		/// </summary>
		protected RMethod r_RLoadContentFromCareerConfigHold_CareerPropConfigHold;
		public virtual RMethod RLoadContentFromCareerConfigHold_CareerPropConfigHold
		{
			get
			{
				if(r_RLoadContentFromCareerConfigHold_CareerPropConfigHold == null)
				{
					r_RLoadContentFromCareerConfigHold_CareerPropConfigHold = new(this, "LoadContentFromCareerConfigHold", 0, typeof(CareerPropConfigHold));
					r_RLoadContentFromCareerConfigHold_CareerPropConfigHold.SetBelong(this.instance);
				}
				return r_RLoadContentFromCareerConfigHold_CareerPropConfigHold;
			}
		}
        ...
        public RCareerPropertyXMLReader() : base("CareerPropertyXMLReader")
        {
        }

        public RCareerPropertyXMLReader(System.Object instance) : base("CareerPropertyXMLReader")
		{
            SetInstance(instance);
		}

        public RCareerPropertyXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCareerPropertyXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Object LoadContentFromCareerConfigHold(CareerPropConfigHold  @config)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@config};
            var ___result = RLoadContentFromCareerConfigHold_CareerPropConfigHold.Invoke(___genericsType, ___parameters);

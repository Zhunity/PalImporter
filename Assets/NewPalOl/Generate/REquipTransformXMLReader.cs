...
{
	/// <summary>
	/// EquipTransformXMLReader
	/// </summary>
    public partial class REquipTransformXMLReader : RMember //
    {
        ...
        public REquipTransformXMLReader() : base("EquipTransformXMLReader")
        {
        }

        public REquipTransformXMLReader(System.Object instance) : base("EquipTransformXMLReader")
		{
            SetInstance(instance);
		}

        public REquipTransformXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REquipTransformXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

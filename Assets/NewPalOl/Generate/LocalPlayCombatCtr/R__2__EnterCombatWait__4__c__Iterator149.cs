...
{public partial class RLocalPlayCombatCtr
{
	
	/// <summary>
	/// LocalPlayCombatCtr+<EnterCombatWait>c__Iterator149
	/// </summary>
    public partial class R__2__EnterCombatWait__4__c__Iterator149 : RMember //
    {
		...
		/// <summary>
		/// LocalPlayCombatCtr <>f__this
		/// </summary>
		protected RLocalPlayCombatCtr r___2____4__f__this;
		public virtual RLocalPlayCombatCtr R__2____4__f__this
		{
			get
			{
        ...
        public R__2__EnterCombatWait__4__c__Iterator149() : base("LocalPlayCombatCtr+<EnterCombatWait>c__Iterator149")
        {
        }

        public R__2__EnterCombatWait__4__c__Iterator149(System.Object instance) : base("LocalPlayCombatCtr+<EnterCombatWait>c__Iterator149")
		{
            SetInstance(instance);
		}

        public R__2__EnterCombatWait__4__c__Iterator149(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__EnterCombatWait__4__c__Iterator149(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

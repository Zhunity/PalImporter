...
namespace SMFrame.Editor.Refleaction
{
	...
	/// </summary>
    public partial class RColorCorrectionCurves : RMember //
    {

		/// <summary>
		/// UnityEngine.Material _ccDepthMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r__ccDepthMaterial;
		public virtual RUnityEngine.RMaterial R_ccDepthMaterial
		{
			get
			{
				if(r__ccDepthMaterial == null)
				{
					r__ccDepthMaterial = new(this, "_ccDepthMaterial");
					r__ccDepthMaterial.SetBelong(this.instance);
				}
				return r__ccDepthMaterial;
			}
		}

		/// <summary>
		/// UnityEngine.Material _ccMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r__ccMaterial;
		public virtual RUnityEngine.RMaterial R_ccMaterial
		{
			get
			{
				if(r__ccMaterial == null)
				{
					r__ccMaterial = new(this, "_ccMaterial");
					r__ccMaterial.SetBelong(this.instance);
				}
				return r__ccMaterial;
			}
		}

		/// <summary>
		/// UnityEngine.Texture2D _rgbChannelTex
		/// </summary>
		protected RUnityEngine.RTexture2D r__rgbChannelTex;
		public virtual RUnityEngine.RTexture2D R_rgbChannelTex
		{
			get
			{
				if(r__rgbChannelTex == null)
				{
					r__rgbChannelTex = new(this, "_rgbChannelTex");
					r__rgbChannelTex.SetBelong(this.instance);
				}
				return r__rgbChannelTex;
			}
		}

		/// <summary>
		/// UnityEngine.Texture2D _rgbDepthChannelTex
		/// </summary>
		protected RUnityEngine.RTexture2D r__rgbDepthChannelTex;
		public virtual RUnityEngine.RTexture2D R_rgbDepthChannelTex
		{
			get
			{
				if(r__rgbDepthChannelTex == null)
				{
					r__rgbDepthChannelTex = new(this, "_rgbDepthChannelTex");
					r__rgbDepthChannelTex.SetBelong(this.instance);
				}
				return r__rgbDepthChannelTex;
			}
		}

		/// <summary>
		/// UnityEngine.Material _selectiveCcMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r__selectiveCcMaterial;
		public virtual RUnityEngine.RMaterial R_selectiveCcMaterial
		{
			get
			{
				if(r__selectiveCcMaterial == null)
				{
					r__selectiveCcMaterial = new(this, "_selectiveCcMaterial");
					r__selectiveCcMaterial.SetBelong(this.instance);
				}
				return r__selectiveCcMaterial;
			}
		}

		/// <summary>
		/// UnityEngine.Texture2D _zCurve
		/// </summary>
		protected RUnityEngine.RTexture2D r__zCurve;
		public virtual RUnityEngine.RTexture2D R_zCurve
		{
			get
			{
				if(r__zCurve == null)
				{
					r__zCurve = new(this, "_zCurve");
					r__zCurve.SetBelong(this.instance);
				}
				return r__zCurve;
			}
		}
		...
		/// <summary>
		/// UnityEngine.AnimationCurve blueChannel
		/// </summary>
		protected RUnityEngine.RAnimationCurve r_blueChannel;
		public virtual RUnityEngine.RAnimationCurve RblueChannel
		{
			get
			{
				if(r_blueChannel == null)
				{
					r_blueChannel = new(this, "blueChannel");
					r_blueChannel.SetBelong(this.instance);
				}
				return r_blueChannel;
			}
		}

		/// <summary>
		/// UnityEngine.Shader colorCorrectionCurvesShader
		/// </summary>
		protected RUnityEngine.RShader r_colorCorrectionCurvesShader;
		public virtual RUnityEngine.RShader RcolorCorrectionCurvesShader
		{
			get
			{
				if(r_colorCorrectionCurvesShader == null)
				{
					r_colorCorrectionCurvesShader = new(this, "colorCorrectionCurvesShader");
					r_colorCorrectionCurvesShader.SetBelong(this.instance);
				}
				return r_colorCorrectionCurvesShader;
			}
		}

		/// <summary>
		/// UnityEngine.Shader colorCorrectionSelectiveShader
		/// </summary>
		protected RUnityEngine.RShader r_colorCorrectionSelectiveShader;
		public virtual RUnityEngine.RShader RcolorCorrectionSelectiveShader
		{
			get
			{
				if(r_colorCorrectionSelectiveShader == null)
				{
					r_colorCorrectionSelectiveShader = new(this, "colorCorrectionSelectiveShader");
					r_colorCorrectionSelectiveShader.SetBelong(this.instance);
				}
				return r_colorCorrectionSelectiveShader;
			}
		}

		/// <summary>
		/// System.Int32 curveResolution
		/// </summary>
		protected RField r_curveResolution;
		public virtual RField RcurveResolution
		{
			get
			{
				if(r_curveResolution == null)
				{
					r_curveResolution = new(this, "curveResolution");
					r_curveResolution.SetBelong(this.instance);
				}
				return r_curveResolution;
			}
		}

		/// <summary>
		/// UnityEngine.AnimationCurve depthBlueChannel
		/// </summary>
		protected RUnityEngine.RAnimationCurve r_depthBlueChannel;
		public virtual RUnityEngine.RAnimationCurve RdepthBlueChannel
		{
			get
			{
				if(r_depthBlueChannel == null)
				{
					r_depthBlueChannel = new(this, "depthBlueChannel");
					r_depthBlueChannel.SetBelong(this.instance);
				}
				return r_depthBlueChannel;
			}
		}

		/// <summary>
		/// UnityEngine.AnimationCurve depthGreenChannel
		/// </summary>
		protected RUnityEngine.RAnimationCurve r_depthGreenChannel;
		public virtual RUnityEngine.RAnimationCurve RdepthGreenChannel
		{
			get
			{
				if(r_depthGreenChannel == null)
				{
					r_depthGreenChannel = new(this, "depthGreenChannel");
					r_depthGreenChannel.SetBelong(this.instance);
				}
				return r_depthGreenChannel;
			}
		}

		/// <summary>
		/// UnityEngine.AnimationCurve depthRedChannel
		/// </summary>
		protected RUnityEngine.RAnimationCurve r_depthRedChannel;
		public virtual RUnityEngine.RAnimationCurve RdepthRedChannel
		{
			get
			{
				if(r_depthRedChannel == null)
				{
					r_depthRedChannel = new(this, "depthRedChannel");
					r_depthRedChannel.SetBelong(this.instance);
				}
				return r_depthRedChannel;
			}
		}

		/// <summary>
		/// UnityEngine.AnimationCurve greenChannel
		/// </summary>
		protected RUnityEngine.RAnimationCurve r_greenChannel;
		public virtual RUnityEngine.RAnimationCurve RgreenChannel
		{
			get
			{
				if(r_greenChannel == null)
				{
					r_greenChannel = new(this, "greenChannel");
					r_greenChannel.SetBelong(this.instance);
				}
				return r_greenChannel;
			}
		}

		/// <summary>
		/// ColorCorrectionCurves+ColorCorrectionMode mode
		/// </summary>
		...
		/// <summary>
		/// System.Boolean recreateTextures
		/// </summary>
		protected RField r_recreateTextures;
		public virtual RField RrecreateTextures
		{
			get
			{
				if(r_recreateTextures == null)
				{
					r_recreateTextures = new(this, "recreateTextures");
					r_recreateTextures.SetBelong(this.instance);
				}
				return r_recreateTextures;
			}
		}

		/// <summary>
		/// UnityEngine.AnimationCurve redChannel
		/// </summary>
		protected RUnityEngine.RAnimationCurve r_redChannel;
		public virtual RUnityEngine.RAnimationCurve RredChannel
		{
			get
			{
				if(r_redChannel == null)
				{
					r_redChannel = new(this, "redChannel");
					r_redChannel.SetBelong(this.instance);
				}
				return r_redChannel;
			}
		}
		...
		/// <summary>
		/// System.Boolean selectiveCc
		/// </summary>
		protected RField r_selectiveCc;
		public virtual RField RselectiveCc
		{
			get
			{
				if(r_selectiveCc == null)
				{
					r_selectiveCc = new(this, "selectiveCc");
					r_selectiveCc.SetBelong(this.instance);
				}
				return r_selectiveCc;
			}
		}

		/// <summary>
		/// UnityEngine.Color selectiveFromColor
		/// </summary>
		protected RUnityEngine.RColor r_selectiveFromColor;
		public virtual RUnityEngine.RColor RselectiveFromColor
		{
			get
			{
				if(r_selectiveFromColor == null)
				{
					r_selectiveFromColor = new(this, "selectiveFromColor");
					r_selectiveFromColor.SetBelong(this.instance);
				}
				return r_selectiveFromColor;
			}
		}

		/// <summary>
		/// UnityEngine.Color selectiveToColor
		/// </summary>
		protected RUnityEngine.RColor r_selectiveToColor;
		public virtual RUnityEngine.RColor RselectiveToColor
		{
			get
			{
				if(r_selectiveToColor == null)
				{
					r_selectiveToColor = new(this, "selectiveToColor");
					r_selectiveToColor.SetBelong(this.instance);
				}
				return r_selectiveToColor;
			}
		}

		/// <summary>
		/// UnityEngine.Shader simpleColorCorrectionCurvesShader
		/// </summary>
		protected RUnityEngine.RShader r_simpleColorCorrectionCurvesShader;
		public virtual RUnityEngine.RShader RsimpleColorCorrectionCurvesShader
		{
			get
			{
				if(r_simpleColorCorrectionCurvesShader == null)
				{
					r_simpleColorCorrectionCurvesShader = new(this, "simpleColorCorrectionCurvesShader");
					r_simpleColorCorrectionCurvesShader.SetBelong(this.instance);
				}
				return r_simpleColorCorrectionCurvesShader;
			}
		}

		/// <summary>
		/// System.Boolean updateTextures
		/// </summary>
		protected RField r_updateTextures;
		public virtual RField RupdateTextures
		{
			get
			{
				if(r_updateTextures == null)
				{
					r_updateTextures = new(this, "updateTextures");
					r_updateTextures.SetBelong(this.instance);
				}
				return r_updateTextures;
			}
		}

		/// <summary>
		/// System.Boolean useDepthCorrection
		/// </summary>
		protected RField r_useDepthCorrection;
		public virtual RField RuseDepthCorrection
		{
			get
			{
				if(r_useDepthCorrection == null)
				{
					r_useDepthCorrection = new(this, "useDepthCorrection");
					r_useDepthCorrection.SetBelong(this.instance);
				}
				return r_useDepthCorrection;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RAnimationCurve r_zCurve;
		public virtual RUnityEngine.RAnimationCurve RzCurve
		{
			get
			{
				if(r_zCurve == null)
				{
					r_zCurve = new(this, "zCurve");
					r_zCurve.SetBelong(this.instance);
				}
				return r_zCurve;
			}
		}
		...
		/// </summary>
		protected RMethod r_RUpdateParameters;
		public virtual RMethod RUpdateParameters
		{
			get
			{
				if(r_RUpdateParameters == null)
				{
					r_RUpdateParameters = new(this, "UpdateParameters", 0);
					r_RUpdateParameters.SetBelong(this.instance);
				}
				return r_RUpdateParameters;
			}
		}
        ...
        public RColorCorrectionCurves() : base("ColorCorrectionCurves")
        {
        }

        public RColorCorrectionCurves(System.Object instance) : base("ColorCorrectionCurves")
		{
            SetInstance(instance);
		}

        public RColorCorrectionCurves(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RColorCorrectionCurves(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void UpdateParameters()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RUpdateParameters.Invoke(___genericsType, ___parameters);

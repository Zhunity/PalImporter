...
namespace SMFrame.Editor.Refleaction
{
	...
	/// GerstnerDisplace
	/// </summary>
    public partial class RGerstnerDisplace : RMember //
    {
        ...
        public RGerstnerDisplace() : base("GerstnerDisplace")
        {
        }

        public RGerstnerDisplace(System.Object instance) : base("GerstnerDisplace")
		{
            SetInstance(instance);
		}

        public RGerstnerDisplace(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RGerstnerDisplace(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

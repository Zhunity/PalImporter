...
{public partial class RElementBase
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#4Nb
	/// </summary>
    public partial class R__0__4Nb : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Object, #oU.#7X)
		/// </summary>
        ...
        public R__0__4Nb() : base("MyGUI.ElementBase+#4Nb")
        {
        }

        public R__0__4Nb(System.Object instance) : base("MyGUI.ElementBase+#4Nb")
		{
            SetInstance(instance);
		}

        public R__0__4Nb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4Nb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

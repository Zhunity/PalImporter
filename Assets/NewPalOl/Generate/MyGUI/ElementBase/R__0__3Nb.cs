...
{public partial class RElementBase
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#3Nb
	/// </summary>
    public partial class R__0__3Nb : RMember //
    {
        ...
        public R__0__3Nb() : base("MyGUI.ElementBase+#3Nb")
        {
        }

        public R__0__3Nb(System.Object instance) : base("MyGUI.ElementBase+#3Nb")
		{
            SetInstance(instance);
		}

        public R__0__3Nb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3Nb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RElementBase
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#8Nb
	/// </summary>
    public partial class R__0__8Nb : RMember //
    {
        ...
        public R__0__8Nb() : base("MyGUI.ElementBase+#8Nb")
        {
        }

        public R__0__8Nb(System.Object instance) : base("MyGUI.ElementBase+#8Nb")
		{
            SetInstance(instance);
		}

        public R__0__8Nb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Nb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RElementBase
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#0Nb
	/// </summary>
    public partial class R__0__0Nb : RMember //
    {
        ...
        public R__0__0Nb() : base("MyGUI.ElementBase+#0Nb")
        {
        }

        public R__0__0Nb(System.Object instance) : base("MyGUI.ElementBase+#0Nb")
		{
            SetInstance(instance);
		}

        public R__0__0Nb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0Nb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

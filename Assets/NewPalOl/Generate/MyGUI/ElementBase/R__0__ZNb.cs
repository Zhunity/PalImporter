...
{public partial class RElementBase
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#ZNb
	/// </summary>
    public partial class R__0__ZNb : RMember //
    {
        ...
        public R__0__ZNb() : base("MyGUI.ElementBase+#ZNb")
        {
        }

        public R__0__ZNb(System.Object instance) : base("MyGUI.ElementBase+#ZNb")
		{
            SetInstance(instance);
		}

        public R__0__ZNb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ZNb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

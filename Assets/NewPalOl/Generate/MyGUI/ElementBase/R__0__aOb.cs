...
{public partial class RElementBase
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#aOb
	/// </summary>
    public partial class R__0__aOb : RMember //
    {
        ...
        public R__0__aOb() : base("MyGUI.ElementBase+#aOb")
        {
        }

        public R__0__aOb(System.Object instance) : base("MyGUI.ElementBase+#aOb")
		{
            SetInstance(instance);
		}

        public R__0__aOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__aOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

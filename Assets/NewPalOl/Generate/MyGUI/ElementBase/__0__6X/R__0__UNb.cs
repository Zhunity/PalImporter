	...
	public partial class R__0__6X
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#6X+#UNb
	/// </summary>
    public partial class R__0__UNb : RMember //
    {
        ...
        public R__0__UNb() : base("MyGUI.ElementBase+#6X+#UNb")
        {
        }

        public R__0__UNb(System.Object instance) : base("MyGUI.ElementBase+#6X+#UNb")
		{
            SetInstance(instance);
		}

        public R__0__UNb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__UNb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

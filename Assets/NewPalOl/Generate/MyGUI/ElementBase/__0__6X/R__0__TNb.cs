	...
	public partial class R__0__6X
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#6X+#TNb
	/// </summary>
    public partial class R__0__TNb : RMember //
    {
        ...
        public R__0__TNb() : base("MyGUI.ElementBase+#6X+#TNb")
        {
        }

        public R__0__TNb(System.Object instance) : base("MyGUI.ElementBase+#6X+#TNb")
		{
            SetInstance(instance);
		}

        public R__0__TNb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__TNb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

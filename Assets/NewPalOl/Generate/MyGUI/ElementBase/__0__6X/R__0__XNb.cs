	...
	public partial class R__0__6X
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#6X+#XNb
	/// </summary>
    public partial class R__0__XNb : RMember //
    {
        ...
        public R__0__XNb() : base("MyGUI.ElementBase+#6X+#XNb")
        {
        }

        public R__0__XNb(System.Object instance) : base("MyGUI.ElementBase+#6X+#XNb")
		{
            SetInstance(instance);
		}

        public R__0__XNb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XNb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

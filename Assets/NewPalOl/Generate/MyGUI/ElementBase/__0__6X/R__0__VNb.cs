...
{
	public partial class R__0__6X
{
	
	/// <summary>
	/// MyGUI.ElementBase+#6X+#VNb
	/// </summary>
    public partial class R__0__VNb : RMember //
    {
		...
		/// <summary>
		/// Boolean Invoke(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_RInvoke_Object___0__7X;
		public virtual RMethod RInvoke_Object___0__7X
		{
			get
			{
				if(r_RInvoke_Object___0__7X == null)
				{
					r_RInvoke_Object___0__7X = new(this, "Invoke", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_RInvoke_Object___0__7X.SetBelong(this.instance);
				}
				return r_RInvoke_Object___0__7X;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, #oU.#7X, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Object___0__7X_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object___0__7X_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object___0__7X_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object___0__7X_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object___0__7X_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object___0__7X_AsyncCallback_Object;
			}
		}
        ...
        public R__0__VNb() : base("MyGUI.ElementBase+#6X+#VNb")
        {
        }

        public R__0__VNb(System.Object instance) : base("MyGUI.ElementBase+#6X+#VNb")
		{
            SetInstance(instance);
		}

        public R__0__VNb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__VNb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

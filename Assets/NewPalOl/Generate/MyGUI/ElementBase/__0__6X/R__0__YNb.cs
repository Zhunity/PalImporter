	...
	public partial class R__0__6X
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#6X+#YNb
	/// </summary>
    public partial class R__0__YNb : RMember //
    {
        ...
        public R__0__YNb() : base("MyGUI.ElementBase+#6X+#YNb")
        {
        }

        public R__0__YNb(System.Object instance) : base("MyGUI.ElementBase+#6X+#YNb")
		{
            SetInstance(instance);
		}

        public R__0__YNb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YNb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

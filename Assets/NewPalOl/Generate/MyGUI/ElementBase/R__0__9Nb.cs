...
{public partial class RElementBase
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#9Nb
	/// </summary>
    public partial class R__0__9Nb : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Object, #oU.#7X, MyGUI.DragDropInfo)
		/// </summary>
		protected RMethod r_RInvoke_Object___0__7X_DragDropInfo;
		public virtual RMethod RInvoke_Object___0__7X_DragDropInfo
		{
			get
			{
				if(r_RInvoke_Object___0__7X_DragDropInfo == null)
				{
					r_RInvoke_Object___0__7X_DragDropInfo = new(this, "Invoke", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"), typeof(MyGUI.DragDropInfo));
					r_RInvoke_Object___0__7X_DragDropInfo.SetBelong(this.instance);
				}
				return r_RInvoke_Object___0__7X_DragDropInfo;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, #oU.#7X, MyGUI.DragDropInfo, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Object___0__7X_DragDropInfo_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object___0__7X_DragDropInfo_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object___0__7X_DragDropInfo_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object___0__7X_DragDropInfo_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"), typeof(MyGUI.DragDropInfo), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object___0__7X_DragDropInfo_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object___0__7X_DragDropInfo_AsyncCallback_Object;
			}
		}
        ...
        public R__0__9Nb() : base("MyGUI.ElementBase+#9Nb")
        {
        }

        public R__0__9Nb(System.Object instance) : base("MyGUI.ElementBase+#9Nb")
		{
            SetInstance(instance);
		}

        public R__0__9Nb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Nb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

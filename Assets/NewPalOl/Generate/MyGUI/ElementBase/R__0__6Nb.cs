...
{public partial class RElementBase
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#6Nb
	/// </summary>
    public partial class R__0__6Nb : RMember //
    {
        ...
        public R__0__6Nb() : base("MyGUI.ElementBase+#6Nb")
        {
        }

        public R__0__6Nb(System.Object instance) : base("MyGUI.ElementBase+#6Nb")
		{
            SetInstance(instance);
		}

        public R__0__6Nb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6Nb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

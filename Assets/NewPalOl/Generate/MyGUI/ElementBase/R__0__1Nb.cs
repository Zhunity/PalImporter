...
{public partial class RElementBase
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#1Nb
	/// </summary>
    public partial class R__0__1Nb : RMember //
    {
        ...
        public R__0__1Nb() : base("MyGUI.ElementBase+#1Nb")
        {
        }

        public R__0__1Nb(System.Object instance) : base("MyGUI.ElementBase+#1Nb")
		{
            SetInstance(instance);
		}

        public R__0__1Nb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1Nb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RElementBase
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#ENv
	/// </summary>
    public partial class R__0__ENv : RMember //
    {
        ...
        public R__0__ENv() : base("MyGUI.ElementBase+#ENv")
        {
        }

        public R__0__ENv(System.Object instance) : base("MyGUI.ElementBase+#ENv")
		{
            SetInstance(instance);
		}

        public R__0__ENv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ENv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Object  @sender)
        {
        ...
        public virtual System.IAsyncResult BeginInvoke(System.Object  @sender, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @callback, @object};

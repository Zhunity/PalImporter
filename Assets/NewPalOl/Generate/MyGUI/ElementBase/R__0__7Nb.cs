...
{public partial class RElementBase
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#7Nb
	/// </summary>
    public partial class R__0__7Nb : RMember //
    {
        ...
        public R__0__7Nb() : base("MyGUI.ElementBase+#7Nb")
        {
        }

        public R__0__7Nb(System.Object instance) : base("MyGUI.ElementBase+#7Nb")
		{
            SetInstance(instance);
		}

        public R__0__7Nb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7Nb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

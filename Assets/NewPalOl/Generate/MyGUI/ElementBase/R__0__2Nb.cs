...
{public partial class RElementBase
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#2Nb
	/// </summary>
    public partial class R__0__2Nb : RMember //
    {
        ...
        public R__0__2Nb() : base("MyGUI.ElementBase+#2Nb")
        {
        }

        public R__0__2Nb(System.Object instance) : base("MyGUI.ElementBase+#2Nb")
		{
            SetInstance(instance);
		}

        public R__0__2Nb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2Nb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

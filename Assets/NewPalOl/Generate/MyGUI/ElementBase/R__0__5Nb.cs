...
{public partial class RElementBase
{
	...
	/// <summary>
	/// MyGUI.ElementBase+#5Nb
	/// </summary>
    public partial class R__0__5Nb : RMember //
    {
        ...
        public R__0__5Nb() : base("MyGUI.ElementBase+#5Nb")
        {
        }

        public R__0__5Nb(System.Object instance) : base("MyGUI.ElementBase+#5Nb")
		{
            SetInstance(instance);
		}

        public R__0__5Nb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5Nb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

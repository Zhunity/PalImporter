...
{
	/// <summary>
	/// QuestionInfoXMLReader
	/// </summary>
    public partial class RQuestionInfoXMLReader : RMember //
    {
        ...
        public RQuestionInfoXMLReader() : base("QuestionInfoXMLReader")
        {
        }

        public RQuestionInfoXMLReader(System.Object instance) : base("QuestionInfoXMLReader")
		{
            SetInstance(instance);
		}

        public RQuestionInfoXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RQuestionInfoXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

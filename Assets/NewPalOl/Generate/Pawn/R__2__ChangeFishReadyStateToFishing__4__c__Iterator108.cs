...
{public partial class RPawn
{
	
	/// <summary>
	/// Pawn+<ChangeFishReadyStateToFishing>c__Iterator108
	/// </summary>
    public partial class R__2__ChangeFishReadyStateToFishing__4__c__Iterator108 : RMember //
    {
		...
		/// Pawn <>f__this
		/// </summary>
		protected RPawn r___2____4__f__this;
		public virtual RPawn R__2____4__f__this
		{
			get
			{
        ...
        public R__2__ChangeFishReadyStateToFishing__4__c__Iterator108() : base("Pawn+<ChangeFishReadyStateToFishing>c__Iterator108")
        {
        }

        public R__2__ChangeFishReadyStateToFishing__4__c__Iterator108(System.Object instance) : base("Pawn+<ChangeFishReadyStateToFishing>c__Iterator108")
		{
            SetInstance(instance);
		}

        public R__2__ChangeFishReadyStateToFishing__4__c__Iterator108(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ChangeFishReadyStateToFishing__4__c__Iterator108(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

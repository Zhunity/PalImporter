...
{public partial class RPawn
{
	...
	/// <summary>
	/// Pawn+<ChangeFishingStateToNone>c__Iterator109
	/// </summary>
    public partial class R__2__ChangeFishingStateToNone__4__c__Iterator109 : RMember //
    {
        ...
        public R__2__ChangeFishingStateToNone__4__c__Iterator109() : base("Pawn+<ChangeFishingStateToNone>c__Iterator109")
        {
        }

        public R__2__ChangeFishingStateToNone__4__c__Iterator109(System.Object instance) : base("Pawn+<ChangeFishingStateToNone>c__Iterator109")
		{
            SetInstance(instance);
		}

        public R__2__ChangeFishingStateToNone__4__c__Iterator109(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ChangeFishingStateToNone__4__c__Iterator109(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// Vignetting
	/// </summary>
    public partial class RVignetting : RMember //
    {

		/// <summary>
		/// UnityEngine.Material _chromAberrationMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r__chromAberrationMaterial;
		public virtual RUnityEngine.RMaterial R_chromAberrationMaterial
		{
			get
			{
				if(r__chromAberrationMaterial == null)
				{
					r__chromAberrationMaterial = new(this, "_chromAberrationMaterial");
					r__chromAberrationMaterial.SetBelong(this.instance);
				}
				return r__chromAberrationMaterial;
			}
		}
		...
		/// <summary>
		/// System.Single blurVignette
		/// </summary>
		protected RField r_blurVignette;
		public virtual RField RblurVignette
		{
			get
			{
				if(r_blurVignette == null)
				{
					r_blurVignette = new(this, "blurVignette");
					r_blurVignette.SetBelong(this.instance);
				}
				return r_blurVignette;
			}
		}

		/// <summary>
		/// UnityEngine.Shader chromAberrationShader
		/// </summary>
		protected RUnityEngine.RShader r_chromAberrationShader;
		public virtual RUnityEngine.RShader RchromAberrationShader
		{
			get
			{
				if(r_chromAberrationShader == null)
				{
					r_chromAberrationShader = new(this, "chromAberrationShader");
					r_chromAberrationShader.SetBelong(this.instance);
				}
				return r_chromAberrationShader;
			}
		}

		/// <summary>
		/// System.Single chromaticAberrationIntensity
		/// </summary>
		protected RField r_chromaticAberrationIntensity;
		public virtual RField RchromaticAberrationIntensity
		{
			get
			{
				if(r_chromaticAberrationIntensity == null)
				{
					r_chromaticAberrationIntensity = new(this, "chromaticAberrationIntensity");
					r_chromaticAberrationIntensity.SetBelong(this.instance);
				}
				return r_chromaticAberrationIntensity;
			}
		}
		...
		/// <summary>
		/// System.Single vignetteIntensity
		/// </summary>
		protected RField r_vignetteIntensity;
		public virtual RField RvignetteIntensity
		{
			get
			{
				if(r_vignetteIntensity == null)
				{
					r_vignetteIntensity = new(this, "vignetteIntensity");
					r_vignetteIntensity.SetBelong(this.instance);
				}
				return r_vignetteIntensity;
			}
		}
        ...
        public RVignetting() : base("Vignetting")
        {
        }

        public RVignetting(System.Object instance) : base("Vignetting")
		{
            SetInstance(instance);
		}

        public RVignetting(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RVignetting(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

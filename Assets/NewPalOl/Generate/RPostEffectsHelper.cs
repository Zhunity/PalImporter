...
namespace SMFrame.Editor.Refleaction
{
	...
	/// PostEffectsHelper
	/// </summary>
    public partial class RPostEffectsHelper : RMember //
    {
		...
		/// </summary>
		protected static RMethod r_RDrawBorder_RenderTexture_Material;
		public static RMethod RDrawBorder_RenderTexture_Material
		{
			get
			{
				if(r_RDrawBorder_RenderTexture_Material == null)
				{
					r_RDrawBorder_RenderTexture_Material = new( ReleactionUtils.GetType("PostEffectsHelper"), "DrawBorder", 0, typeof(UnityEngine.RenderTexture), typeof(UnityEngine.Material));
					r_RDrawBorder_RenderTexture_Material.SetBelong(null);
				}
		...
		/// </summary>
		protected static RMethod r_RDrawLowLevelPlaneAlignedWithCamera_Single_RenderTexture_RenderTexture_Material_Camera;
		public static RMethod RDrawLowLevelPlaneAlignedWithCamera_Single_RenderTexture_RenderTexture_Material_Camera
		{
			get
			{
				if(r_RDrawLowLevelPlaneAlignedWithCamera_Single_RenderTexture_RenderTexture_Material_Camera == null)
				{
					r_RDrawLowLevelPlaneAlignedWithCamera_Single_RenderTexture_RenderTexture_Material_Camera = new( ReleactionUtils.GetType("PostEffectsHelper"), "DrawLowLevelPlaneAlignedWithCamera", 0, typeof(System.Single), typeof(UnityEngine.RenderTexture), typeof(UnityEngine.RenderTexture), typeof(UnityEngine.Material), typeof(UnityEngine.Camera));
					r_RDrawLowLevelPlaneAlignedWithCamera_Single_RenderTexture_RenderTexture_Material_Camera.SetBelong(null);
				}
		...
		/// </summary>
		protected static RMethod r_RDrawLowLevelQuad_Single_Single_Single_Single_RenderTexture_RenderTexture_Material;
		public static RMethod RDrawLowLevelQuad_Single_Single_Single_Single_RenderTexture_RenderTexture_Material
		{
			get
			{
				if(r_RDrawLowLevelQuad_Single_Single_Single_Single_RenderTexture_RenderTexture_Material == null)
				{
					r_RDrawLowLevelQuad_Single_Single_Single_Single_RenderTexture_RenderTexture_Material = new( ReleactionUtils.GetType("PostEffectsHelper"), "DrawLowLevelQuad", 0, typeof(System.Single), typeof(System.Single), typeof(System.Single), typeof(System.Single), typeof(UnityEngine.RenderTexture), typeof(UnityEngine.RenderTexture), typeof(UnityEngine.Material));
					r_RDrawLowLevelQuad_Single_Single_Single_Single_RenderTexture_RenderTexture_Material.SetBelong(null);
				}
        ...
        public RPostEffectsHelper() : base("PostEffectsHelper")
        {
        }

        public RPostEffectsHelper(System.Object instance) : base("PostEffectsHelper")
		{
            SetInstance(instance);
		}

        public RPostEffectsHelper(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPostEffectsHelper(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public static void DrawBorder(UnityEngine.RenderTexture  @dest, UnityEngine.Material  @material)
        {
        ...
        public static void DrawLowLevelPlaneAlignedWithCamera(System.Single  @dist, UnityEngine.RenderTexture  @source, UnityEngine.RenderTexture  @dest, UnityEngine.Material  @material, UnityEngine.Camera  @cameraForProjectionMatrix)
        {
        ...
        public static void DrawLowLevelQuad(System.Single  @x1, System.Single  @x2, System.Single  @y1, System.Single  @y2, UnityEngine.RenderTexture  @source, UnityEngine.RenderTexture  @dest, UnityEngine.Material  @material)
        {

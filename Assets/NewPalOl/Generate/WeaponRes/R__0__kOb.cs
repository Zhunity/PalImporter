...
{public partial class RWeaponRes
{
	
	/// <summary>
	/// WeaponRes+#kOb
	/// </summary>
    public partial class R__0__kOb : RMember //
    {
        ...
        public R__0__kOb() : base("WeaponRes+#kOb")
        {
        }

        public R__0__kOb(System.Object instance) : base("WeaponRes+#kOb")
		{
            SetInstance(instance);
		}

        public R__0__kOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__kOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

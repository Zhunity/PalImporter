...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ColorRevertEffect
	/// </summary>
    public partial class RColorRevertEffect : RMember //
    {
		...
		public static RUnityEngine.RMaterial R_mat
		{
			get
			{
				if(r__mat == null)
				{
					r__mat = new(typeof(ColorRevertEffect), "_mat");
		...
		/// <summary>
		/// UnityEngine.Material m_mat
		/// </summary>
		protected static RUnityEngine.RMaterial r_m_mat;
		public static RUnityEngine.RMaterial Rm_mat
		{
			get
			{
				if(r_m_mat == null)
				{
					r_m_mat = new(typeof(ColorRevertEffect), "m_mat", -1);
					r_m_mat.SetBelong(null);
				}
				return r_m_mat;
			}
		}
		...
		/// <summary>
		/// Void SetColorRevertEffect(Single)
		/// </summary>
		protected static RMethod r_RSetColorRevertEffect_Single;
		public static RMethod RSetColorRevertEffect_Single
		{
			get
			{
				if(r_RSetColorRevertEffect_Single == null)
				{
					r_RSetColorRevertEffect_Single = new(typeof(ColorRevertEffect), "SetColorRevertEffect", 0, typeof(System.Single));
					r_RSetColorRevertEffect_Single.SetBelong(null);
				}
				return r_RSetColorRevertEffect_Single;
			}
		}
        ...
        public RColorRevertEffect() : base("ColorRevertEffect")
        {
        }

        public RColorRevertEffect(System.Object instance) : base("ColorRevertEffect")
		{
            SetInstance(instance);
		}

        public RColorRevertEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RColorRevertEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public static void SetColorRevertEffect(System.Single  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time};
            var ___result = RSetColorRevertEffect_Single.Invoke(___genericsType, ___parameters);

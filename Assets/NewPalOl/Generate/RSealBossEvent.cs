...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SealBossEvent
	/// </summary>
    public partial class RSealBossEvent : RMember //
    {
		...
		/// </summary>
		protected RField r_maxPoint;
		public virtual RField RmaxPoint
		{
			get
			{
				if(r_maxPoint == null)
				{
					r_maxPoint = new(this, "maxPoint");
					r_maxPoint.SetBelong(this.instance);
				}
				return r_maxPoint;
			}
		}
		...
		/// <summary>
		/// SealBossEvent+EventDimension dimension
		/// </summary>
		...
		/// <summary>
		/// System.Int32 bossLevel
		/// </summary>
		protected RField r_bossLevel;
		public virtual RField RbossLevel
		{
			get
			{
				if(r_bossLevel == null)
				{
					r_bossLevel = new(this, "bossLevel");
					r_bossLevel.SetBelong(this.instance);
				}
				return r_bossLevel;
			}
		}
		...
		/// Void Update(#Pfb.#Vub)
		/// </summary>
		protected RMethod r_RUpdate___0__Vub;
		public virtual RMethod RUpdate___0__Vub
		{
			get
			{
				if(r_RUpdate___0__Vub == null)
				{
					r_RUpdate___0__Vub = new(this, "Update", 0,  ReleactionUtils.GetType("#Pfb.#Vub"));
					r_RUpdate___0__Vub.SetBelong(this.instance);
				}
				return r_RUpdate___0__Vub;
			}
		}
		...
		public static RMethod R__0__Fbb_EventDimension
		{
			get
			{
				...
				{
					r_R__0__Fbb_EventDimension = new(typeof(SealBossEvent), "#Fbb", 0,  ReleactionUtils.GetType("SealBossEvent+EventDimension"));
        ...
        public RSealBossEvent() : base("SealBossEvent")
        {
        }

        public RSealBossEvent(System.Object instance) : base("SealBossEvent")
		{
            SetInstance(instance);
		}

        public RSealBossEvent(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSealBossEvent(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// UITexture
	/// </summary>
    public partial class RUITexture : RMember //
    {
        ...
        public RUITexture() : base("UITexture")
        {
        }

        public RUITexture(System.Object instance) : base("UITexture")
		{
            SetInstance(instance);
		}

        public RUITexture(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RUITexture(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CareerDesXMLReader
	/// </summary>
    public partial class RCareerDesXMLReader : RMember //
    {
        ...
        public RCareerDesXMLReader() : base("CareerDesXMLReader")
        {
        }

        public RCareerDesXMLReader(System.Object instance) : base("CareerDesXMLReader")
		{
            SetInstance(instance);
		}

        public RCareerDesXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCareerDesXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

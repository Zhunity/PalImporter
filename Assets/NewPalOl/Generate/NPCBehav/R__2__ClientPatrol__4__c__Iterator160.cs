...
{public partial class RNPCBehav
{
	...
	/// <summary>
	/// NPCBehav+<ClientPatrol>c__Iterator160
	/// </summary>
    public partial class R__2__ClientPatrol__4__c__Iterator160 : RMember //
    {

		/// <summary>
		/// System.Int32 <nIdx>__0
		/// </summary>
		protected RField r___2__nIdx__4____0;
		public virtual RField R__2__nIdx__4____0
		{
			get
			{
				if(r___2__nIdx__4____0 == null)
				{
					r___2__nIdx__4____0 = new(this, "<nIdx>__0");
					r___2__nIdx__4____0.SetBelong(this.instance);
				}
				return r___2__nIdx__4____0;
			}
		}

		/// <summary>
		/// UnityEngine.Vector3 <vec>__1
		/// </summary>
		protected RUnityEngine.RVector3 r___2__vec__4____1;
		public virtual RUnityEngine.RVector3 R__2__vec__4____1
		{
			get
			{
				if(r___2__vec__4____1 == null)
				{
					r___2__vec__4____1 = new(this, "<vec>__1");
					r___2__vec__4____1.SetBelong(this.instance);
				}
				return r___2__vec__4____1;
			}
		}

		/// <summary>
		/// System.Single <dist>__2
		/// </summary>
		protected RField r___2__dist__4____2;
		public virtual RField R__2__dist__4____2
		{
			get
			{
				if(r___2__dist__4____2 == null)
				{
					r___2__dist__4____2 = new(this, "<dist>__2");
					r___2__dist__4____2.SetBelong(this.instance);
				}
				return r___2__dist__4____2;
			}
		}
        ...
        public R__2__ClientPatrol__4__c__Iterator160() : base("NPCBehav+<ClientPatrol>c__Iterator160")
        {
        }

        public R__2__ClientPatrol__4__c__Iterator160(System.Object instance) : base("NPCBehav+<ClientPatrol>c__Iterator160")
		{
            SetInstance(instance);
		}

        public R__2__ClientPatrol__4__c__Iterator160(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ClientPatrol__4__c__Iterator160(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RNPCBehav
{
	...
	/// <summary>
	/// NPCBehav+<ShowNpcBubble>c__Iterator15C
	/// </summary>
    public partial class R__2__ShowNpcBubble__4__c__Iterator15C : RMember //
    {

		/// <summary>
		/// NPCBehav+NpcBubbleArg arg
		/// </summary>
		protected RNPCBehav.RNpcBubbleArg r_arg;
		public virtual RNPCBehav.RNpcBubbleArg Rarg
		{
			get
			{
				if(r_arg == null)
		...
		/// NPCBehav+NpcBubbleArg <$>arg
		/// </summary>
		protected RNPCBehav.RNpcBubbleArg r___2____9____4__arg;
		public virtual RNPCBehav.RNpcBubbleArg R__2____9____4__arg
		{
			get
			{
        ...
        public R__2__ShowNpcBubble__4__c__Iterator15C() : base("NPCBehav+<ShowNpcBubble>c__Iterator15C")
        {
        }

        public R__2__ShowNpcBubble__4__c__Iterator15C(System.Object instance) : base("NPCBehav+<ShowNpcBubble>c__Iterator15C")
		{
            SetInstance(instance);
		}

        public R__2__ShowNpcBubble__4__c__Iterator15C(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ShowNpcBubble__4__c__Iterator15C(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

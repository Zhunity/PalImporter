...
{public partial class RNPCBehav
{
	...
	/// <summary>
	/// NPCBehav+<PlayAnimDelay>c__Iterator158
	/// </summary>
    public partial class R__2__PlayAnimDelay__4__c__Iterator158 : RMember //
    {
		...
		/// </summary>
		protected RField r_animname;
		public virtual RField Ranimname
		{
			get
			{
				if(r_animname == null)
				{
					r_animname = new(this, "animname");
					r_animname.SetBelong(this.instance);
				}
				return r_animname;
			}
		}
		...
		/// System.Single <$>timeDelay
		/// </summary>
		protected RField r___2____9____4__timeDelay;
		public virtual RField R__2____9____4__timeDelay
		{
			get
			{
				if(r___2____9____4__timeDelay == null)
				{
					r___2____9____4__timeDelay = new(this, "<$>timeDelay");
					r___2____9____4__timeDelay.SetBelong(this.instance);
				}
				return r___2____9____4__timeDelay;
			}
		}
		...
		/// System.String <$>animname
		/// </summary>
		protected RField r___2____9____4__animname;
		public virtual RField R__2____9____4__animname
		{
			get
			{
				if(r___2____9____4__animname == null)
				{
					r___2____9____4__animname = new(this, "<$>animname");
					r___2____9____4__animname.SetBelong(this.instance);
				}
				return r___2____9____4__animname;
			}
		}
		...
		/// System.Boolean <$>bLoop
		/// </summary>
		protected RField r___2____9____4__bLoop;
		public virtual RField R__2____9____4__bLoop
		{
			get
			{
				if(r___2____9____4__bLoop == null)
				{
					r___2____9____4__bLoop = new(this, "<$>bLoop");
					r___2____9____4__bLoop.SetBelong(this.instance);
				}
				return r___2____9____4__bLoop;
			}
		}
        ...
        public R__2__PlayAnimDelay__4__c__Iterator158() : base("NPCBehav+<PlayAnimDelay>c__Iterator158")
        {
        }

        public R__2__PlayAnimDelay__4__c__Iterator158(System.Object instance) : base("NPCBehav+<PlayAnimDelay>c__Iterator158")
		{
            SetInstance(instance);
		}

        public R__2__PlayAnimDelay__4__c__Iterator158(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__PlayAnimDelay__4__c__Iterator158(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

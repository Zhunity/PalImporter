...
{public partial class RNPCBehav
{
	...
	/// <summary>
	/// NPCBehav+<WaitForSpecAnim>c__Iterator15A
	/// </summary>
    public partial class R__2__WaitForSpecAnim__4__c__Iterator15A : RMember //
    {
        ...
        public R__2__WaitForSpecAnim__4__c__Iterator15A() : base("NPCBehav+<WaitForSpecAnim>c__Iterator15A")
        {
        }

        public R__2__WaitForSpecAnim__4__c__Iterator15A(System.Object instance) : base("NPCBehav+<WaitForSpecAnim>c__Iterator15A")
		{
            SetInstance(instance);
		}

        public R__2__WaitForSpecAnim__4__c__Iterator15A(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__WaitForSpecAnim__4__c__Iterator15A(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

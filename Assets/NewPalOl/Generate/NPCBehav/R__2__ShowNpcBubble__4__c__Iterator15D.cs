...
{public partial class RNPCBehav
{
	...
	/// <summary>
	/// NPCBehav+<ShowNpcBubble>c__Iterator15D
	/// </summary>
    public partial class R__2__ShowNpcBubble__4__c__Iterator15D : RMember //
    {
		...
		/// </summary>
		protected RBubbleContent r_content;
		public virtual RBubbleContent Rcontent
		{
			get
			{
				if(r_content == null)
		...
		/// <summary>
		/// NPCBehav <tmpNPCb>__0
		/// </summary>
		protected RNPCBehav r___2__tmpNPCb__4____0;
		public virtual RNPCBehav R__2__tmpNPCb__4____0
		{
			get
			{
				if(r___2__tmpNPCb__4____0 == null)
				{
					r___2__tmpNPCb__4____0 = new(this, "<tmpNPCb>__0");
					r___2__tmpNPCb__4____0.SetBelong(this.instance);
				}
				return r___2__tmpNPCb__4____0;
			}
		}
		...
		/// BubbleContent <$>content
		/// </summary>
		protected RBubbleContent r___2____9____4__content;
		public virtual RBubbleContent R__2____9____4__content
		{
			get
			{
				if(r___2____9____4__content == null)
				{
					r___2____9____4__content = new(this, "<$>content");
					r___2____9____4__content.SetBelong(this.instance);
				}
				return r___2____9____4__content;
			}
		}
        ...
        public R__2__ShowNpcBubble__4__c__Iterator15D() : base("NPCBehav+<ShowNpcBubble>c__Iterator15D")
        {
        }

        public R__2__ShowNpcBubble__4__c__Iterator15D(System.Object instance) : base("NPCBehav+<ShowNpcBubble>c__Iterator15D")
		{
            SetInstance(instance);
		}

        public R__2__ShowNpcBubble__4__c__Iterator15D(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ShowNpcBubble__4__c__Iterator15D(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RNPCBehav
{
	...
	/// <summary>
	/// NPCBehav+<AnimationCullTypeReset>c__Iterator159
	/// </summary>
    public partial class R__2__AnimationCullTypeReset__4__c__Iterator159 : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RAnimation r_ani;
		public virtual RUnityEngine.RAnimation Rani
		{
			get
			{
				if(r_ani == null)
		...
		/// UnityEngine.Animation <$>ani
		/// </summary>
		protected RUnityEngine.RAnimation r___2____9____4__ani;
		public virtual RUnityEngine.RAnimation R__2____9____4__ani
		{
			get
			{
				if(r___2____9____4__ani == null)
				{
					r___2____9____4__ani = new(this, "<$>ani");
					r___2____9____4__ani.SetBelong(this.instance);
				}
				return r___2____9____4__ani;
			}
		}
        ...
        public R__2__AnimationCullTypeReset__4__c__Iterator159() : base("NPCBehav+<AnimationCullTypeReset>c__Iterator159")
        {
        }

        public R__2__AnimationCullTypeReset__4__c__Iterator159(System.Object instance) : base("NPCBehav+<AnimationCullTypeReset>c__Iterator159")
		{
            SetInstance(instance);
		}

        public R__2__AnimationCullTypeReset__4__c__Iterator159(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__AnimationCullTypeReset__4__c__Iterator159(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

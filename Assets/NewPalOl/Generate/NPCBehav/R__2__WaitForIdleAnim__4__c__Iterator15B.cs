...
{public partial class RNPCBehav
{
	...
	/// <summary>
	/// NPCBehav+<WaitForIdleAnim>c__Iterator15B
	/// </summary>
    public partial class R__2__WaitForIdleAnim__4__c__Iterator15B : RMember //
    {
        ...
        public R__2__WaitForIdleAnim__4__c__Iterator15B() : base("NPCBehav+<WaitForIdleAnim>c__Iterator15B")
        {
        }

        public R__2__WaitForIdleAnim__4__c__Iterator15B(System.Object instance) : base("NPCBehav+<WaitForIdleAnim>c__Iterator15B")
		{
            SetInstance(instance);
		}

        public R__2__WaitForIdleAnim__4__c__Iterator15B(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__WaitForIdleAnim__4__c__Iterator15B(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

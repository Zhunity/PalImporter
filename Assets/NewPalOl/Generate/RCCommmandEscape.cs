...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CCommmandEscape
	/// </summary>
    public partial class RCCommmandEscape : RMember //
    {
		...
		/// #Pfb.#1ob #b
		/// </summary>
		protected R__0__Pfb.R__0__1ob r___0__b;
		public virtual R__0__Pfb.R__0__1ob R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// CombatEvent #c
		/// </summary>
		protected RCombatEvent r___0__c;
		public virtual RCombatEvent R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// Void #c9()
		/// </summary>
		protected RMethod r_R__0__c9;
		public virtual RMethod R__0__c9
		{
			get
			{
				if(r_R__0__c9 == null)
				{
					r_R__0__c9 = new(this, "#c9", 0);
					r_R__0__c9.SetBelong(this.instance);
				}
				return r_R__0__c9;
			}
		}
        ...
        public RCCommmandEscape() : base("CCommmandEscape")
        {
        }

        public RCCommmandEscape(System.Object instance) : base("CCommmandEscape")
		{
            SetInstance(instance);
		}

        public RCCommmandEscape(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCCommmandEscape(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }


        public virtual void __0__c9()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__c9.Invoke(___genericsType, ___parameters);

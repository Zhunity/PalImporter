...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SoundEffect
	/// </summary>
    public partial class RSoundEffect : RMember //
    {
        ...
        public RSoundEffect() : base("SoundEffect")
        {
        }

        public RSoundEffect(System.Object instance) : base("SoundEffect")
		{
            SetInstance(instance);
		}

        public RSoundEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSoundEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

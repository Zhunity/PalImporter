...
{
	/// <summary>
	/// CustomSendMouseEvents
	/// </summary>
    public partial class RCustomSendMouseEvents : RMember //
    {

		/// <summary>
		/// System.Boolean isFog
		/// </summary>
		protected RField r_isFog;
		public virtual RField RisFog
		{
			get
			{
				if(r_isFog == null)
				{
					r_isFog = new(this, "isFog");
					r_isFog.SetBelong(this.instance);
				}
				return r_isFog;
			}
		}
		...
		/// <summary>
		/// CustomSendMouseEvents+MouseOverPair[] m_OldMouseDrag
		/// </summary>
		protected RFieldArray<RCustomSendMouseEvents.RMouseOverPair> r_m_OldMouseDrag;
		public virtual RFieldArray<RCustomSendMouseEvents.RMouseOverPair> Rm_OldMouseDrag
		{
			get
			{
		...
		/// <summary>
		/// CustomSendMouseEvents+MouseOverPair[] m_OldMouseOver
		/// </summary>
		protected RFieldArray<RCustomSendMouseEvents.RMouseOverPair> r_m_OldMouseOver;
		public virtual RFieldArray<RCustomSendMouseEvents.RMouseOverPair> Rm_OldMouseOver
		{
			get
			{
		...
		/// <summary>
		/// MyGUIFormationWnd matrixWnd
		/// </summary>
		protected RMyGUIFormationWnd r_matrixWnd;
		public virtual RMyGUIFormationWnd RmatrixWnd
		{
			get
			{
				if(r_matrixWnd == null)
				{
					r_matrixWnd = new(this, "matrixWnd");
					r_matrixWnd.SetBelong(this.instance);
				}
				return r_matrixWnd;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RCamera r__camera;
		public virtual RUnityEngine.RCamera R_camera
		{
			get
			{
				if(r__camera == null)
				{
					r__camera = new(this, "_camera");
					r__camera.SetBelong(this.instance);
				}
				return r__camera;
			}
		}
		...
		/// <summary>
		/// MyGUIWindow hoverWindow
		/// </summary>
		protected RMyGUIWindow r_hoverWindow;
		public virtual RMyGUIWindow RhoverWindow
		{
			get
			{
				if(r_hoverWindow == null)
				{
					r_hoverWindow = new(this, "hoverWindow");
					r_hoverWindow.SetBelong(this.instance);
				}
				return r_hoverWindow;
			}
		}
		...
		/// <summary>
		/// Void DoSendMouseEvents()
		/// </summary>
		protected RMethod r_RDoSendMouseEvents;
		public virtual RMethod RDoSendMouseEvents
		{
			get
			{
				if(r_RDoSendMouseEvents == null)
				{
					r_RDoSendMouseEvents = new(this, "DoSendMouseEvents", 0);
					r_RDoSendMouseEvents.SetBelong(this.instance);
				}
				return r_RDoSendMouseEvents;
			}
		}
        ...
        public RCustomSendMouseEvents() : base("CustomSendMouseEvents")
        {
        }

        public RCustomSendMouseEvents(System.Object instance) : base("CustomSendMouseEvents")
		{
            SetInstance(instance);
		}

        public RCustomSendMouseEvents(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCustomSendMouseEvents(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void DoSendMouseEvents()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RDoSendMouseEvents.Invoke(___genericsType, ___parameters);

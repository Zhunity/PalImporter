...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CameraMove
	/// </summary>
    public partial class RCameraMove : RMember //
    {
		...
		/// System.Int32 mod
		/// </summary>
		protected RField r_mod;
		public virtual RField Rmod
		{
			get
			{
				if(r_mod == null)
        ...
        public RCameraMove() : base("CameraMove")
        {
        }

        public RCameraMove(System.Object instance) : base("CameraMove")
		{
            SetInstance(instance);
		}

        public RCameraMove(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCameraMove(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

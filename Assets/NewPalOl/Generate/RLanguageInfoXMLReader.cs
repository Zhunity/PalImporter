...
{
	/// <summary>
	/// LanguageInfoXMLReader
	/// </summary>
    public partial class RLanguageInfoXMLReader : RMember //
    {
        ...
        public RLanguageInfoXMLReader() : base("LanguageInfoXMLReader")
        {
        }

        public RLanguageInfoXMLReader(System.Object instance) : base("LanguageInfoXMLReader")
		{
            SetInstance(instance);
		}

        public RLanguageInfoXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RLanguageInfoXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// AreaXMLReader
	/// </summary>
    public partial class RAreaXMLReader : RMember //
    {
        ...
        public RAreaXMLReader() : base("AreaXMLReader")
        {
        }

        public RAreaXMLReader(System.Object instance) : base("AreaXMLReader")
		{
            SetInstance(instance);
		}

        public RAreaXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAreaXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

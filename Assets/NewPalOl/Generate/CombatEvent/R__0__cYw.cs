...
{public partial class RCombatEvent
{
	...
	/// CombatEvent+#cYw
	/// </summary>
    public partial class R__0__cYw : RMember //
    {
        ...
        public R__0__cYw() : base("CombatEvent+#cYw")
        {
        }

        public R__0__cYw(System.Object instance) : base("CombatEvent+#cYw")
		{
            SetInstance(instance);
		}

        public R__0__cYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

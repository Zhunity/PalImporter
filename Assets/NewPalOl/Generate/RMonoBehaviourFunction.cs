...
{
	/// <summary>
	/// MonoBehaviourFunction
	/// </summary>
    public partial class RMonoBehaviourFunction : RMember //
    {
        ...
        public RMonoBehaviourFunction() : base("MonoBehaviourFunction")
        {
        }

        public RMonoBehaviourFunction(System.Object instance) : base("MonoBehaviourFunction")
		{
            SetInstance(instance);
		}

        public RMonoBehaviourFunction(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMonoBehaviourFunction(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

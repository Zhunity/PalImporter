...
{public partial class RDragPrefab
{
	...
	/// <summary>
	/// DragPrefab+<PlayAttackOnMouseDown>c__Iterator44
	/// </summary>
    public partial class R__2__PlayAttackOnMouseDown__4__c__Iterator44 : RMember //
    {

		/// <summary>
		/// UnityEngine.Animation <ani>__0
		/// </summary>
		protected RUnityEngine.RAnimation r___2__ani__4____0;
		public virtual RUnityEngine.RAnimation R__2__ani__4____0
		{
			get
			{
				if(r___2__ani__4____0 == null)
				{
					r___2__ani__4____0 = new(this, "<ani>__0");
					r___2__ani__4____0.SetBelong(this.instance);
				}
				return r___2__ani__4____0;
			}
		}

		/// <summary>
		/// UnityEngine.AnimationClip <tmpAC>__1
		/// </summary>
		protected RUnityEngine.RAnimationClip r___2__tmpAC__4____1;
		public virtual RUnityEngine.RAnimationClip R__2__tmpAC__4____1
		{
			get
			{
				if(r___2__tmpAC__4____1 == null)
				{
					r___2__tmpAC__4____1 = new(this, "<tmpAC>__1");
					r___2__tmpAC__4____1.SetBelong(this.instance);
				}
				return r___2__tmpAC__4____1;
			}
		}
		...
		/// DragPrefab <>f__this
		/// </summary>
		protected RDragPrefab r___2____4__f__this;
		public virtual RDragPrefab R__2____4__f__this
		{
			get
			{
        ...
        public R__2__PlayAttackOnMouseDown__4__c__Iterator44() : base("DragPrefab+<PlayAttackOnMouseDown>c__Iterator44")
        {
        }

        public R__2__PlayAttackOnMouseDown__4__c__Iterator44(System.Object instance) : base("DragPrefab+<PlayAttackOnMouseDown>c__Iterator44")
		{
            SetInstance(instance);
		}

        public R__2__PlayAttackOnMouseDown__4__c__Iterator44(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__PlayAttackOnMouseDown__4__c__Iterator44(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RDragPrefab
{
	...
	/// <summary>
	/// DragPrefab+<PlayIdle>c__Iterator43
	/// </summary>
    public partial class R__2__PlayIdle__4__c__Iterator43 : RMember //
    {
        ...
        public R__2__PlayIdle__4__c__Iterator43() : base("DragPrefab+<PlayIdle>c__Iterator43")
        {
        }

        public R__2__PlayIdle__4__c__Iterator43(System.Object instance) : base("DragPrefab+<PlayIdle>c__Iterator43")
		{
            SetInstance(instance);
		}

        public R__2__PlayIdle__4__c__Iterator43(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__PlayIdle__4__c__Iterator43(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

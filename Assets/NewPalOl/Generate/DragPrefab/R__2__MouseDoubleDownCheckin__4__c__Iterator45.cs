...
{public partial class RDragPrefab
{
	...
	/// <summary>
	/// DragPrefab+<MouseDoubleDownCheckin>c__Iterator45
	/// </summary>
    public partial class R__2__MouseDoubleDownCheckin__4__c__Iterator45 : RMember //
    {
        ...
        public R__2__MouseDoubleDownCheckin__4__c__Iterator45() : base("DragPrefab+<MouseDoubleDownCheckin>c__Iterator45")
        {
        }

        public R__2__MouseDoubleDownCheckin__4__c__Iterator45(System.Object instance) : base("DragPrefab+<MouseDoubleDownCheckin>c__Iterator45")
		{
            SetInstance(instance);
		}

        public R__2__MouseDoubleDownCheckin__4__c__Iterator45(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__MouseDoubleDownCheckin__4__c__Iterator45(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

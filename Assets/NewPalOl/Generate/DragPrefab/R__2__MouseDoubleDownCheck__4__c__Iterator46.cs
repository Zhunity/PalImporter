...
{public partial class RDragPrefab
{
	...
	/// <summary>
	/// DragPrefab+<MouseDoubleDownCheck>c__Iterator46
	/// </summary>
    public partial class R__2__MouseDoubleDownCheck__4__c__Iterator46 : RMember //
    {
        ...
        public R__2__MouseDoubleDownCheck__4__c__Iterator46() : base("DragPrefab+<MouseDoubleDownCheck>c__Iterator46")
        {
        }

        public R__2__MouseDoubleDownCheck__4__c__Iterator46(System.Object instance) : base("DragPrefab+<MouseDoubleDownCheck>c__Iterator46")
		{
            SetInstance(instance);
		}

        public R__2__MouseDoubleDownCheck__4__c__Iterator46(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__MouseDoubleDownCheck__4__c__Iterator46(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

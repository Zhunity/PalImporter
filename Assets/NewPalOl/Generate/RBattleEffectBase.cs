...
namespace SMFrame.Editor.Refleaction
{
	...
	/// BattleEffectBase
	/// </summary>
    public partial class RBattleEffectBase : RMember //
    {
        ...
        public RBattleEffectBase() : base("BattleEffectBase")
        {
        }

        public RBattleEffectBase(System.Object instance) : base("BattleEffectBase")
		{
            SetInstance(instance);
		}

        public RBattleEffectBase(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBattleEffectBase(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

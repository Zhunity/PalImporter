...
{public partial class RCreatureBehav
{
	...
	/// <summary>
	/// CreatureBehav+<UpdateCDtimeProgressBar>c__Iterator154
	/// </summary>
    public partial class R__2__UpdateCDtimeProgressBar__4__c__Iterator154 : RMember //
    {
		...
		/// System.Single <$>_time
		/// </summary>
		protected RField r___2____9____4___time;
		public virtual RField R__2____9____4___time
		{
			get
			{
				if(r___2____9____4___time == null)
				{
					r___2____9____4___time = new(this, "<$>_time");
					r___2____9____4___time.SetBelong(this.instance);
				}
				return r___2____9____4___time;
			}
		}
        ...
        public R__2__UpdateCDtimeProgressBar__4__c__Iterator154() : base("CreatureBehav+<UpdateCDtimeProgressBar>c__Iterator154")
        {
        }

        public R__2__UpdateCDtimeProgressBar__4__c__Iterator154(System.Object instance) : base("CreatureBehav+<UpdateCDtimeProgressBar>c__Iterator154")
		{
            SetInstance(instance);
		}

        public R__2__UpdateCDtimeProgressBar__4__c__Iterator154(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__UpdateCDtimeProgressBar__4__c__Iterator154(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

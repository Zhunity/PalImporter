...
{public partial class RCreatureBehav
{
	...
	/// <summary>
	/// CreatureBehav+BehaveMouseHandle
	/// </summary>
    public partial class RBehaveMouseHandle : RMember //
    {
        ...
        public RBehaveMouseHandle() : base("CreatureBehav+BehaveMouseHandle")
        {
        }

        public RBehaveMouseHandle(System.Object instance) : base("CreatureBehav+BehaveMouseHandle")
		{
            SetInstance(instance);
		}

        public RBehaveMouseHandle(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBehaveMouseHandle(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

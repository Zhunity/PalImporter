...
{public partial class RCreatureBehav
{
	...
	/// <summary>
	/// CreatureBehav+<UpdatePopText>c__Iterator152
	/// </summary>
    public partial class R__2__UpdatePopText__4__c__Iterator152 : RMember //
    {
        ...
        public R__2__UpdatePopText__4__c__Iterator152() : base("CreatureBehav+<UpdatePopText>c__Iterator152")
        {
        }

        public R__2__UpdatePopText__4__c__Iterator152(System.Object instance) : base("CreatureBehav+<UpdatePopText>c__Iterator152")
		{
            SetInstance(instance);
		}

        public R__2__UpdatePopText__4__c__Iterator152(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__UpdatePopText__4__c__Iterator152(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

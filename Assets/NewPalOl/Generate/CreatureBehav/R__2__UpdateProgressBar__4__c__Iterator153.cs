...
{public partial class RCreatureBehav
{
	...
	/// <summary>
	/// CreatureBehav+<UpdateProgressBar>c__Iterator153
	/// </summary>
    public partial class R__2__UpdateProgressBar__4__c__Iterator153 : RMember //
    {
        ...
        public R__2__UpdateProgressBar__4__c__Iterator153() : base("CreatureBehav+<UpdateProgressBar>c__Iterator153")
        {
        }

        public R__2__UpdateProgressBar__4__c__Iterator153(System.Object instance) : base("CreatureBehav+<UpdateProgressBar>c__Iterator153")
		{
            SetInstance(instance);
		}

        public R__2__UpdateProgressBar__4__c__Iterator153(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__UpdateProgressBar__4__c__Iterator153(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

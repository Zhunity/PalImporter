...
{public partial class RCreatureBehav
{
	...
	/// <summary>
	/// CreatureBehav+<ListenMouseCancel>c__Iterator151
	/// </summary>
    public partial class R__2__ListenMouseCancel__4__c__Iterator151 : RMember //
    {
        ...
        public R__2__ListenMouseCancel__4__c__Iterator151() : base("CreatureBehav+<ListenMouseCancel>c__Iterator151")
        {
        }

        public R__2__ListenMouseCancel__4__c__Iterator151(System.Object instance) : base("CreatureBehav+<ListenMouseCancel>c__Iterator151")
		{
            SetInstance(instance);
		}

        public R__2__ListenMouseCancel__4__c__Iterator151(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ListenMouseCancel__4__c__Iterator151(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

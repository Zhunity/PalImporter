...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ure
	/// </summary>
    public partial class R__0__ure : RMember //
    {
        ...
        public R__0__ure() : base("#Pfb.#ure")
        {
        }

        public R__0__ure(System.Object instance) : base("#Pfb.#ure")
		{
            SetInstance(instance);
		}

        public R__0__ure(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ure(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

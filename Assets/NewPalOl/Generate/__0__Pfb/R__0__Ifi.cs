...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ifi
	/// </summary>
    public partial class R__0__Ifi : RMember //
    {
        ...
        public R__0__Ifi() : base("#Pfb.#Ifi")
        {
        }

        public R__0__Ifi(System.Object instance) : base("#Pfb.#Ifi")
		{
            SetInstance(instance);
		}

        public R__0__Ifi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ifi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#IOi
	/// </summary>
    public partial class R__0__IOi : RMember //
    {
        ...
        public R__0__IOi() : base("#Pfb.#IOi")
        {
        }

        public R__0__IOi(System.Object instance) : base("#Pfb.#IOi")
		{
            SetInstance(instance);
		}

        public R__0__IOi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__IOi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#6Fd
	/// </summary>
    public partial class R__0__6Fd : RMember //
    {
        ...
        public R__0__6Fd() : base("#Pfb.#6Fd")
        {
        }

        public R__0__6Fd(System.Object instance) : base("#Pfb.#6Fd")
		{
            SetInstance(instance);
		}

        public R__0__6Fd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6Fd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

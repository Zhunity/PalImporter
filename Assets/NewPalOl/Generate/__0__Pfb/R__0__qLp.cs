...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#qLp
	/// </summary>
    public partial class R__0__qLp : RMember //
    {
        ...
        public R__0__qLp() : base("#Pfb.#qLp")
        {
        }

        public R__0__qLp(System.Object instance) : base("#Pfb.#qLp")
		{
            SetInstance(instance);
		}

        public R__0__qLp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__qLp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

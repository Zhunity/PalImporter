...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ACb
	/// </summary>
    public partial class R__0__ACb : RMember //
    {
        ...
        public R__0__ACb() : base("#Pfb.#ACb")
        {
        }

        public R__0__ACb(System.Object instance) : base("#Pfb.#ACb")
		{
            SetInstance(instance);
		}

        public R__0__ACb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ACb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

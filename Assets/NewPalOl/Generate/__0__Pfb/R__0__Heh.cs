...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Heh
	/// </summary>
    public partial class R__0__Heh : RMember //
    {
        ...
        public R__0__Heh() : base("#Pfb.#Heh")
        {
        }

        public R__0__Heh(System.Object instance) : base("#Pfb.#Heh")
		{
            SetInstance(instance);
		}

        public R__0__Heh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Heh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#jEo
	/// </summary>
    public partial class R__0__jEo : RMember //
    {
        ...
        public R__0__jEo() : base("#Pfb.#jEo")
        {
        }

        public R__0__jEo(System.Object instance) : base("#Pfb.#jEo")
		{
            SetInstance(instance);
		}

        public R__0__jEo(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jEo(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#VVj
	/// </summary>
    public partial class R__0__VVj : RMember //
    {
        ...
        public R__0__VVj() : base("#Pfb.#VVj")
        {
        }

        public R__0__VVj(System.Object instance) : base("#Pfb.#VVj")
		{
            SetInstance(instance);
		}

        public R__0__VVj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__VVj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

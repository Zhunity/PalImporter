...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wih
	/// </summary>
    public partial class R__0__Wih : RMember //
    {
        ...
        public R__0__Wih() : base("#Pfb.#Wih")
        {
        }

        public R__0__Wih(System.Object instance) : base("#Pfb.#Wih")
		{
            SetInstance(instance);
		}

        public R__0__Wih(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wih(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

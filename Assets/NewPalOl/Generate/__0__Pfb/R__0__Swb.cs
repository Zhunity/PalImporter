...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Swb
	/// </summary>
    public partial class R__0__Swb : RMember //
    {
        ...
        public R__0__Swb() : base("#Pfb.#Swb")
        {
        }

        public R__0__Swb(System.Object instance) : base("#Pfb.#Swb")
		{
            SetInstance(instance);
		}

        public R__0__Swb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Swb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

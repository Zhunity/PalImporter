...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Cpb
	/// </summary>
    public partial class R__0__Cpb : RMember //
    {
        ...
        public R__0__Cpb() : base("#Pfb.#Cpb")
        {
        }

        public R__0__Cpb(System.Object instance) : base("#Pfb.#Cpb")
		{
            SetInstance(instance);
		}

        public R__0__Cpb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Cpb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

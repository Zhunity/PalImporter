...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#P2k
	/// </summary>
    public partial class R__0__P2k : RMember //
    {
        ...
        public R__0__P2k() : base("#Pfb.#P2k")
        {
        }

        public R__0__P2k(System.Object instance) : base("#Pfb.#P2k")
		{
            SetInstance(instance);
		}

        public R__0__P2k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__P2k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Xfi
	/// </summary>
    public partial class R__0__Xfi : RMember //
    {
        ...
        public R__0__Xfi() : base("#Pfb.#Xfi")
        {
        }

        public R__0__Xfi(System.Object instance) : base("#Pfb.#Xfi")
		{
            SetInstance(instance);
		}

        public R__0__Xfi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Xfi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#jdr
	/// </summary>
    public partial class R__0__jdr : RMember //
    {
        ...
        public R__0__jdr() : base("#Pfb.#jdr")
        {
        }

        public R__0__jdr(System.Object instance) : base("#Pfb.#jdr")
		{
            SetInstance(instance);
		}

        public R__0__jdr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jdr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

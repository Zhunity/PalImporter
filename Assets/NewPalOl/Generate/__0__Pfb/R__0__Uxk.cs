...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Uxk
	/// </summary>
    public partial class R__0__Uxk : RMember //
    {
        ...
        public R__0__Uxk() : base("#Pfb.#Uxk")
        {
        }

        public R__0__Uxk(System.Object instance) : base("#Pfb.#Uxk")
		{
            SetInstance(instance);
		}

        public R__0__Uxk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Uxk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

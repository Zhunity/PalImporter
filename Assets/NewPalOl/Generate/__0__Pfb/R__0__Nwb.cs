...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Nwb
	/// </summary>
    public partial class R__0__Nwb : RMember //
    {
        ...
        public R__0__Nwb() : base("#Pfb.#Nwb")
        {
        }

        public R__0__Nwb(System.Object instance) : base("#Pfb.#Nwb")
		{
            SetInstance(instance);
		}

        public R__0__Nwb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Nwb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

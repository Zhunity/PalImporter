...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ksx
	/// </summary>
    public partial class R__0__ksx : RMember //
    {
        ...
        public R__0__ksx() : base("#Pfb.#ksx")
        {
        }

        public R__0__ksx(System.Object instance) : base("#Pfb.#ksx")
		{
            SetInstance(instance);
		}

        public R__0__ksx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ksx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

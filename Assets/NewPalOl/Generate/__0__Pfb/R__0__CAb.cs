...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#CAb
	/// </summary>
    public partial class R__0__CAb : RMember //
    {
        ...
        public R__0__CAb() : base("#Pfb.#CAb")
        {
        }

        public R__0__CAb(System.Object instance) : base("#Pfb.#CAb")
		{
            SetInstance(instance);
		}

        public R__0__CAb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__CAb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

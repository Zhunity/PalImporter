...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#dXe
	/// </summary>
    public partial class R__0__dXe : RMember //
    {
        ...
        public R__0__dXe() : base("#Pfb.#dXe")
        {
        }

        public R__0__dXe(System.Object instance) : base("#Pfb.#dXe")
		{
            SetInstance(instance);
		}

        public R__0__dXe(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dXe(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

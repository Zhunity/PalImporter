...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Vcr
	/// </summary>
    public partial class R__0__Vcr : RMember //
    {
        ...
        public R__0__Vcr() : base("#Pfb.#Vcr")
        {
        }

        public R__0__Vcr(System.Object instance) : base("#Pfb.#Vcr")
		{
            SetInstance(instance);
		}

        public R__0__Vcr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vcr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

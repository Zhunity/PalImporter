...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4Bw
	/// </summary>
    public partial class R__0__4Bw : RMember //
    {
        ...
        public R__0__4Bw() : base("#Pfb.#4Bw")
        {
        }

        public R__0__4Bw(System.Object instance) : base("#Pfb.#4Bw")
		{
            SetInstance(instance);
		}

        public R__0__4Bw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4Bw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

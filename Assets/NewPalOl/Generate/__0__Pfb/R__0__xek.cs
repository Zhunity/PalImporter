...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#xek
	/// </summary>
    public partial class R__0__xek : RMember //
    {
        ...
        public R__0__xek() : base("#Pfb.#xek")
        {
        }

        public R__0__xek(System.Object instance) : base("#Pfb.#xek")
		{
            SetInstance(instance);
		}

        public R__0__xek(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__xek(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#fDi
	/// </summary>
    public partial class R__0__fDi : RMember //
    {
        ...
        public R__0__fDi() : base("#Pfb.#fDi")
        {
        }

        public R__0__fDi(System.Object instance) : base("#Pfb.#fDi")
		{
            SetInstance(instance);
		}

        public R__0__fDi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fDi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

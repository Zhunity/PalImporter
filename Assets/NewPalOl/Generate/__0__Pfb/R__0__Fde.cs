...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Fde
	/// </summary>
    public partial class R__0__Fde : RMember //
    {
        ...
        public R__0__Fde() : base("#Pfb.#Fde")
        {
        }

        public R__0__Fde(System.Object instance) : base("#Pfb.#Fde")
		{
            SetInstance(instance);
		}

        public R__0__Fde(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Fde(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

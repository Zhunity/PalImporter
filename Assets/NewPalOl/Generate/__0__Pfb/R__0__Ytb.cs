...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ytb
	/// </summary>
    public partial class R__0__Ytb : RMember //
    {
        ...
        public R__0__Ytb() : base("#Pfb.#Ytb")
        {
        }

        public R__0__Ytb(System.Object instance) : base("#Pfb.#Ytb")
		{
            SetInstance(instance);
		}

        public R__0__Ytb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ytb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

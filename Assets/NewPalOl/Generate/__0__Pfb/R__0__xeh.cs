...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#xeh
	/// </summary>
    public partial class R__0__xeh : RMember //
    {
        ...
        public R__0__xeh() : base("#Pfb.#xeh")
        {
        }

        public R__0__xeh(System.Object instance) : base("#Pfb.#xeh")
		{
            SetInstance(instance);
		}

        public R__0__xeh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__xeh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

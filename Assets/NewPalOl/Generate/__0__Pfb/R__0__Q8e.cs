...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Q8e
	/// </summary>
    public partial class R__0__Q8e : RMember //
    {
        ...
        public R__0__Q8e() : base("#Pfb.#Q8e")
        {
        }

        public R__0__Q8e(System.Object instance) : base("#Pfb.#Q8e")
		{
            SetInstance(instance);
		}

        public R__0__Q8e(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Q8e(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

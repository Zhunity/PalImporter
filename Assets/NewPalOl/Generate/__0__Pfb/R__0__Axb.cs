...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Axb
	/// </summary>
    public partial class R__0__Axb : RMember //
    {
        ...
        public R__0__Axb() : base("#Pfb.#Axb")
        {
        }

        public R__0__Axb(System.Object instance) : base("#Pfb.#Axb")
		{
            SetInstance(instance);
		}

        public R__0__Axb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Axb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

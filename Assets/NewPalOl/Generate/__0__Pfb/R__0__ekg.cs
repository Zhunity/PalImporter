...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ekg
	/// </summary>
    public partial class R__0__ekg : RMember //
    {
        ...
        public R__0__ekg() : base("#Pfb.#ekg")
        {
        }

        public R__0__ekg(System.Object instance) : base("#Pfb.#ekg")
		{
            SetInstance(instance);
		}

        public R__0__ekg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ekg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

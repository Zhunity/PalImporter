...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#6px
	/// </summary>
    public partial class R__0__6px : RMember //
    {
        ...
        public R__0__6px() : base("#Pfb.#6px")
        {
        }

        public R__0__6px(System.Object instance) : base("#Pfb.#6px")
		{
            SetInstance(instance);
		}

        public R__0__6px(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6px(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

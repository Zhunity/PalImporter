...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#zek
	/// </summary>
    public partial class R__0__zek : RMember //
    {
        ...
        public R__0__zek() : base("#Pfb.#zek")
        {
        }

        public R__0__zek(System.Object instance) : base("#Pfb.#zek")
		{
            SetInstance(instance);
		}

        public R__0__zek(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zek(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#JHn
	/// </summary>
    public partial class R__0__JHn : RMember //
    {
        ...
        public R__0__JHn() : base("#Pfb.#JHn")
        {
        }

        public R__0__JHn(System.Object instance) : base("#Pfb.#JHn")
		{
            SetInstance(instance);
		}

        public R__0__JHn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__JHn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

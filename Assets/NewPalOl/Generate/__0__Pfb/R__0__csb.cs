...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#csb
	/// </summary>
    public partial class R__0__csb : RMember //
    {
        ...
        public R__0__csb() : base("#Pfb.#csb")
        {
        }

        public R__0__csb(System.Object instance) : base("#Pfb.#csb")
		{
            SetInstance(instance);
		}

        public R__0__csb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__csb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

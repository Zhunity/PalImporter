...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ijg
	/// </summary>
    public partial class R__0__Ijg : RMember //
    {
        ...
        public R__0__Ijg() : base("#Pfb.#Ijg")
        {
        }

        public R__0__Ijg(System.Object instance) : base("#Pfb.#Ijg")
		{
            SetInstance(instance);
		}

        public R__0__Ijg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ijg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

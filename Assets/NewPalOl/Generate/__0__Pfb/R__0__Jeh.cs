...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Jeh
	/// </summary>
    public partial class R__0__Jeh : RMember //
    {
        ...
        public R__0__Jeh() : base("#Pfb.#Jeh")
        {
        }

        public R__0__Jeh(System.Object instance) : base("#Pfb.#Jeh")
		{
            SetInstance(instance);
		}

        public R__0__Jeh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Jeh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9ce
	/// </summary>
    public partial class R__0__9ce : RMember //
    {
        ...
        public R__0__9ce() : base("#Pfb.#9ce")
        {
        }

        public R__0__9ce(System.Object instance) : base("#Pfb.#9ce")
		{
            SetInstance(instance);
		}

        public R__0__9ce(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9ce(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

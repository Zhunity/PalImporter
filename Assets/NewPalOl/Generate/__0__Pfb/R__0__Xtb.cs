...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Xtb
	/// </summary>
    public partial class R__0__Xtb : RMember //
    {
        ...
        public R__0__Xtb() : base("#Pfb.#Xtb")
        {
        }

        public R__0__Xtb(System.Object instance) : base("#Pfb.#Xtb")
		{
            SetInstance(instance);
		}

        public R__0__Xtb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Xtb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

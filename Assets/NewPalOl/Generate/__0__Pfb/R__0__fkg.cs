...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#fkg
	/// </summary>
    public partial class R__0__fkg : RMember //
    {
        ...
        public R__0__fkg() : base("#Pfb.#fkg")
        {
        }

        public R__0__fkg(System.Object instance) : base("#Pfb.#fkg")
		{
            SetInstance(instance);
		}

        public R__0__fkg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fkg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Hnw
	/// </summary>
    public partial class R__0__Hnw : RMember //
    {
        ...
        public R__0__Hnw() : base("#Pfb.#Hnw")
        {
        }

        public R__0__Hnw(System.Object instance) : base("#Pfb.#Hnw")
		{
            SetInstance(instance);
		}

        public R__0__Hnw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Hnw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

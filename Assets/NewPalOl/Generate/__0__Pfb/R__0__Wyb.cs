...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wyb
	/// </summary>
    public partial class R__0__Wyb : RMember //
    {
        ...
        public R__0__Wyb() : base("#Pfb.#Wyb")
        {
        }

        public R__0__Wyb(System.Object instance) : base("#Pfb.#Wyb")
		{
            SetInstance(instance);
		}

        public R__0__Wyb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wyb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Jhs
	/// </summary>
    public partial class R__0__Jhs : RMember //
    {
        ...
        public R__0__Jhs() : base("#Pfb.#Jhs")
        {
        }

        public R__0__Jhs(System.Object instance) : base("#Pfb.#Jhs")
		{
            SetInstance(instance);
		}

        public R__0__Jhs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Jhs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

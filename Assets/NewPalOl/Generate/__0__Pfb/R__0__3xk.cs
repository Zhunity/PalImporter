...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#3xk
	/// </summary>
    public partial class R__0__3xk : RMember //
    {
        ...
        public R__0__3xk() : base("#Pfb.#3xk")
        {
        }

        public R__0__3xk(System.Object instance) : base("#Pfb.#3xk")
		{
            SetInstance(instance);
		}

        public R__0__3xk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3xk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

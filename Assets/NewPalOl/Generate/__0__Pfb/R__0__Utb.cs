...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Utb
	/// </summary>
    public partial class R__0__Utb : RMember //
    {
        ...
        public R__0__Utb() : base("#Pfb.#Utb")
        {
        }

        public R__0__Utb(System.Object instance) : base("#Pfb.#Utb")
		{
            SetInstance(instance);
		}

        public R__0__Utb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Utb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

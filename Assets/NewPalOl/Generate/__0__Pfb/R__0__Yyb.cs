...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Yyb
	/// </summary>
    public partial class R__0__Yyb : RMember //
    {
        ...
        public R__0__Yyb() : base("#Pfb.#Yyb")
        {
        }

        public R__0__Yyb(System.Object instance) : base("#Pfb.#Yyb")
		{
            SetInstance(instance);
		}

        public R__0__Yyb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Yyb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

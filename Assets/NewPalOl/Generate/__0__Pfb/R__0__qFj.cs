...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#qFj
	/// </summary>
    public partial class R__0__qFj : RMember //
    {
        ...
        public R__0__qFj() : base("#Pfb.#qFj")
        {
        }

        public R__0__qFj(System.Object instance) : base("#Pfb.#qFj")
		{
            SetInstance(instance);
		}

        public R__0__qFj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__qFj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

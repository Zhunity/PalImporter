...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#wvb
	/// </summary>
    public partial class R__0__wvb : RMember //
    {
        ...
        public R__0__wvb() : base("#Pfb.#wvb")
        {
        }

        public R__0__wvb(System.Object instance) : base("#Pfb.#wvb")
		{
            SetInstance(instance);
		}

        public R__0__wvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__wvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

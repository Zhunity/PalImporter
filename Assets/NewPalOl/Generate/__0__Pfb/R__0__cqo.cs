...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#cqo
	/// </summary>
    public partial class R__0__cqo : RMember //
    {
        ...
        public R__0__cqo() : base("#Pfb.#cqo")
        {
        }

        public R__0__cqo(System.Object instance) : base("#Pfb.#cqo")
		{
            SetInstance(instance);
		}

        public R__0__cqo(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cqo(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

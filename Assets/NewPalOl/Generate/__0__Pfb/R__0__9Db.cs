...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9Db
	/// </summary>
    public partial class R__0__9Db : RMember //
    {
        ...
        public R__0__9Db() : base("#Pfb.#9Db")
        {
        }

        public R__0__9Db(System.Object instance) : base("#Pfb.#9Db")
		{
            SetInstance(instance);
		}

        public R__0__9Db(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Db(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

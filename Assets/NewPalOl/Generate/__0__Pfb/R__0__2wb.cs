...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#2wb
	/// </summary>
    public partial class R__0__2wb : RMember //
    {
        ...
        public R__0__2wb() : base("#Pfb.#2wb")
        {
        }

        public R__0__2wb(System.Object instance) : base("#Pfb.#2wb")
		{
            SetInstance(instance);
		}

        public R__0__2wb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2wb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

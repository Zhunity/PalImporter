...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#dHc
	/// </summary>
    public partial class R__0__dHc : RMember //
    {
        ...
        public R__0__dHc() : base("#Pfb.#dHc")
        {
        }

        public R__0__dHc(System.Object instance) : base("#Pfb.#dHc")
		{
            SetInstance(instance);
		}

        public R__0__dHc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dHc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

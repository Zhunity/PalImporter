...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Mhs
	/// </summary>
    public partial class R__0__Mhs : RMember //
    {
        ...
        public R__0__Mhs() : base("#Pfb.#Mhs")
        {
        }

        public R__0__Mhs(System.Object instance) : base("#Pfb.#Mhs")
		{
            SetInstance(instance);
		}

        public R__0__Mhs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Mhs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

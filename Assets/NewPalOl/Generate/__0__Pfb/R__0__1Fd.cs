...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#1Fd
	/// </summary>
    public partial class R__0__1Fd : RMember //
    {
        ...
        public R__0__1Fd() : base("#Pfb.#1Fd")
        {
        }

        public R__0__1Fd(System.Object instance) : base("#Pfb.#1Fd")
		{
            SetInstance(instance);
		}

        public R__0__1Fd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1Fd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

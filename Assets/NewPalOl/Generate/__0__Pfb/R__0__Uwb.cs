...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Uwb
	/// </summary>
    public partial class R__0__Uwb : RMember //
    {
        ...
        public R__0__Uwb() : base("#Pfb.#Uwb")
        {
        }

        public R__0__Uwb(System.Object instance) : base("#Pfb.#Uwb")
		{
            SetInstance(instance);
		}

        public R__0__Uwb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Uwb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

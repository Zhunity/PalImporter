...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#oFj
	/// </summary>
    public partial class R__0__oFj : RMember //
    {
        ...
        public R__0__oFj() : base("#Pfb.#oFj")
        {
        }

        public R__0__oFj(System.Object instance) : base("#Pfb.#oFj")
		{
            SetInstance(instance);
		}

        public R__0__oFj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oFj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

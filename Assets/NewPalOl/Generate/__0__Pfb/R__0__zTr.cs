...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#zTr
	/// </summary>
    public partial class R__0__zTr : RMember //
    {
        ...
        public R__0__zTr() : base("#Pfb.#zTr")
        {
        }

        public R__0__zTr(System.Object instance) : base("#Pfb.#zTr")
		{
            SetInstance(instance);
		}

        public R__0__zTr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zTr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

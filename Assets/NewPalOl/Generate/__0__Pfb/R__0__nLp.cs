...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#nLp
	/// </summary>
    public partial class R__0__nLp : RMember //
    {
        ...
        public R__0__nLp() : base("#Pfb.#nLp")
        {
        }

        public R__0__nLp(System.Object instance) : base("#Pfb.#nLp")
		{
            SetInstance(instance);
		}

        public R__0__nLp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__nLp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

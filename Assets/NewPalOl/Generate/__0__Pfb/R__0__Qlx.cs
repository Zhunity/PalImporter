...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Qlx
	/// </summary>
    public partial class R__0__Qlx : RMember //
    {
        ...
        public R__0__Qlx() : base("#Pfb.#Qlx")
        {
        }

        public R__0__Qlx(System.Object instance) : base("#Pfb.#Qlx")
		{
            SetInstance(instance);
		}

        public R__0__Qlx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Qlx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

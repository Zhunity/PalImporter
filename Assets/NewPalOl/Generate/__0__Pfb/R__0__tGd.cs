...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#tGd
	/// </summary>
    public partial class R__0__tGd : RMember //
    {
        ...
        public R__0__tGd() : base("#Pfb.#tGd")
        {
        }

        public R__0__tGd(System.Object instance) : base("#Pfb.#tGd")
		{
            SetInstance(instance);
		}

        public R__0__tGd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__tGd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

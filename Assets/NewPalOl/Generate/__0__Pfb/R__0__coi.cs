...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#coi
	/// </summary>
    public partial class R__0__coi : RMember //
    {
        ...
        public R__0__coi() : base("#Pfb.#coi")
        {
        }

        public R__0__coi(System.Object instance) : base("#Pfb.#coi")
		{
            SetInstance(instance);
		}

        public R__0__coi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__coi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#3ig
	/// </summary>
    public partial class R__0__3ig : RMember //
    {
        ...
        public R__0__3ig() : base("#Pfb.#3ig")
        {
        }

        public R__0__3ig(System.Object instance) : base("#Pfb.#3ig")
		{
            SetInstance(instance);
		}

        public R__0__3ig(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3ig(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

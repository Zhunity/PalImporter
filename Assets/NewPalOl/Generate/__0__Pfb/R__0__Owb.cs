...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Owb
	/// </summary>
    public partial class R__0__Owb : RMember //
    {
        ...
        public R__0__Owb() : base("#Pfb.#Owb")
        {
        }

        public R__0__Owb(System.Object instance) : base("#Pfb.#Owb")
		{
            SetInstance(instance);
		}

        public R__0__Owb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Owb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

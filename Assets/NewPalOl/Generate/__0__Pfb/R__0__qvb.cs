...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#qvb
	/// </summary>
    public partial class R__0__qvb : RMember //
    {
        ...
        public R__0__qvb() : base("#Pfb.#qvb")
        {
        }

        public R__0__qvb(System.Object instance) : base("#Pfb.#qvb")
		{
            SetInstance(instance);
		}

        public R__0__qvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__qvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Dam
	/// </summary>
    public partial class R__0__Dam : RMember //
    {
        ...
        public R__0__Dam() : base("#Pfb.#Dam")
        {
        }

        public R__0__Dam(System.Object instance) : base("#Pfb.#Dam")
		{
            SetInstance(instance);
		}

        public R__0__Dam(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Dam(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

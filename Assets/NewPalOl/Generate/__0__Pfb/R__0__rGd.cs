...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#rGd
	/// </summary>
    public partial class R__0__rGd : RMember //
    {
        ...
        public R__0__rGd() : base("#Pfb.#rGd")
        {
        }

        public R__0__rGd(System.Object instance) : base("#Pfb.#rGd")
		{
            SetInstance(instance);
		}

        public R__0__rGd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__rGd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

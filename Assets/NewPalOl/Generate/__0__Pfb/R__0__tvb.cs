...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#tvb
	/// </summary>
    public partial class R__0__tvb : RMember //
    {
        ...
        public R__0__tvb() : base("#Pfb.#tvb")
        {
        }

        public R__0__tvb(System.Object instance) : base("#Pfb.#tvb")
		{
            SetInstance(instance);
		}

        public R__0__tvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__tvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

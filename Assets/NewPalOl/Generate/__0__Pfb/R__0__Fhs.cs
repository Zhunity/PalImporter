...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Fhs
	/// </summary>
    public partial class R__0__Fhs : RMember //
    {
        ...
        public R__0__Fhs() : base("#Pfb.#Fhs")
        {
        }

        public R__0__Fhs(System.Object instance) : base("#Pfb.#Fhs")
		{
            SetInstance(instance);
		}

        public R__0__Fhs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Fhs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

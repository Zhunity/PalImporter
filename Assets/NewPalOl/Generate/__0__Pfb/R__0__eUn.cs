...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#eUn
	/// </summary>
    public partial class R__0__eUn : RMember //
    {
        ...
        public R__0__eUn() : base("#Pfb.#eUn")
        {
        }

        public R__0__eUn(System.Object instance) : base("#Pfb.#eUn")
		{
            SetInstance(instance);
		}

        public R__0__eUn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__eUn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

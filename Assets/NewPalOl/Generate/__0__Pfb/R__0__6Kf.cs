...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#6Kf
	/// </summary>
    public partial class R__0__6Kf : RMember //
    {
        ...
        public R__0__6Kf() : base("#Pfb.#6Kf")
        {
        }

        public R__0__6Kf(System.Object instance) : base("#Pfb.#6Kf")
		{
            SetInstance(instance);
		}

        public R__0__6Kf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6Kf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

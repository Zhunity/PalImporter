...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#92k
	/// </summary>
    public partial class R__0__92k : RMember //
    {
        ...
        public R__0__92k() : base("#Pfb.#92k")
        {
        }

        public R__0__92k(System.Object instance) : base("#Pfb.#92k")
		{
            SetInstance(instance);
		}

        public R__0__92k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__92k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

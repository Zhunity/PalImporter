...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#eHc
	/// </summary>
    public partial class R__0__eHc : RMember //
    {
        ...
        public R__0__eHc() : base("#Pfb.#eHc")
        {
        }

        public R__0__eHc(System.Object instance) : base("#Pfb.#eHc")
		{
            SetInstance(instance);
		}

        public R__0__eHc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__eHc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

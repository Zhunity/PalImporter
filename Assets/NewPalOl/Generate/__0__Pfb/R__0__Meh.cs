...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Meh
	/// </summary>
    public partial class R__0__Meh : RMember //
    {
        ...
        public R__0__Meh() : base("#Pfb.#Meh")
        {
        }

        public R__0__Meh(System.Object instance) : base("#Pfb.#Meh")
		{
            SetInstance(instance);
		}

        public R__0__Meh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Meh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#1Ci
	/// </summary>
    public partial class R__0__1Ci : RMember //
    {
        ...
        public R__0__1Ci() : base("#Pfb.#1Ci")
        {
        }

        public R__0__1Ci(System.Object instance) : base("#Pfb.#1Ci")
		{
            SetInstance(instance);
		}

        public R__0__1Ci(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1Ci(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

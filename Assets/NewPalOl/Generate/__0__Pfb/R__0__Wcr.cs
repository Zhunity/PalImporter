...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wcr
	/// </summary>
    public partial class R__0__Wcr : RMember //
    {
        ...
        public R__0__Wcr() : base("#Pfb.#Wcr")
        {
        }

        public R__0__Wcr(System.Object instance) : base("#Pfb.#Wcr")
		{
            SetInstance(instance);
		}

        public R__0__Wcr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wcr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

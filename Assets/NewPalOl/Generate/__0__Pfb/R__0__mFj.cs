...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#mFj
	/// </summary>
    public partial class R__0__mFj : RMember //
    {
        ...
        public R__0__mFj() : base("#Pfb.#mFj")
        {
        }

        public R__0__mFj(System.Object instance) : base("#Pfb.#mFj")
		{
            SetInstance(instance);
		}

        public R__0__mFj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__mFj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

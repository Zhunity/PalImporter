...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Yfi
	/// </summary>
    public partial class R__0__Yfi : RMember //
    {
        ...
        public R__0__Yfi() : base("#Pfb.#Yfi")
        {
        }

        public R__0__Yfi(System.Object instance) : base("#Pfb.#Yfi")
		{
            SetInstance(instance);
		}

        public R__0__Yfi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Yfi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#MCb
	/// </summary>
    public partial class R__0__MCb : RMember //
    {
        ...
        public R__0__MCb() : base("#Pfb.#MCb")
        {
        }

        public R__0__MCb(System.Object instance) : base("#Pfb.#MCb")
		{
            SetInstance(instance);
		}

        public R__0__MCb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__MCb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#CIc
	/// </summary>
    public partial class R__0__CIc : RMember //
    {
        ...
        public R__0__CIc() : base("#Pfb.#CIc")
        {
        }

        public R__0__CIc(System.Object instance) : base("#Pfb.#CIc")
		{
            SetInstance(instance);
		}

        public R__0__CIc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__CIc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#yii
	/// </summary>
    public partial class R__0__yii : RMember //
    {
        ...
        public R__0__yii() : base("#Pfb.#yii")
        {
        }

        public R__0__yii(System.Object instance) : base("#Pfb.#yii")
		{
            SetInstance(instance);
		}

        public R__0__yii(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__yii(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

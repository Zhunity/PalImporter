...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#U2k
	/// </summary>
    public partial class R__0__U2k : RMember //
    {
        ...
        public R__0__U2k() : base("#Pfb.#U2k")
        {
        }

        public R__0__U2k(System.Object instance) : base("#Pfb.#U2k")
		{
            SetInstance(instance);
		}

        public R__0__U2k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__U2k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Luf
	/// </summary>
    public partial class R__0__Luf : RMember //
    {
        ...
        public R__0__Luf() : base("#Pfb.#Luf")
        {
        }

        public R__0__Luf(System.Object instance) : base("#Pfb.#Luf")
		{
            SetInstance(instance);
		}

        public R__0__Luf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Luf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

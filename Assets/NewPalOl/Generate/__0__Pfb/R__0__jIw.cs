...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#jIw
	/// </summary>
    public partial class R__0__jIw : RMember //
    {
        ...
        public R__0__jIw() : base("#Pfb.#jIw")
        {
        }

        public R__0__jIw(System.Object instance) : base("#Pfb.#jIw")
		{
            SetInstance(instance);
		}

        public R__0__jIw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jIw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Avb
	/// </summary>
    public partial class R__0__Avb : RMember //
    {
        ...
        public R__0__Avb() : base("#Pfb.#Avb")
        {
        }

        public R__0__Avb(System.Object instance) : base("#Pfb.#Avb")
		{
            SetInstance(instance);
		}

        public R__0__Avb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Avb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#BTr
	/// </summary>
    public partial class R__0__BTr : RMember //
    {
        ...
        public R__0__BTr() : base("#Pfb.#BTr")
        {
        }

        public R__0__BTr(System.Object instance) : base("#Pfb.#BTr")
		{
            SetInstance(instance);
		}

        public R__0__BTr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__BTr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

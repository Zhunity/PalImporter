...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#1de
	/// </summary>
    public partial class R__0__1de : RMember //
    {
        ...
        public R__0__1de() : base("#Pfb.#1de")
        {
        }

        public R__0__1de(System.Object instance) : base("#Pfb.#1de")
		{
            SetInstance(instance);
		}

        public R__0__1de(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1de(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

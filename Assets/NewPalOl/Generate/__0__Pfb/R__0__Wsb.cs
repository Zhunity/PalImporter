...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wsb
	/// </summary>
    public partial class R__0__Wsb : RMember //
    {
        ...
        public R__0__Wsb() : base("#Pfb.#Wsb")
        {
        }

        public R__0__Wsb(System.Object instance) : base("#Pfb.#Wsb")
		{
            SetInstance(instance);
		}

        public R__0__Wsb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wsb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Idx
	/// </summary>
    public partial class R__0__Idx : RMember //
    {
        ...
        public R__0__Idx() : base("#Pfb.#Idx")
        {
        }

        public R__0__Idx(System.Object instance) : base("#Pfb.#Idx")
		{
            SetInstance(instance);
		}

        public R__0__Idx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Idx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

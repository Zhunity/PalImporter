...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ayb
	/// </summary>
    public partial class R__0__Ayb : RMember //
    {
        ...
        public R__0__Ayb() : base("#Pfb.#Ayb")
        {
        }

        public R__0__Ayb(System.Object instance) : base("#Pfb.#Ayb")
		{
            SetInstance(instance);
		}

        public R__0__Ayb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ayb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#iVr
	/// </summary>
    public partial class R__0__iVr : RMember //
    {
        ...
        public R__0__iVr() : base("#Pfb.#iVr")
        {
        }

        public R__0__iVr(System.Object instance) : base("#Pfb.#iVr")
		{
            SetInstance(instance);
		}

        public R__0__iVr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__iVr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#I2k
	/// </summary>
    public partial class R__0__I2k : RMember //
    {
        ...
        public R__0__I2k() : base("#Pfb.#I2k")
        {
        }

        public R__0__I2k(System.Object instance) : base("#Pfb.#I2k")
		{
            SetInstance(instance);
		}

        public R__0__I2k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__I2k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

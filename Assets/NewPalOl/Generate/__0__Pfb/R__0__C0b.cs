...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#C0b
	/// </summary>
    public partial class R__0__C0b : RMember //
    {
        ...
        public R__0__C0b() : base("#Pfb.#C0b")
        {
        }

        public R__0__C0b(System.Object instance) : base("#Pfb.#C0b")
		{
            SetInstance(instance);
		}

        public R__0__C0b(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__C0b(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

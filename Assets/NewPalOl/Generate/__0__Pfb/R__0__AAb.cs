...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#AAb
	/// </summary>
    public partial class R__0__AAb : RMember //
    {
        ...
        public R__0__AAb() : base("#Pfb.#AAb")
        {
        }

        public R__0__AAb(System.Object instance) : base("#Pfb.#AAb")
		{
            SetInstance(instance);
		}

        public R__0__AAb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__AAb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Yqf
	/// </summary>
    public partial class R__0__Yqf : RMember //
    {
        ...
        public R__0__Yqf() : base("#Pfb.#Yqf")
        {
        }

        public R__0__Yqf(System.Object instance) : base("#Pfb.#Yqf")
		{
            SetInstance(instance);
		}

        public R__0__Yqf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Yqf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

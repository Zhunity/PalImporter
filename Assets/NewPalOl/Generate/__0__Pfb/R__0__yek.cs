...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#yek
	/// </summary>
    public partial class R__0__yek : RMember //
    {
        ...
        public R__0__yek() : base("#Pfb.#yek")
        {
        }

        public R__0__yek(System.Object instance) : base("#Pfb.#yek")
		{
            SetInstance(instance);
		}

        public R__0__yek(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__yek(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

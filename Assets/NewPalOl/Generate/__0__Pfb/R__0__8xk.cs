...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8xk
	/// </summary>
    public partial class R__0__8xk : RMember //
    {
        ...
        public R__0__8xk() : base("#Pfb.#8xk")
        {
        }

        public R__0__8xk(System.Object instance) : base("#Pfb.#8xk")
		{
            SetInstance(instance);
		}

        public R__0__8xk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8xk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

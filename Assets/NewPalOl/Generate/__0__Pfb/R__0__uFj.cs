...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#uFj
	/// </summary>
    public partial class R__0__uFj : RMember //
    {
        ...
        public R__0__uFj() : base("#Pfb.#uFj")
        {
        }

        public R__0__uFj(System.Object instance) : base("#Pfb.#uFj")
		{
            SetInstance(instance);
		}

        public R__0__uFj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__uFj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

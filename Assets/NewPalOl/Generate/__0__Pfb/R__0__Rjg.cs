...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Rjg
	/// </summary>
    public partial class R__0__Rjg : RMember //
    {
        ...
        public R__0__Rjg() : base("#Pfb.#Rjg")
        {
        }

        public R__0__Rjg(System.Object instance) : base("#Pfb.#Rjg")
		{
            SetInstance(instance);
		}

        public R__0__Rjg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Rjg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

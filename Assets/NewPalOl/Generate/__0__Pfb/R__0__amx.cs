...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#amx
	/// </summary>
    public partial class R__0__amx : RMember //
    {
        ...
        public R__0__amx() : base("#Pfb.#amx")
        {
        }

        public R__0__amx(System.Object instance) : base("#Pfb.#amx")
		{
            SetInstance(instance);
		}

        public R__0__amx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__amx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

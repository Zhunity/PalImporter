...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#SDb
	/// </summary>
    public partial class R__0__SDb : RMember //
    {
        ...
        public R__0__SDb() : base("#Pfb.#SDb")
        {
        }

        public R__0__SDb(System.Object instance) : base("#Pfb.#SDb")
		{
            SetInstance(instance);
		}

        public R__0__SDb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__SDb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#N6g
	/// </summary>
    public partial class R__0__N6g : RMember //
    {
        ...
        public R__0__N6g() : base("#Pfb.#N6g")
        {
        }

        public R__0__N6g(System.Object instance) : base("#Pfb.#N6g")
		{
            SetInstance(instance);
		}

        public R__0__N6g(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__N6g(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

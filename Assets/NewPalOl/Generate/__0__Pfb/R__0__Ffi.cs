...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ffi
	/// </summary>
    public partial class R__0__Ffi : RMember //
    {
        ...
        public R__0__Ffi() : base("#Pfb.#Ffi")
        {
        }

        public R__0__Ffi(System.Object instance) : base("#Pfb.#Ffi")
		{
            SetInstance(instance);
		}

        public R__0__Ffi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ffi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Gce
	/// </summary>
    public partial class R__0__Gce : RMember //
    {
        ...
        public R__0__Gce() : base("#Pfb.#Gce")
        {
        }

        public R__0__Gce(System.Object instance) : base("#Pfb.#Gce")
		{
            SetInstance(instance);
		}

        public R__0__Gce(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Gce(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#bqo
	/// </summary>
    public partial class R__0__bqo : RMember //
    {
        ...
        public R__0__bqo() : base("#Pfb.#bqo")
        {
        }

        public R__0__bqo(System.Object instance) : base("#Pfb.#bqo")
		{
            SetInstance(instance);
		}

        public R__0__bqo(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__bqo(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

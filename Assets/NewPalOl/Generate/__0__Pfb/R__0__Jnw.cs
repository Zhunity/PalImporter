...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Jnw
	/// </summary>
    public partial class R__0__Jnw : RMember //
    {
        ...
        public R__0__Jnw() : base("#Pfb.#Jnw")
        {
        }

        public R__0__Jnw(System.Object instance) : base("#Pfb.#Jnw")
		{
            SetInstance(instance);
		}

        public R__0__Jnw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Jnw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

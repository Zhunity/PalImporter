...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#xCb
	/// </summary>
    public partial class R__0__xCb : RMember //
    {
        ...
        public R__0__xCb() : base("#Pfb.#xCb")
        {
        }

        public R__0__xCb(System.Object instance) : base("#Pfb.#xCb")
		{
            SetInstance(instance);
		}

        public R__0__xCb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__xCb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#1xk
	/// </summary>
    public partial class R__0__1xk : RMember //
    {
        ...
        public R__0__1xk() : base("#Pfb.#1xk")
        {
        }

        public R__0__1xk(System.Object instance) : base("#Pfb.#1xk")
		{
            SetInstance(instance);
		}

        public R__0__1xk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1xk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

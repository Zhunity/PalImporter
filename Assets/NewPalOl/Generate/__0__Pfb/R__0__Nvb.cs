...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Nvb
	/// </summary>
    public partial class R__0__Nvb : RMember //
    {
        ...
        public R__0__Nvb() : base("#Pfb.#Nvb")
        {
        }

        public R__0__Nvb(System.Object instance) : base("#Pfb.#Nvb")
		{
            SetInstance(instance);
		}

        public R__0__Nvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Nvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

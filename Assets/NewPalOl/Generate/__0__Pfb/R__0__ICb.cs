...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ICb
	/// </summary>
    public partial class R__0__ICb : RMember //
    {
        ...
        public R__0__ICb() : base("#Pfb.#ICb")
        {
        }

        public R__0__ICb(System.Object instance) : base("#Pfb.#ICb")
		{
            SetInstance(instance);
		}

        public R__0__ICb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ICb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

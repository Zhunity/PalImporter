...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Aam
	/// </summary>
    public partial class R__0__Aam : RMember //
    {
        ...
        public R__0__Aam() : base("#Pfb.#Aam")
        {
        }

        public R__0__Aam(System.Object instance) : base("#Pfb.#Aam")
		{
            SetInstance(instance);
		}

        public R__0__Aam(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Aam(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

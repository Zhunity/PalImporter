...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Nhp
	/// </summary>
    public partial class R__0__Nhp : RMember //
    {
        ...
        public R__0__Nhp() : base("#Pfb.#Nhp")
        {
        }

        public R__0__Nhp(System.Object instance) : base("#Pfb.#Nhp")
		{
            SetInstance(instance);
		}

        public R__0__Nhp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Nhp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

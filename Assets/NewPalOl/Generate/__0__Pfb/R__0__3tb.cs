...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#3tb
	/// </summary>
    public partial class R__0__3tb : RMember //
    {
        ...
        public R__0__3tb() : base("#Pfb.#3tb")
        {
        }

        public R__0__3tb(System.Object instance) : base("#Pfb.#3tb")
		{
            SetInstance(instance);
		}

        public R__0__3tb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3tb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Bxb
	/// </summary>
    public partial class R__0__Bxb : RMember //
    {
        ...
        public R__0__Bxb() : base("#Pfb.#Bxb")
        {
        }

        public R__0__Bxb(System.Object instance) : base("#Pfb.#Bxb")
		{
            SetInstance(instance);
		}

        public R__0__Bxb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Bxb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#YXl
	/// </summary>
    public partial class R__0__YXl : RMember //
    {
        ...
        public R__0__YXl() : base("#Pfb.#YXl")
        {
        }

        public R__0__YXl(System.Object instance) : base("#Pfb.#YXl")
		{
            SetInstance(instance);
		}

        public R__0__YXl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YXl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

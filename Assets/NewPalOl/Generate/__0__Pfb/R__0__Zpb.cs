...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Zpb
	/// </summary>
    public partial class R__0__Zpb : RMember //
    {
        ...
        public R__0__Zpb() : base("#Pfb.#Zpb")
        {
        }

        public R__0__Zpb(System.Object instance) : base("#Pfb.#Zpb")
		{
            SetInstance(instance);
		}

        public R__0__Zpb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Zpb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

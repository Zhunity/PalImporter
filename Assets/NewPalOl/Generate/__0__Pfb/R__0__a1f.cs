...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#a1f
	/// </summary>
    public partial class R__0__a1f : RMember //
    {
        ...
        public R__0__a1f() : base("#Pfb.#a1f")
        {
        }

        public R__0__a1f(System.Object instance) : base("#Pfb.#a1f")
		{
            SetInstance(instance);
		}

        public R__0__a1f(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__a1f(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#mOs
	/// </summary>
    public partial class R__0__mOs : RMember //
    {
        ...
        public R__0__mOs() : base("#Pfb.#mOs")
        {
        }

        public R__0__mOs(System.Object instance) : base("#Pfb.#mOs")
		{
            SetInstance(instance);
		}

        public R__0__mOs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__mOs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

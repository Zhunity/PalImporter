...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Xce
	/// </summary>
    public partial class R__0__Xce : RMember //
    {
        ...
        public R__0__Xce() : base("#Pfb.#Xce")
        {
        }

        public R__0__Xce(System.Object instance) : base("#Pfb.#Xce")
		{
            SetInstance(instance);
		}

        public R__0__Xce(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Xce(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#XFt
	/// </summary>
    public partial class R__0__XFt : RMember //
    {
        ...
        public R__0__XFt() : base("#Pfb.#XFt")
        {
        }

        public R__0__XFt(System.Object instance) : base("#Pfb.#XFt")
		{
            SetInstance(instance);
		}

        public R__0__XFt(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XFt(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

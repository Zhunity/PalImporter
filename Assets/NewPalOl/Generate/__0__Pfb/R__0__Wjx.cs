...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wjx
	/// </summary>
    public partial class R__0__Wjx : RMember //
    {
        ...
        public R__0__Wjx() : base("#Pfb.#Wjx")
        {
        }

        public R__0__Wjx(System.Object instance) : base("#Pfb.#Wjx")
		{
            SetInstance(instance);
		}

        public R__0__Wjx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wjx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

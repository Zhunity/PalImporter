...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#yYm
	/// </summary>
    public partial class R__0__yYm : RMember //
    {
        ...
        public R__0__yYm() : base("#Pfb.#yYm")
        {
        }

        public R__0__yYm(System.Object instance) : base("#Pfb.#yYm")
		{
            SetInstance(instance);
		}

        public R__0__yYm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__yYm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

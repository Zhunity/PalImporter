...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Hde
	/// </summary>
    public partial class R__0__Hde : RMember //
    {
        ...
        public R__0__Hde() : base("#Pfb.#Hde")
        {
        }

        public R__0__Hde(System.Object instance) : base("#Pfb.#Hde")
		{
            SetInstance(instance);
		}

        public R__0__Hde(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Hde(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

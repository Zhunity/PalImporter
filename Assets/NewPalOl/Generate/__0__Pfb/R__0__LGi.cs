...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#LGi
	/// </summary>
    public partial class R__0__LGi : RMember //
    {
        ...
        public R__0__LGi() : base("#Pfb.#LGi")
        {
        }

        public R__0__LGi(System.Object instance) : base("#Pfb.#LGi")
		{
            SetInstance(instance);
		}

        public R__0__LGi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__LGi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

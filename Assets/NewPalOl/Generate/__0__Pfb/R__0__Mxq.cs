...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Mxq
	/// </summary>
    public partial class R__0__Mxq : RMember //
    {
        ...
        public R__0__Mxq() : base("#Pfb.#Mxq")
        {
        }

        public R__0__Mxq(System.Object instance) : base("#Pfb.#Mxq")
		{
            SetInstance(instance);
		}

        public R__0__Mxq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Mxq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

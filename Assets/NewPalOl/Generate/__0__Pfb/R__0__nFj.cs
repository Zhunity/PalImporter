...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#nFj
	/// </summary>
    public partial class R__0__nFj : RMember //
    {
        ...
        public R__0__nFj() : base("#Pfb.#nFj")
        {
        }

        public R__0__nFj(System.Object instance) : base("#Pfb.#nFj")
		{
            SetInstance(instance);
		}

        public R__0__nFj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__nFj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9Ab
	/// </summary>
    public partial class R__0__9Ab : RMember //
    {
        ...
        public R__0__9Ab() : base("#Pfb.#9Ab")
        {
        }

        public R__0__9Ab(System.Object instance) : base("#Pfb.#9Ab")
		{
            SetInstance(instance);
		}

        public R__0__9Ab(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Ab(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

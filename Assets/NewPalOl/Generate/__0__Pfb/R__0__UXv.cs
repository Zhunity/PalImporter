...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#UXv
	/// </summary>
    public partial class R__0__UXv : RMember //
    {
        ...
        public R__0__UXv() : base("#Pfb.#UXv")
        {
        }

        public R__0__UXv(System.Object instance) : base("#Pfb.#UXv")
		{
            SetInstance(instance);
		}

        public R__0__UXv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__UXv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

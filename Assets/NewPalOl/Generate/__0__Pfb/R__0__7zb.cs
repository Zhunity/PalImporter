...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7zb
	/// </summary>
    public partial class R__0__7zb : RMember //
    {
        ...
        public R__0__7zb() : base("#Pfb.#7zb")
        {
        }

        public R__0__7zb(System.Object instance) : base("#Pfb.#7zb")
		{
            SetInstance(instance);
		}

        public R__0__7zb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7zb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

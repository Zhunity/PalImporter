...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#f8r
	/// </summary>
    public partial class R__0__f8r : RMember //
    {
        ...
        public R__0__f8r() : base("#Pfb.#f8r")
        {
        }

        public R__0__f8r(System.Object instance) : base("#Pfb.#f8r")
		{
            SetInstance(instance);
		}

        public R__0__f8r(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__f8r(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

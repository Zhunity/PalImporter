...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#16q
	/// </summary>
    public partial class R__0__16q : RMember //
    {
        ...
        public R__0__16q() : base("#Pfb.#16q")
        {
        }

        public R__0__16q(System.Object instance) : base("#Pfb.#16q")
		{
            SetInstance(instance);
		}

        public R__0__16q(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__16q(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

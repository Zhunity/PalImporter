...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ebx
	/// </summary>
    public partial class R__0__Ebx : RMember //
    {
        ...
        public R__0__Ebx() : base("#Pfb.#Ebx")
        {
        }

        public R__0__Ebx(System.Object instance) : base("#Pfb.#Ebx")
		{
            SetInstance(instance);
		}

        public R__0__Ebx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ebx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#xon
	/// </summary>
    public partial class R__0__xon : RMember //
    {
        ...
        public R__0__xon() : base("#Pfb.#xon")
        {
        }

        public R__0__xon(System.Object instance) : base("#Pfb.#xon")
		{
            SetInstance(instance);
		}

        public R__0__xon(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__xon(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

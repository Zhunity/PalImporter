...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#TSv
	/// </summary>
    public partial class R__0__TSv : RMember //
    {
        ...
        public R__0__TSv() : base("#Pfb.#TSv")
        {
        }

        public R__0__TSv(System.Object instance) : base("#Pfb.#TSv")
		{
            SetInstance(instance);
		}

        public R__0__TSv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__TSv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#fLp
	/// </summary>
    public partial class R__0__fLp : RMember //
    {
        ...
        public R__0__fLp() : base("#Pfb.#fLp")
        {
        }

        public R__0__fLp(System.Object instance) : base("#Pfb.#fLp")
		{
            SetInstance(instance);
		}

        public R__0__fLp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fLp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

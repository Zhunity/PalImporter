...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Vtb
	/// </summary>
    public partial class R__0__Vtb : RMember //
    {
        ...
        public R__0__Vtb() : base("#Pfb.#Vtb")
        {
        }

        public R__0__Vtb(System.Object instance) : base("#Pfb.#Vtb")
		{
            SetInstance(instance);
		}

        public R__0__Vtb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vtb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

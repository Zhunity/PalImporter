...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#eoc
	/// </summary>
    public partial class R__0__eoc : RMember //
    {
        ...
        public R__0__eoc() : base("#Pfb.#eoc")
        {
        }

        public R__0__eoc(System.Object instance) : base("#Pfb.#eoc")
		{
            SetInstance(instance);
		}

        public R__0__eoc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__eoc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

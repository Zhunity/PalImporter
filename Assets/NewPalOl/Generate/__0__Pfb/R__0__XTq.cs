...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#XTq
	/// </summary>
    public partial class R__0__XTq : RMember //
    {
        ...
        public R__0__XTq() : base("#Pfb.#XTq")
        {
        }

        public R__0__XTq(System.Object instance) : base("#Pfb.#XTq")
		{
            SetInstance(instance);
		}

        public R__0__XTq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XTq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

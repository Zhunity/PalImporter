...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Tij
	/// </summary>
    public partial class R__0__Tij : RMember //
    {
        ...
        public R__0__Tij() : base("#Pfb.#Tij")
        {
        }

        public R__0__Tij(System.Object instance) : base("#Pfb.#Tij")
		{
            SetInstance(instance);
		}

        public R__0__Tij(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Tij(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

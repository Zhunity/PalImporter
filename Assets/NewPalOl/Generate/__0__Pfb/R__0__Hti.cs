...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Hti
	/// </summary>
    public partial class R__0__Hti : RMember //
    {
        ...
        public R__0__Hti() : base("#Pfb.#Hti")
        {
        }

        public R__0__Hti(System.Object instance) : base("#Pfb.#Hti")
		{
            SetInstance(instance);
		}

        public R__0__Hti(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Hti(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

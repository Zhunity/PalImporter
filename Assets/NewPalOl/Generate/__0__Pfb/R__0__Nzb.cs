...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Nzb
	/// </summary>
    public partial class R__0__Nzb : RMember //
    {
        ...
        public R__0__Nzb() : base("#Pfb.#Nzb")
        {
        }

        public R__0__Nzb(System.Object instance) : base("#Pfb.#Nzb")
		{
            SetInstance(instance);
		}

        public R__0__Nzb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Nzb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

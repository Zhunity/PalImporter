...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#wYm
	/// </summary>
    public partial class R__0__wYm : RMember //
    {
        ...
        public R__0__wYm() : base("#Pfb.#wYm")
        {
        }

        public R__0__wYm(System.Object instance) : base("#Pfb.#wYm")
		{
            SetInstance(instance);
		}

        public R__0__wYm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__wYm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

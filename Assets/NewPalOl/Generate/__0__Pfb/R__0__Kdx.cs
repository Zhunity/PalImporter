...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Kdx
	/// </summary>
    public partial class R__0__Kdx : RMember //
    {
        ...
        public R__0__Kdx() : base("#Pfb.#Kdx")
        {
        }

        public R__0__Kdx(System.Object instance) : base("#Pfb.#Kdx")
		{
            SetInstance(instance);
		}

        public R__0__Kdx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Kdx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

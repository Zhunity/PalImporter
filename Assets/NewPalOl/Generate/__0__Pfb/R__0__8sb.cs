...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8sb
	/// </summary>
    public partial class R__0__8sb : RMember //
    {
        ...
        public R__0__8sb() : base("#Pfb.#8sb")
        {
        }

        public R__0__8sb(System.Object instance) : base("#Pfb.#8sb")
		{
            SetInstance(instance);
		}

        public R__0__8sb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8sb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

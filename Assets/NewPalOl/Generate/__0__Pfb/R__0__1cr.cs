...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#1cr
	/// </summary>
    public partial class R__0__1cr : RMember //
    {
        ...
        public R__0__1cr() : base("#Pfb.#1cr")
        {
        }

        public R__0__1cr(System.Object instance) : base("#Pfb.#1cr")
		{
            SetInstance(instance);
		}

        public R__0__1cr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1cr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ook
	/// </summary>
    public partial class R__0__Ook : RMember //
    {
        ...
        public R__0__Ook() : base("#Pfb.#Ook")
        {
        }

        public R__0__Ook(System.Object instance) : base("#Pfb.#Ook")
		{
            SetInstance(instance);
		}

        public R__0__Ook(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ook(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

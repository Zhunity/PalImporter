...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Cyb
	/// </summary>
    public partial class R__0__Cyb : RMember //
    {
        ...
        public R__0__Cyb() : base("#Pfb.#Cyb")
        {
        }

        public R__0__Cyb(System.Object instance) : base("#Pfb.#Cyb")
		{
            SetInstance(instance);
		}

        public R__0__Cyb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Cyb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

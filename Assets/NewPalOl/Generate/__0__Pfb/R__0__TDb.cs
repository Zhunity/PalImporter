...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#TDb
	/// </summary>
    public partial class R__0__TDb : RMember //
    {
        ...
        public R__0__TDb() : base("#Pfb.#TDb")
        {
        }

        public R__0__TDb(System.Object instance) : base("#Pfb.#TDb")
		{
            SetInstance(instance);
		}

        public R__0__TDb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__TDb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

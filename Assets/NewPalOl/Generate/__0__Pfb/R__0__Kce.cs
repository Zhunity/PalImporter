...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Kce
	/// </summary>
    public partial class R__0__Kce : RMember //
    {
        ...
        public R__0__Kce() : base("#Pfb.#Kce")
        {
        }

        public R__0__Kce(System.Object instance) : base("#Pfb.#Kce")
		{
            SetInstance(instance);
		}

        public R__0__Kce(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Kce(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

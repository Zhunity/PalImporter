...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Avl
	/// </summary>
    public partial class R__0__Avl : RMember //
    {
        ...
        public R__0__Avl() : base("#Pfb.#Avl")
        {
        }

        public R__0__Avl(System.Object instance) : base("#Pfb.#Avl")
		{
            SetInstance(instance);
		}

        public R__0__Avl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Avl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

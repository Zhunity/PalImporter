...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Yxq
	/// </summary>
    public partial class R__0__Yxq : RMember //
    {
        ...
        public R__0__Yxq() : base("#Pfb.#Yxq")
        {
        }

        public R__0__Yxq(System.Object instance) : base("#Pfb.#Yxq")
		{
            SetInstance(instance);
		}

        public R__0__Yxq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Yxq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Pdx
	/// </summary>
    public partial class R__0__Pdx : RMember //
    {
        ...
        public R__0__Pdx() : base("#Pfb.#Pdx")
        {
        }

        public R__0__Pdx(System.Object instance) : base("#Pfb.#Pdx")
		{
            SetInstance(instance);
		}

        public R__0__Pdx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Pdx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#WDb
	/// </summary>
    public partial class R__0__WDb : RMember //
    {
        ...
        public R__0__WDb() : base("#Pfb.#WDb")
        {
        }

        public R__0__WDb(System.Object instance) : base("#Pfb.#WDb")
		{
            SetInstance(instance);
		}

        public R__0__WDb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__WDb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#XCi
	/// </summary>
    public partial class R__0__XCi : RMember //
    {
        ...
        public R__0__XCi() : base("#Pfb.#XCi")
        {
        }

        public R__0__XCi(System.Object instance) : base("#Pfb.#XCi")
		{
            SetInstance(instance);
		}

        public R__0__XCi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XCi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Hfi
	/// </summary>
    public partial class R__0__Hfi : RMember //
    {
        ...
        public R__0__Hfi() : base("#Pfb.#Hfi")
        {
        }

        public R__0__Hfi(System.Object instance) : base("#Pfb.#Hfi")
		{
            SetInstance(instance);
		}

        public R__0__Hfi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Hfi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#tSe
	/// </summary>
    public partial class R__0__tSe : RMember //
    {
        ...
        public R__0__tSe() : base("#Pfb.#tSe")
        {
        }

        public R__0__tSe(System.Object instance) : base("#Pfb.#tSe")
		{
            SetInstance(instance);
		}

        public R__0__tSe(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__tSe(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#fBn
	/// </summary>
    public partial class R__0__fBn : RMember //
    {
        ...
        public R__0__fBn() : base("#Pfb.#fBn")
        {
        }

        public R__0__fBn(System.Object instance) : base("#Pfb.#fBn")
		{
            SetInstance(instance);
		}

        public R__0__fBn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fBn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#RVb
	/// </summary>
    public partial class R__0__RVb : RMember //
    {
        ...
        public R__0__RVb() : base("#Pfb.#RVb")
        {
        }

        public R__0__RVb(System.Object instance) : base("#Pfb.#RVb")
		{
            SetInstance(instance);
		}

        public R__0__RVb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__RVb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

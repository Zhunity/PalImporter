...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#bDb
	/// </summary>
    public partial class R__0__bDb : RMember //
    {
        ...
        public R__0__bDb() : base("#Pfb.#bDb")
        {
        }

        public R__0__bDb(System.Object instance) : base("#Pfb.#bDb")
		{
            SetInstance(instance);
		}

        public R__0__bDb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__bDb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

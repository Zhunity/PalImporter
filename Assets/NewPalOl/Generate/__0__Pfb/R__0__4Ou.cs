...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4Ou
	/// </summary>
    public partial class R__0__4Ou : RMember //
    {
        ...
        public R__0__4Ou() : base("#Pfb.#4Ou")
        {
        }

        public R__0__4Ou(System.Object instance) : base("#Pfb.#4Ou")
		{
            SetInstance(instance);
		}

        public R__0__4Ou(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4Ou(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

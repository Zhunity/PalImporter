...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ECb
	/// </summary>
    public partial class R__0__ECb : RMember //
    {
        ...
        public R__0__ECb() : base("#Pfb.#ECb")
        {
        }

        public R__0__ECb(System.Object instance) : base("#Pfb.#ECb")
		{
            SetInstance(instance);
		}

        public R__0__ECb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ECb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8Ab
	/// </summary>
    public partial class R__0__8Ab : RMember //
    {
        ...
        public R__0__8Ab() : base("#Pfb.#8Ab")
        {
        }

        public R__0__8Ab(System.Object instance) : base("#Pfb.#8Ab")
		{
            SetInstance(instance);
		}

        public R__0__8Ab(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Ab(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

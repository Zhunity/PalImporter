...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#R2e
	/// </summary>
    public partial class R__0__R2e : RMember //
    {
        ...
        public R__0__R2e() : base("#Pfb.#R2e")
        {
        }

        public R__0__R2e(System.Object instance) : base("#Pfb.#R2e")
		{
            SetInstance(instance);
		}

        public R__0__R2e(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__R2e(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

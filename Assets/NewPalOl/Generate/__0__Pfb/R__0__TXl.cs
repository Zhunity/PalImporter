...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#TXl
	/// </summary>
    public partial class R__0__TXl : RMember //
    {
        ...
        public R__0__TXl() : base("#Pfb.#TXl")
        {
        }

        public R__0__TXl(System.Object instance) : base("#Pfb.#TXl")
		{
            SetInstance(instance);
		}

        public R__0__TXl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__TXl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#RBc
	/// </summary>
    public partial class R__0__RBc : RMember //
    {
        ...
        public R__0__RBc() : base("#Pfb.#RBc")
        {
        }

        public R__0__RBc(System.Object instance) : base("#Pfb.#RBc")
		{
            SetInstance(instance);
		}

        public R__0__RBc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__RBc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

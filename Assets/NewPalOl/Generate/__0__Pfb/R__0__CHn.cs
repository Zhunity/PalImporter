...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#CHn
	/// </summary>
    public partial class R__0__CHn : RMember //
    {
        ...
        public R__0__CHn() : base("#Pfb.#CHn")
        {
        }

        public R__0__CHn(System.Object instance) : base("#Pfb.#CHn")
		{
            SetInstance(instance);
		}

        public R__0__CHn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__CHn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#nGd
	/// </summary>
    public partial class R__0__nGd : RMember //
    {
        ...
        public R__0__nGd() : base("#Pfb.#nGd")
        {
        }

        public R__0__nGd(System.Object instance) : base("#Pfb.#nGd")
		{
            SetInstance(instance);
		}

        public R__0__nGd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__nGd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#oek
	/// </summary>
    public partial class R__0__oek : RMember //
    {
        ...
        public R__0__oek() : base("#Pfb.#oek")
        {
        }

        public R__0__oek(System.Object instance) : base("#Pfb.#oek")
		{
            SetInstance(instance);
		}

        public R__0__oek(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oek(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

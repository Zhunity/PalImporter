...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#UDm
	/// </summary>
    public partial class R__0__UDm : RMember //
    {
        ...
        public R__0__UDm() : base("#Pfb.#UDm")
        {
        }

        public R__0__UDm(System.Object instance) : base("#Pfb.#UDm")
		{
            SetInstance(instance);
		}

        public R__0__UDm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__UDm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

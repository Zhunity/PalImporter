...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7Kf
	/// </summary>
    public partial class R__0__7Kf : RMember //
    {
        ...
        public R__0__7Kf() : base("#Pfb.#7Kf")
        {
        }

        public R__0__7Kf(System.Object instance) : base("#Pfb.#7Kf")
		{
            SetInstance(instance);
		}

        public R__0__7Kf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7Kf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

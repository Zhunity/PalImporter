...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Vql
	/// </summary>
    public partial class R__0__Vql : RMember //
    {
        ...
        public R__0__Vql() : base("#Pfb.#Vql")
        {
        }

        public R__0__Vql(System.Object instance) : base("#Pfb.#Vql")
		{
            SetInstance(instance);
		}

        public R__0__Vql(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vql(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

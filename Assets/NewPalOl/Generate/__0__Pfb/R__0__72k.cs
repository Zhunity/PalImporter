...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#72k
	/// </summary>
    public partial class R__0__72k : RMember //
    {
        ...
        public R__0__72k() : base("#Pfb.#72k")
        {
        }

        public R__0__72k(System.Object instance) : base("#Pfb.#72k")
		{
            SetInstance(instance);
		}

        public R__0__72k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__72k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

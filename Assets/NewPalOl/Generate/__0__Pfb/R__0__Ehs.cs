...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ehs
	/// </summary>
    public partial class R__0__Ehs : RMember //
    {
        ...
        public R__0__Ehs() : base("#Pfb.#Ehs")
        {
        }

        public R__0__Ehs(System.Object instance) : base("#Pfb.#Ehs")
		{
            SetInstance(instance);
		}

        public R__0__Ehs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ehs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

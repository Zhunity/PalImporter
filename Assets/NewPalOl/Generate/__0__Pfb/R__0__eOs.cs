...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#eOs
	/// </summary>
    public partial class R__0__eOs : RMember //
    {
        ...
        public R__0__eOs() : base("#Pfb.#eOs")
        {
        }

        public R__0__eOs(System.Object instance) : base("#Pfb.#eOs")
		{
            SetInstance(instance);
		}

        public R__0__eOs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__eOs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4jg
	/// </summary>
    public partial class R__0__4jg : RMember //
    {
        ...
        public R__0__4jg() : base("#Pfb.#4jg")
        {
        }

        public R__0__4jg(System.Object instance) : base("#Pfb.#4jg")
		{
            SetInstance(instance);
		}

        public R__0__4jg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4jg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#dkg
	/// </summary>
    public partial class R__0__dkg : RMember //
    {
        ...
        public R__0__dkg() : base("#Pfb.#dkg")
        {
        }

        public R__0__dkg(System.Object instance) : base("#Pfb.#dkg")
		{
            SetInstance(instance);
		}

        public R__0__dkg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dkg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

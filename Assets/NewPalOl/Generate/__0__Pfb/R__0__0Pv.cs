...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0Pv
	/// </summary>
    public partial class R__0__0Pv : RMember //
    {
        ...
        public R__0__0Pv() : base("#Pfb.#0Pv")
        {
        }

        public R__0__0Pv(System.Object instance) : base("#Pfb.#0Pv")
		{
            SetInstance(instance);
		}

        public R__0__0Pv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0Pv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

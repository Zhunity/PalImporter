...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#KIr
	/// </summary>
    public partial class R__0__KIr : RMember //
    {
        ...
        public R__0__KIr() : base("#Pfb.#KIr")
        {
        }

        public R__0__KIr(System.Object instance) : base("#Pfb.#KIr")
		{
            SetInstance(instance);
		}

        public R__0__KIr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__KIr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

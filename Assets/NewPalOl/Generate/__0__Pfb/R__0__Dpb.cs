...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Dpb
	/// </summary>
    public partial class R__0__Dpb : RMember //
    {
        ...
        public R__0__Dpb() : base("#Pfb.#Dpb")
        {
        }

        public R__0__Dpb(System.Object instance) : base("#Pfb.#Dpb")
		{
            SetInstance(instance);
		}

        public R__0__Dpb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Dpb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

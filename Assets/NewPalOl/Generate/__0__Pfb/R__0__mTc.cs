...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#mTc
	/// </summary>
    public partial class R__0__mTc : RMember //
    {
        ...
        public R__0__mTc() : base("#Pfb.#mTc")
        {
        }

        public R__0__mTc(System.Object instance) : base("#Pfb.#mTc")
		{
            SetInstance(instance);
		}

        public R__0__mTc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__mTc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#E6c
	/// </summary>
    public partial class R__0__E6c : RMember //
    {
        ...
        public R__0__E6c() : base("#Pfb.#E6c")
        {
        }

        public R__0__E6c(System.Object instance) : base("#Pfb.#E6c")
		{
            SetInstance(instance);
		}

        public R__0__E6c(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__E6c(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#goi
	/// </summary>
    public partial class R__0__goi : RMember //
    {
        ...
        public R__0__goi() : base("#Pfb.#goi")
        {
        }

        public R__0__goi(System.Object instance) : base("#Pfb.#goi")
		{
            SetInstance(instance);
		}

        public R__0__goi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__goi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Peh
	/// </summary>
    public partial class R__0__Peh : RMember //
    {
        ...
        public R__0__Peh() : base("#Pfb.#Peh")
        {
        }

        public R__0__Peh(System.Object instance) : base("#Pfb.#Peh")
		{
            SetInstance(instance);
		}

        public R__0__Peh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Peh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

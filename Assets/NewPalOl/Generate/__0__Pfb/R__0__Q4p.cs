...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Q4p
	/// </summary>
    public partial class R__0__Q4p : RMember //
    {
        ...
        public R__0__Q4p() : base("#Pfb.#Q4p")
        {
        }

        public R__0__Q4p(System.Object instance) : base("#Pfb.#Q4p")
		{
            SetInstance(instance);
		}

        public R__0__Q4p(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Q4p(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

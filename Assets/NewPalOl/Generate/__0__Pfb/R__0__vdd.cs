...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#vdd
	/// </summary>
    public partial class R__0__vdd : RMember //
    {
        ...
        public R__0__vdd() : base("#Pfb.#vdd")
        {
        }

        public R__0__vdd(System.Object instance) : base("#Pfb.#vdd")
		{
            SetInstance(instance);
		}

        public R__0__vdd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__vdd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

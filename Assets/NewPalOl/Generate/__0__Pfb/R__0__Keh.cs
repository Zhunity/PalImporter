...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Keh
	/// </summary>
    public partial class R__0__Keh : RMember //
    {
        ...
        public R__0__Keh() : base("#Pfb.#Keh")
        {
        }

        public R__0__Keh(System.Object instance) : base("#Pfb.#Keh")
		{
            SetInstance(instance);
		}

        public R__0__Keh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Keh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

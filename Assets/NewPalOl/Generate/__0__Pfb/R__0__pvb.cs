...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#pvb
	/// </summary>
    public partial class R__0__pvb : RMember //
    {
        ...
        public R__0__pvb() : base("#Pfb.#pvb")
        {
        }

        public R__0__pvb(System.Object instance) : base("#Pfb.#pvb")
		{
            SetInstance(instance);
		}

        public R__0__pvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__pvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

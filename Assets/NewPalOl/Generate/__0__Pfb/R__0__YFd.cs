...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#YFd
	/// </summary>
    public partial class R__0__YFd : RMember //
    {
        ...
        public R__0__YFd() : base("#Pfb.#YFd")
        {
        }

        public R__0__YFd(System.Object instance) : base("#Pfb.#YFd")
		{
            SetInstance(instance);
		}

        public R__0__YFd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YFd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

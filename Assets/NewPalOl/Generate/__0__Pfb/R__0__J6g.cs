...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#J6g
	/// </summary>
    public partial class R__0__J6g : RMember //
    {
        ...
        public R__0__J6g() : base("#Pfb.#J6g")
        {
        }

        public R__0__J6g(System.Object instance) : base("#Pfb.#J6g")
		{
            SetInstance(instance);
		}

        public R__0__J6g(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__J6g(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

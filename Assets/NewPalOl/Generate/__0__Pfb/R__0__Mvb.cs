...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Mvb
	/// </summary>
    public partial class R__0__Mvb : RMember //
    {
        ...
        public R__0__Mvb() : base("#Pfb.#Mvb")
        {
        }

        public R__0__Mvb(System.Object instance) : base("#Pfb.#Mvb")
		{
            SetInstance(instance);
		}

        public R__0__Mvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Mvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#iYb
	/// </summary>
    public partial class R__0__iYb : RMember //
    {
        ...
        public R__0__iYb() : base("#Pfb.#iYb")
        {
        }

        public R__0__iYb(System.Object instance) : base("#Pfb.#iYb")
		{
            SetInstance(instance);
		}

        public R__0__iYb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__iYb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

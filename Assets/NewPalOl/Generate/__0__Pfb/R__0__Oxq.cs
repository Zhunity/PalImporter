...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Oxq
	/// </summary>
    public partial class R__0__Oxq : RMember //
    {
        ...
        public R__0__Oxq() : base("#Pfb.#Oxq")
        {
        }

        public R__0__Oxq(System.Object instance) : base("#Pfb.#Oxq")
		{
            SetInstance(instance);
		}

        public R__0__Oxq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Oxq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8cr
	/// </summary>
    public partial class R__0__8cr : RMember //
    {
        ...
        public R__0__8cr() : base("#Pfb.#8cr")
        {
        }

        public R__0__8cr(System.Object instance) : base("#Pfb.#8cr")
		{
            SetInstance(instance);
		}

        public R__0__8cr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8cr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#6wb
	/// </summary>
    public partial class R__0__6wb : RMember //
    {
        ...
        public R__0__6wb() : base("#Pfb.#6wb")
        {
        }

        public R__0__6wb(System.Object instance) : base("#Pfb.#6wb")
		{
            SetInstance(instance);
		}

        public R__0__6wb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6wb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

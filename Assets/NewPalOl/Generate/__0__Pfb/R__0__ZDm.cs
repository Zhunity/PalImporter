...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ZDm
	/// </summary>
    public partial class R__0__ZDm : RMember //
    {
        ...
        public R__0__ZDm() : base("#Pfb.#ZDm")
        {
        }

        public R__0__ZDm(System.Object instance) : base("#Pfb.#ZDm")
		{
            SetInstance(instance);
		}

        public R__0__ZDm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ZDm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

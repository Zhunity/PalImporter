...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#hkg
	/// </summary>
    public partial class R__0__hkg : RMember //
    {
        ...
        public R__0__hkg() : base("#Pfb.#hkg")
        {
        }

        public R__0__hkg(System.Object instance) : base("#Pfb.#hkg")
		{
            SetInstance(instance);
		}

        public R__0__hkg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hkg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ilq
	/// </summary>
    public partial class R__0__ilq : RMember //
    {
        ...
        public R__0__ilq() : base("#Pfb.#ilq")
        {
        }

        public R__0__ilq(System.Object instance) : base("#Pfb.#ilq")
		{
            SetInstance(instance);
		}

        public R__0__ilq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ilq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Fvb
	/// </summary>
    public partial class R__0__Fvb : RMember //
    {
        ...
        public R__0__Fvb() : base("#Pfb.#Fvb")
        {
        }

        public R__0__Fvb(System.Object instance) : base("#Pfb.#Fvb")
		{
            SetInstance(instance);
		}

        public R__0__Fvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Fvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

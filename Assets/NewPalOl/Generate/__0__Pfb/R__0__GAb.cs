...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#GAb
	/// </summary>
    public partial class R__0__GAb : RMember //
    {
        ...
        public R__0__GAb() : base("#Pfb.#GAb")
        {
        }

        public R__0__GAb(System.Object instance) : base("#Pfb.#GAb")
		{
            SetInstance(instance);
		}

        public R__0__GAb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__GAb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

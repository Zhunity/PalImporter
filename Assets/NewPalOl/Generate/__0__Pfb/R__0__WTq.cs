...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#WTq
	/// </summary>
    public partial class R__0__WTq : RMember //
    {
        ...
        public R__0__WTq() : base("#Pfb.#WTq")
        {
        }

        public R__0__WTq(System.Object instance) : base("#Pfb.#WTq")
		{
            SetInstance(instance);
		}

        public R__0__WTq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__WTq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

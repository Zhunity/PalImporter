...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Fbx
	/// </summary>
    public partial class R__0__Fbx : RMember //
    {
        ...
        public R__0__Fbx() : base("#Pfb.#Fbx")
        {
        }

        public R__0__Fbx(System.Object instance) : base("#Pfb.#Fbx")
		{
            SetInstance(instance);
		}

        public R__0__Fbx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Fbx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

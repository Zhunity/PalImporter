...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0Tq
	/// </summary>
    public partial class R__0__0Tq : RMember //
    {
        ...
        public R__0__0Tq() : base("#Pfb.#0Tq")
        {
        }

        public R__0__0Tq(System.Object instance) : base("#Pfb.#0Tq")
		{
            SetInstance(instance);
		}

        public R__0__0Tq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0Tq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

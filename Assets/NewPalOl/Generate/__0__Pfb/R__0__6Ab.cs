...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#6Ab
	/// </summary>
    public partial class R__0__6Ab : RMember //
    {
        ...
        public R__0__6Ab() : base("#Pfb.#6Ab")
        {
        }

        public R__0__6Ab(System.Object instance) : base("#Pfb.#6Ab")
		{
            SetInstance(instance);
		}

        public R__0__6Ab(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6Ab(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

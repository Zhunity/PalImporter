...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#LCb
	/// </summary>
    public partial class R__0__LCb : RMember //
    {
        ...
        public R__0__LCb() : base("#Pfb.#LCb")
        {
        }

        public R__0__LCb(System.Object instance) : base("#Pfb.#LCb")
		{
            SetInstance(instance);
		}

        public R__0__LCb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__LCb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

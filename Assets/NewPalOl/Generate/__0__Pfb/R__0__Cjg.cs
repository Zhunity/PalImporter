...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Cjg
	/// </summary>
    public partial class R__0__Cjg : RMember //
    {
        ...
        public R__0__Cjg() : base("#Pfb.#Cjg")
        {
        }

        public R__0__Cjg(System.Object instance) : base("#Pfb.#Cjg")
		{
            SetInstance(instance);
		}

        public R__0__Cjg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Cjg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

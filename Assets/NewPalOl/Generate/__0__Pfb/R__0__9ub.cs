...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9ub
	/// </summary>
    public partial class R__0__9ub : RMember //
    {
        ...
        public R__0__9ub() : base("#Pfb.#9ub")
        {
        }

        public R__0__9ub(System.Object instance) : base("#Pfb.#9ub")
		{
            SetInstance(instance);
		}

        public R__0__9ub(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9ub(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

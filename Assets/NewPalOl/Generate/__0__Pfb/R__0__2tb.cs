...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#2tb
	/// </summary>
    public partial class R__0__2tb : RMember //
    {
        ...
        public R__0__2tb() : base("#Pfb.#2tb")
        {
        }

        public R__0__2tb(System.Object instance) : base("#Pfb.#2tb")
		{
            SetInstance(instance);
		}

        public R__0__2tb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2tb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

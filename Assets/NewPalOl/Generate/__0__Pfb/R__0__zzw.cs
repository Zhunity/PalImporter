...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#zzw
	/// </summary>
    public partial class R__0__zzw : RMember //
    {
        ...
        public R__0__zzw() : base("#Pfb.#zzw")
        {
        }

        public R__0__zzw(System.Object instance) : base("#Pfb.#zzw")
		{
            SetInstance(instance);
		}

        public R__0__zzw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zzw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

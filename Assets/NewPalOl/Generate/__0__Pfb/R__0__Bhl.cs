...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Bhl
	/// </summary>
    public partial class R__0__Bhl : RMember //
    {
        ...
        public R__0__Bhl() : base("#Pfb.#Bhl")
        {
        }

        public R__0__Bhl(System.Object instance) : base("#Pfb.#Bhl")
		{
            SetInstance(instance);
		}

        public R__0__Bhl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Bhl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

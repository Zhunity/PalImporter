...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#NAb
	/// </summary>
    public partial class R__0__NAb : RMember //
    {
        ...
        public R__0__NAb() : base("#Pfb.#NAb")
        {
        }

        public R__0__NAb(System.Object instance) : base("#Pfb.#NAb")
		{
            SetInstance(instance);
		}

        public R__0__NAb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__NAb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

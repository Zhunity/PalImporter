...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Sql
	/// </summary>
    public partial class R__0__Sql : RMember //
    {
        ...
        public R__0__Sql() : base("#Pfb.#Sql")
        {
        }

        public R__0__Sql(System.Object instance) : base("#Pfb.#Sql")
		{
            SetInstance(instance);
		}

        public R__0__Sql(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Sql(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#eDi
	/// </summary>
    public partial class R__0__eDi : RMember //
    {
        ...
        public R__0__eDi() : base("#Pfb.#eDi")
        {
        }

        public R__0__eDi(System.Object instance) : base("#Pfb.#eDi")
		{
            SetInstance(instance);
		}

        public R__0__eDi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__eDi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Fxb
	/// </summary>
    public partial class R__0__Fxb : RMember //
    {
        ...
        public R__0__Fxb() : base("#Pfb.#Fxb")
        {
        }

        public R__0__Fxb(System.Object instance) : base("#Pfb.#Fxb")
		{
            SetInstance(instance);
		}

        public R__0__Fxb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Fxb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

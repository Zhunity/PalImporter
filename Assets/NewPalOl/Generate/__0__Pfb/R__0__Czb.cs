...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Czb
	/// </summary>
    public partial class R__0__Czb : RMember //
    {
        ...
        public R__0__Czb() : base("#Pfb.#Czb")
        {
        }

        public R__0__Czb(System.Object instance) : base("#Pfb.#Czb")
		{
            SetInstance(instance);
		}

        public R__0__Czb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Czb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9Vb
	/// </summary>
    public partial class R__0__9Vb : RMember //
    {
        ...
        public R__0__9Vb() : base("#Pfb.#9Vb")
        {
        }

        public R__0__9Vb(System.Object instance) : base("#Pfb.#9Vb")
		{
            SetInstance(instance);
		}

        public R__0__9Vb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Vb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

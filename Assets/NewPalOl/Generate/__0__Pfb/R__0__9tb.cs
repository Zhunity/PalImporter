...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9tb
	/// </summary>
    public partial class R__0__9tb : RMember //
    {
        ...
        public R__0__9tb() : base("#Pfb.#9tb")
        {
        }

        public R__0__9tb(System.Object instance) : base("#Pfb.#9tb")
		{
            SetInstance(instance);
		}

        public R__0__9tb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9tb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

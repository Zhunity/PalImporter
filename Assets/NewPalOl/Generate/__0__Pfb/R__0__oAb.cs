...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#oAb
	/// </summary>
    public partial class R__0__oAb : RMember //
    {
        ...
        public R__0__oAb() : base("#Pfb.#oAb")
        {
        }

        public R__0__oAb(System.Object instance) : base("#Pfb.#oAb")
		{
            SetInstance(instance);
		}

        public R__0__oAb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oAb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

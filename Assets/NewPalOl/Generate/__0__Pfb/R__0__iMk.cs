...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#iMk
	/// </summary>
    public partial class R__0__iMk : RMember //
    {
        ...
        public R__0__iMk() : base("#Pfb.#iMk")
        {
        }

        public R__0__iMk(System.Object instance) : base("#Pfb.#iMk")
		{
            SetInstance(instance);
		}

        public R__0__iMk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__iMk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Nrb
	/// </summary>
    public partial class R__0__Nrb : RMember //
    {
        ...
        public R__0__Nrb() : base("#Pfb.#Nrb")
        {
        }

        public R__0__Nrb(System.Object instance) : base("#Pfb.#Nrb")
		{
            SetInstance(instance);
		}

        public R__0__Nrb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Nrb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

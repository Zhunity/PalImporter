...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ycr
	/// </summary>
    public partial class R__0__Ycr : RMember //
    {
        ...
        public R__0__Ycr() : base("#Pfb.#Ycr")
        {
        }

        public R__0__Ycr(System.Object instance) : base("#Pfb.#Ycr")
		{
            SetInstance(instance);
		}

        public R__0__Ycr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ycr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

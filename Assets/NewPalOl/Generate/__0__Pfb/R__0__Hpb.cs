...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Hpb
	/// </summary>
    public partial class R__0__Hpb : RMember //
    {
        ...
        public R__0__Hpb() : base("#Pfb.#Hpb")
        {
        }

        public R__0__Hpb(System.Object instance) : base("#Pfb.#Hpb")
		{
            SetInstance(instance);
		}

        public R__0__Hpb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Hpb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

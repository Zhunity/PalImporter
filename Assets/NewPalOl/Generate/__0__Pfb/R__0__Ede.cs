...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ede
	/// </summary>
    public partial class R__0__Ede : RMember //
    {
        ...
        public R__0__Ede() : base("#Pfb.#Ede")
        {
        }

        public R__0__Ede(System.Object instance) : base("#Pfb.#Ede")
		{
            SetInstance(instance);
		}

        public R__0__Ede(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ede(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

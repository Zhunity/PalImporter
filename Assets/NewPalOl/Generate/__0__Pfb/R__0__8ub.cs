...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8ub
	/// </summary>
    public partial class R__0__8ub : RMember //
    {
        ...
        public R__0__8ub() : base("#Pfb.#8ub")
        {
        }

        public R__0__8ub(System.Object instance) : base("#Pfb.#8ub")
		{
            SetInstance(instance);
		}

        public R__0__8ub(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8ub(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

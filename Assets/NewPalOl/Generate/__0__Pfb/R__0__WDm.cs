...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#WDm
	/// </summary>
    public partial class R__0__WDm : RMember //
    {
        ...
        public R__0__WDm() : base("#Pfb.#WDm")
        {
        }

        public R__0__WDm(System.Object instance) : base("#Pfb.#WDm")
		{
            SetInstance(instance);
		}

        public R__0__WDm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__WDm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

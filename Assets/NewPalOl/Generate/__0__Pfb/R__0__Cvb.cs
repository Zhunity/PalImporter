...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Cvb
	/// </summary>
    public partial class R__0__Cvb : RMember //
    {
        ...
        public R__0__Cvb() : base("#Pfb.#Cvb")
        {
        }

        public R__0__Cvb(System.Object instance) : base("#Pfb.#Cvb")
		{
            SetInstance(instance);
		}

        public R__0__Cvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Cvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

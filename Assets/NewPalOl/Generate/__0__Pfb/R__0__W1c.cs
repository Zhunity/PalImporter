...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#W1c
	/// </summary>
    public partial class R__0__W1c : RMember //
    {
        ...
        public R__0__W1c() : base("#Pfb.#W1c")
        {
        }

        public R__0__W1c(System.Object instance) : base("#Pfb.#W1c")
		{
            SetInstance(instance);
		}

        public R__0__W1c(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__W1c(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

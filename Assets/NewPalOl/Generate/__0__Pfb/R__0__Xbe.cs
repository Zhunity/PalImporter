...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Xbe
	/// </summary>
    public partial class R__0__Xbe : RMember //
    {
        ...
        public R__0__Xbe() : base("#Pfb.#Xbe")
        {
        }

        public R__0__Xbe(System.Object instance) : base("#Pfb.#Xbe")
		{
            SetInstance(instance);
		}

        public R__0__Xbe(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Xbe(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

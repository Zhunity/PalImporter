...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#K6g
	/// </summary>
    public partial class R__0__K6g : RMember //
    {
        ...
        public R__0__K6g() : base("#Pfb.#K6g")
        {
        }

        public R__0__K6g(System.Object instance) : base("#Pfb.#K6g")
		{
            SetInstance(instance);
		}

        public R__0__K6g(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__K6g(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Pbu
	/// </summary>
    public partial class R__0__Pbu : RMember //
    {
        ...
        public R__0__Pbu() : base("#Pfb.#Pbu")
        {
        }

        public R__0__Pbu(System.Object instance) : base("#Pfb.#Pbu")
		{
            SetInstance(instance);
		}

        public R__0__Pbu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Pbu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

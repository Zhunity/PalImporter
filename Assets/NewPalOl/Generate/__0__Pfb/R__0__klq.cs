...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#klq
	/// </summary>
    public partial class R__0__klq : RMember //
    {
        ...
        public R__0__klq() : base("#Pfb.#klq")
        {
        }

        public R__0__klq(System.Object instance) : base("#Pfb.#klq")
		{
            SetInstance(instance);
		}

        public R__0__klq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__klq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

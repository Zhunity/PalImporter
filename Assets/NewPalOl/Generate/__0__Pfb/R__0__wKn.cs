...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#wKn
	/// </summary>
    public partial class R__0__wKn : RMember //
    {
        ...
        public R__0__wKn() : base("#Pfb.#wKn")
        {
        }

        public R__0__wKn(System.Object instance) : base("#Pfb.#wKn")
		{
            SetInstance(instance);
		}

        public R__0__wKn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__wKn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ghs
	/// </summary>
    public partial class R__0__Ghs : RMember //
    {
        ...
        public R__0__Ghs() : base("#Pfb.#Ghs")
        {
        }

        public R__0__Ghs(System.Object instance) : base("#Pfb.#Ghs")
		{
            SetInstance(instance);
		}

        public R__0__Ghs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ghs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

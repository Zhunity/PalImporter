...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Rrb
	/// </summary>
    public partial class R__0__Rrb : RMember //
    {
        ...
        public R__0__Rrb() : base("#Pfb.#Rrb")
        {
        }

        public R__0__Rrb(System.Object instance) : base("#Pfb.#Rrb")
		{
            SetInstance(instance);
		}

        public R__0__Rrb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Rrb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Kbe
	/// </summary>
    public partial class R__0__Kbe : RMember //
    {
        ...
        public R__0__Kbe() : base("#Pfb.#Kbe")
        {
        }

        public R__0__Kbe(System.Object instance) : base("#Pfb.#Kbe")
		{
            SetInstance(instance);
		}

        public R__0__Kbe(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Kbe(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

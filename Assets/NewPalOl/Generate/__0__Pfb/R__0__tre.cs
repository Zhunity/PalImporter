...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#tre
	/// </summary>
    public partial class R__0__tre : RMember //
    {
        ...
        public R__0__tre() : base("#Pfb.#tre")
        {
        }

        public R__0__tre(System.Object instance) : base("#Pfb.#tre")
		{
            SetInstance(instance);
		}

        public R__0__tre(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__tre(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7Dm
	/// </summary>
    public partial class R__0__7Dm : RMember //
    {
        ...
        public R__0__7Dm() : base("#Pfb.#7Dm")
        {
        }

        public R__0__7Dm(System.Object instance) : base("#Pfb.#7Dm")
		{
            SetInstance(instance);
		}

        public R__0__7Dm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7Dm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

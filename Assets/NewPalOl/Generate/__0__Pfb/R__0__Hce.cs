...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Hce
	/// </summary>
    public partial class R__0__Hce : RMember //
    {
        ...
        public R__0__Hce() : base("#Pfb.#Hce")
        {
        }

        public R__0__Hce(System.Object instance) : base("#Pfb.#Hce")
		{
            SetInstance(instance);
		}

        public R__0__Hce(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Hce(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

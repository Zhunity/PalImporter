...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Kvb
	/// </summary>
    public partial class R__0__Kvb : RMember //
    {
        ...
        public R__0__Kvb() : base("#Pfb.#Kvb")
        {
        }

        public R__0__Kvb(System.Object instance) : base("#Pfb.#Kvb")
		{
            SetInstance(instance);
		}

        public R__0__Kvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Kvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Dyb
	/// </summary>
    public partial class R__0__Dyb : RMember //
    {
        ...
        public R__0__Dyb() : base("#Pfb.#Dyb")
        {
        }

        public R__0__Dyb(System.Object instance) : base("#Pfb.#Dyb")
		{
            SetInstance(instance);
		}

        public R__0__Dyb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Dyb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

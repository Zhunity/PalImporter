...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Txb
	/// </summary>
    public partial class R__0__Txb : RMember //
    {
        ...
        public R__0__Txb() : base("#Pfb.#Txb")
        {
        }

        public R__0__Txb(System.Object instance) : base("#Pfb.#Txb")
		{
            SetInstance(instance);
		}

        public R__0__Txb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Txb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

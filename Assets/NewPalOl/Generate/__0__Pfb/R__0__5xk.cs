...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#5xk
	/// </summary>
    public partial class R__0__5xk : RMember //
    {
        ...
        public R__0__5xk() : base("#Pfb.#5xk")
        {
        }

        public R__0__5xk(System.Object instance) : base("#Pfb.#5xk")
		{
            SetInstance(instance);
		}

        public R__0__5xk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5xk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#TVj
	/// </summary>
    public partial class R__0__TVj : RMember //
    {
        ...
        public R__0__TVj() : base("#Pfb.#TVj")
        {
        }

        public R__0__TVj(System.Object instance) : base("#Pfb.#TVj")
		{
            SetInstance(instance);
		}

        public R__0__TVj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__TVj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Fam
	/// </summary>
    public partial class R__0__Fam : RMember //
    {
        ...
        public R__0__Fam() : base("#Pfb.#Fam")
        {
        }

        public R__0__Fam(System.Object instance) : base("#Pfb.#Fam")
		{
            SetInstance(instance);
		}

        public R__0__Fam(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Fam(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#a3k
	/// </summary>
    public partial class R__0__a3k : RMember //
    {
        ...
        public R__0__a3k() : base("#Pfb.#a3k")
        {
        }

        public R__0__a3k(System.Object instance) : base("#Pfb.#a3k")
		{
            SetInstance(instance);
		}

        public R__0__a3k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__a3k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Efi
	/// </summary>
    public partial class R__0__Efi : RMember //
    {
        ...
        public R__0__Efi() : base("#Pfb.#Efi")
        {
        }

        public R__0__Efi(System.Object instance) : base("#Pfb.#Efi")
		{
            SetInstance(instance);
		}

        public R__0__Efi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Efi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

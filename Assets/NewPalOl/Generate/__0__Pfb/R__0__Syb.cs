...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Syb
	/// </summary>
    public partial class R__0__Syb : RMember //
    {
        ...
        public R__0__Syb() : base("#Pfb.#Syb")
        {
        }

        public R__0__Syb(System.Object instance) : base("#Pfb.#Syb")
		{
            SetInstance(instance);
		}

        public R__0__Syb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Syb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

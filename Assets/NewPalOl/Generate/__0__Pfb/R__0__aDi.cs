...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#aDi
	/// </summary>
    public partial class R__0__aDi : RMember //
    {
        ...
        public R__0__aDi() : base("#Pfb.#aDi")
        {
        }

        public R__0__aDi(System.Object instance) : base("#Pfb.#aDi")
		{
            SetInstance(instance);
		}

        public R__0__aDi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__aDi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ipb
	/// </summary>
    public partial class R__0__Ipb : RMember //
    {
        ...
        public R__0__Ipb() : base("#Pfb.#Ipb")
        {
        }

        public R__0__Ipb(System.Object instance) : base("#Pfb.#Ipb")
		{
            SetInstance(instance);
		}

        public R__0__Ipb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ipb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

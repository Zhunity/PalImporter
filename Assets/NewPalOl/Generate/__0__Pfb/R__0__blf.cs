...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#blf
	/// </summary>
    public partial class R__0__blf : RMember //
    {
        ...
        public R__0__blf() : base("#Pfb.#blf")
        {
        }

        public R__0__blf(System.Object instance) : base("#Pfb.#blf")
		{
            SetInstance(instance);
		}

        public R__0__blf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__blf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#gkg
	/// </summary>
    public partial class R__0__gkg : RMember //
    {
        ...
        public R__0__gkg() : base("#Pfb.#gkg")
        {
        }

        public R__0__gkg(System.Object instance) : base("#Pfb.#gkg")
		{
            SetInstance(instance);
		}

        public R__0__gkg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gkg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

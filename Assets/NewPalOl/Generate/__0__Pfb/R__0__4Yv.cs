...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4Yv
	/// </summary>
    public partial class R__0__4Yv : RMember //
    {
        ...
        public R__0__4Yv() : base("#Pfb.#4Yv")
        {
        }

        public R__0__4Yv(System.Object instance) : base("#Pfb.#4Yv")
		{
            SetInstance(instance);
		}

        public R__0__4Yv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4Yv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

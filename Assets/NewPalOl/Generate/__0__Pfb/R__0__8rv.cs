...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8rv
	/// </summary>
    public partial class R__0__8rv : RMember //
    {
        ...
        public R__0__8rv() : base("#Pfb.#8rv")
        {
        }

        public R__0__8rv(System.Object instance) : base("#Pfb.#8rv")
		{
            SetInstance(instance);
		}

        public R__0__8rv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8rv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#I7j
	/// </summary>
    public partial class R__0__I7j : RMember //
    {
        ...
        public R__0__I7j() : base("#Pfb.#I7j")
        {
        }

        public R__0__I7j(System.Object instance) : base("#Pfb.#I7j")
		{
            SetInstance(instance);
		}

        public R__0__I7j(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__I7j(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

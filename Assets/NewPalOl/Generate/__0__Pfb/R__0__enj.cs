...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#enj
	/// </summary>
    public partial class R__0__enj : RMember //
    {
        ...
        public R__0__enj() : base("#Pfb.#enj")
        {
        }

        public R__0__enj(System.Object instance) : base("#Pfb.#enj")
		{
            SetInstance(instance);
		}

        public R__0__enj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__enj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Vyb
	/// </summary>
    public partial class R__0__Vyb : RMember //
    {
        ...
        public R__0__Vyb() : base("#Pfb.#Vyb")
        {
        }

        public R__0__Vyb(System.Object instance) : base("#Pfb.#Vyb")
		{
            SetInstance(instance);
		}

        public R__0__Vyb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vyb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

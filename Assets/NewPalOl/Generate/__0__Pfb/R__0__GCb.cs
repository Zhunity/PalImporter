...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#GCb
	/// </summary>
    public partial class R__0__GCb : RMember //
    {
        ...
        public R__0__GCb() : base("#Pfb.#GCb")
        {
        }

        public R__0__GCb(System.Object instance) : base("#Pfb.#GCb")
		{
            SetInstance(instance);
		}

        public R__0__GCb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__GCb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

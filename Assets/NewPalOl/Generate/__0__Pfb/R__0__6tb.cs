...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#6tb
	/// </summary>
    public partial class R__0__6tb : RMember //
    {
        ...
        public R__0__6tb() : base("#Pfb.#6tb")
        {
        }

        public R__0__6tb(System.Object instance) : base("#Pfb.#6tb")
		{
            SetInstance(instance);
		}

        public R__0__6tb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6tb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Llc
	/// </summary>
    public partial class R__0__Llc : RMember //
    {
        ...
        public R__0__Llc() : base("#Pfb.#Llc")
        {
        }

        public R__0__Llc(System.Object instance) : base("#Pfb.#Llc")
		{
            SetInstance(instance);
		}

        public R__0__Llc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Llc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#lGd
	/// </summary>
    public partial class R__0__lGd : RMember //
    {
        ...
        public R__0__lGd() : base("#Pfb.#lGd")
        {
        }

        public R__0__lGd(System.Object instance) : base("#Pfb.#lGd")
		{
            SetInstance(instance);
		}

        public R__0__lGd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__lGd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

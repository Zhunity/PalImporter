...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#o6c
	/// </summary>
    public partial class R__0__o6c : RMember //
    {
        ...
        public R__0__o6c() : base("#Pfb.#o6c")
        {
        }

        public R__0__o6c(System.Object instance) : base("#Pfb.#o6c")
		{
            SetInstance(instance);
		}

        public R__0__o6c(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__o6c(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

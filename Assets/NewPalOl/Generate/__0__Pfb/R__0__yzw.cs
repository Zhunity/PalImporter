...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#yzw
	/// </summary>
    public partial class R__0__yzw : RMember //
    {
        ...
        public R__0__yzw() : base("#Pfb.#yzw")
        {
        }

        public R__0__yzw(System.Object instance) : base("#Pfb.#yzw")
		{
            SetInstance(instance);
		}

        public R__0__yzw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__yzw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

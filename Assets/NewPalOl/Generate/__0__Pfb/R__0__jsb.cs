...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#jsb
	/// </summary>
    public partial class R__0__jsb : RMember //
    {
        ...
        public R__0__jsb() : base("#Pfb.#jsb")
        {
        }

        public R__0__jsb(System.Object instance) : base("#Pfb.#jsb")
		{
            SetInstance(instance);
		}

        public R__0__jsb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jsb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#46q
	/// </summary>
    public partial class R__0__46q : RMember //
    {
        ...
        public R__0__46q() : base("#Pfb.#46q")
        {
        }

        public R__0__46q(System.Object instance) : base("#Pfb.#46q")
		{
            SetInstance(instance);
		}

        public R__0__46q(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__46q(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

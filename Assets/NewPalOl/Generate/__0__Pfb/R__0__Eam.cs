...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Eam
	/// </summary>
    public partial class R__0__Eam : RMember //
    {
        ...
        public R__0__Eam() : base("#Pfb.#Eam")
        {
        }

        public R__0__Eam(System.Object instance) : base("#Pfb.#Eam")
		{
            SetInstance(instance);
		}

        public R__0__Eam(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Eam(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

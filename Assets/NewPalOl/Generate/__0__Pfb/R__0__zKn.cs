...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#zKn
	/// </summary>
    public partial class R__0__zKn : RMember //
    {
        ...
        public R__0__zKn() : base("#Pfb.#zKn")
        {
        }

        public R__0__zKn(System.Object instance) : base("#Pfb.#zKn")
		{
            SetInstance(instance);
		}

        public R__0__zKn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zKn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#uAb
	/// </summary>
    public partial class R__0__uAb : RMember //
    {
        ...
        public R__0__uAb() : base("#Pfb.#uAb")
        {
        }

        public R__0__uAb(System.Object instance) : base("#Pfb.#uAb")
		{
            SetInstance(instance);
		}

        public R__0__uAb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__uAb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

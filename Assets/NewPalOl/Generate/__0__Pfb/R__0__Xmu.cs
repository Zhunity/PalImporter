...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Xmu
	/// </summary>
    public partial class R__0__Xmu : RMember //
    {
        ...
        public R__0__Xmu() : base("#Pfb.#Xmu")
        {
        }

        public R__0__Xmu(System.Object instance) : base("#Pfb.#Xmu")
		{
            SetInstance(instance);
		}

        public R__0__Xmu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Xmu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

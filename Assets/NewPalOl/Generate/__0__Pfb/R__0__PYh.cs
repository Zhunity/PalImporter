...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#PYh
	/// </summary>
    public partial class R__0__PYh : RMember //
    {
        ...
        public R__0__PYh() : base("#Pfb.#PYh")
        {
        }

        public R__0__PYh(System.Object instance) : base("#Pfb.#PYh")
		{
            SetInstance(instance);
		}

        public R__0__PYh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__PYh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

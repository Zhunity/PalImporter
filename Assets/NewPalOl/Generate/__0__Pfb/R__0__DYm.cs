...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#DYm
	/// </summary>
    public partial class R__0__DYm : RMember //
    {
        ...
        public R__0__DYm() : base("#Pfb.#DYm")
        {
        }

        public R__0__DYm(System.Object instance) : base("#Pfb.#DYm")
		{
            SetInstance(instance);
		}

        public R__0__DYm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__DYm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

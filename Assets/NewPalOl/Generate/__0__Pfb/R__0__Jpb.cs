...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Jpb
	/// </summary>
    public partial class R__0__Jpb : RMember //
    {
        ...
        public R__0__Jpb() : base("#Pfb.#Jpb")
        {
        }

        public R__0__Jpb(System.Object instance) : base("#Pfb.#Jpb")
		{
            SetInstance(instance);
		}

        public R__0__Jpb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Jpb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#n0c
	/// </summary>
    public partial class R__0__n0c : RMember //
    {
        ...
        public R__0__n0c() : base("#Pfb.#n0c")
        {
        }

        public R__0__n0c(System.Object instance) : base("#Pfb.#n0c")
		{
            SetInstance(instance);
		}

        public R__0__n0c(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__n0c(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

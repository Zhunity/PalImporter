...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Qhp
	/// </summary>
    public partial class R__0__Qhp : RMember //
    {
        ...
        public R__0__Qhp() : base("#Pfb.#Qhp")
        {
        }

        public R__0__Qhp(System.Object instance) : base("#Pfb.#Qhp")
		{
            SetInstance(instance);
		}

        public R__0__Qhp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Qhp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

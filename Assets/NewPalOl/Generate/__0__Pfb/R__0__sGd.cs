...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#sGd
	/// </summary>
    public partial class R__0__sGd : RMember //
    {
        ...
        public R__0__sGd() : base("#Pfb.#sGd")
        {
        }

        public R__0__sGd(System.Object instance) : base("#Pfb.#sGd")
		{
            SetInstance(instance);
		}

        public R__0__sGd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__sGd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4xb
	/// </summary>
    public partial class R__0__4xb : RMember //
    {
        ...
        public R__0__4xb() : base("#Pfb.#4xb")
        {
        }

        public R__0__4xb(System.Object instance) : base("#Pfb.#4xb")
		{
            SetInstance(instance);
		}

        public R__0__4xb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4xb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

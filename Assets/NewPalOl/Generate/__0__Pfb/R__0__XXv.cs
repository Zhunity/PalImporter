...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#XXv
	/// </summary>
    public partial class R__0__XXv : RMember //
    {
        ...
        public R__0__XXv() : base("#Pfb.#XXv")
        {
        }

        public R__0__XXv(System.Object instance) : base("#Pfb.#XXv")
		{
            SetInstance(instance);
		}

        public R__0__XXv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XXv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4wb
	/// </summary>
    public partial class R__0__4wb : RMember //
    {
        ...
        public R__0__4wb() : base("#Pfb.#4wb")
        {
        }

        public R__0__4wb(System.Object instance) : base("#Pfb.#4wb")
		{
            SetInstance(instance);
		}

        public R__0__4wb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4wb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Xsx
	/// </summary>
    public partial class R__0__Xsx : RMember //
    {
        ...
        public R__0__Xsx() : base("#Pfb.#Xsx")
        {
        }

        public R__0__Xsx(System.Object instance) : base("#Pfb.#Xsx")
		{
            SetInstance(instance);
		}

        public R__0__Xsx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Xsx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#kDr
	/// </summary>
    public partial class R__0__kDr : RMember //
    {
        ...
        public R__0__kDr() : base("#Pfb.#kDr")
        {
        }

        public R__0__kDr(System.Object instance) : base("#Pfb.#kDr")
		{
            SetInstance(instance);
		}

        public R__0__kDr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__kDr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

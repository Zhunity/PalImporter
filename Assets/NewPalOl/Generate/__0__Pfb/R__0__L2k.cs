...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#L2k
	/// </summary>
    public partial class R__0__L2k : RMember //
    {
        ...
        public R__0__L2k() : base("#Pfb.#L2k")
        {
        }

        public R__0__L2k(System.Object instance) : base("#Pfb.#L2k")
		{
            SetInstance(instance);
		}

        public R__0__L2k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__L2k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

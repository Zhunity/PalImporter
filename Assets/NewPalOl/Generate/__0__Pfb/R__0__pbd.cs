...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#pbd
	/// </summary>
    public partial class R__0__pbd : RMember //
    {
        ...
        public R__0__pbd() : base("#Pfb.#pbd")
        {
        }

        public R__0__pbd(System.Object instance) : base("#Pfb.#pbd")
		{
            SetInstance(instance);
		}

        public R__0__pbd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__pbd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

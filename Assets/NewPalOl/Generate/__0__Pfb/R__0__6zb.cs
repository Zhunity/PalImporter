...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#6zb
	/// </summary>
    public partial class R__0__6zb : RMember //
    {
        ...
        public R__0__6zb() : base("#Pfb.#6zb")
        {
        }

        public R__0__6zb(System.Object instance) : base("#Pfb.#6zb")
		{
            SetInstance(instance);
		}

        public R__0__6zb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6zb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

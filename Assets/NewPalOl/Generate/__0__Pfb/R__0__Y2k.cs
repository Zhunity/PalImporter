...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Y2k
	/// </summary>
    public partial class R__0__Y2k : RMember //
    {
        ...
        public R__0__Y2k() : base("#Pfb.#Y2k")
        {
        }

        public R__0__Y2k(System.Object instance) : base("#Pfb.#Y2k")
		{
            SetInstance(instance);
		}

        public R__0__Y2k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Y2k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#xzw
	/// </summary>
    public partial class R__0__xzw : RMember //
    {
        ...
        public R__0__xzw() : base("#Pfb.#xzw")
        {
        }

        public R__0__xzw(System.Object instance) : base("#Pfb.#xzw")
		{
            SetInstance(instance);
		}

        public R__0__xzw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__xzw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#UDb
	/// </summary>
    public partial class R__0__UDb : RMember //
    {
        ...
        public R__0__UDb() : base("#Pfb.#UDb")
        {
        }

        public R__0__UDb(System.Object instance) : base("#Pfb.#UDb")
		{
            SetInstance(instance);
		}

        public R__0__UDb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__UDb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

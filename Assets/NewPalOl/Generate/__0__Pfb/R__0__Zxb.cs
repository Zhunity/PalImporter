...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Zxb
	/// </summary>
    public partial class R__0__Zxb : RMember //
    {
        ...
        public R__0__Zxb() : base("#Pfb.#Zxb")
        {
        }

        public R__0__Zxb(System.Object instance) : base("#Pfb.#Zxb")
		{
            SetInstance(instance);
		}

        public R__0__Zxb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Zxb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

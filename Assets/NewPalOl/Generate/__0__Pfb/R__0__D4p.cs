...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#D4p
	/// </summary>
    public partial class R__0__D4p : RMember //
    {
        ...
        public R__0__D4p() : base("#Pfb.#D4p")
        {
        }

        public R__0__D4p(System.Object instance) : base("#Pfb.#D4p")
		{
            SetInstance(instance);
		}

        public R__0__D4p(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__D4p(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

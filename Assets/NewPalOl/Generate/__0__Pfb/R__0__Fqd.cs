...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Fqd
	/// </summary>
    public partial class R__0__Fqd : RMember //
    {
        ...
        public R__0__Fqd() : base("#Pfb.#Fqd")
        {
        }

        public R__0__Fqd(System.Object instance) : base("#Pfb.#Fqd")
		{
            SetInstance(instance);
		}

        public R__0__Fqd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Fqd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

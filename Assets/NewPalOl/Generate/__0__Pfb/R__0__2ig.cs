...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#2ig
	/// </summary>
    public partial class R__0__2ig : RMember //
    {
        ...
        public R__0__2ig() : base("#Pfb.#2ig")
        {
        }

        public R__0__2ig(System.Object instance) : base("#Pfb.#2ig")
		{
            SetInstance(instance);
		}

        public R__0__2ig(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2ig(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#5jg
	/// </summary>
    public partial class R__0__5jg : RMember //
    {
        ...
        public R__0__5jg() : base("#Pfb.#5jg")
        {
        }

        public R__0__5jg(System.Object instance) : base("#Pfb.#5jg")
		{
            SetInstance(instance);
		}

        public R__0__5jg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5jg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#LLh
	/// </summary>
    public partial class R__0__LLh : RMember //
    {
        ...
        public R__0__LLh() : base("#Pfb.#LLh")
        {
        }

        public R__0__LLh(System.Object instance) : base("#Pfb.#LLh")
		{
            SetInstance(instance);
		}

        public R__0__LLh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__LLh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

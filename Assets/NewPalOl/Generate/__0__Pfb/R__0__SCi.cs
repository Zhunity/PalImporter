...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#SCi
	/// </summary>
    public partial class R__0__SCi : RMember //
    {
        ...
        public R__0__SCi() : base("#Pfb.#SCi")
        {
        }

        public R__0__SCi(System.Object instance) : base("#Pfb.#SCi")
		{
            SetInstance(instance);
		}

        public R__0__SCi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__SCi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

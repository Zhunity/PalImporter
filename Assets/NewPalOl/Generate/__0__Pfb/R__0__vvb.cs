...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#vvb
	/// </summary>
    public partial class R__0__vvb : RMember //
    {
        ...
        public R__0__vvb() : base("#Pfb.#vvb")
        {
        }

        public R__0__vvb(System.Object instance) : base("#Pfb.#vvb")
		{
            SetInstance(instance);
		}

        public R__0__vvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__vvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

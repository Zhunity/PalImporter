...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#yGd
	/// </summary>
    public partial class R__0__yGd : RMember //
    {
        ...
        public R__0__yGd() : base("#Pfb.#yGd")
        {
        }

        public R__0__yGd(System.Object instance) : base("#Pfb.#yGd")
		{
            SetInstance(instance);
		}

        public R__0__yGd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__yGd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#RXl
	/// </summary>
    public partial class R__0__RXl : RMember //
    {
        ...
        public R__0__RXl() : base("#Pfb.#RXl")
        {
        }

        public R__0__RXl(System.Object instance) : base("#Pfb.#RXl")
		{
            SetInstance(instance);
		}

        public R__0__RXl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__RXl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

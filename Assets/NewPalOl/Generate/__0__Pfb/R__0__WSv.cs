...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#WSv
	/// </summary>
    public partial class R__0__WSv : RMember //
    {
        ...
        public R__0__WSv() : base("#Pfb.#WSv")
        {
        }

        public R__0__WSv(System.Object instance) : base("#Pfb.#WSv")
		{
            SetInstance(instance);
		}

        public R__0__WSv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__WSv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#I4p
	/// </summary>
    public partial class R__0__I4p : RMember //
    {
        ...
        public R__0__I4p() : base("#Pfb.#I4p")
        {
        }

        public R__0__I4p(System.Object instance) : base("#Pfb.#I4p")
		{
            SetInstance(instance);
		}

        public R__0__I4p(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__I4p(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

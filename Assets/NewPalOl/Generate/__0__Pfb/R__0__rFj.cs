...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#rFj
	/// </summary>
    public partial class R__0__rFj : RMember //
    {
        ...
        public R__0__rFj() : base("#Pfb.#rFj")
        {
        }

        public R__0__rFj(System.Object instance) : base("#Pfb.#rFj")
		{
            SetInstance(instance);
		}

        public R__0__rFj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__rFj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

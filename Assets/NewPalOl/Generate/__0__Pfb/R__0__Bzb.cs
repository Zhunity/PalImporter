...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Bzb
	/// </summary>
    public partial class R__0__Bzb : RMember //
    {
        ...
        public R__0__Bzb() : base("#Pfb.#Bzb")
        {
        }

        public R__0__Bzb(System.Object instance) : base("#Pfb.#Bzb")
		{
            SetInstance(instance);
		}

        public R__0__Bzb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Bzb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

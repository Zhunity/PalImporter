...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Gvl
	/// </summary>
    public partial class R__0__Gvl : RMember //
    {
        ...
        public R__0__Gvl() : base("#Pfb.#Gvl")
        {
        }

        public R__0__Gvl(System.Object instance) : base("#Pfb.#Gvl")
		{
            SetInstance(instance);
		}

        public R__0__Gvl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Gvl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#vDr
	/// </summary>
    public partial class R__0__vDr : RMember //
    {
        ...
        public R__0__vDr() : base("#Pfb.#vDr")
        {
        }

        public R__0__vDr(System.Object instance) : base("#Pfb.#vDr")
		{
            SetInstance(instance);
		}

        public R__0__vDr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__vDr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

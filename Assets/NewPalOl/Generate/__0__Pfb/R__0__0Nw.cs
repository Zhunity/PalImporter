...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0Nw
	/// </summary>
    public partial class R__0__0Nw : RMember //
    {
        ...
        public R__0__0Nw() : base("#Pfb.#0Nw")
        {
        }

        public R__0__0Nw(System.Object instance) : base("#Pfb.#0Nw")
		{
            SetInstance(instance);
		}

        public R__0__0Nw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0Nw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

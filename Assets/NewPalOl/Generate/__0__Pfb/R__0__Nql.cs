...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Nql
	/// </summary>
    public partial class R__0__Nql : RMember //
    {
        ...
        public R__0__Nql() : base("#Pfb.#Nql")
        {
        }

        public R__0__Nql(System.Object instance) : base("#Pfb.#Nql")
		{
            SetInstance(instance);
		}

        public R__0__Nql(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Nql(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

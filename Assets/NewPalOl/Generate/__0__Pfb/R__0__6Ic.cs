...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#6Ic
	/// </summary>
    public partial class R__0__6Ic : RMember //
    {
        ...
        public R__0__6Ic() : base("#Pfb.#6Ic")
        {
        }

        public R__0__6Ic(System.Object instance) : base("#Pfb.#6Ic")
		{
            SetInstance(instance);
		}

        public R__0__6Ic(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6Ic(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ujx
	/// </summary>
    public partial class R__0__Ujx : RMember //
    {
        ...
        public R__0__Ujx() : base("#Pfb.#Ujx")
        {
        }

        public R__0__Ujx(System.Object instance) : base("#Pfb.#Ujx")
		{
            SetInstance(instance);
		}

        public R__0__Ujx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ujx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

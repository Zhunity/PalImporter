...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4Tn
	/// </summary>
    public partial class R__0__4Tn : RMember //
    {
        ...
        public R__0__4Tn() : base("#Pfb.#4Tn")
        {
        }

        public R__0__4Tn(System.Object instance) : base("#Pfb.#4Tn")
		{
            SetInstance(instance);
		}

        public R__0__4Tn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4Tn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

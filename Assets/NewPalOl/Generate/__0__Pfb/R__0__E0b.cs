...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#E0b
	/// </summary>
    public partial class R__0__E0b : RMember //
    {
        ...
        public R__0__E0b() : base("#Pfb.#E0b")
        {
        }

        public R__0__E0b(System.Object instance) : base("#Pfb.#E0b")
		{
            SetInstance(instance);
		}

        public R__0__E0b(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__E0b(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

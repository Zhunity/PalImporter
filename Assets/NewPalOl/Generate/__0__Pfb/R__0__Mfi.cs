...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Mfi
	/// </summary>
    public partial class R__0__Mfi : RMember //
    {
        ...
        public R__0__Mfi() : base("#Pfb.#Mfi")
        {
        }

        public R__0__Mfi(System.Object instance) : base("#Pfb.#Mfi")
		{
            SetInstance(instance);
		}

        public R__0__Mfi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Mfi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

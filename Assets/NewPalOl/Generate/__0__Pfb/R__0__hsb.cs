...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#hsb
	/// </summary>
    public partial class R__0__hsb : RMember //
    {
        ...
        public R__0__hsb() : base("#Pfb.#hsb")
        {
        }

        public R__0__hsb(System.Object instance) : base("#Pfb.#hsb")
		{
            SetInstance(instance);
		}

        public R__0__hsb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hsb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

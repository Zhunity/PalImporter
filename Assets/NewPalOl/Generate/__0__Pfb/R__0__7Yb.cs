...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7Yb
	/// </summary>
    public partial class R__0__7Yb : RMember //
    {
        ...
        public R__0__7Yb() : base("#Pfb.#7Yb")
        {
        }

        public R__0__7Yb(System.Object instance) : base("#Pfb.#7Yb")
		{
            SetInstance(instance);
		}

        public R__0__7Yb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7Yb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

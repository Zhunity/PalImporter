...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Cxb
	/// </summary>
    public partial class R__0__Cxb : RMember //
    {
        ...
        public R__0__Cxb() : base("#Pfb.#Cxb")
        {
        }

        public R__0__Cxb(System.Object instance) : base("#Pfb.#Cxb")
		{
            SetInstance(instance);
		}

        public R__0__Cxb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Cxb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

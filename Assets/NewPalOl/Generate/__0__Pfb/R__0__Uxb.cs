...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Uxb
	/// </summary>
    public partial class R__0__Uxb : RMember //
    {
        ...
        public R__0__Uxb() : base("#Pfb.#Uxb")
        {
        }

        public R__0__Uxb(System.Object instance) : base("#Pfb.#Uxb")
		{
            SetInstance(instance);
		}

        public R__0__Uxb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Uxb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

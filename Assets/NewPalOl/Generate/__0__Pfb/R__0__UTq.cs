...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#UTq
	/// </summary>
    public partial class R__0__UTq : RMember //
    {
        ...
        public R__0__UTq() : base("#Pfb.#UTq")
        {
        }

        public R__0__UTq(System.Object instance) : base("#Pfb.#UTq")
		{
            SetInstance(instance);
		}

        public R__0__UTq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__UTq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

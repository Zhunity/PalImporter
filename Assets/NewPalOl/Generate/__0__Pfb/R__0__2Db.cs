...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#2Db
	/// </summary>
    public partial class R__0__2Db : RMember //
    {
        ...
        public R__0__2Db() : base("#Pfb.#2Db")
        {
        }

        public R__0__2Db(System.Object instance) : base("#Pfb.#2Db")
		{
            SetInstance(instance);
		}

        public R__0__2Db(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2Db(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Lad
	/// </summary>
    public partial class R__0__Lad : RMember //
    {
        ...
        public R__0__Lad() : base("#Pfb.#Lad")
        {
        }

        public R__0__Lad(System.Object instance) : base("#Pfb.#Lad")
		{
            SetInstance(instance);
		}

        public R__0__Lad(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Lad(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

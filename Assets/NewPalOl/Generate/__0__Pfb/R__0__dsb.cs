...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#dsb
	/// </summary>
    public partial class R__0__dsb : RMember //
    {
        ...
        public R__0__dsb() : base("#Pfb.#dsb")
        {
        }

        public R__0__dsb(System.Object instance) : base("#Pfb.#dsb")
		{
            SetInstance(instance);
		}

        public R__0__dsb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dsb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

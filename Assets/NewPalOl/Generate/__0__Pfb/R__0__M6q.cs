...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#M6q
	/// </summary>
    public partial class R__0__M6q : RMember //
    {
        ...
        public R__0__M6q() : base("#Pfb.#M6q")
        {
        }

        public R__0__M6q(System.Object instance) : base("#Pfb.#M6q")
		{
            SetInstance(instance);
		}

        public R__0__M6q(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__M6q(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Mhp
	/// </summary>
    public partial class R__0__Mhp : RMember //
    {
        ...
        public R__0__Mhp() : base("#Pfb.#Mhp")
        {
        }

        public R__0__Mhp(System.Object instance) : base("#Pfb.#Mhp")
		{
            SetInstance(instance);
		}

        public R__0__Mhp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Mhp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

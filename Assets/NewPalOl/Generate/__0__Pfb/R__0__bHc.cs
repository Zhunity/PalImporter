...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#bHc
	/// </summary>
    public partial class R__0__bHc : RMember //
    {
        ...
        public R__0__bHc() : base("#Pfb.#bHc")
        {
        }

        public R__0__bHc(System.Object instance) : base("#Pfb.#bHc")
		{
            SetInstance(instance);
		}

        public R__0__bHc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__bHc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#mVr
	/// </summary>
    public partial class R__0__mVr : RMember //
    {
        ...
        public R__0__mVr() : base("#Pfb.#mVr")
        {
        }

        public R__0__mVr(System.Object instance) : base("#Pfb.#mVr")
		{
            SetInstance(instance);
		}

        public R__0__mVr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__mVr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

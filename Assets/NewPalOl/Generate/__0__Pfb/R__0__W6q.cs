...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#W6q
	/// </summary>
    public partial class R__0__W6q : RMember //
    {
        ...
        public R__0__W6q() : base("#Pfb.#W6q")
        {
        }

        public R__0__W6q(System.Object instance) : base("#Pfb.#W6q")
		{
            SetInstance(instance);
		}

        public R__0__W6q(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__W6q(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

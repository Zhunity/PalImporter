...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#HGg
	/// </summary>
    public partial class R__0__HGg : RMember //
    {
        ...
        public R__0__HGg() : base("#Pfb.#HGg")
        {
        }

        public R__0__HGg(System.Object instance) : base("#Pfb.#HGg")
		{
            SetInstance(instance);
		}

        public R__0__HGg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__HGg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Qql
	/// </summary>
    public partial class R__0__Qql : RMember //
    {
        ...
        public R__0__Qql() : base("#Pfb.#Qql")
        {
        }

        public R__0__Qql(System.Object instance) : base("#Pfb.#Qql")
		{
            SetInstance(instance);
		}

        public R__0__Qql(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Qql(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Vjx
	/// </summary>
    public partial class R__0__Vjx : RMember //
    {
        ...
        public R__0__Vjx() : base("#Pfb.#Vjx")
        {
        }

        public R__0__Vjx(System.Object instance) : base("#Pfb.#Vjx")
		{
            SetInstance(instance);
		}

        public R__0__Vjx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vjx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Vxd
	/// </summary>
    public partial class R__0__Vxd : RMember //
    {
        ...
        public R__0__Vxd() : base("#Pfb.#Vxd")
        {
        }

        public R__0__Vxd(System.Object instance) : base("#Pfb.#Vxd")
		{
            SetInstance(instance);
		}

        public R__0__Vxd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vxd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

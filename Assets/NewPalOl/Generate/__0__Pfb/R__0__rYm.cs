...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#rYm
	/// </summary>
    public partial class R__0__rYm : RMember //
    {
        ...
        public R__0__rYm() : base("#Pfb.#rYm")
        {
        }

        public R__0__rYm(System.Object instance) : base("#Pfb.#rYm")
		{
            SetInstance(instance);
		}

        public R__0__rYm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__rYm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

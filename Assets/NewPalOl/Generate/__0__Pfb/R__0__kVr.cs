...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#kVr
	/// </summary>
    public partial class R__0__kVr : RMember //
    {
        ...
        public R__0__kVr() : base("#Pfb.#kVr")
        {
        }

        public R__0__kVr(System.Object instance) : base("#Pfb.#kVr")
		{
            SetInstance(instance);
		}

        public R__0__kVr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__kVr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#rwb
	/// </summary>
    public partial class R__0__rwb : RMember //
    {
        ...
        public R__0__rwb() : base("#Pfb.#rwb")
        {
        }

        public R__0__rwb(System.Object instance) : base("#Pfb.#rwb")
		{
            SetInstance(instance);
		}

        public R__0__rwb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__rwb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

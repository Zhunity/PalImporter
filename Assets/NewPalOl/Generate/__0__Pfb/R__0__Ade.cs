...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ade
	/// </summary>
    public partial class R__0__Ade : RMember //
    {
        ...
        public R__0__Ade() : base("#Pfb.#Ade")
        {
        }

        public R__0__Ade(System.Object instance) : base("#Pfb.#Ade")
		{
            SetInstance(instance);
		}

        public R__0__Ade(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ade(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

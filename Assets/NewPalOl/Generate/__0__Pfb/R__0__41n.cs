...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#41n
	/// </summary>
    public partial class R__0__41n : RMember //
    {
        ...
        public R__0__41n() : base("#Pfb.#41n")
        {
        }

        public R__0__41n(System.Object instance) : base("#Pfb.#41n")
		{
            SetInstance(instance);
		}

        public R__0__41n(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__41n(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

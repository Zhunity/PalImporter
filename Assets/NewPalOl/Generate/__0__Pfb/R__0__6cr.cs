...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#6cr
	/// </summary>
    public partial class R__0__6cr : RMember //
    {
        ...
        public R__0__6cr() : base("#Pfb.#6cr")
        {
        }

        public R__0__6cr(System.Object instance) : base("#Pfb.#6cr")
		{
            SetInstance(instance);
		}

        public R__0__6cr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6cr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

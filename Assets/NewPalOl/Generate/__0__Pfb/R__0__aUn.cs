...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#aUn
	/// </summary>
    public partial class R__0__aUn : RMember //
    {
        ...
        public R__0__aUn() : base("#Pfb.#aUn")
        {
        }

        public R__0__aUn(System.Object instance) : base("#Pfb.#aUn")
		{
            SetInstance(instance);
		}

        public R__0__aUn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__aUn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7jg
	/// </summary>
    public partial class R__0__7jg : RMember //
    {
        ...
        public R__0__7jg() : base("#Pfb.#7jg")
        {
        }

        public R__0__7jg(System.Object instance) : base("#Pfb.#7jg")
		{
            SetInstance(instance);
		}

        public R__0__7jg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7jg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

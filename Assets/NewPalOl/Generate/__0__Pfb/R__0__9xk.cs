...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9xk
	/// </summary>
    public partial class R__0__9xk : RMember //
    {
        ...
        public R__0__9xk() : base("#Pfb.#9xk")
        {
        }

        public R__0__9xk(System.Object instance) : base("#Pfb.#9xk")
		{
            SetInstance(instance);
		}

        public R__0__9xk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9xk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

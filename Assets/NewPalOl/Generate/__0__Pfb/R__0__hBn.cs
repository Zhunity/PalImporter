...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#hBn
	/// </summary>
    public partial class R__0__hBn : RMember //
    {
        ...
        public R__0__hBn() : base("#Pfb.#hBn")
        {
        }

        public R__0__hBn(System.Object instance) : base("#Pfb.#hBn")
		{
            SetInstance(instance);
		}

        public R__0__hBn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hBn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#NXu
	/// </summary>
    public partial class R__0__NXu : RMember //
    {
        ...
        public R__0__NXu() : base("#Pfb.#NXu")
        {
        }

        public R__0__NXu(System.Object instance) : base("#Pfb.#NXu")
		{
            SetInstance(instance);
		}

        public R__0__NXu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__NXu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Eek
	/// </summary>
    public partial class R__0__Eek : RMember //
    {
        ...
        public R__0__Eek() : base("#Pfb.#Eek")
        {
        }

        public R__0__Eek(System.Object instance) : base("#Pfb.#Eek")
		{
            SetInstance(instance);
		}

        public R__0__Eek(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Eek(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

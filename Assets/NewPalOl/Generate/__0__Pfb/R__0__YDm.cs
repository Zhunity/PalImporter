...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#YDm
	/// </summary>
    public partial class R__0__YDm : RMember //
    {
        ...
        public R__0__YDm() : base("#Pfb.#YDm")
        {
        }

        public R__0__YDm(System.Object instance) : base("#Pfb.#YDm")
		{
            SetInstance(instance);
		}

        public R__0__YDm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YDm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

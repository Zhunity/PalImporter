...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#5Ec
	/// </summary>
    public partial class R__0__5Ec : RMember //
    {
        ...
        public R__0__5Ec() : base("#Pfb.#5Ec")
        {
        }

        public R__0__5Ec(System.Object instance) : base("#Pfb.#5Ec")
		{
            SetInstance(instance);
		}

        public R__0__5Ec(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5Ec(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

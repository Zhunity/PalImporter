...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#1qf
	/// </summary>
    public partial class R__0__1qf : RMember //
    {
        ...
        public R__0__1qf() : base("#Pfb.#1qf")
        {
        }

        public R__0__1qf(System.Object instance) : base("#Pfb.#1qf")
		{
            SetInstance(instance);
		}

        public R__0__1qf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1qf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

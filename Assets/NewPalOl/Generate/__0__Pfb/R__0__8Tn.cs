...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8Tn
	/// </summary>
    public partial class R__0__8Tn : RMember //
    {
        ...
        public R__0__8Tn() : base("#Pfb.#8Tn")
        {
        }

        public R__0__8Tn(System.Object instance) : base("#Pfb.#8Tn")
		{
            SetInstance(instance);
		}

        public R__0__8Tn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Tn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Gyb
	/// </summary>
    public partial class R__0__Gyb : RMember //
    {
        ...
        public R__0__Gyb() : base("#Pfb.#Gyb")
        {
        }

        public R__0__Gyb(System.Object instance) : base("#Pfb.#Gyb")
		{
            SetInstance(instance);
		}

        public R__0__Gyb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Gyb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

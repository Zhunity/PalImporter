...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Bde
	/// </summary>
    public partial class R__0__Bde : RMember //
    {
        ...
        public R__0__Bde() : base("#Pfb.#Bde")
        {
        }

        public R__0__Bde(System.Object instance) : base("#Pfb.#Bde")
		{
            SetInstance(instance);
		}

        public R__0__Bde(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Bde(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

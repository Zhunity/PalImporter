...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Dzb
	/// </summary>
    public partial class R__0__Dzb : RMember //
    {
        ...
        public R__0__Dzb() : base("#Pfb.#Dzb")
        {
        }

        public R__0__Dzb(System.Object instance) : base("#Pfb.#Dzb")
		{
            SetInstance(instance);
		}

        public R__0__Dzb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Dzb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

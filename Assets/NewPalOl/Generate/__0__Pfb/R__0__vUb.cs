...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#vUb
	/// </summary>
    public partial class R__0__vUb : RMember //
    {
        ...
        public R__0__vUb() : base("#Pfb.#vUb")
        {
        }

        public R__0__vUb(System.Object instance) : base("#Pfb.#vUb")
		{
            SetInstance(instance);
		}

        public R__0__vUb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__vUb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

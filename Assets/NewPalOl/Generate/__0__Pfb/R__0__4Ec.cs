...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4Ec
	/// </summary>
    public partial class R__0__4Ec : RMember //
    {
        ...
        public R__0__4Ec() : base("#Pfb.#4Ec")
        {
        }

        public R__0__4Ec(System.Object instance) : base("#Pfb.#4Ec")
		{
            SetInstance(instance);
		}

        public R__0__4Ec(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4Ec(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

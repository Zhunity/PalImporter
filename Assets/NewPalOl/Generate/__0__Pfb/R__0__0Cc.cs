...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0Cc
	/// </summary>
    public partial class R__0__0Cc : RMember //
    {
        ...
        public R__0__0Cc() : base("#Pfb.#0Cc")
        {
        }

        public R__0__0Cc(System.Object instance) : base("#Pfb.#0Cc")
		{
            SetInstance(instance);
		}

        public R__0__0Cc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0Cc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

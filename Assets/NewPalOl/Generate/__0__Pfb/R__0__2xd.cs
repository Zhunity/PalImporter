...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#2xd
	/// </summary>
    public partial class R__0__2xd : RMember //
    {
        ...
        public R__0__2xd() : base("#Pfb.#2xd")
        {
        }

        public R__0__2xd(System.Object instance) : base("#Pfb.#2xd")
		{
            SetInstance(instance);
		}

        public R__0__2xd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2xd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

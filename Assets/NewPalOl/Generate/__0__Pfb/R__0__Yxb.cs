...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Yxb
	/// </summary>
    public partial class R__0__Yxb : RMember //
    {
        ...
        public R__0__Yxb() : base("#Pfb.#Yxb")
        {
        }

        public R__0__Yxb(System.Object instance) : base("#Pfb.#Yxb")
		{
            SetInstance(instance);
		}

        public R__0__Yxb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Yxb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

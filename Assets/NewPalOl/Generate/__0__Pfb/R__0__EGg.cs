...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#EGg
	/// </summary>
    public partial class R__0__EGg : RMember //
    {
        ...
        public R__0__EGg() : base("#Pfb.#EGg")
        {
        }

        public R__0__EGg(System.Object instance) : base("#Pfb.#EGg")
		{
            SetInstance(instance);
		}

        public R__0__EGg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__EGg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

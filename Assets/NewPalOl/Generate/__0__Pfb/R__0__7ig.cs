...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7ig
	/// </summary>
    public partial class R__0__7ig : RMember //
    {
        ...
        public R__0__7ig() : base("#Pfb.#7ig")
        {
        }

        public R__0__7ig(System.Object instance) : base("#Pfb.#7ig")
		{
            SetInstance(instance);
		}

        public R__0__7ig(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7ig(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

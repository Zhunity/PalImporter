...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#P6q
	/// </summary>
    public partial class R__0__P6q : RMember //
    {
        ...
        public R__0__P6q() : base("#Pfb.#P6q")
        {
        }

        public R__0__P6q(System.Object instance) : base("#Pfb.#P6q")
		{
            SetInstance(instance);
		}

        public R__0__P6q(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__P6q(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

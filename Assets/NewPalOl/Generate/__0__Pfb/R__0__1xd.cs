...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#1xd
	/// </summary>
    public partial class R__0__1xd : RMember //
    {
        ...
        public R__0__1xd() : base("#Pfb.#1xd")
        {
        }

        public R__0__1xd(System.Object instance) : base("#Pfb.#1xd")
		{
            SetInstance(instance);
		}

        public R__0__1xd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1xd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

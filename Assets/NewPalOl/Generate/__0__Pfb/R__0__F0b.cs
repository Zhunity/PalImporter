...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#F0b
	/// </summary>
    public partial class R__0__F0b : RMember //
    {
        ...
        public R__0__F0b() : base("#Pfb.#F0b")
        {
        }

        public R__0__F0b(System.Object instance) : base("#Pfb.#F0b")
		{
            SetInstance(instance);
		}

        public R__0__F0b(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__F0b(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

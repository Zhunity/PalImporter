...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Gqd
	/// </summary>
    public partial class R__0__Gqd : RMember //
    {
        ...
        public R__0__Gqd() : base("#Pfb.#Gqd")
        {
        }

        public R__0__Gqd(System.Object instance) : base("#Pfb.#Gqd")
		{
            SetInstance(instance);
		}

        public R__0__Gqd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Gqd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

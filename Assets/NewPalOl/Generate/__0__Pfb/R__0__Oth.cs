...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Oth
	/// </summary>
    public partial class R__0__Oth : RMember //
    {
        ...
        public R__0__Oth() : base("#Pfb.#Oth")
        {
        }

        public R__0__Oth(System.Object instance) : base("#Pfb.#Oth")
		{
            SetInstance(instance);
		}

        public R__0__Oth(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Oth(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

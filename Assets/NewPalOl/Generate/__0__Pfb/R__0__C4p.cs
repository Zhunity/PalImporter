...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#C4p
	/// </summary>
    public partial class R__0__C4p : RMember //
    {
        ...
        public R__0__C4p() : base("#Pfb.#C4p")
        {
        }

        public R__0__C4p(System.Object instance) : base("#Pfb.#C4p")
		{
            SetInstance(instance);
		}

        public R__0__C4p(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__C4p(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#wUb
	/// </summary>
    public partial class R__0__wUb : RMember //
    {
        ...
        public R__0__wUb() : base("#Pfb.#wUb")
        {
        }

        public R__0__wUb(System.Object instance) : base("#Pfb.#wUb")
		{
            SetInstance(instance);
		}

        public R__0__wUb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__wUb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

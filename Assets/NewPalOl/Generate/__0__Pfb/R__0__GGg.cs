...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#GGg
	/// </summary>
    public partial class R__0__GGg : RMember //
    {
        ...
        public R__0__GGg() : base("#Pfb.#GGg")
        {
        }

        public R__0__GGg(System.Object instance) : base("#Pfb.#GGg")
		{
            SetInstance(instance);
		}

        public R__0__GGg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__GGg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

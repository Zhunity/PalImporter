...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Zpo
	/// </summary>
    public partial class R__0__Zpo : RMember //
    {
        ...
        public R__0__Zpo() : base("#Pfb.#Zpo")
        {
        }

        public R__0__Zpo(System.Object instance) : base("#Pfb.#Zpo")
		{
            SetInstance(instance);
		}

        public R__0__Zpo(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Zpo(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

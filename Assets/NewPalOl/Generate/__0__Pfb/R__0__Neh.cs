...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Neh
	/// </summary>
    public partial class R__0__Neh : RMember //
    {
        ...
        public R__0__Neh() : base("#Pfb.#Neh")
        {
        }

        public R__0__Neh(System.Object instance) : base("#Pfb.#Neh")
		{
            SetInstance(instance);
		}

        public R__0__Neh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Neh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

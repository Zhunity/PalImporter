...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Qrb
	/// </summary>
    public partial class R__0__Qrb : RMember //
    {
        ...
        public R__0__Qrb() : base("#Pfb.#Qrb")
        {
        }

        public R__0__Qrb(System.Object instance) : base("#Pfb.#Qrb")
		{
            SetInstance(instance);
		}

        public R__0__Qrb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Qrb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ATr
	/// </summary>
    public partial class R__0__ATr : RMember //
    {
        ...
        public R__0__ATr() : base("#Pfb.#ATr")
        {
        }

        public R__0__ATr(System.Object instance) : base("#Pfb.#ATr")
		{
            SetInstance(instance);
		}

        public R__0__ATr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ATr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

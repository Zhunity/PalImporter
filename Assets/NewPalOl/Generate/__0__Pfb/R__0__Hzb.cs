...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Hzb
	/// </summary>
    public partial class R__0__Hzb : RMember //
    {
        ...
        public R__0__Hzb() : base("#Pfb.#Hzb")
        {
        }

        public R__0__Hzb(System.Object instance) : base("#Pfb.#Hzb")
		{
            SetInstance(instance);
		}

        public R__0__Hzb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Hzb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

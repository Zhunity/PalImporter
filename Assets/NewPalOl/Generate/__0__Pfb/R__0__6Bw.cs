...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#6Bw
	/// </summary>
    public partial class R__0__6Bw : RMember //
    {
        ...
        public R__0__6Bw() : base("#Pfb.#6Bw")
        {
        }

        public R__0__6Bw(System.Object instance) : base("#Pfb.#6Bw")
		{
            SetInstance(instance);
		}

        public R__0__6Bw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6Bw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

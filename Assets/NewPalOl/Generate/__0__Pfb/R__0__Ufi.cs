...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ufi
	/// </summary>
    public partial class R__0__Ufi : RMember //
    {
        ...
        public R__0__Ufi() : base("#Pfb.#Ufi")
        {
        }

        public R__0__Ufi(System.Object instance) : base("#Pfb.#Ufi")
		{
            SetInstance(instance);
		}

        public R__0__Ufi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ufi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

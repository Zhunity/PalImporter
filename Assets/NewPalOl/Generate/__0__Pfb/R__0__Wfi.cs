...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wfi
	/// </summary>
    public partial class R__0__Wfi : RMember //
    {
        ...
        public R__0__Wfi() : base("#Pfb.#Wfi")
        {
        }

        public R__0__Wfi(System.Object instance) : base("#Pfb.#Wfi")
		{
            SetInstance(instance);
		}

        public R__0__Wfi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wfi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

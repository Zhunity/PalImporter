...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#LAb
	/// </summary>
    public partial class R__0__LAb : RMember //
    {
        ...
        public R__0__LAb() : base("#Pfb.#LAb")
        {
        }

        public R__0__LAb(System.Object instance) : base("#Pfb.#LAb")
		{
            SetInstance(instance);
		}

        public R__0__LAb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__LAb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

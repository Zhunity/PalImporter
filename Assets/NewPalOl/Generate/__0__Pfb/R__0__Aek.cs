...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Aek
	/// </summary>
    public partial class R__0__Aek : RMember //
    {
        ...
        public R__0__Aek() : base("#Pfb.#Aek")
        {
        }

        public R__0__Aek(System.Object instance) : base("#Pfb.#Aek")
		{
            SetInstance(instance);
		}

        public R__0__Aek(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Aek(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

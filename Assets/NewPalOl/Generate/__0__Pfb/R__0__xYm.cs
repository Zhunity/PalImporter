...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#xYm
	/// </summary>
    public partial class R__0__xYm : RMember //
    {
        ...
        public R__0__xYm() : base("#Pfb.#xYm")
        {
        }

        public R__0__xYm(System.Object instance) : base("#Pfb.#xYm")
		{
            SetInstance(instance);
		}

        public R__0__xYm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__xYm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

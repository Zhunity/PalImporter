...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#jLp
	/// </summary>
    public partial class R__0__jLp : RMember //
    {
        ...
        public R__0__jLp() : base("#Pfb.#jLp")
        {
        }

        public R__0__jLp(System.Object instance) : base("#Pfb.#jLp")
		{
            SetInstance(instance);
		}

        public R__0__jLp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jLp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

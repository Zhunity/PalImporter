...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ohp
	/// </summary>
    public partial class R__0__Ohp : RMember //
    {
        ...
        public R__0__Ohp() : base("#Pfb.#Ohp")
        {
        }

        public R__0__Ohp(System.Object instance) : base("#Pfb.#Ohp")
		{
            SetInstance(instance);
		}

        public R__0__Ohp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ohp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

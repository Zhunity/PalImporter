...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#OIr
	/// </summary>
    public partial class R__0__OIr : RMember //
    {
        ...
        public R__0__OIr() : base("#Pfb.#OIr")
        {
        }

        public R__0__OIr(System.Object instance) : base("#Pfb.#OIr")
		{
            SetInstance(instance);
		}

        public R__0__OIr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__OIr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

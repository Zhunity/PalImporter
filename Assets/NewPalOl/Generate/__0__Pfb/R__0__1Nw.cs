...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#1Nw
	/// </summary>
    public partial class R__0__1Nw : RMember //
    {
        ...
        public R__0__1Nw() : base("#Pfb.#1Nw")
        {
        }

        public R__0__1Nw(System.Object instance) : base("#Pfb.#1Nw")
		{
            SetInstance(instance);
		}

        public R__0__1Nw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1Nw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#XLh
	/// </summary>
    public partial class R__0__XLh : RMember //
    {
        ...
        public R__0__XLh() : base("#Pfb.#XLh")
        {
        }

        public R__0__XLh(System.Object instance) : base("#Pfb.#XLh")
		{
            SetInstance(instance);
		}

        public R__0__XLh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XLh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Fyb
	/// </summary>
    public partial class R__0__Fyb : RMember //
    {
        ...
        public R__0__Fyb() : base("#Pfb.#Fyb")
        {
        }

        public R__0__Fyb(System.Object instance) : base("#Pfb.#Fyb")
		{
            SetInstance(instance);
		}

        public R__0__Fyb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Fyb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

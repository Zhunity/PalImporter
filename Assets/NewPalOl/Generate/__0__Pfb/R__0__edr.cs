...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#edr
	/// </summary>
    public partial class R__0__edr : RMember //
    {
        ...
        public R__0__edr() : base("#Pfb.#edr")
        {
        }

        public R__0__edr(System.Object instance) : base("#Pfb.#edr")
		{
            SetInstance(instance);
		}

        public R__0__edr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__edr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Cvl
	/// </summary>
    public partial class R__0__Cvl : RMember //
    {
        ...
        public R__0__Cvl() : base("#Pfb.#Cvl")
        {
        }

        public R__0__Cvl(System.Object instance) : base("#Pfb.#Cvl")
		{
            SetInstance(instance);
		}

        public R__0__Cvl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Cvl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

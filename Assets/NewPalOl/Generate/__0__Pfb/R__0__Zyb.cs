...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Zyb
	/// </summary>
    public partial class R__0__Zyb : RMember //
    {
        ...
        public R__0__Zyb() : base("#Pfb.#Zyb")
        {
        }

        public R__0__Zyb(System.Object instance) : base("#Pfb.#Zyb")
		{
            SetInstance(instance);
		}

        public R__0__Zyb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Zyb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

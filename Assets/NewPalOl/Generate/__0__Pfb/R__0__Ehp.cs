...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ehp
	/// </summary>
    public partial class R__0__Ehp : RMember //
    {
        ...
        public R__0__Ehp() : base("#Pfb.#Ehp")
        {
        }

        public R__0__Ehp(System.Object instance) : base("#Pfb.#Ehp")
		{
            SetInstance(instance);
		}

        public R__0__Ehp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ehp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

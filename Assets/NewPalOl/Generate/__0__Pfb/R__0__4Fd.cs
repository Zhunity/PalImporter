...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4Fd
	/// </summary>
    public partial class R__0__4Fd : RMember //
    {
        ...
        public R__0__4Fd() : base("#Pfb.#4Fd")
        {
        }

        public R__0__4Fd(System.Object instance) : base("#Pfb.#4Fd")
		{
            SetInstance(instance);
		}

        public R__0__4Fd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4Fd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#apm
	/// </summary>
    public partial class R__0__apm : RMember //
    {
        ...
        public R__0__apm() : base("#Pfb.#apm")
        {
        }

        public R__0__apm(System.Object instance) : base("#Pfb.#apm")
		{
            SetInstance(instance);
		}

        public R__0__apm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__apm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

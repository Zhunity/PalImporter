...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8Fd
	/// </summary>
    public partial class R__0__8Fd : RMember //
    {
        ...
        public R__0__8Fd() : base("#Pfb.#8Fd")
        {
        }

        public R__0__8Fd(System.Object instance) : base("#Pfb.#8Fd")
		{
            SetInstance(instance);
		}

        public R__0__8Fd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Fd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

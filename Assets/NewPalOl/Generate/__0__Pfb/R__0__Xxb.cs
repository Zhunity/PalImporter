...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Xxb
	/// </summary>
    public partial class R__0__Xxb : RMember //
    {
        ...
        public R__0__Xxb() : base("#Pfb.#Xxb")
        {
        }

        public R__0__Xxb(System.Object instance) : base("#Pfb.#Xxb")
		{
            SetInstance(instance);
		}

        public R__0__Xxb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Xxb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#T2k
	/// </summary>
    public partial class R__0__T2k : RMember //
    {
        ...
        public R__0__T2k() : base("#Pfb.#T2k")
        {
        }

        public R__0__T2k(System.Object instance) : base("#Pfb.#T2k")
		{
            SetInstance(instance);
		}

        public R__0__T2k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__T2k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Knw
	/// </summary>
    public partial class R__0__Knw : RMember //
    {
        ...
        public R__0__Knw() : base("#Pfb.#Knw")
        {
        }

        public R__0__Knw(System.Object instance) : base("#Pfb.#Knw")
		{
            SetInstance(instance);
		}

        public R__0__Knw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Knw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

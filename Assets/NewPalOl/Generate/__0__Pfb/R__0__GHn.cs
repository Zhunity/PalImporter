...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#GHn
	/// </summary>
    public partial class R__0__GHn : RMember //
    {
        ...
        public R__0__GHn() : base("#Pfb.#GHn")
        {
        }

        public R__0__GHn(System.Object instance) : base("#Pfb.#GHn")
		{
            SetInstance(instance);
		}

        public R__0__GHn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__GHn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

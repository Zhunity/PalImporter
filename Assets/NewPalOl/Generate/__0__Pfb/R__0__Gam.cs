...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Gam
	/// </summary>
    public partial class R__0__Gam : RMember //
    {
        ...
        public R__0__Gam() : base("#Pfb.#Gam")
        {
        }

        public R__0__Gam(System.Object instance) : base("#Pfb.#Gam")
		{
            SetInstance(instance);
		}

        public R__0__Gam(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Gam(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

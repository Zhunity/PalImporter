...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#K4p
	/// </summary>
    public partial class R__0__K4p : RMember //
    {
        ...
        public R__0__K4p() : base("#Pfb.#K4p")
        {
        }

        public R__0__K4p(System.Object instance) : base("#Pfb.#K4p")
		{
            SetInstance(instance);
		}

        public R__0__K4p(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__K4p(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

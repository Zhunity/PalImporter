...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ham
	/// </summary>
    public partial class R__0__Ham : RMember //
    {
        ...
        public R__0__Ham() : base("#Pfb.#Ham")
        {
        }

        public R__0__Ham(System.Object instance) : base("#Pfb.#Ham")
		{
            SetInstance(instance);
		}

        public R__0__Ham(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ham(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#2qb
	/// </summary>
    public partial class R__0__2qb : RMember //
    {
        ...
        public R__0__2qb() : base("#Pfb.#2qb")
        {
        }

        public R__0__2qb(System.Object instance) : base("#Pfb.#2qb")
		{
            SetInstance(instance);
		}

        public R__0__2qb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2qb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

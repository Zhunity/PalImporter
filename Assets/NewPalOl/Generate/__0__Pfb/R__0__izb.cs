...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#izb
	/// </summary>
    public partial class R__0__izb : RMember //
    {
        ...
        public R__0__izb() : base("#Pfb.#izb")
        {
        }

        public R__0__izb(System.Object instance) : base("#Pfb.#izb")
		{
            SetInstance(instance);
		}

        public R__0__izb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__izb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

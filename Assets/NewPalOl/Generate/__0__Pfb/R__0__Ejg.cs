...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ejg
	/// </summary>
    public partial class R__0__Ejg : RMember //
    {
        ...
        public R__0__Ejg() : base("#Pfb.#Ejg")
        {
        }

        public R__0__Ejg(System.Object instance) : base("#Pfb.#Ejg")
		{
            SetInstance(instance);
		}

        public R__0__Ejg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ejg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#xKn
	/// </summary>
    public partial class R__0__xKn : RMember //
    {
        ...
        public R__0__xKn() : base("#Pfb.#xKn")
        {
        }

        public R__0__xKn(System.Object instance) : base("#Pfb.#xKn")
		{
            SetInstance(instance);
		}

        public R__0__xKn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__xKn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

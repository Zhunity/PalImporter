...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0Dm
	/// </summary>
    public partial class R__0__0Dm : RMember //
    {
        ...
        public R__0__0Dm() : base("#Pfb.#0Dm")
        {
        }

        public R__0__0Dm(System.Object instance) : base("#Pfb.#0Dm")
		{
            SetInstance(instance);
		}

        public R__0__0Dm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0Dm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

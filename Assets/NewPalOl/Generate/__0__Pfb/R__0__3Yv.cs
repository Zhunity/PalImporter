...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#3Yv
	/// </summary>
    public partial class R__0__3Yv : RMember //
    {
        ...
        public R__0__3Yv() : base("#Pfb.#3Yv")
        {
        }

        public R__0__3Yv(System.Object instance) : base("#Pfb.#3Yv")
		{
            SetInstance(instance);
		}

        public R__0__3Yv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3Yv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

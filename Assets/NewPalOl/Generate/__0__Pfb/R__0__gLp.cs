...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#gLp
	/// </summary>
    public partial class R__0__gLp : RMember //
    {
        ...
        public R__0__gLp() : base("#Pfb.#gLp")
        {
        }

        public R__0__gLp(System.Object instance) : base("#Pfb.#gLp")
		{
            SetInstance(instance);
		}

        public R__0__gLp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gLp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

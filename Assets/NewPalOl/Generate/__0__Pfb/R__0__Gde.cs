...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Gde
	/// </summary>
    public partial class R__0__Gde : RMember //
    {
        ...
        public R__0__Gde() : base("#Pfb.#Gde")
        {
        }

        public R__0__Gde(System.Object instance) : base("#Pfb.#Gde")
		{
            SetInstance(instance);
		}

        public R__0__Gde(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Gde(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

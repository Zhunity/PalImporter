...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Yjx
	/// </summary>
    public partial class R__0__Yjx : RMember //
    {
        ...
        public R__0__Yjx() : base("#Pfb.#Yjx")
        {
        }

        public R__0__Yjx(System.Object instance) : base("#Pfb.#Yjx")
		{
            SetInstance(instance);
		}

        public R__0__Yjx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Yjx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

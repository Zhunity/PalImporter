...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#H6c
	/// </summary>
    public partial class R__0__H6c : RMember //
    {
        ...
        public R__0__H6c() : base("#Pfb.#H6c")
        {
        }

        public R__0__H6c(System.Object instance) : base("#Pfb.#H6c")
		{
            SetInstance(instance);
		}

        public R__0__H6c(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__H6c(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

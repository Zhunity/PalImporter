...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ihs
	/// </summary>
    public partial class R__0__Ihs : RMember //
    {
        ...
        public R__0__Ihs() : base("#Pfb.#Ihs")
        {
        }

        public R__0__Ihs(System.Object instance) : base("#Pfb.#Ihs")
		{
            SetInstance(instance);
		}

        public R__0__Ihs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ihs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

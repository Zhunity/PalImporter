...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#VSv
	/// </summary>
    public partial class R__0__VSv : RMember //
    {
        ...
        public R__0__VSv() : base("#Pfb.#VSv")
        {
        }

        public R__0__VSv(System.Object instance) : base("#Pfb.#VSv")
		{
            SetInstance(instance);
		}

        public R__0__VSv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__VSv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

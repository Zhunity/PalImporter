...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#dqo
	/// </summary>
    public partial class R__0__dqo : RMember //
    {
        ...
        public R__0__dqo() : base("#Pfb.#dqo")
        {
        }

        public R__0__dqo(System.Object instance) : base("#Pfb.#dqo")
		{
            SetInstance(instance);
		}

        public R__0__dqo(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dqo(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

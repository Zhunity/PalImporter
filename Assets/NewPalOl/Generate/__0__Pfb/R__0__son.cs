...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#son
	/// </summary>
    public partial class R__0__son : RMember //
    {
        ...
        public R__0__son() : base("#Pfb.#son")
        {
        }

        public R__0__son(System.Object instance) : base("#Pfb.#son")
		{
            SetInstance(instance);
		}

        public R__0__son(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__son(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

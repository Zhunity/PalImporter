...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#JLh
	/// </summary>
    public partial class R__0__JLh : RMember //
    {
        ...
        public R__0__JLh() : base("#Pfb.#JLh")
        {
        }

        public R__0__JLh(System.Object instance) : base("#Pfb.#JLh")
		{
            SetInstance(instance);
		}

        public R__0__JLh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__JLh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

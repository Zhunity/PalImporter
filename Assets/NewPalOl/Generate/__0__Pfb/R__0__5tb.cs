...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#5tb
	/// </summary>
    public partial class R__0__5tb : RMember //
    {
        ...
        public R__0__5tb() : base("#Pfb.#5tb")
        {
        }

        public R__0__5tb(System.Object instance) : base("#Pfb.#5tb")
		{
            SetInstance(instance);
		}

        public R__0__5tb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5tb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

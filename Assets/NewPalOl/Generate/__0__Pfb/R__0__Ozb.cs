...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ozb
	/// </summary>
    public partial class R__0__Ozb : RMember //
    {
        ...
        public R__0__Ozb() : base("#Pfb.#Ozb")
        {
        }

        public R__0__Ozb(System.Object instance) : base("#Pfb.#Ozb")
		{
            SetInstance(instance);
		}

        public R__0__Ozb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ozb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

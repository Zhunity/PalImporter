...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9wv
	/// </summary>
    public partial class R__0__9wv : RMember //
    {
        ...
        public R__0__9wv() : base("#Pfb.#9wv")
        {
        }

        public R__0__9wv(System.Object instance) : base("#Pfb.#9wv")
		{
            SetInstance(instance);
		}

        public R__0__9wv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9wv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

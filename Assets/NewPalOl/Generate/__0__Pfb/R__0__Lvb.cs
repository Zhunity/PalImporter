...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Lvb
	/// </summary>
    public partial class R__0__Lvb : RMember //
    {
        ...
        public R__0__Lvb() : base("#Pfb.#Lvb")
        {
        }

        public R__0__Lvb(System.Object instance) : base("#Pfb.#Lvb")
		{
            SetInstance(instance);
		}

        public R__0__Lvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Lvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

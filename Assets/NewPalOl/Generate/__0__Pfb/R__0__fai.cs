...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#fai
	/// </summary>
    public partial class R__0__fai : RMember //
    {
        ...
        public R__0__fai() : base("#Pfb.#fai")
        {
        }

        public R__0__fai(System.Object instance) : base("#Pfb.#fai")
		{
            SetInstance(instance);
		}

        public R__0__fai(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fai(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#3xb
	/// </summary>
    public partial class R__0__3xb : RMember //
    {
        ...
        public R__0__3xb() : base("#Pfb.#3xb")
        {
        }

        public R__0__3xb(System.Object instance) : base("#Pfb.#3xb")
		{
            SetInstance(instance);
		}

        public R__0__3xb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3xb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

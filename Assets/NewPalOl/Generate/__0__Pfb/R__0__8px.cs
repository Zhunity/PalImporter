...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8px
	/// </summary>
    public partial class R__0__8px : RMember //
    {
        ...
        public R__0__8px() : base("#Pfb.#8px")
        {
        }

        public R__0__8px(System.Object instance) : base("#Pfb.#8px")
		{
            SetInstance(instance);
		}

        public R__0__8px(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8px(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

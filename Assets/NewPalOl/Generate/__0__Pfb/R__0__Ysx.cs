...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ysx
	/// </summary>
    public partial class R__0__Ysx : RMember //
    {
        ...
        public R__0__Ysx() : base("#Pfb.#Ysx")
        {
        }

        public R__0__Ysx(System.Object instance) : base("#Pfb.#Ysx")
		{
            SetInstance(instance);
		}

        public R__0__Ysx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ysx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

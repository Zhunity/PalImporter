...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#NIr
	/// </summary>
    public partial class R__0__NIr : RMember //
    {
        ...
        public R__0__NIr() : base("#Pfb.#NIr")
        {
        }

        public R__0__NIr(System.Object instance) : base("#Pfb.#NIr")
		{
            SetInstance(instance);
		}

        public R__0__NIr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__NIr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

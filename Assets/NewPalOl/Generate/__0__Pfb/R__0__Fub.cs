...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Fub
	/// </summary>
    public partial class R__0__Fub : RMember //
    {
        ...
        public R__0__Fub() : base("#Pfb.#Fub")
        {
        }

        public R__0__Fub(System.Object instance) : base("#Pfb.#Fub")
		{
            SetInstance(instance);
		}

        public R__0__Fub(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Fub(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9Gc
	/// </summary>
    public partial class R__0__9Gc : RMember //
    {
        ...
        public R__0__9Gc() : base("#Pfb.#9Gc")
        {
        }

        public R__0__9Gc(System.Object instance) : base("#Pfb.#9Gc")
		{
            SetInstance(instance);
		}

        public R__0__9Gc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Gc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

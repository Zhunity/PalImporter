...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#36c
	/// </summary>
    public partial class R__0__36c : RMember //
    {
        ...
        public R__0__36c() : base("#Pfb.#36c")
        {
        }

        public R__0__36c(System.Object instance) : base("#Pfb.#36c")
		{
            SetInstance(instance);
		}

        public R__0__36c(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__36c(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

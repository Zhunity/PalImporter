...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#qGd
	/// </summary>
    public partial class R__0__qGd : RMember //
    {
        ...
        public R__0__qGd() : base("#Pfb.#qGd")
        {
        }

        public R__0__qGd(System.Object instance) : base("#Pfb.#qGd")
		{
            SetInstance(instance);
		}

        public R__0__qGd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__qGd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

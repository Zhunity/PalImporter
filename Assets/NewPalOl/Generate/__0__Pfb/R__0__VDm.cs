...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#VDm
	/// </summary>
    public partial class R__0__VDm : RMember //
    {
        ...
        public R__0__VDm() : base("#Pfb.#VDm")
        {
        }

        public R__0__VDm(System.Object instance) : base("#Pfb.#VDm")
		{
            SetInstance(instance);
		}

        public R__0__VDm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__VDm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

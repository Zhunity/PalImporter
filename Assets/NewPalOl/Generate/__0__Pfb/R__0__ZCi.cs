...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ZCi
	/// </summary>
    public partial class R__0__ZCi : RMember //
    {
        ...
        public R__0__ZCi() : base("#Pfb.#ZCi")
        {
        }

        public R__0__ZCi(System.Object instance) : base("#Pfb.#ZCi")
		{
            SetInstance(instance);
		}

        public R__0__ZCi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ZCi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

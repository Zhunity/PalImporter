...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#qDr
	/// </summary>
    public partial class R__0__qDr : RMember //
    {
        ...
        public R__0__qDr() : base("#Pfb.#qDr")
        {
        }

        public R__0__qDr(System.Object instance) : base("#Pfb.#qDr")
		{
            SetInstance(instance);
		}

        public R__0__qDr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__qDr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

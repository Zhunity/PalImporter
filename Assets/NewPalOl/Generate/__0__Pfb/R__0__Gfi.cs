...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Gfi
	/// </summary>
    public partial class R__0__Gfi : RMember //
    {
        ...
        public R__0__Gfi() : base("#Pfb.#Gfi")
        {
        }

        public R__0__Gfi(System.Object instance) : base("#Pfb.#Gfi")
		{
            SetInstance(instance);
		}

        public R__0__Gfi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Gfi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wij
	/// </summary>
    public partial class R__0__Wij : RMember //
    {
        ...
        public R__0__Wij() : base("#Pfb.#Wij")
        {
        }

        public R__0__Wij(System.Object instance) : base("#Pfb.#Wij")
		{
            SetInstance(instance);
		}

        public R__0__Wij(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wij(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

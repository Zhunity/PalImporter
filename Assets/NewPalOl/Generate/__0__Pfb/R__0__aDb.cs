...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#aDb
	/// </summary>
    public partial class R__0__aDb : RMember //
    {
        ...
        public R__0__aDb() : base("#Pfb.#aDb")
        {
        }

        public R__0__aDb(System.Object instance) : base("#Pfb.#aDb")
		{
            SetInstance(instance);
		}

        public R__0__aDb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__aDb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

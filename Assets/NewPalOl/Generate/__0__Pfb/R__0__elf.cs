...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#elf
	/// </summary>
    public partial class R__0__elf : RMember //
    {
        ...
        public R__0__elf() : base("#Pfb.#elf")
        {
        }

        public R__0__elf(System.Object instance) : base("#Pfb.#elf")
		{
            SetInstance(instance);
		}

        public R__0__elf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__elf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

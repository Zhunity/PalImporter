...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#PXu
	/// </summary>
    public partial class R__0__PXu : RMember //
    {
        ...
        public R__0__PXu() : base("#Pfb.#PXu")
        {
        }

        public R__0__PXu(System.Object instance) : base("#Pfb.#PXu")
		{
            SetInstance(instance);
		}

        public R__0__PXu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__PXu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

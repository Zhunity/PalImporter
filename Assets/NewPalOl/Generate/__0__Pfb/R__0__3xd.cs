...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#3xd
	/// </summary>
    public partial class R__0__3xd : RMember //
    {
        ...
        public R__0__3xd() : base("#Pfb.#3xd")
        {
        }

        public R__0__3xd(System.Object instance) : base("#Pfb.#3xd")
		{
            SetInstance(instance);
		}

        public R__0__3xd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3xd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

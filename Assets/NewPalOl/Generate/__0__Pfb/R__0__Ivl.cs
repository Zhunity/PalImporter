...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ivl
	/// </summary>
    public partial class R__0__Ivl : RMember //
    {
        ...
        public R__0__Ivl() : base("#Pfb.#Ivl")
        {
        }

        public R__0__Ivl(System.Object instance) : base("#Pfb.#Ivl")
		{
            SetInstance(instance);
		}

        public R__0__Ivl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ivl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

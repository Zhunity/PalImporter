...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#gIw
	/// </summary>
    public partial class R__0__gIw : RMember //
    {
        ...
        public R__0__gIw() : base("#Pfb.#gIw")
        {
        }

        public R__0__gIw(System.Object instance) : base("#Pfb.#gIw")
		{
            SetInstance(instance);
		}

        public R__0__gIw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gIw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

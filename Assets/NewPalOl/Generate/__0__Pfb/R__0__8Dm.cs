...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8Dm
	/// </summary>
    public partial class R__0__8Dm : RMember //
    {
        ...
        public R__0__8Dm() : base("#Pfb.#8Dm")
        {
        }

        public R__0__8Dm(System.Object instance) : base("#Pfb.#8Dm")
		{
            SetInstance(instance);
		}

        public R__0__8Dm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Dm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

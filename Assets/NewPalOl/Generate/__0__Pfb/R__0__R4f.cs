...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#R4f
	/// </summary>
    public partial class R__0__R4f : RMember //
    {
        ...
        public R__0__R4f() : base("#Pfb.#R4f")
        {
        }

        public R__0__R4f(System.Object instance) : base("#Pfb.#R4f")
		{
            SetInstance(instance);
		}

        public R__0__R4f(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__R4f(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ron
	/// </summary>
    public partial class R__0__ron : RMember //
    {
        ...
        public R__0__ron() : base("#Pfb.#ron")
        {
        }

        public R__0__ron(System.Object instance) : base("#Pfb.#ron")
		{
            SetInstance(instance);
		}

        public R__0__ron(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ron(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7qb
	/// </summary>
    public partial class R__0__7qb : RMember //
    {
		...
		/// GameDefineType.ID #v
		/// </summary>
		protected RGameDefineType.RID r___0__v;
		public virtual RGameDefineType.RID R__0__v
		{
			get
			{
				if(r___0__v == null)
        ...
        public R__0__7qb() : base("#Pfb.#7qb")
        {
        }

        public R__0__7qb(System.Object instance) : base("#Pfb.#7qb")
		{
            SetInstance(instance);
		}

        public R__0__7qb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7qb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

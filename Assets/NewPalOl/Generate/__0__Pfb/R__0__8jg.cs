...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8jg
	/// </summary>
    public partial class R__0__8jg : RMember //
    {
        ...
        public R__0__8jg() : base("#Pfb.#8jg")
        {
        }

        public R__0__8jg(System.Object instance) : base("#Pfb.#8jg")
		{
            SetInstance(instance);
		}

        public R__0__8jg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8jg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

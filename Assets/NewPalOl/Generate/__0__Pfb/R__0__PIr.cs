...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#PIr
	/// </summary>
    public partial class R__0__PIr : RMember //
    {
        ...
        public R__0__PIr() : base("#Pfb.#PIr")
        {
        }

        public R__0__PIr(System.Object instance) : base("#Pfb.#PIr")
		{
            SetInstance(instance);
		}

        public R__0__PIr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__PIr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

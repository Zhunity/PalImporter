...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#QDb
	/// </summary>
    public partial class R__0__QDb : RMember //
    {
        ...
        public R__0__QDb() : base("#Pfb.#QDb")
        {
        }

        public R__0__QDb(System.Object instance) : base("#Pfb.#QDb")
		{
            SetInstance(instance);
		}

        public R__0__QDb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__QDb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

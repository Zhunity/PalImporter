...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Yih
	/// </summary>
    public partial class R__0__Yih : RMember //
    {
        ...
        public R__0__Yih() : base("#Pfb.#Yih")
        {
        }

        public R__0__Yih(System.Object instance) : base("#Pfb.#Yih")
		{
            SetInstance(instance);
		}

        public R__0__Yih(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Yih(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

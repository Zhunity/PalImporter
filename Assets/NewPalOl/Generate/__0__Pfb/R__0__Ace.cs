...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ace
	/// </summary>
    public partial class R__0__Ace : RMember //
    {
        ...
        public R__0__Ace() : base("#Pfb.#Ace")
        {
        }

        public R__0__Ace(System.Object instance) : base("#Pfb.#Ace")
		{
            SetInstance(instance);
		}

        public R__0__Ace(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ace(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

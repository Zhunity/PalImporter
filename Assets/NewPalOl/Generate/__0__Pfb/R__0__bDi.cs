...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#bDi
	/// </summary>
    public partial class R__0__bDi : RMember //
    {
        ...
        public R__0__bDi() : base("#Pfb.#bDi")
        {
        }

        public R__0__bDi(System.Object instance) : base("#Pfb.#bDi")
		{
            SetInstance(instance);
		}

        public R__0__bDi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__bDi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

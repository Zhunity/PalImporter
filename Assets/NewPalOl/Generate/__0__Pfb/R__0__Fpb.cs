...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Fpb
	/// </summary>
    public partial class R__0__Fpb : RMember //
    {
        ...
        public R__0__Fpb() : base("#Pfb.#Fpb")
        {
        }

        public R__0__Fpb(System.Object instance) : base("#Pfb.#Fpb")
		{
            SetInstance(instance);
		}

        public R__0__Fpb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Fpb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

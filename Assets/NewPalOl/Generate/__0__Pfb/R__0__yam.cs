...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#yam
	/// </summary>
    public partial class R__0__yam : RMember //
    {
        ...
        public R__0__yam() : base("#Pfb.#yam")
        {
        }

        public R__0__yam(System.Object instance) : base("#Pfb.#yam")
		{
            SetInstance(instance);
		}

        public R__0__yam(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__yam(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

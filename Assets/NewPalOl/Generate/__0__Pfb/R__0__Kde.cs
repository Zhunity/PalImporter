...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Kde
	/// </summary>
    public partial class R__0__Kde : RMember //
    {
        ...
        public R__0__Kde() : base("#Pfb.#Kde")
        {
        }

        public R__0__Kde(System.Object instance) : base("#Pfb.#Kde")
		{
            SetInstance(instance);
		}

        public R__0__Kde(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Kde(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

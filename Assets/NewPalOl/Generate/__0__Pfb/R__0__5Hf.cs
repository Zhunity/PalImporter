...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#5Hf
	/// </summary>
    public partial class R__0__5Hf : RMember //
    {
        ...
        public R__0__5Hf() : base("#Pfb.#5Hf")
        {
        }

        public R__0__5Hf(System.Object instance) : base("#Pfb.#5Hf")
		{
            SetInstance(instance);
		}

        public R__0__5Hf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5Hf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Lce
	/// </summary>
    public partial class R__0__Lce : RMember //
    {
        ...
        public R__0__Lce() : base("#Pfb.#Lce")
        {
        }

        public R__0__Lce(System.Object instance) : base("#Pfb.#Lce")
		{
            SetInstance(instance);
		}

        public R__0__Lce(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Lce(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

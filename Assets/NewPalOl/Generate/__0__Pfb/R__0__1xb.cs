...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#1xb
	/// </summary>
    public partial class R__0__1xb : RMember //
    {
        ...
        public R__0__1xb() : base("#Pfb.#1xb")
        {
        }

        public R__0__1xb(System.Object instance) : base("#Pfb.#1xb")
		{
            SetInstance(instance);
		}

        public R__0__1xb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1xb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

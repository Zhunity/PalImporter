...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Bjg
	/// </summary>
    public partial class R__0__Bjg : RMember //
    {
        ...
        public R__0__Bjg() : base("#Pfb.#Bjg")
        {
        }

        public R__0__Bjg(System.Object instance) : base("#Pfb.#Bjg")
		{
            SetInstance(instance);
		}

        public R__0__Bjg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Bjg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

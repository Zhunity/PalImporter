...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#fMg
	/// </summary>
    public partial class R__0__fMg : RMember //
    {
        ...
        public R__0__fMg() : base("#Pfb.#fMg")
        {
        }

        public R__0__fMg(System.Object instance) : base("#Pfb.#fMg")
		{
            SetInstance(instance);
		}

        public R__0__fMg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fMg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

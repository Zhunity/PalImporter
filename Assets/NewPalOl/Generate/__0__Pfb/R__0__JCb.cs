...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#JCb
	/// </summary>
    public partial class R__0__JCb : RMember //
    {
        ...
        public R__0__JCb() : base("#Pfb.#JCb")
        {
        }

        public R__0__JCb(System.Object instance) : base("#Pfb.#JCb")
		{
            SetInstance(instance);
		}

        public R__0__JCb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__JCb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

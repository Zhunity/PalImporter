...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Vsb
	/// </summary>
    public partial class R__0__Vsb : RMember //
    {
        ...
        public R__0__Vsb() : base("#Pfb.#Vsb")
        {
        }

        public R__0__Vsb(System.Object instance) : base("#Pfb.#Vsb")
		{
            SetInstance(instance);
		}

        public R__0__Vsb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vsb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

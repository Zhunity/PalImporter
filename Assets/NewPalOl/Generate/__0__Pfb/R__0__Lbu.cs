...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Lbu
	/// </summary>
    public partial class R__0__Lbu : RMember //
    {
        ...
        public R__0__Lbu() : base("#Pfb.#Lbu")
        {
        }

        public R__0__Lbu(System.Object instance) : base("#Pfb.#Lbu")
		{
            SetInstance(instance);
		}

        public R__0__Lbu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Lbu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

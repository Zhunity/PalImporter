...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#1yb
	/// </summary>
    public partial class R__0__1yb : RMember //
    {
        ...
        public R__0__1yb() : base("#Pfb.#1yb")
        {
        }

        public R__0__1yb(System.Object instance) : base("#Pfb.#1yb")
		{
            SetInstance(instance);
		}

        public R__0__1yb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1yb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0be
	/// </summary>
    public partial class R__0__0be : RMember //
    {
        ...
        public R__0__0be() : base("#Pfb.#0be")
        {
        }

        public R__0__0be(System.Object instance) : base("#Pfb.#0be")
		{
            SetInstance(instance);
		}

        public R__0__0be(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0be(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

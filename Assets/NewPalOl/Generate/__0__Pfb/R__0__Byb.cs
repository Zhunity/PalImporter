...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Byb
	/// </summary>
    public partial class R__0__Byb : RMember //
    {
        ...
        public R__0__Byb() : base("#Pfb.#Byb")
        {
        }

        public R__0__Byb(System.Object instance) : base("#Pfb.#Byb")
		{
            SetInstance(instance);
		}

        public R__0__Byb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Byb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

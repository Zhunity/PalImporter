...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7Cb
	/// </summary>
    public partial class R__0__7Cb : RMember //
    {
        ...
        public R__0__7Cb() : base("#Pfb.#7Cb")
        {
        }

        public R__0__7Cb(System.Object instance) : base("#Pfb.#7Cb")
		{
            SetInstance(instance);
		}

        public R__0__7Cb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7Cb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

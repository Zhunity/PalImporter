...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#V4f
	/// </summary>
    public partial class R__0__V4f : RMember //
    {
        ...
        public R__0__V4f() : base("#Pfb.#V4f")
        {
        }

        public R__0__V4f(System.Object instance) : base("#Pfb.#V4f")
		{
            SetInstance(instance);
		}

        public R__0__V4f(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__V4f(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

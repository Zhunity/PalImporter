...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8sr
	/// </summary>
    public partial class R__0__8sr : RMember //
    {
        ...
        public R__0__8sr() : base("#Pfb.#8sr")
        {
        }

        public R__0__8sr(System.Object instance) : base("#Pfb.#8sr")
		{
            SetInstance(instance);
		}

        public R__0__8sr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8sr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

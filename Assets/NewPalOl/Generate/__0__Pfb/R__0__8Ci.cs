...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8Ci
	/// </summary>
    public partial class R__0__8Ci : RMember //
    {
        ...
        public R__0__8Ci() : base("#Pfb.#8Ci")
        {
        }

        public R__0__8Ci(System.Object instance) : base("#Pfb.#8Ci")
		{
            SetInstance(instance);
		}

        public R__0__8Ci(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Ci(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

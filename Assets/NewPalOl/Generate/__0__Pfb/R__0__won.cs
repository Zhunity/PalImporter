...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#won
	/// </summary>
    public partial class R__0__won : RMember //
    {
        ...
        public R__0__won() : base("#Pfb.#won")
        {
        }

        public R__0__won(System.Object instance) : base("#Pfb.#won")
		{
            SetInstance(instance);
		}

        public R__0__won(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__won(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

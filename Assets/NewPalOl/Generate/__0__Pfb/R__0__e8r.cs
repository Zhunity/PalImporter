...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#e8r
	/// </summary>
    public partial class R__0__e8r : RMember //
    {
        ...
        public R__0__e8r() : base("#Pfb.#e8r")
        {
        }

        public R__0__e8r(System.Object instance) : base("#Pfb.#e8r")
		{
            SetInstance(instance);
		}

        public R__0__e8r(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__e8r(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wwb
	/// </summary>
    public partial class R__0__Wwb : RMember //
    {
        ...
        public R__0__Wwb() : base("#Pfb.#Wwb")
        {
        }

        public R__0__Wwb(System.Object instance) : base("#Pfb.#Wwb")
		{
            SetInstance(instance);
		}

        public R__0__Wwb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wwb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

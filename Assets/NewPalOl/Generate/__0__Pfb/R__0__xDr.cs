...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#xDr
	/// </summary>
    public partial class R__0__xDr : RMember //
    {
        ...
        public R__0__xDr() : base("#Pfb.#xDr")
        {
        }

        public R__0__xDr(System.Object instance) : base("#Pfb.#xDr")
		{
            SetInstance(instance);
		}

        public R__0__xDr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__xDr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Tig
	/// </summary>
    public partial class R__0__Tig : RMember //
    {
        ...
        public R__0__Tig() : base("#Pfb.#Tig")
        {
        }

        public R__0__Tig(System.Object instance) : base("#Pfb.#Tig")
		{
            SetInstance(instance);
		}

        public R__0__Tig(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Tig(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

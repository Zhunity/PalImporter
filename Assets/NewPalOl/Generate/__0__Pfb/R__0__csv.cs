...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#csv
	/// </summary>
    public partial class R__0__csv : RMember //
    {
        ...
        public R__0__csv() : base("#Pfb.#csv")
        {
        }

        public R__0__csv(System.Object instance) : base("#Pfb.#csv")
		{
            SetInstance(instance);
		}

        public R__0__csv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__csv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Qwb
	/// </summary>
    public partial class R__0__Qwb : RMember //
    {
        ...
        public R__0__Qwb() : base("#Pfb.#Qwb")
        {
        }

        public R__0__Qwb(System.Object instance) : base("#Pfb.#Qwb")
		{
            SetInstance(instance);
		}

        public R__0__Qwb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Qwb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

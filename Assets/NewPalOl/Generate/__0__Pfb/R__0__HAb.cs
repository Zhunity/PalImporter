...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#HAb
	/// </summary>
    public partial class R__0__HAb : RMember //
    {
        ...
        public R__0__HAb() : base("#Pfb.#HAb")
        {
        }

        public R__0__HAb(System.Object instance) : base("#Pfb.#HAb")
		{
            SetInstance(instance);
		}

        public R__0__HAb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__HAb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

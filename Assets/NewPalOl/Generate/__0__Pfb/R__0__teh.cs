...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#teh
	/// </summary>
    public partial class R__0__teh : RMember //
    {
        ...
        public R__0__teh() : base("#Pfb.#teh")
        {
        }

        public R__0__teh(System.Object instance) : base("#Pfb.#teh")
		{
            SetInstance(instance);
		}

        public R__0__teh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__teh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

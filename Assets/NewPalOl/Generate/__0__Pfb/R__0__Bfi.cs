...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Bfi
	/// </summary>
    public partial class R__0__Bfi : RMember //
    {
        ...
        public R__0__Bfi() : base("#Pfb.#Bfi")
        {
        }

        public R__0__Bfi(System.Object instance) : base("#Pfb.#Bfi")
		{
            SetInstance(instance);
		}

        public R__0__Bfi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Bfi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

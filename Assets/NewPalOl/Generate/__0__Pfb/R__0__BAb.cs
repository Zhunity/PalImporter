...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#BAb
	/// </summary>
    public partial class R__0__BAb : RMember //
    {
        ...
        public R__0__BAb() : base("#Pfb.#BAb")
        {
        }

        public R__0__BAb(System.Object instance) : base("#Pfb.#BAb")
		{
            SetInstance(instance);
		}

        public R__0__BAb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__BAb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

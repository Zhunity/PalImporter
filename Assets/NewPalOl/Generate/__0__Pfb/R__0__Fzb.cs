...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Fzb
	/// </summary>
    public partial class R__0__Fzb : RMember //
    {
        ...
        public R__0__Fzb() : base("#Pfb.#Fzb")
        {
        }

        public R__0__Fzb(System.Object instance) : base("#Pfb.#Fzb")
		{
            SetInstance(instance);
		}

        public R__0__Fzb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Fzb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

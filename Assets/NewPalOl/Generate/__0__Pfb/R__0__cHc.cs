...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#cHc
	/// </summary>
    public partial class R__0__cHc : RMember //
    {
        ...
        public R__0__cHc() : base("#Pfb.#cHc")
        {
        }

        public R__0__cHc(System.Object instance) : base("#Pfb.#cHc")
		{
            SetInstance(instance);
		}

        public R__0__cHc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cHc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

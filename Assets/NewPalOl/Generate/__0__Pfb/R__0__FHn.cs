...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#FHn
	/// </summary>
    public partial class R__0__FHn : RMember //
    {
        ...
        public R__0__FHn() : base("#Pfb.#FHn")
        {
        }

        public R__0__FHn(System.Object instance) : base("#Pfb.#FHn")
		{
            SetInstance(instance);
		}

        public R__0__FHn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__FHn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

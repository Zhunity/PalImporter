...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Tqb
	/// </summary>
    public partial class R__0__Tqb : RMember //
    {
        ...
        public R__0__Tqb() : base("#Pfb.#Tqb")
        {
        }

        public R__0__Tqb(System.Object instance) : base("#Pfb.#Tqb")
		{
            SetInstance(instance);
		}

        public R__0__Tqb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Tqb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#CYm
	/// </summary>
    public partial class R__0__CYm : RMember //
    {
        ...
        public R__0__CYm() : base("#Pfb.#CYm")
        {
        }

        public R__0__CYm(System.Object instance) : base("#Pfb.#CYm")
		{
            SetInstance(instance);
		}

        public R__0__CYm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__CYm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

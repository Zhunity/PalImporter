...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Yig
	/// </summary>
    public partial class R__0__Yig : RMember //
    {
        ...
        public R__0__Yig() : base("#Pfb.#Yig")
        {
        }

        public R__0__Yig(System.Object instance) : base("#Pfb.#Yig")
		{
            SetInstance(instance);
		}

        public R__0__Yig(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Yig(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

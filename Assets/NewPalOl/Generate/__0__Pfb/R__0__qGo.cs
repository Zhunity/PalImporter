...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#qGo
	/// </summary>
    public partial class R__0__qGo : RMember //
    {
        ...
        public R__0__qGo() : base("#Pfb.#qGo")
        {
        }

        public R__0__qGo(System.Object instance) : base("#Pfb.#qGo")
		{
            SetInstance(instance);
		}

        public R__0__qGo(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__qGo(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#von
	/// </summary>
    public partial class R__0__von : RMember //
    {
        ...
        public R__0__von() : base("#Pfb.#von")
        {
        }

        public R__0__von(System.Object instance) : base("#Pfb.#von")
		{
            SetInstance(instance);
		}

        public R__0__von(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__von(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Mrb
	/// </summary>
    public partial class R__0__Mrb : RMember //
    {
        ...
        public R__0__Mrb() : base("#Pfb.#Mrb")
        {
        }

        public R__0__Mrb(System.Object instance) : base("#Pfb.#Mrb")
		{
            SetInstance(instance);
		}

        public R__0__Mrb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Mrb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

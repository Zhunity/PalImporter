...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#fsb
	/// </summary>
    public partial class R__0__fsb : RMember //
    {
        ...
        public R__0__fsb() : base("#Pfb.#fsb")
        {
        }

        public R__0__fsb(System.Object instance) : base("#Pfb.#fsb")
		{
            SetInstance(instance);
		}

        public R__0__fsb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fsb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

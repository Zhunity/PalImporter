...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#cxv
	/// </summary>
    public partial class R__0__cxv : RMember //
    {
        ...
        public R__0__cxv() : base("#Pfb.#cxv")
        {
        }

        public R__0__cxv(System.Object instance) : base("#Pfb.#cxv")
		{
            SetInstance(instance);
		}

        public R__0__cxv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cxv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

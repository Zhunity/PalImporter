...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Uij
	/// </summary>
    public partial class R__0__Uij : RMember //
    {
        ...
        public R__0__Uij() : base("#Pfb.#Uij")
        {
        }

        public R__0__Uij(System.Object instance) : base("#Pfb.#Uij")
		{
            SetInstance(instance);
		}

        public R__0__Uij(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Uij(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#cDb
	/// </summary>
    public partial class R__0__cDb : RMember //
    {
        ...
        public R__0__cDb() : base("#Pfb.#cDb")
        {
        }

        public R__0__cDb(System.Object instance) : base("#Pfb.#cDb")
		{
            SetInstance(instance);
		}

        public R__0__cDb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cDb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7px
	/// </summary>
    public partial class R__0__7px : RMember //
    {
        ...
        public R__0__7px() : base("#Pfb.#7px")
        {
        }

        public R__0__7px(System.Object instance) : base("#Pfb.#7px")
		{
            SetInstance(instance);
		}

        public R__0__7px(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7px(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Usb
	/// </summary>
    public partial class R__0__Usb : RMember //
    {
        ...
        public R__0__Usb() : base("#Pfb.#Usb")
        {
        }

        public R__0__Usb(System.Object instance) : base("#Pfb.#Usb")
		{
            SetInstance(instance);
		}

        public R__0__Usb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Usb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

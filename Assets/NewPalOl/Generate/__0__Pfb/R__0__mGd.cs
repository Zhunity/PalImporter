...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#mGd
	/// </summary>
    public partial class R__0__mGd : RMember //
    {
        ...
        public R__0__mGd() : base("#Pfb.#mGd")
        {
        }

        public R__0__mGd(System.Object instance) : base("#Pfb.#mGd")
		{
            SetInstance(instance);
		}

        public R__0__mGd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__mGd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#H2k
	/// </summary>
    public partial class R__0__H2k : RMember //
    {
        ...
        public R__0__H2k() : base("#Pfb.#H2k")
        {
        }

        public R__0__H2k(System.Object instance) : base("#Pfb.#H2k")
		{
            SetInstance(instance);
		}

        public R__0__H2k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__H2k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#BCb
	/// </summary>
    public partial class R__0__BCb : RMember //
    {
        ...
        public R__0__BCb() : base("#Pfb.#BCb")
        {
        }

        public R__0__BCb(System.Object instance) : base("#Pfb.#BCb")
		{
            SetInstance(instance);
		}

        public R__0__BCb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__BCb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#5wg
	/// </summary>
    public partial class R__0__5wg : RMember //
    {
        ...
        public R__0__5wg() : base("#Pfb.#5wg")
        {
        }

        public R__0__5wg(System.Object instance) : base("#Pfb.#5wg")
		{
            SetInstance(instance);
		}

        public R__0__5wg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5wg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

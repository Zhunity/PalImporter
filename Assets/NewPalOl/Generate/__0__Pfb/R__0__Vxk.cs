...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Vxk
	/// </summary>
    public partial class R__0__Vxk : RMember //
    {
        ...
        public R__0__Vxk() : base("#Pfb.#Vxk")
        {
        }

        public R__0__Vxk(System.Object instance) : base("#Pfb.#Vxk")
		{
            SetInstance(instance);
		}

        public R__0__Vxk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vxk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

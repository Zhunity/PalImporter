...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#T2e
	/// </summary>
    public partial class R__0__T2e : RMember //
    {
        ...
        public R__0__T2e() : base("#Pfb.#T2e")
        {
        }

        public R__0__T2e(System.Object instance) : base("#Pfb.#T2e")
		{
            SetInstance(instance);
		}

        public R__0__T2e(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__T2e(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

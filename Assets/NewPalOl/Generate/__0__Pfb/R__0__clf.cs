...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#clf
	/// </summary>
    public partial class R__0__clf : RMember //
    {
        ...
        public R__0__clf() : base("#Pfb.#clf")
        {
        }

        public R__0__clf(System.Object instance) : base("#Pfb.#clf")
		{
            SetInstance(instance);
		}

        public R__0__clf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__clf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Krc
	/// </summary>
    public partial class R__0__Krc : RMember //
    {
        ...
        public R__0__Krc() : base("#Pfb.#Krc")
        {
        }

        public R__0__Krc(System.Object instance) : base("#Pfb.#Krc")
		{
            SetInstance(instance);
		}

        public R__0__Krc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Krc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

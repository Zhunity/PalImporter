...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Dbx
	/// </summary>
    public partial class R__0__Dbx : RMember //
    {
        ...
        public R__0__Dbx() : base("#Pfb.#Dbx")
        {
        }

        public R__0__Dbx(System.Object instance) : base("#Pfb.#Dbx")
		{
            SetInstance(instance);
		}

        public R__0__Dbx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Dbx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

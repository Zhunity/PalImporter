...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#1tb
	/// </summary>
    public partial class R__0__1tb : RMember //
    {
        ...
        public R__0__1tb() : base("#Pfb.#1tb")
        {
        }

        public R__0__1tb(System.Object instance) : base("#Pfb.#1tb")
		{
            SetInstance(instance);
		}

        public R__0__1tb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1tb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

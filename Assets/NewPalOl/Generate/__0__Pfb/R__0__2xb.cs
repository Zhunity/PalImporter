...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#2xb
	/// </summary>
    public partial class R__0__2xb : RMember //
    {
        ...
        public R__0__2xb() : base("#Pfb.#2xb")
        {
        }

        public R__0__2xb(System.Object instance) : base("#Pfb.#2xb")
		{
            SetInstance(instance);
		}

        public R__0__2xb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2xb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

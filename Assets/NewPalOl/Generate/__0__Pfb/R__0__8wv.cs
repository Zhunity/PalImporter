...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8wv
	/// </summary>
    public partial class R__0__8wv : RMember //
    {
        ...
        public R__0__8wv() : base("#Pfb.#8wv")
        {
        }

        public R__0__8wv(System.Object instance) : base("#Pfb.#8wv")
		{
            SetInstance(instance);
		}

        public R__0__8wv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8wv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

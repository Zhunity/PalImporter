...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ZFd
	/// </summary>
    public partial class R__0__ZFd : RMember //
    {
        ...
        public R__0__ZFd() : base("#Pfb.#ZFd")
        {
        }

        public R__0__ZFd(System.Object instance) : base("#Pfb.#ZFd")
		{
            SetInstance(instance);
		}

        public R__0__ZFd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ZFd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8Vb
	/// </summary>
    public partial class R__0__8Vb : RMember //
    {
        ...
        public R__0__8Vb() : base("#Pfb.#8Vb")
        {
        }

        public R__0__8Vb(System.Object instance) : base("#Pfb.#8Vb")
		{
            SetInstance(instance);
		}

        public R__0__8Vb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Vb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

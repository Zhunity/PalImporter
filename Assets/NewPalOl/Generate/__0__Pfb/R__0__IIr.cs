...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#IIr
	/// </summary>
    public partial class R__0__IIr : RMember //
    {
        ...
        public R__0__IIr() : base("#Pfb.#IIr")
        {
        }

        public R__0__IIr(System.Object instance) : base("#Pfb.#IIr")
		{
            SetInstance(instance);
		}

        public R__0__IIr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__IIr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

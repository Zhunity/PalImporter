...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Dvl
	/// </summary>
    public partial class R__0__Dvl : RMember //
    {
        ...
        public R__0__Dvl() : base("#Pfb.#Dvl")
        {
        }

        public R__0__Dvl(System.Object instance) : base("#Pfb.#Dvl")
		{
            SetInstance(instance);
		}

        public R__0__Dvl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Dvl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

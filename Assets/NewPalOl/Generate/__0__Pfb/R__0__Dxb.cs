...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Dxb
	/// </summary>
    public partial class R__0__Dxb : RMember //
    {
        ...
        public R__0__Dxb() : base("#Pfb.#Dxb")
        {
        }

        public R__0__Dxb(System.Object instance) : base("#Pfb.#Dxb")
		{
            SetInstance(instance);
		}

        public R__0__Dxb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Dxb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

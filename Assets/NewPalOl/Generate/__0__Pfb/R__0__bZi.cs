...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#bZi
	/// </summary>
    public partial class R__0__bZi : RMember //
    {
        ...
        public R__0__bZi() : base("#Pfb.#bZi")
        {
        }

        public R__0__bZi(System.Object instance) : base("#Pfb.#bZi")
		{
            SetInstance(instance);
		}

        public R__0__bZi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__bZi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

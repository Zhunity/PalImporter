...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#5wb
	/// </summary>
    public partial class R__0__5wb : RMember //
    {
        ...
        public R__0__5wb() : base("#Pfb.#5wb")
        {
        }

        public R__0__5wb(System.Object instance) : base("#Pfb.#5wb")
		{
            SetInstance(instance);
		}

        public R__0__5wb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5wb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

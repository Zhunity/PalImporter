...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#gOs
	/// </summary>
    public partial class R__0__gOs : RMember //
    {
        ...
        public R__0__gOs() : base("#Pfb.#gOs")
        {
        }

        public R__0__gOs(System.Object instance) : base("#Pfb.#gOs")
		{
            SetInstance(instance);
		}

        public R__0__gOs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gOs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#1Pv
	/// </summary>
    public partial class R__0__1Pv : RMember //
    {
        ...
        public R__0__1Pv() : base("#Pfb.#1Pv")
        {
        }

        public R__0__1Pv(System.Object instance) : base("#Pfb.#1Pv")
		{
            SetInstance(instance);
		}

        public R__0__1Pv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1Pv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#tYm
	/// </summary>
    public partial class R__0__tYm : RMember //
    {
        ...
        public R__0__tYm() : base("#Pfb.#tYm")
        {
        }

        public R__0__tYm(System.Object instance) : base("#Pfb.#tYm")
		{
            SetInstance(instance);
		}

        public R__0__tYm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__tYm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

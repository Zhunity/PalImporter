...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#CTr
	/// </summary>
    public partial class R__0__CTr : RMember //
    {
        ...
        public R__0__CTr() : base("#Pfb.#CTr")
        {
        }

        public R__0__CTr(System.Object instance) : base("#Pfb.#CTr")
		{
            SetInstance(instance);
		}

        public R__0__CTr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__CTr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

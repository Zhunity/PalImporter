...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#PLh
	/// </summary>
    public partial class R__0__PLh : RMember //
    {
        ...
        public R__0__PLh() : base("#Pfb.#PLh")
        {
        }

        public R__0__PLh(System.Object instance) : base("#Pfb.#PLh")
		{
            SetInstance(instance);
		}

        public R__0__PLh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__PLh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

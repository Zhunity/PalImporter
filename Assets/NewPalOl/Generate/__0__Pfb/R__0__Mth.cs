...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Mth
	/// </summary>
    public partial class R__0__Mth : RMember //
    {
        ...
        public R__0__Mth() : base("#Pfb.#Mth")
        {
        }

        public R__0__Mth(System.Object instance) : base("#Pfb.#Mth")
		{
            SetInstance(instance);
		}

        public R__0__Mth(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Mth(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

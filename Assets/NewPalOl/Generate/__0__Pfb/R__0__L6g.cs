...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#L6g
	/// </summary>
    public partial class R__0__L6g : RMember //
    {
        ...
        public R__0__L6g() : base("#Pfb.#L6g")
        {
        }

        public R__0__L6g(System.Object instance) : base("#Pfb.#L6g")
		{
            SetInstance(instance);
		}

        public R__0__L6g(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__L6g(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

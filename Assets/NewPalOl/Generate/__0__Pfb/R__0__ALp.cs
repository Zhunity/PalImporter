...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ALp
	/// </summary>
    public partial class R__0__ALp : RMember //
    {
        ...
        public R__0__ALp() : base("#Pfb.#ALp")
        {
        }

        public R__0__ALp(System.Object instance) : base("#Pfb.#ALp")
		{
            SetInstance(instance);
		}

        public R__0__ALp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ALp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

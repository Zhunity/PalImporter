...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Jvb
	/// </summary>
    public partial class R__0__Jvb : RMember //
    {
        ...
        public R__0__Jvb() : base("#Pfb.#Jvb")
        {
        }

        public R__0__Jvb(System.Object instance) : base("#Pfb.#Jvb")
		{
            SetInstance(instance);
		}

        public R__0__Jvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Jvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

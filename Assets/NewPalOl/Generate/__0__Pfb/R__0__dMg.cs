...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#dMg
	/// </summary>
    public partial class R__0__dMg : RMember //
    {
        ...
        public R__0__dMg() : base("#Pfb.#dMg")
        {
        }

        public R__0__dMg(System.Object instance) : base("#Pfb.#dMg")
		{
            SetInstance(instance);
		}

        public R__0__dMg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dMg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

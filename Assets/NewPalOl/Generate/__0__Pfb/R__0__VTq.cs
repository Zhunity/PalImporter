...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#VTq
	/// </summary>
    public partial class R__0__VTq : RMember //
    {
        ...
        public R__0__VTq() : base("#Pfb.#VTq")
        {
        }

        public R__0__VTq(System.Object instance) : base("#Pfb.#VTq")
		{
            SetInstance(instance);
		}

        public R__0__VTq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__VTq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

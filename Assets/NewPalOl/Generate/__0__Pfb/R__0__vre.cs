...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#vre
	/// </summary>
    public partial class R__0__vre : RMember //
    {
        ...
        public R__0__vre() : base("#Pfb.#vre")
        {
        }

        public R__0__vre(System.Object instance) : base("#Pfb.#vre")
		{
            SetInstance(instance);
		}

        public R__0__vre(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__vre(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

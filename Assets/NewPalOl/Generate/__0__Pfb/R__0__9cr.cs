...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9cr
	/// </summary>
    public partial class R__0__9cr : RMember //
    {
        ...
        public R__0__9cr() : base("#Pfb.#9cr")
        {
        }

        public R__0__9cr(System.Object instance) : base("#Pfb.#9cr")
		{
            SetInstance(instance);
		}

        public R__0__9cr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9cr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#E4p
	/// </summary>
    public partial class R__0__E4p : RMember //
    {
        ...
        public R__0__E4p() : base("#Pfb.#E4p")
        {
        }

        public R__0__E4p(System.Object instance) : base("#Pfb.#E4p")
		{
            SetInstance(instance);
		}

        public R__0__E4p(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__E4p(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#oFw
	/// </summary>
    public partial class R__0__oFw : RMember //
    {
        ...
        public R__0__oFw() : base("#Pfb.#oFw")
        {
        }

        public R__0__oFw(System.Object instance) : base("#Pfb.#oFw")
		{
            SetInstance(instance);
		}

        public R__0__oFw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oFw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#lIw
	/// </summary>
    public partial class R__0__lIw : RMember //
    {
        ...
        public R__0__lIw() : base("#Pfb.#lIw")
        {
        }

        public R__0__lIw(System.Object instance) : base("#Pfb.#lIw")
		{
            SetInstance(instance);
		}

        public R__0__lIw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__lIw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

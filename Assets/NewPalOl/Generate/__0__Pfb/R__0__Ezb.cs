...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ezb
	/// </summary>
    public partial class R__0__Ezb : RMember //
    {
        ...
        public R__0__Ezb() : base("#Pfb.#Ezb")
        {
        }

        public R__0__Ezb(System.Object instance) : base("#Pfb.#Ezb")
		{
            SetInstance(instance);
		}

        public R__0__Ezb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ezb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

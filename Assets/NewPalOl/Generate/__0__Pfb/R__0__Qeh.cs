...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Qeh
	/// </summary>
    public partial class R__0__Qeh : RMember //
    {
        ...
        public R__0__Qeh() : base("#Pfb.#Qeh")
        {
        }

        public R__0__Qeh(System.Object instance) : base("#Pfb.#Qeh")
		{
            SetInstance(instance);
		}

        public R__0__Qeh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Qeh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

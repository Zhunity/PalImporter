...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Xxq
	/// </summary>
    public partial class R__0__Xxq : RMember //
    {
        ...
        public R__0__Xxq() : base("#Pfb.#Xxq")
        {
        }

        public R__0__Xxq(System.Object instance) : base("#Pfb.#Xxq")
		{
            SetInstance(instance);
		}

        public R__0__Xxq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Xxq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

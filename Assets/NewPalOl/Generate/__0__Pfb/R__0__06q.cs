...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#06q
	/// </summary>
    public partial class R__0__06q : RMember //
    {
        ...
        public R__0__06q() : base("#Pfb.#06q")
        {
        }

        public R__0__06q(System.Object instance) : base("#Pfb.#06q")
		{
            SetInstance(instance);
		}

        public R__0__06q(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__06q(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

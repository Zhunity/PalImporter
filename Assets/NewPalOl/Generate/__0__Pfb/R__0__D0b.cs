...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#D0b
	/// </summary>
    public partial class R__0__D0b : RMember //
    {
        ...
        public R__0__D0b() : base("#Pfb.#D0b")
        {
        }

        public R__0__D0b(System.Object instance) : base("#Pfb.#D0b")
		{
            SetInstance(instance);
		}

        public R__0__D0b(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__D0b(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

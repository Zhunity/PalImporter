...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#sGo
	/// </summary>
    public partial class R__0__sGo : RMember //
    {
        ...
        public R__0__sGo() : base("#Pfb.#sGo")
        {
        }

        public R__0__sGo(System.Object instance) : base("#Pfb.#sGo")
		{
            SetInstance(instance);
		}

        public R__0__sGo(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__sGo(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ieh
	/// </summary>
    public partial class R__0__Ieh : RMember //
    {
        ...
        public R__0__Ieh() : base("#Pfb.#Ieh")
        {
        }

        public R__0__Ieh(System.Object instance) : base("#Pfb.#Ieh")
		{
            SetInstance(instance);
		}

        public R__0__Ieh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ieh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#FGg
	/// </summary>
    public partial class R__0__FGg : RMember //
    {
        ...
        public R__0__FGg() : base("#Pfb.#FGg")
        {
        }

        public R__0__FGg(System.Object instance) : base("#Pfb.#FGg")
		{
            SetInstance(instance);
		}

        public R__0__FGg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__FGg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#N2k
	/// </summary>
    public partial class R__0__N2k : RMember //
    {
        ...
        public R__0__N2k() : base("#Pfb.#N2k")
        {
        }

        public R__0__N2k(System.Object instance) : base("#Pfb.#N2k")
		{
            SetInstance(instance);
		}

        public R__0__N2k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__N2k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

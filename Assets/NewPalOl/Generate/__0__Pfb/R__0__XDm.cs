...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#XDm
	/// </summary>
    public partial class R__0__XDm : RMember //
    {
        ...
        public R__0__XDm() : base("#Pfb.#XDm")
        {
        }

        public R__0__XDm(System.Object instance) : base("#Pfb.#XDm")
		{
            SetInstance(instance);
		}

        public R__0__XDm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XDm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

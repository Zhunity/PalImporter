...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#RDb
	/// </summary>
    public partial class R__0__RDb : RMember //
    {
        ...
        public R__0__RDb() : base("#Pfb.#RDb")
        {
        }

        public R__0__RDb(System.Object instance) : base("#Pfb.#RDb")
		{
            SetInstance(instance);
		}

        public R__0__RDb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__RDb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#5qf
	/// </summary>
    public partial class R__0__5qf : RMember //
    {
        ...
        public R__0__5qf() : base("#Pfb.#5qf")
        {
        }

        public R__0__5qf(System.Object instance) : base("#Pfb.#5qf")
		{
            SetInstance(instance);
		}

        public R__0__5qf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5qf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Lpb
	/// </summary>
    public partial class R__0__Lpb : RMember //
    {
        ...
        public R__0__Lpb() : base("#Pfb.#Lpb")
        {
        }

        public R__0__Lpb(System.Object instance) : base("#Pfb.#Lpb")
		{
            SetInstance(instance);
		}

        public R__0__Lpb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Lpb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

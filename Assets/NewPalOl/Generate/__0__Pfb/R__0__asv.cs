...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#asv
	/// </summary>
    public partial class R__0__asv : RMember //
    {
        ...
        public R__0__asv() : base("#Pfb.#asv")
        {
        }

        public R__0__asv(System.Object instance) : base("#Pfb.#asv")
		{
            SetInstance(instance);
		}

        public R__0__asv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__asv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

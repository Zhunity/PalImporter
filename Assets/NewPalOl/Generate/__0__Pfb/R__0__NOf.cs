...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#NOf
	/// </summary>
    public partial class R__0__NOf : RMember //
    {
        ...
        public R__0__NOf() : base("#Pfb.#NOf")
        {
        }

        public R__0__NOf(System.Object instance) : base("#Pfb.#NOf")
		{
            SetInstance(instance);
		}

        public R__0__NOf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__NOf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

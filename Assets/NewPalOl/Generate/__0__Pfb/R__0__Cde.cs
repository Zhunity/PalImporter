...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Cde
	/// </summary>
    public partial class R__0__Cde : RMember //
    {
        ...
        public R__0__Cde() : base("#Pfb.#Cde")
        {
        }

        public R__0__Cde(System.Object instance) : base("#Pfb.#Cde")
		{
            SetInstance(instance);
		}

        public R__0__Cde(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Cde(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

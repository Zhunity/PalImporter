...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#kEo
	/// </summary>
    public partial class R__0__kEo : RMember //
    {
        ...
        public R__0__kEo() : base("#Pfb.#kEo")
        {
        }

        public R__0__kEo(System.Object instance) : base("#Pfb.#kEo")
		{
            SetInstance(instance);
		}

        public R__0__kEo(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__kEo(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

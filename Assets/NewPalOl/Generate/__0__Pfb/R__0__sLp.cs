...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#sLp
	/// </summary>
    public partial class R__0__sLp : RMember //
    {
        ...
        public R__0__sLp() : base("#Pfb.#sLp")
        {
        }

        public R__0__sLp(System.Object instance) : base("#Pfb.#sLp")
		{
            SetInstance(instance);
		}

        public R__0__sLp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__sLp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

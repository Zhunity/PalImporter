...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ube
	/// </summary>
    public partial class R__0__Ube : RMember //
    {
        ...
        public R__0__Ube() : base("#Pfb.#Ube")
        {
        }

        public R__0__Ube(System.Object instance) : base("#Pfb.#Ube")
		{
            SetInstance(instance);
		}

        public R__0__Ube(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ube(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#iLp
	/// </summary>
    public partial class R__0__iLp : RMember //
    {
        ...
        public R__0__iLp() : base("#Pfb.#iLp")
        {
        }

        public R__0__iLp(System.Object instance) : base("#Pfb.#iLp")
		{
            SetInstance(instance);
		}

        public R__0__iLp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__iLp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

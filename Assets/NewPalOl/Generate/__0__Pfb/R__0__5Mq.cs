...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#5Mq
	/// </summary>
    public partial class R__0__5Mq : RMember //
    {
        ...
        public R__0__5Mq() : base("#Pfb.#5Mq")
        {
        }

        public R__0__5Mq(System.Object instance) : base("#Pfb.#5Mq")
		{
            SetInstance(instance);
		}

        public R__0__5Mq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5Mq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#bdr
	/// </summary>
    public partial class R__0__bdr : RMember //
    {
        ...
        public R__0__bdr() : base("#Pfb.#bdr")
        {
        }

        public R__0__bdr(System.Object instance) : base("#Pfb.#bdr")
		{
            SetInstance(instance);
		}

        public R__0__bdr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__bdr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

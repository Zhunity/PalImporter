...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#jMk
	/// </summary>
    public partial class R__0__jMk : RMember //
    {
        ...
        public R__0__jMk() : base("#Pfb.#jMk")
        {
        }

        public R__0__jMk(System.Object instance) : base("#Pfb.#jMk")
		{
            SetInstance(instance);
		}

        public R__0__jMk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jMk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

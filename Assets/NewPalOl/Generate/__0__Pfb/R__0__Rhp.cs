...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Rhp
	/// </summary>
    public partial class R__0__Rhp : RMember //
    {
        ...
        public R__0__Rhp() : base("#Pfb.#Rhp")
        {
        }

        public R__0__Rhp(System.Object instance) : base("#Pfb.#Rhp")
		{
            SetInstance(instance);
		}

        public R__0__Rhp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Rhp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0xb
	/// </summary>
    public partial class R__0__0xb : RMember //
    {
        ...
        public R__0__0xb() : base("#Pfb.#0xb")
        {
        }

        public R__0__0xb(System.Object instance) : base("#Pfb.#0xb")
		{
            SetInstance(instance);
		}

        public R__0__0xb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0xb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#c1f
	/// </summary>
    public partial class R__0__c1f : RMember //
    {
        ...
        public R__0__c1f() : base("#Pfb.#c1f")
        {
        }

        public R__0__c1f(System.Object instance) : base("#Pfb.#c1f")
		{
            SetInstance(instance);
		}

        public R__0__c1f(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__c1f(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

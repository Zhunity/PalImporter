...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#pLp
	/// </summary>
    public partial class R__0__pLp : RMember //
    {
        ...
        public R__0__pLp() : base("#Pfb.#pLp")
        {
        }

        public R__0__pLp(System.Object instance) : base("#Pfb.#pLp")
		{
            SetInstance(instance);
		}

        public R__0__pLp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__pLp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Pzb
	/// </summary>
    public partial class R__0__Pzb : RMember //
    {
        ...
        public R__0__Pzb() : base("#Pfb.#Pzb")
        {
        }

        public R__0__Pzb(System.Object instance) : base("#Pfb.#Pzb")
		{
            SetInstance(instance);
		}

        public R__0__Pzb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Pzb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

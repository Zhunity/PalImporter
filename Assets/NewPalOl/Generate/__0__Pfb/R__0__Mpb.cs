...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Mpb
	/// </summary>
    public partial class R__0__Mpb : RMember //
    {
        ...
        public R__0__Mpb() : base("#Pfb.#Mpb")
        {
        }

        public R__0__Mpb(System.Object instance) : base("#Pfb.#Mpb")
		{
            SetInstance(instance);
		}

        public R__0__Mpb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Mpb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

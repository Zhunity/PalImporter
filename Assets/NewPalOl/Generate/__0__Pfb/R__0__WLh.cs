...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#WLh
	/// </summary>
    public partial class R__0__WLh : RMember //
    {
        ...
        public R__0__WLh() : base("#Pfb.#WLh")
        {
        }

        public R__0__WLh(System.Object instance) : base("#Pfb.#WLh")
		{
            SetInstance(instance);
		}

        public R__0__WLh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__WLh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#EYm
	/// </summary>
    public partial class R__0__EYm : RMember //
    {
        ...
        public R__0__EYm() : base("#Pfb.#EYm")
        {
        }

        public R__0__EYm(System.Object instance) : base("#Pfb.#EYm")
		{
            SetInstance(instance);
		}

        public R__0__EYm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__EYm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

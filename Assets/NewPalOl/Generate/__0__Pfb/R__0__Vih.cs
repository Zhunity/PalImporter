...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Vih
	/// </summary>
    public partial class R__0__Vih : RMember //
    {
        ...
        public R__0__Vih() : base("#Pfb.#Vih")
        {
        }

        public R__0__Vih(System.Object instance) : base("#Pfb.#Vih")
		{
            SetInstance(instance);
		}

        public R__0__Vih(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vih(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7Ab
	/// </summary>
    public partial class R__0__7Ab : RMember //
    {
        ...
        public R__0__7Ab() : base("#Pfb.#7Ab")
        {
        }

        public R__0__7Ab(System.Object instance) : base("#Pfb.#7Ab")
		{
            SetInstance(instance);
		}

        public R__0__7Ab(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7Ab(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Rmn
	/// </summary>
    public partial class R__0__Rmn : RMember //
    {
        ...
        public R__0__Rmn() : base("#Pfb.#Rmn")
        {
        }

        public R__0__Rmn(System.Object instance) : base("#Pfb.#Rmn")
		{
            SetInstance(instance);
		}

        public R__0__Rmn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Rmn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Evb
	/// </summary>
    public partial class R__0__Evb : RMember //
    {
        ...
        public R__0__Evb() : base("#Pfb.#Evb")
        {
        }

        public R__0__Evb(System.Object instance) : base("#Pfb.#Evb")
		{
            SetInstance(instance);
		}

        public R__0__Evb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Evb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

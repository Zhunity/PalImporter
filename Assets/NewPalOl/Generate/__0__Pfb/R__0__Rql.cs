...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Rql
	/// </summary>
    public partial class R__0__Rql : RMember //
    {
        ...
        public R__0__Rql() : base("#Pfb.#Rql")
        {
        }

        public R__0__Rql(System.Object instance) : base("#Pfb.#Rql")
		{
            SetInstance(instance);
		}

        public R__0__Rql(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Rql(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

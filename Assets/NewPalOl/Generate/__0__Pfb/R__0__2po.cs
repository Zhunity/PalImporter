...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#2po
	/// </summary>
    public partial class R__0__2po : RMember //
    {
        ...
        public R__0__2po() : base("#Pfb.#2po")
        {
        }

        public R__0__2po(System.Object instance) : base("#Pfb.#2po")
		{
            SetInstance(instance);
		}

        public R__0__2po(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2po(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

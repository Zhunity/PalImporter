...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Gzb
	/// </summary>
    public partial class R__0__Gzb : RMember //
    {
        ...
        public R__0__Gzb() : base("#Pfb.#Gzb")
        {
        }

        public R__0__Gzb(System.Object instance) : base("#Pfb.#Gzb")
		{
            SetInstance(instance);
		}

        public R__0__Gzb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Gzb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#obd
	/// </summary>
    public partial class R__0__obd : RMember //
    {
        ...
        public R__0__obd() : base("#Pfb.#obd")
        {
        }

        public R__0__obd(System.Object instance) : base("#Pfb.#obd")
		{
            SetInstance(instance);
		}

        public R__0__obd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__obd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

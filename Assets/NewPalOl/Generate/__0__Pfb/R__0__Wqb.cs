...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wqb
	/// </summary>
    public partial class R__0__Wqb : RMember //
    {
        ...
        public R__0__Wqb() : base("#Pfb.#Wqb")
        {
        }

        public R__0__Wqb(System.Object instance) : base("#Pfb.#Wqb")
		{
            SetInstance(instance);
		}

        public R__0__Wqb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wqb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

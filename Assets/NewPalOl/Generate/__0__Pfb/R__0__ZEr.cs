...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ZEr
	/// </summary>
    public partial class R__0__ZEr : RMember //
    {
        ...
        public R__0__ZEr() : base("#Pfb.#ZEr")
        {
        }

        public R__0__ZEr(System.Object instance) : base("#Pfb.#ZEr")
		{
            SetInstance(instance);
		}

        public R__0__ZEr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ZEr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

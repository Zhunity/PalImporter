...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8tb
	/// </summary>
    public partial class R__0__8tb : RMember //
    {
        ...
        public R__0__8tb() : base("#Pfb.#8tb")
        {
        }

        public R__0__8tb(System.Object instance) : base("#Pfb.#8tb")
		{
            SetInstance(instance);
		}

        public R__0__8tb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8tb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

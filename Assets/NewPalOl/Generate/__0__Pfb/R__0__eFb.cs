...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#eFb
	/// </summary>
    public partial class R__0__eFb : RMember //
    {
        ...
        public R__0__eFb() : base("#Pfb.#eFb")
        {
        }

        public R__0__eFb(System.Object instance) : base("#Pfb.#eFb")
		{
            SetInstance(instance);
		}

        public R__0__eFb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__eFb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

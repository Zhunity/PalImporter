...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9Cb
	/// </summary>
    public partial class R__0__9Cb : RMember //
    {
        ...
        public R__0__9Cb() : base("#Pfb.#9Cb")
        {
        }

        public R__0__9Cb(System.Object instance) : base("#Pfb.#9Cb")
		{
            SetInstance(instance);
		}

        public R__0__9Cb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Cb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

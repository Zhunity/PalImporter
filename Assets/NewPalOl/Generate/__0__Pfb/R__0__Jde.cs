...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Jde
	/// </summary>
    public partial class R__0__Jde : RMember //
    {
        ...
        public R__0__Jde() : base("#Pfb.#Jde")
        {
        }

        public R__0__Jde(System.Object instance) : base("#Pfb.#Jde")
		{
            SetInstance(instance);
		}

        public R__0__Jde(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Jde(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

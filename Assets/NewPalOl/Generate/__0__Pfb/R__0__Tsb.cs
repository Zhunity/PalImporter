...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Tsb
	/// </summary>
    public partial class R__0__Tsb : RMember //
    {
        ...
        public R__0__Tsb() : base("#Pfb.#Tsb")
        {
        }

        public R__0__Tsb(System.Object instance) : base("#Pfb.#Tsb")
		{
            SetInstance(instance);
		}

        public R__0__Tsb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Tsb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0de
	/// </summary>
    public partial class R__0__0de : RMember //
    {
        ...
        public R__0__0de() : base("#Pfb.#0de")
        {
        }

        public R__0__0de(System.Object instance) : base("#Pfb.#0de")
		{
            SetInstance(instance);
		}

        public R__0__0de(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0de(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

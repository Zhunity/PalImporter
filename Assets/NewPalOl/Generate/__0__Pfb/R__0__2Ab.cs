...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#2Ab
	/// </summary>
    public partial class R__0__2Ab : RMember //
    {
        ...
        public R__0__2Ab() : base("#Pfb.#2Ab")
        {
        }

        public R__0__2Ab(System.Object instance) : base("#Pfb.#2Ab")
		{
            SetInstance(instance);
		}

        public R__0__2Ab(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2Ab(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

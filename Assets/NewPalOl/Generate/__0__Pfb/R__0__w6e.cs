...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#w6e
	/// </summary>
    public partial class R__0__w6e : RMember //
    {
        ...
        public R__0__w6e() : base("#Pfb.#w6e")
        {
        }

        public R__0__w6e(System.Object instance) : base("#Pfb.#w6e")
		{
            SetInstance(instance);
		}

        public R__0__w6e(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__w6e(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

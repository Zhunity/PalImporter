...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ssb
	/// </summary>
    public partial class R__0__Ssb : RMember //
    {
        ...
        public R__0__Ssb() : base("#Pfb.#Ssb")
        {
        }

        public R__0__Ssb(System.Object instance) : base("#Pfb.#Ssb")
		{
            SetInstance(instance);
		}

        public R__0__Ssb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ssb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

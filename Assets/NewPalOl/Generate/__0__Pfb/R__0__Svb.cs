...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Svb
	/// </summary>
    public partial class R__0__Svb : RMember //
    {
        ...
        public R__0__Svb() : base("#Pfb.#Svb")
        {
        }

        public R__0__Svb(System.Object instance) : base("#Pfb.#Svb")
		{
            SetInstance(instance);
		}

        public R__0__Svb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Svb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

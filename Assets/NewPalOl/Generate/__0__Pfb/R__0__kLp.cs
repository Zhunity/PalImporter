...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#kLp
	/// </summary>
    public partial class R__0__kLp : RMember //
    {
        ...
        public R__0__kLp() : base("#Pfb.#kLp")
        {
        }

        public R__0__kLp(System.Object instance) : base("#Pfb.#kLp")
		{
            SetInstance(instance);
		}

        public R__0__kLp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__kLp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

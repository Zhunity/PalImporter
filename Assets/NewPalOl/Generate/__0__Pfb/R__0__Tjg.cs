...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Tjg
	/// </summary>
    public partial class R__0__Tjg : RMember //
    {
        ...
        public R__0__Tjg() : base("#Pfb.#Tjg")
        {
        }

        public R__0__Tjg(System.Object instance) : base("#Pfb.#Tjg")
		{
            SetInstance(instance);
		}

        public R__0__Tjg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Tjg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

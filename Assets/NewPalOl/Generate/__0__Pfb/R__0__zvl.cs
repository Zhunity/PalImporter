...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#zvl
	/// </summary>
    public partial class R__0__zvl : RMember //
    {
        ...
        public R__0__zvl() : base("#Pfb.#zvl")
        {
        }

        public R__0__zvl(System.Object instance) : base("#Pfb.#zvl")
		{
            SetInstance(instance);
		}

        public R__0__zvl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zvl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

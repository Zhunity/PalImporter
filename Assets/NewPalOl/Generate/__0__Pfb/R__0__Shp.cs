...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Shp
	/// </summary>
    public partial class R__0__Shp : RMember //
    {
        ...
        public R__0__Shp() : base("#Pfb.#Shp")
        {
        }

        public R__0__Shp(System.Object instance) : base("#Pfb.#Shp")
		{
            SetInstance(instance);
		}

        public R__0__Shp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Shp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#jre
	/// </summary>
    public partial class R__0__jre : RMember //
    {
        ...
        public R__0__jre() : base("#Pfb.#jre")
        {
        }

        public R__0__jre(System.Object instance) : base("#Pfb.#jre")
		{
            SetInstance(instance);
		}

        public R__0__jre(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jre(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

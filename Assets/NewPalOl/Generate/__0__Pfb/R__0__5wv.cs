...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#5wv
	/// </summary>
    public partial class R__0__5wv : RMember //
    {
        ...
        public R__0__5wv() : base("#Pfb.#5wv")
        {
        }

        public R__0__5wv(System.Object instance) : base("#Pfb.#5wv")
		{
            SetInstance(instance);
		}

        public R__0__5wv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5wv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

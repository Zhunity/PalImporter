...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Krb
	/// </summary>
    public partial class R__0__Krb : RMember //
    {
        ...
        public R__0__Krb() : base("#Pfb.#Krb")
        {
        }

        public R__0__Krb(System.Object instance) : base("#Pfb.#Krb")
		{
            SetInstance(instance);
		}

        public R__0__Krb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Krb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#3cr
	/// </summary>
    public partial class R__0__3cr : RMember //
    {
        ...
        public R__0__3cr() : base("#Pfb.#3cr")
        {
        }

        public R__0__3cr(System.Object instance) : base("#Pfb.#3cr")
		{
            SetInstance(instance);
		}

        public R__0__3cr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3cr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

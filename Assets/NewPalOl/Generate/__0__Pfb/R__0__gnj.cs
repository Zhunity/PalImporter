...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#gnj
	/// </summary>
    public partial class R__0__gnj : RMember //
    {
        ...
        public R__0__gnj() : base("#Pfb.#gnj")
        {
        }

        public R__0__gnj(System.Object instance) : base("#Pfb.#gnj")
		{
            SetInstance(instance);
		}

        public R__0__gnj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gnj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

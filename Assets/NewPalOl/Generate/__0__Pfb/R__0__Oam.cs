...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Oam
	/// </summary>
    public partial class R__0__Oam : RMember //
    {
        ...
        public R__0__Oam() : base("#Pfb.#Oam")
        {
        }

        public R__0__Oam(System.Object instance) : base("#Pfb.#Oam")
		{
            SetInstance(instance);
		}

        public R__0__Oam(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Oam(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

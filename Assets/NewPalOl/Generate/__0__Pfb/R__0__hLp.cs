...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#hLp
	/// </summary>
    public partial class R__0__hLp : RMember //
    {
        ...
        public R__0__hLp() : base("#Pfb.#hLp")
        {
        }

        public R__0__hLp(System.Object instance) : base("#Pfb.#hLp")
		{
            SetInstance(instance);
		}

        public R__0__hLp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hLp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#VDb
	/// </summary>
    public partial class R__0__VDb : RMember //
    {
        ...
        public R__0__VDb() : base("#Pfb.#VDb")
        {
        }

        public R__0__VDb(System.Object instance) : base("#Pfb.#VDb")
		{
            SetInstance(instance);
		}

        public R__0__VDb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__VDb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

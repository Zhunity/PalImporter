...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#fdr
	/// </summary>
    public partial class R__0__fdr : RMember //
    {
        ...
        public R__0__fdr() : base("#Pfb.#fdr")
        {
        }

        public R__0__fdr(System.Object instance) : base("#Pfb.#fdr")
		{
            SetInstance(instance);
		}

        public R__0__fdr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fdr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

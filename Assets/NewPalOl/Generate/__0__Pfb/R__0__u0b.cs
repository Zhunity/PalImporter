...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#u0b
	/// </summary>
    public partial class R__0__u0b : RMember //
    {
        ...
        public R__0__u0b() : base("#Pfb.#u0b")
        {
        }

        public R__0__u0b(System.Object instance) : base("#Pfb.#u0b")
		{
            SetInstance(instance);
		}

        public R__0__u0b(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__u0b(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

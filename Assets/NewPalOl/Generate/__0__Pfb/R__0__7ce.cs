...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7ce
	/// </summary>
    public partial class R__0__7ce : RMember //
    {
        ...
        public R__0__7ce() : base("#Pfb.#7ce")
        {
        }

        public R__0__7ce(System.Object instance) : base("#Pfb.#7ce")
		{
            SetInstance(instance);
		}

        public R__0__7ce(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7ce(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

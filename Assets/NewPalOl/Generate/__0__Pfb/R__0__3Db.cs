...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#3Db
	/// </summary>
    public partial class R__0__3Db : RMember //
    {
        ...
        public R__0__3Db() : base("#Pfb.#3Db")
        {
        }

        public R__0__3Db(System.Object instance) : base("#Pfb.#3Db")
		{
            SetInstance(instance);
		}

        public R__0__3Db(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3Db(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4Db
	/// </summary>
    public partial class R__0__4Db : RMember //
    {
        ...
        public R__0__4Db() : base("#Pfb.#4Db")
        {
        }

        public R__0__4Db(System.Object instance) : base("#Pfb.#4Db")
		{
            SetInstance(instance);
		}

        public R__0__4Db(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4Db(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

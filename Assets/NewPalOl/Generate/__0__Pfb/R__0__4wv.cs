...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4wv
	/// </summary>
    public partial class R__0__4wv : RMember //
    {
        ...
        public R__0__4wv() : base("#Pfb.#4wv")
        {
        }

        public R__0__4wv(System.Object instance) : base("#Pfb.#4wv")
		{
            SetInstance(instance);
		}

        public R__0__4wv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4wv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

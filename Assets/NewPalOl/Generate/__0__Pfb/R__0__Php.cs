...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Php
	/// </summary>
    public partial class R__0__Php : RMember //
    {
        ...
        public R__0__Php() : base("#Pfb.#Php")
        {
        }

        public R__0__Php(System.Object instance) : base("#Pfb.#Php")
		{
            SetInstance(instance);
		}

        public R__0__Php(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Php(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

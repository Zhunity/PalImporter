...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#wod
	/// </summary>
    public partial class R__0__wod : RMember //
    {
        ...
        public R__0__wod() : base("#Pfb.#wod")
        {
        }

        public R__0__wod(System.Object instance) : base("#Pfb.#wod")
		{
            SetInstance(instance);
		}

        public R__0__wod(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__wod(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

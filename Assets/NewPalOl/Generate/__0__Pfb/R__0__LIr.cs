...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#LIr
	/// </summary>
    public partial class R__0__LIr : RMember //
    {
        ...
        public R__0__LIr() : base("#Pfb.#LIr")
        {
        }

        public R__0__LIr(System.Object instance) : base("#Pfb.#LIr")
		{
            SetInstance(instance);
		}

        public R__0__LIr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__LIr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

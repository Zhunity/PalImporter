...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Fek
	/// </summary>
    public partial class R__0__Fek : RMember //
    {
        ...
        public R__0__Fek() : base("#Pfb.#Fek")
        {
        }

        public R__0__Fek(System.Object instance) : base("#Pfb.#Fek")
		{
            SetInstance(instance);
		}

        public R__0__Fek(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Fek(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

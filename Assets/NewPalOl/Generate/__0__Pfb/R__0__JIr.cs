...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#JIr
	/// </summary>
    public partial class R__0__JIr : RMember //
    {
        ...
        public R__0__JIr() : base("#Pfb.#JIr")
        {
        }

        public R__0__JIr(System.Object instance) : base("#Pfb.#JIr")
		{
            SetInstance(instance);
		}

        public R__0__JIr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__JIr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

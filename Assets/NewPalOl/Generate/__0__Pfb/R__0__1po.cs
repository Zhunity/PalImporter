...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#1po
	/// </summary>
    public partial class R__0__1po : RMember //
    {
        ...
        public R__0__1po() : base("#Pfb.#1po")
        {
        }

        public R__0__1po(System.Object instance) : base("#Pfb.#1po")
		{
            SetInstance(instance);
		}

        public R__0__1po(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1po(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

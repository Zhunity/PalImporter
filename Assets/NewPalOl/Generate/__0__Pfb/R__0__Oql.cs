...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Oql
	/// </summary>
    public partial class R__0__Oql : RMember //
    {
        ...
        public R__0__Oql() : base("#Pfb.#Oql")
        {
        }

        public R__0__Oql(System.Object instance) : base("#Pfb.#Oql")
		{
            SetInstance(instance);
		}

        public R__0__Oql(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Oql(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

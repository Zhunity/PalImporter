...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7Fd
	/// </summary>
    public partial class R__0__7Fd : RMember //
    {
        ...
        public R__0__7Fd() : base("#Pfb.#7Fd")
        {
        }

        public R__0__7Fd(System.Object instance) : base("#Pfb.#7Fd")
		{
            SetInstance(instance);
		}

        public R__0__7Fd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7Fd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

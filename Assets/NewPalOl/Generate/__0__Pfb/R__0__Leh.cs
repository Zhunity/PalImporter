...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Leh
	/// </summary>
    public partial class R__0__Leh : RMember //
    {
        ...
        public R__0__Leh() : base("#Pfb.#Leh")
        {
        }

        public R__0__Leh(System.Object instance) : base("#Pfb.#Leh")
		{
            SetInstance(instance);
		}

        public R__0__Leh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Leh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7cr
	/// </summary>
    public partial class R__0__7cr : RMember //
    {
        ...
        public R__0__7cr() : base("#Pfb.#7cr")
        {
        }

        public R__0__7cr(System.Object instance) : base("#Pfb.#7cr")
		{
            SetInstance(instance);
		}

        public R__0__7cr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7cr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

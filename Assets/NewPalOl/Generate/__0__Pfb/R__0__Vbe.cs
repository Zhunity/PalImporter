...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Vbe
	/// </summary>
    public partial class R__0__Vbe : RMember //
    {
        ...
        public R__0__Vbe() : base("#Pfb.#Vbe")
        {
        }

        public R__0__Vbe(System.Object instance) : base("#Pfb.#Vbe")
		{
            SetInstance(instance);
		}

        public R__0__Vbe(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vbe(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#UCi
	/// </summary>
    public partial class R__0__UCi : RMember //
    {
        ...
        public R__0__UCi() : base("#Pfb.#UCi")
        {
        }

        public R__0__UCi(System.Object instance) : base("#Pfb.#UCi")
		{
            SetInstance(instance);
		}

        public R__0__UCi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__UCi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

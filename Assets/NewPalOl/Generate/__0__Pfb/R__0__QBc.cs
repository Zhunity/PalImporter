...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#QBc
	/// </summary>
    public partial class R__0__QBc : RMember //
    {
        ...
        public R__0__QBc() : base("#Pfb.#QBc")
        {
        }

        public R__0__QBc(System.Object instance) : base("#Pfb.#QBc")
		{
            SetInstance(instance);
		}

        public R__0__QBc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__QBc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

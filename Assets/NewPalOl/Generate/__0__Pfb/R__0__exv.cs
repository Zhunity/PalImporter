...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#exv
	/// </summary>
    public partial class R__0__exv : RMember //
    {
        ...
        public R__0__exv() : base("#Pfb.#exv")
        {
        }

        public R__0__exv(System.Object instance) : base("#Pfb.#exv")
		{
            SetInstance(instance);
		}

        public R__0__exv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__exv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

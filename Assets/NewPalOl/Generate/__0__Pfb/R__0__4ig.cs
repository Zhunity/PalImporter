...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4ig
	/// </summary>
    public partial class R__0__4ig : RMember //
    {
        ...
        public R__0__4ig() : base("#Pfb.#4ig")
        {
        }

        public R__0__4ig(System.Object instance) : base("#Pfb.#4ig")
		{
            SetInstance(instance);
		}

        public R__0__4ig(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4ig(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

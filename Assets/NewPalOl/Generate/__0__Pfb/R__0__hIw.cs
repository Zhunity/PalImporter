...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#hIw
	/// </summary>
    public partial class R__0__hIw : RMember //
    {
        ...
        public R__0__hIw() : base("#Pfb.#hIw")
        {
        }

        public R__0__hIw(System.Object instance) : base("#Pfb.#hIw")
		{
            SetInstance(instance);
		}

        public R__0__hIw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hIw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

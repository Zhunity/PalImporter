...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8Gc
	/// </summary>
    public partial class R__0__8Gc : RMember //
    {
        ...
        public R__0__8Gc() : base("#Pfb.#8Gc")
        {
        }

        public R__0__8Gc(System.Object instance) : base("#Pfb.#8Gc")
		{
            SetInstance(instance);
		}

        public R__0__8Gc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Gc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#JAb
	/// </summary>
    public partial class R__0__JAb : RMember //
    {
        ...
        public R__0__JAb() : base("#Pfb.#JAb")
        {
        }

        public R__0__JAb(System.Object instance) : base("#Pfb.#JAb")
		{
            SetInstance(instance);
		}

        public R__0__JAb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__JAb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

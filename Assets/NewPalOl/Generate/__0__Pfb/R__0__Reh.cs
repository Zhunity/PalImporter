...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Reh
	/// </summary>
    public partial class R__0__Reh : RMember //
    {
        ...
        public R__0__Reh() : base("#Pfb.#Reh")
        {
        }

        public R__0__Reh(System.Object instance) : base("#Pfb.#Reh")
		{
            SetInstance(instance);
		}

        public R__0__Reh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Reh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#W2k
	/// </summary>
    public partial class R__0__W2k : RMember //
    {
        ...
        public R__0__W2k() : base("#Pfb.#W2k")
        {
        }

        public R__0__W2k(System.Object instance) : base("#Pfb.#W2k")
		{
            SetInstance(instance);
		}

        public R__0__W2k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__W2k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

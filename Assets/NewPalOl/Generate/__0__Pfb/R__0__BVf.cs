...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#BVf
	/// </summary>
    public partial class R__0__BVf : RMember //
    {
        ...
        public R__0__BVf() : base("#Pfb.#BVf")
        {
        }

        public R__0__BVf(System.Object instance) : base("#Pfb.#BVf")
		{
            SetInstance(instance);
		}

        public R__0__BVf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__BVf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

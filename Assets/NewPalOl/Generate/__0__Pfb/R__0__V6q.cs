...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#V6q
	/// </summary>
    public partial class R__0__V6q : RMember //
    {
        ...
        public R__0__V6q() : base("#Pfb.#V6q")
        {
        }

        public R__0__V6q(System.Object instance) : base("#Pfb.#V6q")
		{
            SetInstance(instance);
		}

        public R__0__V6q(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__V6q(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

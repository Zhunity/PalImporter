...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#32k
	/// </summary>
    public partial class R__0__32k : RMember //
    {
        ...
        public R__0__32k() : base("#Pfb.#32k")
        {
        }

        public R__0__32k(System.Object instance) : base("#Pfb.#32k")
		{
            SetInstance(instance);
		}

        public R__0__32k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__32k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

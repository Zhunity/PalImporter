...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#yKn
	/// </summary>
    public partial class R__0__yKn : RMember //
    {
        ...
        public R__0__yKn() : base("#Pfb.#yKn")
        {
        }

        public R__0__yKn(System.Object instance) : base("#Pfb.#yKn")
		{
            SetInstance(instance);
		}

        public R__0__yKn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__yKn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

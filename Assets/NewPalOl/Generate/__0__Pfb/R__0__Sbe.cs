...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Sbe
	/// </summary>
    public partial class R__0__Sbe : RMember //
    {
        ...
        public R__0__Sbe() : base("#Pfb.#Sbe")
        {
        }

        public R__0__Sbe(System.Object instance) : base("#Pfb.#Sbe")
		{
            SetInstance(instance);
		}

        public R__0__Sbe(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Sbe(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

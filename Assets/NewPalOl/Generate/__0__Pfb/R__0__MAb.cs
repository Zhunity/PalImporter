...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#MAb
	/// </summary>
    public partial class R__0__MAb : RMember //
    {
        ...
        public R__0__MAb() : base("#Pfb.#MAb")
        {
        }

        public R__0__MAb(System.Object instance) : base("#Pfb.#MAb")
		{
            SetInstance(instance);
		}

        public R__0__MAb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__MAb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

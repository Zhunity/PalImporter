...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#anj
	/// </summary>
    public partial class R__0__anj : RMember //
    {
        ...
        public R__0__anj() : base("#Pfb.#anj")
        {
        }

        public R__0__anj(System.Object instance) : base("#Pfb.#anj")
		{
            SetInstance(instance);
		}

        public R__0__anj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__anj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

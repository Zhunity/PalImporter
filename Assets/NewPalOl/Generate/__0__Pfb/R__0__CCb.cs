...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#CCb
	/// </summary>
    public partial class R__0__CCb : RMember //
    {
        ...
        public R__0__CCb() : base("#Pfb.#CCb")
        {
        }

        public R__0__CCb(System.Object instance) : base("#Pfb.#CCb")
		{
            SetInstance(instance);
		}

        public R__0__CCb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__CCb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

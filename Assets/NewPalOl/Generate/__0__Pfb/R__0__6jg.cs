...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#6jg
	/// </summary>
    public partial class R__0__6jg : RMember //
    {
        ...
        public R__0__6jg() : base("#Pfb.#6jg")
        {
        }

        public R__0__6jg(System.Object instance) : base("#Pfb.#6jg")
		{
            SetInstance(instance);
		}

        public R__0__6jg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6jg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Lrb
	/// </summary>
    public partial class R__0__Lrb : RMember //
    {
        ...
        public R__0__Lrb() : base("#Pfb.#Lrb")
        {
        }

        public R__0__Lrb(System.Object instance) : base("#Pfb.#Lrb")
		{
            SetInstance(instance);
		}

        public R__0__Lrb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Lrb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

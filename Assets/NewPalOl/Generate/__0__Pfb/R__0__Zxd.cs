...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Zxd
	/// </summary>
    public partial class R__0__Zxd : RMember //
    {
        ...
        public R__0__Zxd() : base("#Pfb.#Zxd")
        {
        }

        public R__0__Zxd(System.Object instance) : base("#Pfb.#Zxd")
		{
            SetInstance(instance);
		}

        public R__0__Zxd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Zxd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

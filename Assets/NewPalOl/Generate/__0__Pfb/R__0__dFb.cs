...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#dFb
	/// </summary>
    public partial class R__0__dFb : RMember //
    {
        ...
        public R__0__dFb() : base("#Pfb.#dFb")
        {
        }

        public R__0__dFb(System.Object instance) : base("#Pfb.#dFb")
		{
            SetInstance(instance);
		}

        public R__0__dFb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dFb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

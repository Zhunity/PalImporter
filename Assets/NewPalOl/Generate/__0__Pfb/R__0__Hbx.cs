...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Hbx
	/// </summary>
    public partial class R__0__Hbx : RMember //
    {
        ...
        public R__0__Hbx() : base("#Pfb.#Hbx")
        {
        }

        public R__0__Hbx(System.Object instance) : base("#Pfb.#Hbx")
		{
            SetInstance(instance);
		}

        public R__0__Hbx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Hbx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

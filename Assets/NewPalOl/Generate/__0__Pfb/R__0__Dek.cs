...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Dek
	/// </summary>
    public partial class R__0__Dek : RMember //
    {
        ...
        public R__0__Dek() : base("#Pfb.#Dek")
        {
        }

        public R__0__Dek(System.Object instance) : base("#Pfb.#Dek")
		{
            SetInstance(instance);
		}

        public R__0__Dek(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Dek(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7ub
	/// </summary>
    public partial class R__0__7ub : RMember //
    {
        ...
        public R__0__7ub() : base("#Pfb.#7ub")
        {
        }

        public R__0__7ub(System.Object instance) : base("#Pfb.#7ub")
		{
            SetInstance(instance);
		}

        public R__0__7ub(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7ub(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Lhp
	/// </summary>
    public partial class R__0__Lhp : RMember //
    {
        ...
        public R__0__Lhp() : base("#Pfb.#Lhp")
        {
        }

        public R__0__Lhp(System.Object instance) : base("#Pfb.#Lhp")
		{
            SetInstance(instance);
		}

        public R__0__Lhp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Lhp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

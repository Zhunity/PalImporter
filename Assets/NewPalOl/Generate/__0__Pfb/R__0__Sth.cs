...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Sth
	/// </summary>
    public partial class R__0__Sth : RMember //
    {
        ...
        public R__0__Sth() : base("#Pfb.#Sth")
        {
        }

        public R__0__Sth(System.Object instance) : base("#Pfb.#Sth")
		{
            SetInstance(instance);
		}

        public R__0__Sth(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Sth(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Y6q
	/// </summary>
    public partial class R__0__Y6q : RMember //
    {
        ...
        public R__0__Y6q() : base("#Pfb.#Y6q")
        {
        }

        public R__0__Y6q(System.Object instance) : base("#Pfb.#Y6q")
		{
            SetInstance(instance);
		}

        public R__0__Y6q(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Y6q(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

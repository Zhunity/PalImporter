...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Pwb
	/// </summary>
    public partial class R__0__Pwb : RMember //
    {
        ...
        public R__0__Pwb() : base("#Pfb.#Pwb")
        {
        }

        public R__0__Pwb(System.Object instance) : base("#Pfb.#Pwb")
		{
            SetInstance(instance);
		}

        public R__0__Pwb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Pwb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

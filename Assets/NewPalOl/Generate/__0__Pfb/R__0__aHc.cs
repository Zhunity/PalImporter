...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#aHc
	/// </summary>
    public partial class R__0__aHc : RMember //
    {
        ...
        public R__0__aHc() : base("#Pfb.#aHc")
        {
        }

        public R__0__aHc(System.Object instance) : base("#Pfb.#aHc")
		{
            SetInstance(instance);
		}

        public R__0__aHc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__aHc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ojg
	/// </summary>
    public partial class R__0__Ojg : RMember //
    {
        ...
        public R__0__Ojg() : base("#Pfb.#Ojg")
        {
        }

        public R__0__Ojg(System.Object instance) : base("#Pfb.#Ojg")
		{
            SetInstance(instance);
		}

        public R__0__Ojg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ojg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

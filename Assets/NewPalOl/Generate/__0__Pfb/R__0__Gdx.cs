...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Gdx
	/// </summary>
    public partial class R__0__Gdx : RMember //
    {
        ...
        public R__0__Gdx() : base("#Pfb.#Gdx")
        {
        }

        public R__0__Gdx(System.Object instance) : base("#Pfb.#Gdx")
		{
            SetInstance(instance);
		}

        public R__0__Gdx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Gdx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

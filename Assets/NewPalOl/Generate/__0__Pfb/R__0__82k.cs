...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#82k
	/// </summary>
    public partial class R__0__82k : RMember //
    {
        ...
        public R__0__82k() : base("#Pfb.#82k")
        {
        }

        public R__0__82k(System.Object instance) : base("#Pfb.#82k")
		{
            SetInstance(instance);
		}

        public R__0__82k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__82k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

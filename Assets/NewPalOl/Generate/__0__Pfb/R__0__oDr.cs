...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#oDr
	/// </summary>
    public partial class R__0__oDr : RMember //
    {
        ...
        public R__0__oDr() : base("#Pfb.#oDr")
        {
        }

        public R__0__oDr(System.Object instance) : base("#Pfb.#oDr")
		{
            SetInstance(instance);
		}

        public R__0__oDr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oDr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

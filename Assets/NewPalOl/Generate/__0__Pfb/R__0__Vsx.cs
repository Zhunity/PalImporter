...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Vsx
	/// </summary>
    public partial class R__0__Vsx : RMember //
    {
        ...
        public R__0__Vsx() : base("#Pfb.#Vsx")
        {
        }

        public R__0__Vsx(System.Object instance) : base("#Pfb.#Vsx")
		{
            SetInstance(instance);
		}

        public R__0__Vsx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vsx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

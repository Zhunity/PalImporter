...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#cdv
	/// </summary>
    public partial class R__0__cdv : RMember //
    {
        ...
        public R__0__cdv() : base("#Pfb.#cdv")
        {
        }

        public R__0__cdv(System.Object instance) : base("#Pfb.#cdv")
		{
            SetInstance(instance);
		}

        public R__0__cdv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cdv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#YSv
	/// </summary>
    public partial class R__0__YSv : RMember //
    {
        ...
        public R__0__YSv() : base("#Pfb.#YSv")
        {
        }

        public R__0__YSv(System.Object instance) : base("#Pfb.#YSv")
		{
            SetInstance(instance);
		}

        public R__0__YSv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YSv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

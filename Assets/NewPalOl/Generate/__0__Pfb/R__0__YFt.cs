...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#YFt
	/// </summary>
    public partial class R__0__YFt : RMember //
    {
        ...
        public R__0__YFt() : base("#Pfb.#YFt")
        {
        }

        public R__0__YFt(System.Object instance) : base("#Pfb.#YFt")
		{
            SetInstance(instance);
		}

        public R__0__YFt(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YFt(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

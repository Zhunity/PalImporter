...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#aqo
	/// </summary>
    public partial class R__0__aqo : RMember //
    {
        ...
        public R__0__aqo() : base("#Pfb.#aqo")
        {
        }

        public R__0__aqo(System.Object instance) : base("#Pfb.#aqo")
		{
            SetInstance(instance);
		}

        public R__0__aqo(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__aqo(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

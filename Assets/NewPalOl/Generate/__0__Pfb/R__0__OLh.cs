...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#OLh
	/// </summary>
    public partial class R__0__OLh : RMember //
    {
        ...
        public R__0__OLh() : base("#Pfb.#OLh")
        {
        }

        public R__0__OLh(System.Object instance) : base("#Pfb.#OLh")
		{
            SetInstance(instance);
		}

        public R__0__OLh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__OLh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

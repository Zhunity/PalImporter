...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Vwb
	/// </summary>
    public partial class R__0__Vwb : RMember //
    {
        ...
        public R__0__Vwb() : base("#Pfb.#Vwb")
        {
        }

        public R__0__Vwb(System.Object instance) : base("#Pfb.#Vwb")
		{
            SetInstance(instance);
		}

        public R__0__Vwb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vwb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

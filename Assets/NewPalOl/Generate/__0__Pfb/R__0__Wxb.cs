...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wxb
	/// </summary>
    public partial class R__0__Wxb : RMember //
    {
        ...
        public R__0__Wxb() : base("#Pfb.#Wxb")
        {
        }

        public R__0__Wxb(System.Object instance) : base("#Pfb.#Wxb")
		{
            SetInstance(instance);
		}

        public R__0__Wxb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wxb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9rv
	/// </summary>
    public partial class R__0__9rv : RMember //
    {
        ...
        public R__0__9rv() : base("#Pfb.#9rv")
        {
        }

        public R__0__9rv(System.Object instance) : base("#Pfb.#9rv")
		{
            SetInstance(instance);
		}

        public R__0__9rv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9rv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Lam
	/// </summary>
    public partial class R__0__Lam : RMember //
    {
        ...
        public R__0__Lam() : base("#Pfb.#Lam")
        {
        }

        public R__0__Lam(System.Object instance) : base("#Pfb.#Lam")
		{
            SetInstance(instance);
		}

        public R__0__Lam(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Lam(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Oce
	/// </summary>
    public partial class R__0__Oce : RMember //
    {
        ...
        public R__0__Oce() : base("#Pfb.#Oce")
        {
        }

        public R__0__Oce(System.Object instance) : base("#Pfb.#Oce")
		{
            SetInstance(instance);
		}

        public R__0__Oce(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Oce(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

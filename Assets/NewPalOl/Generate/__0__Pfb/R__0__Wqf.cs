...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wqf
	/// </summary>
    public partial class R__0__Wqf : RMember //
    {
        ...
        public R__0__Wqf() : base("#Pfb.#Wqf")
        {
        }

        public R__0__Wqf(System.Object instance) : base("#Pfb.#Wqf")
		{
            SetInstance(instance);
		}

        public R__0__Wqf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wqf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

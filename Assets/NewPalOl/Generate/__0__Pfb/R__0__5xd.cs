...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#5xd
	/// </summary>
    public partial class R__0__5xd : RMember //
    {
        ...
        public R__0__5xd() : base("#Pfb.#5xd")
        {
        }

        public R__0__5xd(System.Object instance) : base("#Pfb.#5xd")
		{
            SetInstance(instance);
		}

        public R__0__5xd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5xd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

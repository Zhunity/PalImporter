...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8qf
	/// </summary>
    public partial class R__0__8qf : RMember //
    {
        ...
        public R__0__8qf() : base("#Pfb.#8qf")
        {
        }

        public R__0__8qf(System.Object instance) : base("#Pfb.#8qf")
		{
            SetInstance(instance);
		}

        public R__0__8qf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8qf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

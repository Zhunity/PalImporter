...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7tb
	/// </summary>
    public partial class R__0__7tb : RMember //
    {
        ...
        public R__0__7tb() : base("#Pfb.#7tb")
        {
        }

        public R__0__7tb(System.Object instance) : base("#Pfb.#7tb")
		{
            SetInstance(instance);
		}

        public R__0__7tb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7tb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

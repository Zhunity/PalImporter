...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#esb
	/// </summary>
    public partial class R__0__esb : RMember //
    {
        ...
        public R__0__esb() : base("#Pfb.#esb")
        {
        }

        public R__0__esb(System.Object instance) : base("#Pfb.#esb")
		{
            SetInstance(instance);
		}

        public R__0__esb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__esb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

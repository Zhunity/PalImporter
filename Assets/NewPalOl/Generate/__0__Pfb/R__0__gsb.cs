...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#gsb
	/// </summary>
    public partial class R__0__gsb : RMember //
    {
        ...
        public R__0__gsb() : base("#Pfb.#gsb")
        {
        }

        public R__0__gsb(System.Object instance) : base("#Pfb.#gsb")
		{
            SetInstance(instance);
		}

        public R__0__gsb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gsb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#J2k
	/// </summary>
    public partial class R__0__J2k : RMember //
    {
        ...
        public R__0__J2k() : base("#Pfb.#J2k")
        {
        }

        public R__0__J2k(System.Object instance) : base("#Pfb.#J2k")
		{
            SetInstance(instance);
		}

        public R__0__J2k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__J2k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

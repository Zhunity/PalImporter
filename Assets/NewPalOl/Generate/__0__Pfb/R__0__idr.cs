...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#idr
	/// </summary>
    public partial class R__0__idr : RMember //
    {
        ...
        public R__0__idr() : base("#Pfb.#idr")
        {
        }

        public R__0__idr(System.Object instance) : base("#Pfb.#idr")
		{
            SetInstance(instance);
		}

        public R__0__idr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__idr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

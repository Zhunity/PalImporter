...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Sij
	/// </summary>
    public partial class R__0__Sij : RMember //
    {
        ...
        public R__0__Sij() : base("#Pfb.#Sij")
        {
        }

        public R__0__Sij(System.Object instance) : base("#Pfb.#Sij")
		{
            SetInstance(instance);
		}

        public R__0__Sij(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Sij(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

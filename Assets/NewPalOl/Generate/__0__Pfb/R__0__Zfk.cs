...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Zfk
	/// </summary>
    public partial class R__0__Zfk : RMember //
    {
        ...
        public R__0__Zfk() : base("#Pfb.#Zfk")
        {
        }

        public R__0__Zfk(System.Object instance) : base("#Pfb.#Zfk")
		{
            SetInstance(instance);
		}

        public R__0__Zfk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Zfk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

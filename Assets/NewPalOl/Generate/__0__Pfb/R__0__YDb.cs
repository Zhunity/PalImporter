...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#YDb
	/// </summary>
    public partial class R__0__YDb : RMember //
    {
        ...
        public R__0__YDb() : base("#Pfb.#YDb")
        {
        }

        public R__0__YDb(System.Object instance) : base("#Pfb.#YDb")
		{
            SetInstance(instance);
		}

        public R__0__YDb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YDb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

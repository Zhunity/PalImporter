...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#VXl
	/// </summary>
    public partial class R__0__VXl : RMember //
    {
        ...
        public R__0__VXl() : base("#Pfb.#VXl")
        {
        }

        public R__0__VXl(System.Object instance) : base("#Pfb.#VXl")
		{
            SetInstance(instance);
		}

        public R__0__VXl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__VXl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

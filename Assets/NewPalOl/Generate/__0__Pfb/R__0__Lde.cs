...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Lde
	/// </summary>
    public partial class R__0__Lde : RMember //
    {
        ...
        public R__0__Lde() : base("#Pfb.#Lde")
        {
        }

        public R__0__Lde(System.Object instance) : base("#Pfb.#Lde")
		{
            SetInstance(instance);
		}

        public R__0__Lde(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Lde(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

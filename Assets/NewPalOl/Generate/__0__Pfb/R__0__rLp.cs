...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#rLp
	/// </summary>
    public partial class R__0__rLp : RMember //
    {
        ...
        public R__0__rLp() : base("#Pfb.#rLp")
        {
        }

        public R__0__rLp(System.Object instance) : base("#Pfb.#rLp")
		{
            SetInstance(instance);
		}

        public R__0__rLp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__rLp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

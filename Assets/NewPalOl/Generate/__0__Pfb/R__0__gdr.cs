...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#gdr
	/// </summary>
    public partial class R__0__gdr : RMember //
    {
        ...
        public R__0__gdr() : base("#Pfb.#gdr")
        {
        }

        public R__0__gdr(System.Object instance) : base("#Pfb.#gdr")
		{
            SetInstance(instance);
		}

        public R__0__gdr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gdr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

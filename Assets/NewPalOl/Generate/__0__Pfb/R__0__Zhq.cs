...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Zhq
	/// </summary>
    public partial class R__0__Zhq : RMember //
    {
        ...
        public R__0__Zhq() : base("#Pfb.#Zhq")
        {
        }

        public R__0__Zhq(System.Object instance) : base("#Pfb.#Zhq")
		{
            SetInstance(instance);
		}

        public R__0__Zhq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Zhq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

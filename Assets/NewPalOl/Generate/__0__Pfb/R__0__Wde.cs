...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wde
	/// </summary>
    public partial class R__0__Wde : RMember //
    {
        ...
        public R__0__Wde() : base("#Pfb.#Wde")
        {
        }

        public R__0__Wde(System.Object instance) : base("#Pfb.#Wde")
		{
            SetInstance(instance);
		}

        public R__0__Wde(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wde(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#wre
	/// </summary>
    public partial class R__0__wre : RMember //
    {
        ...
        public R__0__wre() : base("#Pfb.#wre")
        {
        }

        public R__0__wre(System.Object instance) : base("#Pfb.#wre")
		{
            SetInstance(instance);
		}

        public R__0__wre(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__wre(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

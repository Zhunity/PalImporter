...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#whl
	/// </summary>
    public partial class R__0__whl : RMember //
    {
        ...
        public R__0__whl() : base("#Pfb.#whl")
        {
        }

        public R__0__whl(System.Object instance) : base("#Pfb.#whl")
		{
            SetInstance(instance);
		}

        public R__0__whl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__whl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

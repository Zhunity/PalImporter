...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#1Xl
	/// </summary>
    public partial class R__0__1Xl : RMember //
    {
        ...
        public R__0__1Xl() : base("#Pfb.#1Xl")
        {
        }

        public R__0__1Xl(System.Object instance) : base("#Pfb.#1Xl")
		{
            SetInstance(instance);
		}

        public R__0__1Xl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1Xl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#lLp
	/// </summary>
    public partial class R__0__lLp : RMember //
    {
        ...
        public R__0__lLp() : base("#Pfb.#lLp")
        {
        }

        public R__0__lLp(System.Object instance) : base("#Pfb.#lLp")
		{
            SetInstance(instance);
		}

        public R__0__lLp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__lLp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0hq
	/// </summary>
    public partial class R__0__0hq : RMember //
    {
        ...
        public R__0__0hq() : base("#Pfb.#0hq")
        {
        }

        public R__0__0hq(System.Object instance) : base("#Pfb.#0hq")
		{
            SetInstance(instance);
		}

        public R__0__0hq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0hq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

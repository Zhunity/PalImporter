...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ihf
	/// </summary>
    public partial class R__0__Ihf : RMember //
    {
        ...
        public R__0__Ihf() : base("#Pfb.#Ihf")
        {
        }

        public R__0__Ihf(System.Object instance) : base("#Pfb.#Ihf")
		{
            SetInstance(instance);
		}

        public R__0__Ihf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ihf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#llq
	/// </summary>
    public partial class R__0__llq : RMember //
    {
        ...
        public R__0__llq() : base("#Pfb.#llq")
        {
        }

        public R__0__llq(System.Object instance) : base("#Pfb.#llq")
		{
            SetInstance(instance);
		}

        public R__0__llq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__llq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#cZi
	/// </summary>
    public partial class R__0__cZi : RMember //
    {
        ...
        public R__0__cZi() : base("#Pfb.#cZi")
        {
        }

        public R__0__cZi(System.Object instance) : base("#Pfb.#cZi")
		{
            SetInstance(instance);
		}

        public R__0__cZi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cZi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

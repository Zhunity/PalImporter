...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#G2k
	/// </summary>
    public partial class R__0__G2k : RMember //
    {
        ...
        public R__0__G2k() : base("#Pfb.#G2k")
        {
        }

        public R__0__G2k(System.Object instance) : base("#Pfb.#G2k")
		{
            SetInstance(instance);
		}

        public R__0__G2k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__G2k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

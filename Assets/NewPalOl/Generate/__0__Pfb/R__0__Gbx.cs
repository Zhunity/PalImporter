...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Gbx
	/// </summary>
    public partial class R__0__Gbx : RMember //
    {
        ...
        public R__0__Gbx() : base("#Pfb.#Gbx")
        {
        }

        public R__0__Gbx(System.Object instance) : base("#Pfb.#Gbx")
		{
            SetInstance(instance);
		}

        public R__0__Gbx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Gbx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

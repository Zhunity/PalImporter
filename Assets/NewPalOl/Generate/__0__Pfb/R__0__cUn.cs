...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#cUn
	/// </summary>
    public partial class R__0__cUn : RMember //
    {
        ...
        public R__0__cUn() : base("#Pfb.#cUn")
        {
        }

        public R__0__cUn(System.Object instance) : base("#Pfb.#cUn")
		{
            SetInstance(instance);
		}

        public R__0__cUn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cUn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

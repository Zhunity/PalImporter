...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#2jg
	/// </summary>
    public partial class R__0__2jg : RMember //
    {
        ...
        public R__0__2jg() : base("#Pfb.#2jg")
        {
        }

        public R__0__2jg(System.Object instance) : base("#Pfb.#2jg")
		{
            SetInstance(instance);
		}

        public R__0__2jg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2jg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Gek
	/// </summary>
    public partial class R__0__Gek : RMember //
    {
        ...
        public R__0__Gek() : base("#Pfb.#Gek")
        {
        }

        public R__0__Gek(System.Object instance) : base("#Pfb.#Gek")
		{
            SetInstance(instance);
		}

        public R__0__Gek(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Gek(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

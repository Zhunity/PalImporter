...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#HHn
	/// </summary>
    public partial class R__0__HHn : RMember //
    {
        ...
        public R__0__HHn() : base("#Pfb.#HHn")
        {
        }

        public R__0__HHn(System.Object instance) : base("#Pfb.#HHn")
		{
            SetInstance(instance);
		}

        public R__0__HHn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__HHn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

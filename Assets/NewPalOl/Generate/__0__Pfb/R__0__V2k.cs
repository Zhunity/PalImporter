...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#V2k
	/// </summary>
    public partial class R__0__V2k : RMember //
    {
        ...
        public R__0__V2k() : base("#Pfb.#V2k")
        {
        }

        public R__0__V2k(System.Object instance) : base("#Pfb.#V2k")
		{
            SetInstance(instance);
		}

        public R__0__V2k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__V2k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#KAb
	/// </summary>
    public partial class R__0__KAb : RMember //
    {
        ...
        public R__0__KAb() : base("#Pfb.#KAb")
        {
        }

        public R__0__KAb(System.Object instance) : base("#Pfb.#KAb")
		{
            SetInstance(instance);
		}

        public R__0__KAb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__KAb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

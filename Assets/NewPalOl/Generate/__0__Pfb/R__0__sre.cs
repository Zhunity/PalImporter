...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#sre
	/// </summary>
    public partial class R__0__sre : RMember //
    {
        ...
        public R__0__sre() : base("#Pfb.#sre")
        {
        }

        public R__0__sre(System.Object instance) : base("#Pfb.#sre")
		{
            SetInstance(instance);
		}

        public R__0__sre(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__sre(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

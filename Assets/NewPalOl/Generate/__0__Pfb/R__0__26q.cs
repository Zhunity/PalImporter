...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#26q
	/// </summary>
    public partial class R__0__26q : RMember //
    {
        ...
        public R__0__26q() : base("#Pfb.#26q")
        {
        }

        public R__0__26q(System.Object instance) : base("#Pfb.#26q")
		{
            SetInstance(instance);
		}

        public R__0__26q(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__26q(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

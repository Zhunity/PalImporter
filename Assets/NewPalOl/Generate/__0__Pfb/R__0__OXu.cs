...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#OXu
	/// </summary>
    public partial class R__0__OXu : RMember //
    {
        ...
        public R__0__OXu() : base("#Pfb.#OXu")
        {
        }

        public R__0__OXu(System.Object instance) : base("#Pfb.#OXu")
		{
            SetInstance(instance);
		}

        public R__0__OXu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__OXu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

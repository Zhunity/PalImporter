...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9Tn
	/// </summary>
    public partial class R__0__9Tn : RMember //
    {
        ...
        public R__0__9Tn() : base("#Pfb.#9Tn")
        {
        }

        public R__0__9Tn(System.Object instance) : base("#Pfb.#9Tn")
		{
            SetInstance(instance);
		}

        public R__0__9Tn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Tn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wmu
	/// </summary>
    public partial class R__0__Wmu : RMember //
    {
        ...
        public R__0__Wmu() : base("#Pfb.#Wmu")
        {
        }

        public R__0__Wmu(System.Object instance) : base("#Pfb.#Wmu")
		{
            SetInstance(instance);
		}

        public R__0__Wmu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wmu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Exb
	/// </summary>
    public partial class R__0__Exb : RMember //
    {
        ...
        public R__0__Exb() : base("#Pfb.#Exb")
        {
        }

        public R__0__Exb(System.Object instance) : base("#Pfb.#Exb")
		{
            SetInstance(instance);
		}

        public R__0__Exb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Exb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

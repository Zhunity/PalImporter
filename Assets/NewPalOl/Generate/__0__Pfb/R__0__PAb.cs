...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#PAb
	/// </summary>
    public partial class R__0__PAb : RMember //
    {
        ...
        public R__0__PAb() : base("#Pfb.#PAb")
        {
        }

        public R__0__PAb(System.Object instance) : base("#Pfb.#PAb")
		{
            SetInstance(instance);
		}

        public R__0__PAb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__PAb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

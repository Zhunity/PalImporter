...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#nVr
	/// </summary>
    public partial class R__0__nVr : RMember //
    {
        ...
        public R__0__nVr() : base("#Pfb.#nVr")
        {
        }

        public R__0__nVr(System.Object instance) : base("#Pfb.#nVr")
		{
            SetInstance(instance);
		}

        public R__0__nVr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__nVr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

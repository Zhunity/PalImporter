...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Jfi
	/// </summary>
    public partial class R__0__Jfi : RMember //
    {
        ...
        public R__0__Jfi() : base("#Pfb.#Jfi")
        {
        }

        public R__0__Jfi(System.Object instance) : base("#Pfb.#Jfi")
		{
            SetInstance(instance);
		}

        public R__0__Jfi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Jfi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0Ci
	/// </summary>
    public partial class R__0__0Ci : RMember //
    {
        ...
        public R__0__0Ci() : base("#Pfb.#0Ci")
        {
        }

        public R__0__0Ci(System.Object instance) : base("#Pfb.#0Ci")
		{
            SetInstance(instance);
		}

        public R__0__0Ci(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0Ci(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0ih
	/// </summary>
    public partial class R__0__0ih : RMember //
    {
        ...
        public R__0__0ih() : base("#Pfb.#0ih")
        {
        }

        public R__0__0ih(System.Object instance) : base("#Pfb.#0ih")
		{
            SetInstance(instance);
		}

        public R__0__0ih(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0ih(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Uih
	/// </summary>
    public partial class R__0__Uih : RMember //
    {
        ...
        public R__0__Uih() : base("#Pfb.#Uih")
        {
        }

        public R__0__Uih(System.Object instance) : base("#Pfb.#Uih")
		{
            SetInstance(instance);
		}

        public R__0__Uih(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Uih(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

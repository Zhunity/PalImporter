...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#uDr
	/// </summary>
    public partial class R__0__uDr : RMember //
    {
        ...
        public R__0__uDr() : base("#Pfb.#uDr")
        {
        }

        public R__0__uDr(System.Object instance) : base("#Pfb.#uDr")
		{
            SetInstance(instance);
		}

        public R__0__uDr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__uDr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Epb
	/// </summary>
    public partial class R__0__Epb : RMember //
    {
        ...
        public R__0__Epb() : base("#Pfb.#Epb")
        {
        }

        public R__0__Epb(System.Object instance) : base("#Pfb.#Epb")
		{
            SetInstance(instance);
		}

        public R__0__Epb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Epb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

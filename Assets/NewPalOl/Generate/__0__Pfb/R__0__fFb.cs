...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#fFb
	/// </summary>
    public partial class R__0__fFb : RMember //
    {
        ...
        public R__0__fFb() : base("#Pfb.#fFb")
        {
        }

        public R__0__fFb(System.Object instance) : base("#Pfb.#fFb")
		{
            SetInstance(instance);
		}

        public R__0__fFb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fFb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

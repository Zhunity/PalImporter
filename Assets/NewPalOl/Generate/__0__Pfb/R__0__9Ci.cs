...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9Ci
	/// </summary>
    public partial class R__0__9Ci : RMember //
    {
        ...
        public R__0__9Ci() : base("#Pfb.#9Ci")
        {
        }

        public R__0__9Ci(System.Object instance) : base("#Pfb.#9Ci")
		{
            SetInstance(instance);
		}

        public R__0__9Ci(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Ci(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

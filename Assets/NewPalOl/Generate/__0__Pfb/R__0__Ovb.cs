...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ovb
	/// </summary>
    public partial class R__0__Ovb : RMember //
    {
        ...
        public R__0__Ovb() : base("#Pfb.#Ovb")
        {
        }

        public R__0__Ovb(System.Object instance) : base("#Pfb.#Ovb")
		{
            SetInstance(instance);
		}

        public R__0__Ovb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ovb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ebi
	/// </summary>
    public partial class R__0__ebi : RMember //
    {
        ...
        public R__0__ebi() : base("#Pfb.#ebi")
        {
        }

        public R__0__ebi(System.Object instance) : base("#Pfb.#ebi")
		{
            SetInstance(instance);
		}

        public R__0__ebi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ebi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

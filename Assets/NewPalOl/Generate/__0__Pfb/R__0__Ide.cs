...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ide
	/// </summary>
    public partial class R__0__Ide : RMember //
    {
        ...
        public R__0__Ide() : base("#Pfb.#Ide")
        {
        }

        public R__0__Ide(System.Object instance) : base("#Pfb.#Ide")
		{
            SetInstance(instance);
		}

        public R__0__Ide(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ide(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

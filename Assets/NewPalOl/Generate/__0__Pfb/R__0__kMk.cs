...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#kMk
	/// </summary>
    public partial class R__0__kMk : RMember //
    {
        ...
        public R__0__kMk() : base("#Pfb.#kMk")
        {
        }

        public R__0__kMk(System.Object instance) : base("#Pfb.#kMk")
		{
            SetInstance(instance);
		}

        public R__0__kMk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__kMk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

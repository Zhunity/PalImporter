...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#WJv
	/// </summary>
    public partial class R__0__WJv : RMember //
    {
        ...
        public R__0__WJv() : base("#Pfb.#WJv")
        {
        }

        public R__0__WJv(System.Object instance) : base("#Pfb.#WJv")
		{
            SetInstance(instance);
		}

        public R__0__WJv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__WJv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

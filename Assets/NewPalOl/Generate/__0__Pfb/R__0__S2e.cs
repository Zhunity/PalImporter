...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#S2e
	/// </summary>
    public partial class R__0__S2e : RMember //
    {
        ...
        public R__0__S2e() : base("#Pfb.#S2e")
        {
        }

        public R__0__S2e(System.Object instance) : base("#Pfb.#S2e")
		{
            SetInstance(instance);
		}

        public R__0__S2e(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__S2e(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

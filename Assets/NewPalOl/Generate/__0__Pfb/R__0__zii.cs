...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#zii
	/// </summary>
    public partial class R__0__zii : RMember //
    {
        ...
        public R__0__zii() : base("#Pfb.#zii")
        {
        }

        public R__0__zii(System.Object instance) : base("#Pfb.#zii")
		{
            SetInstance(instance);
		}

        public R__0__zii(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zii(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

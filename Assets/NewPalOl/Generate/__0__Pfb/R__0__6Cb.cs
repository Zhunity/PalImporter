...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#6Cb
	/// </summary>
    public partial class R__0__6Cb : RMember //
    {
        ...
        public R__0__6Cb() : base("#Pfb.#6Cb")
        {
        }

        public R__0__6Cb(System.Object instance) : base("#Pfb.#6Cb")
		{
            SetInstance(instance);
		}

        public R__0__6Cb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6Cb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

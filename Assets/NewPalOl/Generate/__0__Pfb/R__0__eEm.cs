...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#eEm
	/// </summary>
    public partial class R__0__eEm : RMember //
    {
        ...
        public R__0__eEm() : base("#Pfb.#eEm")
        {
        }

        public R__0__eEm(System.Object instance) : base("#Pfb.#eEm")
		{
            SetInstance(instance);
		}

        public R__0__eEm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__eEm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#P4p
	/// </summary>
    public partial class R__0__P4p : RMember //
    {
        ...
        public R__0__P4p() : base("#Pfb.#P4p")
        {
        }

        public R__0__P4p(System.Object instance) : base("#Pfb.#P4p")
		{
            SetInstance(instance);
		}

        public R__0__P4p(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__P4p(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

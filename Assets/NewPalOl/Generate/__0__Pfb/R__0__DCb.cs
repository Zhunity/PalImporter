...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#DCb
	/// </summary>
    public partial class R__0__DCb : RMember //
    {
        ...
        public R__0__DCb() : base("#Pfb.#DCb")
        {
        }

        public R__0__DCb(System.Object instance) : base("#Pfb.#DCb")
		{
            SetInstance(instance);
		}

        public R__0__DCb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__DCb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

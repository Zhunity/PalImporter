...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#gMg
	/// </summary>
    public partial class R__0__gMg : RMember //
    {
        ...
        public R__0__gMg() : base("#Pfb.#gMg")
        {
        }

        public R__0__gMg(System.Object instance) : base("#Pfb.#gMg")
		{
            SetInstance(instance);
		}

        public R__0__gMg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gMg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

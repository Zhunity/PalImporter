...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ivb
	/// </summary>
    public partial class R__0__Ivb : RMember //
    {
        ...
        public R__0__Ivb() : base("#Pfb.#Ivb")
        {
        }

        public R__0__Ivb(System.Object instance) : base("#Pfb.#Ivb")
		{
            SetInstance(instance);
		}

        public R__0__Ivb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ivb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

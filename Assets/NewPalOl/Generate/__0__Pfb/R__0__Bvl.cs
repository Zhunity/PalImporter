...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Bvl
	/// </summary>
    public partial class R__0__Bvl : RMember //
    {
        ...
        public R__0__Bvl() : base("#Pfb.#Bvl")
        {
        }

        public R__0__Bvl(System.Object instance) : base("#Pfb.#Bvl")
		{
            SetInstance(instance);
		}

        public R__0__Bvl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Bvl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

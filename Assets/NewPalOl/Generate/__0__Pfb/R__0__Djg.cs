...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Djg
	/// </summary>
    public partial class R__0__Djg : RMember //
    {
        ...
        public R__0__Djg() : base("#Pfb.#Djg")
        {
        }

        public R__0__Djg(System.Object instance) : base("#Pfb.#Djg")
		{
            SetInstance(instance);
		}

        public R__0__Djg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Djg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

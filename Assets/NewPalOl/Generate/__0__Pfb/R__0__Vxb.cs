...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Vxb
	/// </summary>
    public partial class R__0__Vxb : RMember //
    {
        ...
        public R__0__Vxb() : base("#Pfb.#Vxb")
        {
        }

        public R__0__Vxb(System.Object instance) : base("#Pfb.#Vxb")
		{
            SetInstance(instance);
		}

        public R__0__Vxb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vxb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

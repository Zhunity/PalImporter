...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#TXv
	/// </summary>
    public partial class R__0__TXv : RMember //
    {
        ...
        public R__0__TXv() : base("#Pfb.#TXv")
        {
        }

        public R__0__TXv(System.Object instance) : base("#Pfb.#TXv")
		{
            SetInstance(instance);
		}

        public R__0__TXv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__TXv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#oLp
	/// </summary>
    public partial class R__0__oLp : RMember //
    {
        ...
        public R__0__oLp() : base("#Pfb.#oLp")
        {
        }

        public R__0__oLp(System.Object instance) : base("#Pfb.#oLp")
		{
            SetInstance(instance);
		}

        public R__0__oLp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oLp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

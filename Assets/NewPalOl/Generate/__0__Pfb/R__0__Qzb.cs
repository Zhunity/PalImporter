...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Qzb
	/// </summary>
    public partial class R__0__Qzb : RMember //
    {
        ...
        public R__0__Qzb() : base("#Pfb.#Qzb")
        {
        }

        public R__0__Qzb(System.Object instance) : base("#Pfb.#Qzb")
		{
            SetInstance(instance);
		}

        public R__0__Qzb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Qzb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

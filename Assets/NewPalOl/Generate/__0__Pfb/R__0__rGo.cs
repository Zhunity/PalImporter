...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#rGo
	/// </summary>
    public partial class R__0__rGo : RMember //
    {
        ...
        public R__0__rGo() : base("#Pfb.#rGo")
        {
        }

        public R__0__rGo(System.Object instance) : base("#Pfb.#rGo")
		{
            SetInstance(instance);
		}

        public R__0__rGo(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__rGo(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

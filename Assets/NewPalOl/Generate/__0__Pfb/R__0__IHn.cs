...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#IHn
	/// </summary>
    public partial class R__0__IHn : RMember //
    {
        ...
        public R__0__IHn() : base("#Pfb.#IHn")
        {
        }

        public R__0__IHn(System.Object instance) : base("#Pfb.#IHn")
		{
            SetInstance(instance);
		}

        public R__0__IHn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__IHn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

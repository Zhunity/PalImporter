...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#pek
	/// </summary>
    public partial class R__0__pek : RMember //
    {
        ...
        public R__0__pek() : base("#Pfb.#pek")
        {
        }

        public R__0__pek(System.Object instance) : base("#Pfb.#pek")
		{
            SetInstance(instance);
		}

        public R__0__pek(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__pek(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

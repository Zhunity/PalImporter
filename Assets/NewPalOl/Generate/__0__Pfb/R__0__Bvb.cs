...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Bvb
	/// </summary>
    public partial class R__0__Bvb : RMember //
    {
        ...
        public R__0__Bvb() : base("#Pfb.#Bvb")
        {
        }

        public R__0__Bvb(System.Object instance) : base("#Pfb.#Bvb")
		{
            SetInstance(instance);
		}

        public R__0__Bvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Bvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

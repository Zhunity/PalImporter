...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Jyb
	/// </summary>
    public partial class R__0__Jyb : RMember //
    {
        ...
        public R__0__Jyb() : base("#Pfb.#Jyb")
        {
        }

        public R__0__Jyb(System.Object instance) : base("#Pfb.#Jyb")
		{
            SetInstance(instance);
		}

        public R__0__Jyb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Jyb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

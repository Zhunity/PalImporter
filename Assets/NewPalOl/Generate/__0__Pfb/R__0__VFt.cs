...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#VFt
	/// </summary>
    public partial class R__0__VFt : RMember //
    {
        ...
        public R__0__VFt() : base("#Pfb.#VFt")
        {
        }

        public R__0__VFt(System.Object instance) : base("#Pfb.#VFt")
		{
            SetInstance(instance);
		}

        public R__0__VFt(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__VFt(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

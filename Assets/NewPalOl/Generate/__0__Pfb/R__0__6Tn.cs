...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#6Tn
	/// </summary>
    public partial class R__0__6Tn : RMember //
    {
        ...
        public R__0__6Tn() : base("#Pfb.#6Tn")
        {
        }

        public R__0__6Tn(System.Object instance) : base("#Pfb.#6Tn")
		{
            SetInstance(instance);
		}

        public R__0__6Tn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6Tn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Nxq
	/// </summary>
    public partial class R__0__Nxq : RMember //
    {
        ...
        public R__0__Nxq() : base("#Pfb.#Nxq")
        {
        }

        public R__0__Nxq(System.Object instance) : base("#Pfb.#Nxq")
		{
            SetInstance(instance);
		}

        public R__0__Nxq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Nxq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

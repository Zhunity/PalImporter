...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Q2e
	/// </summary>
    public partial class R__0__Q2e : RMember //
    {
        ...
        public R__0__Q2e() : base("#Pfb.#Q2e")
        {
        }

        public R__0__Q2e(System.Object instance) : base("#Pfb.#Q2e")
		{
            SetInstance(instance);
		}

        public R__0__Q2e(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Q2e(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

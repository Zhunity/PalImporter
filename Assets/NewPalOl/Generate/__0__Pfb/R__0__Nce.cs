...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Nce
	/// </summary>
    public partial class R__0__Nce : RMember //
    {
        ...
        public R__0__Nce() : base("#Pfb.#Nce")
        {
        }

        public R__0__Nce(System.Object instance) : base("#Pfb.#Nce")
		{
            SetInstance(instance);
		}

        public R__0__Nce(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Nce(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#2Eb
	/// </summary>
    public partial class R__0__2Eb : RMember //
    {
        ...
        public R__0__2Eb() : base("#Pfb.#2Eb")
        {
        }

        public R__0__2Eb(System.Object instance) : base("#Pfb.#2Eb")
		{
            SetInstance(instance);
		}

        public R__0__2Eb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2Eb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

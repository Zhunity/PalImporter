...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Pfi
	/// </summary>
    public partial class R__0__Pfi : RMember //
    {
        ...
        public R__0__Pfi() : base("#Pfb.#Pfi")
        {
        }

        public R__0__Pfi(System.Object instance) : base("#Pfb.#Pfi")
		{
            SetInstance(instance);
		}

        public R__0__Pfi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Pfi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

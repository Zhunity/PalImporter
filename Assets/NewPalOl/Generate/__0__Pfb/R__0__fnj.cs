...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#fnj
	/// </summary>
    public partial class R__0__fnj : RMember //
    {
        ...
        public R__0__fnj() : base("#Pfb.#fnj")
        {
        }

        public R__0__fnj(System.Object instance) : base("#Pfb.#fnj")
		{
            SetInstance(instance);
		}

        public R__0__fnj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fnj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

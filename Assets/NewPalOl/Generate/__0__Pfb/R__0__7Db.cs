...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7Db
	/// </summary>
    public partial class R__0__7Db : RMember //
    {
        ...
        public R__0__7Db() : base("#Pfb.#7Db")
        {
        }

        public R__0__7Db(System.Object instance) : base("#Pfb.#7Db")
		{
            SetInstance(instance);
		}

        public R__0__7Db(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7Db(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

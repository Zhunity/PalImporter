...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Usx
	/// </summary>
    public partial class R__0__Usx : RMember //
    {
        ...
        public R__0__Usx() : base("#Pfb.#Usx")
        {
        }

        public R__0__Usx(System.Object instance) : base("#Pfb.#Usx")
		{
            SetInstance(instance);
		}

        public R__0__Usx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Usx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

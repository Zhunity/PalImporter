...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Mzb
	/// </summary>
    public partial class R__0__Mzb : RMember //
    {
        ...
        public R__0__Mzb() : base("#Pfb.#Mzb")
        {
        }

        public R__0__Mzb(System.Object instance) : base("#Pfb.#Mzb")
		{
            SetInstance(instance);
		}

        public R__0__Mzb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Mzb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

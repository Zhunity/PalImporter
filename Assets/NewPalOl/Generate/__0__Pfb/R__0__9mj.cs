...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9mj
	/// </summary>
    public partial class R__0__9mj : RMember //
    {
        ...
        public R__0__9mj() : base("#Pfb.#9mj")
        {
        }

        public R__0__9mj(System.Object instance) : base("#Pfb.#9mj")
		{
            SetInstance(instance);
		}

        public R__0__9mj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9mj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

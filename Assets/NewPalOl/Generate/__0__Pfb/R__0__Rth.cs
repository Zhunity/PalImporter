...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Rth
	/// </summary>
    public partial class R__0__Rth : RMember //
    {
        ...
        public R__0__Rth() : base("#Pfb.#Rth")
        {
        }

        public R__0__Rth(System.Object instance) : base("#Pfb.#Rth")
		{
            SetInstance(instance);
		}

        public R__0__Rth(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Rth(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#zCb
	/// </summary>
    public partial class R__0__zCb : RMember //
    {
        ...
        public R__0__zCb() : base("#Pfb.#zCb")
        {
        }

        public R__0__zCb(System.Object instance) : base("#Pfb.#zCb")
		{
            SetInstance(instance);
		}

        public R__0__zCb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zCb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

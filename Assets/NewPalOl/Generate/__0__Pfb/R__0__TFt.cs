...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#TFt
	/// </summary>
    public partial class R__0__TFt : RMember //
    {
        ...
        public R__0__TFt() : base("#Pfb.#TFt")
        {
        }

        public R__0__TFt(System.Object instance) : base("#Pfb.#TFt")
		{
            SetInstance(instance);
		}

        public R__0__TFt(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__TFt(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#2Dm
	/// </summary>
    public partial class R__0__2Dm : RMember //
    {
        ...
        public R__0__2Dm() : base("#Pfb.#2Dm")
        {
        }

        public R__0__2Dm(System.Object instance) : base("#Pfb.#2Dm")
		{
            SetInstance(instance);
		}

        public R__0__2Dm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2Dm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

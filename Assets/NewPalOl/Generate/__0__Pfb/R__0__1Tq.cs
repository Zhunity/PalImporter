...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#1Tq
	/// </summary>
    public partial class R__0__1Tq : RMember //
    {
        ...
        public R__0__1Tq() : base("#Pfb.#1Tq")
        {
        }

        public R__0__1Tq(System.Object instance) : base("#Pfb.#1Tq")
		{
            SetInstance(instance);
		}

        public R__0__1Tq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1Tq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

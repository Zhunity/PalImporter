...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4Dm
	/// </summary>
    public partial class R__0__4Dm : RMember //
    {
        ...
        public R__0__4Dm() : base("#Pfb.#4Dm")
        {
        }

        public R__0__4Dm(System.Object instance) : base("#Pfb.#4Dm")
		{
            SetInstance(instance);
		}

        public R__0__4Dm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4Dm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

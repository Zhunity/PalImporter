...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Hvb
	/// </summary>
    public partial class R__0__Hvb : RMember //
    {
        ...
        public R__0__Hvb() : base("#Pfb.#Hvb")
        {
        }

        public R__0__Hvb(System.Object instance) : base("#Pfb.#Hvb")
		{
            SetInstance(instance);
		}

        public R__0__Hvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Hvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

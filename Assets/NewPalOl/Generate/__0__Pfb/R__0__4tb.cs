...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4tb
	/// </summary>
    public partial class R__0__4tb : RMember //
    {
        ...
        public R__0__4tb() : base("#Pfb.#4tb")
        {
        }

        public R__0__4tb(System.Object instance) : base("#Pfb.#4tb")
		{
            SetInstance(instance);
		}

        public R__0__4tb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4tb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

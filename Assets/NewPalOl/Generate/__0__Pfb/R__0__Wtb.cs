...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wtb
	/// </summary>
    public partial class R__0__Wtb : RMember //
    {
        ...
        public R__0__Wtb() : base("#Pfb.#Wtb")
        {
        }

        public R__0__Wtb(System.Object instance) : base("#Pfb.#Wtb")
		{
            SetInstance(instance);
		}

        public R__0__Wtb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wtb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

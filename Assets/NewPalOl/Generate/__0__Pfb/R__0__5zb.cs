...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#5zb
	/// </summary>
    public partial class R__0__5zb : RMember //
    {
        ...
        public R__0__5zb() : base("#Pfb.#5zb")
        {
        }

        public R__0__5zb(System.Object instance) : base("#Pfb.#5zb")
		{
            SetInstance(instance);
		}

        public R__0__5zb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5zb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

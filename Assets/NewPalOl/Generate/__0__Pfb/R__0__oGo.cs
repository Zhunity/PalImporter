...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#oGo
	/// </summary>
    public partial class R__0__oGo : RMember //
    {
        ...
        public R__0__oGo() : base("#Pfb.#oGo")
        {
        }

        public R__0__oGo(System.Object instance) : base("#Pfb.#oGo")
		{
            SetInstance(instance);
		}

        public R__0__oGo(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oGo(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

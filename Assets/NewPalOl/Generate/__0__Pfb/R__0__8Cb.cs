...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8Cb
	/// </summary>
    public partial class R__0__8Cb : RMember //
    {
        ...
        public R__0__8Cb() : base("#Pfb.#8Cb")
        {
        }

        public R__0__8Cb(System.Object instance) : base("#Pfb.#8Cb")
		{
            SetInstance(instance);
		}

        public R__0__8Cb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Cb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Dvb
	/// </summary>
    public partial class R__0__Dvb : RMember //
    {
        ...
        public R__0__Dvb() : base("#Pfb.#Dvb")
        {
        }

        public R__0__Dvb(System.Object instance) : base("#Pfb.#Dvb")
		{
            SetInstance(instance);
		}

        public R__0__Dvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Dvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Tbe
	/// </summary>
    public partial class R__0__Tbe : RMember //
    {
        ...
        public R__0__Tbe() : base("#Pfb.#Tbe")
        {
        }

        public R__0__Tbe(System.Object instance) : base("#Pfb.#Tbe")
		{
            SetInstance(instance);
		}

        public R__0__Tbe(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Tbe(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#bsv
	/// </summary>
    public partial class R__0__bsv : RMember //
    {
        ...
        public R__0__bsv() : base("#Pfb.#bsv")
        {
        }

        public R__0__bsv(System.Object instance) : base("#Pfb.#bsv")
		{
            SetInstance(instance);
		}

        public R__0__bsv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__bsv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

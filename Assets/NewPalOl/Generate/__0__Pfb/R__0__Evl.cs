...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Evl
	/// </summary>
    public partial class R__0__Evl : RMember //
    {
        ...
        public R__0__Evl() : base("#Pfb.#Evl")
        {
        }

        public R__0__Evl(System.Object instance) : base("#Pfb.#Evl")
		{
            SetInstance(instance);
		}

        public R__0__Evl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Evl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

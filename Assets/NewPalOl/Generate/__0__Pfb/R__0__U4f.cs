...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#U4f
	/// </summary>
    public partial class R__0__U4f : RMember //
    {
        ...
        public R__0__U4f() : base("#Pfb.#U4f")
        {
        }

        public R__0__U4f(System.Object instance) : base("#Pfb.#U4f")
		{
            SetInstance(instance);
		}

        public R__0__U4f(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__U4f(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Gpb
	/// </summary>
    public partial class R__0__Gpb : RMember //
    {
        ...
        public R__0__Gpb() : base("#Pfb.#Gpb")
        {
        }

        public R__0__Gpb(System.Object instance) : base("#Pfb.#Gpb")
		{
            SetInstance(instance);
		}

        public R__0__Gpb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Gpb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

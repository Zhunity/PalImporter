...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#XXl
	/// </summary>
    public partial class R__0__XXl : RMember //
    {
        ...
        public R__0__XXl() : base("#Pfb.#XXl")
        {
        }

        public R__0__XXl(System.Object instance) : base("#Pfb.#XXl")
		{
            SetInstance(instance);
		}

        public R__0__XXl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XXl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

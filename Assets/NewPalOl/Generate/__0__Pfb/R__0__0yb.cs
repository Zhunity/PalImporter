...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0yb
	/// </summary>
    public partial class R__0__0yb : RMember //
    {
        ...
        public R__0__0yb() : base("#Pfb.#0yb")
        {
        }

        public R__0__0yb(System.Object instance) : base("#Pfb.#0yb")
		{
            SetInstance(instance);
		}

        public R__0__0yb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0yb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

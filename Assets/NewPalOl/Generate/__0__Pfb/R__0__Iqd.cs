...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Iqd
	/// </summary>
    public partial class R__0__Iqd : RMember //
    {
        ...
        public R__0__Iqd() : base("#Pfb.#Iqd")
        {
        }

        public R__0__Iqd(System.Object instance) : base("#Pfb.#Iqd")
		{
            SetInstance(instance);
		}

        public R__0__Iqd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Iqd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

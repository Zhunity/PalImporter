...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Tyb
	/// </summary>
    public partial class R__0__Tyb : RMember //
    {
        ...
        public R__0__Tyb() : base("#Pfb.#Tyb")
        {
        }

        public R__0__Tyb(System.Object instance) : base("#Pfb.#Tyb")
		{
            SetInstance(instance);
		}

        public R__0__Tyb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Tyb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#VXv
	/// </summary>
    public partial class R__0__VXv : RMember //
    {
        ...
        public R__0__VXv() : base("#Pfb.#VXv")
        {
        }

        public R__0__VXv(System.Object instance) : base("#Pfb.#VXv")
		{
            SetInstance(instance);
		}

        public R__0__VXv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__VXv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

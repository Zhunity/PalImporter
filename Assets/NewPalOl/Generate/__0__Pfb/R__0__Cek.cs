...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Cek
	/// </summary>
    public partial class R__0__Cek : RMember //
    {
        ...
        public R__0__Cek() : base("#Pfb.#Cek")
        {
        }

        public R__0__Cek(System.Object instance) : base("#Pfb.#Cek")
		{
            SetInstance(instance);
		}

        public R__0__Cek(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Cek(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

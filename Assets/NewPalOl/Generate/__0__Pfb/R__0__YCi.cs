...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#YCi
	/// </summary>
    public partial class R__0__YCi : RMember //
    {
        ...
        public R__0__YCi() : base("#Pfb.#YCi")
        {
        }

        public R__0__YCi(System.Object instance) : base("#Pfb.#YCi")
		{
            SetInstance(instance);
		}

        public R__0__YCi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YCi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

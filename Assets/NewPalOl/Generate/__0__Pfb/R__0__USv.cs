...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#USv
	/// </summary>
    public partial class R__0__USv : RMember //
    {
        ...
        public R__0__USv() : base("#Pfb.#USv")
        {
        }

        public R__0__USv(System.Object instance) : base("#Pfb.#USv")
		{
            SetInstance(instance);
		}

        public R__0__USv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__USv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Vde
	/// </summary>
    public partial class R__0__Vde : RMember //
    {
        ...
        public R__0__Vde() : base("#Pfb.#Vde")
        {
        }

        public R__0__Vde(System.Object instance) : base("#Pfb.#Vde")
		{
            SetInstance(instance);
		}

        public R__0__Vde(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vde(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

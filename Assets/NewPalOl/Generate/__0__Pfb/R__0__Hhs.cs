...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Hhs
	/// </summary>
    public partial class R__0__Hhs : RMember //
    {
        ...
        public R__0__Hhs() : base("#Pfb.#Hhs")
        {
        }

        public R__0__Hhs(System.Object instance) : base("#Pfb.#Hhs")
		{
            SetInstance(instance);
		}

        public R__0__Hhs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Hhs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

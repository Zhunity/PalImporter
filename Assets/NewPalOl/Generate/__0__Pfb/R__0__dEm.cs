...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#dEm
	/// </summary>
    public partial class R__0__dEm : RMember //
    {
        ...
        public R__0__dEm() : base("#Pfb.#dEm")
        {
        }

        public R__0__dEm(System.Object instance) : base("#Pfb.#dEm")
		{
            SetInstance(instance);
		}

        public R__0__dEm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dEm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

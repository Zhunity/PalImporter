...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#yud
	/// </summary>
    public partial class R__0__yud : RMember //
    {
        ...
        public R__0__yud() : base("#Pfb.#yud")
        {
        }

        public R__0__yud(System.Object instance) : base("#Pfb.#yud")
		{
            SetInstance(instance);
		}

        public R__0__yud(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__yud(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

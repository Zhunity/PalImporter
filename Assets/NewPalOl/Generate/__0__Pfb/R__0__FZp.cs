...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#FZp
	/// </summary>
    public partial class R__0__FZp : RMember //
    {
        ...
        public R__0__FZp() : base("#Pfb.#FZp")
        {
        }

        public R__0__FZp(System.Object instance) : base("#Pfb.#FZp")
		{
            SetInstance(instance);
		}

        public R__0__FZp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__FZp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

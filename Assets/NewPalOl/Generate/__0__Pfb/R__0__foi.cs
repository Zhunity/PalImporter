...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#foi
	/// </summary>
    public partial class R__0__foi : RMember //
    {
        ...
        public R__0__foi() : base("#Pfb.#foi")
        {
        }

        public R__0__foi(System.Object instance) : base("#Pfb.#foi")
		{
            SetInstance(instance);
		}

        public R__0__foi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__foi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

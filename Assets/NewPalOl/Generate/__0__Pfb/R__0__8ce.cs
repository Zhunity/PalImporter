...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8ce
	/// </summary>
    public partial class R__0__8ce : RMember //
    {
        ...
        public R__0__8ce() : base("#Pfb.#8ce")
        {
        }

        public R__0__8ce(System.Object instance) : base("#Pfb.#8ce")
		{
            SetInstance(instance);
		}

        public R__0__8ce(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8ce(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

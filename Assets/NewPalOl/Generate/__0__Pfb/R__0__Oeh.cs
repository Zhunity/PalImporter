...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Oeh
	/// </summary>
    public partial class R__0__Oeh : RMember //
    {
        ...
        public R__0__Oeh() : base("#Pfb.#Oeh")
        {
        }

        public R__0__Oeh(System.Object instance) : base("#Pfb.#Oeh")
		{
            SetInstance(instance);
		}

        public R__0__Oeh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Oeh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Gvb
	/// </summary>
    public partial class R__0__Gvb : RMember //
    {
        ...
        public R__0__Gvb() : base("#Pfb.#Gvb")
        {
        }

        public R__0__Gvb(System.Object instance) : base("#Pfb.#Gvb")
		{
            SetInstance(instance);
		}

        public R__0__Gvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Gvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

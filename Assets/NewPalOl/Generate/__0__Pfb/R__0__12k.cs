...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#12k
	/// </summary>
    public partial class R__0__12k : RMember //
    {
        ...
        public R__0__12k() : base("#Pfb.#12k")
        {
        }

        public R__0__12k(System.Object instance) : base("#Pfb.#12k")
		{
            SetInstance(instance);
		}

        public R__0__12k(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__12k(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

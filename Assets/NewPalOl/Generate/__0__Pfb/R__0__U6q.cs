...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#U6q
	/// </summary>
    public partial class R__0__U6q : RMember //
    {
        ...
        public R__0__U6q() : base("#Pfb.#U6q")
        {
        }

        public R__0__U6q(System.Object instance) : base("#Pfb.#U6q")
		{
            SetInstance(instance);
		}

        public R__0__U6q(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__U6q(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

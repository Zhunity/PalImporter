...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7wv
	/// </summary>
    public partial class R__0__7wv : RMember //
    {
        ...
        public R__0__7wv() : base("#Pfb.#7wv")
        {
        }

        public R__0__7wv(System.Object instance) : base("#Pfb.#7wv")
		{
            SetInstance(instance);
		}

        public R__0__7wv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7wv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Muf
	/// </summary>
    public partial class R__0__Muf : RMember //
    {
        ...
        public R__0__Muf() : base("#Pfb.#Muf")
        {
        }

        public R__0__Muf(System.Object instance) : base("#Pfb.#Muf")
		{
            SetInstance(instance);
		}

        public R__0__Muf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Muf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

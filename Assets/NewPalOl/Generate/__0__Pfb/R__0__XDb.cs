...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#XDb
	/// </summary>
    public partial class R__0__XDb : RMember //
    {
        ...
        public R__0__XDb() : base("#Pfb.#XDb")
        {
        }

        public R__0__XDb(System.Object instance) : base("#Pfb.#XDb")
		{
            SetInstance(instance);
		}

        public R__0__XDb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XDb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

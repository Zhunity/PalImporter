...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#DTr
	/// </summary>
    public partial class R__0__DTr : RMember //
    {
        ...
        public R__0__DTr() : base("#Pfb.#DTr")
        {
        }

        public R__0__DTr(System.Object instance) : base("#Pfb.#DTr")
		{
            SetInstance(instance);
		}

        public R__0__DTr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__DTr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

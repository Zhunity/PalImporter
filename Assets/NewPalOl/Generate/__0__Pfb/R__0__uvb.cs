...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#uvb
	/// </summary>
    public partial class R__0__uvb : RMember //
    {
        ...
        public R__0__uvb() : base("#Pfb.#uvb")
        {
        }

        public R__0__uvb(System.Object instance) : base("#Pfb.#uvb")
		{
            SetInstance(instance);
		}

        public R__0__uvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__uvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0xk
	/// </summary>
    public partial class R__0__0xk : RMember //
    {
        ...
        public R__0__0xk() : base("#Pfb.#0xk")
        {
        }

        public R__0__0xk(System.Object instance) : base("#Pfb.#0xk")
		{
            SetInstance(instance);
		}

        public R__0__0xk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0xk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

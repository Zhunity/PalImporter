...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Prb
	/// </summary>
    public partial class R__0__Prb : RMember //
    {
        ...
        public R__0__Prb() : base("#Pfb.#Prb")
        {
        }

        public R__0__Prb(System.Object instance) : base("#Pfb.#Prb")
		{
            SetInstance(instance);
		}

        public R__0__Prb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Prb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

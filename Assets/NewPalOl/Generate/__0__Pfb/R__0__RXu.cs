...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#RXu
	/// </summary>
    public partial class R__0__RXu : RMember //
    {
        ...
        public R__0__RXu() : base("#Pfb.#RXu")
        {
        }

        public R__0__RXu(System.Object instance) : base("#Pfb.#RXu")
		{
            SetInstance(instance);
		}

        public R__0__RXu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__RXu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

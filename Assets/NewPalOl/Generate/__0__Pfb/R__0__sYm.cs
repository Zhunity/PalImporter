...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#sYm
	/// </summary>
    public partial class R__0__sYm : RMember //
    {
        ...
        public R__0__sYm() : base("#Pfb.#sYm")
        {
        }

        public R__0__sYm(System.Object instance) : base("#Pfb.#sYm")
		{
            SetInstance(instance);
		}

        public R__0__sYm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__sYm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

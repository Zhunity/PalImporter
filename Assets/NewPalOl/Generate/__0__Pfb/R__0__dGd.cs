...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#dGd
	/// </summary>
    public partial class R__0__dGd : RMember //
    {
        ...
        public R__0__dGd() : base("#Pfb.#dGd")
        {
        }

        public R__0__dGd(System.Object instance) : base("#Pfb.#dGd")
		{
            SetInstance(instance);
		}

        public R__0__dGd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dGd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

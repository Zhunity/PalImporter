...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ice
	/// </summary>
    public partial class R__0__Ice : RMember //
    {
        ...
        public R__0__Ice() : base("#Pfb.#Ice")
        {
        }

        public R__0__Ice(System.Object instance) : base("#Pfb.#Ice")
		{
            SetInstance(instance);
		}

        public R__0__Ice(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ice(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

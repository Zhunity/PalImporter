...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Qpb
	/// </summary>
    public partial class R__0__Qpb : RMember //
    {
        ...
        public R__0__Qpb() : base("#Pfb.#Qpb")
        {
        }

        public R__0__Qpb(System.Object instance) : base("#Pfb.#Qpb")
		{
            SetInstance(instance);
		}

        public R__0__Qpb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Qpb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

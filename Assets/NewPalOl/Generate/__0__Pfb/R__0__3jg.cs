...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#3jg
	/// </summary>
    public partial class R__0__3jg : RMember //
    {
        ...
        public R__0__3jg() : base("#Pfb.#3jg")
        {
        }

        public R__0__3jg(System.Object instance) : base("#Pfb.#3jg")
		{
            SetInstance(instance);
		}

        public R__0__3jg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3jg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

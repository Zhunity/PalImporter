...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Eyb
	/// </summary>
    public partial class R__0__Eyb : RMember //
    {
        ...
        public R__0__Eyb() : base("#Pfb.#Eyb")
        {
        }

        public R__0__Eyb(System.Object instance) : base("#Pfb.#Eyb")
		{
            SetInstance(instance);
		}

        public R__0__Eyb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Eyb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

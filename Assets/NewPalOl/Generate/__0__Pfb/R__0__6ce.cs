...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#6ce
	/// </summary>
    public partial class R__0__6ce : RMember //
    {
        ...
        public R__0__6ce() : base("#Pfb.#6ce")
        {
        }

        public R__0__6ce(System.Object instance) : base("#Pfb.#6ce")
		{
            SetInstance(instance);
		}

        public R__0__6ce(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6ce(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

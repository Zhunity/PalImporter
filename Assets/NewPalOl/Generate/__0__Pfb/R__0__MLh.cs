...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#MLh
	/// </summary>
    public partial class R__0__MLh : RMember //
    {
        ...
        public R__0__MLh() : base("#Pfb.#MLh")
        {
        }

        public R__0__MLh(System.Object instance) : base("#Pfb.#MLh")
		{
            SetInstance(instance);
		}

        public R__0__MLh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__MLh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

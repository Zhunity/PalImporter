...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#sDr
	/// </summary>
    public partial class R__0__sDr : RMember //
    {
        ...
        public R__0__sDr() : base("#Pfb.#sDr")
        {
        }

        public R__0__sDr(System.Object instance) : base("#Pfb.#sDr")
		{
            SetInstance(instance);
		}

        public R__0__sDr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__sDr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#gFb
	/// </summary>
    public partial class R__0__gFb : RMember //
    {
        ...
        public R__0__gFb() : base("#Pfb.#gFb")
        {
        }

        public R__0__gFb(System.Object instance) : base("#Pfb.#gFb")
		{
            SetInstance(instance);
		}

        public R__0__gFb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gFb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#HCb
	/// </summary>
    public partial class R__0__HCb : RMember //
    {
        ...
        public R__0__HCb() : base("#Pfb.#HCb")
        {
        }

        public R__0__HCb(System.Object instance) : base("#Pfb.#HCb")
		{
            SetInstance(instance);
		}

        public R__0__HCb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__HCb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

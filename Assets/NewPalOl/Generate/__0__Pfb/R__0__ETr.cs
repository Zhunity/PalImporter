...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ETr
	/// </summary>
    public partial class R__0__ETr : RMember //
    {
        ...
        public R__0__ETr() : base("#Pfb.#ETr")
        {
        }

        public R__0__ETr(System.Object instance) : base("#Pfb.#ETr")
		{
            SetInstance(instance);
		}

        public R__0__ETr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ETr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

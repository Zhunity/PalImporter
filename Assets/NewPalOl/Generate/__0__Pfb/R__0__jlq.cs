...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#jlq
	/// </summary>
    public partial class R__0__jlq : RMember //
    {
        ...
        public R__0__jlq() : base("#Pfb.#jlq")
        {
        }

        public R__0__jlq(System.Object instance) : base("#Pfb.#jlq")
		{
            SetInstance(instance);
		}

        public R__0__jlq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jlq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

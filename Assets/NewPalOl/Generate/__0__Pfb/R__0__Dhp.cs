...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Dhp
	/// </summary>
    public partial class R__0__Dhp : RMember //
    {
        ...
        public R__0__Dhp() : base("#Pfb.#Dhp")
        {
        }

        public R__0__Dhp(System.Object instance) : base("#Pfb.#Dhp")
		{
            SetInstance(instance);
		}

        public R__0__Dhp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Dhp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

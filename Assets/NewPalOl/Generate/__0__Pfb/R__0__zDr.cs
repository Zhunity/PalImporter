...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#zDr
	/// </summary>
    public partial class R__0__zDr : RMember //
    {
        ...
        public R__0__zDr() : base("#Pfb.#zDr")
        {
        }

        public R__0__zDr(System.Object instance) : base("#Pfb.#zDr")
		{
            SetInstance(instance);
		}

        public R__0__zDr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zDr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

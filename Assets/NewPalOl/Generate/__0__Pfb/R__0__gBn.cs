...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#gBn
	/// </summary>
    public partial class R__0__gBn : RMember //
    {
        ...
        public R__0__gBn() : base("#Pfb.#gBn")
        {
        }

        public R__0__gBn(System.Object instance) : base("#Pfb.#gBn")
		{
            SetInstance(instance);
		}

        public R__0__gBn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gBn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

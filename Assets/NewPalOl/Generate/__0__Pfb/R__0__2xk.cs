...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#2xk
	/// </summary>
    public partial class R__0__2xk : RMember //
    {
        ...
        public R__0__2xk() : base("#Pfb.#2xk")
        {
        }

        public R__0__2xk(System.Object instance) : base("#Pfb.#2xk")
		{
            SetInstance(instance);
		}

        public R__0__2xk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2xk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#eBn
	/// </summary>
    public partial class R__0__eBn : RMember //
    {
        ...
        public R__0__eBn() : base("#Pfb.#eBn")
        {
        }

        public R__0__eBn(System.Object instance) : base("#Pfb.#eBn")
		{
            SetInstance(instance);
		}

        public R__0__eBn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__eBn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

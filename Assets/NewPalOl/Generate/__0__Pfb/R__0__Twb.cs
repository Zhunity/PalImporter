...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Twb
	/// </summary>
    public partial class R__0__Twb : RMember //
    {
        ...
        public R__0__Twb() : base("#Pfb.#Twb")
        {
        }

        public R__0__Twb(System.Object instance) : base("#Pfb.#Twb")
		{
            SetInstance(instance);
		}

        public R__0__Twb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Twb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

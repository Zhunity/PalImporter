...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8qb
	/// </summary>
    public partial class R__0__8qb : RMember //
    {
        ...
        public R__0__8qb() : base("#Pfb.#8qb")
        {
        }

        public R__0__8qb(System.Object instance) : base("#Pfb.#8qb")
		{
            SetInstance(instance);
		}

        public R__0__8qb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8qb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

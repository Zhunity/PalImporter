...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#v6e
	/// </summary>
    public partial class R__0__v6e : RMember //
    {
        ...
        public R__0__v6e() : base("#Pfb.#v6e")
        {
        }

        public R__0__v6e(System.Object instance) : base("#Pfb.#v6e")
		{
            SetInstance(instance);
		}

        public R__0__v6e(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__v6e(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

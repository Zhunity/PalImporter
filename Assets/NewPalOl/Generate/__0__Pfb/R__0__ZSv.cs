...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#ZSv
	/// </summary>
    public partial class R__0__ZSv : RMember //
    {
        ...
        public R__0__ZSv() : base("#Pfb.#ZSv")
        {
        }

        public R__0__ZSv(System.Object instance) : base("#Pfb.#ZSv")
		{
            SetInstance(instance);
		}

        public R__0__ZSv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ZSv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

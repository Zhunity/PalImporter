...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Mql
	/// </summary>
    public partial class R__0__Mql : RMember //
    {
        ...
        public R__0__Mql() : base("#Pfb.#Mql")
        {
        }

        public R__0__Mql(System.Object instance) : base("#Pfb.#Mql")
		{
            SetInstance(instance);
		}

        public R__0__Mql(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Mql(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

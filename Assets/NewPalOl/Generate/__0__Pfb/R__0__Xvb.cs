...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Xvb
	/// </summary>
    public partial class R__0__Xvb : RMember //
    {
        ...
        public R__0__Xvb() : base("#Pfb.#Xvb")
        {
        }

        public R__0__Xvb(System.Object instance) : base("#Pfb.#Xvb")
		{
            SetInstance(instance);
		}

        public R__0__Xvb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Xvb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0qf
	/// </summary>
    public partial class R__0__0qf : RMember //
    {
        ...
        public R__0__0qf() : base("#Pfb.#0qf")
        {
        }

        public R__0__0qf(System.Object instance) : base("#Pfb.#0qf")
		{
            SetInstance(instance);
		}

        public R__0__0qf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0qf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

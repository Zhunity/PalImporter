...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9sb
	/// </summary>
    public partial class R__0__9sb : RMember //
    {
        ...
        public R__0__9sb() : base("#Pfb.#9sb")
        {
        }

        public R__0__9sb(System.Object instance) : base("#Pfb.#9sb")
		{
            SetInstance(instance);
		}

        public R__0__9sb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9sb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

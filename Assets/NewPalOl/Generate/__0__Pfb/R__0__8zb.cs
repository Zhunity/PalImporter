...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8zb
	/// </summary>
    public partial class R__0__8zb : RMember //
    {
        ...
        public R__0__8zb() : base("#Pfb.#8zb")
        {
        }

        public R__0__8zb(System.Object instance) : base("#Pfb.#8zb")
		{
            SetInstance(instance);
		}

        public R__0__8zb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8zb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#mLp
	/// </summary>
    public partial class R__0__mLp : RMember //
    {
        ...
        public R__0__mLp() : base("#Pfb.#mLp")
        {
        }

        public R__0__mLp(System.Object instance) : base("#Pfb.#mLp")
		{
            SetInstance(instance);
		}

        public R__0__mLp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__mLp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

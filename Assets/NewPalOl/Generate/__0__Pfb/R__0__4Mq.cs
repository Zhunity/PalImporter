...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4Mq
	/// </summary>
    public partial class R__0__4Mq : RMember //
    {
        ...
        public R__0__4Mq() : base("#Pfb.#4Mq")
        {
        }

        public R__0__4Mq(System.Object instance) : base("#Pfb.#4Mq")
		{
            SetInstance(instance);
		}

        public R__0__4Mq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4Mq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

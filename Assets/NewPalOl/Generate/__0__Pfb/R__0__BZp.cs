...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#BZp
	/// </summary>
    public partial class R__0__BZp : RMember //
    {
        ...
        public R__0__BZp() : base("#Pfb.#BZp")
        {
        }

        public R__0__BZp(System.Object instance) : base("#Pfb.#BZp")
		{
            SetInstance(instance);
		}

        public R__0__BZp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__BZp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4Ab
	/// </summary>
    public partial class R__0__4Ab : RMember //
    {
        ...
        public R__0__4Ab() : base("#Pfb.#4Ab")
        {
        }

        public R__0__4Ab(System.Object instance) : base("#Pfb.#4Ab")
		{
            SetInstance(instance);
		}

        public R__0__4Ab(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4Ab(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

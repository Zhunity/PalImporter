...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#XSv
	/// </summary>
    public partial class R__0__XSv : RMember //
    {
        ...
        public R__0__XSv() : base("#Pfb.#XSv")
        {
        }

        public R__0__XSv(System.Object instance) : base("#Pfb.#XSv")
		{
            SetInstance(instance);
		}

        public R__0__XSv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XSv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

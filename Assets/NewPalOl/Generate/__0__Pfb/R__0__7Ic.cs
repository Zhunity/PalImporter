...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#7Ic
	/// </summary>
    public partial class R__0__7Ic : RMember //
    {
        ...
        public R__0__7Ic() : base("#Pfb.#7Ic")
        {
        }

        public R__0__7Ic(System.Object instance) : base("#Pfb.#7Ic")
		{
            SetInstance(instance);
		}

        public R__0__7Ic(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7Ic(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

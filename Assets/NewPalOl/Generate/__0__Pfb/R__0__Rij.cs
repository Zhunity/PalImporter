...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Rij
	/// </summary>
    public partial class R__0__Rij : RMember //
    {
        ...
        public R__0__Rij() : base("#Pfb.#Rij")
        {
        }

        public R__0__Rij(System.Object instance) : base("#Pfb.#Rij")
		{
            SetInstance(instance);
		}

        public R__0__Rij(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Rij(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

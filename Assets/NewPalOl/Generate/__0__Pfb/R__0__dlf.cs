...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#dlf
	/// </summary>
    public partial class R__0__dlf : RMember //
    {
        ...
        public R__0__dlf() : base("#Pfb.#dlf")
        {
        }

        public R__0__dlf(System.Object instance) : base("#Pfb.#dlf")
		{
            SetInstance(instance);
		}

        public R__0__dlf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dlf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

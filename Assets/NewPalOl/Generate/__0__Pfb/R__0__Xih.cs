...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Xih
	/// </summary>
    public partial class R__0__Xih : RMember //
    {
        ...
        public R__0__Xih() : base("#Pfb.#Xih")
        {
        }

        public R__0__Xih(System.Object instance) : base("#Pfb.#Xih")
		{
            SetInstance(instance);
		}

        public R__0__Xih(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Xih(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

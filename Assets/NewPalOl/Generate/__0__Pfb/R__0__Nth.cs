...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Nth
	/// </summary>
    public partial class R__0__Nth : RMember //
    {
        ...
        public R__0__Nth() : base("#Pfb.#Nth")
        {
        }

        public R__0__Nth(System.Object instance) : base("#Pfb.#Nth")
		{
            SetInstance(instance);
		}

        public R__0__Nth(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Nth(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

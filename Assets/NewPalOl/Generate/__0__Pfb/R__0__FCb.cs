...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#FCb
	/// </summary>
    public partial class R__0__FCb : RMember //
    {
        ...
        public R__0__FCb() : base("#Pfb.#FCb")
        {
        }

        public R__0__FCb(System.Object instance) : base("#Pfb.#FCb")
		{
            SetInstance(instance);
		}

        public R__0__FCb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__FCb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

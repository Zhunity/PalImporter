...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0tb
	/// </summary>
    public partial class R__0__0tb : RMember //
    {
        ...
        public R__0__0tb() : base("#Pfb.#0tb")
        {
        }

        public R__0__0tb(System.Object instance) : base("#Pfb.#0tb")
		{
            SetInstance(instance);
		}

        public R__0__0tb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0tb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

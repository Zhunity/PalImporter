...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#4zb
	/// </summary>
    public partial class R__0__4zb : RMember //
    {
        ...
        public R__0__4zb() : base("#Pfb.#4zb")
        {
        }

        public R__0__4zb(System.Object instance) : base("#Pfb.#4zb")
		{
            SetInstance(instance);
		}

        public R__0__4zb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4zb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

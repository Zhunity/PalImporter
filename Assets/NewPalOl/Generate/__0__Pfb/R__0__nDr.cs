...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#nDr
	/// </summary>
    public partial class R__0__nDr : RMember //
    {
        ...
        public R__0__nDr() : base("#Pfb.#nDr")
        {
        }

        public R__0__nDr(System.Object instance) : base("#Pfb.#nDr")
		{
            SetInstance(instance);
		}

        public R__0__nDr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__nDr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

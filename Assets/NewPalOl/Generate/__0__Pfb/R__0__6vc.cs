...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#6vc
	/// </summary>
    public partial class R__0__6vc : RMember //
    {
        ...
        public R__0__6vc() : base("#Pfb.#6vc")
        {
        }

        public R__0__6vc(System.Object instance) : base("#Pfb.#6vc")
		{
            SetInstance(instance);
		}

        public R__0__6vc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6vc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

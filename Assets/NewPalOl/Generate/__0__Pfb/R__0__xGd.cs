...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#xGd
	/// </summary>
    public partial class R__0__xGd : RMember //
    {
        ...
        public R__0__xGd() : base("#Pfb.#xGd")
        {
        }

        public R__0__xGd(System.Object instance) : base("#Pfb.#xGd")
		{
            SetInstance(instance);
		}

        public R__0__xGd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__xGd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

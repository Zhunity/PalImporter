...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#oVr
	/// </summary>
    public partial class R__0__oVr : RMember //
    {
        ...
        public R__0__oVr() : base("#Pfb.#oVr")
        {
        }

        public R__0__oVr(System.Object instance) : base("#Pfb.#oVr")
		{
            SetInstance(instance);
		}

        public R__0__oVr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oVr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

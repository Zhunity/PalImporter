...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#M6g
	/// </summary>
    public partial class R__0__M6g : RMember //
    {
        ...
        public R__0__M6g() : base("#Pfb.#M6g")
        {
        }

        public R__0__M6g(System.Object instance) : base("#Pfb.#M6g")
		{
            SetInstance(instance);
		}

        public R__0__M6g(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__M6g(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

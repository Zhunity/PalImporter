...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#0po
	/// </summary>
    public partial class R__0__0po : RMember //
    {
        ...
        public R__0__0po() : base("#Pfb.#0po")
        {
        }

        public R__0__0po(System.Object instance) : base("#Pfb.#0po")
		{
            SetInstance(instance);
		}

        public R__0__0po(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0po(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Bce
	/// </summary>
    public partial class R__0__Bce : RMember //
    {
        ...
        public R__0__Bce() : base("#Pfb.#Bce")
        {
        }

        public R__0__Bce(System.Object instance) : base("#Pfb.#Bce")
		{
            SetInstance(instance);
		}

        public R__0__Bce(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Bce(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

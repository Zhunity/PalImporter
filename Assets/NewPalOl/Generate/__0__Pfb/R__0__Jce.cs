...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Jce
	/// </summary>
    public partial class R__0__Jce : RMember //
    {
        ...
        public R__0__Jce() : base("#Pfb.#Jce")
        {
        }

        public R__0__Jce(System.Object instance) : base("#Pfb.#Jce")
		{
            SetInstance(instance);
		}

        public R__0__Jce(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Jce(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

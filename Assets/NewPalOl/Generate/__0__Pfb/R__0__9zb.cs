...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#9zb
	/// </summary>
    public partial class R__0__9zb : RMember //
    {
        ...
        public R__0__9zb() : base("#Pfb.#9zb")
        {
        }

        public R__0__9zb(System.Object instance) : base("#Pfb.#9zb")
		{
            SetInstance(instance);
		}

        public R__0__9zb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9zb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#IAb
	/// </summary>
    public partial class R__0__IAb : RMember //
    {
        ...
        public R__0__IAb() : base("#Pfb.#IAb")
        {
        }

        public R__0__IAb(System.Object instance) : base("#Pfb.#IAb")
		{
            SetInstance(instance);
		}

        public R__0__IAb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__IAb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

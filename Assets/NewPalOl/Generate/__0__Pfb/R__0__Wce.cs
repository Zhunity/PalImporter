...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wce
	/// </summary>
    public partial class R__0__Wce : RMember //
    {
        ...
        public R__0__Wce() : base("#Pfb.#Wce")
        {
        }

        public R__0__Wce(System.Object instance) : base("#Pfb.#Wce")
		{
            SetInstance(instance);
		}

        public R__0__Wce(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wce(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

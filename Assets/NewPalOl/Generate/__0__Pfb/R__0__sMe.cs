...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#sMe
	/// </summary>
    public partial class R__0__sMe : RMember //
    {
        ...
        public R__0__sMe() : base("#Pfb.#sMe")
        {
        }

        public R__0__sMe(System.Object instance) : base("#Pfb.#sMe")
		{
            SetInstance(instance);
		}

        public R__0__sMe(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__sMe(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

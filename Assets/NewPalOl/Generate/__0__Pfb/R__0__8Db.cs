...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#8Db
	/// </summary>
    public partial class R__0__8Db : RMember //
    {
        ...
        public R__0__8Db() : base("#Pfb.#8Db")
        {
        }

        public R__0__8Db(System.Object instance) : base("#Pfb.#8Db")
		{
            SetInstance(instance);
		}

        public R__0__8Db(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Db(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

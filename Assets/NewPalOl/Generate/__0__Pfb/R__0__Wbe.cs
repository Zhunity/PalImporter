...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Wbe
	/// </summary>
    public partial class R__0__Wbe : RMember //
    {
        ...
        public R__0__Wbe() : base("#Pfb.#Wbe")
        {
        }

        public R__0__Wbe(System.Object instance) : base("#Pfb.#Wbe")
		{
            SetInstance(instance);
		}

        public R__0__Wbe(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wbe(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

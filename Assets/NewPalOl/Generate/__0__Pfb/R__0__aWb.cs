...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#aWb
	/// </summary>
    public partial class R__0__aWb : RMember //
    {
        ...
        public R__0__aWb() : base("#Pfb.#aWb")
        {
        }

        public R__0__aWb(System.Object instance) : base("#Pfb.#aWb")
		{
            SetInstance(instance);
		}

        public R__0__aWb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__aWb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

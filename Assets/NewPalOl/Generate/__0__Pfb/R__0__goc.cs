...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#goc
	/// </summary>
    public partial class R__0__goc : RMember //
    {
        ...
        public R__0__goc() : base("#Pfb.#goc")
        {
        }

        public R__0__goc(System.Object instance) : base("#Pfb.#goc")
		{
            SetInstance(instance);
		}

        public R__0__goc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__goc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Lql
	/// </summary>
    public partial class R__0__Lql : RMember //
    {
        ...
        public R__0__Lql() : base("#Pfb.#Lql")
        {
        }

        public R__0__Lql(System.Object instance) : base("#Pfb.#Lql")
		{
            SetInstance(instance);
		}

        public R__0__Lql(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Lql(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

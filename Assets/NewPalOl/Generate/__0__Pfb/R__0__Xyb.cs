...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Xyb
	/// </summary>
    public partial class R__0__Xyb : RMember //
    {
        ...
        public R__0__Xyb() : base("#Pfb.#Xyb")
        {
        }

        public R__0__Xyb(System.Object instance) : base("#Pfb.#Xyb")
		{
            SetInstance(instance);
		}

        public R__0__Xyb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Xyb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

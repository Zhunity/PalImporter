...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Vce
	/// </summary>
    public partial class R__0__Vce : RMember //
    {
        ...
        public R__0__Vce() : base("#Pfb.#Vce")
        {
        }

        public R__0__Vce(System.Object instance) : base("#Pfb.#Vce")
		{
            SetInstance(instance);
		}

        public R__0__Vce(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vce(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

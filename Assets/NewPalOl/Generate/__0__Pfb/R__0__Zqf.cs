...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Zqf
	/// </summary>
    public partial class R__0__Zqf : RMember //
    {
        ...
        public R__0__Zqf() : base("#Pfb.#Zqf")
        {
        }

        public R__0__Zqf(System.Object instance) : base("#Pfb.#Zqf")
		{
            SetInstance(instance);
		}

        public R__0__Zqf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Zqf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

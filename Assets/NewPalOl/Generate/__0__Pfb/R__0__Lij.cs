...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Lij
	/// </summary>
    public partial class R__0__Lij : RMember //
    {
        ...
        public R__0__Lij() : base("#Pfb.#Lij")
        {
        }

        public R__0__Lij(System.Object instance) : base("#Pfb.#Lij")
		{
            SetInstance(instance);
		}

        public R__0__Lij(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Lij(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

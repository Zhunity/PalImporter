...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#3wb
	/// </summary>
    public partial class R__0__3wb : RMember //
    {
        ...
        public R__0__3wb() : base("#Pfb.#3wb")
        {
        }

        public R__0__3wb(System.Object instance) : base("#Pfb.#3wb")
		{
            SetInstance(instance);
		}

        public R__0__3wb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3wb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

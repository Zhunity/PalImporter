...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#Ypb
	/// </summary>
    public partial class R__0__Ypb : RMember //
    {
        ...
        public R__0__Ypb() : base("#Pfb.#Ypb")
        {
        }

        public R__0__Ypb(System.Object instance) : base("#Pfb.#Ypb")
		{
            SetInstance(instance);
		}

        public R__0__Ypb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ypb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

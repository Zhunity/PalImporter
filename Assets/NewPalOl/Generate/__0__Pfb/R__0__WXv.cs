...
namespace SMFrame.Editor.Refleaction.R__0__Pfb
{
	...
	/// #Pfb.#WXv
	/// </summary>
    public partial class R__0__WXv : RMember //
    {
        ...
        public R__0__WXv() : base("#Pfb.#WXv")
        {
        }

        public R__0__WXv(System.Object instance) : base("#Pfb.#WXv")
		{
            SetInstance(instance);
		}

        public R__0__WXv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__WXv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

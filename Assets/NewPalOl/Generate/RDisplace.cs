...
namespace SMFrame.Editor.Refleaction
{
	...
	/// Displace
	/// </summary>
    public partial class RDisplace : RMember //
    {
        ...
        public RDisplace() : base("Displace")
        {
        }

        public RDisplace(System.Object instance) : base("Displace")
		{
            SetInstance(instance);
		}

        public RDisplace(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RDisplace(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

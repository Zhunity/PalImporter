...
{public partial class RAudio
{
	
	/// <summary>
	/// Audio+<RefreshProperties>c__Iterator0
	/// </summary>
    public partial class R__2__RefreshProperties__4__c__Iterator0 : RMember //
    {
		...
		/// Audio <>f__this
		/// </summary>
		protected RAudio r___2____4__f__this;
		public virtual RAudio R__2____4__f__this
		{
			get
			{
        ...
        public R__2__RefreshProperties__4__c__Iterator0() : base("Audio+<RefreshProperties>c__Iterator0")
        {
        }

        public R__2__RefreshProperties__4__c__Iterator0(System.Object instance) : base("Audio+<RefreshProperties>c__Iterator0")
		{
            SetInstance(instance);
		}

        public R__2__RefreshProperties__4__c__Iterator0(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__RefreshProperties__4__c__Iterator0(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

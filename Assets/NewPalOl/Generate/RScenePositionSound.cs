...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ScenePositionSound
	/// </summary>
    public partial class RScenePositionSound : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RAudioSource r_mAS;
		public virtual RUnityEngine.RAudioSource RmAS
		{
			get
			{
				if(r_mAS == null)
        ...
        public RScenePositionSound() : base("ScenePositionSound")
        {
        }

        public RScenePositionSound(System.Object instance) : base("ScenePositionSound")
		{
            SetInstance(instance);
		}

        public RScenePositionSound(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RScenePositionSound(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MonoBehaviourScript
	/// </summary>
    public partial class RMonoBehaviourScript : RMember //
    {

		/// <summary>
		/// MonoBehaviourFunction m_handleStart
		/// </summary>
		protected RMonoBehaviourFunction r_m_handleStart;
		public virtual RMonoBehaviourFunction Rm_handleStart
		{
			get
			{
				if(r_m_handleStart == null)
				{
					r_m_handleStart = new(this, "m_handleStart");
					r_m_handleStart.SetBelong(this.instance);
				}
				return r_m_handleStart;
			}
		}

		/// <summary>
		/// MonoBehaviourFunction m_handleOnGUI
		/// </summary>
		protected RMonoBehaviourFunction r_m_handleOnGUI;
		public virtual RMonoBehaviourFunction Rm_handleOnGUI
		{
			get
			{
				if(r_m_handleOnGUI == null)
				{
					r_m_handleOnGUI = new(this, "m_handleOnGUI");
					r_m_handleOnGUI.SetBelong(this.instance);
				}
				return r_m_handleOnGUI;
			}
		}

		/// <summary>
		/// MonoBehaviourFunction m_handleUpdate
		/// </summary>
		protected RMonoBehaviourFunction r_m_handleUpdate;
		public virtual RMonoBehaviourFunction Rm_handleUpdate
		{
			get
			{
				if(r_m_handleUpdate == null)
				{
					r_m_handleUpdate = new(this, "m_handleUpdate");
					r_m_handleUpdate.SetBelong(this.instance);
				}
				return r_m_handleUpdate;
			}
		}

		/// <summary>
		/// MonoBehaviourFunction m_handleLateUpdate
		/// </summary>
		protected RMonoBehaviourFunction r_m_handleLateUpdate;
		public virtual RMonoBehaviourFunction Rm_handleLateUpdate
		{
			get
			{
				if(r_m_handleLateUpdate == null)
				{
					r_m_handleLateUpdate = new(this, "m_handleLateUpdate");
					r_m_handleLateUpdate.SetBelong(this.instance);
				}
				return r_m_handleLateUpdate;
			}
		}
        ...
        public RMonoBehaviourScript() : base("MonoBehaviourScript")
        {
        }

        public RMonoBehaviourScript(System.Object instance) : base("MonoBehaviourScript")
		{
            SetInstance(instance);
		}

        public RMonoBehaviourScript(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMonoBehaviourScript(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

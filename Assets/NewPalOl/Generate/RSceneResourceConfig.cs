...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SceneResourceConfig
	/// </summary>
    public partial class RSceneResourceConfig : RMember //
    {

		/// <summary>
		/// UnityEngine.Transform m_Trans
		/// </summary>
		protected RUnityEngine.RTransform r_m_Trans;
		public virtual RUnityEngine.RTransform Rm_Trans
		{
			get
			{
				if(r_m_Trans == null)
				{
					r_m_Trans = new(this, "m_Trans");
					r_m_Trans.SetBelong(this.instance);
				}
				return r_m_Trans;
			}
		}
		...
		/// <summary>
		/// System.String m_MeshPath
		/// </summary>
		protected RField r_m_MeshPath;
		public virtual RField Rm_MeshPath
		{
			get
			{
				if(r_m_MeshPath == null)
				{
					r_m_MeshPath = new(this, "m_MeshPath");
					r_m_MeshPath.SetBelong(this.instance);
				}
				return r_m_MeshPath;
			}
		}
		...
		/// <summary>
		/// System.String[] m_TexPath
		/// </summary>
		protected RFieldArray<RField> r_m_TexPath;
		public virtual RFieldArray<RField> Rm_TexPath
		{
			get
			{
				if(r_m_TexPath == null)
				{
					r_m_TexPath = new(this, "m_TexPath");
					r_m_TexPath.SetBelong(this.instance);
				}
				return r_m_TexPath;
			}
		}
		...
		/// <summary>
		/// System.String m_TreePath
		/// </summary>
		protected RField r_m_TreePath;
		public virtual RField Rm_TreePath
		{
			get
			{
				if(r_m_TreePath == null)
				{
					r_m_TreePath = new(this, "m_TreePath");
					r_m_TreePath.SetBelong(this.instance);
				}
				return r_m_TreePath;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RMesh r__mesh;
		public virtual RUnityEngine.RMesh R_mesh
		{
			get
			{
				if(r__mesh == null)
				{
					r__mesh = new(this, "_mesh");
					r__mesh.SetBelong(this.instance);
				}
				return r__mesh;
			}
		}
		...
		/// </summary>
		protected RField r__isLoading;
		public virtual RField R_isLoading
		{
			get
			{
				if(r__isLoading == null)
				{
					r__isLoading = new(this, "_isLoading");
					r__isLoading.SetBelong(this.instance);
				}
				return r__isLoading;
			}
		}
		...
		/// <summary>
		/// System.Collections.Generic.List`1[System.String] urls
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RField> r_urls;
		public virtual RSystem.RCollections.RGeneric.RList<RField> Rurls
		{
			get
			{
				if(r_urls == null)
		...
		/// <summary>
		/// System.Boolean _isLoaded
		/// </summary>
		protected RField r__isLoaded;
		public virtual RField R_isLoaded
		{
			get
			{
				if(r__isLoaded == null)
				{
					r__isLoaded = new(this, "_isLoaded");
					r__isLoaded.SetBelong(this.instance);
				}
				return r__isLoaded;
			}
		}
		...
		/// <summary>
		/// System.String meshAssetName
		/// </summary>
		protected RProperty r_meshAssetName;
		public virtual RProperty RmeshAssetName
		{
			get
			{
				if(r_meshAssetName == null)
				{
					r_meshAssetName = new(this, "meshAssetName", -1);
					r_meshAssetName.SetBelong(this.instance);
				}
				return r_meshAssetName;
			}
		}
		...
		/// </summary>
		protected RProperty r_meshName;
		public virtual RProperty RmeshName
		{
			get
			{
				if(r_meshName == null)
				{
					r_meshName = new(this, "meshName", -1);
					r_meshName.SetBelong(this.instance);
				}
				return r_meshName;
			}
		}
		...
		/// <summary>
		/// Void AddUrl(System.String)
		/// </summary>
		protected RMethod r_RAddUrl_String;
		public virtual RMethod RAddUrl_String
		{
			get
			{
				if(r_RAddUrl_String == null)
				{
					r_RAddUrl_String = new(this, "AddUrl", 0, typeof(System.String));
					r_RAddUrl_String.SetBelong(this.instance);
				}
				return r_RAddUrl_String;
			}
		}

		/// <summary>
		/// Void OnResDownload(System.String)
		/// </summary>
		protected RMethod r_ROnResDownload_String;
		public virtual RMethod ROnResDownload_String
		{
			get
			{
				if(r_ROnResDownload_String == null)
				{
					r_ROnResDownload_String = new(this, "OnResDownload", 0, typeof(System.String));
					r_ROnResDownload_String.SetBelong(this.instance);
				}
				return r_ROnResDownload_String;
			}
		}

		/// <summary>
		/// Int32 CompareTo(SceneResourceConfig)
		/// </summary>
		protected RMethod r_RCompareTo_SceneResourceConfig;
		public virtual RMethod RCompareTo_SceneResourceConfig
		{
			get
			{
				if(r_RCompareTo_SceneResourceConfig == null)
				{
					r_RCompareTo_SceneResourceConfig = new(this, "CompareTo", 0, typeof(SceneResourceConfig));
					r_RCompareTo_SceneResourceConfig.SetBelong(this.instance);
				}
				return r_RCompareTo_SceneResourceConfig;
			}
		}
		...
		/// Boolean isVisible()
		/// </summary>
		protected RMethod r_RisVisible;
		public virtual RMethod RisVisible
		{
			get
			{
				if(r_RisVisible == null)
				{
					r_RisVisible = new(this, "isVisible", 0);
					r_RisVisible.SetBelong(this.instance);
				}
				return r_RisVisible;
			}
		}
		...
		/// <summary>
		/// Boolean isVisible(Single ByRef)
		/// </summary>
		protected RMethod r_RisVisible_Out_Single;
		public virtual RMethod RisVisible_Out_Single
		{
			get
			{
				if(r_RisVisible_Out_Single == null)
				{
					r_RisVisible_Out_Single = new(this, "isVisible", 0, typeof(System.Single).MakeByRefType());
					r_RisVisible_Out_Single.SetBelong(this.instance);
				}
				return r_RisVisible_Out_Single;
			}
		}

		/// <summary>
		/// Void StartSecondPassLoading(GameDefineType.ID)
		/// </summary>
		protected RMethod r_RStartSecondPassLoading_ID;
		public virtual RMethod RStartSecondPassLoading_ID
		{
			get
			{
				if(r_RStartSecondPassLoading_ID == null)
				{
					r_RStartSecondPassLoading_ID = new(this, "StartSecondPassLoading", 0, typeof(GameDefineType.ID));
					r_RStartSecondPassLoading_ID.SetBelong(this.instance);
				}
				return r_RStartSecondPassLoading_ID;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator WaitForDownLoad(GameDefineType.ID)
		/// </summary>
		protected RMethod r_RWaitForDownLoad_ID;
		public virtual RMethod RWaitForDownLoad_ID
		{
			get
			{
				if(r_RWaitForDownLoad_ID == null)
				{
					r_RWaitForDownLoad_ID = new(this, "WaitForDownLoad", 0, typeof(GameDefineType.ID));
					r_RWaitForDownLoad_ID.SetBelong(this.instance);
				}
				return r_RWaitForDownLoad_ID;
			}
		}

		/// <summary>
		/// Void DownLoadMeshTex(GameDefineType.ID, ABLoadingHandler, ABLoadedHandler)
		/// </summary>
		protected RMethod r_RDownLoadMeshTex_ID_ABLoadingHandler_ABLoadedHandler;
		public virtual RMethod RDownLoadMeshTex_ID_ABLoadingHandler_ABLoadedHandler
		{
			get
			{
				if(r_RDownLoadMeshTex_ID_ABLoadingHandler_ABLoadedHandler == null)
				{
					r_RDownLoadMeshTex_ID_ABLoadingHandler_ABLoadedHandler = new(this, "DownLoadMeshTex", 0, typeof(GameDefineType.ID),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadingHandler"),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadedHandler"));
					r_RDownLoadMeshTex_ID_ABLoadingHandler_ABLoadedHandler.SetBelong(this.instance);
				}
				return r_RDownLoadMeshTex_ID_ABLoadingHandler_ABLoadedHandler;
			}
		}

		/// <summary>
		/// Void DownLoadMesh(GameDefineType.ID, ABLoadingHandler, ABLoadedHandler)
		/// </summary>
		protected RMethod r_RDownLoadMesh_ID_ABLoadingHandler_ABLoadedHandler;
		public virtual RMethod RDownLoadMesh_ID_ABLoadingHandler_ABLoadedHandler
		{
			get
			{
				if(r_RDownLoadMesh_ID_ABLoadingHandler_ABLoadedHandler == null)
				{
					r_RDownLoadMesh_ID_ABLoadingHandler_ABLoadedHandler = new(this, "DownLoadMesh", 0, typeof(GameDefineType.ID),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadingHandler"),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadedHandler"));
					r_RDownLoadMesh_ID_ABLoadingHandler_ABLoadedHandler.SetBelong(this.instance);
				}
				return r_RDownLoadMesh_ID_ABLoadingHandler_ABLoadedHandler;
			}
		}

		/// <summary>
		/// Void DownLoadTex(GameDefineType.ID, ABLoadingHandler, ABLoadedHandler)
		/// </summary>
		protected RMethod r_RDownLoadTex_ID_ABLoadingHandler_ABLoadedHandler;
		public virtual RMethod RDownLoadTex_ID_ABLoadingHandler_ABLoadedHandler
		{
			get
			{
				if(r_RDownLoadTex_ID_ABLoadingHandler_ABLoadedHandler == null)
				{
					r_RDownLoadTex_ID_ABLoadingHandler_ABLoadedHandler = new(this, "DownLoadTex", 0, typeof(GameDefineType.ID),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadingHandler"),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadedHandler"));
					r_RDownLoadTex_ID_ABLoadingHandler_ABLoadedHandler.SetBelong(this.instance);
				}
				return r_RDownLoadTex_ID_ABLoadingHandler_ABLoadedHandler;
			}
		}

		/// <summary>
		/// Void DownLoadTree(GameDefineType.ID, ABLoadingHandler, ABLoadedHandler)
		/// </summary>
		protected RMethod r_RDownLoadTree_ID_ABLoadingHandler_ABLoadedHandler;
		public virtual RMethod RDownLoadTree_ID_ABLoadingHandler_ABLoadedHandler
		{
			get
			{
				if(r_RDownLoadTree_ID_ABLoadingHandler_ABLoadedHandler == null)
				{
					r_RDownLoadTree_ID_ABLoadingHandler_ABLoadedHandler = new(this, "DownLoadTree", 0, typeof(GameDefineType.ID),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadingHandler"),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadedHandler"));
					r_RDownLoadTree_ID_ABLoadingHandler_ABLoadedHandler.SetBelong(this.instance);
				}
				return r_RDownLoadTree_ID_ABLoadingHandler_ABLoadedHandler;
			}
		}

		/// <summary>
		/// Void OnLoadMesh(System.Object, ABLoadedArgs)
		/// </summary>
		protected RMethod r_ROnLoadMesh_Object_ABLoadedArgs;
		public virtual RMethod ROnLoadMesh_Object_ABLoadedArgs
		{
			get
			{
				if(r_ROnLoadMesh_Object_ABLoadedArgs == null)
				{
					r_ROnLoadMesh_Object_ABLoadedArgs = new(this, "OnLoadMesh", 0, typeof(System.Object),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadedArgs"));
					r_ROnLoadMesh_Object_ABLoadedArgs.SetBelong(this.instance);
				}
				return r_ROnLoadMesh_Object_ABLoadedArgs;
			}
		}
		...
		/// <summary>
		/// Void OnLoadTree(System.Object, ABLoadedArgs)
		/// </summary>
		protected RMethod r_ROnLoadTree_Object_ABLoadedArgs;
		public virtual RMethod ROnLoadTree_Object_ABLoadedArgs
		{
			get
			{
				if(r_ROnLoadTree_Object_ABLoadedArgs == null)
				{
					r_ROnLoadTree_Object_ABLoadedArgs = new(this, "OnLoadTree", 0, typeof(System.Object),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadedArgs"));
					r_ROnLoadTree_Object_ABLoadedArgs.SetBelong(this.instance);
				}
				return r_ROnLoadTree_Object_ABLoadedArgs;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator ResetMeshRender(UnityEngine.MeshRenderer)
		/// </summary>
		protected RMethod r_RResetMeshRender_MeshRenderer;
		public virtual RMethod RResetMeshRender_MeshRenderer
		{
			get
			{
				if(r_RResetMeshRender_MeshRenderer == null)
				{
					r_RResetMeshRender_MeshRenderer = new(this, "ResetMeshRender", 0, typeof(UnityEngine.MeshRenderer));
					r_RResetMeshRender_MeshRenderer.SetBelong(this.instance);
				}
				return r_RResetMeshRender_MeshRenderer;
			}
		}
        ...
        public RSceneResourceConfig() : base("SceneResourceConfig")
        {
        }

        public RSceneResourceConfig(System.Object instance) : base("SceneResourceConfig")
		{
            SetInstance(instance);
		}

        public RSceneResourceConfig(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSceneResourceConfig(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void AddUrl(System.String  @url)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@url};
            var ___result = RAddUrl_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void OnResDownload(System.String  @url)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@url};
            var ___result = ROnResDownload_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Int32 CompareTo(SceneResourceConfig  @other)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@other};
            var ___result = RCompareTo_SceneResourceConfig.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Boolean isVisible()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RisVisible.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual System.Boolean isVisible(out System.Single  @sqrDistan)
        {
			sqrDistan = default;

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sqrDistan};
            var ___result = RisVisible_Out_Single.Invoke(___genericsType, ___parameters);
			sqrDistan = (System.Single)___parameters[0];

            return (System.Boolean)___result;
        }


        public virtual void StartSecondPassLoading(GameDefineType.ID  @sceneID)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sceneID};
            var ___result = RStartSecondPassLoading_ID.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator WaitForDownLoad(GameDefineType.ID  @sceneID)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sceneID};
            var ___result = RWaitForDownLoad_ID.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Collections.IEnumerator ResetMeshRender(UnityEngine.MeshRenderer  @mr)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@mr};
            var ___result = RResetMeshRender_MeshRenderer.Invoke(___genericsType, ___parameters);

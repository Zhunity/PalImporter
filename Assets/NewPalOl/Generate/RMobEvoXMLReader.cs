...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MobEvoXMLReader
	/// </summary>
    public partial class RMobEvoXMLReader : RMember //
    {
        ...
        public RMobEvoXMLReader() : base("MobEvoXMLReader")
        {
        }

        public RMobEvoXMLReader(System.Object instance) : base("MobEvoXMLReader")
		{
            SetInstance(instance);
		}

        public RMobEvoXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMobEvoXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

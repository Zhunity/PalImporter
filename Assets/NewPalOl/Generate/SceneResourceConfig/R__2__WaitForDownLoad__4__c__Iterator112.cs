...
{public partial class RSceneResourceConfig
{
	
	/// <summary>
	/// SceneResourceConfig+<WaitForDownLoad>c__Iterator112
	/// </summary>
    public partial class R__2__WaitForDownLoad__4__c__Iterator112 : RMember //
    {

		/// <summary>
		/// System.Single <sqrDistan>__0
		/// </summary>
		protected RField r___2__sqrDistan__4____0;
		public virtual RField R__2__sqrDistan__4____0
		{
			get
			{
				if(r___2__sqrDistan__4____0 == null)
				{
					r___2__sqrDistan__4____0 = new(this, "<sqrDistan>__0");
					r___2__sqrDistan__4____0.SetBelong(this.instance);
				}
				return r___2__sqrDistan__4____0;
			}
		}
		...
		/// </summary>
		protected RGameDefineType.RID r_sceneID;
		public virtual RGameDefineType.RID RsceneID
		{
			get
			{
				if(r_sceneID == null)
		...
		/// GameDefineType.ID <$>sceneID
		/// </summary>
		protected RGameDefineType.RID r___2____9____4__sceneID;
		public virtual RGameDefineType.RID R__2____9____4__sceneID
		{
			get
			{
				if(r___2____9____4__sceneID == null)
				{
					r___2____9____4__sceneID = new(this, "<$>sceneID");
					r___2____9____4__sceneID.SetBelong(this.instance);
				}
				return r___2____9____4__sceneID;
			}
		}

		/// <summary>
		/// SceneResourceConfig <>f__this
		/// </summary>
		protected RSceneResourceConfig r___2____4__f__this;
		public virtual RSceneResourceConfig R__2____4__f__this
		{
			get
			{
        ...
        public R__2__WaitForDownLoad__4__c__Iterator112() : base("SceneResourceConfig+<WaitForDownLoad>c__Iterator112")
        {
        }

        public R__2__WaitForDownLoad__4__c__Iterator112(System.Object instance) : base("SceneResourceConfig+<WaitForDownLoad>c__Iterator112")
		{
            SetInstance(instance);
		}

        public R__2__WaitForDownLoad__4__c__Iterator112(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__WaitForDownLoad__4__c__Iterator112(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

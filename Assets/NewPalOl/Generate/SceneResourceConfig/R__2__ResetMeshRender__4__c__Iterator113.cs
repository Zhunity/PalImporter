...
{public partial class RSceneResourceConfig
{
	...
	/// <summary>
	/// SceneResourceConfig+<ResetMeshRender>c__Iterator113
	/// </summary>
    public partial class R__2__ResetMeshRender__4__c__Iterator113 : RMember //
    {

		/// <summary>
		/// UnityEngine.MeshRenderer mr
		/// </summary>
		protected RUnityEngine.RMeshRenderer r_mr;
		public virtual RUnityEngine.RMeshRenderer Rmr
		{
			get
			{
				if(r_mr == null)
		...
		/// UnityEngine.MeshRenderer <$>mr
		/// </summary>
		protected RUnityEngine.RMeshRenderer r___2____9____4__mr;
		public virtual RUnityEngine.RMeshRenderer R__2____9____4__mr
		{
			get
			{
				if(r___2____9____4__mr == null)
				{
					r___2____9____4__mr = new(this, "<$>mr");
					r___2____9____4__mr.SetBelong(this.instance);
				}
				return r___2____9____4__mr;
			}
		}
        ...
        public R__2__ResetMeshRender__4__c__Iterator113() : base("SceneResourceConfig+<ResetMeshRender>c__Iterator113")
        {
        }

        public R__2__ResetMeshRender__4__c__Iterator113(System.Object instance) : base("SceneResourceConfig+<ResetMeshRender>c__Iterator113")
		{
            SetInstance(instance);
		}

        public R__2__ResetMeshRender__4__c__Iterator113(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ResetMeshRender__4__c__Iterator113(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

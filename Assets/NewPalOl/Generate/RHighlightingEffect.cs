...
namespace SMFrame.Editor.Refleaction
{
	...
	/// HighlightingEffect
	/// </summary>
    public partial class RHighlightingEffect : RMember //
    {

		/// <summary>
		/// System.Int32 stencilZBufferDepth
		/// </summary>
		protected RField r_stencilZBufferDepth;
		public virtual RField RstencilZBufferDepth
		{
			get
			{
				if(r_stencilZBufferDepth == null)
				{
					r_stencilZBufferDepth = new(this, "stencilZBufferDepth");
					r_stencilZBufferDepth.SetBelong(this.instance);
				}
				return r_stencilZBufferDepth;
			}
		}

		/// <summary>
		/// System.Int32 _downsampleFactor
		/// </summary>
		protected RField r__downsampleFactor;
		public virtual RField R_downsampleFactor
		{
			get
			{
				if(r__downsampleFactor == null)
				{
					r__downsampleFactor = new(this, "_downsampleFactor");
					r__downsampleFactor.SetBelong(this.instance);
				}
				return r__downsampleFactor;
			}
		}
		...
		/// </summary>
		protected RField r_iterations;
		public virtual RField Riterations
		{
			get
			{
				if(r_iterations == null)
				{
					r_iterations = new(this, "iterations");
					r_iterations.SetBelong(this.instance);
				}
				return r_iterations;
			}
		}
		...
		/// <summary>
		/// System.Single blurMinSpread
		/// </summary>
		protected RField r_blurMinSpread;
		public virtual RField RblurMinSpread
		{
			get
			{
				if(r_blurMinSpread == null)
				{
					r_blurMinSpread = new(this, "blurMinSpread");
					r_blurMinSpread.SetBelong(this.instance);
				}
				return r_blurMinSpread;
			}
		}
		...
		/// <summary>
		/// System.Single _blurIntensity
		/// </summary>
		protected RField r__blurIntensity;
		public virtual RField R_blurIntensity
		{
			get
			{
				if(r__blurIntensity == null)
				{
					r__blurIntensity = new(this, "_blurIntensity");
					r__blurIntensity.SetBelong(this.instance);
				}
				return r__blurIntensity;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RGameObject r_go;
		public virtual RUnityEngine.RGameObject Rgo
		{
			get
			{
				if(r_go == null)
		...
		/// <summary>
		/// UnityEngine.GameObject shaderCameraGO
		/// </summary>
		protected RUnityEngine.RGameObject r_shaderCameraGO;
		public virtual RUnityEngine.RGameObject RshaderCameraGO
		{
			get
			{
				if(r_shaderCameraGO == null)
				{
					r_shaderCameraGO = new(this, "shaderCameraGO");
					r_shaderCameraGO.SetBelong(this.instance);
				}
				return r_shaderCameraGO;
			}
		}
		...
		/// <summary>
		/// UnityEngine.RenderTexture stencilBuffer
		/// </summary>
		protected RUnityEngine.RRenderTexture r_stencilBuffer;
		public virtual RUnityEngine.RRenderTexture RstencilBuffer
		{
			get
			{
				if(r_stencilBuffer == null)
				{
					r_stencilBuffer = new(this, "stencilBuffer");
					r_stencilBuffer.SetBelong(this.instance);
				}
				return r_stencilBuffer;
			}
		}

		/// <summary>
		/// UnityEngine.Camera refCam
		/// </summary>
		protected RUnityEngine.RCamera r_refCam;
		public virtual RUnityEngine.RCamera RrefCam
		{
			get
			{
				if(r_refCam == null)
				{
					r_refCam = new(this, "refCam");
					r_refCam.SetBelong(this.instance);
				}
				return r_refCam;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Shader _blurShader
		/// </summary>
		protected static RUnityEngine.RShader r__blurShader;
		public static RUnityEngine.RShader R_blurShader
		{
			get
			{
				if(r__blurShader == null)
				{
					r__blurShader = new(typeof(HighlightingEffect), "_blurShader");
					r__blurShader.SetBelong(null);
				}
				return r__blurShader;
			}
		}

		/// <summary>
		/// UnityEngine.Shader _compShader
		/// </summary>
		protected static RUnityEngine.RShader r__compShader;
		public static RUnityEngine.RShader R_compShader
		{
			get
			{
				if(r__compShader == null)
				{
					r__compShader = new(typeof(HighlightingEffect), "_compShader");
					r__compShader.SetBelong(null);
				}
				return r__compShader;
			}
		}
		...
		/// </summary>
		protected static RUnityEngine.RMaterial r__blurMaterial;
		public static RUnityEngine.RMaterial R_blurMaterial
		{
			get
			{
				if(r__blurMaterial == null)
				{
					r__blurMaterial = new(typeof(HighlightingEffect), "_blurMaterial");
					r__blurMaterial.SetBelong(null);
				}
		...
		/// </summary>
		protected static RUnityEngine.RMaterial r__compMaterial;
		public static RUnityEngine.RMaterial R_compMaterial
		{
			get
			{
				if(r__compMaterial == null)
				{
					r__compMaterial = new(typeof(HighlightingEffect), "_compMaterial");
					r__compMaterial.SetBelong(null);
				}
		...
		/// <summary>
		/// HighlightingEventHandler highlightingEvent
		/// </summary>
		protected static RHighlightingEventHandler r_highlightingEvent;
		public static RHighlightingEventHandler RhighlightingEvent
		{
			get
			{
				if(r_highlightingEvent == null)
				{
					r_highlightingEvent = new(typeof(HighlightingEffect), "highlightingEvent");
					r_highlightingEvent.SetBelong(null);
				}
				return r_highlightingEvent;
			}
		}
		...
		/// </summary>
		protected static RUnityEngine.RShader r_blurShader;
		public static RUnityEngine.RShader RblurShader
		{
			get
			{
				if(r_blurShader == null)
				{
					r_blurShader = new(typeof(HighlightingEffect), "blurShader", -1);
					r_blurShader.SetBelong(null);
				}
				return r_blurShader;
			}
		}
		...
		/// </summary>
		protected static RUnityEngine.RShader r_compShader;
		public static RUnityEngine.RShader RcompShader
		{
			get
			{
				if(r_compShader == null)
				{
					r_compShader = new(typeof(HighlightingEffect), "compShader", -1);
					r_compShader.SetBelong(null);
				}
				return r_compShader;
			}
		}
		...
		public static RUnityEngine.RMaterial RblurMaterial
		{
			get
			{
				...
				{
					r_blurMaterial = new(typeof(HighlightingEffect), "blurMaterial", -1);
		...
		/// </summary>
		protected static RUnityEngine.RMaterial r_compMaterial;
		public static RUnityEngine.RMaterial RcompMaterial
		{
			get
			{
				if(r_compMaterial == null)
				{
					r_compMaterial = new(typeof(HighlightingEffect), "compMaterial", -1);
					r_compMaterial.SetBelong(null);
				}
				return r_compMaterial;
			}
		}
		...
		/// Void OnPreRender()
		/// </summary>
		protected RMethod r_ROnPreRender;
		public virtual RMethod ROnPreRender
		{
			get
			{
				if(r_ROnPreRender == null)
				{
					r_ROnPreRender = new(this, "OnPreRender", 0);
					r_ROnPreRender.SetBelong(this.instance);
				}
				return r_ROnPreRender;
			}
		}
        ...
        public RHighlightingEffect() : base("HighlightingEffect")
        {
        }

        public RHighlightingEffect(System.Object instance) : base("HighlightingEffect")
		{
            SetInstance(instance);
		}

        public RHighlightingEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RHighlightingEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void OnPreRender()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = ROnPreRender.Invoke(___genericsType, ___parameters);

...
{public partial class RCharacBehav
{
	...
	/// <summary>
	/// CharacBehav+<ProcessProtection>c__Iterator156
	/// </summary>
    public partial class R__2__ProcessProtection__4__c__Iterator156 : RMember //
    {
        ...
        public R__2__ProcessProtection__4__c__Iterator156() : base("CharacBehav+<ProcessProtection>c__Iterator156")
        {
        }

        public R__2__ProcessProtection__4__c__Iterator156(System.Object instance) : base("CharacBehav+<ProcessProtection>c__Iterator156")
		{
            SetInstance(instance);
		}

        public R__2__ProcessProtection__4__c__Iterator156(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ProcessProtection__4__c__Iterator156(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

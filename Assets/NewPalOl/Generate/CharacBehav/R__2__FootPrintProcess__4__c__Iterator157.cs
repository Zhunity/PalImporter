...
{public partial class RCharacBehav
{
	
	/// <summary>
	/// CharacBehav+<FootPrintProcess>c__Iterator157
	/// </summary>
    public partial class R__2__FootPrintProcess__4__c__Iterator157 : RMember //
    {

		/// <summary>
		/// FootPrintConfig <cfg>__0
		/// </summary>
		protected RFootPrintConfig r___2__cfg__4____0;
		public virtual RFootPrintConfig R__2__cfg__4____0
		{
			get
			{
				if(r___2__cfg__4____0 == null)
				{
					r___2__cfg__4____0 = new(this, "<cfg>__0");
					r___2__cfg__4____0.SetBelong(this.instance);
				}
				return r___2__cfg__4____0;
			}
		}

		/// <summary>
		/// UnityEngine.GameObject <obj>__1
		/// </summary>
		protected RUnityEngine.RGameObject r___2__obj__4____1;
		public virtual RUnityEngine.RGameObject R__2__obj__4____1
		{
			get
			{
				if(r___2__obj__4____1 == null)
				{
					r___2__obj__4____1 = new(this, "<obj>__1");
					r___2__obj__4____1.SetBelong(this.instance);
				}
				return r___2__obj__4____1;
			}
		}

		/// <summary>
		/// EffectInstanceHold <tmpEIH>__2
		/// </summary>
		protected REffectInstanceHold r___2__tmpEIH__4____2;
		public virtual REffectInstanceHold R__2__tmpEIH__4____2
		{
			get
			{
				if(r___2__tmpEIH__4____2 == null)
				{
					r___2__tmpEIH__4____2 = new(this, "<tmpEIH>__2");
					r___2__tmpEIH__4____2.SetBelong(this.instance);
				}
				return r___2__tmpEIH__4____2;
			}
		}
		...
		/// CharacBehav <>f__this
		/// </summary>
		protected RCharacBehav r___2____4__f__this;
		public virtual RCharacBehav R__2____4__f__this
		{
			get
			{
        ...
        public R__2__FootPrintProcess__4__c__Iterator157() : base("CharacBehav+<FootPrintProcess>c__Iterator157")
        {
        }

        public R__2__FootPrintProcess__4__c__Iterator157(System.Object instance) : base("CharacBehav+<FootPrintProcess>c__Iterator157")
		{
            SetInstance(instance);
		}

        public R__2__FootPrintProcess__4__c__Iterator157(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__FootPrintProcess__4__c__Iterator157(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

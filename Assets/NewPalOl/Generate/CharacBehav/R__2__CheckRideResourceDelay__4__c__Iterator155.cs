...
{public partial class RCharacBehav
{
	...
	/// <summary>
	/// CharacBehav+<CheckRideResourceDelay>c__Iterator155
	/// </summary>
    public partial class R__2__CheckRideResourceDelay__4__c__Iterator155 : RMember //
    {
        ...
        public R__2__CheckRideResourceDelay__4__c__Iterator155() : base("CharacBehav+<CheckRideResourceDelay>c__Iterator155")
        {
        }

        public R__2__CheckRideResourceDelay__4__c__Iterator155(System.Object instance) : base("CharacBehav+<CheckRideResourceDelay>c__Iterator155")
		{
            SetInstance(instance);
		}

        public R__2__CheckRideResourceDelay__4__c__Iterator155(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__CheckRideResourceDelay__4__c__Iterator155(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

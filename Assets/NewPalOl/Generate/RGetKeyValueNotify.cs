...
namespace SMFrame.Editor.Refleaction
{
	...
	/// GetKeyValueNotify
	/// </summary>
    public partial class RGetKeyValueNotify : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Object, #u.#i8)
		/// </summary>
		protected RMethod r_RInvoke_Object___0__i8;
		public virtual RMethod RInvoke_Object___0__i8
		{
			get
			{
				if(r_RInvoke_Object___0__i8 == null)
				{
					r_RInvoke_Object___0__i8 = new(this, "Invoke", 0, typeof(System.Object),  ReleactionUtils.GetType("#u.#i8"));
					r_RInvoke_Object___0__i8.SetBelong(this.instance);
				}
				return r_RInvoke_Object___0__i8;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, #u.#i8, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Object___0__i8_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object___0__i8_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object___0__i8_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object___0__i8_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object),  ReleactionUtils.GetType("#u.#i8"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object___0__i8_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object___0__i8_AsyncCallback_Object;
			}
		}
        ...
        public RGetKeyValueNotify() : base("GetKeyValueNotify")
        {
        }

        public RGetKeyValueNotify(System.Object instance) : base("GetKeyValueNotify")
		{
            SetInstance(instance);
		}

        public RGetKeyValueNotify(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RGetKeyValueNotify(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

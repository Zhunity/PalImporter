...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MyGUIEscortTipsWnd
	/// </summary>
    public partial class RMyGUIEscortTipsWnd : RMember //
    {
		...
		/// <summary>
		/// Void #iT(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__iT_ID;
		public virtual RMethod R__0__iT_ID
		{
			get
			{
				if(r_R__0__iT_ID == null)
				{
					r_R__0__iT_ID = new(this, "#iT", 0, typeof(GameDefineType.ID));
					r_R__0__iT_ID.SetBelong(this.instance);
				}
				return r_R__0__iT_ID;
			}
		}
        ...
        public RMyGUIEscortTipsWnd() : base("MyGUIEscortTipsWnd")
        {
        }

        public RMyGUIEscortTipsWnd(System.Object instance) : base("MyGUIEscortTipsWnd")
		{
            SetInstance(instance);
		}

        public RMyGUIEscortTipsWnd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMyGUIEscortTipsWnd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__iT(GameDefineType.ID  @id)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id};
            var ___result = R__0__iT_ID.Invoke(___genericsType, ___parameters);

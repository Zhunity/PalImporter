...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MyGUIMarryFunWnd
	/// </summary>
    public partial class RMyGUIMarryFunWnd : RMember //
    {
		...
		public static RField R__0__c
		{
			get
			{
				if(r___0__c == null)
				{
					r___0__c = new( ReleactionUtils.GetType("MyGUIMarryFunWnd"), "#c");
		...
		/// <summary>
		/// Void #Xah(System.Object)
		/// </summary>
		protected RMethod r_R__0__Xah_Object;
		public virtual RMethod R__0__Xah_Object
		{
			get
			{
				if(r_R__0__Xah_Object == null)
				{
					r_R__0__Xah_Object = new(this, "#Xah", 0, typeof(System.Object));
					r_R__0__Xah_Object.SetBelong(this.instance);
				}
				return r_R__0__Xah_Object;
			}
		}

		/// <summary>
		/// Void #Yah(System.Object)
		/// </summary>
		protected RMethod r_R__0__Yah_Object;
		public virtual RMethod R__0__Yah_Object
		{
			get
			{
				if(r_R__0__Yah_Object == null)
				{
					r_R__0__Yah_Object = new(this, "#Yah", 0, typeof(System.Object));
					r_R__0__Yah_Object.SetBelong(this.instance);
				}
				return r_R__0__Yah_Object;
			}
		}

		/// <summary>
		/// Void #Zah(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Zah_Object___0__7X;
		public virtual RMethod R__0__Zah_Object___0__7X
		{
			get
			{
				if(r_R__0__Zah_Object___0__7X == null)
				{
					r_R__0__Zah_Object___0__7X = new(this, "#Zah", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Zah_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Zah_Object___0__7X;
			}
		}
        ...
        public RMyGUIMarryFunWnd() : base("MyGUIMarryFunWnd")
        {
        }

        public RMyGUIMarryFunWnd(System.Object instance) : base("MyGUIMarryFunWnd")
		{
            SetInstance(instance);
		}

        public RMyGUIMarryFunWnd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMyGUIMarryFunWnd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Xah(System.Object  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@data};
            var ___result = R__0__Xah_Object.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Yah(System.Object  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@data};
            var ___result = R__0__Yah_Object.Invoke(___genericsType, ___parameters);

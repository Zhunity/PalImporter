...
{
	/// <summary>
	/// DestroyMyselfInMunite
	/// </summary>
    public partial class RDestroyMyselfInMunite : RMember //
    {

		/// <summary>
		/// System.Single timeed
		/// </summary>
		protected RField r_timeed;
		public virtual RField Rtimeed
		{
			get
			{
				if(r_timeed == null)
				{
					r_timeed = new(this, "timeed");
					r_timeed.SetBelong(this.instance);
				}
				return r_timeed;
			}
		}
		...
		/// System.Boolean isGo
		/// </summary>
		protected RField r_isGo;
		public virtual RField RisGo
		{
			get
			{
				if(r_isGo == null)
				{
					r_isGo = new(this, "isGo");
					r_isGo.SetBelong(this.instance);
				}
				return r_isGo;
			}
		}
		...
		/// Void DestrotyMyself()
		/// </summary>
		protected RMethod r_RDestrotyMyself;
		public virtual RMethod RDestrotyMyself
		{
			get
			{
				if(r_RDestrotyMyself == null)
				{
					r_RDestrotyMyself = new(this, "DestrotyMyself", 0);
					r_RDestrotyMyself.SetBelong(this.instance);
				}
				return r_RDestrotyMyself;
			}
		}
        ...
        public RDestroyMyselfInMunite() : base("DestroyMyselfInMunite")
        {
        }

        public RDestroyMyselfInMunite(System.Object instance) : base("DestroyMyselfInMunite")
		{
            SetInstance(instance);
		}

        public RDestroyMyselfInMunite(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RDestroyMyselfInMunite(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void DestrotyMyself()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RDestrotyMyself.Invoke(___genericsType, ___parameters);

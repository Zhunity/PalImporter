...
namespace SMFrame.Editor.Refleaction
{
	...
	/// </summary>
    public partial class REffectInstanceHelper : RMember //
    {

		/// <summary>
		/// UnityEngine.GameObject effectHold
		/// </summary>
		protected RUnityEngine.RGameObject r_effectHold;
		public virtual RUnityEngine.RGameObject ReffectHold
		{
			get
			{
				if(r_effectHold == null)
				{
					r_effectHold = new(this, "effectHold");
					r_effectHold.SetBelong(this.instance);
				}
				return r_effectHold;
			}
		}
        ...
        public REffectInstanceHelper() : base("EffectInstanceHelper")
        {
        }

        public REffectInstanceHelper(System.Object instance) : base("EffectInstanceHelper")
		{
            SetInstance(instance);
		}

        public REffectInstanceHelper(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REffectInstanceHelper(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

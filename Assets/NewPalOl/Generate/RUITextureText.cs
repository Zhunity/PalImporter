...
namespace SMFrame.Editor.Refleaction
{
	...
	/// UITextureText
	/// </summary>
    public partial class RUITextureText : RMember //
    {
        ...
        public RUITextureText() : base("UITextureText")
        {
        }

        public RUITextureText(System.Object instance) : base("UITextureText")
		{
            SetInstance(instance);
		}

        public RUITextureText(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RUITextureText(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

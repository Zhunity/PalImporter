...
{public partial class RAvatarController
{
	...
	/// <summary>
	/// AvatarController+<InitFlowllEffect>c__Iterator119
	/// </summary>
    public partial class R__2__InitFlowllEffect__4__c__Iterator119 : RMember //
    {
        ...
        public R__2__InitFlowllEffect__4__c__Iterator119() : base("AvatarController+<InitFlowllEffect>c__Iterator119")
        {
        }

        public R__2__InitFlowllEffect__4__c__Iterator119(System.Object instance) : base("AvatarController+<InitFlowllEffect>c__Iterator119")
		{
            SetInstance(instance);
		}

        public R__2__InitFlowllEffect__4__c__Iterator119(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__InitFlowllEffect__4__c__Iterator119(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

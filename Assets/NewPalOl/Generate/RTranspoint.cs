...
namespace SMFrame.Editor.Refleaction
{
	...
	/// Transpoint
	/// </summary>
    public partial class RTranspoint : RMember //
    {
		...
		/// </summary>
		protected RTransformInfo r_m_Info;
		public virtual RTransformInfo Rm_Info
		{
			get
			{
				if(r_m_Info == null)
		...
		/// <summary>
		/// System.Boolean m_bTreasureEntry
		/// </summary>
		protected RField r_m_bTreasureEntry;
		public virtual RField Rm_bTreasureEntry
		{
			get
			{
				if(r_m_bTreasureEntry == null)
				{
					r_m_bTreasureEntry = new(this, "m_bTreasureEntry");
					r_m_bTreasureEntry.SetBelong(this.instance);
				}
				return r_m_bTreasureEntry;
			}
		}

		/// <summary>
		/// Boolean TREASURE_ENTRY
		/// </summary>
		protected RProperty r_TREASURE_ENTRY;
		public virtual RProperty RTREASURE_ENTRY
		{
			get
			{
				if(r_TREASURE_ENTRY == null)
				{
					r_TREASURE_ENTRY = new(this, "TREASURE_ENTRY", -1);
					r_TREASURE_ENTRY.SetBelong(this.instance);
				}
				return r_TREASURE_ENTRY;
			}
		}
		...
		/// <summary>
		/// Void ConfirmEnter(System.Object)
		/// </summary>
		protected RMethod r_RConfirmEnter_Object;
		public virtual RMethod RConfirmEnter_Object
		{
			get
			{
				if(r_RConfirmEnter_Object == null)
				{
					r_RConfirmEnter_Object = new(this, "ConfirmEnter", 0, typeof(System.Object));
					r_RConfirmEnter_Object.SetBelong(this.instance);
				}
				return r_RConfirmEnter_Object;
			}
		}
        ...
        public RTranspoint() : base("Transpoint")
        {
        }

        public RTranspoint(System.Object instance) : base("Transpoint")
		{
            SetInstance(instance);
		}

        public RTranspoint(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RTranspoint(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void ConfirmEnter(System.Object  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@data};
            var ___result = RConfirmEnter_Object.Invoke(___genericsType, ___parameters);

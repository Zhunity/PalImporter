...
namespace SMFrame.Editor.Refleaction
{
	...
	/// UVScroller_water
	/// </summary>
    public partial class RUVScroller_water : RMember //
    {
        ...
        public RUVScroller_water() : base("UVScroller_water")
        {
        }

        public RUVScroller_water(System.Object instance) : base("UVScroller_water")
		{
            SetInstance(instance);
		}

        public RUVScroller_water(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RUVScroller_water(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

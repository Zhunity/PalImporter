...
namespace SMFrame.Editor.Refleaction.R__10____10__
{
	/// <summary>
	/// .
	/// </summary>
    public partial class R__10____10__ : RMember //
    {
        ...
        public R__10____10__() : base(".")
        {
        }

        public R__10____10__(System.Object instance) : base(".")
		{
            SetInstance(instance);
		}

        public R__10____10__(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__10____10__(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

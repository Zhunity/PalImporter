...
{public partial class RWeaponManager
{
	
	/// <summary>
	/// WeaponManager+#kOb1
	/// </summary>
    public partial class R__0__kOb1 : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Object, UnityEngine.Object[], UnityEngine.Object[], UnityEngine.Object[])
		/// </summary>
		protected RMethod r_RInvoke_Object_ObjectArray_ObjectArray_ObjectArray;
		public virtual RMethod RInvoke_Object_ObjectArray_ObjectArray_ObjectArray
		{
			get
			{
				if(r_RInvoke_Object_ObjectArray_ObjectArray_ObjectArray == null)
				{
					r_RInvoke_Object_ObjectArray_ObjectArray_ObjectArray = new(this, "Invoke", 0, typeof(System.Object), typeof(UnityEngine.Object).MakeArrayType(), typeof(UnityEngine.Object).MakeArrayType(), typeof(UnityEngine.Object).MakeArrayType());
					r_RInvoke_Object_ObjectArray_ObjectArray_ObjectArray.SetBelong(this.instance);
				}
				return r_RInvoke_Object_ObjectArray_ObjectArray_ObjectArray;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, UnityEngine.Object[], UnityEngine.Object[], UnityEngine.Object[], System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Object_ObjectArray_ObjectArray_ObjectArray_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object_ObjectArray_ObjectArray_ObjectArray_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object_ObjectArray_ObjectArray_ObjectArray_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object_ObjectArray_ObjectArray_ObjectArray_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object), typeof(UnityEngine.Object).MakeArrayType(), typeof(UnityEngine.Object).MakeArrayType(), typeof(UnityEngine.Object).MakeArrayType(), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object_ObjectArray_ObjectArray_ObjectArray_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object_ObjectArray_ObjectArray_ObjectArray_AsyncCallback_Object;
			}
		}
        ...
        public R__0__kOb1() : base("WeaponManager+#kOb1")
        {
        }

        public R__0__kOb1(System.Object instance) : base("WeaponManager+#kOb1")
		{
            SetInstance(instance);
		}

        public R__0__kOb1(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__kOb1(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Object  @sender, UnityEngine.Object[]  @model, UnityEngine.Object[]  @texture, UnityEngine.Object[]  @effect)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @model, @texture, @effect};
            var ___result = RInvoke_Object_ObjectArray_ObjectArray_ObjectArray.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.Object  @sender, UnityEngine.Object[]  @model, UnityEngine.Object[]  @texture, UnityEngine.Object[]  @effect, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @model, @texture, @effect, @callback, @object};
            var ___result = RBeginInvoke_Object_ObjectArray_ObjectArray_ObjectArray_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

...
{
	/// <summary>
	/// SceneMovieDialogManager
	/// </summary>
    public partial class RSceneMovieDialogManager : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.List`1[UnityEngine.GameObject] m_DialogList
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RGameObject> r_m_DialogList;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RGameObject> Rm_DialogList
		{
			get
			{
				if(r_m_DialogList == null)
				{
					r_m_DialogList = new(this, "m_DialogList");
					r_m_DialogList.SetBelong(this.instance);
				}
				return r_m_DialogList;
			}
		}
		...
		/// <summary>
		/// UnityEngine.GameObject m_CurrFixedDialog
		/// </summary>
		protected RUnityEngine.RGameObject r_m_CurrFixedDialog;
		public virtual RUnityEngine.RGameObject Rm_CurrFixedDialog
		{
			get
			{
				if(r_m_CurrFixedDialog == null)
				{
					r_m_CurrFixedDialog = new(this, "m_CurrFixedDialog");
					r_m_CurrFixedDialog.SetBelong(this.instance);
				}
				return r_m_CurrFixedDialog;
			}
		}
		...
		/// Void ResetDialogLib()
		/// </summary>
		protected RMethod r_RResetDialogLib;
		public virtual RMethod RResetDialogLib
		{
			get
			{
				if(r_RResetDialogLib == null)
				{
					r_RResetDialogLib = new(this, "ResetDialogLib", 0);
					r_RResetDialogLib.SetBelong(this.instance);
				}
				return r_RResetDialogLib;
			}
		}

		/// <summary>
		/// Void OpenTextDialog(SceneMovieDialogCmd, System.String, UnityEngine.Texture2D, UnityEngine.Texture2D, Boolean, Boolean, Boolean)
		/// </summary>
		protected RMethod r_ROpenTextDialog_SceneMovieDialogCmd_String_Texture2D_Texture2D_Boolean_Boolean_Boolean;
		public virtual RMethod ROpenTextDialog_SceneMovieDialogCmd_String_Texture2D_Texture2D_Boolean_Boolean_Boolean
		{
			get
			{
				if(r_ROpenTextDialog_SceneMovieDialogCmd_String_Texture2D_Texture2D_Boolean_Boolean_Boolean == null)
				{
					r_ROpenTextDialog_SceneMovieDialogCmd_String_Texture2D_Texture2D_Boolean_Boolean_Boolean = new(this, "OpenTextDialog", 0, typeof(SceneMovieDialogCmd), typeof(System.String), typeof(UnityEngine.Texture2D), typeof(UnityEngine.Texture2D), typeof(System.Boolean), typeof(System.Boolean), typeof(System.Boolean));
					r_ROpenTextDialog_SceneMovieDialogCmd_String_Texture2D_Texture2D_Boolean_Boolean_Boolean.SetBelong(this.instance);
				}
				return r_ROpenTextDialog_SceneMovieDialogCmd_String_Texture2D_Texture2D_Boolean_Boolean_Boolean;
			}
		}

		/// <summary>
		/// Void OpenPicDialog(SceneMovieDialogCmd, Boolean)
		/// </summary>
		protected RMethod r_ROpenPicDialog_SceneMovieDialogCmd_Boolean;
		public virtual RMethod ROpenPicDialog_SceneMovieDialogCmd_Boolean
		{
			get
			{
				if(r_ROpenPicDialog_SceneMovieDialogCmd_Boolean == null)
				{
					r_ROpenPicDialog_SceneMovieDialogCmd_Boolean = new(this, "OpenPicDialog", 0, typeof(SceneMovieDialogCmd), typeof(System.Boolean));
					r_ROpenPicDialog_SceneMovieDialogCmd_Boolean.SetBelong(this.instance);
				}
				return r_ROpenPicDialog_SceneMovieDialogCmd_Boolean;
			}
		}
        ...
        public RSceneMovieDialogManager() : base("SceneMovieDialogManager")
        {
        }

        public RSceneMovieDialogManager(System.Object instance) : base("SceneMovieDialogManager")
		{
            SetInstance(instance);
		}

        public RSceneMovieDialogManager(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSceneMovieDialogManager(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void ResetDialogLib()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RResetDialogLib.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void OpenTextDialog(SceneMovieDialogCmd  @cmd, System.String  @text, UnityEngine.Texture2D  @headtexture, UnityEngine.Texture2D  @otherHeadTex, System.Boolean  @bWait, System.Boolean  @bPopDown, System.Boolean  @bShowPop)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cmd, @text, @headtexture, @otherHeadTex, @bWait, @bPopDown, @bShowPop};
            var ___result = ROpenTextDialog_SceneMovieDialogCmd_String_Texture2D_Texture2D_Boolean_Boolean_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void OpenPicDialog(SceneMovieDialogCmd  @cmd, System.Boolean  @bWait)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cmd, @bWait};
            var ___result = ROpenPicDialog_SceneMovieDialogCmd_Boolean.Invoke(___genericsType, ___parameters);

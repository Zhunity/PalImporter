...
namespace SMFrame.Editor.Refleaction
{
	...
	/// EquipRecastReader
	/// </summary>
    public partial class REquipRecastReader : RMember //
    {
        ...
        public REquipRecastReader() : base("EquipRecastReader")
        {
        }

        public REquipRecastReader(System.Object instance) : base("EquipRecastReader")
		{
            SetInstance(instance);
		}

        public REquipRecastReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REquipRecastReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

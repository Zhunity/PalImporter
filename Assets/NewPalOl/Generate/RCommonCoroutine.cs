...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CommonCoroutine
	/// </summary>
    public partial class RCommonCoroutine : RMember //
    {
		...
		/// </summary>
		protected RSystem.RObject r_sender;
		public virtual RSystem.RObject Rsender
		{
			get
			{
				if(r_sender == null)
				{
					r_sender = new(this, "sender");
					r_sender.SetBelong(this.instance);
				}
				return r_sender;
			}
		}
		...
		/// <summary>
		/// EventHandler mHandle
		/// </summary>
		protected REventHandler r_mHandle;
		public virtual REventHandler RmHandle
		{
			get
			{
				if(r_mHandle == null)
		...
		/// <summary>
		/// EventHandlering mHandleing
		/// </summary>
		protected REventHandlering r_mHandleing;
		public virtual REventHandlering RmHandleing
		{
			get
			{
				if(r_mHandleing == null)
				{
					r_mHandleing = new(this, "mHandleing");
					r_mHandleing.SetBelong(this.instance);
				}
				return r_mHandleing;
			}
		}
		...
		/// <summary>
		/// Void StartCommonCoroutine(Single, EventHandler, System.Object, System.EventArgs)
		/// </summary>
		protected RMethod r_RStartCommonCoroutine_Single_EventHandler_Object_EventArgs;
		public virtual RMethod RStartCommonCoroutine_Single_EventHandler_Object_EventArgs
		{
			get
			{
				if(r_RStartCommonCoroutine_Single_EventHandler_Object_EventArgs == null)
				{
					r_RStartCommonCoroutine_Single_EventHandler_Object_EventArgs = new(this, "StartCommonCoroutine", 0, typeof(System.Single), typeof(EventHandler), typeof(System.Object), typeof(System.EventArgs));
					r_RStartCommonCoroutine_Single_EventHandler_Object_EventArgs.SetBelong(this.instance);
				}
				return r_RStartCommonCoroutine_Single_EventHandler_Object_EventArgs;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator CoroutineFun(Single)
		/// </summary>
		protected RMethod r_RCoroutineFun_Single;
		public virtual RMethod RCoroutineFun_Single
		{
			get
			{
				if(r_RCoroutineFun_Single == null)
				{
					r_RCoroutineFun_Single = new(this, "CoroutineFun", 0, typeof(System.Single));
					r_RCoroutineFun_Single.SetBelong(this.instance);
				}
				return r_RCoroutineFun_Single;
			}
		}

		/// <summary>
		/// Void StartCommonCoroutine(EventHandler, System.Object, System.EventArgs)
		/// </summary>
		protected RMethod r_RStartCommonCoroutine_EventHandler_Object_EventArgs;
		public virtual RMethod RStartCommonCoroutine_EventHandler_Object_EventArgs
		{
			get
			{
				if(r_RStartCommonCoroutine_EventHandler_Object_EventArgs == null)
				{
					r_RStartCommonCoroutine_EventHandler_Object_EventArgs = new(this, "StartCommonCoroutine", 0, typeof(EventHandler), typeof(System.Object), typeof(System.EventArgs));
					r_RStartCommonCoroutine_EventHandler_Object_EventArgs.SetBelong(this.instance);
				}
				return r_RStartCommonCoroutine_EventHandler_Object_EventArgs;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator CoroutineFunFrame()
		/// </summary>
		protected RMethod r_RCoroutineFunFrame;
		public virtual RMethod RCoroutineFunFrame
		{
			get
			{
				if(r_RCoroutineFunFrame == null)
				{
					r_RCoroutineFunFrame = new(this, "CoroutineFunFrame", 0);
					r_RCoroutineFunFrame.SetBelong(this.instance);
				}
				return r_RCoroutineFunFrame;
			}
		}

		/// <summary>
		/// Void StartCommonCoroutine(Single, EventHandler, System.Object, System.EventArgs, EventHandlering)
		/// </summary>
		protected RMethod r_RStartCommonCoroutine_Single_EventHandler_Object_EventArgs_EventHandlering;
		public virtual RMethod RStartCommonCoroutine_Single_EventHandler_Object_EventArgs_EventHandlering
		{
			get
			{
				if(r_RStartCommonCoroutine_Single_EventHandler_Object_EventArgs_EventHandlering == null)
				{
					r_RStartCommonCoroutine_Single_EventHandler_Object_EventArgs_EventHandlering = new(this, "StartCommonCoroutine", 0, typeof(System.Single), typeof(EventHandler), typeof(System.Object), typeof(System.EventArgs), typeof(EventHandlering));
					r_RStartCommonCoroutine_Single_EventHandler_Object_EventArgs_EventHandlering.SetBelong(this.instance);
				}
				return r_RStartCommonCoroutine_Single_EventHandler_Object_EventArgs_EventHandlering;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator CoroutineFunX(Single)
		/// </summary>
		protected RMethod r_RCoroutineFunX_Single;
		public virtual RMethod RCoroutineFunX_Single
		{
			get
			{
				if(r_RCoroutineFunX_Single == null)
				{
					r_RCoroutineFunX_Single = new(this, "CoroutineFunX", 0, typeof(System.Single));
					r_RCoroutineFunX_Single.SetBelong(this.instance);
				}
				return r_RCoroutineFunX_Single;
			}
		}
        ...
        public RCommonCoroutine() : base("CommonCoroutine")
        {
        }

        public RCommonCoroutine(System.Object instance) : base("CommonCoroutine")
		{
            SetInstance(instance);
		}

        public RCommonCoroutine(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCommonCoroutine(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void StartCommonCoroutine(System.Single  @time, EventHandler  @obj, System.Object  @sender, System.EventArgs  @e)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time, @obj, @sender, @e};
            var ___result = RStartCommonCoroutine_Single_EventHandler_Object_EventArgs.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator CoroutineFun(System.Single  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time};
            var ___result = RCoroutineFun_Single.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual void StartCommonCoroutine(EventHandler  @obj, System.Object  @sender, System.EventArgs  @e)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@obj, @sender, @e};
            var ___result = RStartCommonCoroutine_EventHandler_Object_EventArgs.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator CoroutineFunFrame()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RCoroutineFunFrame.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual void StartCommonCoroutine(System.Single  @time, EventHandler  @obj, System.Object  @sender, System.EventArgs  @e, EventHandlering  @handlerin)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time, @obj, @sender, @e, @handlerin};
            var ___result = RStartCommonCoroutine_Single_EventHandler_Object_EventArgs_EventHandlering.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator CoroutineFunX(System.Single  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time};
            var ___result = RCoroutineFunX_Single.Invoke(___genericsType, ___parameters);

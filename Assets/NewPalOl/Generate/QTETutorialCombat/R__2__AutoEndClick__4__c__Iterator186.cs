...
{public partial class RQTETutorialCombat
{
	
	/// <summary>
	/// QTETutorialCombat+<AutoEndClick>c__Iterator186
	/// </summary>
    public partial class R__2__AutoEndClick__4__c__Iterator186 : RMember //
    {
		...
		/// <summary>
		/// QTETutorialCombat <>f__this
		/// </summary>
		protected RQTETutorialCombat r___2____4__f__this;
		public virtual RQTETutorialCombat R__2____4__f__this
		{
			get
			{
        ...
        public R__2__AutoEndClick__4__c__Iterator186() : base("QTETutorialCombat+<AutoEndClick>c__Iterator186")
        {
        }

        public R__2__AutoEndClick__4__c__Iterator186(System.Object instance) : base("QTETutorialCombat+<AutoEndClick>c__Iterator186")
		{
            SetInstance(instance);
		}

        public R__2__AutoEndClick__4__c__Iterator186(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__AutoEndClick__4__c__Iterator186(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

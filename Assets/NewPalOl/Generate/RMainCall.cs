...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MainCall
	/// </summary>
    public partial class RMainCall : RMember //
    {
		...
		/// <summary>
		/// TransactionMonitor GetLaunchTransaction()
		/// </summary>
		protected RMethod r_RGetLaunchTransaction;
		public virtual RMethod RGetLaunchTransaction
		{
			get
			{
				if(r_RGetLaunchTransaction == null)
				{
					r_RGetLaunchTransaction = new(this, "GetLaunchTransaction", 0);
					r_RGetLaunchTransaction.SetBelong(this.instance);
				}
				return r_RGetLaunchTransaction;
			}
		}

		/// <summary>
		/// TransactionMonitor GetModuleTransaction()
		/// </summary>
		protected RMethod r_RGetModuleTransaction;
		public virtual RMethod RGetModuleTransaction
		{
			get
			{
				if(r_RGetModuleTransaction == null)
				{
					r_RGetModuleTransaction = new(this, "GetModuleTransaction", 0);
					r_RGetModuleTransaction.SetBelong(this.instance);
				}
				return r_RGetModuleTransaction;
			}
		}

		/// <summary>
		/// Void BrowerInfo(System.String)
		/// </summary>
		protected RMethod r_RBrowerInfo_String;
		public virtual RMethod RBrowerInfo_String
		{
			get
			{
				if(r_RBrowerInfo_String == null)
				{
					r_RBrowerInfo_String = new(this, "BrowerInfo", 0, typeof(System.String));
					r_RBrowerInfo_String.SetBelong(this.instance);
				}
				return r_RBrowerInfo_String;
			}
		}
        ...
        public RMainCall() : base("MainCall")
        {
        }

        public RMainCall(System.Object instance) : base("MainCall")
		{
            SetInstance(instance);
		}

        public RMainCall(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMainCall(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void SetHttpGet(System.String  @infoStr)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@infoStr};
        ...
        public virtual TransactionMonitor GetLaunchTransaction()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RGetLaunchTransaction.Invoke(___genericsType, ___parameters);

            return (TransactionMonitor)___result;
        }


        public virtual TransactionMonitor GetModuleTransaction()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RGetModuleTransaction.Invoke(___genericsType, ___parameters);

            return (TransactionMonitor)___result;
        }


        public virtual void BrowerInfo(System.String  @szbrower)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@szbrower};
            var ___result = RBrowerInfo_String.Invoke(___genericsType, ___parameters);

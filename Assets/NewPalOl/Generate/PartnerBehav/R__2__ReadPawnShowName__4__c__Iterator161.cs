...
{public partial class RPartnerBehav
{
	...
	/// <summary>
	/// PartnerBehav+<ReadPawnShowName>c__Iterator161
	/// </summary>
    public partial class R__2__ReadPawnShowName__4__c__Iterator161 : RMember //
    {
        ...
        public R__2__ReadPawnShowName__4__c__Iterator161() : base("PartnerBehav+<ReadPawnShowName>c__Iterator161")
        {
        }

        public R__2__ReadPawnShowName__4__c__Iterator161(System.Object instance) : base("PartnerBehav+<ReadPawnShowName>c__Iterator161")
		{
            SetInstance(instance);
		}

        public R__2__ReadPawnShowName__4__c__Iterator161(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ReadPawnShowName__4__c__Iterator161(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

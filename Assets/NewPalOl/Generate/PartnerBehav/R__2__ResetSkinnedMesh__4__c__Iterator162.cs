...
{public partial class RPartnerBehav
{
	
	/// <summary>
	/// PartnerBehav+<ResetSkinnedMesh>c__Iterator162
	/// </summary>
    public partial class R__2__ResetSkinnedMesh__4__c__Iterator162 : RMember //
    {
		...
		/// <summary>
		/// PartnerBehav <>f__this
		/// </summary>
		protected RPartnerBehav r___2____4__f__this;
		public virtual RPartnerBehav R__2____4__f__this
		{
			get
			{
        ...
        public R__2__ResetSkinnedMesh__4__c__Iterator162() : base("PartnerBehav+<ResetSkinnedMesh>c__Iterator162")
        {
        }

        public R__2__ResetSkinnedMesh__4__c__Iterator162(System.Object instance) : base("PartnerBehav+<ResetSkinnedMesh>c__Iterator162")
		{
            SetInstance(instance);
		}

        public R__2__ResetSkinnedMesh__4__c__Iterator162(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__ResetSkinnedMesh__4__c__Iterator162(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

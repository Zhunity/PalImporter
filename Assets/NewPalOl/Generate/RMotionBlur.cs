...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MotionBlur
	/// </summary>
    public partial class RMotionBlur : RMember //
    {
        ...
        public RMotionBlur() : base("MotionBlur")
        {
        }

        public RMotionBlur(System.Object instance) : base("MotionBlur")
		{
            SetInstance(instance);
		}

        public RMotionBlur(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMotionBlur(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// EquipMakerReader
	/// </summary>
    public partial class REquipMakerReader : RMember //
    {
        ...
        public REquipMakerReader() : base("EquipMakerReader")
        {
        }

        public REquipMakerReader(System.Object instance) : base("EquipMakerReader")
		{
            SetInstance(instance);
		}

        public REquipMakerReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REquipMakerReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// PriceInfoXMLReader
	/// </summary>
    public partial class RPriceInfoXMLReader : RMember //
    {
        ...
        public RPriceInfoXMLReader() : base("PriceInfoXMLReader")
        {
        }

        public RPriceInfoXMLReader(System.Object instance) : base("PriceInfoXMLReader")
		{
            SetInstance(instance);
		}

        public RPriceInfoXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPriceInfoXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

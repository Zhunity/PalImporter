...
namespace SMFrame.Editor.Refleaction
{
	...
	/// NpcBubble
	/// </summary>
    public partial class RNpcBubble : RMember //
    {
        ...
        public RNpcBubble() : base("NpcBubble")
        {
        }

        public RNpcBubble(System.Object instance) : base("NpcBubble")
		{
            SetInstance(instance);
		}

        public RNpcBubble(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RNpcBubble(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// PlayerBubble
	/// </summary>
    public partial class RPlayerBubble : RMember //
    {
        ...
        public RPlayerBubble() : base("PlayerBubble")
        {
        }

        public RPlayerBubble(System.Object instance) : base("PlayerBubble")
		{
            SetInstance(instance);
		}

        public RPlayerBubble(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPlayerBubble(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// KeyValueXMLReader`1
	/// </summary>
    public partial class RKeyValueXMLReader<T> : RMember //
    {
		...
		public static RField ROOT_NAME
		{
			get
			{
				if(r_ROOT_NAME == null)
				{
					r_ROOT_NAME = new( ReleactionUtils.GetType("KeyValueXMLReader`1"), "ROOT_NAME");
		...
		public static RField RID_NAME
		{
			get
			{
				if(r_ID_NAME == null)
				{
					r_ID_NAME = new( ReleactionUtils.GetType("KeyValueXMLReader`1"), "ID_NAME");
        ...
        public RKeyValueXMLReader() : base("KeyValueXMLReader`1")
        {
        }

        public RKeyValueXMLReader(System.Object instance) : base("KeyValueXMLReader`1")
		{
            SetInstance(instance);
		}

        public RKeyValueXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RKeyValueXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

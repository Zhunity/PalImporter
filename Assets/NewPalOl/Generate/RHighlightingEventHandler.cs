...
namespace SMFrame.Editor.Refleaction
{
	...
	/// </summary>
    public partial class RHighlightingEventHandler : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(Boolean, Boolean)
		/// </summary>
		protected RMethod r_RInvoke_Boolean_Boolean;
		public virtual RMethod RInvoke_Boolean_Boolean
		{
			get
			{
				if(r_RInvoke_Boolean_Boolean == null)
				{
					r_RInvoke_Boolean_Boolean = new(this, "Invoke", 0, typeof(System.Boolean), typeof(System.Boolean));
					r_RInvoke_Boolean_Boolean.SetBelong(this.instance);
				}
				return r_RInvoke_Boolean_Boolean;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(Boolean, Boolean, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Boolean_Boolean_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Boolean_Boolean_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Boolean_Boolean_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Boolean_Boolean_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Boolean), typeof(System.Boolean), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Boolean_Boolean_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Boolean_Boolean_AsyncCallback_Object;
			}
		}
        ...
        public RHighlightingEventHandler() : base("HighlightingEventHandler")
        {
        }

        public RHighlightingEventHandler(System.Object instance) : base("HighlightingEventHandler")
		{
            SetInstance(instance);
		}

        public RHighlightingEventHandler(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RHighlightingEventHandler(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Boolean  @state, System.Boolean  @zWrite)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@state, @zWrite};
            var ___result = RInvoke_Boolean_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.Boolean  @state, System.Boolean  @zWrite, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@state, @zWrite, @callback, @object};
            var ___result = RBeginInvoke_Boolean_Boolean_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

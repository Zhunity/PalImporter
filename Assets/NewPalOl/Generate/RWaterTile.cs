...
namespace SMFrame.Editor.Refleaction
{
	...
	/// WaterTile
	/// </summary>
    public partial class RWaterTile : RMember //
    {

		/// <summary>
		/// PlanarReflection reflection
		/// </summary>
		protected RPlanarReflection r_reflection;
		public virtual RPlanarReflection Rreflection
		{
			get
			{
				if(r_reflection == null)
				{
					r_reflection = new(this, "reflection");
					r_reflection.SetBelong(this.instance);
				}
				return r_reflection;
			}
		}
		...
		/// WaterBase waterBase
		/// </summary>
		protected RWaterBase r_waterBase;
		public virtual RWaterBase RwaterBase
		{
			get
			{
				if(r_waterBase == null)
				{
					r_waterBase = new(this, "waterBase");
					r_waterBase.SetBelong(this.instance);
				}
				return r_waterBase;
			}
		}
		...
		/// </summary>
		protected RMethod r_RAcquireComponents;
		public virtual RMethod RAcquireComponents
		{
			get
			{
				if(r_RAcquireComponents == null)
				{
					r_RAcquireComponents = new(this, "AcquireComponents", 0);
					r_RAcquireComponents.SetBelong(this.instance);
				}
				return r_RAcquireComponents;
			}
		}
        ...
        public RWaterTile() : base("WaterTile")
        {
        }

        public RWaterTile(System.Object instance) : base("WaterTile")
		{
            SetInstance(instance);
		}

        public RWaterTile(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RWaterTile(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void AcquireComponents()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RAcquireComponents.Invoke(___genericsType, ___parameters);

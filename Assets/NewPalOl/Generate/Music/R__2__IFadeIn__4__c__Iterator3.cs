...
{public partial class RMusic
{
	...
	/// <summary>
	/// Music+<IFadeIn>c__Iterator3
	/// </summary>
    public partial class R__2__IFadeIn__4__c__Iterator3 : RMember //
    {
        ...
        public R__2__IFadeIn__4__c__Iterator3() : base("Music+<IFadeIn>c__Iterator3")
        {
        }

        public R__2__IFadeIn__4__c__Iterator3(System.Object instance) : base("Music+<IFadeIn>c__Iterator3")
		{
            SetInstance(instance);
		}

        public R__2__IFadeIn__4__c__Iterator3(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__IFadeIn__4__c__Iterator3(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

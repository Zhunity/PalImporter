...
{public partial class RMusic
{
	
	/// <summary>
	/// Music+<IFadeOut>c__Iterator2
	/// </summary>
    public partial class R__2__IFadeOut__4__c__Iterator2 : RMember //
    {
		...
		/// <summary>
		/// System.Single <mTime>__0
		/// </summary>
		protected RField r___2__mTime__4____0;
		public virtual RField R__2__mTime__4____0
		{
			get
			{
				if(r___2__mTime__4____0 == null)
				{
					r___2__mTime__4____0 = new(this, "<mTime>__0");
					r___2__mTime__4____0.SetBelong(this.instance);
				}
				return r___2__mTime__4____0;
			}
		}
		...
		/// Music <>f__this
		/// </summary>
		protected RMusic r___2____4__f__this;
		public virtual RMusic R__2____4__f__this
		{
			get
			{
        ...
        public R__2__IFadeOut__4__c__Iterator2() : base("Music+<IFadeOut>c__Iterator2")
        {
        }

        public R__2__IFadeOut__4__c__Iterator2(System.Object instance) : base("Music+<IFadeOut>c__Iterator2")
		{
            SetInstance(instance);
		}

        public R__2__IFadeOut__4__c__Iterator2(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__IFadeOut__4__c__Iterator2(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

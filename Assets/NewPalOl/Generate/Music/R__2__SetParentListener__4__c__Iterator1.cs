...
{public partial class RMusic
{
	...
	/// <summary>
	/// Music+<SetParentListener>c__Iterator1
	/// </summary>
    public partial class R__2__SetParentListener__4__c__Iterator1 : RMember //
    {
        ...
        public R__2__SetParentListener__4__c__Iterator1() : base("Music+<SetParentListener>c__Iterator1")
        {
        }

        public R__2__SetParentListener__4__c__Iterator1(System.Object instance) : base("Music+<SetParentListener>c__Iterator1")
		{
            SetInstance(instance);
		}

        public R__2__SetParentListener__4__c__Iterator1(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__SetParentListener__4__c__Iterator1(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

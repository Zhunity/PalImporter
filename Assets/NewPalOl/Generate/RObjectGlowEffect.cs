...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ObjectGlowEffect
	/// </summary>
    public partial class RObjectGlowEffect : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.Shader _renderSceneShader
		/// </summary>
		protected RUnityEngine.RShader r__renderSceneShader;
		public virtual RUnityEngine.RShader R_renderSceneShader
		{
			get
			{
				if(r__renderSceneShader == null)
				{
					r__renderSceneShader = new(this, "_renderSceneShader");
					r__renderSceneShader.SetBelong(this.instance);
				}
				return r__renderSceneShader;
			}
		}

		/// <summary>
		/// UnityEngine.Shader _composeShader
		/// </summary>
		protected RUnityEngine.RShader r__composeShader;
		public virtual RUnityEngine.RShader R_composeShader
		{
			get
			{
				if(r__composeShader == null)
				{
					r__composeShader = new(this, "_composeShader");
					r__composeShader.SetBelong(this.instance);
				}
				return r__composeShader;
			}
		}

		/// <summary>
		/// UnityEngine.Shader _maskCopyShader
		/// </summary>
		protected RUnityEngine.RShader r__maskCopyShader;
		public virtual RUnityEngine.RShader R_maskCopyShader
		{
			get
			{
				if(r__maskCopyShader == null)
				{
					r__maskCopyShader = new(this, "_maskCopyShader");
					r__maskCopyShader.SetBelong(this.instance);
				}
				return r__maskCopyShader;
			}
		}

		/// <summary>
		/// UnityEngine.Shader _zeroAlphaShader
		/// </summary>
		protected RUnityEngine.RShader r__zeroAlphaShader;
		public virtual RUnityEngine.RShader R_zeroAlphaShader
		{
			get
			{
				if(r__zeroAlphaShader == null)
				{
					r__zeroAlphaShader = new(this, "_zeroAlphaShader");
					r__zeroAlphaShader.SetBelong(this.instance);
				}
				return r__zeroAlphaShader;
			}
		}

		/// <summary>
		/// UnityEngine.Shader _alpha2Green
		/// </summary>
		protected RUnityEngine.RShader r__alpha2Green;
		public virtual RUnityEngine.RShader R_alpha2Green
		{
			get
			{
				if(r__alpha2Green == null)
				{
					r__alpha2Green = new(this, "_alpha2Green");
					r__alpha2Green.SetBelong(this.instance);
				}
				return r__alpha2Green;
			}
		}

		/// <summary>
		/// UnityEngine.Camera shaderCamera
		/// </summary>
		protected RUnityEngine.RCamera r_shaderCamera;
		public virtual RUnityEngine.RCamera RshaderCamera
		{
			get
			{
				if(r_shaderCamera == null)
				{
					r_shaderCamera = new(this, "shaderCamera");
					r_shaderCamera.SetBelong(this.instance);
				}
				return r_shaderCamera;
			}
		}

		/// <summary>
		/// System.String compositeMatString
		/// </summary>
		protected static RField r_compositeMatString;
		public static RField RcompositeMatString
		{
			get
			{
				if(r_compositeMatString == null)
				{
					r_compositeMatString = new(typeof(ObjectGlowEffect), "compositeMatString");
					r_compositeMatString.SetBelong(null);
				}
				return r_compositeMatString;
			}
		}

		/// <summary>
		/// UnityEngine.Material m_CompositeMaterial
		/// </summary>
		protected static RUnityEngine.RMaterial r_m_CompositeMaterial;
		public static RUnityEngine.RMaterial Rm_CompositeMaterial
		{
			get
			{
				if(r_m_CompositeMaterial == null)
				{
					r_m_CompositeMaterial = new(typeof(ObjectGlowEffect), "m_CompositeMaterial");
					r_m_CompositeMaterial.SetBelong(null);
				}
				return r_m_CompositeMaterial;
			}
		}

		/// <summary>
		/// System.String blurMatString
		/// </summary>
		protected static RField r_blurMatString;
		public static RField RblurMatString
		{
			get
			{
				if(r_blurMatString == null)
				{
					r_blurMatString = new(typeof(ObjectGlowEffect), "blurMatString");
					r_blurMatString.SetBelong(null);
				}
				return r_blurMatString;
			}
		}

		/// <summary>
		/// UnityEngine.Material m_BlurMaterial
		/// </summary>
		protected static RUnityEngine.RMaterial r_m_BlurMaterial;
		public static RUnityEngine.RMaterial Rm_BlurMaterial
		{
			get
			{
				if(r_m_BlurMaterial == null)
				{
					r_m_BlurMaterial = new(typeof(ObjectGlowEffect), "m_BlurMaterial");
					r_m_BlurMaterial.SetBelong(null);
				}
				return r_m_BlurMaterial;
			}
		}

		/// <summary>
		/// UnityEngine.Shader _downsampleShader
		/// </summary>
		protected RUnityEngine.RShader r__downsampleShader;
		public virtual RUnityEngine.RShader R_downsampleShader
		{
			get
			{
				if(r__downsampleShader == null)
				{
					r__downsampleShader = new(this, "_downsampleShader");
					r__downsampleShader.SetBelong(this.instance);
				}
				return r__downsampleShader;
			}
		}

		/// <summary>
		/// UnityEngine.Material m_DownsampleMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r_m_DownsampleMaterial;
		public virtual RUnityEngine.RMaterial Rm_DownsampleMaterial
		{
			get
			{
				if(r_m_DownsampleMaterial == null)
				{
					r_m_DownsampleMaterial = new(this, "m_DownsampleMaterial");
					r_m_DownsampleMaterial.SetBelong(this.instance);
				}
				return r_m_DownsampleMaterial;
			}
		}

		/// <summary>
		/// UnityEngine.Shader renderSceneShader
		/// </summary>
		protected RUnityEngine.RShader r_renderSceneShader;
		public virtual RUnityEngine.RShader RrenderSceneShader
		{
			get
			{
				if(r_renderSceneShader == null)
				{
					r_renderSceneShader = new(this, "renderSceneShader", -1);
					r_renderSceneShader.SetBelong(this.instance);
				}
				return r_renderSceneShader;
			}
		}

		/// <summary>
		/// UnityEngine.Shader composeShader
		/// </summary>
		protected RUnityEngine.RShader r_composeShader;
		public virtual RUnityEngine.RShader RcomposeShader
		{
			get
			{
				if(r_composeShader == null)
				{
					r_composeShader = new(this, "composeShader", -1);
					r_composeShader.SetBelong(this.instance);
				}
				return r_composeShader;
			}
		}

		/// <summary>
		/// UnityEngine.Shader maskCopyShader
		/// </summary>
		protected RUnityEngine.RShader r_maskCopyShader;
		public virtual RUnityEngine.RShader RmaskCopyShader
		{
			get
			{
				if(r_maskCopyShader == null)
				{
					r_maskCopyShader = new(this, "maskCopyShader", -1);
					r_maskCopyShader.SetBelong(this.instance);
				}
				return r_maskCopyShader;
			}
		}

		/// <summary>
		/// UnityEngine.Shader zeroAlphaShader
		/// </summary>
		protected RUnityEngine.RShader r_zeroAlphaShader;
		public virtual RUnityEngine.RShader RzeroAlphaShader
		{
			get
			{
				if(r_zeroAlphaShader == null)
				{
					r_zeroAlphaShader = new(this, "zeroAlphaShader", -1);
					r_zeroAlphaShader.SetBelong(this.instance);
				}
				return r_zeroAlphaShader;
			}
		}

		/// <summary>
		/// UnityEngine.Shader alpha2Green
		/// </summary>
		protected RUnityEngine.RShader r_alpha2Green;
		public virtual RUnityEngine.RShader Ralpha2Green
		{
			get
			{
				if(r_alpha2Green == null)
				{
					r_alpha2Green = new(this, "alpha2Green", -1);
					r_alpha2Green.SetBelong(this.instance);
				}
				return r_alpha2Green;
			}
		}

		/// <summary>
		/// UnityEngine.Material compositeMaterial
		/// </summary>
		protected static RUnityEngine.RMaterial r_compositeMaterial;
		public static RUnityEngine.RMaterial RcompositeMaterial
		{
			get
			{
				if(r_compositeMaterial == null)
				{
					r_compositeMaterial = new(typeof(ObjectGlowEffect), "compositeMaterial", -1);
					r_compositeMaterial.SetBelong(null);
				}
				return r_compositeMaterial;
			}
		}
		...
		/// </summary>
		protected static RUnityEngine.RMaterial r_blurMaterial;
		public static RUnityEngine.RMaterial RblurMaterial
		{
			get
			{
				if(r_blurMaterial == null)
				{
					r_blurMaterial = new(typeof(ObjectGlowEffect), "blurMaterial", -1);
					r_blurMaterial.SetBelong(null);
				}
				return r_blurMaterial;
			}
		}
		...
		public virtual RUnityEngine.RShader RdownsampleShader
		{
			get
			{
				...
				{
					r_downsampleShader = new(this, "downsampleShader", -1);
		...
		/// <summary>
		/// Void FourTapCone(UnityEngine.RenderTexture, UnityEngine.RenderTexture, Int32)
		/// </summary>
		protected RMethod r_RFourTapCone_RenderTexture_RenderTexture_Int32;
		public virtual RMethod RFourTapCone_RenderTexture_RenderTexture_Int32
		{
			get
			{
				if(r_RFourTapCone_RenderTexture_RenderTexture_Int32 == null)
				{
					r_RFourTapCone_RenderTexture_RenderTexture_Int32 = new(this, "FourTapCone", 0, typeof(UnityEngine.RenderTexture), typeof(UnityEngine.RenderTexture), typeof(System.Int32));
					r_RFourTapCone_RenderTexture_RenderTexture_Int32.SetBelong(this.instance);
				}
				return r_RFourTapCone_RenderTexture_RenderTexture_Int32;
			}
		}

		/// <summary>
		/// Void DownSample4x(UnityEngine.RenderTexture, UnityEngine.RenderTexture)
		/// </summary>
		protected RMethod r_RDownSample4x_RenderTexture_RenderTexture;
		public virtual RMethod RDownSample4x_RenderTexture_RenderTexture
		{
			get
			{
				if(r_RDownSample4x_RenderTexture_RenderTexture == null)
				{
					r_RDownSample4x_RenderTexture_RenderTexture = new(this, "DownSample4x", 0, typeof(UnityEngine.RenderTexture), typeof(UnityEngine.RenderTexture));
					r_RDownSample4x_RenderTexture_RenderTexture.SetBelong(this.instance);
				}
				return r_RDownSample4x_RenderTexture_RenderTexture;
			}
		}
		...
		/// <summary>
		/// Void BlitGlow(UnityEngine.RenderTexture, UnityEngine.RenderTexture)
		/// </summary>
		protected RMethod r_RBlitGlow_RenderTexture_RenderTexture;
		public virtual RMethod RBlitGlow_RenderTexture_RenderTexture
		{
			get
			{
				if(r_RBlitGlow_RenderTexture_RenderTexture == null)
				{
					r_RBlitGlow_RenderTexture_RenderTexture = new(this, "BlitGlow", 0, typeof(UnityEngine.RenderTexture), typeof(UnityEngine.RenderTexture));
					r_RBlitGlow_RenderTexture_RenderTexture.SetBelong(this.instance);
				}
				return r_RBlitGlow_RenderTexture_RenderTexture;
			}
		}

		/// <summary>
		/// Void BlitGlowMasking(UnityEngine.RenderTexture, UnityEngine.RenderTexture, UnityEngine.RenderTexture)
		/// </summary>
		protected RMethod r_RBlitGlowMasking_RenderTexture_RenderTexture_RenderTexture;
		public virtual RMethod RBlitGlowMasking_RenderTexture_RenderTexture_RenderTexture
		{
			get
			{
				if(r_RBlitGlowMasking_RenderTexture_RenderTexture_RenderTexture == null)
				{
					r_RBlitGlowMasking_RenderTexture_RenderTexture_RenderTexture = new(this, "BlitGlowMasking", 0, typeof(UnityEngine.RenderTexture), typeof(UnityEngine.RenderTexture), typeof(UnityEngine.RenderTexture));
					r_RBlitGlowMasking_RenderTexture_RenderTexture_RenderTexture.SetBelong(this.instance);
				}
				return r_RBlitGlowMasking_RenderTexture_RenderTexture_RenderTexture;
			}
		}
        ...
        public RObjectGlowEffect() : base("ObjectGlowEffect")
        {
        }

        public RObjectGlowEffect(System.Object instance) : base("ObjectGlowEffect")
		{
            SetInstance(instance);
		}

        public RObjectGlowEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RObjectGlowEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void FourTapCone(UnityEngine.RenderTexture  @source, UnityEngine.RenderTexture  @dest, System.Int32  @iteration)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@source, @dest, @iteration};
            var ___result = RFourTapCone_RenderTexture_RenderTexture_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void DownSample4x(UnityEngine.RenderTexture  @source, UnityEngine.RenderTexture  @dest)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@source, @dest};
            var ___result = RDownSample4x_RenderTexture_RenderTexture.Invoke(___genericsType, ___parameters);
        ...
        public virtual void BlitGlow(UnityEngine.RenderTexture  @source, UnityEngine.RenderTexture  @dest)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@source, @dest};
            var ___result = RBlitGlow_RenderTexture_RenderTexture.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void BlitGlowMasking(UnityEngine.RenderTexture  @source, UnityEngine.RenderTexture  @mask, UnityEngine.RenderTexture  @dest)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@source, @mask, @dest};
            var ___result = RBlitGlowMasking_RenderTexture_RenderTexture_RenderTexture.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// BaseGroup`1
	/// </summary>
    public partial class RBaseGroup<T> : RMember // where T : UnityEngine.MonoBehaviour
    {

		/// <summary>
		/// UnityEngine.GameObject mObjectGroup
		/// </summary>
		protected static RUnityEngine.RGameObject r_mObjectGroup;
		public static RUnityEngine.RGameObject RmObjectGroup
		{
			get
			{
				if(r_mObjectGroup == null)
				{
					r_mObjectGroup = new( ReleactionUtils.GetType("BaseGroup`1"), "mObjectGroup");
					r_mObjectGroup.SetBelong(null);
				}
				return r_mObjectGroup;
			}
		}

		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.String,UnityEngine.MonoBehaviour] mGroupComponent
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RDictionary<RField, RUnityEngine.RMonoBehaviour> r_mGroupComponent;
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RUnityEngine.RMonoBehaviour> RmGroupComponent
		{
			get
			{
				if(r_mGroupComponent == null)
				{
					r_mGroupComponent = new( ReleactionUtils.GetType("BaseGroup`1"), "mGroupComponent");
					r_mGroupComponent.SetBelong(null);
				}
				return r_mGroupComponent;
			}
		}
		...
		/// T GetInstance()
		/// </summary>
		protected static RMethod r_RGetInstance;
		public static RMethod RGetInstance
		{
			get
			{
				if(r_RGetInstance == null)
				{
					r_RGetInstance = new( ReleactionUtils.GetType("BaseGroup`1"), "GetInstance", 0);
					r_RGetInstance.SetBelong(null);
				}
				return r_RGetInstance;
			}
		}
        ...
        public RBaseGroup() : base("BaseGroup`1")
        {
        }

        public RBaseGroup(System.Object instance) : base("BaseGroup`1")
		{
            SetInstance(instance);
		}

        public RBaseGroup(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBaseGroup(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public static T GetInstance()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RGetInstance.Invoke(___genericsType, ___parameters);

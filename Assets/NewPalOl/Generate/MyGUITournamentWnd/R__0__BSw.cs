...
{public partial class RMyGUITournamentWnd
{
	...
	/// <summary>
	/// MyGUITournamentWnd+#BSw
	/// </summary>
    public partial class R__0__BSw : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.Animation #g
		/// </summary>
		protected RUnityEngine.RAnimation r___0__g;
		public virtual RUnityEngine.RAnimation R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__BSw() : base("MyGUITournamentWnd+#BSw")
        {
        }

        public R__0__BSw(System.Object instance) : base("MyGUITournamentWnd+#BSw")
		{
            SetInstance(instance);
		}

        public R__0__BSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__BSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

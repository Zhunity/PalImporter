...
{public partial class RMyGUITournamentWnd
{
	...
	/// <summary>
	/// MyGUITournamentWnd+#ASw
	/// </summary>
    public partial class R__0__ASw : RMember //
    {
		...
		/// <summary>
		/// MyGUITournamentWnd #e
		/// </summary>
		protected RMyGUITournamentWnd r___0__e;
		public virtual RMyGUITournamentWnd R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__ASw() : base("MyGUITournamentWnd+#ASw")
        {
        }

        public R__0__ASw(System.Object instance) : base("MyGUITournamentWnd+#ASw")
		{
            SetInstance(instance);
		}

        public R__0__ASw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ASw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RMyGUITournamentWnd
{
	...
	/// <summary>
	/// MyGUITournamentWnd+#dKh
	/// </summary>
    public partial class R__0__dKh : RMember //
    {
        ...
        public R__0__dKh() : base("MyGUITournamentWnd+#dKh")
        {
        }

        public R__0__dKh(System.Object instance) : base("MyGUITournamentWnd+#dKh")
		{
            SetInstance(instance);
		}

        public R__0__dKh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dKh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

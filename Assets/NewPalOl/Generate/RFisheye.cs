...
namespace SMFrame.Editor.Refleaction
{
	...
	/// Fisheye
	/// </summary>
    public partial class RFisheye : RMember //
    {

		/// <summary>
		/// UnityEngine.Material _fisheyeMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r__fisheyeMaterial;
		public virtual RUnityEngine.RMaterial R_fisheyeMaterial
		{
			get
			{
				if(r__fisheyeMaterial == null)
				{
					r__fisheyeMaterial = new(this, "_fisheyeMaterial");
					r__fisheyeMaterial.SetBelong(this.instance);
				}
				return r__fisheyeMaterial;
			}
		}

		/// <summary>
		/// UnityEngine.Shader fishEyeShader
		/// </summary>
		protected RUnityEngine.RShader r_fishEyeShader;
		public virtual RUnityEngine.RShader RfishEyeShader
		{
			get
			{
				if(r_fishEyeShader == null)
				{
					r_fishEyeShader = new(this, "fishEyeShader");
					r_fishEyeShader.SetBelong(this.instance);
				}
				return r_fishEyeShader;
			}
		}

		/// <summary>
		/// System.Single strengthX
		/// </summary>
		protected RField r_strengthX;
		public virtual RField RstrengthX
		{
			get
			{
				if(r_strengthX == null)
				{
					r_strengthX = new(this, "strengthX");
					r_strengthX.SetBelong(this.instance);
				}
				return r_strengthX;
			}
		}
		...
		/// <summary>
		/// System.Single strengthY
		/// </summary>
		protected RField r_strengthY;
		public virtual RField RstrengthY
		{
			get
			{
				if(r_strengthY == null)
				{
					r_strengthY = new(this, "strengthY");
					r_strengthY.SetBelong(this.instance);
				}
				return r_strengthY;
			}
		}
        ...
        public RFisheye() : base("Fisheye")
        {
        }

        public RFisheye(System.Object instance) : base("Fisheye")
		{
            SetInstance(instance);
		}

        public RFisheye(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RFisheye(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

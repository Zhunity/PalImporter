...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MyGUIWindowAssets
	/// </summary>
    public partial class RMyGUIWindowAssets : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.TextAsset UITextFile
		/// </summary>
		protected RUnityEngine.RTextAsset r_UITextFile;
		public virtual RUnityEngine.RTextAsset RUITextFile
		{
			get
			{
				if(r_UITextFile == null)
				{
					r_UITextFile = new(this, "UITextFile");
					r_UITextFile.SetBelong(this.instance);
				}
				return r_UITextFile;
			}
		}
		...
		/// <summary>
		/// UnityEngine.TextAsset UILayoutFile
		/// </summary>
		protected RUnityEngine.RTextAsset r_UILayoutFile;
		public virtual RUnityEngine.RTextAsset RUILayoutFile
		{
			get
			{
				if(r_UILayoutFile == null)
				{
					r_UILayoutFile = new(this, "UILayoutFile");
					r_UILayoutFile.SetBelong(this.instance);
				}
				return r_UILayoutFile;
			}
		}

		/// <summary>
		/// UnityEngine.Texture LoginBackGround
		/// </summary>
		protected RUnityEngine.RTexture r_LoginBackGround;
		public virtual RUnityEngine.RTexture RLoginBackGround
		{
			get
			{
				if(r_LoginBackGround == null)
				{
					r_LoginBackGround = new(this, "LoginBackGround");
					r_LoginBackGround.SetBelong(this.instance);
				}
				return r_LoginBackGround;
			}
		}
        ...
        public RMyGUIWindowAssets() : base("MyGUIWindowAssets")
        {
        }

        public RMyGUIWindowAssets(System.Object instance) : base("MyGUIWindowAssets")
		{
            SetInstance(instance);
		}

        public RMyGUIWindowAssets(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMyGUIWindowAssets(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

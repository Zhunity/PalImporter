...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MyGUIMeleeWnd
	/// </summary>
    public partial class RMyGUIMeleeWnd : RMember //
    {
		...
		/// <summary>
		/// MyGUIMeleeWnd+ChampionMsg #c
		/// </summary>
		protected RMyGUIMeleeWnd.RChampionMsg r___0__c;
		public virtual RMyGUIMeleeWnd.RChampionMsg R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// <summary>
		/// AvatarController+weaponInfo #e
		/// </summary>
		protected RAvatarController.RweaponInfo r___0__e;
		public virtual RAvatarController.RweaponInfo R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		public static R__0__u.R__0__IOc.R__0__LNb1 R__0__g
		{
			get
			{
				if(r___0__g == null)
				{
					r___0__g = new( ReleactionUtils.GetType("MyGUIMeleeWnd"), "#g");
		...
		/// <summary>
		/// Void #8Jh(Message.SCNetMsgMeleeLastChampion)
		/// </summary>
		protected RMethod r_R__0__8Jh_SCNetMsgMeleeLastChampion;
		public virtual RMethod R__0__8Jh_SCNetMsgMeleeLastChampion
		{
			get
			{
				if(r_R__0__8Jh_SCNetMsgMeleeLastChampion == null)
				{
					r_R__0__8Jh_SCNetMsgMeleeLastChampion = new(this, "#8Jh", 0,  ReleactionUtils.GetType("Message.SCNetMsgMeleeLastChampion"));
					r_R__0__8Jh_SCNetMsgMeleeLastChampion.SetBelong(this.instance);
				}
				return r_R__0__8Jh_SCNetMsgMeleeLastChampion;
			}
		}
		...
		/// Void #eNs(Boolean)
		/// </summary>
		protected RMethod r_R__0__eNs_Boolean;
		public virtual RMethod R__0__eNs_Boolean
		{
			get
			{
				if(r_R__0__eNs_Boolean == null)
				{
					r_R__0__eNs_Boolean = new(this, "#eNs", 0, typeof(System.Boolean));
					r_R__0__eNs_Boolean.SetBelong(this.instance);
				}
				return r_R__0__eNs_Boolean;
			}
		}
		...
		/// Void #S2s(Int32)
		/// </summary>
		protected RMethod r_R__0__S2s_Int32;
		public virtual RMethod R__0__S2s_Int32
		{
			get
			{
				if(r_R__0__S2s_Int32 == null)
				{
					r_R__0__S2s_Int32 = new(this, "#S2s", 0, typeof(System.Int32));
					r_R__0__S2s_Int32.SetBelong(this.instance);
				}
				return r_R__0__S2s_Int32;
			}
		}
		...
		/// <summary>
		/// Void #eex(System.Object)
		/// </summary>
		protected static RMethod r_R__0__eex_Object;
		public static RMethod R__0__eex_Object
		{
			get
			{
				if(r_R__0__eex_Object == null)
				{
					r_R__0__eex_Object = new( ReleactionUtils.GetType("MyGUIMeleeWnd"), "#eex", 0, typeof(System.Object));
					r_R__0__eex_Object.SetBelong(null);
				}
				return r_R__0__eex_Object;
			}
		}
        ...
        public RMyGUIMeleeWnd() : base("MyGUIMeleeWnd")
        {
        }

        public RMyGUIMeleeWnd(System.Object instance) : base("MyGUIMeleeWnd")
		{
            SetInstance(instance);
		}

        public RMyGUIMeleeWnd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMyGUIMeleeWnd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__eNs(System.Boolean  @bEnabled)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bEnabled};
            var ___result = R__0__eNs_Boolean.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__S2s(System.Int32  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time};
            var ___result = R__0__S2s_Int32.Invoke(___genericsType, ___parameters);
        ...
        public static void __0__eex(System.Object  @x)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@x};
            var ___result = R__0__eex_Object.Invoke(___genericsType, ___parameters);

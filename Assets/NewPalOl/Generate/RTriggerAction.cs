...
namespace SMFrame.Editor.Refleaction
{
	...
	/// TriggerAction
	/// </summary>
    public partial class RTriggerAction : RMember //
    {
        ...
        public RTriggerAction() : base("TriggerAction")
        {
        }

        public RTriggerAction(System.Object instance) : base("TriggerAction")
		{
            SetInstance(instance);
		}

        public RTriggerAction(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RTriggerAction(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

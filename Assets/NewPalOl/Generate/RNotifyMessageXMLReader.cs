...
{
	/// <summary>
	/// NotifyMessageXMLReader
	/// </summary>
    public partial class RNotifyMessageXMLReader : RMember //
    {

		/// <summary>
		/// GetKeyValueNotify NotifyCB
		/// </summary>
		protected RGetKeyValueNotify r_NotifyCB;
		public virtual RGetKeyValueNotify RNotifyCB
		{
			get
			{
				if(r_NotifyCB == null)
				{
					r_NotifyCB = new(this, "NotifyCB");
					r_NotifyCB.SetBelong(this.instance);
				}
				return r_NotifyCB;
			}
		}
		...
		/// <summary>
		/// GetKeyValueNotify RootAttributeCB
		/// </summary>
		protected RGetKeyValueNotify r_RootAttributeCB;
		public virtual RGetKeyValueNotify RootAttributeCB
		{
			get
			{
				if(r_RootAttributeCB == null)
				{
					r_RootAttributeCB = new(this, "RootAttributeCB");
					r_RootAttributeCB.SetBelong(this.instance);
				}
				return r_RootAttributeCB;
			}
		}
        ...
        public RNotifyMessageXMLReader() : base("NotifyMessageXMLReader")
        {
        }

        public RNotifyMessageXMLReader(System.Object instance) : base("NotifyMessageXMLReader")
		{
            SetInstance(instance);
		}

        public RNotifyMessageXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RNotifyMessageXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

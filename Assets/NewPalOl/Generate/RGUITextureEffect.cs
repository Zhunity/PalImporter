...
namespace SMFrame.Editor.Refleaction
{
	...
	/// GUITextureEffect
	/// </summary>
    public partial class RGUITextureEffect : RMember //
    {

		/// <summary>
		/// UnityEngine.Transform mTrans
		/// </summary>
		protected RUnityEngine.RTransform r_mTrans;
		public virtual RUnityEngine.RTransform RmTrans
		{
			get
			{
				if(r_mTrans == null)
				{
					r_mTrans = new(this, "mTrans");
					r_mTrans.SetBelong(this.instance);
				}
				return r_mTrans;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Rect mRect
		/// </summary>
		protected RUnityEngine.RRect r_mRect;
		public virtual RUnityEngine.RRect RmRect
		{
			get
			{
				if(r_mRect == null)
				{
					r_mRect = new(this, "mRect");
					r_mRect.SetBelong(this.instance);
				}
				return r_mRect;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Texture2D mTex
		/// </summary>
		protected RUnityEngine.RTexture2D r_mTex;
		public virtual RUnityEngine.RTexture2D RmTex
		{
			get
			{
				if(r_mTex == null)
				{
					r_mTex = new(this, "mTex");
					r_mTex.SetBelong(this.instance);
				}
				return r_mTex;
			}
		}
		...
		/// <summary>
		/// System.Boolean isFollowTarget
		/// </summary>
		protected RField r_isFollowTarget;
		public virtual RField RisFollowTarget
		{
			get
			{
				if(r_isFollowTarget == null)
				{
					r_isFollowTarget = new(this, "isFollowTarget");
					r_isFollowTarget.SetBelong(this.instance);
				}
				return r_isFollowTarget;
			}
		}

		/// <summary>
		/// System.Single mScale
		/// </summary>
		protected RField r_mScale;
		public virtual RField RmScale
		{
			get
			{
				if(r_mScale == null)
				{
					r_mScale = new(this, "mScale");
					r_mScale.SetBelong(this.instance);
				}
				return r_mScale;
			}
		}
		...
		/// UnityEngine.Rect rt
		/// </summary>
		protected RUnityEngine.RRect r_rt;
		public virtual RUnityEngine.RRect Rrt
		{
			get
			{
				if(r_rt == null)
		...
		/// <summary>
		/// UnityEngine.Vector3 tmpV
		/// </summary>
		protected RUnityEngine.RVector3 r_tmpV;
		public virtual RUnityEngine.RVector3 RtmpV
		{
			get
			{
				if(r_tmpV == null)
				{
					r_tmpV = new(this, "tmpV");
					r_tmpV.SetBelong(this.instance);
				}
				return r_tmpV;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Vector3 _PositionIn3D
		/// </summary>
		protected RUnityEngine.RVector3 r__PositionIn3D;
		public virtual RUnityEngine.RVector3 R_PositionIn3D
		{
			get
			{
				if(r__PositionIn3D == null)
				{
					r__PositionIn3D = new(this, "_PositionIn3D");
					r__PositionIn3D.SetBelong(this.instance);
				}
				return r__PositionIn3D;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Vector3 PositionIn3D
		/// </summary>
		protected RUnityEngine.RVector3 r_PositionIn3D;
		public virtual RUnityEngine.RVector3 RPositionIn3D
		{
			get
			{
				if(r_PositionIn3D == null)
				{
					r_PositionIn3D = new(this, "PositionIn3D", -1);
					r_PositionIn3D.SetBelong(this.instance);
				}
				return r_PositionIn3D;
			}
		}
		...
		/// <summary>
		/// Void SetGUITextureEffect(UnityEngine.Texture2D, UnityEngine.Transform)
		/// </summary>
		protected RMethod r_RSetGUITextureEffect_Texture2D_Transform;
		public virtual RMethod RSetGUITextureEffect_Texture2D_Transform
		{
			get
			{
				if(r_RSetGUITextureEffect_Texture2D_Transform == null)
				{
					r_RSetGUITextureEffect_Texture2D_Transform = new(this, "SetGUITextureEffect", 0, typeof(UnityEngine.Texture2D), typeof(UnityEngine.Transform));
					r_RSetGUITextureEffect_Texture2D_Transform.SetBelong(this.instance);
				}
				return r_RSetGUITextureEffect_Texture2D_Transform;
			}
		}

		/// <summary>
		/// Void SetGUITextureEffect(UnityEngine.Texture2D, UnityEngine.Vector3)
		/// </summary>
		protected RMethod r_RSetGUITextureEffect_Texture2D_Vector3;
		public virtual RMethod RSetGUITextureEffect_Texture2D_Vector3
		{
			get
			{
				if(r_RSetGUITextureEffect_Texture2D_Vector3 == null)
				{
					r_RSetGUITextureEffect_Texture2D_Vector3 = new(this, "SetGUITextureEffect", 0, typeof(UnityEngine.Texture2D), typeof(UnityEngine.Vector3));
					r_RSetGUITextureEffect_Texture2D_Vector3.SetBelong(this.instance);
				}
				return r_RSetGUITextureEffect_Texture2D_Vector3;
			}
		}

		/// <summary>
		/// Void SetGUITextureEffect(UnityEngine.Texture2D, UnityEngine.Transform, Boolean)
		/// </summary>
		protected RMethod r_RSetGUITextureEffect_Texture2D_Transform_Boolean;
		public virtual RMethod RSetGUITextureEffect_Texture2D_Transform_Boolean
		{
			get
			{
				if(r_RSetGUITextureEffect_Texture2D_Transform_Boolean == null)
				{
					r_RSetGUITextureEffect_Texture2D_Transform_Boolean = new(this, "SetGUITextureEffect", 0, typeof(UnityEngine.Texture2D), typeof(UnityEngine.Transform), typeof(System.Boolean));
					r_RSetGUITextureEffect_Texture2D_Transform_Boolean.SetBelong(this.instance);
				}
				return r_RSetGUITextureEffect_Texture2D_Transform_Boolean;
			}
		}
        ...
        public RGUITextureEffect() : base("GUITextureEffect")
        {
        }

        public RGUITextureEffect(System.Object instance) : base("GUITextureEffect")
		{
            SetInstance(instance);
		}

        public RGUITextureEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RGUITextureEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void SetGUITextureEffect(UnityEngine.Texture2D  @tex, UnityEngine.Transform  @trans)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@tex, @trans};
            var ___result = RSetGUITextureEffect_Texture2D_Transform.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void SetGUITextureEffect(UnityEngine.Texture2D  @tex, UnityEngine.Vector3  @pos)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@tex, @pos};
            var ___result = RSetGUITextureEffect_Texture2D_Vector3.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void SetGUITextureEffect(UnityEngine.Texture2D  @tex, UnityEngine.Transform  @trans, System.Boolean  @isFollow)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@tex, @trans, @isFollow};
            var ___result = RSetGUITextureEffect_Texture2D_Transform_Boolean.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SplinePathParams
	/// </summary>
    public partial class RSplinePathParams : RMember //
    {

		/// <summary>
		/// eWrapMode WrapMode
		/// </summary>
		protected RField r_WrapMode;
		public virtual RField RWrapMode
		{
			get
			{
				if(r_WrapMode == null)
				{
					r_WrapMode = new(this, "WrapMode");
		...
		/// </summary>
		protected RField r_OrientationMode;
		public virtual RField ROrientationMode
		{
			get
			{
				if(r_OrientationMode == null)
				{
					r_OrientationMode = new(this, "OrientationMode");
					r_OrientationMode.SetBelong(this.instance);
				}
				return r_OrientationMode;
			}
		}
		...
		/// </summary>
		protected RField r_AutoStart;
		public virtual RField RAutoStart
		{
			get
			{
				if(r_AutoStart == null)
				{
					r_AutoStart = new(this, "AutoStart");
					r_AutoStart.SetBelong(this.instance);
				}
				return r_AutoStart;
			}
		}
		...
		/// </summary>
		protected RField r_AutoClose;
		public virtual RField RAutoClose
		{
			get
			{
				if(r_AutoClose == null)
				{
					r_AutoClose = new(this, "AutoClose");
					r_AutoClose.SetBelong(this.instance);
				}
				return r_AutoClose;
			}
		}
		...
		/// <summary>
		/// System.Boolean HideOnExecute
		/// </summary>
		protected RField r_HideOnExecute;
		public virtual RField RHideOnExecute
		{
			get
			{
				if(r_HideOnExecute == null)
				{
					r_HideOnExecute = new(this, "HideOnExecute");
					r_HideOnExecute.SetBelong(this.instance);
				}
				return r_HideOnExecute;
			}
		}
        ...
        public RSplinePathParams() : base("SplinePathParams")
        {
        }

        public RSplinePathParams(System.Object instance) : base("SplinePathParams")
		{
            SetInstance(instance);
		}

        public RSplinePathParams(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSplinePathParams(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

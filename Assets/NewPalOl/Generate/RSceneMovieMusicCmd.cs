...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SceneMovieMusicCmd
	/// </summary>
    public partial class RSceneMovieMusicCmd : RMember //
    {
        ...
        public RSceneMovieMusicCmd() : base("SceneMovieMusicCmd")
        {
        }

        public RSceneMovieMusicCmd(System.Object instance) : base("SceneMovieMusicCmd")
		{
            SetInstance(instance);
		}

        public RSceneMovieMusicCmd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSceneMovieMusicCmd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

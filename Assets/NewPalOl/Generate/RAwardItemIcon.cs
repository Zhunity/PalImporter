...
namespace SMFrame.Editor.Refleaction
{
	...
	/// AwardItemIcon
	/// </summary>
    public partial class RAwardItemIcon : RMember //
    {
        ...
        public RAwardItemIcon() : base("AwardItemIcon")
        {
        }

        public RAwardItemIcon(System.Object instance) : base("AwardItemIcon")
		{
            SetInstance(instance);
		}

        public RAwardItemIcon(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAwardItemIcon(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// GUITextObj
	/// </summary>
    public partial class RGUITextObj : RMember //
    {
        ...
        public RGUITextObj() : base("GUITextObj")
        {
        }

        public RGUITextObj(System.Object instance) : base("GUITextObj")
		{
            SetInstance(instance);
		}

        public RGUITextObj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RGUITextObj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

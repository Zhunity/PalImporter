...
namespace SMFrame.Editor.Refleaction
{
	...
	/// dice
	/// </summary>
    public partial class Rdice : RMember //
    {

		/// <summary>
		/// UnityEngine.Vector3[] _sides
		/// </summary>
		protected RFieldArray<RUnityEngine.RVector3> r__sides;
		public virtual RFieldArray<RUnityEngine.RVector3> R_sides
		{
			get
			{
				if(r__sides == null)
				{
					r__sides = new(this, "_sides");
					r__sides.SetBelong(this.instance);
				}
				return r__sides;
			}
		}
		...
		/// <summary>
		/// System.Boolean _isSleeping
		/// </summary>
		protected RField r__isSleeping;
		public virtual RField R_isSleeping
		{
			get
			{
				if(r__isSleeping == null)
				{
					r__isSleeping = new(this, "_isSleeping");
					r__isSleeping.SetBelong(this.instance);
				}
				return r__isSleeping;
			}
		}

		/// <summary>
		/// System.Boolean bStart
		/// </summary>
		protected RField r_bStart;
		public virtual RField RbStart
		{
			get
			{
				if(r_bStart == null)
				{
					r_bStart = new(this, "bStart");
					r_bStart.SetBelong(this.instance);
				}
				return r_bStart;
			}
		}
		...
		/// <summary>
		/// System.Int32 wantedresult
		/// </summary>
		protected RField r_wantedresult;
		public virtual RField Rwantedresult
		{
			get
			{
				if(r_wantedresult == null)
				{
					r_wantedresult = new(this, "wantedresult");
					r_wantedresult.SetBelong(this.instance);
				}
				return r_wantedresult;
			}
		}
		...
		/// Int32 WhichIsUp()
		/// </summary>
		protected RMethod r_RWhichIsUp;
		public virtual RMethod RWhichIsUp
		{
			get
			{
				if(r_RWhichIsUp == null)
				{
					r_RWhichIsUp = new(this, "WhichIsUp", 0);
					r_RWhichIsUp.SetBelong(this.instance);
				}
				return r_RWhichIsUp;
			}
		}
		...
		/// Boolean IsAtRest()
		/// </summary>
		protected RMethod r_RIsAtRest;
		public virtual RMethod RIsAtRest
		{
			get
			{
				if(r_RIsAtRest == null)
				{
					r_RIsAtRest = new(this, "IsAtRest", 0);
					r_RIsAtRest.SetBelong(this.instance);
				}
				return r_RIsAtRest;
			}
		}
        ...
        public Rdice() : base("dice")
        {
        }

        public Rdice(System.Object instance) : base("dice")
		{
            SetInstance(instance);
		}

        public Rdice(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public Rdice(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Int32 WhichIsUp()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RWhichIsUp.Invoke(___genericsType, ___parameters);

            return (System.Int32)___result;
        }


        public virtual System.Boolean IsAtRest()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RIsAtRest.Invoke(___genericsType, ___parameters);

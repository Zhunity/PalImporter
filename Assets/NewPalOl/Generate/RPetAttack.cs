...
namespace SMFrame.Editor.Refleaction
{
	...
	/// PetAttack
	/// </summary>
    public partial class RPetAttack : RMember //
    {

		/// <summary>
		/// GameDefineType.ID idSkill
		/// </summary>
		protected RGameDefineType.RID r_idSkill;
		public virtual RGameDefineType.RID RidSkill
		{
			get
			{
				if(r_idSkill == null)
				{
					r_idSkill = new(this, "idSkill");
					r_idSkill.SetBelong(this.instance);
				}
				return r_idSkill;
			}
		}
        ...
        public RPetAttack() : base("PetAttack")
        {
        }

        public RPetAttack(System.Object instance) : base("PetAttack")
		{
            SetInstance(instance);
		}

        public RPetAttack(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPetAttack(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

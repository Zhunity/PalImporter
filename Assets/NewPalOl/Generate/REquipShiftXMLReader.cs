...
namespace SMFrame.Editor.Refleaction
{
	...
	/// EquipShiftXMLReader
	/// </summary>
    public partial class REquipShiftXMLReader : RMember //
    {
        ...
        public REquipShiftXMLReader() : base("EquipShiftXMLReader")
        {
        }

        public REquipShiftXMLReader(System.Object instance) : base("EquipShiftXMLReader")
		{
            SetInstance(instance);
		}

        public REquipShiftXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REquipShiftXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

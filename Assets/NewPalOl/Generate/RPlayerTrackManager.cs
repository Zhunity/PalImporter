...
namespace SMFrame.Editor.Refleaction
{
	...
	/// PlayerTrackManager
	/// </summary>
    public partial class RPlayerTrackManager : RMember //
    {
        ...
        public RPlayerTrackManager() : base("PlayerTrackManager")
        {
        }

        public RPlayerTrackManager(System.Object instance) : base("PlayerTrackManager")
		{
            SetInstance(instance);
		}

        public RPlayerTrackManager(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPlayerTrackManager(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

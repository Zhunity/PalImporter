...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ChampionBehav
	/// </summary>
    public partial class RChampionBehav : RMember //
    {
		...
		/// <summary>
		/// System.Int32 m_ServerNameHalfLength
		/// </summary>
		protected RField r_m_ServerNameHalfLength;
		public virtual RField Rm_ServerNameHalfLength
		{
			get
			{
				if(r_m_ServerNameHalfLength == null)
				{
					r_m_ServerNameHalfLength = new(this, "m_ServerNameHalfLength");
					r_m_ServerNameHalfLength.SetBelong(this.instance);
				}
				return r_m_ServerNameHalfLength;
			}
		}
		...
		/// <summary>
		/// System.Single m_fTipWitdh
		/// </summary>
		protected RField r_m_fTipWitdh;
		public virtual RField Rm_fTipWitdh
		{
			get
			{
				if(r_m_fTipWitdh == null)
				{
					r_m_fTipWitdh = new(this, "m_fTipWitdh");
					r_m_fTipWitdh.SetBelong(this.instance);
				}
				return r_m_fTipWitdh;
			}
		}

		/// <summary>
		/// System.Single m_fTipWitdh2
		/// </summary>
		protected RField r_m_fTipWitdh2;
		public virtual RField Rm_fTipWitdh2
		{
			get
			{
				if(r_m_fTipWitdh2 == null)
				{
					r_m_fTipWitdh2 = new(this, "m_fTipWitdh2");
					r_m_fTipWitdh2.SetBelong(this.instance);
				}
				return r_m_fTipWitdh2;
			}
		}

		/// <summary>
		/// System.String m_sTip
		/// </summary>
		protected RField r_m_sTip;
		public virtual RField Rm_sTip
		{
			get
			{
				if(r_m_sTip == null)
				{
					r_m_sTip = new(this, "m_sTip");
					r_m_sTip.SetBelong(this.instance);
				}
				return r_m_sTip;
			}
		}
		...
		/// <summary>
		/// System.String m_sTip2
		/// </summary>
		protected RField r_m_sTip2;
		public virtual RField Rm_sTip2
		{
			get
			{
				if(r_m_sTip2 == null)
				{
					r_m_sTip2 = new(this, "m_sTip2");
					r_m_sTip2.SetBelong(this.instance);
				}
				return r_m_sTip2;
			}
		}
		...
		/// <summary>
		/// System.Boolean m_bInTournament
		/// </summary>
		protected RField r_m_bInTournament;
		public virtual RField Rm_bInTournament
		{
			get
			{
				if(r_m_bInTournament == null)
				{
					r_m_bInTournament = new(this, "m_bInTournament");
					r_m_bInTournament.SetBelong(this.instance);
				}
				return r_m_bInTournament;
			}
		}

		/// <summary>
		/// System.String m_sServerName
		/// </summary>
		protected RField r_m_sServerName;
		public virtual RField Rm_sServerName
		{
			get
			{
				if(r_m_sServerName == null)
				{
					r_m_sServerName = new(this, "m_sServerName");
					r_m_sServerName.SetBelong(this.instance);
				}
				return r_m_sServerName;
			}
		}
		...
		/// <summary>
		/// GameDefineType.ID m_TitleID
		/// </summary>
		protected RGameDefineType.RID r_m_TitleID;
		public virtual RGameDefineType.RID Rm_TitleID
		{
			get
			{
				if(r_m_TitleID == null)
				{
					r_m_TitleID = new(this, "m_TitleID");
					r_m_TitleID.SetBelong(this.instance);
				}
				return r_m_TitleID;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Texture m_TitleIcon
		/// </summary>
		protected RUnityEngine.RTexture r_m_TitleIcon;
		public virtual RUnityEngine.RTexture Rm_TitleIcon
		{
			get
			{
				if(r_m_TitleIcon == null)
				{
					r_m_TitleIcon = new(this, "m_TitleIcon");
					r_m_TitleIcon.SetBelong(this.instance);
				}
				return r_m_TitleIcon;
			}
		}
		...
		/// <summary>
		/// System.Boolean m_bReceiveMouseDown
		/// </summary>
		protected RField r_m_bReceiveMouseDown;
		public virtual RField Rm_bReceiveMouseDown
		{
			get
			{
				if(r_m_bReceiveMouseDown == null)
				{
					r_m_bReceiveMouseDown = new(this, "m_bReceiveMouseDown");
					r_m_bReceiveMouseDown.SetBelong(this.instance);
				}
				return r_m_bReceiveMouseDown;
			}
		}

		/// <summary>
		/// UnityEngine.Vector2 m_vStatus
		/// </summary>
		protected RUnityEngine.RVector2 r_m_vStatus;
		public virtual RUnityEngine.RVector2 Rm_vStatus
		{
			get
			{
				if(r_m_vStatus == null)
				{
					r_m_vStatus = new(this, "m_vStatus");
					r_m_vStatus.SetBelong(this.instance);
				}
				return r_m_vStatus;
			}
		}
		...
		/// <summary>
		/// MyGUIFormationWnd m_FormationWnd
		/// </summary>
		protected RMyGUIFormationWnd r_m_FormationWnd;
		public virtual RMyGUIFormationWnd Rm_FormationWnd
		{
			get
			{
				if(r_m_FormationWnd == null)
				{
					r_m_FormationWnd = new(this, "m_FormationWnd");
					r_m_FormationWnd.SetBelong(this.instance);
				}
				return r_m_FormationWnd;
			}
		}

		/// <summary>
		/// MyGUITournamentWnd m_TournamentWnd
		/// </summary>
		protected RMyGUITournamentWnd r_m_TournamentWnd;
		public virtual RMyGUITournamentWnd Rm_TournamentWnd
		{
			get
			{
				if(r_m_TournamentWnd == null)
				{
					r_m_TournamentWnd = new(this, "m_TournamentWnd");
					r_m_TournamentWnd.SetBelong(this.instance);
				}
				return r_m_TournamentWnd;
			}
		}
		...
		/// </summary>
		protected RProperty r_IsInTournament;
		public virtual RProperty RIsInTournament
		{
			get
			{
				if(r_IsInTournament == null)
				{
					r_IsInTournament = new(this, "IsInTournament", -1);
					r_IsInTournament.SetBelong(this.instance);
				}
				return r_IsInTournament;
			}
		}
		...
		/// </summary>
		protected RProperty r_ServerName;
		public virtual RProperty RServerName
		{
			get
			{
				if(r_ServerName == null)
				{
					r_ServerName = new(this, "ServerName", -1);
					r_ServerName.SetBelong(this.instance);
				}
				return r_ServerName;
			}
		}
		...
		/// <summary>
		/// GameDefineType.ID TitleID
		/// </summary>
		protected RGameDefineType.RID r_TitleID;
		public virtual RGameDefineType.RID RTitleID
		{
			get
			{
				if(r_TitleID == null)
				{
					r_TitleID = new(this, "TitleID", -1);
		...
		/// <summary>
		/// MyGUIFormationWnd FormationWnd
		/// </summary>
		protected RMyGUIFormationWnd r_FormationWnd;
		public virtual RMyGUIFormationWnd RFormationWnd
		{
			get
			{
				if(r_FormationWnd == null)
				{
					r_FormationWnd = new(this, "FormationWnd", -1);
					r_FormationWnd.SetBelong(this.instance);
				}
				return r_FormationWnd;
			}
		}

		/// <summary>
		/// MyGUITournamentWnd TournamentWnd
		/// </summary>
		protected RMyGUITournamentWnd r_TournamentWnd;
		public virtual RMyGUITournamentWnd RTournamentWnd
		{
			get
			{
				if(r_TournamentWnd == null)
				{
					r_TournamentWnd = new(this, "TournamentWnd", -1);
					r_TournamentWnd.SetBelong(this.instance);
				}
				return r_TournamentWnd;
			}
		}
        ...
        public RChampionBehav() : base("ChampionBehav")
        {
        }

        public RChampionBehav(System.Object instance) : base("ChampionBehav")
		{
            SetInstance(instance);
		}

        public RChampionBehav(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RChampionBehav(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// BubbleObject
	/// </summary>
    public partial class RBubbleObject : RMember //
    {

		/// <summary>
		/// MyGUI.ColorTextArea _ColorArea
		/// </summary>
		protected RMyGUI.RColorTextArea r__ColorArea;
		public virtual RMyGUI.RColorTextArea R_ColorArea
		{
			get
			{
				if(r__ColorArea == null)
				{
					r__ColorArea = new(this, "_ColorArea");
					r__ColorArea.SetBelong(this.instance);
				}
				return r__ColorArea;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Rect _screenRect
		/// </summary>
		protected RUnityEngine.RRect r__screenRect;
		public virtual RUnityEngine.RRect R_screenRect
		{
			get
			{
				if(r__screenRect == null)
				{
					r__screenRect = new(this, "_screenRect");
					r__screenRect.SetBelong(this.instance);
				}
				return r__screenRect;
			}
		}

		/// <summary>
		/// UnityEngine.Rect _localRect
		/// </summary>
		protected RUnityEngine.RRect r__localRect;
		public virtual RUnityEngine.RRect R_localRect
		{
			get
			{
				if(r__localRect == null)
				{
					r__localRect = new(this, "_localRect");
					r__localRect.SetBelong(this.instance);
				}
				return r__localRect;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Rect _ContentRect
		/// </summary>
		protected RUnityEngine.RRect r__ContentRect;
		public virtual RUnityEngine.RRect R_ContentRect
		{
			get
			{
				if(r__ContentRect == null)
				{
					r__ContentRect = new(this, "_ContentRect");
					r__ContentRect.SetBelong(this.instance);
				}
				return r__ContentRect;
			}
		}
		...
		/// System.String _text
		/// </summary>
		protected RField r__text;
		public virtual RField R_text
		{
			get
			{
				if(r__text == null)
				{
					r__text = new(this, "_text");
					r__text.SetBelong(this.instance);
				}
				return r__text;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RColor r__color;
		public virtual RUnityEngine.RColor R_color
		{
			get
			{
				if(r__color == null)
				{
					r__color = new(this, "_color");
					r__color.SetBelong(this.instance);
				}
				return r__color;
			}
		}
		...
		/// <summary>
		/// System.Single _lifeTime
		/// </summary>
		protected RField r__lifeTime;
		public virtual RField R_lifeTime
		{
			get
			{
				if(r__lifeTime == null)
				{
					r__lifeTime = new(this, "_lifeTime");
					r__lifeTime.SetBelong(this.instance);
				}
				return r__lifeTime;
			}
		}
		...
		/// <summary>
		/// System.Int32 appearSpd
		/// </summary>
		protected RField r_appearSpd;
		public virtual RField RappearSpd
		{
			get
			{
				if(r_appearSpd == null)
				{
					r_appearSpd = new(this, "appearSpd");
					r_appearSpd.SetBelong(this.instance);
				}
				return r_appearSpd;
			}
		}
		...
		/// Void BubbleUp()
		/// </summary>
		protected RMethod r_RBubbleUp;
		public virtual RMethod RBubbleUp
		{
			get
			{
				if(r_RBubbleUp == null)
				{
					r_RBubbleUp = new(this, "BubbleUp", 0);
					r_RBubbleUp.SetBelong(this.instance);
				}
				return r_RBubbleUp;
			}
		}
		...
		/// <summary>
		/// Void Init(System.String, UnityEngine.Rect)
		/// </summary>
		protected RMethod r_RInit_String_Rect;
		public virtual RMethod RInit_String_Rect
		{
			get
			{
				if(r_RInit_String_Rect == null)
				{
					r_RInit_String_Rect = new(this, "Init", 0, typeof(System.String), typeof(UnityEngine.Rect));
					r_RInit_String_Rect.SetBelong(this.instance);
				}
				return r_RInit_String_Rect;
			}
		}

		/// <summary>
		/// Void Init(System.String, Single, UnityEngine.GUIStyle)
		/// </summary>
		protected RMethod r_RInit_String_Single_GUIStyle;
		public virtual RMethod RInit_String_Single_GUIStyle
		{
			get
			{
				if(r_RInit_String_Single_GUIStyle == null)
				{
					r_RInit_String_Single_GUIStyle = new(this, "Init", 0, typeof(System.String), typeof(System.Single), typeof(UnityEngine.GUIStyle));
					r_RInit_String_Single_GUIStyle.SetBelong(this.instance);
				}
				return r_RInit_String_Single_GUIStyle;
			}
		}

		/// <summary>
		/// Void Draw(UnityEngine.Vector2)
		/// </summary>
		protected RMethod r_RDraw_Vector2;
		public virtual RMethod RDraw_Vector2
		{
			get
			{
				if(r_RDraw_Vector2 == null)
				{
					r_RDraw_Vector2 = new(this, "Draw", 0, typeof(UnityEngine.Vector2));
					r_RDraw_Vector2.SetBelong(this.instance);
				}
				return r_RDraw_Vector2;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator Appear()
		/// </summary>
		protected RMethod r_RAppear;
		public virtual RMethod RAppear
		{
			get
			{
				if(r_RAppear == null)
				{
					r_RAppear = new(this, "Appear", 0);
					r_RAppear.SetBelong(this.instance);
				}
				return r_RAppear;
			}
		}
		...
		/// </summary>
		protected RMethod r_RDisappear;
		public virtual RMethod RDisappear
		{
			get
			{
				if(r_RDisappear == null)
				{
					r_RDisappear = new(this, "Disappear", 0);
					r_RDisappear.SetBelong(this.instance);
				}
				return r_RDisappear;
			}
		}
		...
		/// Void DestroyBubble()
		/// </summary>
		protected RMethod r_RDestroyBubble;
		public virtual RMethod RDestroyBubble
		{
			get
			{
				if(r_RDestroyBubble == null)
				{
					r_RDestroyBubble = new(this, "DestroyBubble", 0);
					r_RDestroyBubble.SetBelong(this.instance);
				}
				return r_RDestroyBubble;
			}
		}
        ...
        public RBubbleObject() : base("BubbleObject")
        {
        }

        public RBubbleObject(System.Object instance) : base("BubbleObject")
		{
            SetInstance(instance);
		}

        public RBubbleObject(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBubbleObject(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void BubbleUp()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RBubbleUp.Invoke(___genericsType, ___parameters);
        ...
        public virtual void Init(System.String  @text, UnityEngine.Rect  @rt)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text, @rt};
            var ___result = RInit_String_Rect.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void Init(System.String  @text, System.Single  @time, UnityEngine.GUIStyle  @guistyle)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text, @time, @guistyle};
            var ___result = RInit_String_Single_GUIStyle.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void Draw(UnityEngine.Vector2  @pos)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pos};
            var ___result = RDraw_Vector2.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator Appear()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RAppear.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual System.Collections.IEnumerator Disappear()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RDisappear.Invoke(___genericsType, ___parameters);
        ...
        public virtual void DestroyBubble()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RDestroyBubble.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// LocatedToBone
	/// </summary>
    public partial class RLocatedToBone : RMember //
    {

		/// <summary>
		/// System.String mBoneName
		/// </summary>
		protected RField r_mBoneName;
		public virtual RField RmBoneName
		{
			get
			{
				if(r_mBoneName == null)
				{
					r_mBoneName = new(this, "mBoneName");
					r_mBoneName.SetBelong(this.instance);
				}
				return r_mBoneName;
			}
		}
        ...
        public RLocatedToBone() : base("LocatedToBone")
        {
        }

        public RLocatedToBone(System.Object instance) : base("LocatedToBone")
		{
            SetInstance(instance);
		}

        public RLocatedToBone(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RLocatedToBone(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

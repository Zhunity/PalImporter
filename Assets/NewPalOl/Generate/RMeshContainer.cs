...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MeshContainer
	/// </summary>
    public partial class RMeshContainer : RMember //
    {
        ...
        public RMeshContainer() : base("MeshContainer")
        {
        }

        public RMeshContainer(System.Object instance) : base("MeshContainer")
		{
            SetInstance(instance);
		}

        public RMeshContainer(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMeshContainer(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

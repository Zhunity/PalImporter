...
namespace SMFrame.Editor.Refleaction
{
	...
	/// DayNightTimeSetting
	/// </summary>
    public partial class RDayNightTimeSetting : RMember //
    {

		/// <summary>
		/// ComponentFieldItween[] allComponentFieldItween
		/// </summary>
		protected RFieldArray<RComponentFieldItween> r_allComponentFieldItween;
		public virtual RFieldArray<RComponentFieldItween> RallComponentFieldItween
		{
			get
			{
				if(r_allComponentFieldItween == null)
				{
					r_allComponentFieldItween = new(this, "allComponentFieldItween");
					r_allComponentFieldItween.SetBelong(this.instance);
				}
				return r_allComponentFieldItween;
			}
		}

		/// <summary>
		/// System.Int32 dayTime
		/// </summary>
		protected RField r_dayTime;
		public virtual RField RdayTime
		{
			get
			{
				if(r_dayTime == null)
				{
					r_dayTime = new(this, "dayTime");
					r_dayTime.SetBelong(this.instance);
				}
				return r_dayTime;
			}
		}
		...
		/// <summary>
		/// System.Int32 timeOld
		/// </summary>
		protected RField r_timeOld;
		public virtual RField RtimeOld
		{
			get
			{
				if(r_timeOld == null)
				{
					r_timeOld = new(this, "timeOld");
					r_timeOld.SetBelong(this.instance);
				}
				return r_timeOld;
			}
		}
        ...
        public RDayNightTimeSetting() : base("DayNightTimeSetting")
        {
        }

        public RDayNightTimeSetting(System.Object instance) : base("DayNightTimeSetting")
		{
            SetInstance(instance);
		}

        public RDayNightTimeSetting(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RDayNightTimeSetting(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

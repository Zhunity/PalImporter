...
{public partial class RMyGUIFormationWnd
{
	
	/// <summary>
	/// MyGUIFormationWnd+#hRw
	/// </summary>
    public partial class R__0__hRw : RMember //
    {
		...
		/// RuneItem #c
		/// </summary>
		protected RRuneItem r___0__c;
		public virtual RRuneItem R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1[#oU.#I1] #d
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__oU.R__0__I1> r___0__d;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__oU.R__0__I1> R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// <summary>
		/// UnityEngine.Vector3 #g
		/// </summary>
		protected RUnityEngine.RVector3 r___0__g;
		public virtual RUnityEngine.RVector3 R__0__g
		{
			get
			{
				if(r___0__g == null)
		...
		/// </summary>
		protected RUnityEngine.RVector3 r___0__h;
		public virtual RUnityEngine.RVector3 R__0__h
		{
			get
			{
				if(r___0__h == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1+Enumerator[#oU.#I1] #j
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RField>.REnumerator r___0__j;
		public virtual RSystem.RCollections.RGeneric.RList<RField>.REnumerator R__0__j
		{
			get
			{
				if(r___0__j == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1+Enumerator[#oU.#I1] #l
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RField>.REnumerator r___0__l;
		public virtual RSystem.RCollections.RGeneric.RList<RField>.REnumerator R__0__l
		{
			get
			{
				if(r___0__l == null)
		...
		/// System.Object #o
		/// </summary>
		protected RSystem.RObject r___0__o;
		public virtual RSystem.RObject R__0__o
		{
			get
			{
				if(r___0__o == null)
		...
		/// </summary>
		protected RUnityEngine.RVector3 r___0__r;
		public virtual RUnityEngine.RVector3 R__0__r
		{
			get
			{
				if(r___0__r == null)
		...
		/// MyGUIFormationWnd #s
		/// </summary>
		protected RMyGUIFormationWnd r___0__s;
		public virtual RMyGUIFormationWnd R__0__s
		{
			get
			{
				if(r___0__s == null)
        ...
        public R__0__hRw() : base("MyGUIFormationWnd+#hRw")
        {
        }

        public R__0__hRw(System.Object instance) : base("MyGUIFormationWnd+#hRw")
		{
            SetInstance(instance);
		}

        public R__0__hRw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hRw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

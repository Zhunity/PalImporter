...
{public partial class RMyGUIFormationWnd
{
	...
	/// <summary>
	/// MyGUIFormationWnd+#gRw
	/// </summary>
    public partial class R__0__gRw : RMember //
    {
		...
		/// <summary>
		/// TimedObjectDestructor #c
		/// </summary>
		protected RTimedObjectDestructor r___0__c;
		public virtual RTimedObjectDestructor R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// MyGUIFormationWnd #f
		/// </summary>
		protected RMyGUIFormationWnd r___0__f;
		public virtual RMyGUIFormationWnd R__0__f
		{
			get
			{
				if(r___0__f == null)
        ...
        public R__0__gRw() : base("MyGUIFormationWnd+#gRw")
        {
        }

        public R__0__gRw(System.Object instance) : base("MyGUIFormationWnd+#gRw")
		{
            SetInstance(instance);
		}

        public R__0__gRw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gRw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

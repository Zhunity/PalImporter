...
namespace SMFrame.Editor.Refleaction.R__0__oU
{
	...
	/// #oU.#T3
	/// </summary>
    public partial class R__0__T3 : RMember //
    {
        ...
        public R__0__T3() : base("#oU.#T3")
        {
        }

        public R__0__T3(System.Object instance) : base("#oU.#T3")
		{
            SetInstance(instance);
		}

        public R__0__T3(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__T3(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

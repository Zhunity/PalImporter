...
namespace SMFrame.Editor.Refleaction.R__0__oU
{
	...
	/// #oU.#8X
	/// </summary>
    public partial class R__0__8X : RMember //
    {
        ...
        public R__0__8X() : base("#oU.#8X")
        {
        }

        public R__0__8X(System.Object instance) : base("#oU.#8X")
		{
            SetInstance(instance);
		}

        public R__0__8X(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8X(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

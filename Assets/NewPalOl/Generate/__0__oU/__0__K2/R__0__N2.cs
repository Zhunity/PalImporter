...
{public partial class R__0__K2
{
	...
	/// #oU.#K2+#N2
	/// </summary>
    public partial class R__0__N2 : RMember //
    {

		/// <summary>
		/// MyGUI.ElementBase+EventHandlingEnum #a
		/// </summary>
		...
		/// <summary>
		/// MyGUI.ElementBase+#6X #i
		/// </summary>
		protected RMyGUI.RElementBase.R__0__6X r___0__i;
		public virtual RMyGUI.RElementBase.R__0__6X R__0__i
		{
			get
			{
				if(r___0__i == null)
        ...
        public R__0__N2() : base("#oU.#K2+#N2")
        {
        }

        public R__0__N2(System.Object instance) : base("#oU.#K2+#N2")
		{
            SetInstance(instance);
		}

        public R__0__N2(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__N2(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

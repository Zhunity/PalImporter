...
{public partial class R__0__K2
{
	...
	/// #oU.#K2+#dOb
	/// </summary>
    public partial class R__0__dOb : RMember //
    {
        ...
        public R__0__dOb() : base("#oU.#K2+#dOb")
        {
        }

        public R__0__dOb(System.Object instance) : base("#oU.#K2+#dOb")
		{
            SetInstance(instance);
		}

        public R__0__dOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(MyGUI.ElementBase  @element)
        {
        ...
        public virtual System.IAsyncResult BeginInvoke(MyGUI.ElementBase  @element, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@element, @callback, @object};

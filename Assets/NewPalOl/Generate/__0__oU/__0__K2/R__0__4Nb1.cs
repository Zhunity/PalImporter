...
{public partial class R__0__K2
{
	
	/// <summary>
	/// #oU.#K2+#4Nb1
	/// </summary>
    public partial class R__0__4Nb1 : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(MyGUI.DragDropInfo)
		/// </summary>
		protected RMethod r_RInvoke_DragDropInfo;
		public virtual RMethod RInvoke_DragDropInfo
		{
			get
			{
				if(r_RInvoke_DragDropInfo == null)
				{
					r_RInvoke_DragDropInfo = new(this, "Invoke", 0, typeof(MyGUI.DragDropInfo));
					r_RInvoke_DragDropInfo.SetBelong(this.instance);
				}
				return r_RInvoke_DragDropInfo;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(MyGUI.DragDropInfo, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_DragDropInfo_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_DragDropInfo_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_DragDropInfo_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_DragDropInfo_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(MyGUI.DragDropInfo), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_DragDropInfo_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_DragDropInfo_AsyncCallback_Object;
			}
		}
        ...
        public R__0__4Nb1() : base("#oU.#K2+#4Nb1")
        {
        }

        public R__0__4Nb1(System.Object instance) : base("#oU.#K2+#4Nb1")
		{
            SetInstance(instance);
		}

        public R__0__4Nb1(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4Nb1(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(MyGUI.DragDropInfo  @dragInfo)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@dragInfo};
            var ___result = RInvoke_DragDropInfo.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(MyGUI.DragDropInfo  @dragInfo, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@dragInfo, @callback, @object};
            var ___result = RBeginInvoke_DragDropInfo_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

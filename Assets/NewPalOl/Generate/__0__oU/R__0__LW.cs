...
namespace SMFrame.Editor.Refleaction.R__0__oU
{
	...
	/// #oU.#LW
	/// </summary>
    public partial class R__0__LW : RMember //
    {
		...
		/// Boolean IsValiable
		/// </summary>
		protected RProperty r_R__0__HW;
		public virtual RProperty R__0__HW
		{
			get
			{
				if(r_R__0__HW == null)
				{
					r_R__0__HW = new(this, "IsValiable", -1);
		...
		/// <summary>
		/// Void #JW(UnityEngine.GUIStyle)
		/// </summary>
		protected RMethod r_R__0__JW_GUIStyle;
		public virtual RMethod R__0__JW_GUIStyle
		{
			get
			{
				if(r_R__0__JW_GUIStyle == null)
				{
					r_R__0__JW_GUIStyle = new(this, "#JW", 0, typeof(UnityEngine.GUIStyle));
					r_R__0__JW_GUIStyle.SetBelong(this.instance);
				}
				return r_R__0__JW_GUIStyle;
			}
		}

		/// <summary>
		/// UnityEngine.Color #KW()
		/// </summary>
		protected RMethod r_R__0__KW;
		public virtual RMethod R__0__KW
		{
			get
			{
				if(r_R__0__KW == null)
				{
					r_R__0__KW = new(this, "#KW", 0);
        ...
        public R__0__LW() : base("#oU.#LW")
        {
        }

        public R__0__LW(System.Object instance) : base("#oU.#LW")
		{
            SetInstance(instance);
		}

        public R__0__LW(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__LW(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__JW(UnityEngine.GUIStyle  @style)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@style};
            var ___result = R__0__JW_GUIStyle.Invoke(___genericsType, ___parameters);

            
        }


        public virtual UnityEngine.Color __0__KW()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__KW.Invoke(___genericsType, ___parameters);

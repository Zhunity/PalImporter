...
{public partial class R__0__05
{
	...
	/// #oU.#05+#eOb
	/// </summary>
    public partial class R__0__eOb : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(#O2, Boolean)
		/// </summary>
		protected RMethod r_RInvoke___0__O2_Boolean;
		public virtual RMethod RInvoke___0__O2_Boolean
		{
			get
			{
				if(r_RInvoke___0__O2_Boolean == null)
				{
					r_RInvoke___0__O2_Boolean = new(this, "Invoke", 0,  ReleactionUtils.GetType("#oU.#K2+#O2"), typeof(System.Boolean));
					r_RInvoke___0__O2_Boolean.SetBelong(this.instance);
				}
				return r_RInvoke___0__O2_Boolean;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(#O2, Boolean, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke___0__O2_Boolean_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke___0__O2_Boolean_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke___0__O2_Boolean_AsyncCallback_Object == null)
				{
					r_RBeginInvoke___0__O2_Boolean_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("#oU.#K2+#O2"), typeof(System.Boolean), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke___0__O2_Boolean_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke___0__O2_Boolean_AsyncCallback_Object;
			}
		}
        ...
        public R__0__eOb() : base("#oU.#05+#eOb")
        {
        }

        public R__0__eOb(System.Object instance) : base("#oU.#05+#eOb")
		{
            SetInstance(instance);
		}

        public R__0__eOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__eOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__05
{
	
	/// <summary>
	/// #oU.#05+#Jqd
	/// </summary>
    public partial class R__0__Jqd : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Object, UnityEngine.Vector2)
		/// </summary>
		protected RMethod r_RInvoke_Object_Vector2;
		public virtual RMethod RInvoke_Object_Vector2
		{
			get
			{
				if(r_RInvoke_Object_Vector2 == null)
				{
					r_RInvoke_Object_Vector2 = new(this, "Invoke", 0, typeof(System.Object), typeof(UnityEngine.Vector2));
					r_RInvoke_Object_Vector2.SetBelong(this.instance);
				}
				return r_RInvoke_Object_Vector2;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, UnityEngine.Vector2, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Object_Vector2_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object_Vector2_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object_Vector2_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object_Vector2_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object), typeof(UnityEngine.Vector2), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object_Vector2_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object_Vector2_AsyncCallback_Object;
			}
		}
        ...
        public R__0__Jqd() : base("#oU.#05+#Jqd")
        {
        }

        public R__0__Jqd(System.Object instance) : base("#oU.#05+#Jqd")
		{
            SetInstance(instance);
		}

        public R__0__Jqd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Jqd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Object  @sender, UnityEngine.Vector2  @delta)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @delta};
            var ___result = RInvoke_Object_Vector2.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.Object  @sender, UnityEngine.Vector2  @delta, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @delta, @callback, @object};
            var ___result = RBeginInvoke_Object_Vector2_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

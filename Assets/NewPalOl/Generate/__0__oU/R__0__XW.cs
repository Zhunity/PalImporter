...
namespace SMFrame.Editor.Refleaction.R__0__oU
{
	...
	/// #oU.#XW
	/// </summary>
    public partial class R__0__XW : RMember //
    {
        ...
        public R__0__XW() : base("#oU.#XW")
        {
        }

        public R__0__XW(System.Object instance) : base("#oU.#XW")
		{
            SetInstance(instance);
		}

        public R__0__XW(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XW(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

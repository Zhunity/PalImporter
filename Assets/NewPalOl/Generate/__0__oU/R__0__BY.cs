...
namespace SMFrame.Editor.Refleaction.R__0__oU
{
	...
	/// #oU.#BY
	/// </summary>
    public partial class R__0__BY : RMember //
    {

		/// <summary>
		/// #oU.#dZ #a
		/// </summary>
		protected R__0__oU.R__0__dZ r___0__a;
		public virtual R__0__oU.R__0__dZ R__0__a
		{
			get
			{
				if(r___0__a == null)
        ...
        public R__0__BY() : base("#oU.#BY")
        {
        }

        public R__0__BY(System.Object instance) : base("#oU.#BY")
		{
            SetInstance(instance);
		}

        public R__0__BY(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__BY(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

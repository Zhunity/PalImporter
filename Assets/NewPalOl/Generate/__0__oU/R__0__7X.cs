...
namespace SMFrame.Editor.Refleaction.R__0__oU
{
	...
	/// #oU.#7X
	/// </summary>
    public partial class R__0__7X : RMember //
    {
        ...
        public R__0__7X() : base("#oU.#7X")
        {
        }

        public R__0__7X(System.Object instance) : base("#oU.#7X")
		{
            SetInstance(instance);
		}

        public R__0__7X(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7X(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__oU
{
	...
	/// #oU.#R0
	/// </summary>
    public partial class R__0__R0 : RMember //
    {

		/// <summary>
		/// #oU.#N0 #a
		/// </summary>
		protected R__0__oU.R__0__N0 r___0__a;
		public virtual R__0__oU.R__0__N0 R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #oU.#N0 ParentBox
		/// </summary>
		protected R__0__oU.R__0__N0 r_R__0__P0;
		public virtual R__0__oU.R__0__N0 R__0__P0
		{
			get
			{
				if(r_R__0__P0 == null)
				{
					r_R__0__P0 = new(this, "ParentBox", -1);
					r_R__0__P0.SetBelong(this.instance);
				}
				return r_R__0__P0;
			}
		}
		...
		/// Void #O0()
		/// </summary>
		protected RMethod r_R__0__O0;
		public virtual RMethod R__0__O0
		{
			get
			{
				if(r_R__0__O0 == null)
				{
					r_R__0__O0 = new(this, "#O0", 0);
					r_R__0__O0.SetBelong(this.instance);
				}
				return r_R__0__O0;
			}
		}
		...
		/// <summary>
		/// Void Draw(UnityEngine.Rect)
		/// </summary>
		protected RMethod r_RDraw_Rect;
		public virtual RMethod RDraw_Rect
		{
			get
			{
				if(r_RDraw_Rect == null)
				{
					r_RDraw_Rect = new(this, "Draw", 0, typeof(UnityEngine.Rect));
					r_RDraw_Rect.SetBelong(this.instance);
				}
				return r_RDraw_Rect;
			}
		}
        ...
        public R__0__R0() : base("#oU.#R0")
        {
        }

        public R__0__R0(System.Object instance) : base("#oU.#R0")
		{
            SetInstance(instance);
		}

        public R__0__R0(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__R0(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void __0__O0()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__O0.Invoke(___genericsType, ___parameters);
        ...
        public virtual void Draw(UnityEngine.Rect  @rect)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@rect};
            var ___result = RDraw_Rect.Invoke(___genericsType, ___parameters);

...
{public partial class R__0__SZ
{
	
	/// <summary>
	/// #oU.#SZ+#cOb
	/// </summary>
    public partial class R__0__cOb : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.String, MyGUI.WordSeg ByRef)
		/// </summary>
		protected RMethod r_RInvoke_String_Ref_WordSeg;
		public virtual RMethod RInvoke_String_Ref_WordSeg
		{
			get
			{
				if(r_RInvoke_String_Ref_WordSeg == null)
				{
					r_RInvoke_String_Ref_WordSeg = new(this, "Invoke", 0, typeof(System.String), typeof(MyGUI.WordSeg).MakeByRefType());
					r_RInvoke_String_Ref_WordSeg.SetBelong(this.instance);
				}
				return r_RInvoke_String_Ref_WordSeg;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.String, MyGUI.WordSeg ByRef, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_String_Ref_WordSeg_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_String_Ref_WordSeg_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_String_Ref_WordSeg_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_String_Ref_WordSeg_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.String), typeof(MyGUI.WordSeg).MakeByRefType(), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_String_Ref_WordSeg_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_String_Ref_WordSeg_AsyncCallback_Object;
			}
		}

		/// <summary>
		/// Void EndInvoke(MyGUI.WordSeg ByRef, System.IAsyncResult)
		/// </summary>
		protected RMethod r_REndInvoke_Ref_WordSeg_IAsyncResult;
		public virtual RMethod REndInvoke_Ref_WordSeg_IAsyncResult
		{
			get
			{
				if(r_REndInvoke_Ref_WordSeg_IAsyncResult == null)
				{
					r_REndInvoke_Ref_WordSeg_IAsyncResult = new(this, "EndInvoke", 0, typeof(MyGUI.WordSeg).MakeByRefType(), typeof(System.IAsyncResult));
					r_REndInvoke_Ref_WordSeg_IAsyncResult.SetBelong(this.instance);
				}
				return r_REndInvoke_Ref_WordSeg_IAsyncResult;
			}
		}
        ...
        public R__0__cOb() : base("#oU.#SZ+#cOb")
        {
        }

        public R__0__cOb(System.Object instance) : base("#oU.#SZ+#cOb")
		{
            SetInstance(instance);
		}

        public R__0__cOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.String  @flag, ref MyGUI.WordSeg  @word)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@flag, @word};
            var ___result = RInvoke_String_Ref_WordSeg.Invoke(___genericsType, ___parameters);
			word = (MyGUI.WordSeg)___parameters[1];

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.String  @flag, ref MyGUI.WordSeg  @word, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@flag, @word, @callback, @object};
            var ___result = RBeginInvoke_String_Ref_WordSeg_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
			word = (MyGUI.WordSeg)___parameters[1];
        ...
        public virtual void EndInvoke(ref MyGUI.WordSeg  @word, System.IAsyncResult  @result)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@word, @result};
            var ___result = REndInvoke_Ref_WordSeg_IAsyncResult.Invoke(___genericsType, ___parameters);
			word = (MyGUI.WordSeg)___parameters[0];

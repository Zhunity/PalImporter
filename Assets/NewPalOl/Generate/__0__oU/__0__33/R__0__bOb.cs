...
{public partial class R__0__33
{
	
	/// <summary>
	/// #oU.#33+#bOb
	/// </summary>
    public partial class R__0__bOb : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Object, Boolean)
		/// </summary>
		protected RMethod r_RInvoke_Object_Boolean;
		public virtual RMethod RInvoke_Object_Boolean
		{
			get
			{
				if(r_RInvoke_Object_Boolean == null)
				{
					r_RInvoke_Object_Boolean = new(this, "Invoke", 0, typeof(System.Object), typeof(System.Boolean));
					r_RInvoke_Object_Boolean.SetBelong(this.instance);
				}
				return r_RInvoke_Object_Boolean;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, Boolean, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Object_Boolean_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object_Boolean_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object_Boolean_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object_Boolean_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object), typeof(System.Boolean), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object_Boolean_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object_Boolean_AsyncCallback_Object;
			}
		}
        ...
        public R__0__bOb() : base("#oU.#33+#bOb")
        {
        }

        public R__0__bOb(System.Object instance) : base("#oU.#33+#bOb")
		{
            SetInstance(instance);
		}

        public R__0__bOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__bOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Object  @sender, System.Boolean  @bActive)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @bActive};
            var ___result = RInvoke_Object_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.Object  @sender, System.Boolean  @bActive, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @bActive, @callback, @object};
            var ___result = RBeginInvoke_Object_Boolean_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

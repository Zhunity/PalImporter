...
namespace SMFrame.Editor.Refleaction.R__0__oU
{
	...
	/// #oU.#33
	/// </summary>
    public partial class R__0__33 : RMember //
    {
		...
		/// #oU.#33+#bOb #d
		/// </summary>
		protected R__0__oU.R__0__33.R__0__bOb r___0__d;
		public virtual R__0__oU.R__0__33.R__0__bOb R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__33() : base("#oU.#33")
        {
        }

        public R__0__33(System.Object instance) : base("#oU.#33")
		{
            SetInstance(instance);
		}

        public R__0__33(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__33(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

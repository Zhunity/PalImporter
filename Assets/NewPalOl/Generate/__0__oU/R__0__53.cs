...
namespace SMFrame.Editor.Refleaction.R__0__oU
{
	...
	/// #oU.#53
	/// </summary>
    public partial class R__0__53 : RMember //
    {
        ...
        public R__0__53() : base("#oU.#53")
        {
        }

        public R__0__53(System.Object instance) : base("#oU.#53")
		{
            SetInstance(instance);
		}

        public R__0__53(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__53(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

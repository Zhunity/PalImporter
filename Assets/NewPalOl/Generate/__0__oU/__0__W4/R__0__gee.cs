...
{public partial class R__0__W4
{
	
	/// <summary>
	/// #oU.#W4+#gee
	/// </summary>
    public partial class R__0__gee : RMember //
    {
        ...
        public R__0__gee() : base("#oU.#W4+#gee")
        {
        }

        public R__0__gee(System.Object instance) : base("#oU.#W4+#gee")
		{
            SetInstance(instance);
		}

        public R__0__gee(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gee(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{
	/// <summary>
	/// CameraAnimationFollow
	/// </summary>
    public partial class RCameraAnimationFollow : RMember //
    {
		...
		/// <summary>
		/// Void Init(UnityEngine.Transform, EventHandler, System.Object, System.EventArgs)
		/// </summary>
		protected RMethod r_RInit_Transform_EventHandler_Object_EventArgs;
		public virtual RMethod RInit_Transform_EventHandler_Object_EventArgs
		{
			get
			{
				if(r_RInit_Transform_EventHandler_Object_EventArgs == null)
				{
					r_RInit_Transform_EventHandler_Object_EventArgs = new(this, "Init", 0, typeof(UnityEngine.Transform), typeof(EventHandler), typeof(System.Object), typeof(System.EventArgs));
					r_RInit_Transform_EventHandler_Object_EventArgs.SetBelong(this.instance);
				}
				return r_RInit_Transform_EventHandler_Object_EventArgs;
			}
		}
        ...
        public RCameraAnimationFollow() : base("CameraAnimationFollow")
        {
        }

        public RCameraAnimationFollow(System.Object instance) : base("CameraAnimationFollow")
		{
            SetInstance(instance);
		}

        public RCameraAnimationFollow(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCameraAnimationFollow(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Init(UnityEngine.Transform  @transToAni, EventHandler  @obj, System.Object  @sender, System.EventArgs  @e)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@transToAni, @obj, @sender, @e};
            var ___result = RInit_Transform_EventHandler_Object_EventArgs.Invoke(___genericsType, ___parameters);

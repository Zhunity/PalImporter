...
{public partial class RMyGUIMarketWnd
{
	...
	/// MyGUIMarketWnd+#yqx
	/// </summary>
    public partial class R__0__yqx : RMember //
    {

		/// <summary>
		/// MyGUIMarketWnd+#Gpe #a
		/// </summary>
		protected RMyGUIMarketWnd.R__0__Gpe r___0__a;
		public virtual RMyGUIMarketWnd.R__0__Gpe R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// MyGUIMarketWnd+#Gpe #d
		/// </summary>
		protected RMyGUIMarketWnd.R__0__Gpe r___0__d;
		public virtual RMyGUIMarketWnd.R__0__Gpe R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__yqx() : base("MyGUIMarketWnd+#yqx")
        {
        }

        public R__0__yqx(System.Object instance) : base("MyGUIMarketWnd+#yqx")
		{
            SetInstance(instance);
		}

        public R__0__yqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__yqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

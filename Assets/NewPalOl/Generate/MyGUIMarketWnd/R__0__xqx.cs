...
{public partial class RMyGUIMarketWnd
{
	...
	/// MyGUIMarketWnd+#xqx
	/// </summary>
    public partial class R__0__xqx : RMember //
    {
        ...
        public R__0__xqx() : base("MyGUIMarketWnd+#xqx")
        {
        }

        public R__0__xqx(System.Object instance) : base("MyGUIMarketWnd+#xqx")
		{
            SetInstance(instance);
		}

        public R__0__xqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__xqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RMyGUIMarketWnd
{
	...
	/// MyGUIMarketWnd+#zqx
	/// </summary>
    public partial class R__0__zqx : RMember //
    {

		/// <summary>
		/// MyGUIMarketWnd+#Kpe #a
		/// </summary>
		protected RMyGUIMarketWnd.R__0__Kpe r___0__a;
		public virtual RMyGUIMarketWnd.R__0__Kpe R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// MyGUIMarketWnd+#Kpe #d
		/// </summary>
		protected RMyGUIMarketWnd.R__0__Kpe r___0__d;
		public virtual RMyGUIMarketWnd.R__0__Kpe R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__zqx() : base("MyGUIMarketWnd+#zqx")
        {
        }

        public R__0__zqx(System.Object instance) : base("MyGUIMarketWnd+#zqx")
		{
            SetInstance(instance);
		}

        public R__0__zqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

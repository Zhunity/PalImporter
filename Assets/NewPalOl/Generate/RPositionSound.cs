...
namespace SMFrame.Editor.Refleaction
{
	...
	/// PositionSound
	/// </summary>
    public partial class RPositionSound : RMember //
    {

		/// <summary>
		/// System.Single m_LoopIntervalTime
		/// </summary>
		protected RField r_m_LoopIntervalTime;
		public virtual RField Rm_LoopIntervalTime
		{
			get
			{
				if(r_m_LoopIntervalTime == null)
				{
					r_m_LoopIntervalTime = new(this, "m_LoopIntervalTime");
					r_m_LoopIntervalTime.SetBelong(this.instance);
				}
				return r_m_LoopIntervalTime;
			}
		}

		/// <summary>
		/// System.Single m_lastFrameTime
		/// </summary>
		protected RField r_m_lastFrameTime;
		public virtual RField Rm_lastFrameTime
		{
			get
			{
				if(r_m_lastFrameTime == null)
				{
					r_m_lastFrameTime = new(this, "m_lastFrameTime");
					r_m_lastFrameTime.SetBelong(this.instance);
				}
				return r_m_lastFrameTime;
			}
		}

		/// <summary>
		/// UnityEngine.AudioSource mAudio
		/// </summary>
		protected RUnityEngine.RAudioSource r_mAudio;
		public virtual RUnityEngine.RAudioSource RmAudio
		{
			get
			{
				if(r_mAudio == null)
				{
					r_mAudio = new(this, "mAudio");
					r_mAudio.SetBelong(this.instance);
				}
				return r_mAudio;
			}
		}
        ...
        public RPositionSound() : base("PositionSound")
        {
        }

        public RPositionSound(System.Object instance) : base("PositionSound")
		{
            SetInstance(instance);
		}

        public RPositionSound(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPositionSound(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

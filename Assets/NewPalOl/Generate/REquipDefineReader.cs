...
namespace SMFrame.Editor.Refleaction
{
	...
	/// EquipDefineReader
	/// </summary>
    public partial class REquipDefineReader : RMember //
    {
        ...
        public REquipDefineReader() : base("EquipDefineReader")
        {
        }

        public REquipDefineReader(System.Object instance) : base("EquipDefineReader")
		{
            SetInstance(instance);
		}

        public REquipDefineReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REquipDefineReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

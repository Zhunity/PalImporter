...
namespace SMFrame.Editor.Refleaction
{
	...
	/// AutoUpPlatform
	/// </summary>
    public partial class RAutoUpPlatform : RMember //
    {

		/// <summary>
		/// System.Single yOffset
		/// </summary>
		protected RField r_yOffset;
		public virtual RField RyOffset
		{
			get
			{
				if(r_yOffset == null)
				{
					r_yOffset = new(this, "yOffset");
					r_yOffset.SetBelong(this.instance);
				}
				return r_yOffset;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Vector3 vInitPos
		/// </summary>
		protected RUnityEngine.RVector3 r_vInitPos;
		public virtual RUnityEngine.RVector3 RvInitPos
		{
			get
			{
				if(r_vInitPos == null)
				{
					r_vInitPos = new(this, "vInitPos");
					r_vInitPos.SetBelong(this.instance);
				}
				return r_vInitPos;
			}
		}
		...
		/// <summary>
		/// System.Boolean bMoveToDest
		/// </summary>
		protected RField r_bMoveToDest;
		public virtual RField RbMoveToDest
		{
			get
			{
				if(r_bMoveToDest == null)
				{
					r_bMoveToDest = new(this, "bMoveToDest");
					r_bMoveToDest.SetBelong(this.instance);
				}
				return r_bMoveToDest;
			}
		}
		...
		/// Void Trigger()
		/// </summary>
		protected RMethod r_RTrigger;
		public virtual RMethod RTrigger
		{
			get
			{
				if(r_RTrigger == null)
				{
					r_RTrigger = new(this, "Trigger", 0);
					r_RTrigger.SetBelong(this.instance);
				}
				return r_RTrigger;
			}
		}
        ...
        public RAutoUpPlatform() : base("AutoUpPlatform")
        {
        }

        public RAutoUpPlatform(System.Object instance) : base("AutoUpPlatform")
		{
            SetInstance(instance);
		}

        public RAutoUpPlatform(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAutoUpPlatform(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void Trigger()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RTrigger.Invoke(___genericsType, ___parameters);

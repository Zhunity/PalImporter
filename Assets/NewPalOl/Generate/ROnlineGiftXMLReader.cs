...
namespace SMFrame.Editor.Refleaction
{
	...
	/// OnlineGiftXMLReader
	/// </summary>
    public partial class ROnlineGiftXMLReader : RMember //
    {
        ...
        public ROnlineGiftXMLReader() : base("OnlineGiftXMLReader")
        {
        }

        public ROnlineGiftXMLReader(System.Object instance) : base("OnlineGiftXMLReader")
		{
            SetInstance(instance);
		}

        public ROnlineGiftXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public ROnlineGiftXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

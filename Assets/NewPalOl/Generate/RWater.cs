...
namespace SMFrame.Editor.Refleaction
{
	...
	/// Water
	/// </summary>
    public partial class RWater : RMember //
    {

		/// <summary>
		/// Water+WaterMode m_WaterMode
		/// </summary>
		...
		/// <summary>
		/// UnityEngine.LayerMask m_RefractLayers
		/// </summary>
		protected RUnityEngine.RLayerMask r_m_RefractLayers;
		public virtual RUnityEngine.RLayerMask Rm_RefractLayers
		{
			get
			{
				if(r_m_RefractLayers == null)
				{
					r_m_RefractLayers = new(this, "m_RefractLayers");
					r_m_RefractLayers.SetBelong(this.instance);
				}
				return r_m_RefractLayers;
			}
		}
		...
		/// <summary>
		/// System.Collections.Hashtable m_RefractionCameras
		/// </summary>
		protected RSystem.RCollections.RHashtable r_m_RefractionCameras;
		public virtual RSystem.RCollections.RHashtable Rm_RefractionCameras
		{
			get
			{
				if(r_m_RefractionCameras == null)
				{
					r_m_RefractionCameras = new(this, "m_RefractionCameras");
					r_m_RefractionCameras.SetBelong(this.instance);
				}
				return r_m_RefractionCameras;
			}
		}
		...
		/// <summary>
		/// UnityEngine.RenderTexture m_RefractionTexture
		/// </summary>
		protected RUnityEngine.RRenderTexture r_m_RefractionTexture;
		public virtual RUnityEngine.RRenderTexture Rm_RefractionTexture
		{
			get
			{
				if(r_m_RefractionTexture == null)
				{
					r_m_RefractionTexture = new(this, "m_RefractionTexture");
					r_m_RefractionTexture.SetBelong(this.instance);
				}
				return r_m_RefractionTexture;
			}
		}

		/// <summary>
		/// Water+WaterMode m_HardwareWaterSupport
		/// </summary>
		...
		/// <summary>
		/// System.Int32 m_OldRefractionTextureSize
		/// </summary>
		protected RField r_m_OldRefractionTextureSize;
		public virtual RField Rm_OldRefractionTextureSize
		{
			get
			{
				if(r_m_OldRefractionTextureSize == null)
				{
					r_m_OldRefractionTextureSize = new(this, "m_OldRefractionTextureSize");
					r_m_OldRefractionTextureSize.SetBelong(this.instance);
				}
				return r_m_OldRefractionTextureSize;
			}
		}
		...
		public static RField Rs_InsideWater
		{
			get
			{
				...
				{
					r_s_InsideWater = new(typeof(Water), "s_InsideWater");
		...
		/// <summary>
		/// Void CreateWaterObjects(UnityEngine.Camera, UnityEngine.Camera ByRef, UnityEngine.Camera ByRef)
		/// </summary>
		protected RMethod r_RCreateWaterObjects_Camera_Out_Camera_Out_Camera;
		public virtual RMethod RCreateWaterObjects_Camera_Out_Camera_Out_Camera
		{
			get
			{
				if(r_RCreateWaterObjects_Camera_Out_Camera_Out_Camera == null)
				{
					r_RCreateWaterObjects_Camera_Out_Camera_Out_Camera = new(this, "CreateWaterObjects", 0, typeof(UnityEngine.Camera), typeof(UnityEngine.Camera).MakeByRefType(), typeof(UnityEngine.Camera).MakeByRefType());
					r_RCreateWaterObjects_Camera_Out_Camera_Out_Camera.SetBelong(this.instance);
				}
				return r_RCreateWaterObjects_Camera_Out_Camera_Out_Camera;
			}
		}
		...
		public static RMethod Rsgn_Single
		{
			get
			{
				...
				{
					r_Rsgn_Single = new(typeof(Water), "sgn", 0, typeof(System.Single));
		...
		public static RMethod RCalculateObliqueMatrix_Ref_Matrix4x4_Vector4
		{
			get
			{
				...
				{
					r_RCalculateObliqueMatrix_Ref_Matrix4x4_Vector4 = new(typeof(Water), "CalculateObliqueMatrix", 0, typeof(UnityEngine.Matrix4x4).MakeByRefType(), typeof(UnityEngine.Vector4));
		...
		public static RMethod RCalculateReflectionMatrix_Ref_Matrix4x4_Vector4
		{
			get
			{
				...
				{
					r_RCalculateReflectionMatrix_Ref_Matrix4x4_Vector4 = new(typeof(Water), "CalculateReflectionMatrix", 0, typeof(UnityEngine.Matrix4x4).MakeByRefType(), typeof(UnityEngine.Vector4));
        ...
        public RWater() : base("Water")
        {
        }

        public RWater(System.Object instance) : base("Water")
		{
            SetInstance(instance);
		}

        public RWater(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RWater(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void CreateWaterObjects(UnityEngine.Camera  @currentCamera, out UnityEngine.Camera  @reflectionCamera, out UnityEngine.Camera  @refractionCamera)
        {
			reflectionCamera = default;
			refractionCamera = default;

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@currentCamera, @reflectionCamera, @refractionCamera};
            var ___result = RCreateWaterObjects_Camera_Out_Camera_Out_Camera.Invoke(___genericsType, ___parameters);
			reflectionCamera = (UnityEngine.Camera)___parameters[1];
			refractionCamera = (UnityEngine.Camera)___parameters[2];

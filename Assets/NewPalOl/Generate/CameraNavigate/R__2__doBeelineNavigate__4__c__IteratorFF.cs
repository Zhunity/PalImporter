...
{public partial class RCameraNavigate
{
	
	/// <summary>
	/// CameraNavigate+<doBeelineNavigate>c__IteratorFF
	/// </summary>
    public partial class R__2__doBeelineNavigate__4__c__IteratorFF : RMember //
    {
		...
		/// </summary>
		protected RField r_pathName;
		public virtual RField RpathName
		{
			get
			{
				if(r_pathName == null)
				{
					r_pathName = new(this, "pathName");
					r_pathName.SetBelong(this.instance);
				}
				return r_pathName;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RTransform r_obj;
		public virtual RUnityEngine.RTransform Robj
		{
			get
			{
				if(r_obj == null)
		...
		/// System.String <$>pathName
		/// </summary>
		protected RField r___2____9____4__pathName;
		public virtual RField R__2____9____4__pathName
		{
			get
			{
				if(r___2____9____4__pathName == null)
				{
					r___2____9____4__pathName = new(this, "<$>pathName");
					r___2____9____4__pathName.SetBelong(this.instance);
				}
				return r___2____9____4__pathName;
			}
		}
		...
		/// UnityEngine.Transform <$>obj
		/// </summary>
		protected RUnityEngine.RTransform r___2____9____4__obj;
		public virtual RUnityEngine.RTransform R__2____9____4__obj
		{
			get
			{
		...
		/// <summary>
		/// CameraNavigate <>f__this
		/// </summary>
		protected RCameraNavigate r___2____4__f__this;
		public virtual RCameraNavigate R__2____4__f__this
		{
			get
			{
        ...
        public R__2__doBeelineNavigate__4__c__IteratorFF() : base("CameraNavigate+<doBeelineNavigate>c__IteratorFF")
        {
        }

        public R__2__doBeelineNavigate__4__c__IteratorFF(System.Object instance) : base("CameraNavigate+<doBeelineNavigate>c__IteratorFF")
		{
            SetInstance(instance);
		}

        public R__2__doBeelineNavigate__4__c__IteratorFF(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__doBeelineNavigate__4__c__IteratorFF(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

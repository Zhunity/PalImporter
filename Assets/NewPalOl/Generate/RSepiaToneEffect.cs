...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SepiaToneEffect
	/// </summary>
    public partial class RSepiaToneEffect : RMember //
    {
        ...
        public RSepiaToneEffect() : base("SepiaToneEffect")
        {
        }

        public RSepiaToneEffect(System.Object instance) : base("SepiaToneEffect")
		{
            SetInstance(instance);
		}

        public RSepiaToneEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSepiaToneEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

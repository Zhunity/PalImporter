...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MallInfoXMLReader
	/// </summary>
    public partial class RMallInfoXMLReader : RMember //
    {
        ...
        public RMallInfoXMLReader() : base("MallInfoXMLReader")
        {
        }

        public RMallInfoXMLReader(System.Object instance) : base("MallInfoXMLReader")
		{
            SetInstance(instance);
		}

        public RMallInfoXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMallInfoXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// OnEndCallback
	/// </summary>
    public partial class ROnEndCallback : RMember //
    {
        ...
        public ROnEndCallback() : base("OnEndCallback")
        {
        }

        public ROnEndCallback(System.Object instance) : base("OnEndCallback")
		{
            SetInstance(instance);
		}

        public ROnEndCallback(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public ROnEndCallback(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

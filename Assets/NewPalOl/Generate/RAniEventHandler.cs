...
namespace SMFrame.Editor.Refleaction
{
	...
	/// AniEventHandler
	/// </summary>
    public partial class RAniEventHandler : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Object, #u.#5ab)
		/// </summary>
		protected RMethod r_RInvoke_Object___0__5ab;
		public virtual RMethod RInvoke_Object___0__5ab
		{
			get
			{
				if(r_RInvoke_Object___0__5ab == null)
				{
					r_RInvoke_Object___0__5ab = new(this, "Invoke", 0, typeof(System.Object),  ReleactionUtils.GetType("#u.#5ab"));
					r_RInvoke_Object___0__5ab.SetBelong(this.instance);
				}
				return r_RInvoke_Object___0__5ab;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, #u.#5ab, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Object___0__5ab_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object___0__5ab_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object___0__5ab_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object___0__5ab_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object),  ReleactionUtils.GetType("#u.#5ab"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object___0__5ab_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object___0__5ab_AsyncCallback_Object;
			}
		}
        ...
        public RAniEventHandler() : base("AniEventHandler")
        {
        }

        public RAniEventHandler(System.Object instance) : base("AniEventHandler")
		{
            SetInstance(instance);
		}

        public RAniEventHandler(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAniEventHandler(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

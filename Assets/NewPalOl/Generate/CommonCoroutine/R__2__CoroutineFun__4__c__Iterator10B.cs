...
{public partial class RCommonCoroutine
{
	...
	/// <summary>
	/// CommonCoroutine+<CoroutineFun>c__Iterator10B
	/// </summary>
    public partial class R__2__CoroutineFun__4__c__Iterator10B : RMember //
    {
        ...
        public R__2__CoroutineFun__4__c__Iterator10B() : base("CommonCoroutine+<CoroutineFun>c__Iterator10B")
        {
        }

        public R__2__CoroutineFun__4__c__Iterator10B(System.Object instance) : base("CommonCoroutine+<CoroutineFun>c__Iterator10B")
		{
            SetInstance(instance);
		}

        public R__2__CoroutineFun__4__c__Iterator10B(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__CoroutineFun__4__c__Iterator10B(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

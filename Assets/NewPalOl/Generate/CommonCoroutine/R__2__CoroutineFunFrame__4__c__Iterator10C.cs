...
{public partial class RCommonCoroutine
{
	...
	/// <summary>
	/// CommonCoroutine+<CoroutineFunFrame>c__Iterator10C
	/// </summary>
    public partial class R__2__CoroutineFunFrame__4__c__Iterator10C : RMember //
    {
        ...
        public R__2__CoroutineFunFrame__4__c__Iterator10C() : base("CommonCoroutine+<CoroutineFunFrame>c__Iterator10C")
        {
        }

        public R__2__CoroutineFunFrame__4__c__Iterator10C(System.Object instance) : base("CommonCoroutine+<CoroutineFunFrame>c__Iterator10C")
		{
            SetInstance(instance);
		}

        public R__2__CoroutineFunFrame__4__c__Iterator10C(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__CoroutineFunFrame__4__c__Iterator10C(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

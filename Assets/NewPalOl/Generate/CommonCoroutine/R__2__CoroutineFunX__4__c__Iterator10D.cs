...
{public partial class RCommonCoroutine
{
	
	/// <summary>
	/// CommonCoroutine+<CoroutineFunX>c__Iterator10D
	/// </summary>
    public partial class R__2__CoroutineFunX__4__c__Iterator10D : RMember //
    {
		...
		/// <summary>
		/// System.Single <m_time>__0
		/// </summary>
		protected RField r___2__m_time__4____0;
		public virtual RField R__2__m_time__4____0
		{
			get
			{
				if(r___2__m_time__4____0 == null)
				{
					r___2__m_time__4____0 = new(this, "<m_time>__0");
					r___2__m_time__4____0.SetBelong(this.instance);
				}
				return r___2__m_time__4____0;
			}
		}
		...
		/// <summary>
		/// CommonCoroutine <>f__this
		/// </summary>
		protected RCommonCoroutine r___2____4__f__this;
		public virtual RCommonCoroutine R__2____4__f__this
		{
			get
			{
        ...
        public R__2__CoroutineFunX__4__c__Iterator10D() : base("CommonCoroutine+<CoroutineFunX>c__Iterator10D")
        {
        }

        public R__2__CoroutineFunX__4__c__Iterator10D(System.Object instance) : base("CommonCoroutine+<CoroutineFunX>c__Iterator10D")
		{
            SetInstance(instance);
		}

        public R__2__CoroutineFunX__4__c__Iterator10D(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__CoroutineFunX__4__c__Iterator10D(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

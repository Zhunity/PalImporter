...
namespace SMFrame.Editor.Refleaction
{
	...
	/// </summary>
    public partial class REdgeDetectEffectNormals : RMember //
    {

		/// <summary>
		/// UnityEngine.Material _edgeApplyMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r__edgeApplyMaterial;
		public virtual RUnityEngine.RMaterial R_edgeApplyMaterial
		{
			get
			{
				if(r__edgeApplyMaterial == null)
				{
					r__edgeApplyMaterial = new(this, "_edgeApplyMaterial");
					r__edgeApplyMaterial.SetBelong(this.instance);
				}
				return r__edgeApplyMaterial;
			}
		}

		/// <summary>
		/// UnityEngine.Material _edgeDetectHqMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r__edgeDetectHqMaterial;
		public virtual RUnityEngine.RMaterial R_edgeDetectHqMaterial
		{
			get
			{
				if(r__edgeDetectHqMaterial == null)
				{
					r__edgeDetectHqMaterial = new(this, "_edgeDetectHqMaterial");
					r__edgeDetectHqMaterial.SetBelong(this.instance);
				}
				return r__edgeDetectHqMaterial;
			}
		}

		/// <summary>
		/// UnityEngine.Material _edgeDetectMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r__edgeDetectMaterial;
		public virtual RUnityEngine.RMaterial R_edgeDetectMaterial
		{
			get
			{
				if(r__edgeDetectMaterial == null)
				{
					r__edgeDetectMaterial = new(this, "_edgeDetectMaterial");
					r__edgeDetectMaterial.SetBelong(this.instance);
				}
				return r__edgeDetectMaterial;
			}
		}

		/// <summary>
		/// UnityEngine.Material _sepBlurMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r__sepBlurMaterial;
		public virtual RUnityEngine.RMaterial R_sepBlurMaterial
		{
			get
			{
				if(r__sepBlurMaterial == null)
				{
					r__sepBlurMaterial = new(this, "_sepBlurMaterial");
					r__sepBlurMaterial.SetBelong(this.instance);
				}
				return r__sepBlurMaterial;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Shader edgeApplyShader
		/// </summary>
		protected RUnityEngine.RShader r_edgeApplyShader;
		public virtual RUnityEngine.RShader RedgeApplyShader
		{
			get
			{
				if(r_edgeApplyShader == null)
				{
					r_edgeApplyShader = new(this, "edgeApplyShader");
					r_edgeApplyShader.SetBelong(this.instance);
				}
				return r_edgeApplyShader;
			}
		}

		/// <summary>
		/// System.Boolean edgeBlur
		/// </summary>
		protected RField r_edgeBlur;
		public virtual RField RedgeBlur
		{
			get
			{
				if(r_edgeBlur == null)
				{
					r_edgeBlur = new(this, "edgeBlur");
					r_edgeBlur.SetBelong(this.instance);
				}
				return r_edgeBlur;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Shader edgeDetectHqShader
		/// </summary>
		protected RUnityEngine.RShader r_edgeDetectHqShader;
		public virtual RUnityEngine.RShader RedgeDetectHqShader
		{
			get
			{
				if(r_edgeDetectHqShader == null)
				{
					r_edgeDetectHqShader = new(this, "edgeDetectHqShader");
					r_edgeDetectHqShader.SetBelong(this.instance);
				}
				return r_edgeDetectHqShader;
			}
		}

		/// <summary>
		/// UnityEngine.Shader edgeDetectShader
		/// </summary>
		protected RUnityEngine.RShader r_edgeDetectShader;
		public virtual RUnityEngine.RShader RedgeDetectShader
		{
			get
			{
				if(r_edgeDetectShader == null)
				{
					r_edgeDetectShader = new(this, "edgeDetectShader");
					r_edgeDetectShader.SetBelong(this.instance);
				}
				return r_edgeDetectShader;
			}
		}

		/// <summary>
		/// System.Single edgesIntensity
		/// </summary>
		protected RField r_edgesIntensity;
		public virtual RField RedgesIntensity
		{
			get
			{
				if(r_edgesIntensity == null)
				{
					r_edgesIntensity = new(this, "edgesIntensity");
					r_edgesIntensity.SetBelong(this.instance);
				}
				return r_edgesIntensity;
			}
		}

		/// <summary>
		/// System.Single edgesOnly
		/// </summary>
		protected RField r_edgesOnly;
		public virtual RField RedgesOnly
		{
			get
			{
				if(r_edgesOnly == null)
				{
					r_edgesOnly = new(this, "edgesOnly");
					r_edgesOnly.SetBelong(this.instance);
				}
				return r_edgesOnly;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Color edgesOnlyBgColor
		/// </summary>
		protected RUnityEngine.RColor r_edgesOnlyBgColor;
		public virtual RUnityEngine.RColor RedgesOnlyBgColor
		{
			get
			{
				if(r_edgesOnlyBgColor == null)
				{
					r_edgesOnlyBgColor = new(this, "edgesOnlyBgColor");
					r_edgesOnlyBgColor.SetBelong(this.instance);
				}
				return r_edgesOnlyBgColor;
			}
		}
		...
		/// </summary>
		protected RField r_highQuality;
		public virtual RField RhighQuality
		{
			get
			{
				if(r_highQuality == null)
				{
					r_highQuality = new(this, "highQuality");
					r_highQuality.SetBelong(this.instance);
				}
				return r_highQuality;
			}
		}

		/// <summary>
		/// System.Single sensitivityDepth
		/// </summary>
		protected RField r_sensitivityDepth;
		public virtual RField RsensitivityDepth
		{
			get
			{
				if(r_sensitivityDepth == null)
				{
					r_sensitivityDepth = new(this, "sensitivityDepth");
					r_sensitivityDepth.SetBelong(this.instance);
				}
				return r_sensitivityDepth;
			}
		}

		/// <summary>
		/// System.Single sensitivityNormals
		/// </summary>
		protected RField r_sensitivityNormals;
		public virtual RField RsensitivityNormals
		{
			get
			{
				if(r_sensitivityNormals == null)
				{
					r_sensitivityNormals = new(this, "sensitivityNormals");
					r_sensitivityNormals.SetBelong(this.instance);
				}
				return r_sensitivityNormals;
			}
		}

		/// <summary>
		/// UnityEngine.Shader sepBlurShader
		/// </summary>
		protected RUnityEngine.RShader r_sepBlurShader;
		public virtual RUnityEngine.RShader RsepBlurShader
		{
			get
			{
				if(r_sepBlurShader == null)
				{
					r_sepBlurShader = new(this, "sepBlurShader");
					r_sepBlurShader.SetBelong(this.instance);
				}
				return r_sepBlurShader;
			}
		}
		...
		/// </summary>
		protected RField r_spread;
		public virtual RField Rspread
		{
			get
			{
				if(r_spread == null)
				{
					r_spread = new(this, "spread");
        ...
        public REdgeDetectEffectNormals() : base("EdgeDetectEffectNormals")
        {
        }

        public REdgeDetectEffectNormals(System.Object instance) : base("EdgeDetectEffectNormals")
		{
            SetInstance(instance);
		}

        public REdgeDetectEffectNormals(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REdgeDetectEffectNormals(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// GlowEffect
	/// </summary>
    public partial class RGlowEffect : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.Shader _compositeShader
		/// </summary>
		protected RUnityEngine.RShader r__compositeShader;
		public virtual RUnityEngine.RShader R_compositeShader
		{
			get
			{
				if(r__compositeShader == null)
				{
					r__compositeShader = new(this, "_compositeShader");
					r__compositeShader.SetBelong(this.instance);
				}
				return r__compositeShader;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RMaterial r_m_CompositeMaterial;
		public virtual RUnityEngine.RMaterial Rm_CompositeMaterial
		{
			get
			{
				if(r_m_CompositeMaterial == null)
				{
					r_m_CompositeMaterial = new(this, "m_CompositeMaterial");
					r_m_CompositeMaterial.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected RUnityEngine.RShader r__blurShader;
		public virtual RUnityEngine.RShader R_blurShader
		{
			get
			{
				if(r__blurShader == null)
				{
					r__blurShader = new(this, "_blurShader");
					r__blurShader.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected RUnityEngine.RMaterial r_m_BlurMaterial;
		public virtual RUnityEngine.RMaterial Rm_BlurMaterial
		{
			get
			{
				if(r_m_BlurMaterial == null)
				{
					r_m_BlurMaterial = new(this, "m_BlurMaterial");
					r_m_BlurMaterial.SetBelong(this.instance);
				}
		...
		/// <summary>
		/// UnityEngine.Shader compositeShader
		/// </summary>
		protected RUnityEngine.RShader r_compositeShader;
		public virtual RUnityEngine.RShader RcompositeShader
		{
			get
			{
				if(r_compositeShader == null)
				{
					r_compositeShader = new(this, "compositeShader", -1);
					r_compositeShader.SetBelong(this.instance);
				}
				return r_compositeShader;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RMaterial r_compositeMaterial;
		public virtual RUnityEngine.RMaterial RcompositeMaterial
		{
			get
			{
				if(r_compositeMaterial == null)
				{
					r_compositeMaterial = new(this, "compositeMaterial", -1);
					r_compositeMaterial.SetBelong(this.instance);
				}
		...
		public virtual RUnityEngine.RShader RblurShader
		{
			get
			{
				...
				{
					r_blurShader = new(this, "blurShader", -1);
		...
		/// </summary>
		protected RUnityEngine.RMaterial r_blurMaterial;
		public virtual RUnityEngine.RMaterial RblurMaterial
		{
			get
			{
				if(r_blurMaterial == null)
				{
					r_blurMaterial = new(this, "blurMaterial", -1);
					r_blurMaterial.SetBelong(this.instance);
				}
        ...
        public RGlowEffect() : base("GlowEffect")
        {
        }

        public RGlowEffect(System.Object instance) : base("GlowEffect")
		{
            SetInstance(instance);
		}

        public RGlowEffect(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RGlowEffect(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

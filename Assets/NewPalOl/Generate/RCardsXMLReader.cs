...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CardsXMLReader
	/// </summary>
    public partial class RCardsXMLReader : RMember //
    {
        ...
        public RCardsXMLReader() : base("CardsXMLReader")
        {
        }

        public RCardsXMLReader(System.Object instance) : base("CardsXMLReader")
		{
            SetInstance(instance);
		}

        public RCardsXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCardsXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

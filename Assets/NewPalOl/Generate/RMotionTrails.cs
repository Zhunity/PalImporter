...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MotionTrails
	/// </summary>
    public partial class RMotionTrails : RMember //
    {

		/// <summary>
		/// UnityEngine.Material mat
		/// </summary>
		protected RUnityEngine.RMaterial r_mat;
		public virtual RUnityEngine.RMaterial Rmat
		{
			get
			{
				if(r_mat == null)
		...
		/// <summary>
		/// UnityEngine.MeshRenderer mMR
		/// </summary>
		protected RUnityEngine.RMeshRenderer r_mMR;
		public virtual RUnityEngine.RMeshRenderer RmMR
		{
			get
			{
				if(r_mMR == null)
		...
		/// <summary>
		/// System.Int32 maxMotionTrails
		/// </summary>
		protected RField r_maxMotionTrails;
		public virtual RField RmaxMotionTrails
		{
			get
			{
				if(r_maxMotionTrails == null)
				{
					r_maxMotionTrails = new(this, "maxMotionTrails");
					r_maxMotionTrails.SetBelong(this.instance);
				}
				return r_maxMotionTrails;
			}
		}
		...
		/// </summary>
		protected RField r_lifetime;
		public virtual RField Rlifetime
		{
			get
			{
				if(r_lifetime == null)
				{
					r_lifetime = new(this, "lifetime");
		...
		/// </summary>
		protected RField r_minDist;
		public virtual RField RminDist
		{
			get
			{
				if(r_minDist == null)
				{
					r_minDist = new(this, "minDist");
					r_minDist.SetBelong(this.instance);
				}
				return r_minDist;
			}
		}
		...
		/// <summary>
		/// System.Single curveTessel
		/// </summary>
		protected RField r_curveTessel;
		public virtual RField RcurveTessel
		{
			get
			{
				if(r_curveTessel == null)
				{
					r_curveTessel = new(this, "curveTessel");
					r_curveTessel.SetBelong(this.instance);
				}
				return r_curveTessel;
			}
		}

		/// <summary>
		/// System.Single[] lastTime
		/// </summary>
		protected RFieldArray<RField> r_lastTime;
		public virtual RFieldArray<RField> RlastTime
		{
			get
			{
				if(r_lastTime == null)
				{
					r_lastTime = new(this, "lastTime");
					r_lastTime.SetBelong(this.instance);
				}
				return r_lastTime;
			}
		}
		...
		/// <summary>
		/// System.Int32[] trailCount
		/// </summary>
		protected RFieldArray<RField> r_trailCount;
		public virtual RFieldArray<RField> RtrailCount
		{
			get
			{
				if(r_trailCount == null)
				{
					r_trailCount = new(this, "trailCount");
					r_trailCount.SetBelong(this.instance);
				}
				return r_trailCount;
			}
		}
		...
		/// <summary>
		/// MotionTrails+motionTrailSection[][] mTrail
		/// </summary>
		protected RFieldArray<RFieldArray<RMotionTrails.RmotionTrailSection>> r_mTrail;
		public virtual RFieldArray<RFieldArray<RMotionTrails.RmotionTrailSection>> RmTrail
		{
			get
			{
				if(r_mTrail == null)
				{
					r_mTrail = new(this, "mTrail");
					r_mTrail.SetBelong(this.instance);
				}
				return r_mTrail;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Vector3[] lastAddedPos
		/// </summary>
		protected RFieldArray<RUnityEngine.RVector3> r_lastAddedPos;
		public virtual RFieldArray<RUnityEngine.RVector3> RlastAddedPos
		{
			get
			{
				if(r_lastAddedPos == null)
				{
					r_lastAddedPos = new(this, "lastAddedPos");
					r_lastAddedPos.SetBelong(this.instance);
				}
				return r_lastAddedPos;
			}
		}
		...
		/// <summary>
		/// System.Boolean updateTrailsStarted
		/// </summary>
		protected RField r_updateTrailsStarted;
		public virtual RField RupdateTrailsStarted
		{
			get
			{
				if(r_updateTrailsStarted == null)
				{
					r_updateTrailsStarted = new(this, "updateTrailsStarted");
					r_updateTrailsStarted.SetBelong(this.instance);
				}
				return r_updateTrailsStarted;
			}
		}

		/// <summary>
		/// System.Boolean secondTrail
		/// </summary>
		protected RField r_secondTrail;
		public virtual RField RsecondTrail
		{
			get
			{
				if(r_secondTrail == null)
				{
					r_secondTrail = new(this, "secondTrail");
					r_secondTrail.SetBelong(this.instance);
				}
				return r_secondTrail;
			}
		}

		/// <summary>
		/// UnityEngine.Vector3 startPos2
		/// </summary>
		protected RUnityEngine.RVector3 r_startPos2;
		public virtual RUnityEngine.RVector3 RstartPos2
		{
			get
			{
				if(r_startPos2 == null)
				{
					r_startPos2 = new(this, "startPos2");
					r_startPos2.SetBelong(this.instance);
				}
				return r_startPos2;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Vector3 endPos2
		/// </summary>
		protected RUnityEngine.RVector3 r_endPos2;
		public virtual RUnityEngine.RVector3 RendPos2
		{
			get
			{
				if(r_endPos2 == null)
				{
					r_endPos2 = new(this, "endPos2");
					r_endPos2.SetBelong(this.instance);
				}
				return r_endPos2;
			}
		}
		...
		/// <summary>
		/// Void CatmullRomCalc(UnityEngine.Vector3 ByRef, Single, UnityEngine.Vector3, UnityEngine.Vector3, UnityEngine.Vector3, UnityEngine.Vector3)
		/// </summary>
		protected RMethod r_RCatmullRomCalc_Out_Vector3_Single_Vector3_Vector3_Vector3_Vector3;
		public virtual RMethod RCatmullRomCalc_Out_Vector3_Single_Vector3_Vector3_Vector3_Vector3
		{
			get
			{
				if(r_RCatmullRomCalc_Out_Vector3_Single_Vector3_Vector3_Vector3_Vector3 == null)
				{
					r_RCatmullRomCalc_Out_Vector3_Single_Vector3_Vector3_Vector3_Vector3 = new(this, "CatmullRomCalc", 0, typeof(UnityEngine.Vector3).MakeByRefType(), typeof(System.Single), typeof(UnityEngine.Vector3), typeof(UnityEngine.Vector3), typeof(UnityEngine.Vector3), typeof(UnityEngine.Vector3));
					r_RCatmullRomCalc_Out_Vector3_Single_Vector3_Vector3_Vector3_Vector3.SetBelong(this.instance);
				}
				return r_RCatmullRomCalc_Out_Vector3_Single_Vector3_Vector3_Vector3_Vector3;
			}
		}

		/// <summary>
		/// Single interpolate(Single, Single, Single)
		/// </summary>
		protected RMethod r_Rinterpolate_Single_Single_Single;
		public virtual RMethod Rinterpolate_Single_Single_Single
		{
			get
			{
				if(r_Rinterpolate_Single_Single_Single == null)
				{
					r_Rinterpolate_Single_Single_Single = new(this, "interpolate", 0, typeof(System.Single), typeof(System.Single), typeof(System.Single));
					r_Rinterpolate_Single_Single_Single.SetBelong(this.instance);
				}
				return r_Rinterpolate_Single_Single_Single;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator updateTrailsLoop()
		/// </summary>
		protected RMethod r_RupdateTrailsLoop;
		public virtual RMethod RupdateTrailsLoop
		{
			get
			{
				if(r_RupdateTrailsLoop == null)
				{
					r_RupdateTrailsLoop = new(this, "updateTrailsLoop", 0);
					r_RupdateTrailsLoop.SetBelong(this.instance);
				}
				return r_RupdateTrailsLoop;
			}
		}
		...
		/// Void OnRenderObject()
		/// </summary>
		protected RMethod r_ROnRenderObject;
		public virtual RMethod ROnRenderObject
		{
			get
			{
				if(r_ROnRenderObject == null)
				{
					r_ROnRenderObject = new(this, "OnRenderObject", 0);
					r_ROnRenderObject.SetBelong(this.instance);
				}
				return r_ROnRenderObject;
			}
		}

		/// <summary>
		/// Void renderTrail(Int32, Int32)
		/// </summary>
		protected RMethod r_RrenderTrail_Int32_Int32;
		public virtual RMethod RrenderTrail_Int32_Int32
		{
			get
			{
				if(r_RrenderTrail_Int32_Int32 == null)
				{
					r_RrenderTrail_Int32_Int32 = new(this, "renderTrail", 0, typeof(System.Int32), typeof(System.Int32));
					r_RrenderTrail_Int32_Int32.SetBelong(this.instance);
				}
				return r_RrenderTrail_Int32_Int32;
			}
		}

		/// <summary>
		/// Void updateTrail(Int32, UnityEngine.Vector3, UnityEngine.Vector3, Boolean)
		/// </summary>
		protected RMethod r_RupdateTrail_Int32_Vector3_Vector3_Boolean;
		public virtual RMethod RupdateTrail_Int32_Vector3_Vector3_Boolean
		{
			get
			{
				if(r_RupdateTrail_Int32_Vector3_Vector3_Boolean == null)
				{
					r_RupdateTrail_Int32_Vector3_Vector3_Boolean = new(this, "updateTrail", 0, typeof(System.Int32), typeof(UnityEngine.Vector3), typeof(UnityEngine.Vector3), typeof(System.Boolean));
					r_RupdateTrail_Int32_Vector3_Vector3_Boolean.SetBelong(this.instance);
				}
				return r_RupdateTrail_Int32_Vector3_Vector3_Boolean;
			}
		}

		/// <summary>
		/// Void addTrail(Int32, UnityEngine.Vector3, UnityEngine.Vector3)
		/// </summary>
		protected RMethod r_RaddTrail_Int32_Vector3_Vector3;
		public virtual RMethod RaddTrail_Int32_Vector3_Vector3
		{
			get
			{
				if(r_RaddTrail_Int32_Vector3_Vector3 == null)
				{
					r_RaddTrail_Int32_Vector3_Vector3 = new(this, "addTrail", 0, typeof(System.Int32), typeof(UnityEngine.Vector3), typeof(UnityEngine.Vector3));
					r_RaddTrail_Int32_Vector3_Vector3.SetBelong(this.instance);
				}
				return r_RaddTrail_Int32_Vector3_Vector3;
			}
		}
        ...
        public RMotionTrails() : base("MotionTrails")
        {
        }

        public RMotionTrails(System.Object instance) : base("MotionTrails")
		{
            SetInstance(instance);
		}

        public RMotionTrails(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMotionTrails(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void CatmullRomCalc(out UnityEngine.Vector3  @Out, System.Single  @t, UnityEngine.Vector3  @p0, UnityEngine.Vector3  @p1, UnityEngine.Vector3  @p2, UnityEngine.Vector3  @p3)
        {
			Out = default;

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@Out, @t, @p0, @p1, @p2, @p3};
            var ___result = RCatmullRomCalc_Out_Vector3_Single_Vector3_Vector3_Vector3_Vector3.Invoke(___genericsType, ___parameters);
			Out = (UnityEngine.Vector3)___parameters[0];

            
        }


        public virtual System.Single interpolate(System.Single  @from, System.Single  @to, System.Single  @factor)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@from, @to, @factor};
            var ___result = Rinterpolate_Single_Single_Single.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Collections.IEnumerator updateTrailsLoop()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RupdateTrailsLoop.Invoke(___genericsType, ___parameters);
        ...
        public virtual void OnRenderObject()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = ROnRenderObject.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void renderTrail(System.Int32  @whichTrail, System.Int32  @currentTrail)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@whichTrail, @currentTrail};
            var ___result = RrenderTrail_Int32_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void updateTrail(System.Int32  @whichTrail, UnityEngine.Vector3  @inStart, UnityEngine.Vector3  @inEnd, System.Boolean  @addMoreTrails)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@whichTrail, @inStart, @inEnd, @addMoreTrails};
            var ___result = RupdateTrail_Int32_Vector3_Vector3_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void addTrail(System.Int32  @whichTrail, UnityEngine.Vector3  @inStart, UnityEngine.Vector3  @inEnd)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@whichTrail, @inStart, @inEnd};
            var ___result = RaddTrail_Int32_Vector3_Vector3.Invoke(___genericsType, ___parameters);

...
{
	/// <summary>
	/// EquipMagicWeaponReader
	/// </summary>
    public partial class REquipMagicWeaponReader : RMember //
    {
        ...
        public REquipMagicWeaponReader() : base("EquipMagicWeaponReader")
        {
        }

        public REquipMagicWeaponReader(System.Object instance) : base("EquipMagicWeaponReader")
		{
            SetInstance(instance);
		}

        public REquipMagicWeaponReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REquipMagicWeaponReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

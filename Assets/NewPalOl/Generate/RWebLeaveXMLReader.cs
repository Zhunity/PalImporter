...
namespace SMFrame.Editor.Refleaction
{
	...
	/// WebLeaveXMLReader
	/// </summary>
    public partial class RWebLeaveXMLReader : RMember //
    {
        ...
        public RWebLeaveXMLReader() : base("WebLeaveXMLReader")
        {
        }

        public RWebLeaveXMLReader(System.Object instance) : base("WebLeaveXMLReader")
		{
            SetInstance(instance);
		}

        public RWebLeaveXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RWebLeaveXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

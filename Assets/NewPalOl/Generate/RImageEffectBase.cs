...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ImageEffectBase
	/// </summary>
    public partial class RImageEffectBase : RMember //
    {
        ...
        public RImageEffectBase() : base("ImageEffectBase")
        {
        }

        public RImageEffectBase(System.Object instance) : base("ImageEffectBase")
		{
            SetInstance(instance);
		}

        public RImageEffectBase(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RImageEffectBase(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

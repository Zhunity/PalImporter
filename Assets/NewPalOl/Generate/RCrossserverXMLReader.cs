...
{
	/// <summary>
	/// CrossserverXMLReader
	/// </summary>
    public partial class RCrossserverXMLReader : RMember //
    {
        ...
        public RCrossserverXMLReader() : base("CrossserverXMLReader")
        {
        }

        public RCrossserverXMLReader(System.Object instance) : base("CrossserverXMLReader")
		{
            SetInstance(instance);
		}

        public RCrossserverXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCrossserverXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

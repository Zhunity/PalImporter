...
namespace SMFrame.Editor.Refleaction
{
	...
	/// ItemXMLReader
	/// </summary>
    public partial class RItemXMLReader : RMember //
    {
        ...
        public RItemXMLReader() : base("ItemXMLReader")
        {
        }

        public RItemXMLReader(System.Object instance) : base("ItemXMLReader")
		{
            SetInstance(instance);
		}

        public RItemXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RItemXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

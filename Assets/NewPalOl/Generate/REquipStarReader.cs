...
namespace SMFrame.Editor.Refleaction
{
	...
	/// EquipStarReader
	/// </summary>
    public partial class REquipStarReader : RMember //
    {
        ...
        public REquipStarReader() : base("EquipStarReader")
        {
        }

        public REquipStarReader(System.Object instance) : base("EquipStarReader")
		{
            SetInstance(instance);
		}

        public REquipStarReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REquipStarReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

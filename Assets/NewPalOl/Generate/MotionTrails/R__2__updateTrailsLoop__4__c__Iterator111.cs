...
{public partial class RMotionTrails
{
	...
	/// <summary>
	/// MotionTrails+<updateTrailsLoop>c__Iterator111
	/// </summary>
    public partial class R__2__updateTrailsLoop__4__c__Iterator111 : RMember //
    {
		...
		/// <summary>
		/// MotionTrails <>f__this
		/// </summary>
		protected RMotionTrails r___2____4__f__this;
		public virtual RMotionTrails R__2____4__f__this
		{
			get
			{
        ...
        public R__2__updateTrailsLoop__4__c__Iterator111() : base("MotionTrails+<updateTrailsLoop>c__Iterator111")
        {
        }

        public R__2__updateTrailsLoop__4__c__Iterator111(System.Object instance) : base("MotionTrails+<updateTrailsLoop>c__Iterator111")
		{
            SetInstance(instance);
		}

        public R__2__updateTrailsLoop__4__c__Iterator111(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__updateTrailsLoop__4__c__Iterator111(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

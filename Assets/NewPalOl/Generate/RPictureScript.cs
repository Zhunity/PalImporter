...
namespace SMFrame.Editor.Refleaction
{
	...
	/// PictureScript
	/// </summary>
    public partial class RPictureScript : RMember //
    {
		...
		public static RField RMAX_FADE_TIME
		{
			get
			{
				...
				{
					r_MAX_FADE_TIME = new( ReleactionUtils.GetType("PictureScript"), "MAX_FADE_TIME");
		...
		/// <summary>
		/// UnityEngine.Color m_TexColor
		/// </summary>
		protected RUnityEngine.RColor r_m_TexColor;
		public virtual RUnityEngine.RColor Rm_TexColor
		{
			get
			{
				if(r_m_TexColor == null)
				{
					r_m_TexColor = new(this, "m_TexColor");
					r_m_TexColor.SetBelong(this.instance);
				}
				return r_m_TexColor;
			}
		}
		...
		/// <summary>
		/// System.Byte m_byFadeType
		/// </summary>
		protected RField r_m_byFadeType;
		public virtual RField Rm_byFadeType
		{
			get
			{
				if(r_m_byFadeType == null)
				{
					r_m_byFadeType = new(this, "m_byFadeType");
					r_m_byFadeType.SetBelong(this.instance);
				}
				return r_m_byFadeType;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Rect m_StartRect
		/// </summary>
		protected RUnityEngine.RRect r_m_StartRect;
		public virtual RUnityEngine.RRect Rm_StartRect
		{
			get
			{
				if(r_m_StartRect == null)
				{
					r_m_StartRect = new(this, "m_StartRect");
					r_m_StartRect.SetBelong(this.instance);
				}
				return r_m_StartRect;
			}
		}

		/// <summary>
		/// UnityEngine.Rect m_EndRect
		/// </summary>
		protected RUnityEngine.RRect r_m_EndRect;
		public virtual RUnityEngine.RRect Rm_EndRect
		{
			get
			{
				if(r_m_EndRect == null)
				{
					r_m_EndRect = new(this, "m_EndRect");
					r_m_EndRect.SetBelong(this.instance);
				}
				return r_m_EndRect;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Rect m_PicRect
		/// </summary>
		protected RUnityEngine.RRect r_m_PicRect;
		public virtual RUnityEngine.RRect Rm_PicRect
		{
			get
			{
				if(r_m_PicRect == null)
				{
					r_m_PicRect = new(this, "m_PicRect");
					r_m_PicRect.SetBelong(this.instance);
				}
				return r_m_PicRect;
			}
		}
		...
		/// <summary>
		/// System.Int32 m_PicPosx
		/// </summary>
		protected RField r_m_PicPosx;
		public virtual RField Rm_PicPosx
		{
			get
			{
				if(r_m_PicPosx == null)
				{
					r_m_PicPosx = new(this, "m_PicPosx");
					r_m_PicPosx.SetBelong(this.instance);
				}
				return r_m_PicPosx;
			}
		}
		...
		/// <summary>
		/// System.Int32 m_PicPosy
		/// </summary>
		protected RField r_m_PicPosy;
		public virtual RField Rm_PicPosy
		{
			get
			{
				if(r_m_PicPosy == null)
				{
					r_m_PicPosy = new(this, "m_PicPosy");
					r_m_PicPosy.SetBelong(this.instance);
				}
				return r_m_PicPosy;
			}
		}
		...
		/// <summary>
		/// PictureScript+SHOW_PIC_STEP m_ShowPicStep
		/// </summary>
		protected RField r_m_ShowPicStep;
		public virtual RField Rm_ShowPicStep
		{
			get
			{
				if(r_m_ShowPicStep == null)
				{
					r_m_ShowPicStep = new(this, "m_ShowPicStep");
					r_m_ShowPicStep.SetBelong(this.instance);
				}
				return r_m_ShowPicStep;
			}
		}
		...
		/// <summary>
		/// Void InitPicDialog(SceneMovieDialogCmd, Boolean)
		/// </summary>
		protected RMethod r_RInitPicDialog_SceneMovieDialogCmd_Boolean;
		public virtual RMethod RInitPicDialog_SceneMovieDialogCmd_Boolean
		{
			get
			{
				if(r_RInitPicDialog_SceneMovieDialogCmd_Boolean == null)
				{
					r_RInitPicDialog_SceneMovieDialogCmd_Boolean = new(this, "InitPicDialog", 0, typeof(SceneMovieDialogCmd), typeof(System.Boolean));
					r_RInitPicDialog_SceneMovieDialogCmd_Boolean.SetBelong(this.instance);
				}
				return r_RInitPicDialog_SceneMovieDialogCmd_Boolean;
			}
		}

		/// <summary>
		/// Void SetupRect(Byte, Int32, Int32)
		/// </summary>
		protected RMethod r_RSetupRect_Byte_Int32_Int32;
		public virtual RMethod RSetupRect_Byte_Int32_Int32
		{
			get
			{
				if(r_RSetupRect_Byte_Int32_Int32 == null)
				{
					r_RSetupRect_Byte_Int32_Int32 = new(this, "SetupRect", 0, typeof(System.Byte), typeof(System.Int32), typeof(System.Int32));
					r_RSetupRect_Byte_Int32_Int32.SetBelong(this.instance);
				}
				return r_RSetupRect_Byte_Int32_Int32;
			}
		}
        ...
        public RPictureScript() : base("PictureScript")
        {
        }

        public RPictureScript(System.Object instance) : base("PictureScript")
		{
            SetInstance(instance);
		}

        public RPictureScript(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPictureScript(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void InitPicDialog(SceneMovieDialogCmd  @cmd, System.Boolean  @bWait)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cmd, @bWait};
            var ___result = RInitPicDialog_SceneMovieDialogCmd_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void SetupRect(System.Byte  @type, System.Int32  @posx, System.Int32  @posy)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@type, @posx, @posy};
            var ___result = RSetupRect_Byte_Int32_Int32.Invoke(___genericsType, ___parameters);

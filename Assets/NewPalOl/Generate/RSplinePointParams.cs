...
namespace SMFrame.Editor.Refleaction
{
	...
	/// SplinePointParams
	/// </summary>
    public partial class RSplinePointParams : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.Transform mAttachTarget
		/// </summary>
		protected RUnityEngine.RTransform r_mAttachTarget;
		public virtual RUnityEngine.RTransform RmAttachTarget
		{
			get
			{
				if(r_mAttachTarget == null)
				{
					r_mAttachTarget = new(this, "mAttachTarget");
					r_mAttachTarget.SetBelong(this.instance);
				}
				return r_mAttachTarget;
			}
		}
		...
		/// Void DetectActive()
		/// </summary>
		protected RMethod r_RDetectActive;
		public virtual RMethod RDetectActive
		{
			get
			{
				if(r_RDetectActive == null)
				{
					r_RDetectActive = new(this, "DetectActive", 0);
					r_RDetectActive.SetBelong(this.instance);
				}
				return r_RDetectActive;
			}
		}
        ...
        public RSplinePointParams() : base("SplinePointParams")
        {
        }

        public RSplinePointParams(System.Object instance) : base("SplinePointParams")
		{
            SetInstance(instance);
		}

        public RSplinePointParams(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSplinePointParams(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void DetectActive()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RDetectActive.Invoke(___genericsType, ___parameters);

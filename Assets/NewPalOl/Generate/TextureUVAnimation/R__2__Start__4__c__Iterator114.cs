...
{public partial class RTextureUVAnimation
{
	
	/// <summary>
	/// TextureUVAnimation+<Start>c__Iterator114
	/// </summary>
    public partial class R__2__Start__4__c__Iterator114 : RMember //
    {
		...
		/// <summary>
		/// TextureUVAnimation <>f__this
		/// </summary>
		protected RTextureUVAnimation r___2____4__f__this;
		public virtual RTextureUVAnimation R__2____4__f__this
		{
			get
			{
        ...
        public R__2__Start__4__c__Iterator114() : base("TextureUVAnimation+<Start>c__Iterator114")
        {
        }

        public R__2__Start__4__c__Iterator114(System.Object instance) : base("TextureUVAnimation+<Start>c__Iterator114")
		{
            SetInstance(instance);
		}

        public R__2__Start__4__c__Iterator114(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__Start__4__c__Iterator114(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// TickCountNumber
	/// </summary>
    public partial class RTickCountNumber : RMember //
    {

		/// <summary>
		/// UnityEngine.Texture2D numberTexture
		/// </summary>
		protected RUnityEngine.RTexture2D r_numberTexture;
		public virtual RUnityEngine.RTexture2D RnumberTexture
		{
			get
			{
				if(r_numberTexture == null)
				{
					r_numberTexture = new(this, "numberTexture");
					r_numberTexture.SetBelong(this.instance);
				}
				return r_numberTexture;
			}
		}

		/// <summary>
		/// NumberTexture mTickCountNumber
		/// </summary>
		protected RNumberTexture r_mTickCountNumber;
		public virtual RNumberTexture RmTickCountNumber
		{
			get
			{
				if(r_mTickCountNumber == null)
				{
					r_mTickCountNumber = new(this, "mTickCountNumber");
					r_mTickCountNumber.SetBelong(this.instance);
				}
				return r_mTickCountNumber;
			}
		}

		/// <summary>
		/// System.Int32 TickCountSecond
		/// </summary>
		protected RField r_TickCountSecond;
		public virtual RField RTickCountSecond
		{
			get
			{
				if(r_TickCountSecond == null)
				{
					r_TickCountSecond = new(this, "TickCountSecond");
					r_TickCountSecond.SetBelong(this.instance);
				}
				return r_TickCountSecond;
			}
		}
		...
		/// </summary>
		protected RField r_LastTime;
		public virtual RField RLastTime
		{
			get
			{
				if(r_LastTime == null)
		...
		/// <summary>
		/// Void BeginTickCount(Int32)
		/// </summary>
		protected RMethod r_RBeginTickCount_Int32;
		public virtual RMethod RBeginTickCount_Int32
		{
			get
			{
				if(r_RBeginTickCount_Int32 == null)
				{
					r_RBeginTickCount_Int32 = new(this, "BeginTickCount", 0, typeof(System.Int32));
					r_RBeginTickCount_Int32.SetBelong(this.instance);
				}
				return r_RBeginTickCount_Int32;
			}
		}

		/// <summary>
		/// Void SetSecond(Int32)
		/// </summary>
		protected RMethod r_RSetSecond_Int32;
		public virtual RMethod RSetSecond_Int32
		{
			get
			{
				if(r_RSetSecond_Int32 == null)
				{
					r_RSetSecond_Int32 = new(this, "SetSecond", 0, typeof(System.Int32));
					r_RSetSecond_Int32.SetBelong(this.instance);
				}
				return r_RSetSecond_Int32;
			}
		}
        ...
        public RTickCountNumber() : base("TickCountNumber")
        {
        }

        public RTickCountNumber(System.Object instance) : base("TickCountNumber")
		{
            SetInstance(instance);
		}

        public RTickCountNumber(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RTickCountNumber(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void BeginTickCount(System.Int32  @tickCountSecond)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@tickCountSecond};
            var ___result = RBeginTickCount_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void SetSecond(System.Int32  @second)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@second};
            var ___result = RSetSecond_Int32.Invoke(___genericsType, ___parameters);

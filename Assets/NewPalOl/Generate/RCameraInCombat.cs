...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CameraInCombat
	/// </summary>
    public partial class RCameraInCombat : RMember //
    {

		/// <summary>
		/// UnityEngine.Vector3 vOriginPosition
		/// </summary>
		protected RUnityEngine.RVector3 r_vOriginPosition;
		public virtual RUnityEngine.RVector3 RvOriginPosition
		{
			get
			{
				if(r_vOriginPosition == null)
				{
					r_vOriginPosition = new(this, "vOriginPosition");
					r_vOriginPosition.SetBelong(this.instance);
				}
				return r_vOriginPosition;
			}
		}
		...
		/// </summary>
		protected RMethod r_R_StartCameraShake;
		public virtual RMethod R_StartCameraShake
		{
			get
			{
				if(r_R_StartCameraShake == null)
				{
					r_R_StartCameraShake = new(this, "_StartCameraShake", 0);
					r_R_StartCameraShake.SetBelong(this.instance);
				}
				return r_R_StartCameraShake;
			}
		}

		/// <summary>
		/// Void StartCameraShake(Single, Single)
		/// </summary>
		protected RMethod r_RStartCameraShake_Single_Single;
		public virtual RMethod RStartCameraShake_Single_Single
		{
			get
			{
				if(r_RStartCameraShake_Single_Single == null)
				{
					r_RStartCameraShake_Single_Single = new(this, "StartCameraShake", 0, typeof(System.Single), typeof(System.Single));
					r_RStartCameraShake_Single_Single.SetBelong(this.instance);
				}
				return r_RStartCameraShake_Single_Single;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator UpdateCameraShake()
		/// </summary>
        ...
        public RCameraInCombat() : base("CameraInCombat")
        {
        }

        public RCameraInCombat(System.Object instance) : base("CameraInCombat")
		{
            SetInstance(instance);
		}

        public RCameraInCombat(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCameraInCombat(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void _StartCameraShake()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R_StartCameraShake.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void StartCameraShake(System.Single  @mDuration, System.Single  @amplitude)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@mDuration, @amplitude};
            var ___result = RStartCameraShake_Single_Single.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator UpdateCameraShake()
        {

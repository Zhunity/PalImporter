...
namespace SMFrame.Editor.Refleaction
{
	...
	/// NPCRangeTrigger
	/// </summary>
    public partial class RNPCRangeTrigger : RMember //
    {

		/// <summary>
		/// System.Boolean _intriggerRange
		/// </summary>
		protected RField r__intriggerRange;
		public virtual RField R_intriggerRange
		{
			get
			{
				if(r__intriggerRange == null)
				{
					r__intriggerRange = new(this, "_intriggerRange");
					r__intriggerRange.SetBelong(this.instance);
				}
				return r__intriggerRange;
			}
		}
        ...
        public RNPCRangeTrigger() : base("NPCRangeTrigger")
        {
        }

        public RNPCRangeTrigger(System.Object instance) : base("NPCRangeTrigger")
		{
            SetInstance(instance);
		}

        public RNPCRangeTrigger(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RNPCRangeTrigger(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

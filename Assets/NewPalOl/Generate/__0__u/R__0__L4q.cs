...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#L4q
	/// </summary>
    public partial class R__0__L4q : RMember //
    {
		...
		/// <summary>
		/// Void #J4q(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__J4q_Object___0__7X;
		public virtual RMethod R__0__J4q_Object___0__7X
		{
			get
			{
				if(r_R__0__J4q_Object___0__7X == null)
				{
					r_R__0__J4q_Object___0__7X = new(this, "#J4q", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__J4q_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__J4q_Object___0__7X;
			}
		}
		...
		/// Void #Kb(#Pfb.#N6q)
		/// </summary>
		protected RMethod r_R__0__Kb___0__N6q;
		public virtual RMethod R__0__Kb___0__N6q
		{
			get
			{
				if(r_R__0__Kb___0__N6q == null)
				{
					r_R__0__Kb___0__N6q = new(this, "#Kb", 0,  ReleactionUtils.GetType("#Pfb.#N6q"));
					r_R__0__Kb___0__N6q.SetBelong(this.instance);
				}
				return r_R__0__Kb___0__N6q;
			}
		}
		...
		/// Void #K4q(#Pfb.#O6q)
		/// </summary>
		protected RMethod r_R__0__K4q___0__O6q;
		public virtual RMethod R__0__K4q___0__O6q
		{
			get
			{
				if(r_R__0__K4q___0__O6q == null)
				{
					r_R__0__K4q___0__O6q = new(this, "#K4q", 0,  ReleactionUtils.GetType("#Pfb.#O6q"));
					r_R__0__K4q___0__O6q.SetBelong(this.instance);
				}
				return r_R__0__K4q___0__O6q;
			}
		}
        ...
        public R__0__L4q() : base("#u.#L4q")
        {
        }

        public R__0__L4q(System.Object instance) : base("#u.#L4q")
		{
            SetInstance(instance);
		}

        public R__0__L4q(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__L4q(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

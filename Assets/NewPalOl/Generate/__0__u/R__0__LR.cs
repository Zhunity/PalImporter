...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#LR
	/// </summary>
    public partial class R__0__LR : RMember //
    {
		...
		/// Void #KR(#oU.#VZ, #oU.#VZ)
		/// </summary>
		protected RMethod r_R__0__KR___0__VZ___0__VZ;
		public virtual RMethod R__0__KR___0__VZ___0__VZ
		{
			get
			{
				if(r_R__0__KR___0__VZ___0__VZ == null)
				{
					r_R__0__KR___0__VZ___0__VZ = new(this, "#KR", 0,  ReleactionUtils.GetType("#oU.#VZ"),  ReleactionUtils.GetType("#oU.#VZ"));
					r_R__0__KR___0__VZ___0__VZ.SetBelong(this.instance);
				}
				return r_R__0__KR___0__VZ___0__VZ;
			}
		}
        ...
        public R__0__LR() : base("#u.#LR")
        {
        }

        public R__0__LR(System.Object instance) : base("#u.#LR")
		{
            SetInstance(instance);
		}

        public R__0__LR(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__LR(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

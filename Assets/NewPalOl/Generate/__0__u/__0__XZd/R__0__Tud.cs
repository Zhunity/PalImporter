...
{public partial class R__0__XZd
{
	...
	/// #u.#XZd+#Tud
	/// </summary>
    public partial class R__0__Tud : RMember //
    {
		...
		/// #u.#XZd #f
		/// </summary>
		protected R__0__u.R__0__XZd r___0__f;
		public virtual R__0__u.R__0__XZd R__0__f
		{
			get
			{
				if(r___0__f == null)
        ...
        public R__0__Tud() : base("#u.#XZd+#Tud")
        {
        }

        public R__0__Tud(System.Object instance) : base("#u.#XZd+#Tud")
		{
            SetInstance(instance);
		}

        public R__0__Tud(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Tud(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

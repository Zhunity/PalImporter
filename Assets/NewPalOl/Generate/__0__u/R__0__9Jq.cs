...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#9Jq
	/// </summary>
    public partial class R__0__9Jq : RMember //
    {
		...
		public static RSystem.RFunc<RGameDefineType.RID, RField> R__0__e
		{
			get
			{
				if(r___0__e == null)
				{
					r___0__e = new( ReleactionUtils.GetType("#u.#9Jq"), "#e");
		...
		/// <summary>
		/// Boolean #8Jq(GameDefineType.ID)
		/// </summary>
		protected static RMethod r_R__0__8Jq_ID;
		public static RMethod R__0__8Jq_ID
		{
			get
			{
				if(r_R__0__8Jq_ID == null)
				{
					r_R__0__8Jq_ID = new( ReleactionUtils.GetType("#u.#9Jq"), "#8Jq", 0, typeof(GameDefineType.ID));
					r_R__0__8Jq_ID.SetBelong(null);
				}
				return r_R__0__8Jq_ID;
			}
		}
        ...
        public R__0__9Jq() : base("#u.#9Jq")
        {
        }

        public R__0__9Jq(System.Object instance) : base("#u.#9Jq")
		{
            SetInstance(instance);
		}

        public R__0__9Jq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Jq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public static System.Boolean __0__8Jq(GameDefineType.ID  @x)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@x};
            var ___result = R__0__8Jq_ID.Invoke(___genericsType, ___parameters);

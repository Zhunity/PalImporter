...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#BR
	/// </summary>
    public partial class R__0__BR : RMember //
    {
		...
		/// <summary>
		/// Void #wR(System.String)
		/// </summary>
		protected RMethod r_R__0__wR_String;
		public virtual RMethod R__0__wR_String
		{
			get
			{
				if(r_R__0__wR_String == null)
				{
					r_R__0__wR_String = new(this, "#wR", 0, typeof(System.String));
					r_R__0__wR_String.SetBelong(this.instance);
				}
				return r_R__0__wR_String;
			}
		}

		/// <summary>
		/// Void #xR(System.String)
		/// </summary>
		protected RMethod r_R__0__xR_String;
		public virtual RMethod R__0__xR_String
		{
			get
			{
				if(r_R__0__xR_String == null)
				{
					r_R__0__xR_String = new(this, "#xR", 0, typeof(System.String));
					r_R__0__xR_String.SetBelong(this.instance);
				}
				return r_R__0__xR_String;
			}
		}
		...
		/// <summary>
		/// Void #3Fc(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__3Fc_Object___0__7X;
		public virtual RMethod R__0__3Fc_Object___0__7X
		{
			get
			{
				if(r_R__0__3Fc_Object___0__7X == null)
				{
					r_R__0__3Fc_Object___0__7X = new(this, "#3Fc", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__3Fc_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__3Fc_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #4Fc(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__4Fc_Object___0__7X;
		public virtual RMethod R__0__4Fc_Object___0__7X
		{
			get
			{
				if(r_R__0__4Fc_Object___0__7X == null)
				{
					r_R__0__4Fc_Object___0__7X = new(this, "#4Fc", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__4Fc_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__4Fc_Object___0__7X;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator #yR()
		/// </summary>
		protected RMethod r_R__0__yR;
		public virtual RMethod R__0__yR
		{
			get
			{
				if(r_R__0__yR == null)
				{
					r_R__0__yR = new(this, "#yR", 0);
					r_R__0__yR.SetBelong(this.instance);
				}
				return r_R__0__yR;
			}
		}
		...
		/// Boolean #AR()
		/// </summary>
		protected RMethod r_R__0__AR;
		public virtual RMethod R__0__AR
		{
			get
			{
				if(r_R__0__AR == null)
				{
					r_R__0__AR = new(this, "#AR", 0);
					r_R__0__AR.SetBelong(this.instance);
				}
				return r_R__0__AR;
			}
		}
        ...
        public R__0__BR() : base("#u.#BR")
        {
        }

        public R__0__BR(System.Object instance) : base("#u.#BR")
		{
            SetInstance(instance);
		}

        public R__0__BR(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__BR(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__wR(System.String  @text)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text};
            var ___result = R__0__wR_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__xR(System.String  @text)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text};
            var ___result = R__0__xR_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Collections.IEnumerator __0__yR()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__yR.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Boolean __0__AR()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__AR.Invoke(___genericsType, ___parameters);

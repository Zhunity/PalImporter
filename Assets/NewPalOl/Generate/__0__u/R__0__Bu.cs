...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Bu
	/// </summary>
    public partial class R__0__Bu : RMember //
    {

		/// <summary>
		/// #u.#Bu+#ONb #a
		/// </summary>
		protected R__0__u.R__0__Bu.R__0__ONb r___0__a;
		public virtual R__0__u.R__0__Bu.R__0__ONb R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #u.#Bu+#PNb #b
		/// </summary>
		protected R__0__u.R__0__Bu.R__0__PNb r___0__b;
		public virtual R__0__u.R__0__Bu.R__0__PNb R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// <summary>
		/// Void #mk(Boolean, Single)
		/// </summary>
		protected RMethod r_R__0__mk_Boolean_Single;
		public virtual RMethod R__0__mk_Boolean_Single
		{
			get
			{
				if(r_R__0__mk_Boolean_Single == null)
				{
					r_R__0__mk_Boolean_Single = new(this, "#mk", 0, typeof(System.Boolean), typeof(System.Single));
					r_R__0__mk_Boolean_Single.SetBelong(this.instance);
				}
				return r_R__0__mk_Boolean_Single;
			}
		}

		/// <summary>
		/// Void #mk(Boolean, Single, System.String)
		/// </summary>
		protected RMethod r_R__0__mk_Boolean_Single_String;
		public virtual RMethod R__0__mk_Boolean_Single_String
		{
			get
			{
				if(r_R__0__mk_Boolean_Single_String == null)
				{
					r_R__0__mk_Boolean_Single_String = new(this, "#mk", 0, typeof(System.Boolean), typeof(System.Single), typeof(System.String));
					r_R__0__mk_Boolean_Single_String.SetBelong(this.instance);
				}
				return r_R__0__mk_Boolean_Single_String;
			}
		}
		...
		/// Void #xu()
		/// </summary>
		protected RMethod r_R__0__xu;
		public virtual RMethod R__0__xu
		{
			get
			{
				if(r_R__0__xu == null)
				{
					r_R__0__xu = new(this, "#xu", 0);
		...
		/// <summary>
		/// System.Collections.IEnumerator #yu(Int32)
		/// </summary>
		protected RMethod r_R__0__yu_Int32;
		public virtual RMethod R__0__yu_Int32
		{
			get
			{
				if(r_R__0__yu_Int32 == null)
				{
					r_R__0__yu_Int32 = new(this, "#yu", 0, typeof(System.Int32));
					r_R__0__yu_Int32.SetBelong(this.instance);
				}
				return r_R__0__yu_Int32;
			}
		}
		...
		/// Void #zu(Boolean)
		/// </summary>
		protected RMethod r_R__0__zu_Boolean;
		public virtual RMethod R__0__zu_Boolean
		{
			get
			{
				if(r_R__0__zu_Boolean == null)
				{
					r_R__0__zu_Boolean = new(this, "#zu", 0, typeof(System.Boolean));
					r_R__0__zu_Boolean.SetBelong(this.instance);
				}
				return r_R__0__zu_Boolean;
			}
		}
		...
		/// Void #9wc()
		/// </summary>
		protected RMethod r_R__0__9wc;
		public virtual RMethod R__0__9wc
		{
			get
			{
				if(r_R__0__9wc == null)
				{
					r_R__0__9wc = new(this, "#9wc", 0);
					r_R__0__9wc.SetBelong(this.instance);
				}
				return r_R__0__9wc;
			}
		}
		...
		/// <summary>
		/// Void PlayAnim(Boolean)
		/// </summary>
		protected RMethod r_RPlayAnim_Boolean;
		public virtual RMethod RPlayAnim_Boolean
		{
			get
			{
				if(r_RPlayAnim_Boolean == null)
				{
					r_RPlayAnim_Boolean = new(this, "PlayAnim", 0, typeof(System.Boolean));
					r_RPlayAnim_Boolean.SetBelong(this.instance);
				}
				return r_RPlayAnim_Boolean;
			}
		}
        ...
        public R__0__Bu() : base("#u.#Bu")
        {
        }

        public R__0__Bu(System.Object instance) : base("#u.#Bu")
		{
            SetInstance(instance);
		}

        public R__0__Bu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Bu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__mk(System.Boolean  @show, System.Single  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@show, @time};
            var ___result = R__0__mk_Boolean_Single.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__mk(System.Boolean  @show, System.Single  @time, System.String  @tip)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@show, @time, @tip};
            var ___result = R__0__mk_Boolean_Single_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__xu()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__xu.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator __0__yu(System.Int32  @timeID)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@timeID};
            var ___result = R__0__yu_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__zu(System.Boolean  @bLock)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bLock};
            var ___result = R__0__zu_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__9wc()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__9wc.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void PlayAnim(System.Boolean  @bPlay)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bPlay};
            var ___result = RPlayAnim_Boolean.Invoke(___genericsType, ___parameters);

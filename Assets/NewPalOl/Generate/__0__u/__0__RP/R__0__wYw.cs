...
{public partial class R__0__RP
{
	
	/// <summary>
	/// #u.#RP+#wYw
	/// </summary>
    public partial class R__0__wYw : RMember //
    {

		/// <summary>
		/// #u.#CFb+#Nuf #a
		/// </summary>
		protected R__0__u.R__0__CFb.R__0__Nuf r___0__a;
		public virtual R__0__u.R__0__CFb.R__0__Nuf R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #u.#RP #e
		/// </summary>
		protected R__0__u.R__0__RP r___0__e;
		public virtual R__0__u.R__0__RP R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__wYw() : base("#u.#RP+#wYw")
        {
        }

        public R__0__wYw(System.Object instance) : base("#u.#RP+#wYw")
		{
            SetInstance(instance);
		}

        public R__0__wYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__wYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

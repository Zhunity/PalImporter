...
{public partial class R__0__RP
{
	...
	/// #u.#RP+#xYw
	/// </summary>
    public partial class R__0__xYw : RMember //
    {
		...
		/// #u.#RP #c
		/// </summary>
		protected R__0__u.R__0__RP r___0__c;
		public virtual R__0__u.R__0__RP R__0__c
		{
			get
			{
				if(r___0__c == null)
        ...
        public R__0__xYw() : base("#u.#RP+#xYw")
        {
        }

        public R__0__xYw(System.Object instance) : base("#u.#RP+#xYw")
		{
            SetInstance(instance);
		}

        public R__0__xYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__xYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

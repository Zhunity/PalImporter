...
{public partial class R__0__NSc
{
	...
	/// #u.#NSc+#nYw
	/// </summary>
    public partial class R__0__nYw : RMember //
    {

		/// <summary>
		/// #u.#jUb #a
		/// </summary>
		protected R__0__u.R__0__jUb r___0__a;
		public virtual R__0__u.R__0__jUb R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// MyGUIEmptyWnd #e
		/// </summary>
		protected RMyGUIEmptyWnd r___0__e;
		public virtual RMyGUIEmptyWnd R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__nYw() : base("#u.#NSc+#nYw")
        {
        }

        public R__0__nYw(System.Object instance) : base("#u.#NSc+#nYw")
		{
            SetInstance(instance);
		}

        public R__0__nYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__nYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

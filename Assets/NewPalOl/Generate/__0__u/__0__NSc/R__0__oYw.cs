...
{public partial class R__0__NSc
{
	
	/// <summary>
	/// #u.#NSc+#oYw
	/// </summary>
    public partial class R__0__oYw : RMember //
    {

		/// <summary>
		/// #u.#jR #a
		/// </summary>
		protected R__0__u.R__0__jR r___0__a;
		public virtual R__0__u.R__0__jR R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// MyGUIEmptyWnd #f
		/// </summary>
		protected RMyGUIEmptyWnd r___0__f;
		public virtual RMyGUIEmptyWnd R__0__f
		{
			get
			{
				if(r___0__f == null)
        ...
        public R__0__oYw() : base("#u.#NSc+#oYw")
        {
        }

        public R__0__oYw(System.Object instance) : base("#u.#NSc+#oYw")
		{
            SetInstance(instance);
		}

        public R__0__oYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

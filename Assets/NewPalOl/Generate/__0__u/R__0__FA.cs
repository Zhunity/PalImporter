...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#FA
	/// </summary>
    public partial class R__0__FA : RMember //
    {
		...
		/// MyGUIWindow #d
		/// </summary>
		protected RMyGUIWindow r___0__d;
		public virtual RMyGUIWindow R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		public static RField R__0__e
		{
			get
			{
				if(r___0__e == null)
				{
					r___0__e = new( ReleactionUtils.GetType("#u.#FA"), "#e");
		...
		/// #u.#MSc #f
		/// </summary>
		protected R__0__u.R__0__MSc r___0__f;
		public virtual R__0__u.R__0__MSc R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// <summary>
		/// Void #AA(System.String, #cjb, GameDefineType.ID, #LNb1, System.String)
		/// </summary>
		protected RMethod r_R__0__AA_String___0__cjb_ID___0__LNb1_String;
		public virtual RMethod R__0__AA_String___0__cjb_ID___0__LNb1_String
		{
			get
			{
				if(r_R__0__AA_String___0__cjb_ID___0__LNb1_String == null)
				{
					r_R__0__AA_String___0__cjb_ID___0__LNb1_String = new(this, "#AA", 0, typeof(System.String),  ReleactionUtils.GetType("#u.#LSc+#cjb"), typeof(GameDefineType.ID),  ReleactionUtils.GetType("#u.#IOc+#LNb1"), typeof(System.String));
					r_R__0__AA_String___0__cjb_ID___0__LNb1_String.SetBelong(this.instance);
				}
				return r_R__0__AA_String___0__cjb_ID___0__LNb1_String;
			}
		}

		/// <summary>
		/// System.Object #BA(#cjb, GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__BA___0__cjb_ID;
		public virtual RMethod R__0__BA___0__cjb_ID
		{
			get
			{
				if(r_R__0__BA___0__cjb_ID == null)
				{
					r_R__0__BA___0__cjb_ID = new(this, "#BA", 0,  ReleactionUtils.GetType("#u.#LSc+#cjb"), typeof(GameDefineType.ID));
					r_R__0__BA___0__cjb_ID.SetBelong(this.instance);
				}
				return r_R__0__BA___0__cjb_ID;
			}
		}
		...
		/// <summary>
		/// Void #DA(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__DA_Object___0__7X;
		public virtual RMethod R__0__DA_Object___0__7X
		{
			get
			{
				if(r_R__0__DA_Object___0__7X == null)
				{
					r_R__0__DA_Object___0__7X = new(this, "#DA", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__DA_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__DA_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #EA(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__EA_Object___0__7X;
		public virtual RMethod R__0__EA_Object___0__7X
		{
			get
			{
				if(r_R__0__EA_Object___0__7X == null)
				{
					r_R__0__EA_Object___0__7X = new(this, "#EA", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__EA_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__EA_Object___0__7X;
			}
		}
        ...
        public R__0__FA() : base("#u.#FA")
        {
        }

        public R__0__FA(System.Object instance) : base("#u.#FA")
		{
            SetInstance(instance);
		}

        public R__0__FA(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__FA(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

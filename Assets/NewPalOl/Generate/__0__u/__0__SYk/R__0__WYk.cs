...
{public partial class R__0__SYk
{
	...
	/// #u.#SYk+#WYk
	/// </summary>
    public partial class R__0__WYk : RMember //
    {
        ...
        public R__0__WYk() : base("#u.#SYk+#WYk")
        {
        }

        public R__0__WYk(System.Object instance) : base("#u.#SYk+#WYk")
		{
            SetInstance(instance);
		}

        public R__0__WYk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__WYk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

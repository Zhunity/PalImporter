...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#48
	/// </summary>
    public partial class R__0__48 : RMember //
    {

		/// <summary>
		/// #Pfb.#apb #a
		/// </summary>
		protected R__0__Pfb.R__0__apb r___0__a;
		public virtual R__0__Pfb.R__0__apb R__0__a
		{
			get
			{
				if(r___0__a == null)
        ...
        public R__0__48() : base("#u.#48")
        {
        }

        public R__0__48(System.Object instance) : base("#u.#48")
		{
            SetInstance(instance);
		}

        public R__0__48(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__48(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#jYk
	/// </summary>
    public partial class R__0__jYk : RMember //
    {
		...
		/// Void #Pb(#Pfb.#F2k)
		/// </summary>
		protected RMethod r_R__0__Pb___0__F2k;
		public virtual RMethod R__0__Pb___0__F2k
		{
			get
			{
				if(r_R__0__Pb___0__F2k == null)
				{
					r_R__0__Pb___0__F2k = new(this, "#Pb", 0,  ReleactionUtils.GetType("#Pfb.#F2k"));
					r_R__0__Pb___0__F2k.SetBelong(this.instance);
				}
				return r_R__0__Pb___0__F2k;
			}
		}
        ...
        public R__0__jYk() : base("#u.#jYk")
        {
        }

        public R__0__jYk(System.Object instance) : base("#u.#jYk")
		{
            SetInstance(instance);
		}

        public R__0__jYk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jYk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

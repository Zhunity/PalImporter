...
{public partial class R__0__wq
{
	
	/// <summary>
	/// #u.#wq+#dRw
	/// </summary>
    public partial class R__0__dRw : RMember //
    {
		...
		/// #u.#wq #c
		/// </summary>
		protected R__0__u.R__0__wq r___0__c;
		public virtual R__0__u.R__0__wq R__0__c
		{
			get
			{
				if(r___0__c == null)
        ...
        public R__0__dRw() : base("#u.#wq+#dRw")
        {
        }

        public R__0__dRw(System.Object instance) : base("#u.#wq+#dRw")
		{
            SetInstance(instance);
		}

        public R__0__dRw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dRw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

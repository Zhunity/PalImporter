...
{public partial class R__0__O3p
{
	
	/// <summary>
	/// #u.#O3p+#hSw
	/// </summary>
    public partial class R__0__hSw : RMember //
    {

		/// <summary>
		/// AssetBundleDownloader+ABLoadedArgs #a
		/// </summary>
		protected RAssetBundleDownloader.RABLoadedArgs r___0__a;
		public virtual RAssetBundleDownloader.RABLoadedArgs R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1[SeekPartnerConfig] #b
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RSeekPartnerConfig> r___0__b;
		public virtual RSystem.RCollections.RGeneric.RList<RSeekPartnerConfig> R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// </summary>
		protected RFieldArray<RUnityEngine.RTransform> r___0__e;
		public virtual RFieldArray<RUnityEngine.RTransform> R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// </summary>
		protected RUnityEngine.RTransform r___0__g;
		public virtual RUnityEngine.RTransform R__0__g
		{
			get
			{
				if(r___0__g == null)
		...
		/// <summary>
		/// UnityEngine.MeshRenderer #h
		/// </summary>
		protected RUnityEngine.RMeshRenderer r___0__h;
		public virtual RUnityEngine.RMeshRenderer R__0__h
		{
			get
			{
				if(r___0__h == null)
		...
		/// System.Object #j
		/// </summary>
		protected RSystem.RObject r___0__j;
		public virtual RSystem.RObject R__0__j
		{
			get
			{
				if(r___0__j == null)
		...
		/// <summary>
		/// AssetBundleDownloader+ABLoadedArgs #k
		/// </summary>
		protected RAssetBundleDownloader.RABLoadedArgs r___0__k;
		public virtual RAssetBundleDownloader.RABLoadedArgs R__0__k
		{
			get
			{
				if(r___0__k == null)
		...
		/// #u.#O3p #l
		/// </summary>
		protected R__0__u.R__0__O3p r___0__l;
		public virtual R__0__u.R__0__O3p R__0__l
		{
			get
			{
				if(r___0__l == null)
        ...
        public R__0__hSw() : base("#u.#O3p+#hSw")
        {
        }

        public R__0__hSw(System.Object instance) : base("#u.#O3p+#hSw")
		{
            SetInstance(instance);
		}

        public R__0__hSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

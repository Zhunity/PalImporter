...
{public partial class R__0__5jc
{
	
	/// <summary>
	/// #u.#5jc+#oTw
	/// </summary>
    public partial class R__0__oTw : RMember //
    {
		...
		/// CAMERA_PARAM #b
		/// </summary>
		protected RCAMERA_PARAM r___0__b;
		public virtual RCAMERA_PARAM R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// #u.#5jc #f
		/// </summary>
		protected R__0__u.R__0__5jc r___0__f;
		public virtual R__0__u.R__0__5jc R__0__f
		{
			get
			{
				if(r___0__f == null)
        ...
        public R__0__oTw() : base("#u.#5jc+#oTw")
        {
        }

        public R__0__oTw(System.Object instance) : base("#u.#5jc+#oTw")
		{
            SetInstance(instance);
		}

        public R__0__oTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

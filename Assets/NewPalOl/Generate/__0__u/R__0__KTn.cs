...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#KTn
	/// </summary>
    public partial class R__0__KTn : RMember //
    {
		...
		/// Void #mk(Int32, Int32)
		/// </summary>
		protected RMethod r_R__0__mk_Int32_Int32;
		public virtual RMethod R__0__mk_Int32_Int32
		{
			get
			{
				if(r_R__0__mk_Int32_Int32 == null)
				{
					r_R__0__mk_Int32_Int32 = new(this, "#mk", 0, typeof(System.Int32), typeof(System.Int32));
					r_R__0__mk_Int32_Int32.SetBelong(this.instance);
				}
				return r_R__0__mk_Int32_Int32;
			}
		}
        ...
        public R__0__KTn() : base("#u.#KTn")
        {
        }

        public R__0__KTn(System.Object instance) : base("#u.#KTn")
		{
            SetInstance(instance);
		}

        public R__0__KTn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__KTn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__mk(System.Int32  @srcItem, System.Int32  @dstItem)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@srcItem, @dstItem};
            var ___result = R__0__mk_Int32_Int32.Invoke(___genericsType, ___parameters);

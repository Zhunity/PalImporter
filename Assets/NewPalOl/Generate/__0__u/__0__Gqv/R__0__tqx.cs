...
{public partial class R__0__Gqv
{
	
	/// <summary>
	/// #u.#Gqv+#tqx
	/// </summary>
    public partial class R__0__tqx : RMember //
    {
		...
		/// #u.#Gqv #n
		/// </summary>
		protected R__0__u.R__0__Gqv r___0__n;
		public virtual R__0__u.R__0__Gqv R__0__n
		{
			get
			{
				if(r___0__n == null)
        ...
        public R__0__tqx() : base("#u.#Gqv+#tqx")
        {
        }

        public R__0__tqx(System.Object instance) : base("#u.#Gqv+#tqx")
		{
            SetInstance(instance);
		}

        public R__0__tqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__tqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

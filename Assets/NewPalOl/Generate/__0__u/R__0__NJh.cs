...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#NJh
	/// </summary>
    public partial class R__0__NJh : RMember //
    {
		...
		/// <summary>
		/// Void #Xd(System.String)
		/// </summary>
		protected RMethod r_R__0__Xd_String;
		public virtual RMethod R__0__Xd_String
		{
			get
			{
				if(r_R__0__Xd_String == null)
				{
					r_R__0__Xd_String = new(this, "#Xd", 0, typeof(System.String));
					r_R__0__Xd_String.SetBelong(this.instance);
				}
				return r_R__0__Xd_String;
			}
		}
        ...
        public R__0__NJh() : base("#u.#NJh")
        {
        }

        public R__0__NJh(System.Object instance) : base("#u.#NJh")
		{
            SetInstance(instance);
		}

        public R__0__NJh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__NJh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Xd(System.String  @rankstr)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@rankstr};
            var ___result = R__0__Xd_String.Invoke(___genericsType, ___parameters);

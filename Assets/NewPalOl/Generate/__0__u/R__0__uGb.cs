...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#uGb
	/// </summary>
    public partial class R__0__uGb : RMember //
    {
        ...
        public R__0__uGb() : base("#u.#uGb")
        {
        }

        public R__0__uGb(System.Object instance) : base("#u.#uGb")
		{
            SetInstance(instance);
		}

        public R__0__uGb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__uGb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

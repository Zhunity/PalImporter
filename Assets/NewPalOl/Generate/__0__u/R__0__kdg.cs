...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#kdg
	/// </summary>
    public partial class R__0__kdg : RMember //
    {
		...
		/// #u.#IOc+#LNb1 #c
		/// </summary>
		protected R__0__u.R__0__IOc.R__0__LNb1 r___0__c;
		public virtual R__0__u.R__0__IOc.R__0__LNb1 R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.Int32,#u.#Ckb] #f
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, R__0__u.R__0__Ckb> r___0__f;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, R__0__u.R__0__Ckb> R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// Void #OZg()
		/// </summary>
		protected RMethod r_R__0__OZg;
		public virtual RMethod R__0__OZg
		{
			get
			{
				if(r_R__0__OZg == null)
				{
					r_R__0__OZg = new(this, "#OZg", 0);
					r_R__0__OZg.SetBelong(this.instance);
				}
				return r_R__0__OZg;
			}
		}
		...
		/// <summary>
		/// Void #PZg(System.Object)
		/// </summary>
		protected RMethod r_R__0__PZg_Object;
		public virtual RMethod R__0__PZg_Object
		{
			get
			{
				if(r_R__0__PZg_Object == null)
				{
					r_R__0__PZg_Object = new(this, "#PZg", 0, typeof(System.Object));
					r_R__0__PZg_Object.SetBelong(this.instance);
				}
				return r_R__0__PZg_Object;
			}
		}
		...
		/// <summary>
		/// Void #RZg(System.Object)
		/// </summary>
		protected RMethod r_R__0__RZg_Object;
		public virtual RMethod R__0__RZg_Object
		{
			get
			{
				if(r_R__0__RZg_Object == null)
				{
					r_R__0__RZg_Object = new(this, "#RZg", 0, typeof(System.Object));
					r_R__0__RZg_Object.SetBelong(this.instance);
				}
				return r_R__0__RZg_Object;
			}
		}

		/// <summary>
		/// Void #SZg(#u.#NZg, #LNb1, System.Object)
		/// </summary>
		protected RMethod r_R__0__SZg___0__NZg___0__LNb1_Object;
		public virtual RMethod R__0__SZg___0__NZg___0__LNb1_Object
		{
			get
			{
				if(r_R__0__SZg___0__NZg___0__LNb1_Object == null)
				{
					r_R__0__SZg___0__NZg___0__LNb1_Object = new(this, "#SZg", 0,  ReleactionUtils.GetType("#u.#NZg"),  ReleactionUtils.GetType("#u.#IOc+#LNb1"), typeof(System.Object));
					r_R__0__SZg___0__NZg___0__LNb1_Object.SetBelong(this.instance);
				}
				return r_R__0__SZg___0__NZg___0__LNb1_Object;
			}
		}
		...
		/// Void #Mlb()
		/// </summary>
		protected RMethod r_R__0__Mlb;
		public virtual RMethod R__0__Mlb
		{
			get
			{
				if(r_R__0__Mlb == null)
				{
					r_R__0__Mlb = new(this, "#Mlb", 0);
					r_R__0__Mlb.SetBelong(this.instance);
				}
				return r_R__0__Mlb;
			}
		}
		...
		/// <summary>
		/// Void #oo(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__oo_Object___0__7X;
		public virtual RMethod R__0__oo_Object___0__7X
		{
			get
			{
				if(r_R__0__oo_Object___0__7X == null)
				{
					r_R__0__oo_Object___0__7X = new(this, "#oo", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__oo_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__oo_Object___0__7X;
			}
		}
		...
		/// Void #hdg()
		/// </summary>
		protected RMethod r_R__0__hdg;
		public virtual RMethod R__0__hdg
		{
			get
			{
				if(r_R__0__hdg == null)
				{
					r_R__0__hdg = new(this, "#hdg", 0);
					r_R__0__hdg.SetBelong(this.instance);
				}
				return r_R__0__hdg;
			}
		}
		...
		/// Void #idg()
		/// </summary>
		protected RMethod r_R__0__idg;
		public virtual RMethod R__0__idg
		{
			get
			{
				if(r_R__0__idg == null)
				{
					r_R__0__idg = new(this, "#idg", 0);
					r_R__0__idg.SetBelong(this.instance);
				}
				return r_R__0__idg;
			}
		}
		...
		/// Void #jdg()
		/// </summary>
		protected RMethod r_R__0__jdg;
		public virtual RMethod R__0__jdg
		{
			get
			{
				if(r_R__0__jdg == null)
				{
					r_R__0__jdg = new(this, "#jdg", 0);
					r_R__0__jdg.SetBelong(this.instance);
				}
				return r_R__0__jdg;
			}
		}
		...
		/// Void #jdg(#u.#Ckb)
		/// </summary>
		protected RMethod r_R__0__jdg___0__Ckb;
		public virtual RMethod R__0__jdg___0__Ckb
		{
			get
			{
				if(r_R__0__jdg___0__Ckb == null)
				{
					r_R__0__jdg___0__Ckb = new(this, "#jdg", 0,  ReleactionUtils.GetType("#u.#Ckb"));
					r_R__0__jdg___0__Ckb.SetBelong(this.instance);
				}
				return r_R__0__jdg___0__Ckb;
			}
		}
		...
		/// <summary>
		/// Void #po(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__po_Object___0__7X;
		public virtual RMethod R__0__po_Object___0__7X
		{
			get
			{
				if(r_R__0__po_Object___0__7X == null)
				{
					r_R__0__po_Object___0__7X = new(this, "#po", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__po_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__po_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// #u.#Ckb #rlb(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__rlb_ID;
		public virtual RMethod R__0__rlb_ID
		{
			get
			{
				if(r_R__0__rlb_ID == null)
				{
					r_R__0__rlb_ID = new(this, "#rlb", 0, typeof(GameDefineType.ID));
					r_R__0__rlb_ID.SetBelong(this.instance);
				}
				return r_R__0__rlb_ID;
			}
		}
        ...
        public R__0__kdg() : base("#u.#kdg")
        {
        }

        public R__0__kdg(System.Object instance) : base("#u.#kdg")
		{
            SetInstance(instance);
		}

        public R__0__kdg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__kdg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__OZg()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__OZg.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__PZg(System.Object  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@data};
            var ___result = R__0__PZg_Object.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__RZg(System.Object  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@data};
            var ___result = R__0__RZg_Object.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Object __0__Ozd()
        {
        ...
        public virtual void __0__Mlb()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Mlb.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__hdg()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__hdg.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__idg()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__idg.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__jdg()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__jdg.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Object __0__rlb(GameDefineType.ID  @cfgID)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cfgID};
            var ___result = R__0__rlb_ID.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#1Wd
	/// </summary>
    public partial class R__0__1Wd : RMember //
    {
        ...
        public R__0__1Wd() : base("#u.#1Wd")
        {
        }

        public R__0__1Wd(System.Object instance) : base("#u.#1Wd")
		{
            SetInstance(instance);
		}

        public R__0__1Wd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1Wd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

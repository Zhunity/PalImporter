...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#O4g
	/// </summary>
    public partial class R__0__O4g : RMember //
    {
        ...
        public R__0__O4g() : base("#u.#O4g")
        {
        }

        public R__0__O4g(System.Object instance) : base("#u.#O4g")
		{
            SetInstance(instance);
		}

        public R__0__O4g(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__O4g(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

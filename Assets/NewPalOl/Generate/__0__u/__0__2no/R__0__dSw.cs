...
{public partial class R__0__2no
{
	...
	/// #u.#2no+#dSw
	/// </summary>
    public partial class R__0__dSw : RMember //
    {
		...
		/// #u.#2no #g
		/// </summary>
		protected R__0__u.R__0__2no r___0__g;
		public virtual R__0__u.R__0__2no R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__dSw() : base("#u.#2no+#dSw")
        {
        }

        public R__0__dSw(System.Object instance) : base("#u.#2no+#dSw")
		{
            SetInstance(instance);
		}

        public R__0__dSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

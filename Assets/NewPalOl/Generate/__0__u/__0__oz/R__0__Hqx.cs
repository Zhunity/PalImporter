...
{public partial class R__0__oz
{
	...
	/// #u.#oz+#Hqx
	/// </summary>
    public partial class R__0__Hqx : RMember //
    {
		...
		/// #u.#oz #g
		/// </summary>
		protected R__0__u.R__0__oz r___0__g;
		public virtual R__0__u.R__0__oz R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__Hqx() : base("#u.#oz+#Hqx")
        {
        }

        public R__0__Hqx(System.Object instance) : base("#u.#oz+#Hqx")
		{
            SetInstance(instance);
		}

        public R__0__Hqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Hqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

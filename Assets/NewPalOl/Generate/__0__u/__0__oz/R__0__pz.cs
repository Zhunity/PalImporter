...
{public partial class R__0__oz
{
	...
	/// #u.#oz+#pz
	/// </summary>
    public partial class R__0__pz : RMember //
    {
		...
		/// Int32 CompareTo(#pz)
		/// </summary>
		protected RMethod r_RCompareTo___0__pz;
		public virtual RMethod RCompareTo___0__pz
		{
			get
			{
				if(r_RCompareTo___0__pz == null)
				{
					r_RCompareTo___0__pz = new(this, "CompareTo", 0,  ReleactionUtils.GetType("#u.#oz+#pz"));
					r_RCompareTo___0__pz.SetBelong(this.instance);
				}
				return r_RCompareTo___0__pz;
			}
		}
        ...
        public R__0__pz() : base("#u.#oz+#pz")
        {
        }

        public R__0__pz(System.Object instance) : base("#u.#oz+#pz")
		{
            SetInstance(instance);
		}

        public R__0__pz(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__pz(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

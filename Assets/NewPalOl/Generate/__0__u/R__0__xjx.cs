...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#xjx
	/// </summary>
    public partial class R__0__xjx : RMember //
    {
		...
		/// Void #nK()
		/// </summary>
		protected RMethod r_R__0__nK;
		public virtual RMethod R__0__nK
		{
			get
			{
				if(r_R__0__nK == null)
				{
					r_R__0__nK = new(this, "#nK", 0);
					r_R__0__nK.SetBelong(this.instance);
				}
				return r_R__0__nK;
			}
		}
		...
		/// Void #tjx()
		/// </summary>
		protected RMethod r_R__0__tjx;
		public virtual RMethod R__0__tjx
		{
			get
			{
				if(r_R__0__tjx == null)
				{
					r_R__0__tjx = new(this, "#tjx", 0);
					r_R__0__tjx.SetBelong(this.instance);
				}
				return r_R__0__tjx;
			}
		}
		...
		/// <summary>
		/// Void #Yot(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Yot_Object___0__7X;
		public virtual RMethod R__0__Yot_Object___0__7X
		{
			get
			{
				if(r_R__0__Yot_Object___0__7X == null)
				{
					r_R__0__Yot_Object___0__7X = new(this, "#Yot", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Yot_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Yot_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #ujx(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__ujx_Object___0__7X;
		public virtual RMethod R__0__ujx_Object___0__7X
		{
			get
			{
				if(r_R__0__ujx_Object___0__7X == null)
				{
					r_R__0__ujx_Object___0__7X = new(this, "#ujx", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__ujx_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__ujx_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #vjx(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__vjx_Object___0__7X;
		public virtual RMethod R__0__vjx_Object___0__7X
		{
			get
			{
				if(r_R__0__vjx_Object___0__7X == null)
				{
					r_R__0__vjx_Object___0__7X = new(this, "#vjx", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__vjx_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__vjx_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #vAm(System.String)
		/// </summary>
		protected RMethod r_R__0__vAm_String;
		public virtual RMethod R__0__vAm_String
		{
			get
			{
				if(r_R__0__vAm_String == null)
				{
					r_R__0__vAm_String = new(this, "#vAm", 0, typeof(System.String));
					r_R__0__vAm_String.SetBelong(this.instance);
				}
				return r_R__0__vAm_String;
			}
		}
		...
		/// Void #wjx(Int64)
		/// </summary>
		protected RMethod r_R__0__wjx_Int64;
		public virtual RMethod R__0__wjx_Int64
		{
			get
			{
				if(r_R__0__wjx_Int64 == null)
				{
					r_R__0__wjx_Int64 = new(this, "#wjx", 0, typeof(System.Int64));
					r_R__0__wjx_Int64.SetBelong(this.instance);
				}
				return r_R__0__wjx_Int64;
			}
		}
        ...
        public R__0__xjx() : base("#u.#xjx")
        {
        }

        public R__0__xjx(System.Object instance) : base("#u.#xjx")
		{
            SetInstance(instance);
		}

        public R__0__xjx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__xjx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__nK()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__nK.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__tjx()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__tjx.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__vAm(System.String  @info)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@info};
            var ___result = R__0__vAm_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__wjx(System.Int64  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time};
            var ___result = R__0__wjx_Int64.Invoke(___genericsType, ___parameters);

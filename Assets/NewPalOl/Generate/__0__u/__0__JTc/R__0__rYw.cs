...
{public partial class R__0__JTc
{
	...
	/// #u.#JTc+#rYw
	/// </summary>
    public partial class R__0__rYw : RMember //
    {
		...
		/// #u.#LR #b
		/// </summary>
		protected R__0__u.R__0__LR r___0__b;
		public virtual R__0__u.R__0__LR R__0__b
		{
			get
			{
				if(r___0__b == null)
        ...
        public R__0__rYw() : base("#u.#JTc+#rYw")
        {
        }

        public R__0__rYw(System.Object instance) : base("#u.#JTc+#rYw")
		{
            SetInstance(instance);
		}

        public R__0__rYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__rYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

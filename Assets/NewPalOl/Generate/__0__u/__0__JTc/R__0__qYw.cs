...
{public partial class R__0__JTc
{
	
	/// <summary>
	/// #u.#JTc+#qYw
	/// </summary>
    public partial class R__0__qYw : RMember //
    {

		/// <summary>
		/// System.Threading.Thread #a
		/// </summary>
		protected RSystem.RThreading.RThread r___0__a;
		public virtual RSystem.RThreading.RThread R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #u.#JTc #f
		/// </summary>
		protected R__0__u.R__0__JTc r___0__f;
		public virtual R__0__u.R__0__JTc R__0__f
		{
			get
			{
				if(r___0__f == null)
        ...
        public R__0__qYw() : base("#u.#JTc+#qYw")
        {
        }

        public R__0__qYw(System.Object instance) : base("#u.#JTc+#qYw")
		{
            SetInstance(instance);
		}

        public R__0__qYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__qYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__JTc
{
	...
	/// #u.#JTc+#hiv
	/// </summary>
    public partial class R__0__hiv : RMember //
    {
		...
		/// #u.#JTc #d
		/// </summary>
		protected R__0__u.R__0__JTc r___0__d;
		public virtual R__0__u.R__0__JTc R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__hiv() : base("#u.#JTc+#hiv")
        {
        }

        public R__0__hiv(System.Object instance) : base("#u.#JTc+#hiv")
		{
            SetInstance(instance);
		}

        public R__0__hiv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hiv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

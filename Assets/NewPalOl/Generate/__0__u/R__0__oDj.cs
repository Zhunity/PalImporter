...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#oDj
	/// </summary>
    public partial class R__0__oDj : RMember //
    {
        ...
        public R__0__oDj() : base("#u.#oDj")
        {
        }

        public R__0__oDj(System.Object instance) : base("#u.#oDj")
		{
            SetInstance(instance);
		}

        public R__0__oDj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oDj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

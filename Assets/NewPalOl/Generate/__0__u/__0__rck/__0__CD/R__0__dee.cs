...
{public partial class R__0__rck
{
	public partial class R__0__CD
{
	
	/// <summary>
	/// #u.#rck+#CD+#dee
	/// </summary>
    public partial class R__0__dee : RMember //
    {
		...
		/// Void Invoke(#BD)
		/// </summary>
		protected RMethod r_RInvoke___0__BD;
		public virtual RMethod RInvoke___0__BD
		{
			get
			{
				if(r_RInvoke___0__BD == null)
				{
					r_RInvoke___0__BD = new(this, "Invoke", 0,  ReleactionUtils.GetType("#u.#rck+#BD"));
					r_RInvoke___0__BD.SetBelong(this.instance);
				}
				return r_RInvoke___0__BD;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(#BD, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke___0__BD_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke___0__BD_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke___0__BD_AsyncCallback_Object == null)
				{
					r_RBeginInvoke___0__BD_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("#u.#rck+#BD"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke___0__BD_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke___0__BD_AsyncCallback_Object;
			}
		}
        ...
        public R__0__dee() : base("#u.#rck+#CD+#dee")
        {
        }

        public R__0__dee(System.Object instance) : base("#u.#rck+#CD+#dee")
		{
            SetInstance(instance);
		}

        public R__0__dee(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dee(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

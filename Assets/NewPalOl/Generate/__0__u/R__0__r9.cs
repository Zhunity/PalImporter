...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#r9
	/// </summary>
    public partial class R__0__r9 : RMember //
    {
        ...
        public R__0__r9() : base("#u.#r9")
        {
        }

        public R__0__r9(System.Object instance) : base("#u.#r9")
		{
            SetInstance(instance);
		}

        public R__0__r9(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__r9(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#EVe
	/// </summary>
    public partial class R__0__EVe : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.Dictionary`2[#u.#EVe+#FVe,#oU.#5bb] #a
		/// </summary>
		...
		/// <summary>
		/// Void #3Bd(#FVe, Boolean)
		/// </summary>
		protected RMethod r_R__0__3Bd___0__FVe_Boolean;
		public virtual RMethod R__0__3Bd___0__FVe_Boolean
		{
			get
			{
				if(r_R__0__3Bd___0__FVe_Boolean == null)
				{
					r_R__0__3Bd___0__FVe_Boolean = new(this, "#3Bd", 0,  ReleactionUtils.GetType("#u.#EVe+#FVe"), typeof(System.Boolean));
					r_R__0__3Bd___0__FVe_Boolean.SetBelong(this.instance);
				}
				return r_R__0__3Bd___0__FVe_Boolean;
			}
		}

		/// <summary>
		/// Void #CVe(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__CVe_Object___0__7X;
		public virtual RMethod R__0__CVe_Object___0__7X
		{
			get
			{
				if(r_R__0__CVe_Object___0__7X == null)
				{
					r_R__0__CVe_Object___0__7X = new(this, "#CVe", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__CVe_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__CVe_Object___0__7X;
			}
		}
		...
		/// Void #DVe()
		/// </summary>
		protected RMethod r_R__0__DVe;
		public virtual RMethod R__0__DVe
		{
			get
			{
				if(r_R__0__DVe == null)
				{
					r_R__0__DVe = new(this, "#DVe", 0);
					r_R__0__DVe.SetBelong(this.instance);
				}
				return r_R__0__DVe;
			}
		}
		...
		/// <summary>
		/// Int32 #AVe(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__AVe_ID;
		public virtual RMethod R__0__AVe_ID
		{
			get
			{
				if(r_R__0__AVe_ID == null)
				{
					r_R__0__AVe_ID = new(this, "#AVe", 0, typeof(GameDefineType.ID));
					r_R__0__AVe_ID.SetBelong(this.instance);
				}
				return r_R__0__AVe_ID;
			}
		}
        ...
        public R__0__EVe() : base("#u.#EVe")
        {
        }

        public R__0__EVe(System.Object instance) : base("#u.#EVe")
		{
            SetInstance(instance);
		}

        public R__0__EVe(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__EVe(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__DVe()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__DVe.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Int32 __0__AVe(GameDefineType.ID  @id)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id};
            var ___result = R__0__AVe_ID.Invoke(___genericsType, ___parameters);

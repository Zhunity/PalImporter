...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Rpf
	/// </summary>
    public partial class R__0__Rpf : RMember //
    {
		...
		/// <summary>
		/// System.Comparison`1[#u.#Rpf+#Syf] #k
		/// </summary>
		protected static RSystem.RComparison<R__0__u.R__0__Rpf.R__0__Syf> r___0__k;
		public static RSystem.RComparison<R__0__u.R__0__Rpf.R__0__Syf> R__0__k
		{
			get
			{
				if(r___0__k == null)
				{
					r___0__k = new( ReleactionUtils.GetType("#u.#Rpf"), "#k");
		...
		/// <summary>
		/// Void #Mpf(#u.#Bu, System.Object)
		/// </summary>
		protected RMethod r_R__0__Mpf___0__Bu_Object;
		public virtual RMethod R__0__Mpf___0__Bu_Object
		{
			get
			{
				if(r_R__0__Mpf___0__Bu_Object == null)
				{
					r_R__0__Mpf___0__Bu_Object = new(this, "#Mpf", 0,  ReleactionUtils.GetType("#u.#Bu"), typeof(System.Object));
					r_R__0__Mpf___0__Bu_Object.SetBelong(this.instance);
				}
				return r_R__0__Mpf___0__Bu_Object;
			}
		}

		/// <summary>
		/// Void #Npf(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Npf_Object___0__7X;
		public virtual RMethod R__0__Npf_Object___0__7X
		{
			get
			{
				if(r_R__0__Npf_Object___0__7X == null)
				{
					r_R__0__Npf_Object___0__7X = new(this, "#Npf", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Npf_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Npf_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #Opf(#u.#Bu, System.Object)
		/// </summary>
		protected RMethod r_R__0__Opf___0__Bu_Object;
		public virtual RMethod R__0__Opf___0__Bu_Object
		{
			get
			{
				if(r_R__0__Opf___0__Bu_Object == null)
				{
					r_R__0__Opf___0__Bu_Object = new(this, "#Opf", 0,  ReleactionUtils.GetType("#u.#Bu"), typeof(System.Object));
					r_R__0__Opf___0__Bu_Object.SetBelong(this.instance);
				}
				return r_R__0__Opf___0__Bu_Object;
			}
		}
		...
		/// <summary>
		/// Void #Qpf(#u.#Bu, System.Object)
		/// </summary>
		protected RMethod r_R__0__Qpf___0__Bu_Object;
		public virtual RMethod R__0__Qpf___0__Bu_Object
		{
			get
			{
				if(r_R__0__Qpf___0__Bu_Object == null)
				{
					r_R__0__Qpf___0__Bu_Object = new(this, "#Qpf", 0,  ReleactionUtils.GetType("#u.#Bu"), typeof(System.Object));
					r_R__0__Qpf___0__Bu_Object.SetBelong(this.instance);
				}
				return r_R__0__Qpf___0__Bu_Object;
			}
		}
		...
		/// Void #mk(#Pfb.#3qf)
		/// </summary>
		protected RMethod r_R__0__mk___0__3qf;
		public virtual RMethod R__0__mk___0__3qf
		{
			get
			{
				if(r_R__0__mk___0__3qf == null)
				{
					r_R__0__mk___0__3qf = new(this, "#mk", 0,  ReleactionUtils.GetType("#Pfb.#3qf"));
					r_R__0__mk___0__3qf.SetBelong(this.instance);
				}
				return r_R__0__mk___0__3qf;
			}
		}
		...
		/// Int32 #jex(#Syf, #Syf)
		/// </summary>
		protected static RMethod r_R__0__jex___0__Syf___0__Syf;
		public static RMethod R__0__jex___0__Syf___0__Syf
		{
			get
			{
				if(r_R__0__jex___0__Syf___0__Syf == null)
				{
					r_R__0__jex___0__Syf___0__Syf = new( ReleactionUtils.GetType("#u.#Rpf"), "#jex", 0,  ReleactionUtils.GetType("#u.#Rpf+#Syf"),  ReleactionUtils.GetType("#u.#Rpf+#Syf"));
					r_R__0__jex___0__Syf___0__Syf.SetBelong(null);
				}
				return r_R__0__jex___0__Syf___0__Syf;
			}
		}
        ...
        public R__0__Rpf() : base("#u.#Rpf")
        {
        }

        public R__0__Rpf(System.Object instance) : base("#u.#Rpf")
		{
            SetInstance(instance);
		}

        public R__0__Rpf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Rpf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

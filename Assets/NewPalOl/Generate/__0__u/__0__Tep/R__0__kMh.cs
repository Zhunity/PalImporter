...
{public partial class R__0__Tep
{
	
	/// <summary>
	/// #u.#Tep+#kMh
	/// </summary>
    public partial class R__0__kMh : RMember //
    {
        ...
        public R__0__kMh() : base("#u.#Tep+#kMh")
        {
        }

        public R__0__kMh(System.Object instance) : base("#u.#Tep+#kMh")
		{
            SetInstance(instance);
		}

        public R__0__kMh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__kMh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

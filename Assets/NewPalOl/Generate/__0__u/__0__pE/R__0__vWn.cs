...
{public partial class R__0__pE
{
	
	/// <summary>
	/// #u.#pE+#vWn
	/// </summary>
    public partial class R__0__vWn : RMember //
    {
        ...
        public R__0__vWn() : base("#u.#pE+#vWn")
        {
        }

        public R__0__vWn(System.Object instance) : base("#u.#pE+#vWn")
		{
            SetInstance(instance);
		}

        public R__0__vWn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__vWn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

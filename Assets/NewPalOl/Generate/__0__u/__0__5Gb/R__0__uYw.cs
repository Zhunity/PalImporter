...
{public partial class R__0__5Gb
{
	...
	/// #u.#5Gb+#uYw
	/// </summary>
    public partial class R__0__uYw : RMember //
    {
		...
		/// #u.#5Gb #d
		/// </summary>
		protected R__0__u.R__0__5Gb r___0__d;
		public virtual R__0__u.R__0__5Gb R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__uYw() : base("#u.#5Gb+#uYw")
        {
        }

        public R__0__uYw(System.Object instance) : base("#u.#5Gb+#uYw")
		{
            SetInstance(instance);
		}

        public R__0__uYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__uYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Ks
	/// </summary>
    public partial class R__0__Ks : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.List`1[#oU.#X4] #d
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__oU.R__0__X4> r___0__d;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__oU.R__0__X4> R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1[#Pfb.#kwb] #e
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__Pfb.R__0__kwb> r___0__e;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__Pfb.R__0__kwb> R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// <summary>
		/// Void #Gs(System.Collections.Generic.List`1[#Pfb.#kwb])
		/// </summary>
		protected RMethod r_R__0__Gs_List_d___0__kwb_p_;
		public virtual RMethod R__0__Gs_List_d___0__kwb_p_
		{
			get
			{
				if(r_R__0__Gs_List_d___0__kwb_p_ == null)
				{
					r_R__0__Gs_List_d___0__kwb_p_ = new(this, "#Gs", 0, typeof(System.Collections.Generic.List<>).MakeGenericType( ReleactionUtils.GetType("#Pfb.#kwb")));
					r_R__0__Gs_List_d___0__kwb_p_.SetBelong(this.instance);
				}
				return r_R__0__Gs_List_d___0__kwb_p_;
			}
		}
		...
		/// <summary>
		/// Void #Is(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Is_Object___0__7X;
		public virtual RMethod R__0__Is_Object___0__7X
		{
			get
			{
				if(r_R__0__Is_Object___0__7X == null)
				{
					r_R__0__Is_Object___0__7X = new(this, "#Is", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Is_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Is_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #Js(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Js_Object___0__7X;
		public virtual RMethod R__0__Js_Object___0__7X
		{
			get
			{
				if(r_R__0__Js_Object___0__7X == null)
				{
					r_R__0__Js_Object___0__7X = new(this, "#Js", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Js_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Js_Object___0__7X;
			}
		}
        ...
        public R__0__Ks() : base("#u.#Ks")
        {
        }

        public R__0__Ks(System.Object instance) : base("#u.#Ks")
		{
            SetInstance(instance);
		}

        public R__0__Ks(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ks(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

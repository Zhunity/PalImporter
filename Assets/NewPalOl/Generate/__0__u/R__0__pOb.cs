...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#pOb
	/// </summary>
    public partial class R__0__pOb : RMember //
    {
        ...
        public R__0__pOb() : base("#u.#pOb")
        {
        }

        public R__0__pOb(System.Object instance) : base("#u.#pOb")
		{
            SetInstance(instance);
		}

        public R__0__pOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__pOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

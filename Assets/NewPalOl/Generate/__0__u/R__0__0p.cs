...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#0p
	/// </summary>
    public partial class R__0__0p : RMember //
    {
        ...
        public R__0__0p() : base("#u.#0p")
        {
        }

        public R__0__0p(System.Object instance) : base("#u.#0p")
		{
            SetInstance(instance);
		}

        public R__0__0p(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0p(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__JSc
{
	
	/// <summary>
	/// #u.#JSc+#jYw
	/// </summary>
    public partial class R__0__jYw : RMember //
    {

		/// <summary>
		/// SpiritTowerConfig #a
		/// </summary>
		protected RSpiritTowerConfig r___0__a;
		public virtual RSpiritTowerConfig R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// SpiritTowerConfig #b
		/// </summary>
		protected RSpiritTowerConfig r___0__b;
		public virtual RSpiritTowerConfig R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// #u.#JSc #f
		/// </summary>
		protected R__0__u.R__0__JSc r___0__f;
		public virtual R__0__u.R__0__JSc R__0__f
		{
			get
			{
				if(r___0__f == null)
        ...
        public R__0__jYw() : base("#u.#JSc+#jYw")
        {
        }

        public R__0__jYw(System.Object instance) : base("#u.#JSc+#jYw")
		{
            SetInstance(instance);
		}

        public R__0__jYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Ybg
	/// </summary>
    public partial class R__0__Ybg : RMember //
    {
		...
		/// <summary>
		/// Void #Vbg(Boolean, Int32)
		/// </summary>
		protected RMethod r_R__0__Vbg_Boolean_Int32;
		public virtual RMethod R__0__Vbg_Boolean_Int32
		{
			get
			{
				if(r_R__0__Vbg_Boolean_Int32 == null)
				{
					r_R__0__Vbg_Boolean_Int32 = new(this, "#Vbg", 0, typeof(System.Boolean), typeof(System.Int32));
					r_R__0__Vbg_Boolean_Int32.SetBelong(this.instance);
				}
				return r_R__0__Vbg_Boolean_Int32;
			}
		}

		/// <summary>
		/// Void #Wbg(Boolean, Int32)
		/// </summary>
		protected RMethod r_R__0__Wbg_Boolean_Int32;
		public virtual RMethod R__0__Wbg_Boolean_Int32
		{
			get
			{
				if(r_R__0__Wbg_Boolean_Int32 == null)
				{
					r_R__0__Wbg_Boolean_Int32 = new(this, "#Wbg", 0, typeof(System.Boolean), typeof(System.Int32));
					r_R__0__Wbg_Boolean_Int32.SetBelong(this.instance);
				}
				return r_R__0__Wbg_Boolean_Int32;
			}
		}

		/// <summary>
		/// Void #Xbg(Boolean, Int32)
		/// </summary>
		protected RMethod r_R__0__Xbg_Boolean_Int32;
		public virtual RMethod R__0__Xbg_Boolean_Int32
		{
			get
			{
				if(r_R__0__Xbg_Boolean_Int32 == null)
				{
					r_R__0__Xbg_Boolean_Int32 = new(this, "#Xbg", 0, typeof(System.Boolean), typeof(System.Int32));
					r_R__0__Xbg_Boolean_Int32.SetBelong(this.instance);
				}
				return r_R__0__Xbg_Boolean_Int32;
			}
		}
        ...
        public R__0__Ybg() : base("#u.#Ybg")
        {
        }

        public R__0__Ybg(System.Object instance) : base("#u.#Ybg")
		{
            SetInstance(instance);
		}

        public R__0__Ybg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ybg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Vbg(System.Boolean  @bShow, System.Int32  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bShow, @time};
            var ___result = R__0__Vbg_Boolean_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Wbg(System.Boolean  @bShow, System.Int32  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bShow, @time};
            var ___result = R__0__Wbg_Boolean_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Xbg(System.Boolean  @bShow, System.Int32  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bShow, @time};
            var ___result = R__0__Xbg_Boolean_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Boolean __0__Xd()
        {

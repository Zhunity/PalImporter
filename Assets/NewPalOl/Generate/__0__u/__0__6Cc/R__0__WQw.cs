...
{public partial class R__0__6Cc
{
	...
	/// #u.#6Cc+#WQw
	/// </summary>
    public partial class R__0__WQw : RMember //
    {
		...
		/// #u.#6Cc #d
		/// </summary>
		protected R__0__u.R__0__6Cc r___0__d;
		public virtual R__0__u.R__0__6Cc R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__WQw() : base("#u.#6Cc+#WQw")
        {
        }

        public R__0__WQw(System.Object instance) : base("#u.#6Cc+#WQw")
		{
            SetInstance(instance);
		}

        public R__0__WQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__WQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

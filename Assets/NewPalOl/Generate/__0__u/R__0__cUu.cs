...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#cUu
	/// </summary>
    public partial class R__0__cUu : RMember //
    {
		...
		/// <summary>
		/// System.String #vlj(Int32)
		/// </summary>
		protected RMethod r_R__0__vlj_Int32;
		public virtual RMethod R__0__vlj_Int32
		{
			get
			{
				if(r_R__0__vlj_Int32 == null)
				{
					r_R__0__vlj_Int32 = new(this, "#vlj", 0, typeof(System.Int32));
					r_R__0__vlj_Int32.SetBelong(this.instance);
				}
				return r_R__0__vlj_Int32;
			}
		}

		/// <summary>
		/// Void #aUu(System.String)
		/// </summary>
		protected RMethod r_R__0__aUu_String;
		public virtual RMethod R__0__aUu_String
		{
			get
			{
				if(r_R__0__aUu_String == null)
				{
					r_R__0__aUu_String = new(this, "#aUu", 0, typeof(System.String));
					r_R__0__aUu_String.SetBelong(this.instance);
				}
				return r_R__0__aUu_String;
			}
		}

		/// <summary>
		/// Void #Pb(System.String)
		/// </summary>
		protected RMethod r_R__0__Pb_String;
		public virtual RMethod R__0__Pb_String
		{
			get
			{
				if(r_R__0__Pb_String == null)
				{
					r_R__0__Pb_String = new(this, "#Pb", 0, typeof(System.String));
					r_R__0__Pb_String.SetBelong(this.instance);
				}
				return r_R__0__Pb_String;
			}
		}

		/// <summary>
		/// Void #bUu(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__bUu_Object___0__7X;
		public virtual RMethod R__0__bUu_Object___0__7X
		{
			get
			{
				if(r_R__0__bUu_Object___0__7X == null)
				{
					r_R__0__bUu_Object___0__7X = new(this, "#bUu", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__bUu_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__bUu_Object___0__7X;
			}
		}
        ...
        public R__0__cUu() : base("#u.#cUu")
        {
        }

        public R__0__cUu(System.Object instance) : base("#u.#cUu")
		{
            SetInstance(instance);
		}

        public R__0__cUu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cUu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.String __0__vlj(System.Int32  @career)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@career};
            var ___result = R__0__vlj_Int32.Invoke(___genericsType, ___parameters);

            return (System.String)___result;
        }


        public virtual void __0__aUu(System.String  @info)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@info};
            var ___result = R__0__aUu_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Pb(System.String  @msg)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@msg};
            var ___result = R__0__Pb_String.Invoke(___genericsType, ___parameters);

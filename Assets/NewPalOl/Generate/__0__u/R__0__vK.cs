...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#vK
	/// </summary>
    public partial class R__0__vK : RMember //
    {
		...
		/// <summary>
		/// Void #pK(GameDefineType.ID, Boolean, Int32)
		/// </summary>
		protected RMethod r_R__0__pK_ID_Boolean_Int32;
		public virtual RMethod R__0__pK_ID_Boolean_Int32
		{
			get
			{
				if(r_R__0__pK_ID_Boolean_Int32 == null)
				{
					r_R__0__pK_ID_Boolean_Int32 = new(this, "#pK", 0, typeof(GameDefineType.ID), typeof(System.Boolean), typeof(System.Int32));
					r_R__0__pK_ID_Boolean_Int32.SetBelong(this.instance);
				}
				return r_R__0__pK_ID_Boolean_Int32;
			}
		}
		...
		/// <summary>
		/// Void #rK(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__rK_Object___0__7X;
		public virtual RMethod R__0__rK_Object___0__7X
		{
			get
			{
				if(r_R__0__rK_Object___0__7X == null)
				{
					r_R__0__rK_Object___0__7X = new(this, "#rK", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__rK_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__rK_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #sK(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__sK_Object___0__7X;
		public virtual RMethod R__0__sK_Object___0__7X
		{
			get
			{
				if(r_R__0__sK_Object___0__7X == null)
				{
					r_R__0__sK_Object___0__7X = new(this, "#sK", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__sK_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__sK_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #tK(System.Object)
		/// </summary>
		protected RMethod r_R__0__tK_Object;
		public virtual RMethod R__0__tK_Object
		{
			get
			{
				if(r_R__0__tK_Object == null)
				{
					r_R__0__tK_Object = new(this, "#tK", 0, typeof(System.Object));
					r_R__0__tK_Object.SetBelong(this.instance);
				}
				return r_R__0__tK_Object;
			}
		}

		/// <summary>
		/// Void #uK(System.Object)
		/// </summary>
		protected RMethod r_R__0__uK_Object;
		public virtual RMethod R__0__uK_Object
		{
			get
			{
				if(r_R__0__uK_Object == null)
				{
					r_R__0__uK_Object = new(this, "#uK", 0, typeof(System.Object));
					r_R__0__uK_Object.SetBelong(this.instance);
				}
				return r_R__0__uK_Object;
			}
		}
        ...
        public R__0__vK() : base("#u.#vK")
        {
        }

        public R__0__vK(System.Object instance) : base("#u.#vK")
		{
            SetInstance(instance);
		}

        public R__0__vK(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__vK(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__pK(GameDefineType.ID  @id, System.Boolean  @isLeader, System.Int32  @idx)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id, @isLeader, @idx};
            var ___result = R__0__pK_ID_Boolean_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__tK(System.Object  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@data};
            var ___result = R__0__tK_Object.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__uK(System.Object  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@data};
            var ___result = R__0__uK_Object.Invoke(___genericsType, ___parameters);

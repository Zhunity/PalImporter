...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Oyf
	/// </summary>
    public partial class R__0__Oyf : RMember //
    {
		...
		/// Void #Nyf()
		/// </summary>
		protected RMethod r_R__0__Nyf;
		public virtual RMethod R__0__Nyf
		{
			get
			{
				if(r_R__0__Nyf == null)
				{
					r_R__0__Nyf = new(this, "#Nyf", 0);
					r_R__0__Nyf.SetBelong(this.instance);
				}
				return r_R__0__Nyf;
			}
		}
        ...
        public R__0__Oyf() : base("#u.#Oyf")
        {
        }

        public R__0__Oyf(System.Object instance) : base("#u.#Oyf")
		{
            SetInstance(instance);
		}

        public R__0__Oyf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Oyf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Nyf()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Nyf.Invoke(___genericsType, ___parameters);

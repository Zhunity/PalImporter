...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#9C
	/// </summary>
    public partial class R__0__9C : RMember //
    {
        ...
        public R__0__9C() : base("#u.#9C")
        {
        }

        public R__0__9C(System.Object instance) : base("#u.#9C")
		{
            SetInstance(instance);
		}

        public R__0__9C(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9C(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

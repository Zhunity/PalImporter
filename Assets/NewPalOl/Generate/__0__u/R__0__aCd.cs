...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#aCd
	/// </summary>
    public partial class R__0__aCd : RMember //
    {
		...
		public static RMyGUI.RElementBase.R__0__ZNb R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#aCd"), "#a");
		...
		/// Void #yPd()
		/// </summary>
		protected RMethod r_R__0__yPd;
		public virtual RMethod R__0__yPd
		{
			get
			{
				if(r_R__0__yPd == null)
				{
					r_R__0__yPd = new(this, "#yPd", 0);
					r_R__0__yPd.SetBelong(this.instance);
				}
				return r_R__0__yPd;
			}
		}
		...
		/// <summary>
		/// Void #s8l(System.Object, #oU.#7X)
		/// </summary>
		protected static RMethod r_R__0__s8l_Object___0__7X;
		public static RMethod R__0__s8l_Object___0__7X
		{
			get
			{
				if(r_R__0__s8l_Object___0__7X == null)
				{
					r_R__0__s8l_Object___0__7X = new( ReleactionUtils.GetType("#u.#aCd"), "#s8l", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__s8l_Object___0__7X.SetBelong(null);
				}
				return r_R__0__s8l_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #t8l(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__t8l_Object___0__7X;
		public virtual RMethod R__0__t8l_Object___0__7X
		{
			get
			{
				if(r_R__0__t8l_Object___0__7X == null)
				{
					r_R__0__t8l_Object___0__7X = new(this, "#t8l", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__t8l_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__t8l_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #Ovk(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Ovk_Object___0__7X;
		public virtual RMethod R__0__Ovk_Object___0__7X
		{
			get
			{
				if(r_R__0__Ovk_Object___0__7X == null)
				{
					r_R__0__Ovk_Object___0__7X = new(this, "#Ovk", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Ovk_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Ovk_Object___0__7X;
			}
		}
        ...
        public R__0__aCd() : base("#u.#aCd")
        {
        }

        public R__0__aCd(System.Object instance) : base("#u.#aCd")
		{
            SetInstance(instance);
		}

        public R__0__aCd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__aCd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__yPd()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__yPd.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#NO
	/// </summary>
    public partial class R__0__NO : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#NO"), "#a");
		...
		/// <summary>
		/// Void #sb(PreviewConfig)
		/// </summary>
		protected RMethod r_R__0__sb_PreviewConfig;
		public virtual RMethod R__0__sb_PreviewConfig
		{
			get
			{
				if(r_R__0__sb_PreviewConfig == null)
				{
					r_R__0__sb_PreviewConfig = new(this, "#sb", 0, typeof(PreviewConfig));
					r_R__0__sb_PreviewConfig.SetBelong(this.instance);
				}
				return r_R__0__sb_PreviewConfig;
			}
		}

		/// <summary>
		/// Void #sb(PreviewConfig, Boolean)
		/// </summary>
		protected RMethod r_R__0__sb_PreviewConfig_Boolean;
		public virtual RMethod R__0__sb_PreviewConfig_Boolean
		{
			get
			{
				if(r_R__0__sb_PreviewConfig_Boolean == null)
				{
					r_R__0__sb_PreviewConfig_Boolean = new(this, "#sb", 0, typeof(PreviewConfig), typeof(System.Boolean));
					r_R__0__sb_PreviewConfig_Boolean.SetBelong(this.instance);
				}
				return r_R__0__sb_PreviewConfig_Boolean;
			}
		}
        ...
        public R__0__NO() : base("#u.#NO")
        {
        }

        public R__0__NO(System.Object instance) : base("#u.#NO")
		{
            SetInstance(instance);
		}

        public R__0__NO(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__NO(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__sb(PreviewConfig  @config)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@config};
            var ___result = R__0__sb_PreviewConfig.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__sb(PreviewConfig  @config, System.Boolean  @bForce)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@config, @bForce};
            var ___result = R__0__sb_PreviewConfig_Boolean.Invoke(___genericsType, ___parameters);

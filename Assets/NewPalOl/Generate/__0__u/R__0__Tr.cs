...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Tr
	/// </summary>
    public partial class R__0__Tr : RMember //
    {
		...
		/// <summary>
		/// MyGUI.ElementBase+#ZNb #h
		/// </summary>
		protected static RMyGUI.RElementBase.R__0__ZNb r___0__h;
		public static RMyGUI.RElementBase.R__0__ZNb R__0__h
		{
			get
			{
				if(r___0__h == null)
				{
					r___0__h = new( ReleactionUtils.GetType("#u.#Tr"), "#h");
		...
		/// <summary>
		/// System.Func`2[#u.#Tbb,System.Boolean] #i
		/// </summary>
		protected static RSystem.RFunc<R__0__u.R__0__Tbb, RField> r___0__i;
		public static RSystem.RFunc<R__0__u.R__0__Tbb, RField> R__0__i
		{
			get
			{
				if(r___0__i == null)
				{
					r___0__i = new( ReleactionUtils.GetType("#u.#Tr"), "#i");
		...
		/// <summary>
		/// System.Func`2[#u.#Tbb,System.DateTime] #j
		/// </summary>
		protected static RSystem.RFunc<R__0__u.R__0__Tbb, RSystem.RDateTime> r___0__j;
		public static RSystem.RFunc<R__0__u.R__0__Tbb, RSystem.RDateTime> R__0__j
		{
			get
			{
				if(r___0__j == null)
				{
					r___0__j = new( ReleactionUtils.GetType("#u.#Tr"), "#j");
		...
		/// Void #Jr()
		/// </summary>
		protected RMethod r_R__0__Jr;
		public virtual RMethod R__0__Jr
		{
			get
			{
				if(r_R__0__Jr == null)
				{
					r_R__0__Jr = new(this, "#Jr", 0);
					r_R__0__Jr.SetBelong(this.instance);
				}
				return r_R__0__Jr;
			}
		}
		...
		/// <summary>
		/// Void #Kr(System.String)
		/// </summary>
		protected RMethod r_R__0__Kr_String;
		public virtual RMethod R__0__Kr_String
		{
			get
			{
				if(r_R__0__Kr_String == null)
				{
					r_R__0__Kr_String = new(this, "#Kr", 0, typeof(System.String));
					r_R__0__Kr_String.SetBelong(this.instance);
				}
				return r_R__0__Kr_String;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator #Lr()
		/// </summary>
		protected RMethod r_R__0__Lr;
		public virtual RMethod R__0__Lr
		{
			get
			{
				if(r_R__0__Lr == null)
				{
					r_R__0__Lr = new(this, "#Lr", 0);
					r_R__0__Lr.SetBelong(this.instance);
				}
				return r_R__0__Lr;
			}
		}
		...
		/// <summary>
		/// Void #KPd(System.Object, #oU.#7X)
		/// </summary>
		protected static RMethod r_R__0__KPd_Object___0__7X;
		public static RMethod R__0__KPd_Object___0__7X
		{
			get
			{
				if(r_R__0__KPd_Object___0__7X == null)
				{
					r_R__0__KPd_Object___0__7X = new( ReleactionUtils.GetType("#u.#Tr"), "#KPd", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__KPd_Object___0__7X.SetBelong(null);
				}
				return r_R__0__KPd_Object___0__7X;
			}
		}
		...
		/// Boolean #Ydx(#u.#Tbb)
		/// </summary>
		protected static RMethod r_R__0__Ydx___0__Tbb;
		public static RMethod R__0__Ydx___0__Tbb
		{
			get
			{
				if(r_R__0__Ydx___0__Tbb == null)
				{
					r_R__0__Ydx___0__Tbb = new( ReleactionUtils.GetType("#u.#Tr"), "#Ydx", 0,  ReleactionUtils.GetType("#u.#Tbb"));
					r_R__0__Ydx___0__Tbb.SetBelong(null);
				}
				return r_R__0__Ydx___0__Tbb;
			}
		}

		/// <summary>
		/// System.DateTime #HTt(#u.#Tbb)
		/// </summary>
		protected static RMethod r_R__0__HTt___0__Tbb;
		public static RMethod R__0__HTt___0__Tbb
		{
			get
			{
				if(r_R__0__HTt___0__Tbb == null)
				{
					r_R__0__HTt___0__Tbb = new( ReleactionUtils.GetType("#u.#Tr"), "#HTt", 0,  ReleactionUtils.GetType("#u.#Tbb"));
					r_R__0__HTt___0__Tbb.SetBelong(null);
				}
				return r_R__0__HTt___0__Tbb;
			}
		}
        ...
        public R__0__Tr() : base("#u.#Tr")
        {
        }

        public R__0__Tr(System.Object instance) : base("#u.#Tr")
		{
            SetInstance(instance);
		}

        public R__0__Tr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Tr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Jr()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Jr.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Kr(System.String  @findName)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@findName};
            var ___result = R__0__Kr_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator __0__Lr()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Lr.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Cdx
	/// </summary>
    public partial class R__0__Cdx : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.Int32,System.Collections.Generic.List`1[System.Int32]] #c
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, RSystem.RCollections.RGeneric.RList<RField>> r___0__c;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, RSystem.RCollections.RGeneric.RList<RField>> R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// <summary>
		/// Void #nTr(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__nTr_Object___0__7X;
		public virtual RMethod R__0__nTr_Object___0__7X
		{
			get
			{
				if(r_R__0__nTr_Object___0__7X == null)
				{
					r_R__0__nTr_Object___0__7X = new(this, "#nTr", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__nTr_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__nTr_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #oTr(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__oTr_Object___0__7X;
		public virtual RMethod R__0__oTr_Object___0__7X
		{
			get
			{
				if(r_R__0__oTr_Object___0__7X == null)
				{
					r_R__0__oTr_Object___0__7X = new(this, "#oTr", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__oTr_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__oTr_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #Jdx(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Jdx_Object___0__7X;
		public virtual RMethod R__0__Jdx_Object___0__7X
		{
			get
			{
				if(r_R__0__Jdx_Object___0__7X == null)
				{
					r_R__0__Jdx_Object___0__7X = new(this, "#Jdx", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Jdx_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Jdx_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #qch(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__qch_Object___0__7X;
		public virtual RMethod R__0__qch_Object___0__7X
		{
			get
			{
				if(r_R__0__qch_Object___0__7X == null)
				{
					r_R__0__qch_Object___0__7X = new(this, "#qch", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__qch_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__qch_Object___0__7X;
			}
		}
		...
		/// Void #pTr()
		/// </summary>
		protected RMethod r_R__0__pTr;
		public virtual RMethod R__0__pTr
		{
			get
			{
				if(r_R__0__pTr == null)
				{
					r_R__0__pTr = new(this, "#pTr", 0);
					r_R__0__pTr.SetBelong(this.instance);
				}
				return r_R__0__pTr;
			}
		}
		...
		/// Void #Kb(#Pfb.#Hdx)
		/// </summary>
		protected RMethod r_R__0__Kb___0__Hdx;
		public virtual RMethod R__0__Kb___0__Hdx
		{
			get
			{
				if(r_R__0__Kb___0__Hdx == null)
				{
					r_R__0__Kb___0__Hdx = new(this, "#Kb", 0,  ReleactionUtils.GetType("#Pfb.#Hdx"));
					r_R__0__Kb___0__Hdx.SetBelong(this.instance);
				}
				return r_R__0__Kb___0__Hdx;
			}
		}
        ...
        public R__0__Cdx() : base("#u.#Cdx")
        {
        }

        public R__0__Cdx(System.Object instance) : base("#u.#Cdx")
		{
            SetInstance(instance);
		}

        public R__0__Cdx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Cdx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__pTr()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__pTr.Invoke(___genericsType, ___parameters);

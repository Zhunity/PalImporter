...
{public partial class R__0__yhj
{
	...
	/// #u.#yhj+#CSw
	/// </summary>
    public partial class R__0__CSw : RMember //
    {

		/// <summary>
		/// #Pfb.#Oij #a
		/// </summary>
		protected R__0__Pfb.R__0__Oij r___0__a;
		public virtual R__0__Pfb.R__0__Oij R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// ToxophilyDropConfig #c
		/// </summary>
		protected RToxophilyDropConfig r___0__c;
		public virtual RToxophilyDropConfig R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// #Pfb.#Oij #f
		/// </summary>
		protected R__0__Pfb.R__0__Oij r___0__f;
		public virtual R__0__Pfb.R__0__Oij R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// #u.#yhj #g
		/// </summary>
		protected R__0__u.R__0__yhj r___0__g;
		public virtual R__0__u.R__0__yhj R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__CSw() : base("#u.#yhj+#CSw")
        {
        }

        public R__0__CSw(System.Object instance) : base("#u.#yhj+#CSw")
		{
            SetInstance(instance);
		}

        public R__0__CSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__CSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

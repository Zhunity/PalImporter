...
{public partial class R__0__yhj
{
	...
	/// #u.#yhj+#ESw
	/// </summary>
    public partial class R__0__ESw : RMember //
    {
        ...
        public R__0__ESw() : base("#u.#yhj+#ESw")
        {
        }

        public R__0__ESw(System.Object instance) : base("#u.#yhj+#ESw")
		{
            SetInstance(instance);
		}

        public R__0__ESw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ESw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

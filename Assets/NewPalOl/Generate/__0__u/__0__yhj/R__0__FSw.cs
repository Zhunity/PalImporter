...
{public partial class R__0__yhj
{
	...
	/// #u.#yhj+#FSw
	/// </summary>
    public partial class R__0__FSw : RMember //
    {
		...
		/// #Pfb.#Tij #b
		/// </summary>
		protected R__0__Pfb.R__0__Tij r___0__b;
		public virtual R__0__Pfb.R__0__Tij R__0__b
		{
			get
			{
				if(r___0__b == null)
        ...
        public R__0__FSw() : base("#u.#yhj+#FSw")
        {
        }

        public R__0__FSw(System.Object instance) : base("#u.#yhj+#FSw")
		{
            SetInstance(instance);
		}

        public R__0__FSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__FSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#hw
	/// </summary>
    public partial class R__0__hw : RMember //
    {
        ...
        public R__0__hw() : base("#u.#hw")
        {
        }

        public R__0__hw(System.Object instance) : base("#u.#hw")
		{
            SetInstance(instance);
		}

        public R__0__hw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__tWd
{
	...
	/// #u.#tWd+#Kee
	/// </summary>
    public partial class R__0__Kee : RMember //
    {
		...
		/// #u.#tWd #l
		/// </summary>
		protected R__0__u.R__0__tWd r___0__l;
		public virtual R__0__u.R__0__tWd R__0__l
		{
			get
			{
				if(r___0__l == null)
        ...
        public R__0__Kee() : base("#u.#tWd+#Kee")
        {
        }

        public R__0__Kee(System.Object instance) : base("#u.#tWd+#Kee")
		{
            SetInstance(instance);
		}

        public R__0__Kee(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Kee(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

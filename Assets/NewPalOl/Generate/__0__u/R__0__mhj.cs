...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#mhj
	/// </summary>
    public partial class R__0__mhj : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#mhj"), "#a");
		...
		public static RField R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#mhj"), "#b");
		...
		public static RField R__0__c
		{
			get
			{
				if(r___0__c == null)
				{
					r___0__c = new( ReleactionUtils.GetType("#u.#mhj"), "#c");
		...
		public static RField R__0__d
		{
			get
			{
				if(r___0__d == null)
				{
					r___0__d = new( ReleactionUtils.GetType("#u.#mhj"), "#d");
		...
		/// <summary>
		/// Void #Jxj(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Jxj_Object___0__7X;
		public virtual RMethod R__0__Jxj_Object___0__7X
		{
			get
			{
				if(r_R__0__Jxj_Object___0__7X == null)
				{
					r_R__0__Jxj_Object___0__7X = new(this, "#Jxj", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Jxj_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Jxj_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #jhj(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__jhj_Object___0__7X;
		public virtual RMethod R__0__jhj_Object___0__7X
		{
			get
			{
				if(r_R__0__jhj_Object___0__7X == null)
				{
					r_R__0__jhj_Object___0__7X = new(this, "#jhj", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__jhj_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__jhj_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #khj(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__khj_Object___0__7X;
		public virtual RMethod R__0__khj_Object___0__7X
		{
			get
			{
				if(r_R__0__khj_Object___0__7X == null)
				{
					r_R__0__khj_Object___0__7X = new(this, "#khj", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__khj_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__khj_Object___0__7X;
			}
		}
		...
		/// Void #xpl(#u.#eql)
		/// </summary>
		protected RMethod r_R__0__xpl___0__eql;
		public virtual RMethod R__0__xpl___0__eql
		{
			get
			{
				if(r_R__0__xpl___0__eql == null)
				{
					r_R__0__xpl___0__eql = new(this, "#xpl", 0,  ReleactionUtils.GetType("#u.#eql"));
					r_R__0__xpl___0__eql.SetBelong(this.instance);
				}
				return r_R__0__xpl___0__eql;
			}
		}
		...
		/// Void #lhj()
		/// </summary>
		protected RMethod r_R__0__lhj;
		public virtual RMethod R__0__lhj
		{
			get
			{
				if(r_R__0__lhj == null)
				{
					r_R__0__lhj = new(this, "#lhj", 0);
					r_R__0__lhj.SetBelong(this.instance);
				}
				return r_R__0__lhj;
			}
		}
        ...
        public R__0__mhj() : base("#u.#mhj")
        {
        }

        public R__0__mhj(System.Object instance) : base("#u.#mhj")
		{
            SetInstance(instance);
		}

        public R__0__mhj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__mhj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__lhj()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__lhj.Invoke(___genericsType, ___parameters);

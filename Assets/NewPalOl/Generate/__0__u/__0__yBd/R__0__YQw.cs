...
{public partial class R__0__yBd<__0__bk>
{
	
	/// <summary>
	/// #u.#yBd+#YQw
	/// </summary>
    public partial class R__0__YQw : RMember //
    {
        ...
        public R__0__YQw() : base("#u.#yBd+#YQw")
        {
        }

        public R__0__YQw(System.Object instance) : base("#u.#yBd+#YQw")
		{
            SetInstance(instance);
		}

        public R__0__YQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

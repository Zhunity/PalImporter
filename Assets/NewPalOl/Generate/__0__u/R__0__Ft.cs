...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Ft
	/// </summary>
    public partial class R__0__Ft : RMember //
    {
        ...
        public R__0__Ft() : base("#u.#Ft")
        {
        }

        public R__0__Ft(System.Object instance) : base("#u.#Ft")
		{
            SetInstance(instance);
		}

        public R__0__Ft(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ft(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__FOc
{
	
	/// <summary>
	/// #u.#FOc+#UIr
	/// </summary>
    public partial class R__0__UIr : RMember //
    {
		...
		/// #u.#Mrc #c
		/// </summary>
		protected R__0__u.R__0__Mrc r___0__c;
		public virtual R__0__u.R__0__Mrc R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// #u.#Mrc #g
		/// </summary>
		protected R__0__u.R__0__Mrc r___0__g;
		public virtual R__0__u.R__0__Mrc R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__UIr() : base("#u.#FOc+#UIr")
        {
        }

        public R__0__UIr(System.Object instance) : base("#u.#FOc+#UIr")
		{
            SetInstance(instance);
		}

        public R__0__UIr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__UIr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#bai
	/// </summary>
    public partial class R__0__bai : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[GameDefineType.ID,System.Int32] #c
		/// </summary>
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[GameDefineType.ID,System.Int32] #d
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RGameDefineType.RID, RField> r___0__d;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RGameDefineType.RID, RField> R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// System.String #aai()
		/// </summary>
		protected RMethod r_R__0__aai;
		public virtual RMethod R__0__aai
		{
			get
			{
				if(r_R__0__aai == null)
				{
					r_R__0__aai = new(this, "#aai", 0);
					r_R__0__aai.SetBelong(this.instance);
				}
				return r_R__0__aai;
			}
		}
		...
		/// <summary>
		/// Void #Pb(System.String, Int32, System.String)
		/// </summary>
		protected RMethod r_R__0__Pb_String_Int32_String;
		public virtual RMethod R__0__Pb_String_Int32_String
		{
			get
			{
				if(r_R__0__Pb_String_Int32_String == null)
				{
					r_R__0__Pb_String_Int32_String = new(this, "#Pb", 0, typeof(System.String), typeof(System.Int32), typeof(System.String));
					r_R__0__Pb_String_Int32_String.SetBelong(this.instance);
				}
				return r_R__0__Pb_String_Int32_String;
			}
		}

		/// <summary>
		/// Void #7ai(GameDefineType.ID, Int32)
		/// </summary>
		protected RMethod r_R__0__7ai_ID_Int32;
		public virtual RMethod R__0__7ai_ID_Int32
		{
			get
			{
				if(r_R__0__7ai_ID_Int32 == null)
				{
					r_R__0__7ai_ID_Int32 = new(this, "#7ai", 0, typeof(GameDefineType.ID), typeof(System.Int32));
					r_R__0__7ai_ID_Int32.SetBelong(this.instance);
				}
				return r_R__0__7ai_ID_Int32;
			}
		}
        ...
        public R__0__bai() : base("#u.#bai")
        {
        }

        public R__0__bai(System.Object instance) : base("#u.#bai")
		{
            SetInstance(instance);
		}

        public R__0__bai(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__bai(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.String __0__aai()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__aai.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__Pb(System.String  @myinfo, System.Int32  @count, System.String  @totalinfo)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@myinfo, @count, @totalinfo};
            var ___result = R__0__Pb_String_Int32_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__7ai(GameDefineType.ID  @id, System.Int32  @count)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id, @count};
            var ___result = R__0__7ai_ID_Int32.Invoke(___genericsType, ___parameters);

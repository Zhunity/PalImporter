...
{public partial class R__0__yXu
{
	
	/// <summary>
	/// #u.#yXu+#4fw
	/// </summary>
    public partial class R__0__4fw : RMember //
    {
		...
		/// System.Object #u
		/// </summary>
		protected RSystem.RObject r___0__u;
		public virtual RSystem.RObject R__0__u
		{
			get
			{
				if(r___0__u == null)
		...
		/// #u.#yXu #w
		/// </summary>
		protected R__0__u.R__0__yXu r___0__w;
		public virtual R__0__u.R__0__yXu R__0__w
		{
			get
			{
				if(r___0__w == null)
        ...
        public R__0__4fw() : base("#u.#yXu+#4fw")
        {
        }

        public R__0__4fw(System.Object instance) : base("#u.#yXu+#4fw")
		{
            SetInstance(instance);
		}

        public R__0__4fw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4fw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

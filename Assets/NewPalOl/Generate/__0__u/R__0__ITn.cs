...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#ITn
	/// </summary>
    public partial class R__0__ITn : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#ITn"), "#a");
		...
		/// <summary>
		/// System.Func`2[#u.#ITn+#weo,#u.#ITn+#weo] #g
		/// </summary>
		protected static RSystem.RFunc<R__0__u.R__0__ITn.R__0__weo, R__0__u.R__0__ITn.R__0__weo> r___0__g;
		public static RSystem.RFunc<R__0__u.R__0__ITn.R__0__weo, R__0__u.R__0__ITn.R__0__weo> R__0__g
		{
			get
			{
				if(r___0__g == null)
				{
					r___0__g = new( ReleactionUtils.GetType("#u.#ITn"), "#g");
		...
		/// <summary>
		/// Void #FTn(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__FTn_Object___0__7X;
		public virtual RMethod R__0__FTn_Object___0__7X
		{
			get
			{
				if(r_R__0__FTn_Object___0__7X == null)
				{
					r_R__0__FTn_Object___0__7X = new(this, "#FTn", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__FTn_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__FTn_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Int32 Compare(SecretShopExchange, SecretShopExchange)
		/// </summary>
		protected RMethod r_RCompare_SecretShopExchange_SecretShopExchange;
		public virtual RMethod RCompare_SecretShopExchange_SecretShopExchange
		{
			get
			{
				if(r_RCompare_SecretShopExchange_SecretShopExchange == null)
				{
					r_RCompare_SecretShopExchange_SecretShopExchange = new(this, "Compare", 0, typeof(SecretShopExchange), typeof(SecretShopExchange));
					r_RCompare_SecretShopExchange_SecretShopExchange.SetBelong(this.instance);
				}
				return r_RCompare_SecretShopExchange_SecretShopExchange;
			}
		}
		...
		/// Void #MDc()
		/// </summary>
		protected RMethod r_R__0__MDc;
		public virtual RMethod R__0__MDc
		{
			get
			{
				if(r_R__0__MDc == null)
				{
					r_R__0__MDc = new(this, "#MDc", 0);
					r_R__0__MDc.SetBelong(this.instance);
				}
				return r_R__0__MDc;
			}
		}
		...
		/// Void #GTn(#Pfb.#fUn)
		/// </summary>
		protected RMethod r_R__0__GTn___0__fUn;
		public virtual RMethod R__0__GTn___0__fUn
		{
			get
			{
				if(r_R__0__GTn___0__fUn == null)
				{
					r_R__0__GTn___0__fUn = new(this, "#GTn", 0,  ReleactionUtils.GetType("#Pfb.#fUn"));
					r_R__0__GTn___0__fUn.SetBelong(this.instance);
				}
				return r_R__0__GTn___0__fUn;
			}
		}

		/// <summary>
		/// Void #HTn(Int32, Int32)
		/// </summary>
		protected RMethod r_R__0__HTn_Int32_Int32;
		public virtual RMethod R__0__HTn_Int32_Int32
		{
			get
			{
				if(r_R__0__HTn_Int32_Int32 == null)
				{
					r_R__0__HTn_Int32_Int32 = new(this, "#HTn", 0, typeof(System.Int32), typeof(System.Int32));
					r_R__0__HTn_Int32_Int32.SetBelong(this.instance);
				}
				return r_R__0__HTn_Int32_Int32;
			}
		}
		...
		/// Int32 #Gfp(Int32)
		/// </summary>
		protected RMethod r_R__0__Gfp_Int32;
		public virtual RMethod R__0__Gfp_Int32
		{
			get
			{
				if(r_R__0__Gfp_Int32 == null)
				{
					r_R__0__Gfp_Int32 = new(this, "#Gfp", 0, typeof(System.Int32));
					r_R__0__Gfp_Int32.SetBelong(this.instance);
				}
				return r_R__0__Gfp_Int32;
			}
		}
		...
		/// #weo #Bex(#weo)
		/// </summary>
		protected static RMethod r_R__0__Bex___0__weo;
		public static RMethod R__0__Bex___0__weo
		{
			get
			{
				if(r_R__0__Bex___0__weo == null)
				{
					r_R__0__Bex___0__weo = new( ReleactionUtils.GetType("#u.#ITn"), "#Bex", 0,  ReleactionUtils.GetType("#u.#ITn+#weo"));
					r_R__0__Bex___0__weo.SetBelong(null);
				}
				return r_R__0__Bex___0__weo;
			}
		}
        ...
        public R__0__ITn() : base("#u.#ITn")
        {
        }

        public R__0__ITn(System.Object instance) : base("#u.#ITn")
		{
            SetInstance(instance);
		}

        public R__0__ITn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ITn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Int32 Compare(SecretShopExchange  @x, SecretShopExchange  @y)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@x, @y};
            var ___result = RCompare_SecretShopExchange_SecretShopExchange.Invoke(___genericsType, ___parameters);

            return (System.Int32)___result;
        }


        public virtual void __0__MDc()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__MDc.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__HTn(System.Int32  @id, System.Int32  @count)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id, @count};
            var ___result = R__0__HTn_Int32_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Int32 __0__Gfp(System.Int32  @id)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id};
            var ___result = R__0__Gfp_Int32.Invoke(___genericsType, ___parameters);

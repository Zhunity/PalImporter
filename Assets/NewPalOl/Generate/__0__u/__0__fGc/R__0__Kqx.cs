...
{public partial class R__0__fGc
{
	
	/// <summary>
	/// #u.#fGc+#Kqx
	/// </summary>
    public partial class R__0__Kqx : RMember //
    {
		...
		/// TutorialConfig #d
		/// </summary>
		protected RTutorialConfig r___0__d;
		public virtual RTutorialConfig R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// #u.#fGc #e
		/// </summary>
		protected R__0__u.R__0__fGc r___0__e;
		public virtual R__0__u.R__0__fGc R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__Kqx() : base("#u.#fGc+#Kqx")
        {
        }

        public R__0__Kqx(System.Object instance) : base("#u.#fGc+#Kqx")
		{
            SetInstance(instance);
		}

        public R__0__Kqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Kqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

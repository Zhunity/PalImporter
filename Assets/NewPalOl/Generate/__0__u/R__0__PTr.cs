...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#PTr
	/// </summary>
    public partial class R__0__PTr : RMember //
    {
		...
		/// <summary>
		/// Void #LTr(System.String)
		/// </summary>
		protected RMethod r_R__0__LTr_String;
		public virtual RMethod R__0__LTr_String
		{
			get
			{
				if(r_R__0__LTr_String == null)
				{
					r_R__0__LTr_String = new(this, "#LTr", 0, typeof(System.String));
					r_R__0__LTr_String.SetBelong(this.instance);
				}
				return r_R__0__LTr_String;
			}
		}
		...
		/// Void #MTr(Int32)
		/// </summary>
		protected RMethod r_R__0__MTr_Int32;
		public virtual RMethod R__0__MTr_Int32
		{
			get
			{
				if(r_R__0__MTr_Int32 == null)
				{
					r_R__0__MTr_Int32 = new(this, "#MTr", 0, typeof(System.Int32));
					r_R__0__MTr_Int32.SetBelong(this.instance);
				}
				return r_R__0__MTr_Int32;
			}
		}
		...
		/// Void #NTr(Int32)
		/// </summary>
		protected RMethod r_R__0__NTr_Int32;
		public virtual RMethod R__0__NTr_Int32
		{
			get
			{
				if(r_R__0__NTr_Int32 == null)
				{
					r_R__0__NTr_Int32 = new(this, "#NTr", 0, typeof(System.Int32));
					r_R__0__NTr_Int32.SetBelong(this.instance);
				}
				return r_R__0__NTr_Int32;
			}
		}

		/// <summary>
		/// Void #0k(#eUr, UnityEngine.Vector2)
		/// </summary>
		protected RMethod r_R__0__0k___0__eUr_Vector2;
		public virtual RMethod R__0__0k___0__eUr_Vector2
		{
			get
			{
				if(r_R__0__0k___0__eUr_Vector2 == null)
				{
					r_R__0__0k___0__eUr_Vector2 = new(this, "#0k", 0,  ReleactionUtils.GetType("#u.#dUr+#eUr"), typeof(UnityEngine.Vector2));
					r_R__0__0k___0__eUr_Vector2.SetBelong(this.instance);
				}
				return r_R__0__0k___0__eUr_Vector2;
			}
		}

		/// <summary>
		/// Void #OTr(System.String)
		/// </summary>
		protected RMethod r_R__0__OTr_String;
		public virtual RMethod R__0__OTr_String
		{
			get
			{
				if(r_R__0__OTr_String == null)
				{
					r_R__0__OTr_String = new(this, "#OTr", 0, typeof(System.String));
					r_R__0__OTr_String.SetBelong(this.instance);
				}
				return r_R__0__OTr_String;
			}
		}
        ...
        public R__0__PTr() : base("#u.#PTr")
        {
        }

        public R__0__PTr(System.Object instance) : base("#u.#PTr")
		{
            SetInstance(instance);
		}

        public R__0__PTr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__PTr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__LTr(System.String  @text)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text};
            var ___result = R__0__LTr_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__MTr(System.Int32  @career)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@career};
            var ___result = R__0__MTr_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__NTr(System.Int32  @career)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@career};
            var ___result = R__0__NTr_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__OTr(System.String  @text)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text};
            var ___result = R__0__OTr_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Bx(System.String  @text)
        {

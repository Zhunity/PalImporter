...
{public partial class R__0__uMw
{
	
	/// <summary>
	/// #u.#uMw+#HQw
	/// </summary>
    public partial class R__0__HQw : RMember //
    {
		...
		/// #u.#uMw #j
		/// </summary>
		protected R__0__u.R__0__uMw r___0__j;
		public virtual R__0__u.R__0__uMw R__0__j
		{
			get
			{
				if(r___0__j == null)
        ...
        public R__0__HQw() : base("#u.#uMw+#HQw")
        {
        }

        public R__0__HQw(System.Object instance) : base("#u.#uMw+#HQw")
		{
            SetInstance(instance);
		}

        public R__0__HQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__HQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

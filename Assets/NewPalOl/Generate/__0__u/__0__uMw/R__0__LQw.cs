...
{public partial class R__0__uMw
{
	...
	/// #u.#uMw+#LQw
	/// </summary>
    public partial class R__0__LQw : RMember //
    {
		...
		/// #u.#uMw #d
		/// </summary>
		protected R__0__u.R__0__uMw r___0__d;
		public virtual R__0__u.R__0__uMw R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__LQw() : base("#u.#uMw+#LQw")
        {
        }

        public R__0__LQw(System.Object instance) : base("#u.#uMw+#LQw")
		{
            SetInstance(instance);
		}

        public R__0__LQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__LQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

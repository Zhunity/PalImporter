...
{public partial class R__0__uMw
{
	...
	/// #u.#uMw+#IQw
	/// </summary>
    public partial class R__0__IQw : RMember //
    {
        ...
        public R__0__IQw() : base("#u.#uMw+#IQw")
        {
        }

        public R__0__IQw(System.Object instance) : base("#u.#uMw+#IQw")
		{
            SetInstance(instance);
		}

        public R__0__IQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__IQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__uMw
{
	...
	/// #u.#uMw+#KQw
	/// </summary>
    public partial class R__0__KQw : RMember //
    {
        ...
        public R__0__KQw() : base("#u.#uMw+#KQw")
        {
        }

        public R__0__KQw(System.Object instance) : base("#u.#uMw+#KQw")
		{
            SetInstance(instance);
		}

        public R__0__KQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__KQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__uMw
{
	...
	/// #u.#uMw+#JQw
	/// </summary>
    public partial class R__0__JQw : RMember //
    {
        ...
        public R__0__JQw() : base("#u.#uMw+#JQw")
        {
        }

        public R__0__JQw(System.Object instance) : base("#u.#uMw+#JQw")
		{
            SetInstance(instance);
		}

        public R__0__JQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__JQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

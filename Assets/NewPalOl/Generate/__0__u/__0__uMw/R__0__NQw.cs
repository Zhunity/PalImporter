...
{public partial class R__0__uMw
{
	...
	/// #u.#uMw+#NQw
	/// </summary>
    public partial class R__0__NQw : RMember //
    {
		...
		/// #u.#uMw #e
		/// </summary>
		protected R__0__u.R__0__uMw r___0__e;
		public virtual R__0__u.R__0__uMw R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__NQw() : base("#u.#uMw+#NQw")
        {
        }

        public R__0__NQw(System.Object instance) : base("#u.#uMw+#NQw")
		{
            SetInstance(instance);
		}

        public R__0__NQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__NQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

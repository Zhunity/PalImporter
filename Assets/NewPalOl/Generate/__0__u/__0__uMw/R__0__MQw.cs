...
{public partial class R__0__uMw
{
	...
	/// #u.#uMw+#MQw
	/// </summary>
    public partial class R__0__MQw : RMember //
    {
		...
		/// #u.#uMw #c
		/// </summary>
		protected R__0__u.R__0__uMw r___0__c;
		public virtual R__0__u.R__0__uMw R__0__c
		{
			get
			{
				if(r___0__c == null)
        ...
        public R__0__MQw() : base("#u.#uMw+#MQw")
        {
        }

        public R__0__MQw(System.Object instance) : base("#u.#uMw+#MQw")
		{
            SetInstance(instance);
		}

        public R__0__MQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__MQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

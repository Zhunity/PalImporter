...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#PJg
	/// </summary>
    public partial class R__0__PJg : RMember //
    {
        ...
        public R__0__PJg() : base("#u.#PJg")
        {
        }

        public R__0__PJg(System.Object instance) : base("#u.#PJg")
		{
            SetInstance(instance);
		}

        public R__0__PJg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__PJg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Umn
	/// </summary>
    public partial class R__0__Umn : RMember //
    {
		...
		/// Void #Cj(Int32, Int32)
		/// </summary>
		protected RMethod r_R__0__Cj_Int32_Int32;
		public virtual RMethod R__0__Cj_Int32_Int32
		{
			get
			{
				if(r_R__0__Cj_Int32_Int32 == null)
				{
					r_R__0__Cj_Int32_Int32 = new(this, "#Cj", 0, typeof(System.Int32), typeof(System.Int32));
					r_R__0__Cj_Int32_Int32.SetBelong(this.instance);
				}
				return r_R__0__Cj_Int32_Int32;
			}
		}
        ...
        public R__0__Umn() : base("#u.#Umn")
        {
        }

        public R__0__Umn(System.Object instance) : base("#u.#Umn")
		{
            SetInstance(instance);
		}

        public R__0__Umn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Umn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Cj(System.Int32  @itemid, System.Int32  @count)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@itemid, @count};
            var ___result = R__0__Cj_Int32_Int32.Invoke(___genericsType, ___parameters);

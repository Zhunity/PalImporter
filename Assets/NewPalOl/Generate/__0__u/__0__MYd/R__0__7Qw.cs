...
{public partial class R__0__MYd
{
	...
	/// #u.#MYd+#7Qw
	/// </summary>
    public partial class R__0__7Qw : RMember //
    {
		...
		/// #u.#MYd #g
		/// </summary>
		protected R__0__u.R__0__MYd r___0__g;
		public virtual R__0__u.R__0__MYd R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__7Qw() : base("#u.#MYd+#7Qw")
        {
        }

        public R__0__7Qw(System.Object instance) : base("#u.#MYd+#7Qw")
		{
            SetInstance(instance);
		}

        public R__0__7Qw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7Qw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Quc
	/// </summary>
    public partial class R__0__Quc : RMember //
    {
		...
		/// #u.#cGc #e
		/// </summary>
		protected R__0__u.R__0__cGc r___0__e;
		public virtual R__0__u.R__0__cGc R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// #u.#Quc+#hHc #f
		/// </summary>
		protected R__0__u.R__0__Quc.R__0__hHc r___0__f;
		public virtual R__0__u.R__0__Quc.R__0__hHc R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// Void #mwc()
		/// </summary>
		protected RMethod r_R__0__mwc;
		public virtual RMethod R__0__mwc
		{
			get
			{
				if(r_R__0__mwc == null)
				{
					r_R__0__mwc = new(this, "#mwc", 0);
					r_R__0__mwc.SetBelong(this.instance);
				}
				return r_R__0__mwc;
			}
		}
		...
		/// Void #Ibb(#u.#cGc)
		/// </summary>
		protected RMethod r_R__0__Ibb___0__cGc;
		public virtual RMethod R__0__Ibb___0__cGc
		{
			get
			{
				if(r_R__0__Ibb___0__cGc == null)
				{
					r_R__0__Ibb___0__cGc = new(this, "#Ibb", 0,  ReleactionUtils.GetType("#u.#cGc"));
					r_R__0__Ibb___0__cGc.SetBelong(this.instance);
				}
				return r_R__0__Ibb___0__cGc;
			}
		}

		/// <summary>
		/// Void #nwc(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__nwc_Object___0__7X;
		public virtual RMethod R__0__nwc_Object___0__7X
		{
			get
			{
				if(r_R__0__nwc_Object___0__7X == null)
				{
					r_R__0__nwc_Object___0__7X = new(this, "#nwc", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__nwc_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__nwc_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #dxc(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__dxc_Object___0__7X;
		public virtual RMethod R__0__dxc_Object___0__7X
		{
			get
			{
				if(r_R__0__dxc_Object___0__7X == null)
				{
					r_R__0__dxc_Object___0__7X = new(this, "#dxc", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__dxc_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__dxc_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #exc(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__exc_Object___0__7X;
		public virtual RMethod R__0__exc_Object___0__7X
		{
			get
			{
				if(r_R__0__exc_Object___0__7X == null)
				{
					r_R__0__exc_Object___0__7X = new(this, "#exc", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__exc_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__exc_Object___0__7X;
			}
		}
        ...
        public R__0__Quc() : base("#u.#Quc")
        {
        }

        public R__0__Quc(System.Object instance) : base("#u.#Quc")
		{
            SetInstance(instance);
		}

        public R__0__Quc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Quc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__mwc()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__mwc.Invoke(___genericsType, ___parameters);

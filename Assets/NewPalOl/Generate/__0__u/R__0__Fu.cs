...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Fu
	/// </summary>
    public partial class R__0__Fu : RMember //
    {

		/// <summary>
		/// #u.#Fu+#ONb1 #a
		/// </summary>
		protected R__0__u.R__0__Fu.R__0__ONb1 r___0__a;
		public virtual R__0__u.R__0__Fu.R__0__ONb1 R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #u.#Fu+#PNb1 #b
		/// </summary>
		protected R__0__u.R__0__Fu.R__0__PNb1 r___0__b;
		public virtual R__0__u.R__0__Fu.R__0__PNb1 R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.String,System.Single] #h
		/// </summary>
		...
		/// <summary>
		/// Void #Cu(System.Collections.Generic.List`1[System.String], ABLoadingHandler, ABLoadedHandler, ABLoadedHandler, System.Object)
		/// </summary>
		protected RMethod r_R__0__Cu_List_d_String_p__ABLoadingHandler_ABLoadedHandler_ABLoadedHandler_Object;
		public virtual RMethod R__0__Cu_List_d_String_p__ABLoadingHandler_ABLoadedHandler_ABLoadedHandler_Object
		{
			get
			{
				if(r_R__0__Cu_List_d_String_p__ABLoadingHandler_ABLoadedHandler_ABLoadedHandler_Object == null)
				{
					r_R__0__Cu_List_d_String_p__ABLoadingHandler_ABLoadedHandler_ABLoadedHandler_Object = new(this, "#Cu", 0, typeof(System.Collections.Generic.List<>).MakeGenericType(typeof(System.String)),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadingHandler"),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadedHandler"),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadedHandler"), typeof(System.Object));
					r_R__0__Cu_List_d_String_p__ABLoadingHandler_ABLoadedHandler_ABLoadedHandler_Object.SetBelong(this.instance);
				}
				return r_R__0__Cu_List_d_String_p__ABLoadingHandler_ABLoadedHandler_ABLoadedHandler_Object;
			}
		}
		...
		/// <summary>
		/// Void #Du(System.Object, ABLoadedArgs)
		/// </summary>
		protected RMethod r_R__0__Du_Object_ABLoadedArgs;
		public virtual RMethod R__0__Du_Object_ABLoadedArgs
		{
			get
			{
				if(r_R__0__Du_Object_ABLoadedArgs == null)
				{
					r_R__0__Du_Object_ABLoadedArgs = new(this, "#Du", 0, typeof(System.Object),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadedArgs"));
					r_R__0__Du_Object_ABLoadedArgs.SetBelong(this.instance);
				}
				return r_R__0__Du_Object_ABLoadedArgs;
			}
		}

		/// <summary>
		/// Void #Eu(System.Object, ABLoadingArgs)
		/// </summary>
		protected RMethod r_R__0__Eu_Object_ABLoadingArgs;
		public virtual RMethod R__0__Eu_Object_ABLoadingArgs
		{
			get
			{
				if(r_R__0__Eu_Object_ABLoadingArgs == null)
				{
					r_R__0__Eu_Object_ABLoadingArgs = new(this, "#Eu", 0, typeof(System.Object),  ReleactionUtils.GetType("AssetBundleDownloader+ABLoadingArgs"));
					r_R__0__Eu_Object_ABLoadingArgs.SetBelong(this.instance);
				}
				return r_R__0__Eu_Object_ABLoadingArgs;
			}
		}
        ...
        public R__0__Fu() : base("#u.#Fu")
        {
        }

        public R__0__Fu(System.Object instance) : base("#u.#Fu")
		{
            SetInstance(instance);
		}

        public R__0__Fu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Fu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

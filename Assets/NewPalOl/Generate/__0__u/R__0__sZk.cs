...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#sZk
	/// </summary>
    public partial class R__0__sZk : RMember //
    {
		...
		/// <summary>
		/// MyGUI.ElementBase+#ZNb #b
		/// </summary>
		protected static RMyGUI.RElementBase.R__0__ZNb r___0__b;
		public static RMyGUI.RElementBase.R__0__ZNb R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#sZk"), "#b");
		...
		/// </summary>
		protected static RMyGUI.RElementBase.R__0__ZNb r___0__c;
		public static RMyGUI.RElementBase.R__0__ZNb R__0__c
		{
			get
			{
				if(r___0__c == null)
				{
					r___0__c = new( ReleactionUtils.GetType("#u.#sZk"), "#c");
		...
		/// #u.#IOc+#LNb1 #d
		/// </summary>
		protected static R__0__u.R__0__IOc.R__0__LNb1 r___0__d;
		public static R__0__u.R__0__IOc.R__0__LNb1 R__0__d
		{
			get
			{
				if(r___0__d == null)
				{
					r___0__d = new( ReleactionUtils.GetType("#u.#sZk"), "#d");
		...
		public static RMyGUI.RElementBase.R__0__ZNb R__0__e
		{
			get
			{
				if(r___0__e == null)
				{
					r___0__e = new( ReleactionUtils.GetType("#u.#sZk"), "#e");
		...
		/// <summary>
		/// Void #9Tu(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__9Tu_Object___0__7X;
		public virtual RMethod R__0__9Tu_Object___0__7X
		{
			get
			{
				if(r_R__0__9Tu_Object___0__7X == null)
				{
					r_R__0__9Tu_Object___0__7X = new(this, "#9Tu", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__9Tu_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__9Tu_Object___0__7X;
			}
		}
		...
		/// Void #5I()
		/// </summary>
		protected RMethod r_R__0__5I;
		public virtual RMethod R__0__5I
		{
			get
			{
				if(r_R__0__5I == null)
				{
					r_R__0__5I = new(this, "#5I", 0);
					r_R__0__5I.SetBelong(this.instance);
				}
				return r_R__0__5I;
			}
		}
		...
		/// Void #ECd(Boolean)
		/// </summary>
		protected RMethod r_R__0__ECd_Boolean;
		public virtual RMethod R__0__ECd_Boolean
		{
			get
			{
				if(r_R__0__ECd_Boolean == null)
				{
					r_R__0__ECd_Boolean = new(this, "#ECd", 0, typeof(System.Boolean));
					r_R__0__ECd_Boolean.SetBelong(this.instance);
				}
				return r_R__0__ECd_Boolean;
			}
		}
		...
		/// <summary>
		/// Void #ebr(System.Object, #oU.#7X)
		/// </summary>
		protected static RMethod r_R__0__ebr_Object___0__7X;
		public static RMethod R__0__ebr_Object___0__7X
		{
			get
			{
				if(r_R__0__ebr_Object___0__7X == null)
				{
					r_R__0__ebr_Object___0__7X = new( ReleactionUtils.GetType("#u.#sZk"), "#ebr", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__ebr_Object___0__7X.SetBelong(null);
				}
				return r_R__0__ebr_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #Jlr(System.Object, #oU.#7X)
		/// </summary>
		protected static RMethod r_R__0__Jlr_Object___0__7X;
		public static RMethod R__0__Jlr_Object___0__7X
		{
			get
			{
				if(r_R__0__Jlr_Object___0__7X == null)
				{
					r_R__0__Jlr_Object___0__7X = new( ReleactionUtils.GetType("#u.#sZk"), "#Jlr", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Jlr_Object___0__7X.SetBelong(null);
				}
				return r_R__0__Jlr_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #Klr(System.Object)
		/// </summary>
		protected static RMethod r_R__0__Klr_Object;
		public static RMethod R__0__Klr_Object
		{
			get
			{
				if(r_R__0__Klr_Object == null)
				{
					r_R__0__Klr_Object = new( ReleactionUtils.GetType("#u.#sZk"), "#Klr", 0, typeof(System.Object));
					r_R__0__Klr_Object.SetBelong(null);
				}
				return r_R__0__Klr_Object;
			}
		}

		/// <summary>
		/// Void #Llr(System.Object, #oU.#7X)
		/// </summary>
		protected static RMethod r_R__0__Llr_Object___0__7X;
		public static RMethod R__0__Llr_Object___0__7X
		{
			get
			{
				if(r_R__0__Llr_Object___0__7X == null)
				{
					r_R__0__Llr_Object___0__7X = new( ReleactionUtils.GetType("#u.#sZk"), "#Llr", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Llr_Object___0__7X.SetBelong(null);
				}
				return r_R__0__Llr_Object___0__7X;
			}
		}
        ...
        public R__0__sZk() : base("#u.#sZk")
        {
        }

        public R__0__sZk(System.Object instance) : base("#u.#sZk")
		{
            SetInstance(instance);
		}

        public R__0__sZk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__sZk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__5I()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__5I.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__ECd(System.Boolean  @isAutoTeam)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@isAutoTeam};
            var ___result = R__0__ECd_Boolean.Invoke(___genericsType, ___parameters);
        ...
        public static void __0__Klr(System.Object  @x)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@x};
            var ___result = R__0__Klr_Object.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Z8
	/// </summary>
    public partial class R__0__Z8 : RMember //
    {

		/// <summary>
		/// #Pfb.#Vob #a
		/// </summary>
		protected R__0__Pfb.R__0__Vob r___0__a;
		public virtual R__0__Pfb.R__0__Vob R__0__a
		{
			get
			{
				if(r___0__a == null)
        ...
        public R__0__Z8() : base("#u.#Z8")
        {
        }

        public R__0__Z8(System.Object instance) : base("#u.#Z8")
		{
            SetInstance(instance);
		}

        public R__0__Z8(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Z8(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

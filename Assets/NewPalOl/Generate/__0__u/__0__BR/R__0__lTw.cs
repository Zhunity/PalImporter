...
{public partial class R__0__BR
{
	
	/// <summary>
	/// #u.#BR+#lTw
	/// </summary>
    public partial class R__0__lTw : RMember //
    {
		...
		/// #u.#BR #e
		/// </summary>
		protected R__0__u.R__0__BR r___0__e;
		public virtual R__0__u.R__0__BR R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__lTw() : base("#u.#BR+#lTw")
        {
        }

        public R__0__lTw(System.Object instance) : base("#u.#BR+#lTw")
		{
            SetInstance(instance);
		}

        public R__0__lTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__lTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__wAm
{
	...
	/// #u.#wAm+#kRw
	/// </summary>
    public partial class R__0__kRw : RMember //
    {
        ...
        public R__0__kRw() : base("#u.#wAm+#kRw")
        {
        }

        public R__0__kRw(System.Object instance) : base("#u.#wAm+#kRw")
		{
            SetInstance(instance);
		}

        public R__0__kRw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__kRw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

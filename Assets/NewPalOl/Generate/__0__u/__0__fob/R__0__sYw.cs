...
{public partial class R__0__fob
{
	
	/// <summary>
	/// #u.#fob+#sYw
	/// </summary>
    public partial class R__0__sYw : RMember //
    {
        ...
        public R__0__sYw() : base("#u.#fob+#sYw")
        {
        }

        public R__0__sYw(System.Object instance) : base("#u.#fob+#sYw")
		{
            SetInstance(instance);
		}

        public R__0__sYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__sYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

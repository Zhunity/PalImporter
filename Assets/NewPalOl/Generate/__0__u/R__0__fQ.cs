...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#fQ
	/// </summary>
    public partial class R__0__fQ : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#fQ"), "#a");
		...
		/// <summary>
		/// Void #dQ(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__dQ_Object___0__7X;
		public virtual RMethod R__0__dQ_Object___0__7X
		{
			get
			{
				if(r_R__0__dQ_Object___0__7X == null)
				{
					r_R__0__dQ_Object___0__7X = new(this, "#dQ", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__dQ_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__dQ_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #xd(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__xd_Object___0__7X;
		public virtual RMethod R__0__xd_Object___0__7X
		{
			get
			{
				if(r_R__0__xd_Object___0__7X == null)
				{
					r_R__0__xd_Object___0__7X = new(this, "#xd", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__xd_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__xd_Object___0__7X;
			}
		}
		...
		/// Void #nWe()
		/// </summary>
		protected RMethod r_R__0__nWe;
		public virtual RMethod R__0__nWe
		{
			get
			{
				if(r_R__0__nWe == null)
				{
					r_R__0__nWe = new(this, "#nWe", 0);
					r_R__0__nWe.SetBelong(this.instance);
				}
				return r_R__0__nWe;
			}
		}
		...
		/// Void #bQ()
		/// </summary>
		protected RMethod r_R__0__bQ;
		public virtual RMethod R__0__bQ
		{
			get
			{
				if(r_R__0__bQ == null)
				{
					r_R__0__bQ = new(this, "#bQ", 0);
					r_R__0__bQ.SetBelong(this.instance);
				}
				return r_R__0__bQ;
			}
		}
		...
		/// <summary>
		/// Void #cQ(System.String, Boolean)
		/// </summary>
		protected RMethod r_R__0__cQ_String_Boolean;
		public virtual RMethod R__0__cQ_String_Boolean
		{
			get
			{
				if(r_R__0__cQ_String_Boolean == null)
				{
					r_R__0__cQ_String_Boolean = new(this, "#cQ", 0, typeof(System.String), typeof(System.Boolean));
					r_R__0__cQ_String_Boolean.SetBelong(this.instance);
				}
				return r_R__0__cQ_String_Boolean;
			}
		}
		...
		/// Void #9P(#Pfb.#5xb)
		/// </summary>
		protected RMethod r_R__0__9P___0__5xb;
		public virtual RMethod R__0__9P___0__5xb
		{
			get
			{
				if(r_R__0__9P___0__5xb == null)
				{
					r_R__0__9P___0__5xb = new(this, "#9P", 0,  ReleactionUtils.GetType("#Pfb.#5xb"));
					r_R__0__9P___0__5xb.SetBelong(this.instance);
				}
				return r_R__0__9P___0__5xb;
			}
		}
		...
		/// Void #aQ(#Pfb.#cyb)
		/// </summary>
		protected RMethod r_R__0__aQ___0__cyb;
		public virtual RMethod R__0__aQ___0__cyb
		{
			get
			{
				if(r_R__0__aQ___0__cyb == null)
				{
					r_R__0__aQ___0__cyb = new(this, "#aQ", 0,  ReleactionUtils.GetType("#Pfb.#cyb"));
					r_R__0__aQ___0__cyb.SetBelong(this.instance);
				}
				return r_R__0__aQ___0__cyb;
			}
		}

		/// <summary>
		/// Boolean #Xyj(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__Xyj_ID;
		public virtual RMethod R__0__Xyj_ID
		{
			get
			{
				if(r_R__0__Xyj_ID == null)
				{
					r_R__0__Xyj_ID = new(this, "#Xyj", 0, typeof(GameDefineType.ID));
					r_R__0__Xyj_ID.SetBelong(this.instance);
				}
				return r_R__0__Xyj_ID;
			}
		}
		...
		/// <summary>
		/// Void #fEj(System.String)
		/// </summary>
		protected RMethod r_R__0__fEj_String;
		public virtual RMethod R__0__fEj_String
		{
			get
			{
				if(r_R__0__fEj_String == null)
				{
					r_R__0__fEj_String = new(this, "#fEj", 0, typeof(System.String));
					r_R__0__fEj_String.SetBelong(this.instance);
				}
				return r_R__0__fEj_String;
			}
		}
        ...
        public R__0__fQ() : base("#u.#fQ")
        {
        }

        public R__0__fQ(System.Object instance) : base("#u.#fQ")
		{
            SetInstance(instance);
		}

        public R__0__fQ(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fQ(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__nWe()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__nWe.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__bQ()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__bQ.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__cQ(System.String  @attachlist, System.Boolean  @isgrey)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@attachlist, @isgrey};
            var ___result = R__0__cQ_String_Boolean.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Boolean __0__Xyj(GameDefineType.ID  @mailID)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@mailID};
            var ___result = R__0__Xyj_ID.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__fEj(System.String  @count)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@count};
            var ___result = R__0__fEj_String.Invoke(___genericsType, ___parameters);

...
{public partial class R__0__3R
{
	...
	/// #u.#3R+#mTw
	/// </summary>
    public partial class R__0__mTw : RMember //
    {
		...
		/// #u.#3R #g
		/// </summary>
		protected R__0__u.R__0__3R r___0__g;
		public virtual R__0__u.R__0__3R R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__mTw() : base("#u.#3R+#mTw")
        {
        }

        public R__0__mTw(System.Object instance) : base("#u.#3R+#mTw")
		{
            SetInstance(instance);
		}

        public R__0__mTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__mTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

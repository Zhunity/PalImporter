...
{public partial class R__0__3R
{
	...
	/// #u.#3R+#nTw
	/// </summary>
    public partial class R__0__nTw : RMember //
    {
		...
		/// #Pfb.#Oth #b
		/// </summary>
		protected R__0__Pfb.R__0__Oth r___0__b;
		public virtual R__0__Pfb.R__0__Oth R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// #u.#3R #f
		/// </summary>
		protected R__0__u.R__0__3R r___0__f;
		public virtual R__0__u.R__0__3R R__0__f
		{
			get
			{
				if(r___0__f == null)
        ...
        public R__0__nTw() : base("#u.#3R+#nTw")
        {
        }

        public R__0__nTw(System.Object instance) : base("#u.#3R+#nTw")
		{
            SetInstance(instance);
		}

        public R__0__nTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__nTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

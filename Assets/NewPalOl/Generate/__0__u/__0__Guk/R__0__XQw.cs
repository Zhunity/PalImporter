...
{public partial class R__0__Guk
{
	...
	/// #u.#Guk+#XQw
	/// </summary>
    public partial class R__0__XQw : RMember //
    {
		...
		/// #u.#Guk #e
		/// </summary>
		protected R__0__u.R__0__Guk r___0__e;
		public virtual R__0__u.R__0__Guk R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__XQw() : base("#u.#Guk+#XQw")
        {
        }

        public R__0__XQw(System.Object instance) : base("#u.#Guk+#XQw")
		{
            SetInstance(instance);
		}

        public R__0__XQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#C7j
	/// </summary>
    public partial class R__0__C7j : RMember //
    {
		...
		/// Void #A7j(Int32)
		/// </summary>
		protected RMethod r_R__0__A7j_Int32;
		public virtual RMethod R__0__A7j_Int32
		{
			get
			{
				if(r_R__0__A7j_Int32 == null)
				{
					r_R__0__A7j_Int32 = new(this, "#A7j", 0, typeof(System.Int32));
					r_R__0__A7j_Int32.SetBelong(this.instance);
				}
				return r_R__0__A7j_Int32;
			}
		}

		/// <summary>
		/// Void #B7j(System.String)
		/// </summary>
		protected RMethod r_R__0__B7j_String;
		public virtual RMethod R__0__B7j_String
		{
			get
			{
				if(r_R__0__B7j_String == null)
				{
					r_R__0__B7j_String = new(this, "#B7j", 0, typeof(System.String));
					r_R__0__B7j_String.SetBelong(this.instance);
				}
				return r_R__0__B7j_String;
			}
		}
        ...
        public R__0__C7j() : base("#u.#C7j")
        {
        }

        public R__0__C7j(System.Object instance) : base("#u.#C7j")
		{
            SetInstance(instance);
		}

        public R__0__C7j(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__C7j(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__A7j(System.Int32  @times)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@times};
            var ___result = R__0__A7j_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__B7j(System.String  @info)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@info};
            var ___result = R__0__B7j_String.Invoke(___genericsType, ___parameters);

...
{public partial class R__0__Ibg
{
	
	/// <summary>
	/// #u.#Ibg+#QNb
	/// </summary>
    public partial class R__0__QNb : RMember //
    {
        ...
        public R__0__QNb() : base("#u.#Ibg+#QNb")
        {
        }

        public R__0__QNb(System.Object instance) : base("#u.#Ibg+#QNb")
		{
            SetInstance(instance);
		}

        public R__0__QNb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__QNb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__wI
{
	...
	/// #u.#wI+#tSw
	/// </summary>
    public partial class R__0__tSw : RMember //
    {
		...
		/// #u.#wI #h
		/// </summary>
		protected R__0__u.R__0__wI r___0__h;
		public virtual R__0__u.R__0__wI R__0__h
		{
			get
			{
				if(r___0__h == null)
        ...
        public R__0__tSw() : base("#u.#wI+#tSw")
        {
        }

        public R__0__tSw(System.Object instance) : base("#u.#wI+#tSw")
		{
            SetInstance(instance);
		}

        public R__0__tSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__tSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

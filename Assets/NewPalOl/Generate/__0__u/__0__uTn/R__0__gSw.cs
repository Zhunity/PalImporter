...
{public partial class R__0__uTn
{
	
	/// <summary>
	/// #u.#uTn+#gSw
	/// </summary>
    public partial class R__0__gSw : RMember //
    {
		...
		/// #u.#uTn #m
		/// </summary>
		protected R__0__u.R__0__uTn r___0__m;
		public virtual R__0__u.R__0__uTn R__0__m
		{
			get
			{
				if(r___0__m == null)
        ...
        public R__0__gSw() : base("#u.#uTn+#gSw")
        {
        }

        public R__0__gSw(System.Object instance) : base("#u.#uTn+#gSw")
		{
            SetInstance(instance);
		}

        public R__0__gSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__2Hb
{
	
	/// <summary>
	/// #u.#2Hb+#yYw
	/// </summary>
    public partial class R__0__yYw : RMember //
    {
		...
		/// #u.#2Hb #d
		/// </summary>
		protected R__0__u.R__0__2Hb r___0__d;
		public virtual R__0__u.R__0__2Hb R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__yYw() : base("#u.#2Hb+#yYw")
        {
        }

        public R__0__yYw(System.Object instance) : base("#u.#2Hb+#yYw")
		{
            SetInstance(instance);
		}

        public R__0__yYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__yYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#NS
	/// </summary>
    public partial class R__0__NS : RMember //
    {

		/// <summary>
		/// #u.#Ckb #a
		/// </summary>
		protected R__0__u.R__0__Ckb r___0__a;
		public virtual R__0__u.R__0__Ckb R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		public static RField R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#NS"), "#b");
		...
		/// Void #IS(#u.#Ckb)
		/// </summary>
		protected RMethod r_R__0__IS___0__Ckb;
		public virtual RMethod R__0__IS___0__Ckb
		{
			get
			{
				if(r_R__0__IS___0__Ckb == null)
				{
					r_R__0__IS___0__Ckb = new(this, "#IS", 0,  ReleactionUtils.GetType("#u.#Ckb"));
					r_R__0__IS___0__Ckb.SetBelong(this.instance);
				}
				return r_R__0__IS___0__Ckb;
			}
		}
		...
		/// Void #LS()
		/// </summary>
		protected RMethod r_R__0__LS;
		public virtual RMethod R__0__LS
		{
			get
			{
				if(r_R__0__LS == null)
				{
					r_R__0__LS = new(this, "#LS", 0);
					r_R__0__LS.SetBelong(this.instance);
				}
				return r_R__0__LS;
			}
		}
        ...
        public R__0__NS() : base("#u.#NS")
        {
        }

        public R__0__NS(System.Object instance) : base("#u.#NS")
		{
            SetInstance(instance);
		}

        public R__0__NS(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__NS(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Boolean __0__KS()
        {
        ...
        public virtual void __0__LS()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__LS.Invoke(___genericsType, ___parameters);

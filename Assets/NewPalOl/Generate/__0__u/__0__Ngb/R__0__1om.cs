...
{public partial class R__0__Ngb
{
	
	/// <summary>
	/// #u.#Ngb+#1om
	/// </summary>
    public partial class R__0__1om : RMember //
    {
        ...
        public R__0__1om() : base("#u.#Ngb+#1om")
        {
        }

        public R__0__1om(System.Object instance) : base("#u.#Ngb+#1om")
		{
            SetInstance(instance);
		}

        public R__0__1om(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1om(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

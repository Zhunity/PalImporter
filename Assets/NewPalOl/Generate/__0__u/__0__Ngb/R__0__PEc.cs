...
{public partial class R__0__Ngb
{
	...
	/// #u.#Ngb+#PEc
	/// </summary>
    public partial class R__0__PEc : RMember //
    {
        ...
        public R__0__PEc() : base("#u.#Ngb+#PEc")
        {
        }

        public R__0__PEc(System.Object instance) : base("#u.#Ngb+#PEc")
		{
            SetInstance(instance);
		}

        public R__0__PEc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__PEc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

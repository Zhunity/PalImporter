...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#zD
	/// </summary>
    public partial class R__0__zD : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#zD"), "#a");
		...
		public static RField R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#zD"), "#b");
		...
		/// <summary>
		/// System.Collections.Generic.Queue`1[#u.#zD+#BD1] #o
		/// </summary>
		protected RSystem.RCollections.RGeneric.RQueue<R__0__u.R__0__zD.R__0__BD1> r___0__o;
		public virtual RSystem.RCollections.RGeneric.RQueue<R__0__u.R__0__zD.R__0__BD1> R__0__o
		{
			get
			{
				if(r___0__o == null)
		...
		/// <summary>
		/// Void #b2d(Int32, Int32, Int32, Int32)
		/// </summary>
		protected RMethod r_R__0__b2d_Int32_Int32_Int32_Int32;
		public virtual RMethod R__0__b2d_Int32_Int32_Int32_Int32
		{
			get
			{
				if(r_R__0__b2d_Int32_Int32_Int32_Int32 == null)
				{
					r_R__0__b2d_Int32_Int32_Int32_Int32 = new(this, "#b2d", 0, typeof(System.Int32), typeof(System.Int32), typeof(System.Int32), typeof(System.Int32));
					r_R__0__b2d_Int32_Int32_Int32_Int32.SetBelong(this.instance);
				}
				return r_R__0__b2d_Int32_Int32_Int32_Int32;
			}
		}
		...
		/// Void #d2d(#BD1)
		/// </summary>
		protected RMethod r_R__0__d2d___0__BD1;
		public virtual RMethod R__0__d2d___0__BD1
		{
			get
			{
				if(r_R__0__d2d___0__BD1 == null)
				{
					r_R__0__d2d___0__BD1 = new(this, "#d2d", 0,  ReleactionUtils.GetType("#u.#zD+#BD1"));
					r_R__0__d2d___0__BD1.SetBelong(this.instance);
				}
				return r_R__0__d2d___0__BD1;
			}
		}
		...
		/// <summary>
		/// Void #pmi(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__pmi_Object___0__7X;
		public virtual RMethod R__0__pmi_Object___0__7X
		{
			get
			{
				if(r_R__0__pmi_Object___0__7X == null)
				{
					r_R__0__pmi_Object___0__7X = new(this, "#pmi", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__pmi_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__pmi_Object___0__7X;
			}
		}
        ...
        public R__0__zD() : base("#u.#zD")
        {
        }

        public R__0__zD(System.Object instance) : base("#u.#zD")
		{
            SetInstance(instance);
		}

        public R__0__zD(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zD(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__b2d(System.Int32  @questionid, System.Int32  @rightnum, System.Int32  @wrongnum, System.Int32  @leftnum)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@questionid, @rightnum, @wrongnum, @leftnum};
            var ___result = R__0__b2d_Int32_Int32_Int32_Int32.Invoke(___genericsType, ___parameters);

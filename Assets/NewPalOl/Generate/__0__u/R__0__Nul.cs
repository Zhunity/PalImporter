...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Nul
	/// </summary>
    public partial class R__0__Nul : RMember //
    {
		...
		/// <summary>
		/// Void #Mul(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__Mul_ID;
		public virtual RMethod R__0__Mul_ID
		{
			get
			{
				if(r_R__0__Mul_ID == null)
				{
					r_R__0__Mul_ID = new(this, "#Mul", 0, typeof(GameDefineType.ID));
					r_R__0__Mul_ID.SetBelong(this.instance);
				}
				return r_R__0__Mul_ID;
			}
		}
        ...
        public R__0__Nul() : base("#u.#Nul")
        {
        }

        public R__0__Nul(System.Object instance) : base("#u.#Nul")
		{
            SetInstance(instance);
		}

        public R__0__Nul(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Nul(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Mul(GameDefineType.ID  @id)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id};
            var ___result = R__0__Mul_ID.Invoke(___genericsType, ___parameters);

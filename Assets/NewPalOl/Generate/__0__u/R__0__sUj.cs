...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#sUj
	/// </summary>
    public partial class R__0__sUj : RMember //
    {
		...
		/// <summary>
		/// Void #MJg(System.Object)
		/// </summary>
		protected RMethod r_R__0__MJg_Object;
		public virtual RMethod R__0__MJg_Object
		{
			get
			{
				if(r_R__0__MJg_Object == null)
				{
					r_R__0__MJg_Object = new(this, "#MJg", 0, typeof(System.Object));
					r_R__0__MJg_Object.SetBelong(this.instance);
				}
				return r_R__0__MJg_Object;
			}
		}
		...
		/// <summary>
		/// Void #NJg(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__NJg_Object___0__7X;
		public virtual RMethod R__0__NJg_Object___0__7X
		{
			get
			{
				if(r_R__0__NJg_Object___0__7X == null)
				{
					r_R__0__NJg_Object___0__7X = new(this, "#NJg", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__NJg_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__NJg_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #KKk(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__KKk_Object___0__7X;
		public virtual RMethod R__0__KKk_Object___0__7X
		{
			get
			{
				if(r_R__0__KKk_Object___0__7X == null)
				{
					r_R__0__KKk_Object___0__7X = new(this, "#KKk", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__KKk_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__KKk_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #LKk(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__LKk_Object___0__7X;
		public virtual RMethod R__0__LKk_Object___0__7X
		{
			get
			{
				if(r_R__0__LKk_Object___0__7X == null)
				{
					r_R__0__LKk_Object___0__7X = new(this, "#LKk", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__LKk_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__LKk_Object___0__7X;
			}
		}
		...
		/// Void #OJg()
		/// </summary>
		protected RMethod r_R__0__OJg;
		public virtual RMethod R__0__OJg
		{
			get
			{
				if(r_R__0__OJg == null)
				{
					r_R__0__OJg = new(this, "#OJg", 0);
					r_R__0__OJg.SetBelong(this.instance);
				}
				return r_R__0__OJg;
			}
		}
		...
		/// <summary>
		/// Void #Kbg(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__Kbg_ID;
		public virtual RMethod R__0__Kbg_ID
		{
			get
			{
				if(r_R__0__Kbg_ID == null)
				{
					r_R__0__Kbg_ID = new(this, "#Kbg", 0, typeof(GameDefineType.ID));
					r_R__0__Kbg_ID.SetBelong(this.instance);
				}
				return r_R__0__Kbg_ID;
			}
		}
		...
		/// Void #ZZd()
		/// </summary>
		protected RMethod r_R__0__ZZd;
		public virtual RMethod R__0__ZZd
		{
			get
			{
				if(r_R__0__ZZd == null)
				{
					r_R__0__ZZd = new(this, "#ZZd", 0);
					r_R__0__ZZd.SetBelong(this.instance);
				}
				return r_R__0__ZZd;
			}
		}
        ...
        public R__0__sUj() : base("#u.#sUj")
        {
        }

        public R__0__sUj(System.Object instance) : base("#u.#sUj")
		{
            SetInstance(instance);
		}

        public R__0__sUj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__sUj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__MJg(System.Object  @sender)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender};
            var ___result = R__0__MJg_Object.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__OJg()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__OJg.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Kbg(GameDefineType.ID  @id)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id};
            var ___result = R__0__Kbg_ID.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__ZZd()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__ZZd.Invoke(___genericsType, ___parameters);

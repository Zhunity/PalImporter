...
{public partial class R__0__8Zk
{
	...
	/// #u.#8Zk+#7Sw
	/// </summary>
    public partial class R__0__7Sw : RMember //
    {
		...
		/// #u.#8Zk #i
		/// </summary>
		protected R__0__u.R__0__8Zk r___0__i;
		public virtual R__0__u.R__0__8Zk R__0__i
		{
			get
			{
				if(r___0__i == null)
        ...
        public R__0__7Sw() : base("#u.#8Zk+#7Sw")
        {
        }

        public R__0__7Sw(System.Object instance) : base("#u.#8Zk+#7Sw")
		{
            SetInstance(instance);
		}

        public R__0__7Sw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7Sw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

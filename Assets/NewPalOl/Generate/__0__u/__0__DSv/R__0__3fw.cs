...
{public partial class R__0__DSv
{
	
	/// <summary>
	/// #u.#DSv+#3fw
	/// </summary>
    public partial class R__0__3fw : RMember //
    {
		...
		/// #u.#DSv #e
		/// </summary>
		protected R__0__u.R__0__DSv r___0__e;
		public virtual R__0__u.R__0__DSv R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__3fw() : base("#u.#DSv+#3fw")
        {
        }

        public R__0__3fw(System.Object instance) : base("#u.#DSv+#3fw")
		{
            SetInstance(instance);
		}

        public R__0__3fw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3fw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

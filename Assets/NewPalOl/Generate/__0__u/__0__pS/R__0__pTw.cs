...
{public partial class R__0__pS
{
	
	/// <summary>
	/// #u.#pS+#pTw
	/// </summary>
    public partial class R__0__pTw : RMember //
    {
		...
		/// #u.#pS #c
		/// </summary>
		protected R__0__u.R__0__pS r___0__c;
		public virtual R__0__u.R__0__pS R__0__c
		{
			get
			{
				if(r___0__c == null)
        ...
        public R__0__pTw() : base("#u.#pS+#pTw")
        {
        }

        public R__0__pTw(System.Object instance) : base("#u.#pS+#pTw")
		{
            SetInstance(instance);
		}

        public R__0__pTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__pTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#XJf
	/// </summary>
    public partial class R__0__XJf : RMember //
    {
		...
		/// <summary>
		/// MyGUI.ElementBase+#ZNb #i
		/// </summary>
		protected static RMyGUI.RElementBase.R__0__ZNb r___0__i;
		public static RMyGUI.RElementBase.R__0__ZNb R__0__i
		{
			get
			{
				if(r___0__i == null)
				{
					r___0__i = new( ReleactionUtils.GetType("#u.#XJf"), "#i");
		...
		/// <summary>
		/// Void #RJg(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__RJg_ID;
		public virtual RMethod R__0__RJg_ID
		{
			get
			{
				if(r_R__0__RJg_ID == null)
				{
					r_R__0__RJg_ID = new(this, "#RJg", 0, typeof(GameDefineType.ID));
					r_R__0__RJg_ID.SetBelong(this.instance);
				}
				return r_R__0__RJg_ID;
			}
		}

		/// <summary>
		/// Void #SJg(GameDefineType.ID, GameDefineType.ID, GameDefineType.ID, Int32, Boolean)
		/// </summary>
		protected RMethod r_R__0__SJg_ID_ID_ID_Int32_Boolean;
		public virtual RMethod R__0__SJg_ID_ID_ID_Int32_Boolean
		{
			get
			{
				if(r_R__0__SJg_ID_ID_ID_Int32_Boolean == null)
				{
					r_R__0__SJg_ID_ID_ID_Int32_Boolean = new(this, "#SJg", 0, typeof(GameDefineType.ID), typeof(GameDefineType.ID), typeof(GameDefineType.ID), typeof(System.Int32), typeof(System.Boolean));
					r_R__0__SJg_ID_ID_ID_Int32_Boolean.SetBelong(this.instance);
				}
				return r_R__0__SJg_ID_ID_ID_Int32_Boolean;
			}
		}

		/// <summary>
		/// Void #UJf(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__UJf_ID;
		public virtual RMethod R__0__UJf_ID
		{
			get
			{
				if(r_R__0__UJf_ID == null)
				{
					r_R__0__UJf_ID = new(this, "#UJf", 0, typeof(GameDefineType.ID));
					r_R__0__UJf_ID.SetBelong(this.instance);
				}
				return r_R__0__UJf_ID;
			}
		}

		/// <summary>
		/// Void #Xd(GameDefineType.ID, GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__Xd_ID_ID;
		public virtual RMethod R__0__Xd_ID_ID
		{
			get
			{
				if(r_R__0__Xd_ID_ID == null)
				{
					r_R__0__Xd_ID_ID = new(this, "#Xd", 0, typeof(GameDefineType.ID), typeof(GameDefineType.ID));
					r_R__0__Xd_ID_ID.SetBelong(this.instance);
				}
				return r_R__0__Xd_ID_ID;
			}
		}

		/// <summary>
		/// Void #TJg(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__TJg_ID;
		public virtual RMethod R__0__TJg_ID
		{
			get
			{
				if(r_R__0__TJg_ID == null)
				{
					r_R__0__TJg_ID = new(this, "#TJg", 0, typeof(GameDefineType.ID));
					r_R__0__TJg_ID.SetBelong(this.instance);
				}
				return r_R__0__TJg_ID;
			}
		}

		/// <summary>
		/// Void #JBd(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__JBd_ID;
		public virtual RMethod R__0__JBd_ID
		{
			get
			{
				if(r_R__0__JBd_ID == null)
				{
					r_R__0__JBd_ID = new(this, "#JBd", 0, typeof(GameDefineType.ID));
					r_R__0__JBd_ID.SetBelong(this.instance);
				}
				return r_R__0__JBd_ID;
			}
		}
		...
		/// <summary>
		/// Void #nZg(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__nZg_Object___0__7X;
		public virtual RMethod R__0__nZg_Object___0__7X
		{
			get
			{
				if(r_R__0__nZg_Object___0__7X == null)
				{
					r_R__0__nZg_Object___0__7X = new(this, "#nZg", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__nZg_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__nZg_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #oZg(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__oZg_Object___0__7X;
		public virtual RMethod R__0__oZg_Object___0__7X
		{
			get
			{
				if(r_R__0__oZg_Object___0__7X == null)
				{
					r_R__0__oZg_Object___0__7X = new(this, "#oZg", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__oZg_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__oZg_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #VJf(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__VJf_Object___0__7X;
		public virtual RMethod R__0__VJf_Object___0__7X
		{
			get
			{
				if(r_R__0__VJf_Object___0__7X == null)
				{
					r_R__0__VJf_Object___0__7X = new(this, "#VJf", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__VJf_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__VJf_Object___0__7X;
			}
		}
		...
		/// Void #WJf()
		/// </summary>
		protected RMethod r_R__0__WJf;
		public virtual RMethod R__0__WJf
		{
			get
			{
				if(r_R__0__WJf == null)
				{
					r_R__0__WJf = new(this, "#WJf", 0);
					r_R__0__WJf.SetBelong(this.instance);
				}
				return r_R__0__WJf;
			}
		}
		...
		/// Void #Mbg()
		/// </summary>
		protected RMethod r_R__0__Mbg;
		public virtual RMethod R__0__Mbg
		{
			get
			{
				if(r_R__0__Mbg == null)
				{
					r_R__0__Mbg = new(this, "#Mbg", 0);
					r_R__0__Mbg.SetBelong(this.instance);
				}
				return r_R__0__Mbg;
			}
		}
		...
		/// <summary>
		/// Void #pIf(System.Object, #oU.#7X)
		/// </summary>
		protected static RMethod r_R__0__pIf_Object___0__7X;
		public static RMethod R__0__pIf_Object___0__7X
		{
			get
			{
				if(r_R__0__pIf_Object___0__7X == null)
				{
					r_R__0__pIf_Object___0__7X = new( ReleactionUtils.GetType("#u.#XJf"), "#pIf", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__pIf_Object___0__7X.SetBelong(null);
				}
				return r_R__0__pIf_Object___0__7X;
			}
		}
        ...
        public R__0__XJf() : base("#u.#XJf")
        {
        }

        public R__0__XJf(System.Object instance) : base("#u.#XJf")
		{
            SetInstance(instance);
		}

        public R__0__XJf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XJf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__RJg(GameDefineType.ID  @configId)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@configId};
            var ___result = R__0__RJg_ID.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__SJg(GameDefineType.ID  @configId, GameDefineType.ID  @serverId, GameDefineType.ID  @itemId, System.Int32  @times, System.Boolean  @isRefresh)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@configId, @serverId, @itemId, @times, @isRefresh};
            var ___result = R__0__SJg_ID_ID_ID_Int32_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__UJf(GameDefineType.ID  @configId)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@configId};
            var ___result = R__0__UJf_ID.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Xd(GameDefineType.ID  @configId, GameDefineType.ID  @petItemId)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@configId, @petItemId};
            var ___result = R__0__Xd_ID_ID.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__TJg(GameDefineType.ID  @careerId)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@careerId};
            var ___result = R__0__TJg_ID.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__JBd(GameDefineType.ID  @careerId)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@careerId};
            var ___result = R__0__JBd_ID.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__WJf()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__WJf.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Mbg()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Mbg.Invoke(___genericsType, ___parameters);

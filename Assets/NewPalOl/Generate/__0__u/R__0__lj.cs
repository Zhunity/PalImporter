...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#lj
	/// </summary>
    public partial class R__0__lj : RMember //
    {
        ...
        public R__0__lj() : base("#u.#lj")
        {
        }

        public R__0__lj(System.Object instance) : base("#u.#lj")
		{
            SetInstance(instance);
		}

        public R__0__lj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__lj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

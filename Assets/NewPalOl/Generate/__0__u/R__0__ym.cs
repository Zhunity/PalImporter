...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#ym
	/// </summary>
    public partial class R__0__ym : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[GameDefineType.ID,#oU.#5bb] #h
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RGameDefineType.RID, R__0__oU.R__0__5bb> r___0__h;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RGameDefineType.RID, R__0__oU.R__0__5bb> R__0__h
		{
			get
			{
				if(r___0__h == null)
		...
		/// Void #pm()
		/// </summary>
		protected RMethod r_R__0__pm;
		public virtual RMethod R__0__pm
		{
			get
			{
				if(r_R__0__pm == null)
				{
					r_R__0__pm = new(this, "#pm", 0);
					r_R__0__pm.SetBelong(this.instance);
				}
				return r_R__0__pm;
			}
		}
		...
		/// <summary>
		/// Void #qm(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__qm_Object___0__7X;
		public virtual RMethod R__0__qm_Object___0__7X
		{
			get
			{
				if(r_R__0__qm_Object___0__7X == null)
				{
					r_R__0__qm_Object___0__7X = new(this, "#qm", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__qm_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__qm_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #rm(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__rm_Object___0__7X;
		public virtual RMethod R__0__rm_Object___0__7X
		{
			get
			{
				if(r_R__0__rm_Object___0__7X == null)
				{
					r_R__0__rm_Object___0__7X = new(this, "#rm", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__rm_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__rm_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #sm(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__sm_Object___0__7X;
		public virtual RMethod R__0__sm_Object___0__7X
		{
			get
			{
				if(r_R__0__sm_Object___0__7X == null)
				{
					r_R__0__sm_Object___0__7X = new(this, "#sm", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__sm_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__sm_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #tm(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__tm_Object___0__7X;
		public virtual RMethod R__0__tm_Object___0__7X
		{
			get
			{
				if(r_R__0__tm_Object___0__7X == null)
				{
					r_R__0__tm_Object___0__7X = new(this, "#tm", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__tm_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__tm_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #um(System.Object)
		/// </summary>
		protected RMethod r_R__0__um_Object;
		public virtual RMethod R__0__um_Object
		{
			get
			{
				if(r_R__0__um_Object == null)
				{
					r_R__0__um_Object = new(this, "#um", 0, typeof(System.Object));
					r_R__0__um_Object.SetBelong(this.instance);
				}
				return r_R__0__um_Object;
			}
		}

		/// <summary>
		/// Void #vm(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__vm_Object___0__7X;
		public virtual RMethod R__0__vm_Object___0__7X
		{
			get
			{
				if(r_R__0__vm_Object___0__7X == null)
				{
					r_R__0__vm_Object___0__7X = new(this, "#vm", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__vm_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__vm_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void ChangeStyle(GameDefineType.ID)
		/// </summary>
		protected RMethod r_RChangeStyle_ID;
		public virtual RMethod RChangeStyle_ID
		{
			get
			{
				if(r_RChangeStyle_ID == null)
				{
					r_RChangeStyle_ID = new(this, "ChangeStyle", 0, typeof(GameDefineType.ID));
					r_RChangeStyle_ID.SetBelong(this.instance);
				}
				return r_RChangeStyle_ID;
			}
		}

		/// <summary>
		/// Void #wm(GameDefineType.ID, Int32, QueueStateType)
		/// </summary>
		protected RMethod r_R__0__wm_ID_Int32_QueueStateType;
		public virtual RMethod R__0__wm_ID_Int32_QueueStateType
		{
			get
			{
				if(r_R__0__wm_ID_Int32_QueueStateType == null)
				{
					r_R__0__wm_ID_Int32_QueueStateType = new(this, "#wm", 0, typeof(GameDefineType.ID), typeof(System.Int32), typeof(QueueStateType));
					r_R__0__wm_ID_Int32_QueueStateType.SetBelong(this.instance);
				}
				return r_R__0__wm_ID_Int32_QueueStateType;
			}
		}

		/// <summary>
		/// #oU.#5bb #xm(GameDefineType.ID, #oU.#5bb)
		/// </summary>
		protected RMethod r_R__0__xm_ID___0__5bb;
		public virtual RMethod R__0__xm_ID___0__5bb
		{
			get
			{
				if(r_R__0__xm_ID___0__5bb == null)
				{
					r_R__0__xm_ID___0__5bb = new(this, "#xm", 0, typeof(GameDefineType.ID),  ReleactionUtils.GetType("#oU.#5bb"));
					r_R__0__xm_ID___0__5bb.SetBelong(this.instance);
				}
				return r_R__0__xm_ID___0__5bb;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Vector2 #8wc(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__8wc_ID;
		public virtual RMethod R__0__8wc_ID
		{
			get
			{
				if(r_R__0__8wc_ID == null)
				{
					r_R__0__8wc_ID = new(this, "#8wc", 0, typeof(GameDefineType.ID));
					r_R__0__8wc_ID.SetBelong(this.instance);
				}
				return r_R__0__8wc_ID;
			}
		}
        ...
        public R__0__ym() : base("#u.#ym")
        {
        }

        public R__0__ym(System.Object instance) : base("#u.#ym")
		{
            SetInstance(instance);
		}

        public R__0__ym(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ym(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__pm()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__pm.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__um(System.Object  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@data};
            var ___result = R__0__um_Object.Invoke(___genericsType, ___parameters);
        ...
        public virtual void ChangeStyle(GameDefineType.ID  @id)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id};
            var ___result = RChangeStyle_ID.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__wm(GameDefineType.ID  @id, System.Int32  @time, QueueStateType  @state)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id, @time, @state};
            var ___result = R__0__wm_ID_Int32_QueueStateType.Invoke(___genericsType, ___parameters);
        ...
        public virtual UnityEngine.Vector2 __0__8wc(GameDefineType.ID  @id)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id};
            var ___result = R__0__8wc_ID.Invoke(___genericsType, ___parameters);

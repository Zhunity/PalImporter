...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#36
	/// </summary>
    public partial class R__0__36 : RMember //
    {
        ...
        public R__0__36() : base("#u.#36")
        {
        }

        public R__0__36(System.Object instance) : base("#u.#36")
		{
            SetInstance(instance);
		}

        public R__0__36(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__36(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

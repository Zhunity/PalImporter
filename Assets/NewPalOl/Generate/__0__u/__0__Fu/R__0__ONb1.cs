...
{public partial class R__0__Fu
{
	
	/// <summary>
	/// #u.#Fu+#ONb1
	/// </summary>
    public partial class R__0__ONb1 : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(#u.#Bu, System.Object)
		/// </summary>
		protected RMethod r_RInvoke___0__Bu_Object;
		public virtual RMethod RInvoke___0__Bu_Object
		{
			get
			{
				if(r_RInvoke___0__Bu_Object == null)
				{
					r_RInvoke___0__Bu_Object = new(this, "Invoke", 0,  ReleactionUtils.GetType("#u.#Bu"), typeof(System.Object));
					r_RInvoke___0__Bu_Object.SetBelong(this.instance);
				}
				return r_RInvoke___0__Bu_Object;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(#u.#Bu, System.Object, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke___0__Bu_Object_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke___0__Bu_Object_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke___0__Bu_Object_AsyncCallback_Object == null)
				{
					r_RBeginInvoke___0__Bu_Object_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("#u.#Bu"), typeof(System.Object), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke___0__Bu_Object_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke___0__Bu_Object_AsyncCallback_Object;
			}
		}
        ...
        public R__0__ONb1() : base("#u.#Fu+#ONb1")
        {
        }

        public R__0__ONb1(System.Object instance) : base("#u.#Fu+#ONb1")
		{
            SetInstance(instance);
		}

        public R__0__ONb1(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ONb1(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__Fu
{
	...
	/// #u.#Fu+#PNb1
	/// </summary>
    public partial class R__0__PNb1 : RMember //
    {
        ...
        public R__0__PNb1() : base("#u.#Fu+#PNb1")
        {
        }

        public R__0__PNb1(System.Object instance) : base("#u.#Fu+#PNb1")
		{
            SetInstance(instance);
		}

        public R__0__PNb1(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__PNb1(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#cNs
	/// </summary>
    public partial class R__0__cNs : RMember //
    {
		...
		/// Void #bNs()
		/// </summary>
		protected RMethod r_R__0__bNs;
		public virtual RMethod R__0__bNs
		{
			get
			{
				if(r_R__0__bNs == null)
				{
					r_R__0__bNs = new(this, "#bNs", 0);
					r_R__0__bNs.SetBelong(this.instance);
				}
				return r_R__0__bNs;
			}
		}
        ...
        public R__0__cNs() : base("#u.#cNs")
        {
        }

        public R__0__cNs(System.Object instance) : base("#u.#cNs")
		{
            SetInstance(instance);
		}

        public R__0__cNs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cNs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__8D(System.Int32  @seconds)
        {
        ...
        public virtual void __0__bNs()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__bNs.Invoke(___genericsType, ___parameters);

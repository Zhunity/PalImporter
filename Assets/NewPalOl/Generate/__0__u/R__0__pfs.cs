...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#pfs
	/// </summary>
    public partial class R__0__pfs : RMember //
    {
        ...
        public R__0__pfs() : base("#u.#pfs")
        {
        }

        public R__0__pfs(System.Object instance) : base("#u.#pfs")
		{
            SetInstance(instance);
		}

        public R__0__pfs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__pfs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

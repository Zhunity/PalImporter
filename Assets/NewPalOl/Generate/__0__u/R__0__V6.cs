...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#V6
	/// </summary>
    public partial class R__0__V6 : RMember //
    {
        ...
        public R__0__V6() : base("#u.#V6")
        {
        }

        public R__0__V6(System.Object instance) : base("#u.#V6")
		{
            SetInstance(instance);
		}

        public R__0__V6(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__V6(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

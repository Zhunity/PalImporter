...
{public partial class R__0__jig
{
	
	/// <summary>
	/// #u.#jig+#kYw
	/// </summary>
    public partial class R__0__kYw : RMember //
    {
		...
		/// #u.#jig #e
		/// </summary>
		protected R__0__u.R__0__jig r___0__e;
		public virtual R__0__u.R__0__jig R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__kYw() : base("#u.#jig+#kYw")
        {
        }

        public R__0__kYw(System.Object instance) : base("#u.#jig+#kYw")
		{
            SetInstance(instance);
		}

        public R__0__kYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__kYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

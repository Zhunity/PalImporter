...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#3Dd
	/// </summary>
    public partial class R__0__3Dd : RMember //
    {
        ...
        public R__0__3Dd() : base("#u.#3Dd")
        {
        }

        public R__0__3Dd(System.Object instance) : base("#u.#3Dd")
		{
            SetInstance(instance);
		}

        public R__0__3Dd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3Dd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__jAm
{
	
	/// <summary>
	/// #u.#jAm+#HVv
	/// </summary>
    public partial class R__0__HVv : RMember //
    {
		...
		/// #u.#jAm #o
		/// </summary>
		protected R__0__u.R__0__jAm r___0__o;
		public virtual R__0__u.R__0__jAm R__0__o
		{
			get
			{
				if(r___0__o == null)
        ...
        public R__0__HVv() : base("#u.#jAm+#HVv")
        {
        }

        public R__0__HVv(System.Object instance) : base("#u.#jAm+#HVv")
		{
            SetInstance(instance);
		}

        public R__0__HVv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__HVv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

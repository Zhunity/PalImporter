...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#qTr
	/// </summary>
    public partial class R__0__qTr : RMember //
    {
		...
		/// Void #Kb(#Pfb.#yTr)
		/// </summary>
		protected RMethod r_R__0__Kb___0__yTr;
		public virtual RMethod R__0__Kb___0__yTr
		{
			get
			{
				if(r_R__0__Kb___0__yTr == null)
				{
					r_R__0__Kb___0__yTr = new(this, "#Kb", 0,  ReleactionUtils.GetType("#Pfb.#yTr"));
					r_R__0__Kb___0__yTr.SetBelong(this.instance);
				}
				return r_R__0__Kb___0__yTr;
			}
		}
        ...
        public R__0__qTr() : base("#u.#qTr")
        {
        }

        public R__0__qTr(System.Object instance) : base("#u.#qTr")
		{
            SetInstance(instance);
		}

        public R__0__qTr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__qTr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

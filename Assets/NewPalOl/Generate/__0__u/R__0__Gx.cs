...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Gx
	/// </summary>
    public partial class R__0__Gx : RMember //
    {
		...
		/// <summary>
		/// Void #Cx(UnityEngine.Texture2D)
		/// </summary>
		protected RMethod r_R__0__Cx_Texture2D;
		public virtual RMethod R__0__Cx_Texture2D
		{
			get
			{
				if(r_R__0__Cx_Texture2D == null)
				{
					r_R__0__Cx_Texture2D = new(this, "#Cx", 0, typeof(UnityEngine.Texture2D));
					r_R__0__Cx_Texture2D.SetBelong(this.instance);
				}
				return r_R__0__Cx_Texture2D;
			}
		}

		/// <summary>
		/// Void #Dx(UnityEngine.Texture2D)
		/// </summary>
		protected RMethod r_R__0__Dx_Texture2D;
		public virtual RMethod R__0__Dx_Texture2D
		{
			get
			{
				if(r_R__0__Dx_Texture2D == null)
				{
					r_R__0__Dx_Texture2D = new(this, "#Dx", 0, typeof(UnityEngine.Texture2D));
					r_R__0__Dx_Texture2D.SetBelong(this.instance);
				}
				return r_R__0__Dx_Texture2D;
			}
		}
		...
		/// Void #Ex(Boolean)
		/// </summary>
		protected RMethod r_R__0__Ex_Boolean;
		public virtual RMethod R__0__Ex_Boolean
		{
			get
			{
				if(r_R__0__Ex_Boolean == null)
				{
					r_R__0__Ex_Boolean = new(this, "#Ex", 0, typeof(System.Boolean));
					r_R__0__Ex_Boolean.SetBelong(this.instance);
				}
				return r_R__0__Ex_Boolean;
			}
		}
		...
		/// <summary>
		/// UnityEngine.GUIStyle #Fx()
		/// </summary>
		protected RMethod r_R__0__Fx;
		public virtual RMethod R__0__Fx
		{
			get
			{
				if(r_R__0__Fx == null)
				{
					r_R__0__Fx = new(this, "#Fx", 0);
		...
		/// <summary>
		/// Void #xx(UnityEngine.Vector2)
		/// </summary>
		protected RMethod r_R__0__xx_Vector2;
		public virtual RMethod R__0__xx_Vector2
		{
			get
			{
				if(r_R__0__xx_Vector2 == null)
				{
					r_R__0__xx_Vector2 = new(this, "#xx", 0, typeof(UnityEngine.Vector2));
					r_R__0__xx_Vector2.SetBelong(this.instance);
				}
				return r_R__0__xx_Vector2;
			}
		}
		...
		/// <summary>
		/// MyGUI.CustomLabel #zx()
		/// </summary>
		protected RMethod r_R__0__zx;
		public virtual RMethod R__0__zx
		{
			get
			{
				if(r_R__0__zx == null)
				{
					r_R__0__zx = new(this, "#zx", 0);
        ...
        public R__0__Gx() : base("#u.#Gx")
        {
        }

        public R__0__Gx(System.Object instance) : base("#u.#Gx")
		{
            SetInstance(instance);
		}

        public R__0__Gx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Gx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Cx(UnityEngine.Texture2D  @tex)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@tex};
            var ___result = R__0__Cx_Texture2D.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Dx(UnityEngine.Texture2D  @tex)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@tex};
            var ___result = R__0__Dx_Texture2D.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__Ex(System.Boolean  @bShow)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bShow};
            var ___result = R__0__Ex_Boolean.Invoke(___genericsType, ___parameters);
        ...
        public virtual UnityEngine.GUIStyle __0__Fx()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Fx.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__xx(UnityEngine.Vector2  @pos)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pos};
            var ___result = R__0__xx_Vector2.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Object __0__zx()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__zx.Invoke(___genericsType, ___parameters);

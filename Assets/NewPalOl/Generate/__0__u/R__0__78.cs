...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#78
	/// </summary>
    public partial class R__0__78 : RMember //
    {
		...
		/// #Pfb.#Xob #b
		/// </summary>
		protected R__0__Pfb.R__0__Xob r___0__b;
		public virtual R__0__Pfb.R__0__Xob R__0__b
		{
			get
			{
				if(r___0__b == null)
        ...
        public R__0__78() : base("#u.#78")
        {
        }

        public R__0__78(System.Object instance) : base("#u.#78")
		{
            SetInstance(instance);
		}

        public R__0__78(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__78(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

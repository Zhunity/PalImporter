...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#66
	/// </summary>
    public partial class R__0__66 : RMember //
    {
        ...
        public R__0__66() : base("#u.#66")
        {
        }

        public R__0__66(System.Object instance) : base("#u.#66")
		{
            SetInstance(instance);
		}

        public R__0__66(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__66(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#58
	/// </summary>
    public partial class R__0__58 : RMember //
    {
        ...
        public R__0__58() : base("#u.#58")
        {
        }

        public R__0__58(System.Object instance) : base("#u.#58")
		{
            SetInstance(instance);
		}

        public R__0__58(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__58(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

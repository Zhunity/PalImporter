...
{public partial class R__0__z6c
{
	
	/// <summary>
	/// #u.#z6c+#I6c
	/// </summary>
    public partial class R__0__I6c : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(Boolean, System.Object)
		/// </summary>
		protected RMethod r_RInvoke_Boolean_Object;
		public virtual RMethod RInvoke_Boolean_Object
		{
			get
			{
				if(r_RInvoke_Boolean_Object == null)
				{
					r_RInvoke_Boolean_Object = new(this, "Invoke", 0, typeof(System.Boolean), typeof(System.Object));
					r_RInvoke_Boolean_Object.SetBelong(this.instance);
				}
				return r_RInvoke_Boolean_Object;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(Boolean, System.Object, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Boolean_Object_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Boolean_Object_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Boolean_Object_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Boolean_Object_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Boolean), typeof(System.Object), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Boolean_Object_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Boolean_Object_AsyncCallback_Object;
			}
		}
        ...
        public R__0__I6c() : base("#u.#z6c+#I6c")
        {
        }

        public R__0__I6c(System.Object instance) : base("#u.#z6c+#I6c")
		{
            SetInstance(instance);
		}

        public R__0__I6c(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__I6c(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Boolean  @checkValue, System.Object  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@checkValue, @data};
            var ___result = RInvoke_Boolean_Object.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.Boolean  @checkValue, System.Object  @data, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@checkValue, @data, @callback, @object};
            var ___result = RBeginInvoke_Boolean_Object_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

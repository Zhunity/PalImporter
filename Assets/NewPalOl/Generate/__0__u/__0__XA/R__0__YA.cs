...
{public partial class R__0__XA
{
	...
	/// #u.#XA+#YA
	/// </summary>
    public partial class R__0__YA : RMember //
    {
		...
		public static RField R__0__g
		{
			get
			{
				if(r___0__g == null)
				{
					r___0__g = new( ReleactionUtils.GetType("#u.#XA+#YA"), "#g");
		...
		public static RField R__0__h
		{
			get
			{
				if(r___0__h == null)
				{
					r___0__h = new( ReleactionUtils.GetType("#u.#XA+#YA"), "#h");
		...
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__i
		{
			get
			{
				if(r___0__i == null)
				{
					r___0__i = new( ReleactionUtils.GetType("#u.#XA+#YA"), "#i");
		...
		/// Int32 CompareTo(#YA)
		/// </summary>
		protected RMethod r_RCompareTo___0__YA;
		public virtual RMethod RCompareTo___0__YA
		{
			get
			{
				if(r_RCompareTo___0__YA == null)
				{
					r_RCompareTo___0__YA = new(this, "CompareTo", 0,  ReleactionUtils.GetType("#u.#XA+#YA"));
					r_RCompareTo___0__YA.SetBelong(this.instance);
				}
				return r_RCompareTo___0__YA;
			}
		}
        ...
        public R__0__YA() : base("#u.#XA+#YA")
        {
        }

        public R__0__YA(System.Object instance) : base("#u.#XA+#YA")
		{
            SetInstance(instance);
		}

        public R__0__YA(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YA(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

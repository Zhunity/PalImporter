...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#MO
	/// </summary>
    public partial class R__0__MO : RMember //
    {
		...
		/// <summary>
		/// Void #LO(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__LO_Object___0__7X;
		public virtual RMethod R__0__LO_Object___0__7X
		{
			get
			{
				if(r_R__0__LO_Object___0__7X == null)
				{
					r_R__0__LO_Object___0__7X = new(this, "#LO", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__LO_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__LO_Object___0__7X;
			}
		}
        ...
        public R__0__MO() : base("#u.#MO")
        {
        }

        public R__0__MO(System.Object instance) : base("#u.#MO")
		{
            SetInstance(instance);
		}

        public R__0__MO(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__MO(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

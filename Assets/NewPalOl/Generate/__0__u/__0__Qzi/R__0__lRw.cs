...
{public partial class R__0__Qzi
{
	...
	/// #u.#Qzi+#lRw
	/// </summary>
    public partial class R__0__lRw : RMember //
    {
		...
		/// #u.#Qzi #d
		/// </summary>
		protected R__0__u.R__0__Qzi r___0__d;
		public virtual R__0__u.R__0__Qzi R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__lRw() : base("#u.#Qzi+#lRw")
        {
        }

        public R__0__lRw(System.Object instance) : base("#u.#Qzi+#lRw")
		{
            SetInstance(instance);
		}

        public R__0__lRw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__lRw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

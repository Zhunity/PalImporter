...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Zzh
	/// </summary>
    public partial class R__0__Zzh : RMember //
    {
        ...
        public R__0__Zzh() : base("#u.#Zzh")
        {
        }

        public R__0__Zzh(System.Object instance) : base("#u.#Zzh")
		{
            SetInstance(instance);
		}

        public R__0__Zzh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Zzh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__9Gr
{
	
	/// <summary>
	/// #u.#9Gr+#SIr
	/// </summary>
    public partial class R__0__SIr : RMember //
    {
		...
		/// #u.#9Gr #g
		/// </summary>
		protected R__0__u.R__0__9Gr r___0__g;
		public virtual R__0__u.R__0__9Gr R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__SIr() : base("#u.#9Gr+#SIr")
        {
        }

        public R__0__SIr(System.Object instance) : base("#u.#9Gr+#SIr")
		{
            SetInstance(instance);
		}

        public R__0__SIr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__SIr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

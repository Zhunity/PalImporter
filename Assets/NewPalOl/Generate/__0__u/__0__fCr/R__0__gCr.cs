...
{public partial class R__0__fCr
{
	
	/// <summary>
	/// #u.#fCr+#gCr
	/// </summary>
    public partial class R__0__gCr : RMember //
    {
        ...
        public R__0__gCr() : base("#u.#fCr+#gCr")
        {
        }

        public R__0__gCr(System.Object instance) : base("#u.#fCr+#gCr")
		{
            SetInstance(instance);
		}

        public R__0__gCr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gCr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

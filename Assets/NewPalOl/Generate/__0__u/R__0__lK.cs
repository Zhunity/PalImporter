...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#lK
	/// </summary>
    public partial class R__0__lK : RMember //
    {
        ...
        public R__0__lK() : base("#u.#lK")
        {
        }

        public R__0__lK(System.Object instance) : base("#u.#lK")
		{
            SetInstance(instance);
		}

        public R__0__lK(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__lK(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

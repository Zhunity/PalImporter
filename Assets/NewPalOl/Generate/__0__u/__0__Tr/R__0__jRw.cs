...
{public partial class R__0__Tr
{
	
	/// <summary>
	/// #u.#Tr+#jRw
	/// </summary>
    public partial class R__0__jRw : RMember //
    {
		...
		/// #u.#Tr #d
		/// </summary>
		protected R__0__u.R__0__Tr r___0__d;
		public virtual R__0__u.R__0__Tr R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__jRw() : base("#u.#Tr+#jRw")
        {
        }

        public R__0__jRw(System.Object instance) : base("#u.#Tr+#jRw")
		{
            SetInstance(instance);
		}

        public R__0__jRw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jRw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

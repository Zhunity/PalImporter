...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Ax
	/// </summary>
    public partial class R__0__Ax : RMember //
    {
        ...
        public R__0__Ax() : base("#u.#Ax")
        {
        }

        public R__0__Ax(System.Object instance) : base("#u.#Ax")
		{
            SetInstance(instance);
		}

        public R__0__Ax(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ax(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

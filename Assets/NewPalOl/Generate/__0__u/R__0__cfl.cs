...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#cfl
	/// </summary>
    public partial class R__0__cfl : RMember //
    {
        ...
        public R__0__cfl() : base("#u.#cfl")
        {
        }

        public R__0__cfl(System.Object instance) : base("#u.#cfl")
		{
            SetInstance(instance);
		}

        public R__0__cfl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cfl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

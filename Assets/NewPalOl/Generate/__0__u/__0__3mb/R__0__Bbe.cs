...
{public partial class R__0__3mb
{
	...
	/// #u.#3mb+#Bbe
	/// </summary>
    public partial class R__0__Bbe : RMember //
    {
        ...
        public R__0__Bbe() : base("#u.#3mb+#Bbe")
        {
        }

        public R__0__Bbe(System.Object instance) : base("#u.#3mb+#Bbe")
		{
            SetInstance(instance);
		}

        public R__0__Bbe(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Bbe(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

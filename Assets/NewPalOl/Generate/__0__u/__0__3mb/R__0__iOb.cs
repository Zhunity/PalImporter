...
{public partial class R__0__3mb
{
	...
	/// #u.#3mb+#iOb
	/// </summary>
    public partial class R__0__iOb : RMember //
    {
        ...
        public R__0__iOb() : base("#u.#3mb+#iOb")
        {
        }

        public R__0__iOb(System.Object instance) : base("#u.#3mb+#iOb")
		{
            SetInstance(instance);
		}

        public R__0__iOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__iOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__3mb
{
	
	/// <summary>
	/// #u.#3mb+#jOb1
	/// </summary>
    public partial class R__0__jOb1 : RMember //
    {
		...
		/// <summary>
		/// Boolean Invoke(#u.#Ckb)
		/// </summary>
		protected RMethod r_RInvoke___0__Ckb;
		public virtual RMethod RInvoke___0__Ckb
		{
			get
			{
				if(r_RInvoke___0__Ckb == null)
				{
					r_RInvoke___0__Ckb = new(this, "Invoke", 0,  ReleactionUtils.GetType("#u.#Ckb"));
					r_RInvoke___0__Ckb.SetBelong(this.instance);
				}
				return r_RInvoke___0__Ckb;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(#u.#Ckb, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke___0__Ckb_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke___0__Ckb_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke___0__Ckb_AsyncCallback_Object == null)
				{
					r_RBeginInvoke___0__Ckb_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("#u.#Ckb"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke___0__Ckb_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke___0__Ckb_AsyncCallback_Object;
			}
		}
        ...
        public R__0__jOb1() : base("#u.#3mb+#jOb1")
        {
        }

        public R__0__jOb1(System.Object instance) : base("#u.#3mb+#jOb1")
		{
            SetInstance(instance);
		}

        public R__0__jOb1(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jOb1(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

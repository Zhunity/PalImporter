...
{public partial class R__0__3mb
{
	...
	/// #u.#3mb+#AFd
	/// </summary>
    public partial class R__0__AFd : RMember //
    {
        ...
        public R__0__AFd() : base("#u.#3mb+#AFd")
        {
        }

        public R__0__AFd(System.Object instance) : base("#u.#3mb+#AFd")
		{
            SetInstance(instance);
		}

        public R__0__AFd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__AFd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

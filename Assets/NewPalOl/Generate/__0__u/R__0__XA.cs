...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#XA
	/// </summary>
    public partial class R__0__XA : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#XA"), "#a");
		...
		public static RField R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#XA"), "#b");
		...
		/// <summary>
		/// System.Collections.Generic.List`1[#u.#XA+#0A] #n
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__u.R__0__XA.R__0__0A> r___0__n;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__u.R__0__XA.R__0__0A> R__0__n
		{
			get
			{
				if(r___0__n == null)
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.Int32,System.String] #o
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, RField> r___0__o;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__o
		{
			get
			{
				if(r___0__o == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1[#u.#XA+#YA] #p
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__u.R__0__XA.R__0__YA> r___0__p;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__u.R__0__XA.R__0__YA> R__0__p
		{
			get
			{
				if(r___0__p == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1[#u.#XA+#ZA] #q
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__u.R__0__XA.R__0__ZA> r___0__q;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__u.R__0__XA.R__0__ZA> R__0__q
		{
			get
			{
				if(r___0__q == null)
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.Int32,System.String] #r
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, RField> r___0__r;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__r
		{
			get
			{
				if(r___0__r == null)
		...
		/// <summary>
		/// Void #IA(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__IA_Object___0__7X;
		public virtual RMethod R__0__IA_Object___0__7X
		{
			get
			{
				if(r_R__0__IA_Object___0__7X == null)
				{
					r_R__0__IA_Object___0__7X = new(this, "#IA", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__IA_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__IA_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #Kt(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Kt_Object___0__7X;
		public virtual RMethod R__0__Kt_Object___0__7X
		{
			get
			{
				if(r_R__0__Kt_Object___0__7X == null)
				{
					r_R__0__Kt_Object___0__7X = new(this, "#Kt", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Kt_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Kt_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #KA(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__KA_Object___0__7X;
		public virtual RMethod R__0__KA_Object___0__7X
		{
			get
			{
				if(r_R__0__KA_Object___0__7X == null)
				{
					r_R__0__KA_Object___0__7X = new(this, "#KA", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__KA_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__KA_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Boolean #ocd(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__ocd_ID;
		public virtual RMethod R__0__ocd_ID
		{
			get
			{
				if(r_R__0__ocd_ID == null)
				{
					r_R__0__ocd_ID = new(this, "#ocd", 0, typeof(GameDefineType.ID));
					r_R__0__ocd_ID.SetBelong(this.instance);
				}
				return r_R__0__ocd_ID;
			}
		}
		...
		/// Void #MA()
		/// </summary>
		protected RMethod r_R__0__MA;
		public virtual RMethod R__0__MA
		{
			get
			{
				if(r_R__0__MA == null)
				{
					r_R__0__MA = new(this, "#MA", 0);
					r_R__0__MA.SetBelong(this.instance);
				}
				return r_R__0__MA;
			}
		}
		...
		/// Boolean #NA()
		/// </summary>
		protected RMethod r_R__0__NA;
		public virtual RMethod R__0__NA
		{
			get
			{
				if(r_R__0__NA == null)
				{
					r_R__0__NA = new(this, "#NA", 0);
					r_R__0__NA.SetBelong(this.instance);
				}
				return r_R__0__NA;
			}
		}
		...
		/// Void #PA()
		/// </summary>
		protected RMethod r_R__0__PA;
		public virtual RMethod R__0__PA
		{
			get
			{
				if(r_R__0__PA == null)
				{
					r_R__0__PA = new(this, "#PA", 0);
					r_R__0__PA.SetBelong(this.instance);
				}
				return r_R__0__PA;
			}
		}
		...
		/// <summary>
		/// Void #UA(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__UA_ID;
		public virtual RMethod R__0__UA_ID
		{
			get
			{
				if(r_R__0__UA_ID == null)
				{
					r_R__0__UA_ID = new(this, "#UA", 0, typeof(GameDefineType.ID));
					r_R__0__UA_ID.SetBelong(this.instance);
				}
				return r_R__0__UA_ID;
			}
		}

		/// <summary>
		/// Void #VA(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__VA_Object___0__7X;
		public virtual RMethod R__0__VA_Object___0__7X
		{
			get
			{
				if(r_R__0__VA_Object___0__7X == null)
				{
					r_R__0__VA_Object___0__7X = new(this, "#VA", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__VA_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__VA_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #WA(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__WA_Object___0__7X;
		public virtual RMethod R__0__WA_Object___0__7X
		{
			get
			{
				if(r_R__0__WA_Object___0__7X == null)
				{
					r_R__0__WA_Object___0__7X = new(this, "#WA", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__WA_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__WA_Object___0__7X;
			}
		}
        ...
        public R__0__XA() : base("#u.#XA")
        {
        }

        public R__0__XA(System.Object instance) : base("#u.#XA")
		{
            SetInstance(instance);
		}

        public R__0__XA(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XA(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Boolean __0__ocd(GameDefineType.ID  @id)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id};
            var ___result = R__0__ocd_ID.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__MA()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__MA.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Boolean __0__NA()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__NA.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__PA()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__PA.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__UA(GameDefineType.ID  @id)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id};
            var ___result = R__0__UA_ID.Invoke(___genericsType, ___parameters);

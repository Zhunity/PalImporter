...
{public partial class R__0__sbi
{
	...
	/// #u.#sbi+#GVv
	/// </summary>
    public partial class R__0__GVv : RMember //
    {
        ...
        public R__0__GVv() : base("#u.#sbi+#GVv")
        {
        }

        public R__0__GVv(System.Object instance) : base("#u.#sbi+#GVv")
		{
            SetInstance(instance);
		}

        public R__0__GVv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__GVv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__sbi
{
	...
	/// #u.#sbi+#1hp
	/// </summary>
    public partial class R__0__1hp : RMember //
    {
		...
		/// #u.#sbi #g
		/// </summary>
		protected R__0__u.R__0__sbi r___0__g;
		public virtual R__0__u.R__0__sbi R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__1hp() : base("#u.#sbi+#1hp")
        {
        }

        public R__0__1hp(System.Object instance) : base("#u.#sbi+#1hp")
		{
            SetInstance(instance);
		}

        public R__0__1hp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1hp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#o9
	/// </summary>
    public partial class R__0__o9 : RMember //
    {

		/// <summary>
		/// #Pfb.#4ob #a
		/// </summary>
		protected R__0__Pfb.R__0__4ob r___0__a;
		public virtual R__0__Pfb.R__0__4ob R__0__a
		{
			get
			{
				if(r___0__a == null)
        ...
        public R__0__o9() : base("#u.#o9")
        {
        }

        public R__0__o9(System.Object instance) : base("#u.#o9")
		{
            SetInstance(instance);
		}

        public R__0__o9(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__o9(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__Gh
{
	...
	/// #u.#Gh+#Qh
	/// </summary>
    public partial class R__0__Qh : RMember //
    {
        ...
        public R__0__Qh() : base("#u.#Gh+#Qh")
        {
        }

        public R__0__Qh(System.Object instance) : base("#u.#Gh+#Qh")
		{
            SetInstance(instance);
		}

        public R__0__Qh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Qh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

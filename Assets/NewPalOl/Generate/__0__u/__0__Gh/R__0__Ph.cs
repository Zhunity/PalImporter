...
{public partial class R__0__Gh
{
	...
	/// #u.#Gh+#Ph
	/// </summary>
    public partial class R__0__Ph : RMember //
    {
        ...
        public R__0__Ph() : base("#u.#Gh+#Ph")
        {
        }

        public R__0__Ph(System.Object instance) : base("#u.#Gh+#Ph")
		{
            SetInstance(instance);
		}

        public R__0__Ph(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ph(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

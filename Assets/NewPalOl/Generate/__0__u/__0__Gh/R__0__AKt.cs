...
{public partial class R__0__Gh
{
	...
	/// #u.#Gh+#AKt
	/// </summary>
    public partial class R__0__AKt : RMember //
    {
		...
		/// #u.#Gh+#Kh #b
		/// </summary>
		protected R__0__u.R__0__Gh.R__0__Kh r___0__b;
		public virtual R__0__u.R__0__Gh.R__0__Kh R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// #u.#Gh+#Kh #e
		/// </summary>
		protected R__0__u.R__0__Gh.R__0__Kh r___0__e;
		public virtual R__0__u.R__0__Gh.R__0__Kh R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// #u.#Gh #f
		/// </summary>
		protected R__0__u.R__0__Gh r___0__f;
		public virtual R__0__u.R__0__Gh R__0__f
		{
			get
			{
				if(r___0__f == null)
        ...
        public R__0__AKt() : base("#u.#Gh+#AKt")
        {
        }

        public R__0__AKt(System.Object instance) : base("#u.#Gh+#AKt")
		{
            SetInstance(instance);
		}

        public R__0__AKt(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__AKt(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

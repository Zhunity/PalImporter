...
{public partial class R__0__Gh
{
	...
	/// #u.#Gh+#0kc
	/// </summary>
    public partial class R__0__0kc : RMember //
    {
        ...
        public R__0__0kc() : base("#u.#Gh+#0kc")
        {
        }

        public R__0__0kc(System.Object instance) : base("#u.#Gh+#0kc")
		{
            SetInstance(instance);
		}

        public R__0__0kc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0kc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

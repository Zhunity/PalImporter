...
{public partial class R__0__vAi
{
	
	/// <summary>
	/// #u.#vAi+#NSw
	/// </summary>
    public partial class R__0__NSw : RMember //
    {
		...
		/// #u.#vAi #t
		/// </summary>
		protected R__0__u.R__0__vAi r___0__t;
		public virtual R__0__u.R__0__vAi R__0__t
		{
			get
			{
				if(r___0__t == null)
        ...
        public R__0__NSw() : base("#u.#vAi+#NSw")
        {
        }

        public R__0__NSw(System.Object instance) : base("#u.#vAi+#NSw")
		{
            SetInstance(instance);
		}

        public R__0__NSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__NSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

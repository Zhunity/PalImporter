...
{public partial class R__0__R1c
{
	...
	/// #u.#R1c+#lYw
	/// </summary>
    public partial class R__0__lYw : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.List`1+Enumerator[#Pfb.#W1c] #b
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RField>.REnumerator r___0__b;
		public virtual RSystem.RCollections.RGeneric.RList<RField>.REnumerator R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// #Pfb.#W1c #c
		/// </summary>
		protected R__0__Pfb.R__0__W1c r___0__c;
		public virtual R__0__Pfb.R__0__W1c R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// #u.#R1c #i
		/// </summary>
		protected R__0__u.R__0__R1c r___0__i;
		public virtual R__0__u.R__0__R1c R__0__i
		{
			get
			{
				if(r___0__i == null)
        ...
        public R__0__lYw() : base("#u.#R1c+#lYw")
        {
        }

        public R__0__lYw(System.Object instance) : base("#u.#R1c+#lYw")
		{
            SetInstance(instance);
		}

        public R__0__lYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__lYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

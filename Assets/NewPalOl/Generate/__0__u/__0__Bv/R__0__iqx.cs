...
{public partial class R__0__Bv
{
	...
	/// #u.#Bv+#iqx
	/// </summary>
    public partial class R__0__iqx : RMember //
    {

		/// <summary>
		/// #u.#mLb #a
		/// </summary>
		protected R__0__u.R__0__mLb r___0__a;
		public virtual R__0__u.R__0__mLb R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #u.#mLb #d
		/// </summary>
		protected R__0__u.R__0__mLb r___0__d;
		public virtual R__0__u.R__0__mLb R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__iqx() : base("#u.#Bv+#iqx")
        {
        }

        public R__0__iqx(System.Object instance) : base("#u.#Bv+#iqx")
		{
            SetInstance(instance);
		}

        public R__0__iqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__iqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

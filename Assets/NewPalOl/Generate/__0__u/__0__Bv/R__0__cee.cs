...
{public partial class R__0__Bv
{
	
	/// <summary>
	/// #u.#Bv+#cee
	/// </summary>
    public partial class R__0__cee : RMember //
    {
        ...
        public R__0__cee() : base("#u.#Bv+#cee")
        {
        }

        public R__0__cee(System.Object instance) : base("#u.#Bv+#cee")
		{
            SetInstance(instance);
		}

        public R__0__cee(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cee(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__Kib
{
	...
	/// #u.#Kib+#Oib
	/// </summary>
    public partial class R__0__Oib : RMember //
    {
        ...
        public R__0__Oib() : base("#u.#Kib+#Oib")
        {
        }

        public R__0__Oib(System.Object instance) : base("#u.#Kib+#Oib")
		{
            SetInstance(instance);
		}

        public R__0__Oib(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Oib(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

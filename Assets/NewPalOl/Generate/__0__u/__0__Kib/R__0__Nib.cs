...
{public partial class R__0__Kib
{
	...
	/// #u.#Kib+#Nib
	/// </summary>
    public partial class R__0__Nib : RMember //
    {
        ...
        public R__0__Nib() : base("#u.#Kib+#Nib")
        {
        }

        public R__0__Nib(System.Object instance) : base("#u.#Kib+#Nib")
		{
            SetInstance(instance);
		}

        public R__0__Nib(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Nib(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

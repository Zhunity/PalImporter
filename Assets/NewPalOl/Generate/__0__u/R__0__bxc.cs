...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#bxc
	/// </summary>
    public partial class R__0__bxc : RMember //
    {
        ...
        public R__0__bxc() : base("#u.#bxc")
        {
        }

        public R__0__bxc(System.Object instance) : base("#u.#bxc")
		{
            SetInstance(instance);
		}

        public R__0__bxc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__bxc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__zD
{
	public partial class R__0__CD1
{
	
	/// <summary>
	/// #u.#zD+#CD1+#dee1
	/// </summary>
    public partial class R__0__dee1 : RMember //
    {
		...
		/// Void Invoke(#BD1)
		/// </summary>
		protected RMethod r_RInvoke___0__BD1;
		public virtual RMethod RInvoke___0__BD1
		{
			get
			{
				if(r_RInvoke___0__BD1 == null)
				{
					r_RInvoke___0__BD1 = new(this, "Invoke", 0,  ReleactionUtils.GetType("#u.#zD+#BD1"));
					r_RInvoke___0__BD1.SetBelong(this.instance);
				}
				return r_RInvoke___0__BD1;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(#BD1, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke___0__BD1_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke___0__BD1_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke___0__BD1_AsyncCallback_Object == null)
				{
					r_RBeginInvoke___0__BD1_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("#u.#zD+#BD1"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke___0__BD1_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke___0__BD1_AsyncCallback_Object;
			}
		}
        ...
        public R__0__dee1() : base("#u.#zD+#CD1+#dee1")
        {
        }

        public R__0__dee1(System.Object instance) : base("#u.#zD+#CD1+#dee1")
		{
            SetInstance(instance);
		}

        public R__0__dee1(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dee1(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

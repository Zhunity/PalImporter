...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#xGn
	/// </summary>
    public partial class R__0__xGn : RMember //
    {
        ...
        public R__0__xGn() : base("#u.#xGn")
        {
        }

        public R__0__xGn(System.Object instance) : base("#u.#xGn")
		{
            SetInstance(instance);
		}

        public R__0__xGn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__xGn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#rKk
	/// </summary>
    public partial class R__0__rKk : RMember //
    {
        ...
        public R__0__rKk() : base("#u.#rKk")
        {
        }

        public R__0__rKk(System.Object instance) : base("#u.#rKk")
		{
            SetInstance(instance);
		}

        public R__0__rKk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__rKk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

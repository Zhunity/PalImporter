...
{public partial class R__0__Jah
{
	...
	/// #u.#Jah+#vqx
	/// </summary>
    public partial class R__0__vqx : RMember //
    {
		...
		/// #u.#Jah #e
		/// </summary>
		protected R__0__u.R__0__Jah r___0__e;
		public virtual R__0__u.R__0__Jah R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__vqx() : base("#u.#Jah+#vqx")
        {
        }

        public R__0__vqx(System.Object instance) : base("#u.#Jah+#vqx")
		{
            SetInstance(instance);
		}

        public R__0__vqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__vqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

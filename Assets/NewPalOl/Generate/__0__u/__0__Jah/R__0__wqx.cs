...
{public partial class R__0__Jah
{
	...
	/// #u.#Jah+#wqx
	/// </summary>
    public partial class R__0__wqx : RMember //
    {
		...
		/// UnityEngine.WWW #b
		/// </summary>
		protected RUnityEngine.RWWW r___0__b;
		public virtual RUnityEngine.RWWW R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// #u.#Jah #f
		/// </summary>
		protected R__0__u.R__0__Jah r___0__f;
		public virtual R__0__u.R__0__Jah R__0__f
		{
			get
			{
				if(r___0__f == null)
        ...
        public R__0__wqx() : base("#u.#Jah+#wqx")
        {
        }

        public R__0__wqx(System.Object instance) : base("#u.#Jah+#wqx")
		{
            SetInstance(instance);
		}

        public R__0__wqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__wqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

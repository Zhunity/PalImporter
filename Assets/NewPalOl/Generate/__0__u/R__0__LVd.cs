...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#LVd
	/// </summary>
    public partial class R__0__LVd : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#LVd"), "#a");
		...
		/// <summary>
		/// Void #JVd(System.Object)
		/// </summary>
		protected RMethod r_R__0__JVd_Object;
		public virtual RMethod R__0__JVd_Object
		{
			get
			{
				if(r_R__0__JVd_Object == null)
				{
					r_R__0__JVd_Object = new(this, "#JVd", 0, typeof(System.Object));
					r_R__0__JVd_Object.SetBelong(this.instance);
				}
				return r_R__0__JVd_Object;
			}
		}
        ...
        public R__0__LVd() : base("#u.#LVd")
        {
        }

        public R__0__LVd(System.Object instance) : base("#u.#LVd")
		{
            SetInstance(instance);
		}

        public R__0__LVd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__LVd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__JVd(System.Object  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@data};
            var ___result = R__0__JVd_Object.Invoke(___genericsType, ___parameters);

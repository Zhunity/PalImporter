...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#SYv
	/// </summary>
    public partial class R__0__SYv : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#SYv"), "#a");
        ...
        public R__0__SYv() : base("#u.#SYv")
        {
        }

        public R__0__SYv(System.Object instance) : base("#u.#SYv")
		{
            SetInstance(instance);
		}

        public R__0__SYv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__SYv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__mk(System.Int32  @todaymoney)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@todaymoney};

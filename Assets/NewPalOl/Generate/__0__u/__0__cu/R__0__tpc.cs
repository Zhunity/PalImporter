...
{public partial class R__0__cu
{
	...
	/// #u.#cu+#tpc
	/// </summary>
    public partial class R__0__tpc : RMember //
    {
        ...
        public R__0__tpc() : base("#u.#cu+#tpc")
        {
        }

        public R__0__tpc(System.Object instance) : base("#u.#cu+#tpc")
		{
            SetInstance(instance);
		}

        public R__0__tpc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__tpc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#NEg
	/// </summary>
    public partial class R__0__NEg : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#NEg"), "#a");
		...
		/// <summary>
		/// Void #MEg(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__MEg_Object___0__7X;
		public virtual RMethod R__0__MEg_Object___0__7X
		{
			get
			{
				if(r_R__0__MEg_Object___0__7X == null)
				{
					r_R__0__MEg_Object___0__7X = new(this, "#MEg", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__MEg_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__MEg_Object___0__7X;
			}
		}
        ...
        public R__0__NEg() : base("#u.#NEg")
        {
        }

        public R__0__NEg(System.Object instance) : base("#u.#NEg")
		{
            SetInstance(instance);
		}

        public R__0__NEg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__NEg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Dbh
	/// </summary>
    public partial class R__0__Dbh : RMember //
    {
		...
		/// <summary>
		/// Void #Cbh(System.String)
		/// </summary>
		protected RMethod r_R__0__Cbh_String;
		public virtual RMethod R__0__Cbh_String
		{
			get
			{
				if(r_R__0__Cbh_String == null)
				{
					r_R__0__Cbh_String = new(this, "#Cbh", 0, typeof(System.String));
					r_R__0__Cbh_String.SetBelong(this.instance);
				}
				return r_R__0__Cbh_String;
			}
		}
        ...
        public R__0__Dbh() : base("#u.#Dbh")
        {
        }

        public R__0__Dbh(System.Object instance) : base("#u.#Dbh")
		{
            SetInstance(instance);
		}

        public R__0__Dbh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Dbh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Cbh(System.String  @giftList)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@giftList};
            var ___result = R__0__Cbh_String.Invoke(___genericsType, ___parameters);

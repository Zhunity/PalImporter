...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#VB
	/// </summary>
    public partial class R__0__VB : RMember //
    {
        ...
        public R__0__VB() : base("#u.#VB")
        {
        }

        public R__0__VB(System.Object instance) : base("#u.#VB")
		{
            SetInstance(instance);
		}

        public R__0__VB(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__VB(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__sb(GameDefineType.ID  @sceneID)
        {

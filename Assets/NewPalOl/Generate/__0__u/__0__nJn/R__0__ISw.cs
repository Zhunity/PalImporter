...
{public partial class R__0__nJn
{
	...
	/// #u.#nJn+#ISw
	/// </summary>
    public partial class R__0__ISw : RMember //
    {
		...
		/// #u.#nJn #g
		/// </summary>
		protected R__0__u.R__0__nJn r___0__g;
		public virtual R__0__u.R__0__nJn R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__ISw() : base("#u.#nJn+#ISw")
        {
        }

        public R__0__ISw(System.Object instance) : base("#u.#nJn+#ISw")
		{
            SetInstance(instance);
		}

        public R__0__ISw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ISw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

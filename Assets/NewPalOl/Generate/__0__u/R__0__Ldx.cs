...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Ldx
	/// </summary>
    public partial class R__0__Ldx : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.List`1[System.Double] #f
		/// </summary>
		...
		/// <summary>
		/// Void #Xd(System.String, System.String, System.Collections.Generic.List`1[System.Double])
		/// </summary>
		protected RMethod r_R__0__Xd_String_String_List_d_Double_p_;
		public virtual RMethod R__0__Xd_String_String_List_d_Double_p_
		{
			get
			{
				if(r_R__0__Xd_String_String_List_d_Double_p_ == null)
				{
					r_R__0__Xd_String_String_List_d_Double_p_ = new(this, "#Xd", 0, typeof(System.String), typeof(System.String), typeof(System.Collections.Generic.List<>).MakeGenericType(typeof(System.Double)));
					r_R__0__Xd_String_String_List_d_Double_p_.SetBelong(this.instance);
				}
				return r_R__0__Xd_String_String_List_d_Double_p_;
			}
		}
        ...
        public R__0__Ldx() : base("#u.#Ldx")
        {
        }

        public R__0__Ldx(System.Object instance) : base("#u.#Ldx")
		{
            SetInstance(instance);
		}

        public R__0__Ldx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ldx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Xd(System.String  @iteminfo, System.String  @time, System.Collections.Generic.List<System.Double>  @time_rest)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@iteminfo, @time, @time_rest};
            var ___result = R__0__Xd_String_String_List_d_Double_p_.Invoke(___genericsType, ___parameters);

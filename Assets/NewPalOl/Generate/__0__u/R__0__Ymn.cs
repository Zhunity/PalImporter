...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Ymn
	/// </summary>
    public partial class R__0__Ymn : RMember //
    {
        ...
        public R__0__Ymn() : base("#u.#Ymn")
        {
        }

        public R__0__Ymn(System.Object instance) : base("#u.#Ymn")
		{
            SetInstance(instance);
		}

        public R__0__Ymn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ymn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#g6d
	/// </summary>
    public partial class R__0__g6d : RMember //
    {
		...
		/// <summary>
		/// System.String #f6d(Int32)
		/// </summary>
		protected RMethod r_R__0__f6d_Int32;
		public virtual RMethod R__0__f6d_Int32
		{
			get
			{
				if(r_R__0__f6d_Int32 == null)
				{
					r_R__0__f6d_Int32 = new(this, "#f6d", 0, typeof(System.Int32));
					r_R__0__f6d_Int32.SetBelong(this.instance);
				}
				return r_R__0__f6d_Int32;
			}
		}
        ...
        public R__0__g6d() : base("#u.#g6d")
        {
        }

        public R__0__g6d(System.Object instance) : base("#u.#g6d")
		{
            SetInstance(instance);
		}

        public R__0__g6d(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__g6d(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.String __0__f6d(System.Int32  @rare)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@rare};
            var ___result = R__0__f6d_Int32.Invoke(___genericsType, ___parameters);

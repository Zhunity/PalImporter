...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#meg
	/// </summary>
    public partial class R__0__meg : RMember //
    {
		...
		/// <summary>
		/// Void #dUu(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__dUu_Object___0__7X;
		public virtual RMethod R__0__dUu_Object___0__7X
		{
			get
			{
				if(r_R__0__dUu_Object___0__7X == null)
				{
					r_R__0__dUu_Object___0__7X = new(this, "#dUu", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__dUu_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__dUu_Object___0__7X;
			}
		}
		...
		/// Void #jeg(Int32)
		/// </summary>
		protected RMethod r_R__0__jeg_Int32;
		public virtual RMethod R__0__jeg_Int32
		{
			get
			{
				if(r_R__0__jeg_Int32 == null)
				{
					r_R__0__jeg_Int32 = new(this, "#jeg", 0, typeof(System.Int32));
					r_R__0__jeg_Int32.SetBelong(this.instance);
				}
				return r_R__0__jeg_Int32;
			}
		}

		/// <summary>
		/// Void #eUu(System.String)
		/// </summary>
		protected RMethod r_R__0__eUu_String;
		public virtual RMethod R__0__eUu_String
		{
			get
			{
				if(r_R__0__eUu_String == null)
				{
					r_R__0__eUu_String = new(this, "#eUu", 0, typeof(System.String));
					r_R__0__eUu_String.SetBelong(this.instance);
				}
				return r_R__0__eUu_String;
			}
		}

		/// <summary>
		/// Void #fUu(System.String)
		/// </summary>
		protected RMethod r_R__0__fUu_String;
		public virtual RMethod R__0__fUu_String
		{
			get
			{
				if(r_R__0__fUu_String == null)
				{
					r_R__0__fUu_String = new(this, "#fUu", 0, typeof(System.String));
					r_R__0__fUu_String.SetBelong(this.instance);
				}
				return r_R__0__fUu_String;
			}
		}

		/// <summary>
		/// Void #yZo(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__yZo_Object___0__7X;
		public virtual RMethod R__0__yZo_Object___0__7X
		{
			get
			{
				if(r_R__0__yZo_Object___0__7X == null)
				{
					r_R__0__yZo_Object___0__7X = new(this, "#yZo", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__yZo_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__yZo_Object___0__7X;
			}
		}
        ...
        public R__0__meg() : base("#u.#meg")
        {
        }

        public R__0__meg(System.Object instance) : base("#u.#meg")
		{
            SetInstance(instance);
		}

        public R__0__meg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__meg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__jeg(System.Int32  @lv)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@lv};
            var ___result = R__0__jeg_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__eUu(System.String  @msg)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@msg};
            var ___result = R__0__eUu_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__fUu(System.String  @info)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@info};
            var ___result = R__0__fUu_String.Invoke(___genericsType, ___parameters);

...
{public partial class R__0__VB
{
	
	/// <summary>
	/// #u.#VB+#3Rd
	/// </summary>
    public partial class R__0__3Rd : RMember //
    {
		...
		/// #u.#VB #c
		/// </summary>
		protected R__0__u.R__0__VB r___0__c;
		public virtual R__0__u.R__0__VB R__0__c
		{
			get
			{
				if(r___0__c == null)
        ...
        public R__0__3Rd() : base("#u.#VB+#3Rd")
        {
        }

        public R__0__3Rd(System.Object instance) : base("#u.#VB+#3Rd")
		{
            SetInstance(instance);
		}

        public R__0__3Rd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3Rd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

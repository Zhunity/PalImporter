...
{public partial class R__0__EOd
{
	...
	/// #u.#EOd+#WIr
	/// </summary>
    public partial class R__0__WIr : RMember //
    {
		...
		/// #u.#EOd #n
		/// </summary>
		protected R__0__u.R__0__EOd r___0__n;
		public virtual R__0__u.R__0__EOd R__0__n
		{
			get
			{
				if(r___0__n == null)
        ...
        public R__0__WIr() : base("#u.#EOd+#WIr")
        {
        }

        public R__0__WIr(System.Object instance) : base("#u.#EOd+#WIr")
		{
            SetInstance(instance);
		}

        public R__0__WIr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__WIr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

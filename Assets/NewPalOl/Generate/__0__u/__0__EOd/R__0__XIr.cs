...
{public partial class R__0__EOd
{
	...
	/// #u.#EOd+#XIr
	/// </summary>
    public partial class R__0__XIr : RMember //
    {
        ...
        public R__0__XIr() : base("#u.#EOd+#XIr")
        {
        }

        public R__0__XIr(System.Object instance) : base("#u.#EOd+#XIr")
		{
            SetInstance(instance);
		}

        public R__0__XIr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XIr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

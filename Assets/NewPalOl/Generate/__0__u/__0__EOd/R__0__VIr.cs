...
{public partial class R__0__EOd
{
	...
	/// #u.#EOd+#VIr
	/// </summary>
    public partial class R__0__VIr : RMember //
    {
		...
		/// #u.#EOd #c
		/// </summary>
		protected R__0__u.R__0__EOd r___0__c;
		public virtual R__0__u.R__0__EOd R__0__c
		{
			get
			{
				if(r___0__c == null)
        ...
        public R__0__VIr() : base("#u.#EOd+#VIr")
        {
        }

        public R__0__VIr(System.Object instance) : base("#u.#EOd+#VIr")
		{
            SetInstance(instance);
		}

        public R__0__VIr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__VIr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

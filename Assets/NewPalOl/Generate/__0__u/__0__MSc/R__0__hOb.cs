...
{public partial class R__0__MSc
{
	
	/// <summary>
	/// #u.#MSc+#hOb
	/// </summary>
    public partial class R__0__hOb : RMember //
    {
        ...
        public R__0__hOb() : base("#u.#MSc+#hOb")
        {
        }

        public R__0__hOb(System.Object instance) : base("#u.#MSc+#hOb")
		{
            SetInstance(instance);
		}

        public R__0__hOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__XJf
{
	...
	/// #u.#XJf+#vMh
	/// </summary>
    public partial class R__0__vMh : RMember //
    {
		...
		/// #u.#XJf #e
		/// </summary>
		protected R__0__u.R__0__XJf r___0__e;
		public virtual R__0__u.R__0__XJf R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__vMh() : base("#u.#XJf+#vMh")
        {
        }

        public R__0__vMh(System.Object instance) : base("#u.#XJf+#vMh")
		{
            SetInstance(instance);
		}

        public R__0__vMh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__vMh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

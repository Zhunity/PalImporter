...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Wff
	/// </summary>
    public partial class R__0__Wff : RMember //
    {
		...
		/// #u.#Ckb #d
		/// </summary>
		protected R__0__u.R__0__Ckb r___0__d;
		public virtual R__0__u.R__0__Ckb R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// Void #Xd(#u.#Ckb)
		/// </summary>
		protected RMethod r_R__0__Xd___0__Ckb;
		public virtual RMethod R__0__Xd___0__Ckb
		{
			get
			{
				if(r_R__0__Xd___0__Ckb == null)
				{
					r_R__0__Xd___0__Ckb = new(this, "#Xd", 0,  ReleactionUtils.GetType("#u.#Ckb"));
					r_R__0__Xd___0__Ckb.SetBelong(this.instance);
				}
				return r_R__0__Xd___0__Ckb;
			}
		}
        ...
        public R__0__Wff() : base("#u.#Wff")
        {
        }

        public R__0__Wff(System.Object instance) : base("#u.#Wff")
		{
            SetInstance(instance);
		}

        public R__0__Wff(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wff(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#NCs
	/// </summary>
    public partial class R__0__NCs : RMember //
    {
		...
		/// #oU.#I1 #j
		/// </summary>
		protected R__0__oU.R__0__I1 r___0__j;
		public virtual R__0__oU.R__0__I1 R__0__j
		{
			get
			{
				if(r___0__j == null)
		...
		/// #oU.#I1 #s
		/// </summary>
		protected R__0__oU.R__0__I1 r___0__s;
		public virtual R__0__oU.R__0__I1 R__0__s
		{
			get
			{
				if(r___0__s == null)
        ...
        public R__0__NCs() : base("#u.#NCs")
        {
        }

        public R__0__NCs(System.Object instance) : base("#u.#NCs")
		{
            SetInstance(instance);
		}

        public R__0__NCs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__NCs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#dcv
	/// </summary>
    public partial class R__0__dcv : RMember //
    {
        ...
        public R__0__dcv() : base("#u.#dcv")
        {
        }

        public R__0__dcv(System.Object instance) : base("#u.#dcv")
		{
            SetInstance(instance);
		}

        public R__0__dcv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dcv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

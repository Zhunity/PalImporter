...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#zjx
	/// </summary>
    public partial class R__0__zjx : RMember //
    {
		...
		/// Void #yjx(Int32)
		/// </summary>
		protected RMethod r_R__0__yjx_Int32;
		public virtual RMethod R__0__yjx_Int32
		{
			get
			{
				if(r_R__0__yjx_Int32 == null)
				{
					r_R__0__yjx_Int32 = new(this, "#yjx", 0, typeof(System.Int32));
					r_R__0__yjx_Int32.SetBelong(this.instance);
				}
				return r_R__0__yjx_Int32;
			}
		}
        ...
        public R__0__zjx() : base("#u.#zjx")
        {
        }

        public R__0__zjx(System.Object instance) : base("#u.#zjx")
		{
            SetInstance(instance);
		}

        public R__0__zjx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zjx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__ld(System.String  @info)
        {
        ...
        public virtual void __0__yjx(System.Int32  @point)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@point};
            var ___result = R__0__yjx_Int32.Invoke(___genericsType, ___parameters);

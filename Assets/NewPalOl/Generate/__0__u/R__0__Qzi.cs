...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Qzi
	/// </summary>
    public partial class R__0__Qzi : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#Qzi"), "#a");
		...
		public static RField R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#Qzi"), "#b");
		...
		public static RField R__0__c
		{
			get
			{
				if(r___0__c == null)
				{
					r___0__c = new( ReleactionUtils.GetType("#u.#Qzi"), "#c");
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.Int32,System.Collections.Generic.List`1[#u.#Qzi+#Rzi]] #d
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, RSystem.RCollections.RGeneric.RList<R__0__u.R__0__Qzi.R__0__Rzi>> r___0__d;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, RSystem.RCollections.RGeneric.RList<R__0__u.R__0__Qzi.R__0__Rzi>> R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// Void #Izi()
		/// </summary>
		protected RMethod r_R__0__Izi;
		public virtual RMethod R__0__Izi
		{
			get
			{
				if(r_R__0__Izi == null)
				{
					r_R__0__Izi = new(this, "#Izi", 0);
					r_R__0__Izi.SetBelong(this.instance);
				}
				return r_R__0__Izi;
			}
		}
		...
		/// <summary>
		/// Void #Lzi(System.Object)
		/// </summary>
		protected RMethod r_R__0__Lzi_Object;
		public virtual RMethod R__0__Lzi_Object
		{
			get
			{
				if(r_R__0__Lzi_Object == null)
				{
					r_R__0__Lzi_Object = new(this, "#Lzi", 0, typeof(System.Object));
					r_R__0__Lzi_Object.SetBelong(this.instance);
				}
				return r_R__0__Lzi_Object;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator #Mzi()
		/// </summary>
		protected RMethod r_R__0__Mzi;
		public virtual RMethod R__0__Mzi
		{
			get
			{
				if(r_R__0__Mzi == null)
				{
					r_R__0__Mzi = new(this, "#Mzi", 0);
					r_R__0__Mzi.SetBelong(this.instance);
				}
				return r_R__0__Mzi;
			}
		}
		...
		/// <summary>
		/// Void #Nzi(System.Object)
		/// </summary>
		protected RMethod r_R__0__Nzi_Object;
		public virtual RMethod R__0__Nzi_Object
		{
			get
			{
				if(r_R__0__Nzi_Object == null)
				{
					r_R__0__Nzi_Object = new(this, "#Nzi", 0, typeof(System.Object));
					r_R__0__Nzi_Object.SetBelong(this.instance);
				}
				return r_R__0__Nzi_Object;
			}
		}

		/// <summary>
		/// Void #Ozi(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Ozi_Object___0__7X;
		public virtual RMethod R__0__Ozi_Object___0__7X
		{
			get
			{
				if(r_R__0__Ozi_Object___0__7X == null)
				{
					r_R__0__Ozi_Object___0__7X = new(this, "#Ozi", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Ozi_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Ozi_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #Pzi(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Pzi_Object___0__7X;
		public virtual RMethod R__0__Pzi_Object___0__7X
		{
			get
			{
				if(r_R__0__Pzi_Object___0__7X == null)
				{
					r_R__0__Pzi_Object___0__7X = new(this, "#Pzi", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Pzi_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Pzi_Object___0__7X;
			}
		}
        ...
        public R__0__Qzi() : base("#u.#Qzi")
        {
        }

        public R__0__Qzi(System.Object instance) : base("#u.#Qzi")
		{
            SetInstance(instance);
		}

        public R__0__Qzi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Qzi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Izi()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Izi.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__Lzi(System.Object  @ojt)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@ojt};
            var ___result = R__0__Lzi_Object.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator __0__Mzi()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Mzi.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual void __0__Nzi(System.Object  @ojt)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@ojt};
            var ___result = R__0__Nzi_Object.Invoke(___genericsType, ___parameters);

...
{public partial class R__0__64d
{
	
	/// <summary>
	/// #u.#64d+#ZA1
	/// </summary>
    public partial class R__0__ZA1 : RMember //
    {
		...
		public static RField R__0__f
		{
			get
			{
				if(r___0__f == null)
				{
					r___0__f = new( ReleactionUtils.GetType("#u.#64d+#ZA1"), "#f");
		...
		public static RField R__0__g
		{
			get
			{
				if(r___0__g == null)
				{
					r___0__g = new( ReleactionUtils.GetType("#u.#64d+#ZA1"), "#g");
		...
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__h
		{
			get
			{
				if(r___0__h == null)
				{
					r___0__h = new( ReleactionUtils.GetType("#u.#64d+#ZA1"), "#h");
		...
		/// Int32 CompareTo(#ZA1)
		/// </summary>
		protected RMethod r_RCompareTo___0__ZA1;
		public virtual RMethod RCompareTo___0__ZA1
		{
			get
			{
				if(r_RCompareTo___0__ZA1 == null)
				{
					r_RCompareTo___0__ZA1 = new(this, "CompareTo", 0,  ReleactionUtils.GetType("#u.#64d+#ZA1"));
					r_RCompareTo___0__ZA1.SetBelong(this.instance);
				}
				return r_RCompareTo___0__ZA1;
			}
		}
        ...
        public R__0__ZA1() : base("#u.#64d+#ZA1")
        {
        }

        public R__0__ZA1(System.Object instance) : base("#u.#64d+#ZA1")
		{
            SetInstance(instance);
		}

        public R__0__ZA1(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ZA1(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__uJ
{
	
	/// <summary>
	/// #u.#uJ+#bOv
	/// </summary>
    public partial class R__0__bOv : RMember //
    {
		...
		/// #u.#uJ #g
		/// </summary>
		protected R__0__u.R__0__uJ r___0__g;
		public virtual R__0__u.R__0__uJ R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__bOv() : base("#u.#uJ+#bOv")
        {
        }

        public R__0__bOv(System.Object instance) : base("#u.#uJ+#bOv")
		{
            SetInstance(instance);
		}

        public R__0__bOv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__bOv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

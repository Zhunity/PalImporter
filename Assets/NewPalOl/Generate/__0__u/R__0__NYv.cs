...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#NYv
	/// </summary>
    public partial class R__0__NYv : RMember //
    {
		...
		/// <summary>
		/// Void #ei(System.String)
		/// </summary>
		protected RMethod r_R__0__ei_String;
		public virtual RMethod R__0__ei_String
		{
			get
			{
				if(r_R__0__ei_String == null)
				{
					r_R__0__ei_String = new(this, "#ei", 0, typeof(System.String));
					r_R__0__ei_String.SetBelong(this.instance);
				}
				return r_R__0__ei_String;
			}
		}
        ...
        public R__0__NYv() : base("#u.#NYv")
        {
        }

        public R__0__NYv(System.Object instance) : base("#u.#NYv")
		{
            SetInstance(instance);
		}

        public R__0__NYv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__NYv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__ei(System.String  @ret)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@ret};
            var ___result = R__0__ei_String.Invoke(___genericsType, ___parameters);

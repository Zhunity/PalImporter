...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#fHr
	/// </summary>
    public partial class R__0__fHr : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#fHr"), "#a");
		...
		/// <summary>
		/// UIEffectInstanceHold[] #d
		/// </summary>
		protected RFieldArray<RUIEffectInstanceHold> r___0__d;
		public virtual RFieldArray<RUIEffectInstanceHold> R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// <summary>
		/// UIEffectInstanceHold #e
		/// </summary>
		protected RUIEffectInstanceHold r___0__e;
		public virtual RUIEffectInstanceHold R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// <summary>
		/// UIEffectInstanceHold #f
		/// </summary>
		protected RUIEffectInstanceHold r___0__f;
		public virtual RUIEffectInstanceHold R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// <summary>
		/// Void #cHr(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__cHr_Object___0__7X;
		public virtual RMethod R__0__cHr_Object___0__7X
		{
			get
			{
				if(r_R__0__cHr_Object___0__7X == null)
				{
					r_R__0__cHr_Object___0__7X = new(this, "#cHr", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__cHr_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__cHr_Object___0__7X;
			}
		}
		...
		/// Void #mk(#tHr)
		/// </summary>
		protected RMethod r_R__0__mk___0__tHr;
		public virtual RMethod R__0__mk___0__tHr
		{
			get
			{
				if(r_R__0__mk___0__tHr == null)
				{
					r_R__0__mk___0__tHr = new(this, "#mk", 0,  ReleactionUtils.GetType("#u.#sHr+#tHr"));
					r_R__0__mk___0__tHr.SetBelong(this.instance);
				}
				return r_R__0__mk___0__tHr;
			}
		}
		...
		/// Void #dHr(#tHr)
		/// </summary>
		protected RMethod r_R__0__dHr___0__tHr;
		public virtual RMethod R__0__dHr___0__tHr
		{
			get
			{
				if(r_R__0__dHr___0__tHr == null)
				{
					r_R__0__dHr___0__tHr = new(this, "#dHr", 0,  ReleactionUtils.GetType("#u.#sHr+#tHr"));
					r_R__0__dHr___0__tHr.SetBelong(this.instance);
				}
				return r_R__0__dHr___0__tHr;
			}
		}
		...
		/// <summary>
		/// Void #eHr(#tHr, Boolean)
		/// </summary>
		protected RMethod r_R__0__eHr___0__tHr_Boolean;
		public virtual RMethod R__0__eHr___0__tHr_Boolean
		{
			get
			{
				if(r_R__0__eHr___0__tHr_Boolean == null)
				{
					r_R__0__eHr___0__tHr_Boolean = new(this, "#eHr", 0,  ReleactionUtils.GetType("#u.#sHr+#tHr"), typeof(System.Boolean));
					r_R__0__eHr___0__tHr_Boolean.SetBelong(this.instance);
				}
				return r_R__0__eHr___0__tHr_Boolean;
			}
		}

		/// <summary>
		/// Void LoadUIEffect(Int32, System.String, MyGUI.ElementBase)
		/// </summary>
		protected RMethod r_RLoadUIEffect_Int32_String_ElementBase;
		public virtual RMethod RLoadUIEffect_Int32_String_ElementBase
		{
			get
			{
				if(r_RLoadUIEffect_Int32_String_ElementBase == null)
				{
					r_RLoadUIEffect_Int32_String_ElementBase = new(this, "LoadUIEffect", 0, typeof(System.Int32), typeof(System.String), typeof(MyGUI.ElementBase));
					r_RLoadUIEffect_Int32_String_ElementBase.SetBelong(this.instance);
				}
				return r_RLoadUIEffect_Int32_String_ElementBase;
			}
		}

		/// <summary>
		/// System.String #TCd(Int32)
		/// </summary>
		protected RMethod r_R__0__TCd_Int32;
		public virtual RMethod R__0__TCd_Int32
		{
			get
			{
				if(r_R__0__TCd_Int32 == null)
				{
					r_R__0__TCd_Int32 = new(this, "#TCd", 0, typeof(System.Int32));
					r_R__0__TCd_Int32.SetBelong(this.instance);
				}
				return r_R__0__TCd_Int32;
			}
		}
		...
		/// Void #0z(Int32)
		/// </summary>
		protected RMethod r_R__0__0z_Int32;
		public virtual RMethod R__0__0z_Int32
		{
			get
			{
				if(r_R__0__0z_Int32 == null)
				{
					r_R__0__0z_Int32 = new(this, "#0z", 0, typeof(System.Int32));
					r_R__0__0z_Int32.SetBelong(this.instance);
				}
				return r_R__0__0z_Int32;
			}
		}
		...
		/// <summary>
		/// Void ShowPetModel(GameDefineType.ID)
		/// </summary>
		protected RMethod r_RShowPetModel_ID;
		public virtual RMethod RShowPetModel_ID
		{
			get
			{
				if(r_RShowPetModel_ID == null)
				{
					r_RShowPetModel_ID = new(this, "ShowPetModel", 0, typeof(GameDefineType.ID));
					r_RShowPetModel_ID.SetBelong(this.instance);
				}
				return r_RShowPetModel_ID;
			}
		}
        ...
        public R__0__fHr() : base("#u.#fHr")
        {
        }

        public R__0__fHr(System.Object instance) : base("#u.#fHr")
		{
            SetInstance(instance);
		}

        public R__0__fHr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fHr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void LoadUIEffect(System.Int32  @idx, System.String  @name, MyGUI.ElementBase  @elem)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@idx, @name, @elem};
            var ___result = RLoadUIEffect_Int32_String_ElementBase.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.String __0__TCd(System.Int32  @level)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@level};
            var ___result = R__0__TCd_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__0z(System.Int32  @resid)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@resid};
            var ___result = R__0__0z_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual void ShowPetModel(GameDefineType.ID  @resID)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@resID};
            var ___result = RShowPetModel_ID.Invoke(___genericsType, ___parameters);

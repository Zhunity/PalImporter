...
{public partial class R__0__RJ
{
	...
	/// #u.#RJ+#xSw
	/// </summary>
    public partial class R__0__xSw : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.Dictionary`2+ValueCollection+Enumerator[GameDefineType.ID,#oU.#5bb] #a
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, RField>.RValueCollection.REnumerator r___0__a;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, RField>.RValueCollection.REnumerator R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #u.#RJ #g
		/// </summary>
		protected R__0__u.R__0__RJ r___0__g;
		public virtual R__0__u.R__0__RJ R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__xSw() : base("#u.#RJ+#xSw")
        {
        }

        public R__0__xSw(System.Object instance) : base("#u.#RJ+#xSw")
		{
            SetInstance(instance);
		}

        public R__0__xSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__xSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

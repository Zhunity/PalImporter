...
{public partial class R__0__RJ
{
	...
	/// #u.#RJ+#zSw
	/// </summary>
    public partial class R__0__zSw : RMember //
    {
		...
		/// ZHULING_CONFIG #c
		/// </summary>
		protected RZHULING_CONFIG r___0__c;
		public virtual RZHULING_CONFIG R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// ZHULING_CONFIG #d
		/// </summary>
		protected RZHULING_CONFIG r___0__d;
		public virtual RZHULING_CONFIG R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// System.Object #g
		/// </summary>
		protected RSystem.RObject r___0__g;
		public virtual RSystem.RObject R__0__g
		{
			get
			{
				if(r___0__g == null)
		...
		/// System.Object #r
		/// </summary>
		protected RSystem.RObject r___0__r;
		public virtual RSystem.RObject R__0__r
		{
			get
			{
				if(r___0__r == null)
		...
		/// System.Object #s
		/// </summary>
		protected RSystem.RObject r___0__s;
		public virtual RSystem.RObject R__0__s
		{
			get
			{
				if(r___0__s == null)
		...
		/// #u.#RJ #t
		/// </summary>
		protected R__0__u.R__0__RJ r___0__t;
		public virtual R__0__u.R__0__RJ R__0__t
		{
			get
			{
				if(r___0__t == null)
        ...
        public R__0__zSw() : base("#u.#RJ+#zSw")
        {
        }

        public R__0__zSw(System.Object instance) : base("#u.#RJ+#zSw")
		{
            SetInstance(instance);
		}

        public R__0__zSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#ZUj
	/// </summary>
    public partial class R__0__ZUj : RMember //
    {
		...
		/// MyGUI.CustomLabel #e
		/// </summary>
		protected RMyGUI.RCustomLabel r___0__e;
		public virtual RMyGUI.RCustomLabel R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// <summary>
		/// Void #XEe(Int32, Int32, MyGUI.ElementBase)
		/// </summary>
		protected RMethod r_R__0__XEe_Int32_Int32_ElementBase;
		public virtual RMethod R__0__XEe_Int32_Int32_ElementBase
		{
			get
			{
				if(r_R__0__XEe_Int32_Int32_ElementBase == null)
				{
					r_R__0__XEe_Int32_Int32_ElementBase = new(this, "#XEe", 0, typeof(System.Int32), typeof(System.Int32), typeof(MyGUI.ElementBase));
					r_R__0__XEe_Int32_Int32_ElementBase.SetBelong(this.instance);
				}
				return r_R__0__XEe_Int32_Int32_ElementBase;
			}
		}
        ...
        public R__0__ZUj() : base("#u.#ZUj")
        {
        }

        public R__0__ZUj(System.Object instance) : base("#u.#ZUj")
		{
            SetInstance(instance);
		}

        public R__0__ZUj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ZUj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__XEe(System.Int32  @id, System.Int32  @lv, MyGUI.ElementBase  @element)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id, @lv, @element};
            var ___result = R__0__XEe_Int32_Int32_ElementBase.Invoke(___genericsType, ___parameters);

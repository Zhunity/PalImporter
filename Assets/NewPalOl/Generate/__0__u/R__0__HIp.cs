...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#HIp
	/// </summary>
    public partial class R__0__HIp : RMember //
    {
		...
		/// <summary>
		/// Void #FIp(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__FIp_Object___0__7X;
		public virtual RMethod R__0__FIp_Object___0__7X
		{
			get
			{
				if(r_R__0__FIp_Object___0__7X == null)
				{
					r_R__0__FIp_Object___0__7X = new(this, "#FIp", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__FIp_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__FIp_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #GIp(System.String)
		/// </summary>
		protected RMethod r_R__0__GIp_String;
		public virtual RMethod R__0__GIp_String
		{
			get
			{
				if(r_R__0__GIp_String == null)
				{
					r_R__0__GIp_String = new(this, "#GIp", 0, typeof(System.String));
					r_R__0__GIp_String.SetBelong(this.instance);
				}
				return r_R__0__GIp_String;
			}
		}
        ...
        public R__0__HIp() : base("#u.#HIp")
        {
        }

        public R__0__HIp(System.Object instance) : base("#u.#HIp")
		{
            SetInstance(instance);
		}

        public R__0__HIp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__HIp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__GIp(System.String  @val)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@val};
            var ___result = R__0__GIp_String.Invoke(___genericsType, ___parameters);

...
{public partial class R__0__sHr
{
	
	/// <summary>
	/// #u.#sHr+#tHr
	/// </summary>
    public partial class R__0__tHr : RMember //
    {
        ...
        public R__0__tHr() : base("#u.#sHr+#tHr")
        {
        }

        public R__0__tHr(System.Object instance) : base("#u.#sHr+#tHr")
		{
            SetInstance(instance);
		}

        public R__0__tHr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__tHr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

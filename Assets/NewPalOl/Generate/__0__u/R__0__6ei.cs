...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#6ei
	/// </summary>
    public partial class R__0__6ei : RMember //
    {
		...
		/// GameDefineType.ID[] #g
		/// </summary>
		protected RFieldArray<RGameDefineType.RID> r___0__g;
		public virtual RFieldArray<RGameDefineType.RID> R__0__g
		{
			get
			{
				if(r___0__g == null)
		...
		/// Void #d2k(#u.#6ei)
		/// </summary>
		protected RMethod r_R__0__d2k___0__6ei;
		public virtual RMethod R__0__d2k___0__6ei
		{
			get
			{
				if(r_R__0__d2k___0__6ei == null)
				{
					r_R__0__d2k___0__6ei = new(this, "#d2k", 0,  ReleactionUtils.GetType("#u.#6ei"));
					r_R__0__d2k___0__6ei.SetBelong(this.instance);
				}
				return r_R__0__d2k___0__6ei;
			}
		}
        ...
        public R__0__6ei() : base("#u.#6ei")
        {
        }

        public R__0__6ei(System.Object instance) : base("#u.#6ei")
		{
            SetInstance(instance);
		}

        public R__0__6ei(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6ei(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

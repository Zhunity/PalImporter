...
{public partial class R__0__qJ
{
	
	/// <summary>
	/// #u.#qJ+#aOv
	/// </summary>
    public partial class R__0__aOv : RMember //
    {
		...
		/// #u.#qJ #i
		/// </summary>
		protected R__0__u.R__0__qJ r___0__i;
		public virtual R__0__u.R__0__qJ R__0__i
		{
			get
			{
				if(r___0__i == null)
        ...
        public R__0__aOv() : base("#u.#qJ+#aOv")
        {
        }

        public R__0__aOv(System.Object instance) : base("#u.#qJ+#aOv")
		{
            SetInstance(instance);
		}

        public R__0__aOv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__aOv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

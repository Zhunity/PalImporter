...
{public partial class R__0__iF
{
	...
	/// #u.#iF+#9Rw
	/// </summary>
    public partial class R__0__9Rw : RMember //
    {
        ...
        public R__0__9Rw() : base("#u.#iF+#9Rw")
        {
        }

        public R__0__9Rw(System.Object instance) : base("#u.#iF+#9Rw")
		{
            SetInstance(instance);
		}

        public R__0__9Rw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Rw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

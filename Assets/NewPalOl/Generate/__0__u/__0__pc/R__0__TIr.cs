...
{public partial class R__0__pc
{
	...
	/// #u.#pc+#TIr
	/// </summary>
    public partial class R__0__TIr : RMember //
    {
		...
		/// #u.#pc #k
		/// </summary>
		protected R__0__u.R__0__pc r___0__k;
		public virtual R__0__u.R__0__pc R__0__k
		{
			get
			{
				if(r___0__k == null)
        ...
        public R__0__TIr() : base("#u.#pc+#TIr")
        {
        }

        public R__0__TIr(System.Object instance) : base("#u.#pc+#TIr")
		{
            SetInstance(instance);
		}

        public R__0__TIr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__TIr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

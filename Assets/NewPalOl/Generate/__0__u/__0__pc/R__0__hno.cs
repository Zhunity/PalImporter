...
{public partial class R__0__pc
{
    ...
    public partial class R__0__hno : RMember //
    {
		...
		/// <summary>
		/// AvatarController+weaponInfo #i
		/// </summary>
		protected RAvatarController.RweaponInfo r___0__i;
		public virtual RAvatarController.RweaponInfo R__0__i
		{
			get
			{
				if(r___0__i == null)
        ...
        public R__0__hno() : base("#u.#pc+#hno")
        {
        }

        public R__0__hno(System.Object instance) : base("#u.#pc+#hno")
		{

...
{public partial class R__0__12p
{
	...
	/// #u.#12p+#SAu
	/// </summary>
    public partial class R__0__SAu : RMember //
    {
		...
		/// #u.#12p #e
		/// </summary>
		protected R__0__u.R__0__12p r___0__e;
		public virtual R__0__u.R__0__12p R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__SAu() : base("#u.#12p+#SAu")
        {
        }

        public R__0__SAu(System.Object instance) : base("#u.#12p+#SAu")
		{
            SetInstance(instance);
		}

        public R__0__SAu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__SAu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

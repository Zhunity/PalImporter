...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#tXd
	/// </summary>
    public partial class R__0__tXd : RMember //
    {
		...
		/// #u.#3mb+#jOb1 #d
		/// </summary>
		protected static R__0__u.R__0__3mb.R__0__jOb1 r___0__d;
		public static R__0__u.R__0__3mb.R__0__jOb1 R__0__d
		{
			get
			{
				if(r___0__d == null)
				{
					r___0__d = new( ReleactionUtils.GetType("#u.#tXd"), "#d");
		...
		/// Void #7Fc(Int32)
		/// </summary>
		protected RMethod r_R__0__7Fc_Int32;
		public virtual RMethod R__0__7Fc_Int32
		{
			get
			{
				if(r_R__0__7Fc_Int32 == null)
				{
					r_R__0__7Fc_Int32 = new(this, "#7Fc", 0, typeof(System.Int32));
					r_R__0__7Fc_Int32.SetBelong(this.instance);
				}
				return r_R__0__7Fc_Int32;
			}
		}
		...
		/// <summary>
		/// Void #WKe(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__WKe_Object___0__7X;
		public virtual RMethod R__0__WKe_Object___0__7X
		{
			get
			{
				if(r_R__0__WKe_Object___0__7X == null)
				{
					r_R__0__WKe_Object___0__7X = new(this, "#WKe", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__WKe_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__WKe_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #UKe(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__UKe_Object___0__7X;
		public virtual RMethod R__0__UKe_Object___0__7X
		{
			get
			{
				if(r_R__0__UKe_Object___0__7X == null)
				{
					r_R__0__UKe_Object___0__7X = new(this, "#UKe", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__UKe_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__UKe_Object___0__7X;
			}
		}
		...
		/// Void #VKe(Int32)
		/// </summary>
		protected RMethod r_R__0__VKe_Int32;
		public virtual RMethod R__0__VKe_Int32
		{
			get
			{
				if(r_R__0__VKe_Int32 == null)
				{
					r_R__0__VKe_Int32 = new(this, "#VKe", 0, typeof(System.Int32));
					r_R__0__VKe_Int32.SetBelong(this.instance);
				}
				return r_R__0__VKe_Int32;
			}
		}
		...
		/// Void #XKe(Boolean)
		/// </summary>
		protected RMethod r_R__0__XKe_Boolean;
		public virtual RMethod R__0__XKe_Boolean
		{
			get
			{
				if(r_R__0__XKe_Boolean == null)
				{
					r_R__0__XKe_Boolean = new(this, "#XKe", 0, typeof(System.Boolean));
					r_R__0__XKe_Boolean.SetBelong(this.instance);
				}
				return r_R__0__XKe_Boolean;
			}
		}
		...
		/// Boolean #nKq(#u.#Ckb)
		/// </summary>
		protected static RMethod r_R__0__nKq___0__Ckb;
		public static RMethod R__0__nKq___0__Ckb
		{
			get
			{
				if(r_R__0__nKq___0__Ckb == null)
				{
					r_R__0__nKq___0__Ckb = new( ReleactionUtils.GetType("#u.#tXd"), "#nKq", 0,  ReleactionUtils.GetType("#u.#Ckb"));
					r_R__0__nKq___0__Ckb.SetBelong(null);
				}
				return r_R__0__nKq___0__Ckb;
			}
		}
        ...
        public R__0__tXd() : base("#u.#tXd")
        {
        }

        public R__0__tXd(System.Object instance) : base("#u.#tXd")
		{
            SetInstance(instance);
		}

        public R__0__tXd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__tXd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__7Fc(System.Int32  @seconds)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@seconds};
            var ___result = R__0__7Fc_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__VKe(System.Int32  @rate)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@rate};
            var ___result = R__0__VKe_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__XKe(System.Boolean  @bEnable)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bEnable};
            var ___result = R__0__XKe_Boolean.Invoke(___genericsType, ___parameters);

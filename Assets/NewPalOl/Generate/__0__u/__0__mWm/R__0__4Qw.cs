...
{public partial class R__0__mWm
{
	...
	/// #u.#mWm+#4Qw
	/// </summary>
    public partial class R__0__4Qw : RMember //
    {
		...
		/// #u.#mWm #e
		/// </summary>
		protected R__0__u.R__0__mWm r___0__e;
		public virtual R__0__u.R__0__mWm R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__4Qw() : base("#u.#mWm+#4Qw")
        {
        }

        public R__0__4Qw(System.Object instance) : base("#u.#mWm+#4Qw")
		{
            SetInstance(instance);
		}

        public R__0__4Qw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4Qw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Uah
	/// </summary>
    public partial class R__0__Uah : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#Uah"), "#a");
		...
		public static RField R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#Uah"), "#b");
		...
		/// #Pfb.#xeh #d
		/// </summary>
		protected R__0__Pfb.R__0__xeh r___0__d;
		public virtual R__0__Pfb.R__0__xeh R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// Void #Rah(#Pfb.#xeh)
		/// </summary>
		protected RMethod r_R__0__Rah___0__xeh;
		public virtual RMethod R__0__Rah___0__xeh
		{
			get
			{
				if(r_R__0__Rah___0__xeh == null)
				{
					r_R__0__Rah___0__xeh = new(this, "#Rah", 0,  ReleactionUtils.GetType("#Pfb.#xeh"));
					r_R__0__Rah___0__xeh.SetBelong(this.instance);
				}
				return r_R__0__Rah___0__xeh;
			}
		}
		...
		/// <summary>
		/// Void #vmh(System.Object)
		/// </summary>
		protected RMethod r_R__0__vmh_Object;
		public virtual RMethod R__0__vmh_Object
		{
			get
			{
				if(r_R__0__vmh_Object == null)
				{
					r_R__0__vmh_Object = new(this, "#vmh", 0, typeof(System.Object));
					r_R__0__vmh_Object.SetBelong(this.instance);
				}
				return r_R__0__vmh_Object;
			}
		}

		/// <summary>
		/// Void #Sah(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Sah_Object___0__7X;
		public virtual RMethod R__0__Sah_Object___0__7X
		{
			get
			{
				if(r_R__0__Sah_Object___0__7X == null)
				{
					r_R__0__Sah_Object___0__7X = new(this, "#Sah", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Sah_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Sah_Object___0__7X;
			}
		}
        ...
        public R__0__Uah() : base("#u.#Uah")
        {
        }

        public R__0__Uah(System.Object instance) : base("#u.#Uah")
		{
            SetInstance(instance);
		}

        public R__0__Uah(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Uah(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__vmh(System.Object  @obj)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@obj};
            var ___result = R__0__vmh_Object.Invoke(___genericsType, ___parameters);

...
{public partial class R__0__zKk
{
	
	/// <summary>
	/// #u.#zKk+#fmx
	/// </summary>
    public partial class R__0__fmx : RMember //
    {
		...
		/// #u.#zKk #h
		/// </summary>
		protected R__0__u.R__0__zKk r___0__h;
		public virtual R__0__u.R__0__zKk R__0__h
		{
			get
			{
				if(r___0__h == null)
        ...
        public R__0__fmx() : base("#u.#zKk+#fmx")
        {
        }

        public R__0__fmx(System.Object instance) : base("#u.#zKk+#fmx")
		{
            SetInstance(instance);
		}

        public R__0__fmx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fmx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

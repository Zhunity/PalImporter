...
{public partial class R__0__AIc
{
	...
	/// #u.#AIc+#BIc
	/// </summary>
    public partial class R__0__BIc : RMember //
    {
        ...
        public R__0__BIc() : base("#u.#AIc+#BIc")
        {
        }

        public R__0__BIc(System.Object instance) : base("#u.#AIc+#BIc")
		{
            SetInstance(instance);
		}

        public R__0__BIc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__BIc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__AIc
{
	
	/// <summary>
	/// #u.#AIc+#tYw
	/// </summary>
    public partial class R__0__tYw : RMember //
    {
		...
		/// #u.#AIc #d
		/// </summary>
		protected R__0__u.R__0__AIc r___0__d;
		public virtual R__0__u.R__0__AIc R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__tYw() : base("#u.#AIc+#tYw")
        {
        }

        public R__0__tYw(System.Object instance) : base("#u.#AIc+#tYw")
		{
            SetInstance(instance);
		}

        public R__0__tYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__tYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#3bg
	/// </summary>
    public partial class R__0__3bg : RMember //
    {
		...
		/// Void #1bg(Boolean)
		/// </summary>
		protected RMethod r_R__0__1bg_Boolean;
		public virtual RMethod R__0__1bg_Boolean
		{
			get
			{
				if(r_R__0__1bg_Boolean == null)
				{
					r_R__0__1bg_Boolean = new(this, "#1bg", 0, typeof(System.Boolean));
					r_R__0__1bg_Boolean.SetBelong(this.instance);
				}
				return r_R__0__1bg_Boolean;
			}
		}

		/// <summary>
		/// Void #2bg(System.String)
		/// </summary>
		protected RMethod r_R__0__2bg_String;
		public virtual RMethod R__0__2bg_String
		{
			get
			{
				if(r_R__0__2bg_String == null)
				{
					r_R__0__2bg_String = new(this, "#2bg", 0, typeof(System.String));
					r_R__0__2bg_String.SetBelong(this.instance);
				}
				return r_R__0__2bg_String;
			}
		}
        ...
        public R__0__3bg() : base("#u.#3bg")
        {
        }

        public R__0__3bg(System.Object instance) : base("#u.#3bg")
		{
            SetInstance(instance);
		}

        public R__0__3bg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3bg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__1bg(System.Boolean  @bWin)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bWin};
            var ___result = R__0__1bg_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__2bg(System.String  @info)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@info};
            var ___result = R__0__2bg_String.Invoke(___genericsType, ___parameters);

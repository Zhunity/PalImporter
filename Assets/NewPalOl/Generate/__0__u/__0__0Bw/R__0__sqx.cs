...
{public partial class R__0__0Bw
{
	
	/// <summary>
	/// #u.#0Bw+#sqx
	/// </summary>
    public partial class R__0__sqx : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.Animation #b
		/// </summary>
		protected RUnityEngine.RAnimation r___0__b;
		public virtual RUnityEngine.RAnimation R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// #u.#0Bw #o
		/// </summary>
		protected R__0__u.R__0__0Bw r___0__o;
		public virtual R__0__u.R__0__0Bw R__0__o
		{
			get
			{
				if(r___0__o == null)
        ...
        public R__0__sqx() : base("#u.#0Bw+#sqx")
        {
        }

        public R__0__sqx(System.Object instance) : base("#u.#0Bw+#sqx")
		{
            SetInstance(instance);
		}

        public R__0__sqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__sqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

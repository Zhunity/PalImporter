...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#n4q
	/// </summary>
    public partial class R__0__n4q : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#n4q"), "#a");
		...
		public static RField R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#n4q"), "#b");
		...
		public static RField R__0__c
		{
			get
			{
				if(r___0__c == null)
				{
					r___0__c = new( ReleactionUtils.GetType("#u.#n4q"), "#c");
		...
		/// ChildQualityUp #f
		/// </summary>
		protected RChildQualityUp r___0__f;
		public virtual RChildQualityUp R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// <summary>
		/// Void #m4q(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__m4q_Object___0__7X;
		public virtual RMethod R__0__m4q_Object___0__7X
		{
			get
			{
				if(r_R__0__m4q_Object___0__7X == null)
				{
					r_R__0__m4q_Object___0__7X = new(this, "#m4q", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__m4q_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__m4q_Object___0__7X;
			}
		}
        ...
        public R__0__n4q() : base("#u.#n4q")
        {
        }

        public R__0__n4q(System.Object instance) : base("#u.#n4q")
		{
            SetInstance(instance);
		}

        public R__0__n4q(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__n4q(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#dNs
	/// </summary>
    public partial class R__0__dNs : RMember //
    {
		...
		/// Void #Kb(#Pfb.#hOs)
		/// </summary>
		protected RMethod r_R__0__Kb___0__hOs;
		public virtual RMethod R__0__Kb___0__hOs
		{
			get
			{
				if(r_R__0__Kb___0__hOs == null)
				{
					r_R__0__Kb___0__hOs = new(this, "#Kb", 0,  ReleactionUtils.GetType("#Pfb.#hOs"));
					r_R__0__Kb___0__hOs.SetBelong(this.instance);
				}
				return r_R__0__Kb___0__hOs;
			}
		}
        ...
        public R__0__dNs() : base("#u.#dNs")
        {
        }

        public R__0__dNs(System.Object instance) : base("#u.#dNs")
		{
            SetInstance(instance);
		}

        public R__0__dNs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dNs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__hcg
{
	
	/// <summary>
	/// #u.#hcg+#Eqx
	/// </summary>
    public partial class R__0__Eqx : RMember //
    {
		...
		/// #u.#hcg #i
		/// </summary>
		protected R__0__u.R__0__hcg r___0__i;
		public virtual R__0__u.R__0__hcg R__0__i
		{
			get
			{
				if(r___0__i == null)
        ...
        public R__0__Eqx() : base("#u.#hcg+#Eqx")
        {
        }

        public R__0__Eqx(System.Object instance) : base("#u.#hcg+#Eqx")
		{
            SetInstance(instance);
		}

        public R__0__Eqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Eqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

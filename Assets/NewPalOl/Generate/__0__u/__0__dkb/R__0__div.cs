...
{public partial class R__0__dkb
{
	
	/// <summary>
	/// #u.#dkb+#div
	/// </summary>
    public partial class R__0__div : RMember //
    {
		...
		/// #u.#dkb #h
		/// </summary>
		protected R__0__u.R__0__dkb r___0__h;
		public virtual R__0__u.R__0__dkb R__0__h
		{
			get
			{
				if(r___0__h == null)
        ...
        public R__0__div() : base("#u.#dkb+#div")
        {
        }

        public R__0__div(System.Object instance) : base("#u.#dkb+#div")
		{
            SetInstance(instance);
		}

        public R__0__div(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__div(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#iWm
	/// </summary>
    public partial class R__0__iWm : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#iWm"), "#a");
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.String,System.Boolean] #c
		/// </summary>
		...
		/// Void #cWm(#Pfb.#vYm)
		/// </summary>
		protected RMethod r_R__0__cWm___0__vYm;
		public virtual RMethod R__0__cWm___0__vYm
		{
			get
			{
				if(r_R__0__cWm___0__vYm == null)
				{
					r_R__0__cWm___0__vYm = new(this, "#cWm", 0,  ReleactionUtils.GetType("#Pfb.#vYm"));
					r_R__0__cWm___0__vYm.SetBelong(this.instance);
				}
				return r_R__0__cWm___0__vYm;
			}
		}
		...
		/// Void #yKk(#Pfb.#uYm)
		/// </summary>
		protected RMethod r_R__0__yKk___0__uYm;
		public virtual RMethod R__0__yKk___0__uYm
		{
			get
			{
				if(r_R__0__yKk___0__uYm == null)
				{
					r_R__0__yKk___0__uYm = new(this, "#yKk", 0,  ReleactionUtils.GetType("#Pfb.#uYm"));
					r_R__0__yKk___0__uYm.SetBelong(this.instance);
				}
				return r_R__0__yKk___0__uYm;
			}
		}
		...
		/// Void #eWm(Int32)
		/// </summary>
		protected RMethod r_R__0__eWm_Int32;
		public virtual RMethod R__0__eWm_Int32
		{
			get
			{
				if(r_R__0__eWm_Int32 == null)
				{
					r_R__0__eWm_Int32 = new(this, "#eWm", 0, typeof(System.Int32));
					r_R__0__eWm_Int32.SetBelong(this.instance);
				}
				return r_R__0__eWm_Int32;
			}
		}
		...
		/// Void #fWm(Int32)
		/// </summary>
		protected RMethod r_R__0__fWm_Int32;
		public virtual RMethod R__0__fWm_Int32
		{
			get
			{
				if(r_R__0__fWm_Int32 == null)
				{
					r_R__0__fWm_Int32 = new(this, "#fWm", 0, typeof(System.Int32));
					r_R__0__fWm_Int32.SetBelong(this.instance);
				}
				return r_R__0__fWm_Int32;
			}
		}

		/// <summary>
		/// Void #gWm(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__gWm_Object___0__7X;
		public virtual RMethod R__0__gWm_Object___0__7X
		{
			get
			{
				if(r_R__0__gWm_Object___0__7X == null)
				{
					r_R__0__gWm_Object___0__7X = new(this, "#gWm", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__gWm_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__gWm_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #hWm(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__hWm_Object___0__7X;
		public virtual RMethod R__0__hWm_Object___0__7X
		{
			get
			{
				if(r_R__0__hWm_Object___0__7X == null)
				{
					r_R__0__hWm_Object___0__7X = new(this, "#hWm", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__hWm_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__hWm_Object___0__7X;
			}
		}
        ...
        public R__0__iWm() : base("#u.#iWm")
        {
        }

        public R__0__iWm(System.Object instance) : base("#u.#iWm")
		{
            SetInstance(instance);
		}

        public R__0__iWm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__iWm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__eWm(System.Int32  @i)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@i};
            var ___result = R__0__eWm_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__fWm(System.Int32  @level)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@level};
            var ___result = R__0__fWm_Int32.Invoke(___genericsType, ___parameters);

...
{public partial class R__0__jFw
{
	
	/// <summary>
	/// #u.#jFw+#2Qw
	/// </summary>
    public partial class R__0__2Qw : RMember //
    {
		...
		/// #u.#jFw #p
		/// </summary>
		protected R__0__u.R__0__jFw r___0__p;
		public virtual R__0__u.R__0__jFw R__0__p
		{
			get
			{
				if(r___0__p == null)
        ...
        public R__0__2Qw() : base("#u.#jFw+#2Qw")
        {
        }

        public R__0__2Qw(System.Object instance) : base("#u.#jFw+#2Qw")
		{
            SetInstance(instance);
		}

        public R__0__2Qw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2Qw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

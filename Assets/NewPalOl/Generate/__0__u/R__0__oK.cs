...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#oK
	/// </summary>
    public partial class R__0__oK : RMember //
    {

		/// <summary>
		/// #oU.#I4 #a
		/// </summary>
		protected R__0__oU.R__0__I4 r___0__a;
		public virtual R__0__oU.R__0__I4 R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// Void #mK(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__mK_Object___0__7X;
		public virtual RMethod R__0__mK_Object___0__7X
		{
			get
			{
				if(r_R__0__mK_Object___0__7X == null)
				{
					r_R__0__mK_Object___0__7X = new(this, "#mK", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__mK_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__mK_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #nK(System.String)
		/// </summary>
		protected RMethod r_R__0__nK_String;
		public virtual RMethod R__0__nK_String
		{
			get
			{
				if(r_R__0__nK_String == null)
				{
					r_R__0__nK_String = new(this, "#nK", 0, typeof(System.String));
					r_R__0__nK_String.SetBelong(this.instance);
				}
				return r_R__0__nK_String;
			}
		}
        ...
        public R__0__oK() : base("#u.#oK")
        {
        }

        public R__0__oK(System.Object instance) : base("#u.#oK")
		{
            SetInstance(instance);
		}

        public R__0__oK(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oK(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__nK(System.String  @notice)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@notice};
            var ___result = R__0__nK_String.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#wq
	/// </summary>
    public partial class R__0__wq : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#wq"), "#a");
		...
		/// BitTexture #c
		/// </summary>
		protected RBitTexture r___0__c;
		public virtual RBitTexture R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// BitTexture #d
		/// </summary>
		protected RBitTexture r___0__d;
		public virtual RBitTexture R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// <summary>
		/// BitTexture BTFlower0
		/// </summary>
		protected RBitTexture r_R__0__sq;
		public virtual RBitTexture R__0__sq
		{
			get
			{
				if(r_R__0__sq == null)
				{
					r_R__0__sq = new(this, "BTFlower0", -1);
					r_R__0__sq.SetBelong(this.instance);
				}
				return r_R__0__sq;
			}
		}
		...
		/// <summary>
		/// BitTexture BTFlower1
		/// </summary>
		protected RBitTexture r_R__0__tq;
		public virtual RBitTexture R__0__tq
		{
			get
			{
				if(r_R__0__tq == null)
				{
					r_R__0__tq = new(this, "BTFlower1", -1);
					r_R__0__tq.SetBelong(this.instance);
				}
				return r_R__0__tq;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator #uq()
		/// </summary>
		protected RMethod r_R__0__uq;
		public virtual RMethod R__0__uq
		{
			get
			{
				if(r_R__0__uq == null)
				{
					r_R__0__uq = new(this, "#uq", 0);
					r_R__0__uq.SetBelong(this.instance);
				}
				return r_R__0__uq;
			}
		}
		...
		/// <summary>
		/// Void #He(System.String, Int32, Int32, GameDefineType.ID, System.String)
		/// </summary>
		protected RMethod r_R__0__He_String_Int32_Int32_ID_String;
		public virtual RMethod R__0__He_String_Int32_Int32_ID_String
		{
			get
			{
				if(r_R__0__He_String_Int32_Int32_ID_String == null)
				{
					r_R__0__He_String_Int32_Int32_ID_String = new(this, "#He", 0, typeof(System.String), typeof(System.Int32), typeof(System.Int32), typeof(GameDefineType.ID), typeof(System.String));
					r_R__0__He_String_Int32_Int32_ID_String.SetBelong(this.instance);
				}
				return r_R__0__He_String_Int32_Int32_ID_String;
			}
		}

		/// <summary>
		/// Void #vq(System.String, Int32, Int32, GameDefineType.ID, System.String)
		/// </summary>
		protected RMethod r_R__0__vq_String_Int32_Int32_ID_String;
		public virtual RMethod R__0__vq_String_Int32_Int32_ID_String
		{
			get
			{
				if(r_R__0__vq_String_Int32_Int32_ID_String == null)
				{
					r_R__0__vq_String_Int32_Int32_ID_String = new(this, "#vq", 0, typeof(System.String), typeof(System.Int32), typeof(System.Int32), typeof(GameDefineType.ID), typeof(System.String));
					r_R__0__vq_String_Int32_Int32_ID_String.SetBelong(this.instance);
				}
				return r_R__0__vq_String_Int32_Int32_ID_String;
			}
		}
		...
		/// <summary>
		/// Void #f9c(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__f9c_Object___0__7X;
		public virtual RMethod R__0__f9c_Object___0__7X
		{
			get
			{
				if(r_R__0__f9c_Object___0__7X == null)
				{
					r_R__0__f9c_Object___0__7X = new(this, "#f9c", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__f9c_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__f9c_Object___0__7X;
			}
		}
        ...
        public R__0__wq() : base("#u.#wq")
        {
        }

        public R__0__wq(System.Object instance) : base("#u.#wq")
		{
            SetInstance(instance);
		}

        public R__0__wq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__wq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Collections.IEnumerator __0__uq()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__uq.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual void __0__He(System.String  @name, System.Int32  @flowernum, System.Int32  @type, GameDefineType.ID  @playid, System.String  @text)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@name, @flowernum, @type, @playid, @text};
            var ___result = R__0__He_String_Int32_Int32_ID_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__vq(System.String  @name, System.Int32  @flowernum, System.Int32  @type, GameDefineType.ID  @playid, System.String  @text)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@name, @flowernum, @type, @playid, @text};
            var ___result = R__0__vq_String_Int32_Int32_ID_String.Invoke(___genericsType, ___parameters);

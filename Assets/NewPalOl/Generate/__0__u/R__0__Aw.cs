...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Aw
	/// </summary>
    public partial class R__0__Aw : RMember //
    {
        ...
        public R__0__Aw() : base("#u.#Aw")
        {
        }

        public R__0__Aw(System.Object instance) : base("#u.#Aw")
		{
            SetInstance(instance);
		}

        public R__0__Aw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Aw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__LE
{
	...
	/// #u.#LE+#7Rw
	/// </summary>
    public partial class R__0__7Rw : RMember //
    {
        ...
        public R__0__7Rw() : base("#u.#LE+#7Rw")
        {
        }

        public R__0__7Rw(System.Object instance) : base("#u.#LE+#7Rw")
		{
            SetInstance(instance);
		}

        public R__0__7Rw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7Rw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__LE
{
	...
	/// #u.#LE+#6Rw
	/// </summary>
    public partial class R__0__6Rw : RMember //
    {
		...
		/// #u.#LE #g
		/// </summary>
		protected R__0__u.R__0__LE r___0__g;
		public virtual R__0__u.R__0__LE R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__6Rw() : base("#u.#LE+#6Rw")
        {
        }

        public R__0__6Rw(System.Object instance) : base("#u.#LE+#6Rw")
		{
            SetInstance(instance);
		}

        public R__0__6Rw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6Rw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

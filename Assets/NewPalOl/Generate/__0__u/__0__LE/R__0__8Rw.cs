...
{public partial class R__0__LE
{
	
	/// <summary>
	/// #u.#LE+#8Rw
	/// </summary>
    public partial class R__0__8Rw : RMember //
    {
		...
		/// #u.#LE #n
		/// </summary>
		protected R__0__u.R__0__LE r___0__n;
		public virtual R__0__u.R__0__LE R__0__n
		{
			get
			{
				if(r___0__n == null)
        ...
        public R__0__8Rw() : base("#u.#LE+#8Rw")
        {
        }

        public R__0__8Rw(System.Object instance) : base("#u.#LE+#8Rw")
		{
            SetInstance(instance);
		}

        public R__0__8Rw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Rw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

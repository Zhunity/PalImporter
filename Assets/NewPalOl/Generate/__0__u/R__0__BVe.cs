...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#BVe
	/// </summary>
    public partial class R__0__BVe : RMember //
    {
		...
		/// </summary>
		protected RFieldArray<RMyGUI.RColorTextArea> r___0__b;
		public virtual RFieldArray<RMyGUI.RColorTextArea> R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// Void #G8e()
		/// </summary>
		protected RMethod r_R__0__G8e;
		public virtual RMethod R__0__G8e
		{
			get
			{
				if(r_R__0__G8e == null)
				{
					r_R__0__G8e = new(this, "#G8e", 0);
					r_R__0__G8e.SetBelong(this.instance);
				}
				return r_R__0__G8e;
			}
		}
		...
		/// <summary>
		/// Void #Xd(Int32, GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__Xd_Int32_ID;
		public virtual RMethod R__0__Xd_Int32_ID
		{
			get
			{
				if(r_R__0__Xd_Int32_ID == null)
				{
					r_R__0__Xd_Int32_ID = new(this, "#Xd", 0, typeof(System.Int32), typeof(GameDefineType.ID));
					r_R__0__Xd_Int32_ID.SetBelong(this.instance);
				}
				return r_R__0__Xd_Int32_ID;
			}
		}
        ...
        public R__0__BVe() : base("#u.#BVe")
        {
        }

        public R__0__BVe(System.Object instance) : base("#u.#BVe")
		{
            SetInstance(instance);
		}

        public R__0__BVe(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__BVe(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__G8e()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__G8e.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__Xd(System.Int32  @index, GameDefineType.ID  @configId)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@index, @configId};
            var ___result = R__0__Xd_Int32_ID.Invoke(___genericsType, ___parameters);

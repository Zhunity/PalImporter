...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#WP
	/// </summary>
    public partial class R__0__WP : RMember //
    {
		...
		/// <summary>
		/// Int32 CompareTo(#u.#WP)
		/// </summary>
		protected RMethod r_RCompareTo___0__WP;
		public virtual RMethod RCompareTo___0__WP
		{
			get
			{
				if(r_RCompareTo___0__WP == null)
				{
					r_RCompareTo___0__WP = new(this, "CompareTo", 0,  ReleactionUtils.GetType("#u.#WP"));
					r_RCompareTo___0__WP.SetBelong(this.instance);
				}
				return r_RCompareTo___0__WP;
			}
		}
        ...
        public R__0__WP() : base("#u.#WP")
        {
        }

        public R__0__WP(System.Object instance) : base("#u.#WP")
		{
            SetInstance(instance);
		}

        public R__0__WP(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__WP(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__6We
{
	
	/// <summary>
	/// #u.#6We+#Qmv
	/// </summary>
    public partial class R__0__Qmv : RMember //
    {
		...
		/// #u.#6We #h
		/// </summary>
		protected R__0__u.R__0__6We r___0__h;
		public virtual R__0__u.R__0__6We R__0__h
		{
			get
			{
				if(r___0__h == null)
        ...
        public R__0__Qmv() : base("#u.#6We+#Qmv")
        {
        }

        public R__0__Qmv(System.Object instance) : base("#u.#6We+#Qmv")
		{
            SetInstance(instance);
		}

        public R__0__Qmv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Qmv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

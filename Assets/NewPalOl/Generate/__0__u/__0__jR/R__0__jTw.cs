...
{public partial class R__0__jR
{
	...
	/// #u.#jR+#jTw
	/// </summary>
    public partial class R__0__jTw : RMember //
    {
		...
		/// #u.#jR #c
		/// </summary>
		protected R__0__u.R__0__jR r___0__c;
		public virtual R__0__u.R__0__jR R__0__c
		{
			get
			{
				if(r___0__c == null)
        ...
        public R__0__jTw() : base("#u.#jR+#jTw")
        {
        }

        public R__0__jTw(System.Object instance) : base("#u.#jR+#jTw")
		{
            SetInstance(instance);
		}

        public R__0__jTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

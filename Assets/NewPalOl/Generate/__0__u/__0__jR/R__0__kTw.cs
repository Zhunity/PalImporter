...
{public partial class R__0__jR
{
	...
	/// #u.#jR+#kTw
	/// </summary>
    public partial class R__0__kTw : RMember //
    {

		/// <summary>
		/// UnityEngine.Ping #a
		/// </summary>
		protected RUnityEngine.RPing r___0__a;
		public virtual RUnityEngine.RPing R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #u.#jR #d
		/// </summary>
		protected R__0__u.R__0__jR r___0__d;
		public virtual R__0__u.R__0__jR R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__kTw() : base("#u.#jR+#kTw")
        {
        }

        public R__0__kTw(System.Object instance) : base("#u.#jR+#kTw")
		{
            SetInstance(instance);
		}

        public R__0__kTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__kTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

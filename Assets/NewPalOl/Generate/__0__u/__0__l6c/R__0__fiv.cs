...
{public partial class R__0__l6c
{
    ...
    public partial class R__0__fiv : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RObject r___0__a;
		public virtual RUnityEngine.RObject R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// TransPointsHold #b
		/// </summary>
		protected RTransPointsHold r___0__b;
		public virtual RTransPointsHold R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1+Enumerator[TransformInfo] #c
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RField>.REnumerator r___0__c;
		public virtual RSystem.RCollections.RGeneric.RList<RField>.REnumerator R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// TransformInfo #d
		/// </summary>
		protected RTransformInfo r___0__d;
		public virtual RTransformInfo R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// <summary>
		/// UnityEngine.Object #g
		/// </summary>
		protected RUnityEngine.RObject r___0__g;
		public virtual RUnityEngine.RObject R__0__g
		{
			get
			{
				if(r___0__g == null)
		...
		/// #u.#l6c #h
		/// </summary>
		protected R__0__u.R__0__l6c r___0__h;
		public virtual R__0__u.R__0__l6c R__0__h
		{
			get
			{
				if(r___0__h == null)
        ...
        public R__0__fiv() : base("#u.#l6c+#fiv")
        {
        }

        public R__0__fiv(System.Object instance) : base("#u.#l6c+#fiv")
		{

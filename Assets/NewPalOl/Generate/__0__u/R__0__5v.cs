...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#5v
	/// </summary>
    public partial class R__0__5v : RMember //
    {
		...
		/// Void #4v(#u.#hw)
		/// </summary>
		protected RMethod r_R__0__4v___0__hw;
		public virtual RMethod R__0__4v___0__hw
		{
			get
			{
				if(r_R__0__4v___0__hw == null)
				{
					r_R__0__4v___0__hw = new(this, "#4v", 0,  ReleactionUtils.GetType("#u.#hw"));
					r_R__0__4v___0__hw.SetBelong(this.instance);
				}
				return r_R__0__4v___0__hw;
			}
		}
        ...
        public R__0__5v() : base("#u.#5v")
        {
        }

        public R__0__5v(System.Object instance) : base("#u.#5v")
		{
            SetInstance(instance);
		}

        public R__0__5v(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5v(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

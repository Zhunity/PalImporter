...
{public partial class R__0__ion
{
	...
	/// #u.#ion+#gYw
	/// </summary>
    public partial class R__0__gYw : RMember //
    {
		...
		/// <summary>
		/// AssetBundleDownloader+AB_DOWNLOADER_ARGS #b
		/// </summary>
		protected RAssetBundleDownloader.RAB_DOWNLOADER_ARGS r___0__b;
		public virtual RAssetBundleDownloader.RAB_DOWNLOADER_ARGS R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// #u.#ion #g
		/// </summary>
		protected R__0__u.R__0__ion r___0__g;
		public virtual R__0__u.R__0__ion R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__gYw() : base("#u.#ion+#gYw")
        {
        }

        public R__0__gYw(System.Object instance) : base("#u.#ion+#gYw")
		{
            SetInstance(instance);
		}

        public R__0__gYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

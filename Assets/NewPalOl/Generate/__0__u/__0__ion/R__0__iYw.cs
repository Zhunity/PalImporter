...
{public partial class R__0__ion
{
	...
	/// #u.#ion+#iYw
	/// </summary>
    public partial class R__0__iYw : RMember //
    {
		...
		/// #u.#ion #c
		/// </summary>
		protected R__0__u.R__0__ion r___0__c;
		public virtual R__0__u.R__0__ion R__0__c
		{
			get
			{
				if(r___0__c == null)
        ...
        public R__0__iYw() : base("#u.#ion+#iYw")
        {
        }

        public R__0__iYw(System.Object instance) : base("#u.#ion+#iYw")
		{
            SetInstance(instance);
		}

        public R__0__iYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__iYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

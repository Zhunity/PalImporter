...
{public partial class R__0__ion
{
	
	/// <summary>
	/// #u.#ion+#hYw
	/// </summary>
    public partial class R__0__hYw : RMember //
    {

		/// <summary>
		/// UnityEngine.Animation #a
		/// </summary>
		protected RUnityEngine.RAnimation r___0__a;
		public virtual RUnityEngine.RAnimation R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// PATH_FIND_STRUCT #h
		/// </summary>
		protected RPATH_FIND_STRUCT r___0__h;
		public virtual RPATH_FIND_STRUCT R__0__h
		{
			get
			{
				if(r___0__h == null)
		...
		/// #u.#ion #l
		/// </summary>
		protected R__0__u.R__0__ion r___0__l;
		public virtual R__0__u.R__0__ion R__0__l
		{
			get
			{
				if(r___0__l == null)
        ...
        public R__0__hYw() : base("#u.#ion+#hYw")
        {
        }

        public R__0__hYw(System.Object instance) : base("#u.#ion+#hYw")
		{
            SetInstance(instance);
		}

        public R__0__hYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

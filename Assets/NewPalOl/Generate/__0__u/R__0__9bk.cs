...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#9bk
	/// </summary>
    public partial class R__0__9bk : RMember //
    {
        ...
        public R__0__9bk() : base("#u.#9bk")
        {
        }

        public R__0__9bk(System.Object instance) : base("#u.#9bk")
		{
            SetInstance(instance);
		}

        public R__0__9bk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9bk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

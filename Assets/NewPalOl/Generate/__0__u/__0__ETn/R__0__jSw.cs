...
{public partial class R__0__ETn
{
	...
	/// #u.#ETn+#jSw
	/// </summary>
    public partial class R__0__jSw : RMember //
    {
		...
		/// #u.#ETn #g
		/// </summary>
		protected R__0__u.R__0__ETn r___0__g;
		public virtual R__0__u.R__0__ETn R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__jSw() : base("#u.#ETn+#jSw")
        {
        }

        public R__0__jSw(System.Object instance) : base("#u.#ETn+#jSw")
		{
            SetInstance(instance);
		}

        public R__0__jSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

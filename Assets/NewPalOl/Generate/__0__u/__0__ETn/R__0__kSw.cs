...
{public partial class R__0__ETn
{
	
	/// <summary>
	/// #u.#ETn+#kSw
	/// </summary>
    public partial class R__0__kSw : RMember //
    {
		...
		/// #u.#ETn #l
		/// </summary>
		protected R__0__u.R__0__ETn r___0__l;
		public virtual R__0__u.R__0__ETn R__0__l
		{
			get
			{
				if(r___0__l == null)
        ...
        public R__0__kSw() : base("#u.#ETn+#kSw")
        {
        }

        public R__0__kSw(System.Object instance) : base("#u.#ETn+#kSw")
		{
            SetInstance(instance);
		}

        public R__0__kSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__kSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

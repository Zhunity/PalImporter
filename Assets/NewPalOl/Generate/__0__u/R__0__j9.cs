...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#j9
	/// </summary>
    public partial class R__0__j9 : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.List`1[#u.#S8] #a
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__u.R__0__S8> r___0__a;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__u.R__0__S8> R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#j9"), "#b");
		...
		/// Void #h9(#Pfb.#qpb)
		/// </summary>
		protected RMethod r_R__0__h9___0__qpb;
		public virtual RMethod R__0__h9___0__qpb
		{
			get
			{
				if(r_R__0__h9___0__qpb == null)
				{
					r_R__0__h9___0__qpb = new(this, "#h9", 0,  ReleactionUtils.GetType("#Pfb.#qpb"));
					r_R__0__h9___0__qpb.SetBelong(this.instance);
				}
				return r_R__0__h9___0__qpb;
			}
		}
		...
		/// <summary>
		/// Void #i9(System.Object, System.EventArgs)
		/// </summary>
		protected RMethod r_R__0__i9_Object_EventArgs;
		public virtual RMethod R__0__i9_Object_EventArgs
		{
			get
			{
				if(r_R__0__i9_Object_EventArgs == null)
				{
					r_R__0__i9_Object_EventArgs = new(this, "#i9", 0, typeof(System.Object), typeof(System.EventArgs));
					r_R__0__i9_Object_EventArgs.SetBelong(this.instance);
				}
				return r_R__0__i9_Object_EventArgs;
			}
		}
        ...
        public R__0__j9() : base("#u.#j9")
        {
        }

        public R__0__j9(System.Object instance) : base("#u.#j9")
		{
            SetInstance(instance);
		}

        public R__0__j9(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__j9(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }



        public virtual void __0__i9(System.Object  @sender, System.EventArgs  @e)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @e};
            var ___result = R__0__i9_Object_EventArgs.Invoke(___genericsType, ___parameters);

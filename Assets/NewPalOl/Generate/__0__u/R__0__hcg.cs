...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#hcg
	/// </summary>
    public partial class R__0__hcg : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.Queue`1[GameDefineType.ID] #d
		/// </summary>
		protected RSystem.RCollections.RGeneric.RQueue<RGameDefineType.RID> r___0__d;
		public virtual RSystem.RCollections.RGeneric.RQueue<RGameDefineType.RID> R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// <summary>
		/// System.Collections.Generic.Queue`1[System.Int32] #e
		/// </summary>
		protected RSystem.RCollections.RGeneric.RQueue<RField> r___0__e;
		public virtual RSystem.RCollections.RGeneric.RQueue<RField> R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// <summary>
		/// Void #fcg(GameDefineType.ID, Int32)
		/// </summary>
		protected RMethod r_R__0__fcg_ID_Int32;
		public virtual RMethod R__0__fcg_ID_Int32
		{
			get
			{
				if(r_R__0__fcg_ID_Int32 == null)
				{
					r_R__0__fcg_ID_Int32 = new(this, "#fcg", 0, typeof(GameDefineType.ID), typeof(System.Int32));
					r_R__0__fcg_ID_Int32.SetBelong(this.instance);
				}
				return r_R__0__fcg_ID_Int32;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator #gcg(GameDefineType.ID, Int32)
		/// </summary>
		protected RMethod r_R__0__gcg_ID_Int32;
		public virtual RMethod R__0__gcg_ID_Int32
		{
			get
			{
				if(r_R__0__gcg_ID_Int32 == null)
				{
					r_R__0__gcg_ID_Int32 = new(this, "#gcg", 0, typeof(GameDefineType.ID), typeof(System.Int32));
					r_R__0__gcg_ID_Int32.SetBelong(this.instance);
				}
				return r_R__0__gcg_ID_Int32;
			}
		}
        ...
        public R__0__hcg() : base("#u.#hcg")
        {
        }

        public R__0__hcg(System.Object instance) : base("#u.#hcg")
		{
            SetInstance(instance);
		}

        public R__0__hcg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hcg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__fcg(GameDefineType.ID  @id, System.Int32  @count)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id, @count};
            var ___result = R__0__fcg_ID_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator __0__gcg(GameDefineType.ID  @id, System.Int32  @count)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id, @count};
            var ___result = R__0__gcg_ID_Int32.Invoke(___genericsType, ___parameters);

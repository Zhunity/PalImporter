...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#QCs
	/// </summary>
    public partial class R__0__QCs : RMember //
    {
        ...
        public R__0__QCs() : base("#u.#QCs")
        {
        }

        public R__0__QCs(System.Object instance) : base("#u.#QCs")
		{
            SetInstance(instance);
		}

        public R__0__QCs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__QCs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

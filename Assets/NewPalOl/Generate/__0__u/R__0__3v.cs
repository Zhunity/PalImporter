...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#3v
	/// </summary>
    public partial class R__0__3v : RMember //
    {
		...
		/// <summary>
		/// Void #sb(#u.#Dkb, MyGUIWindow)
		/// </summary>
		protected RMethod r_R__0__sb___0__Dkb_MyGUIWindow;
		public virtual RMethod R__0__sb___0__Dkb_MyGUIWindow
		{
			get
			{
				if(r_R__0__sb___0__Dkb_MyGUIWindow == null)
				{
					r_R__0__sb___0__Dkb_MyGUIWindow = new(this, "#sb", 0,  ReleactionUtils.GetType("#u.#Dkb"),  ReleactionUtils.GetType("MyGUIWindow"));
					r_R__0__sb___0__Dkb_MyGUIWindow.SetBelong(this.instance);
				}
				return r_R__0__sb___0__Dkb_MyGUIWindow;
			}
		}
        ...
        public R__0__3v() : base("#u.#3v")
        {
        }

        public R__0__3v(System.Object instance) : base("#u.#3v")
		{
            SetInstance(instance);
		}

        public R__0__3v(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3v(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#2A
	/// </summary>
    public partial class R__0__2A : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.Queue`1[#u.#2A+#3A] #a
		/// </summary>
		protected RSystem.RCollections.RGeneric.RQueue<R__0__u.R__0__2A.R__0__3A> r___0__a;
		public virtual RSystem.RCollections.RGeneric.RQueue<R__0__u.R__0__2A.R__0__3A> R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #u.#2A+#3A #f
		/// </summary>
		protected R__0__u.R__0__2A.R__0__3A r___0__f;
		public virtual R__0__u.R__0__2A.R__0__3A R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// <summary>
		/// Void #1A(System.String)
		/// </summary>
		protected RMethod r_R__0__1A_String;
		public virtual RMethod R__0__1A_String
		{
			get
			{
				if(r_R__0__1A_String == null)
				{
					r_R__0__1A_String = new(this, "#1A", 0, typeof(System.String));
					r_R__0__1A_String.SetBelong(this.instance);
				}
				return r_R__0__1A_String;
			}
		}
        ...
        public R__0__2A() : base("#u.#2A")
        {
        }

        public R__0__2A(System.Object instance) : base("#u.#2A")
		{
            SetInstance(instance);
		}

        public R__0__2A(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2A(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__1A(System.String  @text)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text};
            var ___result = R__0__1A_String.Invoke(___genericsType, ___parameters);

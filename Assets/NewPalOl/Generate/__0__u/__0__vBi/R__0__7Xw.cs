...
{public partial class R__0__vBi
{
	
	/// <summary>
	/// #u.#vBi+#7Xw
	/// </summary>
    public partial class R__0__7Xw : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.IDictionary`2[System.String,System.Object] #a
		/// </summary>
		protected RSystem.RCollections.RGeneric.RIDictionary<RField, RSystem.RObject> r___0__a;
		public virtual RSystem.RCollections.RGeneric.RIDictionary<RField, RSystem.RObject> R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// UnityEngine.WWWForm #f
		/// </summary>
		protected RUnityEngine.RWWWForm r___0__f;
		public virtual RUnityEngine.RWWWForm R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// <summary>
		/// System.Collections.Generic.IEnumerator`1[System.String] #g
		/// </summary>
		protected RSystem.RCollections.RGeneric.RIEnumerator<RField> r___0__g;
		public virtual RSystem.RCollections.RGeneric.RIEnumerator<RField> R__0__g
		{
			get
			{
				if(r___0__g == null)
		...
		/// UnityEngine.WWW #i
		/// </summary>
		protected RUnityEngine.RWWW r___0__i;
		public virtual RUnityEngine.RWWW R__0__i
		{
			get
			{
				if(r___0__i == null)
		...
		/// <summary>
		/// System.Action`1[System.Boolean] #m
		/// </summary>
		protected RSystem.RAction<RField> r___0__m;
		public virtual RSystem.RAction<RField> R__0__m
		{
			get
			{
				if(r___0__m == null)
		...
		/// <summary>
		/// System.Action`1[System.Boolean] #u
		/// </summary>
		protected RSystem.RAction<RField> r___0__u;
		public virtual RSystem.RAction<RField> R__0__u
		{
			get
			{
				if(r___0__u == null)
		...
		/// #u.#vBi #w
		/// </summary>
		protected R__0__u.R__0__vBi r___0__w;
		public virtual R__0__u.R__0__vBi R__0__w
		{
			get
			{
				if(r___0__w == null)
        ...
        public R__0__7Xw() : base("#u.#vBi+#7Xw")
        {
        }

        public R__0__7Xw(System.Object instance) : base("#u.#vBi+#7Xw")
		{
            SetInstance(instance);
		}

        public R__0__7Xw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7Xw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__vBi
{
	...
	/// #u.#vBi+#6Xw
	/// </summary>
    public partial class R__0__6Xw : RMember //
    {
		...
		/// #u.#RP #d
		/// </summary>
		protected R__0__u.R__0__RP r___0__d;
		public virtual R__0__u.R__0__RP R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// UnityEngine.WWW #m
		/// </summary>
		protected RUnityEngine.RWWW r___0__m;
		public virtual RUnityEngine.RWWW R__0__m
		{
			get
			{
				if(r___0__m == null)
        ...
        public R__0__6Xw() : base("#u.#vBi+#6Xw")
        {
        }

        public R__0__6Xw(System.Object instance) : base("#u.#vBi+#6Xw")
		{
            SetInstance(instance);
		}

        public R__0__6Xw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6Xw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__vBi
{
	...
	/// #u.#vBi+#9Xw
	/// </summary>
    public partial class R__0__9Xw : RMember //
    {

		/// <summary>
		/// UnityEngine.WWWForm #a
		/// </summary>
		protected RUnityEngine.RWWWForm r___0__a;
		public virtual RUnityEngine.RWWWForm R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// System.Collections.Generic.IDictionary`2[System.String,System.Object] #b
		/// </summary>
		protected RSystem.RCollections.RGeneric.RIDictionary<RField, RSystem.RObject> r___0__b;
		public virtual RSystem.RCollections.RGeneric.RIDictionary<RField, RSystem.RObject> R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// <summary>
		/// System.Collections.Generic.IEnumerator`1[System.String] #c
		/// </summary>
		protected RSystem.RCollections.RGeneric.RIEnumerator<RField> r___0__c;
		public virtual RSystem.RCollections.RGeneric.RIEnumerator<RField> R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// UnityEngine.WWW #f
		/// </summary>
		protected RUnityEngine.RWWW r___0__f;
		public virtual RUnityEngine.RWWW R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// System.Object #i
		/// </summary>
		protected RSystem.RObject r___0__i;
		public virtual RSystem.RObject R__0__i
		{
			get
			{
				if(r___0__i == null)
		...
		/// <summary>
		/// System.Collections.Generic.IDictionary`2[System.String,System.Object] #j
		/// </summary>
		protected RSystem.RCollections.RGeneric.RIDictionary<RField, RSystem.RObject> r___0__j;
		public virtual RSystem.RCollections.RGeneric.RIDictionary<RField, RSystem.RObject> R__0__j
		{
			get
			{
				if(r___0__j == null)
        ...
        public R__0__9Xw() : base("#u.#vBi+#9Xw")
        {
        }

        public R__0__9Xw(System.Object instance) : base("#u.#vBi+#9Xw")
		{
            SetInstance(instance);
		}

        public R__0__9Xw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Xw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

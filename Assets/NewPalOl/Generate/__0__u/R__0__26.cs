...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#26
	/// </summary>
    public partial class R__0__26 : RMember //
    {
        ...
        public R__0__26() : base("#u.#26")
        {
        }

        public R__0__26(System.Object instance) : base("#u.#26")
		{
            SetInstance(instance);
		}

        public R__0__26(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__26(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

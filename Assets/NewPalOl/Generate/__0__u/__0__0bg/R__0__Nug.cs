...
{public partial class R__0__0bg
{
	...
	/// #u.#0bg+#Nug
	/// </summary>
    public partial class R__0__Nug : RMember //
    {
        ...
        public R__0__Nug() : base("#u.#0bg+#Nug")
        {
        }

        public R__0__Nug(System.Object instance) : base("#u.#0bg+#Nug")
		{
            SetInstance(instance);
		}

        public R__0__Nug(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Nug(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#9A
	/// </summary>
    public partial class R__0__9A : RMember //
    {
		...
		/// Void #TAm()
		/// </summary>
		protected RMethod r_R__0__TAm;
		public virtual RMethod R__0__TAm
		{
			get
			{
				if(r_R__0__TAm == null)
				{
					r_R__0__TAm = new(this, "#TAm", 0);
					r_R__0__TAm.SetBelong(this.instance);
				}
				return r_R__0__TAm;
			}
		}
		...
		/// <summary>
		/// Void #UAm(GameDefineType.ID, Int32)
		/// </summary>
		protected RMethod r_R__0__UAm_ID_Int32;
		public virtual RMethod R__0__UAm_ID_Int32
		{
			get
			{
				if(r_R__0__UAm_ID_Int32 == null)
				{
					r_R__0__UAm_ID_Int32 = new(this, "#UAm", 0, typeof(GameDefineType.ID), typeof(System.Int32));
					r_R__0__UAm_ID_Int32.SetBelong(this.instance);
				}
				return r_R__0__UAm_ID_Int32;
			}
		}
		...
		/// <summary>
		/// Void #WAm(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__WAm_Object___0__7X;
		public virtual RMethod R__0__WAm_Object___0__7X
		{
			get
			{
				if(r_R__0__WAm_Object___0__7X == null)
				{
					r_R__0__WAm_Object___0__7X = new(this, "#WAm", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__WAm_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__WAm_Object___0__7X;
			}
		}
        ...
        public R__0__9A() : base("#u.#9A")
        {
        }

        public R__0__9A(System.Object instance) : base("#u.#9A")
		{
            SetInstance(instance);
		}

        public R__0__9A(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9A(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__TAm()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__TAm.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__UAm(GameDefineType.ID  @id, System.Int32  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id, @time};
            var ___result = R__0__UAm_ID_Int32.Invoke(___genericsType, ___parameters);

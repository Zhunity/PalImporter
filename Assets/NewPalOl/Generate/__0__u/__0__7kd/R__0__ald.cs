...
{public partial class R__0__7kd
{
	...
	/// #u.#7kd+#ald
	/// </summary>
    public partial class R__0__ald : RMember //
    {
        ...
        public R__0__ald() : base("#u.#7kd+#ald")
        {
        }

        public R__0__ald(System.Object instance) : base("#u.#7kd+#ald")
		{
            SetInstance(instance);
		}

        public R__0__ald(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ald(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

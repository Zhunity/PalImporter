...
{public partial class R__0__7kd
{
	
	/// <summary>
	/// #u.#7kd+#IGd
	/// </summary>
    public partial class R__0__IGd : RMember //
    {
		...
		/// Void Invoke(#Pfb.#ild)
		/// </summary>
		protected RMethod r_RInvoke___0__ild;
		public virtual RMethod RInvoke___0__ild
		{
			get
			{
				if(r_RInvoke___0__ild == null)
				{
					r_RInvoke___0__ild = new(this, "Invoke", 0,  ReleactionUtils.GetType("#Pfb.#ild"));
					r_RInvoke___0__ild.SetBelong(this.instance);
				}
				return r_RInvoke___0__ild;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(#Pfb.#ild, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke___0__ild_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke___0__ild_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke___0__ild_AsyncCallback_Object == null)
				{
					r_RBeginInvoke___0__ild_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("#Pfb.#ild"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke___0__ild_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke___0__ild_AsyncCallback_Object;
			}
		}
        ...
        public R__0__IGd() : base("#u.#7kd+#IGd")
        {
        }

        public R__0__IGd(System.Object instance) : base("#u.#7kd+#IGd")
		{
            SetInstance(instance);
		}

        public R__0__IGd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__IGd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

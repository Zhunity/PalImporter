...
{public partial class R__0__HIp
{
	...
	/// #u.#HIp+#XAt
	/// </summary>
    public partial class R__0__XAt : RMember //
    {
		...
		/// #u.#HIp #g
		/// </summary>
		protected R__0__u.R__0__HIp r___0__g;
		public virtual R__0__u.R__0__HIp R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__XAt() : base("#u.#HIp+#XAt")
        {
        }

        public R__0__XAt(System.Object instance) : base("#u.#HIp+#XAt")
		{
            SetInstance(instance);
		}

        public R__0__XAt(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XAt(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

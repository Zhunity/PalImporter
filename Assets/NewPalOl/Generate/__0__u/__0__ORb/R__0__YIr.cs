...
{public partial class R__0__ORb
{
	...
	/// #u.#ORb+#YIr
	/// </summary>
    public partial class R__0__YIr : RMember //
    {
        ...
        public R__0__YIr() : base("#u.#ORb+#YIr")
        {
        }

        public R__0__YIr(System.Object instance) : base("#u.#ORb+#YIr")
		{
            SetInstance(instance);
		}

        public R__0__YIr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YIr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

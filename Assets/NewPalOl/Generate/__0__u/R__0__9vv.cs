...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#9vv
	/// </summary>
    public partial class R__0__9vv : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#9vv"), "#a");
		...
		/// Void #rtl(Int32)
		/// </summary>
		protected RMethod r_R__0__rtl_Int32;
		public virtual RMethod R__0__rtl_Int32
		{
			get
			{
				if(r_R__0__rtl_Int32 == null)
				{
					r_R__0__rtl_Int32 = new(this, "#rtl", 0, typeof(System.Int32));
					r_R__0__rtl_Int32.SetBelong(this.instance);
				}
				return r_R__0__rtl_Int32;
			}
		}
		...
		/// Void #yKk(#Pfb.#6wv)
		/// </summary>
		protected RMethod r_R__0__yKk___0__6wv;
		public virtual RMethod R__0__yKk___0__6wv
		{
			get
			{
				if(r_R__0__yKk___0__6wv == null)
				{
					r_R__0__yKk___0__6wv = new(this, "#yKk", 0,  ReleactionUtils.GetType("#Pfb.#6wv"));
					r_R__0__yKk___0__6wv.SetBelong(this.instance);
				}
				return r_R__0__yKk___0__6wv;
			}
		}
        ...
        public R__0__9vv() : base("#u.#9vv")
        {
        }

        public R__0__9vv(System.Object instance) : base("#u.#9vv")
		{
            SetInstance(instance);
		}

        public R__0__9vv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9vv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__rtl(System.Int32  @score)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@score};
            var ___result = R__0__rtl_Int32.Invoke(___genericsType, ___parameters);

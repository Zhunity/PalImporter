...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#0bg
	/// </summary>
    public partial class R__0__0bg : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.List`1[#u.#0bg+#Nug] #c
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__u.R__0__0bg.R__0__Nug> r___0__c;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__u.R__0__0bg.R__0__Nug> R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1[System.String] #d
		/// </summary>
		...
		/// <summary>
		/// System.Func`2[#u.#0bg+#Nug,#u.#0bg+#Nug] #g
		/// </summary>
		protected static RSystem.RFunc<R__0__u.R__0__0bg.R__0__Nug, R__0__u.R__0__0bg.R__0__Nug> r___0__g;
		public static RSystem.RFunc<R__0__u.R__0__0bg.R__0__Nug, R__0__u.R__0__0bg.R__0__Nug> R__0__g
		{
			get
			{
				if(r___0__g == null)
				{
					r___0__g = new( ReleactionUtils.GetType("#u.#0bg"), "#g");
		...
		/// <summary>
		/// Void #vZg(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__vZg_Object___0__7X;
		public virtual RMethod R__0__vZg_Object___0__7X
		{
			get
			{
				if(r_R__0__vZg_Object___0__7X == null)
				{
					r_R__0__vZg_Object___0__7X = new(this, "#vZg", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__vZg_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__vZg_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #wZg(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__wZg_Object___0__7X;
		public virtual RMethod R__0__wZg_Object___0__7X
		{
			get
			{
				if(r_R__0__wZg_Object___0__7X == null)
				{
					r_R__0__wZg_Object___0__7X = new(this, "#wZg", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__wZg_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__wZg_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #xZg(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__xZg_Object___0__7X;
		public virtual RMethod R__0__xZg_Object___0__7X
		{
			get
			{
				if(r_R__0__xZg_Object___0__7X == null)
				{
					r_R__0__xZg_Object___0__7X = new(this, "#xZg", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__xZg_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__xZg_Object___0__7X;
			}
		}
		...
		/// Void #Zbg(#Pfb.#ejg)
		/// </summary>
		protected RMethod r_R__0__Zbg___0__ejg;
		public virtual RMethod R__0__Zbg___0__ejg
		{
			get
			{
				if(r_R__0__Zbg___0__ejg == null)
				{
					r_R__0__Zbg___0__ejg = new(this, "#Zbg", 0,  ReleactionUtils.GetType("#Pfb.#ejg"));
					r_R__0__Zbg___0__ejg.SetBelong(this.instance);
				}
				return r_R__0__Zbg___0__ejg;
			}
		}
		...
		/// Void #mUc()
		/// </summary>
		protected RMethod r_R__0__mUc;
		public virtual RMethod R__0__mUc
		{
			get
			{
				if(r_R__0__mUc == null)
				{
					r_R__0__mUc = new(this, "#mUc", 0);
					r_R__0__mUc.SetBelong(this.instance);
				}
				return r_R__0__mUc;
			}
		}
		...
		/// <summary>
		/// Void #d3c(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__d3c_Object___0__7X;
		public virtual RMethod R__0__d3c_Object___0__7X
		{
			get
			{
				if(r_R__0__d3c_Object___0__7X == null)
				{
					r_R__0__d3c_Object___0__7X = new(this, "#d3c", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__d3c_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__d3c_Object___0__7X;
			}
		}
		...
		/// #Nug #kex(#Nug)
		/// </summary>
		protected static RMethod r_R__0__kex___0__Nug;
		public static RMethod R__0__kex___0__Nug
		{
			get
			{
				if(r_R__0__kex___0__Nug == null)
				{
					r_R__0__kex___0__Nug = new( ReleactionUtils.GetType("#u.#0bg"), "#kex", 0,  ReleactionUtils.GetType("#u.#0bg+#Nug"));
					r_R__0__kex___0__Nug.SetBelong(null);
				}
				return r_R__0__kex___0__Nug;
			}
		}
        ...
        public R__0__0bg() : base("#u.#0bg")
        {
        }

        public R__0__0bg(System.Object instance) : base("#u.#0bg")
		{
            SetInstance(instance);
		}

        public R__0__0bg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0bg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__mUc()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__mUc.Invoke(___genericsType, ___parameters);

...
{public partial class R__0__7Hw
{
	
	/// <summary>
	/// #u.#7Hw+#nqx
	/// </summary>
    public partial class R__0__nqx : RMember //
    {
		...
		/// #u.#7Hw #s
		/// </summary>
		protected R__0__u.R__0__7Hw r___0__s;
		public virtual R__0__u.R__0__7Hw R__0__s
		{
			get
			{
				if(r___0__s == null)
        ...
        public R__0__nqx() : base("#u.#7Hw+#nqx")
        {
        }

        public R__0__nqx(System.Object instance) : base("#u.#7Hw+#nqx")
		{
            SetInstance(instance);
		}

        public R__0__nqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__nqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__6H
{
	...
	/// #u.#6H+#K6u
	/// </summary>
    public partial class R__0__K6u : RMember //
    {
		...
		/// #u.#6H #d
		/// </summary>
		protected R__0__u.R__0__6H r___0__d;
		public virtual R__0__u.R__0__6H R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__K6u() : base("#u.#6H+#K6u")
        {
        }

        public R__0__K6u(System.Object instance) : base("#u.#6H+#K6u")
		{
            SetInstance(instance);
		}

        public R__0__K6u(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__K6u(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__6H
{
	
	/// <summary>
	/// #u.#6H+#8yq
	/// </summary>
    public partial class R__0__8yq : RMember //
    {
        ...
        public R__0__8yq() : base("#u.#6H+#8yq")
        {
        }

        public R__0__8yq(System.Object instance) : base("#u.#6H+#8yq")
		{
            SetInstance(instance);
		}

        public R__0__8yq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8yq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

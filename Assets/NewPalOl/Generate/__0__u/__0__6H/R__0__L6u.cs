...
{public partial class R__0__6H
{
	...
	/// #u.#6H+#L6u
	/// </summary>
    public partial class R__0__L6u : RMember //
    {
		...
		/// #u.#6H #e
		/// </summary>
		protected R__0__u.R__0__6H r___0__e;
		public virtual R__0__u.R__0__6H R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__L6u() : base("#u.#6H+#L6u")
        {
        }

        public R__0__L6u(System.Object instance) : base("#u.#6H+#L6u")
		{
            SetInstance(instance);
		}

        public R__0__L6u(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__L6u(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#4vv
	/// </summary>
    public partial class R__0__4vv : RMember //
    {
        ...
        public R__0__4vv() : base("#u.#4vv")
        {
        }

        public R__0__4vv(System.Object instance) : base("#u.#4vv")
		{
            SetInstance(instance);
		}

        public R__0__4vv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4vv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__mk(GameDefineType.ID  @equipID)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@equipID};

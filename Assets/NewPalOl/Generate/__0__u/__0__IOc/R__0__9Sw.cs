...
{public partial class R__0__IOc
{
	...
	/// #u.#IOc+#9Sw
	/// </summary>
    public partial class R__0__9Sw : RMember //
    {
		...
		/// #u.#IOc #g
		/// </summary>
		protected R__0__u.R__0__IOc r___0__g;
		public virtual R__0__u.R__0__IOc R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__9Sw() : base("#u.#IOc+#9Sw")
        {
        }

        public R__0__9Sw(System.Object instance) : base("#u.#IOc+#9Sw")
		{
            SetInstance(instance);
		}

        public R__0__9Sw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Sw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

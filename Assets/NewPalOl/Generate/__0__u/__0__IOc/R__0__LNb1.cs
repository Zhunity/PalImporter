...
{public partial class R__0__IOc
{
	...
	/// #u.#IOc+#LNb1
	/// </summary>
    public partial class R__0__LNb1 : RMember //
    {
        ...
        public R__0__LNb1() : base("#u.#IOc+#LNb1")
        {
        }

        public R__0__LNb1(System.Object instance) : base("#u.#IOc+#LNb1")
		{
            SetInstance(instance);
		}

        public R__0__LNb1(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__LNb1(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Object  @data)
        {
        ...
        public virtual System.IAsyncResult BeginInvoke(System.Object  @data, System.AsyncCallback  @callback, System.Object  @object)
        {

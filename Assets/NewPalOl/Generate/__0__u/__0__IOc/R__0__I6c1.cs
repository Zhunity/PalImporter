...
{public partial class R__0__IOc
{
	
	/// <summary>
	/// #u.#IOc+#I6c1
	/// </summary>
    public partial class R__0__I6c1 : RMember //
    {
        ...
        public R__0__I6c1() : base("#u.#IOc+#I6c1")
        {
        }

        public R__0__I6c1(System.Object instance) : base("#u.#IOc+#I6c1")
		{
            SetInstance(instance);
		}

        public R__0__I6c1(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__I6c1(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Object  @data, System.Boolean  @isCheck)
        {
        ...
        public virtual System.IAsyncResult BeginInvoke(System.Object  @data, System.Boolean  @isCheck, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@data, @isCheck, @callback, @object};

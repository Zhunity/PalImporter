...
{public partial class R__0__IOc
{
	...
	/// #u.#IOc+#8Sw
	/// </summary>
    public partial class R__0__8Sw : RMember //
    {
		...
		/// #u.#IOc #c
		/// </summary>
		protected R__0__u.R__0__IOc r___0__c;
		public virtual R__0__u.R__0__IOc R__0__c
		{
			get
			{
				if(r___0__c == null)
        ...
        public R__0__8Sw() : base("#u.#IOc+#8Sw")
        {
        }

        public R__0__8Sw(System.Object instance) : base("#u.#IOc+#8Sw")
		{
            SetInstance(instance);
		}

        public R__0__8Sw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Sw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

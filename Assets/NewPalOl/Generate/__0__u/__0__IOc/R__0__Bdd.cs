...
{public partial class R__0__IOc
{
	...
	/// #u.#IOc+#Bdd
	/// </summary>
    public partial class R__0__Bdd : RMember //
    {
		...
		/// Void Invoke(#u.#IOc)
		/// </summary>
		protected RMethod r_RInvoke___0__IOc;
		public virtual RMethod RInvoke___0__IOc
		{
			get
			{
				if(r_RInvoke___0__IOc == null)
				{
					r_RInvoke___0__IOc = new(this, "Invoke", 0,  ReleactionUtils.GetType("#u.#IOc"));
					r_RInvoke___0__IOc.SetBelong(this.instance);
				}
				return r_RInvoke___0__IOc;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(#u.#IOc, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke___0__IOc_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke___0__IOc_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke___0__IOc_AsyncCallback_Object == null)
				{
					r_RBeginInvoke___0__IOc_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("#u.#IOc"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke___0__IOc_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke___0__IOc_AsyncCallback_Object;
			}
		}
        ...
        public R__0__Bdd() : base("#u.#IOc+#Bdd")
        {
        }

        public R__0__Bdd(System.Object instance) : base("#u.#IOc+#Bdd")
		{
            SetInstance(instance);
		}

        public R__0__Bdd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Bdd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

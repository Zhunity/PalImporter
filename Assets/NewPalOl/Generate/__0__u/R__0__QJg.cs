...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#QJg
	/// </summary>
    public partial class R__0__QJg : RMember //
    {
		...
		/// <summary>
		/// Void #Uff(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Uff_Object___0__7X;
		public virtual RMethod R__0__Uff_Object___0__7X
		{
			get
			{
				if(r_R__0__Uff_Object___0__7X == null)
				{
					r_R__0__Uff_Object___0__7X = new(this, "#Uff", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Uff_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Uff_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #Vff(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Vff_Object___0__7X;
		public virtual RMethod R__0__Vff_Object___0__7X
		{
			get
			{
				if(r_R__0__Vff_Object___0__7X == null)
				{
					r_R__0__Vff_Object___0__7X = new(this, "#Vff", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Vff_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Vff_Object___0__7X;
			}
		}
        ...
        public R__0__QJg() : base("#u.#QJg")
        {
        }

        public R__0__QJg(System.Object instance) : base("#u.#QJg")
		{
            SetInstance(instance);
		}

        public R__0__QJg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__QJg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Xd(GameDefineType.ID  @item)
        {

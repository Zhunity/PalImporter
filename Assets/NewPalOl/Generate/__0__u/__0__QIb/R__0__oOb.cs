...
{public partial class R__0__QIb
{
	
	/// <summary>
	/// #u.#QIb+#oOb
	/// </summary>
    public partial class R__0__oOb : RMember //
    {
		...
		/// <summary>
		/// Boolean Invoke(MyGUI.ElementBase)
		/// </summary>
		protected RMethod r_RInvoke_ElementBase;
		public virtual RMethod RInvoke_ElementBase
		{
			get
			{
				if(r_RInvoke_ElementBase == null)
				{
					r_RInvoke_ElementBase = new(this, "Invoke", 0, typeof(MyGUI.ElementBase));
					r_RInvoke_ElementBase.SetBelong(this.instance);
				}
				return r_RInvoke_ElementBase;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(MyGUI.ElementBase, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_ElementBase_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_ElementBase_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_ElementBase_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_ElementBase_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(MyGUI.ElementBase), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_ElementBase_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_ElementBase_AsyncCallback_Object;
			}
		}
        ...
        public R__0__oOb() : base("#u.#QIb+#oOb")
        {
        }

        public R__0__oOb(System.Object instance) : base("#u.#QIb+#oOb")
		{
            SetInstance(instance);
		}

        public R__0__oOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Boolean Invoke(MyGUI.ElementBase  @foundElement)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@foundElement};
            var ___result = RInvoke_ElementBase.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual System.IAsyncResult BeginInvoke(MyGUI.ElementBase  @foundElement, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@foundElement, @callback, @object};
            var ___result = RBeginInvoke_ElementBase_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

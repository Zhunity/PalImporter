...
{public partial class R__0__QIb
{
	...
	/// #u.#QIb+#zYw
	/// </summary>
    public partial class R__0__zYw : RMember //
    {
        ...
        public R__0__zYw() : base("#u.#QIb+#zYw")
        {
        }

        public R__0__zYw(System.Object instance) : base("#u.#QIb+#zYw")
		{
            SetInstance(instance);
		}

        public R__0__zYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

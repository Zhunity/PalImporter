...
{public partial class R__0__QIb
{
	...
	/// #u.#QIb+#nOb
	/// </summary>
    public partial class R__0__nOb : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(#zY, #oU.#BY)
		/// </summary>
		protected RMethod r_RInvoke___0__zY___0__BY;
		public virtual RMethod RInvoke___0__zY___0__BY
		{
			get
			{
				if(r_RInvoke___0__zY___0__BY == null)
				{
					r_RInvoke___0__zY___0__BY = new(this, "Invoke", 0,  ReleactionUtils.GetType("MyGUI.ColorTextArea+#zY"),  ReleactionUtils.GetType("#oU.#BY"));
					r_RInvoke___0__zY___0__BY.SetBelong(this.instance);
				}
				return r_RInvoke___0__zY___0__BY;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(#zY, #oU.#BY, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke___0__zY___0__BY_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke___0__zY___0__BY_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke___0__zY___0__BY_AsyncCallback_Object == null)
				{
					r_RBeginInvoke___0__zY___0__BY_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("MyGUI.ColorTextArea+#zY"),  ReleactionUtils.GetType("#oU.#BY"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke___0__zY___0__BY_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke___0__zY___0__BY_AsyncCallback_Object;
			}
		}
        ...
        public R__0__nOb() : base("#u.#QIb+#nOb")
        {
        }

        public R__0__nOb(System.Object instance) : base("#u.#QIb+#nOb")
		{
            SetInstance(instance);
		}

        public R__0__nOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__nOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

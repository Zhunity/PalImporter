...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#UJh
	/// </summary>
    public partial class R__0__UJh : RMember //
    {
		...
		/// Void #Xd(Int32, Int32)
		/// </summary>
		protected RMethod r_R__0__Xd_Int32_Int32;
		public virtual RMethod R__0__Xd_Int32_Int32
		{
			get
			{
				if(r_R__0__Xd_Int32_Int32 == null)
				{
					r_R__0__Xd_Int32_Int32 = new(this, "#Xd", 0, typeof(System.Int32), typeof(System.Int32));
					r_R__0__Xd_Int32_Int32.SetBelong(this.instance);
				}
				return r_R__0__Xd_Int32_Int32;
			}
		}
        ...
        public R__0__UJh() : base("#u.#UJh")
        {
        }

        public R__0__UJh(System.Object instance) : base("#u.#UJh")
		{
            SetInstance(instance);
		}

        public R__0__UJh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__UJh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Xd(System.Int32  @RemainLive, System.Int32  @addProp)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@RemainLive, @addProp};
            var ___result = R__0__Xd_Int32_Int32.Invoke(___genericsType, ___parameters);

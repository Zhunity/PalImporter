...
{public partial class R__0__JBm
{
	...
	/// #u.#JBm+#V5p
	/// </summary>
    public partial class R__0__V5p : RMember //
    {
		...
		/// #u.#JBm #e
		/// </summary>
		protected R__0__u.R__0__JBm r___0__e;
		public virtual R__0__u.R__0__JBm R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__V5p() : base("#u.#JBm+#V5p")
        {
        }

        public R__0__V5p(System.Object instance) : base("#u.#JBm+#V5p")
		{
            SetInstance(instance);
		}

        public R__0__V5p(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__V5p(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

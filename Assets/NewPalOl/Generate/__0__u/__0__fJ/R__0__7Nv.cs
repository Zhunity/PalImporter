...
{public partial class R__0__fJ
{
	...
	/// #u.#fJ+#7Nv
	/// </summary>
    public partial class R__0__7Nv : RMember //
    {
        ...
        public R__0__7Nv() : base("#u.#fJ+#7Nv")
        {
        }

        public R__0__7Nv(System.Object instance) : base("#u.#fJ+#7Nv")
		{
            SetInstance(instance);
		}

        public R__0__7Nv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__7Nv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#XTr
	/// </summary>
    public partial class R__0__XTr : RMember //
    {
        ...
        public R__0__XTr() : base("#u.#XTr")
        {
        }

        public R__0__XTr(System.Object instance) : base("#u.#XTr")
		{
            SetInstance(instance);
		}

        public R__0__XTr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XTr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

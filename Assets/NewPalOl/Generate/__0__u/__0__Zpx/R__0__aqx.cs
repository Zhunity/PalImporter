...
{public partial class R__0__Zpx
{
	...
	/// #u.#Zpx+#aqx
	/// </summary>
    public partial class R__0__aqx : RMember //
    {
        ...
        public R__0__aqx() : base("#u.#Zpx+#aqx")
        {
        }

        public R__0__aqx(System.Object instance) : base("#u.#Zpx+#aqx")
		{
            SetInstance(instance);
		}

        public R__0__aqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__aqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

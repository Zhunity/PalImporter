...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#W6
	/// </summary>
    public partial class R__0__W6 : RMember //
    {
        ...
        public R__0__W6() : base("#u.#W6")
        {
        }

        public R__0__W6(System.Object instance) : base("#u.#W6")
		{
            SetInstance(instance);
		}

        public R__0__W6(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__W6(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

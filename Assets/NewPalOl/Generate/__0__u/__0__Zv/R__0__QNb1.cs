...
{public partial class R__0__Zv
{
	
	/// <summary>
	/// #u.#Zv+#QNb1
	/// </summary>
    public partial class R__0__QNb1 : RMember //
    {
        ...
        public R__0__QNb1() : base("#u.#Zv+#QNb1")
        {
        }

        public R__0__QNb1(System.Object instance) : base("#u.#Zv+#QNb1")
		{
            SetInstance(instance);
		}

        public R__0__QNb1(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__QNb1(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

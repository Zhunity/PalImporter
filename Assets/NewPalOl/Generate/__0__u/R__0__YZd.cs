...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#YZd
	/// </summary>
    public partial class R__0__YZd : RMember //
    {
        ...
        public R__0__YZd() : base("#u.#YZd")
        {
        }

        public R__0__YZd(System.Object instance) : base("#u.#YZd")
		{
            SetInstance(instance);
		}

        public R__0__YZd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YZd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

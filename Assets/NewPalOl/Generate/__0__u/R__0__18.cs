...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#18
	/// </summary>
    public partial class R__0__18 : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.List`1[Action] #i
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RAction> r___0__i;
		public virtual RSystem.RCollections.RGeneric.RList<RAction> R__0__i
		{
			get
			{
				if(r___0__i == null)
		...
		/// <summary>
		/// Void #3c(Fighter, GameDefineType.ID, Boolean)
		/// </summary>
		protected RMethod r_R__0__3c_Fighter_ID_Boolean;
		public virtual RMethod R__0__3c_Fighter_ID_Boolean
		{
			get
			{
				if(r_R__0__3c_Fighter_ID_Boolean == null)
				{
					r_R__0__3c_Fighter_ID_Boolean = new(this, "#3c", 0,  ReleactionUtils.GetType("Fighter"), typeof(GameDefineType.ID), typeof(System.Boolean));
					r_R__0__3c_Fighter_ID_Boolean.SetBelong(this.instance);
				}
				return r_R__0__3c_Fighter_ID_Boolean;
			}
		}
        ...
        public R__0__18() : base("#u.#18")
        {
        }

        public R__0__18(System.Object instance) : base("#u.#18")
		{
            SetInstance(instance);
		}

        public R__0__18(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__18(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#p2d
	/// </summary>
    public partial class R__0__p2d : RMember //
    {
		...
		/// <summary>
		/// Boolean IsUseBindGold
		/// </summary>
		protected RProperty r_R__0__zFg;
		public virtual RProperty R__0__zFg
		{
			get
			{
				if(r_R__0__zFg == null)
				{
					r_R__0__zFg = new(this, "IsUseBindGold", -1);
		...
		/// <summary>
		/// Void #Yvv(QuickBuyItemType)
		/// </summary>
		protected RMethod r_R__0__Yvv_QuickBuyItemType;
		public virtual RMethod R__0__Yvv_QuickBuyItemType
		{
			get
			{
				if(r_R__0__Yvv_QuickBuyItemType == null)
				{
					r_R__0__Yvv_QuickBuyItemType = new(this, "#Yvv", 0, typeof(QuickBuyItemType));
					r_R__0__Yvv_QuickBuyItemType.SetBelong(this.instance);
				}
				return r_R__0__Yvv_QuickBuyItemType;
			}
		}

		/// <summary>
		/// Void #l2d(QuickBuyItemType)
		/// </summary>
		protected RMethod r_R__0__l2d_QuickBuyItemType;
		public virtual RMethod R__0__l2d_QuickBuyItemType
		{
			get
			{
				if(r_R__0__l2d_QuickBuyItemType == null)
				{
					r_R__0__l2d_QuickBuyItemType = new(this, "#l2d", 0, typeof(QuickBuyItemType));
					r_R__0__l2d_QuickBuyItemType.SetBelong(this.instance);
				}
				return r_R__0__l2d_QuickBuyItemType;
			}
		}
		...
		/// <summary>
		/// QuickBuyItemType #Qlb(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__Qlb_ID;
		public virtual RMethod R__0__Qlb_ID
		{
			get
			{
				if(r_R__0__Qlb_ID == null)
				{
					r_R__0__Qlb_ID = new(this, "#Qlb", 0, typeof(GameDefineType.ID));
					r_R__0__Qlb_ID.SetBelong(this.instance);
				}
				return r_R__0__Qlb_ID;
			}
		}
		...
		/// <summary>
		/// Void #m2d(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__m2d_Object___0__7X;
		public virtual RMethod R__0__m2d_Object___0__7X
		{
			get
			{
				if(r_R__0__m2d_Object___0__7X == null)
				{
					r_R__0__m2d_Object___0__7X = new(this, "#m2d", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__m2d_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__m2d_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #n2d(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__n2d_Object___0__7X;
		public virtual RMethod R__0__n2d_Object___0__7X
		{
			get
			{
				if(r_R__0__n2d_Object___0__7X == null)
				{
					r_R__0__n2d_Object___0__7X = new(this, "#n2d", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__n2d_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__n2d_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #o2d(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__o2d_Object___0__7X;
		public virtual RMethod R__0__o2d_Object___0__7X
		{
			get
			{
				if(r_R__0__o2d_Object___0__7X == null)
				{
					r_R__0__o2d_Object___0__7X = new(this, "#o2d", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__o2d_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__o2d_Object___0__7X;
			}
		}
        ...
        public R__0__p2d() : base("#u.#p2d")
        {
        }

        public R__0__p2d(System.Object instance) : base("#u.#p2d")
		{
            SetInstance(instance);
		}

        public R__0__p2d(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__p2d(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Yvv(QuickBuyItemType  @type)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@type};
            var ___result = R__0__Yvv_QuickBuyItemType.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__l2d(QuickBuyItemType  @type)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@type};
            var ___result = R__0__l2d_QuickBuyItemType.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__l2d(GameDefineType.ID  @configid)
        {
        ...
        public virtual QuickBuyItemType __0__Qlb(GameDefineType.ID  @itemid)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@itemid};
            var ___result = R__0__Qlb_ID.Invoke(___genericsType, ___parameters);

            return (QuickBuyItemType)___result;
        }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#dK
	/// </summary>
    public partial class R__0__dK : RMember //
    {
		...
		/// <summary>
		/// Void #cK(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__cK_Object___0__7X;
		public virtual RMethod R__0__cK_Object___0__7X
		{
			get
			{
				if(r_R__0__cK_Object___0__7X == null)
				{
					r_R__0__cK_Object___0__7X = new(this, "#cK", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__cK_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__cK_Object___0__7X;
			}
		}
        ...
        public R__0__dK() : base("#u.#dK")
        {
        }

        public R__0__dK(System.Object instance) : base("#u.#dK")
		{
            SetInstance(instance);
		}

        public R__0__dK(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dK(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#1vv
	/// </summary>
    public partial class R__0__1vv : RMember //
    {
		...
		/// Void #mk(#2vv)
		/// </summary>
		protected RMethod r_R__0__mk___0__2vv;
		public virtual RMethod R__0__mk___0__2vv
		{
			get
			{
				if(r_R__0__mk___0__2vv == null)
				{
					r_R__0__mk___0__2vv = new(this, "#mk", 0,  ReleactionUtils.GetType("#u.#1vv+#2vv"));
					r_R__0__mk___0__2vv.SetBelong(this.instance);
				}
				return r_R__0__mk___0__2vv;
			}
		}
        ...
        public R__0__1vv() : base("#u.#1vv")
        {
        }

        public R__0__1vv(System.Object instance) : base("#u.#1vv")
		{
            SetInstance(instance);
		}

        public R__0__1vv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1vv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

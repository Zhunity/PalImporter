...
{public partial class R__0__Bu
{
	
	/// <summary>
	/// #u.#Bu+#ONb
	/// </summary>
    public partial class R__0__ONb : RMember //
    {
        ...
        public R__0__ONb() : base("#u.#Bu+#ONb")
        {
        }

        public R__0__ONb(System.Object instance) : base("#u.#Bu+#ONb")
		{
            SetInstance(instance);
		}

        public R__0__ONb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ONb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

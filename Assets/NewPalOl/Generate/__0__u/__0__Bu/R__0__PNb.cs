...
{public partial class R__0__Bu
{
	...
	/// #u.#Bu+#PNb
	/// </summary>
    public partial class R__0__PNb : RMember //
    {
        ...
        public R__0__PNb() : base("#u.#Bu+#PNb")
        {
        }

        public R__0__PNb(System.Object instance) : base("#u.#Bu+#PNb")
		{
            SetInstance(instance);
		}

        public R__0__PNb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__PNb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

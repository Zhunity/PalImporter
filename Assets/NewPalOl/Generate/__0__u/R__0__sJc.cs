...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#sJc
	/// </summary>
    public partial class R__0__sJc : RMember //
    {

		/// <summary>
		/// #Pfb.#uJc #a
		/// </summary>
		protected R__0__Pfb.R__0__uJc r___0__a;
		public virtual R__0__Pfb.R__0__uJc R__0__a
		{
			get
			{
				if(r___0__a == null)
        ...
        public R__0__sJc() : base("#u.#sJc")
        {
        }

        public R__0__sJc(System.Object instance) : base("#u.#sJc")
		{
            SetInstance(instance);
		}

        public R__0__sJc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__sJc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

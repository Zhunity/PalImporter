...
{public partial class R__0__CFb
{
	
	/// <summary>
	/// #u.#CFb+#czf
	/// </summary>
    public partial class R__0__czf : RMember //
    {
        ...
        public R__0__czf() : base("#u.#CFb+#czf")
        {
        }

        public R__0__czf(System.Object instance) : base("#u.#CFb+#czf")
		{
            SetInstance(instance);
		}

        public R__0__czf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__czf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

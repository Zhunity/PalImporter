...
{public partial class R__0__5li
{
	...
	/// #u.#5li+#0hl
	/// </summary>
    public partial class R__0__0hl : RMember //
    {
		...
		/// #u.#5li #e
		/// </summary>
		protected R__0__u.R__0__5li r___0__e;
		public virtual R__0__u.R__0__5li R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__0hl() : base("#u.#5li+#0hl")
        {
        }

        public R__0__0hl(System.Object instance) : base("#u.#5li+#0hl")
		{
            SetInstance(instance);
		}

        public R__0__0hl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0hl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

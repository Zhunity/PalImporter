...
{public partial class R__0__7Ad
{
	
	/// <summary>
	/// #u.#7Ad+#8Ad
	/// </summary>
    public partial class R__0__8Ad : RMember //
    {
        ...
        public R__0__8Ad() : base("#u.#7Ad+#8Ad")
        {
        }

        public R__0__8Ad(System.Object instance) : base("#u.#7Ad+#8Ad")
		{
            SetInstance(instance);
		}

        public R__0__8Ad(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Ad(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

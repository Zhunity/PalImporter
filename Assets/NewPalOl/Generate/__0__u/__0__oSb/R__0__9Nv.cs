...
{public partial class R__0__oSb
{
	
	/// <summary>
	/// #u.#oSb+#9Nv
	/// </summary>
    public partial class R__0__9Nv : RMember //
    {
		...
		/// #u.#oSb #c
		/// </summary>
		protected R__0__u.R__0__oSb r___0__c;
		public virtual R__0__u.R__0__oSb R__0__c
		{
			get
			{
				if(r___0__c == null)
        ...
        public R__0__9Nv() : base("#u.#oSb+#9Nv")
        {
        }

        public R__0__9Nv(System.Object instance) : base("#u.#oSb+#9Nv")
		{
            SetInstance(instance);
		}

        public R__0__9Nv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Nv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__oSb
{
	...
	/// #u.#oSb+#8Nv
	/// </summary>
    public partial class R__0__8Nv : RMember //
    {
        ...
        public R__0__8Nv() : base("#u.#oSb+#8Nv")
        {
        }

        public R__0__8Nv(System.Object instance) : base("#u.#oSb+#8Nv")
		{
            SetInstance(instance);
		}

        public R__0__8Nv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Nv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Izd
	/// </summary>
    public partial class R__0__Izd : RMember //
    {
        ...
        public R__0__Izd() : base("#u.#Izd")
        {
        }

        public R__0__Izd(System.Object instance) : base("#u.#Izd")
		{
            SetInstance(instance);
		}

        public R__0__Izd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Izd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

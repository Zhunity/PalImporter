...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Ibg
	/// </summary>
    public partial class R__0__Ibg : RMember //
    {
		...
		/// #u.#Ibg+#QNb #c
		/// </summary>
		protected R__0__u.R__0__Ibg.R__0__QNb r___0__c;
		public virtual R__0__u.R__0__Ibg.R__0__QNb R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// #u.#Ibg+#QNb #d
		/// </summary>
		protected R__0__u.R__0__Ibg.R__0__QNb r___0__d;
		public virtual R__0__u.R__0__Ibg.R__0__QNb R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// <summary>
		/// Void #Yv(System.String, #u.#Ckb, #QNb, #QNb, System.String)
		/// </summary>
		protected RMethod r_R__0__Yv_String___0__Ckb___0__QNb___0__QNb_String;
		public virtual RMethod R__0__Yv_String___0__Ckb___0__QNb___0__QNb_String
		{
			get
			{
				if(r_R__0__Yv_String___0__Ckb___0__QNb___0__QNb_String == null)
				{
					r_R__0__Yv_String___0__Ckb___0__QNb___0__QNb_String = new(this, "#Yv", 0, typeof(System.String),  ReleactionUtils.GetType("#u.#Ckb"),  ReleactionUtils.GetType("#u.#Ibg+#QNb"),  ReleactionUtils.GetType("#u.#Ibg+#QNb"), typeof(System.String));
					r_R__0__Yv_String___0__Ckb___0__QNb___0__QNb_String.SetBelong(this.instance);
				}
				return r_R__0__Yv_String___0__Ckb___0__QNb___0__QNb_String;
			}
		}

		/// <summary>
		/// Void #Yv(System.String, #u.#Ckb, #QNb, #QNb)
		/// </summary>
		protected RMethod r_R__0__Yv_String___0__Ckb___0__QNb___0__QNb;
		public virtual RMethod R__0__Yv_String___0__Ckb___0__QNb___0__QNb
		{
			get
			{
				if(r_R__0__Yv_String___0__Ckb___0__QNb___0__QNb == null)
				{
					r_R__0__Yv_String___0__Ckb___0__QNb___0__QNb = new(this, "#Yv", 0, typeof(System.String),  ReleactionUtils.GetType("#u.#Ckb"),  ReleactionUtils.GetType("#u.#Ibg+#QNb"),  ReleactionUtils.GetType("#u.#Ibg+#QNb"));
					r_R__0__Yv_String___0__Ckb___0__QNb___0__QNb.SetBelong(this.instance);
				}
				return r_R__0__Yv_String___0__Ckb___0__QNb___0__QNb;
			}
		}
        ...
        public R__0__Ibg() : base("#u.#Ibg")
        {
        }

        public R__0__Ibg(System.Object instance) : base("#u.#Ibg")
		{
            SetInstance(instance);
		}

        public R__0__Ibg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Ibg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#12p
	/// </summary>
    public partial class R__0__12p : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#12p"), "#a");
		...
		public static RField R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#12p"), "#b");
		...
		public static RField R__0__c
		{
			get
			{
				if(r___0__c == null)
				{
					r___0__c = new( ReleactionUtils.GetType("#u.#12p"), "#c");
		...
		public static RField R__0__d
		{
			get
			{
				if(r___0__d == null)
				{
					r___0__d = new( ReleactionUtils.GetType("#u.#12p"), "#d");
		...
		/// <summary>
		/// System.Collections.Generic.List`1[#u.#12p+#62p] #j
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__u.R__0__12p.R__0__62p> r___0__j;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__u.R__0__12p.R__0__62p> R__0__j
		{
			get
			{
				if(r___0__j == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1[#u.#12p+#92p] #k
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__u.R__0__12p.R__0__92p> r___0__k;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__u.R__0__12p.R__0__92p> R__0__k
		{
			get
			{
				if(r___0__k == null)
		...
		/// UnityEngine.Rect[] #n
		/// </summary>
		protected RFieldArray<RUnityEngine.RRect> r___0__n;
		public virtual RFieldArray<RUnityEngine.RRect> R__0__n
		{
			get
			{
				if(r___0__n == null)
		...
		/// #oU.#Y2 #o
		/// </summary>
		protected R__0__oU.R__0__Y2 r___0__o;
		public virtual R__0__oU.R__0__Y2 R__0__o
		{
			get
			{
				if(r___0__o == null)
		...
		/// GoddessInfo #p
		/// </summary>
		protected RGoddessInfo r___0__p;
		public virtual RGoddessInfo R__0__p
		{
			get
			{
				if(r___0__p == null)
		...
		public static RField R__0__t
		{
			get
			{
				if(r___0__t == null)
				{
					r___0__t = new( ReleactionUtils.GetType("#u.#12p"), "#t");
		...
		/// Void #lBn()
		/// </summary>
		protected RMethod r_R__0__lBn;
		public virtual RMethod R__0__lBn
		{
			get
			{
				if(r_R__0__lBn == null)
				{
					r_R__0__lBn = new(this, "#lBn", 0);
					r_R__0__lBn.SetBelong(this.instance);
				}
				return r_R__0__lBn;
			}
		}
		...
		/// Void #WSc()
		/// </summary>
		protected RMethod r_R__0__WSc;
		public virtual RMethod R__0__WSc
		{
			get
			{
				if(r_R__0__WSc == null)
				{
					r_R__0__WSc = new(this, "#WSc", 0);
					r_R__0__WSc.SetBelong(this.instance);
				}
				return r_R__0__WSc;
			}
		}
		...
		/// Void #MHp()
		/// </summary>
		protected RMethod r_R__0__MHp;
		public virtual RMethod R__0__MHp
		{
			get
			{
				if(r_R__0__MHp == null)
				{
					r_R__0__MHp = new(this, "#MHp", 0);
					r_R__0__MHp.SetBelong(this.instance);
				}
				return r_R__0__MHp;
			}
		}
		...
		/// Void #D2p()
		/// </summary>
		protected RMethod r_R__0__D2p;
		public virtual RMethod R__0__D2p
		{
			get
			{
				if(r_R__0__D2p == null)
				{
					r_R__0__D2p = new(this, "#D2p", 0);
					r_R__0__D2p.SetBelong(this.instance);
				}
				return r_R__0__D2p;
			}
		}
		...
		/// Void #E2p()
		/// </summary>
		protected RMethod r_R__0__E2p;
		public virtual RMethod R__0__E2p
		{
			get
			{
				if(r_R__0__E2p == null)
				{
					r_R__0__E2p = new(this, "#E2p", 0);
					r_R__0__E2p.SetBelong(this.instance);
				}
				return r_R__0__E2p;
			}
		}
		...
		/// <summary>
		/// Void #F2p(Int32, System.String, System.String)
		/// </summary>
		protected RMethod r_R__0__F2p_Int32_String_String;
		public virtual RMethod R__0__F2p_Int32_String_String
		{
			get
			{
				if(r_R__0__F2p_Int32_String_String == null)
				{
					r_R__0__F2p_Int32_String_String = new(this, "#F2p", 0, typeof(System.Int32), typeof(System.String), typeof(System.String));
					r_R__0__F2p_Int32_String_String.SetBelong(this.instance);
				}
				return r_R__0__F2p_Int32_String_String;
			}
		}

		/// <summary>
		/// Void #G2p(GoddessInfo, GoddessByLevel)
		/// </summary>
		protected RMethod r_R__0__G2p_GoddessInfo_GoddessByLevel;
		public virtual RMethod R__0__G2p_GoddessInfo_GoddessByLevel
		{
			get
			{
				if(r_R__0__G2p_GoddessInfo_GoddessByLevel == null)
				{
					r_R__0__G2p_GoddessInfo_GoddessByLevel = new(this, "#G2p", 0, typeof(GoddessInfo), typeof(GoddessByLevel));
					r_R__0__G2p_GoddessInfo_GoddessByLevel.SetBelong(this.instance);
				}
				return r_R__0__G2p_GoddessInfo_GoddessByLevel;
			}
		}

		/// <summary>
		/// Void #H2p(GoddessInfo, eGoddessStatus, GoddessByLevel)
		/// </summary>
		protected RMethod r_R__0__H2p_GoddessInfo_eGoddessStatus_GoddessByLevel;
		public virtual RMethod R__0__H2p_GoddessInfo_eGoddessStatus_GoddessByLevel
		{
			get
			{
				if(r_R__0__H2p_GoddessInfo_eGoddessStatus_GoddessByLevel == null)
				{
					r_R__0__H2p_GoddessInfo_eGoddessStatus_GoddessByLevel = new(this, "#H2p", 0, typeof(GoddessInfo), typeof(eGoddessStatus), typeof(GoddessByLevel));
					r_R__0__H2p_GoddessInfo_eGoddessStatus_GoddessByLevel.SetBelong(this.instance);
				}
				return r_R__0__H2p_GoddessInfo_eGoddessStatus_GoddessByLevel;
			}
		}

		/// <summary>
		/// Void #I2p(GoddessInfo, GoddessByLevel)
		/// </summary>
		protected RMethod r_R__0__I2p_GoddessInfo_GoddessByLevel;
		public virtual RMethod R__0__I2p_GoddessInfo_GoddessByLevel
		{
			get
			{
				if(r_R__0__I2p_GoddessInfo_GoddessByLevel == null)
				{
					r_R__0__I2p_GoddessInfo_GoddessByLevel = new(this, "#I2p", 0, typeof(GoddessInfo), typeof(GoddessByLevel));
					r_R__0__I2p_GoddessInfo_GoddessByLevel.SetBelong(this.instance);
				}
				return r_R__0__I2p_GoddessInfo_GoddessByLevel;
			}
		}
		...
		/// Void #J2p(Int32)
		/// </summary>
		protected RMethod r_R__0__J2p_Int32;
		public virtual RMethod R__0__J2p_Int32
		{
			get
			{
				if(r_R__0__J2p_Int32 == null)
				{
					r_R__0__J2p_Int32 = new(this, "#J2p", 0, typeof(System.Int32));
					r_R__0__J2p_Int32.SetBelong(this.instance);
				}
				return r_R__0__J2p_Int32;
			}
		}

		/// <summary>
		/// Void #XSc(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__XSc_Object___0__7X;
		public virtual RMethod R__0__XSc_Object___0__7X
		{
			get
			{
				if(r_R__0__XSc_Object___0__7X == null)
				{
					r_R__0__XSc_Object___0__7X = new(this, "#XSc", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__XSc_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__XSc_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #K2p(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__K2p_Object___0__7X;
		public virtual RMethod R__0__K2p_Object___0__7X
		{
			get
			{
				if(r_R__0__K2p_Object___0__7X == null)
				{
					r_R__0__K2p_Object___0__7X = new(this, "#K2p", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__K2p_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__K2p_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #ZO(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__ZO_Object___0__7X;
		public virtual RMethod R__0__ZO_Object___0__7X
		{
			get
			{
				if(r_R__0__ZO_Object___0__7X == null)
				{
					r_R__0__ZO_Object___0__7X = new(this, "#ZO", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__ZO_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__ZO_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #0O(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__0O_Object___0__7X;
		public virtual RMethod R__0__0O_Object___0__7X
		{
			get
			{
				if(r_R__0__0O_Object___0__7X == null)
				{
					r_R__0__0O_Object___0__7X = new(this, "#0O", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__0O_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__0O_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #L2p(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__L2p_Object___0__7X;
		public virtual RMethod R__0__L2p_Object___0__7X
		{
			get
			{
				if(r_R__0__L2p_Object___0__7X == null)
				{
					r_R__0__L2p_Object___0__7X = new(this, "#L2p", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__L2p_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__L2p_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #M2p(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__M2p_Object___0__7X;
		public virtual RMethod R__0__M2p_Object___0__7X
		{
			get
			{
				if(r_R__0__M2p_Object___0__7X == null)
				{
					r_R__0__M2p_Object___0__7X = new(this, "#M2p", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__M2p_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__M2p_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #3pd(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__3pd_Object___0__7X;
		public virtual RMethod R__0__3pd_Object___0__7X
		{
			get
			{
				if(r_R__0__3pd_Object___0__7X == null)
				{
					r_R__0__3pd_Object___0__7X = new(this, "#3pd", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__3pd_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__3pd_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #N2p(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__N2p_Object___0__7X;
		public virtual RMethod R__0__N2p_Object___0__7X
		{
			get
			{
				if(r_R__0__N2p_Object___0__7X == null)
				{
					r_R__0__N2p_Object___0__7X = new(this, "#N2p", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__N2p_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__N2p_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #Viq(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Viq_Object___0__7X;
		public virtual RMethod R__0__Viq_Object___0__7X
		{
			get
			{
				if(r_R__0__Viq_Object___0__7X == null)
				{
					r_R__0__Viq_Object___0__7X = new(this, "#Viq", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Viq_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Viq_Object___0__7X;
			}
		}
		...
		/// Void #O2p(Boolean)
		/// </summary>
		protected RMethod r_R__0__O2p_Boolean;
		public virtual RMethod R__0__O2p_Boolean
		{
			get
			{
				if(r_R__0__O2p_Boolean == null)
				{
					r_R__0__O2p_Boolean = new(this, "#O2p", 0, typeof(System.Boolean));
					r_R__0__O2p_Boolean.SetBelong(this.instance);
				}
				return r_R__0__O2p_Boolean;
			}
		}
		...
		/// Void #P2p(Int32)
		/// </summary>
		protected RMethod r_R__0__P2p_Int32;
		public virtual RMethod R__0__P2p_Int32
		{
			get
			{
				if(r_R__0__P2p_Int32 == null)
				{
					r_R__0__P2p_Int32 = new(this, "#P2p", 0, typeof(System.Int32));
					r_R__0__P2p_Int32.SetBelong(this.instance);
				}
				return r_R__0__P2p_Int32;
			}
		}

		/// <summary>
		/// Void #Q2p(Int32, Int32)
		/// </summary>
		protected RMethod r_R__0__Q2p_Int32_Int32;
		public virtual RMethod R__0__Q2p_Int32_Int32
		{
			get
			{
				if(r_R__0__Q2p_Int32_Int32 == null)
				{
					r_R__0__Q2p_Int32_Int32 = new(this, "#Q2p", 0, typeof(System.Int32), typeof(System.Int32));
					r_R__0__Q2p_Int32_Int32.SetBelong(this.instance);
				}
				return r_R__0__Q2p_Int32_Int32;
			}
		}
		...
		/// Void #R2p(Int32)
		/// </summary>
		protected RMethod r_R__0__R2p_Int32;
		public virtual RMethod R__0__R2p_Int32
		{
			get
			{
				if(r_R__0__R2p_Int32 == null)
				{
					r_R__0__R2p_Int32 = new(this, "#R2p", 0, typeof(System.Int32));
					r_R__0__R2p_Int32.SetBelong(this.instance);
				}
				return r_R__0__R2p_Int32;
			}
		}
		...
		/// Void #Wiq(Int32)
		/// </summary>
		protected RMethod r_R__0__Wiq_Int32;
		public virtual RMethod R__0__Wiq_Int32
		{
			get
			{
				if(r_R__0__Wiq_Int32 == null)
				{
					r_R__0__Wiq_Int32 = new(this, "#Wiq", 0, typeof(System.Int32));
					r_R__0__Wiq_Int32.SetBelong(this.instance);
				}
				return r_R__0__Wiq_Int32;
			}
		}
		...
		/// Void #S2p()
		/// </summary>
		protected RMethod r_R__0__S2p;
		public virtual RMethod R__0__S2p
		{
			get
			{
				if(r_R__0__S2p == null)
				{
					r_R__0__S2p = new(this, "#S2p", 0);
		...
		/// <summary>
		/// System.Collections.IEnumerator #eJn(UnityEngine.GameObject)
		/// </summary>
		protected RMethod r_R__0__eJn_GameObject;
		public virtual RMethod R__0__eJn_GameObject
		{
			get
			{
				if(r_R__0__eJn_GameObject == null)
				{
					r_R__0__eJn_GameObject = new(this, "#eJn", 0, typeof(UnityEngine.GameObject));
					r_R__0__eJn_GameObject.SetBelong(this.instance);
				}
				return r_R__0__eJn_GameObject;
			}
		}
		...
		/// Void #T2p()
		/// </summary>
		protected RMethod r_R__0__T2p;
		public virtual RMethod R__0__T2p
		{
			get
			{
				if(r_R__0__T2p == null)
				{
					r_R__0__T2p = new(this, "#T2p", 0);
					r_R__0__T2p.SetBelong(this.instance);
				}
				return r_R__0__T2p;
			}
		}
		...
		/// Void #U2p()
		/// </summary>
		protected RMethod r_R__0__U2p;
		public virtual RMethod R__0__U2p
		{
			get
			{
				if(r_R__0__U2p == null)
				{
					r_R__0__U2p = new(this, "#U2p", 0);
					r_R__0__U2p.SetBelong(this.instance);
				}
				return r_R__0__U2p;
			}
		}
		...
		/// Void #V2p()
		/// </summary>
		protected RMethod r_R__0__V2p;
		public virtual RMethod R__0__V2p
		{
			get
			{
				if(r_R__0__V2p == null)
				{
					r_R__0__V2p = new(this, "#V2p", 0);
					r_R__0__V2p.SetBelong(this.instance);
				}
				return r_R__0__V2p;
			}
		}
		...
		/// Int32 #W2p()
		/// </summary>
		protected RMethod r_R__0__W2p;
		public virtual RMethod R__0__W2p
		{
			get
			{
				if(r_R__0__W2p == null)
				{
					r_R__0__W2p = new(this, "#W2p", 0);
					r_R__0__W2p.SetBelong(this.instance);
				}
				return r_R__0__W2p;
			}
		}
		...
		/// Void #X2p()
		/// </summary>
		protected RMethod r_R__0__X2p;
		public virtual RMethod R__0__X2p
		{
			get
			{
				if(r_R__0__X2p == null)
				{
					r_R__0__X2p = new(this, "#X2p", 0);
					r_R__0__X2p.SetBelong(this.instance);
				}
				return r_R__0__X2p;
			}
		}
		...
		/// GoddessInfo #Y2p()
		/// </summary>
		protected RMethod r_R__0__Y2p;
		public virtual RMethod R__0__Y2p
		{
			get
			{
				if(r_R__0__Y2p == null)
				{
					r_R__0__Y2p = new(this, "#Y2p", 0);
					r_R__0__Y2p.SetBelong(this.instance);
				}
				return r_R__0__Y2p;
			}
		}
		...
		/// <summary>
		/// Int32 #Z2p(GoddessInfo, Int32)
		/// </summary>
		protected RMethod r_R__0__Z2p_GoddessInfo_Int32;
		public virtual RMethod R__0__Z2p_GoddessInfo_Int32
		{
			get
			{
				if(r_R__0__Z2p_GoddessInfo_Int32 == null)
				{
					r_R__0__Z2p_GoddessInfo_Int32 = new(this, "#Z2p", 0, typeof(GoddessInfo), typeof(System.Int32));
					r_R__0__Z2p_GoddessInfo_Int32.SetBelong(this.instance);
				}
				return r_R__0__Z2p_GoddessInfo_Int32;
			}
		}

		/// <summary>
		/// Single #02p(Int32, Int32)
		/// </summary>
		protected RMethod r_R__0__02p_Int32_Int32;
		public virtual RMethod R__0__02p_Int32_Int32
		{
			get
			{
				if(r_R__0__02p_Int32_Int32 == null)
				{
					r_R__0__02p_Int32_Int32 = new(this, "#02p", 0, typeof(System.Int32), typeof(System.Int32));
					r_R__0__02p_Int32_Int32.SetBelong(this.instance);
				}
				return r_R__0__02p_Int32_Int32;
			}
		}

		/// <summary>
		/// Void #v2p(eGoddessAttr, GoddessInfo, GoddessByLevel, Int32 ByRef)
		/// </summary>
		protected RMethod r_R__0__v2p_eGoddessAttr_GoddessInfo_GoddessByLevel_Ref_Int32;
		public virtual RMethod R__0__v2p_eGoddessAttr_GoddessInfo_GoddessByLevel_Ref_Int32
		{
			get
			{
				if(r_R__0__v2p_eGoddessAttr_GoddessInfo_GoddessByLevel_Ref_Int32 == null)
				{
					r_R__0__v2p_eGoddessAttr_GoddessInfo_GoddessByLevel_Ref_Int32 = new(this, "#v2p", 0, typeof(eGoddessAttr), typeof(GoddessInfo), typeof(GoddessByLevel), typeof(System.Int32).MakeByRefType());
					r_R__0__v2p_eGoddessAttr_GoddessInfo_GoddessByLevel_Ref_Int32.SetBelong(this.instance);
				}
				return r_R__0__v2p_eGoddessAttr_GoddessInfo_GoddessByLevel_Ref_Int32;
			}
		}
        ...
        public R__0__12p() : base("#u.#12p")
        {
        }

        public R__0__12p(System.Object instance) : base("#u.#12p")
		{
            SetInstance(instance);
		}

        public R__0__12p(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__12p(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__lBn()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__lBn.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__WSc()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__WSc.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__MHp()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__MHp.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__D2p()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__D2p.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__E2p()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__E2p.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__F2p(System.Int32  @level, System.String  @resBigIcon, System.String  @resName)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@level, @resBigIcon, @resName};
            var ___result = R__0__F2p_Int32_String_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__G2p(GoddessInfo  @info, GoddessByLevel  @levelInfo)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@info, @levelInfo};
            var ___result = R__0__G2p_GoddessInfo_GoddessByLevel.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__H2p(GoddessInfo  @info, eGoddessStatus  @status, GoddessByLevel  @levelInfo)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@info, @status, @levelInfo};
            var ___result = R__0__H2p_GoddessInfo_eGoddessStatus_GoddessByLevel.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__I2p(GoddessInfo  @info, GoddessByLevel  @levelInfo)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@info, @levelInfo};
            var ___result = R__0__I2p_GoddessInfo_GoddessByLevel.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__J2p(System.Int32  @index)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@index};
            var ___result = R__0__J2p_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__O2p(System.Boolean  @isLevelUp)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@isLevelUp};
            var ___result = R__0__O2p_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__P2p(System.Int32  @idGoddess)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@idGoddess};
            var ___result = R__0__P2p_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Q2p(System.Int32  @idGoddess, System.Int32  @lingshiNum)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@idGoddess, @lingshiNum};
            var ___result = R__0__Q2p_Int32_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__R2p(System.Int32  @idGoddess)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@idGoddess};
            var ___result = R__0__R2p_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Wiq(System.Int32  @idGoddess)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@idGoddess};
            var ___result = R__0__Wiq_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__S2p()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__S2p.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator __0__eJn(UnityEngine.GameObject  @obj)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@obj};
            var ___result = R__0__eJn_GameObject.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual void __0__T2p()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__T2p.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__U2p()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__U2p.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__V2p()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__V2p.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Int32 __0__W2p()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__W2p.Invoke(___genericsType, ___parameters);

            return (System.Int32)___result;
        }


        public virtual void __0__X2p()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__X2p.Invoke(___genericsType, ___parameters);

            
        }


        public virtual GoddessInfo __0__Y2p()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Y2p.Invoke(___genericsType, ___parameters);

            return (GoddessInfo)___result;
        }


        public virtual System.Int32 __0__Z2p(GoddessInfo  @infoNow, System.Int32  @lingshiNow)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@infoNow, @lingshiNow};
            var ___result = R__0__Z2p_GoddessInfo_Int32.Invoke(___genericsType, ___parameters);

            return (System.Int32)___result;
        }


        public virtual System.Single __0__02p(System.Int32  @exp, System.Int32  @expUpgrade)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@exp, @expUpgrade};
            var ___result = R__0__02p_Int32_Int32.Invoke(___genericsType, ___parameters);

            return (System.Single)___result;
        }


        public virtual void __0__v2p(eGoddessAttr  @type, GoddessInfo  @info, GoddessByLevel  @levelInfo, ref System.Int32  @attrIndexNow)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@type, @info, @levelInfo, @attrIndexNow};
            var ___result = R__0__v2p_eGoddessAttr_GoddessInfo_GoddessByLevel_Ref_Int32.Invoke(___genericsType, ___parameters);
			attrIndexNow = (System.Int32)___parameters[3];

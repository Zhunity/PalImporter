    ...
    public partial class R__0__Ytq : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#Ytq"), "#a");
		...
		/// Void #mk(#nxq, Boolean)
		/// </summary>
		protected RMethod r_R__0__mk___0__nxq_Boolean;
		public virtual RMethod R__0__mk___0__nxq_Boolean
		{
			get
			{
				if(r_R__0__mk___0__nxq_Boolean == null)
				{
					r_R__0__mk___0__nxq_Boolean = new(this, "#mk", 0,  ReleactionUtils.GetType("#u.#jxq+#nxq"), typeof(System.Boolean));
					r_R__0__mk___0__nxq_Boolean.SetBelong(this.instance);
				}
				return r_R__0__mk___0__nxq_Boolean;
			}
		}
        ...
        public R__0__Ytq() : base("#u.#Ytq")
        {
        }

        public R__0__Ytq(System.Object instance) : base("#u.#Ytq")
		{

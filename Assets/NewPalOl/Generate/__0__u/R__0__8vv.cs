...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#8vv
	/// </summary>
    public partial class R__0__8vv : RMember //
    {
		...
		/// <summary>
		/// Void #7vv(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__7vv_Object___0__7X;
		public virtual RMethod R__0__7vv_Object___0__7X
		{
			get
			{
				if(r_R__0__7vv_Object___0__7X == null)
				{
					r_R__0__7vv_Object___0__7X = new(this, "#7vv", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__7vv_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__7vv_Object___0__7X;
			}
		}
		...
		/// Void #OJv(Boolean)
		/// </summary>
		protected RMethod r_R__0__OJv_Boolean;
		public virtual RMethod R__0__OJv_Boolean
		{
			get
			{
				if(r_R__0__OJv_Boolean == null)
				{
					r_R__0__OJv_Boolean = new(this, "#OJv", 0, typeof(System.Boolean));
					r_R__0__OJv_Boolean.SetBelong(this.instance);
				}
				return r_R__0__OJv_Boolean;
			}
		}
        ...
        public R__0__8vv() : base("#u.#8vv")
        {
        }

        public R__0__8vv(System.Object instance) : base("#u.#8vv")
		{
            SetInstance(instance);
		}

        public R__0__8vv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8vv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__OJv(System.Boolean  @bCorrect)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bCorrect};
            var ___result = R__0__OJv_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__mk(System.Int32  @eventid, System.Int32  @questionID)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@eventid, @questionID};

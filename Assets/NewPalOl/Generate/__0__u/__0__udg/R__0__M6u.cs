...
{public partial class R__0__udg
{
	
	/// <summary>
	/// #u.#udg+#M6u
	/// </summary>
    public partial class R__0__M6u : RMember //
    {
        ...
        public R__0__M6u() : base("#u.#udg+#M6u")
        {
        }

        public R__0__M6u(System.Object instance) : base("#u.#udg+#M6u")
		{
            SetInstance(instance);
		}

        public R__0__M6u(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__M6u(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

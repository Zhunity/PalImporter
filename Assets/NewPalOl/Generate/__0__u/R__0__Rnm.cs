...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Rnm
	/// </summary>
    public partial class R__0__Rnm : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#Rnm"), "#a");
		...
		public static RField R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#Rnm"), "#b");
		...
		public static RField R__0__c
		{
			get
			{
				if(r___0__c == null)
				{
					r___0__c = new( ReleactionUtils.GetType("#u.#Rnm"), "#c");
		...
		public static RField R__0__d
		{
			get
			{
				if(r___0__d == null)
				{
					r___0__d = new( ReleactionUtils.GetType("#u.#Rnm"), "#d");
		...
		/// <summary>
		/// Void #Nnm(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Nnm_Object___0__7X;
		public virtual RMethod R__0__Nnm_Object___0__7X
		{
			get
			{
				if(r_R__0__Nnm_Object___0__7X == null)
				{
					r_R__0__Nnm_Object___0__7X = new(this, "#Nnm", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Nnm_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Nnm_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #Onm(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Onm_Object___0__7X;
		public virtual RMethod R__0__Onm_Object___0__7X
		{
			get
			{
				if(r_R__0__Onm_Object___0__7X == null)
				{
					r_R__0__Onm_Object___0__7X = new(this, "#Onm", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Onm_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Onm_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #Pnm(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Pnm_Object___0__7X;
		public virtual RMethod R__0__Pnm_Object___0__7X
		{
			get
			{
				if(r_R__0__Pnm_Object___0__7X == null)
				{
					r_R__0__Pnm_Object___0__7X = new(this, "#Pnm", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Pnm_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Pnm_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #Qnm(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Qnm_Object___0__7X;
		public virtual RMethod R__0__Qnm_Object___0__7X
		{
			get
			{
				if(r_R__0__Qnm_Object___0__7X == null)
				{
					r_R__0__Qnm_Object___0__7X = new(this, "#Qnm", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Qnm_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Qnm_Object___0__7X;
			}
		}
        ...
        public R__0__Rnm() : base("#u.#Rnm")
        {
        }

        public R__0__Rnm(System.Object instance) : base("#u.#Rnm")
		{
            SetInstance(instance);
		}

        public R__0__Rnm(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Rnm(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

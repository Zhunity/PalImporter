...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#zJ
	/// </summary>
    public partial class R__0__zJ : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#zJ"), "#a");
		...
		public static RFieldArray<RField> R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#zJ"), "#b");
		...
		/// EventHandler #d
		/// </summary>
		protected REventHandler r___0__d;
		public virtual REventHandler R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// </summary>
		protected REvent r_mHandle;
		public virtual REvent RmHandle
		{
			get
			{
				if(r_mHandle == null)
		...
		/// <summary>
		/// System.Collections.IEnumerator #vJ()
		/// </summary>
		...
		/// <summary>
		/// Void #wJ(EventHandler, Int32)
		/// </summary>
		protected RMethod r_R__0__wJ_EventHandler_Int32;
		public virtual RMethod R__0__wJ_EventHandler_Int32
		{
			get
			{
				if(r_R__0__wJ_EventHandler_Int32 == null)
				{
					r_R__0__wJ_EventHandler_Int32 = new(this, "#wJ", 0, typeof(EventHandler), typeof(System.Int32));
					r_R__0__wJ_EventHandler_Int32.SetBelong(this.instance);
				}
				return r_R__0__wJ_EventHandler_Int32;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator #xJ()
		/// </summary>
		...
		/// <summary>
		/// Void #yJ(EventHandler)
		/// </summary>
		protected RMethod r_R__0__yJ_EventHandler;
		public virtual RMethod R__0__yJ_EventHandler
		{
			get
			{
				if(r_R__0__yJ_EventHandler == null)
				{
					r_R__0__yJ_EventHandler = new(this, "#yJ", 0, typeof(EventHandler));
					r_R__0__yJ_EventHandler.SetBelong(this.instance);
				}
				return r_R__0__yJ_EventHandler;
			}
		}
		...
		/// Void #kF()
		/// </summary>
		protected RMethod r_R__0__kF;
		public virtual RMethod R__0__kF
		{
			get
			{
				if(r_R__0__kF == null)
				{
					r_R__0__kF = new(this, "#kF", 0);
					r_R__0__kF.SetBelong(this.instance);
				}
				return r_R__0__kF;
			}
		}
        ...
        public R__0__zJ() : base("#u.#zJ")
        {
        }

        public R__0__zJ(System.Object instance) : base("#u.#zJ")
		{
            SetInstance(instance);
		}

        public R__0__zJ(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zJ(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Collections.IEnumerator __0__vJ()
        {
        ...
        public virtual void __0__wJ(EventHandler  @handler, System.Int32  @deadTyp)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@handler, @deadTyp};
            var ___result = R__0__wJ_EventHandler_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Collections.IEnumerator __0__xJ()
        {
        ...
        public virtual void __0__yJ(EventHandler  @handler)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@handler};
            var ___result = R__0__yJ_EventHandler.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__kF()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__kF.Invoke(___genericsType, ___parameters);

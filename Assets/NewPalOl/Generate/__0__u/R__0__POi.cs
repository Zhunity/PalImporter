...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#POi
	/// </summary>
    public partial class R__0__POi : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(#u.#MNi, UnityEngine.AnimationClip)
		/// </summary>
		protected RMethod r_RInvoke___0__MNi_AnimationClip;
		public virtual RMethod RInvoke___0__MNi_AnimationClip
		{
			get
			{
				if(r_RInvoke___0__MNi_AnimationClip == null)
				{
					r_RInvoke___0__MNi_AnimationClip = new(this, "Invoke", 0,  ReleactionUtils.GetType("#u.#MNi"), typeof(UnityEngine.AnimationClip));
					r_RInvoke___0__MNi_AnimationClip.SetBelong(this.instance);
				}
				return r_RInvoke___0__MNi_AnimationClip;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(#u.#MNi, UnityEngine.AnimationClip, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke___0__MNi_AnimationClip_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke___0__MNi_AnimationClip_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke___0__MNi_AnimationClip_AsyncCallback_Object == null)
				{
					r_RBeginInvoke___0__MNi_AnimationClip_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("#u.#MNi"), typeof(UnityEngine.AnimationClip), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke___0__MNi_AnimationClip_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke___0__MNi_AnimationClip_AsyncCallback_Object;
			}
		}
        ...
        public R__0__POi() : base("#u.#POi")
        {
        }

        public R__0__POi(System.Object instance) : base("#u.#POi")
		{
            SetInstance(instance);
		}

        public R__0__POi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__POi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

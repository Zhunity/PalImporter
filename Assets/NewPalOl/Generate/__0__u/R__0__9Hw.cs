...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#9Hw
	/// </summary>
    public partial class R__0__9Hw : RMember //
    {
		...
		/// Void #DBm(Int32)
		/// </summary>
		protected RMethod r_R__0__DBm_Int32;
		public virtual RMethod R__0__DBm_Int32
		{
			get
			{
				if(r_R__0__DBm_Int32 == null)
				{
					r_R__0__DBm_Int32 = new(this, "#DBm", 0, typeof(System.Int32));
					r_R__0__DBm_Int32.SetBelong(this.instance);
				}
				return r_R__0__DBm_Int32;
			}
		}

		/// <summary>
		/// Void UpdateState(Boolean)
		/// </summary>
		protected RMethod r_RUpdateState_Boolean;
		public virtual RMethod RUpdateState_Boolean
		{
			get
			{
				if(r_RUpdateState_Boolean == null)
				{
					r_RUpdateState_Boolean = new(this, "UpdateState", 0, typeof(System.Boolean));
					r_RUpdateState_Boolean.SetBelong(this.instance);
				}
				return r_RUpdateState_Boolean;
			}
		}

		/// <summary>
		/// Void #Kb(System.Object, System.Object)
		/// </summary>
		protected RMethod r_R__0__Kb_Object_Object;
		public virtual RMethod R__0__Kb_Object_Object
		{
			get
			{
				if(r_R__0__Kb_Object_Object == null)
				{
					r_R__0__Kb_Object_Object = new(this, "#Kb", 0, typeof(System.Object), typeof(System.Object));
					r_R__0__Kb_Object_Object.SetBelong(this.instance);
				}
				return r_R__0__Kb_Object_Object;
			}
		}
        ...
        public R__0__9Hw() : base("#u.#9Hw")
        {
        }

        public R__0__9Hw(System.Object instance) : base("#u.#9Hw")
		{
            SetInstance(instance);
		}

        public R__0__9Hw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Hw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__DBm(System.Int32  @val)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@val};
            var ___result = R__0__DBm_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void UpdateState(System.Boolean  @isOpen)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@isOpen};
            var ___result = RUpdateState_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Kb(System.Object  @oldval, System.Object  @newval)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@oldval, @newval};
            var ___result = R__0__Kb_Object_Object.Invoke(___genericsType, ___parameters);

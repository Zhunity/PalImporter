...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#86
	/// </summary>
    public partial class R__0__86 : RMember //
    {
        ...
        public R__0__86() : base("#u.#86")
        {
        }

        public R__0__86(System.Object instance) : base("#u.#86")
		{
            SetInstance(instance);
		}

        public R__0__86(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__86(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#YKg
	/// </summary>
    public partial class R__0__YKg : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.List`1[#u.#YKg+#ZKg] #d
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__u.R__0__YKg.R__0__ZKg> r___0__d;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__u.R__0__YKg.R__0__ZKg> R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// <summary>
		/// System.Comparison`1[#u.#YKg+#ZKg] #g
		/// </summary>
		protected static RSystem.RComparison<R__0__u.R__0__YKg.R__0__ZKg> r___0__g;
		public static RSystem.RComparison<R__0__u.R__0__YKg.R__0__ZKg> R__0__g
		{
			get
			{
				if(r___0__g == null)
				{
					r___0__g = new( ReleactionUtils.GetType("#u.#YKg"), "#g");
		...
		/// Void #OKg(#Pfb.#eMg)
		/// </summary>
		protected RMethod r_R__0__OKg___0__eMg;
		public virtual RMethod R__0__OKg___0__eMg
		{
			get
			{
				if(r_R__0__OKg___0__eMg == null)
				{
					r_R__0__OKg___0__eMg = new(this, "#OKg", 0,  ReleactionUtils.GetType("#Pfb.#eMg"));
					r_R__0__OKg___0__eMg.SetBelong(this.instance);
				}
				return r_R__0__OKg___0__eMg;
			}
		}
		...
		/// Void #PKg()
		/// </summary>
		protected RMethod r_R__0__PKg;
		public virtual RMethod R__0__PKg
		{
			get
			{
				if(r_R__0__PKg == null)
				{
					r_R__0__PKg = new(this, "#PKg", 0);
					r_R__0__PKg.SetBelong(this.instance);
				}
				return r_R__0__PKg;
			}
		}
		...
		/// <summary>
		/// Void #QKg(System.Object)
		/// </summary>
		protected RMethod r_R__0__QKg_Object;
		public virtual RMethod R__0__QKg_Object
		{
			get
			{
				if(r_R__0__QKg_Object == null)
				{
					r_R__0__QKg_Object = new(this, "#QKg", 0, typeof(System.Object));
					r_R__0__QKg_Object.SetBelong(this.instance);
				}
				return r_R__0__QKg_Object;
			}
		}

		/// <summary>
		/// Void #RKg(System.Object)
		/// </summary>
		protected RMethod r_R__0__RKg_Object;
		public virtual RMethod R__0__RKg_Object
		{
			get
			{
				if(r_R__0__RKg_Object == null)
				{
					r_R__0__RKg_Object = new(this, "#RKg", 0, typeof(System.Object));
					r_R__0__RKg_Object.SetBelong(this.instance);
				}
				return r_R__0__RKg_Object;
			}
		}
		...
		/// Void #SKg()
		/// </summary>
		protected RMethod r_R__0__SKg;
		public virtual RMethod R__0__SKg
		{
			get
			{
				if(r_R__0__SKg == null)
				{
					r_R__0__SKg = new(this, "#SKg", 0);
					r_R__0__SKg.SetBelong(this.instance);
				}
				return r_R__0__SKg;
			}
		}
		...
		/// <summary>
		/// Void #TKg(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__TKg_Object___0__7X;
		public virtual RMethod R__0__TKg_Object___0__7X
		{
			get
			{
				if(r_R__0__TKg_Object___0__7X == null)
				{
					r_R__0__TKg_Object___0__7X = new(this, "#TKg", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__TKg_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__TKg_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #UKg(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__UKg_Object___0__7X;
		public virtual RMethod R__0__UKg_Object___0__7X
		{
			get
			{
				if(r_R__0__UKg_Object___0__7X == null)
				{
					r_R__0__UKg_Object___0__7X = new(this, "#UKg", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__UKg_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__UKg_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #WKg(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__WKg_Object___0__7X;
		public virtual RMethod R__0__WKg_Object___0__7X
		{
			get
			{
				if(r_R__0__WKg_Object___0__7X == null)
				{
					r_R__0__WKg_Object___0__7X = new(this, "#WKg", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__WKg_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__WKg_Object___0__7X;
			}
		}
		...
		/// Int32 #Iex(#ZKg, #ZKg)
		/// </summary>
		protected static RMethod r_R__0__Iex___0__ZKg___0__ZKg;
		public static RMethod R__0__Iex___0__ZKg___0__ZKg
		{
			get
			{
				if(r_R__0__Iex___0__ZKg___0__ZKg == null)
				{
					r_R__0__Iex___0__ZKg___0__ZKg = new( ReleactionUtils.GetType("#u.#YKg"), "#Iex", 0,  ReleactionUtils.GetType("#u.#YKg+#ZKg"),  ReleactionUtils.GetType("#u.#YKg+#ZKg"));
					r_R__0__Iex___0__ZKg___0__ZKg.SetBelong(null);
				}
				return r_R__0__Iex___0__ZKg___0__ZKg;
			}
		}
        ...
        public R__0__YKg() : base("#u.#YKg")
        {
        }

        public R__0__YKg(System.Object instance) : base("#u.#YKg")
		{
            SetInstance(instance);
		}

        public R__0__YKg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YKg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__PKg()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__PKg.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__QKg(System.Object  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@data};
            var ___result = R__0__QKg_Object.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__RKg(System.Object  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@data};
            var ___result = R__0__RKg_Object.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__SKg()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__SKg.Invoke(___genericsType, ___parameters);

...
{public partial class R__0__LL
{
	...
	/// #u.#LL+#ML
	/// </summary>
    public partial class R__0__ML : RMember //
    {
		...
		/// #oU.#Y2 #g
		/// </summary>
		protected R__0__oU.R__0__Y2 r___0__g;
		public virtual R__0__oU.R__0__Y2 R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__ML() : base("#u.#LL+#ML")
        {
        }

        public R__0__ML(System.Object instance) : base("#u.#LL+#ML")
		{
            SetInstance(instance);
		}

        public R__0__ML(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ML(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

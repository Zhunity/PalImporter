...
{public partial class R__0__LL
{
	
	/// <summary>
	/// #u.#LL+#QSw
	/// </summary>
    public partial class R__0__QSw : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.MonoBehaviour #f
		/// </summary>
		protected RUnityEngine.RMonoBehaviour r___0__f;
		public virtual RUnityEngine.RMonoBehaviour R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// #u.#LL #n
		/// </summary>
		protected R__0__u.R__0__LL r___0__n;
		public virtual R__0__u.R__0__LL R__0__n
		{
			get
			{
				if(r___0__n == null)
        ...
        public R__0__QSw() : base("#u.#LL+#QSw")
        {
        }

        public R__0__QSw(System.Object instance) : base("#u.#LL+#QSw")
		{
            SetInstance(instance);
		}

        public R__0__QSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__QSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

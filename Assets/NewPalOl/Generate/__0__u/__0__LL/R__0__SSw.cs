...
{public partial class R__0__LL
{
	...
	/// #u.#LL+#SSw
	/// </summary>
    public partial class R__0__SSw : RMember //
    {
		...
		/// NPCBehav #b
		/// </summary>
		protected RNPCBehav r___0__b;
		public virtual RNPCBehav R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// <summary>
		/// AssetBundleDownloader+AB_DOWNLOADER_ARGS #c
		/// </summary>
		protected RAssetBundleDownloader.RAB_DOWNLOADER_ARGS r___0__c;
		public virtual RAssetBundleDownloader.RAB_DOWNLOADER_ARGS R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// #u.#LL #g
		/// </summary>
		protected R__0__u.R__0__LL r___0__g;
		public virtual R__0__u.R__0__LL R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__SSw() : base("#u.#LL+#SSw")
        {
        }

        public R__0__SSw(System.Object instance) : base("#u.#LL+#SSw")
		{
            SetInstance(instance);
		}

        public R__0__SSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__SSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__XD
{
	...
	/// #u.#XD+#Qqx
	/// </summary>
    public partial class R__0__Qqx : RMember //
    {
		...
		/// #u.#XD #i
		/// </summary>
		protected R__0__u.R__0__XD r___0__i;
		public virtual R__0__u.R__0__XD R__0__i
		{
			get
			{
				if(r___0__i == null)
        ...
        public R__0__Qqx() : base("#u.#XD+#Qqx")
        {
        }

        public R__0__Qqx(System.Object instance) : base("#u.#XD+#Qqx")
		{
            SetInstance(instance);
		}

        public R__0__Qqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Qqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__XD
{
	...
	/// #u.#XD+#Rqx
	/// </summary>
    public partial class R__0__Rqx : RMember //
    {
		...
		/// #u.#XD #g
		/// </summary>
		protected R__0__u.R__0__XD r___0__g;
		public virtual R__0__u.R__0__XD R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__Rqx() : base("#u.#XD+#Rqx")
        {
        }

        public R__0__Rqx(System.Object instance) : base("#u.#XD+#Rqx")
		{
            SetInstance(instance);
		}

        public R__0__Rqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Rqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

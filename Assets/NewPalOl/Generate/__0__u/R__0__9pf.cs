...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#9pf
	/// </summary>
    public partial class R__0__9pf : RMember //
    {
		...
		/// #Pfb.#dnj #d
		/// </summary>
		protected R__0__Pfb.R__0__dnj r___0__d;
		public virtual R__0__Pfb.R__0__dnj R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// GameDefineType.ID[] #e
		/// </summary>
		protected RFieldArray<RGameDefineType.RID> r___0__e;
		public virtual RFieldArray<RGameDefineType.RID> R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// <summary>
		/// Void #8pf(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__8pf_Object___0__7X;
		public virtual RMethod R__0__8pf_Object___0__7X
		{
			get
			{
				if(r_R__0__8pf_Object___0__7X == null)
				{
					r_R__0__8pf_Object___0__7X = new(this, "#8pf", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__8pf_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__8pf_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #wlj(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__wlj_Object___0__7X;
		public virtual RMethod R__0__wlj_Object___0__7X
		{
			get
			{
				if(r_R__0__wlj_Object___0__7X == null)
				{
					r_R__0__wlj_Object___0__7X = new(this, "#wlj", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__wlj_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__wlj_Object___0__7X;
			}
		}
		...
		/// Void #xlj(#Pfb.#dnj)
		/// </summary>
		protected RMethod r_R__0__xlj___0__dnj;
		public virtual RMethod R__0__xlj___0__dnj
		{
			get
			{
				if(r_R__0__xlj___0__dnj == null)
				{
					r_R__0__xlj___0__dnj = new(this, "#xlj", 0,  ReleactionUtils.GetType("#Pfb.#dnj"));
					r_R__0__xlj___0__dnj.SetBelong(this.instance);
				}
				return r_R__0__xlj___0__dnj;
			}
		}
        ...
        public R__0__9pf() : base("#u.#9pf")
        {
        }

        public R__0__9pf(System.Object instance) : base("#u.#9pf")
		{
            SetInstance(instance);
		}

        public R__0__9pf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9pf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

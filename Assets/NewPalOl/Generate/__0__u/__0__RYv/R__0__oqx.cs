...
{public partial class R__0__RYv
{
	
	/// <summary>
	/// #u.#RYv+#oqx
	/// </summary>
    public partial class R__0__oqx : RMember //
    {

		/// <summary>
		/// #Pfb.#4Yv #a
		/// </summary>
		protected R__0__Pfb.R__0__4Yv r___0__a;
		public virtual R__0__Pfb.R__0__4Yv R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #u.#RYv #f
		/// </summary>
		protected R__0__u.R__0__RYv r___0__f;
		public virtual R__0__u.R__0__RYv R__0__f
		{
			get
			{
				if(r___0__f == null)
        ...
        public R__0__oqx() : base("#u.#RYv+#oqx")
        {
        }

        public R__0__oqx(System.Object instance) : base("#u.#RYv+#oqx")
		{
            SetInstance(instance);
		}

        public R__0__oqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

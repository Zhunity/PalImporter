...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#ZGr
	/// </summary>
    public partial class R__0__ZGr : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.Int32,System.Boolean] #a
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, RField> r___0__a;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1[System.Int32] #b
		/// </summary>
		...
		/// <summary>
		/// Void #Pr(System.String, System.String)
		/// </summary>
		protected RMethod r_R__0__Pr_String_String;
		public virtual RMethod R__0__Pr_String_String
		{
			get
			{
				if(r_R__0__Pr_String_String == null)
				{
					r_R__0__Pr_String_String = new(this, "#Pr", 0, typeof(System.String), typeof(System.String));
					r_R__0__Pr_String_String.SetBelong(this.instance);
				}
				return r_R__0__Pr_String_String;
			}
		}
		...
		/// Void #WGr(Int32)
		/// </summary>
		protected RMethod r_R__0__WGr_Int32;
		public virtual RMethod R__0__WGr_Int32
		{
			get
			{
				if(r_R__0__WGr_Int32 == null)
				{
					r_R__0__WGr_Int32 = new(this, "#WGr", 0, typeof(System.Int32));
					r_R__0__WGr_Int32.SetBelong(this.instance);
				}
				return r_R__0__WGr_Int32;
			}
		}
		...
		/// <summary>
		/// Void #XGr(Int32, Boolean)
		/// </summary>
		protected RMethod r_R__0__XGr_Int32_Boolean;
		public virtual RMethod R__0__XGr_Int32_Boolean
		{
			get
			{
				if(r_R__0__XGr_Int32_Boolean == null)
				{
					r_R__0__XGr_Int32_Boolean = new(this, "#XGr", 0, typeof(System.Int32), typeof(System.Boolean));
					r_R__0__XGr_Int32_Boolean.SetBelong(this.instance);
				}
				return r_R__0__XGr_Int32_Boolean;
			}
		}
        ...
        public R__0__ZGr() : base("#u.#ZGr")
        {
        }

        public R__0__ZGr(System.Object instance) : base("#u.#ZGr")
		{
            SetInstance(instance);
		}

        public R__0__ZGr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ZGr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Pr(System.String  @info, System.String  @rewardstate)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@info, @rewardstate};
            var ___result = R__0__Pr_String_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__WGr(System.Int32  @num)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@num};
            var ___result = R__0__WGr_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__XGr(System.Int32  @index, System.Boolean  @bActive)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@index, @bActive};
            var ___result = R__0__XGr_Int32_Boolean.Invoke(___genericsType, ___parameters);

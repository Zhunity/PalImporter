...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#5vk
	/// </summary>
    public partial class R__0__5vk : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#5vk"), "#a");
		...
		public static RField R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#5vk"), "#b");
		...
		public static RField R__0__c
		{
			get
			{
				if(r___0__c == null)
				{
					r___0__c = new( ReleactionUtils.GetType("#u.#5vk"), "#c");
		...
		public static RField R__0__d
		{
			get
			{
				if(r___0__d == null)
				{
					r___0__d = new( ReleactionUtils.GetType("#u.#5vk"), "#d");
		...
		/// <summary>
		/// Void #3vk(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__3vk_Object___0__7X;
		public virtual RMethod R__0__3vk_Object___0__7X
		{
			get
			{
				if(r_R__0__3vk_Object___0__7X == null)
				{
					r_R__0__3vk_Object___0__7X = new(this, "#3vk", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__3vk_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__3vk_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #4vk(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__4vk_Object___0__7X;
		public virtual RMethod R__0__4vk_Object___0__7X
		{
			get
			{
				if(r_R__0__4vk_Object___0__7X == null)
				{
					r_R__0__4vk_Object___0__7X = new(this, "#4vk", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__4vk_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__4vk_Object___0__7X;
			}
		}
        ...
        public R__0__5vk() : base("#u.#5vk")
        {
        }

        public R__0__5vk(System.Object instance) : base("#u.#5vk")
		{
            SetInstance(instance);
		}

        public R__0__5vk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5vk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

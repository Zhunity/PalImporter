...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Bid
	/// </summary>
    public partial class R__0__Bid : RMember //
    {
        ...
        public R__0__Bid() : base("#u.#Bid")
        {
        }

        public R__0__Bid(System.Object instance) : base("#u.#Bid")
		{
            SetInstance(instance);
		}

        public R__0__Bid(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Bid(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

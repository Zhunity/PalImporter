...
{public partial class R__0__d4c
{
	...
	/// #u.#d4c+#aYw
	/// </summary>
    public partial class R__0__aYw : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.Dictionary`2+KeyCollection+Enumerator[GameDefineType.ID,System.Collections.Generic.Queue`1[#Pfb.#n6c]] #a
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, RField>.RKeyCollection.REnumerator r___0__a;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, RField>.RKeyCollection.REnumerator R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #Pfb.#n6c #c
		/// </summary>
		protected R__0__Pfb.R__0__n6c r___0__c;
		public virtual R__0__Pfb.R__0__n6c R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// #u.#d4c #h
		/// </summary>
		protected R__0__u.R__0__d4c r___0__h;
		public virtual R__0__u.R__0__d4c R__0__h
		{
			get
			{
				if(r___0__h == null)
        ...
        public R__0__aYw() : base("#u.#d4c+#aYw")
        {
        }

        public R__0__aYw(System.Object instance) : base("#u.#d4c+#aYw")
		{
            SetInstance(instance);
		}

        public R__0__aYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__aYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

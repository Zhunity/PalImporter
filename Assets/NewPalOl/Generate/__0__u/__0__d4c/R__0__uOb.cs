...
{public partial class R__0__d4c
{
	
	/// <summary>
	/// #u.#d4c+#uOb
	/// </summary>
    public partial class R__0__uOb : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Object, #Pfb.#n6c)
		/// </summary>
		protected RMethod r_RInvoke_Object___0__n6c;
		public virtual RMethod RInvoke_Object___0__n6c
		{
			get
			{
				if(r_RInvoke_Object___0__n6c == null)
				{
					r_RInvoke_Object___0__n6c = new(this, "Invoke", 0, typeof(System.Object),  ReleactionUtils.GetType("#Pfb.#n6c"));
					r_RInvoke_Object___0__n6c.SetBelong(this.instance);
				}
				return r_RInvoke_Object___0__n6c;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, #Pfb.#n6c, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Object___0__n6c_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object___0__n6c_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object___0__n6c_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object___0__n6c_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object),  ReleactionUtils.GetType("#Pfb.#n6c"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object___0__n6c_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object___0__n6c_AsyncCallback_Object;
			}
		}
        ...
        public R__0__uOb() : base("#u.#d4c+#uOb")
        {
        }

        public R__0__uOb(System.Object instance) : base("#u.#d4c+#uOb")
		{
            SetInstance(instance);
		}

        public R__0__uOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__uOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#RAi
	/// </summary>
    public partial class R__0__RAi : RMember //
    {
		...
		/// Void #Edi(#u.#Ckb)
		/// </summary>
		protected RMethod r_R__0__Edi___0__Ckb;
		public virtual RMethod R__0__Edi___0__Ckb
		{
			get
			{
				if(r_R__0__Edi___0__Ckb == null)
				{
					r_R__0__Edi___0__Ckb = new(this, "#Edi", 0,  ReleactionUtils.GetType("#u.#Ckb"));
					r_R__0__Edi___0__Ckb.SetBelong(this.instance);
				}
				return r_R__0__Edi___0__Ckb;
			}
		}
        ...
        public R__0__RAi() : base("#u.#RAi")
        {
        }

        public R__0__RAi(System.Object instance) : base("#u.#RAi")
		{
            SetInstance(instance);
		}

        public R__0__RAi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__RAi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

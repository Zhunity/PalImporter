...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#hol
	/// </summary>
    public partial class R__0__hol : RMember //
    {
        ...
        public R__0__hol() : base("#u.#hol")
        {
        }

        public R__0__hol(System.Object instance) : base("#u.#hol")
		{
            SetInstance(instance);
		}

        public R__0__hol(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hol(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

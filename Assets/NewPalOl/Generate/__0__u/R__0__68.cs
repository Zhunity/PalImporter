...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#68
	/// </summary>
    public partial class R__0__68 : RMember //
    {

		/// <summary>
		/// #Pfb.#3ob #a
		/// </summary>
		protected R__0__Pfb.R__0__3ob r___0__a;
		public virtual R__0__Pfb.R__0__3ob R__0__a
		{
			get
			{
				if(r___0__a == null)
        ...
        public R__0__68() : base("#u.#68")
        {
        }

        public R__0__68(System.Object instance) : base("#u.#68")
		{
            SetInstance(instance);
		}

        public R__0__68(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__68(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

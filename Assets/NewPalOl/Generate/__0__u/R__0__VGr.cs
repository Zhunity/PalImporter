...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#VGr
	/// </summary>
    public partial class R__0__VGr : RMember //
    {
		...
		/// <summary>
		/// AnniversaryFragment #c
		/// </summary>
		protected RAnniversaryFragment r___0__c;
		public virtual RAnniversaryFragment R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// <summary>
		/// Void #mk(AnniversaryFragment, Boolean)
		/// </summary>
		protected RMethod r_R__0__mk_AnniversaryFragment_Boolean;
		public virtual RMethod R__0__mk_AnniversaryFragment_Boolean
		{
			get
			{
				if(r_R__0__mk_AnniversaryFragment_Boolean == null)
				{
					r_R__0__mk_AnniversaryFragment_Boolean = new(this, "#mk", 0, typeof(AnniversaryFragment), typeof(System.Boolean));
					r_R__0__mk_AnniversaryFragment_Boolean.SetBelong(this.instance);
				}
				return r_R__0__mk_AnniversaryFragment_Boolean;
			}
		}

		/// <summary>
		/// Void UpdateState(Int32, Boolean)
		/// </summary>
		protected RMethod r_RUpdateState_Int32_Boolean;
		public virtual RMethod RUpdateState_Int32_Boolean
		{
			get
			{
				if(r_RUpdateState_Int32_Boolean == null)
				{
					r_RUpdateState_Int32_Boolean = new(this, "UpdateState", 0, typeof(System.Int32), typeof(System.Boolean));
					r_RUpdateState_Int32_Boolean.SetBelong(this.instance);
				}
				return r_RUpdateState_Int32_Boolean;
			}
		}
        ...
        public R__0__VGr() : base("#u.#VGr")
        {
        }

        public R__0__VGr(System.Object instance) : base("#u.#VGr")
		{
            SetInstance(instance);
		}

        public R__0__VGr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__VGr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__mk(AnniversaryFragment  @cfg, System.Boolean  @bActive)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cfg, @bActive};
            var ___result = R__0__mk_AnniversaryFragment_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void UpdateState(System.Int32  @index, System.Boolean  @bActive)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@index, @bActive};
            var ___result = RUpdateState_Int32_Boolean.Invoke(___genericsType, ___parameters);

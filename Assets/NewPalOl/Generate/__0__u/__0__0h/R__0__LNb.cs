...
{public partial class R__0__0h
{
	
	/// <summary>
	/// #u.#0h+#LNb
	/// </summary>
    public partial class R__0__LNb : RMember //
    {
        ...
        public R__0__LNb() : base("#u.#0h+#LNb")
        {
        }

        public R__0__LNb(System.Object instance) : base("#u.#0h+#LNb")
		{
            SetInstance(instance);
		}

        public R__0__LNb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__LNb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

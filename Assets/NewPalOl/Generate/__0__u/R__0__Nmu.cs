...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Nmu
	/// </summary>
    public partial class R__0__Nmu : RMember //
    {
        ...
        public R__0__Nmu() : base("#u.#Nmu")
        {
        }

        public R__0__Nmu(System.Object instance) : base("#u.#Nmu")
		{
            SetInstance(instance);
		}

        public R__0__Nmu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Nmu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

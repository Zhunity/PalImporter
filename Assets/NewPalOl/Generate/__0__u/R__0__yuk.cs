...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#yuk
	/// </summary>
    public partial class R__0__yuk : RMember //
    {
		...
		/// Void #sb(#zuk)
		/// </summary>
		protected RMethod r_R__0__sb___0__zuk;
		public virtual RMethod R__0__sb___0__zuk
		{
			get
			{
				if(r_R__0__sb___0__zuk == null)
				{
					r_R__0__sb___0__zuk = new(this, "#sb", 0,  ReleactionUtils.GetType("#u.#yuk+#zuk"));
					r_R__0__sb___0__zuk.SetBelong(this.instance);
				}
				return r_R__0__sb___0__zuk;
			}
		}

		/// <summary>
		/// Void LoadConfig(Int32)
		/// </summary>
		protected RMethod r_RLoadConfig_Int32;
		public virtual RMethod RLoadConfig_Int32
		{
			get
			{
				if(r_RLoadConfig_Int32 == null)
				{
					r_RLoadConfig_Int32 = new(this, "LoadConfig", 0, typeof(System.Int32));
					r_RLoadConfig_Int32.SetBelong(this.instance);
				}
				return r_RLoadConfig_Int32;
			}
		}
        ...
        public R__0__yuk() : base("#u.#yuk")
        {
        }

        public R__0__yuk(System.Object instance) : base("#u.#yuk")
		{
            SetInstance(instance);
		}

        public R__0__yuk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__yuk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void LoadConfig(System.Int32  @id)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id};
            var ___result = RLoadConfig_Int32.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#b4d
	/// </summary>
    public partial class R__0__b4d : RMember //
    {
        ...
        public R__0__b4d() : base("#u.#b4d")
        {
        }

        public R__0__b4d(System.Object instance) : base("#u.#b4d")
		{
            SetInstance(instance);
		}

        public R__0__b4d(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__b4d(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

    ...
    public partial class R__0__Wci : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#Wci"), "#a");
		...
		public static RField R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#Wci"), "#b");
		...
		public static RField R__0__c
		{
			get
			{
				if(r___0__c == null)
				{
					r___0__c = new( ReleactionUtils.GetType("#u.#Wci"), "#c");
		...
		/// #u.#6ei #d
		/// </summary>
		protected R__0__u.R__0__6ei r___0__d;
		public virtual R__0__u.R__0__6ei R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// Void #Vci(#u.#6ei)
		/// </summary>
		protected RMethod r_R__0__Vci___0__6ei;
		public virtual RMethod R__0__Vci___0__6ei
		{
			get
			{
				if(r_R__0__Vci___0__6ei == null)
				{
					r_R__0__Vci___0__6ei = new(this, "#Vci", 0,  ReleactionUtils.GetType("#u.#6ei"));
					r_R__0__Vci___0__6ei.SetBelong(this.instance);
				}
				return r_R__0__Vci___0__6ei;
			}
		}
        ...
        public R__0__Wci() : base("#u.#Wci")
        {
        }

        public R__0__Wci(System.Object instance) : base("#u.#Wci")
		{

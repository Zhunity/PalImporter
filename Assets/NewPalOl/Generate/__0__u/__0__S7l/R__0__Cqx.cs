...
{public partial class R__0__S7l
{
	
	/// <summary>
	/// #u.#S7l+#Cqx
	/// </summary>
    public partial class R__0__Cqx : RMember //
    {
		...
		/// </summary>
		protected RSystem.RCollections.RIEnumerator r___0__c;
		public virtual RSystem.RCollections.RIEnumerator R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// </summary>
		protected RUnityEngine.RTransform r___0__d;
		public virtual RUnityEngine.RTransform R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// UIeffect #f
		/// </summary>
		protected RUIeffect r___0__f;
		public virtual RUIeffect R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// </summary>
		protected RSystem.RCollections.RIEnumerator r___0__i;
		public virtual RSystem.RCollections.RIEnumerator R__0__i
		{
			get
			{
				if(r___0__i == null)
		...
		/// #u.#S7l #o
		/// </summary>
		protected R__0__u.R__0__S7l r___0__o;
		public virtual R__0__u.R__0__S7l R__0__o
		{
			get
			{
				if(r___0__o == null)
        ...
        public R__0__Cqx() : base("#u.#S7l+#Cqx")
        {
        }

        public R__0__Cqx(System.Object instance) : base("#u.#S7l+#Cqx")
		{
            SetInstance(instance);
		}

        public R__0__Cqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Cqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

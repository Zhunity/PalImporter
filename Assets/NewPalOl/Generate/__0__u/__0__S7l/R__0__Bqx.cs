...
{public partial class R__0__S7l
{
	...
	/// #u.#S7l+#Bqx
	/// </summary>
    public partial class R__0__Bqx : RMember //
    {
		...
		/// MonsterTowerSeal #c
		/// </summary>
		protected RMonsterTowerSeal r___0__c;
		public virtual RMonsterTowerSeal R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// #u.#S7l #i
		/// </summary>
		protected R__0__u.R__0__S7l r___0__i;
		public virtual R__0__u.R__0__S7l R__0__i
		{
			get
			{
				if(r___0__i == null)
        ...
        public R__0__Bqx() : base("#u.#S7l+#Bqx")
        {
        }

        public R__0__Bqx(System.Object instance) : base("#u.#S7l+#Bqx")
		{
            SetInstance(instance);
		}

        public R__0__Bqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Bqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#sgf
	/// </summary>
    public partial class R__0__sgf : RMember //
    {
		...
		/// Void #Scg(Int32)
		/// </summary>
		protected RMethod r_R__0__Scg_Int32;
		public virtual RMethod R__0__Scg_Int32
		{
			get
			{
				if(r_R__0__Scg_Int32 == null)
				{
					r_R__0__Scg_Int32 = new(this, "#Scg", 0, typeof(System.Int32));
					r_R__0__Scg_Int32.SetBelong(this.instance);
				}
				return r_R__0__Scg_Int32;
			}
		}
		...
		/// Void #rgf()
		/// </summary>
		protected RMethod r_R__0__rgf;
		public virtual RMethod R__0__rgf
		{
			get
			{
				if(r_R__0__rgf == null)
				{
					r_R__0__rgf = new(this, "#rgf", 0);
					r_R__0__rgf.SetBelong(this.instance);
				}
				return r_R__0__rgf;
			}
		}
        ...
        public R__0__sgf() : base("#u.#sgf")
        {
        }

        public R__0__sgf(System.Object instance) : base("#u.#sgf")
		{
            SetInstance(instance);
		}

        public R__0__sgf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__sgf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Scg(System.Int32  @num)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@num};
            var ___result = R__0__Scg_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__rgf()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__rgf.Invoke(___genericsType, ___parameters);

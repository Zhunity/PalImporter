...
{public partial class R__0__Ewd
{
	...
	/// #u.#Ewd+#UQw
	/// </summary>
    public partial class R__0__UQw : RMember //
    {
		...
		/// #u.#Ewd #m
		/// </summary>
		protected R__0__u.R__0__Ewd r___0__m;
		public virtual R__0__u.R__0__Ewd R__0__m
		{
			get
			{
				if(r___0__m == null)
        ...
        public R__0__UQw() : base("#u.#Ewd+#UQw")
        {
        }

        public R__0__UQw(System.Object instance) : base("#u.#Ewd+#UQw")
		{
            SetInstance(instance);
		}

        public R__0__UQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__UQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

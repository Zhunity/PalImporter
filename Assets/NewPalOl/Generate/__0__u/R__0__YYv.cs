...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#YYv
	/// </summary>
    public partial class R__0__YYv : RMember //
    {
        ...
        public R__0__YYv() : base("#u.#YYv")
        {
        }

        public R__0__YYv(System.Object instance) : base("#u.#YYv")
		{
            SetInstance(instance);
		}

        public R__0__YYv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YYv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

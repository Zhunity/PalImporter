...
{public partial class R__0__gT
{
	
	/// <summary>
	/// #u.#gT+#LNb2
	/// </summary>
    public partial class R__0__LNb2 : RMember //
    {
		...
		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.String, System.Object, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_String_Object_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_String_Object_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_String_Object_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_String_Object_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.String), typeof(System.Object), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_String_Object_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_String_Object_AsyncCallback_Object;
			}
		}
        ...
        public R__0__LNb2() : base("#u.#gT+#LNb2")
        {
        }

        public R__0__LNb2(System.Object instance) : base("#u.#gT+#LNb2")
		{
            SetInstance(instance);
		}

        public R__0__LNb2(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__LNb2(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.String  @str, System.Object  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@str, @data};
        ...
        public virtual System.IAsyncResult BeginInvoke(System.String  @str, System.Object  @data, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@str, @data, @callback, @object};
            var ___result = RBeginInvoke_String_Object_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#qT
	/// </summary>
    public partial class R__0__qT : RMember //
    {
		...
		/// <summary>
		/// Void #pT(System.String)
		/// </summary>
		protected RMethod r_R__0__pT_String;
		public virtual RMethod R__0__pT_String
		{
			get
			{
				if(r_R__0__pT_String == null)
				{
					r_R__0__pT_String = new(this, "#pT", 0, typeof(System.String));
					r_R__0__pT_String.SetBelong(this.instance);
				}
				return r_R__0__pT_String;
			}
		}
		...
		/// <summary>
		/// Void #dw(System.String)
		/// </summary>
		protected RMethod r_R__0__dw_String;
		public virtual RMethod R__0__dw_String
		{
			get
			{
				if(r_R__0__dw_String == null)
				{
					r_R__0__dw_String = new(this, "#dw", 0, typeof(System.String));
					r_R__0__dw_String.SetBelong(this.instance);
				}
				return r_R__0__dw_String;
			}
		}
        ...
        public R__0__qT() : base("#u.#qT")
        {
        }

        public R__0__qT(System.Object instance) : base("#u.#qT")
		{
            SetInstance(instance);
		}

        public R__0__qT(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__qT(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__pT(System.String  @text)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text};
            var ___result = R__0__pT_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__dw(System.String  @tipText)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@tipText};
            var ___result = R__0__dw_String.Invoke(___genericsType, ___parameters);

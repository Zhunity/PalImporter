...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#0E
	/// </summary>
    public partial class R__0__0E : RMember //
    {
		...
		/// #oU.#X4 #b
		/// </summary>
		protected R__0__oU.R__0__X4 r___0__b;
		public virtual R__0__oU.R__0__X4 R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// #oU.#uU #d
		/// </summary>
		protected R__0__oU.R__0__uU r___0__d;
		public virtual R__0__oU.R__0__uU R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.String,System.Collections.Generic.Dictionary`2[System.String,MyGUI.ElementBase]] #F
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, RSystem.RCollections.RGeneric.RDictionary<RField, RMyGUI.RElementBase>> r___0__F;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, RSystem.RCollections.RGeneric.RDictionary<RField, RMyGUI.RElementBase>> R__0__F
		{
			get
			{
				if(r___0__F == null)
		...
		/// RANK_INFO #H
		/// </summary>
		protected RRANK_INFO r___0__H;
		public virtual RRANK_INFO R__0__H
		{
			get
			{
				if(r___0__H == null)
		...
		public static RField R__0__I
		{
			get
			{
				if(r___0__I == null)
				{
					r___0__I = new( ReleactionUtils.GetType("#u.#0E"), "#I");
		...
		/// MyGUI.ElementBase #K
		/// </summary>
		protected RMyGUI.RElementBase r___0__K;
		public virtual RMyGUI.RElementBase R__0__K
		{
			get
			{
				if(r___0__K == null)
		...
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__M
		{
			get
			{
				if(r___0__M == null)
				{
					r___0__M = new( ReleactionUtils.GetType("#u.#0E"), "#M");
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.String,System.Int32] #N
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RDictionary<RField, RField> r___0__N;
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__N
		{
			get
			{
				if(r___0__N == null)
				{
					r___0__N = new( ReleactionUtils.GetType("#u.#0E"), "#N");
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.String,System.Int32] #O
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RDictionary<RField, RField> r___0__O;
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__O
		{
			get
			{
				if(r___0__O == null)
				{
					r___0__O = new( ReleactionUtils.GetType("#u.#0E"), "#O");
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.String,System.Int32] #P
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RDictionary<RField, RField> r___0__P;
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__P
		{
			get
			{
				if(r___0__P == null)
				{
					r___0__P = new( ReleactionUtils.GetType("#u.#0E"), "#P");
		...
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RDictionary<RField, RField> r___0__Q;
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__Q
		{
			get
			{
				if(r___0__Q == null)
				{
					r___0__Q = new( ReleactionUtils.GetType("#u.#0E"), "#Q");
		...
		/// #u.#EGd+#JGd #R
		/// </summary>
		protected static R__0__u.R__0__EGd.R__0__JGd r___0__R;
		public static R__0__u.R__0__EGd.R__0__JGd R__0__R
		{
			get
			{
				if(r___0__R == null)
				{
					r___0__R = new( ReleactionUtils.GetType("#u.#0E"), "#R");
		...
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__S
		{
			get
			{
				if(r___0__S == null)
				{
					r___0__S = new( ReleactionUtils.GetType("#u.#0E"), "#S");
		...
		/// <summary>
		/// System.String TEXT_RANK
		/// </summary>
		protected RProperty r_R__0__xsl;
		public virtual RProperty R__0__xsl
		{
			get
			{
				if(r_R__0__xsl == null)
				{
					r_R__0__xsl = new(this, "TEXT_RANK", -1);
					r_R__0__xsl.SetBelong(this.instance);
				}
				return r_R__0__xsl;
			}
		}
		...
		/// <summary>
		/// System.String TEXT_CAREER
		/// </summary>
		protected RProperty r_R__0__ysl;
		public virtual RProperty R__0__ysl
		{
			get
			{
				if(r_R__0__ysl == null)
				{
					r_R__0__ysl = new(this, "TEXT_CAREER", -1);
					r_R__0__ysl.SetBelong(this.instance);
				}
				return r_R__0__ysl;
			}
		}
		...
		/// <summary>
		/// System.String TEXT_REWARD
		/// </summary>
		protected RProperty r_R__0__zsl;
		public virtual RProperty R__0__zsl
		{
			get
			{
				if(r_R__0__zsl == null)
				{
					r_R__0__zsl = new(this, "TEXT_REWARD", -1);
					r_R__0__zsl.SetBelong(this.instance);
				}
				return r_R__0__zsl;
			}
		}
		...
		/// <summary>
		/// System.String TEXT_TITLE
		/// </summary>
		protected RProperty r_R__0__Asl;
		public virtual RProperty R__0__Asl
		{
			get
			{
				if(r_R__0__Asl == null)
				{
					r_R__0__Asl = new(this, "TEXT_TITLE", -1);
					r_R__0__Asl.SetBelong(this.instance);
				}
				return r_R__0__Asl;
			}
		}
		...
		/// <summary>
		/// System.String TEXT_DEVIL_PROGRESS
		/// </summary>
		protected RProperty r_R__0__Bsl;
		public virtual RProperty R__0__Bsl
		{
			get
			{
				if(r_R__0__Bsl == null)
				{
					r_R__0__Bsl = new(this, "TEXT_DEVIL_PROGRESS", -1);
					r_R__0__Bsl.SetBelong(this.instance);
				}
				return r_R__0__Bsl;
			}
		}
		...
		/// <summary>
		/// Void #w6b(System.String)
		/// </summary>
		protected RMethod r_R__0__w6b_String;
		public virtual RMethod R__0__w6b_String
		{
			get
			{
				if(r_R__0__w6b_String == null)
				{
					r_R__0__w6b_String = new(this, "#w6b", 0, typeof(System.String));
					r_R__0__w6b_String.SetBelong(this.instance);
				}
				return r_R__0__w6b_String;
			}
		}
		...
		/// <summary>
		/// Void #Cb(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Cb_Object___0__7X;
		public virtual RMethod R__0__Cb_Object___0__7X
		{
			get
			{
				if(r_R__0__Cb_Object___0__7X == null)
				{
					r_R__0__Cb_Object___0__7X = new(this, "#Cb", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Cb_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Cb_Object___0__7X;
			}
		}
		...
		/// Void #OE(RANK_INFO)
		/// </summary>
		protected RMethod r_R__0__OE_RANK_INFO;
		public virtual RMethod R__0__OE_RANK_INFO
		{
			get
			{
				if(r_R__0__OE_RANK_INFO == null)
				{
					r_R__0__OE_RANK_INFO = new(this, "#OE", 0, typeof(RANK_INFO));
					r_R__0__OE_RANK_INFO.SetBelong(this.instance);
				}
				return r_R__0__OE_RANK_INFO;
			}
		}
		...
		/// </summary>
		protected static RMethod r_RCompare_String_String;
		public static RMethod RCompare_String_String
		{
			get
			{
				...
				{
					r_RCompare_String_String = new( ReleactionUtils.GetType("#u.#0E"), "Compare", 0, typeof(System.String), typeof(System.String));
					r_RCompare_String_String.SetBelong(null);
				}
		...
		/// <summary>
		/// System.String #PE(System.String, Int32, Int32)
		/// </summary>
		protected RMethod r_R__0__PE_String_Int32_Int32;
		public virtual RMethod R__0__PE_String_Int32_Int32
		{
			get
			{
				if(r_R__0__PE_String_Int32_Int32 == null)
				{
					r_R__0__PE_String_Int32_Int32 = new(this, "#PE", 0, typeof(System.String), typeof(System.Int32), typeof(System.Int32));
					r_R__0__PE_String_Int32_Int32.SetBelong(this.instance);
				}
				return r_R__0__PE_String_Int32_Int32;
			}
		}

		/// <summary>
		/// Void #QE(System.String, Int32, Single ByRef, Single, Single)
		/// </summary>
		protected RMethod r_R__0__QE_String_Int32_Ref_Single_Single_Single;
		public virtual RMethod R__0__QE_String_Int32_Ref_Single_Single_Single
		{
			get
			{
				if(r_R__0__QE_String_Int32_Ref_Single_Single_Single == null)
				{
					r_R__0__QE_String_Int32_Ref_Single_Single_Single = new(this, "#QE", 0, typeof(System.String), typeof(System.Int32), typeof(System.Single).MakeByRefType(), typeof(System.Single), typeof(System.Single));
					r_R__0__QE_String_Int32_Ref_Single_Single_Single.SetBelong(this.instance);
				}
				return r_R__0__QE_String_Int32_Ref_Single_Single_Single;
			}
		}

		/// <summary>
		/// Void #8k(System.String, System.String, Int32, Int32)
		/// </summary>
		protected RMethod r_R__0__8k_String_String_Int32_Int32;
		public virtual RMethod R__0__8k_String_String_Int32_Int32
		{
			get
			{
				if(r_R__0__8k_String_String_Int32_Int32 == null)
				{
					r_R__0__8k_String_String_Int32_Int32 = new(this, "#8k", 0, typeof(System.String), typeof(System.String), typeof(System.Int32), typeof(System.Int32));
					r_R__0__8k_String_String_Int32_Int32.SetBelong(this.instance);
				}
				return r_R__0__8k_String_String_Int32_Int32;
			}
		}

		/// <summary>
		/// Void #Z9c(MyGUI.ElementBase, System.String, Int32)
		/// </summary>
		protected RMethod r_R__0__Z9c_ElementBase_String_Int32;
		public virtual RMethod R__0__Z9c_ElementBase_String_Int32
		{
			get
			{
				if(r_R__0__Z9c_ElementBase_String_Int32 == null)
				{
					r_R__0__Z9c_ElementBase_String_Int32 = new(this, "#Z9c", 0, typeof(MyGUI.ElementBase), typeof(System.String), typeof(System.Int32));
					r_R__0__Z9c_ElementBase_String_Int32.SetBelong(this.instance);
				}
				return r_R__0__Z9c_ElementBase_String_Int32;
			}
		}

		/// <summary>
		/// Void #RE(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__RE_Object___0__7X;
		public virtual RMethod R__0__RE_Object___0__7X
		{
			get
			{
				if(r_R__0__RE_Object___0__7X == null)
				{
					r_R__0__RE_Object___0__7X = new(this, "#RE", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__RE_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__RE_Object___0__7X;
			}
		}

		/// <summary>
		/// System.String #SE(Int32, System.String, System.String, #oU.#I1, Single ByRef, Single, Single)
		/// </summary>
		protected RMethod r_R__0__SE_Int32_String_String___0__I1_Ref_Single_Single_Single;
		public virtual RMethod R__0__SE_Int32_String_String___0__I1_Ref_Single_Single_Single
		{
			get
			{
				if(r_R__0__SE_Int32_String_String___0__I1_Ref_Single_Single_Single == null)
				{
					r_R__0__SE_Int32_String_String___0__I1_Ref_Single_Single_Single = new(this, "#SE", 0, typeof(System.Int32), typeof(System.String), typeof(System.String),  ReleactionUtils.GetType("#oU.#I1"), typeof(System.Single).MakeByRefType(), typeof(System.Single), typeof(System.Single));
					r_R__0__SE_Int32_String_String___0__I1_Ref_Single_Single_Single.SetBelong(this.instance);
				}
				return r_R__0__SE_Int32_String_String___0__I1_Ref_Single_Single_Single;
			}
		}
		...
		/// <summary>
		/// Boolean #VE(System.String)
		/// </summary>
		protected RMethod r_R__0__VE_String;
		public virtual RMethod R__0__VE_String
		{
			get
			{
				if(r_R__0__VE_String == null)
				{
					r_R__0__VE_String = new(this, "#VE", 0, typeof(System.String));
					r_R__0__VE_String.SetBelong(this.instance);
				}
				return r_R__0__VE_String;
			}
		}

		/// <summary>
		/// Boolean #WE(System.String)
		/// </summary>
		protected RMethod r_R__0__WE_String;
		public virtual RMethod R__0__WE_String
		{
			get
			{
				if(r_R__0__WE_String == null)
				{
					r_R__0__WE_String = new(this, "#WE", 0, typeof(System.String));
					r_R__0__WE_String.SetBelong(this.instance);
				}
				return r_R__0__WE_String;
			}
		}

		/// <summary>
		/// Void #XE(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__XE_Object___0__7X;
		public virtual RMethod R__0__XE_Object___0__7X
		{
			get
			{
				if(r_R__0__XE_Object___0__7X == null)
				{
					r_R__0__XE_Object___0__7X = new(this, "#XE", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__XE_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__XE_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #YE(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__YE_Object___0__7X;
		public virtual RMethod R__0__YE_Object___0__7X
		{
			get
			{
				if(r_R__0__YE_Object___0__7X == null)
				{
					r_R__0__YE_Object___0__7X = new(this, "#YE", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__YE_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__YE_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #ZE(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__ZE_Object___0__7X;
		public virtual RMethod R__0__ZE_Object___0__7X
		{
			get
			{
				if(r_R__0__ZE_Object___0__7X == null)
				{
					r_R__0__ZE_Object___0__7X = new(this, "#ZE", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__ZE_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__ZE_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #Yuc(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Yuc_Object___0__7X;
		public virtual RMethod R__0__Yuc_Object___0__7X
		{
			get
			{
				if(r_R__0__Yuc_Object___0__7X == null)
				{
					r_R__0__Yuc_Object___0__7X = new(this, "#Yuc", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Yuc_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Yuc_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #Zuc(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Zuc_Object___0__7X;
		public virtual RMethod R__0__Zuc_Object___0__7X
		{
			get
			{
				if(r_R__0__Zuc_Object___0__7X == null)
				{
					r_R__0__Zuc_Object___0__7X = new(this, "#Zuc", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Zuc_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Zuc_Object___0__7X;
			}
		}

		/// <summary>
		/// System.String #0uc(System.String, Int32)
		/// </summary>
		protected RMethod r_R__0__0uc_String_Int32;
		public virtual RMethod R__0__0uc_String_Int32
		{
			get
			{
				if(r_R__0__0uc_String_Int32 == null)
				{
					r_R__0__0uc_String_Int32 = new(this, "#0uc", 0, typeof(System.String), typeof(System.Int32));
					r_R__0__0uc_String_Int32.SetBelong(this.instance);
				}
				return r_R__0__0uc_String_Int32;
			}
		}

		/// <summary>
		/// Void #yex(#u.#BGd, System.Object, MyGUI.ElementBase, System.Object)
		/// </summary>
		protected static RMethod r_R__0__yex___0__BGd_Object_ElementBase_Object;
		public static RMethod R__0__yex___0__BGd_Object_ElementBase_Object
		{
			get
			{
				if(r_R__0__yex___0__BGd_Object_ElementBase_Object == null)
				{
					r_R__0__yex___0__BGd_Object_ElementBase_Object = new( ReleactionUtils.GetType("#u.#0E"), "#yex", 0,  ReleactionUtils.GetType("#u.#BGd"), typeof(System.Object), typeof(MyGUI.ElementBase), typeof(System.Object));
					r_R__0__yex___0__BGd_Object_ElementBase_Object.SetBelong(null);
				}
				return r_R__0__yex___0__BGd_Object_ElementBase_Object;
			}
		}
        ...
        public R__0__0E() : base("#u.#0E")
        {
        }

        public R__0__0E(System.Object instance) : base("#u.#0E")
		{
            SetInstance(instance);
		}

        public R__0__0E(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0E(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__w6b(System.String  @subtype)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@subtype};
            var ___result = R__0__w6b_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__OE(RANK_INFO  @info)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@info};
            var ___result = R__0__OE_RANK_INFO.Invoke(___genericsType, ___parameters);

            
        }


        public static System.Int32 Compare(System.String  @tmp1, System.String  @tmp2)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@tmp1, @tmp2};
        ...
        public virtual System.String __0__PE(System.String  @type, System.Int32  @myrank, System.Int32  @myval)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@type, @myrank, @myval};
            var ___result = R__0__PE_String_Int32_Int32.Invoke(___genericsType, ___parameters);

            return (System.String)___result;
        }


        public virtual void __0__QE(System.String  @colname, System.Int32  @rankIdx, ref System.Single  @height, System.Single  @x, System.Single  @y)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@colname, @rankIdx, @height, @x, @y};
            var ___result = R__0__QE_String_Int32_Ref_Single_Single_Single.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__8k(System.String  @type, System.String  @strInfo, System.Int32  @myrank, System.Int32  @myVal)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@type, @strInfo, @myrank, @myVal};
            var ___result = R__0__8k_String_String_Int32_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Z9c(MyGUI.ElementBase  @elem, System.String  @type, System.Int32  @rankIdx)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@elem, @type, @rankIdx};
            var ___result = R__0__Z9c_ElementBase_String_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Boolean __0__VE(System.String  @name)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@name};
            var ___result = R__0__VE_String.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual System.Boolean __0__WE(System.String  @name)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@name};
            var ___result = R__0__WE_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.String __0__0uc(System.String  @type, System.Int32  @idx)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@type, @idx};
            var ___result = R__0__0uc_String_Int32.Invoke(___genericsType, ___parameters);

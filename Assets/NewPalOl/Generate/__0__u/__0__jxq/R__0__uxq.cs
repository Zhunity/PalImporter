...
{public partial class R__0__jxq
{
	...
	/// #u.#jxq+#uxq
	/// </summary>
    public partial class R__0__uxq : RMember //
    {
        ...
        public R__0__uxq() : base("#u.#jxq+#uxq")
        {
        }

        public R__0__uxq(System.Object instance) : base("#u.#jxq+#uxq")
		{
            SetInstance(instance);
		}

        public R__0__uxq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__uxq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

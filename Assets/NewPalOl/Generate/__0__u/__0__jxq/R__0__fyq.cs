...
{public partial class R__0__jxq
{
	
	/// <summary>
	/// #u.#jxq+#fyq
	/// </summary>
    public partial class R__0__fyq : RMember //
    {
        ...
        public R__0__fyq() : base("#u.#jxq+#fyq")
        {
        }

        public R__0__fyq(System.Object instance) : base("#u.#jxq+#fyq")
		{
            SetInstance(instance);
		}

        public R__0__fyq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fyq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Boolean Invoke(System.String[]  @arrayInfo)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@arrayInfo};
        ...
        public virtual System.IAsyncResult BeginInvoke(System.String[]  @arrayInfo, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@arrayInfo, @callback, @object};

...
{public partial class R__0__jxq
{
	...
	/// #u.#jxq+#pxq
	/// </summary>
    public partial class R__0__pxq : RMember //
    {
        ...
        public R__0__pxq() : base("#u.#jxq+#pxq")
        {
        }

        public R__0__pxq(System.Object instance) : base("#u.#jxq+#pxq")
		{
            SetInstance(instance);
		}

        public R__0__pxq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__pxq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

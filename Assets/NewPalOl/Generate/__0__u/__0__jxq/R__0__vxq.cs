...
{public partial class R__0__jxq
{
	...
	/// #u.#jxq+#vxq
	/// </summary>
    public partial class R__0__vxq : RMember //
    {
        ...
        public R__0__vxq() : base("#u.#jxq+#vxq")
        {
        }

        public R__0__vxq(System.Object instance) : base("#u.#jxq+#vxq")
		{
            SetInstance(instance);
		}

        public R__0__vxq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__vxq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

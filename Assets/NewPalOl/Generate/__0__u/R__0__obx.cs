...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#obx
	/// </summary>
    public partial class R__0__obx : RMember //
    {
        ...
        public R__0__obx() : base("#u.#obx")
        {
        }

        public R__0__obx(System.Object instance) : base("#u.#obx")
		{
            SetInstance(instance);
		}

        public R__0__obx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__obx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#TS
	/// </summary>
    public partial class R__0__TS : RMember //
    {
        ...
        public R__0__TS() : base("#u.#TS")
        {
        }

        public R__0__TS(System.Object instance) : base("#u.#TS")
		{
            SetInstance(instance);
		}

        public R__0__TS(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__TS(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

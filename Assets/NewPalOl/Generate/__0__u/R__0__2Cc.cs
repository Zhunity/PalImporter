...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#2Cc
	/// </summary>
    public partial class R__0__2Cc : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#2Cc"), "#a");
        ...
        public R__0__2Cc() : base("#u.#2Cc")
        {
        }

        public R__0__2Cc(System.Object instance) : base("#u.#2Cc")
		{
            SetInstance(instance);
		}

        public R__0__2Cc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2Cc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

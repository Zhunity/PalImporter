...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#HOc
	/// </summary>
    public partial class R__0__HOc : RMember //
    {
        ...
        public R__0__HOc() : base("#u.#HOc")
        {
        }

        public R__0__HOc(System.Object instance) : base("#u.#HOc")
		{
            SetInstance(instance);
		}

        public R__0__HOc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__HOc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

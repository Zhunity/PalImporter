...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#OJh
	/// </summary>
    public partial class R__0__OJh : RMember //
    {
		...
		/// <summary>
		/// Void #sb(Int32, System.String)
		/// </summary>
		protected RMethod r_R__0__sb_Int32_String;
		public virtual RMethod R__0__sb_Int32_String
		{
			get
			{
				if(r_R__0__sb_Int32_String == null)
				{
					r_R__0__sb_Int32_String = new(this, "#sb", 0, typeof(System.Int32), typeof(System.String));
					r_R__0__sb_Int32_String.SetBelong(this.instance);
				}
				return r_R__0__sb_Int32_String;
			}
		}
		...
		/// <summary>
		/// Void #Xd(Int32, System.String)
		/// </summary>
		protected RMethod r_R__0__Xd_Int32_String;
		public virtual RMethod R__0__Xd_Int32_String
		{
			get
			{
				if(r_R__0__Xd_Int32_String == null)
				{
					r_R__0__Xd_Int32_String = new(this, "#Xd", 0, typeof(System.Int32), typeof(System.String));
					r_R__0__Xd_Int32_String.SetBelong(this.instance);
				}
				return r_R__0__Xd_Int32_String;
			}
		}
        ...
        public R__0__OJh() : base("#u.#OJh")
        {
        }

        public R__0__OJh(System.Object instance) : base("#u.#OJh")
		{
            SetInstance(instance);
		}

        public R__0__OJh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__OJh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__sb(System.Int32  @type, System.String  @name)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@type, @name};
            var ___result = R__0__sb_Int32_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__Xd(System.Int32  @type, System.String  @name)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@type, @name};
            var ___result = R__0__Xd_Int32_String.Invoke(___genericsType, ___parameters);

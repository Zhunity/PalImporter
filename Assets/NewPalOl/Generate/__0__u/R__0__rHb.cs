...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#rHb
	/// </summary>
    public partial class R__0__rHb : RMember //
    {
        ...
        public R__0__rHb() : base("#u.#rHb")
        {
        }

        public R__0__rHb(System.Object instance) : base("#u.#rHb")
		{
            SetInstance(instance);
		}

        public R__0__rHb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__rHb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void __0__Pr(System.String  @next)
        {

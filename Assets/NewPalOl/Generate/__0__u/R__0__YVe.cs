...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#YVe
	/// </summary>
    public partial class R__0__YVe : RMember //
    {
		...
		/// <summary>
		/// Void #VVe(Int32, Int32)
		/// </summary>
		protected RMethod r_R__0__VVe_Int32_Int32;
		public virtual RMethod R__0__VVe_Int32_Int32
		{
			get
			{
				if(r_R__0__VVe_Int32_Int32 == null)
				{
					r_R__0__VVe_Int32_Int32 = new(this, "#VVe", 0, typeof(System.Int32), typeof(System.Int32));
					r_R__0__VVe_Int32_Int32.SetBelong(this.instance);
				}
				return r_R__0__VVe_Int32_Int32;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator #WVe(Int32)
		/// </summary>
		protected RMethod r_R__0__WVe_Int32;
		public virtual RMethod R__0__WVe_Int32
		{
			get
			{
				if(r_R__0__WVe_Int32 == null)
				{
					r_R__0__WVe_Int32 = new(this, "#WVe", 0, typeof(System.Int32));
					r_R__0__WVe_Int32.SetBelong(this.instance);
				}
				return r_R__0__WVe_Int32;
			}
		}
		...
		/// Void #XVe()
		/// </summary>
		protected RMethod r_R__0__XVe;
		public virtual RMethod R__0__XVe
		{
			get
			{
				if(r_R__0__XVe == null)
				{
					r_R__0__XVe = new(this, "#XVe", 0);
					r_R__0__XVe.SetBelong(this.instance);
				}
				return r_R__0__XVe;
			}
		}
        ...
        public R__0__YVe() : base("#u.#YVe")
        {
        }

        public R__0__YVe(System.Object instance) : base("#u.#YVe")
		{
            SetInstance(instance);
		}

        public R__0__YVe(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YVe(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__VVe(System.Int32  @idSkipTask, System.Int32  @idTutorial)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@idSkipTask, @idTutorial};
            var ___result = R__0__VVe_Int32_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Collections.IEnumerator __0__WVe(System.Int32  @nSkipTask)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@nSkipTask};
            var ___result = R__0__WVe_Int32.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual void __0__XVe()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__XVe.Invoke(___genericsType, ___parameters);

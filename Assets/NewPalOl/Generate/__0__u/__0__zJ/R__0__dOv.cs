...
{public partial class R__0__zJ
{
	...
	/// #u.#zJ+#dOv
	/// </summary>
    public partial class R__0__dOv : RMember //
    {
		...
		/// #u.#zJ #c
		/// </summary>
		protected R__0__u.R__0__zJ r___0__c;
		public virtual R__0__u.R__0__zJ R__0__c
		{
			get
			{
				if(r___0__c == null)
        ...
        public R__0__dOv() : base("#u.#zJ+#dOv")
        {
        }

        public R__0__dOv(System.Object instance) : base("#u.#zJ+#dOv")
		{
            SetInstance(instance);
		}

        public R__0__dOv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dOv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

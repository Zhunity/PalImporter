...
{public partial class R__0__zJ
{
	
	/// <summary>
	/// #u.#zJ+#cOv
	/// </summary>
    public partial class R__0__cOv : RMember //
    {
		...
		/// #u.#zJ #d
		/// </summary>
		protected R__0__u.R__0__zJ r___0__d;
		public virtual R__0__u.R__0__zJ R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__cOv() : base("#u.#zJ+#cOv")
        {
        }

        public R__0__cOv(System.Object instance) : base("#u.#zJ+#cOv")
		{
            SetInstance(instance);
		}

        public R__0__cOv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cOv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#OC
	/// </summary>
    public partial class R__0__OC : RMember //
    {
		...
		/// Creature #c
		/// </summary>
		protected RCreature r___0__c;
		public virtual RCreature R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// <summary>
		/// GameDefineType.ID m_TargetID
		/// </summary>
		protected RGameDefineType.RID r_R__0__wC;
		public virtual RGameDefineType.RID R__0__wC
		{
			get
			{
				if(r_R__0__wC == null)
				{
					r_R__0__wC = new(this, "m_TargetID", -1);
					r_R__0__wC.SetBelong(this.instance);
				}
				return r_R__0__wC;
			}
		}
		...
		/// <summary>
		/// Void #X1d(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__X1d_Object___0__7X;
		public virtual RMethod R__0__X1d_Object___0__7X
		{
			get
			{
				if(r_R__0__X1d_Object___0__7X == null)
				{
					r_R__0__X1d_Object___0__7X = new(this, "#X1d", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__X1d_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__X1d_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #CC(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__CC_Object___0__7X;
		public virtual RMethod R__0__CC_Object___0__7X
		{
			get
			{
				if(r_R__0__CC_Object___0__7X == null)
				{
					r_R__0__CC_Object___0__7X = new(this, "#CC", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__CC_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__CC_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #Y1d(System.String)
		/// </summary>
		protected RMethod r_R__0__Y1d_String;
		public virtual RMethod R__0__Y1d_String
		{
			get
			{
				if(r_R__0__Y1d_String == null)
				{
					r_R__0__Y1d_String = new(this, "#Y1d", 0, typeof(System.String));
					r_R__0__Y1d_String.SetBelong(this.instance);
				}
				return r_R__0__Y1d_String;
			}
		}
		...
		/// <summary>
		/// Void #7td(System.String)
		/// </summary>
		protected RMethod r_R__0__7td_String;
		public virtual RMethod R__0__7td_String
		{
			get
			{
				if(r_R__0__7td_String == null)
				{
					r_R__0__7td_String = new(this, "#7td", 0, typeof(System.String));
					r_R__0__7td_String.SetBelong(this.instance);
				}
				return r_R__0__7td_String;
			}
		}

		/// <summary>
		/// Void #Z1d(System.String)
		/// </summary>
		protected RMethod r_R__0__Z1d_String;
		public virtual RMethod R__0__Z1d_String
		{
			get
			{
				if(r_R__0__Z1d_String == null)
				{
					r_R__0__Z1d_String = new(this, "#Z1d", 0, typeof(System.String));
					r_R__0__Z1d_String.SetBelong(this.instance);
				}
				return r_R__0__Z1d_String;
			}
		}
		...
		/// Boolean #ckf(NPC)
		/// </summary>
		protected RMethod r_R__0__ckf_NPC;
		public virtual RMethod R__0__ckf_NPC
		{
			get
			{
				if(r_R__0__ckf_NPC == null)
				{
					r_R__0__ckf_NPC = new(this, "#ckf", 0,  ReleactionUtils.GetType("NPC"));
					r_R__0__ckf_NPC.SetBelong(this.instance);
				}
				return r_R__0__ckf_NPC;
			}
		}
		...
		/// Void #dkf()
		/// </summary>
		protected RMethod r_R__0__dkf;
		public virtual RMethod R__0__dkf
		{
			get
			{
				if(r_R__0__dkf == null)
				{
					r_R__0__dkf = new(this, "#dkf", 0);
					r_R__0__dkf.SetBelong(this.instance);
				}
				return r_R__0__dkf;
			}
		}
		...
		/// Void #ekf()
		/// </summary>
		protected RMethod r_R__0__ekf;
		public virtual RMethod R__0__ekf
		{
			get
			{
				if(r_R__0__ekf == null)
				{
					r_R__0__ekf = new(this, "#ekf", 0);
					r_R__0__ekf.SetBelong(this.instance);
				}
				return r_R__0__ekf;
			}
		}
		...
		/// <summary>
		/// Void #KC(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__KC_ID;
		public virtual RMethod R__0__KC_ID
		{
			get
			{
				if(r_R__0__KC_ID == null)
				{
					r_R__0__KC_ID = new(this, "#KC", 0, typeof(GameDefineType.ID));
					r_R__0__KC_ID.SetBelong(this.instance);
				}
				return r_R__0__KC_ID;
			}
		}

		/// <summary>
		/// Void #LC(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__LC_ID;
		public virtual RMethod R__0__LC_ID
		{
			get
			{
				if(r_R__0__LC_ID == null)
				{
					r_R__0__LC_ID = new(this, "#LC", 0, typeof(GameDefineType.ID));
					r_R__0__LC_ID.SetBelong(this.instance);
				}
				return r_R__0__LC_ID;
			}
		}
		...
		/// Boolean #MC()
		/// </summary>
		protected RMethod r_R__0__MC;
		public virtual RMethod R__0__MC
		{
			get
			{
				if(r_R__0__MC == null)
				{
					r_R__0__MC = new(this, "#MC", 0);
					r_R__0__MC.SetBelong(this.instance);
				}
				return r_R__0__MC;
			}
		}
		...
		/// Boolean #NC()
		/// </summary>
		protected RMethod r_R__0__NC;
		public virtual RMethod R__0__NC
		{
			get
			{
				if(r_R__0__NC == null)
				{
					r_R__0__NC = new(this, "#NC", 0);
					r_R__0__NC.SetBelong(this.instance);
				}
				return r_R__0__NC;
			}
		}
        ...
        public R__0__OC() : base("#u.#OC")
        {
        }

        public R__0__OC(System.Object instance) : base("#u.#OC")
		{
            SetInstance(instance);
		}

        public R__0__OC(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__OC(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Y1d(System.String  @zhandouli)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@zhandouli};
            var ___result = R__0__Y1d_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__7td(System.String  @szlv)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@szlv};
            var ___result = R__0__7td_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Z1d(System.String  @careername)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@careername};
            var ___result = R__0__Z1d_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__dkf()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__dkf.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__ekf()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__ekf.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__KC(GameDefineType.ID  @id)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id};
            var ___result = R__0__KC_ID.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__LC(GameDefineType.ID  @targetId)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@targetId};
            var ___result = R__0__LC_ID.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Boolean __0__MC()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__MC.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual System.Boolean __0__NC()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__NC.Invoke(___genericsType, ___parameters);

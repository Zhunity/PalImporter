...
{public partial class R__0__Muq
{
	
	/// <summary>
	/// #u.#Muq+#Mqx
	/// </summary>
    public partial class R__0__Mqx : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.Animation #e
		/// </summary>
		protected RUnityEngine.RAnimation r___0__e;
		public virtual RUnityEngine.RAnimation R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// #u.#Muq #g
		/// </summary>
		protected R__0__u.R__0__Muq r___0__g;
		public virtual R__0__u.R__0__Muq R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__Mqx() : base("#u.#Muq+#Mqx")
        {
        }

        public R__0__Mqx(System.Object instance) : base("#u.#Muq+#Mqx")
		{
            SetInstance(instance);
		}

        public R__0__Mqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Mqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

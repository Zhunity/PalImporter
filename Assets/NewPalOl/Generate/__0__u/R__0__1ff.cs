...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#1ff
	/// </summary>
    public partial class R__0__1ff : RMember //
    {
		...
		/// Void #Xff()
		/// </summary>
		protected RMethod r_R__0__Xff;
		public virtual RMethod R__0__Xff
		{
			get
			{
				if(r_R__0__Xff == null)
				{
					r_R__0__Xff = new(this, "#Xff", 0);
					r_R__0__Xff.SetBelong(this.instance);
				}
				return r_R__0__Xff;
			}
		}
		...
		/// Void #sb(#2ff)
		/// </summary>
		protected RMethod r_R__0__sb___0__2ff;
		public virtual RMethod R__0__sb___0__2ff
		{
			get
			{
				if(r_R__0__sb___0__2ff == null)
				{
					r_R__0__sb___0__2ff = new(this, "#sb", 0,  ReleactionUtils.GetType("#u.#1ff+#2ff"));
					r_R__0__sb___0__2ff.SetBelong(this.instance);
				}
				return r_R__0__sb___0__2ff;
			}
		}
		...
		/// Void #Yff()
		/// </summary>
		protected RMethod r_R__0__Yff;
		public virtual RMethod R__0__Yff
		{
			get
			{
				if(r_R__0__Yff == null)
				{
					r_R__0__Yff = new(this, "#Yff", 0);
					r_R__0__Yff.SetBelong(this.instance);
				}
				return r_R__0__Yff;
			}
		}
		...
		/// Void #Zff()
		/// </summary>
		protected RMethod r_R__0__Zff;
		public virtual RMethod R__0__Zff
		{
			get
			{
				if(r_R__0__Zff == null)
				{
					r_R__0__Zff = new(this, "#Zff", 0);
					r_R__0__Zff.SetBelong(this.instance);
				}
				return r_R__0__Zff;
			}
		}
		...
		/// <summary>
		/// Void #0ff(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__0ff_Object___0__7X;
		public virtual RMethod R__0__0ff_Object___0__7X
		{
			get
			{
				if(r_R__0__0ff_Object___0__7X == null)
				{
					r_R__0__0ff_Object___0__7X = new(this, "#0ff", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__0ff_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__0ff_Object___0__7X;
			}
		}

		/// <summary>
		/// System.Collections.IEnumerator #mZg(Single)
		/// </summary>
		protected RMethod r_R__0__mZg_Single;
		public virtual RMethod R__0__mZg_Single
		{
			get
			{
				if(r_R__0__mZg_Single == null)
				{
					r_R__0__mZg_Single = new(this, "#mZg", 0, typeof(System.Single));
					r_R__0__mZg_Single.SetBelong(this.instance);
				}
				return r_R__0__mZg_Single;
			}
		}
        ...
        public R__0__1ff() : base("#u.#1ff")
        {
        }

        public R__0__1ff(System.Object instance) : base("#u.#1ff")
		{
            SetInstance(instance);
		}

        public R__0__1ff(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__1ff(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Xff()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Xff.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__Yff()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Yff.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Zff()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Zff.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Collections.IEnumerator __0__mZg(System.Single  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time};
            var ___result = R__0__mZg_Single.Invoke(___genericsType, ___parameters);

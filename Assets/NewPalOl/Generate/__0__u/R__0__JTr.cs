...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#JTr
	/// </summary>
    public partial class R__0__JTr : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.Int32,#u.#JTr+#KTr] #k
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, R__0__u.R__0__JTr.R__0__KTr> r___0__k;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, R__0__u.R__0__JTr.R__0__KTr> R__0__k
		{
			get
			{
				if(r___0__k == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1[#u.#JTr+#KTr] #l
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__u.R__0__JTr.R__0__KTr> r___0__l;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__u.R__0__JTr.R__0__KTr> R__0__l
		{
			get
			{
				if(r___0__l == null)
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.Int32,System.String] #m
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, RField> r___0__m;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__m
		{
			get
			{
				if(r___0__m == null)
		...
		/// <summary>
		/// Void #L5r(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__L5r_Object___0__7X;
		public virtual RMethod R__0__L5r_Object___0__7X
		{
			get
			{
				if(r_R__0__L5r_Object___0__7X == null)
				{
					r_R__0__L5r_Object___0__7X = new(this, "#L5r", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__L5r_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__L5r_Object___0__7X;
			}
		}
		...
		/// Void #M5r()
		/// </summary>
		protected RMethod r_R__0__M5r;
		public virtual RMethod R__0__M5r
		{
			get
			{
				if(r_R__0__M5r == null)
				{
					r_R__0__M5r = new(this, "#M5r", 0);
					r_R__0__M5r.SetBelong(this.instance);
				}
				return r_R__0__M5r;
			}
		}
		...
		/// <summary>
		/// Int32 CompareTo(#KTr, #KTr)
		/// </summary>
		protected RMethod r_RCompareTo___0__KTr___0__KTr;
		public virtual RMethod RCompareTo___0__KTr___0__KTr
		{
			get
			{
				if(r_RCompareTo___0__KTr___0__KTr == null)
				{
					r_RCompareTo___0__KTr___0__KTr = new(this, "CompareTo", 0,  ReleactionUtils.GetType("#u.#JTr+#KTr"),  ReleactionUtils.GetType("#u.#JTr+#KTr"));
					r_RCompareTo___0__KTr___0__KTr.SetBelong(this.instance);
				}
				return r_RCompareTo___0__KTr___0__KTr;
			}
		}
		...
		/// Void #N5r()
		/// </summary>
		protected RMethod r_R__0__N5r;
		public virtual RMethod R__0__N5r
		{
			get
			{
				if(r_R__0__N5r == null)
				{
					r_R__0__N5r = new(this, "#N5r", 0);
					r_R__0__N5r.SetBelong(this.instance);
				}
				return r_R__0__N5r;
			}
		}
		...
		/// <summary>
		/// Void #AM(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__AM_Object___0__7X;
		public virtual RMethod R__0__AM_Object___0__7X
		{
			get
			{
				if(r_R__0__AM_Object___0__7X == null)
				{
					r_R__0__AM_Object___0__7X = new(this, "#AM", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__AM_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__AM_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #NE(System.Collections.Generic.List`1[AchievementConfig])
		/// </summary>
		protected RMethod r_R__0__NE_List_d_AchievementConfig_p_;
		public virtual RMethod R__0__NE_List_d_AchievementConfig_p_
		{
			get
			{
				if(r_R__0__NE_List_d_AchievementConfig_p_ == null)
				{
					r_R__0__NE_List_d_AchievementConfig_p_ = new(this, "#NE", 0, typeof(System.Collections.Generic.List<>).MakeGenericType(typeof(AchievementConfig)));
					r_R__0__NE_List_d_AchievementConfig_p_.SetBelong(this.instance);
				}
				return r_R__0__NE_List_d_AchievementConfig_p_;
			}
		}

		/// <summary>
		/// Void #HTr(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__HTr_Object___0__7X;
		public virtual RMethod R__0__HTr_Object___0__7X
		{
			get
			{
				if(r_R__0__HTr_Object___0__7X == null)
				{
					r_R__0__HTr_Object___0__7X = new(this, "#HTr", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__HTr_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__HTr_Object___0__7X;
			}
		}
		...
		/// Void #yKk(#Pfb.#gVr)
		/// </summary>
		protected RMethod r_R__0__yKk___0__gVr;
		public virtual RMethod R__0__yKk___0__gVr
		{
			get
			{
				if(r_R__0__yKk___0__gVr == null)
				{
					r_R__0__yKk___0__gVr = new(this, "#yKk", 0,  ReleactionUtils.GetType("#Pfb.#gVr"));
					r_R__0__yKk___0__gVr.SetBelong(this.instance);
				}
				return r_R__0__yKk___0__gVr;
			}
		}
		...
		/// Void #ITr(#Pfb.#hVr)
		/// </summary>
		protected RMethod r_R__0__ITr___0__hVr;
		public virtual RMethod R__0__ITr___0__hVr
		{
			get
			{
				if(r_R__0__ITr___0__hVr == null)
				{
					r_R__0__ITr___0__hVr = new(this, "#ITr", 0,  ReleactionUtils.GetType("#Pfb.#hVr"));
					r_R__0__ITr___0__hVr.SetBelong(this.instance);
				}
				return r_R__0__ITr___0__hVr;
			}
		}
		...
		/// Void #O5r(#Pfb.#g8r)
		/// </summary>
		protected RMethod r_R__0__O5r___0__g8r;
		public virtual RMethod R__0__O5r___0__g8r
		{
			get
			{
				if(r_R__0__O5r___0__g8r == null)
				{
					r_R__0__O5r___0__g8r = new(this, "#O5r", 0,  ReleactionUtils.GetType("#Pfb.#g8r"));
					r_R__0__O5r___0__g8r.SetBelong(this.instance);
				}
				return r_R__0__O5r___0__g8r;
			}
		}
		...
		/// <summary>
		/// Void #rtl(System.Object, System.Object)
		/// </summary>
		protected RMethod r_R__0__rtl_Object_Object;
		public virtual RMethod R__0__rtl_Object_Object
		{
			get
			{
				if(r_R__0__rtl_Object_Object == null)
				{
					r_R__0__rtl_Object_Object = new(this, "#rtl", 0, typeof(System.Object), typeof(System.Object));
					r_R__0__rtl_Object_Object.SetBelong(this.instance);
				}
				return r_R__0__rtl_Object_Object;
			}
		}
        ...
        public R__0__JTr() : base("#u.#JTr")
        {
        }

        public R__0__JTr(System.Object instance) : base("#u.#JTr")
		{
            SetInstance(instance);
		}

        public R__0__JTr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__JTr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__M5r()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__M5r.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__N5r()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__N5r.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__NE(System.Collections.Generic.List<AchievementConfig>  @list)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@list};
            var ___result = R__0__NE_List_d_AchievementConfig_p_.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__rtl(System.Object  @oldval, System.Object  @newval)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@oldval, @newval};
            var ___result = R__0__rtl_Object_Object.Invoke(___genericsType, ___parameters);

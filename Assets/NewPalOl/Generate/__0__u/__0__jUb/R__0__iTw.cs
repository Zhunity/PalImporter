...
{public partial class R__0__jUb
{
	
	/// <summary>
	/// #u.#jUb+#iTw
	/// </summary>
    public partial class R__0__iTw : RMember //
    {
		...
		/// #u.#jUb #i
		/// </summary>
		protected R__0__u.R__0__jUb r___0__i;
		public virtual R__0__u.R__0__jUb R__0__i
		{
			get
			{
				if(r___0__i == null)
        ...
        public R__0__iTw() : base("#u.#jUb+#iTw")
        {
        }

        public R__0__iTw(System.Object instance) : base("#u.#jUb+#iTw")
		{
            SetInstance(instance);
		}

        public R__0__iTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__iTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

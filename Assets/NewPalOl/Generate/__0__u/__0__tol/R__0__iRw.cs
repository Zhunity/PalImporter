...
{public partial class R__0__tol
{
	...
	/// #u.#tol+#iRw
	/// </summary>
    public partial class R__0__iRw : RMember //
    {

		/// <summary>
		/// #u.#hol #a
		/// </summary>
		protected R__0__u.R__0__hol r___0__a;
		public virtual R__0__u.R__0__hol R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #u.#tol #k
		/// </summary>
		protected R__0__u.R__0__tol r___0__k;
		public virtual R__0__u.R__0__tol R__0__k
		{
			get
			{
				if(r___0__k == null)
        ...
        public R__0__iRw() : base("#u.#tol+#iRw")
        {
        }

        public R__0__iRw(System.Object instance) : base("#u.#tol+#iRw")
		{
            SetInstance(instance);
		}

        public R__0__iRw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__iRw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

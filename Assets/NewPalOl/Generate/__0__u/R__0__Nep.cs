...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Nep
	/// </summary>
    public partial class R__0__Nep : RMember //
    {
		...
		/// Void #Mep(Int32)
		/// </summary>
		protected RMethod r_R__0__Mep_Int32;
		public virtual RMethod R__0__Mep_Int32
		{
			get
			{
				if(r_R__0__Mep_Int32 == null)
				{
					r_R__0__Mep_Int32 = new(this, "#Mep", 0, typeof(System.Int32));
					r_R__0__Mep_Int32.SetBelong(this.instance);
				}
				return r_R__0__Mep_Int32;
			}
		}
        ...
        public R__0__Nep() : base("#u.#Nep")
        {
        }

        public R__0__Nep(System.Object instance) : base("#u.#Nep")
		{
            SetInstance(instance);
		}

        public R__0__Nep(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Nep(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__sb(System.Boolean  @show, System.Int32  @type)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@show, @type};
        ...
        public virtual void __0__Mep(System.Int32  @type)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@type};
            var ___result = R__0__Mep_Int32.Invoke(___genericsType, ___parameters);

...
{public partial class R__0__Leg
{
	...
	/// #u.#Leg+#46u
	/// </summary>
    public partial class R__0__46u : RMember //
    {
		...
		/// #u.#Leg #h
		/// </summary>
		protected R__0__u.R__0__Leg r___0__h;
		public virtual R__0__u.R__0__Leg R__0__h
		{
			get
			{
				if(r___0__h == null)
        ...
        public R__0__46u() : base("#u.#Leg+#46u")
        {
        }

        public R__0__46u(System.Object instance) : base("#u.#Leg+#46u")
		{
            SetInstance(instance);
		}

        public R__0__46u(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__46u(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

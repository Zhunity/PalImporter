...
{public partial class R__0__Leg
{
	...
	/// #u.#Leg+#76u
	/// </summary>
    public partial class R__0__76u : RMember //
    {
		...
		/// UIeffect #e
		/// </summary>
		protected RUIeffect r___0__e;
		public virtual RUIeffect R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// #u.#Leg #q
		/// </summary>
		protected R__0__u.R__0__Leg r___0__q;
		public virtual R__0__u.R__0__Leg R__0__q
		{
			get
			{
				if(r___0__q == null)
        ...
        public R__0__76u() : base("#u.#Leg+#76u")
        {
        }

        public R__0__76u(System.Object instance) : base("#u.#Leg+#76u")
		{
            SetInstance(instance);
		}

        public R__0__76u(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__76u(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

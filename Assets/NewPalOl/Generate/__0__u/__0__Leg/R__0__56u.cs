...
{public partial class R__0__Leg
{
	...
	/// #u.#Leg+#56u
	/// </summary>
    public partial class R__0__56u : RMember //
    {
		...
		/// #u.#Leg #d
		/// </summary>
		protected R__0__u.R__0__Leg r___0__d;
		public virtual R__0__u.R__0__Leg R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__56u() : base("#u.#Leg+#56u")
        {
        }

        public R__0__56u(System.Object instance) : base("#u.#Leg+#56u")
		{
            SetInstance(instance);
		}

        public R__0__56u(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__56u(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__Leg
{
	...
	/// #u.#Leg+#36u
	/// </summary>
    public partial class R__0__36u : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.Renderer[] #b
		/// </summary>
		protected RFieldArray<RUnityEngine.RRenderer> r___0__b;
		public virtual RFieldArray<RUnityEngine.RRenderer> R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// <summary>
		/// UnityEngine.Renderer[] #c
		/// </summary>
		protected RFieldArray<RUnityEngine.RRenderer> r___0__c;
		public virtual RFieldArray<RUnityEngine.RRenderer> R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// <summary>
		/// UnityEngine.Renderer #e
		/// </summary>
		protected RUnityEngine.RRenderer r___0__e;
		public virtual RUnityEngine.RRenderer R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// <summary>
		/// UnityEngine.Renderer[] #g
		/// </summary>
		protected RFieldArray<RUnityEngine.RRenderer> r___0__g;
		public virtual RFieldArray<RUnityEngine.RRenderer> R__0__g
		{
			get
			{
				if(r___0__g == null)
		...
		/// <summary>
		/// UnityEngine.Renderer[] #h
		/// </summary>
		protected RFieldArray<RUnityEngine.RRenderer> r___0__h;
		public virtual RFieldArray<RUnityEngine.RRenderer> R__0__h
		{
			get
			{
				if(r___0__h == null)
		...
		/// <summary>
		/// UnityEngine.Renderer #j
		/// </summary>
		protected RUnityEngine.RRenderer r___0__j;
		public virtual RUnityEngine.RRenderer R__0__j
		{
			get
			{
				if(r___0__j == null)
		...
		/// System.Object #m
		/// </summary>
		protected RSystem.RObject r___0__m;
		public virtual RSystem.RObject R__0__m
		{
			get
			{
				if(r___0__m == null)
		...
		/// #u.#Leg #o
		/// </summary>
		protected R__0__u.R__0__Leg r___0__o;
		public virtual R__0__u.R__0__Leg R__0__o
		{
			get
			{
				if(r___0__o == null)
        ...
        public R__0__36u() : base("#u.#Leg+#36u")
        {
        }

        public R__0__36u(System.Object instance) : base("#u.#Leg+#36u")
		{
            SetInstance(instance);
		}

        public R__0__36u(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__36u(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

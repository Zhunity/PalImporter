...
{public partial class R__0__Leg
{
	...
	/// #u.#Leg+#96u
	/// </summary>
    public partial class R__0__96u : RMember //
    {
        ...
        public R__0__96u() : base("#u.#Leg+#96u")
        {
        }

        public R__0__96u(System.Object instance) : base("#u.#Leg+#96u")
		{
            SetInstance(instance);
		}

        public R__0__96u(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__96u(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

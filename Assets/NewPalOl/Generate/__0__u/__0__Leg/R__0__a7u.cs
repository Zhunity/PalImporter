...
{public partial class R__0__Leg
{
	...
	/// #u.#Leg+#a7u
	/// </summary>
    public partial class R__0__a7u : RMember //
    {
		...
		/// #u.#Leg #k
		/// </summary>
		protected R__0__u.R__0__Leg r___0__k;
		public virtual R__0__u.R__0__Leg R__0__k
		{
			get
			{
				if(r___0__k == null)
        ...
        public R__0__a7u() : base("#u.#Leg+#a7u")
        {
        }

        public R__0__a7u(System.Object instance) : base("#u.#Leg+#a7u")
		{
            SetInstance(instance);
		}

        public R__0__a7u(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__a7u(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

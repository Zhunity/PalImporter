...
{public partial class R__0__Leg
{
	...
	/// #u.#Leg+#86u
	/// </summary>
    public partial class R__0__86u : RMember //
    {
		...
		/// #u.#Leg+#Oeg #b
		/// </summary>
		protected R__0__u.R__0__Leg.R__0__Oeg r___0__b;
		public virtual R__0__u.R__0__Leg.R__0__Oeg R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// #u.#Leg #e
		/// </summary>
		protected R__0__u.R__0__Leg r___0__e;
		public virtual R__0__u.R__0__Leg R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__86u() : base("#u.#Leg+#86u")
        {
        }

        public R__0__86u(System.Object instance) : base("#u.#Leg+#86u")
		{
            SetInstance(instance);
		}

        public R__0__86u(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__86u(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

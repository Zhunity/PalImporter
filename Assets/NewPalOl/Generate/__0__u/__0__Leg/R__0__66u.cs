...
{public partial class R__0__Leg
{
	
	/// <summary>
	/// #u.#Leg+#66u
	/// </summary>
    public partial class R__0__66u : RMember //
    {
        ...
        public R__0__66u() : base("#u.#Leg+#66u")
        {
        }

        public R__0__66u(System.Object instance) : base("#u.#Leg+#66u")
		{
            SetInstance(instance);
		}

        public R__0__66u(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__66u(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

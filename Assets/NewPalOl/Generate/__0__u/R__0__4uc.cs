...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#4uc
	/// </summary>
    public partial class R__0__4uc : RMember //
    {
        ...
        public R__0__4uc() : base("#u.#4uc")
        {
        }

        public R__0__4uc(System.Object instance) : base("#u.#4uc")
		{
            SetInstance(instance);
		}

        public R__0__4uc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__4uc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

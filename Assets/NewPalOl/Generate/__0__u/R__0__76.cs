...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#76
	/// </summary>
    public partial class R__0__76 : RMember //
    {
        ...
        public R__0__76() : base("#u.#76")
        {
        }

        public R__0__76(System.Object instance) : base("#u.#76")
		{
            SetInstance(instance);
		}

        public R__0__76(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__76(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#nDj
	/// </summary>
    public partial class R__0__nDj : RMember //
    {
		...
		/// #oU.#X4 #g
		/// </summary>
		protected R__0__oU.R__0__X4 r___0__g;
		public virtual R__0__oU.R__0__X4 R__0__g
		{
			get
			{
				if(r___0__g == null)
		...
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__m
		{
			get
			{
				if(r___0__m == null)
				{
					r___0__m = new( ReleactionUtils.GetType("#u.#nDj"), "#m");
		...
		/// <summary>
		/// Void #lDj(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__lDj_Object___0__7X;
		public virtual RMethod R__0__lDj_Object___0__7X
		{
			get
			{
				if(r_R__0__lDj_Object___0__7X == null)
				{
					r_R__0__lDj_Object___0__7X = new(this, "#lDj", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__lDj_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__lDj_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #mDj(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__mDj_Object___0__7X;
		public virtual RMethod R__0__mDj_Object___0__7X
		{
			get
			{
				if(r_R__0__mDj_Object___0__7X == null)
				{
					r_R__0__mDj_Object___0__7X = new(this, "#mDj", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__mDj_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__mDj_Object___0__7X;
			}
		}
		...
		/// Void #mk(#Pfb.#pFj)
		/// </summary>
		protected RMethod r_R__0__mk___0__pFj;
		public virtual RMethod R__0__mk___0__pFj
		{
			get
			{
				if(r_R__0__mk___0__pFj == null)
				{
					r_R__0__mk___0__pFj = new(this, "#mk", 0,  ReleactionUtils.GetType("#Pfb.#pFj"));
					r_R__0__mk___0__pFj.SetBelong(this.instance);
				}
				return r_R__0__mk___0__pFj;
			}
		}
        ...
        public R__0__nDj() : base("#u.#nDj")
        {
        }

        public R__0__nDj(System.Object instance) : base("#u.#nDj")
		{
            SetInstance(instance);
		}

        public R__0__nDj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__nDj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

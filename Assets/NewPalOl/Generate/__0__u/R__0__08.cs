...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#08
	/// </summary>
    public partial class R__0__08 : RMember //
    {

		/// <summary>
		/// #Pfb.#Wob #a
		/// </summary>
		protected R__0__Pfb.R__0__Wob r___0__a;
		public virtual R__0__Pfb.R__0__Wob R__0__a
		{
			get
			{
				if(r___0__a == null)
        ...
        public R__0__08() : base("#u.#08")
        {
        }

        public R__0__08(System.Object instance) : base("#u.#08")
		{
            SetInstance(instance);
		}

        public R__0__08(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__08(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__wUc
{
	...
	/// #u.#wUc+#rTw
	/// </summary>
    public partial class R__0__rTw : RMember //
    {

		/// <summary>
		/// #u.#wUc+#CUc #a
		/// </summary>
		protected R__0__u.R__0__wUc.R__0__CUc r___0__a;
		public virtual R__0__u.R__0__wUc.R__0__CUc R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// UnityEngine.AssetBundleCreateRequest #b
		/// </summary>
		protected RUnityEngine.RAssetBundleCreateRequest r___0__b;
		public virtual RUnityEngine.RAssetBundleCreateRequest R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// System.Exception #c
		/// </summary>
		protected RSystem.RException r___0__c;
		public virtual RSystem.RException R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// System.Exception #d
		/// </summary>
		protected RSystem.RException r___0__d;
		public virtual RSystem.RException R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// System.Exception #e
		/// </summary>
		protected RSystem.RException r___0__e;
		public virtual RSystem.RException R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// #u.#wUc+#CUc #i
		/// </summary>
		protected R__0__u.R__0__wUc.R__0__CUc r___0__i;
		public virtual R__0__u.R__0__wUc.R__0__CUc R__0__i
		{
			get
			{
				if(r___0__i == null)
		...
		/// #u.#wUc #k
		/// </summary>
		protected R__0__u.R__0__wUc r___0__k;
		public virtual R__0__u.R__0__wUc R__0__k
		{
			get
			{
				if(r___0__k == null)
        ...
        public R__0__rTw() : base("#u.#wUc+#rTw")
        {
        }

        public R__0__rTw(System.Object instance) : base("#u.#wUc+#rTw")
		{
            SetInstance(instance);
		}

        public R__0__rTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__rTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__wUc
{
	...
	/// #u.#wUc+#qTw
	/// </summary>
    public partial class R__0__qTw : RMember //
    {

		/// <summary>
		/// UnityEngine.WWW #a
		/// </summary>
		protected RUnityEngine.RWWW r___0__a;
		public virtual RUnityEngine.RWWW R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #u.#wUc #D
		/// </summary>
		protected R__0__u.R__0__wUc r___0__D;
		public virtual R__0__u.R__0__wUc R__0__D
		{
			get
			{
				if(r___0__D == null)
        ...
        public R__0__qTw() : base("#u.#wUc+#qTw")
        {
        }

        public R__0__qTw(System.Object instance) : base("#u.#wUc+#qTw")
		{
            SetInstance(instance);
		}

        public R__0__qTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__qTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#l9
	/// </summary>
    public partial class R__0__l9 : RMember //
    {
        ...
        public R__0__l9() : base("#u.#l9")
        {
        }

        public R__0__l9(System.Object instance) : base("#u.#l9")
		{
            SetInstance(instance);
		}

        public R__0__l9(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__l9(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

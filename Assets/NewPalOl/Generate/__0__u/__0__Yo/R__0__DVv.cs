...
{public partial class R__0__Yo
{
	
	/// <summary>
	/// #u.#Yo+#DVv
	/// </summary>
    public partial class R__0__DVv : RMember //
    {

		/// <summary>
		/// #Pfb.#Zub #a
		/// </summary>
		protected R__0__Pfb.R__0__Zub r___0__a;
		public virtual R__0__Pfb.R__0__Zub R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #Pfb.#Zub #e
		/// </summary>
		protected R__0__Pfb.R__0__Zub r___0__e;
		public virtual R__0__Pfb.R__0__Zub R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// #u.#Yo #f
		/// </summary>
		protected R__0__u.R__0__Yo r___0__f;
		public virtual R__0__u.R__0__Yo R__0__f
		{
			get
			{
				if(r___0__f == null)
        ...
        public R__0__DVv() : base("#u.#Yo+#DVv")
        {
        }

        public R__0__DVv(System.Object instance) : base("#u.#Yo+#DVv")
		{
            SetInstance(instance);
		}

        public R__0__DVv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__DVv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

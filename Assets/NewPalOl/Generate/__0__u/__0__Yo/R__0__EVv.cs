...
{public partial class R__0__Yo
{
	...
	/// #u.#Yo+#EVv
	/// </summary>
    public partial class R__0__EVv : RMember //
    {

		/// <summary>
		/// NPCBehav #a
		/// </summary>
		protected RNPCBehav r___0__a;
		public virtual RNPCBehav R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// NPCBehav #f
		/// </summary>
		protected RNPCBehav r___0__f;
		public virtual RNPCBehav R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// #u.#Yo #i
		/// </summary>
		protected R__0__u.R__0__Yo r___0__i;
		public virtual R__0__u.R__0__Yo R__0__i
		{
			get
			{
				if(r___0__i == null)
        ...
        public R__0__EVv() : base("#u.#Yo+#EVv")
        {
        }

        public R__0__EVv(System.Object instance) : base("#u.#Yo+#EVv")
		{
            SetInstance(instance);
		}

        public R__0__EVv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__EVv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

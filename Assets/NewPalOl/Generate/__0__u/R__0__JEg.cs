...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#JEg
	/// </summary>
    public partial class R__0__JEg : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#JEg"), "#a");
		...
		/// MyGUI.ElementBase[] #b
		/// </summary>
		protected RFieldArray<RMyGUI.RElementBase> r___0__b;
		public virtual RFieldArray<RMyGUI.RElementBase> R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		public static RField R__0__c
		{
			get
			{
				if(r___0__c == null)
				{
					r___0__c = new( ReleactionUtils.GetType("#u.#JEg"), "#c");
		...
		/// <summary>
		/// Void #IEg(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__IEg_Object___0__7X;
		public virtual RMethod R__0__IEg_Object___0__7X
		{
			get
			{
				if(r_R__0__IEg_Object___0__7X == null)
				{
					r_R__0__IEg_Object___0__7X = new(this, "#IEg", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__IEg_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__IEg_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #5Ig(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__5Ig_Object___0__7X;
		public virtual RMethod R__0__5Ig_Object___0__7X
		{
			get
			{
				if(r_R__0__5Ig_Object___0__7X == null)
				{
					r_R__0__5Ig_Object___0__7X = new(this, "#5Ig", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__5Ig_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__5Ig_Object___0__7X;
			}
		}
        ...
        public R__0__JEg() : base("#u.#JEg")
        {
        }

        public R__0__JEg(System.Object instance) : base("#u.#JEg")
		{
            SetInstance(instance);
		}

        public R__0__JEg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__JEg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__sb(System.Int32  @flag)
        {

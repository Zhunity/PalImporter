...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#q9
	/// </summary>
    public partial class R__0__q9 : RMember //
    {

		/// <summary>
		/// #Pfb.#EAb #a
		/// </summary>
		protected R__0__Pfb.R__0__EAb r___0__a;
		public virtual R__0__Pfb.R__0__EAb R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// Void #p9(System.Object, System.EventArgs)
		/// </summary>
		protected RMethod r_R__0__p9_Object_EventArgs;
		public virtual RMethod R__0__p9_Object_EventArgs
		{
			get
			{
				if(r_R__0__p9_Object_EventArgs == null)
				{
					r_R__0__p9_Object_EventArgs = new(this, "#p9", 0, typeof(System.Object), typeof(System.EventArgs));
					r_R__0__p9_Object_EventArgs.SetBelong(this.instance);
				}
				return r_R__0__p9_Object_EventArgs;
			}
		}
        ...
        public R__0__q9() : base("#u.#q9")
        {
        }

        public R__0__q9(System.Object instance) : base("#u.#q9")
		{
            SetInstance(instance);
		}

        public R__0__q9(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__q9(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }


        public virtual void __0__p9(System.Object  @sender, System.EventArgs  @e)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @e};
            var ___result = R__0__p9_Object_EventArgs.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#2Dd
	/// </summary>
    public partial class R__0__2Dd : RMember //
    {
        ...
        public R__0__2Dd() : base("#u.#2Dd")
        {
        }

        public R__0__2Dd(System.Object instance) : base("#u.#2Dd")
		{
            SetInstance(instance);
		}

        public R__0__2Dd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2Dd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

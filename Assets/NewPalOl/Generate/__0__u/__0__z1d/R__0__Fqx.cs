...
{public partial class R__0__z1d
{
	...
	/// #u.#z1d+#Fqx
	/// </summary>
    public partial class R__0__Fqx : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.IEnumerable`1[#Pfb.#mTc] #a
		/// </summary>
		protected RSystem.RCollections.RGeneric.RIEnumerable<R__0__Pfb.R__0__mTc> r___0__a;
		public virtual RSystem.RCollections.RGeneric.RIEnumerable<R__0__Pfb.R__0__mTc> R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// System.Collections.Generic.IEnumerable`1[#Pfb.#mTc] #d
		/// </summary>
		protected RSystem.RCollections.RGeneric.RIEnumerable<R__0__Pfb.R__0__mTc> r___0__d;
		public virtual RSystem.RCollections.RGeneric.RIEnumerable<R__0__Pfb.R__0__mTc> R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// #u.#z1d #e
		/// </summary>
		protected R__0__u.R__0__z1d r___0__e;
		public virtual R__0__u.R__0__z1d R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__Fqx() : base("#u.#z1d+#Fqx")
        {
        }

        public R__0__Fqx(System.Object instance) : base("#u.#z1d+#Fqx")
		{
            SetInstance(instance);
		}

        public R__0__Fqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Fqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#zb
	/// </summary>
    public partial class R__0__zb : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#zb"), "#a");
		...
		/// <summary>
		/// Void #vb(System.Object, System.Object)
		/// </summary>
		protected RMethod r_R__0__vb_Object_Object;
		public virtual RMethod R__0__vb_Object_Object
		{
			get
			{
				if(r_R__0__vb_Object_Object == null)
				{
					r_R__0__vb_Object_Object = new(this, "#vb", 0, typeof(System.Object), typeof(System.Object));
					r_R__0__vb_Object_Object.SetBelong(this.instance);
				}
				return r_R__0__vb_Object_Object;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator #wb()
		/// </summary>
		protected RMethod r_R__0__wb;
		public virtual RMethod R__0__wb
		{
			get
			{
				if(r_R__0__wb == null)
				{
					r_R__0__wb = new(this, "#wb", 0);
					r_R__0__wb.SetBelong(this.instance);
				}
				return r_R__0__wb;
			}
		}
		...
		/// Void #xb(Boolean)
		/// </summary>
		protected RMethod r_R__0__xb_Boolean;
		public virtual RMethod R__0__xb_Boolean
		{
			get
			{
				if(r_R__0__xb_Boolean == null)
				{
					r_R__0__xb_Boolean = new(this, "#xb", 0, typeof(System.Boolean));
					r_R__0__xb_Boolean.SetBelong(this.instance);
				}
				return r_R__0__xb_Boolean;
			}
		}
		...
		/// <summary>
		/// Void #yb(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__yb_Object___0__7X;
		public virtual RMethod R__0__yb_Object___0__7X
		{
			get
			{
				if(r_R__0__yb_Object___0__7X == null)
				{
					r_R__0__yb_Object___0__7X = new(this, "#yb", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__yb_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__yb_Object___0__7X;
			}
		}
        ...
        public R__0__zb() : base("#u.#zb")
        {
        }

        public R__0__zb(System.Object instance) : base("#u.#zb")
		{
            SetInstance(instance);
		}

        public R__0__zb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__vb(System.Object  @oldval, System.Object  @newval)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@oldval, @newval};
            var ___result = R__0__vb_Object_Object.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Int32 __0__xVd(System.Int32  @inval)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@inval};
        ...
        public virtual System.Collections.IEnumerator __0__wb()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__wb.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual void __0__xb(System.Boolean  @bEnable)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bEnable};
            var ___result = R__0__xb_Boolean.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#mp
	/// </summary>
    public partial class R__0__mp : RMember //
    {
		...
		/// <summary>
		/// Void #oKq(System.Object)
		/// </summary>
		protected RMethod r_R__0__oKq_Object;
		public virtual RMethod R__0__oKq_Object
		{
			get
			{
				if(r_R__0__oKq_Object == null)
				{
					r_R__0__oKq_Object = new(this, "#oKq", 0, typeof(System.Object));
					r_R__0__oKq_Object.SetBelong(this.instance);
				}
				return r_R__0__oKq_Object;
			}
		}
        ...
        public R__0__mp() : base("#u.#mp")
        {
        }

        public R__0__mp(System.Object instance) : base("#u.#mp")
		{
            SetInstance(instance);
		}

        public R__0__mp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__mp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__oKq(System.Object  @x)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@x};
            var ___result = R__0__oKq_Object.Invoke(___genericsType, ___parameters);

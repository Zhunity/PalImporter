...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#RJh
	/// </summary>
    public partial class R__0__RJh : RMember //
    {
		...
		/// Void #EIh()
		/// </summary>
		protected RMethod r_R__0__EIh;
		public virtual RMethod R__0__EIh
		{
			get
			{
				if(r_R__0__EIh == null)
				{
					r_R__0__EIh = new(this, "#EIh", 0);
					r_R__0__EIh.SetBelong(this.instance);
				}
				return r_R__0__EIh;
			}
		}
		...
		/// <summary>
		/// Void #Lmi(System.String, UInt32)
		/// </summary>
		protected RMethod r_R__0__Lmi_String_UInt32;
		public virtual RMethod R__0__Lmi_String_UInt32
		{
			get
			{
				if(r_R__0__Lmi_String_UInt32 == null)
				{
					r_R__0__Lmi_String_UInt32 = new(this, "#Lmi", 0, typeof(System.String), typeof(System.UInt32));
					r_R__0__Lmi_String_UInt32.SetBelong(this.instance);
				}
				return r_R__0__Lmi_String_UInt32;
			}
		}
        ...
        public R__0__RJh() : base("#u.#RJh")
        {
        }

        public R__0__RJh(System.Object instance) : base("#u.#RJh")
		{
            SetInstance(instance);
		}

        public R__0__RJh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__RJh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__EIh()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__EIh.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Lmi(System.String  @name, System.UInt32  @careerId)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@name, @careerId};
            var ___result = R__0__Lmi_String_UInt32.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#fGc
	/// </summary>
    public partial class R__0__fGc : RMember //
    {
		...
		/// #u.#MSc #e
		/// </summary>
		protected R__0__u.R__0__MSc r___0__e;
		public virtual R__0__u.R__0__MSc R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// <summary>
		/// System.Collections.IEnumerator #yA(TutorialConfig)
		/// </summary>
		protected RMethod r_R__0__yA_TutorialConfig;
		public virtual RMethod R__0__yA_TutorialConfig
		{
			get
			{
				if(r_R__0__yA_TutorialConfig == null)
				{
					r_R__0__yA_TutorialConfig = new(this, "#yA", 0, typeof(TutorialConfig));
					r_R__0__yA_TutorialConfig.SetBelong(this.instance);
				}
				return r_R__0__yA_TutorialConfig;
			}
		}
		...
		/// Void #zA()
		/// </summary>
		protected RMethod r_R__0__zA;
		public virtual RMethod R__0__zA
		{
			get
			{
				if(r_R__0__zA == null)
				{
					r_R__0__zA = new(this, "#zA", 0);
					r_R__0__zA.SetBelong(this.instance);
				}
				return r_R__0__zA;
			}
		}
		...
		/// <summary>
		/// Void #h5j(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__h5j_Object___0__7X;
		public virtual RMethod R__0__h5j_Object___0__7X
		{
			get
			{
				if(r_R__0__h5j_Object___0__7X == null)
				{
					r_R__0__h5j_Object___0__7X = new(this, "#h5j", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__h5j_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__h5j_Object___0__7X;
			}
		}
        ...
        public R__0__fGc() : base("#u.#fGc")
        {
        }

        public R__0__fGc(System.Object instance) : base("#u.#fGc")
		{
            SetInstance(instance);
		}

        public R__0__fGc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fGc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Collections.IEnumerator __0__yA(TutorialConfig  @config)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@config};
            var ___result = R__0__yA_TutorialConfig.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual void __0__zA()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__zA.Invoke(___genericsType, ___parameters);

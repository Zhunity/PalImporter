...
{public partial class R__0__0pd
{
	...
	/// #u.#0pd+#mSw
	/// </summary>
    public partial class R__0__mSw : RMember //
    {
		...
		/// #u.#0pd #i
		/// </summary>
		protected R__0__u.R__0__0pd r___0__i;
		public virtual R__0__u.R__0__0pd R__0__i
		{
			get
			{
				if(r___0__i == null)
        ...
        public R__0__mSw() : base("#u.#0pd+#mSw")
        {
        }

        public R__0__mSw(System.Object instance) : base("#u.#0pd+#mSw")
		{
            SetInstance(instance);
		}

        public R__0__mSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__mSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__0pd
{
	...
	/// #u.#0pd+#lSw
	/// </summary>
    public partial class R__0__lSw : RMember //
    {
		...
		/// #u.#0pd #l
		/// </summary>
		protected R__0__u.R__0__0pd r___0__l;
		public virtual R__0__u.R__0__0pd R__0__l
		{
			get
			{
				if(r___0__l == null)
        ...
        public R__0__lSw() : base("#u.#0pd+#lSw")
        {
        }

        public R__0__lSw(System.Object instance) : base("#u.#0pd+#lSw")
		{
            SetInstance(instance);
		}

        public R__0__lSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__lSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__0pd
{
	...
	/// #u.#0pd+#oSw
	/// </summary>
    public partial class R__0__oSw : RMember //
    {
		...
		/// SKILL_CFG #d
		/// </summary>
		protected RSKILL_CFG r___0__d;
		public virtual RSKILL_CFG R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// #u.#0pd #h
		/// </summary>
		protected R__0__u.R__0__0pd r___0__h;
		public virtual R__0__u.R__0__0pd R__0__h
		{
			get
			{
				if(r___0__h == null)
        ...
        public R__0__oSw() : base("#u.#0pd+#oSw")
        {
        }

        public R__0__oSw(System.Object instance) : base("#u.#0pd+#oSw")
		{
            SetInstance(instance);
		}

        public R__0__oSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

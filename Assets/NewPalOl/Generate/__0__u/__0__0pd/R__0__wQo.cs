...
{public partial class R__0__0pd
{
	
	/// <summary>
	/// #u.#0pd+#wQo
	/// </summary>
    public partial class R__0__wQo : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RVector3 r___0__c;
		public virtual RUnityEngine.RVector3 R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// </summary>
		protected RSystem.RCollections.RIEnumerator r___0__e;
		public virtual RSystem.RCollections.RIEnumerator R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// </summary>
		protected RUnityEngine.RTransform r___0__f;
		public virtual RUnityEngine.RTransform R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// System.Object #k
		/// </summary>
		protected RSystem.RObject r___0__k;
		public virtual RSystem.RObject R__0__k
		{
			get
			{
				if(r___0__k == null)
		...
		/// </summary>
		protected RUnityEngine.RVector3 r___0__n;
		public virtual RUnityEngine.RVector3 R__0__n
		{
			get
			{
				if(r___0__n == null)
        ...
        public R__0__wQo() : base("#u.#0pd+#wQo")
        {
        }

        public R__0__wQo(System.Object instance) : base("#u.#0pd+#wQo")
		{
            SetInstance(instance);
		}

        public R__0__wQo(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__wQo(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

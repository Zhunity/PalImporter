...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#ZYv
	/// </summary>
    public partial class R__0__ZYv : RMember //
    {
        ...
        public R__0__ZYv() : base("#u.#ZYv")
        {
        }

        public R__0__ZYv(System.Object instance) : base("#u.#ZYv")
		{
            SetInstance(instance);
		}

        public R__0__ZYv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ZYv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

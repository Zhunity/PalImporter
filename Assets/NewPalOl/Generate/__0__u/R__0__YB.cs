...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#YB
	/// </summary>
    public partial class R__0__YB : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#YB"), "#a");
		...
		/// <summary>
		/// Void #sb(System.Collections.Generic.List`1[#u.#XB], System.String)
		/// </summary>
		protected RMethod r_R__0__sb_List_d___0__XB_p__String;
		public virtual RMethod R__0__sb_List_d___0__XB_p__String
		{
			get
			{
				if(r_R__0__sb_List_d___0__XB_p__String == null)
				{
					r_R__0__sb_List_d___0__XB_p__String = new(this, "#sb", 0, typeof(System.Collections.Generic.List<>).MakeGenericType( ReleactionUtils.GetType("#u.#XB")), typeof(System.String));
					r_R__0__sb_List_d___0__XB_p__String.SetBelong(this.instance);
				}
				return r_R__0__sb_List_d___0__XB_p__String;
			}
		}
        ...
        public R__0__YB() : base("#u.#YB")
        {
        }

        public R__0__YB(System.Object instance) : base("#u.#YB")
		{
            SetInstance(instance);
		}

        public R__0__YB(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YB(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

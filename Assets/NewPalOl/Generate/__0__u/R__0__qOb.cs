...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#qOb
	/// </summary>
    public partial class R__0__qOb : RMember //
    {
        ...
        public R__0__qOb() : base("#u.#qOb")
        {
        }

        public R__0__qOb(System.Object instance) : base("#u.#qOb")
		{
            SetInstance(instance);
		}

        public R__0__qOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__qOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

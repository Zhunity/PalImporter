...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#3ci
	/// </summary>
    public partial class R__0__3ci : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#3ci"), "#a");
		...
		/// <summary>
		/// Void #DFg(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__DFg_Object___0__7X;
		public virtual RMethod R__0__DFg_Object___0__7X
		{
			get
			{
				if(r_R__0__DFg_Object___0__7X == null)
				{
					r_R__0__DFg_Object___0__7X = new(this, "#DFg", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__DFg_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__DFg_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #Xci(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Xci_Object___0__7X;
		public virtual RMethod R__0__Xci_Object___0__7X
		{
			get
			{
				if(r_R__0__Xci_Object___0__7X == null)
				{
					r_R__0__Xci_Object___0__7X = new(this, "#Xci", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Xci_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Xci_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #Yci(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Yci_Object___0__7X;
		public virtual RMethod R__0__Yci_Object___0__7X
		{
			get
			{
				if(r_R__0__Yci_Object___0__7X == null)
				{
					r_R__0__Yci_Object___0__7X = new(this, "#Yci", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Yci_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Yci_Object___0__7X;
			}
		}
        ...
        public R__0__3ci() : base("#u.#3ci")
        {
        }

        public R__0__3ci(System.Object instance) : base("#u.#3ci")
		{
            SetInstance(instance);
		}

        public R__0__3ci(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__3ci(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

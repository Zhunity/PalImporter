...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#pS
	/// </summary>
    public partial class R__0__pS : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.Queue`1[#u.#pS] #a
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RQueue<R__0__u.R__0__pS> r___0__a;
		public static RSystem.RCollections.RGeneric.RQueue<R__0__u.R__0__pS> R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#pS"), "#a");
		...
		/// <summary>
		/// MyGUI.ColorTextArea #m
		/// </summary>
		protected RMyGUI.RColorTextArea r___0__m;
		public virtual RMyGUI.RColorTextArea R__0__m
		{
			get
			{
				if(r___0__m == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1[System.Collections.Generic.KeyValuePair`2[System.String,System.Single]] #n
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RSystem.RCollections.RGeneric.RKeyValuePair<RField, RField>> r___0__n;
		public virtual RSystem.RCollections.RGeneric.RList<RSystem.RCollections.RGeneric.RKeyValuePair<RField, RField>> R__0__n
		{
			get
			{
				if(r___0__n == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1[System.Collections.Generic.KeyValuePair`2[System.String,System.Int32]] #o
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RSystem.RCollections.RGeneric.RKeyValuePair<RField, RField>> r___0__o;
		public virtual RSystem.RCollections.RGeneric.RList<RSystem.RCollections.RGeneric.RKeyValuePair<RField, RField>> R__0__o
		{
			get
			{
				if(r___0__o == null)
		...
		public static RField R__0__p
		{
			get
			{
				if(r___0__p == null)
				{
					r___0__p = new( ReleactionUtils.GetType("#u.#pS"), "#p");
		...
		/// Void #jS()
		/// </summary>
		protected RMethod r_R__0__jS;
		public virtual RMethod R__0__jS
		{
			get
			{
				if(r_R__0__jS == null)
				{
					r_R__0__jS = new(this, "#jS", 0);
					r_R__0__jS.SetBelong(this.instance);
				}
				return r_R__0__jS;
			}
		}
		...
		/// Void #kS()
		/// </summary>
		protected RMethod r_R__0__kS;
		public virtual RMethod R__0__kS
		{
			get
			{
				if(r_R__0__kS == null)
				{
					r_R__0__kS = new(this, "#kS", 0);
					r_R__0__kS.SetBelong(this.instance);
				}
				return r_R__0__kS;
			}
		}
		...
		/// Void #cdk(Int32)
		/// </summary>
		protected RMethod r_R__0__cdk_Int32;
		public virtual RMethod R__0__cdk_Int32
		{
			get
			{
				if(r_R__0__cdk_Int32 == null)
				{
					r_R__0__cdk_Int32 = new(this, "#cdk", 0, typeof(System.Int32));
					r_R__0__cdk_Int32.SetBelong(this.instance);
				}
				return r_R__0__cdk_Int32;
			}
		}

		/// <summary>
		/// Void #wR(System.String, Int32)
		/// </summary>
		protected RMethod r_R__0__wR_String_Int32;
		public virtual RMethod R__0__wR_String_Int32
		{
			get
			{
				if(r_R__0__wR_String_Int32 == null)
				{
					r_R__0__wR_String_Int32 = new(this, "#wR", 0, typeof(System.String), typeof(System.Int32));
					r_R__0__wR_String_Int32.SetBelong(this.instance);
				}
				return r_R__0__wR_String_Int32;
			}
		}

		/// <summary>
		/// UnityEngine.Vector2 #lS(System.String, Single)
		/// </summary>
		protected RMethod r_R__0__lS_String_Single;
		public virtual RMethod R__0__lS_String_Single
		{
			get
			{
				if(r_R__0__lS_String_Single == null)
				{
					r_R__0__lS_String_Single = new(this, "#lS", 0, typeof(System.String), typeof(System.Single));
					r_R__0__lS_String_Single.SetBelong(this.instance);
				}
				return r_R__0__lS_String_Single;
			}
		}

		/// <summary>
		/// System.String #mS(Single ByRef)
		/// </summary>
		protected RMethod r_R__0__mS_Out_Single;
		public virtual RMethod R__0__mS_Out_Single
		{
			get
			{
				if(r_R__0__mS_Out_Single == null)
				{
					r_R__0__mS_Out_Single = new(this, "#mS", 0, typeof(System.Single).MakeByRefType());
					r_R__0__mS_Out_Single.SetBelong(this.instance);
				}
				return r_R__0__mS_Out_Single;
			}
		}

		/// <summary>
		/// Void #xR(System.String, Int32)
		/// </summary>
		protected RMethod r_R__0__xR_String_Int32;
		public virtual RMethod R__0__xR_String_Int32
		{
			get
			{
				if(r_R__0__xR_String_Int32 == null)
				{
					r_R__0__xR_String_Int32 = new(this, "#xR", 0, typeof(System.String), typeof(System.Int32));
					r_R__0__xR_String_Int32.SetBelong(this.instance);
				}
				return r_R__0__xR_String_Int32;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator #TB()
		/// </summary>
		...
		/// Void #oS()
		/// </summary>
		protected RMethod r_R__0__oS;
		public virtual RMethod R__0__oS
		{
			get
			{
				if(r_R__0__oS == null)
				{
					r_R__0__oS = new(this, "#oS", 0);
					r_R__0__oS.SetBelong(this.instance);
				}
				return r_R__0__oS;
			}
		}
		...
		/// Void #zR()
		/// </summary>
		protected RMethod r_R__0__zR;
		public virtual RMethod R__0__zR
		{
			get
			{
				if(r_R__0__zR == null)
				{
					r_R__0__zR = new(this, "#zR", 0);
					r_R__0__zR.SetBelong(this.instance);
				}
				return r_R__0__zR;
			}
		}
        ...
        public R__0__pS() : base("#u.#pS")
        {
        }

        public R__0__pS(System.Object instance) : base("#u.#pS")
		{
            SetInstance(instance);
		}

        public R__0__pS(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__pS(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__jS()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__jS.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__kS()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__kS.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__cdk(System.Int32  @channel)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@channel};
            var ___result = R__0__cdk_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__wR(System.String  @text, System.Int32  @channel)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text, @channel};
            var ___result = R__0__wR_String_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual UnityEngine.Vector2 __0__lS(System.String  @text, System.Single  @alpha)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text, @alpha};
            var ___result = R__0__lS_String_Single.Invoke(___genericsType, ___parameters);

            return (UnityEngine.Vector2)___result;
        }


        public virtual System.String __0__mS(out System.Single  @alpha)
        {
			alpha = default;

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@alpha};
            var ___result = R__0__mS_Out_Single.Invoke(___genericsType, ___parameters);
			alpha = (System.Single)___parameters[0];

            return (System.String)___result;
        }


        public virtual void __0__xR(System.String  @text, System.Int32  @channel)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text, @channel};
            var ___result = R__0__xR_String_Int32.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Collections.IEnumerator __0__TB()
        {
        ...
        public virtual void __0__oS()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__oS.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__zR()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__zR.Invoke(___genericsType, ___parameters);

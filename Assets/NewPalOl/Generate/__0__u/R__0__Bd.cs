...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Bd
	/// </summary>
    public partial class R__0__Bd : RMember //
    {

		/// <summary>
		/// #u.#Bd+#KNb #a
		/// </summary>
		protected R__0__u.R__0__Bd.R__0__KNb r___0__a;
		public virtual R__0__u.R__0__Bd.R__0__KNb R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// Void #sb(System.String, #u.#Ckb, Int32)
		/// </summary>
		protected RMethod r_R__0__sb_String___0__Ckb_Int32;
		public virtual RMethod R__0__sb_String___0__Ckb_Int32
		{
			get
			{
				if(r_R__0__sb_String___0__Ckb_Int32 == null)
				{
					r_R__0__sb_String___0__Ckb_Int32 = new(this, "#sb", 0, typeof(System.String),  ReleactionUtils.GetType("#u.#Ckb"), typeof(System.Int32));
					r_R__0__sb_String___0__Ckb_Int32.SetBelong(this.instance);
				}
				return r_R__0__sb_String___0__Ckb_Int32;
			}
		}
		...
		/// Int32 #td()
		/// </summary>
		protected RMethod r_R__0__td;
		public virtual RMethod R__0__td
		{
			get
			{
				if(r_R__0__td == null)
				{
					r_R__0__td = new(this, "#td", 0);
					r_R__0__td.SetBelong(this.instance);
				}
				return r_R__0__td;
			}
		}
		...
		/// Void #yd()
		/// </summary>
		protected RMethod r_R__0__yd;
		public virtual RMethod R__0__yd
		{
			get
			{
				if(r_R__0__yd == null)
				{
					r_R__0__yd = new(this, "#yd", 0);
					r_R__0__yd.SetBelong(this.instance);
				}
				return r_R__0__yd;
			}
		}
		...
		/// Void #zd()
		/// </summary>
		protected RMethod r_R__0__zd;
		public virtual RMethod R__0__zd
		{
			get
			{
				if(r_R__0__zd == null)
				{
					r_R__0__zd = new(this, "#zd", 0);
					r_R__0__zd.SetBelong(this.instance);
				}
				return r_R__0__zd;
			}
		}
        ...
        public R__0__Bd() : base("#u.#Bd")
        {
        }

        public R__0__Bd(System.Object instance) : base("#u.#Bd")
		{
            SetInstance(instance);
		}

        public R__0__Bd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Bd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Int32 __0__td()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__td.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__yd()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__yd.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__zd()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__zd.Invoke(___genericsType, ___parameters);

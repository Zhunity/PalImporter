...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Wck
	/// </summary>
    public partial class R__0__Wck : RMember //
    {
        ...
        public R__0__Wck() : base("#u.#Wck")
        {
        }

        public R__0__Wck(System.Object instance) : base("#u.#Wck")
		{
            SetInstance(instance);
		}

        public R__0__Wck(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wck(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__mk(System.Collections.Generic.List<System.Int32>  @list)
        {

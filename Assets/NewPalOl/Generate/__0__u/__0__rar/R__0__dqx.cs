...
{public partial class R__0__rar
{
	...
	/// #u.#rar+#dqx
	/// </summary>
    public partial class R__0__dqx : RMember //
    {
		...
		/// #u.#rar #o
		/// </summary>
		protected R__0__u.R__0__rar r___0__o;
		public virtual R__0__u.R__0__rar R__0__o
		{
			get
			{
				if(r___0__o == null)
        ...
        public R__0__dqx() : base("#u.#rar+#dqx")
        {
        }

        public R__0__dqx(System.Object instance) : base("#u.#rar+#dqx")
		{
            SetInstance(instance);
		}

        public R__0__dqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__dqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__rar
{
	...
	/// #u.#rar+#uar
	/// </summary>
    public partial class R__0__uar : RMember //
    {
        ...
        public R__0__uar() : base("#u.#rar+#uar")
        {
        }

        public R__0__uar(System.Object instance) : base("#u.#rar+#uar")
		{
            SetInstance(instance);
		}

        public R__0__uar(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__uar(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

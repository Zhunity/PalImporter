...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#56
	/// </summary>
    public partial class R__0__56 : RMember //
    {
        ...
        public R__0__56() : base("#u.#56")
        {
        }

        public R__0__56(System.Object instance) : base("#u.#56")
		{
            SetInstance(instance);
		}

        public R__0__56(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__56(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__F4g
{
	
	/// <summary>
	/// #u.#F4g+#VQw
	/// </summary>
    public partial class R__0__VQw : RMember //
    {
		...
		/// #u.#F4g #m
		/// </summary>
		protected R__0__u.R__0__F4g r___0__m;
		public virtual R__0__u.R__0__F4g R__0__m
		{
			get
			{
				if(r___0__m == null)
        ...
        public R__0__VQw() : base("#u.#F4g+#VQw")
        {
        }

        public R__0__VQw(System.Object instance) : base("#u.#F4g+#VQw")
		{
            SetInstance(instance);
		}

        public R__0__VQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__VQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

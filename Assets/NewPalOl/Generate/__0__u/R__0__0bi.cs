...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#0bi
	/// </summary>
    public partial class R__0__0bi : RMember //
    {
		...
		/// Void #Zbi()
		/// </summary>
		protected RMethod r_R__0__Zbi;
		public virtual RMethod R__0__Zbi
		{
			get
			{
				if(r_R__0__Zbi == null)
				{
					r_R__0__Zbi = new(this, "#Zbi", 0);
					r_R__0__Zbi.SetBelong(this.instance);
				}
				return r_R__0__Zbi;
			}
		}
		...
		/// <summary>
		/// Void #Bah(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Bah_Object___0__7X;
		public virtual RMethod R__0__Bah_Object___0__7X
		{
			get
			{
				if(r_R__0__Bah_Object___0__7X == null)
				{
					r_R__0__Bah_Object___0__7X = new(this, "#Bah", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Bah_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Bah_Object___0__7X;
			}
		}
        ...
        public R__0__0bi() : base("#u.#0bi")
        {
        }

        public R__0__0bi(System.Object instance) : base("#u.#0bi")
		{
            SetInstance(instance);
		}

        public R__0__0bi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__0bi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Zbi()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Zbi.Invoke(___genericsType, ___parameters);

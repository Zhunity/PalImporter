...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Qb
	/// </summary>
    public partial class R__0__Qb : RMember //
    {
        ...
        public R__0__Qb() : base("#u.#Qb")
        {
        }

        public R__0__Qb(System.Object instance) : base("#u.#Qb")
		{
            SetInstance(instance);
		}

        public R__0__Qb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Qb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__HOc
{
	
	/// <summary>
	/// #u.#HOc+#Jqx
	/// </summary>
    public partial class R__0__Jqx : RMember //
    {
		...
		/// #u.#HOc #e
		/// </summary>
		protected R__0__u.R__0__HOc r___0__e;
		public virtual R__0__u.R__0__HOc R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__Jqx() : base("#u.#HOc+#Jqx")
        {
        }

        public R__0__Jqx(System.Object instance) : base("#u.#HOc+#Jqx")
		{
            SetInstance(instance);
		}

        public R__0__Jqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Jqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

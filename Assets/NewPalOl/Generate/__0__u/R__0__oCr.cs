...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#oCr
	/// </summary>
    public partial class R__0__oCr : RMember //
    {
		...
		/// <summary>
		/// Void #lCr(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__lCr_Object___0__7X;
		public virtual RMethod R__0__lCr_Object___0__7X
		{
			get
			{
				if(r_R__0__lCr_Object___0__7X == null)
				{
					r_R__0__lCr_Object___0__7X = new(this, "#lCr", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__lCr_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__lCr_Object___0__7X;
			}
		}
		...
		/// Void #mCr(Int32)
		/// </summary>
		protected RMethod r_R__0__mCr_Int32;
		public virtual RMethod R__0__mCr_Int32
		{
			get
			{
				if(r_R__0__mCr_Int32 == null)
				{
					r_R__0__mCr_Int32 = new(this, "#mCr", 0, typeof(System.Int32));
					r_R__0__mCr_Int32.SetBelong(this.instance);
				}
				return r_R__0__mCr_Int32;
			}
		}
		...
		/// Void #nCr()
		/// </summary>
		protected RMethod r_R__0__nCr;
		public virtual RMethod R__0__nCr
		{
			get
			{
				if(r_R__0__nCr == null)
				{
					r_R__0__nCr = new(this, "#nCr", 0);
					r_R__0__nCr.SetBelong(this.instance);
				}
				return r_R__0__nCr;
			}
		}
        ...
        public R__0__oCr() : base("#u.#oCr")
        {
        }

        public R__0__oCr(System.Object instance) : base("#u.#oCr")
		{
            SetInstance(instance);
		}

        public R__0__oCr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__oCr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__mCr(System.Int32  @count)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@count};
            var ___result = R__0__mCr_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__nCr()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__nCr.Invoke(___genericsType, ___parameters);

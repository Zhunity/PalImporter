...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#28
	/// </summary>
    public partial class R__0__28 : RMember //
    {

		/// <summary>
		/// #Pfb.#bpb #a
		/// </summary>
		protected R__0__Pfb.R__0__bpb r___0__a;
		public virtual R__0__Pfb.R__0__bpb R__0__a
		{
			get
			{
				if(r___0__a == null)
        ...
        public R__0__28() : base("#u.#28")
        {
        }

        public R__0__28(System.Object instance) : base("#u.#28")
		{
            SetInstance(instance);
		}

        public R__0__28(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__28(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

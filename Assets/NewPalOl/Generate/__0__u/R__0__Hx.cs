...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Hx
	/// </summary>
    public partial class R__0__Hx : RMember //
    {
		...
		/// <summary>
		/// Void #mk(System.String, Single)
		/// </summary>
		protected RMethod r_R__0__mk_String_Single;
		public virtual RMethod R__0__mk_String_Single
		{
			get
			{
				if(r_R__0__mk_String_Single == null)
				{
					r_R__0__mk_String_Single = new(this, "#mk", 0, typeof(System.String), typeof(System.Single));
					r_R__0__mk_String_Single.SetBelong(this.instance);
				}
				return r_R__0__mk_String_Single;
			}
		}
        ...
        public R__0__Hx() : base("#u.#Hx")
        {
        }

        public R__0__Hx(System.Object instance) : base("#u.#Hx")
		{
            SetInstance(instance);
		}

        public R__0__Hx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Hx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__mk(System.String  @msg, System.Single  @speed)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@msg, @speed};
            var ___result = R__0__mk_String_Single.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#sch
	/// </summary>
    public partial class R__0__sch : RMember //
    {
		...
		/// <summary>
		/// Void #A4g(XJTargetInfo)
		/// </summary>
		protected RMethod r_R__0__A4g_XJTargetInfo;
		public virtual RMethod R__0__A4g_XJTargetInfo
		{
			get
			{
				if(r_R__0__A4g_XJTargetInfo == null)
				{
					r_R__0__A4g_XJTargetInfo = new(this, "#A4g", 0, typeof(XJTargetInfo));
					r_R__0__A4g_XJTargetInfo.SetBelong(this.instance);
				}
				return r_R__0__A4g_XJTargetInfo;
			}
		}

		/// <summary>
		/// Void #rch(XJTargetChapterInfo)
		/// </summary>
		protected RMethod r_R__0__rch_XJTargetChapterInfo;
		public virtual RMethod R__0__rch_XJTargetChapterInfo
		{
			get
			{
				if(r_R__0__rch_XJTargetChapterInfo == null)
				{
					r_R__0__rch_XJTargetChapterInfo = new(this, "#rch", 0, typeof(XJTargetChapterInfo));
					r_R__0__rch_XJTargetChapterInfo.SetBelong(this.instance);
				}
				return r_R__0__rch_XJTargetChapterInfo;
			}
		}
		...
		/// Void #mk(#Pfb.#neh)
		/// </summary>
		protected RMethod r_R__0__mk___0__neh;
		public virtual RMethod R__0__mk___0__neh
		{
			get
			{
				if(r_R__0__mk___0__neh == null)
				{
					r_R__0__mk___0__neh = new(this, "#mk", 0,  ReleactionUtils.GetType("#Pfb.#neh"));
					r_R__0__mk___0__neh.SetBelong(this.instance);
				}
				return r_R__0__mk___0__neh;
			}
		}
        ...
        public R__0__sch() : base("#u.#sch")
        {
        }

        public R__0__sch(System.Object instance) : base("#u.#sch")
		{
            SetInstance(instance);
		}

        public R__0__sch(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__sch(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__A4g(XJTargetInfo  @info)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@info};
            var ___result = R__0__A4g_XJTargetInfo.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__rch(XJTargetChapterInfo  @chapterinfo)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@chapterinfo};
            var ___result = R__0__rch_XJTargetChapterInfo.Invoke(___genericsType, ___parameters);

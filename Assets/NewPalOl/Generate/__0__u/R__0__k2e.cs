...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#k2e
	/// </summary>
    public partial class R__0__k2e : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.List`1[pveFailConfigItem] #a
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RList<RpveFailConfigItem> r___0__a;
		public static RSystem.RCollections.RGeneric.RList<RpveFailConfigItem> R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#k2e"), "#a");
		...
		/// <summary>
		/// Void OnLoadpveFailTutorialConfig(UnityEngine.Object)
		/// </summary>
		protected static RMethod r_ROnLoadpveFailTutorialConfig_Object;
		public static RMethod ROnLoadpveFailTutorialConfig_Object
		{
			get
			{
				if(r_ROnLoadpveFailTutorialConfig_Object == null)
				{
					r_ROnLoadpveFailTutorialConfig_Object = new( ReleactionUtils.GetType("#u.#k2e"), "OnLoadpveFailTutorialConfig", 0, typeof(UnityEngine.Object));
					r_ROnLoadpveFailTutorialConfig_Object.SetBelong(null);
				}
				return r_ROnLoadpveFailTutorialConfig_Object;
			}
		}
		...
		/// <summary>
		/// Void #g2e(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__g2e_Object___0__7X;
		public virtual RMethod R__0__g2e_Object___0__7X
		{
			get
			{
				if(r_R__0__g2e_Object___0__7X == null)
				{
					r_R__0__g2e_Object___0__7X = new(this, "#g2e", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__g2e_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__g2e_Object___0__7X;
			}
		}
		...
		/// Void #P8e(Boolean)
		/// </summary>
		protected RMethod r_R__0__P8e_Boolean;
		public virtual RMethod R__0__P8e_Boolean
		{
			get
			{
				if(r_R__0__P8e_Boolean == null)
				{
					r_R__0__P8e_Boolean = new(this, "#P8e", 0, typeof(System.Boolean));
					r_R__0__P8e_Boolean.SetBelong(this.instance);
				}
				return r_R__0__P8e_Boolean;
			}
		}
		...
		/// Void #iAc()
		/// </summary>
		protected RMethod r_R__0__iAc;
		public virtual RMethod R__0__iAc
		{
			get
			{
				if(r_R__0__iAc == null)
				{
					r_R__0__iAc = new(this, "#iAc", 0);
					r_R__0__iAc.SetBelong(this.instance);
				}
				return r_R__0__iAc;
			}
		}
		...
		/// <summary>
		/// Void #qUr(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__qUr_Object___0__7X;
		public virtual RMethod R__0__qUr_Object___0__7X
		{
			get
			{
				if(r_R__0__qUr_Object___0__7X == null)
				{
					r_R__0__qUr_Object___0__7X = new(this, "#qUr", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__qUr_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__qUr_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #rUr(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__rUr_Object___0__7X;
		public virtual RMethod R__0__rUr_Object___0__7X
		{
			get
			{
				if(r_R__0__rUr_Object___0__7X == null)
				{
					r_R__0__rUr_Object___0__7X = new(this, "#rUr", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__rUr_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__rUr_Object___0__7X;
			}
		}
        ...
        public R__0__k2e() : base("#u.#k2e")
        {
        }

        public R__0__k2e(System.Object instance) : base("#u.#k2e")
		{
            SetInstance(instance);
		}

        public R__0__k2e(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__k2e(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public static void OnLoadpveFailTutorialConfig(UnityEngine.Object  @textAsset)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@textAsset};
            var ___result = ROnLoadpveFailTutorialConfig_Object.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__P8e(System.Boolean  @bl)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bl};
            var ___result = R__0__P8e_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__iAc()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__iAc.Invoke(___genericsType, ___parameters);

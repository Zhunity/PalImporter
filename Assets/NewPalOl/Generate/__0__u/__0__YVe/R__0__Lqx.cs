...
{public partial class R__0__YVe
{
	
	/// <summary>
	/// #u.#YVe+#Lqx
	/// </summary>
    public partial class R__0__Lqx : RMember //
    {
		...
		/// System.Object #e
		/// </summary>
		protected RSystem.RObject r___0__e;
		public virtual RSystem.RObject R__0__e
		{
			get
			{
				if(r___0__e == null)
		...
		/// #u.#YVe #g
		/// </summary>
		protected R__0__u.R__0__YVe r___0__g;
		public virtual R__0__u.R__0__YVe R__0__g
		{
			get
			{
				if(r___0__g == null)
		...
		/// <summary>
		/// Void #oke(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__oke_Object___0__7X;
		public virtual RMethod R__0__oke_Object___0__7X
		{
			get
			{
				if(r_R__0__oke_Object___0__7X == null)
				{
					r_R__0__oke_Object___0__7X = new(this, "#oke", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__oke_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__oke_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #qke(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__qke_Object___0__7X;
		public virtual RMethod R__0__qke_Object___0__7X
		{
			get
			{
				if(r_R__0__qke_Object___0__7X == null)
				{
					r_R__0__qke_Object___0__7X = new(this, "#qke", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__qke_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__qke_Object___0__7X;
			}
		}
        ...
        public R__0__Lqx() : base("#u.#YVe+#Lqx")
        {
        }

        public R__0__Lqx(System.Object instance) : base("#u.#YVe+#Lqx")
		{
            SetInstance(instance);
		}

        public R__0__Lqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Lqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

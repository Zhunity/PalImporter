...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#lqr
	/// </summary>
    public partial class R__0__lqr : RMember //
    {
		...
		/// <summary>
		/// Void #Rdx(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Rdx_Object___0__7X;
		public virtual RMethod R__0__Rdx_Object___0__7X
		{
			get
			{
				if(r_R__0__Rdx_Object___0__7X == null)
				{
					r_R__0__Rdx_Object___0__7X = new(this, "#Rdx", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Rdx_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Rdx_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #Sdx(System.Object)
		/// </summary>
		protected RMethod r_R__0__Sdx_Object;
		public virtual RMethod R__0__Sdx_Object
		{
			get
			{
				if(r_R__0__Sdx_Object == null)
				{
					r_R__0__Sdx_Object = new(this, "#Sdx", 0, typeof(System.Object));
					r_R__0__Sdx_Object.SetBelong(this.instance);
				}
				return r_R__0__Sdx_Object;
			}
		}
        ...
        public R__0__lqr() : base("#u.#lqr")
        {
        }

        public R__0__lqr(System.Object instance) : base("#u.#lqr")
		{
            SetInstance(instance);
		}

        public R__0__lqr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__lqr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Sdx(System.Object  @x)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@x};
            var ___result = R__0__Sdx_Object.Invoke(___genericsType, ___parameters);

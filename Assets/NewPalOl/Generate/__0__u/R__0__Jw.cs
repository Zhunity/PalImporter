...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Jw
	/// </summary>
    public partial class R__0__Jw : RMember //
    {
		...
		public static RField R__0__h
		{
			get
			{
				if(r___0__h == null)
				{
					r___0__h = new( ReleactionUtils.GetType("#u.#Jw"), "#h");
		...
		public static RField R__0__i
		{
			get
			{
				if(r___0__i == null)
				{
					r___0__i = new( ReleactionUtils.GetType("#u.#Jw"), "#i");
		...
		public static RField R__0__j
		{
			get
			{
				if(r___0__j == null)
				{
					r___0__j = new( ReleactionUtils.GetType("#u.#Jw"), "#j");
		...
		/// <summary>
		/// UnityEngine.Texture #s
		/// </summary>
		protected RUnityEngine.RTexture r___0__s;
		public virtual RUnityEngine.RTexture R__0__s
		{
			get
			{
				if(r___0__s == null)
		...
		/// <summary>
		/// UnityEngine.Material #t
		/// </summary>
		protected RUnityEngine.RMaterial r___0__t;
		public virtual RUnityEngine.RMaterial R__0__t
		{
			get
			{
				if(r___0__t == null)
		...
		/// <summary>
		/// UnityEngine.Texture HandTexture
		/// </summary>
		protected RUnityEngine.RTexture r_R__0__Hw;
		public virtual RUnityEngine.RTexture R__0__Hw
		{
			get
			{
				if(r_R__0__Hw == null)
				{
					r_R__0__Hw = new(this, "HandTexture", -1);
					r_R__0__Hw.SetBelong(this.instance);
				}
				return r_R__0__Hw;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Material RotateMaterial
		/// </summary>
		protected RUnityEngine.RMaterial r_R__0__Iw;
		public virtual RUnityEngine.RMaterial R__0__Iw
		{
			get
			{
				if(r_R__0__Iw == null)
				{
					r_R__0__Iw = new(this, "RotateMaterial", -1);
        ...
        public R__0__Jw() : base("#u.#Jw")
        {
        }

        public R__0__Jw(System.Object instance) : base("#u.#Jw")
		{
            SetInstance(instance);
		}

        public R__0__Jw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Jw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

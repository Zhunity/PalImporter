...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#k9
	/// </summary>
    public partial class R__0__k9 : RMember //
    {

		/// <summary>
		/// #Pfb.#lpb #a
		/// </summary>
		protected R__0__Pfb.R__0__lpb r___0__a;
		public virtual R__0__Pfb.R__0__lpb R__0__a
		{
			get
			{
				if(r___0__a == null)
        ...
        public R__0__k9() : base("#u.#k9")
        {
        }

        public R__0__k9(System.Object instance) : base("#u.#k9")
		{
            SetInstance(instance);
		}

        public R__0__k9(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__k9(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

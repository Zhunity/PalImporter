...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#jFw
	/// </summary>
    public partial class R__0__jFw : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#jFw"), "#a");
		...
		/// <summary>
		/// UnityEngine.Transform #j
		/// </summary>
		protected RUnityEngine.RTransform r___0__j;
		public virtual RUnityEngine.RTransform R__0__j
		{
			get
			{
				if(r___0__j == null)
		...
		/// Void #mk(#u.#Ckb)
		/// </summary>
		protected RMethod r_R__0__mk___0__Ckb;
		public virtual RMethod R__0__mk___0__Ckb
		{
			get
			{
				if(r_R__0__mk___0__Ckb == null)
				{
					r_R__0__mk___0__Ckb = new(this, "#mk", 0,  ReleactionUtils.GetType("#u.#Ckb"));
					r_R__0__mk___0__Ckb.SetBelong(this.instance);
				}
				return r_R__0__mk___0__Ckb;
			}
		}
		...
		/// <summary>
		/// System.Collections.IEnumerator #l3d(UnityEngine.Transform, UnityEngine.Vector3, UnityEngine.GameObject, Boolean)
		/// </summary>
		protected RMethod r_R__0__l3d_Transform_Vector3_GameObject_Boolean;
		public virtual RMethod R__0__l3d_Transform_Vector3_GameObject_Boolean
		{
			get
			{
				if(r_R__0__l3d_Transform_Vector3_GameObject_Boolean == null)
				{
					r_R__0__l3d_Transform_Vector3_GameObject_Boolean = new(this, "#l3d", 0, typeof(UnityEngine.Transform), typeof(UnityEngine.Vector3), typeof(UnityEngine.GameObject), typeof(System.Boolean));
					r_R__0__l3d_Transform_Vector3_GameObject_Boolean.SetBelong(this.instance);
				}
				return r_R__0__l3d_Transform_Vector3_GameObject_Boolean;
			}
		}

		/// <summary>
		/// Void #iFw(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__iFw_ID;
		public virtual RMethod R__0__iFw_ID
		{
			get
			{
				if(r_R__0__iFw_ID == null)
				{
					r_R__0__iFw_ID = new(this, "#iFw", 0, typeof(GameDefineType.ID));
					r_R__0__iFw_ID.SetBelong(this.instance);
				}
				return r_R__0__iFw_ID;
			}
		}
        ...
        public R__0__jFw() : base("#u.#jFw")
        {
        }

        public R__0__jFw(System.Object instance) : base("#u.#jFw")
		{
            SetInstance(instance);
		}

        public R__0__jFw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jFw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__vtd(System.Int32  @exp, System.Boolean  @bLocate)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@exp, @bLocate};
        ...
        public virtual System.Collections.IEnumerator __0__l3d(UnityEngine.Transform  @mSlEffect, UnityEngine.Vector3  @targetPos, UnityEngine.GameObject  @obj, System.Boolean  @bLocate)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@mSlEffect, @targetPos, @obj, @bLocate};
            var ___result = R__0__l3d_Transform_Vector3_GameObject_Boolean.Invoke(___genericsType, ___parameters);

            return (System.Collections.IEnumerator)___result;
        }


        public virtual void __0__iFw(GameDefineType.ID  @idEquip)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@idEquip};
            var ___result = R__0__iFw_ID.Invoke(___genericsType, ___parameters);

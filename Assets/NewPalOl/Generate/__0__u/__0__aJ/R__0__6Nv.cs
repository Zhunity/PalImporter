...
{public partial class R__0__aJ
{
	...
	/// #u.#aJ+#6Nv
	/// </summary>
    public partial class R__0__6Nv : RMember //
    {
		...
		/// #u.#aJ #c
		/// </summary>
		protected R__0__u.R__0__aJ r___0__c;
		public virtual R__0__u.R__0__aJ R__0__c
		{
			get
			{
				if(r___0__c == null)
        ...
        public R__0__6Nv() : base("#u.#aJ+#6Nv")
        {
        }

        public R__0__6Nv(System.Object instance) : base("#u.#aJ+#6Nv")
		{
            SetInstance(instance);
		}

        public R__0__6Nv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6Nv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

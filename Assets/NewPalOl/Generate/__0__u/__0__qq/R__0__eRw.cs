...
{public partial class R__0__Qq
{
	...
	/// #u.#Qq+#eRw
	/// </summary>
    public partial class R__0__eRw : RMember //
    {
        ...
        public R__0__eRw() : base("#u.#Qq+#eRw")
        {
        }

        public R__0__eRw(System.Object instance) : base("#u.#Qq+#eRw")
		{
            SetInstance(instance);
		}

        public R__0__eRw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__eRw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

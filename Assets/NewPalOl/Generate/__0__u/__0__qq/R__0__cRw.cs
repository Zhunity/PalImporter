...
{public partial class R__0__qq
{
	...
	/// #u.#qq+#cRw
	/// </summary>
    public partial class R__0__cRw : RMember //
    {
		...
		/// #u.#qq #c
		/// </summary>
		protected R__0__u.R__0__qq r___0__c;
		public virtual R__0__u.R__0__qq R__0__c
		{
			get
			{
				if(r___0__c == null)
        ...
        public R__0__cRw() : base("#u.#qq+#cRw")
        {
        }

        public R__0__cRw(System.Object instance) : base("#u.#qq+#cRw")
		{
            SetInstance(instance);
		}

        public R__0__cRw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cRw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

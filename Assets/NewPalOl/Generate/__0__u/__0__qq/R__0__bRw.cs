...
{public partial class R__0__qq
{
	...
	/// #u.#qq+#bRw
	/// </summary>
    public partial class R__0__bRw : RMember //
    {
        ...
        public R__0__bRw() : base("#u.#qq+#bRw")
        {
        }

        public R__0__bRw(System.Object instance) : base("#u.#qq+#bRw")
		{
            SetInstance(instance);
		}

        public R__0__bRw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__bRw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

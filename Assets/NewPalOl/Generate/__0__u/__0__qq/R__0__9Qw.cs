...
{public partial class R__0__qq
{
	
	/// <summary>
	/// #u.#qq+#9Qw
	/// </summary>
    public partial class R__0__9Qw : RMember //
    {
		...
		/// #u.#qq #d
		/// </summary>
		protected R__0__u.R__0__qq r___0__d;
		public virtual R__0__u.R__0__qq R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__9Qw() : base("#u.#qq+#9Qw")
        {
        }

        public R__0__9Qw(System.Object instance) : base("#u.#qq+#9Qw")
		{
            SetInstance(instance);
		}

        public R__0__9Qw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Qw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

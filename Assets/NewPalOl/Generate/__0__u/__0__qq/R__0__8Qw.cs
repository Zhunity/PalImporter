...
{public partial class R__0__qq
{
	...
	/// #u.#qq+#8Qw
	/// </summary>
    public partial class R__0__8Qw : RMember //
    {
        ...
        public R__0__8Qw() : base("#u.#qq+#8Qw")
        {
        }

        public R__0__8Qw(System.Object instance) : base("#u.#qq+#8Qw")
		{
            SetInstance(instance);
		}

        public R__0__8Qw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Qw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

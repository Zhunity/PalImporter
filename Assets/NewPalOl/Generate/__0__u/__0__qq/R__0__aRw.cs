...
{public partial class R__0__qq
{
	...
	/// #u.#qq+#aRw
	/// </summary>
    public partial class R__0__aRw : RMember //
    {
		...
		/// #u.#qq #e
		/// </summary>
		protected R__0__u.R__0__qq r___0__e;
		public virtual R__0__u.R__0__qq R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__aRw() : base("#u.#qq+#aRw")
        {
        }

        public R__0__aRw(System.Object instance) : base("#u.#qq+#aRw")
		{
            SetInstance(instance);
		}

        public R__0__aRw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__aRw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#s9
	/// </summary>
    public partial class R__0__s9 : RMember //
    {
        ...
        public R__0__s9() : base("#u.#s9")
        {
        }

        public R__0__s9(System.Object instance) : base("#u.#s9")
		{
            SetInstance(instance);
		}

        public R__0__s9(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__s9(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

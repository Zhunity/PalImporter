...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#b9
	/// </summary>
    public partial class R__0__b9 : RMember //
    {
        ...
        public R__0__b9() : base("#u.#b9")
        {
        }

        public R__0__b9(System.Object instance) : base("#u.#b9")
		{
            SetInstance(instance);
		}

        public R__0__b9(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__b9(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Eep
	/// </summary>
    public partial class R__0__Eep : RMember //
    {
		...
		/// Void #Aep()
		/// </summary>
		protected RMethod r_R__0__Aep;
		public virtual RMethod R__0__Aep
		{
			get
			{
				if(r_R__0__Aep == null)
				{
					r_R__0__Aep = new(this, "#Aep", 0);
					r_R__0__Aep.SetBelong(this.instance);
				}
				return r_R__0__Aep;
			}
		}
        ...
        public R__0__Eep() : base("#u.#Eep")
        {
        }

        public R__0__Eep(System.Object instance) : base("#u.#Eep")
		{
            SetInstance(instance);
		}

        public R__0__Eep(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Eep(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Aep()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Aep.Invoke(___genericsType, ___parameters);

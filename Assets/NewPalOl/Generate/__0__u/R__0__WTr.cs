...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#WTr
	/// </summary>
    public partial class R__0__WTr : RMember //
    {
		...
		/// #u.#UTr #d
		/// </summary>
		protected R__0__u.R__0__UTr r___0__d;
		public virtual R__0__u.R__0__UTr R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// <summary>
		/// Void #Gex(System.Object)
		/// </summary>
		protected RMethod r_R__0__Gex_Object;
		public virtual RMethod R__0__Gex_Object
		{
			get
			{
				if(r_R__0__Gex_Object == null)
				{
					r_R__0__Gex_Object = new(this, "#Gex", 0, typeof(System.Object));
					r_R__0__Gex_Object.SetBelong(this.instance);
				}
				return r_R__0__Gex_Object;
			}
		}
        ...
        public R__0__WTr() : base("#u.#WTr")
        {
        }

        public R__0__WTr(System.Object instance) : base("#u.#WTr")
		{
            SetInstance(instance);
		}

        public R__0__WTr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__WTr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Gex(System.Object  @x)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@x};
            var ___result = R__0__Gex_Object.Invoke(___genericsType, ___parameters);

...
{public partial class R__0__5Rc
{
	...
	/// #u.#5Rc+#eYw
	/// </summary>
    public partial class R__0__eYw : RMember //
    {
		...
		/// MountPet #b
		/// </summary>
		protected RMountPet r___0__b;
		public virtual RMountPet R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// MountPetConfig #c
		/// </summary>
		protected RMountPetConfig r___0__c;
		public virtual RMountPetConfig R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// #u.#5Rc #g
		/// </summary>
		protected R__0__u.R__0__5Rc r___0__g;
		public virtual R__0__u.R__0__5Rc R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__eYw() : base("#u.#5Rc+#eYw")
        {
        }

        public R__0__eYw(System.Object instance) : base("#u.#5Rc+#eYw")
		{
            SetInstance(instance);
		}

        public R__0__eYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__eYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#EO
	/// </summary>
    public partial class R__0__EO : RMember //
    {

		/// <summary>
		/// UnityEngine.Vector2 #a
		/// </summary>
		protected static RUnityEngine.RVector2 r___0__a;
		public static RUnityEngine.RVector2 R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#EO"), "#a");
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[#u.#Tbb,#u.#EO] #b
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RDictionary<R__0__u.R__0__Tbb, R__0__u.R__0__EO> r___0__b;
		public static RSystem.RCollections.RGeneric.RDictionary<R__0__u.R__0__Tbb, R__0__u.R__0__EO> R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#EO"), "#b");
		...
		/// <summary>
		/// System.Collections.Generic.List`1[#u.#EO] #c
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RList<R__0__u.R__0__EO> r___0__c;
		public static RSystem.RCollections.RGeneric.RList<R__0__u.R__0__EO> R__0__c
		{
			get
			{
				if(r___0__c == null)
				{
					r___0__c = new( ReleactionUtils.GetType("#u.#EO"), "#c");
		...
		/// <summary>
		/// System.Collections.Generic.Stack`1[UnityEngine.Vector2] #d
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RStack<RUnityEngine.RVector2> r___0__d;
		public static RSystem.RCollections.RGeneric.RStack<RUnityEngine.RVector2> R__0__d
		{
			get
			{
				if(r___0__d == null)
				{
					r___0__d = new( ReleactionUtils.GetType("#u.#EO"), "#d");
		...
		/// <summary>
		/// System.Collections.Generic.List`1[UnityEngine.Vector2] #e
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RList<RUnityEngine.RVector2> r___0__e;
		public static RSystem.RCollections.RGeneric.RList<RUnityEngine.RVector2> R__0__e
		{
			get
			{
				if(r___0__e == null)
				{
					r___0__e = new( ReleactionUtils.GetType("#u.#EO"), "#e");
		...
		/// <summary>
		/// UnityEngine.Vector2 #f
		/// </summary>
		protected static RUnityEngine.RVector2 r___0__f;
		public static RUnityEngine.RVector2 R__0__f
		{
			get
			{
				if(r___0__f == null)
				{
					r___0__f = new( ReleactionUtils.GetType("#u.#EO"), "#f");
		...
		/// #oU.#I4 #h
		/// </summary>
		protected R__0__oU.R__0__I4 r___0__h;
		public virtual R__0__oU.R__0__I4 R__0__h
		{
			get
			{
				if(r___0__h == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1[#oU.#BY] #j
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__oU.R__0__BY> r___0__j;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__oU.R__0__BY> R__0__j
		{
			get
			{
				if(r___0__j == null)
		...
		/// #u.#Tbb #k
		/// </summary>
		protected R__0__u.R__0__Tbb r___0__k;
		public virtual R__0__u.R__0__Tbb R__0__k
		{
			get
			{
				if(r___0__k == null)
		...
		/// </summary>
		protected RUnityEngine.RGUIStyle r___0__m;
		public virtual RUnityEngine.RGUIStyle R__0__m
		{
			get
			{
				if(r___0__m == null)
		...
		/// <summary>
		/// System.Func`2[#u.#EO,System.Boolean] #r
		/// </summary>
		protected static RSystem.RFunc<R__0__u.R__0__EO, RField> r___0__r;
		public static RSystem.RFunc<R__0__u.R__0__EO, RField> R__0__r
		{
			get
			{
				if(r___0__r == null)
				{
					r___0__r = new( ReleactionUtils.GetType("#u.#EO"), "#r");
		...
		/// Void #pO()
		/// </summary>
		protected RMethod r_R__0__pO;
		public virtual RMethod R__0__pO
		{
			get
			{
				if(r_R__0__pO == null)
				{
					r_R__0__pO = new(this, "#pO", 0);
					r_R__0__pO.SetBelong(this.instance);
				}
				return r_R__0__pO;
			}
		}
		...
		/// <summary>
		/// Boolean #lnd(GameDefineType.ID, #u.#EO ByRef)
		/// </summary>
		protected static RMethod r_R__0__lnd_ID_Out___0__EO;
		public static RMethod R__0__lnd_ID_Out___0__EO
		{
			get
			{
				if(r_R__0__lnd_ID_Out___0__EO == null)
				{
					r_R__0__lnd_ID_Out___0__EO = new( ReleactionUtils.GetType("#u.#EO"), "#lnd", 0, typeof(GameDefineType.ID),  ReleactionUtils.GetType("#u.#EO").MakeByRefType());
					r_R__0__lnd_ID_Out___0__EO.SetBelong(null);
				}
				return r_R__0__lnd_ID_Out___0__EO;
			}
		}
		...
		/// Boolean #rO(#u.#Tbb)
		/// </summary>
		protected static RMethod r_R__0__rO___0__Tbb;
		public static RMethod R__0__rO___0__Tbb
		{
			get
			{
				if(r_R__0__rO___0__Tbb == null)
				{
					r_R__0__rO___0__Tbb = new( ReleactionUtils.GetType("#u.#EO"), "#rO", 0,  ReleactionUtils.GetType("#u.#Tbb"));
					r_R__0__rO___0__Tbb.SetBelong(null);
				}
				return r_R__0__rO___0__Tbb;
			}
		}
		...
		/// #u.#EO #qO(#u.#Tbb)
		/// </summary>
		protected RMethod r_R__0__qO___0__Tbb;
		public virtual RMethod R__0__qO___0__Tbb
		{
			get
			{
				if(r_R__0__qO___0__Tbb == null)
				{
					r_R__0__qO___0__Tbb = new(this, "#qO", 0,  ReleactionUtils.GetType("#u.#Tbb"));
					r_R__0__qO___0__Tbb.SetBelong(this.instance);
				}
				return r_R__0__qO___0__Tbb;
			}
		}

		/// <summary>
		/// Void #sO(System.Object)
		/// </summary>
		protected RMethod r_R__0__sO_Object;
		public virtual RMethod R__0__sO_Object
		{
			get
			{
				if(r_R__0__sO_Object == null)
				{
					r_R__0__sO_Object = new(this, "#sO", 0, typeof(System.Object));
					r_R__0__sO_Object.SetBelong(this.instance);
				}
				return r_R__0__sO_Object;
			}
		}

		/// <summary>
		/// Void #Fp(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Fp_Object___0__7X;
		public virtual RMethod R__0__Fp_Object___0__7X
		{
			get
			{
				if(r_R__0__Fp_Object___0__7X == null)
				{
					r_R__0__Fp_Object___0__7X = new(this, "#Fp", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Fp_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Fp_Object___0__7X;
			}
		}

		/// <summary>
		/// Boolean #tO(System.String, System.String, Int32 ByRef)
		/// </summary>
		protected RMethod r_R__0__tO_String_String_Out_Int32;
		public virtual RMethod R__0__tO_String_String_Out_Int32
		{
			get
			{
				if(r_R__0__tO_String_String_Out_Int32 == null)
				{
					r_R__0__tO_String_String_Out_Int32 = new(this, "#tO", 0, typeof(System.String), typeof(System.String), typeof(System.Int32).MakeByRefType());
					r_R__0__tO_String_String_Out_Int32.SetBelong(this.instance);
				}
				return r_R__0__tO_String_String_Out_Int32;
			}
		}

		/// <summary>
		/// Boolean #uO(System.String)
		/// </summary>
		protected RMethod r_R__0__uO_String;
		public virtual RMethod R__0__uO_String
		{
			get
			{
				if(r_R__0__uO_String == null)
				{
					r_R__0__uO_String = new(this, "#uO", 0, typeof(System.String));
					r_R__0__uO_String.SetBelong(this.instance);
				}
				return r_R__0__uO_String;
			}
		}

		/// <summary>
		/// Void #vO(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__vO_Object___0__7X;
		public virtual RMethod R__0__vO_Object___0__7X
		{
			get
			{
				if(r_R__0__vO_Object___0__7X == null)
				{
					r_R__0__vO_Object___0__7X = new(this, "#vO", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__vO_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__vO_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #wO(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__wO_Object___0__7X;
		public virtual RMethod R__0__wO_Object___0__7X
		{
			get
			{
				if(r_R__0__wO_Object___0__7X == null)
				{
					r_R__0__wO_Object___0__7X = new(this, "#wO", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__wO_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__wO_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #9r(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__9r_Object___0__7X;
		public virtual RMethod R__0__9r_Object___0__7X
		{
			get
			{
				if(r_R__0__9r_Object___0__7X == null)
				{
					r_R__0__9r_Object___0__7X = new(this, "#9r", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__9r_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__9r_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #as(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__as_Object___0__7X;
		public virtual RMethod R__0__as_Object___0__7X
		{
			get
			{
				if(r_R__0__as_Object___0__7X == null)
				{
					r_R__0__as_Object___0__7X = new(this, "#as", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__as_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__as_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #FGc(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__FGc_Object___0__7X;
		public virtual RMethod R__0__FGc_Object___0__7X
		{
			get
			{
				if(r_R__0__FGc_Object___0__7X == null)
				{
					r_R__0__FGc_Object___0__7X = new(this, "#FGc", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__FGc_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__FGc_Object___0__7X;
			}
		}
		...
		/// Void #mnd()
		/// </summary>
		protected RMethod r_R__0__mnd;
		public virtual RMethod R__0__mnd
		{
			get
			{
				if(r_R__0__mnd == null)
				{
					r_R__0__mnd = new(this, "#mnd", 0);
					r_R__0__mnd.SetBelong(this.instance);
				}
				return r_R__0__mnd;
			}
		}
		...
		/// Void #xO()
		/// </summary>
		protected RMethod r_R__0__xO;
		public virtual RMethod R__0__xO
		{
			get
			{
				if(r_R__0__xO == null)
				{
					r_R__0__xO = new(this, "#xO", 0);
					r_R__0__xO.SetBelong(this.instance);
				}
				return r_R__0__xO;
			}
		}
		...
		/// Void #yO(#u.#Vbb)
		/// </summary>
		protected RMethod r_R__0__yO___0__Vbb;
		public virtual RMethod R__0__yO___0__Vbb
		{
			get
			{
				if(r_R__0__yO___0__Vbb == null)
				{
					r_R__0__yO___0__Vbb = new(this, "#yO", 0,  ReleactionUtils.GetType("#u.#Vbb"));
					r_R__0__yO___0__Vbb.SetBelong(this.instance);
				}
				return r_R__0__yO___0__Vbb;
			}
		}
		...
		/// <summary>
		/// System.String #Zkc(System.String)
		/// </summary>
		protected RMethod r_R__0__Zkc_String;
		public virtual RMethod R__0__Zkc_String
		{
			get
			{
				if(r_R__0__Zkc_String == null)
				{
					r_R__0__Zkc_String = new(this, "#Zkc", 0, typeof(System.String));
					r_R__0__Zkc_String.SetBelong(this.instance);
				}
				return r_R__0__Zkc_String;
			}
		}
		...
		/// Void #zO(#u.#Tbb)
		/// </summary>
		protected RMethod r_R__0__zO___0__Tbb;
		public virtual RMethod R__0__zO___0__Tbb
		{
			get
			{
				if(r_R__0__zO___0__Tbb == null)
				{
					r_R__0__zO___0__Tbb = new(this, "#zO", 0,  ReleactionUtils.GetType("#u.#Tbb"));
					r_R__0__zO___0__Tbb.SetBelong(this.instance);
				}
				return r_R__0__zO___0__Tbb;
			}
		}
		...
		/// Void #AO()
		/// </summary>
		protected RMethod r_R__0__AO;
		public virtual RMethod R__0__AO
		{
			get
			{
				if(r_R__0__AO == null)
				{
					r_R__0__AO = new(this, "#AO", 0);
					r_R__0__AO.SetBelong(this.instance);
				}
				return r_R__0__AO;
			}
		}
		...
		/// <summary>
		/// Void #sb(Boolean, Boolean)
		/// </summary>
		protected RMethod r_R__0__sb_Boolean_Boolean;
		public virtual RMethod R__0__sb_Boolean_Boolean
		{
			get
			{
				if(r_R__0__sb_Boolean_Boolean == null)
				{
					r_R__0__sb_Boolean_Boolean = new(this, "#sb", 0, typeof(System.Boolean), typeof(System.Boolean));
					r_R__0__sb_Boolean_Boolean.SetBelong(this.instance);
				}
				return r_R__0__sb_Boolean_Boolean;
			}
		}
		...
		/// Void #sb(#u.#Tbb)
		/// </summary>
		protected RMethod r_R__0__sb___0__Tbb;
		public virtual RMethod R__0__sb___0__Tbb
		{
			get
			{
				if(r_R__0__sb___0__Tbb == null)
				{
					r_R__0__sb___0__Tbb = new(this, "#sb", 0,  ReleactionUtils.GetType("#u.#Tbb"));
					r_R__0__sb___0__Tbb.SetBelong(this.instance);
				}
				return r_R__0__sb___0__Tbb;
			}
		}
		...
		/// <summary>
		/// Void #Uf(System.String)
		/// </summary>
		protected RMethod r_R__0__Uf_String;
		public virtual RMethod R__0__Uf_String
		{
			get
			{
				if(r_R__0__Uf_String == null)
				{
					r_R__0__Uf_String = new(this, "#Uf", 0, typeof(System.String));
					r_R__0__Uf_String.SetBelong(this.instance);
				}
				return r_R__0__Uf_String;
			}
		}

		/// <summary>
		/// Void #BO(UnityEngine.Vector2)
		/// </summary>
		protected RMethod r_R__0__BO_Vector2;
		public virtual RMethod R__0__BO_Vector2
		{
			get
			{
				if(r_R__0__BO_Vector2 == null)
				{
					r_R__0__BO_Vector2 = new(this, "#BO", 0, typeof(UnityEngine.Vector2));
					r_R__0__BO_Vector2.SetBelong(this.instance);
				}
				return r_R__0__BO_Vector2;
			}
		}

		/// <summary>
		/// UnityEngine.Vector2 #CO()
		/// </summary>
		protected RMethod r_R__0__CO;
		public virtual RMethod R__0__CO
		{
			get
			{
				if(r_R__0__CO == null)
				{
					r_R__0__CO = new(this, "#CO", 0);
					r_R__0__CO.SetBelong(this.instance);
				}
				return r_R__0__CO;
			}
		}
		...
		/// Boolean #mUr(#u.#EO)
		/// </summary>
		protected static RMethod r_R__0__mUr___0__EO;
		public static RMethod R__0__mUr___0__EO
		{
			get
			{
				if(r_R__0__mUr___0__EO == null)
				{
					r_R__0__mUr___0__EO = new( ReleactionUtils.GetType("#u.#EO"), "#mUr", 0,  ReleactionUtils.GetType("#u.#EO"));
					r_R__0__mUr___0__EO.SetBelong(null);
				}
				return r_R__0__mUr___0__EO;
			}
		}
        ...
        public R__0__EO() : base("#u.#EO")
        {
        }

        public R__0__EO(System.Object instance) : base("#u.#EO")
		{
            SetInstance(instance);
		}

        public R__0__EO(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__EO(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__pO()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__pO.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__sO(System.Object  @msgObj)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@msgObj};
            var ___result = R__0__sO_Object.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Boolean __0__tO(System.String  @oldText, System.String  @newText, out System.Int32  @enterIndex)
        {
			enterIndex = default;

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@oldText, @newText, @enterIndex};
            var ___result = R__0__tO_String_String_Out_Int32.Invoke(___genericsType, ___parameters);
			enterIndex = (System.Int32)___parameters[2];

            return (System.Boolean)___result;
        }


        public virtual System.Boolean __0__uO(System.String  @text)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text};
            var ___result = R__0__uO_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__mnd()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__mnd.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__xO()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__xO.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.String __0__Zkc(System.String  @text)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text};
            var ___result = R__0__Zkc_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__AO()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__AO.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__sb(System.Boolean  @show, System.Boolean  @bChannelEnd)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@show, @bChannelEnd};
            var ___result = R__0__sb_Boolean_Boolean.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__Uf(System.String  @text)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text};
            var ___result = R__0__Uf_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__BO(UnityEngine.Vector2  @removePos)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@removePos};
            var ___result = R__0__BO_Vector2.Invoke(___genericsType, ___parameters);

            
        }


        public virtual UnityEngine.Vector2 __0__CO()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__CO.Invoke(___genericsType, ___parameters);

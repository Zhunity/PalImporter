...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Lep
	/// </summary>
    public partial class R__0__Lep : RMember //
    {
		...
		/// Void #Jep()
		/// </summary>
		protected RMethod r_R__0__Jep;
		public virtual RMethod R__0__Jep
		{
			get
			{
				if(r_R__0__Jep == null)
				{
					r_R__0__Jep = new(this, "#Jep", 0);
					r_R__0__Jep.SetBelong(this.instance);
				}
				return r_R__0__Jep;
			}
		}
		...
		/// Void #HWc(#Pfb.#Hhp)
		/// </summary>
		protected RMethod r_R__0__HWc___0__Hhp;
		public virtual RMethod R__0__HWc___0__Hhp
		{
			get
			{
				if(r_R__0__HWc___0__Hhp == null)
				{
					r_R__0__HWc___0__Hhp = new(this, "#HWc", 0,  ReleactionUtils.GetType("#Pfb.#Hhp"));
					r_R__0__HWc___0__Hhp.SetBelong(this.instance);
				}
				return r_R__0__HWc___0__Hhp;
			}
		}
		...
		/// Void #HWc(#Pfb.#Ihp)
		/// </summary>
		protected RMethod r_R__0__HWc___0__Ihp;
		public virtual RMethod R__0__HWc___0__Ihp
		{
			get
			{
				if(r_R__0__HWc___0__Ihp == null)
				{
					r_R__0__HWc___0__Ihp = new(this, "#HWc", 0,  ReleactionUtils.GetType("#Pfb.#Ihp"));
					r_R__0__HWc___0__Ihp.SetBelong(this.instance);
				}
				return r_R__0__HWc___0__Ihp;
			}
		}
        ...
        public R__0__Lep() : base("#u.#Lep")
        {
        }

        public R__0__Lep(System.Object instance) : base("#u.#Lep")
		{
            SetInstance(instance);
		}

        public R__0__Lep(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Lep(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Jep()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Jep.Invoke(___genericsType, ___parameters);

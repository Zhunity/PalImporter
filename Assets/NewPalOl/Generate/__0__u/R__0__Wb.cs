...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Wb
	/// </summary>
    public partial class R__0__Wb : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.List`1[#oU.#5bb] #c
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__oU.R__0__5bb> r___0__c;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__oU.R__0__5bb> R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// <summary>
		/// Void #Tb(System.Collections.Generic.List`1[#Pfb.#2qb])
		/// </summary>
		protected RMethod r_R__0__Tb_List_d___0__2qb_p_;
		public virtual RMethod R__0__Tb_List_d___0__2qb_p_
		{
			get
			{
				if(r_R__0__Tb_List_d___0__2qb_p_ == null)
				{
					r_R__0__Tb_List_d___0__2qb_p_ = new(this, "#Tb", 0, typeof(System.Collections.Generic.List<>).MakeGenericType( ReleactionUtils.GetType("#Pfb.#2qb")));
					r_R__0__Tb_List_d___0__2qb_p_.SetBelong(this.instance);
				}
				return r_R__0__Tb_List_d___0__2qb_p_;
			}
		}

		/// <summary>
		/// Void #Ub(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Ub_Object___0__7X;
		public virtual RMethod R__0__Ub_Object___0__7X
		{
			get
			{
				if(r_R__0__Ub_Object___0__7X == null)
				{
					r_R__0__Ub_Object___0__7X = new(this, "#Ub", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Ub_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Ub_Object___0__7X;
			}
		}
        ...
        public R__0__Wb() : base("#u.#Wb")
        {
        }

        public R__0__Wb(System.Object instance) : base("#u.#Wb")
		{
            SetInstance(instance);
		}

        public R__0__Wb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Wb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#90d
	/// </summary>
    public partial class R__0__90d : RMember //
    {
		...
		public static RField R__0__i
		{
			get
			{
				if(r___0__i == null)
				{
					r___0__i = new( ReleactionUtils.GetType("#u.#90d"), "#i");
		...
		public static RField R__0__j
		{
			get
			{
				if(r___0__j == null)
				{
					r___0__j = new( ReleactionUtils.GetType("#u.#90d"), "#j");
		...
		public static RField R__0__k
		{
			get
			{
				if(r___0__k == null)
				{
					r___0__k = new( ReleactionUtils.GetType("#u.#90d"), "#k");
		...
		/// Single #Ew(Int32)
		/// </summary>
		protected RMethod r_R__0__Ew_Int32;
		public virtual RMethod R__0__Ew_Int32
		{
			get
			{
				if(r_R__0__Ew_Int32 == null)
				{
					r_R__0__Ew_Int32 = new(this, "#Ew", 0, typeof(System.Int32));
					r_R__0__Ew_Int32.SetBelong(this.instance);
				}
				return r_R__0__Ew_Int32;
			}
		}
		...
		/// Void #Gw()
		/// </summary>
		protected RMethod r_R__0__Gw;
		public virtual RMethod R__0__Gw
		{
			get
			{
				if(r_R__0__Gw == null)
				{
					r_R__0__Gw = new(this, "#Gw", 0);
		...
		/// Void #He()
		/// </summary>
		protected RMethod r_R__0__He;
		public virtual RMethod R__0__He
		{
			get
			{
				if(r_R__0__He == null)
				{
					r_R__0__He = new(this, "#He", 0);
					r_R__0__He.SetBelong(this.instance);
				}
				return r_R__0__He;
			}
		}
		...
		/// Void #Dw()
		/// </summary>
		protected RMethod r_R__0__Dw;
		public virtual RMethod R__0__Dw
		{
			get
			{
				if(r_R__0__Dw == null)
				{
					r_R__0__Dw = new(this, "#Dw", 0);
					r_R__0__Dw.SetBelong(this.instance);
				}
				return r_R__0__Dw;
			}
		}
		...
		/// <summary>
		/// Void #70d(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__70d_ID;
		public virtual RMethod R__0__70d_ID
		{
			get
			{
				if(r_R__0__70d_ID == null)
				{
					r_R__0__70d_ID = new(this, "#70d", 0, typeof(GameDefineType.ID));
					r_R__0__70d_ID.SetBelong(this.instance);
				}
				return r_R__0__70d_ID;
			}
		}
		...
		/// Void #Fw(Int32)
		/// </summary>
		protected RMethod r_R__0__Fw_Int32;
		public virtual RMethod R__0__Fw_Int32
		{
			get
			{
				if(r_R__0__Fw_Int32 == null)
				{
					r_R__0__Fw_Int32 = new(this, "#Fw", 0, typeof(System.Int32));
					r_R__0__Fw_Int32.SetBelong(this.instance);
				}
				return r_R__0__Fw_Int32;
			}
		}
		...
		/// Void #80d(Int32)
		/// </summary>
		protected RMethod r_R__0__80d_Int32;
		public virtual RMethod R__0__80d_Int32
		{
			get
			{
				if(r_R__0__80d_Int32 == null)
				{
					r_R__0__80d_Int32 = new(this, "#80d", 0, typeof(System.Int32));
					r_R__0__80d_Int32.SetBelong(this.instance);
				}
				return r_R__0__80d_Int32;
			}
		}
        ...
        public R__0__90d() : base("#u.#90d")
        {
        }

        public R__0__90d(System.Object instance) : base("#u.#90d")
		{
            SetInstance(instance);
		}

        public R__0__90d(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__90d(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Single __0__Ew(System.Int32  @mul)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@mul};
            var ___result = R__0__Ew_Int32.Invoke(___genericsType, ___parameters);

            return (System.Single)___result;
        }


        public virtual void __0__Gw()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Gw.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__He()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__He.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__Dw()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Dw.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__70d(GameDefineType.ID  @itemid)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@itemid};
            var ___result = R__0__70d_ID.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Fw(System.Int32  @nMultiple)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@nMultiple};
            var ___result = R__0__Fw_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__80d(System.Int32  @count)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@count};
            var ___result = R__0__80d_Int32.Invoke(___genericsType, ___parameters);

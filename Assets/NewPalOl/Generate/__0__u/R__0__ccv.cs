...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#ccv
	/// </summary>
    public partial class R__0__ccv : RMember //
    {
		...
		/// <summary>
		/// Void #bcv(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__bcv_Object___0__7X;
		public virtual RMethod R__0__bcv_Object___0__7X
		{
			get
			{
				if(r_R__0__bcv_Object___0__7X == null)
				{
					r_R__0__bcv_Object___0__7X = new(this, "#bcv", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__bcv_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__bcv_Object___0__7X;
			}
		}
        ...
        public R__0__ccv() : base("#u.#ccv")
        {
        }

        public R__0__ccv(System.Object instance) : base("#u.#ccv")
		{
            SetInstance(instance);
		}

        public R__0__ccv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ccv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

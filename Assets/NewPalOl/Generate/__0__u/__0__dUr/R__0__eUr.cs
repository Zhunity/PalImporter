...
{public partial class R__0__dUr
{
	
	/// <summary>
	/// #u.#dUr+#eUr
	/// </summary>
    public partial class R__0__eUr : RMember //
    {
        ...
        public R__0__eUr() : base("#u.#dUr+#eUr")
        {
        }

        public R__0__eUr(System.Object instance) : base("#u.#dUr+#eUr")
		{
            SetInstance(instance);
		}

        public R__0__eUr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__eUr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

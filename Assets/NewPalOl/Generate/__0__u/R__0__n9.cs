...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#n9
	/// </summary>
    public partial class R__0__n9 : RMember //
    {

		/// <summary>
		/// #Pfb.#xpb #a
		/// </summary>
		protected R__0__Pfb.R__0__xpb r___0__a;
		public virtual R__0__Pfb.R__0__xpb R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// Void #ei(System.Object, System.EventArgs)
		/// </summary>
		protected RMethod r_R__0__ei_Object_EventArgs;
		public virtual RMethod R__0__ei_Object_EventArgs
		{
			get
			{
				if(r_R__0__ei_Object_EventArgs == null)
				{
					r_R__0__ei_Object_EventArgs = new(this, "#ei", 0, typeof(System.Object), typeof(System.EventArgs));
					r_R__0__ei_Object_EventArgs.SetBelong(this.instance);
				}
				return r_R__0__ei_Object_EventArgs;
			}
		}

		/// <summary>
		/// Void #m9(System.Object, System.EventArgs)
		/// </summary>
		protected RMethod r_R__0__m9_Object_EventArgs;
		public virtual RMethod R__0__m9_Object_EventArgs
		{
			get
			{
				if(r_R__0__m9_Object_EventArgs == null)
				{
					r_R__0__m9_Object_EventArgs = new(this, "#m9", 0, typeof(System.Object), typeof(System.EventArgs));
					r_R__0__m9_Object_EventArgs.SetBelong(this.instance);
				}
				return r_R__0__m9_Object_EventArgs;
			}
		}
        ...
        public R__0__n9() : base("#u.#n9")
        {
        }

        public R__0__n9(System.Object instance) : base("#u.#n9")
		{
            SetInstance(instance);
		}

        public R__0__n9(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__n9(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }


        public virtual void __0__ei(System.Object  @sender, System.EventArgs  @e)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @e};
            var ___result = R__0__ei_Object_EventArgs.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__m9(System.Object  @sender, System.EventArgs  @e)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @e};
            var ___result = R__0__m9_Object_EventArgs.Invoke(___genericsType, ___parameters);

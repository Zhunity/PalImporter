...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#VH
	/// </summary>
    public partial class R__0__VH : RMember //
    {
		...
		public static RField R__0__e
		{
			get
			{
				if(r___0__e == null)
				{
					r___0__e = new( ReleactionUtils.GetType("#u.#VH"), "#e");
		...
		/// Void #NH(Pet)
		/// </summary>
		protected RMethod r_R__0__NH_Pet;
		public virtual RMethod R__0__NH_Pet
		{
			get
			{
				if(r_R__0__NH_Pet == null)
				{
					r_R__0__NH_Pet = new(this, "#NH", 0,  ReleactionUtils.GetType("Pet"));
					r_R__0__NH_Pet.SetBelong(this.instance);
				}
				return r_R__0__NH_Pet;
			}
		}

		/// <summary>
		/// System.String #OH(Creature)
		/// </summary>
		protected RMethod r_R__0__OH_Creature;
		public virtual RMethod R__0__OH_Creature
		{
			get
			{
				if(r_R__0__OH_Creature == null)
				{
					r_R__0__OH_Creature = new(this, "#OH", 0,  ReleactionUtils.GetType("Creature"));
					r_R__0__OH_Creature.SetBelong(this.instance);
				}
				return r_R__0__OH_Creature;
			}
		}

		/// <summary>
		/// System.String #PH(Creature)
		/// </summary>
		protected RMethod r_R__0__PH_Creature;
		public virtual RMethod R__0__PH_Creature
		{
			get
			{
				if(r_R__0__PH_Creature == null)
				{
					r_R__0__PH_Creature = new(this, "#PH", 0,  ReleactionUtils.GetType("Creature"));
					r_R__0__PH_Creature.SetBelong(this.instance);
				}
				return r_R__0__PH_Creature;
			}
		}
		...
		/// Int32 #TH(Pet)
		/// </summary>
		protected RMethod r_R__0__TH_Pet;
		public virtual RMethod R__0__TH_Pet
		{
			get
			{
				if(r_R__0__TH_Pet == null)
				{
					r_R__0__TH_Pet = new(this, "#TH", 0,  ReleactionUtils.GetType("Pet"));
					r_R__0__TH_Pet.SetBelong(this.instance);
				}
				return r_R__0__TH_Pet;
			}
		}
		...
		/// Int32 #z3d(Pet)
		/// </summary>
		protected RMethod r_R__0__z3d_Pet;
		public virtual RMethod R__0__z3d_Pet
		{
			get
			{
				if(r_R__0__z3d_Pet == null)
				{
					r_R__0__z3d_Pet = new(this, "#z3d", 0,  ReleactionUtils.GetType("Pet"));
					r_R__0__z3d_Pet.SetBelong(this.instance);
				}
				return r_R__0__z3d_Pet;
			}
		}
		...
		/// Void #UH(Pet)
		/// </summary>
		protected RMethod r_R__0__UH_Pet;
		public virtual RMethod R__0__UH_Pet
		{
			get
			{
				if(r_R__0__UH_Pet == null)
				{
					r_R__0__UH_Pet = new(this, "#UH", 0,  ReleactionUtils.GetType("Pet"));
					r_R__0__UH_Pet.SetBelong(this.instance);
				}
				return r_R__0__UH_Pet;
			}
		}
        ...
        public R__0__VH() : base("#u.#VH")
        {
        }

        public R__0__VH(System.Object instance) : base("#u.#VH")
		{
            SetInstance(instance);
		}

        public R__0__VH(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__VH(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#RM
	/// </summary>
    public partial class R__0__RM : RMember //
    {
		...
		/// <summary>
		/// Void #QM(UnityEngine.Texture2D)
		/// </summary>
		protected RMethod r_R__0__QM_Texture2D;
		public virtual RMethod R__0__QM_Texture2D
		{
			get
			{
				if(r_R__0__QM_Texture2D == null)
				{
					r_R__0__QM_Texture2D = new(this, "#QM", 0, typeof(UnityEngine.Texture2D));
					r_R__0__QM_Texture2D.SetBelong(this.instance);
				}
				return r_R__0__QM_Texture2D;
			}
		}
        ...
        public R__0__RM() : base("#u.#RM")
        {
        }

        public R__0__RM(System.Object instance) : base("#u.#RM")
		{
            SetInstance(instance);
		}

        public R__0__RM(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__RM(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__QM(UnityEngine.Texture2D  @head)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@head};
            var ___result = R__0__QM_Texture2D.Invoke(___genericsType, ___parameters);

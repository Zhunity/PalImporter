...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Pyf
	/// </summary>
    public partial class R__0__Pyf : RMember //
    {
        ...
        public R__0__Pyf() : base("#u.#Pyf")
        {
        }

        public R__0__Pyf(System.Object instance) : base("#u.#Pyf")
		{
            SetInstance(instance);
		}

        public R__0__Pyf(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Pyf(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

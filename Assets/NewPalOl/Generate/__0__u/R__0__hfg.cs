...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#hfg
	/// </summary>
    public partial class R__0__hfg : RMember //
    {
		...
		/// Void #bfg(#Pfb.#9jg)
		/// </summary>
		protected RMethod r_R__0__bfg___0__9jg;
		public virtual RMethod R__0__bfg___0__9jg
		{
			get
			{
				if(r_R__0__bfg___0__9jg == null)
				{
					r_R__0__bfg___0__9jg = new(this, "#bfg", 0,  ReleactionUtils.GetType("#Pfb.#9jg"));
					r_R__0__bfg___0__9jg.SetBelong(this.instance);
				}
				return r_R__0__bfg___0__9jg;
			}
		}
		...
		/// Void #efg()
		/// </summary>
		protected RMethod r_R__0__efg;
		public virtual RMethod R__0__efg
		{
			get
			{
				if(r_R__0__efg == null)
				{
					r_R__0__efg = new(this, "#efg", 0);
					r_R__0__efg.SetBelong(this.instance);
				}
				return r_R__0__efg;
			}
		}
		...
		/// <summary>
		/// Void #ffg(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__ffg_Object___0__7X;
		public virtual RMethod R__0__ffg_Object___0__7X
		{
			get
			{
				if(r_R__0__ffg_Object___0__7X == null)
				{
					r_R__0__ffg_Object___0__7X = new(this, "#ffg", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__ffg_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__ffg_Object___0__7X;
			}
		}
		...
		/// Void #gfg()
		/// </summary>
		protected RMethod r_R__0__gfg;
		public virtual RMethod R__0__gfg
		{
			get
			{
				if(r_R__0__gfg == null)
				{
					r_R__0__gfg = new(this, "#gfg", 0);
					r_R__0__gfg.SetBelong(this.instance);
				}
				return r_R__0__gfg;
			}
		}
        ...
        public R__0__hfg() : base("#u.#hfg")
        {
        }

        public R__0__hfg(System.Object instance) : base("#u.#hfg")
		{
            SetInstance(instance);
		}

        public R__0__hfg(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hfg(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__efg()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__efg.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__gfg()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__gfg.Invoke(___genericsType, ___parameters);

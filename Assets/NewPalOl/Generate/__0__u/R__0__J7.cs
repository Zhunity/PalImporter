...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#J7
	/// </summary>
    public partial class R__0__J7 : RMember //
    {
		...
		/// UnityEngine.Font #h
		/// </summary>
		protected RUnityEngine.RFont r___0__h;
		public virtual RUnityEngine.RFont R__0__h
		{
			get
			{
				if(r___0__h == null)
        ...
        public R__0__J7() : base("#u.#J7")
        {
        }

        public R__0__J7(System.Object instance) : base("#u.#J7")
		{
            SetInstance(instance);
		}

        public R__0__J7(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__J7(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__2lx
{
	
	/// <summary>
	/// #u.#2lx+#emx
	/// </summary>
    public partial class R__0__emx : RMember //
    {
		...
		/// #u.#2lx #m
		/// </summary>
		protected R__0__u.R__0__2lx r___0__m;
		public virtual R__0__u.R__0__2lx R__0__m
		{
			get
			{
				if(r___0__m == null)
        ...
        public R__0__emx() : base("#u.#2lx+#emx")
        {
        }

        public R__0__emx(System.Object instance) : base("#u.#2lx+#emx")
		{
            SetInstance(instance);
		}

        public R__0__emx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__emx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#YVd
	/// </summary>
    public partial class R__0__YVd : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#YVd"), "#a");
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[#u.#Vmj+#Aae,System.Boolean] #h
		/// </summary>
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[#u.#Vmj+#Aae,System.Int32] #i
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, RField> r___0__i;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__i
		{
			get
			{
				if(r___0__i == null)
		...
		/// System.DateTime #j
		/// </summary>
		protected RSystem.RDateTime r___0__j;
		public virtual RSystem.RDateTime R__0__j
		{
			get
			{
				if(r___0__j == null)
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2[System.String,System.Int32] #k
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RDictionary<RField, RField> r___0__k;
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__k
		{
			get
			{
				if(r___0__k == null)
				{
					r___0__k = new( ReleactionUtils.GetType("#u.#YVd"), "#k");
		...
		/// <summary>
		/// Void #ft(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__ft_Object___0__7X;
		public virtual RMethod R__0__ft_Object___0__7X
		{
			get
			{
				if(r_R__0__ft_Object___0__7X == null)
				{
					r_R__0__ft_Object___0__7X = new(this, "#ft", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__ft_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__ft_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Boolean #fVl(System.String)
		/// </summary>
		protected RMethod r_R__0__fVl_String;
		public virtual RMethod R__0__fVl_String
		{
			get
			{
				if(r_R__0__fVl_String == null)
				{
					r_R__0__fVl_String = new(this, "#fVl", 0, typeof(System.String));
					r_R__0__fVl_String.SetBelong(this.instance);
				}
				return r_R__0__fVl_String;
			}
		}

		/// <summary>
		/// Boolean #TVd(DAILYEVENT_INFO)
		/// </summary>
		protected RMethod r_R__0__TVd_DAILYEVENT_INFO;
		public virtual RMethod R__0__TVd_DAILYEVENT_INFO
		{
			get
			{
				if(r_R__0__TVd_DAILYEVENT_INFO == null)
				{
					r_R__0__TVd_DAILYEVENT_INFO = new(this, "#TVd", 0, typeof(DAILYEVENT_INFO));
					r_R__0__TVd_DAILYEVENT_INFO.SetBelong(this.instance);
				}
				return r_R__0__TVd_DAILYEVENT_INFO;
			}
		}
		...
		/// Void #UVd()
		/// </summary>
		protected RMethod r_R__0__UVd;
		public virtual RMethod R__0__UVd
		{
			get
			{
				if(r_R__0__UVd == null)
				{
					r_R__0__UVd = new(this, "#UVd", 0);
					r_R__0__UVd.SetBelong(this.instance);
				}
				return r_R__0__UVd;
			}
		}
		...
		/// <summary>
		/// Void #WVd(#Aae, Boolean)
		/// </summary>
		protected RMethod r_R__0__WVd___0__Aae_Boolean;
		public virtual RMethod R__0__WVd___0__Aae_Boolean
		{
			get
			{
				if(r_R__0__WVd___0__Aae_Boolean == null)
				{
					r_R__0__WVd___0__Aae_Boolean = new(this, "#WVd", 0,  ReleactionUtils.GetType("#u.#Vmj+#Aae"), typeof(System.Boolean));
					r_R__0__WVd___0__Aae_Boolean.SetBelong(this.instance);
				}
				return r_R__0__WVd___0__Aae_Boolean;
			}
		}
		...
		/// <summary>
		/// Void #XVd(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__XVd_Object___0__7X;
		public virtual RMethod R__0__XVd_Object___0__7X
		{
			get
			{
				if(r_R__0__XVd_Object___0__7X == null)
				{
					r_R__0__XVd_Object___0__7X = new(this, "#XVd", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__XVd_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__XVd_Object___0__7X;
			}
		}

		/// <summary>
		/// System.String #gVl(DAILYEVENT_INFO)
		/// </summary>
		protected RMethod r_R__0__gVl_DAILYEVENT_INFO;
		public virtual RMethod R__0__gVl_DAILYEVENT_INFO
		{
			get
			{
				if(r_R__0__gVl_DAILYEVENT_INFO == null)
				{
					r_R__0__gVl_DAILYEVENT_INFO = new(this, "#gVl", 0, typeof(DAILYEVENT_INFO));
					r_R__0__gVl_DAILYEVENT_INFO.SetBelong(this.instance);
				}
				return r_R__0__gVl_DAILYEVENT_INFO;
			}
		}
		...
		/// Void #yKk(UInt32)
		/// </summary>
		protected RMethod r_R__0__yKk_UInt32;
		public virtual RMethod R__0__yKk_UInt32
		{
			get
			{
				if(r_R__0__yKk_UInt32 == null)
				{
					r_R__0__yKk_UInt32 = new(this, "#yKk", 0, typeof(System.UInt32));
					r_R__0__yKk_UInt32.SetBelong(this.instance);
				}
				return r_R__0__yKk_UInt32;
			}
		}

		/// <summary>
		/// Int32 #hVl(DAILYEVENT_INFO)
		/// </summary>
		protected RMethod r_R__0__hVl_DAILYEVENT_INFO;
		public virtual RMethod R__0__hVl_DAILYEVENT_INFO
		{
			get
			{
				if(r_R__0__hVl_DAILYEVENT_INFO == null)
				{
					r_R__0__hVl_DAILYEVENT_INFO = new(this, "#hVl", 0, typeof(DAILYEVENT_INFO));
					r_R__0__hVl_DAILYEVENT_INFO.SetBelong(this.instance);
				}
				return r_R__0__hVl_DAILYEVENT_INFO;
			}
		}
        ...
        public R__0__YVd() : base("#u.#YVd")
        {
        }

        public R__0__YVd(System.Object instance) : base("#u.#YVd")
		{
            SetInstance(instance);
		}

        public R__0__YVd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YVd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Boolean __0__fVl(System.String  @showdays)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@showdays};
            var ___result = R__0__fVl_String.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual System.Boolean __0__TVd(DAILYEVENT_INFO  @info)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@info};
            var ___result = R__0__TVd_DAILYEVENT_INFO.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual void __0__UVd()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__UVd.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.String __0__gVl(DAILYEVENT_INFO  @info)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@info};
            var ___result = R__0__gVl_DAILYEVENT_INFO.Invoke(___genericsType, ___parameters);

            return (System.String)___result;
        }


        public virtual void __0__yKk(System.UInt32  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time};
            var ___result = R__0__yKk_UInt32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Int32 __0__hVl(DAILYEVENT_INFO  @info)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@info};
            var ___result = R__0__hVl_DAILYEVENT_INFO.Invoke(___genericsType, ___parameters);

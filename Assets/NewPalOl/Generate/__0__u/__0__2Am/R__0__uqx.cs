...
{public partial class R__0__2Am
{
	...
	/// #u.#2Am+#uqx
	/// </summary>
    public partial class R__0__uqx : RMember //
    {

		/// <summary>
		/// AssetBundleDownloader+AB_DOWNLOADER_ARGS #a
		/// </summary>
		protected RAssetBundleDownloader.RAB_DOWNLOADER_ARGS r___0__a;
		public virtual RAssetBundleDownloader.RAB_DOWNLOADER_ARGS R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #u.#2Am #f
		/// </summary>
		protected R__0__u.R__0__2Am r___0__f;
		public virtual R__0__u.R__0__2Am R__0__f
		{
			get
			{
				if(r___0__f == null)
        ...
        public R__0__uqx() : base("#u.#2Am+#uqx")
        {
        }

        public R__0__uqx(System.Object instance) : base("#u.#2Am+#uqx")
		{
            SetInstance(instance);
		}

        public R__0__uqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__uqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__oIp
{
	...
	/// #u.#oIp+#SKs
	/// </summary>
    public partial class R__0__SKs : RMember //
    {
		...
		/// #u.#oIp #e
		/// </summary>
		protected R__0__u.R__0__oIp r___0__e;
		public virtual R__0__u.R__0__oIp R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__SKs() : base("#u.#oIp+#SKs")
        {
        }

        public R__0__SKs(System.Object instance) : base("#u.#oIp+#SKs")
		{
            SetInstance(instance);
		}

        public R__0__SKs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__SKs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

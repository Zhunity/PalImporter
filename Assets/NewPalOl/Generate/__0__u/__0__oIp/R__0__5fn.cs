...
{public partial class R__0__oIp
{
	
	/// <summary>
	/// #u.#oIp+#5fn
	/// </summary>
    public partial class R__0__5fn : RMember //
    {
        ...
        public R__0__5fn() : base("#u.#oIp+#5fn")
        {
        }

        public R__0__5fn(System.Object instance) : base("#u.#oIp+#5fn")
		{
            SetInstance(instance);
		}

        public R__0__5fn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5fn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

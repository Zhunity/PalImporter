...
{public partial class R__0__fHr
{
	
	/// <summary>
	/// #u.#fHr+#USw
	/// </summary>
    public partial class R__0__USw : RMember //
    {
		...
		/// #u.#fHr #g
		/// </summary>
		protected R__0__u.R__0__fHr r___0__g;
		public virtual R__0__u.R__0__fHr R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__USw() : base("#u.#fHr+#USw")
        {
        }

        public R__0__USw(System.Object instance) : base("#u.#fHr+#USw")
		{
            SetInstance(instance);
		}

        public R__0__USw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__USw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Tmn
	/// </summary>
    public partial class R__0__Tmn : RMember //
    {
        ...
        public R__0__Tmn() : base("#u.#Tmn")
        {
        }

        public R__0__Tmn(System.Object instance) : base("#u.#Tmn")
		{
            SetInstance(instance);
		}

        public R__0__Tmn(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Tmn(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Smn(System.Int32  @dicecount)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@dicecount};

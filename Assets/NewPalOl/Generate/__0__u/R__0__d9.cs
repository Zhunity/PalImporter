...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#d9
	/// </summary>
    public partial class R__0__d9 : RMember //
    {
        ...
        public R__0__d9() : base("#u.#d9")
        {
        }

        public R__0__d9(System.Object instance) : base("#u.#d9")
		{
            SetInstance(instance);
		}

        public R__0__d9(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__d9(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

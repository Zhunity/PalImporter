...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#2vk
	/// </summary>
    public partial class R__0__2vk : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#2vk"), "#a");
		...
		public static RField R__0__b
		{
			get
			{
				if(r___0__b == null)
				{
					r___0__b = new( ReleactionUtils.GetType("#u.#2vk"), "#b");
        ...
        public R__0__2vk() : base("#u.#2vk")
        {
        }

        public R__0__2vk(System.Object instance) : base("#u.#2vk")
		{
            SetInstance(instance);
		}

        public R__0__2vk(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__2vk(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

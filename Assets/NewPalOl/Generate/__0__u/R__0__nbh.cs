...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#nbh
	/// </summary>
    public partial class R__0__nbh : RMember //
    {

		/// <summary>
		/// #oU.#GW #a
		/// </summary>
		protected R__0__oU.R__0__GW r___0__a;
		public virtual R__0__oU.R__0__GW R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #Pfb.#teh #c
		/// </summary>
		protected R__0__Pfb.R__0__teh r___0__c;
		public virtual R__0__Pfb.R__0__teh R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// GameDefineType.ID[] #d
		/// </summary>
		protected RFieldArray<RGameDefineType.RID> r___0__d;
		public virtual RFieldArray<RGameDefineType.RID> R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// <summary>
		/// MyGUI.ElementBase+#1Nb #f
		/// </summary>
		protected static RMyGUI.RElementBase.R__0__1Nb r___0__f;
		public static RMyGUI.RElementBase.R__0__1Nb R__0__f
		{
			get
			{
				if(r___0__f == null)
				{
					r___0__f = new( ReleactionUtils.GetType("#u.#nbh"), "#f");
		...
		/// <summary>
		/// MyGUI.ElementBase+#1Nb #g
		/// </summary>
		protected static RMyGUI.RElementBase.R__0__1Nb r___0__g;
		public static RMyGUI.RElementBase.R__0__1Nb R__0__g
		{
			get
			{
				if(r___0__g == null)
				{
					r___0__g = new( ReleactionUtils.GetType("#u.#nbh"), "#g");
		...
		/// Void #dbh(#Pfb.#teh)
		/// </summary>
		protected RMethod r_R__0__dbh___0__teh;
		public virtual RMethod R__0__dbh___0__teh
		{
			get
			{
				if(r_R__0__dbh___0__teh == null)
				{
					r_R__0__dbh___0__teh = new(this, "#dbh", 0,  ReleactionUtils.GetType("#Pfb.#teh"));
					r_R__0__dbh___0__teh.SetBelong(this.instance);
				}
				return r_R__0__dbh___0__teh;
			}
		}
		...
		/// Void #ebh()
		/// </summary>
		protected RMethod r_R__0__ebh;
		public virtual RMethod R__0__ebh
		{
			get
			{
				if(r_R__0__ebh == null)
				{
					r_R__0__ebh = new(this, "#ebh", 0);
					r_R__0__ebh.SetBelong(this.instance);
				}
				return r_R__0__ebh;
			}
		}
		...
		/// <summary>
		/// Void #fbh(GameDefineType.ID, GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__fbh_ID_ID;
		public virtual RMethod R__0__fbh_ID_ID
		{
			get
			{
				if(r_R__0__fbh_ID_ID == null)
				{
					r_R__0__fbh_ID_ID = new(this, "#fbh", 0, typeof(GameDefineType.ID), typeof(GameDefineType.ID));
					r_R__0__fbh_ID_ID.SetBelong(this.instance);
				}
				return r_R__0__fbh_ID_ID;
			}
		}
		...
		/// <summary>
		/// Void #hbh(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__hbh_Object___0__7X;
		public virtual RMethod R__0__hbh_Object___0__7X
		{
			get
			{
				if(r_R__0__hbh_Object___0__7X == null)
				{
					r_R__0__hbh_Object___0__7X = new(this, "#hbh", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__hbh_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__hbh_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #ibh(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__ibh_Object___0__7X;
		public virtual RMethod R__0__ibh_Object___0__7X
		{
			get
			{
				if(r_R__0__ibh_Object___0__7X == null)
				{
					r_R__0__ibh_Object___0__7X = new(this, "#ibh", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__ibh_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__ibh_Object___0__7X;
			}
		}
		...
		/// Void #jbh()
		/// </summary>
		protected RMethod r_R__0__jbh;
		public virtual RMethod R__0__jbh
		{
			get
			{
				if(r_R__0__jbh == null)
				{
					r_R__0__jbh = new(this, "#jbh", 0);
					r_R__0__jbh.SetBelong(this.instance);
				}
				return r_R__0__jbh;
			}
		}
		...
		/// Void #kbh(#u.#Ckb)
		/// </summary>
		protected RMethod r_R__0__kbh___0__Ckb;
		public virtual RMethod R__0__kbh___0__Ckb
		{
			get
			{
				if(r_R__0__kbh___0__Ckb == null)
				{
					r_R__0__kbh___0__Ckb = new(this, "#kbh", 0,  ReleactionUtils.GetType("#u.#Ckb"));
					r_R__0__kbh___0__Ckb.SetBelong(this.instance);
				}
				return r_R__0__kbh___0__Ckb;
			}
		}

		/// <summary>
		/// Void #4Pu(System.Object, #oU.#7X)
		/// </summary>
		protected static RMethod r_R__0__4Pu_Object___0__7X;
		public static RMethod R__0__4Pu_Object___0__7X
		{
			get
			{
				if(r_R__0__4Pu_Object___0__7X == null)
				{
					r_R__0__4Pu_Object___0__7X = new( ReleactionUtils.GetType("#u.#nbh"), "#4Pu", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__4Pu_Object___0__7X.SetBelong(null);
				}
				return r_R__0__4Pu_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #dex(System.Object, #oU.#7X)
		/// </summary>
		protected static RMethod r_R__0__dex_Object___0__7X;
		public static RMethod R__0__dex_Object___0__7X
		{
			get
			{
				if(r_R__0__dex_Object___0__7X == null)
				{
					r_R__0__dex_Object___0__7X = new( ReleactionUtils.GetType("#u.#nbh"), "#dex", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__dex_Object___0__7X.SetBelong(null);
				}
				return r_R__0__dex_Object___0__7X;
			}
		}
        ...
        public R__0__nbh() : base("#u.#nbh")
        {
        }

        public R__0__nbh(System.Object instance) : base("#u.#nbh")
		{
            SetInstance(instance);
		}

        public R__0__nbh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__nbh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__ebh()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__ebh.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__fbh(GameDefineType.ID  @playerid, GameDefineType.ID  @ringid)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@playerid, @ringid};
            var ___result = R__0__fbh_ID_ID.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__jbh()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__jbh.Invoke(___genericsType, ___parameters);

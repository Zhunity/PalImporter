...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#e9
	/// </summary>
    public partial class R__0__e9 : RMember //
    {
        ...
        public R__0__e9() : base("#u.#e9")
        {
        }

        public R__0__e9(System.Object instance) : base("#u.#e9")
		{
            SetInstance(instance);
		}

        public R__0__e9(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__e9(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

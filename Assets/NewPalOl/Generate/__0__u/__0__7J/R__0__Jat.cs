...
{public partial class R__0__7J
{
	...
	/// #u.#7J+#Jat
	/// </summary>
    public partial class R__0__Jat : RMember //
    {
        ...
        public R__0__Jat() : base("#u.#7J+#Jat")
        {
        }

        public R__0__Jat(System.Object instance) : base("#u.#7J+#Jat")
		{
            SetInstance(instance);
		}

        public R__0__Jat(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Jat(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

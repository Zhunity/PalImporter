...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#nJp
	/// </summary>
    public partial class R__0__nJp : RMember //
    {
		...
		/// Void #lJp()
		/// </summary>
		protected RMethod r_R__0__lJp;
		public virtual RMethod R__0__lJp
		{
			get
			{
				if(r_R__0__lJp == null)
				{
					r_R__0__lJp = new(this, "#lJp", 0);
					r_R__0__lJp.SetBelong(this.instance);
				}
				return r_R__0__lJp;
			}
		}
		...
		/// <summary>
		/// Void #mJp(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__mJp_Object___0__7X;
		public virtual RMethod R__0__mJp_Object___0__7X
		{
			get
			{
				if(r_R__0__mJp_Object___0__7X == null)
				{
					r_R__0__mJp_Object___0__7X = new(this, "#mJp", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__mJp_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__mJp_Object___0__7X;
			}
		}
        ...
        public R__0__nJp() : base("#u.#nJp")
        {
        }

        public R__0__nJp(System.Object instance) : base("#u.#nJp")
		{
            SetInstance(instance);
		}

        public R__0__nJp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__nJp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__lJp()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__lJp.Invoke(___genericsType, ___parameters);

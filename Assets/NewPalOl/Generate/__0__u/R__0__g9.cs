...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#g9
	/// </summary>
    public partial class R__0__g9 : RMember //
    {

		/// <summary>
		/// CombatEvent #a
		/// </summary>
		protected RCombatEvent r___0__a;
		public virtual RCombatEvent R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// Void #f9(System.Object, System.EventArgs)
		/// </summary>
		protected RMethod r_R__0__f9_Object_EventArgs;
		public virtual RMethod R__0__f9_Object_EventArgs
		{
			get
			{
				if(r_R__0__f9_Object_EventArgs == null)
				{
					r_R__0__f9_Object_EventArgs = new(this, "#f9", 0, typeof(System.Object), typeof(System.EventArgs));
					r_R__0__f9_Object_EventArgs.SetBelong(this.instance);
				}
				return r_R__0__f9_Object_EventArgs;
			}
		}
        ...
        public R__0__g9() : base("#u.#g9")
        {
        }

        public R__0__g9(System.Object instance) : base("#u.#g9")
		{
            SetInstance(instance);
		}

        public R__0__g9(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__g9(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }


        public virtual void __0__f9(System.Object  @sender, System.EventArgs  @e)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @e};
            var ___result = R__0__f9_Object_EventArgs.Invoke(___genericsType, ___parameters);

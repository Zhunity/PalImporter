...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#t9
	/// </summary>
    public partial class R__0__t9 : RMember //
    {
        ...
        public R__0__t9() : base("#u.#t9")
        {
        }

        public R__0__t9(System.Object instance) : base("#u.#t9")
		{
            SetInstance(instance);
		}

        public R__0__t9(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__t9(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

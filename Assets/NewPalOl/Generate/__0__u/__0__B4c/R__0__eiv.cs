...
{public partial class R__0__B4c
{
	
	/// <summary>
	/// #u.#B4c+#eiv
	/// </summary>
    public partial class R__0__eiv : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.List`1[#u.#K7] #a
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<R__0__u.R__0__K7> r___0__a;
		public virtual RSystem.RCollections.RGeneric.RList<R__0__u.R__0__K7> R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// <summary>
		/// System.Collections.Generic.Dictionary`2+Enumerator[System.String,System.Collections.Generic.List`1[#u.#K7]] #b
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RField, RField>.REnumerator r___0__b;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RField, RField>.REnumerator R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// <summary>
		/// System.Collections.Generic.KeyValuePair`2[System.String,System.Collections.Generic.List`1[#u.#K7]] #c
		/// </summary>
		protected RSystem.RCollections.RGeneric.RKeyValuePair<RField, RSystem.RCollections.RGeneric.RList<R__0__u.R__0__K7>> r___0__c;
		public virtual RSystem.RCollections.RGeneric.RKeyValuePair<RField, RSystem.RCollections.RGeneric.RList<R__0__u.R__0__K7>> R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// #u.#K7 #f
		/// </summary>
		protected R__0__u.R__0__K7 r___0__f;
		public virtual R__0__u.R__0__K7 R__0__f
		{
			get
			{
				if(r___0__f == null)
		...
		/// ConfigDic #h
		/// </summary>
		protected RConfigDic r___0__h;
		public virtual RConfigDic R__0__h
		{
			get
			{
				if(r___0__h == null)
		...
		/// <summary>
		/// UnityEngine.Object #i
		/// </summary>
		protected RUnityEngine.RObject r___0__i;
		public virtual RUnityEngine.RObject R__0__i
		{
			get
			{
				if(r___0__i == null)
		...
		/// System.Object[] #j
		/// </summary>
		protected RFieldArray<RSystem.RObject> r___0__j;
		public virtual RFieldArray<RSystem.RObject> R__0__j
		{
			get
			{
				if(r___0__j == null)
		...
		/// System.Exception #k
		/// </summary>
		protected RSystem.RException r___0__k;
		public virtual RSystem.RException R__0__k
		{
			get
			{
				if(r___0__k == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1+Enumerator[#u.#K7] #n
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RField>.REnumerator r___0__n;
		public virtual RSystem.RCollections.RGeneric.RList<RField>.REnumerator R__0__n
		{
			get
			{
				if(r___0__n == null)
		...
		/// #u.#K7 #o
		/// </summary>
		protected R__0__u.R__0__K7 r___0__o;
		public virtual R__0__u.R__0__K7 R__0__o
		{
			get
			{
				if(r___0__o == null)
		...
		/// ConfigDic #r
		/// </summary>
		protected RConfigDic r___0__r;
		public virtual RConfigDic R__0__r
		{
			get
			{
				if(r___0__r == null)
		...
		/// #u.#B4c #t
		/// </summary>
		protected R__0__u.R__0__B4c r___0__t;
		public virtual R__0__u.R__0__B4c R__0__t
		{
			get
			{
				if(r___0__t == null)
        ...
        public R__0__eiv() : base("#u.#B4c+#eiv")
        {
        }

        public R__0__eiv(System.Object instance) : base("#u.#B4c+#eiv")
		{
            SetInstance(instance);
		}

        public R__0__eiv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__eiv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

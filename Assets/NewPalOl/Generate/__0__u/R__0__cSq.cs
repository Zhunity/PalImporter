...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#cSq
	/// </summary>
    public partial class R__0__cSq : RMember //
    {
		...
		/// <summary>
		/// Void #bSq(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__bSq_Object___0__7X;
		public virtual RMethod R__0__bSq_Object___0__7X
		{
			get
			{
				if(r_R__0__bSq_Object___0__7X == null)
				{
					r_R__0__bSq_Object___0__7X = new(this, "#bSq", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__bSq_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__bSq_Object___0__7X;
			}
		}
        ...
        public R__0__cSq() : base("#u.#cSq")
        {
        }

        public R__0__cSq(System.Object instance) : base("#u.#cSq")
		{
            SetInstance(instance);
		}

        public R__0__cSq(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__cSq(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

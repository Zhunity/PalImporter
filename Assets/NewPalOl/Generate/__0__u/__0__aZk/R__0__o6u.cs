...
{public partial class R__0__aZk
{
	...
	/// #u.#aZk+#o6u
	/// </summary>
    public partial class R__0__o6u : RMember //
    {
		...
		/// #u.#aZk #e
		/// </summary>
		protected R__0__u.R__0__aZk r___0__e;
		public virtual R__0__u.R__0__aZk R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__o6u() : base("#u.#aZk+#o6u")
        {
        }

        public R__0__o6u(System.Object instance) : base("#u.#aZk+#o6u")
		{
            SetInstance(instance);
		}

        public R__0__o6u(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__o6u(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

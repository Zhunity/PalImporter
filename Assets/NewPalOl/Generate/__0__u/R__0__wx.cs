...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#wx
	/// </summary>
    public partial class R__0__wx : RMember //
    {
        ...
        public R__0__wx() : base("#u.#wx")
        {
        }

        public R__0__wx(System.Object instance) : base("#u.#wx")
		{
            SetInstance(instance);
		}

        public R__0__wx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__wx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

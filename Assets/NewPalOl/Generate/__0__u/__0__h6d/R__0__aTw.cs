...
{public partial class R__0__h6d
{
	
	/// <summary>
	/// #u.#h6d+#aTw
	/// </summary>
    public partial class R__0__aTw : RMember //
    {
		...
		/// #u.#h6d #g
		/// </summary>
		protected R__0__u.R__0__h6d r___0__g;
		public virtual R__0__u.R__0__h6d R__0__g
		{
			get
			{
				if(r___0__g == null)
        ...
        public R__0__aTw() : base("#u.#h6d+#aTw")
        {
        }

        public R__0__aTw(System.Object instance) : base("#u.#h6d+#aTw")
		{
            SetInstance(instance);
		}

        public R__0__aTw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__aTw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

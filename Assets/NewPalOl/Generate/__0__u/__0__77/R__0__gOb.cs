...
{public partial class R__0__77
{
	
	/// <summary>
	/// #u.#77+#gOb
	/// </summary>
    public partial class R__0__gOb : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Object, UITextColorContent)
		/// </summary>
		protected RMethod r_RInvoke_Object_UITextColorContent;
		public virtual RMethod RInvoke_Object_UITextColorContent
		{
			get
			{
				if(r_RInvoke_Object_UITextColorContent == null)
				{
					r_RInvoke_Object_UITextColorContent = new(this, "Invoke", 0, typeof(System.Object),  ReleactionUtils.GetType("UITextColorContent"));
					r_RInvoke_Object_UITextColorContent.SetBelong(this.instance);
				}
				return r_RInvoke_Object_UITextColorContent;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, UITextColorContent, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_Object_UITextColorContent_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Object_UITextColorContent_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Object_UITextColorContent_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Object_UITextColorContent_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object),  ReleactionUtils.GetType("UITextColorContent"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Object_UITextColorContent_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Object_UITextColorContent_AsyncCallback_Object;
			}
		}
        ...
        public R__0__gOb() : base("#u.#77+#gOb")
        {
        }

        public R__0__gOb(System.Object instance) : base("#u.#77+#gOb")
		{
            SetInstance(instance);
		}

        public R__0__gOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#ihj
	/// </summary>
    public partial class R__0__ihj : RMember //
    {
		...
		/// #Pfb.#Pij #c
		/// </summary>
		protected R__0__Pfb.R__0__Pij r___0__c;
		public virtual R__0__Pfb.R__0__Pij R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// Void #sb(#Pfb.#Pij)
		/// </summary>
		protected RMethod r_R__0__sb___0__Pij;
		public virtual RMethod R__0__sb___0__Pij
		{
			get
			{
				if(r_R__0__sb___0__Pij == null)
				{
					r_R__0__sb___0__Pij = new(this, "#sb", 0,  ReleactionUtils.GetType("#Pfb.#Pij"));
					r_R__0__sb___0__Pij.SetBelong(this.instance);
				}
				return r_R__0__sb___0__Pij;
			}
		}
        ...
        public R__0__ihj() : base("#u.#ihj")
        {
        }

        public R__0__ihj(System.Object instance) : base("#u.#ihj")
		{
            SetInstance(instance);
		}

        public R__0__ihj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ihj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

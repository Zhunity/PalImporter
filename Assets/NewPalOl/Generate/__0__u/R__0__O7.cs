...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#O7
	/// </summary>
    public partial class R__0__O7 : RMember //
    {
		...
		/// #u.#QHb #f
		/// </summary>
		protected R__0__u.R__0__QHb r___0__f;
		public virtual R__0__u.R__0__QHb R__0__f
		{
			get
			{
				if(r___0__f == null)
        ...
        public R__0__O7() : base("#u.#O7")
        {
        }

        public R__0__O7(System.Object instance) : base("#u.#O7")
		{
            SetInstance(instance);
		}

        public R__0__O7(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__O7(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

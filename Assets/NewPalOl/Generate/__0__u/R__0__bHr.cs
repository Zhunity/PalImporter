...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#bHr
	/// </summary>
    public partial class R__0__bHr : RMember //
    {
		...
		/// <summary>
		/// Void #1Xv(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__1Xv_Object___0__7X;
		public virtual RMethod R__0__1Xv_Object___0__7X
		{
			get
			{
				if(r_R__0__1Xv_Object___0__7X == null)
				{
					r_R__0__1Xv_Object___0__7X = new(this, "#1Xv", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__1Xv_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__1Xv_Object___0__7X;
			}
		}
        ...
        public R__0__bHr() : base("#u.#bHr")
        {
        }

        public R__0__bHr(System.Object instance) : base("#u.#bHr")
		{
            SetInstance(instance);
		}

        public R__0__bHr(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__bHr(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

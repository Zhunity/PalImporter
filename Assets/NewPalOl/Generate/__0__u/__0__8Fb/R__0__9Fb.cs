...
{public partial class R__0__8Fb
{
	...
	/// #u.#8Fb+#9Fb
	/// </summary>
    public partial class R__0__9Fb : RMember //
    {
        ...
        public R__0__9Fb() : base("#u.#8Fb+#9Fb")
        {
        }

        public R__0__9Fb(System.Object instance) : base("#u.#8Fb+#9Fb")
		{
            SetInstance(instance);
		}

        public R__0__9Fb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9Fb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Co
	/// </summary>
    public partial class R__0__Co : RMember //
    {

		/// <summary>
		/// System.Collections.Generic.Dictionary`2[GameDefineType.ID,#u.#Co+#u6b] #a
		/// </summary>
		protected RSystem.RCollections.RGeneric.RDictionary<RGameDefineType.RID, R__0__u.R__0__Co.R__0__u6b> r___0__a;
		public virtual RSystem.RCollections.RGeneric.RDictionary<RGameDefineType.RID, R__0__u.R__0__Co.R__0__u6b> R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// </summary>
		protected RFieldArray<RUnityEngine.RGUIStyle> r___0__c;
		public virtual RFieldArray<RUnityEngine.RGUIStyle> R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// <summary>
		/// Void #p6b(FamilyEventBase)
		/// </summary>
		protected RMethod r_R__0__p6b_FamilyEventBase;
		public virtual RMethod R__0__p6b_FamilyEventBase
		{
			get
			{
				if(r_R__0__p6b_FamilyEventBase == null)
				{
					r_R__0__p6b_FamilyEventBase = new(this, "#p6b", 0, typeof(FamilyEventBase));
					r_R__0__p6b_FamilyEventBase.SetBelong(this.instance);
				}
				return r_R__0__p6b_FamilyEventBase;
			}
		}
		...
		/// Boolean #r6b()
		/// </summary>
		protected RMethod r_R__0__r6b;
		public virtual RMethod R__0__r6b
		{
			get
			{
				if(r_R__0__r6b == null)
				{
					r_R__0__r6b = new(this, "#r6b", 0);
					r_R__0__r6b.SetBelong(this.instance);
				}
				return r_R__0__r6b;
			}
		}
		...
		/// Void #zo(Boolean)
		/// </summary>
		protected RMethod r_R__0__zo_Boolean;
		public virtual RMethod R__0__zo_Boolean
		{
			get
			{
				if(r_R__0__zo_Boolean == null)
				{
					r_R__0__zo_Boolean = new(this, "#zo", 0, typeof(System.Boolean));
					r_R__0__zo_Boolean.SetBelong(this.instance);
				}
				return r_R__0__zo_Boolean;
			}
		}
        ...
        public R__0__Co() : base("#u.#Co")
        {
        }

        public R__0__Co(System.Object instance) : base("#u.#Co")
		{
            SetInstance(instance);
		}

        public R__0__Co(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Co(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__p6b(FamilyEventBase  @evtDate)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@evtDate};
            var ___result = R__0__p6b_FamilyEventBase.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Boolean __0__r6b()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__r6b.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__zo(System.Boolean  @canGet)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@canGet};
            var ___result = R__0__zo_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Int32 __0__Ao()
        {

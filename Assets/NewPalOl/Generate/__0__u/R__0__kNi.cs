...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#kNi
	/// </summary>
    public partial class R__0__kNi : RMember //
    {
		...
		public static RField R__0__c
		{
			get
			{
				if(r___0__c == null)
				{
					r___0__c = new( ReleactionUtils.GetType("#u.#kNi"), "#c");
		...
		public static RField R__0__f
		{
			get
			{
				if(r___0__f == null)
				{
					r___0__f = new( ReleactionUtils.GetType("#u.#kNi"), "#f");
		...
		public static RField R__0__g
		{
			get
			{
				if(r___0__g == null)
				{
					r___0__g = new( ReleactionUtils.GetType("#u.#kNi"), "#g");
		...
		public static RField R__0__i
		{
			get
			{
				if(r___0__i == null)
				{
					r___0__i = new( ReleactionUtils.GetType("#u.#kNi"), "#i");
		...
		/// Pet #j
		/// </summary>
		protected RPet r___0__j;
		public virtual RPet R__0__j
		{
			get
			{
				if(r___0__j == null)
		...
		/// Pet #k
		/// </summary>
		protected RPet r___0__k;
		public virtual RPet R__0__k
		{
			get
			{
				if(r___0__k == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1[Pet] #m
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RPet> r___0__m;
		public virtual RSystem.RCollections.RGeneric.RList<RPet> R__0__m
		{
			get
			{
				if(r___0__m == null)
		...
		/// #Pfb.#b1f #o
		/// </summary>
		protected R__0__Pfb.R__0__b1f r___0__o;
		public virtual R__0__Pfb.R__0__b1f R__0__o
		{
			get
			{
				if(r___0__o == null)
		...
		/// #Pfb.#b1f #p
		/// </summary>
		protected R__0__Pfb.R__0__b1f r___0__p;
		public virtual R__0__Pfb.R__0__b1f R__0__p
		{
			get
			{
				if(r___0__p == null)
		...
		/// <summary>
		/// Void #eNi(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__eNi_Object___0__7X;
		public virtual RMethod R__0__eNi_Object___0__7X
		{
			get
			{
				if(r_R__0__eNi_Object___0__7X == null)
				{
					r_R__0__eNi_Object___0__7X = new(this, "#eNi", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__eNi_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__eNi_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #fNi(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__fNi_Object___0__7X;
		public virtual RMethod R__0__fNi_Object___0__7X
		{
			get
			{
				if(r_R__0__fNi_Object___0__7X == null)
				{
					r_R__0__fNi_Object___0__7X = new(this, "#fNi", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__fNi_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__fNi_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #gNi(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__gNi_Object___0__7X;
		public virtual RMethod R__0__gNi_Object___0__7X
		{
			get
			{
				if(r_R__0__gNi_Object___0__7X == null)
				{
					r_R__0__gNi_Object___0__7X = new(this, "#gNi", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__gNi_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__gNi_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #hNi(System.Collections.Generic.List`1[Pet])
		/// </summary>
		protected RMethod r_R__0__hNi_List_d_Pet_p_;
		public virtual RMethod R__0__hNi_List_d_Pet_p_
		{
			get
			{
				if(r_R__0__hNi_List_d_Pet_p_ == null)
				{
					r_R__0__hNi_List_d_Pet_p_ = new(this, "#hNi", 0, typeof(System.Collections.Generic.List<>).MakeGenericType( ReleactionUtils.GetType("Pet")));
					r_R__0__hNi_List_d_Pet_p_.SetBelong(this.instance);
				}
				return r_R__0__hNi_List_d_Pet_p_;
			}
		}
		...
		/// <summary>
		/// Void #iNi(Int32, Int32, Int32)
		/// </summary>
		protected RMethod r_R__0__iNi_Int32_Int32_Int32;
		public virtual RMethod R__0__iNi_Int32_Int32_Int32
		{
			get
			{
				if(r_R__0__iNi_Int32_Int32_Int32 == null)
				{
					r_R__0__iNi_Int32_Int32_Int32 = new(this, "#iNi", 0, typeof(System.Int32), typeof(System.Int32), typeof(System.Int32));
					r_R__0__iNi_Int32_Int32_Int32.SetBelong(this.instance);
				}
				return r_R__0__iNi_Int32_Int32_Int32;
			}
		}
		...
		/// Void #jNi(#Pfb.#b1f)
		/// </summary>
		protected RMethod r_R__0__jNi___0__b1f;
		public virtual RMethod R__0__jNi___0__b1f
		{
			get
			{
				if(r_R__0__jNi___0__b1f == null)
				{
					r_R__0__jNi___0__b1f = new(this, "#jNi", 0,  ReleactionUtils.GetType("#Pfb.#b1f"));
					r_R__0__jNi___0__b1f.SetBelong(this.instance);
				}
				return r_R__0__jNi___0__b1f;
			}
		}
        ...
        public R__0__kNi() : base("#u.#kNi")
        {
        }

        public R__0__kNi(System.Object instance) : base("#u.#kNi")
		{
            SetInstance(instance);
		}

        public R__0__kNi(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__kNi(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__iNi(System.Int32  @idx, System.Int32  @myval, System.Int32  @otherval)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@idx, @myval, @otherval};
            var ___result = R__0__iNi_Int32_Int32_Int32.Invoke(___genericsType, ___parameters);

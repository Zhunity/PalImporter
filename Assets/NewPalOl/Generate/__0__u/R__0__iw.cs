...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#iw
	/// </summary>
    public partial class R__0__iw : RMember //
    {
		...
		/// #u.#Ckb #fw()
		/// </summary>
		protected RMethod r_R__0__fw;
		public virtual RMethod R__0__fw
		{
			get
			{
				if(r_R__0__fw == null)
				{
					r_R__0__fw = new(this, "#fw", 0);
					r_R__0__fw.SetBelong(this.instance);
				}
				return r_R__0__fw;
			}
		}
		...
		/// <summary>
		/// Void #GBd(#u.#Ckb, #u.#Fnb)
		/// </summary>
		protected RMethod r_R__0__GBd___0__Ckb___0__Fnb;
		public virtual RMethod R__0__GBd___0__Ckb___0__Fnb
		{
			get
			{
				if(r_R__0__GBd___0__Ckb___0__Fnb == null)
				{
					r_R__0__GBd___0__Ckb___0__Fnb = new(this, "#GBd", 0,  ReleactionUtils.GetType("#u.#Ckb"),  ReleactionUtils.GetType("#u.#Fnb"));
					r_R__0__GBd___0__Ckb___0__Fnb.SetBelong(this.instance);
				}
				return r_R__0__GBd___0__Ckb___0__Fnb;
			}
		}
        ...
        public R__0__iw() : base("#u.#iw")
        {
        }

        public R__0__iw(System.Object instance) : base("#u.#iw")
		{
            SetInstance(instance);
		}

        public R__0__iw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__iw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Object __0__fw()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__fw.Invoke(___genericsType, ___parameters);

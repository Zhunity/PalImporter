...
{public partial class R__0__0vk
{
	
	/// <summary>
	/// #u.#0vk+#vSw
	/// </summary>
    public partial class R__0__vSw : RMember //
    {
		...
		/// #u.#0vk #e
		/// </summary>
		protected R__0__u.R__0__0vk r___0__e;
		public virtual R__0__u.R__0__0vk R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__vSw() : base("#u.#0vk+#vSw")
        {
        }

        public R__0__vSw(System.Object instance) : base("#u.#0vk+#vSw")
		{
            SetInstance(instance);
		}

        public R__0__vSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__vSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

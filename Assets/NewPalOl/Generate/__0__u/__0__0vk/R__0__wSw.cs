...
{public partial class R__0__0vk
{
	...
	/// #u.#0vk+#wSw
	/// </summary>
    public partial class R__0__wSw : RMember //
    {
		...
		/// #u.#0vk #n
		/// </summary>
		protected R__0__u.R__0__0vk r___0__n;
		public virtual R__0__u.R__0__0vk R__0__n
		{
			get
			{
				if(r___0__n == null)
        ...
        public R__0__wSw() : base("#u.#0vk+#wSw")
        {
        }

        public R__0__wSw(System.Object instance) : base("#u.#0vk+#wSw")
		{
            SetInstance(instance);
		}

        public R__0__wSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__wSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__TPv
{
	
	/// <summary>
	/// #u.#TPv+#jOb
	/// </summary>
    public partial class R__0__jOb : RMember //
    {
        ...
        public R__0__jOb() : base("#u.#TPv+#jOb")
        {
        }

        public R__0__jOb(System.Object instance) : base("#u.#TPv+#jOb")
		{
            SetInstance(instance);
		}

        public R__0__jOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__jOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__TPv
{
	...
	/// #u.#TPv+#pSw
	/// </summary>
    public partial class R__0__pSw : RMember //
    {
		...
		/// #u.#TPv #o
		/// </summary>
		protected R__0__u.R__0__TPv r___0__o;
		public virtual R__0__u.R__0__TPv R__0__o
		{
			get
			{
				if(r___0__o == null)
        ...
        public R__0__pSw() : base("#u.#TPv+#pSw")
        {
        }

        public R__0__pSw(System.Object instance) : base("#u.#TPv+#pSw")
		{
            SetInstance(instance);
		}

        public R__0__pSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__pSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

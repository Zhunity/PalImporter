...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#XS
	/// </summary>
    public partial class R__0__XS : RMember //
    {

		/// <summary>
		/// UnityEngine.Texture #a
		/// </summary>
		protected RUnityEngine.RTexture r___0__a;
		public virtual RUnityEngine.RTexture R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #UHb.#VHb #c
		/// </summary>
		protected R__0__UHb.R__0__VHb r___0__c;
		public virtual R__0__UHb.R__0__VHb R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// #u.#XS+#SNb #d
		/// </summary>
		protected R__0__u.R__0__XS.R__0__SNb r___0__d;
		public virtual R__0__u.R__0__XS.R__0__SNb R__0__d
		{
			get
			{
				if(r___0__d == null)
		...
		/// <summary>
		/// Void #sb(Boolean, UnityEngine.Texture, #u.#mLb, #UHb.#VHb)
		/// </summary>
		protected RMethod r_R__0__sb_Boolean_Texture___0__mLb___0__VHb;
		public virtual RMethod R__0__sb_Boolean_Texture___0__mLb___0__VHb
		{
			get
			{
				if(r_R__0__sb_Boolean_Texture___0__mLb___0__VHb == null)
				{
					r_R__0__sb_Boolean_Texture___0__mLb___0__VHb = new(this, "#sb", 0, typeof(System.Boolean), typeof(UnityEngine.Texture),  ReleactionUtils.GetType("#u.#mLb"),  ReleactionUtils.GetType("#UHb.#VHb"));
					r_R__0__sb_Boolean_Texture___0__mLb___0__VHb.SetBelong(this.instance);
				}
				return r_R__0__sb_Boolean_Texture___0__mLb___0__VHb;
			}
		}
		...
		/// Void #VS()
		/// </summary>
		protected RMethod r_R__0__VS;
		public virtual RMethod R__0__VS
		{
			get
			{
				if(r_R__0__VS == null)
				{
					r_R__0__VS = new(this, "#VS", 0);
					r_R__0__VS.SetBelong(this.instance);
				}
				return r_R__0__VS;
			}
		}
		...
		/// Void #Yh()
		/// </summary>
		protected RMethod r_R__0__Yh;
		public virtual RMethod R__0__Yh
		{
			get
			{
				if(r_R__0__Yh == null)
				{
					r_R__0__Yh = new(this, "#Yh", 0);
					r_R__0__Yh.SetBelong(this.instance);
				}
				return r_R__0__Yh;
			}
		}
		...
		/// Void #WS()
		/// </summary>
		protected RMethod r_R__0__WS;
		public virtual RMethod R__0__WS
		{
			get
			{
				if(r_R__0__WS == null)
				{
					r_R__0__WS = new(this, "#WS", 0);
					r_R__0__WS.SetBelong(this.instance);
				}
				return r_R__0__WS;
			}
		}
		...
		/// Void #PS()
		/// </summary>
		protected RMethod r_R__0__PS;
		public virtual RMethod R__0__PS
		{
			get
			{
				if(r_R__0__PS == null)
				{
					r_R__0__PS = new(this, "#PS", 0);
					r_R__0__PS.SetBelong(this.instance);
				}
				return r_R__0__PS;
			}
		}
		...
		/// Void #QS(Int32, Int32)
		/// </summary>
		protected RMethod r_R__0__QS_Int32_Int32;
		public virtual RMethod R__0__QS_Int32_Int32
		{
			get
			{
				if(r_R__0__QS_Int32_Int32 == null)
				{
					r_R__0__QS_Int32_Int32 = new(this, "#QS", 0, typeof(System.Int32), typeof(System.Int32));
					r_R__0__QS_Int32_Int32.SetBelong(this.instance);
				}
				return r_R__0__QS_Int32_Int32;
			}
		}
		...
		/// Void #RS()
		/// </summary>
		protected RMethod r_R__0__RS;
		public virtual RMethod R__0__RS
		{
			get
			{
				if(r_R__0__RS == null)
				{
					r_R__0__RS = new(this, "#RS", 0);
					r_R__0__RS.SetBelong(this.instance);
				}
				return r_R__0__RS;
			}
		}
        ...
        public R__0__XS() : base("#u.#XS")
        {
        }

        public R__0__XS(System.Object instance) : base("#u.#XS")
		{
            SetInstance(instance);
		}

        public R__0__XS(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__XS(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__VS()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__VS.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__Yh()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Yh.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__WS()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__WS.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Int32 __0__OS()
        {
        ...
        public virtual void __0__PS()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__PS.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__QS(System.Int32  @initcount, System.Int32  @maxcount)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@initcount, @maxcount};
            var ___result = R__0__QS_Int32_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__RS()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__RS.Invoke(___genericsType, ___parameters);

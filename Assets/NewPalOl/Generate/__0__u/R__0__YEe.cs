...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#YEe
	/// </summary>
    public partial class R__0__YEe : RMember //
    {
		...
		/// Void #Tcg(Boolean)
		/// </summary>
		protected RMethod r_R__0__Tcg_Boolean;
		public virtual RMethod R__0__Tcg_Boolean
		{
			get
			{
				if(r_R__0__Tcg_Boolean == null)
				{
					r_R__0__Tcg_Boolean = new(this, "#Tcg", 0, typeof(System.Boolean));
					r_R__0__Tcg_Boolean.SetBelong(this.instance);
				}
				return r_R__0__Tcg_Boolean;
			}
		}
		...
		/// <summary>
		/// Void #XEe(#u.#8Rc, MyGUI.ElementBase, Int32)
		/// </summary>
		protected RMethod r_R__0__XEe___0__8Rc_ElementBase_Int32;
		public virtual RMethod R__0__XEe___0__8Rc_ElementBase_Int32
		{
			get
			{
				if(r_R__0__XEe___0__8Rc_ElementBase_Int32 == null)
				{
					r_R__0__XEe___0__8Rc_ElementBase_Int32 = new(this, "#XEe", 0,  ReleactionUtils.GetType("#u.#8Rc"), typeof(MyGUI.ElementBase), typeof(System.Int32));
					r_R__0__XEe___0__8Rc_ElementBase_Int32.SetBelong(this.instance);
				}
				return r_R__0__XEe___0__8Rc_ElementBase_Int32;
			}
		}
        ...
        public R__0__YEe() : base("#u.#YEe")
        {
        }

        public R__0__YEe(System.Object instance) : base("#u.#YEe")
		{
            SetInstance(instance);
		}

        public R__0__YEe(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YEe(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Tcg(System.Boolean  @bShow)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bShow};
            var ___result = R__0__Tcg_Boolean.Invoke(___genericsType, ___parameters);

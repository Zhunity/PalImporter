...
{public partial class R__0__Quc
{
	...
	/// #u.#Quc+#hHc
	/// </summary>
    public partial class R__0__hHc : RMember //
    {
        ...
        public R__0__hHc() : base("#u.#Quc+#hHc")
        {
        }

        public R__0__hHc(System.Object instance) : base("#u.#Quc+#hHc")
		{
            SetInstance(instance);
		}

        public R__0__hHc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__hHc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

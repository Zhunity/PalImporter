...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#zag
	/// </summary>
    public partial class R__0__zag : RMember //
    {
		...
		/// Void #mk(#Pfb.#wjg)
		/// </summary>
		protected RMethod r_R__0__mk___0__wjg;
		public virtual RMethod R__0__mk___0__wjg
		{
			get
			{
				if(r_R__0__mk___0__wjg == null)
				{
					r_R__0__mk___0__wjg = new(this, "#mk", 0,  ReleactionUtils.GetType("#Pfb.#wjg"));
					r_R__0__mk___0__wjg.SetBelong(this.instance);
				}
				return r_R__0__mk___0__wjg;
			}
		}
        ...
        public R__0__zag() : base("#u.#zag")
        {
        }

        public R__0__zag(System.Object instance) : base("#u.#zag")
		{
            SetInstance(instance);
		}

        public R__0__zag(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zag(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

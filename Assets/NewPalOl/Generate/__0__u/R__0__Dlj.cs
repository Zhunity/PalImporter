...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Dlj
	/// </summary>
    public partial class R__0__Dlj : RMember //
    {
		...
		/// <summary>
		/// Void #Alj(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__Alj_Object___0__7X;
		public virtual RMethod R__0__Alj_Object___0__7X
		{
			get
			{
				if(r_R__0__Alj_Object___0__7X == null)
				{
					r_R__0__Alj_Object___0__7X = new(this, "#Alj", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__Alj_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__Alj_Object___0__7X;
			}
		}
		...
		/// Void #Blj(#u.#Ckb)
		/// </summary>
		protected RMethod r_R__0__Blj___0__Ckb;
		public virtual RMethod R__0__Blj___0__Ckb
		{
			get
			{
				if(r_R__0__Blj___0__Ckb == null)
				{
					r_R__0__Blj___0__Ckb = new(this, "#Blj", 0,  ReleactionUtils.GetType("#u.#Ckb"));
					r_R__0__Blj___0__Ckb.SetBelong(this.instance);
				}
				return r_R__0__Blj___0__Ckb;
			}
		}
		...
		/// Void #Clj()
		/// </summary>
		protected RMethod r_R__0__Clj;
		public virtual RMethod R__0__Clj
		{
			get
			{
				if(r_R__0__Clj == null)
				{
					r_R__0__Clj = new(this, "#Clj", 0);
					r_R__0__Clj.SetBelong(this.instance);
				}
				return r_R__0__Clj;
			}
		}
        ...
        public R__0__Dlj() : base("#u.#Dlj")
        {
        }

        public R__0__Dlj(System.Object instance) : base("#u.#Dlj")
		{
            SetInstance(instance);
		}

        public R__0__Dlj(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Dlj(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Clj()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__Clj.Invoke(___genericsType, ___parameters);

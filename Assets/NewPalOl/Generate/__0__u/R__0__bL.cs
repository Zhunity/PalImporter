...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#bL
	/// </summary>
    public partial class R__0__bL : RMember //
    {
		...
		/// <summary>
		/// Void #sb(Boolean, Int32)
		/// </summary>
		protected RMethod r_R__0__sb_Boolean_Int32;
		public virtual RMethod R__0__sb_Boolean_Int32
		{
			get
			{
				if(r_R__0__sb_Boolean_Int32 == null)
				{
					r_R__0__sb_Boolean_Int32 = new(this, "#sb", 0, typeof(System.Boolean), typeof(System.Int32));
					r_R__0__sb_Boolean_Int32.SetBelong(this.instance);
				}
				return r_R__0__sb_Boolean_Int32;
			}
		}
        ...
        public R__0__bL() : base("#u.#bL")
        {
        }

        public R__0__bL(System.Object instance) : base("#u.#bL")
		{
            SetInstance(instance);
		}

        public R__0__bL(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__bL(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__Xd(System.Int32  @LvID)
        {
        ...
        public virtual void __0__sb(System.Boolean  @show, System.Int32  @lvlID)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@show, @lvlID};
            var ___result = R__0__sb_Boolean_Int32.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#8Eo
	/// </summary>
    public partial class R__0__8Eo : RMember //
    {
		...
		/// <summary>
		/// Void #mk(Int32, Boolean)
		/// </summary>
		protected RMethod r_R__0__mk_Int32_Boolean;
		public virtual RMethod R__0__mk_Int32_Boolean
		{
			get
			{
				if(r_R__0__mk_Int32_Boolean == null)
				{
					r_R__0__mk_Int32_Boolean = new(this, "#mk", 0, typeof(System.Int32), typeof(System.Boolean));
					r_R__0__mk_Int32_Boolean.SetBelong(this.instance);
				}
				return r_R__0__mk_Int32_Boolean;
			}
		}
        ...
        public R__0__8Eo() : base("#u.#8Eo")
        {
        }

        public R__0__8Eo(System.Object instance) : base("#u.#8Eo")
		{
            SetInstance(instance);
		}

        public R__0__8Eo(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__8Eo(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__mk(System.Int32  @id, System.Boolean  @canGetReward)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id, @canGetReward};
            var ___result = R__0__mk_Int32_Boolean.Invoke(___genericsType, ___parameters);

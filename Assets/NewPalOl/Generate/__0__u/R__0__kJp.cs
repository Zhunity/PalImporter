...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#kJp
	/// </summary>
    public partial class R__0__kJp : RMember //
    {
		...
		/// <summary>
		/// Void #jJp(System.String)
		/// </summary>
		protected RMethod r_R__0__jJp_String;
		public virtual RMethod R__0__jJp_String
		{
			get
			{
				if(r_R__0__jJp_String == null)
				{
					r_R__0__jJp_String = new(this, "#jJp", 0, typeof(System.String));
					r_R__0__jJp_String.SetBelong(this.instance);
				}
				return r_R__0__jJp_String;
			}
		}
        ...
        public R__0__kJp() : base("#u.#kJp")
        {
        }

        public R__0__kJp(System.Object instance) : base("#u.#kJp")
		{
            SetInstance(instance);
		}

        public R__0__kJp(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__kJp(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__jJp(System.String  @info)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@info};
            var ___result = R__0__jJp_String.Invoke(___genericsType, ___parameters);

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#aNs
	/// </summary>
    public partial class R__0__aNs : RMember //
    {
		...
		/// Void #Kb(#Pfb.#lOs)
		/// </summary>
		protected RMethod r_R__0__Kb___0__lOs;
		public virtual RMethod R__0__Kb___0__lOs
		{
			get
			{
				if(r_R__0__Kb___0__lOs == null)
				{
					r_R__0__Kb___0__lOs = new(this, "#Kb", 0,  ReleactionUtils.GetType("#Pfb.#lOs"));
					r_R__0__Kb___0__lOs.SetBelong(this.instance);
				}
				return r_R__0__Kb___0__lOs;
			}
		}
		...
		/// Void #R2s(Boolean)
		/// </summary>
		protected RMethod r_R__0__R2s_Boolean;
		public virtual RMethod R__0__R2s_Boolean
		{
			get
			{
				if(r_R__0__R2s_Boolean == null)
				{
					r_R__0__R2s_Boolean = new(this, "#R2s", 0, typeof(System.Boolean));
					r_R__0__R2s_Boolean.SetBelong(this.instance);
				}
				return r_R__0__R2s_Boolean;
			}
		}
        ...
        public R__0__aNs() : base("#u.#aNs")
        {
        }

        public R__0__aNs(System.Object instance) : base("#u.#aNs")
		{
            SetInstance(instance);
		}

        public R__0__aNs(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__aNs(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__R2s(System.Boolean  @bEnable)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@bEnable};
            var ___result = R__0__R2s_Boolean.Invoke(___genericsType, ___parameters);

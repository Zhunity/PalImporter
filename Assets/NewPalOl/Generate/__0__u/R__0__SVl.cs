...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#SVl
	/// </summary>
    public partial class R__0__SVl : RMember //
    {
		...
		/// Void #RVl(Int32)
		/// </summary>
		protected RMethod r_R__0__RVl_Int32;
		public virtual RMethod R__0__RVl_Int32
		{
			get
			{
				if(r_R__0__RVl_Int32 == null)
				{
					r_R__0__RVl_Int32 = new(this, "#RVl", 0, typeof(System.Int32));
					r_R__0__RVl_Int32.SetBelong(this.instance);
				}
				return r_R__0__RVl_Int32;
			}
		}
        ...
        public R__0__SVl() : base("#u.#SVl")
        {
        }

        public R__0__SVl(System.Object instance) : base("#u.#SVl")
		{
            SetInstance(instance);
		}

        public R__0__SVl(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__SVl(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__RVl(System.Int32  @day)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@day};
            var ___result = R__0__RVl_Int32.Invoke(___genericsType, ___parameters);

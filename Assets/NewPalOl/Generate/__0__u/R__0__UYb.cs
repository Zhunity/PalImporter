...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#UYb
	/// </summary>
    public partial class R__0__UYb : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#UYb"), "#a");
        ...
        public R__0__UYb() : base("#u.#UYb")
        {
        }

        public R__0__UYb(System.Object instance) : base("#u.#UYb")
		{
            SetInstance(instance);
		}

        public R__0__UYb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__UYb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__6hd
{
	
	/// <summary>
	/// #u.#6hd+#fYw
	/// </summary>
    public partial class R__0__fYw : RMember //
    {
		...
		/// #Pfb.#sBb #b
		/// </summary>
		protected R__0__Pfb.R__0__sBb r___0__b;
		public virtual R__0__Pfb.R__0__sBb R__0__b
		{
			get
			{
				if(r___0__b == null)
		...
		/// NPCBehav #c
		/// </summary>
		protected RNPCBehav r___0__c;
		public virtual RNPCBehav R__0__c
		{
			get
			{
				if(r___0__c == null)
		...
		/// #Pfb.#sBb #g
		/// </summary>
		protected R__0__Pfb.R__0__sBb r___0__g;
		public virtual R__0__Pfb.R__0__sBb R__0__g
		{
			get
			{
				if(r___0__g == null)
		...
		/// #u.#6hd #i
		/// </summary>
		protected R__0__u.R__0__6hd r___0__i;
		public virtual R__0__u.R__0__6hd R__0__i
		{
			get
			{
				if(r___0__i == null)
        ...
        public R__0__fYw() : base("#u.#6hd+#fYw")
        {
        }

        public R__0__fYw(System.Object instance) : base("#u.#6hd+#fYw")
		{
            SetInstance(instance);
		}

        public R__0__fYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__fYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

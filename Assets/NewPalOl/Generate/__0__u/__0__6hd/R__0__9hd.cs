...
{public partial class R__0__6hd
{
	...
	/// #u.#6hd+#9hd
	/// </summary>
    public partial class R__0__9hd : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.List`1[UnityEngine.Vector3] #i
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RVector3> r___0__i;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RVector3> R__0__i
		{
			get
			{
				if(r___0__i == null)
		...
		/// <summary>
		/// System.Collections.Generic.List`1[System.Single] #j
		/// </summary>
        ...
        public R__0__9hd() : base("#u.#6hd+#9hd")
        {
        }

        public R__0__9hd(System.Object instance) : base("#u.#6hd+#9hd")
		{
            SetInstance(instance);
		}

        public R__0__9hd(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__9hd(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

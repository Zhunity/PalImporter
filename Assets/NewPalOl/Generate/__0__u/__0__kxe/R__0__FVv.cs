...
{public partial class R__0__kxe
{
	
	/// <summary>
	/// #u.#kxe+#FVv
	/// </summary>
    public partial class R__0__FVv : RMember //
    {
		...
		/// #u.#kxe #d
		/// </summary>
		protected R__0__u.R__0__kxe r___0__d;
		public virtual R__0__u.R__0__kxe R__0__d
		{
			get
			{
				if(r___0__d == null)
        ...
        public R__0__FVv() : base("#u.#kxe+#FVv")
        {
        }

        public R__0__FVv(System.Object instance) : base("#u.#kxe+#FVv")
		{
            SetInstance(instance);
		}

        public R__0__FVv(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__FVv(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

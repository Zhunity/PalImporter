...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#N2d
	/// </summary>
    public partial class R__0__N2d : RMember //
    {
		...
		public static RSystem.RCollections.RGeneric.RDictionary<RField, RField> R__0__i
		{
			get
			{
				if(r___0__i == null)
				{
					r___0__i = new( ReleactionUtils.GetType("#u.#N2d"), "#i");
		...
		/// <summary>
		/// Void #bhj(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__bhj_Object___0__7X;
		public virtual RMethod R__0__bhj_Object___0__7X
		{
			get
			{
				if(r_R__0__bhj_Object___0__7X == null)
				{
					r_R__0__bhj_Object___0__7X = new(this, "#bhj", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__bhj_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__bhj_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #H2d(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__H2d_Object___0__7X;
		public virtual RMethod R__0__H2d_Object___0__7X
		{
			get
			{
				if(r_R__0__H2d_Object___0__7X == null)
				{
					r_R__0__H2d_Object___0__7X = new(this, "#H2d", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__H2d_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__H2d_Object___0__7X;
			}
		}

		/// <summary>
		/// Void #kGg(System.Object)
		/// </summary>
		protected RMethod r_R__0__kGg_Object;
		public virtual RMethod R__0__kGg_Object
		{
			get
			{
				if(r_R__0__kGg_Object == null)
				{
					r_R__0__kGg_Object = new(this, "#kGg", 0, typeof(System.Object));
					r_R__0__kGg_Object.SetBelong(this.instance);
				}
				return r_R__0__kGg_Object;
			}
		}

		/// <summary>
		/// Void #I2d(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__I2d_Object___0__7X;
		public virtual RMethod R__0__I2d_Object___0__7X
		{
			get
			{
				if(r_R__0__I2d_Object___0__7X == null)
				{
					r_R__0__I2d_Object___0__7X = new(this, "#I2d", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__I2d_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__I2d_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #K2d(System.Object, #oU.#7X)
		/// </summary>
		protected RMethod r_R__0__K2d_Object___0__7X;
		public virtual RMethod R__0__K2d_Object___0__7X
		{
			get
			{
				if(r_R__0__K2d_Object___0__7X == null)
				{
					r_R__0__K2d_Object___0__7X = new(this, "#K2d", 0, typeof(System.Object),  ReleactionUtils.GetType("#oU.#7X"));
					r_R__0__K2d_Object___0__7X.SetBelong(this.instance);
				}
				return r_R__0__K2d_Object___0__7X;
			}
		}
		...
		/// <summary>
		/// Void #sb(ITEM_SUBTYPE)
		/// </summary>
		protected RMethod r_R__0__sb_ITEM_SUBTYPE;
		public virtual RMethod R__0__sb_ITEM_SUBTYPE
		{
			get
			{
				if(r_R__0__sb_ITEM_SUBTYPE == null)
				{
					r_R__0__sb_ITEM_SUBTYPE = new(this, "#sb", 0,  ReleactionUtils.GetType("ItemType+ITEM_SUBTYPE"));
					r_R__0__sb_ITEM_SUBTYPE.SetBelong(this.instance);
				}
				return r_R__0__sb_ITEM_SUBTYPE;
			}
		}

		/// <summary>
		/// Void #sb(GameDefineType.ID, GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__sb_ID_ID;
		public virtual RMethod R__0__sb_ID_ID
		{
			get
			{
				if(r_R__0__sb_ID_ID == null)
				{
					r_R__0__sb_ID_ID = new(this, "#sb", 0, typeof(GameDefineType.ID), typeof(GameDefineType.ID));
					r_R__0__sb_ID_ID.SetBelong(this.instance);
				}
				return r_R__0__sb_ID_ID;
			}
		}
		...
		/// <summary>
		/// Void #L2d(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__L2d_ID;
		public virtual RMethod R__0__L2d_ID
		{
			get
			{
				if(r_R__0__L2d_ID == null)
				{
					r_R__0__L2d_ID = new(this, "#L2d", 0, typeof(GameDefineType.ID));
					r_R__0__L2d_ID.SetBelong(this.instance);
				}
				return r_R__0__L2d_ID;
			}
		}
		...
		/// Void #N1d(Int32)
		/// </summary>
		protected RMethod r_R__0__N1d_Int32;
		public virtual RMethod R__0__N1d_Int32
		{
			get
			{
				if(r_R__0__N1d_Int32 == null)
				{
					r_R__0__N1d_Int32 = new(this, "#N1d", 0, typeof(System.Int32));
					r_R__0__N1d_Int32.SetBelong(this.instance);
				}
				return r_R__0__N1d_Int32;
			}
		}

		/// <summary>
		/// System.String GetRareName(System.String)
		/// </summary>
		protected RMethod r_RGetRareName_String;
		public virtual RMethod RGetRareName_String
		{
			get
			{
				if(r_RGetRareName_String == null)
				{
					r_RGetRareName_String = new(this, "GetRareName", 0, typeof(System.String));
					r_RGetRareName_String.SetBelong(this.instance);
				}
				return r_RGetRareName_String;
			}
		}
		...
		/// <summary>
		/// Void #chj(GameDefineType.ID)
		/// </summary>
		protected RMethod r_R__0__chj_ID;
		public virtual RMethod R__0__chj_ID
		{
			get
			{
				if(r_R__0__chj_ID == null)
				{
					r_R__0__chj_ID = new(this, "#chj", 0, typeof(GameDefineType.ID));
					r_R__0__chj_ID.SetBelong(this.instance);
				}
				return r_R__0__chj_ID;
			}
		}
		...
		/// Void #M2d()
		/// </summary>
		protected RMethod r_R__0__M2d;
		public virtual RMethod R__0__M2d
		{
			get
			{
				if(r_R__0__M2d == null)
				{
					r_R__0__M2d = new(this, "#M2d", 0);
					r_R__0__M2d.SetBelong(this.instance);
				}
				return r_R__0__M2d;
			}
		}
        ...
        public R__0__N2d() : base("#u.#N2d")
        {
        }

        public R__0__N2d(System.Object instance) : base("#u.#N2d")
		{
            SetInstance(instance);
		}

        public R__0__N2d(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__N2d(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void __0__kGg(System.Object  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@data};
            var ___result = R__0__kGg_Object.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__sb(GameDefineType.ID  @id, GameDefineType.ID  @itemId)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@id, @itemId};
            var ___result = R__0__sb_ID_ID.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__L2d(GameDefineType.ID  @itemId)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@itemId};
            var ___result = R__0__L2d_ID.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__N1d(System.Int32  @time)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@time};
            var ___result = R__0__N1d_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.String GetRareName(System.String  @rare)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@rare};
            var ___result = RGetRareName_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual void __0__chj(GameDefineType.ID  @itemId)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@itemId};
            var ___result = R__0__chj_ID.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0__M2d()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = R__0__M2d.Invoke(___genericsType, ___parameters);

...
{public partial class R__0__snk
{
	
	/// <summary>
	/// #u.#snk+#ahu
	/// </summary>
    public partial class R__0__ahu : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RTransform r___0__m;
		public virtual RUnityEngine.RTransform R__0__m
		{
			get
			{
				if(r___0__m == null)
		...
		/// #u.#snk #r
		/// </summary>
		protected R__0__u.R__0__snk r___0__r;
		public virtual R__0__u.R__0__snk R__0__r
		{
			get
			{
				if(r___0__r == null)
        ...
        public R__0__ahu() : base("#u.#snk+#ahu")
        {
        }

        public R__0__ahu(System.Object instance) : base("#u.#snk+#ahu")
		{
            SetInstance(instance);
		}

        public R__0__ahu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__ahu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

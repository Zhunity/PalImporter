...
{public partial class R__0__XYv
{
	
	/// <summary>
	/// #u.#XYv+#pqx
	/// </summary>
    public partial class R__0__pqx : RMember //
    {
		...
		/// #u.#XYv #o
		/// </summary>
		protected R__0__u.R__0__XYv r___0__o;
		public virtual R__0__u.R__0__XYv R__0__o
		{
			get
			{
				if(r___0__o == null)
        ...
        public R__0__pqx() : base("#u.#XYv+#pqx")
        {
        }

        public R__0__pqx(System.Object instance) : base("#u.#XYv+#pqx")
		{
            SetInstance(instance);
		}

        public R__0__pqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__pqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction.R__0__u
{
	...
	/// #u.#Vah
	/// </summary>
    public partial class R__0__Vah : RMember //
    {
		...
		public static RField R__0__a
		{
			get
			{
				if(r___0__a == null)
				{
					r___0__a = new( ReleactionUtils.GetType("#u.#Vah"), "#a");
        ...
        public R__0__Vah() : base("#u.#Vah")
        {
        }

        public R__0__Vah(System.Object instance) : base("#u.#Vah")
		{
            SetInstance(instance);
		}

        public R__0__Vah(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__Vah(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__pZd
{
	...
	/// #u.#pZd+#YKc
	/// </summary>
    public partial class R__0__YKc : RMember //
    {
        ...
        public R__0__YKc() : base("#u.#pZd+#YKc")
        {
        }

        public R__0__YKc(System.Object instance) : base("#u.#pZd+#YKc")
		{
            SetInstance(instance);
		}

        public R__0__YKc(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__YKc(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

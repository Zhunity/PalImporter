...
{public partial class R__0__pZd
{
	...
	/// #u.#pZd+#gqx
	/// </summary>
    public partial class R__0__gqx : RMember //
    {
		...
		/// #u.#pZd #e
		/// </summary>
		protected R__0__u.R__0__pZd r___0__e;
		public virtual R__0__u.R__0__pZd R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__gqx() : base("#u.#pZd+#gqx")
        {
        }

        public R__0__gqx(System.Object instance) : base("#u.#pZd+#gqx")
		{
            SetInstance(instance);
		}

        public R__0__gqx(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__gqx(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

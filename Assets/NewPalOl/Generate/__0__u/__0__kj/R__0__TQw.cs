...
{public partial class R__0__kj
{
	
	/// <summary>
	/// #u.#kj+#TQw
	/// </summary>
    public partial class R__0__TQw : RMember //
    {

		/// <summary>
		/// #Pfb.#ipb #a
		/// </summary>
		protected R__0__Pfb.R__0__ipb r___0__a;
		public virtual R__0__Pfb.R__0__ipb R__0__a
		{
			get
			{
				if(r___0__a == null)
		...
		/// #u.#kj #e
		/// </summary>
		protected R__0__u.R__0__kj r___0__e;
		public virtual R__0__u.R__0__kj R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__TQw() : base("#u.#kj+#TQw")
        {
        }

        public R__0__TQw(System.Object instance) : base("#u.#kj+#TQw")
		{
            SetInstance(instance);
		}

        public R__0__TQw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__TQw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

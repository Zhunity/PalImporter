...
{public partial class R__0__LH
{
	...
	/// #u.#LH+#rSw
	/// </summary>
    public partial class R__0__rSw : RMember //
    {
		...
		/// <summary>
		/// System.Collections.Generic.List`1+Enumerator[#oU.#5bb] #c
		/// </summary>
        ...
        public R__0__rSw() : base("#u.#LH+#rSw")
        {
        }

        public R__0__rSw(System.Object instance) : base("#u.#LH+#rSw")
		{
            SetInstance(instance);
		}

        public R__0__rSw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__rSw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class R__0__sS
{
	
	/// <summary>
	/// #u.#sS+#RNb
	/// </summary>
    public partial class R__0__RNb : RMember //
    {
        ...
        public R__0__RNb() : base("#u.#sS+#RNb")
        {
        }

        public R__0__RNb(System.Object instance) : base("#u.#sS+#RNb")
		{
            SetInstance(instance);
		}

        public R__0__RNb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__RNb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.String  @text, System.Object  @data)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text, @data};
        ...
        public virtual System.IAsyncResult BeginInvoke(System.String  @text, System.Object  @data, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@text, @data, @callback, @object};

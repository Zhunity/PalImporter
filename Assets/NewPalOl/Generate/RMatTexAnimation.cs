...
namespace SMFrame.Editor.Refleaction
{
	...
	/// MatTexAnimation
	/// </summary>
    public partial class RMatTexAnimation : RMember //
    {

		/// <summary>
		/// UnityEngine.Renderer TargetRenderer
		/// </summary>
		protected RUnityEngine.RRenderer r_TargetRenderer;
		public virtual RUnityEngine.RRenderer RTargetRenderer
		{
			get
			{
				if(r_TargetRenderer == null)
				{
					r_TargetRenderer = new(this, "TargetRenderer");
					r_TargetRenderer.SetBelong(this.instance);
				}
				return r_TargetRenderer;
			}
		}

		/// <summary>
		/// UnityEngine.Material TargetMat
		/// </summary>
		protected RUnityEngine.RMaterial r_TargetMat;
		public virtual RUnityEngine.RMaterial RTargetMat
		{
			get
			{
				if(r_TargetMat == null)
				{
					r_TargetMat = new(this, "TargetMat");
					r_TargetMat.SetBelong(this.instance);
				}
				return r_TargetMat;
			}
		}
		...
		/// <summary>
		/// System.String TargetTextureName
		/// </summary>
		protected RField r_TargetTextureName;
		public virtual RField RTargetTextureName
		{
			get
			{
				if(r_TargetTextureName == null)
				{
					r_TargetTextureName = new(this, "TargetTextureName");
					r_TargetTextureName.SetBelong(this.instance);
				}
				return r_TargetTextureName;
			}
		}

		/// <summary>
		/// UnityEngine.Texture[] AnimationTexs
		/// </summary>
		protected RFieldArray<RUnityEngine.RTexture> r_AnimationTexs;
		public virtual RFieldArray<RUnityEngine.RTexture> RAnimationTexs
		{
			get
			{
				if(r_AnimationTexs == null)
				{
					r_AnimationTexs = new(this, "AnimationTexs");
					r_AnimationTexs.SetBelong(this.instance);
				}
				return r_AnimationTexs;
			}
		}
		...
		/// </summary>
		protected RField r_frameTime;
		public virtual RField RframeTime
		{
			get
			{
				if(r_frameTime == null)
				{
					r_frameTime = new(this, "frameTime");
					r_frameTime.SetBelong(this.instance);
				}
				return r_frameTime;
			}
		}
		...
		/// </summary>
		protected RField r_bLoop;
		public virtual RField RbLoop
		{
			get
			{
				if(r_bLoop == null)
				{
					r_bLoop = new(this, "bLoop");
					r_bLoop.SetBelong(this.instance);
				}
				return r_bLoop;
			}
		}
		...
		/// </summary>
		protected RField r_lastChangeTime;
		public virtual RField RlastChangeTime
		{
			get
			{
				if(r_lastChangeTime == null)
				{
					r_lastChangeTime = new(this, "lastChangeTime");
					r_lastChangeTime.SetBelong(this.instance);
				}
		...
		/// Void BeginAnimation()
		/// </summary>
		protected RMethod r_RBeginAnimation;
		public virtual RMethod RBeginAnimation
		{
			get
			{
				if(r_RBeginAnimation == null)
				{
					r_RBeginAnimation = new(this, "BeginAnimation", 0);
					r_RBeginAnimation.SetBelong(this.instance);
				}
				return r_RBeginAnimation;
			}
		}
		...
		/// Void PauseAnimation()
		/// </summary>
		protected RMethod r_RPauseAnimation;
		public virtual RMethod RPauseAnimation
		{
			get
			{
				if(r_RPauseAnimation == null)
				{
					r_RPauseAnimation = new(this, "PauseAnimation", 0);
					r_RPauseAnimation.SetBelong(this.instance);
				}
				return r_RPauseAnimation;
			}
		}
		...
		/// </summary>
		protected RMethod r_RContinueAnimation;
		public virtual RMethod RContinueAnimation
		{
			get
			{
				if(r_RContinueAnimation == null)
				{
					r_RContinueAnimation = new(this, "ContinueAnimation", 0);
					r_RContinueAnimation.SetBelong(this.instance);
				}
				return r_RContinueAnimation;
			}
		}
        ...
        public RMatTexAnimation() : base("MatTexAnimation")
        {
        }

        public RMatTexAnimation(System.Object instance) : base("MatTexAnimation")
		{
            SetInstance(instance);
		}

        public RMatTexAnimation(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMatTexAnimation(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void BeginAnimation()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RBeginAnimation.Invoke(___genericsType, ___parameters);
        ...
        public virtual void PauseAnimation()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RPauseAnimation.Invoke(___genericsType, ___parameters);
        ...
        public virtual void ContinueAnimation()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RContinueAnimation.Invoke(___genericsType, ___parameters);

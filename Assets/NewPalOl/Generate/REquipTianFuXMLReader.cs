...
{
	/// <summary>
	/// EquipTianFuXMLReader
	/// </summary>
    public partial class REquipTianFuXMLReader : RMember //
    {
        ...
        public REquipTianFuXMLReader() : base("EquipTianFuXMLReader")
        {
        }

        public REquipTianFuXMLReader(System.Object instance) : base("EquipTianFuXMLReader")
		{
            SetInstance(instance);
		}

        public REquipTianFuXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REquipTianFuXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

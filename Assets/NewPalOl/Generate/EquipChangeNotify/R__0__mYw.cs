...
{public partial class REquipChangeNotify
{
	...
	/// <summary>
	/// EquipChangeNotify+#mYw
	/// </summary>
    public partial class R__0__mYw : RMember //
    {
        ...
        public R__0__mYw() : base("EquipChangeNotify+#mYw")
        {
        }

        public R__0__mYw(System.Object instance) : base("EquipChangeNotify+#mYw")
		{
            SetInstance(instance);
		}

        public R__0__mYw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__mYw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

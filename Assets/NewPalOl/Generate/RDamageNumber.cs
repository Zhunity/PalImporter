...
namespace SMFrame.Editor.Refleaction
{
	...
	/// DamageNumber
	/// </summary>
    public partial class RDamageNumber : RMember //
    {

		/// <summary>
		/// System.Int32 numberTile
		/// </summary>
		protected RField r_numberTile;
		public virtual RField RnumberTile
		{
			get
			{
				if(r_numberTile == null)
				{
					r_numberTile = new(this, "numberTile");
					r_numberTile.SetBelong(this.instance);
				}
				return r_numberTile;
			}
		}
		...
		/// <summary>
		/// System.Single alphaspeed
		/// </summary>
		protected RField r_alphaspeed;
		public virtual RField Ralphaspeed
		{
			get
			{
				if(r_alphaspeed == null)
				{
					r_alphaspeed = new(this, "alphaspeed");
					r_alphaspeed.SetBelong(this.instance);
				}
				return r_alphaspeed;
			}
		}
		...
		/// <summary>
		/// UnityEngine.Texture2D mMainTex
		/// </summary>
		protected RUnityEngine.RTexture2D r_mMainTex;
		public virtual RUnityEngine.RTexture2D RmMainTex
		{
			get
			{
				if(r_mMainTex == null)
				{
					r_mMainTex = new(this, "mMainTex");
					r_mMainTex.SetBelong(this.instance);
				}
				return r_mMainTex;
			}
		}
		...
		/// <summary>
		/// NumberTexture mDamageNumber
		/// </summary>
		protected RNumberTexture r_mDamageNumber;
		public virtual RNumberTexture RmDamageNumber
		{
			get
			{
				if(r_mDamageNumber == null)
				{
					r_mDamageNumber = new(this, "mDamageNumber");
					r_mDamageNumber.SetBelong(this.instance);
				}
				return r_mDamageNumber;
			}
		}

		/// <summary>
		/// UnityEngine.Texture2D missTex
		/// </summary>
		protected RUnityEngine.RTexture2D r_missTex;
		public virtual RUnityEngine.RTexture2D RmissTex
		{
			get
			{
				if(r_missTex == null)
				{
					r_missTex = new(this, "missTex");
					r_missTex.SetBelong(this.instance);
				}
				return r_missTex;
			}
		}
		...
		/// <summary>
		/// Void SetMiss(UnityEngine.Texture2D)
		/// </summary>
		protected RMethod r_RSetMiss_Texture2D;
		public virtual RMethod RSetMiss_Texture2D
		{
			get
			{
				if(r_RSetMiss_Texture2D == null)
				{
					r_RSetMiss_Texture2D = new(this, "SetMiss", 0, typeof(UnityEngine.Texture2D));
					r_RSetMiss_Texture2D.SetBelong(this.instance);
				}
				return r_RSetMiss_Texture2D;
			}
		}

		/// <summary>
		/// Void SetNumber(Int64, UnityEngine.Texture2D)
		/// </summary>
		protected RMethod r_RSetNumber_Int64_Texture2D;
		public virtual RMethod RSetNumber_Int64_Texture2D
		{
			get
			{
				if(r_RSetNumber_Int64_Texture2D == null)
				{
					r_RSetNumber_Int64_Texture2D = new(this, "SetNumber", 0, typeof(System.Int64), typeof(UnityEngine.Texture2D));
					r_RSetNumber_Int64_Texture2D.SetBelong(this.instance);
				}
				return r_RSetNumber_Int64_Texture2D;
			}
		}

		/// <summary>
		/// UnityEngine.Texture2D GetNumTex(UnityEngine.Texture2D, Int64)
		/// </summary>
		protected static RMethod r_RGetNumTex_Texture2D_Int64;
		public static RMethod RGetNumTex_Texture2D_Int64
		{
			get
			{
				if(r_RGetNumTex_Texture2D_Int64 == null)
				{
					r_RGetNumTex_Texture2D_Int64 = new( ReleactionUtils.GetType("DamageNumber"), "GetNumTex", 0, typeof(UnityEngine.Texture2D), typeof(System.Int64));
					r_RGetNumTex_Texture2D_Int64.SetBelong(null);
				}
				return r_RGetNumTex_Texture2D_Int64;
			}
		}

		/// <summary>
		/// Void SetNumber(Int64, UnityEngine.Texture2D, UnityEngine.Texture2D)
		/// </summary>
		protected RMethod r_RSetNumber_Int64_Texture2D_Texture2D;
		public virtual RMethod RSetNumber_Int64_Texture2D_Texture2D
		{
			get
			{
				if(r_RSetNumber_Int64_Texture2D_Texture2D == null)
				{
					r_RSetNumber_Int64_Texture2D_Texture2D = new(this, "SetNumber", 0, typeof(System.Int64), typeof(UnityEngine.Texture2D), typeof(UnityEngine.Texture2D));
					r_RSetNumber_Int64_Texture2D_Texture2D.SetBelong(this.instance);
				}
				return r_RSetNumber_Int64_Texture2D_Texture2D;
			}
		}
		...
		/// Void SetNumber(Int64, UnityEngine.Texture2D[], UnityEngine.Texture2D)
		/// </summary>
		protected RMethod r_RSetNumber_Int64_Texture2DArray_Texture2D;
		public virtual RMethod RSetNumber_Int64_Texture2DArray_Texture2D
		{
			get
			{
				if(r_RSetNumber_Int64_Texture2DArray_Texture2D == null)
				{
					r_RSetNumber_Int64_Texture2DArray_Texture2D = new(this, "SetNumber", 0, typeof(System.Int64), typeof(UnityEngine.Texture2D).MakeArrayType(), typeof(UnityEngine.Texture2D));
					r_RSetNumber_Int64_Texture2DArray_Texture2D.SetBelong(this.instance);
				}
				return r_RSetNumber_Int64_Texture2DArray_Texture2D;
			}
		}

		/// <summary>
		/// UnityEngine.Texture2D CreateNumTextureWithEffectTexture(UnityEngine.Texture2D, UnityEngine.Texture2D)
		/// </summary>
		protected static RMethod r_RCreateNumTextureWithEffectTexture_Texture2D_Texture2D;
		public static RMethod RCreateNumTextureWithEffectTexture_Texture2D_Texture2D
		{
			get
			{
				if(r_RCreateNumTextureWithEffectTexture_Texture2D_Texture2D == null)
				{
					r_RCreateNumTextureWithEffectTexture_Texture2D_Texture2D = new( ReleactionUtils.GetType("DamageNumber"), "CreateNumTextureWithEffectTexture", 0, typeof(UnityEngine.Texture2D), typeof(UnityEngine.Texture2D));
					r_RCreateNumTextureWithEffectTexture_Texture2D_Texture2D.SetBelong(null);
				}
				return r_RCreateNumTextureWithEffectTexture_Texture2D_Texture2D;
			}
		}

		/// <summary>
		/// UnityEngine.Texture2D CreateNumTexture(UnityEngine.Texture2D[], Int64)
		/// </summary>
		protected static RMethod r_RCreateNumTexture_Texture2DArray_Int64;
		public static RMethod RCreateNumTexture_Texture2DArray_Int64
		{
			get
			{
				if(r_RCreateNumTexture_Texture2DArray_Int64 == null)
				{
					r_RCreateNumTexture_Texture2DArray_Int64 = new( ReleactionUtils.GetType("DamageNumber"), "CreateNumTexture", 0, typeof(UnityEngine.Texture2D).MakeArrayType(), typeof(System.Int64));
					r_RCreateNumTexture_Texture2DArray_Int64.SetBelong(null);
				}
				return r_RCreateNumTexture_Texture2DArray_Int64;
			}
		}
        ...
        public RDamageNumber() : base("DamageNumber")
        {
        }

        public RDamageNumber(System.Object instance) : base("DamageNumber")
		{
            SetInstance(instance);
		}

        public RDamageNumber(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RDamageNumber(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void SetMiss(UnityEngine.Texture2D  @mTex)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@mTex};
            var ___result = RSetMiss_Texture2D.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void SetNumber(System.Int64  @number, UnityEngine.Texture2D  @mTex)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@number, @mTex};
            var ___result = RSetNumber_Int64_Texture2D.Invoke(___genericsType, ___parameters);

            
        }


        public static UnityEngine.Texture2D GetNumTex(UnityEngine.Texture2D  @mTex, System.Int64  @num)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@mTex, @num};
            var ___result = RGetNumTex_Texture2D_Int64.Invoke(___genericsType, ___parameters);

            return (UnityEngine.Texture2D)___result;
        }


        public virtual void SetNumber(System.Int64  @number, UnityEngine.Texture2D  @mTex, UnityEngine.Texture2D  @mEffectTex)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@number, @mTex, @mEffectTex};
            var ___result = RSetNumber_Int64_Texture2D_Texture2D.Invoke(___genericsType, ___parameters);
        ...
        public virtual void SetNumber(System.Int64  @number, UnityEngine.Texture2D[]  @mTex, UnityEngine.Texture2D  @mEffectTex)
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@number, @mTex, @mEffectTex};
            var ___result = RSetNumber_Int64_Texture2DArray_Texture2D.Invoke(___genericsType, ___parameters);

            
        }


        public static UnityEngine.Texture2D CreateNumTextureWithEffectTexture(UnityEngine.Texture2D  @mTex, UnityEngine.Texture2D  @mEffectTex)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@mTex, @mEffectTex};
            var ___result = RCreateNumTextureWithEffectTexture_Texture2D_Texture2D.Invoke(___genericsType, ___parameters);

            return (UnityEngine.Texture2D)___result;
        }


        public static UnityEngine.Texture2D CreateNumTexture(UnityEngine.Texture2D[]  @TexArr, System.Int64  @num)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@TexArr, @num};
            var ___result = RCreateNumTexture_Texture2DArray_Int64.Invoke(___genericsType, ___parameters);

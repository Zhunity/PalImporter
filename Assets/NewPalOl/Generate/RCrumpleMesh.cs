...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CrumpleMesh
	/// </summary>
    public partial class RCrumpleMesh : RMember //
    {
		...
		/// <summary>
		/// System.Boolean recalculateNormals
		/// </summary>
		protected RField r_recalculateNormals;
		public virtual RField RrecalculateNormals
		{
			get
			{
				if(r_recalculateNormals == null)
				{
					r_recalculateNormals = new(this, "recalculateNormals");
		...
		/// <summary>
		/// UnityEngine.Vector3[] baseVertices
		/// </summary>
		protected RFieldArray<RUnityEngine.RVector3> r_baseVertices;
		public virtual RFieldArray<RUnityEngine.RVector3> RbaseVertices
		{
			get
			{
				if(r_baseVertices == null)
				{
					r_baseVertices = new(this, "baseVertices");
					r_baseVertices.SetBelong(this.instance);
				}
				return r_baseVertices;
			}
		}
		...
		/// Perlin noise
		/// </summary>
		protected RPerlin r_noise;
		public virtual RPerlin Rnoise
		{
			get
			{
				if(r_noise == null)
				{
					r_noise = new(this, "noise");
					r_noise.SetBelong(this.instance);
				}
				return r_noise;
			}
		}
        ...
        public RCrumpleMesh() : base("CrumpleMesh")
        {
        }

        public RCrumpleMesh(System.Object instance) : base("CrumpleMesh")
		{
            SetInstance(instance);
		}

        public RCrumpleMesh(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCrumpleMesh(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

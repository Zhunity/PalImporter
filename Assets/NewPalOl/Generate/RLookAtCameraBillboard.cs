...
namespace SMFrame.Editor.Refleaction
{
	...
	/// </summary>
    public partial class RLookAtCameraBillboard : RMember //
    {
        ...
        public RLookAtCameraBillboard() : base("LookAtCameraBillboard")
        {
        }

        public RLookAtCameraBillboard(System.Object instance) : base("LookAtCameraBillboard")
		{
            SetInstance(instance);
		}

        public RLookAtCameraBillboard(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RLookAtCameraBillboard(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

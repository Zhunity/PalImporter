...
namespace SMFrame.Editor.Refleaction
{
	...
	/// EffectInstanceHold
	/// </summary>
    public partial class REffectInstanceHold : RMember //
    {
		...
		/// <summary>
		/// System.String m_aniName
		/// </summary>
		protected RField r_m_aniName;
		public virtual RField Rm_aniName
		{
			get
			{
				if(r_m_aniName == null)
				{
					r_m_aniName = new(this, "m_aniName");
					r_m_aniName.SetBelong(this.instance);
				}
				return r_m_aniName;
			}
		}
		...
		/// <summary>
		/// Void SetUrl(System.String, System.String)
		/// </summary>
		protected RMethod r_RSetUrl_String_String;
		public virtual RMethod RSetUrl_String_String
		{
			get
			{
				if(r_RSetUrl_String_String == null)
				{
					r_RSetUrl_String_String = new(this, "SetUrl", 0, typeof(System.String), typeof(System.String));
					r_RSetUrl_String_String.SetBelong(this.instance);
				}
				return r_RSetUrl_String_String;
			}
		}

		/// <summary>
		/// Void SetUrl(System.String, System.String, Boolean)
		/// </summary>
		protected RMethod r_RSetUrl_String_String_Boolean;
		public virtual RMethod RSetUrl_String_String_Boolean
		{
			get
			{
				if(r_RSetUrl_String_String_Boolean == null)
				{
					r_RSetUrl_String_String_Boolean = new(this, "SetUrl", 0, typeof(System.String), typeof(System.String), typeof(System.Boolean));
					r_RSetUrl_String_String_Boolean.SetBelong(this.instance);
				}
				return r_RSetUrl_String_String_Boolean;
			}
		}
		...
		/// <summary>
		/// Void DownLoadPlayAnimation(GameDefineType.ID, System.String, GameDefineType.ID, UnityEngine.Animation, Single, UnityEngine.WrapMode)
		/// </summary>
		protected RMethod r_RDownLoadPlayAnimation_ID_String_ID_Animation_Single_WrapMode;
		public virtual RMethod RDownLoadPlayAnimation_ID_String_ID_Animation_Single_WrapMode
		{
			get
			{
				if(r_RDownLoadPlayAnimation_ID_String_ID_Animation_Single_WrapMode == null)
				{
					r_RDownLoadPlayAnimation_ID_String_ID_Animation_Single_WrapMode = new(this, "DownLoadPlayAnimation", 0, typeof(GameDefineType.ID), typeof(System.String), typeof(GameDefineType.ID), typeof(UnityEngine.Animation), typeof(System.Single), typeof(UnityEngine.WrapMode));
					r_RDownLoadPlayAnimation_ID_String_ID_Animation_Single_WrapMode.SetBelong(this.instance);
				}
				return r_RDownLoadPlayAnimation_ID_String_ID_Animation_Single_WrapMode;
			}
		}
        ...
        public REffectInstanceHold() : base("EffectInstanceHold")
        {
        }

        public REffectInstanceHold(System.Object instance) : base("EffectInstanceHold")
		{
            SetInstance(instance);
		}

        public REffectInstanceHold(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REffectInstanceHold(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void SetUrl(System.String  @url, System.String  @name)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@url, @name};
            var ___result = RSetUrl_String_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void SetUrl(System.String  @url, System.String  @name, System.Boolean  @commonEffect)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@url, @name, @commonEffect};
            var ___result = RSetUrl_String_String_Boolean.Invoke(___genericsType, ___parameters);
        ...
        public virtual void DownLoadPlayAnimation(GameDefineType.ID  @resourceID, System.String  @aniName, GameDefineType.ID  @sceneID, UnityEngine.Animation  @ani, System.Single  @spd, UnityEngine.WrapMode  @mode)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@resourceID, @aniName, @sceneID, @ani, @spd, @mode};
            var ___result = RDownLoadPlayAnimation_ID_String_ID_Animation_Single_WrapMode.Invoke(___genericsType, ___parameters);

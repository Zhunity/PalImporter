...
{
	/// <summary>
	/// WorkshopStudyXMLReader
	/// </summary>
    public partial class RWorkshopStudyXMLReader : RMember //
    {
        ...
        public RWorkshopStudyXMLReader() : base("WorkshopStudyXMLReader")
        {
        }

        public RWorkshopStudyXMLReader(System.Object instance) : base("WorkshopStudyXMLReader")
		{
            SetInstance(instance);
		}

        public RWorkshopStudyXMLReader(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RWorkshopStudyXMLReader(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
namespace SMFrame.Editor.Refleaction
{
	...
	/// OpenDoorAction
	/// </summary>
    public partial class ROpenDoorAction : RMember //
    {
		...
		/// Void DoAction()
		/// </summary>
		protected RMethod r_RDoAction;
		public virtual RMethod RDoAction
		{
			get
			{
				if(r_RDoAction == null)
				{
					r_RDoAction = new(this, "DoAction", 0);
					r_RDoAction.SetBelong(this.instance);
				}
				return r_RDoAction;
			}
		}
        ...
        public ROpenDoorAction() : base("OpenDoorAction")
        {
        }

        public ROpenDoorAction(System.Object instance) : base("OpenDoorAction")
		{
            SetInstance(instance);
		}

        public ROpenDoorAction(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public ROpenDoorAction(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void DoAction()
        {
            ...
            var ___result = RDoAction.Invoke(___genericsType, ___parameters);

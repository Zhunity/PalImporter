...
{public partial class RNetPlayCombatCtr
{
	
	/// <summary>
	/// NetPlayCombatCtr+<EnterCombatWait>c__Iterator14A
	/// </summary>
    public partial class R__2__EnterCombatWait__4__c__Iterator14A : RMember //
    {
		...
		/// <summary>
		/// NetPlayCombatCtr <>f__this
		/// </summary>
		protected RNetPlayCombatCtr r___2____4__f__this;
		public virtual RNetPlayCombatCtr R__2____4__f__this
		{
			get
			{
        ...
        public R__2__EnterCombatWait__4__c__Iterator14A() : base("NetPlayCombatCtr+<EnterCombatWait>c__Iterator14A")
        {
        }

        public R__2__EnterCombatWait__4__c__Iterator14A(System.Object instance) : base("NetPlayCombatCtr+<EnterCombatWait>c__Iterator14A")
		{
            SetInstance(instance);
		}

        public R__2__EnterCombatWait__4__c__Iterator14A(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__2__EnterCombatWait__4__c__Iterator14A(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

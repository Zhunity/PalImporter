...
namespace SMFrame.Editor.Refleaction
{
	...
	/// Water3Float
	/// </summary>
    public partial class RWater3Float : RMember //
    {
        ...
        public RWater3Float() : base("Water3Float")
        {
        }

        public RWater3Float(System.Object instance) : base("Water3Float")
		{
            SetInstance(instance);
		}

        public RWater3Float(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RWater3Float(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

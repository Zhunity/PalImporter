...
namespace SMFrame.Editor.Refleaction
{
	...
	/// CharacterDownLand
	/// </summary>
    public partial class RCharacterDownLand : RMember //
    {
        ...
        public RCharacterDownLand() : base("CharacterDownLand")
        {
        }

        public RCharacterDownLand(System.Object instance) : base("CharacterDownLand")
		{
            SetInstance(instance);
		}

        public RCharacterDownLand(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCharacterDownLand(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

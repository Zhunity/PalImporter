...
namespace SMFrame.Editor.Refleaction
{
	...
	/// XJ19Config
	/// </summary>
    public partial class RXJ19Config : RMember //
    {
        ...
        public RXJ19Config() : base("XJ19Config")
        {
        }

        public RXJ19Config(System.Object instance) : base("XJ19Config")
		{
            SetInstance(instance);
		}

        public RXJ19Config(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RXJ19Config(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

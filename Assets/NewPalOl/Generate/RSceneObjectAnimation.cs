...
namespace SMFrame.Editor.Refleaction
{
	...
	/// </summary>
    public partial class RSceneObjectAnimation : RMember //
    {

		/// <summary>
		/// UnityEngine.GameObject m_particleEffect
		/// </summary>
		protected RUnityEngine.RGameObject r_m_particleEffect;
		public virtual RUnityEngine.RGameObject Rm_particleEffect
		{
			get
			{
				if(r_m_particleEffect == null)
				{
					r_m_particleEffect = new(this, "m_particleEffect");
					r_m_particleEffect.SetBelong(this.instance);
				}
				return r_m_particleEffect;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RAnimation r_m_Animation;
		public virtual RUnityEngine.RAnimation Rm_Animation
		{
			get
			{
				if(r_m_Animation == null)
				{
					r_m_Animation = new(this, "m_Animation");
					r_m_Animation.SetBelong(this.instance);
				}
				return r_m_Animation;
			}
		}

		/// <summary>
		/// System.String m_animationName
		/// </summary>
		protected RField r_m_animationName;
		public virtual RField Rm_animationName
		{
			get
			{
				if(r_m_animationName == null)
				{
					r_m_animationName = new(this, "m_animationName");
					r_m_animationName.SetBelong(this.instance);
				}
				return r_m_animationName;
			}
		}
		...
		/// </summary>
		protected RField r_triggered;
		public virtual RField Rtriggered
		{
			get
			{
				if(r_triggered == null)
				{
					r_triggered = new(this, "triggered");
					r_triggered.SetBelong(this.instance);
				}
				return r_triggered;
			}
		}
		...
		/// Void OnTriggerExit()
		/// </summary>
		protected RMethod r_ROnTriggerExit;
		public virtual RMethod ROnTriggerExit
		{
			get
			{
				if(r_ROnTriggerExit == null)
				{
					r_ROnTriggerExit = new(this, "OnTriggerExit", 0);
					r_ROnTriggerExit.SetBelong(this.instance);
				}
				return r_ROnTriggerExit;
			}
		}
        ...
        public RSceneObjectAnimation() : base("SceneObjectAnimation")
        {
        }

        public RSceneObjectAnimation(System.Object instance) : base("SceneObjectAnimation")
		{
            SetInstance(instance);
		}

        public RSceneObjectAnimation(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSceneObjectAnimation(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void OnTriggerExit()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = ROnTriggerExit.Invoke(___genericsType, ___parameters);

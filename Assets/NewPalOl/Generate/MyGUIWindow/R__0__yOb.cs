...
{public partial class RMyGUIWindow
{
	...
	/// MyGUIWindow+#yOb
	/// </summary>
    public partial class R__0__yOb : RMember //
    {
		...
		/// System.Exception #l
		/// </summary>
		protected RSystem.RException r___0__l;
		public virtual RSystem.RException R__0__l
		{
			get
			{
				if(r___0__l == null)
		...
		/// MyGUIWindow #r
		/// </summary>
		protected RMyGUIWindow r___0__r;
		public virtual RMyGUIWindow R__0__r
		{
			get
			{
				if(r___0__r == null)
        ...
        public R__0__yOb() : base("MyGUIWindow+#yOb")
        {
        }

        public R__0__yOb(System.Object instance) : base("MyGUIWindow+#yOb")
		{
            SetInstance(instance);
		}

        public R__0__yOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__yOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

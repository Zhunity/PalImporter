...
{public partial class RMyGUIWindow
{
	...
	/// MyGUIWindow+#JNb
	/// </summary>
    public partial class R__0__JNb : RMember //
    {
        ...
        public R__0__JNb() : base("MyGUIWindow+#JNb")
        {
        }

        public R__0__JNb(System.Object instance) : base("MyGUIWindow+#JNb")
		{
            SetInstance(instance);
		}

        public R__0__JNb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__JNb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Int32 Invoke(System.Int32  @viplv)
        {
        ...
        public virtual System.IAsyncResult BeginInvoke(System.Int32  @viplv, System.AsyncCallback  @callback, System.Object  @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@viplv, @callback, @object};

...
{public partial class RMyGUIWindow
{
	...
	/// MyGUIWindow+#zOb
	/// </summary>
    public partial class R__0__zOb : RMember //
    {
        ...
        public R__0__zOb() : base("MyGUIWindow+#zOb")
        {
        }

        public R__0__zOb(System.Object instance) : base("MyGUIWindow+#zOb")
		{
            SetInstance(instance);
		}

        public R__0__zOb(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__zOb(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

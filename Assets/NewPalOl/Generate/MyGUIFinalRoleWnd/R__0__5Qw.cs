...
{public partial class RMyGUIFinalRoleWnd
{
	...
	/// <summary>
	/// MyGUIFinalRoleWnd+#5Qw
	/// </summary>
    public partial class R__0__5Qw : RMember //
    {
        ...
        public R__0__5Qw() : base("MyGUIFinalRoleWnd+#5Qw")
        {
        }

        public R__0__5Qw(System.Object instance) : base("MyGUIFinalRoleWnd+#5Qw")
		{
            SetInstance(instance);
		}

        public R__0__5Qw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__5Qw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

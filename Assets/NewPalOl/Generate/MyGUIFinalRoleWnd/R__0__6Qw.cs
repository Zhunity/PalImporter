...
{public partial class RMyGUIFinalRoleWnd
{
	...
	/// <summary>
	/// MyGUIFinalRoleWnd+#6Qw
	/// </summary>
    public partial class R__0__6Qw : RMember //
    {
		...
		/// MyGUIFinalRoleWnd #e
		/// </summary>
		protected RMyGUIFinalRoleWnd r___0__e;
		public virtual RMyGUIFinalRoleWnd R__0__e
		{
			get
			{
				if(r___0__e == null)
        ...
        public R__0__6Qw() : base("MyGUIFinalRoleWnd+#6Qw")
        {
        }

        public R__0__6Qw(System.Object instance) : base("MyGUIFinalRoleWnd+#6Qw")
		{
            SetInstance(instance);
		}

        public R__0__6Qw(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__6Qw(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

...
{public partial class RMyGUIFinalRoleWnd
{
	...
	/// <summary>
	/// MyGUIFinalRoleWnd+#GAt
	/// </summary>
    public partial class R__0__GAt : RMember //
    {
        ...
        public R__0__GAt() : base("MyGUIFinalRoleWnd+#GAt")
        {
        }

        public R__0__GAt(System.Object instance) : base("MyGUIFinalRoleWnd+#GAt")
		{
            SetInstance(instance);
		}

        public R__0__GAt(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public R__0__GAt(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
